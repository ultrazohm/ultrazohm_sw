-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/gmStateSpaceHDL_uz_inverter_3ph/uz_invert_ip_rdfifo_data.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_invert_ip_rdfifo_data
-- Source Path: uz_invert_ip/uz_invert_ip_axi4/uz_invert_ip_axi4_module/uz_invert_ip_rdfifo_data
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_invert_ip_rdfifo_data IS
...
END uz_invert_ip_rdfifo_data;


ARCHITECTURE rtl OF uz_invert_ip_rdfifo_data IS

  -- Component Declarations
  COMPONENT uz_invert_ip_SimpleDualPortRAM_generic
  ...
  FOR ALL : uz_invert_ip_SimpleDualPortRAM_generic
    USE ENTITY work.uz_invert_ip_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_uz_invert_ip_rdfifo_data_classic_ram_generic : uz_invert_ip_SimpleDualPortRAM_generic
