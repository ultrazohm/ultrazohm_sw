...
struct uz_pmsmModel_nonlinear_t
{
    bool is_ready;
    struct uz_pmsmModel_nonlinear_config_t config;
};
...
static void write_config_to_pl(uz_pmsmModel_nonlinear_t *self);
...
uz_pmsmModel_nonlinear_t *uz_pmsmModel_nonlinear_init(struct uz_pmsmModel_nonlinear_config_t config)
{
    ...
    uz_pmsmModel_nonlinear_t *self = uz_pmsmModel_nonlinear_allocation();
    self->config = config;
...
void uz_pmsmModel_nonlinear_reset(uz_pmsmModel_nonlinear_t *self)
{
    ...
    struct uz_pmsmModel_nonlinear_inputs_t inputs = {
        .load_torque=0.0f,
        .omega_mech_1_s=0.0f,
        .v_d_V=0.0f,
        .v_q_V=0.0f
    };
    uz_pmsmModel_nonlinear_set_inputs(self, inputs);
    uz_pmsmModel_nonlinear_hw_trigger_input_strobe(self->config.base_address);
    uz_pmsmModel_nonlinear_hw_write_reset(self->config.base_address, false);
    uz_sleep_useconds(1U);
    uz_pmsmModel_nonlinear_hw_write_reset(self->config.base_address, true);
    uz_sleep_useconds(1U);
    uz_pmsmModel_nonlinear_hw_write_reset(self->config.base_address, false);
}
...
void uz_pmsmModel_nonlinear_set_inputs(uz_pmsmModel_nonlinear_t *self, struct uz_pmsmModel_nonlinear_inputs_t inputs)
{
    ...
    uz_pmsmModel_nonlinear_hw_write_load_torque(self->config.base_address, inputs.load_torque);
}
...
struct uz_pmsmModel_nonlinear_outputs_t uz_pmsmModel_nonlinear_get_outputs(uz_pmsmModel_nonlinear_t *self)
{
    uz_assert_not_NULL(self);
    uz_assert(self->is_ready);
    struct uz_pmsmModel_nonlinear_outputs_t outputs = {
        .i_d_A = 0.0f,
        .i_q_A = 0.0f,
        .torque_Nm = 0.0f,
        .omega_mech_1_s = 0.0f};
    outputs.i_d_A =uz_pmsmModel_nonlinear_hw_read_i_d(self->config.base_address);
    outputs.i_q_A =uz_pmsmModel_nonlinear_hw_read_i_q(self->config.base_address);
    outputs.torque_Nm =uz_pmsmModel_nonlinear_hw_read_torque(self->config.base_address);
    outputs.omega_mech_1_s =uz_pmsmModel_nonlinear_hw_read_omega_mech(self->config.base_address);
    return outputs;
}
...
void uz_pmsmModel_nonlinear_trigger_output_strobe(uz_pmsmModel_nonlinear_t *self){
    uz_assert_not_NULL(self);
    uz_assert(self->is_ready);
    uz_pmsmModel_nonlinear_hw_trigger_output_strobe(self->config.base_address);
}
...
static void write_config_to_pl(uz_pmsmModel_nonlinear_t *self)
{
    ...
    uz_pmsmModel_nonlinear_hw_write_simulate_mechanical(self->config.base_address, self->config.simulate_mechanical_system);
    uz_pmsmModel_nonlinear_hw_write_ad1(self->config.base_address, self->config.ad1);
    uz_pmsmModel_nonlinear_hw_write_ad2(self->config.base_address, self->config.ad2);
    uz_pmsmModel_nonlinear_hw_write_ad3(self->config.base_address, self->config.ad3);
    uz_pmsmModel_nonlinear_hw_write_ad4(self->config.base_address, self->config.ad4);
    uz_pmsmModel_nonlinear_hw_write_ad5(self->config.base_address, self->config.ad5);
    uz_pmsmModel_nonlinear_hw_write_ad6(self->config.base_address, self->config.ad6);
    uz_pmsmModel_nonlinear_hw_write_aq1(self->config.base_address, self->config.aq1);
    uz_pmsmModel_nonlinear_hw_write_aq2(self->config.base_address, self->config.aq2);
    uz_pmsmModel_nonlinear_hw_write_aq3(self->config.base_address, self->config.aq3);
    uz_pmsmModel_nonlinear_hw_write_aq4(self->config.base_address, self->config.aq4);
    uz_pmsmModel_nonlinear_hw_write_aq5(self->config.base_address, self->config.aq5);
    uz_pmsmModel_nonlinear_hw_write_aq6(self->config.base_address, self->config.aq6);
    uz_pmsmModel_nonlinear_hw_write_reciprocal_F1G1(self->config.base_address, self->config.F1G1);
    uz_pmsmModel_nonlinear_hw_write_reciprocal_F2G2(self->config.base_address, self->config.F2G2);
    uz_pmsmModel_nonlinear_hw_write_ad4_mul_ad5(self->config.base_address, self->config.ad4, self->config.ad5);
    uz_pmsmModel_nonlinear_hw_write_ad1_mul_ad2(self->config.base_address, self->config.ad1, self->config.ad2);
    uz_pmsmModel_nonlinear_hw_write_aq4_mul_aq5(self->config.base_address, self->config.aq4, self->config.aq5);
    uz_pmsmModel_nonlinear_hw_write_aq1_mul_aq2(self->config.base_address, self->config.aq1, self->config.aq2);
    uz_pmsmModel_nonlinear_hw_write_aq4_div_aq5(self->config.base_address, self->config.aq4, self->config.aq5);
    uz_pmsmModel_nonlinear_hw_write_aq1_div_aq2(self->config.base_address, self->config.aq1, self->config.aq2);
