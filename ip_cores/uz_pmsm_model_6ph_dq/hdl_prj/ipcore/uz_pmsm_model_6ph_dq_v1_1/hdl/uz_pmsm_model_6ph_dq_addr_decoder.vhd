-- -------------------------------------------------------------
-- 
-- File Name: /home/hufnagelde/ultrazohm_sw/ip_cores/uz_pmsm_model_6ph_dq/hdl_prj/hdlsrc/uz_pmsm_model_6ph_dq/uz_pmsm_model_6ph_dq_addr_decoder.vhd
...
BEGIN
  ...
  data_slice_currents_dq_out_axi_1_0 <= sync_reg_currents_dq_out_axi(0);
  ...
  data_slice_currents_dq_out_axi_1_1 <= sync_reg_currents_dq_out_axi(1);
  ...
  data_slice_currents_dq_out_axi_1_2 <= sync_reg_currents_dq_out_axi(2);
  ...
  data_slice_currents_dq_out_axi_1_3 <= sync_reg_currents_dq_out_axi(3);
  ...
  data_slice_currents_dq_out_axi_1_4 <= sync_reg_currents_dq_out_axi(4);
  ...
  data_slice_currents_dq_out_axi_1_5 <= sync_reg_currents_dq_out_axi(5);
  ...
  data_slice_voltage_input_dq_out_axi_fb_1_0 <= sync_reg_voltage_input_dq_out_axi_fb(0);
  ...
  data_slice_voltage_input_dq_out_axi_fb_1_1 <= sync_reg_voltage_input_dq_out_axi_fb(1);
  ...
  data_slice_voltage_input_dq_out_axi_fb_1_2 <= sync_reg_voltage_input_dq_out_axi_fb(2);
  ...
  data_slice_voltage_input_dq_out_axi_fb_1_3 <= sync_reg_voltage_input_dq_out_axi_fb(3);
  ...
  data_slice_voltage_input_dq_out_axi_fb_1_4 <= sync_reg_voltage_input_dq_out_axi_fb(4);
  ...
  data_slice_voltage_input_dq_out_axi_fb_1_5 <= sync_reg_voltage_input_dq_out_axi_fb(5);
  ...
  write_use_axi_input <= data_reg_use_axi_input_1_1;
