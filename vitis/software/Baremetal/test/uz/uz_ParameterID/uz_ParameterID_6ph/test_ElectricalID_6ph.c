...
void test_uz_ElectricalID_6ph_get_enteredElectricalID_not_NULL(void) {
    TEST_ASSERT_FAIL_ASSERT(uz_ElectricalID_6ph_get_entered(NULL));
}

void test_uz_ElectricalID_6ph_get_finishedElectricalID_not_NULL(void) {
    TEST_ASSERT_FAIL_ASSERT(uz_ElectricalID_6ph_get_finished(NULL));
}

void test_uz_ElectricalID_6ph_get_FOC_output_not_NULL(void) {
    TEST_ASSERT_FAIL_ASSERT(uz_ElectricalID_6ph_get_FOCoutput(NULL));
}

void test_uz_ElectricalID_6ph_get_output_not_NULL(void) {
    TEST_ASSERT_FAIL_ASSERT(uz_ElectricalID_6ph_get_output(NULL));
}

void test_uz_get_ElectricalID_6ph_fft_out(void){
    TEST_ASSERT_FAIL_ASSERT(uz_ElectricalID_6ph_get_fft_out(NULL));
}

void test_uz_get_ElectricalID_6ph_finished_voltage_measurement(void){
    TEST_ASSERT_FAIL_ASSERT(uz_ElectricalID_6ph_get_finished_voltage_measurement(NULL));
}
