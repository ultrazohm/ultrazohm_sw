-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\valen\Documents\repos\UZ\ultrazohm_sw_working\ip_cores\uz_sixphase_VSD_transformation\hdl_prj\hdlsrc\uz_sixphase_VSD_transformation\uz_sixphase_VSD_transformation_src_abc_to_dq.vhd
-- Created: 2022-09-17 18:31:04
-- 
...
ARCHITECTURE rtl OF uz_sixphase_VSD_transformation_src_abc_to_dq IS
  ...
  SIGNAL delayMatch25_reg                 : vector_of_signed18(0 TO 8);  -- sfix18 [9]
  SIGNAL delayMatch25_reg_next            : vector_of_signed18(0 TO 8);  -- sfix18_En16 [9]
...
BEGIN
  ...
  selector_out_2(0) <= x_abc2_ll_pl_4(0);
  selector_out_2(1) <= x_abc2_ll_pl_4(1);
  selector_out_2(2) <= x_abc2_ll_pl_4(2);
  selector_out_2(3) <= x_abc2_ll_pl_4(0);
  selector_out_2(4) <= x_abc2_ll_pl_4(1);
  selector_out_2(5) <= x_abc2_ll_pl_4(2);
  selector_out_2(6) <= x_abc2_ll_pl_4(0);
  selector_out_2(7) <= x_abc2_ll_pl_4(1);
  selector_out_2(8) <= x_abc2_ll_pl_4(2);
  ...
  s_5(0) <= "011111111111111111111111111" WHEN (MMul_add_122_add_temp(27) = '0') AND (MMul_add_122_add_temp(26) /= '0') ELSE
  ...
  s_5(1) <= "011111111111111111111111111" WHEN (MMul_add_122_add_temp_1(27) = '0') AND (MMul_add_122_add_temp_1(26) /= '0') ELSE
  ...
  s_5(2) <= "011111111111111111111111111" WHEN (MMul_add_122_add_temp_2(27) = '0') AND (MMul_add_122_add_temp_2(26) /= '0') ELSE
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        delayMatch25_reg(0) <= to_signed(16#00000#, 18);
        delayMatch25_reg(1) <= to_signed(16#00000#, 18);
        delayMatch25_reg(2) <= to_signed(16#00000#, 18);
        delayMatch25_reg(3) <= to_signed(16#00000#, 18);
        delayMatch25_reg(4) <= to_signed(16#00000#, 18);
        delayMatch25_reg(5) <= to_signed(16#00000#, 18);
        delayMatch25_reg(6) <= to_signed(16#00000#, 18);
        delayMatch25_reg(7) <= to_signed(16#00000#, 18);
        delayMatch25_reg(8) <= to_signed(16#00000#, 18);
      ELSIF enb = '1' THEN
  ...
  s_6(0) <= delayMatch25_reg(0);
  s_6(1) <= delayMatch25_reg(1);
  s_6(2) <= delayMatch25_reg(2);
  s_6(3) <= delayMatch25_reg(3);
  s_6(4) <= delayMatch25_reg(4);
  s_6(5) <= delayMatch25_reg(5);
  s_6(6) <= delayMatch25_reg(6);
  s_6(7) <= delayMatch25_reg(7);
  s_6(8) <= delayMatch25_reg(8);
  delayMatch25_reg_next(0) <= s_1(0);
  delayMatch25_reg_next(1) <= s_1(1);
  delayMatch25_reg_next(2) <= s_1(2);
  delayMatch25_reg_next(3) <= s_1(3);
  delayMatch25_reg_next(4) <= s_1(4);
  delayMatch25_reg_next(5) <= s_1(5);
  delayMatch25_reg_next(6) <= s_1(6);
  delayMatch25_reg_next(7) <= s_1(7);
  delayMatch25_reg_next(8) <= s_1(8);
  ...
  s_8(0) <= "011111111111111111111111111" WHEN (MMul_add_123_add_temp(27) = '0') AND (MMul_add_123_add_temp(26) /= '0') ELSE
  ...
  s_8(1) <= "011111111111111111111111111" WHEN (MMul_add_123_add_temp_1(27) = '0') AND (MMul_add_123_add_temp_1(26) /= '0') ELSE
  ...
  s_8(2) <= "011111111111111111111111111" WHEN (MMul_add_123_add_temp_2(27) = '0') AND (MMul_add_123_add_temp_2(26) /= '0') ELSE
  ...
  selector_out_12(0) <= x_abc1_ll_pl_4(0);
  selector_out_12(1) <= x_abc1_ll_pl_4(1);
  selector_out_12(2) <= x_abc1_ll_pl_4(2);
  selector_out_12(3) <= x_abc1_ll_pl_4(0);
  selector_out_12(4) <= x_abc1_ll_pl_4(1);
  selector_out_12(5) <= x_abc1_ll_pl_4(2);
  selector_out_12(6) <= x_abc1_ll_pl_4(0);
  selector_out_12(7) <= x_abc1_ll_pl_4(1);
  selector_out_12(8) <= x_abc1_ll_pl_4(2);
  ...
  s_14(0) <= "011111111111111111111111111" WHEN (MMul_add_12_add_temp(27) = '0') AND (MMul_add_12_add_temp(26) /= '0') ELSE
  ...
  s_14(1) <= "011111111111111111111111111" WHEN (MMul_add_12_add_temp_1(27) = '0') AND (MMul_add_12_add_temp_1(26) /= '0') ELSE
  ...
  s_14(2) <= "011111111111111111111111111" WHEN (MMul_add_12_add_temp_2(27) = '0') AND (MMul_add_12_add_temp_2(26) /= '0') ELSE
  ...
  s_15(0) <= delayMatch20_reg(0);
  s_15(1) <= delayMatch20_reg(1);
  s_15(2) <= delayMatch20_reg(2);
  s_15(3) <= delayMatch20_reg(3);
  s_15(4) <= delayMatch20_reg(4);
  s_15(5) <= delayMatch20_reg(5);
  s_15(6) <= delayMatch20_reg(6);
  s_15(7) <= delayMatch20_reg(7);
  s_15(8) <= delayMatch20_reg(8);
  delayMatch20_reg_next(0) <= s_10(0);
  delayMatch20_reg_next(1) <= s_10(1);
  delayMatch20_reg_next(2) <= s_10(2);
  delayMatch20_reg_next(3) <= s_10(3);
  delayMatch20_reg_next(4) <= s_10(4);
  delayMatch20_reg_next(5) <= s_10(5);
  delayMatch20_reg_next(6) <= s_10(6);
  delayMatch20_reg_next(7) <= s_10(7);
  delayMatch20_reg_next(8) <= s_10(8);
  ...
  s_17(0) <= "011111111111111111111111111" WHEN (MMul_add_121_add_temp(27) = '0') AND (MMul_add_121_add_temp(26) /= '0') ELSE
  ...
  s_17(1) <= "011111111111111111111111111" WHEN (MMul_add_121_add_temp_1(27) = '0') AND (MMul_add_121_add_temp_1(26) /= '0') ELSE
  ...
  s_17(2) <= "011111111111111111111111111" WHEN (MMul_add_121_add_temp_2(27) = '0') AND (MMul_add_121_add_temp_2(26) /= '0') ELSE
