...
char folder_path[] = "test/uz/uz_dqn/bitflip_ablation_halton_training/";
...
void test_dqn_bitflip_one_not_twister_init_squares(void)
{
    ...
    struct experiment_config exp = get_exp_config(uz_prng_generator_squares, uz_prng_generator_squares, uz_prng_generator_halton, uz_prng_generator_mtwister);
    do_experiment(training_absolute_path, exp);
}
...
void test_dqn_bitflip_one_not_twister_init_pcg(void)
{
    ...
    struct experiment_config exp = get_exp_config(uz_prng_generator_pcg, uz_prng_generator_pcg, uz_prng_generator_halton, uz_prng_generator_mtwister);
    do_experiment(training_absolute_path, exp);
}
...
void test_dqn_bitflip_one_not_twister_init_xoshiro(void)
{
    ...
    struct experiment_config exp = get_exp_config(uz_prng_generator_xoshiro, uz_prng_generator_xoshiro, uz_prng_generator_halton, uz_prng_generator_mtwister);
    do_experiment(training_absolute_path, exp);
}
