-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/dac_spi/uz_dac_src_HDL_DUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_dac_src_HDL_DUT
-- Source Path: dac_spi/HDL_DUT
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END uz_dac_src_HDL_DUT;


ARCHITECTURE rtl OF uz_dac_src_HDL_DUT IS

  -- Component Declarations
  COMPONENT uz_dac_src_HDL_DUT_tc
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          clk_enable                      :   IN    std_logic;
          enb                             :   OUT   std_logic;
  ...
  COMPONENT uz_dac_src_Detect_Rise_Positive
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  COMPONENT uz_dac_src_Subsystem
    PORT( u                               :   IN    std_logic_vector(15 DOWNTO 0);  -- int16
          Out1                            :   OUT   std_logic_vector(0 TO 31)  -- ufix1 [32]
          );
  END COMPONENT;

  COMPONENT uz_dac_src_Subsystem1
    PORT( u                               :   IN    std_logic_vector(15 DOWNTO 0);  -- int16
          Out1                            :   OUT   std_logic_vector(0 TO 31)  -- ufix1 [32]
          );
  END COMPONENT;

  COMPONENT uz_dac_src_Subsystem2
    PORT( u                               :   IN    std_logic_vector(15 DOWNTO 0);  -- int16
          Out1                            :   OUT   std_logic_vector(0 TO 31)  -- ufix1 [32]
          );
  END COMPONENT;

  COMPONENT uz_dac_src_Subsystem3
    PORT( u                               :   IN    std_logic_vector(15 DOWNTO 0);  -- int16
          Out1                            :   OUT   std_logic_vector(0 TO 31)  -- ufix1 [32]
          );
  END COMPONENT;

  COMPONENT uz_dac_src_Subsystem4
    PORT( u                               :   IN    std_logic_vector(15 DOWNTO 0);  -- int16
          Out1                            :   OUT   std_logic_vector(0 TO 31)  -- ufix1 [32]
          );
  END COMPONENT;

  COMPONENT uz_dac_src_Subsystem5
    PORT( u                               :   IN    std_logic_vector(15 DOWNTO 0);  -- int16
          Out1                            :   OUT   std_logic_vector(0 TO 31)  -- ufix1 [32]
          );
  END COMPONENT;

  COMPONENT uz_dac_src_Subsystem6
    PORT( u                               :   IN    std_logic_vector(15 DOWNTO 0);  -- int16
          Out1                            :   OUT   std_logic_vector(0 TO 31)  -- ufix1 [32]
          );
  END COMPONENT;

  COMPONENT uz_dac_src_Subsystem7
    PORT( u                               :   IN    std_logic_vector(15 DOWNTO 0);  -- int16
          Out1                            :   OUT   std_logic_vector(0 TO 31)  -- ufix1 [32]
          );
  END COMPONENT;
  ...
  FOR ALL : uz_dac_src_HDL_DUT_tc
    USE ENTITY work.uz_dac_src_HDL_DUT_tc(rtl);

  FOR ALL : uz_dac_src_Detect_Rise_Positive
    USE ENTITY work.uz_dac_src_Detect_Rise_Positive(rtl);

  FOR ALL : uz_dac_src_Subsystem
    USE ENTITY work.uz_dac_src_Subsystem(rtl);

  FOR ALL : uz_dac_src_Subsystem1
    USE ENTITY work.uz_dac_src_Subsystem1(rtl);

  FOR ALL : uz_dac_src_Subsystem2
    USE ENTITY work.uz_dac_src_Subsystem2(rtl);

  FOR ALL : uz_dac_src_Subsystem3
    USE ENTITY work.uz_dac_src_Subsystem3(rtl);

  FOR ALL : uz_dac_src_Subsystem4
    USE ENTITY work.uz_dac_src_Subsystem4(rtl);

  FOR ALL : uz_dac_src_Subsystem5
    USE ENTITY work.uz_dac_src_Subsystem5(rtl);

  FOR ALL : uz_dac_src_Subsystem6
    USE ENTITY work.uz_dac_src_Subsystem6(rtl);

  FOR ALL : uz_dac_src_Subsystem7
    USE ENTITY work.uz_dac_src_Subsystem7(rtl);
...
BEGIN
  u_HDL_DUT_tc : uz_dac_src_HDL_DUT_tc
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_Detect_Rise_Positive : uz_dac_src_Detect_Rise_Positive
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_32_0 => enb_1_32_0,
