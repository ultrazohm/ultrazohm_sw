...
module uz_NN_3_64_acc_uz_NN_3_64_acc_Pipeline_burst_Action (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] icmp_ln356_reg_150;
reg   [31:0] Actions_load_reg_164;
reg    ap_condition_exit_pp0_iter1_stage0;
wire   [31:0] zext_ln359_fu_119_p1;
wire    ap_block_pp0_stage0_01001;
reg   [31:0] i_fu_54;
wire   [31:0] add_ln356_fu_109_p2;
wire    ap_loop_init;
reg   [31:0] ap_sig_allocacmp_i_7;
wire   [3:0] trunc_ln359_fu_115_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln356_fu_103_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln356_reg_150 == 1'd0))) begin
...
always @ (*) begin
    if (((icmp_ln356_fu_103_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln356_reg_150 == 1'd1))) begin
...
assign Actions_address0 = zext_ln359_fu_119_p1;

assign add_ln356_fu_109_p2 = (ap_sig_allocacmp_i_7 + 32'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((m_axi_arrays_WREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((m_axi_arrays_WREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1));
end
...
assign icmp_ln356_fu_103_p2 = ((ap_sig_allocacmp_i_7 == Action_size_input) ? 1'b1 : 1'b0);
...
assign m_axi_arrays_WSTRB = 4'd15;

assign m_axi_arrays_WUSER = 1'd0;

assign trunc_ln359_fu_115_p1 = ap_sig_allocacmp_i_7[3:0];

assign zext_ln359_fu_119_p1 = trunc_ln359_fu_115_p1;

endmodule //uz_NN_3_64_acc_uz_NN_3_64_acc_Pipeline_burst_Action
