-- -------------------------------------------------------------
-- 
-- File Name: uz_axi_testIP/hdlsrc/uz_axi_testIP/uz_axi_testIP_src_uz_axi_testIP.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_axi_testIP_src_uz_axi_testIP
...
USE work.uz_axi_testIP_src_uz_axi_testIP_pkg.ALL;

ENTITY uz_axi_testIP_src_uz_axi_testIP IS
...
END uz_axi_testIP_src_uz_axi_testIP;


ARCHITECTURE rtl OF uz_axi_testIP_src_uz_axi_testIP IS

  -- Component Declarations
  COMPONENT uz_axi_testIP_src_nfp_mul_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT uz_axi_testIP_src_nfp_add_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          nfp_in1                         :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  FOR ALL : uz_axi_testIP_src_nfp_mul_single
    USE ENTITY work.uz_axi_testIP_src_nfp_mul_single(rtl);

  FOR ALL : uz_axi_testIP_src_nfp_add_single
    USE ENTITY work.uz_axi_testIP_src_nfp_add_single(rtl);
...
BEGIN
  u_nfp_mul_comp : uz_axi_testIP_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_nfp_mul_comp_1 : uz_axi_testIP_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_nfp_add_comp : uz_axi_testIP_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_nfp_mul_comp_2 : uz_axi_testIP_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_nfp_mul_comp_3 : uz_axi_testIP_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_nfp_add_comp_1 : uz_axi_testIP_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_nfp_mul_comp_4 : uz_axi_testIP_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in1 => Reshape_out1t(1, 0),  -- single
  ...
  u_nfp_mul_comp_5 : uz_axi_testIP_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in1 => Reshape_out1t(0, 0),  -- single
  ...
  u_nfp_add_comp_2 : uz_axi_testIP_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_nfp_mul_comp_6 : uz_axi_testIP_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in1 => Reshape_out1t(1, 1),  -- single
  ...
  u_nfp_mul_comp_7 : uz_axi_testIP_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in1 => Reshape_out1t(0, 1),  -- single
  ...
  u_nfp_add_comp_3 : uz_axi_testIP_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
