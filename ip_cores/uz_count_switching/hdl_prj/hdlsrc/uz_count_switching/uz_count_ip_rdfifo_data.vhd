-- -------------------------------------------------------------
-- 
-- File Name: C:\utrazohm_sw_2\ultrazohm_sw\ip_cores\uz_count_switching\hdl_prj\hdlsrc\uz_count_switching\uz_count_ip_rdfifo_data.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_count_ip_rdfifo_data
-- Source Path: uz_count_ip/uz_count_ip_axi4/uz_count_ip_axi4_module/uz_count_ip_rdfifo_data
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_count_ip_rdfifo_data IS
...
END uz_count_ip_rdfifo_data;


ARCHITECTURE rtl OF uz_count_ip_rdfifo_data IS

  -- Component Declarations
  COMPONENT uz_count_ip_SimpleDualPortRAM_generic
  ...
  FOR ALL : uz_count_ip_SimpleDualPortRAM_generic
    USE ENTITY work.uz_count_ip_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_uz_count_ip_rdfifo_data_classic_ram_generic : uz_count_ip_SimpleDualPortRAM_generic
