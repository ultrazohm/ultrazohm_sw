-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/dac_spi/uz_dac_addr_decoder.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_dac_addr_decoder
-- Source Path: uz_dac/uz_dac_axi4/uz_dac_addr_decoder
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END uz_dac_addr_decoder;


ARCHITECTURE rtl OF uz_dac_addr_decoder IS
...
BEGIN
  ...
  decode_sel_dac_data_1_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0040#, 14) ELSE
      '0';
  ...
  decode_sel_trigger_write_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0041#, 14) ELSE
      '0';
