-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj7/hdlsrc/uz_pmsm_model_9ph_21b_all_double/uz_pmsm_model_9ph3_src_Transformation1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_9ph3_src_Transformation1
-- Source Path: uz_pmsm_model_9ph_21b_all_double/uz_pmsm_model_9ph/Transformation1
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_pmsm_model_9ph3_src_Transformation1 IS
...
END uz_pmsm_model_9ph3_src_Transformation1;


ARCHITECTURE rtl OF uz_pmsm_model_9ph3_src_Transformation1 IS
  ...
  COMPONENT uz_pmsm_model_9ph3_src_Transformation1_MAC_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_20_0                      :   IN    std_logic;
  ...
  COMPONENT uz_pmsm_model_9ph3_src_Transformation1_MAC_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_20_0                      :   IN    std_logic;
          in0                             :   IN    vector_of_std_logic_vector18(0 TO 8);  -- sfix18_En16 [9]
  ...
  COMPONENT uz_pmsm_model_9ph3_src_Transformation1_MAC_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_20_0                      :   IN    std_logic;
          in0                             :   IN    vector_of_std_logic_vector18(0 TO 8);  -- sfix18_En16 [9]
  ...
  COMPONENT uz_pmsm_model_9ph3_src_Transformation1_MAC
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_20_0                      :   IN    std_logic;
          in0                             :   IN    vector_of_std_logic_vector18(0 TO 8);  -- sfix18_En16 [9]
  ...
  COMPONENT uz_pmsm_model_9ph3_src_Transformation1_MAC_block6
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_20_0                      :   IN    std_logic;
          in0                             :   IN    vector_of_std_logic_vector18(0 TO 8);  -- sfix18_En16 [9]
  ...
  COMPONENT uz_pmsm_model_9ph3_src_Transformation1_MAC_block4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_20_0                      :   IN    std_logic;
          in0                             :   IN    vector_of_std_logic_vector18(0 TO 8);  -- sfix18_En16 [9]
  ...
  COMPONENT uz_pmsm_model_9ph3_src_Transformation1_MAC_block7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_20_0                      :   IN    std_logic;
          in0                             :   IN    vector_of_std_logic_vector18(0 TO 8);  -- sfix18_En16 [9]
  ...
  COMPONENT uz_pmsm_model_9ph3_src_Transformation1_MAC_block5
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_20_0                      :   IN    std_logic;
          in0                             :   IN    vector_of_std_logic_vector18(0 TO 8);  -- sfix18_En16 [9]
  ...
  COMPONENT uz_pmsm_model_9ph3_src_Transformation1_MAC_block3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_20_0                      :   IN    std_logic;
          in0                             :   IN    vector_of_std_logic_vector18(0 TO 8);  -- sfix18_En16 [9]
  ...
  FOR ALL : uz_pmsm_model_9ph3_src_Transformation1_MAC_block1
    USE ENTITY work.uz_pmsm_model_9ph3_src_Transformation1_MAC_block1(rtl);

  FOR ALL : uz_pmsm_model_9ph3_src_Transformation1_MAC_block
    USE ENTITY work.uz_pmsm_model_9ph3_src_Transformation1_MAC_block(rtl);

  FOR ALL : uz_pmsm_model_9ph3_src_Transformation1_MAC_block2
    USE ENTITY work.uz_pmsm_model_9ph3_src_Transformation1_MAC_block2(rtl);

  FOR ALL : uz_pmsm_model_9ph3_src_Transformation1_MAC
    USE ENTITY work.uz_pmsm_model_9ph3_src_Transformation1_MAC(rtl);

  FOR ALL : uz_pmsm_model_9ph3_src_Transformation1_MAC_block6
    USE ENTITY work.uz_pmsm_model_9ph3_src_Transformation1_MAC_block6(rtl);

  FOR ALL : uz_pmsm_model_9ph3_src_Transformation1_MAC_block4
    USE ENTITY work.uz_pmsm_model_9ph3_src_Transformation1_MAC_block4(rtl);

  FOR ALL : uz_pmsm_model_9ph3_src_Transformation1_MAC_block7
    USE ENTITY work.uz_pmsm_model_9ph3_src_Transformation1_MAC_block7(rtl);

  FOR ALL : uz_pmsm_model_9ph3_src_Transformation1_MAC_block5
    USE ENTITY work.uz_pmsm_model_9ph3_src_Transformation1_MAC_block5(rtl);

  FOR ALL : uz_pmsm_model_9ph3_src_Transformation1_MAC_block3
    USE ENTITY work.uz_pmsm_model_9ph3_src_Transformation1_MAC_block3(rtl);
  ...
  SIGNAL enb_counter_ge_150_1             : std_logic;
  SIGNAL enb_counter_le_158_1             : std_logic;
  SIGNAL uz_pmsm_model_9ph_21b_all_double_uz_pmsm_model_9ph_Transformation1_enb_phase_150_8 : std_logic;
...
BEGIN
  ...
  u_uz_pmsm_model_9ph_21b_all_double_uz_pmsm_model_9ph_nfp_convert_single_to_sfix_25_En12_1 : uz_pmsm_model_9ph3_src_nfp_convert_single_to_sfix_25_En12
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_20_0 => enb_1_20_0,
  ...
  u_uz_pmsm_model_9ph_21b_all_double_uz_pmsm_model_9ph_nfp_convert_single_to_sfix_25_En12_2 : uz_pmsm_model_9ph3_src_nfp_convert_single_to_sfix_25_En12
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_20_0 => enb_1_20_0,
              nfp_in => in_rsvd(2),  -- single
              nfp_out => Data_Type_Conversion28_out1(2)  -- sfix25_En12
              );

  u_uz_pmsm_model_9ph_21b_all_double_uz_pmsm_model_9ph_nfp_convert_single_to_sfix_25_En12_3 : uz_pmsm_model_9ph3_src_nfp_convert_single_to_sfix_25_En12
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_20_0 => enb_1_20_0,
              nfp_in => in_rsvd(3),  -- single
              nfp_out => Data_Type_Conversion28_out1(3)  -- sfix25_En12
              );

  u_uz_pmsm_model_9ph_21b_all_double_uz_pmsm_model_9ph_nfp_convert_single_to_sfix_25_En12_4 : uz_pmsm_model_9ph3_src_nfp_convert_single_to_sfix_25_En12
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_20_0 => enb_1_20_0,
              nfp_in => in_rsvd(4),  -- single
              nfp_out => Data_Type_Conversion28_out1(4)  -- sfix25_En12
              );

  u_uz_pmsm_model_9ph_21b_all_double_uz_pmsm_model_9ph_nfp_convert_single_to_sfix_25_En12_5 : uz_pmsm_model_9ph3_src_nfp_convert_single_to_sfix_25_En12
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_20_0 => enb_1_20_0,
              nfp_in => in_rsvd(5),  -- single
              nfp_out => Data_Type_Conversion28_out1(5)  -- sfix25_En12
              );

  u_uz_pmsm_model_9ph_21b_all_double_uz_pmsm_model_9ph_nfp_convert_single_to_sfix_25_En12_6 : uz_pmsm_model_9ph3_src_nfp_convert_single_to_sfix_25_En12
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_20_0 => enb_1_20_0,
              nfp_in => in_rsvd(6),  -- single
              nfp_out => Data_Type_Conversion28_out1(6)  -- sfix25_En12
              );

  u_uz_pmsm_model_9ph_21b_all_double_uz_pmsm_model_9ph_nfp_convert_single_to_sfix_25_En12_7 : uz_pmsm_model_9ph3_src_nfp_convert_single_to_sfix_25_En12
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_20_0 => enb_1_20_0,
              nfp_in => in_rsvd(7),  -- single
              nfp_out => Data_Type_Conversion28_out1(7)  -- sfix25_En12
              );

  u_uz_pmsm_model_9ph_21b_all_double_uz_pmsm_model_9ph_nfp_convert_single_to_sfix_25_En12_8 : uz_pmsm_model_9ph3_src_nfp_convert_single_to_sfix_25_En12
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_20_0 => enb_1_20_0,
              nfp_in => in_rsvd(8),  -- single
              nfp_out => Data_Type_Conversion28_out1(8)  -- sfix25_En12
              );

  u_Transformation1_MAC2 : uz_pmsm_model_9ph3_src_Transformation1_MAC_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_20_0 => enb_1_20_0,
              in0 => Constant1_out1t_0_1,  -- sfix18_En16 [9]
              in1 => Data_Type_Conversion28_out1,  -- sfix25_En12 [9]
              globalSchedule => uz_pmsm_model_9ph_21b_all_double_uz_pmsm_model_9ph_Transformation1_enb_phase_150_8,
              out0 => colTemp_0(0)  -- sfix25_En12
              );

  u_Transformation1_MAC1 : uz_pmsm_model_9ph3_src_Transformation1_MAC_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_20_0 => enb_1_20_0,
  ...
  u_Transformation1_MAC3 : uz_pmsm_model_9ph3_src_Transformation1_MAC_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_20_0 => enb_1_20_0,
  ...
  u_Transformation1_MAC : uz_pmsm_model_9ph3_src_Transformation1_MAC
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_20_0 => enb_1_20_0,
  ...
  u_Transformation1_MAC7 : uz_pmsm_model_9ph3_src_Transformation1_MAC_block6
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_20_0 => enb_1_20_0,
  ...
  u_Transformation1_MAC5 : uz_pmsm_model_9ph3_src_Transformation1_MAC_block4
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_20_0 => enb_1_20_0,
  ...
  u_Transformation1_MAC8 : uz_pmsm_model_9ph3_src_Transformation1_MAC_block7
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_20_0 => enb_1_20_0,
  ...
  u_Transformation1_MAC6 : uz_pmsm_model_9ph3_src_Transformation1_MAC_block5
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_20_0 => enb_1_20_0,
  ...
  u_Transformation1_MAC4 : uz_pmsm_model_9ph3_src_Transformation1_MAC_block3
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_20_0 => enb_1_20_0,
  ...
  enb_counter_ge_150_1 <= '1' WHEN enb_counter_unsigned >= to_unsigned(16#96#, 8) ELSE
      '0';

  
  enb_counter_le_158_1 <= '1' WHEN enb_counter_unsigned <= to_unsigned(16#9E#, 8) ELSE
      '0';

  uz_pmsm_model_9ph_21b_all_double_uz_pmsm_model_9ph_Transformation1_enb_phase_150_8 <= enb_counter_ge_150_1 AND enb_counter_le_158_1;
