...
char folder_path[] = "test/uz/uz_dqn/10_other_seeds_wrong/";
...
struct experiment_config get_exp_config(enum uz_prng_generator init_generator, enum uz_prng_generator exploration_generator, enum uz_prng_generator training_generator, enum uz_prng_generator env_generator)
{
    ...
    {
    case uz_prng_generator_halton:
        exp.training_config.random_seed = halton_seed_1[0];
        exp.training_config.uz_prng_type = uz_prng_generator_halton;
        exp.training_seeds = halton_seed_1;
        break;
    case uz_prng_generator_mtwister:
        exp.training_config.random_seed = mtwister_seed_1[0];
        exp.training_config.uz_prng_type = uz_prng_generator_mtwister;
        exp.training_seeds = mtwister_seed_1;
        break;
    case uz_prng_generator_squares:
        exp.training_config.random_seed = squares_seed_1[0];
        exp.training_config.uz_prng_type = uz_prng_generator_squares;
        exp.training_seeds = squares_seed_1;
        break;
    case uz_prng_generator_pcg:
        exp.training_config.random_seed = pcg_seed_1[0];
        exp.training_config.uz_prng_type = uz_prng_generator_pcg;
        exp.training_seeds = pcg_seed_1;
        break;
    case uz_prng_generator_xoshiro:
        exp.training_config.random_seed = xoshiro_seed_1[0];
        exp.training_config.uz_prng_type = uz_prng_generator_xoshiro;
        exp.training_seeds = xoshiro_seed_1;
        break;
    default:
        break;
    }
    ...
    {
    case uz_prng_generator_halton:
        exp.exploration_config.random_seed = halton_seed_1[0];
        exp.exploration_config.uz_prng_type = uz_prng_generator_halton;
        exp.exploration_seeds = halton_seed_1;
        break;
    case uz_prng_generator_mtwister:
        exp.exploration_config.random_seed = mtwister_seed_1[0];
        exp.exploration_config.uz_prng_type = uz_prng_generator_mtwister;
        exp.exploration_seeds = mtwister_seed_1;
        break;
    case uz_prng_generator_squares:
        exp.exploration_config.random_seed = squares_seed_1[0];
        exp.exploration_config.uz_prng_type = uz_prng_generator_squares;
        exp.exploration_seeds = squares_seed_1;
        break;
    case uz_prng_generator_pcg:
        exp.exploration_config.random_seed = pcg_seed_1[0];
        exp.exploration_config.uz_prng_type = uz_prng_generator_pcg;
        exp.exploration_seeds = pcg_seed_1;
        break;
    case uz_prng_generator_xoshiro:
        exp.exploration_config.random_seed = xoshiro_seed_1[0];
        exp.exploration_config.uz_prng_type = uz_prng_generator_xoshiro;
        exp.exploration_seeds = xoshiro_seed_1;
        break;
    default:
        break;
    }
