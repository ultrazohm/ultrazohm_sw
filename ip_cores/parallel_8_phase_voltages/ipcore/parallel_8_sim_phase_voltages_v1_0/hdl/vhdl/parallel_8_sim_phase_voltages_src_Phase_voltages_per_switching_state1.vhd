...
ARCHITECTURE rtl OF parallel_8_sim_phase_voltages_src_Phase_voltages_per_switching_state1 IS
  ...
  SIGNAL Switch_on3_out1_1                : signed(31 DOWNTO 0);  -- int32
  ...
  SIGNAL delayMatch2_reg                  : vector_of_signed32(0 TO 20);  -- sfix32 [21]
  SIGNAL delayMatch2_reg_next             : vector_of_signed32(0 TO 20);  -- sfix32 [21]
  SIGNAL Delay49_out1                     : signed(31 DOWNTO 0);  -- int32
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Switch_on3_out1_1 <= to_signed(0, 32);
      ELSIF enb = '1' THEN
  ...
  Switch_on3_out1 <= Switch_on3_out1_1 WHEN switch_compare_1_1 = '0' ELSE
      Delay9_out1;
  ...
  Gain1_mul_temp <= to_signed(16#028BE6#, 24) * End_Cycle_4;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        delayMatch2_reg(0) <= to_signed(0, 32);
        delayMatch2_reg(1) <= to_signed(0, 32);
        delayMatch2_reg(2) <= to_signed(0, 32);
        delayMatch2_reg(3) <= to_signed(0, 32);
        delayMatch2_reg(4) <= to_signed(0, 32);
        delayMatch2_reg(5) <= to_signed(0, 32);
        delayMatch2_reg(6) <= to_signed(0, 32);
        delayMatch2_reg(7) <= to_signed(0, 32);
        delayMatch2_reg(8) <= to_signed(0, 32);
        delayMatch2_reg(9) <= to_signed(0, 32);
        delayMatch2_reg(10) <= to_signed(0, 32);
        delayMatch2_reg(11) <= to_signed(0, 32);
        delayMatch2_reg(12) <= to_signed(0, 32);
        delayMatch2_reg(13) <= to_signed(0, 32);
        delayMatch2_reg(14) <= to_signed(0, 32);
        delayMatch2_reg(15) <= to_signed(0, 32);
        delayMatch2_reg(16) <= to_signed(0, 32);
        delayMatch2_reg(17) <= to_signed(0, 32);
        delayMatch2_reg(18) <= to_signed(0, 32);
        delayMatch2_reg(19) <= to_signed(0, 32);
        delayMatch2_reg(20) <= to_signed(0, 32);
      ELSIF enb = '1' THEN
  ...
  Delay49_out1 <= delayMatch2_reg(20);
  delayMatch2_reg_next(0) <= Switch_on3_out1_1;
  ...
  Index_in_AXI <= std_logic_vector(Delay49_out1);
