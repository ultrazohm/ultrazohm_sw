...
%% Setting variables
n_Ts=[0.01 0.007 0.02]; % 100,200,500 Hz
Tf=10; % simtime
numep=900; % Number of episodes to train
numag=300; % Number of agents to train parallel
minbuf=1e4; % Minimum buffer size
maxbuf=1e6; % Maximum buffer size
minlearn=1e-4;% Minimum learnrate
maxlearn=1e-3;% Maximum learnrater
mindis=0.95;% Minimum discount factor
