-- -------------------------------------------------------------
-- 
-- File Name: /home/hufnagelde/ultrazohm_sw/ip_cores/uz_pmsm_model_6ph_dq/hdl_prj/hdlsrc/uz_pmsm_model_6ph_dq/uz_pmsm_model_6ph_dq.vhd
...
ENTITY uz_pmsm_model_6ph_dq IS
  PORT( IPCORE_CLK                        :   IN    std_logic;  -- ufix1
        ...
        voltage_input_dq                  :   IN    std_logic_vector(161 DOWNTO 0);  -- ufix162
        ...
        currents_dq_out                   :   OUT   std_logic_vector(161 DOWNTO 0);  -- ufix162
...
ARCHITECTURE rtl OF uz_pmsm_model_6ph_dq IS
  ...
  SIGNAL voltage_input_dq_unsigned        : unsigned(161 DOWNTO 0);  -- ufix162
  SIGNAL voltage_input_dq_slice           : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL voltage_input_dq_0_sig           : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL voltage_input_dq_unsigned_1      : unsigned(161 DOWNTO 0);  -- ufix162
  SIGNAL voltage_input_dq_slice_1         : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL voltage_input_dq_1_sig           : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL voltage_input_dq_unsigned_2      : unsigned(161 DOWNTO 0);  -- ufix162
  SIGNAL voltage_input_dq_slice_2         : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL voltage_input_dq_2_sig           : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL voltage_input_dq_unsigned_3      : unsigned(161 DOWNTO 0);  -- ufix162
  SIGNAL voltage_input_dq_slice_3         : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL voltage_input_dq_3_sig           : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL voltage_input_dq_unsigned_4      : unsigned(161 DOWNTO 0);  -- ufix162
  SIGNAL voltage_input_dq_slice_4         : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL voltage_input_dq_4_sig           : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL voltage_input_dq_unsigned_5      : unsigned(161 DOWNTO 0);  -- ufix162
  SIGNAL voltage_input_dq_slice_5         : unsigned(26 DOWNTO 0);  -- ufix27
  ...
  SIGNAL currents_dq_out_tmp              : unsigned(161 DOWNTO 0);  -- ufix162
...
BEGIN
  ...
  ip_timestamp <= unsigned'(X"8983E233");

  reset_cm <=  NOT IPCORE_RESETN;

  voltage_input_dq_unsigned <= unsigned(voltage_input_dq);

  voltage_input_dq_slice <= voltage_input_dq_unsigned(26 DOWNTO 0);

  voltage_input_dq_0_sig <= signed(voltage_input_dq_slice);

  voltage_input_dq_unsigned_1 <= unsigned(voltage_input_dq);

  voltage_input_dq_slice_1 <= voltage_input_dq_unsigned_1(53 DOWNTO 27);

  voltage_input_dq_1_sig <= signed(voltage_input_dq_slice_1);

  voltage_input_dq_unsigned_2 <= unsigned(voltage_input_dq);

  voltage_input_dq_slice_2 <= voltage_input_dq_unsigned_2(80 DOWNTO 54);

  voltage_input_dq_2_sig <= signed(voltage_input_dq_slice_2);

  voltage_input_dq_unsigned_3 <= unsigned(voltage_input_dq);

  voltage_input_dq_slice_3 <= voltage_input_dq_unsigned_3(107 DOWNTO 81);

  voltage_input_dq_3_sig <= signed(voltage_input_dq_slice_3);

  voltage_input_dq_unsigned_4 <= unsigned(voltage_input_dq);

  voltage_input_dq_slice_4 <= voltage_input_dq_unsigned_4(134 DOWNTO 108);

  voltage_input_dq_4_sig <= signed(voltage_input_dq_slice_4);

  voltage_input_dq_unsigned_5 <= unsigned(voltage_input_dq);

  voltage_input_dq_slice_5 <= voltage_input_dq_unsigned_5(161 DOWNTO 135);

  voltage_input_dq_5_sig <= signed(voltage_input_dq_slice_5);
  ...
  currents_dq_out_tmp <= unsigned(currents_dq_out_5_sig_signed) & unsigned(currents_dq_out_4_sig_signed) & unsigned(currents_dq_out_3_sig_signed) & unsigned(currents_dq_out_2_sig_signed) & unsigned(currents_dq_out_1_sig_signed) & unsigned(currents_dq_out_0_sig_signed);

  currents_dq_out <= std_logic_vector(currents_dq_out_tmp);
