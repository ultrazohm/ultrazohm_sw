-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\external_state_machine\uz_6_ph_voltages_ip_src_pu_voltages_vsd.vhd
-- Created: 2023-06-15 08:45:54
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: uz_6_ph_voltages_ip_src_pu_voltages_vsd
...
USE work.uz_6_ph_voltages_ip_src_pu_voltages_vsd_pkg.ALL;

ENTITY uz_6_ph_voltages_ip_src_pu_voltages_vsd IS
...
END uz_6_ph_voltages_ip_src_pu_voltages_vsd;


ARCHITECTURE rtl OF uz_6_ph_voltages_ip_src_pu_voltages_vsd IS

  -- Component Declarations
  COMPONENT uz_6_ph_voltages_ip_src_Detect_Rise_Positive
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  COMPONENT uz_6_ph_voltages_ip_src_Detect_Rise_Positive1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  COMPONENT uz_6_ph_voltages_ip_src_finite_control_set
  ...
  FOR ALL : uz_6_ph_voltages_ip_src_Detect_Rise_Positive
    USE ENTITY work.uz_6_ph_voltages_ip_src_Detect_Rise_Positive(rtl);

  FOR ALL : uz_6_ph_voltages_ip_src_Detect_Rise_Positive1
    USE ENTITY work.uz_6_ph_voltages_ip_src_Detect_Rise_Positive1(rtl);

  FOR ALL : uz_6_ph_voltages_ip_src_finite_control_set
    USE ENTITY work.uz_6_ph_voltages_ip_src_finite_control_set(rtl);
...
BEGIN
  ...
  u_Detect_Rise_Positive : uz_6_ph_voltages_ip_src_Detect_Rise_Positive
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              U => Delay_out1,
  ...
  u_Detect_Rise_Positive1 : uz_6_ph_voltages_ip_src_Detect_Rise_Positive1
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              U => Delay21_out1,
  ...
  u_finite_control_set : uz_6_ph_voltages_ip_src_finite_control_set
