...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.uz_SPWM_3ph.autotvin_u_a.dat"
         "c.uz_SPWM_3ph.autotvin_u_b.dat"
         "c.uz_SPWM_3ph.autotvin_u_c.dat"
         "c.uz_SPWM_3ph.autotvin_u_dc.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.uz_SPWM_3ph.autotvout_DC_a.dat"
         "rtl.uz_SPWM_3ph.autotvout_DC_b.dat"
         "rtl.uz_SPWM_3ph.autotvout_DC_c.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
