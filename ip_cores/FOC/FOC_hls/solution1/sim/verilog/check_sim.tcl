...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.uz_FOC_sample.autotvin_i_reference_Ampere.dat"
         "c.uz_FOC_sample.autotvin_i_actual_Ampere.dat"
         "c.uz_FOC_sample.autotvin_V_dc_volts.dat"
         "c.uz_FOC_sample.autotvin_omega_el_rad_per_sec.dat"
         "c.uz_FOC_sample.autotvin_u_output_Volts.dat"
         "c.uz_FOC_sample.autotvout_Dout.dat"
         "c.uz_FOC_sample.autotvout_self.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.uz_FOC_sample.autotvout_Dout.dat"
         "rtl.uz_FOC_sample.autotvout_self.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
