...
attribute shreg_extract : string;
    ...
    signal p_accumulator_offset_read_reg_138 : STD_LOGIC_VECTOR (8 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal l_parBlocks_reg_143 : STD_LOGIC_VECTOR (31 downto 0);
    signal p_initZero_read_reg_148 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln410_fu_107_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln410_reg_156 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal p_accumulator_addr_reg_161 : STD_LOGIC_VECTOR (8 downto 0);
    signal icmp_ln410_fu_102_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal trunc_ln410_fu_113_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal sum_i_fu_117_p2 : STD_LOGIC_VECTOR (8 downto 0);
...
begin
    fadd_32ns_32ns_32_5_full_dsp_1_U64 : component BGD_fadd_32ns_32ns_32_5_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                add_ln410_reg_156 <= add_ln410_fu_107_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln410_fu_102_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                p_accumulator_addr_reg_161 <= sum_cast_i_fu_122_p1(9 - 1 downto 0);
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, p_values_empty_n, p_accumulator_offset_empty_n, p_size_empty_n, p_initZero_empty_n, ap_CS_fsm_state3, ap_CS_fsm_state2, icmp_ln410_fu_102_p2)
    begin
        case ap_CS_fsm is
    ...
    add_ln410_fu_107_p2 <= std_logic_vector(unsigned(i_reg_87) + unsigned(ap_const_lv32_1));
    ...
    icmp_ln410_fu_102_p2 <= "1" when (i_reg_87 = l_parBlocks_reg_143) else "0";
    ...
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state9)) then 
            ...
            p_accumulator_address0 <= sum_cast_i_fu_122_p1(9 - 1 downto 0);
        else 
    ...
    sum_i_fu_117_p2 <= std_logic_vector(unsigned(p_accumulator_offset_read_reg_138) + unsigned(trunc_ln410_fu_113_p1));
    trunc_ln410_fu_113_p1 <= i_reg_87(9 - 1 downto 0);
end behav;
