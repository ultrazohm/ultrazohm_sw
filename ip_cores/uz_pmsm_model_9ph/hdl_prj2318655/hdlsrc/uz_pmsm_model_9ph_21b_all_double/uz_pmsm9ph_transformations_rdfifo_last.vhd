-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj2318655/hdlsrc/uz_pmsm_model_9ph_21b_all_double/uz_pmsm9ph_transformations_rdfifo_last.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm9ph_transformations_rdfifo_last
-- Source Path: uz_pmsm9ph_transformations/uz_pmsm9ph_transformations_axi4/uz_pmsm9ph_transformations_axi4_module/uz_pmsm9ph_transformations_rdfifo_last
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_pmsm9ph_transformations_rdfifo_last IS
...
END uz_pmsm9ph_transformations_rdfifo_last;


ARCHITECTURE rtl OF uz_pmsm9ph_transformations_rdfifo_last IS

  -- Component Declarations
  COMPONENT uz_pmsm9ph_transformations_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : uz_pmsm9ph_transformations_SimpleDualPortRAM_singlebit
    USE ENTITY work.uz_pmsm9ph_transformations_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_uz_pmsm9ph_transformations_rdfifo_last_classic_ram_singlebit : uz_pmsm9ph_transformations_SimpleDualPortRAM_singlebit
