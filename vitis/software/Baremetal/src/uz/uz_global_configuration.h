...
#define UZ_INCREMENTALENCODER_MAX_INSTANCES             2U
...
#define UZ_SYSMON_PS_MAX_INSTANCES                      1U // Can only be 1 or 0!
#define UZ_RESOLVER_PL_INTERFACE_MAX_INSTANCES          3U
#define UZ_AXI_GPIO_MAX_INSTANCES                       5U
...
#define UZ_PARAMETERID_RC_MAX_INSTANCES 				2U
#define UZ_PARAMETERID_RS_MAX_INSTANCES                 2U
#endif
