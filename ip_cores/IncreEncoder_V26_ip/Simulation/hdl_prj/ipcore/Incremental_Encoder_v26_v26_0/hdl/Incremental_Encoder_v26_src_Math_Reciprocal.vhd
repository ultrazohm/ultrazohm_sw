-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\inc_enc_v26\Incremental_Encoder_v26_src_Math_Reciprocal.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Incremental_Encoder_v26_src_Math_Reciprocal
-- Source Path: inc_enc_v26/IncEnc_V25/speed/calc_omega/invt_mult/Math Reciprocal
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Incremental_Encoder_v26_src_Math_Reciprocal IS
...
END Incremental_Encoder_v26_src_Math_Reciprocal;


ARCHITECTURE rtl OF Incremental_Encoder_v26_src_Math_Reciprocal IS

  -- Component Declarations
  COMPONENT Incremental_Encoder_v26_src_Math_Reciprocal_core
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_5987_0                    :   IN    std_logic;
  ...
  FOR ALL : Incremental_Encoder_v26_src_Math_Reciprocal_core
    USE ENTITY work.Incremental_Encoder_v26_src_Math_Reciprocal_core(rtl);
...
BEGIN
  ...
  u_core_stage1_inst : Incremental_Encoder_v26_src_Math_Reciprocal_core
    PORT MAP( clk => clk,
              reset_x => reset_x,
  ...
  u_core_stage2_inst : Incremental_Encoder_v26_src_Math_Reciprocal_core
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_5987_0 => enb_1_5987_0,
  ...
  u_core_stage3_inst : Incremental_Encoder_v26_src_Math_Reciprocal_core
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_5987_0 => enb_1_5987_0,
