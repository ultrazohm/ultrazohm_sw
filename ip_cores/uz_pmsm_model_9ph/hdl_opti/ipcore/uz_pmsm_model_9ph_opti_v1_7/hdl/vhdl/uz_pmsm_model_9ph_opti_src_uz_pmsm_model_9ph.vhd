...
ARCHITECTURE rtl OF uz_pmsm_model_9ph_opti_src_uz_pmsm_model_9ph IS
  ...
  SIGNAL Data_Type_Conversion32_out1_1    : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL delayMatch29_reg                 : vector_of_std_logic_vector32(0 TO 26);  -- ufix32 [27]
  SIGNAL delayMatch29_reg_next            : vector_of_std_logic_vector32(0 TO 26);  -- ufix32 [27]
  SIGNAL torque                           : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL delayMatch30_reg                 : vector_of_std_logic_vector32(0 TO 65);  -- ufix32 [66]
  SIGNAL delayMatch30_reg_next            : vector_of_std_logic_vector32(0 TO 65);  -- ufix32 [66]
  ...
  SIGNAL delayMatch25_reg                 : vector_of_std_logic_vector32(0 TO 46);  -- ufix32 [47]
  SIGNAL delayMatch25_reg_next            : vector_of_std_logic_vector32(0 TO 46);  -- ufix32 [47]
  SIGNAL From5_out1                       : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL delayMatch31_reg                 : std_logic_vector(0 TO 68);  -- ufix1 [69]
  SIGNAL delayMatch31_reg_next            : std_logic_vector(0 TO 68);  -- ufix1 [69]
  ...
  SIGNAL delayMatch32_reg                 : vector_of_std_logic_vector32(0 TO 68);  -- ufix32 [69]
  SIGNAL delayMatch32_reg_next            : vector_of_std_logic_vector32(0 TO 68);  -- ufix32 [69]
  ...
  SIGNAL delayMatch34_out_1               : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL delayMatch34_1_reg               : vector_of_signed25(0 TO 1);  -- sfix25 [2]
  SIGNAL delayMatch34_out_2               : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL delayMatch34_out_3               : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL delayMatch34_1_reg_1             : vector_of_signed25(0 TO 1);  -- sfix25 [2]
  SIGNAL delayMatch34_1_reg_2             : vector_of_signed25(0 TO 1);  -- sfix25 [2]
  SIGNAL delayMatch34_1_reg_next          : vector_of_signed25(0 TO 1);  -- sfix25_En12 [2]
  SIGNAL delayMatch34_1_reg_next_1        : vector_of_signed25(0 TO 1);  -- sfix25_En12 [2]
  SIGNAL delayMatch34_1_reg_next_2        : vector_of_signed25(0 TO 1);  -- sfix25_En12 [2]
  ...
  SIGNAL delayMatch37_reg                 : vector_of_signed25(0 TO 1);  -- sfix25 [2]
  SIGNAL delayMatch37_reg_next            : vector_of_signed25(0 TO 1);  -- sfix25_En12 [2]
...
BEGIN
  ...
  u_uz_pmsm_model_9ph_uz_pmsm_model_9ph_nfp_convert_double2single_1 : uz_pmsm_model_9ph_opti_src_nfp_convert_double2single
    PORT MAP( clk => clk,
              ...
              enb => enb,
              nfp_in => I_d,  -- double
              nfp_out => Data_Type_Conversion32_out1_1  -- single
              );
  ...
  u_nfp_sub_comp : uz_pmsm_model_9ph_opti_src_nfp_sub_double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Data_Type_Conversion22_out1_1,  -- double
  ...
  i_d_1 <= Data_Type_Conversion32_out1_1;
  ...
  delayMatch16_reg_next(0) <= Delay1_out1_4;
  ...
  delayMatch17_reg_next(0) <= Delay1_out1_5;
  ...
  torque <= delayMatch29_reg(26);
  delayMatch29_reg_next(0) <= M_Mi_6;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        ...
        delayMatch30_reg(45) <= X"00000000";
        delayMatch30_reg(46) <= X"00000000";
        delayMatch30_reg(47) <= X"00000000";
        delayMatch30_reg(48) <= X"00000000";
        delayMatch30_reg(49) <= X"00000000";
        delayMatch30_reg(50) <= X"00000000";
        delayMatch30_reg(51) <= X"00000000";
        delayMatch30_reg(52) <= X"00000000";
        delayMatch30_reg(53) <= X"00000000";
        delayMatch30_reg(54) <= X"00000000";
        delayMatch30_reg(55) <= X"00000000";
        delayMatch30_reg(56) <= X"00000000";
        delayMatch30_reg(57) <= X"00000000";
        delayMatch30_reg(58) <= X"00000000";
        delayMatch30_reg(59) <= X"00000000";
        delayMatch30_reg(60) <= X"00000000";
        delayMatch30_reg(61) <= X"00000000";
        delayMatch30_reg(62) <= X"00000000";
        delayMatch30_reg(63) <= X"00000000";
        delayMatch30_reg(64) <= X"00000000";
        delayMatch30_reg(65) <= X"00000000";
      ELSIF enb = '1' THEN
        ...
        delayMatch30_reg(45) <= delayMatch30_reg_next(45);
        delayMatch30_reg(46) <= delayMatch30_reg_next(46);
        delayMatch30_reg(47) <= delayMatch30_reg_next(47);
        delayMatch30_reg(48) <= delayMatch30_reg_next(48);
        delayMatch30_reg(49) <= delayMatch30_reg_next(49);
        delayMatch30_reg(50) <= delayMatch30_reg_next(50);
        delayMatch30_reg(51) <= delayMatch30_reg_next(51);
        delayMatch30_reg(52) <= delayMatch30_reg_next(52);
        delayMatch30_reg(53) <= delayMatch30_reg_next(53);
        delayMatch30_reg(54) <= delayMatch30_reg_next(54);
        delayMatch30_reg(55) <= delayMatch30_reg_next(55);
        delayMatch30_reg(56) <= delayMatch30_reg_next(56);
        delayMatch30_reg(57) <= delayMatch30_reg_next(57);
        delayMatch30_reg(58) <= delayMatch30_reg_next(58);
        delayMatch30_reg(59) <= delayMatch30_reg_next(59);
        delayMatch30_reg(60) <= delayMatch30_reg_next(60);
        delayMatch30_reg(61) <= delayMatch30_reg_next(61);
        delayMatch30_reg(62) <= delayMatch30_reg_next(62);
        delayMatch30_reg(63) <= delayMatch30_reg_next(63);
        delayMatch30_reg(64) <= delayMatch30_reg_next(64);
        delayMatch30_reg(65) <= delayMatch30_reg_next(65);
      END IF;
    END IF;
  END PROCESS delayMatch30_process;

  omega_mech_1 <= delayMatch30_reg(65);
  delayMatch30_reg_next(0) <= Switch1_out1;
  ...
  delayMatch30_reg_next(45) <= delayMatch30_reg(44);
  delayMatch30_reg_next(46) <= delayMatch30_reg(45);
  delayMatch30_reg_next(47) <= delayMatch30_reg(46);
  delayMatch30_reg_next(48) <= delayMatch30_reg(47);
  delayMatch30_reg_next(49) <= delayMatch30_reg(48);
  delayMatch30_reg_next(50) <= delayMatch30_reg(49);
  delayMatch30_reg_next(51) <= delayMatch30_reg(50);
  delayMatch30_reg_next(52) <= delayMatch30_reg(51);
  delayMatch30_reg_next(53) <= delayMatch30_reg(52);
  delayMatch30_reg_next(54) <= delayMatch30_reg(53);
  delayMatch30_reg_next(55) <= delayMatch30_reg(54);
  delayMatch30_reg_next(56) <= delayMatch30_reg(55);
  delayMatch30_reg_next(57) <= delayMatch30_reg(56);
  delayMatch30_reg_next(58) <= delayMatch30_reg(57);
  delayMatch30_reg_next(59) <= delayMatch30_reg(58);
  delayMatch30_reg_next(60) <= delayMatch30_reg(59);
  delayMatch30_reg_next(61) <= delayMatch30_reg(60);
  delayMatch30_reg_next(62) <= delayMatch30_reg(61);
  delayMatch30_reg_next(63) <= delayMatch30_reg(62);
  delayMatch30_reg_next(64) <= delayMatch30_reg(63);
  delayMatch30_reg_next(65) <= delayMatch30_reg(64);
  ...
  From5_out1 <= delayMatch25_reg(46);
  delayMatch25_reg_next(0) <= polepair_1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        delayMatch31_reg(0) <= '0';
        delayMatch31_reg(1) <= '0';
        delayMatch31_reg(2) <= '0';
        delayMatch31_reg(3) <= '0';
        delayMatch31_reg(4) <= '0';
        delayMatch31_reg(5) <= '0';
        delayMatch31_reg(6) <= '0';
        delayMatch31_reg(7) <= '0';
        delayMatch31_reg(8) <= '0';
        delayMatch31_reg(9) <= '0';
        delayMatch31_reg(10) <= '0';
        delayMatch31_reg(11) <= '0';
        delayMatch31_reg(12) <= '0';
        delayMatch31_reg(13) <= '0';
        delayMatch31_reg(14) <= '0';
        delayMatch31_reg(15) <= '0';
        delayMatch31_reg(16) <= '0';
        delayMatch31_reg(17) <= '0';
        delayMatch31_reg(18) <= '0';
        delayMatch31_reg(19) <= '0';
        delayMatch31_reg(20) <= '0';
        delayMatch31_reg(21) <= '0';
        delayMatch31_reg(22) <= '0';
        delayMatch31_reg(23) <= '0';
        delayMatch31_reg(24) <= '0';
        delayMatch31_reg(25) <= '0';
        delayMatch31_reg(26) <= '0';
        delayMatch31_reg(27) <= '0';
        delayMatch31_reg(28) <= '0';
        delayMatch31_reg(29) <= '0';
        delayMatch31_reg(30) <= '0';
        delayMatch31_reg(31) <= '0';
        delayMatch31_reg(32) <= '0';
        delayMatch31_reg(33) <= '0';
        delayMatch31_reg(34) <= '0';
        delayMatch31_reg(35) <= '0';
        delayMatch31_reg(36) <= '0';
        delayMatch31_reg(37) <= '0';
        delayMatch31_reg(38) <= '0';
        delayMatch31_reg(39) <= '0';
        delayMatch31_reg(40) <= '0';
        delayMatch31_reg(41) <= '0';
        delayMatch31_reg(42) <= '0';
        delayMatch31_reg(43) <= '0';
        delayMatch31_reg(44) <= '0';
        delayMatch31_reg(45) <= '0';
        delayMatch31_reg(46) <= '0';
        delayMatch31_reg(47) <= '0';
        delayMatch31_reg(48) <= '0';
        delayMatch31_reg(49) <= '0';
        delayMatch31_reg(50) <= '0';
        delayMatch31_reg(51) <= '0';
        delayMatch31_reg(52) <= '0';
        delayMatch31_reg(53) <= '0';
        delayMatch31_reg(54) <= '0';
        delayMatch31_reg(55) <= '0';
        delayMatch31_reg(56) <= '0';
        delayMatch31_reg(57) <= '0';
        delayMatch31_reg(58) <= '0';
        delayMatch31_reg(59) <= '0';
        delayMatch31_reg(60) <= '0';
        delayMatch31_reg(61) <= '0';
        delayMatch31_reg(62) <= '0';
        delayMatch31_reg(63) <= '0';
        delayMatch31_reg(64) <= '0';
        delayMatch31_reg(65) <= '0';
        delayMatch31_reg(66) <= '0';
        delayMatch31_reg(67) <= '0';
        delayMatch31_reg(68) <= '0';
      ELSIF enb = '1' THEN
  ...
  reset_integrators_2 <= delayMatch31_reg(68);
  delayMatch31_reg_next(0) <= reset_integrators_1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        ...
        delayMatch32_reg(18) <= X"00000000";
        delayMatch32_reg(19) <= X"00000000";
        delayMatch32_reg(20) <= X"00000000";
        delayMatch32_reg(21) <= X"00000000";
        delayMatch32_reg(22) <= X"00000000";
        delayMatch32_reg(23) <= X"00000000";
        delayMatch32_reg(24) <= X"00000000";
        delayMatch32_reg(25) <= X"00000000";
        delayMatch32_reg(26) <= X"00000000";
        delayMatch32_reg(27) <= X"00000000";
        delayMatch32_reg(28) <= X"00000000";
        delayMatch32_reg(29) <= X"00000000";
        delayMatch32_reg(30) <= X"00000000";
        delayMatch32_reg(31) <= X"00000000";
        delayMatch32_reg(32) <= X"00000000";
        delayMatch32_reg(33) <= X"00000000";
        delayMatch32_reg(34) <= X"00000000";
        delayMatch32_reg(35) <= X"00000000";
        delayMatch32_reg(36) <= X"00000000";
        delayMatch32_reg(37) <= X"00000000";
        delayMatch32_reg(38) <= X"00000000";
        delayMatch32_reg(39) <= X"00000000";
        delayMatch32_reg(40) <= X"00000000";
        delayMatch32_reg(41) <= X"00000000";
        delayMatch32_reg(42) <= X"00000000";
        delayMatch32_reg(43) <= X"00000000";
        delayMatch32_reg(44) <= X"00000000";
        delayMatch32_reg(45) <= X"00000000";
        delayMatch32_reg(46) <= X"00000000";
        delayMatch32_reg(47) <= X"00000000";
        delayMatch32_reg(48) <= X"00000000";
        delayMatch32_reg(49) <= X"00000000";
        delayMatch32_reg(50) <= X"00000000";
        delayMatch32_reg(51) <= X"00000000";
        delayMatch32_reg(52) <= X"00000000";
        delayMatch32_reg(53) <= X"00000000";
        delayMatch32_reg(54) <= X"00000000";
        delayMatch32_reg(55) <= X"00000000";
        delayMatch32_reg(56) <= X"00000000";
        delayMatch32_reg(57) <= X"00000000";
        delayMatch32_reg(58) <= X"00000000";
        delayMatch32_reg(59) <= X"00000000";
        delayMatch32_reg(60) <= X"00000000";
        delayMatch32_reg(61) <= X"00000000";
        delayMatch32_reg(62) <= X"00000000";
        delayMatch32_reg(63) <= X"00000000";
        delayMatch32_reg(64) <= X"00000000";
        delayMatch32_reg(65) <= X"00000000";
        delayMatch32_reg(66) <= X"00000000";
        delayMatch32_reg(67) <= X"00000000";
        delayMatch32_reg(68) <= X"00000000";
      ELSIF enb = '1' THEN
  ...
  Data_Type_Conversion24_out1 <= delayMatch32_reg(68);
  delayMatch32_reg_next(0) <= input_2_1;
  ...
  Data_Type_Conversion25_out1 <= delayMatch33_reg(68);
  delayMatch33_reg_next(0) <= input_3_1;
  ...
  Mux_out1(0) <= Data_Type_Conversion32_out1_1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        delayMatch34_1_reg(0) <= to_signed(16#0000000#, 25);
        delayMatch34_1_reg(1) <= to_signed(16#0000000#, 25);
        delayMatch34_1_reg_1(0) <= to_signed(16#0000000#, 25);
        delayMatch34_1_reg_1(1) <= to_signed(16#0000000#, 25);
        delayMatch34_1_reg_2(0) <= to_signed(16#0000000#, 25);
        delayMatch34_1_reg_2(1) <= to_signed(16#0000000#, 25);
      ELSIF enb_1_500_0 = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        delayMatch37_reg(0) <= to_signed(16#0000000#, 25);
        delayMatch37_reg(1) <= to_signed(16#0000000#, 25);
      ELSIF enb_1_500_0 = '1' THEN
  ...
  Data_Type_Conversion1_out1_5 <= delayMatch37_reg(1);
  delayMatch37_reg_next(0) <= Data_Type_Conversion1_out1_4;
