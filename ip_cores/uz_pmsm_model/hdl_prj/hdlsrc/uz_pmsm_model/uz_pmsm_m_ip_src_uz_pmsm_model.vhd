-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/uz_pmsm_model/uz_pmsm_m_ip_src_uz_pmsm_model.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_m_ip_src_uz_pmsm_model
...
ENTITY uz_pmsm_m_ip_src_uz_pmsm_model IS
...
END uz_pmsm_m_ip_src_uz_pmsm_model;


ARCHITECTURE rtl OF uz_pmsm_m_ip_src_uz_pmsm_model IS

  -- Component Declarations
  COMPONENT uz_pmsm_m_ip_src_uz_pmsm_model_tc
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          clk_enable                      :   IN    std_logic;
          enb                             :   OUT   std_logic;
  ...
  COMPONENT uz_pmsm_m_ip_src_nfp_convert_single2double
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT uz_pmsm_m_ip_src_nfp_gain_pow2_double
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT uz_pmsm_m_ip_src_nfp_mul_double
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          nfp_in1                         :   IN    std_logic_vector(63 DOWNTO 0);  -- double
  ...
  COMPONENT uz_pmsm_m_ip_src_nfp_sub_double
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          nfp_in1                         :   IN    std_logic_vector(63 DOWNTO 0);  -- double
  ...
  COMPONENT uz_pmsm_m_ip_src_nfp_add_double
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          nfp_in1                         :   IN    std_logic_vector(63 DOWNTO 0);  -- double
  ...
  COMPONENT uz_pmsm_m_ip_src_nfp_convert_double2single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : uz_pmsm_m_ip_src_uz_pmsm_model_tc
    USE ENTITY work.uz_pmsm_m_ip_src_uz_pmsm_model_tc(rtl);

  FOR ALL : uz_pmsm_m_ip_src_nfp_convert_single2double
    USE ENTITY work.uz_pmsm_m_ip_src_nfp_convert_single2double(rtl);

  FOR ALL : uz_pmsm_m_ip_src_nfp_gain_pow2_double
    USE ENTITY work.uz_pmsm_m_ip_src_nfp_gain_pow2_double(rtl);

  FOR ALL : uz_pmsm_m_ip_src_nfp_mul_double
    USE ENTITY work.uz_pmsm_m_ip_src_nfp_mul_double(rtl);

  FOR ALL : uz_pmsm_m_ip_src_nfp_sub_double
    USE ENTITY work.uz_pmsm_m_ip_src_nfp_sub_double(rtl);

  FOR ALL : uz_pmsm_m_ip_src_nfp_add_double
    USE ENTITY work.uz_pmsm_m_ip_src_nfp_add_double(rtl);

  FOR ALL : uz_pmsm_m_ip_src_nfp_convert_double2single
    USE ENTITY work.uz_pmsm_m_ip_src_nfp_convert_double2single(rtl);
...
BEGIN
  u_uz_pmsm_model_tc : uz_pmsm_m_ip_src_uz_pmsm_model_tc
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_uz_pmsm_model_uz_pmsm_model_nfp_convert_single2double : uz_pmsm_m_ip_src_nfp_convert_single2double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_uz_pmsm_model_uz_pmsm_model_nfp_convert_single2double_1 : uz_pmsm_m_ip_src_nfp_convert_single2double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_gain_pow2_double : uz_pmsm_m_ip_src_nfp_gain_pow2_double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_uz_pmsm_model_uz_pmsm_model_nfp_convert_single2double_2 : uz_pmsm_m_ip_src_nfp_convert_single2double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp : uz_pmsm_m_ip_src_nfp_mul_double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_1 : uz_pmsm_m_ip_src_nfp_mul_double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_2 : uz_pmsm_m_ip_src_nfp_mul_double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp : uz_pmsm_m_ip_src_nfp_sub_double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_1 : uz_pmsm_m_ip_src_nfp_sub_double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_3 : uz_pmsm_m_ip_src_nfp_mul_double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp : uz_pmsm_m_ip_src_nfp_add_double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_4 : uz_pmsm_m_ip_src_nfp_mul_double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Factor1_out1,  -- double
  ...
  u_nfp_mul_comp_5 : uz_pmsm_m_ip_src_nfp_mul_double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_2 : uz_pmsm_m_ip_src_nfp_sub_double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp_1 : uz_pmsm_m_ip_src_nfp_add_double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_6 : uz_pmsm_m_ip_src_nfp_mul_double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp_2 : uz_pmsm_m_ip_src_nfp_add_double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_3 : uz_pmsm_m_ip_src_nfp_sub_double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_7 : uz_pmsm_m_ip_src_nfp_mul_double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_uz_pmsm_model_uz_pmsm_model_nfp_convert_double2single : uz_pmsm_m_ip_src_nfp_convert_double2single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in => I_d_2,  -- double
  ...
  u_uz_pmsm_model_uz_pmsm_model_nfp_convert_double2single_1 : uz_pmsm_m_ip_src_nfp_convert_double2single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in => I_q_2,  -- double
  ...
  u_nfp_mul_comp_8 : uz_pmsm_m_ip_src_nfp_mul_double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Sum3_out1,  -- double
  ...
  u_nfp_mul_comp_9 : uz_pmsm_m_ip_src_nfp_mul_double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_4 : uz_pmsm_m_ip_src_nfp_sub_double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_10 : uz_pmsm_m_ip_src_nfp_mul_double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_uz_pmsm_model_uz_pmsm_model_nfp_convert_double2single_2 : uz_pmsm_m_ip_src_nfp_convert_double2single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in => M_Mi,  -- double
