...
extern float slip_pct_diag;
extern float speed_ol_thr_scale;
extern float speed_ol_thr_min_rpm;
...
int JavaScope_initialize(DS_Data* data)
{
	...
	js_slowDataArray[JSSD_FLOAT_speed_ol_thr_scale]		= &speed_ol_thr_scale;
	js_slowDataArray[JSSD_FLOAT_speed_ol_thr_min_rpm]	= &speed_ol_thr_min_rpm;
	js_slowDataArray[JSSD_FLOAT_slip_pct]				= &slip_pct_diag;
