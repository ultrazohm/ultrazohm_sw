-- -------------------------------------------------------------
-- 
-- File Name: /home/ts/Dokumente/ultrazohm_testbench/ultrazohm_sw/ip_cores/InterlockDeadtime_2L/hdlsrc/interlock_deadtime/interlock_ip_rdfifo_rid.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: interlock_ip_rdfifo_rid
-- Source Path: interlock_ip/interlock_ip_axi4/interlock_ip_axi4_module/interlock_ip_rdfifo_rid
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY interlock_ip_rdfifo_rid IS
...
END interlock_ip_rdfifo_rid;


ARCHITECTURE rtl OF interlock_ip_rdfifo_rid IS
...
BEGIN
  ...
  u_interlock_ip_rdfifo_rid_classic_ram : interlock_ip_SimpleDualPortRAM_generic
