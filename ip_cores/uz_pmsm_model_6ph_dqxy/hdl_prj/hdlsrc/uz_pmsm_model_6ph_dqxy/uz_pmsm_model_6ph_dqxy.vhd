-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_pmsm_model_6ph_dqxy\uz_pmsm_model_6ph_dqxy.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_6ph_dqxy
-- Source Path: uz_pmsm_model_6ph_dqxy
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_pmsm_model_6ph_dqxy IS
...
END uz_pmsm_model_6ph_dqxy;


ARCHITECTURE rtl OF uz_pmsm_model_6ph_dqxy IS

  -- Component Declarations
  COMPONENT uz_pmsm_model_6ph_dqxy_reset_sync
  ...
  COMPONENT uz_pmsm_model_6ph_dqxy_dut
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          ...
          reciprocal_L_x                  :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
          reciprocal_L_y                  :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
          ...
          inputs_4                        :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
          inputs_5                        :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
          ...
          outputs_5                       :   OUT   std_logic_vector(31 DOWNTO 0)  -- ufix32
          );
  END COMPONENT;

  COMPONENT uz_pmsm_model_6ph_dqxy_axi4
  ...
  FOR ALL : uz_pmsm_model_6ph_dqxy_reset_sync
    USE ENTITY work.uz_pmsm_model_6ph_dqxy_reset_sync(rtl);

  FOR ALL : uz_pmsm_model_6ph_dqxy_dut
    USE ENTITY work.uz_pmsm_model_6ph_dqxy_dut(rtl);

  FOR ALL : uz_pmsm_model_6ph_dqxy_axi4
    USE ENTITY work.uz_pmsm_model_6ph_dqxy_axi4(rtl);
  ...
  SIGNAL write_inputs_unsigned            : vector_of_std_logic_vector32(0 TO 5);  -- ufix32 [6]
  ...
  SIGNAL write_reciprocal_L_x             : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_reciprocal_L_y             : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL ce_out_sig                       : std_logic;  -- ufix1
  SIGNAL read_outputs_vec                 : vector_of_std_logic_vector32(0 TO 5);  -- ufix32 [6]
...
BEGIN
  u_uz_pmsm_model_6ph_dqxy_reset_sync_inst : uz_pmsm_model_6ph_dqxy_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_uz_pmsm_model_6ph_dqxy_dut_inst : uz_pmsm_model_6ph_dqxy_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              ...
              reciprocal_L_x => write_reciprocal_L_x,  -- ufix32
              reciprocal_L_y => write_reciprocal_L_y,  -- ufix32
              ...
              inputs_4 => write_inputs_unsigned(4),  -- ufix32
              inputs_5 => write_inputs_unsigned(5),  -- ufix32
              ...
              outputs_5 => read_outputs_vec(5)  -- ufix32
              );

  u_uz_pmsm_model_6ph_dqxy_axi4_inst : uz_pmsm_model_6ph_dqxy_axi4
    PORT MAP( reset => reset,
              ...
              read_outputs => read_outputs_vec,  -- ufix32 [6]
              ...
              write_reciprocal_L_x => write_reciprocal_L_x,  -- ufix32
              write_reciprocal_L_y => write_reciprocal_L_y,  -- ufix32
              write_inputs => write_inputs_unsigned,  -- ufix32 [6]
              reset_internal => reset_internal  -- ufix1
              );

  ip_timestamp <= unsigned'(X"9B374641");
