...
twister=read_data('mt_init_mt')
halton=read_data('mt_init_halton')
squares=read_data('mt_init_squares')
pcg=read_data('mt_init_pcg')
xoshiro=read_data('mt_init_xoshiro')
