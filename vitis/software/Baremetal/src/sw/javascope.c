...
int JavaScope_initialize(DS_Data* data)
{
	...
	js_ch_observable[JSO_IM_I_D]=&data->av.im_i_d_A;
	js_ch_observable[JSO_IM_I_Q]=&data->av.im_i_q_A;
	js_ch_observable[JSO_IM_I_D_RAW]=&data->av.im_i_d_raw_A;
	js_ch_observable[JSO_IM_I_Q_RAW]=&data->av.im_i_q_raw_A;
	js_ch_observable[JSO_IM_I_D_REF]=&data->rasv.im_i_d_reference_A;
	js_ch_observable[JSO_IM_I_Q_REF]=&data->rasv.im_i_q_reference_A;
	js_ch_observable[JSO_IM_FLUX_VS]=&data->av.im_flux_magnitude_Vs;
	js_ch_observable[JSO_IM_FLUX_ANGLE_RAD]=&data->av.im_flux_angle_rad;
	js_ch_observable[JSO_IM_ROTOR_ELECTRICAL_ANGLE_RAD]=&data->av.im_rotor_electrical_angle_rad;
	js_ch_observable[JSO_IM_FLUX_ROTOR_ANGLE_DIFFERENCE_RAD]=&data->av.im_flux_rotor_angle_difference_rad;
	js_ch_observable[JSO_IM_ROTOR_ELECTRICAL_FREQUENCY_HZ]=&data->av.im_rotor_electrical_frequency_Hz;
	js_ch_observable[JSO_IM_SLIP_FREQUENCY_HZ]=&data->av.im_slip_frequency_Hz;
	js_ch_observable[JSO_IM_SLIP_PERCENT]=&data->av.im_slip_percent;
	js_ch_observable[JSO_IM_STATOR_FREQUENCY_HZ]=&data->av.im_stator_frequency_Hz;
	...
	js_slowDataArray[JSSD_FLOAT_IM_Slip_Percent] = &data->av.im_slip_percent;
	...
	js_slowDataArray[JSSD_FLOAT_IM_I_D] = &data->av.im_i_d_A;
	js_slowDataArray[JSSD_FLOAT_IM_I_Q] = &data->av.im_i_q_A;
	js_slowDataArray[JSSD_FLOAT_IM_I_D_Raw] = &data->av.im_i_d_raw_A;
	js_slowDataArray[JSSD_FLOAT_IM_I_Q_Raw] = &data->av.im_i_q_raw_A;
	js_slowDataArray[JSSD_FLOAT_IM_Flux_Vs] = &data->av.im_flux_magnitude_Vs;
	js_slowDataArray[JSSD_FLOAT_IM_Flux_Angle_Rad] = &data->av.im_flux_angle_rad;
	js_slowDataArray[JSSD_FLOAT_IM_Rotor_Electrical_Angle_Rad] = &data->av.im_rotor_electrical_angle_rad;
	js_slowDataArray[JSSD_FLOAT_IM_Flux_Rotor_Angle_Difference_Rad] = &data->av.im_flux_rotor_angle_difference_rad;
	js_slowDataArray[JSSD_FLOAT_IM_Rotor_Electrical_Frequency_Hz] = &data->av.im_rotor_electrical_frequency_Hz;
	js_slowDataArray[JSSD_FLOAT_Inverter_Hardware_Overcurrent] = &data->av.inverter_hardware_overcurrent;
	js_slowDataArray[JSSD_FLOAT_IM_Slip_Frequency_Hz] = &data->av.im_slip_frequency_Hz;
	js_slowDataArray[JSSD_FLOAT_IM_Stator_Frequency_Hz] = &data->av.im_stator_frequency_Hz;
