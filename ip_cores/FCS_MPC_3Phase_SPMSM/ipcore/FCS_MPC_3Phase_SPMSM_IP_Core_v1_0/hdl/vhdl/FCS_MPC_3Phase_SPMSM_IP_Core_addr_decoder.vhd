-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\FCS_MPC_3Phase_SPMSM\hdlsrc\FCS_MPC_3Phase_SPMSM_TEST1\FCS_MPC_3Phase_SPMSM_IP_Core_addr_decoder.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: FCS_MPC_3Phase_SPMSM_IP_Core_addr_decoder
-- Source Path: FCS_MPC_3Phase_SPMSM_IP_Core/FCS_MPC_3Phase_SPMSM_IP_Core_axi_lite/FCS_MPC_3Phase_SPMSM_IP_Core_addr_decoder
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY FCS_MPC_3Phase_SPMSM_IP_Core_addr_decoder IS
  PORT( clk                               :   IN    std_logic;
        ...
        write_Ld_AXI                      :   OUT   std_logic_vector(23 DOWNTO 0);  -- sfix24_En20
        write_Lq_AXI                      :   OUT   std_logic_vector(23 DOWNTO 0);  -- sfix24_En20
        write_psiPM_AXI                   :   OUT   std_logic_vector(17 DOWNTO 0);  -- sfix18_En11
        write_pole_pairs_AXI              :   OUT   std_logic_vector(31 DOWNTO 0)  -- sfix32
        );
END FCS_MPC_3Phase_SPMSM_IP_Core_addr_decoder;


ARCHITECTURE rtl OF FCS_MPC_3Phase_SPMSM_IP_Core_addr_decoder IS
  ...
  SIGNAL data_in_u_dc_link_AXI            : signed(17 DOWNTO 0);  -- sfix18_En11
  SIGNAL data_reg_u_dc_link_AXI_1_1       : signed(17 DOWNTO 0);  -- sfix18_En11
  SIGNAL decode_sel_SampleTime_AXI_1_1    : std_logic;  -- ufix1
  SIGNAL reg_enb_SampleTime_AXI_1_1       : std_logic;  -- ufix1
  SIGNAL data_in_SampleTime_AXI           : signed(23 DOWNTO 0);  -- sfix24_En20
  SIGNAL data_reg_SampleTime_AXI_1_1      : signed(23 DOWNTO 0);  -- sfix24_En20
  SIGNAL decode_sel_Rs_AXI_1_1            : std_logic;  -- ufix1
  SIGNAL reg_enb_Rs_AXI_1_1               : std_logic;  -- ufix1
  SIGNAL data_in_Rs_AXI                   : signed(17 DOWNTO 0);  -- sfix18_En11
  SIGNAL data_reg_Rs_AXI_1_1              : signed(17 DOWNTO 0);  -- sfix18_En11
  SIGNAL decode_sel_Ld_AXI_1_1            : std_logic;  -- ufix1
  SIGNAL reg_enb_Ld_AXI_1_1               : std_logic;  -- ufix1
  SIGNAL data_in_Ld_AXI                   : signed(23 DOWNTO 0);  -- sfix24_En20
  SIGNAL data_reg_Ld_AXI_1_1              : signed(23 DOWNTO 0);  -- sfix24_En20
  SIGNAL decode_sel_Lq_AXI_1_1            : std_logic;  -- ufix1
  SIGNAL reg_enb_Lq_AXI_1_1               : std_logic;  -- ufix1
  SIGNAL data_in_Lq_AXI                   : signed(23 DOWNTO 0);  -- sfix24_En20
  SIGNAL data_reg_Lq_AXI_1_1              : signed(23 DOWNTO 0);  -- sfix24_En20
  SIGNAL decode_sel_psiPM_AXI_1_1         : std_logic;  -- ufix1
  SIGNAL reg_enb_psiPM_AXI_1_1            : std_logic;  -- ufix1
  SIGNAL data_in_psiPM_AXI                : signed(17 DOWNTO 0);  -- sfix18_En11
  SIGNAL data_reg_psiPM_AXI_1_1           : signed(17 DOWNTO 0);  -- sfix18_En11
...
BEGIN
  ...
  data_in_u_dc_link_AXI <= signed(data_write_unsigned(17 DOWNTO 0));

  reg_u_dc_link_AXI_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_u_dc_link_AXI_1_1 <= to_signed(16#00000#, 18);
      ELSIF enb = '1' AND reg_enb_u_dc_link_AXI_1_1 = '1' THEN
        data_reg_u_dc_link_AXI_1_1 <= data_in_u_dc_link_AXI;
      END IF;
    END IF;
  ...
  data_in_SampleTime_AXI <= signed(data_write_unsigned(23 DOWNTO 0));

  reg_SampleTime_AXI_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_SampleTime_AXI_1_1 <= to_signed(16#000000#, 24);
      ELSIF enb = '1' AND reg_enb_SampleTime_AXI_1_1 = '1' THEN
        data_reg_SampleTime_AXI_1_1 <= data_in_SampleTime_AXI;
      END IF;
    END IF;
  ...
  data_in_Rs_AXI <= signed(data_write_unsigned(17 DOWNTO 0));

  reg_Rs_AXI_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_Rs_AXI_1_1 <= to_signed(16#00000#, 18);
      ELSIF enb = '1' AND reg_enb_Rs_AXI_1_1 = '1' THEN
        data_reg_Rs_AXI_1_1 <= data_in_Rs_AXI;
      END IF;
    END IF;
  ...
  decode_sel_Ld_AXI_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0043#, 14) ELSE
      '0';

  reg_enb_Ld_AXI_1_1 <= decode_sel_Ld_AXI_1_1 AND wr_enb;

  data_in_Ld_AXI <= signed(data_write_unsigned(23 DOWNTO 0));

  reg_Ld_AXI_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_Ld_AXI_1_1 <= to_signed(16#000000#, 24);
      ELSIF enb = '1' AND reg_enb_Ld_AXI_1_1 = '1' THEN
        data_reg_Ld_AXI_1_1 <= data_in_Ld_AXI;
      END IF;
    END IF;
  ...
  decode_sel_Lq_AXI_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0044#, 14) ELSE
      '0';

  reg_enb_Lq_AXI_1_1 <= decode_sel_Lq_AXI_1_1 AND wr_enb;

  data_in_Lq_AXI <= signed(data_write_unsigned(23 DOWNTO 0));

  reg_Lq_AXI_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_Lq_AXI_1_1 <= to_signed(16#000000#, 24);
      ELSIF enb = '1' AND reg_enb_Lq_AXI_1_1 = '1' THEN
        data_reg_Lq_AXI_1_1 <= data_in_Lq_AXI;
      END IF;
    END IF;
  ...
  data_in_psiPM_AXI <= signed(data_write_unsigned(17 DOWNTO 0));

  reg_psiPM_AXI_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_psiPM_AXI_1_1 <= to_signed(16#00000#, 18);
      ELSIF enb = '1' AND reg_enb_psiPM_AXI_1_1 = '1' THEN
        data_reg_psiPM_AXI_1_1 <= data_in_psiPM_AXI;
      END IF;
    END IF;
