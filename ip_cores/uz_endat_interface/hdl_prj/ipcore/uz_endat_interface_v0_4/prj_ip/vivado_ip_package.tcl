...
set_property core_revision 2114372927 [ipx::current_core]
...
ipx::add_file {hdl/uz_endat_interface_src_slice_position_and_CRC.vhd} [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/uz_endat_interface_src_slice_position_and_CRC.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]]
ipx::add_file {hdl/uz_endat_interface_src_slice_position_and_CRC.vhd} [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/uz_endat_interface_src_slice_position_and_CRC.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]]
...
# Package IP
ipx::archive_core {../uz_endat_interface_v0_4.zip} [ipx::current_core]
close_project
exit
