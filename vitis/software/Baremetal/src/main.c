...
int main(void)
{
    ...
    while (1)
    {
        ...
        case init_ip_cores:
            ...
            Global_Data.rasv.resolver_offset = -0.1642f; // tuned by ourselves, => offset for different pole, right offset should be around -0.1747118f
            Global_Data.rasv.endat_offset = 1.021435f; // tuned on 07_05, shift offset mech angle to endat angle
