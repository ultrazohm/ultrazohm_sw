...
proc init_gui { IPINST } {
  ...
  set C_S0_AXI_Lite_DATA_WIDTH [ipgui::add_param $IPINST -name "C_S0_AXI_Lite_DATA_WIDTH" -parent ${Page_0} -widget comboBox]
  set_property tooltip {Width of S_AXI data bus} ${C_S0_AXI_Lite_DATA_WIDTH}
  set C_S0_AXI_Lite_ADDR_WIDTH [ipgui::add_param $IPINST -name "C_S0_AXI_Lite_ADDR_WIDTH" -parent ${Page_0}]
  set_property tooltip {Width of S_AXI address bus} ${C_S0_AXI_Lite_ADDR_WIDTH}
  ipgui::add_param $IPINST -name "C_S0_AXI_Lite_BASEADDR" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_S0_AXI_Lite_HIGHADDR" -parent ${Page_0}
