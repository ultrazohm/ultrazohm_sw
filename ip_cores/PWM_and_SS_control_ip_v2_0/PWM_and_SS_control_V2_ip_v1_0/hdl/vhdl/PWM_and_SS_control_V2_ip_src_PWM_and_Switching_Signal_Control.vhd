-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\IP_Core_SS_Switch_and_PWM\PWM_and_SS_control_V2_ip_src_PWM_and_Switching_Signal_Control.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: PWM_and_SS_control_V2_ip_src_PWM_and_Switching_Signal_Control
...
USE work.PWM_and_SS_control_V2_ip_src_PWM_and_Switching_Signal_Control_pkg.ALL;

ENTITY PWM_and_SS_control_V2_ip_src_PWM_and_Switching_Signal_Control IS
  PORT( clk                               :   IN    std_logic;
        ...
        PWM_T_carrier_us_AXI              :   IN    std_logic_vector(7 DOWNTO 0);  -- uint8
        ...
        PWM_T_carrier_us_rd_AXI           :   OUT   std_logic_vector(7 DOWNTO 0);  -- uint8
...
END PWM_and_SS_control_V2_ip_src_PWM_and_Switching_Signal_Control;


ARCHITECTURE rtl OF PWM_and_SS_control_V2_ip_src_PWM_and_Switching_Signal_Control IS

  -- Component Declarations
  COMPONENT PWM_and_SS_control_V2_ip_src_GenPWM
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          PWM_en_AXI                      :   IN    std_logic;
  ...
  COMPONENT PWM_and_SS_control_V2_ip_src_VSI_Control_Signal_Switch
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : PWM_and_SS_control_V2_ip_src_GenPWM
    USE ENTITY work.PWM_and_SS_control_V2_ip_src_GenPWM(rtl);

  FOR ALL : PWM_and_SS_control_V2_ip_src_VSI_Control_Signal_Switch
    USE ENTITY work.PWM_and_SS_control_V2_ip_src_VSI_Control_Signal_Switch(rtl);
  ...
  SIGNAL GenPWM_out10                     : std_logic_vector(7 DOWNTO 0);  -- ufix8
...
BEGIN
  ...
  u_GenPWM : PWM_and_SS_control_V2_ip_src_GenPWM
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              PWM_en_AXI => PWM_en_AXI,
              f_carrier_kHz_AXI => PWM_f_carrier_kHz_AXI,  -- uint8
              T_carrier_us_AXI => PWM_T_carrier_us_AXI,  -- uint8
              ...
              T_carrier_us_rd_AXI => GenPWM_out9,  -- uint8
              min_pulse_width_rd_AXI => GenPWM_out10,  -- uint8
              enb_out => GenPWM_out11,
              Period_Center => GenPWM_out12
              );

  u_VSI_Control_Signal_Switch : PWM_and_SS_control_V2_ip_src_VSI_Control_Signal_Switch
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
