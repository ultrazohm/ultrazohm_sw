...
#define  IPCore_Timestamp_uz_park_transform_ip           0x8  //contains unique IP timestamp (yymmddHHMM): 2210041112
#define  factor_angle_el_AXI_Data_uz_park_transform_ip   0x100  //data register for Inport factor_angle_el_AXI
#define  y1_AXI_Data_uz_park_transform_ip                0x104  //data register for Outport y1_AXI
#define  y2_AXI_Data_uz_park_transform_ip                0x108  //data register for Outport y2_AXI
