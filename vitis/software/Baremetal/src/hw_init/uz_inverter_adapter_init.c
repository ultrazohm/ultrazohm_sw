...
static struct uz_inverter_adapter_outputs_t uz_inverter_adapter_outputs_d1_DUT = {
...
static struct uz_inverter_adapter_outputs_t uz_inverter_adapter_outputs_d2_Load = {
   .PWMdutyCycNormalized_H1 = 0.0f,
   .PWMdutyCycNormalized_L1 = 0.0f,
   .PWMdutyCycNormalized_H2 = 0.0f,
   .PWMdutyCycNormalized_L2 = 0.0f,
...
uz_inverter_adapter_t* init_uz_inverter_adapter_on_D1_DUT(void) {
       return(uz_inverter_adapter_init(uz_inverter_adapter_config_d1_DUT, uz_inverter_adapter_outputs_d1_DUT));
}

uz_inverter_adapter_t* init_uz_inverter_adapter_on_D2_Load(void) {
       return(uz_inverter_adapter_init(uz_inverter_adapter_config_d2_Load, uz_inverter_adapter_outputs_d2_Load));
}
