...
/* Project Wizard BEGIN: A1 definitions */
...
uz_adcLtc2311_t* initialize_adc_ltc2311_a1(void)
{
    return uz_adcLtc2311_init(config_adc_ltc2311_a1);
}
/* Project Wizard END: A1 definitions */
