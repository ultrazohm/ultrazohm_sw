-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\parallel_8_phase_voltages\hdlsrc\parallel_8_phase_voltages\parallel_8_phase_voltages_src_nfp_uminus_single.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: parallel_8_phase_voltages_src_nfp_uminus_single
-- Source Path: parallel_8_phase_voltages/Phase_voltages_per_switching_state2/Subsystem/MATLAB Function10/nfp_uminus_single
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY parallel_8_phase_voltages_src_nfp_uminus_single IS
  PORT( nfp_in                            :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_out                           :   OUT   std_logic_vector(31 DOWNTO 0)  -- ufix32
        );
END parallel_8_phase_voltages_src_nfp_uminus_single;


ARCHITECTURE rtl OF parallel_8_phase_voltages_src_nfp_uminus_single IS
