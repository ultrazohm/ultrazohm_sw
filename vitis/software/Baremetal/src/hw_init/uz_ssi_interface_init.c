...
struct uz_ssi_interface_outputs_t ssi_d5_1_outputs = {0};
struct uz_ssi_interface_outputs_t ssi_d5_2_outputs = {0};
struct uz_ssi_interface_outputs_t ssi_d5_3_outputs = {0};

uz_ssi_interface_t* ssi_encoder_init_d5_1() {

	return(uz_ssi_interface_init(ssi_d5_1_config, ssi_d5_1_outputs));
}

uz_ssi_interface_t* ssi_encoder_init_d5_2() {

	return(uz_ssi_interface_init(ssi_d5_2_config, ssi_d5_2_outputs));
}

uz_ssi_interface_t* ssi_encoder_init_d5_3() {

	return(uz_ssi_interface_init(ssi_d5_3_config, ssi_d5_2_outputs));
}
