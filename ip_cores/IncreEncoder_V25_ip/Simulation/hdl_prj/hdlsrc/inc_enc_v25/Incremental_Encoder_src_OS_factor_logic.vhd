-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\inc_enc_v25\Incremental_Encoder_src_OS_factor_logic.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Incremental_Encoder_src_OS_factor_logic
-- Source Path: inc_enc_v25/IncEnc_V25/speed/OS_factor_logic
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Incremental_Encoder_src_OS_factor_logic IS
...
END Incremental_Encoder_src_OS_factor_logic;


ARCHITECTURE rtl OF Incremental_Encoder_src_OS_factor_logic IS

  -- Component Declarations
  COMPONENT Incremental_Encoder_src_oversample_factor
  ...
  COMPONENT Incremental_Encoder_src_align_oversamples
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Incremental_Encoder_src_oversample_factor
    USE ENTITY work.Incremental_Encoder_src_oversample_factor(rtl);

  FOR ALL : Incremental_Encoder_src_align_oversamples
    USE ENTITY work.Incremental_Encoder_src_align_oversamples(rtl);
...
BEGIN
  u_oversample_factor : Incremental_Encoder_src_oversample_factor
  ...
  u_align_oversamples : Incremental_Encoder_src_align_oversamples
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
