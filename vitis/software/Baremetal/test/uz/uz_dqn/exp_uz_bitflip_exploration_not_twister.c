...
char folder_path[] = "test/uz/uz_dqn/exploration_results/";

void test_dqn_bitflip_one_not_twister_init_mt(void)
{
    char training_absolute_path[] = "mt_exploration_mt";
...
{
    char training_absolute_path[] = "mt_exploration_squares";
...
{
    char training_absolute_path[] = "mt_exploration_pcg";
...
{
    char training_absolute_path[] = "mt_exploration_halton";
...
{
    char training_absolute_path[] = "mt_exploration_xoshiro";
