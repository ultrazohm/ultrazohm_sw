-- -------------------------------------------------------------
-- 
-- File Name: /home/ts/Dokumente/ultrazohm_testbench/ultrazohm_test/ultrazohm_sw/ip_cores/InterlockDeadtime2L/hdlsrc/uz_interlockDeadtime2L/uz_interlockDeadtime2L_src_uz_interlockDeadtime2L.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_interlockDeadtime2L_src_uz_interlockDeadtime2L
-- Source Path: uz_interlockDeadtime2L/uz_interlockDeadtime2L
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_interlockDeadtime2L_src_uz_interlockDeadtime2L IS
...
END uz_interlockDeadtime2L_src_uz_interlockDeadtime2L;


ARCHITECTURE rtl OF uz_interlockDeadtime2L_src_uz_interlockDeadtime2L IS

  -- Component Declarations
  COMPONENT uz_interlockDeadtime2L_src_DeadtimeModule
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          In1                             :   IN    std_logic;
  ...
  COMPONENT uz_interlockDeadtime2L_src_InterlockModule
    PORT( In1                             :   IN    std_logic_vector(0 TO 1);  -- boolean [2]
          gate_delay_out                  :   OUT   std_logic_vector(0 TO 1)  -- boolean [2]
          );
  END COMPONENT;

  COMPONENT uz_interlockDeadtime2L_src_InverseBotSwitchModule
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT uz_interlockDeadtime2L_src_EnableOutputModule
  ...
  FOR ALL : uz_interlockDeadtime2L_src_DeadtimeModule
    USE ENTITY work.uz_interlockDeadtime2L_src_DeadtimeModule(rtl);

  FOR ALL : uz_interlockDeadtime2L_src_InterlockModule
    USE ENTITY work.uz_interlockDeadtime2L_src_InterlockModule(rtl);

  FOR ALL : uz_interlockDeadtime2L_src_InverseBotSwitchModule
    USE ENTITY work.uz_interlockDeadtime2L_src_InverseBotSwitchModule(rtl);

  FOR ALL : uz_interlockDeadtime2L_src_EnableOutputModule
    USE ENTITY work.uz_interlockDeadtime2L_src_EnableOutputModule(rtl);
...
BEGIN
  ...
  GEN_LABEL3: FOR k3 IN 0 TO 5 GENERATE
    u_DeadtimeModule : uz_interlockDeadtime2L_src_DeadtimeModule
      PORT MAP( clk => clk,
                reset_x => reset_x,
                enb => clk_enable,
                In1 => Mux_out1(k3),
  ...
  GEN_LABEL2: FOR k2 IN 0 TO 2 GENERATE
    u_InterlockModule : uz_interlockDeadtime2L_src_InterlockModule
  ...
  GEN_LABEL1: FOR k1 IN 0 TO 2 GENERATE
    u_InverseBotSwitchModule : uz_interlockDeadtime2L_src_InverseBotSwitchModule
      PORT MAP( clk => clk,
                reset_x => reset_x,
                enb => clk_enable,
  ...
  GEN_LABEL: FOR k IN 0 TO 5 GENERATE
    u_EnableOutputModule : uz_interlockDeadtime2L_src_EnableOutputModule
