...
reg   [0:0] icmp_ln93_reg_153;
reg    ap_block_state2_pp0_stage0_iter1;
wire    ap_block_state3_pp0_stage0_iter2;
reg    ap_block_pp0_stage0_subdone;
wire   [0:0] icmp_ln93_fu_106_p2;
...
wire   [9:0] trunc_ln96_fu_118_p1;
reg   [9:0] trunc_ln96_reg_157;
reg   [9:0] trunc_ln96_reg_157_pp0_iter1_reg;
reg   [31:0] arrays_addr_read_reg_162;
reg    ap_condition_exit_pp0_iter1_stage0;
wire   [31:0] zext_ln96_fu_137_p1;
reg   [31:0] i_fu_60;
wire   [31:0] add_ln93_fu_112_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln93_fu_106_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln93_reg_153 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        arrays_addr_read_reg_162 <= m_axi_arrays_RDATA;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln93_fu_106_p2 == 1'd0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln93_fu_106_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln93_reg_153 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (icmp_ln93_reg_153 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln93_reg_153 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign L_Output_Weights_temp_address0 = zext_ln96_fu_137_p1;

assign L_Output_Weights_temp_d0 = arrays_addr_read_reg_162;

assign add_ln93_fu_112_p2 = (ap_sig_allocacmp_i_2 + 32'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((icmp_ln93_reg_153 == 1'd0) & (m_axi_arrays_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((icmp_ln93_reg_153 == 1'd0) & (m_axi_arrays_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((icmp_ln93_reg_153 == 1'd0) & (m_axi_arrays_RVALID == 1'b0));
end
...
assign icmp_ln93_fu_106_p2 = ((ap_sig_allocacmp_i_2 == mul2) ? 1'b1 : 1'b0);
...
assign trunc_ln96_fu_118_p1 = ap_sig_allocacmp_i_2[9:0];

assign zext_ln96_fu_137_p1 = trunc_ln96_reg_157_pp0_iter1_reg;
