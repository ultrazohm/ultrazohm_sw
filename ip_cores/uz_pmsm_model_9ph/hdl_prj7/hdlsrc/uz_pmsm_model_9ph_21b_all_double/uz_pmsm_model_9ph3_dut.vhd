-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj7/hdlsrc/uz_pmsm_model_9ph_21b_all_double/uz_pmsm_model_9ph3_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_9ph3_dut
-- Source Path: uz_pmsm_model_9ph3/uz_pmsm_model_9ph3_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_pmsm_model_9ph3_dut IS
...
END uz_pmsm_model_9ph3_dut;


ARCHITECTURE rtl OF uz_pmsm_model_9ph3_dut IS

  -- Component Declarations
  COMPONENT uz_pmsm_model_9ph3_src_uz_pmsm_model_9ph
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : uz_pmsm_model_9ph3_src_uz_pmsm_model_9ph
    USE ENTITY work.uz_pmsm_model_9ph3_src_uz_pmsm_model_9ph(rtl);
  ...
  SIGNAL i_abc_ps_0_sig                   : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL i_abc_ps_1_sig                   : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL i_abc_ps_2_sig                   : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL i_abc_ps_3_sig                   : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL i_abc_ps_4_sig                   : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL i_abc_ps_5_sig                   : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL i_abc_ps_6_sig                   : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL i_abc_ps_7_sig                   : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL i_abc_ps_8_sig                   : std_logic_vector(31 DOWNTO 0);  -- ufix32
...
BEGIN
  u_uz_pmsm_model_9ph3_src_uz_pmsm_model_9ph : uz_pmsm_model_9ph3_src_uz_pmsm_model_9ph
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
              ...
              i_abc_ps_0 => i_abc_ps_0_sig,  -- ufix32
              i_abc_ps_1 => i_abc_ps_1_sig,  -- ufix32
              i_abc_ps_2 => i_abc_ps_2_sig,  -- ufix32
              i_abc_ps_3 => i_abc_ps_3_sig,  -- ufix32
              i_abc_ps_4 => i_abc_ps_4_sig,  -- ufix32
              i_abc_ps_5 => i_abc_ps_5_sig,  -- ufix32
              i_abc_ps_6 => i_abc_ps_6_sig,  -- ufix32
              i_abc_ps_7 => i_abc_ps_7_sig,  -- ufix32
              i_abc_ps_8 => i_abc_ps_8_sig,  -- ufix32
  ...
  i_abc_ps_0 <= i_abc_ps_0_sig;

  i_abc_ps_1 <= i_abc_ps_1_sig;

  i_abc_ps_2 <= i_abc_ps_2_sig;

  i_abc_ps_3 <= i_abc_ps_3_sig;

  i_abc_ps_4 <= i_abc_ps_4_sig;

  i_abc_ps_5 <= i_abc_ps_5_sig;

  i_abc_ps_6 <= i_abc_ps_6_sig;

  i_abc_ps_7 <= i_abc_ps_7_sig;

  i_abc_ps_8 <= i_abc_ps_8_sig;
