-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_mpc_3ph\count_f_sw_src_Count_f_sw.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: count_f_sw_src_Count_f_sw
-- Source Path: uz_mpc_3ph/counter_f_sw_3ph/Count_f_sw
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
USE work.count_f_sw_src_counter_f_sw_3ph_pkg.ALL;

ENTITY count_f_sw_src_Count_f_sw IS
...
END count_f_sw_src_Count_f_sw;


ARCHITECTURE rtl OF count_f_sw_src_Count_f_sw IS
...
BEGIN
  ...
  BEGIN
    ...
    --MATLAB Function 'counter_f_sw_3ph/Count_f_sw'
    --    %% toDO
    --    %% Initialization
