-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\Philipp\ultrazohm\ultrazohm_sw\ip_cores\uz_pmsm_model_nonlinear\hdl_prj\hdlsrc\uz_pmsm_model_nonlinear\uz_pmsm_model_nonlinear_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_nonlinear_dut
-- Source Path: uz_pmsm_model_nonlinear/uz_pmsm_model_nonlinear_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_pmsm_model_nonlinear_dut IS
...
END uz_pmsm_model_nonlinear_dut;


ARCHITECTURE rtl OF uz_pmsm_model_nonlinear_dut IS

  -- Component Declarations
  COMPONENT uz_pmsm_model_nonlinear_src_uz_pmsm_model_nonlinear
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : uz_pmsm_model_nonlinear_src_uz_pmsm_model_nonlinear
    USE ENTITY work.uz_pmsm_model_nonlinear_src_uz_pmsm_model_nonlinear(rtl);
...
BEGIN
  u_uz_pmsm_model_nonlinear_src_uz_pmsm_model_nonlinear : uz_pmsm_model_nonlinear_src_uz_pmsm_model_nonlinear
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
