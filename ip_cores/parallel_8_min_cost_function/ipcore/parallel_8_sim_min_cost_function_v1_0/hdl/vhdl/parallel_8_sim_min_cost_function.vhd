-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\parallel_8_min_cost_function\hdlsrc\parallel_8_min_cost_function\parallel_8_sim_min_cost_function.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: parallel_8_sim_min_cost_function
-- Source Path: parallel_8_sim_min_cost_function
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY parallel_8_sim_min_cost_function IS
...
END parallel_8_sim_min_cost_function;


ARCHITECTURE rtl OF parallel_8_sim_min_cost_function IS

  -- Component Declarations
  COMPONENT parallel_8_sim_min_cost_function_reset_sync
  ...
  COMPONENT parallel_8_sim_min_cost_function_axi_lite
    PORT( reset                           :   IN    std_logic;
          ...
          read_Index_in_AXI               :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32
          AXI4_Lite_AWREADY               :   OUT   std_logic;  -- ufix1
          AXI4_Lite_WREADY                :   OUT   std_logic;  -- ufix1
          AXI4_Lite_BRESP                 :   OUT   std_logic_vector(1 DOWNTO 0);  -- ufix2
          AXI4_Lite_BVALID                :   OUT   std_logic;  -- ufix1
  ...
  COMPONENT parallel_8_sim_min_cost_function_dut
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          ...
          Index_in_AXI                    :   OUT   std_logic_vector(31 DOWNTO 0)  -- sfix32
          );
  END COMPONENT;

  -- Component Configuration Statements
  FOR ALL : parallel_8_sim_min_cost_function_reset_sync
    USE ENTITY work.parallel_8_sim_min_cost_function_reset_sync(rtl);

  FOR ALL : parallel_8_sim_min_cost_function_axi_lite
    USE ENTITY work.parallel_8_sim_min_cost_function_axi_lite(rtl);

  FOR ALL : parallel_8_sim_min_cost_function_dut
    USE ENTITY work.parallel_8_sim_min_cost_function_dut(rtl);
  ...
  SIGNAL Index_in_AXI_sig                 : std_logic_vector(31 DOWNTO 0);  -- ufix32
...
BEGIN
  u_parallel_8_sim_min_cost_function_reset_sync_inst : parallel_8_sim_min_cost_function_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_parallel_8_sim_min_cost_function_axi_lite_inst : parallel_8_sim_min_cost_function_axi_lite
    PORT MAP( reset => reset,
              ...
              read_Index_in_AXI => Index_in_AXI_sig,  -- sfix32
  ...
  u_parallel_8_sim_min_cost_function_dut_inst : parallel_8_sim_min_cost_function_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              dut_enable => write_axi_enable,  -- ufix1
              Index_in => std_logic_vector(Index_in_sig),  -- sfix32
              done_prediction_and_cost_function => done_prediction_and_cost_function,  -- ufix1
              J_in_0 => std_logic_vector(J_in_0_sig),  -- sfix20_En9
              J_in_1 => std_logic_vector(J_in_1_sig),  -- sfix20_En9
              J_in_2 => std_logic_vector(J_in_2_sig),  -- sfix20_En9
              J_in_3 => std_logic_vector(J_in_3_sig),  -- sfix20_En9
              J_in_4 => std_logic_vector(J_in_4_sig),  -- sfix20_En9
              J_in_5 => std_logic_vector(J_in_5_sig),  -- sfix20_En9
              J_in_6 => std_logic_vector(J_in_6_sig),  -- sfix20_En9
              J_in_7 => std_logic_vector(J_in_7_sig),  -- sfix20_En9
              ...
              Index_in_AXI => Index_in_AXI_sig  -- sfix32
              );

  ip_timestamp <= unsigned'(X"83CCB601");
