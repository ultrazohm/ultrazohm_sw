-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Transformation_V12\Trans_123_dq_V12_ip_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Trans_123_dq_V12_ip_dut
-- Source Path: Trans_123_dq_V12_ip/Trans_123_dq_V12_ip_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Trans_123_dq_V12_ip_dut IS
...
END Trans_123_dq_V12_ip_dut;


ARCHITECTURE rtl OF Trans_123_dq_V12_ip_dut IS

  -- Component Declarations
  COMPONENT Trans_123_dq_V12_ip_src_Trans_123_dq_fix_V12
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : Trans_123_dq_V12_ip_src_Trans_123_dq_fix_V12
    USE ENTITY work.Trans_123_dq_V12_ip_src_Trans_123_dq_fix_V12(rtl);
...
BEGIN
  u_Trans_123_dq_V12_ip_src_Trans_123_dq_fix_V12 : Trans_123_dq_V12_ip_src_Trans_123_dq_fix_V12
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
