...
BEGIN
  ...
  OR1_out1 <= reset_dac_output OR Delay10_out1;

  OR4_out1 <=  NOT OR1_out1;
  ...
  Switch8_out1 <= Delay9_out1 WHEN use_input_from_axi = '0' ELSE
      trigger_write;

  OR3_out1 <= OR4_out1 AND Switch8_out1;
  ...
  Rate_Transition10_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Rate_Transition10_out1 <= '0';
      ELSIF enb_1_32_0 = '1' THEN
        Rate_Transition10_out1 <= Detect_Rise_Positive1_out1;
      END IF;
    END IF;
  END PROCESS Rate_Transition10_process;


  OR2_out1 <= Rate_Transition10_out1 AND OR1_out1;

  OR_out1 <= OR2_out1 OR OR3_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_32_1 = '1' THEN
        Rate_Transition2_bypass_reg <= OR_out1;
      END IF;
    END IF;
  END PROCESS Rate_Transition2_bypass_process;

  
  Rate_Transition2_out1 <= OR_out1 WHEN enb_1_32_1 = '1' ELSE
  ...
  Switch_out1 <= Delay1_out1 WHEN use_input_from_axi = '0' ELSE
      dac_data_1_signed;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_32_1 = '1' THEN
        Rate_Transition1_bypass_reg <= Switch9_out1;
      END IF;
    END IF;
  END PROCESS Rate_Transition1_bypass_process;

  
  Rate_Transition1_out1 <= Switch9_out1 WHEN enb_1_32_1 = '1' ELSE
  ...
  switch_compare_1 <= '1' WHEN use_input_from_axi > '0' ELSE
      '0';
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_32_1 = '1' THEN
        Rate_Transition3_bypass_reg <= Switch10_out1;
      END IF;
    END IF;
  END PROCESS Rate_Transition3_bypass_process;

  
  Rate_Transition3_out1 <= Switch10_out1 WHEN enb_1_32_1 = '1' ELSE
  ...
  switch_compare_1_1 <= '1' WHEN use_input_from_axi > '0' ELSE
      '0';
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_32_1 = '1' THEN
        Rate_Transition4_bypass_reg <= Switch11_out1;
      END IF;
    END IF;
  END PROCESS Rate_Transition4_bypass_process;

  
  Rate_Transition4_out1 <= Switch11_out1 WHEN enb_1_32_1 = '1' ELSE
  ...
  switch_compare_1_2 <= '1' WHEN use_input_from_axi > '0' ELSE
      '0';
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_32_1 = '1' THEN
        Rate_Transition5_bypass_reg <= Switch12_out1;
      END IF;
    END IF;
  END PROCESS Rate_Transition5_bypass_process;

  
  Rate_Transition5_out1 <= Switch12_out1 WHEN enb_1_32_1 = '1' ELSE
  ...
  switch_compare_1_3 <= '1' WHEN use_input_from_axi > '0' ELSE
      '0';
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_32_1 = '1' THEN
        Rate_Transition6_bypass_reg <= Switch13_out1;
      END IF;
    END IF;
  END PROCESS Rate_Transition6_bypass_process;

  
  Rate_Transition6_out1 <= Switch13_out1 WHEN enb_1_32_1 = '1' ELSE
  ...
  switch_compare_1_4 <= '1' WHEN use_input_from_axi > '0' ELSE
      '0';
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_32_1 = '1' THEN
        Rate_Transition7_bypass_reg <= Switch14_out1;
      END IF;
    END IF;
  END PROCESS Rate_Transition7_bypass_process;

  
  Rate_Transition7_out1 <= Switch14_out1 WHEN enb_1_32_1 = '1' ELSE
  ...
  switch_compare_1_5 <= '1' WHEN use_input_from_axi > '0' ELSE
      '0';
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_32_1 = '1' THEN
        Rate_Transition8_bypass_reg <= Switch15_out1;
      END IF;
    END IF;
  END PROCESS Rate_Transition8_bypass_process;

  
  Rate_Transition8_out1 <= Switch15_out1 WHEN enb_1_32_1 = '1' ELSE
  ...
  switch_compare_1_6 <= '1' WHEN use_input_from_axi > '0' ELSE
      '0';
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_32_1 = '1' THEN
        Rate_Transition9_bypass_reg <= Switch16_out1;
      END IF;
    END IF;
  END PROCESS Rate_Transition9_bypass_process;

  
  Rate_Transition9_out1 <= Switch16_out1 WHEN enb_1_32_1 = '1' ELSE
