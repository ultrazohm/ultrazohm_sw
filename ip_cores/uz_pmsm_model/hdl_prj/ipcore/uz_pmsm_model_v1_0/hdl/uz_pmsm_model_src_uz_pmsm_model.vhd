...
-- approx_flux_testing_0         ce_out        2e-06
-- approx_flux_testing_1         ce_out        2e-06
-- approx_flux_testing_2         ce_out        2e-06
-- approx_flux_testing_3         ce_out        2e-06
-- approx_flux_testing_4         ce_out        2e-06
-- approx_flux_testing_5         ce_out        2e-06
-- -------------------------------------------------------------
-- 
-- -------------------------------------------------------------
...
ENTITY uz_pmsm_model_src_uz_pmsm_model IS
  PORT( clk                               :   IN    std_logic;
        ...
        approx_flux_testing_0             :   OUT   std_logic_vector(31 DOWNTO 0);  -- single
        approx_flux_testing_1             :   OUT   std_logic_vector(31 DOWNTO 0);  -- single
        approx_flux_testing_2             :   OUT   std_logic_vector(31 DOWNTO 0);  -- single
        approx_flux_testing_3             :   OUT   std_logic_vector(31 DOWNTO 0);  -- single
        approx_flux_testing_4             :   OUT   std_logic_vector(31 DOWNTO 0);  -- single
        approx_flux_testing_5             :   OUT   std_logic_vector(31 DOWNTO 0)  -- single
        );
...
ARCHITECTURE rtl OF uz_pmsm_model_src_uz_pmsm_model IS
  ...
  SIGNAL delayMatch14_reg                 : std_logic_vector(29 DOWNTO 0);  -- ufix1 [30]
  ...
  SIGNAL i_d_soll                         : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Switch8_out1                     : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Switch8_out1_1                   : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL i_d_soll_1                       : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL fitting_parameter_17_1           : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL aq1_aq2_1                        : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL psidself_abgeleitet              : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL fitting_parameter_8_1            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL fitting_parameter_16_1           : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL aq4_aq5_1                        : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL psid_s1_3                        : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL fitting_parameter_11_1           : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL fitting_parameter_13_2           : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL fitting_parameter_1_3            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL fitting_parameter_15_1           : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL fitting_parameter_4_3            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL fitting_parameter_14_1           : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL fitting_parameter_12_2           : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL fitting_parameter_13_3           : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL fitting_parameter_12_3           : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL pmsm_out5                        : vector_of_std_logic_vector32(0 TO 5);  -- ufix32 [6]
  SIGNAL t1_bypass_reg                    : vector_of_std_logic_vector32(0 TO 5);  -- ufix32 [6]
  SIGNAL pmsm_out5_1                      : vector_of_std_logic_vector32(0 TO 5);  -- ufix32 [6]
...
BEGIN
  ...
  u_nfp_sub_comp_9 : uz_pmsm_model_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Product4_out1_2,  -- single
  ...
  u_nfp_mul_comp_51 : uz_pmsm_model_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Tanh4_out1_1,  -- single
              nfp_in2 => Tanh4_out1_1,  -- single
  ...
  u_nfp_mul_comp_52 : uz_pmsm_model_src_nfp_mul_single
    PORT MAP( clk => clk,
              ...
              nfp_out => psidself_abgeleitet_1  -- single
              );
  ...
  u_nfp_mul_comp_59 : uz_pmsm_model_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => psid_cross_s1_2,  -- single
  ...
  u_nfp_sub_comp_21 : uz_pmsm_model_src_nfp_sub_single
    PORT MAP( clk => clk,
              ...
              nfp_out => psid_cross_s1_5  -- single
              );
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        delayMatch14_reg(0) <= Switch8_out1_timer;
        delayMatch14_reg(29 DOWNTO 1) <= delayMatch14_reg(28 DOWNTO 0);
      END IF;
    END IF;
  END PROCESS delayMatch14_process;

  Switch8_out1_timer_1 <= delayMatch14_reg(29);
  ...
  Switch8_out1 <= i_d_soll WHEN Switch8_control_abs = X"00000000" ELSE
      Lq_1;
  ...
  i_d_soll_1 <= X"34000000";

  
  Switch_out1 <= i_d_soll_1 WHEN Switch_control_abs = X"00000000" ELSE
      Ld_1;
  ...
  Delay1_toDel <= Sum5_out1_1 WHEN reset_integrators_2 = '0' ELSE
      Delay1_iv;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_200_1 = '1' THEN
        Delay1_lowered1_bypass_reg <= Delay1_toDel_3;
      END IF;
    END IF;
  ...
  Switch_out1_1 <= omega_mech WHEN simulate_mechanical_1 = '0' ELSE
      Delay1_out1_2;
  ...
  i_q_3 <= omega_mech WHEN simulate_mechanical_1 = '0' ELSE
      Delay1_out1_2;
  ...
  Switch_out1_2 <= Constant2_out1 WHEN Switch_control_abs_1 = X"00000000" ELSE
      Tanh4_out1;
  ...
  Switch1_out1 <= Constant2_out1 WHEN Switch1_control_abs = X"00000000" ELSE
      Tanh2_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        alpha1_Fid2_Giq2 <= fitting_parameter_13_1;
      END IF;
    END IF;
  ...
  psid_cross_s1_3 <= psid_cross_s1_2;
  ...
  Switch_out1_3 <= Constant2_out1_1 WHEN Switch_control_abs_2 = X"00000000" ELSE
      Tanh2_out1_1;
  ...
  Switch1_out1_1 <= Constant2_out1_1 WHEN Switch1_control_abs_1 = X"00000000" ELSE
      error_id;
  ...
  Switch_out1_4 <= Constant2_out1_2 WHEN Switch_control_abs_3 = X"00000000" ELSE
      Product14_out1;

  fitting_parameter_17_1 <= fitting_parameter_23(17);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        aq1_aq2_1 <= fitting_parameter_17_1;
      END IF;
    END IF;
  END PROCESS delayMatch32_process;


  fitting_parameter_8_1 <= fitting_parameter_23(8);
  ...
  Switch1_out1_2 <= Constant2_out1_2 WHEN Switch1_control_abs_2 = X"00000000" ELSE
      Product15_out1;

  fitting_parameter_16_1 <= fitting_parameter_23(16);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        aq4_aq5_1 <= fitting_parameter_16_1;
      END IF;
    END IF;
  END PROCESS delayMatch34_process;


  fitting_parameter_11_1 <= fitting_parameter_23(11);
  ...
  fitting_parameter_13_2 <= fitting_parameter_23(13);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        alpha1_Fid2_Giq2_1 <= fitting_parameter_13_2;
      END IF;
    END IF;
  ...
  fitting_parameter_1_3 <= fitting_parameter_23(1);
  ...
  Switch_out1_5 <= Constant2_out1_3 WHEN Switch_control_abs_4 = X"00000000" ELSE
      Product14_out1_1;

  fitting_parameter_15_1 <= fitting_parameter_23(15);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ad1_ad2_1 <= fitting_parameter_15_1;
      END IF;
    END IF;
  END PROCESS delayMatch38_process;


  psidself_abgeleitet_2 <= psidself_abgeleitet_1;

  ad6_2 <= fitting_parameter_23(5);

  fitting_parameter_4_3 <= fitting_parameter_23(4);
  ...
  Switch1_out1_3 <= Constant2_out1_3 WHEN Switch1_control_abs_3 = X"00000000" ELSE
      Product15_out1_1;

  fitting_parameter_14_1 <= fitting_parameter_23(14);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ad4_ad5_1 <= fitting_parameter_14_1;
      END IF;
    END IF;
  ...
  fitting_parameter_12_2 <= fitting_parameter_23(12);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        F1G1 <= X"00000000";
      ELSIF enb = '1' THEN
        F1G1 <= fitting_parameter_12_2;
      END IF;
    END IF;
  END PROCESS delayMatch41_process;


  psid_cross_s1_4 <= psid_cross_s1_2;

  psiq_cross_s1_2 <= psiq_cross_s1;

  fitting_parameter_13_3 <= fitting_parameter_23(13);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        alpha1_Fid2_Giq2_2 <= fitting_parameter_13_3;
      END IF;
    END IF;
  END PROCESS delayMatch42_process;


  fitting_parameter_12_3 <= fitting_parameter_23(12);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        alpha1_Fid1_Giq1 <= fitting_parameter_12_3;
      END IF;
    END IF;
  ...
  Ldd_modell <= psid_cross_s1_5;

  pmsm_out5(0) <= psi_q_approx;
  pmsm_out5(1) <= psi_d_approx_1;
  pmsm_out5(2) <= Lqq_modell;
  pmsm_out5(3) <= Ldd_modell;
  pmsm_out5(4) <= Lqd_approx;
  pmsm_out5(5) <= Ldq_approx;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_200_1 = '1' THEN
        t1_bypass_reg <= pmsm_out5;
      END IF;
    END IF;
  END PROCESS t1_bypass_process;

  
  pmsm_out5_1 <= pmsm_out5 WHEN enb_1_200_1 = '1' ELSE
      t1_bypass_reg;

  approx_flux_testing_0 <= pmsm_out5_1(0);

  approx_flux_testing_1 <= pmsm_out5_1(1);

  approx_flux_testing_2 <= pmsm_out5_1(2);

  approx_flux_testing_3 <= pmsm_out5_1(3);

  approx_flux_testing_4 <= pmsm_out5_1(4);

  approx_flux_testing_5 <= pmsm_out5_1(5);
