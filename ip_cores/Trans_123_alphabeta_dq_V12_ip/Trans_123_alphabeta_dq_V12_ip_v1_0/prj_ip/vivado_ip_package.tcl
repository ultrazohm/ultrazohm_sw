...
set_property core_revision 2112488880 [ipx::current_core]
...
ipx::add_file {doc/Transformation_V12_ip_core_report.html} [ipx::get_file_groups xilinx_productguide -of_objects [ipx::current_core]]
set_property type {{html}} [ipx::get_files {doc/Transformation_V12_ip_core_report.html} -of_objects [ipx::get_file_groups xilinx_productguide -of_objects [ipx::current_core]]]
