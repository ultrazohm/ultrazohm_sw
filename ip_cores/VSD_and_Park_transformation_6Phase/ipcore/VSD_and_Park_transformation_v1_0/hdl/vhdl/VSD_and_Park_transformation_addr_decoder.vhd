-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\VSD_and_Park_transformation_6Phase\hdlsrc\VSD_and_Park_transformation_6Phase\VSD_and_Park_transformation_addr_decoder.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: VSD_and_Park_transformation_addr_decoder
-- Source Path: VSD_and_Park_transformation/VSD_and_Park_transformation_axi_lite/VSD_and_Park_transformation_addr_decoder
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY VSD_and_Park_transformation_addr_decoder IS
...
END VSD_and_Park_transformation_addr_decoder;


ARCHITECTURE rtl OF VSD_and_Park_transformation_addr_decoder IS
  ...
  SIGNAL read_i_alpha_axi_signed          : signed(17 DOWNTO 0);  -- sfix18_En11
  SIGNAL read_i_beta_axi_signed           : signed(17 DOWNTO 0);  -- sfix18_En11
  ...
  SIGNAL read_i_0_plus_axi_signed         : signed(17 DOWNTO 0);  -- sfix18_En11
  SIGNAL read_i_0_minus_axi_signed        : signed(17 DOWNTO 0);  -- sfix18_En11
  ...
  SIGNAL decode_sel_i_0_minus_axi_1_1     : std_logic;  -- ufix1
  SIGNAL decode_sel_i_0_plus_axi_1_1      : std_logic;  -- ufix1
  ...
  SIGNAL decode_sel_i_beta_axi_1_1        : std_logic;  -- ufix1
  SIGNAL decode_sel_i_alpha_axi_1_1       : std_logic;  -- ufix1
  SIGNAL read_reg_ip_timestamp            : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_ip_timestamp_1_1       : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL read_reg_i_alpha_axi             : signed(17 DOWNTO 0);  -- sfix18_En11
  SIGNAL data_slice_i_alpha_axi_1         : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_i_alpha_axi_1_1        : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL read_reg_i_beta_axi              : signed(17 DOWNTO 0);  -- sfix18_En11
  SIGNAL data_slice_i_beta_axi_1          : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_i_beta_axi_1_1         : unsigned(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL read_reg_i_0_plus_axi            : signed(17 DOWNTO 0);  -- sfix18_En11
  SIGNAL data_slice_i_0_plus_axi_1        : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_i_0_plus_axi_1_1       : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL read_reg_i_0_minus_axi           : signed(17 DOWNTO 0);  -- sfix18_En11
  SIGNAL data_slice_i_0_minus_axi_1       : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_i_0_minus_axi_1_1      : unsigned(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL decode_sel_theta_el_offset_1_1   : std_logic;  -- ufix1
  SIGNAL reg_enb_theta_el_offset_1_1      : std_logic;  -- ufix1
  SIGNAL data_in_theta_el_offset          : signed(23 DOWNTO 0);  -- sfix24_En20
  SIGNAL data_reg_theta_el_offset_1_1     : signed(23 DOWNTO 0);  -- sfix24_En20
...
BEGIN
  ...
  read_i_alpha_axi_signed <= signed(read_i_alpha_axi);

  read_i_beta_axi_signed <= signed(read_i_beta_axi);
  ...
  read_i_0_plus_axi_signed <= signed(read_i_0_plus_axi);

  read_i_0_minus_axi_signed <= signed(read_i_0_minus_axi);
  ...
  decode_sel_i_0_minus_axi_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0048#, 14) ELSE
      '0';

  
  decode_sel_i_0_plus_axi_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0047#, 14) ELSE
      '0';

  
  decode_sel_i_y_axi_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0046#, 14) ELSE
      '0';

  
  decode_sel_i_x_axi_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0045#, 14) ELSE
      '0';

  
  decode_sel_i_q_axi_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0044#, 14) ELSE
      '0';

  
  decode_sel_i_d_axi_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0043#, 14) ELSE
      '0';

  
  decode_sel_i_beta_axi_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0042#, 14) ELSE
      '0';

  
  decode_sel_i_alpha_axi_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0041#, 14) ELSE
      '0';
  ...
  reg_i_alpha_axi_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        read_reg_i_alpha_axi <= to_signed(16#00000#, 18);
      ELSIF enb = '1' THEN
        read_reg_i_alpha_axi <= read_i_alpha_axi_signed;
      END IF;
    END IF;
  END PROCESS reg_i_alpha_axi_process;


  data_slice_i_alpha_axi_1 <= unsigned(resize(read_reg_i_alpha_axi, 32));

  
  decode_rd_i_alpha_axi_1_1 <= decode_rd_ip_timestamp_1_1 WHEN decode_sel_i_alpha_axi_1_1 = '0' ELSE
      data_slice_i_alpha_axi_1;

  reg_i_beta_axi_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        read_reg_i_beta_axi <= to_signed(16#00000#, 18);
      ELSIF enb = '1' THEN
        read_reg_i_beta_axi <= read_i_beta_axi_signed;
      END IF;
    END IF;
  END PROCESS reg_i_beta_axi_process;


  data_slice_i_beta_axi_1 <= unsigned(resize(read_reg_i_beta_axi, 32));

  
  decode_rd_i_beta_axi_1_1 <= decode_rd_i_alpha_axi_1_1 WHEN decode_sel_i_beta_axi_1_1 = '0' ELSE
      data_slice_i_beta_axi_1;
  ...
  decode_rd_i_d_axi_1_1 <= decode_rd_i_beta_axi_1_1 WHEN decode_sel_i_d_axi_1_1 = '0' ELSE
  ...
  reg_i_0_plus_axi_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        read_reg_i_0_plus_axi <= to_signed(16#00000#, 18);
      ELSIF enb = '1' THEN
        read_reg_i_0_plus_axi <= read_i_0_plus_axi_signed;
      END IF;
    END IF;
  END PROCESS reg_i_0_plus_axi_process;


  data_slice_i_0_plus_axi_1 <= unsigned(resize(read_reg_i_0_plus_axi, 32));

  
  decode_rd_i_0_plus_axi_1_1 <= decode_rd_i_y_axi_1_1 WHEN decode_sel_i_0_plus_axi_1_1 = '0' ELSE
      data_slice_i_0_plus_axi_1;

  reg_i_0_minus_axi_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        read_reg_i_0_minus_axi <= to_signed(16#00000#, 18);
      ELSIF enb = '1' THEN
        read_reg_i_0_minus_axi <= read_i_0_minus_axi_signed;
      END IF;
    END IF;
  END PROCESS reg_i_0_minus_axi_process;


  data_slice_i_0_minus_axi_1 <= unsigned(resize(read_reg_i_0_minus_axi, 32));

  
  decode_rd_i_0_minus_axi_1_1 <= decode_rd_i_0_plus_axi_1_1 WHEN decode_sel_i_0_minus_axi_1_1 = '0' ELSE
      data_slice_i_0_minus_axi_1;
  ...
  decode_rd_i_a1_axi_1_1 <= decode_rd_i_0_minus_axi_1_1 WHEN decode_sel_i_a1_axi_1_1 = '0' ELSE
  ...
  decode_sel_theta_el_offset_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0040#, 14) ELSE
      '0';

  reg_enb_theta_el_offset_1_1 <= decode_sel_theta_el_offset_1_1 AND wr_enb;

  data_in_theta_el_offset <= signed(data_write_unsigned(23 DOWNTO 0));

  reg_theta_el_offset_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        data_reg_theta_el_offset_1_1 <= to_signed(16#000000#, 24);
      ELSIF enb = '1' AND reg_enb_theta_el_offset_1_1 = '1' THEN
        data_reg_theta_el_offset_1_1 <= data_in_theta_el_offset;
      END IF;
    END IF;
  END PROCESS reg_theta_el_offset_1_1_process;


  write_theta_el_offset <= std_logic_vector(data_reg_theta_el_offset_1_1);
