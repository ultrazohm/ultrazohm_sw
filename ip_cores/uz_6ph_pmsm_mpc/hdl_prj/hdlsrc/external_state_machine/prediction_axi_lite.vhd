-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\external_state_machine\prediction_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: prediction_axi_lite
-- Source Path: prediction/prediction_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END prediction_axi_lite;


ARCHITECTURE rtl OF prediction_axi_lite IS

  -- Component Declarations
  COMPONENT prediction_addr_decoder
  ...
  COMPONENT prediction_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : prediction_addr_decoder
    USE ENTITY work.prediction_addr_decoder(rtl);

  FOR ALL : prediction_axi_lite_module
    USE ENTITY work.prediction_axi_lite_module(rtl);
...
BEGIN
  u_prediction_addr_decoder_inst : prediction_addr_decoder
  ...
  u_prediction_axi_lite_module_inst : prediction_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
