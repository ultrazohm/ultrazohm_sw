...
#ifndef RTW_HEADER_impl_modul_mpc1_h_
#define RTW_HEADER_impl_modul_mpc1_h_
#include <math.h>
#include <string.h>
#include <stddef.h>
#ifndef impl_modul_mpc1_COMMON_INCLUDES_
#define impl_modul_mpc1_COMMON_INCLUDES_
#include "rtwtypes.h"
#endif                                 /* impl_modul_mpc1_COMMON_INCLUDES_ */
...
typedef struct {
  ...
  real_T a;
  real_T b;
  real32_T M_f[32];                    /* '<S1>/formulate_qp_1' */
  real32_T M_b[32];                    /* '<S1>/formulate_qp_2' */
  real32_T M_c[32];                    /* '<S1>/formulate_qp_3' */
  real32_T M_e[32];                    /* '<S1>/formulate_qp_4' */
  real32_T M_m[32];                    /* '<S1>/formulate_qp_5' */
  real32_T M[32];                      /* '<S1>/formulate_qp_6' */
  real32_T rtb_x1_c[24];
  real32_T Linv_data[16];
  real32_T H_ee[16];                   /* '<S1>/formulate_qp_1' */
  real32_T H_f[16];                    /* '<S1>/formulate_qp_2' */
  real32_T H_c[16];                    /* '<S1>/formulate_qp_3' */
  real32_T H_e[16];                    /* '<S1>/formulate_qp_4' */
  real32_T H_m[16];                    /* '<S1>/formulate_qp_5' */
  real32_T H[16];                      /* '<S1>/formulate_qp_6' */
  real32_T r_k[8];                     /* '<S1>/formulate_qp_1' */
  real32_T r_e[8];                     /* '<S1>/formulate_qp_2' */
  real32_T r_nu[8];                    /* '<S1>/formulate_qp_3' */
  real32_T r_n[8];                     /* '<S1>/formulate_qp_4' */
  real32_T r_g[8];                     /* '<S1>/formulate_qp_5' */
  real32_T r[8];                       /* '<S1>/formulate_qp_6' */
  real32_T J_1to6[6];
  real32_T f_p[4];                     /* '<S1>/formulate_qp_1' */
  real32_T f_n[4];                     /* '<S1>/formulate_qp_2' */
  real32_T f_e[4];                     /* '<S1>/formulate_qp_3' */
  real32_T f_m[4];                     /* '<S1>/formulate_qp_4' */
  real32_T f_d[4];                     /* '<S1>/formulate_qp_5' */
...
typedef struct {
  /* Expression: single([1 2 3 4 5 6]')
   * Referenced by: '<S1>/Constant6'
   */
  real32_T Constant6_Value[6];
} ConstP;
...
extern void impl_modul_mpc1_initialize(RT_MODEL *const rtM);
extern void impl_modul_mpc1_step(RT_MODEL *const rtM);
 ...
 *
 * hilite_system('uz_codegen/impl_modul_mpc1')    - opens subsystem uz_codegen/impl_modul_mpc1
 * hilite_system('uz_codegen/impl_modul_mpc1/Kp') - opens and selects block Kp
 *
 * Here is the system hierarchy for this model
 *
 * '<Root>' : 'uz_codegen'
 * '<S1>'   : 'uz_codegen/impl_modul_mpc1'
 * '<S2>'   : 'uz_codegen/impl_modul_mpc1/act_sw_2_dq_volts_all'
 * '<S3>'   : 'uz_codegen/impl_modul_mpc1/detect_unsuited_sequence_1'
 * '<S4>'   : 'uz_codegen/impl_modul_mpc1/detect_unsuited_sequence_2'
 * '<S5>'   : 'uz_codegen/impl_modul_mpc1/detect_unsuited_sequence_3'
 * '<S6>'   : 'uz_codegen/impl_modul_mpc1/detect_unsuited_sequence_4'
 * '<S7>'   : 'uz_codegen/impl_modul_mpc1/detect_unsuited_sequence_5'
 * '<S8>'   : 'uz_codegen/impl_modul_mpc1/detect_unsuited_sequence_6'
 * '<S9>'   : 'uz_codegen/impl_modul_mpc1/formulate_qp_1'
 * '<S10>'  : 'uz_codegen/impl_modul_mpc1/formulate_qp_2'
 * '<S11>'  : 'uz_codegen/impl_modul_mpc1/formulate_qp_3'
 * '<S12>'  : 'uz_codegen/impl_modul_mpc1/formulate_qp_4'
 * '<S13>'  : 'uz_codegen/impl_modul_mpc1/formulate_qp_5'
 * '<S14>'  : 'uz_codegen/impl_modul_mpc1/formulate_qp_6'
 * '<S15>'  : 'uz_codegen/impl_modul_mpc1/min_Costs'
 * '<S16>'  : 'uz_codegen/impl_modul_mpc1/qp_solver_for_suited_seq_AS'
 * '<S17>'  : 'uz_codegen/impl_modul_mpc1/seq_2_act_sw_all'
 * '<S18>'  : 'uz_codegen/impl_modul_mpc1/state_space_mdl_1'
 * '<S19>'  : 'uz_codegen/impl_modul_mpc1/state_space_mdl_2'
 * '<S20>'  : 'uz_codegen/impl_modul_mpc1/state_space_mdl_3'
 * '<S21>'  : 'uz_codegen/impl_modul_mpc1/state_space_mdl_4'
 * '<S22>'  : 'uz_codegen/impl_modul_mpc1/state_space_mdl_5'
 * '<S23>'  : 'uz_codegen/impl_modul_mpc1/state_space_mdl_6'
 * '<S24>'  : 'uz_codegen/impl_modul_mpc1/tz'
 * '<S25>'  : 'uz_codegen/impl_modul_mpc1/tz_2_tph'
 */

/*-
 * Requirements for '<Root>': impl_modul_mpc1
 */
#endif                                 /* RTW_HEADER_impl_modul_mpc1_h_ */
