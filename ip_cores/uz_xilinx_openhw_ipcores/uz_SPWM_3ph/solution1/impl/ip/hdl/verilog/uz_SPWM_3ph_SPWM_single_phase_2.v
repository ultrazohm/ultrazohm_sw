...
module uz_SPWM_3ph_SPWM_single_phase_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_block_state1;
wire   [31:0] select_ln20_1_fu_145_p3;
reg   [31:0] DC_preg;
...
uz_SPWM_3ph_fdiv_32ns_32ns_32_9_no_dsp_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
fdiv_32ns_32ns_32_9_no_dsp_1_U19(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(voltage),
    .din1(u_dc),
...
assign and_ln20_1_fu_125_p2 = (xor_ln18_fu_119_p2 & and_ln20_fu_113_p2);
...
assign icmp_ln18_1_fu_95_p2 = ((trunc_ln18_fu_85_p1 == 23'd0) ? 1'b1 : 1'b0);

assign icmp_ln18_fu_89_p2 = ((tmp_fu_75_p4 != 8'd255) ? 1'b1 : 1'b0);

assign or_ln18_fu_101_p2 = (icmp_ln18_fu_89_p2 | icmp_ln18_1_fu_95_p2);

assign or_ln20_fu_139_p2 = (and_ln20_1_fu_125_p2 | and_ln18_fu_107_p2);

assign select_ln20_1_fu_145_p3 = ((or_ln20_fu_139_p2[0:0] == 1'b1) ? select_ln20_fu_131_p3 : bitcast_ln18_fu_72_p1);

assign select_ln20_fu_131_p3 = ((and_ln20_1_fu_125_p2[0:0] == 1'b1) ? 32'd1065353216 : 32'd0);
...
endmodule //uz_SPWM_3ph_SPWM_single_phase_2
