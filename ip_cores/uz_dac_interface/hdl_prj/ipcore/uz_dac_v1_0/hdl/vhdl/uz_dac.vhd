-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/dac_spi/uz_dac.vhd
...
ARCHITECTURE rtl OF uz_dac IS

  -- Component Declarations
  COMPONENT uz_dac_reset_sync
  ...
  FOR ALL : uz_dac_reset_sync
    USE ENTITY work.uz_dac_reset_sync(rtl);

  FOR ALL : uz_dac_axi4
    USE ENTITY work.uz_dac_axi4(rtl);

  FOR ALL : uz_dac_dut
    USE ENTITY work.uz_dac_dut(rtl);
...
BEGIN
  u_uz_dac_reset_sync_inst : uz_dac_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_uz_dac_axi4_inst : uz_dac_axi4
  ...
  ip_timestamp <= unsigned'(X"837017E5");
