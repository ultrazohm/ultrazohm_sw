-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/inc_enc_v26/IncEnc_V2_ip_src_oversample_factor.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IncEnc_V2_ip_src_oversample_factor
-- Source Path: inc_enc_v26/IncEnc_V26/speed1/OS_factor_logic/oversample_factor
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY IncEnc_V2_ip_src_oversample_factor IS
...
END IncEnc_V2_ip_src_oversample_factor;


ARCHITECTURE rtl OF IncEnc_V2_ip_src_oversample_factor IS
...
BEGIN
  ...
  BEGIN
    ...
    --MATLAB Function 'IncEnc_V26/speed1/OS_factor_logic/oversample_factor'
    --Counter State
    -- Count Up 
