-- -------------------------------------------------------------
-- 
-- File Name: uz_axi_testIP/hdlsrc/uz_axi_testIP/uz_axi_testIP_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_axi_testIP_dut
-- Source Path: uz_axi_testIP/uz_axi_testIP_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END uz_axi_testIP_dut;


ARCHITECTURE rtl OF uz_axi_testIP_dut IS

  -- Component Declarations
  COMPONENT uz_axi_testIP_src_uz_axi_testIP
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : uz_axi_testIP_src_uz_axi_testIP
    USE ENTITY work.uz_axi_testIP_src_uz_axi_testIP(rtl);
...
BEGIN
  u_uz_axi_testIP_src_uz_axi_testIP : uz_axi_testIP_src_uz_axi_testIP
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
