...
# Date: 19.08.2020
set_property PACKAGE_PIN AC9 [get_ports {D1_OUT_inv[0]}]
set_property PACKAGE_PIN AB9 [get_ports {D1_OUT_inv[1]}]
set_property PACKAGE_PIN AB10 [get_ports {D1_OUT_inv[2]}]
set_property PACKAGE_PIN AB11 [get_ports {D1_OUT_inv[3]}]
set_property PACKAGE_PIN AJ11 [get_ports {D1_OUT_inv[4]}]
set_property PACKAGE_PIN AK11 [get_ports {D1_OUT_inv[5]}]
set_property PACKAGE_PIN AA7  	[get_ports D1_OUT_06]
...
set_property PACKAGE_PIN AD10 	[get_ports D1_IN_14]
#set_property PACKAGE_PIN AE10 	[get_ports D1_OUT[15]]
set_property PACKAGE_PIN AF13 	[get_ports D1_IN_16]
...
set_property PULLDOWN true [get_ports {D1_OUT_inv[5]}]
set_property PULLDOWN true [get_ports {D1_OUT_inv[4]}]
set_property PULLDOWN true [get_ports {D1_OUT_inv[3]}]
set_property PULLDOWN true [get_ports {D1_OUT_inv[2]}]
set_property PULLDOWN true [get_ports {D1_OUT_inv[1]}]
set_property PULLDOWN true [get_ports {D1_OUT_inv[0]}]
set_property PULLDOWN true [get_ports {D1_OUT_06}]
