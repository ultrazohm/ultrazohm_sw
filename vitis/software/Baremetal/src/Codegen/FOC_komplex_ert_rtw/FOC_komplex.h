...
#ifndef DEFINED_TYPEDEF_FOR_struct_zyqqq6pSR0woRwhcINxTaC_
#define DEFINED_TYPEDEF_FOR_struct_zyqqq6pSR0woRwhcINxTaC_
...
typedef struct {
  ...
  real32_T error_speed_limit;
} struct_zyqqq6pSR0woRwhcINxTaC;
...
typedef struct {
  ...
  real32_T Voltage_Limit;              /* '<Root>/Voltage_Limit' */
  real32_T error_speed_limit;          /* '<Root>/error_speed_limit' */
