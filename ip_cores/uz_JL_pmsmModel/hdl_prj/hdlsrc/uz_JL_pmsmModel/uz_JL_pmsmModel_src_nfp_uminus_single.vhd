-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\jonat\Documents\MA_JL_CIL\ip_cores\uz_JL_pmsmModel\hdl_prj\hdlsrc\uz_JL_pmsmModel\uz_JL_pmsmModel_src_nfp_uminus_single.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_JL_pmsmModel_src_nfp_uminus_single
-- Source Path: uz_JL_pmsmModel/uz_JL_pmsmModel/Elektrik/dq->abc/Inverse Park-Transformation/nfp_uminus_single
-- Hierarchy Level: 4
-- Model version: 1.66
-- 
-- -------------------------------------------------------------
...
ENTITY uz_JL_pmsmModel_src_nfp_uminus_single IS
  PORT( nfp_in                            :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_out                           :   OUT   std_logic_vector(31 DOWNTO 0)  -- ufix32
        );
END uz_JL_pmsmModel_src_nfp_uminus_single;


ARCHITECTURE rtl OF uz_JL_pmsmModel_src_nfp_uminus_single IS
