...
ARCHITECTURE rtl OF Incremental_Encoder_v26_src_IncEnc_V26 IS
  ...
  -- Signals
  SIGNAL enb_1_245467_0                   : std_logic;
...
BEGIN
  ...
  u_Check_d_Axis_Hit : Incremental_Encoder_v26_src_Check_d_Axis_Hit
    PORT MAP( Count_in => std_logic_vector(Pipeline9_out1),  -- uint16
  ...
  u_Check_d_Axis_Hit_WithCompare : Incremental_Encoder_v26_src_Check_d_Axis_Hit_WithCompare
    PORT MAP( Count_in => std_logic_vector(Pipeline9_out1),  -- uint16
              Counter_Compare => std_logic_vector(Pipeline1_out1),  -- uint16
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_245467_0 = '1' THEN
        Pipeline1_out1 <= Data_Type_Conversion4_out1;
      END IF;
    END IF;
