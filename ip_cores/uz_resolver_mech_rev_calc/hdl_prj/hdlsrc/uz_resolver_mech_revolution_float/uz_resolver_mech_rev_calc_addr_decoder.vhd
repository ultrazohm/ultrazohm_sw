-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_resolver_mech_revolution_float\uz_resolver_mech_rev_calc_addr_decoder.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_resolver_mech_rev_calc_addr_decoder
-- Source Path: uz_resolver_mech_rev_calc/uz_resolver_mech_rev_calc_axi_lite/uz_resolver_mech_rev_calc_addr_decoder
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_resolver_mech_rev_calc_addr_decoder IS
...
END uz_resolver_mech_rev_calc_addr_decoder;


ARCHITECTURE rtl OF uz_resolver_mech_rev_calc_addr_decoder IS
...
BEGIN
  ...
  decode_rd_cnt_AXI_1_1 <= decode_rd_rpm_mech_AXI_1_1 WHEN decode_sel_cnt_AXI_1_1 = '0' ELSE
      data_slice_cnt_AXI_1;

  data_read <= std_logic_vector(decode_rd_cnt_AXI_1_1);
