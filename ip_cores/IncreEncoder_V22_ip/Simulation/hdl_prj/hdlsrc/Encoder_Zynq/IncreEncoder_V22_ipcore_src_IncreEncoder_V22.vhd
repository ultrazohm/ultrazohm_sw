-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Encoder_Zynq\IncreEncoder_V22_ipcore_src_IncreEncoder_V22.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IncreEncoder_V22_ipcore_src_IncreEncoder_V22
...
ENTITY IncreEncoder_V22_ipcore_src_IncreEncoder_V22 IS
...
END IncreEncoder_V22_ipcore_src_IncreEncoder_V22;


ARCHITECTURE rtl OF IncreEncoder_V22_ipcore_src_IncreEncoder_V22 IS

  -- Component Declarations
  COMPONENT IncreEncoder_V22_ipcore_src_IncreEncoder_V22_tc
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          clk_enable                      :   IN    std_logic;
  ...
  COMPONENT IncreEncoder_V22_ipcore_src_omega_by_measure_time
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  COMPONENT IncreEncoder_V22_ipcore_src_HDL_Reciprocal
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_100_0                     :   IN    std_logic;
  ...
  COMPONENT IncreEncoder_V22_ipcore_src_Average
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_100_0                     :   IN    std_logic;
  ...
  COMPONENT IncreEncoder_V22_ipcore_src_Check_Direction
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_100_0                     :   IN    std_logic;
          A                               :   IN    std_logic;
  ...
  COMPONENT IncreEncoder_V22_ipcore_src_Counter
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_100_0                     :   IN    std_logic;
  ...
  COMPONENT IncreEncoder_V22_ipcore_src_Counter_theta_ele
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_100_0                     :   IN    std_logic;
  ...
  COMPONENT IncreEncoder_V22_ipcore_src_Counter_theta
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_100_0                     :   IN    std_logic;
          Edge_rsvd                       :   IN    std_logic_vector(7 DOWNTO 0);  -- int8
  ...
  COMPONENT IncreEncoder_V22_ipcore_src_omega_by_count_lines
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_100_0                     :   IN    std_logic;
          Edge_rsvd                       :   IN    std_logic_vector(7 DOWNTO 0);  -- int8
  ...
  FOR ALL : IncreEncoder_V22_ipcore_src_IncreEncoder_V22_tc
    USE ENTITY work.IncreEncoder_V22_ipcore_src_IncreEncoder_V22_tc(rtl);

  FOR ALL : IncreEncoder_V22_ipcore_src_omega_by_measure_time
    USE ENTITY work.IncreEncoder_V22_ipcore_src_omega_by_measure_time(rtl);

  FOR ALL : IncreEncoder_V22_ipcore_src_HDL_Reciprocal
    USE ENTITY work.IncreEncoder_V22_ipcore_src_HDL_Reciprocal(rtl);

  FOR ALL : IncreEncoder_V22_ipcore_src_Average
    USE ENTITY work.IncreEncoder_V22_ipcore_src_Average(rtl);

  FOR ALL : IncreEncoder_V22_ipcore_src_Check_Direction
    USE ENTITY work.IncreEncoder_V22_ipcore_src_Check_Direction(rtl);

  FOR ALL : IncreEncoder_V22_ipcore_src_Counter
    USE ENTITY work.IncreEncoder_V22_ipcore_src_Counter(rtl);

  FOR ALL : IncreEncoder_V22_ipcore_src_Counter_theta_ele
    USE ENTITY work.IncreEncoder_V22_ipcore_src_Counter_theta_ele(rtl);

  FOR ALL : IncreEncoder_V22_ipcore_src_Counter_theta
    USE ENTITY work.IncreEncoder_V22_ipcore_src_Counter_theta(rtl);

  FOR ALL : IncreEncoder_V22_ipcore_src_omega_by_count_lines
    USE ENTITY work.IncreEncoder_V22_ipcore_src_omega_by_count_lines(rtl);
...
BEGIN
  ...
  u_IncreEncoder_V22_tc : IncreEncoder_V22_ipcore_src_IncreEncoder_V22_tc
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_omega_by_measure_time : IncreEncoder_V22_ipcore_src_omega_by_measure_time
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_100_0 => enb_1_100_0,
  ...
  u_HDL_Reciprocal : IncreEncoder_V22_ipcore_src_HDL_Reciprocal
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_100_0 => enb_1_100_0,
              enb_1_50_0 => enb_1_50_0,
  ...
  u_Average : IncreEncoder_V22_ipcore_src_Average
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_100_0 => enb_1_100_0,
  ...
  u_Check_Direction : IncreEncoder_V22_ipcore_src_Check_Direction
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_100_0 => enb_1_100_0,
              A => A,
  ...
  u_Counter : IncreEncoder_V22_ipcore_src_Counter
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_100_0 => enb_1_100_0,
  ...
  u_Counter_theta_ele : IncreEncoder_V22_ipcore_src_Counter_theta_ele
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_100_0 => enb_1_100_0,
              Edge_rsvd => Counter_out1,  -- int8
  ...
  u_Counter_theta : IncreEncoder_V22_ipcore_src_Counter_theta
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_100_0 => enb_1_100_0,
              Edge_rsvd => Counter_out1,  -- int8
  ...
  u_omega_by_count_lines : IncreEncoder_V22_ipcore_src_omega_by_count_lines
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_100_0 => enb_1_100_0,
              Edge_rsvd => Counter_out1,  -- int8
