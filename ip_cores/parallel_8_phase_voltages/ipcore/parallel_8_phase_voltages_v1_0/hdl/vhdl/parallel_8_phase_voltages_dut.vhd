-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\parallel_8_phase_voltages\hdlsrc\parallel_8_phase_voltages\parallel_8_phase_voltages_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: parallel_8_phase_voltages_dut
-- Source Path: parallel_8_phase_voltages/parallel_8_phase_voltages_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY parallel_8_phase_voltages_dut IS
...
END parallel_8_phase_voltages_dut;


ARCHITECTURE rtl OF parallel_8_phase_voltages_dut IS

  -- Component Declarations
  COMPONENT parallel_8_phase_voltages_src_Phase_voltages_per_switching_state2
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : parallel_8_phase_voltages_src_Phase_voltages_per_switching_state2
    USE ENTITY work.parallel_8_phase_voltages_src_Phase_voltages_per_switching_state2(rtl);
...
BEGIN
  u_parallel_8_phase_voltages_src_Phase_voltages_per_switching_state2 : parallel_8_phase_voltages_src_Phase_voltages_per_switching_state2
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
