...
entity BGD_accumulate_float_1u_3 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of BGD_accumulate_float_1u_3 is 
...
begin
    fadd_32ns_32ns_32_5_full_dsp_1_U317 : component BGD_fadd_32ns_32ns_32_5_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((ap_start = ap_const_logic_0) or (p_initZero_empty_n = ap_const_logic_0) or (mul_ln559_loc_empty_n = ap_const_logic_0) or (p_weightGradientAvg_offset_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                l_parBlocks_reg_152 <= mul_ln559_loc_dout;
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, p_weightGradientAvg_offset_empty_n, mul_ln559_loc_empty_n, p_initZero_empty_n, ap_enable_reg_pp0_iter1, icmp_ln409_fu_106_p2, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, ap_enable_reg_pp0_iter6, ap_enable_reg_pp0_iter7)
    begin
        case ap_CS_fsm is
