...
ARCHITECTURE rtl OF UZ_D_GaN_Inverter_addr_decoder IS
  ...
  SIGNAL read_AXI_GaN_FAULT_unsigned      : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL read_AXI_GaN_OC_unsigned         : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL read_AXI_I_DIAG_unsigned         : unsigned(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL read_reg_AXI_GaN_FAULT           : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_AXI_GaN_FAULT_1_1      : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL read_reg_AXI_GaN_OC              : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_AXI_GaN_OC_1_1         : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL read_reg_AXI_I_DIAG              : unsigned(31 DOWNTO 0);  -- ufix32
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        read_reg_AXI_GaN_FAULT <= to_unsigned(0, 32);
      ELSIF enb = '1' THEN
  ...
  decode_rd_AXI_GaN_FAULT_1_1 <= decode_rd_AXI_Gan_Temp_6_dutycyc_1_1 WHEN decode_sel_AXI_GaN_FAULT_1_1 = '0' ELSE
      read_reg_AXI_GaN_FAULT;

  reg_AXI_GaN_OC_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        read_reg_AXI_GaN_OC <= to_unsigned(0, 32);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        read_reg_AXI_I_DIAG <= to_unsigned(0, 32);
      ELSIF enb = '1' THEN
