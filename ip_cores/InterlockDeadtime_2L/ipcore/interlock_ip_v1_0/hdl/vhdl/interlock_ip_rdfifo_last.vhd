-- -------------------------------------------------------------
-- 
-- File Name: /home/ts/Dokumente/ultrazohm_testbench/ultrazohm_sw/ip_cores/InterlockDeadtime_2L/hdlsrc/interlock_deadtime/interlock_ip_rdfifo_last.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: interlock_ip_rdfifo_last
-- Source Path: interlock_ip/interlock_ip_axi4/interlock_ip_axi4_module/interlock_ip_rdfifo_last
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY interlock_ip_rdfifo_last IS
...
END interlock_ip_rdfifo_last;


ARCHITECTURE rtl OF interlock_ip_rdfifo_last IS

  -- Component Declarations
  COMPONENT interlock_ip_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : interlock_ip_SimpleDualPortRAM_singlebit
    USE ENTITY work.interlock_ip_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_interlock_ip_rdfifo_last_classic_ram_singlebit : interlock_ip_SimpleDualPortRAM_singlebit
