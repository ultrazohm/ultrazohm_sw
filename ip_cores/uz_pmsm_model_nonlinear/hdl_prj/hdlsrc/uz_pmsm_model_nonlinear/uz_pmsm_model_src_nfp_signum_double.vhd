-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\Philipp\ultrazohm\ultrazohm_sw\ip_cores\uz_pmsm_model_nonlinear\hdl_prj\hdlsrc\uz_pmsm_model_nonlinear\uz_pmsm_model_src_nfp_signum_double.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_src_nfp_signum_double
-- Source Path: uz_pmsm_model_nonlinear/uz_pmsm_model/nfp_signum_double
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_pmsm_model_src_nfp_signum_double IS
  PORT( nfp_in                            :   IN    std_logic_vector(63 DOWNTO 0);  -- ufix64
        nfp_out                           :   OUT   std_logic_vector(63 DOWNTO 0)  -- ufix64
        );
END uz_pmsm_model_src_nfp_signum_double;


ARCHITECTURE rtl OF uz_pmsm_model_src_nfp_signum_double IS
