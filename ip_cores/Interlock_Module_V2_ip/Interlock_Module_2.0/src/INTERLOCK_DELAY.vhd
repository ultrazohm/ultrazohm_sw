...
ARCHITECTURE rtl OF INTERLOCK_DELAY IS
  ...
  SIGNAL Delay0_reg                       : std_logic_vector(0 TO (DELAY_COUNT-1));  -- ufix1 [10]
  ...
  SIGNAL Delay1_reg                       : std_logic_vector(0 TO (DELAY_COUNT-1));  -- ufix1 [10]
  ...
  SIGNAL Delay2_reg                       : std_logic_vector(0 TO (DELAY_COUNT-1));  -- ufix1 [10]
  ...
  SIGNAL Delay3_reg                       : std_logic_vector(0 TO (DELAY_COUNT-1));  -- ufix1 [10]
  ...
  SIGNAL Delay4_reg                       : std_logic_vector(0 TO (DELAY_COUNT-1));  -- ufix1 [10]
  ...
  SIGNAL Delay5_reg                       : std_logic_vector(0 TO (DELAY_COUNT-1));  -- ufix1 [10]
...
BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        ...
        ELSE 
          ...
          Delay0_reg(1 TO (DELAY_COUNT-1)) <= Delay0_reg(0 TO (DELAY_COUNT-2));
        END IF;
      END IF;
    END IF;
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        ...
        ELSE 
          ...
          Delay1_reg(1 TO (DELAY_COUNT-1)) <= Delay1_reg(0 TO (DELAY_COUNT-2));
        END IF;
      END IF;
    END IF;
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        ...
        ELSE 
          ...
          Delay2_reg(1 TO (DELAY_COUNT-1)) <= Delay2_reg(0 TO (DELAY_COUNT-2));
        END IF;
      END IF;
    END IF;
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        ...
        ELSE 
          ...
          Delay3_reg(1 TO (DELAY_COUNT-1)) <= Delay3_reg(0 TO (DELAY_COUNT-2));
        END IF;
      END IF;
    END IF;
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        ...
        ELSE 
          ...
          Delay4_reg(1 TO (DELAY_COUNT-1)) <= Delay4_reg(0 TO (DELAY_COUNT-2));
        END IF;
      END IF;
    END IF;
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        ...
        ELSE 
          ...
          Delay5_reg(1 TO (DELAY_COUNT-1)) <= Delay5_reg(0 TO (DELAY_COUNT-2));
        END IF;
      END IF;
    END IF;
  ...
  switch_compare_1_1 <= '1' WHEN INVERSE_BOTTOMSWITCH = true ELSE
      '0';
  ...
  switch_compare_1_2 <= '1' WHEN INVERSE_BOTTOMSWITCH = true ELSE
      '0';
  ...
  switch_compare_1_3 <= '1' WHEN INVERSE_BOTTOMSWITCH = true ELSE
      '0';
