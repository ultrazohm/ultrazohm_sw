-- -------------------------------------------------------------
-- 
-- File Name: /home/ts/Documents/integrate_nn_to_uz/ultrazohm_sw/ip_cores/nnAXI_v1_0/hdl_prj/hdlsrc/uz_mlp_three_layer/uz_mlp_three_layer_dut.vhd
...
ARCHITECTURE rtl OF uz_mlp_three_layer_dut IS
  ...
  COMPONENT uz_mlp_three_layer_src_pcu_mlp2_8parallel
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : uz_mlp_three_layer_src_pcu_mlp2_8parallel
    USE ENTITY work.uz_mlp_three_layer_src_pcu_mlp2_8parallel(rtl);
...
BEGIN
  u_uz_mlp_three_layer_src_pcu_mlp2_8parallel : uz_mlp_three_layer_src_pcu_mlp2_8parallel
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
