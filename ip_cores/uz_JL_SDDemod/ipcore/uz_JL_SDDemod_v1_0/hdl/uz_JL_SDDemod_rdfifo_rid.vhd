-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\jonat\Documents\ultrazohm_sw\ip_cores\uz_JL_SDDemod\hdlsrc\uz_JL_SDDemodulator\uz_JL_SDDemod_rdfifo_rid.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_JL_SDDemod_rdfifo_rid
-- Source Path: uz_JL_SDDemod/uz_JL_SDDemod_axi4/uz_JL_SDDemod_axi4_module/uz_JL_SDDemod_rdfifo_rid
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_JL_SDDemod_rdfifo_rid IS
...
END uz_JL_SDDemod_rdfifo_rid;


ARCHITECTURE rtl OF uz_JL_SDDemod_rdfifo_rid IS
...
BEGIN
  ...
  u_uz_JL_SDDemod_rdfifo_rid_classic_ram : uz_JL_SDDemod_SimpleDualPortRAM_generic
