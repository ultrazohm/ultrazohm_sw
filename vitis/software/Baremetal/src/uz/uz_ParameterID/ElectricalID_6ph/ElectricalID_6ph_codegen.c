...
static void LM_algorithm_h(const uz_ParaID_GlobalConfig_t *GlobalConfig,
  ...
  DW_ElectricalID_6ph_codegen_t *rtElectricalID_6ph_codegen_DW);
static void alignRotor_d_on(ExtU_ElectricalID_6ph_codegen_t
  *rtElectricalID_6ph_codegen_U, ExtY_ElectricalID_6ph_codegen_t
  *rtElectricalID_6ph_codegen_Y, DW_ElectricalID_6ph_codegen_t
  *rtElectricalID_6ph_codegen_DW);
  ...
  DW_ElectricalID_6ph_codegen_t *rtElectricalID_6ph_codegen_DW)
{
  ...
  *L_est = 5.0E-6F;
  ...
  rtElectricalID_6ph_codegen_DW->b_a = *n_iters_hn;
  for (rtElectricalID_6ph_codegen_DW->it_e = 0;
       rtElectricalID_6ph_codegen_DW->it_e < rtElectricalID_6ph_codegen_DW->b_a;
       rtElectricalID_6ph_codegen_DW->it_e++) {
    real32_T y_idx_1;
    ...
    if (*updateJ_ok) {
      ...
      for (rtElectricalID_6ph_codegen_DW->k_a = 0;
           rtElectricalID_6ph_codegen_DW->k_a < 1024;
           rtElectricalID_6ph_codegen_DW->k_a++) {
        ...
        rtElectricalID_6ph_codegen_DW->r_e = expf(-((((real32_T)
          rtElectricalID_6ph_codegen_DW->k_a + 1.0F) - 1.0F) * *R_est *
          GlobalConfig->sampleTimeISR) / *L_est);
        rtElectricalID_6ph_codegen_DW->J_i[rtElectricalID_6ph_codegen_DW->k_a] =
          -((rtElectricalID_6ph_codegen_DW->r_e - 1.0F) *
            rtElectricalID_6ph_codegen_DW->V0_n4) / (*R_est * *R_est) -
          (((real32_T)rtElectricalID_6ph_codegen_DW->k_a + 1.0F) - 1.0F) *
          rtElectricalID_6ph_codegen_DW->V0_n4 * GlobalConfig->sampleTimeISR *
          rtElectricalID_6ph_codegen_DW->r_e / (*L_est * *R_est);
        rtElectricalID_6ph_codegen_DW->J_i[rtElectricalID_6ph_codegen_DW->k_a +
          2048] = expf(-((((real32_T)rtElectricalID_6ph_codegen_DW->k_a + 1.0F)
                          - 1.0F) * *R_est * GlobalConfig->sampleTimeISR) /
                       *L_est) * ((((real32_T)rtElectricalID_6ph_codegen_DW->k_a
        ...
        i_est_lb[rtElectricalID_6ph_codegen_DW->k_a] = (1.0F - expf((((real32_T)
          rtElectricalID_6ph_codegen_DW->k_a + 1.0F) - 1.0F) *
          GlobalConfig->sampleTimeISR * -*R_est / *L_est)) *
          (rtElectricalID_6ph_codegen_DW->V0_n4 / *R_est);
        rtElectricalID_6ph_codegen_DW->d_e[rtElectricalID_6ph_codegen_DW->k_a] =
          rtElectricalID_6ph_codegen_DW->
          current_meas_array_bf[rtElectricalID_6ph_codegen_DW->k_a] -
          i_est_lb[rtElectricalID_6ph_codegen_DW->k_a];
      }

      /*  Approximierte Hesse-Matrix berechnen */
      /* '<S2>:36:42' H = J(1:1024,:)'*J(1:1024,:); */
      for (rtElectricalID_6ph_codegen_DW->k_a = 0;
           rtElectricalID_6ph_codegen_DW->k_a < 2;
           rtElectricalID_6ph_codegen_DW->k_a++) {
        for (rtElectricalID_6ph_codegen_DW->i13 = 0;
             rtElectricalID_6ph_codegen_DW->i13 < 2;
             rtElectricalID_6ph_codegen_DW->i13++) {
          int32_T tmp;
          tmp = (rtElectricalID_6ph_codegen_DW->i13 << 1) +
            rtElectricalID_6ph_codegen_DW->k_a;
          H_iu[tmp] = 0.0F;
          for (rtElectricalID_6ph_codegen_DW->i14 = 0;
               rtElectricalID_6ph_codegen_DW->i14 < 1024;
               rtElectricalID_6ph_codegen_DW->i14++) {
            H_iu[tmp] += rtElectricalID_6ph_codegen_DW->J_i
              [(rtElectricalID_6ph_codegen_DW->k_a << 11) +
              rtElectricalID_6ph_codegen_DW->i14] *
              rtElectricalID_6ph_codegen_DW->J_i
              [(rtElectricalID_6ph_codegen_DW->i13 << 11) +
              rtElectricalID_6ph_codegen_DW->i14];
          }
        }
      }
      ...
      /* '<S2>:36:43' if it==1 */
      if (rtElectricalID_6ph_codegen_DW->it_e + 1 == 1) {
        /* '<S2>:36:44' e = dot(d,d); */
        *e_d = 0.0F;
        for (rtElectricalID_6ph_codegen_DW->k_a = 0;
             rtElectricalID_6ph_codegen_DW->k_a < 2048;
             rtElectricalID_6ph_codegen_DW->k_a++) {
          *e_d += rtElectricalID_6ph_codegen_DW->
            d_e[rtElectricalID_6ph_codegen_DW->k_a] *
    ...
    rtElectricalID_6ph_codegen_DW->e_lm_j = 0.0F;
    y_idx_1 = 0.0F;
    for (rtElectricalID_6ph_codegen_DW->k_a = 0;
         rtElectricalID_6ph_codegen_DW->k_a < 1024;
         rtElectricalID_6ph_codegen_DW->k_a++) {
      rtElectricalID_6ph_codegen_DW->e_lm_j +=
        rtElectricalID_6ph_codegen_DW->J_i[rtElectricalID_6ph_codegen_DW->k_a %
        1024] * rtElectricalID_6ph_codegen_DW->d_e
        [rtElectricalID_6ph_codegen_DW->k_a];
      y_idx_1 += rtElectricalID_6ph_codegen_DW->J_i
        [(rtElectricalID_6ph_codegen_DW->k_a + 1024) % 1024 + 2048] *
        rtElectricalID_6ph_codegen_DW->d_e[rtElectricalID_6ph_codegen_DW->k_a];
    }

    if (fabsf(H_iu[1]) > fabsf(H_iu[0])) {
      rtElectricalID_6ph_codegen_DW->r_e = H_iu[0] / H_iu[1];
      rtElectricalID_6ph_codegen_DW->t_bj = 1.0F /
        (rtElectricalID_6ph_codegen_DW->r_e * H_iu[3] - H_iu[2]);
      rtElectricalID_6ph_codegen_DW->b_y_idx_0_f = H_iu[3] / H_iu[1] *
        rtElectricalID_6ph_codegen_DW->t_bj;
      rtElectricalID_6ph_codegen_DW->b_y_idx_1_a =
        -rtElectricalID_6ph_codegen_DW->t_bj;
      rtElectricalID_6ph_codegen_DW->b_y_idx_2_j = -H_iu[2] / H_iu[1] *
        rtElectricalID_6ph_codegen_DW->t_bj;
      rtElectricalID_6ph_codegen_DW->t_bj *= rtElectricalID_6ph_codegen_DW->r_e;
    } else {
      rtElectricalID_6ph_codegen_DW->r_e = H_iu[1] / H_iu[0];
      rtElectricalID_6ph_codegen_DW->t_bj = 1.0F / (H_iu[3] -
        rtElectricalID_6ph_codegen_DW->r_e * H_iu[2]);
      rtElectricalID_6ph_codegen_DW->b_y_idx_0_f = H_iu[3] / H_iu[0] *
        rtElectricalID_6ph_codegen_DW->t_bj;
      rtElectricalID_6ph_codegen_DW->b_y_idx_1_a =
        -rtElectricalID_6ph_codegen_DW->r_e *
        rtElectricalID_6ph_codegen_DW->t_bj;
      rtElectricalID_6ph_codegen_DW->b_y_idx_2_j = -H_iu[2] / H_iu[0] *
        rtElectricalID_6ph_codegen_DW->t_bj;
    }
    ...
    rtElectricalID_6ph_codegen_DW->r_e =
      (-rtElectricalID_6ph_codegen_DW->b_y_idx_0_f *
       rtElectricalID_6ph_codegen_DW->e_lm_j +
       -rtElectricalID_6ph_codegen_DW->b_y_idx_2_j * y_idx_1) + *R_est;

    /* '<S2>:36:55' L_lm = L_est + dp(2); */
    rtElectricalID_6ph_codegen_DW->t_bj =
      (-rtElectricalID_6ph_codegen_DW->b_y_idx_1_a *
       rtElectricalID_6ph_codegen_DW->e_lm_j +
       -rtElectricalID_6ph_codegen_DW->t_bj * y_idx_1) + *L_est;
    ...
    for (rtElectricalID_6ph_codegen_DW->k_a = 0;
      ...
      i_est_lb[rtElectricalID_6ph_codegen_DW->k_a] = (1.0F - expf((((real32_T)
        rtElectricalID_6ph_codegen_DW->k_a + 1.0F) - 1.0F) *
        GlobalConfig->sampleTimeISR * -rtElectricalID_6ph_codegen_DW->r_e /
        rtElectricalID_6ph_codegen_DW->t_bj)) *
    ...
    /* '<S2>:36:66' if e_lm < e */
    if (rtElectricalID_6ph_codegen_DW->e_lm_j < *e_d) {
      /* '<S2>:36:67' lambda = lambda/10; */
      *lambda_l /= 10.0F;

      /* '<S2>:36:68' R_est = R_lm; */
      *R_est = rtElectricalID_6ph_codegen_DW->r_e;

      /* '<S2>:36:69' L_est = L_lm; */
      *L_est = rtElectricalID_6ph_codegen_DW->t_bj;

      /* '<S2>:36:70' e = e_lm; */
      *e_d = rtElectricalID_6ph_codegen_DW->e_lm_j;
  ...
  i_est_o[2048], DW_ElectricalID_6ph_codegen_t *rtElectricalID_6ph_codegen_DW)
{
  ...
  *L_est = 5.0E-6F;
  ...
  rtElectricalID_6ph_codegen_DW->b_ct = *n_iters_h;
  for (rtElectricalID_6ph_codegen_DW->it_p = 0;
       rtElectricalID_6ph_codegen_DW->it_p < rtElectricalID_6ph_codegen_DW->b_ct;
       rtElectricalID_6ph_codegen_DW->it_p++) {
    real32_T y_idx_1;
    ...
    if (*updateJ_j) {
      ...
      for (rtElectricalID_6ph_codegen_DW->k_p = 0;
        ...
        rtElectricalID_6ph_codegen_DW->J_p[rtElectricalID_6ph_codegen_DW->k_p] =
          ...
          rtElectricalID_6ph_codegen_DW->r_nu / (*L_est * *R_est);
        rtElectricalID_6ph_codegen_DW->J_p[rtElectricalID_6ph_codegen_DW->k_p +
      ...
      /* '<S3>:36:43' if it==1 */
      if (rtElectricalID_6ph_codegen_DW->it_p + 1 == 1) {
        /* '<S3>:36:44' e = dot(d,d); */
        *e_b = 0.0F;
        for (rtElectricalID_6ph_codegen_DW->k_p = 0;
    ...
    rtElectricalID_6ph_codegen_DW->e_lm_ln = 0.0F;
    y_idx_1 = 0.0F;
    for (rtElectricalID_6ph_codegen_DW->k_p = 0;
         rtElectricalID_6ph_codegen_DW->k_p < 1024;
         rtElectricalID_6ph_codegen_DW->k_p++) {
      rtElectricalID_6ph_codegen_DW->e_lm_ln +=
        rtElectricalID_6ph_codegen_DW->J_p[rtElectricalID_6ph_codegen_DW->k_p %
    ...
    if (fabsf(H_iq[1]) > fabsf(H_iq[0])) {
      rtElectricalID_6ph_codegen_DW->r_nu = H_iq[0] / H_iq[1];
      rtElectricalID_6ph_codegen_DW->t_b = 1.0F /
        (rtElectricalID_6ph_codegen_DW->r_nu * H_iq[3] - H_iq[2]);
      rtElectricalID_6ph_codegen_DW->b_y_idx_0_h = H_iq[3] / H_iq[1] *
        rtElectricalID_6ph_codegen_DW->t_b;
      rtElectricalID_6ph_codegen_DW->b_y_idx_1_b =
        -rtElectricalID_6ph_codegen_DW->t_b;
      rtElectricalID_6ph_codegen_DW->b_y_idx_2_d = -H_iq[2] / H_iq[1] *
        rtElectricalID_6ph_codegen_DW->t_b;
      rtElectricalID_6ph_codegen_DW->t_b *= rtElectricalID_6ph_codegen_DW->r_nu;
    } else {
      rtElectricalID_6ph_codegen_DW->r_nu = H_iq[1] / H_iq[0];
      rtElectricalID_6ph_codegen_DW->t_b = 1.0F / (H_iq[3] -
        rtElectricalID_6ph_codegen_DW->r_nu * H_iq[2]);
      rtElectricalID_6ph_codegen_DW->b_y_idx_0_h = H_iq[3] / H_iq[0] *
        rtElectricalID_6ph_codegen_DW->t_b;
      rtElectricalID_6ph_codegen_DW->b_y_idx_1_b =
        -rtElectricalID_6ph_codegen_DW->r_nu *
        rtElectricalID_6ph_codegen_DW->t_b;
      rtElectricalID_6ph_codegen_DW->b_y_idx_2_d = -H_iq[2] / H_iq[0] *
        rtElectricalID_6ph_codegen_DW->t_b;
    }

    /* '<S3>:36:54' R_lm = R_est + dp(1); */
    rtElectricalID_6ph_codegen_DW->r_nu =
      (-rtElectricalID_6ph_codegen_DW->b_y_idx_0_h *
       rtElectricalID_6ph_codegen_DW->e_lm_ln +
    ...
    rtElectricalID_6ph_codegen_DW->t_b =
      (-rtElectricalID_6ph_codegen_DW->b_y_idx_1_b *
       rtElectricalID_6ph_codegen_DW->e_lm_ln +
       -rtElectricalID_6ph_codegen_DW->t_b * y_idx_1) + *L_est;
    ...
    for (rtElectricalID_6ph_codegen_DW->k_p = 0;
      ...
      i_est_o[rtElectricalID_6ph_codegen_DW->k_p] = (1.0F - expf((((real32_T)
        rtElectricalID_6ph_codegen_DW->k_p + 1.0F) - 1.0F) *
        GlobalConfig->sampleTimeISR * -rtElectricalID_6ph_codegen_DW->r_nu /
        rtElectricalID_6ph_codegen_DW->t_b)) *
    ...
    /*  Fallunterscheidung ob Fehler groesser oder kleiner geworden ist */
    /* '<S3>:36:66' if e_lm < e */
    if (rtElectricalID_6ph_codegen_DW->e_lm_ln < *e_b) {
      /* '<S3>:36:67' lambda = lambda/10; */
      *lambda_g /= 10.0F;

      /* '<S3>:36:68' R_est = R_lm; */
      *R_est = rtElectricalID_6ph_codegen_DW->r_nu;

      /* '<S3>:36:69' L_est = L_lm; */
      *L_est = rtElectricalID_6ph_codegen_DW->t_b;

      /* '<S3>:36:70' e = e_lm; */
      *e_b = rtElectricalID_6ph_codegen_DW->e_lm_ln;
  ...
  i_est_l[2048], DW_ElectricalID_6ph_codegen_t *rtElectricalID_6ph_codegen_DW)
{
  ...
  *L_est = 5.0E-6F;
  ...
  rtElectricalID_6ph_codegen_DW->b_j = *n_iters_o;
  for (rtElectricalID_6ph_codegen_DW->it_h = 0;
       rtElectricalID_6ph_codegen_DW->it_h < rtElectricalID_6ph_codegen_DW->b_j;
       rtElectricalID_6ph_codegen_DW->it_h++) {
    real32_T y_idx_1;
    ...
    if (*updateJ_o1) {
      ...
      for (rtElectricalID_6ph_codegen_DW->k_c = 0;
           rtElectricalID_6ph_codegen_DW->k_c < 1024;
           rtElectricalID_6ph_codegen_DW->k_c++) {
        ...
        rtElectricalID_6ph_codegen_DW->r_l = expf(-((((real32_T)
          rtElectricalID_6ph_codegen_DW->k_c + 1.0F) - 1.0F) * *R_est *
          GlobalConfig->sampleTimeISR) / *L_est);
        rtElectricalID_6ph_codegen_DW->J_bk[rtElectricalID_6ph_codegen_DW->k_c] =
          -((rtElectricalID_6ph_codegen_DW->r_l - 1.0F) *
            rtElectricalID_6ph_codegen_DW->V0_a) / (*R_est * *R_est) -
          (((real32_T)rtElectricalID_6ph_codegen_DW->k_c + 1.0F) - 1.0F) *
          rtElectricalID_6ph_codegen_DW->V0_a * GlobalConfig->sampleTimeISR *
          rtElectricalID_6ph_codegen_DW->r_l / (*L_est * *R_est);
        rtElectricalID_6ph_codegen_DW->J_bk[rtElectricalID_6ph_codegen_DW->k_c +
          2048] = expf(-((((real32_T)rtElectricalID_6ph_codegen_DW->k_c + 1.0F)
                          - 1.0F) * *R_est * GlobalConfig->sampleTimeISR) /
                       *L_est) * ((((real32_T)rtElectricalID_6ph_codegen_DW->k_c
          + 1.0F) - 1.0F) * rtElectricalID_6ph_codegen_DW->V0_a *
          GlobalConfig->sampleTimeISR) / (*L_est * *L_est);

        /* . */
        /* '<S4>:36:37' i_est(k) = V0/R_est*(1-exp(-R_est*((k-1)*GlobalConfig.sampleTimeISR)/L_est)); */
        i_est_l[rtElectricalID_6ph_codegen_DW->k_c] = (1.0F - expf((((real32_T)
          rtElectricalID_6ph_codegen_DW->k_c + 1.0F) - 1.0F) *
          GlobalConfig->sampleTimeISR * -*R_est / *L_est)) *
          (rtElectricalID_6ph_codegen_DW->V0_a / *R_est);
        rtElectricalID_6ph_codegen_DW->d_p[rtElectricalID_6ph_codegen_DW->k_c] =
          rtElectricalID_6ph_codegen_DW->
          current_meas_array_b[rtElectricalID_6ph_codegen_DW->k_c] -
          i_est_l[rtElectricalID_6ph_codegen_DW->k_c];
      }

      /*  Approximierte Hesse-Matrix berechnen */
      /* '<S4>:36:42' H = J(1:1024,:)'*J(1:1024,:); */
      for (rtElectricalID_6ph_codegen_DW->k_c = 0;
           rtElectricalID_6ph_codegen_DW->k_c < 2;
           rtElectricalID_6ph_codegen_DW->k_c++) {
        for (rtElectricalID_6ph_codegen_DW->i9 = 0;
          ...
          for (rtElectricalID_6ph_codegen_DW->i10 = 0;
            ...
            H_d[tmp] += rtElectricalID_6ph_codegen_DW->J_bk
              [(rtElectricalID_6ph_codegen_DW->k_c << 11) +
              rtElectricalID_6ph_codegen_DW->i10] *
      ...
      /* '<S4>:36:43' if it==1 */
      if (rtElectricalID_6ph_codegen_DW->it_h + 1 == 1) {
        /* '<S4>:36:44' e = dot(d,d); */
        *e_ib = 0.0F;
        for (rtElectricalID_6ph_codegen_DW->k_c = 0;
             rtElectricalID_6ph_codegen_DW->k_c < 2048;
             rtElectricalID_6ph_codegen_DW->k_c++) {
          *e_ib += rtElectricalID_6ph_codegen_DW->
            d_p[rtElectricalID_6ph_codegen_DW->k_c] *
    ...
    for (rtElectricalID_6ph_codegen_DW->k_c = 0;
      ...
      y_idx_1 += rtElectricalID_6ph_codegen_DW->J_bk
        [(rtElectricalID_6ph_codegen_DW->k_c + 1024) % 1024 + 2048] *
        rtElectricalID_6ph_codegen_DW->d_p[rtElectricalID_6ph_codegen_DW->k_c];
    }

    if (fabsf(H_d[1]) > fabsf(H_d[0])) {
      rtElectricalID_6ph_codegen_DW->r_l = H_d[0] / H_d[1];
      rtElectricalID_6ph_codegen_DW->t_d = 1.0F /
        (rtElectricalID_6ph_codegen_DW->r_l * H_d[3] - H_d[2]);
      rtElectricalID_6ph_codegen_DW->b_y_idx_0_l = H_d[3] / H_d[1] *
        rtElectricalID_6ph_codegen_DW->t_d;
      rtElectricalID_6ph_codegen_DW->b_y_idx_1_o =
        -rtElectricalID_6ph_codegen_DW->t_d;
      rtElectricalID_6ph_codegen_DW->b_y_idx_2_b = -H_d[2] / H_d[1] *
        rtElectricalID_6ph_codegen_DW->t_d;
      rtElectricalID_6ph_codegen_DW->t_d *= rtElectricalID_6ph_codegen_DW->r_l;
    } else {
      rtElectricalID_6ph_codegen_DW->r_l = H_d[1] / H_d[0];
      rtElectricalID_6ph_codegen_DW->t_d = 1.0F / (H_d[3] -
        rtElectricalID_6ph_codegen_DW->r_l * H_d[2]);
      rtElectricalID_6ph_codegen_DW->b_y_idx_0_l = H_d[3] / H_d[0] *
        rtElectricalID_6ph_codegen_DW->t_d;
      rtElectricalID_6ph_codegen_DW->b_y_idx_1_o =
        -rtElectricalID_6ph_codegen_DW->r_l * rtElectricalID_6ph_codegen_DW->t_d;
      rtElectricalID_6ph_codegen_DW->b_y_idx_2_b = -H_d[2] / H_d[0] *
        rtElectricalID_6ph_codegen_DW->t_d;
    }

    /* '<S4>:36:54' R_lm = R_est + dp(1); */
    rtElectricalID_6ph_codegen_DW->r_l =
    ...
    rtElectricalID_6ph_codegen_DW->t_d =
      (-rtElectricalID_6ph_codegen_DW->b_y_idx_1_o *
       rtElectricalID_6ph_codegen_DW->e_lm_d +
       -rtElectricalID_6ph_codegen_DW->t_d * y_idx_1) + *L_est;
    ...
    for (rtElectricalID_6ph_codegen_DW->k_c = 0;
      ...
      i_est_l[rtElectricalID_6ph_codegen_DW->k_c] = (1.0F - expf((((real32_T)
        rtElectricalID_6ph_codegen_DW->k_c + 1.0F) - 1.0F) *
        GlobalConfig->sampleTimeISR * -rtElectricalID_6ph_codegen_DW->r_l /
        rtElectricalID_6ph_codegen_DW->t_d)) *
    ...
    if (rtElectricalID_6ph_codegen_DW->e_lm_d < *e_ib) {
      ...
      *lambda_h /= 10.0F;
      ...
      /* '<S4>:36:68' R_est = R_lm; */
      *R_est = rtElectricalID_6ph_codegen_DW->r_l;

      /* '<S4>:36:69' L_est = L_lm; */
      *L_est = rtElectricalID_6ph_codegen_DW->t_d;
  ...
  i_est_m[2048], DW_ElectricalID_6ph_codegen_t *rtElectricalID_6ph_codegen_DW)
{
  ...
  *L_est = 5.0E-6F;
  ...
  rtElectricalID_6ph_codegen_DW->b_c = *n_iters_l;
  for (rtElectricalID_6ph_codegen_DW->it_m = 0;
       rtElectricalID_6ph_codegen_DW->it_m < rtElectricalID_6ph_codegen_DW->b_c;
       rtElectricalID_6ph_codegen_DW->it_m++) {
    real32_T y_idx_1;
    ...
    if (*updateJ_h) {
      ...
      for (rtElectricalID_6ph_codegen_DW->k_m3 = 0;
           rtElectricalID_6ph_codegen_DW->k_m3 < 1024;
           rtElectricalID_6ph_codegen_DW->k_m3++) {
        ...
        rtElectricalID_6ph_codegen_DW->r_n = expf(-((((real32_T)
          rtElectricalID_6ph_codegen_DW->k_m3 + 1.0F) - 1.0F) * *R_est *
          GlobalConfig->sampleTimeISR) / *L_est);
        rtElectricalID_6ph_codegen_DW->J_b[rtElectricalID_6ph_codegen_DW->k_m3] =
          -((rtElectricalID_6ph_codegen_DW->r_n - 1.0F) *
            rtElectricalID_6ph_codegen_DW->V0_n) / (*R_est * *R_est) -
          (((real32_T)rtElectricalID_6ph_codegen_DW->k_m3 + 1.0F) - 1.0F) *
          rtElectricalID_6ph_codegen_DW->V0_n * GlobalConfig->sampleTimeISR *
          rtElectricalID_6ph_codegen_DW->r_n / (*L_est * *R_est);
        rtElectricalID_6ph_codegen_DW->J_b[rtElectricalID_6ph_codegen_DW->k_m3 +
          2048] = expf(-((((real32_T)rtElectricalID_6ph_codegen_DW->k_m3 + 1.0F)
                          - 1.0F) * *R_est * GlobalConfig->sampleTimeISR) /
                       *L_est) * ((((real32_T)
          rtElectricalID_6ph_codegen_DW->k_m3 + 1.0F) - 1.0F) *
          rtElectricalID_6ph_codegen_DW->V0_n * GlobalConfig->sampleTimeISR) / (*
          L_est * *L_est);

        /* . */
        /* '<S5>:36:37' i_est(k) = V0/R_est*(1-exp(-R_est*((k-1)*GlobalConfig.sampleTimeISR)/L_est)); */
        i_est_m[rtElectricalID_6ph_codegen_DW->k_m3] = (1.0F - expf((((real32_T)
          rtElectricalID_6ph_codegen_DW->k_m3 + 1.0F) - 1.0F) *
          GlobalConfig->sampleTimeISR * -*R_est / *L_est)) *
          (rtElectricalID_6ph_codegen_DW->V0_n / *R_est);
        rtElectricalID_6ph_codegen_DW->d_n[rtElectricalID_6ph_codegen_DW->k_m3] =
          rtElectricalID_6ph_codegen_DW->
          current_meas_array_k[rtElectricalID_6ph_codegen_DW->k_m3] -
          i_est_m[rtElectricalID_6ph_codegen_DW->k_m3];
      }

      /*  Approximierte Hesse-Matrix berechnen */
      /* '<S5>:36:42' H = J(1:1024,:)'*J(1:1024,:); */
      for (rtElectricalID_6ph_codegen_DW->k_m3 = 0;
           rtElectricalID_6ph_codegen_DW->k_m3 < 2;
           rtElectricalID_6ph_codegen_DW->k_m3++) {
        for (rtElectricalID_6ph_codegen_DW->i7 = 0;
          ...
          for (rtElectricalID_6ph_codegen_DW->i8 = 0;
            ...
            H_l[tmp] += rtElectricalID_6ph_codegen_DW->J_b
              [(rtElectricalID_6ph_codegen_DW->k_m3 << 11) +
              rtElectricalID_6ph_codegen_DW->i8] *
      ...
      /* '<S5>:36:43' if it==1 */
      if (rtElectricalID_6ph_codegen_DW->it_m + 1 == 1) {
        /* '<S5>:36:44' e = dot(d,d); */
        *e_i = 0.0F;
        for (rtElectricalID_6ph_codegen_DW->k_m3 = 0;
             rtElectricalID_6ph_codegen_DW->k_m3 < 2048;
             rtElectricalID_6ph_codegen_DW->k_m3++) {
          *e_i += rtElectricalID_6ph_codegen_DW->
            d_n[rtElectricalID_6ph_codegen_DW->k_m3] *
    ...
    rtElectricalID_6ph_codegen_DW->e_lm_l = 0.0F;
    y_idx_1 = 0.0F;
    for (rtElectricalID_6ph_codegen_DW->k_m3 = 0;
         rtElectricalID_6ph_codegen_DW->k_m3 < 1024;
         rtElectricalID_6ph_codegen_DW->k_m3++) {
      rtElectricalID_6ph_codegen_DW->e_lm_l +=
        rtElectricalID_6ph_codegen_DW->J_b[rtElectricalID_6ph_codegen_DW->k_m3 %
        1024] * rtElectricalID_6ph_codegen_DW->d_n
        [rtElectricalID_6ph_codegen_DW->k_m3];
      y_idx_1 += rtElectricalID_6ph_codegen_DW->J_b
        [(rtElectricalID_6ph_codegen_DW->k_m3 + 1024) % 1024 + 2048] *
        rtElectricalID_6ph_codegen_DW->d_n[rtElectricalID_6ph_codegen_DW->k_m3];
    }

    if (fabsf(H_l[1]) > fabsf(H_l[0])) {
      rtElectricalID_6ph_codegen_DW->r_n = H_l[0] / H_l[1];
      rtElectricalID_6ph_codegen_DW->t_p = 1.0F /
        (rtElectricalID_6ph_codegen_DW->r_n * H_l[3] - H_l[2]);
      rtElectricalID_6ph_codegen_DW->b_y_idx_0_j = H_l[3] / H_l[1] *
        rtElectricalID_6ph_codegen_DW->t_p;
      rtElectricalID_6ph_codegen_DW->b_y_idx_1_d =
        -rtElectricalID_6ph_codegen_DW->t_p;
      rtElectricalID_6ph_codegen_DW->b_y_idx_2_g = -H_l[2] / H_l[1] *
        rtElectricalID_6ph_codegen_DW->t_p;
      rtElectricalID_6ph_codegen_DW->t_p *= rtElectricalID_6ph_codegen_DW->r_n;
    } else {
      rtElectricalID_6ph_codegen_DW->r_n = H_l[1] / H_l[0];
      rtElectricalID_6ph_codegen_DW->t_p = 1.0F / (H_l[3] -
        rtElectricalID_6ph_codegen_DW->r_n * H_l[2]);
      rtElectricalID_6ph_codegen_DW->b_y_idx_0_j = H_l[3] / H_l[0] *
        rtElectricalID_6ph_codegen_DW->t_p;
      rtElectricalID_6ph_codegen_DW->b_y_idx_1_d =
        -rtElectricalID_6ph_codegen_DW->r_n * rtElectricalID_6ph_codegen_DW->t_p;
      rtElectricalID_6ph_codegen_DW->b_y_idx_2_g = -H_l[2] / H_l[0] *
        rtElectricalID_6ph_codegen_DW->t_p;
    }

    /* '<S5>:36:54' R_lm = R_est + dp(1); */
    rtElectricalID_6ph_codegen_DW->r_n =
    ...
    for (rtElectricalID_6ph_codegen_DW->k_m3 = 0;
      ...
      i_est_m[rtElectricalID_6ph_codegen_DW->k_m3] = (1.0F - expf((((real32_T)
        rtElectricalID_6ph_codegen_DW->k_m3 + 1.0F) - 1.0F) *
        GlobalConfig->sampleTimeISR * -rtElectricalID_6ph_codegen_DW->r_n /
        rtElectricalID_6ph_codegen_DW->t_p)) *
    ...
    /*  Fallunterscheidung ob Fehler groesser oder kleiner geworden ist */
    /* '<S5>:36:66' if e_lm < e */
    if (rtElectricalID_6ph_codegen_DW->e_lm_l < *e_i) {
      /* '<S5>:36:67' lambda = lambda/10; */
      *lambda_j /= 10.0F;

      /* '<S5>:36:68' R_est = R_lm; */
      *R_est = rtElectricalID_6ph_codegen_DW->r_n;

      /* '<S5>:36:69' L_est = L_lm; */
      *L_est = rtElectricalID_6ph_codegen_DW->t_p;

      /* '<S5>:36:70' e = e_lm; */
      *e_i = rtElectricalID_6ph_codegen_DW->e_lm_l;
  ...
  i_est_f[2048], DW_ElectricalID_6ph_codegen_t *rtElectricalID_6ph_codegen_DW)
{
  ...
  *L_est = 5.0E-6F;
  ...
  rtElectricalID_6ph_codegen_DW->b_o = *n_iters_f;
  for (rtElectricalID_6ph_codegen_DW->it_n = 0;
       rtElectricalID_6ph_codegen_DW->it_n < rtElectricalID_6ph_codegen_DW->b_o;
       rtElectricalID_6ph_codegen_DW->it_n++) {
    real32_T y_idx_1;
    ...
    if (*updateJ_o) {
      ...
      for (rtElectricalID_6ph_codegen_DW->k_m = 0;
        ...
        rtElectricalID_6ph_codegen_DW->r_p = expf(-((((real32_T)
          rtElectricalID_6ph_codegen_DW->k_m + 1.0F) - 1.0F) * *R_est *
          GlobalConfig->sampleTimeISR) / *L_est);
        rtElectricalID_6ph_codegen_DW->J_k[rtElectricalID_6ph_codegen_DW->k_m] =
          -((rtElectricalID_6ph_codegen_DW->r_p - 1.0F) *
          ...
          rtElectricalID_6ph_codegen_DW->r_p / (*L_est * *R_est);
        rtElectricalID_6ph_codegen_DW->J_k[rtElectricalID_6ph_codegen_DW->k_m +
          2048] = expf(-((((real32_T)rtElectricalID_6ph_codegen_DW->k_m + 1.0F)
                          - 1.0F) * *R_est * GlobalConfig->sampleTimeISR) /
                       *L_est) * ((((real32_T)rtElectricalID_6ph_codegen_DW->k_m
          + 1.0F) - 1.0F) * rtElectricalID_6ph_codegen_DW->V0_k *
          GlobalConfig->sampleTimeISR) / (*L_est * *L_est);

        /* . */
        /* '<S6>:36:37' i_est(k) = V0/R_est*(1-exp(-R_est*((k-1)*GlobalConfig.sampleTimeISR)/L_est)); */
        i_est_f[rtElectricalID_6ph_codegen_DW->k_m] = (1.0F - expf((((real32_T)
          rtElectricalID_6ph_codegen_DW->k_m + 1.0F) - 1.0F) *
          GlobalConfig->sampleTimeISR * -*R_est / *L_est)) *
          (rtElectricalID_6ph_codegen_DW->V0_k / *R_est);
        rtElectricalID_6ph_codegen_DW->d_l[rtElectricalID_6ph_codegen_DW->k_m] =
          rtElectricalID_6ph_codegen_DW->
          current_meas_array_m[rtElectricalID_6ph_codegen_DW->k_m] -
          i_est_f[rtElectricalID_6ph_codegen_DW->k_m];
      }
      ...
      /* '<S6>:36:43' if it==1 */
      if (rtElectricalID_6ph_codegen_DW->it_n + 1 == 1) {
        /* '<S6>:36:44' e = dot(d,d); */
        *e_f = 0.0F;
        for (rtElectricalID_6ph_codegen_DW->k_m = 0;
          ...
          *e_f += rtElectricalID_6ph_codegen_DW->
            d_l[rtElectricalID_6ph_codegen_DW->k_m] *
    ...
    rtElectricalID_6ph_codegen_DW->e_lm_f = 0.0F;
    y_idx_1 = 0.0F;
    for (rtElectricalID_6ph_codegen_DW->k_m = 0;
         rtElectricalID_6ph_codegen_DW->k_m < 1024;
         rtElectricalID_6ph_codegen_DW->k_m++) {
      rtElectricalID_6ph_codegen_DW->e_lm_f +=
        rtElectricalID_6ph_codegen_DW->J_k[rtElectricalID_6ph_codegen_DW->k_m %
    ...
    if (fabsf(H_i[1]) > fabsf(H_i[0])) {
      rtElectricalID_6ph_codegen_DW->r_p = H_i[0] / H_i[1];
      rtElectricalID_6ph_codegen_DW->t_c = 1.0F /
        (rtElectricalID_6ph_codegen_DW->r_p * H_i[3] - H_i[2]);
      rtElectricalID_6ph_codegen_DW->b_y_idx_0_g = H_i[3] / H_i[1] *
        rtElectricalID_6ph_codegen_DW->t_c;
      rtElectricalID_6ph_codegen_DW->b_y_idx_1_g =
        -rtElectricalID_6ph_codegen_DW->t_c;
      rtElectricalID_6ph_codegen_DW->b_y_idx_2_m = -H_i[2] / H_i[1] *
        rtElectricalID_6ph_codegen_DW->t_c;
      rtElectricalID_6ph_codegen_DW->t_c *= rtElectricalID_6ph_codegen_DW->r_p;
    } else {
      rtElectricalID_6ph_codegen_DW->r_p = H_i[1] / H_i[0];
      rtElectricalID_6ph_codegen_DW->t_c = 1.0F / (H_i[3] -
        rtElectricalID_6ph_codegen_DW->r_p * H_i[2]);
      rtElectricalID_6ph_codegen_DW->b_y_idx_0_g = H_i[3] / H_i[0] *
        rtElectricalID_6ph_codegen_DW->t_c;
      rtElectricalID_6ph_codegen_DW->b_y_idx_1_g =
        -rtElectricalID_6ph_codegen_DW->r_p * rtElectricalID_6ph_codegen_DW->t_c;
      rtElectricalID_6ph_codegen_DW->b_y_idx_2_m = -H_i[2] / H_i[0] *
        rtElectricalID_6ph_codegen_DW->t_c;
    }

    /* '<S6>:36:54' R_lm = R_est + dp(1); */
    rtElectricalID_6ph_codegen_DW->r_p =
      (-rtElectricalID_6ph_codegen_DW->b_y_idx_0_g *
       rtElectricalID_6ph_codegen_DW->e_lm_f +
       -rtElectricalID_6ph_codegen_DW->b_y_idx_2_m * y_idx_1) + *R_est;

    /* '<S6>:36:55' L_lm = L_est + dp(2); */
    rtElectricalID_6ph_codegen_DW->t_c =
      (-rtElectricalID_6ph_codegen_DW->b_y_idx_1_g *
       rtElectricalID_6ph_codegen_DW->e_lm_f +
       -rtElectricalID_6ph_codegen_DW->t_c * y_idx_1) + *L_est;
    ...
    for (rtElectricalID_6ph_codegen_DW->k_m = 0;
      ...
      i_est_f[rtElectricalID_6ph_codegen_DW->k_m] = (1.0F - expf((((real32_T)
        rtElectricalID_6ph_codegen_DW->k_m + 1.0F) - 1.0F) *
        GlobalConfig->sampleTimeISR * -rtElectricalID_6ph_codegen_DW->r_p /
        rtElectricalID_6ph_codegen_DW->t_c)) *
    ...
    /*  Fallunterscheidung ob Fehler groesser oder kleiner geworden ist */
    /* '<S6>:36:66' if e_lm < e */
    if (rtElectricalID_6ph_codegen_DW->e_lm_f < *e_f) {
      /* '<S6>:36:67' lambda = lambda/10; */
      *lambda_n /= 10.0F;

      /* '<S6>:36:68' R_est = R_lm; */
      *R_est = rtElectricalID_6ph_codegen_DW->r_p;

      /* '<S6>:36:69' L_est = L_lm; */
      *L_est = rtElectricalID_6ph_codegen_DW->t_c;

      /* '<S6>:36:70' e = e_lm; */
      *e_f = rtElectricalID_6ph_codegen_DW->e_lm_f;
  ...
  DW_ElectricalID_6ph_codegen_t *rtElectricalID_6ph_codegen_DW)
{
  ...
  *L_est = 5.0E-6F;
  ...
  rtElectricalID_6ph_codegen_DW->b_n = *n_iters;
  for (rtElectricalID_6ph_codegen_DW->it = 0; rtElectricalID_6ph_codegen_DW->it <
       rtElectricalID_6ph_codegen_DW->b_n; rtElectricalID_6ph_codegen_DW->it++)
  {
    real32_T y_idx_1;
    ...
    if (*updateJ) {
      ...
      for (rtElectricalID_6ph_codegen_DW->k_i = 0;
           rtElectricalID_6ph_codegen_DW->k_i < 1024;
           rtElectricalID_6ph_codegen_DW->k_i++) {
        ...
        rtElectricalID_6ph_codegen_DW->r = expf(-((((real32_T)
          rtElectricalID_6ph_codegen_DW->k_i + 1.0F) - 1.0F) * *R_est *
          GlobalConfig->sampleTimeISR) / *L_est);
        rtElectricalID_6ph_codegen_DW->J[rtElectricalID_6ph_codegen_DW->k_i] =
          -((rtElectricalID_6ph_codegen_DW->r - 1.0F) *
            rtElectricalID_6ph_codegen_DW->V0) / (*R_est * *R_est) - (((real32_T)
          rtElectricalID_6ph_codegen_DW->k_i + 1.0F) - 1.0F) *
          rtElectricalID_6ph_codegen_DW->V0 * GlobalConfig->sampleTimeISR *
          rtElectricalID_6ph_codegen_DW->r / (*L_est * *R_est);
        rtElectricalID_6ph_codegen_DW->J[rtElectricalID_6ph_codegen_DW->k_i +
          2048] = expf(-((((real32_T)rtElectricalID_6ph_codegen_DW->k_i + 1.0F)
                          - 1.0F) * *R_est * GlobalConfig->sampleTimeISR) /
                       *L_est) * ((((real32_T)rtElectricalID_6ph_codegen_DW->k_i
          + 1.0F) - 1.0F) * rtElectricalID_6ph_codegen_DW->V0 *
          GlobalConfig->sampleTimeISR) / (*L_est * *L_est);

        /* . */
        /* '<S7>:36:37' i_est(k) = V0/R_est*(1-exp(-R_est*((k-1)*GlobalConfig.sampleTimeISR)/L_est)); */
        i_est_g[rtElectricalID_6ph_codegen_DW->k_i] = (1.0F - expf((((real32_T)
          rtElectricalID_6ph_codegen_DW->k_i + 1.0F) - 1.0F) *
          GlobalConfig->sampleTimeISR * -*R_est / *L_est)) *
          (rtElectricalID_6ph_codegen_DW->V0 / *R_est);
        rtElectricalID_6ph_codegen_DW->d_f[rtElectricalID_6ph_codegen_DW->k_i] =
          rtElectricalID_6ph_codegen_DW->
          current_meas_array[rtElectricalID_6ph_codegen_DW->k_i] -
          i_est_g[rtElectricalID_6ph_codegen_DW->k_i];
      }

      /*  Approximierte Hesse-Matrix berechnen */
      /* '<S7>:36:42' H = J(1:1024,:)'*J(1:1024,:); */
      for (rtElectricalID_6ph_codegen_DW->k_i = 0;
           rtElectricalID_6ph_codegen_DW->k_i < 2;
           rtElectricalID_6ph_codegen_DW->k_i++) {
        for (rtElectricalID_6ph_codegen_DW->i3 = 0;
          ...
          for (rtElectricalID_6ph_codegen_DW->i4 = 0;
            ...
            H[tmp] += rtElectricalID_6ph_codegen_DW->J
              [(rtElectricalID_6ph_codegen_DW->k_i << 11) +
              rtElectricalID_6ph_codegen_DW->i4] *
      ...
      if (rtElectricalID_6ph_codegen_DW->it + 1 == 1) {
        ...
        *e = 0.0F;
        for (rtElectricalID_6ph_codegen_DW->k_i = 0;
             rtElectricalID_6ph_codegen_DW->k_i < 2048;
             rtElectricalID_6ph_codegen_DW->k_i++) {
    ...
    for (rtElectricalID_6ph_codegen_DW->k_i = 0;
      ...
      rtElectricalID_6ph_codegen_DW->e_lm += rtElectricalID_6ph_codegen_DW->
        J[rtElectricalID_6ph_codegen_DW->k_i % 1024] *
        rtElectricalID_6ph_codegen_DW->d_f[rtElectricalID_6ph_codegen_DW->k_i];
      y_idx_1 += rtElectricalID_6ph_codegen_DW->J
        [(rtElectricalID_6ph_codegen_DW->k_i + 1024) % 1024 + 2048] *
        rtElectricalID_6ph_codegen_DW->d_f[rtElectricalID_6ph_codegen_DW->k_i];
    }
    ...
    for (rtElectricalID_6ph_codegen_DW->k_i = 0;
      ...
      rtElectricalID_6ph_codegen_DW->d_f[rtElectricalID_6ph_codegen_DW->k_i] =
        ...
        i_est_g[rtElectricalID_6ph_codegen_DW->k_i];
      rtElectricalID_6ph_codegen_DW->e_lm += rtElectricalID_6ph_codegen_DW->
        d_f[rtElectricalID_6ph_codegen_DW->k_i] *
        rtElectricalID_6ph_codegen_DW->d_f[rtElectricalID_6ph_codegen_DW->k_i];
    }
  ...
  *rtElectricalID_6ph_codegen_DW)
{
  ...
  if (rtElectricalID_6ph_codegen_DW->one_sec_transition_counter_k ==
    ...
    for (rtElectricalID_6ph_codegen_DW->i1 = 0;
         rtElectricalID_6ph_codegen_DW->i1 < 6;
         rtElectricalID_6ph_codegen_DW->i1++) {
      rtElectricalID_6ph_codegen_DW->setp_abc_c
        [rtElectricalID_6ph_codegen_DW->i1] = 0.0F;
      for (rtElectricalID_6ph_codegen_DW->i2 = 0;
           rtElectricalID_6ph_codegen_DW->i2 < 6;
           rtElectricalID_6ph_codegen_DW->i2++) {
        rtElectricalID_6ph_codegen_DW->setp_abc_c
          [rtElectricalID_6ph_codegen_DW->i1] +=
          rtElectricalID_6ph_codegen_DW->inv_VSD[6 *
          rtElectricalID_6ph_codegen_DW->i2 + rtElectricalID_6ph_codegen_DW->i1]
          * rtElectricalID_6ph_codegen_DW->fv[rtElectricalID_6ph_codegen_DW->i2];
      }
    }
    ...
    DutyCycle_tmp = rtElectricalID_6ph_codegen_U->ActualValues.V_DC / 2.0F;
    rtElectricalID_6ph_codegen_DW->DutyCycle_b =
      (rtElectricalID_6ph_codegen_DW->setp_abc_c[0] / DutyCycle_tmp + 1.0F) /
      2.0F;

    /* 'GenerateDutyCycle:3' if(DutyCycle < 0) */
    if (rtElectricalID_6ph_codegen_DW->DutyCycle_b < 0.0F) {
      /* 'GenerateDutyCycle:4' out = single(0); */
      rtElectricalID_6ph_codegen_DW->DutyCycle_b = 0.0F;
    } else if (rtElectricalID_6ph_codegen_DW->DutyCycle_b > 1.0F) {
      /* 'GenerateDutyCycle:5' elseif (DutyCycle > 1) */
      /* 'GenerateDutyCycle:6' out = single(1); */
      rtElectricalID_6ph_codegen_DW->DutyCycle_b = 1.0F;
    } else {
    ...
    /* 'GenerateDutyCycle:2' DutyCycle  = ( (voltage / (VDC/single(2)) + single(1)) /single(2)); */
    rtElectricalID_6ph_codegen_DW->DutyCycle_b =
      (rtElectricalID_6ph_codegen_DW->setp_abc_c[1] / DutyCycle_tmp + 1.0F) /
      2.0F;
    ...
    /* 'GenerateDutyCycle:2' DutyCycle  = ( (voltage / (VDC/single(2)) + single(1)) /single(2)); */
    rtElectricalID_6ph_codegen_DW->DutyCycle_b =
      (rtElectricalID_6ph_codegen_DW->setp_abc_c[2] / DutyCycle_tmp + 1.0F) /
      2.0F;
    ...
    /* 'GenerateDutyCycle:2' DutyCycle  = ( (voltage / (VDC/single(2)) + single(1)) /single(2)); */
    rtElectricalID_6ph_codegen_DW->DutyCycle_b =
      (rtElectricalID_6ph_codegen_DW->setp_abc_c[3] / DutyCycle_tmp + 1.0F) /
      2.0F;
    ...
    /* 'GenerateDutyCycle:2' DutyCycle  = ( (voltage / (VDC/single(2)) + single(1)) /single(2)); */
    rtElectricalID_6ph_codegen_DW->DutyCycle_b =
      (rtElectricalID_6ph_codegen_DW->setp_abc_c[4] / DutyCycle_tmp + 1.0F) /
      2.0F;
    ...
    /* 'GenerateDutyCycle:2' DutyCycle  = ( (voltage / (VDC/single(2)) + single(1)) /single(2)); */
    rtElectricalID_6ph_codegen_DW->DutyCycle_b =
      (rtElectricalID_6ph_codegen_DW->setp_abc_c[5] / DutyCycle_tmp + 1.0F) /
      2.0F;
  ...
  DW_ElectricalID_6ph_codegen_t *rtElectricalID_6ph_codegen_DW)
{
  ...
  rtElectricalID_6ph_codegen_DW->b = fabsf(u1);
  if (rtElectricalID_6ph_codegen_DW->a < rtElectricalID_6ph_codegen_DW->b) {
    rtElectricalID_6ph_codegen_DW->a /= rtElectricalID_6ph_codegen_DW->b;
    y = sqrtf(rtElectricalID_6ph_codegen_DW->a *
              rtElectricalID_6ph_codegen_DW->a + 1.0F) *
      rtElectricalID_6ph_codegen_DW->b;
  } else if (rtElectricalID_6ph_codegen_DW->a > rtElectricalID_6ph_codegen_DW->b)
  {
    rtElectricalID_6ph_codegen_DW->b /= rtElectricalID_6ph_codegen_DW->a;
    y = sqrtf(rtElectricalID_6ph_codegen_DW->b *
              rtElectricalID_6ph_codegen_DW->b + 1.0F) *
  ...
  *rtElectricalID_6ph_codegen_DW)
{
  ...
  switch (rtElectricalID_6ph_codegen_DW->is_ElectricalID) {
   ...
   case IN_measure_induced_voltage:
    ...
    for (rtElectricalID_6ph_codegen_DW->i_o = 0;
         rtElectricalID_6ph_codegen_DW->i_o < 5;
         rtElectricalID_6ph_codegen_DW->i_o++) {
      /* Outport: '<Root>/ElectricalID_output' incorporates:
       *  Inport: '<Root>/ElectricalID_fft_in'
       */
      rtElectricalID_6ph_codegen_Y->
        ElectricalID_output.psi_pm[rtElectricalID_6ph_codegen_DW->i_o] =
        rtElectricalID_6ph_codegen_U->
        ElectricalID_fft_in.psi_pm_amplitude[rtElectricalID_6ph_codegen_DW->i_o];
    }
    ...
    for (rtElectricalID_6ph_codegen_DW->i_o = 0;
       ...
       */
      rtElectricalID_6ph_codegen_Y->
        ElectricalID_output.psi_pm_angle[rtElectricalID_6ph_codegen_DW->i_o] =
        rtElectricalID_6ph_codegen_U->
        ElectricalID_fft_in.psi_pm_angle[rtElectricalID_6ph_codegen_DW->i_o];
    }
   ...
   case IN_stop:
    ...
    /* '<S1>:361:7' ElectricalID_FOC_output.i_dq_ref.d = single(0); */
    /* '<S1>:361:8' ElectricalID_FOC_output.i_dq_ref.q = single(0); */
    /* '<S1>:361:9' ElectricalID_FOC_output.enableFOC_speed = boolean(0); */
    rtElectricalID_6ph_codegen_Y->ElectricalID_FOC_output.enableFOC_speed =
      false;

    /* '<S1>:361:10' ElectricalID_FOC_output.i_dq_ref.d = single(0); */
    rtElectricalID_6ph_codegen_Y->ElectricalID_FOC_output.i_dq_ref.d = 0.0F;

    /* '<S1>:361:11' ElectricalID_FOC_output.i_dq_ref.q = single(0); */
    rtElectricalID_6ph_codegen_Y->ElectricalID_FOC_output.i_dq_ref.q = 0.0F;
    rtElectricalID_6ph_codegen_DW->is_ElectricalID = IN_NO_ACTIVE_CHILD;
    break;
    ...
    switch (rtElectricalID_6ph_codegen_DW->is_ElectricalID) {
     ...
     case IN_Subchart_Step_Response4:
      ...
      if (rtElectricalID_6ph_codegen_DW->exitPortIndex == 2U) {
        ...
        rtElectricalID_6ph_codegen_DW->e_d =
          rtElectricalID_6ph_codegen_Y->ElectricalID_output.PMSM_parameters.R_ph_Ohm;
        rtElectricalID_6ph_codegen_DW->PMSM_config_Ld_Henry =
          rtElectricalID_6ph_codegen_Y->ElectricalID_output.PMSM_parameters.Ld_Henry;
        rtElectricalID_6ph_codegen_DW->lambda_l =
          rtElectricalID_6ph_codegen_Y->ElectricalID_output.PMSM_parameters.Lq_Henry;
        rtElectricalID_6ph_codegen_DW->PMSM_config_polePairs =
          rtElectricalID_6ph_codegen_Y->ElectricalID_output.PMSM_parameters.polePairs;
        ...
        rtElectricalID_6ph_codegen_Y->ElectricalID_FOC_output.Kp_iq_out =
          rtElectricalID_6ph_codegen_DW->lambda_l * bandwidthCurrentControl;

        /* 'ControllerParameter:5' FOC_out_new.Ki_id_out = single(PMSM_config.R_ph_Ohm * bandwidthCurrentControl); */
        rtElectricalID_6ph_codegen_Y->ElectricalID_FOC_output.Ki_id_out =
          rtElectricalID_6ph_codegen_DW->e_d * bandwidthCurrentControl;
        ...
        rtElectricalID_6ph_codegen_Y->ElectricalID_FOC_output.Kp_n_out =
          rtElectricalID_6ph_codegen_DW->e_d /
          (rtElectricalID_6ph_codegen_DW->lambda_l * dampingFactor *
           rtElectricalID_6ph_codegen_DW->PMSM_config_polePairs * 3.0F / 2.0F *
           psiOverJ);
        ...
        rtElectricalID_6ph_codegen_Y->ElectricalID_FOC_output.Ki_n_out =
          ...
          rtElectricalID_6ph_codegen_DW->e_d /
          (rtElectricalID_6ph_codegen_DW->lambda_l *
           rtElectricalID_6ph_codegen_DW->lambda_l * 1000.0F *
           rtElectricalID_6ph_codegen_DW->PMSM_config_polePairs * 3.0F / 2.0F *
           psiOverJ);
      }
      break;
     ...
     case IN_alignRotor_d_on:
      alignRotor_d_on(rtElectricalID_6ph_codegen_U, rtElectricalID_6ph_codegen_Y,
                      rtElectricalID_6ph_codegen_DW);
      break;
