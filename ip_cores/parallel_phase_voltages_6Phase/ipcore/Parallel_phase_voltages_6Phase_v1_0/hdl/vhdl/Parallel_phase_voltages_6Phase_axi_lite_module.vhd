-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\parallel_phase_voltages_6Phase\hdlsrc\parallel_phase_voltages_per_switching_state_6\Parallel_phase_voltages_6Phase_axi_lite_module.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Parallel_phase_voltages_6Phase_axi_lite_module
-- Source Path: Parallel_phase_voltages_6Phase/Parallel_phase_voltages_6Phase_axi_lite/Parallel_phase_voltages_6Phase_axi_lite_module
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Parallel_phase_voltages_6Phase_axi_lite_module IS
...
END Parallel_phase_voltages_6Phase_axi_lite_module;


ARCHITECTURE rtl OF Parallel_phase_voltages_6Phase_axi_lite_module IS
...
BEGIN
  ...
  reg_rvalid_int_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        AXI4_Lite_RVALID <= '0';
      ...
      END IF;
    END IF;
  END PROCESS reg_rvalid_int_process;
