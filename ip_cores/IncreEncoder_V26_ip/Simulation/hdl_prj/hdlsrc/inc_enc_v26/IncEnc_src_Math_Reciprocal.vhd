-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\inc_enc_v26\IncEnc_src_Math_Reciprocal.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IncEnc_src_Math_Reciprocal
...
ENTITY IncEnc_src_Math_Reciprocal IS
...
END IncEnc_src_Math_Reciprocal;


ARCHITECTURE rtl OF IncEnc_src_Math_Reciprocal IS

  -- Component Declarations
  COMPONENT IncEnc_src_Math_Reciprocal_core
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_5987_0                    :   IN    std_logic;
  ...
  FOR ALL : IncEnc_src_Math_Reciprocal_core
    USE ENTITY work.IncEnc_src_Math_Reciprocal_core(rtl);
...
BEGIN
  ...
  u_core_stage1_inst : IncEnc_src_Math_Reciprocal_core
    PORT MAP( clk => clk,
              reset_x => reset_x,
  ...
  u_core_stage2_inst : IncEnc_src_Math_Reciprocal_core
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_5987_0 => enb_1_5987_0,
  ...
  u_core_stage3_inst : IncEnc_src_Math_Reciprocal_core
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_5987_0 => enb_1_5987_0,
