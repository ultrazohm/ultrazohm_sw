...
ENTITY uz_6ph_cost_ip_src_uz_6ph_mpc_costs_and_optimization IS
  PORT( clk                               :   IN    std_logic;
        ...
        opt_index                         :   OUT   std_logic_vector(7 DOWNTO 0);  -- uint8
        G0                                :   OUT   std_logic;
        G1                                :   OUT   std_logic;
        G2                                :   OUT   std_logic;
        G3                                :   OUT   std_logic;
...
ARCHITECTURE rtl OF uz_6ph_cost_ip_src_uz_6ph_mpc_costs_and_optimization IS
  ...
  SIGNAL Delay50_Initial_Val_out          : unsigned(7 DOWNTO 0);  -- uint8
  ...
  SIGNAL Delay23_Initial_Val_out          : unsigned(7 DOWNTO 0);  -- uint8
  ...
  SIGNAL Delay24_Initial_Val_out          : unsigned(7 DOWNTO 0);  -- uint8
  SIGNAL index_unsigned                   : unsigned(7 DOWNTO 0);  -- uint8
  SIGNAL Delay24_reg                      : vector_of_unsigned8(0 TO 1);  -- ufix8 [2]
  SIGNAL Delay24_out                      : unsigned(7 DOWNTO 0);  -- uint8
  ...
  SIGNAL Delay73_Initial_Val_out          : unsigned(7 DOWNTO 0);  -- uint8
  ...
  SIGNAL opt_idx                          : std_logic_vector(7 DOWNTO 0);  -- ufix8
  SIGNAL opt_idx_unsigned                 : unsigned(7 DOWNTO 0);  -- uint8
  SIGNAL last_opt_idx                     : unsigned(7 DOWNTO 0);  -- uint8
  SIGNAL Delay73_out                      : unsigned(7 DOWNTO 0);  -- uint8
  SIGNAL Delay73_out1                     : unsigned(7 DOWNTO 0);  -- uint8
  ...
  SIGNAL opt_idx_1                        : unsigned(7 DOWNTO 0);  -- uint8
...
BEGIN
  ...
  u_MATLAB_Function : uz_6ph_cost_ip_src_MATLAB_Function
    PORT MAP( in_rsvd => G_1,  -- boolean [64x12]
              index => std_logic_vector(Saturation_out1),  -- uint8
              last_optim_index => std_logic_vector(last_opt_idx),  -- uint8
  ...
  u_iterativesearch : uz_6ph_cost_ip_src_iterativesearch
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              index => std_logic_vector(Saturation1_out1),  -- uint8
              cost => std_logic_vector(Add6_out1),  -- ufix27_En24
              opt_idx => opt_idx,  -- uint8
              opt_done => opt_done_1
              );
  ...
  Delay50_Initial_Val_out <= to_unsigned(16#01#, 8);
  ...
  Delay23_Initial_Val_out <= to_unsigned(16#01#, 8);
  ...
  Delay24_Initial_Val_out <= to_unsigned(16#01#, 8);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Switch11_out1 <= to_unsigned(16#00#, 8);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        reduced_reg <= (OTHERS => to_unsigned(16#00#, 8));
      ELSIF enb = '1' THEN
  ...
  Saturation1_out1 <= to_unsigned(16#40#, 8) WHEN idx > to_unsigned(16#40#, 8) ELSE
      to_unsigned(16#01#, 8) WHEN idx < to_unsigned(16#01#, 8) ELSE
      idx;
  ...
  Saturation_out1 <= to_unsigned(16#40#, 8) WHEN Delay50_out1 > to_unsigned(16#40#, 8) ELSE
      to_unsigned(16#01#, 8) WHEN Delay50_out1 < to_unsigned(16#01#, 8) ELSE
      Delay50_out1;
  ...
  Delay73_Initial_Val_out <= to_unsigned(16#01#, 8);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay73_out <= to_unsigned(16#00#, 8);
      ELSIF enb = '1' THEN
