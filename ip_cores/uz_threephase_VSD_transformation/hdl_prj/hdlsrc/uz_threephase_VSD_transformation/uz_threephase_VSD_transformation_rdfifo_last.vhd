-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\valen\Documents\repos\UZ\ultrazohm_sw_working\ip_cores\uz_threephase_VSD_transformation\hdl_pj\hdlsrc\uz_threephase_VSD_transformation\uz_threephase_VSD_transformation_rdfifo_last.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_threephase_VSD_transformation_rdfifo_last
-- Source Path: uz_threephase_VSD_transformation/uz_threephase_VSD_transformation_axi4/uz_threephase_VSD_transformation_axi4_module/uz_threephase_VSD_transformation_rdfifo_last
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_threephase_VSD_transformation_rdfifo_last IS
...
END uz_threephase_VSD_transformation_rdfifo_last;


ARCHITECTURE rtl OF uz_threephase_VSD_transformation_rdfifo_last IS

  -- Component Declarations
  COMPONENT uz_threephase_VSD_transformation_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : uz_threephase_VSD_transformation_SimpleDualPortRAM_singlebit
    USE ENTITY work.uz_threephase_VSD_transformation_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_uz_threephase_VSD_transformation_rdfifo_last_classic_ram_singlebit : uz_threephase_VSD_transformation_SimpleDualPortRAM_singlebit
