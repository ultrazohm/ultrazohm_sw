-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\test_delay_compensation\hdlsrc\parallel_delay_compensation_6phase\test_parallel_delay_compensation_6Phase_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: test_parallel_delay_compensation_6Phase_dut
-- Source Path: test_parallel_delay_compensation_6Phase/test_parallel_delay_compensation_6Phase_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY test_parallel_delay_compensation_6Phase_dut IS
...
END test_parallel_delay_compensation_6Phase_dut;


ARCHITECTURE rtl OF test_parallel_delay_compensation_6Phase_dut IS

  -- Component Declarations
  COMPONENT test_parallel_delay_compensation_6Phase_src_HDL_DUT
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : test_parallel_delay_compensation_6Phase_src_HDL_DUT
    USE ENTITY work.test_parallel_delay_compensation_6Phase_src_HDL_DUT(rtl);
...
BEGIN
  u_test_parallel_delay_compensation_6Phase_src_HDL_DUT : test_parallel_delay_compensation_6Phase_src_HDL_DUT
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
