-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\IP_Core_SS_Switch_and_PWM\PWM_and_SS_control_V3_ip.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: PWM_and_SS_control_V3_ip
-- Source Path: PWM_and_SS_control_V3_ip
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY PWM_and_SS_control_V3_ip IS
...
END PWM_and_SS_control_V3_ip;


ARCHITECTURE rtl OF PWM_and_SS_control_V3_ip IS

  -- Component Declarations
  COMPONENT PWM_and_SS_control_V3_ip_axi_lite
  ...
  COMPONENT PWM_and_SS_control_V3_ip_dut
  ...
  FOR ALL : PWM_and_SS_control_V3_ip_axi_lite
    USE ENTITY work.PWM_and_SS_control_V3_ip_axi_lite(rtl);

  FOR ALL : PWM_and_SS_control_V3_ip_dut
    USE ENTITY work.PWM_and_SS_control_V3_ip_dut(rtl);
...
BEGIN
  u_PWM_and_SS_control_V3_ip_axi_lite_inst : PWM_and_SS_control_V3_ip_axi_lite
  ...
  u_PWM_and_SS_control_V3_ip_dut_inst : PWM_and_SS_control_V3_ip_dut
  ...
  ip_timestamp <= to_unsigned(2002071411, 32);
