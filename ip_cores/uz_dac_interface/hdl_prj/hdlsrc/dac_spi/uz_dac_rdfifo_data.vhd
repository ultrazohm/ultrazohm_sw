-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/dac_spi/uz_dac_rdfifo_data.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_dac_rdfifo_data
-- Source Path: uz_dac/uz_dac_axi4/uz_dac_axi4_module/uz_dac_rdfifo_data
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END uz_dac_rdfifo_data;


ARCHITECTURE rtl OF uz_dac_rdfifo_data IS

  -- Component Declarations
  COMPONENT uz_dac_SimpleDualPortRAM_generic
  ...
  FOR ALL : uz_dac_SimpleDualPortRAM_generic
    USE ENTITY work.uz_dac_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_uz_dac_rdfifo_data_classic_ram_generic : uz_dac_SimpleDualPortRAM_generic
