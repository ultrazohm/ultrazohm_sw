-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\external_state_machine\uz_6_ph_voltages_ip_dut.vhd
...
ARCHITECTURE rtl OF uz_6_ph_voltages_ip_dut IS
  ...
  COMPONENT uz_6_ph_voltages_ip_src_pu_voltages_vsd
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : uz_6_ph_voltages_ip_src_pu_voltages_vsd
    USE ENTITY work.uz_6_ph_voltages_ip_src_pu_voltages_vsd(rtl);
...
BEGIN
  u_uz_6_ph_voltages_ip_src_pu_voltages_vsd : uz_6_ph_voltages_ip_src_pu_voltages_vsd
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
