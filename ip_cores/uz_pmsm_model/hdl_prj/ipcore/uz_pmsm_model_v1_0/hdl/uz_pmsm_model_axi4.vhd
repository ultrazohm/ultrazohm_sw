...
ARCHITECTURE rtl OF uz_pmsm_model_axi4 IS
  ...
  SIGNAL write_L_d_tmp                    : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_L_q_tmp                    : std_logic_vector(31 DOWNTO 0);  -- ufix32
...
BEGIN
  u_uz_pmsm_model_addr_decoder_inst : uz_pmsm_model_addr_decoder
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
              ...
              write_L_d => write_L_d_tmp,  -- ufix32
              write_L_q => write_L_q_tmp,  -- ufix32
  ...
  write_L_d <= write_L_d_tmp;

  write_L_q <= write_L_q_tmp;
