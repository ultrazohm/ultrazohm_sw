...
#    "${origin_dir}/constraints/te0808/Analog_AdapterBoard.xdc"
#    "${origin_dir}/constraints/te0808/Analog_AdapterBoard_A1.xdc"
#    "${origin_dir}/constraints/te0808/Analog_AdapterBoard_A1_2v00.xdc"
#    "${origin_dir}/constraints/te0808/Analog_AdapterBoard_A2.xdc"
#    "${origin_dir}/constraints/te0808/Analog_AdapterBoard_A2_2v00.xdc"
#    "${origin_dir}/constraints/te0808/Analog_AdapterBoard_A3.xdc"
#    "${origin_dir}/constraints/te0808/Analog_AdapterBoard_A3_2v00.xdc"
#    "${origin_dir}/constraints/te0808/Digital_AdapterBoard_D1.xdc"
#    "${origin_dir}/constraints/te0808/Digital_AdapterBoard_D1_2v00.xdc"
...
#    "${origin_dir}/constraints/te0808/_i_io.xdc"
#    "${origin_dir}/constraints/te0808/_i_bitgen.xdc"
#    "${origin_dir}/constraints/te0808/TE0808.xdc"
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/constraints/$board_family/Analog_AdapterBoard.xdc"]"\
 "[file normalize "$origin_dir/constraints/$board_family/Analog_AdapterBoard_A1.xdc"]"\
 "[file normalize "$origin_dir/constraints/$board_family/Analog_AdapterBoard_A1_2v00.xdc"]"\
 "[file normalize "$origin_dir/constraints/$board_family/Analog_AdapterBoard_A2.xdc"]"\
 "[file normalize "$origin_dir/constraints/$board_family/Analog_AdapterBoard_A2_2v00.xdc"]"\
 "[file normalize "$origin_dir/constraints/$board_family/Analog_AdapterBoard_A3.xdc"]"\
 "[file normalize "$origin_dir/constraints/$board_family/Analog_AdapterBoard_A3_2v00.xdc"]"\
 "[file normalize "$origin_dir/constraints/$board_family/Digital_AdapterBoard_D1.xdc"]"\
 "[file normalize "$origin_dir/constraints/$board_family/Digital_AdapterBoard_D1_2v00.xdc"]"\
 "[file normalize "$origin_dir/constraints/$board_family/Digital_AdapterBoard_D2.xdc"]"\
 "[file normalize "$origin_dir/constraints/$board_family/Digital_AdapterBoard_D3.xdc"]"\
 "[file normalize "$origin_dir/constraints/$board_family/Digital_AdapterBoard_D4.xdc"]"\
 "[file normalize "$origin_dir/constraints/$board_family/Digital_AdapterBoard_D5.xdc"]"\
 "[file normalize "$origin_dir/constraints/$board_family/_i_io.xdc"]"\
 "[file normalize "$origin_dir/constraints/$board_family/_i_bitgen.xdc"]"\
 "[file normalize "$origin_dir/constraints/$board_family/TE0808.xdc"]"\
 "[file normalize "$origin_dir/constraints/$board_family/Digital_D1_packed.xdc"]"\
 "[file normalize "$origin_dir/constraints/$board_family/Digital_D2_packed.xdc"]"\
 "[file normalize "$origin_dir/constraints/$board_family/Digital_D3_packed.xdc"]"\
 "[file normalize "$origin_dir/constraints/$board_family/Digital_D4_packed.xdc"]"\
 "[file normalize "$origin_dir/constraints/$board_family/Analog_A1_packed.xdc"]"\
 "[file normalize "$origin_dir/constraints/$board_family/Analog_A2_packed.xdc"]"\
 "[file normalize "$origin_dir/constraints/$board_family/Analog_A3_packed.xdc"]"\
 "[file normalize "$origin_dir/constraints/$board_family/adc_ltc2311_debug.xdc"]"\
  ]
  foreach ifile $files {
...
set file "[file normalize "$origin_dir/constraints/$board_family/Analog_AdapterBoard.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/constraints/$board_family/Analog_AdapterBoard.xdc"
set file [file normalize $file]
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/constraints/$board_family/Analog_AdapterBoard_A1_2v00.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/constraints/$board_family/Analog_AdapterBoard_A1_2v00.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
set_property -name "is_enabled" -value "0" -objects $file_obj
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/constraints/$board_family/Analog_AdapterBoard_A2_2v00.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/constraints/$board_family/Analog_AdapterBoard_A2_2v00.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
set_property -name "is_enabled" -value "0" -objects $file_obj
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/constraints/$board_family/Analog_AdapterBoard_A3_2v00.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/constraints/$board_family/Analog_AdapterBoard_A3_2v00.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
set_property -name "is_enabled" -value "0" -objects $file_obj
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/constraints/$board_family/Digital_AdapterBoard_D1_2v00.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/constraints/$board_family/Digital_AdapterBoard_D1_2v00.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/constraints/$board_family/_i_io.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/constraints/$board_family/_i_io.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
set_property -name "is_enabled" -value "0" -objects $file_obj
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/constraints/$board_family/TE0808.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/constraints/$board_family/TE0808.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
set_property -name "is_enabled" -value "0" -objects $file_obj
