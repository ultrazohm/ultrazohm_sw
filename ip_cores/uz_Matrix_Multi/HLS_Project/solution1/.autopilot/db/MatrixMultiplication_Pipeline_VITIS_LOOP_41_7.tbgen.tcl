set moduleName MatrixMultiplication_Pipeline_VITIS_LOOP_41_7
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {MatrixMultiplication_Pipeline_VITIS_LOOP_41_7}
set C_modelType { void 0 }
set C_modelArgList {
	{ arrays int 32 regular {axi_master 1}  }
	{ sext_ln41 int 62 regular  }
	{ C float 32 regular {array 5 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "arrays", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "A_input","offset": { "type": "dynamic","port_name": "A_input","bundle": "control"},"direction": "READONLY"},{"cName": "B_input","offset": { "type": "dynamic","port_name": "B_input","bundle": "control"},"direction": "READONLY"},{"cName": "C_output","offset": { "type": "dynamic","port_name": "C_output","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
