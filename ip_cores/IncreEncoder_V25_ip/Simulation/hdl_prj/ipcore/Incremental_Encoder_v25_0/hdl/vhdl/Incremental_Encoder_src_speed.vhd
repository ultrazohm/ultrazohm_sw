-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\inc_enc_v25\Incremental_Encoder_src_speed.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Incremental_Encoder_src_speed
-- Source Path: inc_enc_v25/IncEnc_V25/speed
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Incremental_Encoder_src_speed IS
...
END Incremental_Encoder_src_speed;


ARCHITECTURE rtl OF Incremental_Encoder_src_speed IS

  -- Component Declarations
  COMPONENT Incremental_Encoder_src_OS_factor_logic
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT Incremental_Encoder_src_calc_omega
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT Incremental_Encoder_src_Average
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Incremental_Encoder_src_OS_factor_logic
    USE ENTITY work.Incremental_Encoder_src_OS_factor_logic(rtl);

  FOR ALL : Incremental_Encoder_src_calc_omega
    USE ENTITY work.Incremental_Encoder_src_calc_omega(rtl);

  FOR ALL : Incremental_Encoder_src_Average
    USE ENTITY work.Incremental_Encoder_src_Average(rtl);
...
BEGIN
  u_OS_factor_logic : Incremental_Encoder_src_OS_factor_logic
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_Average : Incremental_Encoder_src_Average
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  GEN_LABEL: FOR k IN 0 TO 3 GENERATE
    u_calc_omega : Incremental_Encoder_src_calc_omega
      PORT MAP( clk => clk,
                reset_x => reset_x,
                enb => enb,
