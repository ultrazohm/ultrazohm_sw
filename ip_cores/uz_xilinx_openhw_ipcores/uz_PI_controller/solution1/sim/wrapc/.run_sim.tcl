...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "uz_PI_controller.autotvin.dat"
	set constFileTvOut       "uz_PI_controller.autotvout.dat"
	set constFileHdlTvIn     "uz_PI_controller.autohdltvin.dat"
	set constFileHdlTvOut    "uz_PI_controller.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
