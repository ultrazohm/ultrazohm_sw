...
void test_uz_pmsm_model3ph_hw_read_torque(void)
{
    ...
    uz_axi_read_float_ExpectAndReturn(BASE_ADDRESS+outputs_Data_uz_pmsm_model_3ph_dq + 0x08,torque_expect);
...
{
    float i_q_val=4.2f;
    uz_axi_read_float_ExpectAndReturn(BASE_ADDRESS+outputs_Data_uz_pmsm_model_3ph_dq + 0x04,i_q_val);
...
void test_uz_pmsm_model3ph_hw_read_i_d(void){
    float i_d_val=13.1f;
    uz_axi_read_float_ExpectAndReturn(BASE_ADDRESS+outputs_Data_uz_pmsm_model_3ph_dq,i_d_val);
...
void test_uz_pmsm_model3ph_hw_read_theta_el(void){
    ...
    uz_axi_read_float_ExpectAndReturn(BASE_ADDRESS+outputs_Data_uz_pmsm_model_3ph_dq + 0x10,theta_el);
...
void test_uz_pmsm_model3ph_hw_write_reset(void){
    uz_axi_write_bool_Expect(BASE_ADDRESS+reset_integrators_Data_uz_pmsm_model_3ph_dq,true);
...
void test_uz_pmsm_model3ph_hw_write_omega_mech(void){
    ...
    uz_axi_write_float_Expect(BASE_ADDRESS+inputs_Data_uz_pmsm_model_3ph_dq+0x08,omega_mech);
...
void test_uz_pmsm_model3ph_hw_read_omega_mech(void){
    ...
    uz_axi_read_float_ExpectAndReturn(BASE_ADDRESS+outputs_Data_uz_pmsm_model_3ph_dq+0x0C,omega_mech_expected);
...
void test_uz_pmsm_model3ph_hw_write_simulate_mechanical(void){
    ...
    uz_axi_write_bool_Expect(BASE_ADDRESS+simulate_mechanical_Data_uz_pmsm_model_3ph_dq,simulate_mech);
...
void test_uz_pmsm_model3ph_hw_write_inertia(void){
    ...
    uz_axi_write_float_Expect(BASE_ADDRESS+reciprocal_J_Data_uz_pmsm_model_3ph_dq,1.0f/inertia);
...
void test_uz_pmsm_model3ph_hw_write_load_torque(void){
    ...
    uz_axi_write_float_Expect(BASE_ADDRESS+inputs_Data_uz_pmsm_model_3ph_dq+0x0C,load_torque);
...
void test_uz_pmsm_model3ph_hw_write_switch_pspl(void){
    ...
    uz_axi_write_bool_Expect(BASE_ADDRESS + use_axi_input_Data_uz_pmsm_model_3ph_dq,switch_pspl);
    uz_pmsm_model3ph_hw_write_switch_pspl(BASE_ADDRESS,switch_pspl);
}

void test_uz_pmsm_model3ph_hw_trigger_input_strobe(void){
    uz_axi_write_bool_Expect(BASE_ADDRESS+inputs_Strobe_uz_pmsm_model_3ph_dq,true);
    uz_axi_write_bool_Expect(BASE_ADDRESS+inputs_Strobe_uz_pmsm_model_3ph_dq,false);
    uz_pmsm_model3ph_hw_trigger_input_strobe(BASE_ADDRESS);
}

void test_uz_pmsm_model3ph_hw_trigger_output_strobe(void){
    uz_axi_write_bool_Expect(BASE_ADDRESS+outputs_Strobe_uz_pmsm_model_3ph_dq,true);
    uz_axi_write_bool_Expect(BASE_ADDRESS+outputs_Strobe_uz_pmsm_model_3ph_dq,false);
    uz_pmsm_model3ph_hw_trigger_output_strobe(BASE_ADDRESS);
}

void test_uz_pmsm_model3ph_hw_trigger_fb_strobe(void){
    uz_axi_write_bool_Expect(BASE_ADDRESS+voltage_input_dq_out_axi_fb_Strobe_uz_pmsm_model_3ph_dq,true);
    uz_axi_write_bool_Expect(BASE_ADDRESS+voltage_input_dq_out_axi_fb_Strobe_uz_pmsm_model_3ph_dq,false);
    uz_pmsm_model3ph_hw_trigger_fb_strobe(BASE_ADDRESS);
}

void test_uz_pmsm_model3ph_hw_read_v_d(void){
    float testvolt=13.1f;
    uz_axi_read_float_ExpectAndReturn(BASE_ADDRESS+voltage_input_dq_out_axi_fb_Data_uz_pmsm_model_3ph_dq,testvolt);
...
void test_uz_pmsm_model3ph_hw_read_v_q(void){
    float testvolt=13.1f;
    uz_axi_read_float_ExpectAndReturn(BASE_ADDRESS+voltage_input_dq_out_axi_fb_Data_uz_pmsm_model_3ph_dq+0x04,testvolt);
