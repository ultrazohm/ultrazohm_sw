...
/* Definitions for peripheral A1_ADC_LTC2311 */
#define XPAR_A1_ADC_LTC2311_S00_AXI_BASEADDR 0x80000000
#define XPAR_A1_ADC_LTC2311_S00_AXI_HIGHADDR 0x8000FFFF


/* Definitions for peripheral A2_ADC_LTC2311 */
#define XPAR_A2_ADC_LTC2311_S00_AXI_BASEADDR 0x80010000
#define XPAR_A2_ADC_LTC2311_S00_AXI_HIGHADDR 0x8001FFFF


/* Definitions for peripheral A3_ADC_LTC2311 */
#define XPAR_A3_ADC_LTC2311_S00_AXI_BASEADDR 0x80020000
#define XPAR_A3_ADC_LTC2311_S00_AXI_HIGHADDR 0x8002FFFF


/* Definitions for peripheral GATES_3L_PWM_SS_3L_IP_0 */
#define XPAR_GATES_3L_PWM_SS_3L_IP_0_BASEADDR 0x80060000
#define XPAR_GATES_3L_PWM_SS_3L_IP_0_HIGHADDR 0x8006FFFF


/* Definitions for peripheral GATES_COUNTER_F_SW_V2_IP_0 */
#define XPAR_GATES_COUNTER_F_SW_V2_IP_0_BASEADDR 0x80030000
#define XPAR_GATES_COUNTER_F_SW_V2_IP_0_HIGHADDR 0x8003FFFF


/* Definitions for peripheral GATES_PWM_AND_SS_CONTROL_V_0 */
#define XPAR_GATES_PWM_AND_SS_CONTROL_V_0_BASEADDR 0x80040000
#define XPAR_GATES_PWM_AND_SS_CONTROL_V_0_HIGHADDR 0x8004FFFF


/* Definitions for peripheral GATES_UZ_INTERLOCKDEADTIME_0 */
#define XPAR_GATES_UZ_INTERLOCKDEADTIME_0_BASEADDR 0x80050000
#define XPAR_GATES_UZ_INTERLOCKDEADTIME_0_HIGHADDR 0x8005FFFF


/* Definitions for peripheral INCREENCODER_V24_IP_0 */
#define XPAR_INCREENCODER_V24_IP_0_BASEADDR 0x80070000
#define XPAR_INCREENCODER_V24_IP_0_HIGHADDR 0x8007FFFF


/* Definitions for peripheral INTERRUPT_MUX_AXI_IP_0 */
#define XPAR_INTERRUPT_MUX_AXI_IP_0_BASEADDR 0x80090000
#define XPAR_INTERRUPT_MUX_AXI_IP_0_HIGHADDR 0x8009FFFF
...
/* Definitions for peripheral UZ_AXI_TESTIP_0 */
#define XPAR_UZ_AXI_TESTIP_0_BASEADDR 0x800C0000
#define XPAR_UZ_AXI_TESTIP_0_HIGHADDR 0x800CFFFF
...
#define XPAR_AXI_GPIO_2_BASEADDR 0x800A0000
#define XPAR_AXI_GPIO_2_HIGHADDR 0x800AFFFF
...
#define XPAR_GPIO_0_BASEADDR 0x800A0000
#define XPAR_GPIO_0_HIGHADDR 0x800AFFFF
...
#define XPAR_FABRIC_INTERRUPT_TRIGGER_F_CC_INTERRUPT_INTR 127U

/******************************************************************/

/* Canonical definitions for Fabric interrupts connected to psu_acpu_gic */
#define XPAR_FABRIC_TMRCTR_0_VEC_ID XPAR_FABRIC_INTERRUPT_TRIGGER_F_CC_INTERRUPT_INTR
...
#define XPAR_PSU_SD_1_SDIO_CLK_FREQ_HZ 200000000
...
/* Definitions for peripheral INTERRUPT_TRIGGER_F_CC */
#define XPAR_INTERRUPT_TRIGGER_F_CC_DEVICE_ID 0U
#define XPAR_INTERRUPT_TRIGGER_F_CC_BASEADDR 0x80080000U
#define XPAR_INTERRUPT_TRIGGER_F_CC_HIGHADDR 0x8008FFFFU
#define XPAR_INTERRUPT_TRIGGER_F_CC_CLOCK_FREQ_HZ 100000000U


/* Definitions for peripheral TIMER_UPTIME_64BIT */
#define XPAR_TIMER_UPTIME_64BIT_DEVICE_ID 1U
#define XPAR_TIMER_UPTIME_64BIT_BASEADDR 0x800B0000U
#define XPAR_TIMER_UPTIME_64BIT_HIGHADDR 0x800BFFFFU
#define XPAR_TIMER_UPTIME_64BIT_CLOCK_FREQ_HZ 100000000U


/******************************************************************/

/* Canonical definitions for peripheral INTERRUPT_TRIGGER_F_CC */
#define XPAR_TMRCTR_0_DEVICE_ID 0U
#define XPAR_TMRCTR_0_BASEADDR 0x80080000U
#define XPAR_TMRCTR_0_HIGHADDR 0x8008FFFFU
#define XPAR_TMRCTR_0_CLOCK_FREQ_HZ XPAR_INTERRUPT_TRIGGER_F_CC_CLOCK_FREQ_HZ
/* Canonical definitions for peripheral TIMER_UPTIME_64BIT */
#define XPAR_TMRCTR_1_DEVICE_ID 1U
#define XPAR_TMRCTR_1_BASEADDR 0x800B0000U
#define XPAR_TMRCTR_1_HIGHADDR 0x800BFFFFU
#define XPAR_TMRCTR_1_CLOCK_FREQ_HZ XPAR_TIMER_UPTIME_64BIT_CLOCK_FREQ_HZ
...
/* Definitions for driver UZ_PI_CONTROLLER_SAMPLE */
#define XPAR_XUZ_PI_CONTROLLER_SAMPLE_NUM_INSTANCES 1

/* Definitions for peripheral UZ_PI_CONTROLLER_SAM_0 */
#define XPAR_UZ_PI_CONTROLLER_SAM_0_DEVICE_ID 0
#define XPAR_UZ_PI_CONTROLLER_SAM_0_S_AXI_CONTROL_BASEADDR 0x800E0000
#define XPAR_UZ_PI_CONTROLLER_SAM_0_S_AXI_CONTROL_HIGHADDR 0x800EFFFF
#define XPAR_UZ_PI_CONTROLLER_SAM_0_S_AXI_DIN_BASEADDR 0x800D0000
#define XPAR_UZ_PI_CONTROLLER_SAM_0_S_AXI_DIN_HIGHADDR 0x800DFFFF


/******************************************************************/

/* Canonical definitions for peripheral UZ_PI_CONTROLLER_SAM_0 */
#define XPAR_XUZ_PI_CONTROLLER_SAMPLE_0_DEVICE_ID XPAR_UZ_PI_CONTROLLER_SAM_0_DEVICE_ID
#define XPAR_XUZ_PI_CONTROLLER_SAMPLE_0_S_AXI_CONTROL_BASEADDR 0x800E0000
#define XPAR_XUZ_PI_CONTROLLER_SAMPLE_0_S_AXI_CONTROL_HIGHADDR 0x800EFFFF
#define XPAR_XUZ_PI_CONTROLLER_SAMPLE_0_S_AXI_DIN_BASEADDR 0x800D0000
#define XPAR_XUZ_PI_CONTROLLER_SAMPLE_0_S_AXI_DIN_HIGHADDR 0x800DFFFF
