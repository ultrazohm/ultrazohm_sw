-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\parallel_8_switching_states\hdlsrc\parallel_8_switching_states\parallel_8_sim_switching_states_src_HDL_DUT.vhd
...
-- HB6T                          ce_out        1e-08
-- HB6B                          ce_out        1e-08
-- done_switching_states         ce_out        1e-08
-- min_Index_AXI                 ce_out        1e-08
-- -------------------------------------------------------------
-- 
-- -------------------------------------------------------------
...
-- -------------------------------------------------------------
-- 
-- Module: parallel_8_sim_switching_states_src_HDL_DUT
...
ENTITY parallel_8_sim_switching_states_src_HDL_DUT IS
  PORT( clk                               :   IN    std_logic;
        reset                             :   IN    std_logic;
        clk_enable                        :   IN    std_logic;
        min_Index                         :   IN    std_logic_vector(31 DOWNTO 0);  -- int32
        ...
        HB6T                              :   OUT   std_logic;
        HB6B                              :   OUT   std_logic;
        done_switching_states             :   OUT   std_logic;
        min_Index_AXI                     :   OUT   std_logic_vector(31 DOWNTO 0)  -- int32
        );
END parallel_8_sim_switching_states_src_HDL_DUT;


ARCHITECTURE rtl OF parallel_8_sim_switching_states_src_HDL_DUT IS

  -- Component Declarations
  COMPONENT parallel_8_sim_switching_states_src_Detect_Rise_Positive
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  COMPONENT parallel_8_sim_switching_states_src_MATLAB_Function1
  ...
  FOR ALL : parallel_8_sim_switching_states_src_Detect_Rise_Positive
    USE ENTITY work.parallel_8_sim_switching_states_src_Detect_Rise_Positive(rtl);

  FOR ALL : parallel_8_sim_switching_states_src_MATLAB_Function1
    USE ENTITY work.parallel_8_sim_switching_states_src_MATLAB_Function1(rtl);
  ...
  SIGNAL min_Index_signed                 : signed(31 DOWNTO 0);  -- int32
...
BEGIN
  u_Detect_Rise_Positive : parallel_8_sim_switching_states_src_Detect_Rise_Positive
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              U => Delay_out1,
  ...
  u_MATLAB_Function1 : parallel_8_sim_switching_states_src_MATLAB_Function1
  ...
  min_Index_signed <= signed(min_Index);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay16_out1 <= Switch_on2_out1;
      END IF;
    END IF;
  END PROCESS Delay16_process;


  min_Index_AXI <= std_logic_vector(Delay16_out1);
  ...
  done_switching_states <= Delay3_out1;
