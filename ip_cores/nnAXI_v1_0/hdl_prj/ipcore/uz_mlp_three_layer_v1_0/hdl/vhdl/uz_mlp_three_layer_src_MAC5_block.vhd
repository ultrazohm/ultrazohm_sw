-- -------------------------------------------------------------
-- 
-- File Name: /home/ts/Documents/integrate_nn_to_uz/ultrazohm_sw/ip_cores/nnAXI_v1_0/hdl_prj/hdlsrc/uz_mlp_three_layer/uz_mlp_three_layer_src_MAC5_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_mlp_three_layer_src_MAC5_block
-- Source Path: uz_mlp_three_layer/pcu_mlp2_8parallel/reluLayer_8Parallel1/MAC5
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_mlp_three_layer_src_MAC5_block IS
...
END uz_mlp_three_layer_src_MAC5_block;


ARCHITECTURE rtl OF uz_mlp_three_layer_src_MAC5_block IS

  -- Component Declarations
  COMPONENT uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block54
  ...
  COMPONENT uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block56
    GENERIC( AddrWidth                    : integer;
             DataWidth                    : integer
             );
    PORT( clk                             :   IN    std_logic;
  ...
  COMPONENT uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block55
    GENERIC( AddrWidth                    : integer;
             DataWidth                    : integer
             );
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block54
    USE ENTITY work.uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block54(rtl);

  FOR ALL : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block56
    USE ENTITY work.uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block56(rtl);

  FOR ALL : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block55
    USE ENTITY work.uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block55(rtl);
...
BEGIN
  u_Dual_Port_RAM_System1 : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block54
  ...
  u_Dual_Port_RAM_System3 : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block56
    GENERIC MAP( AddrWidth => 10,
                 DataWidth => 32
                 )
    PORT MAP( clk => clk,
  ...
  u_Dual_Port_RAM_System2 : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block55
    GENERIC MAP( AddrWidth => 10,
                 DataWidth => 32
                 )
    PORT MAP( clk => clk,
  ...
  Compare_To_Constant1_out1 <= '1' WHEN axi_biasWriteEnable = to_unsigned(16#06#, 8) ELSE
      '0';
  ...
  Compare_To_Constant_out1 <= '1' WHEN axi_weightsWriteEnable = to_unsigned(16#06#, 8) ELSE
      '0';
  ...
  Constant_out1 <= to_unsigned(16#029#, 10);
