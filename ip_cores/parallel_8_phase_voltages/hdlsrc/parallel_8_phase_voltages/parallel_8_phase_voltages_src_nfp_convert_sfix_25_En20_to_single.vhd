-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\parallel_8_phase_voltages\hdlsrc\parallel_8_phase_voltages\parallel_8_phase_voltages_src_nfp_convert_sfix_25_En20_to_single.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: parallel_8_phase_voltages_src_nfp_convert_sfix_25_En20_to_single
-- Source Path: parallel_8_phase_voltages/Phase_voltages_per_switching_state2/nfp_convert_sfix_25_En20_to_single
-- Hierarchy Level: 1
-- 
...
ENTITY parallel_8_phase_voltages_src_nfp_convert_sfix_25_En20_to_single IS
...
END parallel_8_phase_voltages_src_nfp_convert_sfix_25_En20_to_single;


ARCHITECTURE rtl OF parallel_8_phase_voltages_src_nfp_convert_sfix_25_En20_to_single IS

  -- Signals
  SIGNAL nfp_in_signed                    : signed(24 DOWNTO 0);  -- sfix25_En20
  SIGNAL Delay_out1                       : signed(24 DOWNTO 0);  -- sfix25_En20
  ...
  SIGNAL Delay_out1_dtc                   : unsigned(24 DOWNTO 0);  -- ufix25_En20
  SIGNAL Unary_Minus_cast                 : signed(25 DOWNTO 0);  -- sfix26_En20
  SIGNAL Unary_Minus_cast_1               : signed(25 DOWNTO 0);  -- sfix26_En20
  SIGNAL Unary_Minus_out1                 : signed(24 DOWNTO 0);  -- sfix25_En20
  SIGNAL Unary_Minus_out1_dtc             : unsigned(24 DOWNTO 0);  -- ufix25_En20
  SIGNAL Switch_out1                      : unsigned(24 DOWNTO 0);  -- ufix25_En20
...
BEGIN
  ...
  CompareToZero1_out1 <= '1' WHEN Delay_out1 = to_signed(16#0000000#, 25) ELSE
      '0';
  ...
  Compare_To_Zero_out1 <= '1' WHEN Delay_out1 < to_signed(16#0000000#, 25) ELSE
      '0';
  ...
  Unary_Minus_cast <= resize(Delay_out1, 26);
