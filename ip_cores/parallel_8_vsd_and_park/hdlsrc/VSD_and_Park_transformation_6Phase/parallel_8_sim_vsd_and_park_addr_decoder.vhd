...
ARCHITECTURE rtl OF parallel_8_sim_vsd_and_park_addr_decoder IS
  ...
  SIGNAL read_i_a1_axi_signed             : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL read_i_b1_axi_signed             : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL read_i_c1_axi_signed             : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL read_i_a2_axi_signed             : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL read_i_b2_axi_signed             : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL read_i_c2_axi_signed             : signed(26 DOWNTO 0);  -- sfix27_En18
  ...
  SIGNAL data_in_theta_el_offset_AXI      : signed(17 DOWNTO 0);  -- sfix18_En14
  SIGNAL data_reg_theta_el_offset_AXI_1_1 : signed(17 DOWNTO 0);  -- sfix18_En14
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        read_reg_i_a1_axi <= to_signed(16#0000000#, 27);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        read_reg_i_b1_axi <= to_signed(16#0000000#, 27);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        read_reg_i_c1_axi <= to_signed(16#0000000#, 27);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        read_reg_i_a2_axi <= to_signed(16#0000000#, 27);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        read_reg_i_b2_axi <= to_signed(16#0000000#, 27);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        read_reg_i_c2_axi <= to_signed(16#0000000#, 27);
      ELSIF enb = '1' THEN
  ...
  data_in_theta_el_offset_AXI <= signed(data_write_unsigned(17 DOWNTO 0));

  reg_theta_el_offset_AXI_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        data_reg_theta_el_offset_AXI_1_1 <= to_signed(16#00000#, 18);
