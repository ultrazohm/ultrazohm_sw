...
void test_uz_matrix_multiplication_hw_set_A_matrix(void) {
    ...
    uint32_t* pointer = (uint32_t*)A_matrix;
	uint32_t address = (uint32_t)pointer;
    uz_axi_write_uint32_Expect(TEST_BASE_ADDRESS + XMATRIXMULTIPLICATION_CONTROL_ADDR_A_INPUT_DATA, address);
    uz_matrix_multiplication_hw_set_A_matrix(TEST_BASE_ADDRESS, A_matrix);   
...
void test_uz_matrix_multiplication_hw_set_B_matrix(void) {
    ...
    uint32_t* pointer = (uint32_t*)B_matrix;
	uint32_t address = (uint32_t)pointer;
    uz_axi_write_uint32_Expect(TEST_BASE_ADDRESS + XMATRIXMULTIPLICATION_CONTROL_ADDR_B_INPUT_DATA, address);
    uz_matrix_multiplication_hw_set_B_matrix(TEST_BASE_ADDRESS, B_matrix);  
    
}

void test_uz_matrix_multiplication_hw_read_C_out_matrix_assert_zero_base_address(void) {
    float C_out[5] = {0};
    TEST_ASSERT_FAIL_ASSERT(uz_matrix_multiplication_hw_set_C_out_matrix(0x0, &C_out[0]));
}

void test_uz_matrix_multiplication_hw_read_C_out_matrix_assert_NULL_array(void) {
    TEST_ASSERT_FAIL_ASSERT(uz_matrix_multiplication_hw_set_C_out_matrix(TEST_BASE_ADDRESS, NULL));
}
...
void test_uz_matrix_multiplication_hw_read_C_out_matrix(void) {
	...
	uint32_t address = (uint32_t)pointer;
    uz_axi_write_uint32_Expect(TEST_BASE_ADDRESS + XMATRIXMULTIPLICATION_CONTROL_ADDR_C_OUTPUT_DATA, address);
    uz_matrix_multiplication_hw_set_C_out_matrix(TEST_BASE_ADDRESS, C_out);
}
