-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_pmsm_model_nonlinear\uz_pmsm_model_nonlinear_dut.vhd
...
ARCHITECTURE rtl OF uz_pmsm_model_nonlinear_dut IS
  ...
  COMPONENT uz_pmsm_model_nonlinear_src_uz_pmsm_mode_nonlinear
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : uz_pmsm_model_nonlinear_src_uz_pmsm_mode_nonlinear
    USE ENTITY work.uz_pmsm_model_nonlinear_src_uz_pmsm_mode_nonlinear(rtl);
...
BEGIN
  u_uz_pmsm_model_nonlinear_src_uz_pmsm_mode_nonlinear : uz_pmsm_model_nonlinear_src_uz_pmsm_mode_nonlinear
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
