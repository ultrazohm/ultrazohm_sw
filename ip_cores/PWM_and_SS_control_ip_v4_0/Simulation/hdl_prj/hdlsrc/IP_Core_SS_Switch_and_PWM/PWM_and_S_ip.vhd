-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/IP_Core_SS_Switch_and_PWM/PWM_and_S_ip.vhd
...
ARCHITECTURE rtl OF PWM_and_S_ip IS

  -- Component Declarations
  COMPONENT PWM_and_S_ip_reset_sync
  ...
  COMPONENT PWM_and_S_ip_axi_lite
  ...
  FOR ALL : PWM_and_S_ip_reset_sync
    USE ENTITY work.PWM_and_S_ip_reset_sync(rtl);

  FOR ALL : PWM_and_S_ip_axi_lite
    USE ENTITY work.PWM_and_S_ip_axi_lite(rtl);

  FOR ALL : PWM_and_S_ip_dut
    USE ENTITY work.PWM_and_S_ip_dut(rtl);
...
BEGIN
  u_PWM_and_S_ip_reset_sync_inst : PWM_and_S_ip_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_PWM_and_S_ip_axi_lite_inst : PWM_and_S_ip_axi_lite
  ...
  u_PWM_and_S_ip_dut_inst : PWM_and_S_ip_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  ip_timestamp <= unsigned'(X"89B1A899");
