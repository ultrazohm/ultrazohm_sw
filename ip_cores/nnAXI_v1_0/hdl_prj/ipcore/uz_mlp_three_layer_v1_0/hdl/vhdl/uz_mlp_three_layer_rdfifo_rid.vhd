-- -------------------------------------------------------------
-- 
-- File Name: /home/ts/Documents/integrate_nn_to_uz/ultrazohm_sw/ip_cores/nnAXI_v1_0/hdl_prj/hdlsrc/uz_mlp_three_layer/uz_mlp_three_layer_rdfifo_rid.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_mlp_three_layer_rdfifo_rid
-- Source Path: uz_mlp_three_layer/uz_mlp_three_layer_axi4/uz_mlp_three_layer_axi4_module/uz_mlp_three_layer_rdfifo_rid
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_mlp_three_layer_rdfifo_rid IS
...
END uz_mlp_three_layer_rdfifo_rid;


ARCHITECTURE rtl OF uz_mlp_three_layer_rdfifo_rid IS
...
BEGIN
  ...
  u_uz_mlp_three_layer_rdfifo_rid_classic_ram : uz_mlp_three_layer_SimpleDualPortRAM_generic
