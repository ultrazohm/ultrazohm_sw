-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\parallel_8_switching_states\hdlsrc\parallel_8_switching_states\parallel_8_sim_switching_states_src_MATLAB_Function1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: parallel_8_sim_switching_states_src_MATLAB_Function1
...
USE work.parallel_8_sim_switching_states_src_HDL_DUT_pkg.ALL;

ENTITY parallel_8_sim_switching_states_src_MATLAB_Function1 IS
  PORT( I                                 :   IN    std_logic_vector(31 DOWNTO 0);  -- int32
        next_switching_state              :   OUT   std_logic_vector(0 TO 11)  -- boolean [12]
        );
END parallel_8_sim_switching_states_src_MATLAB_Function1;


ARCHITECTURE rtl OF parallel_8_sim_switching_states_src_MATLAB_Function1 IS
