-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\jonat\Documents\MA_JL_CIL\ip_cores\uz_JL_pmsmModel\hdl_prj\hdlsrc\uz_JL_pmsmModel\uz_JL_pmsmModel_src_nfp_div_single.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_JL_pmsmModel_src_nfp_div_single
-- Source Path: uz_JL_pmsmModel/uz_JL_pmsmModel/Elektrik/Subsystem2/nfp_div_single
-- Hierarchy Level: 3
-- Model version: 1.66
-- 
...
ENTITY uz_JL_pmsmModel_src_nfp_div_single IS
...
END uz_JL_pmsmModel_src_nfp_div_single;


ARCHITECTURE rtl OF uz_JL_pmsmModel_src_nfp_div_single IS
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay38_out1 <= '0';
      ELSIF enb = '1' THEN
        Delay38_out1 <= alpha_aExponent_cfType_Exponent_out1;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay32_out1 <= '0';
      ELSIF enb = '1' THEN
        Delay32_out1 <= alpha_aExponent_0_aMantissa_out1;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay35_out1 <= '0';
      ELSIF enb = '1' THEN
        Delay35_out1 <= alpha_bExponent_0_bMantissa_out1;
      END IF;
    END IF;
  ...
  if_Exponent_0_cfType_Exp_out1 <= alpha1_out1_1 WHEN alpha_Exponent_0_cfType_Exp_out1 = '0' ELSE
      alpha0_out1;
  ...
  if_Exponent_0_cfType_Exp_out1_1 <= alpha1_out1_2 WHEN alpha_Exponent_0_cfType_Exp_out1_1 = '0' ELSE
      alpha0_out1_1;
  ...
  mant_a_norm_mant_b_norm_out1 <= '1' WHEN reinterpretcast_bitconcat_fi_0_out1 < reinterpretcast_bitconcat_fi_0_out1_1 ELSE
      '0';
  ...
  if_mant_a_norm_mant_b_norm_out1 <= if_bitget_mant_a_mant_a_WordLen_out1 WHEN mant_a_norm_mant_b_norm_out1 = '0' ELSE
  ...
  alpha_bitget_Mant_tmp_2_0_out1 <= BitSlice1_out1_1 OR Delay10_out1_1;
