-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\Philipp\ultrazohm\ultrazohm_sw\ip_cores\uz_pmsm_model_nonlinear\hdl_prj\hdlsrc\uz_pmsm_model_nonlinear\uz_pmsm_m_ip.vhd
...
USE work.uz_pmsm_m_ip_pkg.ALL;

ENTITY uz_pmsm_m_ip IS
...
ARCHITECTURE rtl OF uz_pmsm_m_ip IS

  -- Component Declarations
  COMPONENT uz_pmsm_m_ip_reset_sync
  ...
  FOR ALL : uz_pmsm_m_ip_reset_sync
    USE ENTITY work.uz_pmsm_m_ip_reset_sync(rtl);

  FOR ALL : uz_pmsm_m_ip_dut
    USE ENTITY work.uz_pmsm_m_ip_dut(rtl);

  FOR ALL : uz_pmsm_m_ip_axi4
    USE ENTITY work.uz_pmsm_m_ip_axi4(rtl);
...
BEGIN
  u_uz_pmsm_m_ip_reset_sync_inst : uz_pmsm_m_ip_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_uz_pmsm_m_ip_dut_inst : uz_pmsm_m_ip_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  u_uz_pmsm_m_ip_axi4_inst : uz_pmsm_m_ip_axi4
  ...
  ip_timestamp <= unsigned'(X"898651FC");
