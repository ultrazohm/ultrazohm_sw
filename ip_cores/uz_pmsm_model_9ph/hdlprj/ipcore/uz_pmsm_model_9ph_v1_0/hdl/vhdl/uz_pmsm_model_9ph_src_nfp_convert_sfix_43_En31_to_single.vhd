-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\valen\Documents\repos\UZ\ultrazohm_sw\ip_cores\uz_pmsm_model_9ph\hdlprj\hdlsrc\uz_pmsm_model_9ph\uz_pmsm_model_9ph_src_nfp_convert_sfix_43_En31_to_single.vhd
...
BEGIN
  ...
  CompareToZero1_out1 <= '1' WHEN nfp_in_signed = to_signed(0, 43) ELSE
      '0';

  Constant3_out1 <= '1';

  
  Compare_To_Zero_out1 <= '1' WHEN nfp_in_signed < to_signed(0, 43) ELSE
      '0';
  ...
  Unary_Minus_cast <= resize(nfp_in_signed, 44);
