-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/uz_mlp_three_layer/uz_mlp_three_layer_axi4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_mlp_three_layer_axi4
-- Source Path: uz_mlp_three_layer/uz_mlp_three_layer_axi4
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_mlp_three_layer_axi4 IS
  PORT( reset                             :   IN    std_logic;
        ...
        write_disable_pl_trigger          :   OUT   std_logic;  -- ufix1
        write_axi_x_input                 :   OUT   vector_of_std_logic_vector32(0 TO 15);  -- sfix32_En14 [16]
        reset_internal                    :   OUT   std_logic  -- ufix1
        );
END uz_mlp_three_layer_axi4;


ARCHITECTURE rtl OF uz_mlp_three_layer_axi4 IS

  -- Component Declarations
  COMPONENT uz_mlp_three_layer_addr_decoder
  ...
  COMPONENT uz_mlp_three_layer_axi4_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_ARESETN                    :   IN    std_logic;  -- ufix1
          AXI4_AWID                       :   IN    std_logic_vector(11 DOWNTO 0);  -- ufix12
          AXI4_AWADDR                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  FOR ALL : uz_mlp_three_layer_addr_decoder
    USE ENTITY work.uz_mlp_three_layer_addr_decoder(rtl);

  FOR ALL : uz_mlp_three_layer_axi4_module
    USE ENTITY work.uz_mlp_three_layer_axi4_module(rtl);
  ...
  SIGNAL write_axi_bias_tmp               : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_axi_weight_tmp             : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_axi_bias_addr_tmp          : std_logic_vector(9 DOWNTO 0);  -- ufix10
  SIGNAL write_axi_weight_addr_tmp        : std_logic_vector(9 DOWNTO 0);  -- ufix10
  SIGNAL write_axi_wrEnBias_tmp           : std_logic_vector(7 DOWNTO 0);  -- ufix8
  SIGNAL write_axi_wrEnWeights_tmp        : std_logic_vector(7 DOWNTO 0);  -- ufix8
  SIGNAL write_axi_layerNr_tmp            : std_logic_vector(7 DOWNTO 0);  -- ufix8
  SIGNAL write_axi_number_of_inputs_tmp   : std_logic_vector(9 DOWNTO 0);  -- ufix10
  SIGNAL write_axi_output_number_configuration_tmp : std_logic_vector(9 DOWNTO 0);  -- ufix10
  SIGNAL write_axi_x_input_tmp            : vector_of_std_logic_vector32(0 TO 15);  -- ufix32 [16]
...
BEGIN
  u_uz_mlp_three_layer_addr_decoder_inst : uz_mlp_three_layer_addr_decoder
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
              ...
              read_axi_valid_output => read_axi_valid_output,  -- ufix1
              read_axi_nn_output => read_axi_nn_output,  -- sfix32_En14 [8]
              data_read => top_data_read,  -- ufix32
              write_axi_enable => write_axi_enable,  -- ufix1
              write_axi_enable_nn => write_axi_enable_nn,  -- ufix1
              write_axi_bias => write_axi_bias_tmp,  -- sfix32_En14
              write_axi_weight => write_axi_weight_tmp,  -- sfix32_En14
              write_axi_bias_addr => write_axi_bias_addr_tmp,  -- ufix10
              write_axi_weight_addr => write_axi_weight_addr_tmp,  -- ufix10
              write_axi_wrEnBias => write_axi_wrEnBias_tmp,  -- ufix8
              write_axi_wrEnWeights => write_axi_wrEnWeights_tmp,  -- ufix8
              write_axi_layerNr => write_axi_layerNr_tmp,  -- ufix8
              write_use_axi_input => write_use_axi_input,  -- ufix1
              write_axi_number_of_inputs => write_axi_number_of_inputs_tmp,  -- ufix10
              write_axi_output_number_configuration => write_axi_output_number_configuration_tmp,  -- ufix10
              write_disable_pl_trigger => write_disable_pl_trigger,  -- ufix1
              write_axi_x_input => write_axi_x_input_tmp  -- sfix32_En14 [16]
              );

  u_uz_mlp_three_layer_axi4_module_inst : uz_mlp_three_layer_axi4_module
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
  ...
  write_axi_bias <= write_axi_bias_tmp;

  write_axi_weight <= write_axi_weight_tmp;

  write_axi_bias_addr <= write_axi_bias_addr_tmp;

  write_axi_weight_addr <= write_axi_weight_addr_tmp;

  write_axi_wrEnBias <= write_axi_wrEnBias_tmp;

  write_axi_wrEnWeights <= write_axi_wrEnWeights_tmp;

  write_axi_layerNr <= write_axi_layerNr_tmp;

  write_axi_number_of_inputs <= write_axi_number_of_inputs_tmp;

  write_axi_output_number_configuration <= write_axi_output_number_configuration_tmp;

  write_axi_x_input <= write_axi_x_input_tmp;
