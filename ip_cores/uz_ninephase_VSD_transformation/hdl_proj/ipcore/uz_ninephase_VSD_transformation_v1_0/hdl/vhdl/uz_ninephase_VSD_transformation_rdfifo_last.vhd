-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\valen\Documents\repos\UZ\ultrazohm_sw\ip_cores\uz_ninephase_VSD_transformation\hdl_proj\hdlsrc\uz_ninephase_VSD_transformation\uz_ninephase_VSD_transformation_rdfifo_last.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_ninephase_VSD_transformation_rdfifo_last
-- Source Path: uz_ninephase_VSD_transformation/uz_ninephase_VSD_transformation_axi4/uz_ninephase_VSD_transformation_axi4_module/uz_ninephase_VSD_transformation_rdfifo_last
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_ninephase_VSD_transformation_rdfifo_last IS
...
END uz_ninephase_VSD_transformation_rdfifo_last;


ARCHITECTURE rtl OF uz_ninephase_VSD_transformation_rdfifo_last IS

  -- Component Declarations
  COMPONENT uz_ninephase_VSD_transformation_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : uz_ninephase_VSD_transformation_SimpleDualPortRAM_singlebit
    USE ENTITY work.uz_ninephase_VSD_transformation_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_uz_ninephase_VSD_transformation_rdfifo_last_classic_ram_singlebit : uz_ninephase_VSD_transformation_SimpleDualPortRAM_singlebit
