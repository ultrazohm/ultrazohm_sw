...
entity BGD_p_anonymous_namespace_dot_tree_float_3u_unsigned_int_float_s is
port (
...
architecture behav of BGD_p_anonymous_namespace_dot_tree_float_3u_unsigned_int_float_s is 
...
attribute shreg_extract : string;
    ...
    component BGD_mul_float_8u_unsigned_int_float_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component BGD_sum_float_3u_unsigned_int_float_s IS
    port (
        p_x_dout : IN STD_LOGIC_VECTOR (255 downto 0);
        p_x_empty_n : IN STD_LOGIC;
        p_x_read : OUT STD_LOGIC;
    ...
    component BGD_fifo_w256_d2_S_x IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component BGD_start_for_sum_float_3u_unsigned_int_float_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    mul_float_8u_unsigned_int_float_U0 : component BGD_mul_float_8u_unsigned_int_float_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    sum_float_3u_unsigned_int_float_U0 : component BGD_sum_float_3u_unsigned_int_float_s
    port map (
    ...
    l_mulStr_U : component BGD_fifo_w256_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    start_for_sum_float_3u_unsigned_int_float_U0_U : component BGD_start_for_sum_float_3u_unsigned_int_float_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
