-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/dac_spi/uz_dac_axi4.vhd
...
-- 
-- Module: uz_dac_axi4
-- Source Path: uz_dac/uz_dac_axi4
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF uz_dac_axi4 IS

  -- Component Declarations
  COMPONENT uz_dac_addr_decoder
  ...
  FOR ALL : uz_dac_addr_decoder
    USE ENTITY work.uz_dac_addr_decoder(rtl);

  FOR ALL : uz_dac_axi4_module
    USE ENTITY work.uz_dac_axi4_module(rtl);
...
BEGIN
  u_uz_dac_addr_decoder_inst : uz_dac_addr_decoder
  ...
  u_uz_dac_axi4_module_inst : uz_dac_axi4_module
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
