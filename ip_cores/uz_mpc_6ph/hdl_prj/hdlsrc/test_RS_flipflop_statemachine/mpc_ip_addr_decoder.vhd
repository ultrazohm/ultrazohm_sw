-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\test_RS_flipflop_statemachine\mpc_ip_addr_decoder.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mpc_ip_addr_decoder
-- Source Path: mpc_ip/mpc_ip_axi_lite/mpc_ip_addr_decoder
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END mpc_ip_addr_decoder;


ARCHITECTURE rtl OF mpc_ip_addr_decoder IS
