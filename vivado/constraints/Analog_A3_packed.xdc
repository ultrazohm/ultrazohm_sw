...
set_property PACKAGE_PIN AK7 [get_ports {A3_IN[0]}]
set_property PACKAGE_PIN AK6 [get_ports {A3_IN[1]}]
#ANL_03_N_Ch3 = B64_L15_N

#Analog_04
#ANL_04_P_Ch3 = B65_L20_P
set_property PACKAGE_PIN AE3 [get_ports {A3_IN[2]}]
set_property PACKAGE_PIN AE2 [get_ports {A3_IN[3]}]
...
set_property PACKAGE_PIN AC2 [get_ports {A3_IN[6]}]
set_property PACKAGE_PIN AD2 [get_ports {A3_IN[7]}]
#ANL_06_N_Ch3 = B65_L21_N

#Analog_07
#ANL_07_P_Ch3 = B64_L23_P
set_property PACKAGE_PIN AF3 [get_ports {A3_IN[8]}]
set_property PACKAGE_PIN AG3 [get_ports {A3_IN[9]}]
...
set_property PACKAGE_PIN AD4 [get_ports {A3_IN[12]}]
set_property PACKAGE_PIN AE4 [get_ports {A3_IN[13]}]
#ANL_09_N_Ch3 = B65_L17_N

#Analog_10
set_property PACKAGE_PIN AC7 [get_ports {A3_IN[14]}]
#ANL_10_P_Ch3 = B65_L11_P
set_property PACKAGE_PIN AD7 [get_ports 	A3_IN[16]		]
...
set_property IOSTANDARD LVCMOS18 [get_ports {A3_OUT_CNV[1]}]
set_property IOSTANDARD LVCMOS18 [get_ports {A3_OUT_CNV[0]}]
