-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\external_state_machine\delay_comp_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: delay_comp_axi_lite
-- Source Path: delay_comp/delay_comp_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END delay_comp_axi_lite;


ARCHITECTURE rtl OF delay_comp_axi_lite IS

  -- Component Declarations
  COMPONENT delay_comp_addr_decoder
  ...
  COMPONENT delay_comp_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : delay_comp_addr_decoder
    USE ENTITY work.delay_comp_addr_decoder(rtl);

  FOR ALL : delay_comp_axi_lite_module
    USE ENTITY work.delay_comp_axi_lite_module(rtl);
...
BEGIN
  u_delay_comp_addr_decoder_inst : delay_comp_addr_decoder
  ...
  u_delay_comp_axi_lite_module_inst : delay_comp_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
