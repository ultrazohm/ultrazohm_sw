-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\parallel_8_min_cost_function\hdlsrc\parallel_8_min_cost_function\parallel_8_min_cost_function_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: parallel_8_min_cost_function_dut
-- Source Path: parallel_8_min_cost_function/parallel_8_min_cost_function_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY parallel_8_min_cost_function_dut IS
...
END parallel_8_min_cost_function_dut;


ARCHITECTURE rtl OF parallel_8_min_cost_function_dut IS

  -- Component Declarations
  COMPONENT parallel_8_min_cost_function_src_Min_cost_function_and_vopt2
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : parallel_8_min_cost_function_src_Min_cost_function_and_vopt2
    USE ENTITY work.parallel_8_min_cost_function_src_Min_cost_function_and_vopt2(rtl);
...
BEGIN
  u_parallel_8_min_cost_function_src_Min_cost_function_and_vopt2 : parallel_8_min_cost_function_src_Min_cost_function_and_vopt2
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
