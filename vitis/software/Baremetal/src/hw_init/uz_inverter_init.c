#include "../include/uz_inverter_init.h"
#include "../uz/uz_HAL.h"
#include "../uz/uz_global_configuration.h"
#include "xparameters.h"

static struct uz_inverter_adapter_config_t uz_inverter_config_d1_left = {
...
static struct uz_inverter_adapter_config_t uz_inverter_config_d2_right = {
               .base_address = XPAR_UZ_USER_UZ_INVERTER_ADAPTER_UZ_D_INVERTER_ADAPTER_1_BASEADDR,
               .ip_clk_frequency_Hz = 100000000,
               .linear_interpolation_params = {-289.01f, 218.72f}
};

static struct uz_inverter_adapter_outputs_t uz_inverter_outputs_d1_left = {
...
static struct uz_inverter_adapter_outputs_t uz_inverter_outputs_d2_right = {
   .PWMdutyCycNormalized_H1 = 0.0f,
   .PWMdutyCycNormalized_L1 = 0.0f,
   .PWMdutyCycNormalized_H2 = 0.0f,
   .PWMdutyCycNormalized_L2 = 0.0f,
...
uz_inverter_adapter_t* initialize_uz_inverter_on_D1_left(void) {
       return(uz_inverter_adapter_init(uz_inverter_config_d1_left, uz_inverter_outputs_d1_left));
}

uz_inverter_adapter_t* initialize_uz_inverter_on_D2_right(void) {
       return(uz_inverter_adapter_init(uz_inverter_config_d2_right, uz_inverter_outputs_d2_right));
}
