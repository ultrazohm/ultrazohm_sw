...
// Defines that map MIO number to carrier signal name
...
// LED on carrier board
#define LED_1								EXT_GPIO_1
#define LED_2								EXT_GPIO_2
#define LED_3								EXT_GPIO_3
#define LED_4								EXT_GPIO_4

// Defines that map carrier signal to cabinet / frontpanel
#define LED_ready							EXT_GPIO_1
#define LED_running							EXT_GPIO_2
#define LED_error							EXT_GPIO_3
#define LED_1_frontpanel					EXT_GPIO_4
