-- -------------------------------------------------------------
-- 
-- File Name: C:\UltraZohm\ultrazohm_test\ip_cores\uz_deadbeat_clean\hdl_prj\hdlsrc\uz_deadbeat_clean\uz_deadbeat_clean_ip_rdfifo_rid.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_deadbeat_clean_ip_rdfifo_rid
-- Source Path: uz_deadbeat_clean_ip/uz_deadbeat_clean_ip_axi4/uz_deadbeat_clean_ip_axi4_module/uz_deadbeat_clean_ip_rdfifo_rid
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_deadbeat_clean_ip_rdfifo_rid IS
...
END uz_deadbeat_clean_ip_rdfifo_rid;


ARCHITECTURE rtl OF uz_deadbeat_clean_ip_rdfifo_rid IS
...
BEGIN
  ...
  u_uz_deadbeat_clean_ip_rdfifo_rid_classic_ram : uz_deadbeat_clean_ip_SimpleDualPortRAM_generic
