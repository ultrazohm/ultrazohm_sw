-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/uz_mlp_three_layer/uz_mlp_three_layer_src_reluLayer_8Parallel1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_mlp_three_layer_src_reluLayer_8Parallel1
-- Source Path: uz_mlp_three_layer/uz_mlp_three_layer/reluLayer_8Parallel1
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_mlp_three_layer_src_reluLayer_8Parallel1 IS
...
END uz_mlp_three_layer_src_reluLayer_8Parallel1;


ARCHITECTURE rtl OF uz_mlp_three_layer_src_reluLayer_8Parallel1 IS

  -- Component Declarations
  COMPONENT uz_mlp_three_layer_src_MAC3_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT uz_mlp_three_layer_src_StateMachines1_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT uz_mlp_three_layer_src_MAC8
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          rd_addr                         :   IN    std_logic_vector(9 DOWNTO 0);  -- ufix10
  ...
  COMPONENT uz_mlp_three_layer_src_MAC1_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          rd_addr                         :   IN    std_logic_vector(9 DOWNTO 0);  -- ufix10
  ...
  COMPONENT uz_mlp_three_layer_src_MAC_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          rd_addr                         :   IN    std_logic_vector(9 DOWNTO 0);  -- ufix10
  ...
  COMPONENT uz_mlp_three_layer_src_MAC4_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          rd_addr                         :   IN    std_logic_vector(9 DOWNTO 0);  -- ufix10
  ...
  COMPONENT uz_mlp_three_layer_src_MAC5_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          rd_addr                         :   IN    std_logic_vector(9 DOWNTO 0);  -- ufix10
  ...
  COMPONENT uz_mlp_three_layer_src_MAC6_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          rd_addr                         :   IN    std_logic_vector(9 DOWNTO 0);  -- ufix10
  ...
  COMPONENT uz_mlp_three_layer_src_MAC7_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          rd_addr                         :   IN    std_logic_vector(9 DOWNTO 0);  -- ufix10
  ...
  FOR ALL : uz_mlp_three_layer_src_MAC3_block1
    USE ENTITY work.uz_mlp_three_layer_src_MAC3_block1(rtl);

  FOR ALL : uz_mlp_three_layer_src_StateMachines1_block1
    USE ENTITY work.uz_mlp_three_layer_src_StateMachines1_block1(rtl);

  FOR ALL : uz_mlp_three_layer_src_MATLAB_Function1
    USE ENTITY work.uz_mlp_three_layer_src_MATLAB_Function1(rtl);

  FOR ALL : uz_mlp_three_layer_src_MAC8
    USE ENTITY work.uz_mlp_three_layer_src_MAC8(rtl);

  FOR ALL : uz_mlp_three_layer_src_MAC1_block1
    USE ENTITY work.uz_mlp_three_layer_src_MAC1_block1(rtl);

  FOR ALL : uz_mlp_three_layer_src_MAC_block1
    USE ENTITY work.uz_mlp_three_layer_src_MAC_block1(rtl);

  FOR ALL : uz_mlp_three_layer_src_MAC4_block
    USE ENTITY work.uz_mlp_three_layer_src_MAC4_block(rtl);

  FOR ALL : uz_mlp_three_layer_src_MAC5_block
    USE ENTITY work.uz_mlp_three_layer_src_MAC5_block(rtl);

  FOR ALL : uz_mlp_three_layer_src_MAC6_block
    USE ENTITY work.uz_mlp_three_layer_src_MAC6_block(rtl);

  FOR ALL : uz_mlp_three_layer_src_MAC7_block
    USE ENTITY work.uz_mlp_three_layer_src_MAC7_block(rtl);
  ...
  SIGNAL MATLAB_Function1_out1            : std_logic_vector(7 DOWNTO 0);  -- ufix8
  SIGNAL MATLAB_Function1_out1_unsigned   : unsigned(7 DOWNTO 0);  -- uint8
  SIGNAL MAC3_out1_signed                 : signed(31 DOWNTO 0);  -- sfix32_En14
  SIGNAL MAC8_out1                        : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL MAC8_out1_signed                 : signed(31 DOWNTO 0);  -- sfix32_En14
...
BEGIN
  u_MAC3 : uz_mlp_three_layer_src_MAC3_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_StateMachines1 : uz_mlp_three_layer_src_StateMachines1_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_MATLAB_Function1 : uz_mlp_three_layer_src_MATLAB_Function1
    PORT MAP( readAddr => std_logic_vector(Delay3_out1),  -- ufix10
              y => MATLAB_Function1_out1  -- uint8
              );

  u_MAC8 : uz_mlp_three_layer_src_MAC8
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              rd_addr => ram_rd_addr,  -- ufix10
              ...
              fromStateMachine_write_enable => StateMachines1_out4_write_enable,
              fromStateMachine_n_perceptron => StateMachines1_out4_n_perceptron,  -- ufix10
              rd_dout => MAC8_out1  -- sfix32_En14
              );

  u_MAC1 : uz_mlp_three_layer_src_MAC1_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              rd_addr => ram_rd_addr,  -- ufix10
  ...
  u_MAC : uz_mlp_three_layer_src_MAC_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              rd_addr => ram_rd_addr,  -- ufix10
  ...
  u_MAC4 : uz_mlp_three_layer_src_MAC4_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              rd_addr => ram_rd_addr,  -- ufix10
  ...
  u_MAC5 : uz_mlp_three_layer_src_MAC5_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              rd_addr => ram_rd_addr,  -- ufix10
  ...
  u_MAC6 : uz_mlp_three_layer_src_MAC6_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              rd_addr => ram_rd_addr,  -- ufix10
  ...
  u_MAC7 : uz_mlp_three_layer_src_MAC7_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              rd_addr => ram_rd_addr,  -- ufix10
  ...
  MATLAB_Function1_out1_unsigned <= unsigned(MATLAB_Function1_out1);
  ...
  layer1_output <= MAC3_out1_signed WHEN MATLAB_Function1_out1_unsigned = to_unsigned(16#00#, 8) ELSE
      MAC8_out1_signed WHEN MATLAB_Function1_out1_unsigned = to_unsigned(16#01#, 8) ELSE
      MAC1_out1_signed WHEN MATLAB_Function1_out1_unsigned = to_unsigned(16#02#, 8) ELSE
      MAC_out1_signed WHEN MATLAB_Function1_out1_unsigned = to_unsigned(16#03#, 8) ELSE
      MAC4_out1_signed WHEN MATLAB_Function1_out1_unsigned = to_unsigned(16#04#, 8) ELSE
      MAC5_out1_signed WHEN MATLAB_Function1_out1_unsigned = to_unsigned(16#05#, 8) ELSE
      MAC6_out1_signed WHEN MATLAB_Function1_out1_unsigned = to_unsigned(16#06#, 8) ELSE
      MAC7_out1_signed;
