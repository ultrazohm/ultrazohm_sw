-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/uz_plantModel_pt1/uz_plantModel_pt1_src_nfp_relop_double.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_plantModel_pt1_src_nfp_relop_double
-- Source Path: uz_plantModel_pt1/uz_plantModel_pt1/nfp_relop_double
-- Hierarchy Level: 1
-- 
...
ENTITY uz_plantModel_pt1_src_nfp_relop_double IS
...
END uz_plantModel_pt1_src_nfp_relop_double;


ARCHITECTURE rtl OF uz_plantModel_pt1_src_nfp_relop_double IS
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay_PS_2_out1 <= '0';
      ELSIF enb = '1' THEN
        Delay_PS_2_out1 <= Logical_Operator_out1_1;
      END IF;
    END IF;
  ...
  Logical_Operator_out1_2 <= Delay_PS_2_out1 OR Delay1_PS_2_out1_1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay1_PS_3_out1 <= '0';
      ELSIF enb = '1' THEN
        Delay1_PS_3_out1 <= Delay1_PS_2_out1;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay_PS_3_out1 <= '0';
      ELSIF enb = '1' THEN
        Delay_PS_3_out1 <= Logical_Operator_out1_2;
      END IF;
    END IF;
  ...
  Logical_Operator1_out1_2 <=  NOT Relational_Operator_relop1;

  Constant1_out1_1 <= '1';

  
  Switch2_out1 <= Logical_Operator2_out1_1 WHEN Delay1_PS_3_out1 = '0' ELSE
      Constant1_out1_1;

  Constant_out1_1 <= '0';

  
  Switch1_out1 <= Switch2_out1 WHEN Logical_Operator1_out1_2 = '0' ELSE
      Constant_out1_1;
