...
static struct uz_inverter_adapter_config_t uz_inverter_adapter_config_d3 = {
               .base_address = XPAR_UZ_USER_UZ_INVERTER_ADAPTER_UZ_D_INVERTER_ADAPTER_2_BASEADDR,
               .ip_clk_frequency_Hz = 100000000,
               .linear_interpolation_params = {162.35f, 20.107f}
};

static struct uz_inverter_adapter_outputs_t uz_inverter_adapter_outputs_d3 = {
   .PWMdutyCycNormalized_H1 = 0.0f,
   .PWMdutyCycNormalized_L1 = 0.0f,
   .PWMdutyCycNormalized_H2 = 0.0f,
   .PWMdutyCycNormalized_L2 = 0.0f,
