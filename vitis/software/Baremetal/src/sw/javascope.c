...
int JavaScope_initialize(DS_Data* data)
{
	...
	js_ch_observable[JSO_ASM_ia]				= &data->av.ASM_ia;
	js_ch_observable[JSO_ASM_ib]				= &data->av.ASM_ib;
	js_ch_observable[JSO_ASM_ic]				= &data->av.ASM_ic;
	...
	js_ch_observable[JSO_ASM_vdc]				= &data->av.ASM_vdc;
	js_ch_observable[JSO_VA_vdc]				= &data->av.VA_vdc;
	js_ch_observable[JSO_ASM_mechanicalRotorSpeed] = &data->av.ASM_mechanicalRotorSpeed;
	js_ch_observable[JSO_ASM_mechanicalRotorSpeed_filtered] = &data->av.ASM_mechanicalRotorSpeed_filtered;
	js_ch_observable[JSO_ASM_mechanicalPosition] = &data->av.ASM_mechanicalPosition;
	...
	js_ch_observable[JSO_ASM_I_d]				= &data->av.ASM_I_d;
	js_ch_observable[JSO_ASM_I_q]				= &data->av.ASM_I_q;
	js_ch_observable[JSO_VA_I_d]				= &data->av.VA_I_d;
	js_ch_observable[JSO_VA_I_q]				= &data->av.VA_I_q;
	js_ch_observable[JSO_ASM_theta_elec]		= &data->av.ASM_theta_elec;
	js_ch_observable[JSO_ASM_theta_mech]		= &data->av.ASM_theta_mech;
	js_ch_observable[JSO_ASM_theta_offset]		= &data->av.ASM_theta_offset;
	js_ch_observable[JSO_ASM_theta_elec_advanced] = &data->av.ASM_theta_elec_advanced;
