-- -------------------------------------------------------------
-- 
-- File Name: /home/ts/Documents/integrate_nn_to_uz/ultrazohm_sw/ip_cores/nnAXI_v1_0/hdl_prj/hdlsrc/uz_mlp_three_layer/uz_mlp_three_layer_rdfifo_last.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_mlp_three_layer_rdfifo_last
-- Source Path: uz_mlp_three_layer/uz_mlp_three_layer_axi4/uz_mlp_three_layer_axi4_module/uz_mlp_three_layer_rdfifo_last
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_mlp_three_layer_rdfifo_last IS
...
END uz_mlp_three_layer_rdfifo_last;


ARCHITECTURE rtl OF uz_mlp_three_layer_rdfifo_last IS

  -- Component Declarations
  COMPONENT uz_mlp_three_layer_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : uz_mlp_three_layer_SimpleDualPortRAM_singlebit
    USE ENTITY work.uz_mlp_three_layer_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_uz_mlp_three_layer_rdfifo_last_classic_ram_singlebit : uz_mlp_three_layer_SimpleDualPortRAM_singlebit
