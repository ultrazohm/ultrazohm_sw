...
module MLP_padding_float_4u_unsigned_int_51 (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
reg   [29:0] i_reg_124;
wire   [29:0] p_n_cast2_i_i_fu_148_p1;
reg   [29:0] p_n_cast2_i_i_reg_225;
reg    ap_block_state1;
wire   [29:0] l_totalNum_fu_168_p3;
reg   [29:0] l_totalNum_reg_230;
wire   [61:0] mul_ln52_fu_184_p2;
reg   [61:0] mul_ln52_reg_235;
wire   [0:0] icmp_ln58_fu_190_p2;
wire    ap_block_state2_pp0_stage0_iter0;
reg    ap_predicate_op38_read_state3;
reg    ap_block_state3_pp0_stage0_iter1;
reg    ap_block_pp0_stage0_11001;
wire   [61:0] add_ln58_fu_195_p2;
reg    ap_enable_reg_pp0_iter0;
wire   [0:0] icmp_ln61_fu_214_p2;
wire   [29:0] i_4_fu_219_p2;
...
wire   [29:0] add_ln56_fu_152_p2;
wire   [27:0] tmp_4_fu_158_p4;
wire   [31:0] mul_ln52_fu_184_p0;
wire   [29:0] mul_ln52_fu_184_p1;
wire   [0:0] icmp_ln59_fu_201_p2;
wire   [29:0] select_ln58_fu_206_p3;
wire    ap_CS_fsm_state4;
reg   [2:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
wire   [61:0] mul_ln52_fu_184_p00;
wire   [61:0] mul_ln52_fu_184_p10;
...
MLP_mul_32ns_30ns_62_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 30 ),
    .dout_WIDTH( 62 ))
mul_32ns_30ns_62_1_1_U244(
...
always @ (posedge ap_clk) begin
    if ((~((real_start == 1'b0) | (p_n_out_full_n == 1'b0) | (l_numElem_cast_loc_out_full_n == 1'b0) | (p_n_empty_n == 1'b0) | (l_numElem_cast_loc_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        l_totalNum_reg_230[29 : 2] <= l_totalNum_fu_168_p3[29 : 2];
        mul_ln52_reg_235 <= mul_ln52_fu_184_p2;
        p_n_cast2_i_i_reg_225[28 : 0] <= p_n_cast2_i_i_fu_148_p1[28 : 0];
    end
end
...
assign add_ln56_fu_152_p2 = (p_n_cast2_i_i_fu_148_p1 + 30'd3);

assign add_ln58_fu_195_p2 = (indvar_flatten_reg_113 + 62'd1);
...
assign i_4_fu_219_p2 = (select_ln58_fu_206_p3 + 30'd1);
...
assign select_ln58_fu_206_p3 = ((icmp_ln59_fu_201_p2[0:0] === 1'b1) ? 30'd0 : i_reg_124);

assign start_out = real_start;

assign tmp_4_fu_158_p4 = {{add_ln56_fu_152_p2[29:2]}};

always @ (posedge ap_clk) begin
    p_n_cast2_i_i_reg_225[29] <= 1'b0;
    l_totalNum_reg_230[1:0] <= 2'b00;
end

endmodule //MLP_padding_float_4u_unsigned_int_51
