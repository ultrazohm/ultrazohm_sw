...
ENTITY UZ_D_GaN_Inverter_src_UZ_D_GaN_Inverter IS
  PORT( clk                               :   IN    std_logic;
        ...
        AXI_GaN_FAULT                     :   OUT   std_logic_vector(31 DOWNTO 0);  -- uint32
        AXI_GaN_OC                        :   OUT   std_logic_vector(31 DOWNTO 0);  -- uint32
        AXI_I_DIAG                        :   OUT   std_logic_vector(31 DOWNTO 0);  -- uint32
...
ARCHITECTURE rtl OF UZ_D_GaN_Inverter_src_UZ_D_GaN_Inverter IS
  ...
  COMPONENT UZ_D_GaN_Inverter_src_Detect_Rise_Positive4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  COMPONENT UZ_D_GaN_Inverter_src_Detect_Fall_Nonpositive4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  COMPONENT UZ_D_GaN_Inverter_src_HDL_Reciprocal4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          din                             :   IN    std_logic_vector(31 DOWNTO 0);  -- uint32
  ...
  COMPONENT UZ_D_GaN_Inverter_src_Detect_Rise_Positive5
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  COMPONENT UZ_D_GaN_Inverter_src_Detect_Fall_Nonpositive5
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  COMPONENT UZ_D_GaN_Inverter_src_HDL_Reciprocal5
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          din                             :   IN    std_logic_vector(31 DOWNTO 0);  -- uint32
  ...
  FOR ALL : UZ_D_GaN_Inverter_src_Detect_Rise_Positive4
    USE ENTITY work.UZ_D_GaN_Inverter_src_Detect_Rise_Positive4(rtl);

  FOR ALL : UZ_D_GaN_Inverter_src_Detect_Fall_Nonpositive4
    USE ENTITY work.UZ_D_GaN_Inverter_src_Detect_Fall_Nonpositive4(rtl);

  FOR ALL : UZ_D_GaN_Inverter_src_HDL_Reciprocal4
    USE ENTITY work.UZ_D_GaN_Inverter_src_HDL_Reciprocal4(rtl);

  FOR ALL : UZ_D_GaN_Inverter_src_Detect_Rise_Positive5
    USE ENTITY work.UZ_D_GaN_Inverter_src_Detect_Rise_Positive5(rtl);

  FOR ALL : UZ_D_GaN_Inverter_src_Detect_Fall_Nonpositive5
    USE ENTITY work.UZ_D_GaN_Inverter_src_Detect_Fall_Nonpositive5(rtl);

  FOR ALL : UZ_D_GaN_Inverter_src_HDL_Reciprocal5
    USE ENTITY work.UZ_D_GaN_Inverter_src_HDL_Reciprocal5(rtl);
  ...
  SIGNAL Detect_Rise_Positive4_out1       : std_logic;
  SIGNAL HDL_Counter4_out1                : unsigned(31 DOWNTO 0);  -- uint32
  ...
  SIGNAL AXI_freq_4                       : unsigned(31 DOWNTO 0);  -- uint32
  SIGNAL Delay30_out1                     : unsigned(31 DOWNTO 0);  -- uint32
  SIGNAL Detect_Fall_Nonpositive4_out1    : std_logic;
  ...
  SIGNAL AXI_lowtime_4                    : unsigned(31 DOWNTO 0);  -- uint32
  SIGNAL HDL_Reciprocal4_out1             : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL HDL_Reciprocal4_out1_unsigned    : unsigned(31 DOWNTO 0);  -- ufix32_En31
  SIGNAL Product4_mul_temp                : unsigned(63 DOWNTO 0);  -- ufix64_En31
  SIGNAL Product4_out1                    : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL Gain4_mul_temp                   : signed(63 DOWNTO 0);  -- sfix64_En54
  SIGNAL AXI_dutycyc_4                    : signed(31 DOWNTO 0);  -- sfix32_En24
  SIGNAL Detect_Rise_Positive5_out1       : std_logic;
  SIGNAL HDL_Counter5_out1                : unsigned(31 DOWNTO 0);  -- uint32
  ...
  SIGNAL AXI_freq_5                       : unsigned(31 DOWNTO 0);  -- uint32
  SIGNAL Delay33_out1                     : unsigned(31 DOWNTO 0);  -- uint32
  SIGNAL Detect_Fall_Nonpositive5_out1    : std_logic;
  SIGNAL Compare_To_Constant10_out1       : std_logic;
  SIGNAL switch_compare_1_11              : std_logic;
  SIGNAL AXI_hightime_5                   : unsigned(31 DOWNTO 0);  -- uint32
  SIGNAL Delay34_out1                     : unsigned(31 DOWNTO 0);  -- uint32
  SIGNAL AXI_lowtime_5                    : unsigned(31 DOWNTO 0);  -- uint32
  SIGNAL HDL_Reciprocal5_out1             : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL HDL_Reciprocal5_out1_unsigned    : unsigned(31 DOWNTO 0);  -- ufix32_En31
  SIGNAL Product5_mul_temp                : unsigned(63 DOWNTO 0);  -- ufix64_En31
  SIGNAL Product5_out1                    : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL Gain5_mul_temp                   : signed(63 DOWNTO 0);  -- sfix64_En54
  SIGNAL AXI_dutycyc_5                    : signed(31 DOWNTO 0);  -- sfix32_En24
  ...
  SIGNAL Bit_Concat_out1                  : unsigned(5 DOWNTO 0);  -- ufix6
...
BEGIN
  ...
  u_Detect_Rise_Positive4 : UZ_D_GaN_Inverter_src_Detect_Rise_Positive4
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              U => GaN_Temp5,
              Y => Detect_Rise_Positive4_out1
              );

  u_Detect_Fall_Nonpositive4 : UZ_D_GaN_Inverter_src_Detect_Fall_Nonpositive4
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              U => GaN_Temp5,
              Y => Detect_Fall_Nonpositive4_out1
              );

  u_HDL_Reciprocal4 : UZ_D_GaN_Inverter_src_HDL_Reciprocal4
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              din => std_logic_vector(AXI_freq_4),  -- uint32
              dout => HDL_Reciprocal4_out1  -- ufix32_En31
              );

  u_Detect_Rise_Positive5 : UZ_D_GaN_Inverter_src_Detect_Rise_Positive5
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              U => GaN_Temp6,
              Y => Detect_Rise_Positive5_out1
              );

  u_Detect_Fall_Nonpositive5 : UZ_D_GaN_Inverter_src_Detect_Fall_Nonpositive5
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              U => GaN_Temp6,
              Y => Detect_Fall_Nonpositive5_out1
              );

  u_HDL_Reciprocal5 : UZ_D_GaN_Inverter_src_HDL_Reciprocal5
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              din => std_logic_vector(AXI_freq_5),  -- uint32
              dout => HDL_Reciprocal5_out1  -- ufix32_En31
              );
  ...
  --  step value      = 1
  --  count to value  = 2500000
  HDL_Counter4_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        HDL_Counter4_out1 <= to_unsigned(1, 32);
      ELSIF enb = '1' THEN
        IF Detect_Rise_Positive4_out1 = '1' THEN 
          HDL_Counter4_out1 <= to_unsigned(1, 32);
        ELSIF HDL_Counter4_out1 >= to_unsigned(2500000, 32) THEN 
          HDL_Counter4_out1 <= to_unsigned(1, 32);
        ELSE 
          HDL_Counter4_out1 <= HDL_Counter4_out1 + to_unsigned(1, 32);
        END IF;
      END IF;
    END IF;
  ...
  Compare_To_Constant9_out1 <= '1' WHEN HDL_Counter4_out1 = to_unsigned(1, 32) ELSE
      '0';

  
  switch_compare_1_8 <= '1' WHEN Compare_To_Constant9_out1 > '0' ELSE
      '0';
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay29_out1 <= HDL_Counter4_out1;
      END IF;
    END IF;
  ...
  AXI_freq_4 <= Delay30_out1 WHEN switch_compare_1_8 = '0' ELSE
      Delay29_out1;

  AXI_Gan_Temp_5_freq <= std_logic_vector(AXI_freq_4);

  
  Compare_To_Constant8_out1 <= '1' WHEN Detect_Fall_Nonpositive4_out1 = '1' ELSE
      '0';

  
  switch_compare_1_9 <= '1' WHEN Compare_To_Constant8_out1 > '0' ELSE
      '0';
  ...
  AXI_hightime_4 <= Delay31_out1 WHEN switch_compare_1_9 = '0' ELSE
      Delay29_out1;

  AXI_Gan_Temp_5_hightime <= std_logic_vector(AXI_hightime_4);

  AXI_lowtime_4 <= AXI_freq_4 - AXI_hightime_4;

  AXI_Gan_Temp_5_lowtime <= std_logic_vector(AXI_lowtime_4);

  HDL_Reciprocal4_out1_unsigned <= unsigned(HDL_Reciprocal4_out1);

  Product4_mul_temp <= AXI_hightime_4 * HDL_Reciprocal4_out1_unsigned;
  Product4_out1 <= signed(Product4_mul_temp(32 DOWNTO 1));

  Gain4_mul_temp <= to_signed(1677721600, 32) * Product4_out1;
  AXI_dutycyc_4 <= Gain4_mul_temp(61 DOWNTO 30);

  AXI_Gan_Temp_5_dutycyc <= std_logic_vector(AXI_dutycyc_4);

  -- Count limited, Unsigned Counter
  --  initial value   = 1
  --  step value      = 1
  --  count to value  = 2500000
  HDL_Counter5_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        HDL_Counter5_out1 <= to_unsigned(1, 32);
      ELSIF enb = '1' THEN
        IF Detect_Rise_Positive5_out1 = '1' THEN 
          HDL_Counter5_out1 <= to_unsigned(1, 32);
        ELSIF HDL_Counter5_out1 >= to_unsigned(2500000, 32) THEN 
          HDL_Counter5_out1 <= to_unsigned(1, 32);
        ELSE 
          HDL_Counter5_out1 <= HDL_Counter5_out1 + to_unsigned(1, 32);
        END IF;
      END IF;
    END IF;
  ...
  Compare_To_Constant11_out1 <= '1' WHEN HDL_Counter5_out1 = to_unsigned(1, 32) ELSE
      '0';

  
  switch_compare_1_10 <= '1' WHEN Compare_To_Constant11_out1 > '0' ELSE
      '0';
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay32_out1 <= HDL_Counter5_out1;
      END IF;
    END IF;
  ...
  AXI_freq_5 <= Delay33_out1 WHEN switch_compare_1_10 = '0' ELSE
      Delay32_out1;

  AXI_Gan_Temp_6_freq <= std_logic_vector(AXI_freq_5);

  
  Compare_To_Constant10_out1 <= '1' WHEN Detect_Fall_Nonpositive5_out1 = '1' ELSE
      '0';

  
  switch_compare_1_11 <= '1' WHEN Compare_To_Constant10_out1 > '0' ELSE
      '0';
  ...
  AXI_hightime_5 <= Delay34_out1 WHEN switch_compare_1_11 = '0' ELSE
      Delay32_out1;

  AXI_Gan_Temp_6_hightime <= std_logic_vector(AXI_hightime_5);

  AXI_lowtime_5 <= AXI_freq_5 - AXI_hightime_5;

  AXI_Gan_Temp_6_lowtime <= std_logic_vector(AXI_lowtime_5);

  HDL_Reciprocal5_out1_unsigned <= unsigned(HDL_Reciprocal5_out1);

  Product5_mul_temp <= AXI_hightime_5 * HDL_Reciprocal5_out1_unsigned;
  Product5_out1 <= signed(Product5_mul_temp(32 DOWNTO 1));

  Gain5_mul_temp <= to_signed(1677721600, 32) * Product5_out1;
  AXI_dutycyc_5 <= Gain5_mul_temp(61 DOWNTO 30);

  AXI_Gan_Temp_6_dutycyc <= std_logic_vector(AXI_dutycyc_5);
  ...
  Bit_Concat_out1 <= unsigned'(Delay5_out1 & Delay4_out1 & Delay3_out1 & Delay2_out1 & Delay1_out1 & Delay_out1);

  Data_Type_Conversion2_out1 <= resize(Bit_Concat_out1, 32);

  AXI_GaN_FAULT <= std_logic_vector(Data_Type_Conversion2_out1);
  ...
  Bit_Concat1_out1 <= unsigned'(Delay11_out1 & Delay10_out1 & Delay9_out1 & Delay8_out1 & Delay7_out1 & Delay6_out1);

  Data_Type_Conversion1_out1 <= resize(Bit_Concat1_out1, 32);

  AXI_GaN_OC <= std_logic_vector(Data_Type_Conversion1_out1);
  ...
  Bit_Concat2_out1 <= unsigned'(Delay15_out1 & Delay14_out1 & Delay13_out1 & Delay12_out1);

  Data_Type_Conversion_out1 <= resize(Bit_Concat2_out1, 32);

  AXI_I_DIAG <= std_logic_vector(Data_Type_Conversion_out1);
