.. _Analog_MAX11331_Rev02:

=====================
Analog MAX11331 Rev02
=====================
...
- Offset and conversion factor are configurable by software individually for each ADC in ``main.c``
  ...
  - Conversion factor is set to 10/6.65*3.3 = 4.96241 by default due to the gain of amplifier circuit, described in the :ref:`MAX11331_measurement_gains` . 
