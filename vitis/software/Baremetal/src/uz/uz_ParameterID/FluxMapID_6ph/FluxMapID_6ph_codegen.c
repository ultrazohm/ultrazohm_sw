                    ...
                    DW_AMMstateIdentificationDQFl_t *localDW)
{
  ...
  switch (localDW->is_c14_Subchart_FluxMapID_refer) {
   ...
   case IN_calculatePsiAndNextStep:
    ...
    } else if (FluxMapID_output->WindingTemp > 70.0F) {
      /* Transition: '<S2>:107' */
  ...
  rtFluxMapID_6ph_codegen_M)
{
  ...
  if (rtFluxMapID_6ph_codegen_DW->is_active_c16_FluxMapID_6ph_cod == 0U) {
    ...
    if (rtFluxMapID_6ph_codegen_U->GlobalConfig_out.Reset ||
      ...
      switch (rtFluxMapID_6ph_codegen_DW->is_AMMstate) {
       ...
       default:
        ...
        /* '<S1>:757:1' sf_internal_predicateOutput = extended_controller_output.selected_subsystem == 2; */
        switch
          (rtFluxMapID_6ph_codegen_Y->extended_controller_output.selected_subsystem)
        {
         case 2:
         ...
         case 1:
          /* '<S1>:754:1' sf_internal_predicateOutput = extended_controller_output.selected_subsystem == 1; */
          /* Transition: '<S1>:754' */
    ...
    /* '<S1>:590:9' extended_controller_output.selected_subsystem = uint16(1); */
    rtFluxMapID_6ph_codegen_Y->extended_controller_output.selected_subsystem =
      1U;
