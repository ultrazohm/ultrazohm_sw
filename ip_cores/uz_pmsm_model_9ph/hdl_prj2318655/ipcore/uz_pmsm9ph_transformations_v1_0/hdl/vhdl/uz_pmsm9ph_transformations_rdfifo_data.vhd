-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj2318655/hdlsrc/uz_pmsm_model_9ph_21b_all_double/uz_pmsm9ph_transformations_rdfifo_data.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm9ph_transformations_rdfifo_data
-- Source Path: uz_pmsm9ph_transformations/uz_pmsm9ph_transformations_axi4/uz_pmsm9ph_transformations_axi4_module/uz_pmsm9ph_transformations_rdfifo_data
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_pmsm9ph_transformations_rdfifo_data IS
...
END uz_pmsm9ph_transformations_rdfifo_data;


ARCHITECTURE rtl OF uz_pmsm9ph_transformations_rdfifo_data IS

  -- Component Declarations
  COMPONENT uz_pmsm9ph_transformations_SimpleDualPortRAM_generic
  ...
  FOR ALL : uz_pmsm9ph_transformations_SimpleDualPortRAM_generic
    USE ENTITY work.uz_pmsm9ph_transformations_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_uz_pmsm9ph_transformations_rdfifo_data_classic_ram_generic : uz_pmsm9ph_transformations_SimpleDualPortRAM_generic
