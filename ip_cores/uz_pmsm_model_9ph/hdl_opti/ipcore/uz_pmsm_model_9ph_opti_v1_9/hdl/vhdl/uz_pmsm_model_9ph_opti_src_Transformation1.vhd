...
BEGIN
  ...
  enb_counter_ge_51_1 <= '1' WHEN enb_counter_unsigned >= to_unsigned(16#0033#, 16) ELSE
      '0';

  
  enb_counter_le_59_1 <= '1' WHEN enb_counter_unsigned <= to_unsigned(16#003B#, 16) ELSE
      '0';
