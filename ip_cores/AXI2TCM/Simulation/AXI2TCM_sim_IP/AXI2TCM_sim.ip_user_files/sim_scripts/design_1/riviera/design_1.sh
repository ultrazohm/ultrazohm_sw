...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/XilinxEyke/MPSOC/Zynq_Ultra_Repo/AA_IP_Repository/IPCores_xczu9EG/AXI2TCM/Simulation/AXI2TCM_sim_IP/AXI2TCM_sim.cache/compile_simlib/riviera"
  fi
