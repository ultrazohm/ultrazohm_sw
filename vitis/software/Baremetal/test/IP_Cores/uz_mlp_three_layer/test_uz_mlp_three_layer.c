...
#include "../uz_prng_mtwister/mt19937.h"
#include "../uz_prng_xoshiro/splitmix64.h"
#include "../uz_prng_xoshiro/xoshiro128plusplus.h"
...
uz_mlp_three_layer_ip_t *successful_init(void)
{
    config.software_network = uz_nn_init(software_nn_config, 4,false);
