-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/gmStateSpaceHDL_uz_inverter_3ph/uz_invert_ip_addr_decoder.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_invert_ip_addr_decoder
-- Source Path: uz_invert_ip/uz_invert_ip_axi4/uz_invert_ip_addr_decoder
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
USE work.uz_invert_ip_pkg.ALL;

ENTITY uz_invert_ip_addr_decoder IS
...
END uz_invert_ip_addr_decoder;


ARCHITECTURE rtl OF uz_invert_ip_addr_decoder IS
...
BEGIN
  ...
  decode_sel_u_abc_ps_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#005C#, 14) ELSE
      '0';
  ...
  decode_sel_u_abc_ps <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0060#, 14) ELSE
      '0';
  ...
  reg_u_abc_ps_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
      ...
      ELSIF enb = '1' AND strobe_reg_u_abc_ps = '1' THEN
  ...
  decode_sel_u_abc_ps_1_2 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#005D#, 14) ELSE
      '0';
  ...
  decode_sel_u_abc_ps_1_3 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#005E#, 14) ELSE
      '0';
  ...
  reg_switch_pspl_abc_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_switch_pspl_abc_1_1 <= '0';
      ELSIF enb = '1' AND reg_enb_switch_pspl_abc_1_1 = '1' THEN
  ...
  reg_switch_pspl_gate_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_switch_pspl_gate_1_1 <= '0';
      ELSIF enb = '1' AND reg_enb_switch_pspl_gate_1_1 = '1' THEN
  ...
  reg_u_dc_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_u_dc_1_1 <= to_unsigned(0, 32);
      ELSIF enb = '1' AND reg_enb_u_dc_1_1 = '1' THEN
  ...
  decode_sel_i_abc_ps <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0048#, 14) ELSE
      '0';
  ...
  decode_sel_i_abc_ps_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0044#, 14) ELSE
      '0';

  reg_enb_i_abc_ps_1_1 <= decode_sel_i_abc_ps_1_1 AND wr_enb;

  
  decode_sel_i_abc_ps_2_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0045#, 14) ELSE
      '0';

  reg_enb_i_abc_ps_2_1 <= decode_sel_i_abc_ps_2_1 AND wr_enb;

  
  decode_sel_i_abc_ps_3_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0046#, 14) ELSE
      '0';
  ...
  reg_i_abc_ps_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_i_abc_ps_1_1 <= to_unsigned(0, 32);
      ELSIF enb = '1' AND reg_enb_i_abc_ps_1_1 = '1' THEN
  ...
  reg_i_abc_ps_2_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_i_abc_ps_2_1 <= to_unsigned(0, 32);
      ELSIF enb = '1' AND reg_enb_i_abc_ps_2_1 = '1' THEN
  ...
  reg_i_abc_ps_3_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_i_abc_ps_3_1 <= to_unsigned(0, 32);
      ELSIF enb = '1' AND reg_enb_i_abc_ps_3_1 = '1' THEN
  ...
  sync_reg_i_abc_ps_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
  ...
  decode_sel_gate_ps <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0058#, 14) ELSE
      '0';
  ...
  decode_sel_gate_ps_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0050#, 14) ELSE
      '0';
  ...
  decode_sel_gate_ps_2_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0051#, 14) ELSE
      '0';

  reg_enb_gate_ps_2_1 <= decode_sel_gate_ps_2_1 AND wr_enb;

  
  decode_sel_gate_ps_3_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0052#, 14) ELSE
      '0';

  reg_enb_gate_ps_3_1 <= decode_sel_gate_ps_3_1 AND wr_enb;

  
  decode_sel_gate_ps_4_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0053#, 14) ELSE
      '0';

  reg_enb_gate_ps_4_1 <= decode_sel_gate_ps_4_1 AND wr_enb;

  
  decode_sel_gate_ps_5_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0054#, 14) ELSE
      '0';

  reg_enb_gate_ps_5_1 <= decode_sel_gate_ps_5_1 AND wr_enb;

  
  decode_sel_gate_ps_6_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0055#, 14) ELSE
      '0';
  ...
  reg_gate_ps_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_gate_ps_1_1 <= '0';
      ELSIF enb = '1' AND reg_enb_gate_ps_1_1 = '1' THEN
  ...
  reg_gate_ps_2_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_gate_ps_2_1 <= '0';
      ELSIF enb = '1' AND reg_enb_gate_ps_2_1 = '1' THEN
  ...
  reg_gate_ps_3_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_gate_ps_3_1 <= '0';
      ELSIF enb = '1' AND reg_enb_gate_ps_3_1 = '1' THEN
  ...
  reg_gate_ps_4_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_gate_ps_4_1 <= '0';
      ELSIF enb = '1' AND reg_enb_gate_ps_4_1 = '1' THEN
  ...
  reg_gate_ps_5_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_gate_ps_5_1 <= '0';
      ELSIF enb = '1' AND reg_enb_gate_ps_5_1 = '1' THEN
  ...
  reg_gate_ps_6_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_gate_ps_6_1 <= '0';
      ELSIF enb = '1' AND reg_enb_gate_ps_6_1 = '1' THEN
  ...
  sync_reg_gate_ps_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
      ...
      ELSIF enb = '1' AND strobe_reg_gate_ps = '1' THEN
