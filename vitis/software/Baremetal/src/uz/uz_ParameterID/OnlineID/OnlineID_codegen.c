...
static void InitParams(ExtU_OnlineID_t *rtOnlineID_U, ExtY_OnlineID_t *rtOnlineID_Y, DW_OnlineID_t *rtOnlineID_DW);
static void enter_atomic_RefreshDataRegiste(ExtY_OnlineID_t *rtOnlineID_Y, DW_OnlineID_t *rtOnlineID_DW);
static void identParams(ExtU_OnlineID_t *rtOnlineID_U, ExtY_OnlineID_t *rtOnlineID_Y, DW_OnlineID_t *rtOnlineID_DW);
static void RefreshDataRegister_i1(ExtU_OnlineID_t *rtOnlineID_U, DW_OnlineID_t * rtOnlineID_DW);
static boolean_T Break(const real32_T iq_reg_alt[50], const real32_T id_reg_alt[50], const real32_T om_reg_alt[5], const real32_T iq_reg_neu[10], const real32_T id_reg_neu[10],
                const real32_T om_reg_neu[5], ExtU_OnlineID_t *rtOnlineID_U);
static void enter_atomic_PsiCalcState(ExtU_OnlineID_t *rtOnlineID_U, ExtY_OnlineID_t *rtOnlineID_Y, DW_OnlineID_t *rtOnlineID_DW);
static void RefreshDataRegister_i(ExtU_OnlineID_t *rtOnlineID_U, DW_OnlineID_t *rtOnlineID_DW);
static void CheckSteadyState(const real32_T iq_reg_in[50], const real32_T id_reg_in[50], const real32_T om_reg_in[5], uint32_T timer, boolean_T *allow_measurement, boolean_T *om_con,
                boolean_T *iq_con, boolean_T *id_con, boolean_T *i_val, ExtU_OnlineID_t *rtOnlineID_U);
static void RefreshDataRegister(ExtU_OnlineID_t *rtOnlineID_U, ExtY_OnlineID_t *rtOnlineID_Y, DW_OnlineID_t *rtOnlineID_DW);
...
static void InitParams(ExtU_OnlineID_t *rtOnlineID_U, ExtY_OnlineID_t *rtOnlineID_Y, DW_OnlineID_t *rtOnlineID_DW)
{
	...
	rtOnlineID_DW->R_old_outside = rtOnlineID_U->GlobalConfig_out.PMSM_config.R_ph_Ohm;
	...
	rtOnlineID_DW->Ld_old_outside = rtOnlineID_U->GlobalConfig_out.PMSM_config.Ld_Henry;
	...
	rtOnlineID_DW->Lq_old_outside = rtOnlineID_U->GlobalConfig_out.PMSM_config.Lq_Henry;
	...
	rtOnlineID_DW->PsiPm_old_outside = rtOnlineID_U->GlobalConfig_out.PMSM_config.Psi_PM_Vs;
	...
	rtOnlineID_DW->PsiPm_old = rtOnlineID_U->GlobalConfig_out.PMSM_config.Psi_PM_Vs;

	/* '<S1>:241:59' PsiPm_veryold=single(GlobalConfig.PMSM_config.Psi_PM_Vs); */
	rtOnlineID_DW->PsiPm_veryold = rtOnlineID_U->GlobalConfig_out.PMSM_config.Psi_PM_Vs;
	...
	rtOnlineID_DW->Ld_veryold = rtOnlineID_U->GlobalConfig_out.PMSM_config.Ld_Henry;
	...
	rtOnlineID_DW->Lq_veryold = rtOnlineID_U->GlobalConfig_out.PMSM_config.Lq_Henry;
  ...
  /* Outputs */
	...
	rtOnlineID_Y->OnlineID_output.Rph_out = rtOnlineID_U->GlobalConfig_out.PMSM_config.R_ph_Ohm;
	...
	rtOnlineID_Y->OnlineID_output.psi_pm_out = rtOnlineID_U->GlobalConfig_out.PMSM_config.Psi_PM_Vs;

	/* '<S1>:241:80' OnlineID_output.Ld_out = single(GlobalConfig.PMSM_config.Ld_Henry); */
	rtOnlineID_Y->OnlineID_output.Ld_out = rtOnlineID_U->GlobalConfig_out.PMSM_config.Ld_Henry;

	/* '<S1>:241:81' OnlineID_output.Lq_out = single(GlobalConfig.PMSM_config.Lq_Henry); */
	rtOnlineID_Y->OnlineID_output.Lq_out = rtOnlineID_U->GlobalConfig_out.PMSM_config.Lq_Henry;
	...
	rtOnlineID_Y->OnlineID_output.psi_array[3] = rtOnlineID_U->OnlineIDConfig.Temp_ref;
	...
	rtOnlineID_Y->OnlineID_output.psi_array[4] = (tmp * rtOnlineID_U->GlobalConfig_out.PMSM_config.Ld_Henry + rtOnlineID_U->GlobalConfig_out.PMSM_config.Psi_PM_Vs) * 1000.0F;
	...
	rtOnlineID_Y->OnlineID_output.psi_array[5] = tmp * rtOnlineID_U->GlobalConfig_out.PMSM_config.Lq_Henry * 1000.0F;
	...
	rtOnlineID_Y->OnlineID_output.psi_array[9] = rtOnlineID_U->OnlineIDConfig.Temp_ref;
	...
	rtOnlineID_Y->OnlineID_output.psi_array[10] = (tmp * rtOnlineID_U->GlobalConfig_out.PMSM_config.Ld_Henry + rtOnlineID_U->GlobalConfig_out.PMSM_config.Psi_PM_Vs) * 1000.0F;
	...
	rtOnlineID_Y->OnlineID_output.psi_array[11] = tmp_0 * rtOnlineID_U->GlobalConfig_out.PMSM_config.Lq_Henry * 1000.0F;
	...
	rtOnlineID_Y->OnlineID_output.psi_array[15] = rtOnlineID_U->OnlineIDConfig.Temp_ref;
	...
	rtOnlineID_Y->OnlineID_output.psi_array[16] = (tmp * rtOnlineID_U->GlobalConfig_out.PMSM_config.Ld_Henry + rtOnlineID_U->GlobalConfig_out.PMSM_config.Psi_PM_Vs) * 1000.0F;
	...
	rtOnlineID_Y->OnlineID_output.psi_array[17] = tmp * rtOnlineID_U->GlobalConfig_out.PMSM_config.Lq_Henry * 1000.0F;
	...
	rtOnlineID_Y->OnlineID_output.psi_array[21] = rtOnlineID_U->OnlineIDConfig.Temp_ref;
	...
	rtOnlineID_Y->OnlineID_output.psi_array[22] = (tmp * rtOnlineID_U->GlobalConfig_out.PMSM_config.Ld_Henry + rtOnlineID_U->GlobalConfig_out.PMSM_config.Psi_PM_Vs) * 1000.0F;
	...
	rtOnlineID_Y->OnlineID_output.psi_array[23] = tmp_0 * rtOnlineID_U->GlobalConfig_out.PMSM_config.Lq_Henry * 1000.0F;
	...
	rtOnlineID_Y->OnlineID_output.psi_array[27] = rtOnlineID_U->OnlineIDConfig.Temp_ref;
	...
	rtOnlineID_Y->OnlineID_output.psi_array[28] = (tmp * rtOnlineID_U->GlobalConfig_out.PMSM_config.Ld_Henry + rtOnlineID_U->GlobalConfig_out.PMSM_config.Psi_PM_Vs) * 1000.0F;
	...
	rtOnlineID_Y->OnlineID_output.psi_array[29] = tmp * rtOnlineID_U->GlobalConfig_out.PMSM_config.Lq_Henry * 1000.0F;
	...
	rtOnlineID_Y->OnlineID_output.psi_array[33] = rtOnlineID_U->OnlineIDConfig.Temp_ref;
	...
	rtOnlineID_Y->OnlineID_output.psi_array[34] = (tmp * rtOnlineID_U->GlobalConfig_out.PMSM_config.Ld_Henry + rtOnlineID_U->GlobalConfig_out.PMSM_config.Psi_PM_Vs) * 1000.0F;
	...
	rtOnlineID_Y->OnlineID_output.psi_array[35] = tmp_0 * rtOnlineID_U->GlobalConfig_out.PMSM_config.Lq_Henry * 1000.0F;
	...
	rtOnlineID_Y->OnlineID_output.psi_array[39] = rtOnlineID_U->OnlineIDConfig.Temp_ref;
	...
	rtOnlineID_Y->OnlineID_output.psi_array[40] = (tmp * rtOnlineID_U->GlobalConfig_out.PMSM_config.Ld_Henry + rtOnlineID_U->GlobalConfig_out.PMSM_config.Psi_PM_Vs) * 1000.0F;
	...
	rtOnlineID_Y->OnlineID_output.psi_array[41] = tmp * rtOnlineID_U->GlobalConfig_out.PMSM_config.Lq_Henry * 1000.0F;
   ...
   */
	...
	rtOnlineID_Y->OnlineID_output.psi_array[45] = rtOnlineID_U->OnlineIDConfig.Temp_ref;
	...
	rtOnlineID_Y->OnlineID_output.psi_array[46] = (tmp * rtOnlineID_U->GlobalConfig_out.PMSM_config.Ld_Henry + rtOnlineID_U->GlobalConfig_out.PMSM_config.Psi_PM_Vs) * 1000.0F;
	...
	rtOnlineID_Y->OnlineID_output.psi_array[47] = tmp_0 * rtOnlineID_U->GlobalConfig_out.PMSM_config.Lq_Henry * 1000.0F;
...
static void identParams(ExtU_OnlineID_t *rtOnlineID_U, ExtY_OnlineID_t *rtOnlineID_Y, DW_OnlineID_t *rtOnlineID_DW)
{
  ...
  /* Inport: '<Root>/GlobalConfig' */
    ...
    /* Inport: '<Root>/GlobalConfig' */
		...
		psipm_check = roundf(0.5F / rtOnlineID_U->GlobalConfig_out.sampleTimeISR - 1.0F);
    ...
    /* Inport: '<Root>/GlobalConfig' */
      ...
      /* Inport: '<Root>/GlobalConfig' */
			...
			Lq_check = roundf(1.1F / rtOnlineID_U->GlobalConfig_out.sampleTimeISR - 1.0F);
			if (Lq_check < 4.2949673E+9F) {
				if (Lq_check >= 0.0F) {
					tmp = (uint32_T) Lq_check;
        } else {
  ...
  /* Inport: '<Root>/GlobalConfig' */
	...
	if (rtOnlineID_DW->counter == tmp) {
		...
		R_check = (rtOnlineID_DW->Vd2counter / Lq_check - rtOnlineID_DW->Vd1counter / psipm_check) / (rtOnlineID_DW->id2counter / Lq_check - rtOnlineID_DW->id1counter / psipm_check);
		...
		Lq_check = (rtOnlineID_DW->Vd1counter * rtOnlineID_DW->id2counter - rtOnlineID_DW->Vd2counter * rtOnlineID_DW->id1counter)
		                / (Lq_check * rtOnlineID_DW->id1counter - psipm_check * rtOnlineID_DW->id2counter);
		...
		psipm_check = (rtOnlineID_DW->Vq1counter - R_check * rtOnlineID_DW->iq1counter) * rtOnlineID_DW->id2counter / (psipm_check * rtOnlineID_DW->omega1counter)
		                - (rtOnlineID_DW->Vq2counter - R_check * rtOnlineID_DW->iq2counter) * rtOnlineID_DW->id1counter / (psipm_check * rtOnlineID_DW->omega2counter);
		...
		Ld_check = (((rtOnlineID_DW->Vq2counter - rtOnlineID_DW->Vq1counter) - (rtOnlineID_DW->iq2counter - rtOnlineID_DW->iq1counter) * R_check)
		                - (rtOnlineID_DW->omega2counter - rtOnlineID_DW->omega1counter) * psipm_check)
		                / (rtOnlineID_DW->id2counter * rtOnlineID_DW->omega2counter - rtOnlineID_DW->id1counter * rtOnlineID_DW->omega1counter);
		...
		if ((Ld_check > 0.0F) && (Ld_check < 1.0F)) {
			...
			if (rtOnlineID_U->OnlineIDConfig.AverageTransParams) {
				...
				if (rtOnlineID_DW->LinPara_ident_outside && (rtOnlineID_DW->counter_ausserhalb == 1)) {
					...
					rtOnlineID_Y->OnlineID_output.Ld_out = ((Ld_check + rtOnlineID_DW->Ld_old_outside) + Ld_veryold_outside) / 3.0F;
				} else if (rtOnlineID_DW->LinPara_ident_outside && (rtOnlineID_DW->counter_ausserhalb == 0)) {
					/* Outport: '<Root>/OnlineID_output' */
					...
					rtOnlineID_Y->OnlineID_output.Ld_out = ((Ld_check + rtOnlineID_DW->Ld_old_outside) + rtOnlineID_DW->Ld_old) / 3.0F;
				}
				...
				if (tmp_0 && (rtOnlineID_DW->counter_innerhalb == 1)) {
					...
					rtOnlineID_Y->OnlineID_output.Ld_out = ((Ld_check + rtOnlineID_DW->Ld_old) + rtOnlineID_DW->Ld_veryold) / 3.0F;
		...
		if ((Lq_check > 0.0F) && (Lq_check < 1.0F)) {
			...
			if (rtOnlineID_U->OnlineIDConfig.AverageTransParams) {
				...
				if (rtOnlineID_DW->LinPara_ident_outside && (rtOnlineID_DW->counter_ausserhalb == 1)) {
					...
					rtOnlineID_Y->OnlineID_output.Lq_out = ((Lq_check + rtOnlineID_DW->Lq_old_outside) + Ld_check) / 3.0F;
				} else if (rtOnlineID_DW->LinPara_ident_outside && (rtOnlineID_DW->counter_ausserhalb == 0)) {
					/* Outport: '<Root>/OnlineID_output' */
					...
					rtOnlineID_Y->OnlineID_output.Lq_out = ((Lq_check + rtOnlineID_DW->Lq_old_outside) + rtOnlineID_DW->Lq_old) / 3.0F;
				}
				...
				if (tmp_0 && (rtOnlineID_DW->counter_innerhalb == 1)) {
					...
					rtOnlineID_Y->OnlineID_output.Lq_out = ((Lq_check + rtOnlineID_DW->Lq_old) + rtOnlineID_DW->Lq_veryold) / 3.0F;
				} else if (tmp_0 && (rtOnlineID_DW->counter_innerhalb == 0)) {
					/* Outport: '<Root>/OnlineID_output' */
		...
		if ((psipm_check > 0.0F) && (psipm_check < 1.0F)) {
			...
			if (rtOnlineID_U->OnlineIDConfig.AverageTransParams) {
				...
				if (rtOnlineID_DW->LinPara_ident_outside && (rtOnlineID_DW->counter_ausserhalb == 1)) {
					...
					rtOnlineID_DW->PsiPm_old_outside = rtOnlineID_Y->OnlineID_output.psi_pm_out;

					/* '<S1>:101:117' OnlineID_output.psi_pm_out=(psipm_check+PsiPm_old_outside+PsiPm_veryold_outside)/single(3.0); */
					rtOnlineID_Y->OnlineID_output.psi_pm_out = ((psipm_check + rtOnlineID_DW->PsiPm_old_outside) + Lq_check) / 3.0F;
				} else if (rtOnlineID_DW->LinPara_ident_outside && (rtOnlineID_DW->counter_ausserhalb == 0)) {
					/* Outport: '<Root>/OnlineID_output' */
					...
					rtOnlineID_Y->OnlineID_output.psi_pm_out = ((psipm_check + rtOnlineID_DW->PsiPm_old_outside) + rtOnlineID_DW->PsiPm_old) / 3.0F;
        }
				...
				if (tmp_0 && (rtOnlineID_DW->counter_innerhalb == 1)) {
					...
					rtOnlineID_Y->OnlineID_output.psi_pm_out = ((psipm_check + rtOnlineID_DW->PsiPm_old) + rtOnlineID_DW->PsiPm_veryold) / 3.0F;
				} else if (tmp_0 && (rtOnlineID_DW->counter_innerhalb == 0)) {
					/* Outport: '<Root>/OnlineID_output' */
		...
		if ((R_check > 0.0F) && (R_check < 1000.0F)) {
			...
			if (rtOnlineID_U->OnlineIDConfig.AverageTransParams) {
				...
				if (rtOnlineID_DW->LinPara_ident_outside && (rtOnlineID_DW->counter_ausserhalb == 1)) {
					...
					rtOnlineID_Y->OnlineID_output.Rph_out = ((R_check + rtOnlineID_DW->R_old_outside) + psipm_check) / 3.0F;
				} else if (rtOnlineID_DW->LinPara_ident_outside && (rtOnlineID_DW->counter_ausserhalb == 0)) {
					/* Outport: '<Root>/OnlineID_output' */
					...
					rtOnlineID_Y->OnlineID_output.Rph_out = ((R_check + rtOnlineID_DW->R_old_outside) + rtOnlineID_DW->R_old) / 3.0F;
				}
				...
				if (tmp_0 && (rtOnlineID_DW->counter_innerhalb == 1)) {
					...
					rtOnlineID_Y->OnlineID_output.Rph_out = ((R_check + rtOnlineID_DW->R_old) + rtOnlineID_DW->R_veryold) / 3.0F;
				} else if (tmp_0 && (rtOnlineID_DW->counter_innerhalb == 0)) {
					/* Outport: '<Root>/OnlineID_output' */
...
static boolean_T Break(const real32_T iq_reg_alt[50], const real32_T id_reg_alt[50], const real32_T om_reg_alt[5], const real32_T iq_reg_neu[10], const real32_T id_reg_neu[10],
	...
	mean_om_alt = ((((om_reg_alt[0] + om_reg_alt[1]) + om_reg_alt[2]) + om_reg_alt[3]) + om_reg_alt[4]) / 5.0F;
	...
	mean_om_neu = ((((om_reg_neu[0] + om_reg_neu[1]) + om_reg_neu[2]) + om_reg_neu[3]) + om_reg_neu[4]) / 5.0F;
	...
	tmp = rtOnlineID_U->OnlineIDConfig.dev_curr * rtOnlineID_U->GlobalConfig_out.ratCurrent;
	...
	mean_iq_alt = rtOnlineID_U->OnlineIDConfig.dev_omega * rtOnlineID_U->GlobalConfig_out.ratSpeed * 2.0F * 3.14159274F / 60.0F;
	...
	if (((rtOnlineID_U->OnlineIDConfig.identRAmp + mean_id_alt) + tmp >= mean_id_neu) && ((-rtOnlineID_U->OnlineIDConfig.identRAmp + mean_id_alt) - tmp <= mean_id_neu)) {
...
static void enter_atomic_PsiCalcState(ExtU_OnlineID_t *rtOnlineID_U, ExtY_OnlineID_t *rtOnlineID_Y, DW_OnlineID_t *rtOnlineID_DW)
{
   ...
   */
	...
	Wtemp_check = (rtOnlineID_Y->OnlineID_output.Rph_out / rtOnlineID_U->GlobalConfig_out.PMSM_config.R_ph_Ohm - 1.0F) * 254.453F + rtOnlineID_U->OnlineIDConfig.Temp_ref;
	...
	if (rtOnlineID_U->OnlineIDConfig.array_cleaned) {
		...
		memcpy(&rtOnlineID_Y->OnlineID_output.psi_array[0], &rtOnlineID_U->cleaned_psi_array[0], 600U * sizeof(real32_T));
	...
	g_x = ((((rtOnlineID_DW->omega_register[0] + rtOnlineID_DW->omega_register[1]) + rtOnlineID_DW->omega_register[2]) + rtOnlineID_DW->omega_register[3]) + rtOnlineID_DW->omega_register[4])
	                / 5.0F;
	...
	rtOnlineID_Y->OnlineID_output.psi_array[591] = rtOnlineID_Y->OnlineID_output.Wtemp;
	...
	/* Outport: '<Root>/OnlineID_output' */
	rtOnlineID_Y->OnlineID_output.psi_array[592] = (Wtemp_check / 50.0F - b_x / 50.0F * rtOnlineID_Y->OnlineID_output.Rph_out) * 1000.0F / g_x;

	/* '<S1>:83:22' OnlineID_output.psi_array(6,array_counter)=psi_q; */
	rtOnlineID_Y->OnlineID_output.psi_array[593] = (d_x / 50.0F - e_x / 50.0F * rtOnlineID_Y->OnlineID_output.Rph_out) * -1000.0F / g_x;
...
static void CheckSteadyState(const real32_T iq_reg_in[50], const real32_T id_reg_in[50], const real32_T om_reg_in[5], uint32_T timer, boolean_T *allow_measurement, boolean_T *om_con,
	...
	mean_om_reg = ((((om_reg_in[0] + om_reg_in[1]) + om_reg_in[2]) + om_reg_in[3]) + om_reg_in[4]) / 5.0F;
	 ...
	 *  Inport: '<Root>/GlobalConfig'
	 */
	mean_iq_reg_tmp = rtOnlineID_U->OnlineIDConfig.dev_curr * rtOnlineID_U->GlobalConfig_out.ratCurrent;
	...
	if (mean_om_reg < rtOnlineID_U->GlobalConfig_out.ratSpeed * rtOnlineID_U->OnlineIDConfig.max_n_ratio * 2.0F * 3.14159274F / 60.0F) {
		if (mean_om_reg > rtOnlineID_U->GlobalConfig_out.ratSpeed * rtOnlineID_U->OnlineIDConfig.min_n_ratio * 2.0F * 3.14159274F / 60.0F) {
			...
			mean_iq_reg_tmp = rtOnlineID_U->OnlineIDConfig.dev_omega * rtOnlineID_U->GlobalConfig_out.ratSpeed * 2.0F * 3.14159274F / 60.0F;
	...
	if (sqrtf(mean_iq_reg * mean_iq_reg + mean_id_reg * mean_id_reg) < rtOnlineID_U->OnlineIDConfig.nom_factor * rtOnlineID_U->GlobalConfig_out.ratCurrent) {
	...
	if (((real_T) timer >= 1.0F / rtOnlineID_U->GlobalConfig_out.sampleTimeISR * rtOnlineID_U->OnlineIDConfig.Rs_time) && (!*i_val)) {
		/* Rs_time in seconds  */
...
static void RefreshDataRegister(ExtU_OnlineID_t *rtOnlineID_U, ExtY_OnlineID_t *rtOnlineID_Y, DW_OnlineID_t *rtOnlineID_DW) {
	...
	if (rtOnlineID_DW->allow_meas && rtOnlineID_DW->omega_const && rtOnlineID_DW->iq_const && rtOnlineID_DW->id_const) {
		/* Transition: '<S1>:55' */
		...
		memcpy(&rtOnlineID_DW->id_register_alt[0], &rtOnlineID_DW->id_register[0], 50U * sizeof(real32_T));
		memcpy(&rtOnlineID_DW->iq_register_alt[0], &rtOnlineID_DW->iq_register[0], 50U * sizeof(real32_T));
		...
		/* . */
		tmp_0 = !rtOnlineID_DW->allow_meas;

		/* Inport: '<Root>/OnlineIDConfig' */
		if (((!rtOnlineID_DW->LinPara_ident_outside) && (!rtOnlineID_U->OnlineIDConfig.allowPsiCalcOutside) && tmp_0 && rtOnlineID_DW->omega_const && rtOnlineID_DW->iq_const)
		                || (rtOnlineID_U->OnlineIDConfig.allowPsiCalcOutside && tmp_0 && rtOnlineID_DW->omega_const && rtOnlineID_DW->iq_const)) {
			/* Transition: '<S1>:378' */
			/* Transition: '<S1>:331' */
			...
			tmp_1 = 0.01F / rtOnlineID_U->GlobalConfig_out.sampleTimeISR;
			tmp = roundf(tmp_1);
			if (tmp < 4.2949673E+9F) {
				if (tmp >= 0.0F) {
					qY = (uint32_T) tmp;
			...
			if (qY == 0U) {
				...
				RefreshDataRegister_i(rtOnlineID_U, rtOnlineID_DW);

				/* '<S1>:37:24' iq_register(1,1)=iq_sum/(0.01/GlobalConfig.sampleTimeISR); */
				rtOnlineID_DW->iq_register[0] = rtOnlineID_DW->iq_sum / tmp_1;

				/* '<S1>:37:25' id_register(1,1)=id_sum/(0.01/GlobalConfig.sampleTimeISR); */
				rtOnlineID_DW->id_register[0] = rtOnlineID_DW->id_sum / tmp_1;

				/* '<S1>:37:26' vd_register(1,1)=vd_sum/(0.01/GlobalConfig.sampleTimeISR); */
				rtOnlineID_DW->vd_register[0] = rtOnlineID_DW->vd_sum / tmp_1;

				/* '<S1>:37:27' vq_register(1,1)=vq_sum/(0.01/GlobalConfig.sampleTimeISR); */
				rtOnlineID_DW->vq_register[0] = rtOnlineID_DW->vq_sum / tmp_1;
				...
				tmp_1 = 0.1F / rtOnlineID_U->GlobalConfig_out.sampleTimeISR;
				tmp = roundf(tmp_1);
				if (tmp < 4.2949673E+9F) {
					if (tmp >= 0.0F) {
						qY = (uint32_T) tmp;
				...
				if (qY == 0U) {
					...
					rtOnlineID_DW->omega_register[0] = rtOnlineID_DW->omega_sum / tmp_1;
					...
					for (i = 0; i < 50; i++) {
						rtOnlineID_DW->c_y[i] = fabsf(rtOnlineID_DW->iq_register[i]);
						rtOnlineID_DW->d_y_m[i] = fabsf(rtOnlineID_DW->id_register[i]);
					}

					for (i = 0; i < 5; i++) {
						rtOnlineID_DW->e_y_c[i] = fabsf(rtOnlineID_DW->omega_register[i]);
          }

					CheckSteadyState(rtOnlineID_DW->c_y, rtOnlineID_DW->d_y_m, rtOnlineID_DW->e_y_c, rtOnlineID_DW->counter_time, &rtOnlineID_DW->allow_meas,
...
void OnlineID_step(RT_MODEL_OnlineID_t * const rtOnlineID_M) {
	...
	if (rtOnlineID_DW->is_active_c5_OnlineID == 0U) {
		...
		/* . */
		if ((!rtOnlineID_U->ControlFlags.enableOnlineID) || rtOnlineID_U->GlobalConfig_out.Reset || rtOnlineID_U->OnlineIDConfig.OnlineID_Reset
			...
			case IN_CalcLinearParamsState:
				...
				if (rtOnlineID_DW->stop_ident) {
					...
					if (rtOnlineID_U->OnlineIDConfig.allowPsiCalcOutside) {
						temp_diff = roundf(1.2F / rtOnlineID_U->GlobalConfig_out.sampleTimeISR + 1.0F);
					...
					if (guard3) {
						if ((!rtOnlineID_DW->LinPara_ident_outside) && (!rtOnlineID_U->OnlineIDConfig.allowPsiCalcOutside)) {
							temp_diff = roundf(1.2F / rtOnlineID_U->GlobalConfig_out.sampleTimeISR + 1.0F);
							if (temp_diff < 4.2949673E+9F) {
								if (temp_diff >= 0.0F) {
									qY = (uint32_T) temp_diff;
							...
							c_sf_internal_predicateOutput = (rtOnlineID_DW->counter == qY);
						} else {
          ...
          /* . */
					...
					} else if ((!rtOnlineID_U->OnlineIDConfig.allowPsiCalcOutside) && rtOnlineID_DW->LinPara_ident_outside) {
						temp_diff = roundf(1.2F / rtOnlineID_U->GlobalConfig_out.sampleTimeISR + 1.0F);
						if (temp_diff < 4.2949673E+9F) {
							if (temp_diff >= 0.0F) {
								qY = (uint32_T) temp_diff;
			...
			case IN_PsiCalcState:
				...
				if (rtOnlineID_DW->breakback == 1.0F) {
					...
					if ((temp_diff > 0.0F) && (temp_diff < 99.0F)) {
						...
						rtOnlineID_Y->OnlineID_output.delta_psi[k] += fabsf(rtOnlineID_Y->OnlineID_output.psi_pm_out - rtOnlineID_U->GlobalConfig_out.PMSM_config.Psi_PM_Vs);
					}
       ...
       default:
			...
			if (guard1) {
				...
				if (qY == 0U) {
					...
					RefreshDataRegister_i1(rtOnlineID_U, rtOnlineID_DW);
					...
					if (qY == 0U) {
						...
						rtOnlineID_DW->omega_register_neu[0] = rtOnlineID_DW->omega_sum / temp_diff;
					...
					if (qY == 0U) {
						...
						rtOnlineID_DW->stop_ident = Break(rtOnlineID_DW->d_y, rtOnlineID_DW->e_y, rtOnlineID_DW->f_y, rtOnlineID_DW->g_y, rtOnlineID_DW->h_y,
						                rtOnlineID_DW->i_y, rtOnlineID_U);
					}
				}
			}
		}
		...
		/* . */
	} else if (rtOnlineID_U->ControlFlags.enableOnlineID && (!rtOnlineID_U->GlobalConfig_out.Reset) && (!rtOnlineID_U->OnlineIDConfig.OnlineID_Reset)
