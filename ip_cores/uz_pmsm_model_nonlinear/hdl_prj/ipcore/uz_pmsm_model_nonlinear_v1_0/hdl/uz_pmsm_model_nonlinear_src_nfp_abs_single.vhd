-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_pmsm_model_nonlinear\uz_pmsm_model_nonlinear_src_nfp_abs_single.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_nonlinear_src_nfp_abs_single
-- Source Path: uz_pmsm_model_nonlinear/uz_pmsm_mode_nonlinear/nfp_abs_single
-- Hierarchy Level: 1
-- Model version: 9.10
-- 
-- -------------------------------------------------------------
...
ENTITY uz_pmsm_model_nonlinear_src_nfp_abs_single IS
  PORT( nfp_in                            :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_out                           :   OUT   std_logic_vector(31 DOWNTO 0)  -- ufix32
        );
END uz_pmsm_model_nonlinear_src_nfp_abs_single;


ARCHITECTURE rtl OF uz_pmsm_model_nonlinear_src_nfp_abs_single IS
