set moduleName MatrixMultiplication_Pipeline_VITIS_LOOP_20_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {MatrixMultiplication_Pipeline_VITIS_LOOP_20_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ arrays int 32 regular {axi_master 0}  }
	{ sext_ln20 int 62 regular  }
	{ A float 32 regular {array 5 { 0 3 } 0 1 }  }
}
...
set Spec2ImplPortList { 
	...
	A { ap_memory {  { A_address0 mem_address 1 3 }  { A_ce0 mem_ce 1 1 }  { A_we0 mem_we 1 1 }  { A_d0 mem_din 1 32 } } }
}
