-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\valen\Documents\repos\UZ\ultrazohm_sw_pr\ip_cores\uz_pmsm_model_3ph_dq\hdl_prj\hdlsrc\uz_pmsm_model\uz_pmsm_model_3ph_dq_src_nfp_convert_double2single.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_3ph_dq_src_nfp_convert_double2single
-- Source Path: uz_pmsm_model/uz_pmsm_model_3ph_dq/nfp_convert_double2single
-- Hierarchy Level: 1
-- 
...
ENTITY uz_pmsm_model_3ph_dq_src_nfp_convert_double2single IS
...
END uz_pmsm_model_3ph_dq_src_nfp_convert_double2single;


ARCHITECTURE rtl OF uz_pmsm_model_3ph_dq_src_nfp_convert_double2single IS
  ...
  SIGNAL Delay32_PS_2_5_reg               : std_logic_vector(0 TO 2);  -- ufix1 [3]
  SIGNAL Delay32_PS_2_5_reg_next          : std_logic_vector(0 TO 2);  -- ufix1 [3]
  ...
  SIGNAL Delay33_PS_2_5_reg               : std_logic_vector(0 TO 1);  -- ufix1 [2]
  SIGNAL Delay33_PS_2_5_reg_next          : std_logic_vector(0 TO 1);  -- ufix1 [2]
...
BEGIN
  ...
  Data_Type_Conversion_out1_1 <= unsigned(alpha1_e_out1(5 DOWNTO 0));

  bitsrl_MantExtended_x_shift_l_out1 <= SHIFT_RIGHT(bitsll_MantAppended_x_shift_l_out1, to_integer(Data_Type_Conversion_out1_1));
