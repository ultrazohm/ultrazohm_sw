-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\valen\Documents\repos\UZ\ultrazohm_sw\ip_cores\uz_pmsm_model_9ph\hdlprj\hdlsrc\uz_pmsm_model_9ph\uz_pmsm_model_9ph_axi4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_9ph_axi4
-- Source Path: uz_pmsm_model_9ph/uz_pmsm_model_9ph_axi4
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_pmsm_model_9ph_axi4 IS
...
END uz_pmsm_model_9ph_axi4;


ARCHITECTURE rtl OF uz_pmsm_model_9ph_axi4 IS

  -- Component Declarations
  COMPONENT uz_pmsm_model_9ph_addr_decoder
  ...
  COMPONENT uz_pmsm_model_9ph_axi4_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_ARESETN                    :   IN    std_logic;  -- ufix1
          AXI4_AWID                       :   IN    std_logic_vector(11 DOWNTO 0);  -- ufix12
          AXI4_AWADDR                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  FOR ALL : uz_pmsm_model_9ph_addr_decoder
    USE ENTITY work.uz_pmsm_model_9ph_addr_decoder(rtl);

  FOR ALL : uz_pmsm_model_9ph_axi4_module
    USE ENTITY work.uz_pmsm_model_9ph_axi4_module(rtl);
  ...
  SIGNAL write_inputs_general_tmp         : vector_of_std_logic_vector32(0 TO 1);  -- ufix32 [2]
  SIGNAL write_input_voltages_dq_tmp      : vector_of_std_logic_vector32(0 TO 8);  -- ufix32 [9]
  SIGNAL write_input_voltages_abc_tmp     : vector_of_std_logic_vector32(0 TO 8);  -- ufix32 [9]
  SIGNAL write_Physical_Parameter_1_J_tmp : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_Physical_Parameter_mu_tmp  : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_Physical_Parameter_M_R0_tmp : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_Physical_Parameter_1_L_d_tmp : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_Physical_Parameter_1_L_q_tmp : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_Physical_Parameter_R_1_tmp : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_Physical_Parameter_polepair_tmp : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_Physical_Parameter_psi_pm_tmp : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_Physical_Parameter_L_o1_tmp : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_Physical_Parameter_L_o2_tmp : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_Physical_Parameter_L_x1_tmp : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_Physical_Parameter_L_y1_tmp : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_Physical_Parameter_L_x2_tmp : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_Physical_Parameter_L_y2_tmp : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_Physical_Parameter_L_zero_tmp : std_logic_vector(31 DOWNTO 0);  -- ufix32
...
BEGIN
  u_uz_pmsm_model_9ph_addr_decoder_inst : uz_pmsm_model_9ph_addr_decoder
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
              ...
              read_output_general => read_output_general,  -- ufix32 [5]
              read_output_currents_dq => read_output_currents_dq,  -- ufix32 [9]
              read_output_currents_abc => read_output_currents_abc,  -- ufix32 [9]
              data_read => top_data_read,  -- ufix32
              write_axi_enable => write_axi_enable,  -- ufix1
              write_inputs_general => write_inputs_general_tmp,  -- ufix32 [2]
              write_input_voltages_dq => write_input_voltages_dq_tmp,  -- ufix32 [9]
              write_input_voltages_abc => write_input_voltages_abc_tmp,  -- ufix32 [9]
              ...
              write_Physical_Parameter_1_J => write_Physical_Parameter_1_J_tmp,  -- ufix32
              write_Physical_Parameter_mu => write_Physical_Parameter_mu_tmp,  -- ufix32
              write_Physical_Parameter_M_R0 => write_Physical_Parameter_M_R0_tmp,  -- ufix32
              write_Physical_Parameter_1_L_d => write_Physical_Parameter_1_L_d_tmp,  -- ufix32
              write_Physical_Parameter_1_L_q => write_Physical_Parameter_1_L_q_tmp,  -- ufix32
              write_Physical_Parameter_R_1 => write_Physical_Parameter_R_1_tmp,  -- ufix32
              write_Physical_Parameter_polepair => write_Physical_Parameter_polepair_tmp,  -- ufix32
              write_Physical_Parameter_psi_pm => write_Physical_Parameter_psi_pm_tmp,  -- ufix32
              write_Physical_Parameter_L_o1 => write_Physical_Parameter_L_o1_tmp,  -- ufix32
              write_Physical_Parameter_L_o2 => write_Physical_Parameter_L_o2_tmp,  -- ufix32
              write_Physical_Parameter_L_x1 => write_Physical_Parameter_L_x1_tmp,  -- ufix32
              write_Physical_Parameter_L_y1 => write_Physical_Parameter_L_y1_tmp,  -- ufix32
              write_Physical_Parameter_L_x2 => write_Physical_Parameter_L_x2_tmp,  -- ufix32
              write_Physical_Parameter_L_y2 => write_Physical_Parameter_L_y2_tmp,  -- ufix32
              write_Physical_Parameter_L_zero => write_Physical_Parameter_L_zero_tmp  -- ufix32
              );

  u_uz_pmsm_model_9ph_axi4_module_inst : uz_pmsm_model_9ph_axi4_module
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
  ...
  write_inputs_general <= write_inputs_general_tmp;

  write_input_voltages_dq <= write_input_voltages_dq_tmp;

  write_input_voltages_abc <= write_input_voltages_abc_tmp;

  write_Physical_Parameter_1_J <= write_Physical_Parameter_1_J_tmp;

  write_Physical_Parameter_mu <= write_Physical_Parameter_mu_tmp;

  write_Physical_Parameter_M_R0 <= write_Physical_Parameter_M_R0_tmp;

  write_Physical_Parameter_1_L_d <= write_Physical_Parameter_1_L_d_tmp;

  write_Physical_Parameter_1_L_q <= write_Physical_Parameter_1_L_q_tmp;

  write_Physical_Parameter_R_1 <= write_Physical_Parameter_R_1_tmp;

  write_Physical_Parameter_polepair <= write_Physical_Parameter_polepair_tmp;

  write_Physical_Parameter_psi_pm <= write_Physical_Parameter_psi_pm_tmp;

  write_Physical_Parameter_L_o1 <= write_Physical_Parameter_L_o1_tmp;

  write_Physical_Parameter_L_o2 <= write_Physical_Parameter_L_o2_tmp;

  write_Physical_Parameter_L_x1 <= write_Physical_Parameter_L_x1_tmp;

  write_Physical_Parameter_L_y1 <= write_Physical_Parameter_L_y1_tmp;

  write_Physical_Parameter_L_x2 <= write_Physical_Parameter_L_x2_tmp;

  write_Physical_Parameter_L_y2 <= write_Physical_Parameter_L_y2_tmp;

  write_Physical_Parameter_L_zero <= write_Physical_Parameter_L_zero_tmp;
