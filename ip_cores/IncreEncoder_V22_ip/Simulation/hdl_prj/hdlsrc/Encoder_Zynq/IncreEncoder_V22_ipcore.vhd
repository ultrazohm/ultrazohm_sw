-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Encoder_Zynq\IncreEncoder_V22_ipcore.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IncreEncoder_V22_ipcore
-- Source Path: IncreEncoder_V22_ipcore
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY IncreEncoder_V22_ipcore IS
...
END IncreEncoder_V22_ipcore;


ARCHITECTURE rtl OF IncreEncoder_V22_ipcore IS

  -- Component Declarations
  COMPONENT IncreEncoder_V22_ipcore_axi_lite
  ...
  COMPONENT IncreEncoder_V22_ipcore_dut
  ...
  FOR ALL : IncreEncoder_V22_ipcore_axi_lite
    USE ENTITY work.IncreEncoder_V22_ipcore_axi_lite(rtl);

  FOR ALL : IncreEncoder_V22_ipcore_dut
    USE ENTITY work.IncreEncoder_V22_ipcore_dut(rtl);
...
BEGIN
  u_IncreEncoder_V22_ipcore_axi_lite_inst : IncreEncoder_V22_ipcore_axi_lite
  ...
  u_IncreEncoder_V22_ipcore_dut_inst : IncreEncoder_V22_ipcore_dut
  ...
  ip_timestamp <= to_unsigned(1809051730, 32);
