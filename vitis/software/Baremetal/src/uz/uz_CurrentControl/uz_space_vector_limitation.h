...
/**
 * @brief function to limit the voltages of a given control algorithm
 *
...
/**
 * @brief function to limit the voltages of a 6ph PMSM. Only applicable if the XY subspace is transformed with -theta_el
 *
