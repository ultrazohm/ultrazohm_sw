-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/gmStateSpaceHDL_uz_inverter_3ph/uz_invert_ip.vhd
...
ENTITY uz_invert_ip IS
  PORT( IPCORE_CLK                        :   IN    std_logic;  -- ufix1
        IPCORE_RESETN                     :   IN    std_logic;  -- ufix1
        i_abc_pl_0                        :   IN    std_logic_vector(80 DOWNTO 0);  -- ufix81
        ...
        u_abc_pl_0                        :   OUT   std_logic_vector(80 DOWNTO 0);  -- ufix81
...
ARCHITECTURE rtl OF uz_invert_ip IS

  -- Component Declarations
  COMPONENT uz_invert_ip_reset_sync
  ...
  FOR ALL : uz_invert_ip_reset_sync
    USE ENTITY work.uz_invert_ip_reset_sync(rtl);

  FOR ALL : uz_invert_ip_axi4
    USE ENTITY work.uz_invert_ip_axi4(rtl);

  FOR ALL : uz_invert_ip_dut
    USE ENTITY work.uz_invert_ip_dut(rtl);

  -- Signals
  SIGNAL reset                            : std_logic;
  SIGNAL ip_timestamp                     : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL reset_cm                         : std_logic;  -- ufix1
  SIGNAL i_abc_pl_0_unsigned              : unsigned(80 DOWNTO 0);  -- ufix81
  SIGNAL i_abc_pl_0_slice                 : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL i_abc_pl_0_sig                   : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL i_abc_pl_0_slice_1               : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL i_abc_pl_1_sig                   : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL i_abc_pl_0_slice_2               : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL i_abc_pl_2_sig                   : signed(26 DOWNTO 0);  -- sfix27_En18
  ...
  SIGNAL u_abc_pl_0_sig                   : std_logic_vector(26 DOWNTO 0);  -- ufix27
  SIGNAL u_abc_pl_1_sig                   : std_logic_vector(26 DOWNTO 0);  -- ufix27
  SIGNAL u_abc_pl_2_sig                   : std_logic_vector(26 DOWNTO 0);  -- ufix27
  SIGNAL u_abc_pl_2_sig_signed            : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL u_abc_pl_1_sig_signed            : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL u_abc_pl_0_sig_signed            : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL u_abc_pl_0_tmp                   : unsigned(80 DOWNTO 0);  -- ufix81

BEGIN
  u_uz_invert_ip_reset_sync_inst : uz_invert_ip_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_uz_invert_ip_axi4_inst : uz_invert_ip_axi4
  ...
  u_uz_invert_ip_dut_inst : uz_invert_ip_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              ...
              i_abc_pl_0 => std_logic_vector(i_abc_pl_0_sig),  -- sfix27_En18
              i_abc_pl_1 => std_logic_vector(i_abc_pl_1_sig),  -- sfix27_En18
              i_abc_pl_2 => std_logic_vector(i_abc_pl_2_sig),  -- sfix27_En18
              ...
              u_abc_pl_0 => u_abc_pl_0_sig,  -- sfix27_En16
              u_abc_pl_1 => u_abc_pl_1_sig,  -- sfix27_En16
              u_abc_pl_2 => u_abc_pl_2_sig  -- sfix27_En16
              );

  ip_timestamp <= unsigned'(X"837E46AF");

  reset_cm <=  NOT IPCORE_RESETN;

  i_abc_pl_0_unsigned <= unsigned(i_abc_pl_0);

  i_abc_pl_0_slice <= i_abc_pl_0_unsigned(26 DOWNTO 0);

  i_abc_pl_0_sig <= signed(i_abc_pl_0_slice);

  i_abc_pl_0_slice_1 <= i_abc_pl_0_unsigned(53 DOWNTO 27);

  i_abc_pl_1_sig <= signed(i_abc_pl_0_slice_1);

  i_abc_pl_0_slice_2 <= i_abc_pl_0_unsigned(80 DOWNTO 54);
