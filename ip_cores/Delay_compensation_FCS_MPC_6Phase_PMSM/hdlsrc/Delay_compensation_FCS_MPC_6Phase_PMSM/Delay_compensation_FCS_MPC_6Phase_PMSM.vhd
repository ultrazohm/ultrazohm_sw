-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\Delay_compensation_FCS_MPC_6Phase_PMSM\hdlsrc\Delay_compensation_FCS_MPC_6Phase_PMSM\Delay_compensation_FCS_MPC_6Phase_PMSM.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Delay_compensation_FCS_MPC_6Phase_PMSM
-- Source Path: Delay_compensation_FCS_MPC_6Phase_PMSM
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Delay_compensation_FCS_MPC_6Phase_PMSM IS
  PORT( IPCORE_CLK                        :   IN    std_logic;  -- ufix1
        ...
        last_applied_optimal_voltage_ud   :   IN    std_logic_vector(23 DOWNTO 0);  -- ufix24
        last_applied_optimal_volatge_uq   :   IN    std_logic_vector(23 DOWNTO 0);  -- ufix24
        last_applied_optimal_voltage_ux   :   IN    std_logic_vector(23 DOWNTO 0);  -- ufix24
        last_applied_optimal_voltage_uy   :   IN    std_logic_vector(23 DOWNTO 0);  -- ufix24
...
END Delay_compensation_FCS_MPC_6Phase_PMSM;


ARCHITECTURE rtl OF Delay_compensation_FCS_MPC_6Phase_PMSM IS

  -- Component Declarations
  COMPONENT Delay_compensation_FCS_MPC_6Phase_PMSM_reset_sync
  ...
  COMPONENT Delay_compensation_FCS_MPC_6Phase_PMSM_axi_lite
  ...
  COMPONENT Delay_compensation_FCS_MPC_6Phase_PMSM_dut
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
  ...
  FOR ALL : Delay_compensation_FCS_MPC_6Phase_PMSM_reset_sync
    USE ENTITY work.Delay_compensation_FCS_MPC_6Phase_PMSM_reset_sync(rtl);

  FOR ALL : Delay_compensation_FCS_MPC_6Phase_PMSM_axi_lite
    USE ENTITY work.Delay_compensation_FCS_MPC_6Phase_PMSM_axi_lite(rtl);

  FOR ALL : Delay_compensation_FCS_MPC_6Phase_PMSM_dut
    USE ENTITY work.Delay_compensation_FCS_MPC_6Phase_PMSM_dut(rtl);
  ...
  SIGNAL last_applied_optimal_voltage_ud_unsigned : unsigned(23 DOWNTO 0);  -- ufix24
  SIGNAL last_applied_optimal_voltage_ud_sig : signed(23 DOWNTO 0);  -- sfix24_En11
  SIGNAL last_applied_optimal_volatge_uq_unsigned : unsigned(23 DOWNTO 0);  -- ufix24
  SIGNAL last_applied_optimal_volatge_uq_sig : signed(23 DOWNTO 0);  -- sfix24_En11
  SIGNAL last_applied_optimal_voltage_ux_unsigned : unsigned(23 DOWNTO 0);  -- ufix24
  SIGNAL last_applied_optimal_voltage_ux_sig : signed(23 DOWNTO 0);  -- sfix24_En11
  SIGNAL last_applied_optimal_voltage_uy_unsigned : unsigned(23 DOWNTO 0);  -- ufix24
  SIGNAL last_applied_optimal_voltage_uy_sig : signed(23 DOWNTO 0);  -- sfix24_En11
  ...
  SIGNAL write_last_applied_optimal_voltage_ud_AXI : std_logic_vector(23 DOWNTO 0);  -- ufix24
  SIGNAL write_last_applied_optimal_volatge_uq_AXI : std_logic_vector(23 DOWNTO 0);  -- ufix24
  SIGNAL write_last_applied_optimal_voltage_ux_AXI : std_logic_vector(23 DOWNTO 0);  -- ufix24
  SIGNAL write_last_applied_optimal_voltage_uy_AXI : std_logic_vector(23 DOWNTO 0);  -- ufix24
  SIGNAL write_id_measured_AXI            : std_logic_vector(17 DOWNTO 0);  -- ufix18
  SIGNAL write_iq_measured_AXI            : std_logic_vector(17 DOWNTO 0);  -- ufix18
  SIGNAL write_ix_measured_AXI            : std_logic_vector(17 DOWNTO 0);  -- ufix18
  SIGNAL write_iy_measured_AXI            : std_logic_vector(17 DOWNTO 0);  -- ufix18
...
BEGIN
  u_Delay_compensation_FCS_MPC_6Phase_PMSM_reset_sync_inst : Delay_compensation_FCS_MPC_6Phase_PMSM_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_Delay_compensation_FCS_MPC_6Phase_PMSM_axi_lite_inst : Delay_compensation_FCS_MPC_6Phase_PMSM_axi_lite
    PORT MAP( reset => reset,
              ...
              write_last_applied_optimal_voltage_ud_AXI => write_last_applied_optimal_voltage_ud_AXI,  -- sfix24_En11
              write_last_applied_optimal_volatge_uq_AXI => write_last_applied_optimal_volatge_uq_AXI,  -- sfix24_En11
              write_last_applied_optimal_voltage_ux_AXI => write_last_applied_optimal_voltage_ux_AXI,  -- sfix24_En11
              write_last_applied_optimal_voltage_uy_AXI => write_last_applied_optimal_voltage_uy_AXI,  -- sfix24_En11
              write_id_measured_AXI => write_id_measured_AXI,  -- sfix18_En11
              write_iq_measured_AXI => write_iq_measured_AXI,  -- sfix18_En11
              write_ix_measured_AXI => write_ix_measured_AXI,  -- sfix18_En11
              write_iy_measured_AXI => write_iy_measured_AXI,  -- sfix18_En11
              write_omega_m_measured_AXI => write_omega_m_measured_AXI,  -- sfix24_En11
              write_use_AXI => write_use_AXI,  -- ufix1
              reset_internal => reset_internal  -- ufix1
              );

  u_Delay_compensation_FCS_MPC_6Phase_PMSM_dut_inst : Delay_compensation_FCS_MPC_6Phase_PMSM_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              ...
              last_applied_optimal_voltage_ud => std_logic_vector(last_applied_optimal_voltage_ud_sig),  -- sfix24_En11
              last_applied_optimal_volatge_uq => std_logic_vector(last_applied_optimal_volatge_uq_sig),  -- sfix24_En11
              last_applied_optimal_voltage_ux => std_logic_vector(last_applied_optimal_voltage_ux_sig),  -- sfix24_En11
              last_applied_optimal_voltage_uy => std_logic_vector(last_applied_optimal_voltage_uy_sig),  -- sfix24_En11
              ...
              last_applied_optimal_voltage_ud_AXI => write_last_applied_optimal_voltage_ud_AXI,  -- sfix24_En11
              last_applied_optimal_volatge_uq_AXI => write_last_applied_optimal_volatge_uq_AXI,  -- sfix24_En11
              last_applied_optimal_voltage_ux_AXI => write_last_applied_optimal_voltage_ux_AXI,  -- sfix24_En11
              last_applied_optimal_voltage_uy_AXI => write_last_applied_optimal_voltage_uy_AXI,  -- sfix24_En11
              id_measured_AXI => write_id_measured_AXI,  -- sfix18_En11
              iq_measured_AXI => write_iq_measured_AXI,  -- sfix18_En11
              ix_measured_AXI => write_ix_measured_AXI,  -- sfix18_En11
              iy_measured_AXI => write_iy_measured_AXI,  -- sfix18_En11
  ...
  ip_timestamp <= unsigned'(X"83AAD4E2");
  ...
  last_applied_optimal_voltage_ud_unsigned <= unsigned(last_applied_optimal_voltage_ud);

  last_applied_optimal_voltage_ud_sig <= signed(last_applied_optimal_voltage_ud_unsigned);

  last_applied_optimal_volatge_uq_unsigned <= unsigned(last_applied_optimal_volatge_uq);

  last_applied_optimal_volatge_uq_sig <= signed(last_applied_optimal_volatge_uq_unsigned);

  last_applied_optimal_voltage_ux_unsigned <= unsigned(last_applied_optimal_voltage_ux);

  last_applied_optimal_voltage_ux_sig <= signed(last_applied_optimal_voltage_ux_unsigned);

  last_applied_optimal_voltage_uy_unsigned <= unsigned(last_applied_optimal_voltage_uy);

  last_applied_optimal_voltage_uy_sig <= signed(last_applied_optimal_voltage_uy_unsigned);
