...
uz_6ph_MLMT_kparameter uz_get_k_parameter(uz_6phFD_indices input_faultindices, neutral_configurations neutral_point_configuration, ML_MT_optimization ML_MT_optimization){
