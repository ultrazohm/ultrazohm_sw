-- -------------------------------------------------------------
-- 
-- File Name: /home/ts/Documents/integrate_nn_to_uz/ultrazohm_sw/ip_cores/nnAXI_v1_0/hdl_prj/hdlsrc/uz_mlp_three_layer/uz_mlp_three_layer_src_StateMachines1.vhd
...
-- Source Path: uz_mlp_three_layer/pcu_mlp2_8parallel/reluLayer_4Parallel/StateMachines1
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  Compare_To_Constant_out1 <= '1' WHEN Delay2_out1 = to_unsigned(16#005#, 10) ELSE
      '0';
    ...
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        ELSIF layer_control_out3 = '1' THEN 
          IF n_perceptron >= to_unsigned(16#00F#, 10) THEN 
            n_perceptron <= to_unsigned(16#000#, 10);
          ELSE 
    ...
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        ELSIF mac_control_out1 = '1' THEN 
          IF mac_counter_tmp >= to_unsigned(16#005#, 10) THEN 
            mac_counter_tmp <= to_unsigned(16#001#, 10);
          ELSE 
