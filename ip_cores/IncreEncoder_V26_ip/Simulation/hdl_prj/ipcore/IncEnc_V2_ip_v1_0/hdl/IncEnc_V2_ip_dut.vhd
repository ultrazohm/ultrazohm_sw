-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/inc_enc_v26/IncEnc_V2_ip_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IncEnc_V2_ip_dut
-- Source Path: IncEnc_V2_ip/IncEnc_V2_ip_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END IncEnc_V2_ip_dut;


ARCHITECTURE rtl OF IncEnc_V2_ip_dut IS

  -- Component Declarations
  COMPONENT IncEnc_V2_ip_src_IncEnc_V26
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : IncEnc_V2_ip_src_IncEnc_V26
    USE ENTITY work.IncEnc_V2_ip_src_IncEnc_V26(rtl);
...
BEGIN
  u_IncEnc_V2_ip_src_IncEnc_V26 : IncEnc_V2_ip_src_IncEnc_V26
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset_x => reset_x,
              A => A_sig,  -- ufix1
