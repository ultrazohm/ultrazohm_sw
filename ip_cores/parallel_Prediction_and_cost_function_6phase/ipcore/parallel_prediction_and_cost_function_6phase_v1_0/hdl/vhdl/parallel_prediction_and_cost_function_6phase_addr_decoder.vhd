-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\parallel_Prediction_and_cost_function_6phase\hdlsrc\parallel_prediction_and_cost_function_6phase\parallel_prediction_and_cost_function_6phase_addr_decoder.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: parallel_prediction_and_cost_function_6phase_addr_decoder
-- Source Path: parallel_prediction_and_cost_function_6phase/parallel_prediction_and_cost_function_6phase_axi_lite/parallel_prediction_and_cost_function_6phase_addr_decoder
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY parallel_prediction_and_cost_function_6phase_addr_decoder IS
...
END parallel_prediction_and_cost_function_6phase_addr_decoder;


ARCHITECTURE rtl OF parallel_prediction_and_cost_function_6phase_addr_decoder IS
  ...
  SIGNAL decode_sel_d_voltage_per_switching_state_AXI_61_64_1_1 : std_logic;  -- ufix1
  SIGNAL reg_enb_d_voltage_per_switching_state_AXI_61_64_1_1 : std_logic;  -- ufix1
  SIGNAL data_in_d_voltage_per_switching_state_AXI_61_64 : signed(23 DOWNTO 0);  -- sfix24_En11
  SIGNAL data_reg_d_voltage_per_switching_state_AXI_61_64_1_1 : signed(23 DOWNTO 0);  -- sfix24_En11
  SIGNAL decode_sel_q_voltage_per_switching_state_AXI_61_64_1_1 : std_logic;  -- ufix1
  SIGNAL reg_enb_q_voltage_per_switching_state_AXI_61_64_1_1 : std_logic;  -- ufix1
  SIGNAL data_in_q_voltage_per_switching_state_AXI_61_64 : signed(23 DOWNTO 0);  -- sfix24_En11
  SIGNAL data_reg_q_voltage_per_switching_state_AXI_61_64_1_1 : signed(23 DOWNTO 0);  -- sfix24_En11
  SIGNAL decode_sel_x_voltage_per_switching_state_AXI_61_64_1_1 : std_logic;  -- ufix1
  SIGNAL reg_enb_x_voltage_per_switching_state_AXI_61_64_1_1 : std_logic;  -- ufix1
  SIGNAL data_in_x_voltage_per_switching_state_AXI_61_64 : signed(23 DOWNTO 0);  -- sfix24_En11
  SIGNAL data_reg_x_voltage_per_switching_state_AXI_61_64_1_1 : signed(23 DOWNTO 0);  -- sfix24_En11
  SIGNAL decode_sel_y_volatge_per_switching_state_AXI_61_64_1_1 : std_logic;  -- ufix1
  SIGNAL reg_enb_y_volatge_per_switching_state_AXI_61_64_1_1 : std_logic;  -- ufix1
  SIGNAL data_in_y_volatge_per_switching_state_AXI_61_64 : signed(23 DOWNTO 0);  -- sfix24_En11
  SIGNAL data_reg_y_volatge_per_switching_state_AXI_61_64_1_1 : signed(23 DOWNTO 0);  -- sfix24_En11
...
BEGIN
  ...
  decode_sel_d_voltage_per_switching_state_AXI_61_64_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0053#, 14) ELSE
      '0';

  reg_enb_d_voltage_per_switching_state_AXI_61_64_1_1 <= decode_sel_d_voltage_per_switching_state_AXI_61_64_1_1 AND wr_enb;

  data_in_d_voltage_per_switching_state_AXI_61_64 <= signed(data_write_unsigned(23 DOWNTO 0));

  reg_d_voltage_per_switching_state_AXI_61_64_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_d_voltage_per_switching_state_AXI_61_64_1_1 <= to_signed(16#000000#, 24);
      ELSIF enb = '1' AND reg_enb_d_voltage_per_switching_state_AXI_61_64_1_1 = '1' THEN
        data_reg_d_voltage_per_switching_state_AXI_61_64_1_1 <= data_in_d_voltage_per_switching_state_AXI_61_64;
      END IF;
    END IF;
  END PROCESS reg_d_voltage_per_switching_state_AXI_61_64_1_1_process;


  write_d_voltage_per_switching_state_AXI_61_64 <= std_logic_vector(data_reg_d_voltage_per_switching_state_AXI_61_64_1_1);

  
  decode_sel_q_voltage_per_switching_state_AXI_61_64_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0054#, 14) ELSE
      '0';

  reg_enb_q_voltage_per_switching_state_AXI_61_64_1_1 <= decode_sel_q_voltage_per_switching_state_AXI_61_64_1_1 AND wr_enb;

  data_in_q_voltage_per_switching_state_AXI_61_64 <= signed(data_write_unsigned(23 DOWNTO 0));

  reg_q_voltage_per_switching_state_AXI_61_64_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_q_voltage_per_switching_state_AXI_61_64_1_1 <= to_signed(16#000000#, 24);
      ELSIF enb = '1' AND reg_enb_q_voltage_per_switching_state_AXI_61_64_1_1 = '1' THEN
        data_reg_q_voltage_per_switching_state_AXI_61_64_1_1 <= data_in_q_voltage_per_switching_state_AXI_61_64;
      END IF;
    END IF;
  END PROCESS reg_q_voltage_per_switching_state_AXI_61_64_1_1_process;


  write_q_voltage_per_switching_state_AXI_61_64 <= std_logic_vector(data_reg_q_voltage_per_switching_state_AXI_61_64_1_1);

  
  decode_sel_x_voltage_per_switching_state_AXI_61_64_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0055#, 14) ELSE
      '0';

  reg_enb_x_voltage_per_switching_state_AXI_61_64_1_1 <= decode_sel_x_voltage_per_switching_state_AXI_61_64_1_1 AND wr_enb;

  data_in_x_voltage_per_switching_state_AXI_61_64 <= signed(data_write_unsigned(23 DOWNTO 0));

  reg_x_voltage_per_switching_state_AXI_61_64_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_x_voltage_per_switching_state_AXI_61_64_1_1 <= to_signed(16#000000#, 24);
      ELSIF enb = '1' AND reg_enb_x_voltage_per_switching_state_AXI_61_64_1_1 = '1' THEN
        data_reg_x_voltage_per_switching_state_AXI_61_64_1_1 <= data_in_x_voltage_per_switching_state_AXI_61_64;
      END IF;
    END IF;
  END PROCESS reg_x_voltage_per_switching_state_AXI_61_64_1_1_process;


  write_x_voltage_per_switching_state_AXI_61_64 <= std_logic_vector(data_reg_x_voltage_per_switching_state_AXI_61_64_1_1);

  
  decode_sel_y_volatge_per_switching_state_AXI_61_64_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0056#, 14) ELSE
      '0';

  reg_enb_y_volatge_per_switching_state_AXI_61_64_1_1 <= decode_sel_y_volatge_per_switching_state_AXI_61_64_1_1 AND wr_enb;

  data_in_y_volatge_per_switching_state_AXI_61_64 <= signed(data_write_unsigned(23 DOWNTO 0));

  reg_y_volatge_per_switching_state_AXI_61_64_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_y_volatge_per_switching_state_AXI_61_64_1_1 <= to_signed(16#000000#, 24);
      ELSIF enb = '1' AND reg_enb_y_volatge_per_switching_state_AXI_61_64_1_1 = '1' THEN
        data_reg_y_volatge_per_switching_state_AXI_61_64_1_1 <= data_in_y_volatge_per_switching_state_AXI_61_64;
      END IF;
    END IF;
  END PROCESS reg_y_volatge_per_switching_state_AXI_61_64_1_1_process;


  write_y_volatge_per_switching_state_AXI_61_64 <= std_logic_vector(data_reg_y_volatge_per_switching_state_AXI_61_64_1_1);
