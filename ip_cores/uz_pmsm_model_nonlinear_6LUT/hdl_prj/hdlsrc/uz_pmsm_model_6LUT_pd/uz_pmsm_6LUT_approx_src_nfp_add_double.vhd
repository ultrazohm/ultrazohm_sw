-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\Philipp\ultrazohm\ultrazohm_sw\ip_cores\uz_pmsm_model_nonlinear_6LUT\hdl_prj\hdlsrc\uz_pmsm_model_6LUT_pd\uz_pmsm_6LUT_approx_src_nfp_add_double.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_6LUT_approx_src_nfp_add_double
...
ENTITY uz_pmsm_6LUT_approx_src_nfp_add_double IS
...
END uz_pmsm_6LUT_approx_src_nfp_add_double;


ARCHITECTURE rtl OF uz_pmsm_6LUT_approx_src_nfp_add_double IS
  ...
  SIGNAL Delay18_PS_7_10_reg              : std_logic_vector(1 DOWNTO 0);  -- ufix1 [2]
  ...
  SIGNAL Delay14_PS_7_10_reg              : std_logic_vector(1 DOWNTO 0);  -- ufix1 [2]
  ...
  SIGNAL Delay13_PS_7_10_reg              : std_logic_vector(1 DOWNTO 0);  -- ufix1 [2]
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay18_PS_7_10_reg(0) <= Delay42_PS_5_out1;
        Delay18_PS_7_10_reg(1) <= Delay18_PS_7_10_reg(0);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay14_PS_7_10_reg(0) <= Delay29_PS_5_out1;
        Delay14_PS_7_10_reg(1) <= Delay14_PS_7_10_reg(0);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay13_PS_7_10_reg(0) <= Delay25_PS_5_out1;
        Delay13_PS_7_10_reg(1) <= Delay13_PS_7_10_reg(0);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay15_PS_7_10_reg(0) <= Delay34_PS_5_out1;
        Delay15_PS_7_10_reg(1) <= Delay15_PS_7_10_reg(0);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay17_PS_7_10_reg(0) <= Delay38_PS_5_out1;
        Delay17_PS_7_10_reg(1) <= Delay17_PS_7_10_reg(0);
      END IF;
    END IF;
