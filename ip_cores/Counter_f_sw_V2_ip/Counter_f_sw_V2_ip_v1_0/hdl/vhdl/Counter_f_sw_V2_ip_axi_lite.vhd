-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\PMSM_Flux_NonLinear_FCS_FixPoint_Np1_V7\Counter_f_sw_V2_ip_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Counter_f_sw_V2_ip_axi_lite
-- Source Path: Counter_f_sw_V2_ip/Counter_f_sw_V2_ip_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Counter_f_sw_V2_ip_axi_lite IS
...
END Counter_f_sw_V2_ip_axi_lite;


ARCHITECTURE rtl OF Counter_f_sw_V2_ip_axi_lite IS

  -- Component Declarations
  COMPONENT Counter_f_sw_V2_ip_addr_decoder
  ...
  COMPONENT Counter_f_sw_V2_ip_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : Counter_f_sw_V2_ip_addr_decoder
    USE ENTITY work.Counter_f_sw_V2_ip_addr_decoder(rtl);

  FOR ALL : Counter_f_sw_V2_ip_axi_lite_module
    USE ENTITY work.Counter_f_sw_V2_ip_axi_lite_module(rtl);
...
BEGIN
  u_Counter_f_sw_V2_ip_addr_decoder_inst : Counter_f_sw_V2_ip_addr_decoder
  ...
  u_Counter_f_sw_V2_ip_axi_lite_module_inst : Counter_f_sw_V2_ip_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
