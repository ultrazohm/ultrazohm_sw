...
//	Global_Data.rasv.halfBridge1DutyCycle = codegenInstance.output.CMPA_1 * 0.0002;
//	Global_Data.rasv.halfBridge2DutyCycle = codegenInstance.output.CMPA_2 * 0.0002;
//	Global_Data.rasv.halfBridge3DutyCycle = codegenInstance.output.CMPA_3 * 0.0002;
