-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_park_transformation\uz_park_t_ip.vhd
...
ENTITY uz_park_t_ip IS
  PORT( IPCORE_CLK                        :   IN    std_logic;  -- ufix1
        IPCORE_RESETN                     :   IN    std_logic;  -- ufix1
        u1                                :   IN    std_logic_vector(26 DOWNTO 0);  -- ufix27
        u2                                :   IN    std_logic_vector(26 DOWNTO 0);  -- ufix27
        angle_el                          :   IN    std_logic_vector(23 DOWNTO 0);  -- ufix24
...
ARCHITECTURE rtl OF uz_park_t_ip IS

  -- Component Declarations
  COMPONENT uz_park_t_ip_reset_sync
  ...
  COMPONENT uz_park_t_ip_axi_lite
  ...
  FOR ALL : uz_park_t_ip_reset_sync
    USE ENTITY work.uz_park_t_ip_reset_sync(rtl);

  FOR ALL : uz_park_t_ip_axi_lite
    USE ENTITY work.uz_park_t_ip_axi_lite(rtl);

  FOR ALL : uz_park_t_ip_dut
    USE ENTITY work.uz_park_t_ip_dut(rtl);

  -- Signals
  SIGNAL reset                            : std_logic;
  SIGNAL ip_timestamp                     : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL reset_cm                         : std_logic;  -- ufix1
  SIGNAL u1_unsigned                      : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL u1_sig                           : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL u2_unsigned                      : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL u2_sig                           : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL angle_el_unsigned                : unsigned(23 DOWNTO 0);  -- ufix24
  SIGNAL angle_el_sig                     : signed(23 DOWNTO 0);  -- sfix24_En20
...
BEGIN
  u_uz_park_t_ip_reset_sync_inst : uz_park_t_ip_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_uz_park_t_ip_axi_lite_inst : uz_park_t_ip_axi_lite
  ...
  u_uz_park_t_ip_dut_inst : uz_park_t_ip_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              dut_enable => write_axi_enable,  -- ufix1
              u1 => std_logic_vector(u1_sig),  -- sfix27_En24
              u2 => std_logic_vector(u2_sig),  -- sfix27_En24
              angle_el => std_logic_vector(angle_el_sig),  -- sfix24_En20
  ...
  ip_timestamp <= unsigned'(X"839D1A1B");
