-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\valen\Documents\repos\UZ\ultrazohm_sw_working\ip_cores\uz_sixphase_VSD_transformation\hdl_prj\hdlsrc\uz_sixphase_VSD_transformation\uz_sixphase_VSD_transformation_axi4_module.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_sixphase_VSD_transformation_axi4_module
-- Source Path: uz_sixphase_VSD_transformation/uz_sixphase_VSD_transformation_axi4/uz_sixphase_VSD_transformation_axi4_module
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_sixphase_VSD_transformation_axi4_module IS
...
END uz_sixphase_VSD_transformation_axi4_module;


ARCHITECTURE rtl OF uz_sixphase_VSD_transformation_axi4_module IS

  -- Component Declarations
  COMPONENT uz_sixphase_VSD_transformation_rdfifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT uz_sixphase_VSD_transformation_rdfifo_rid
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT uz_sixphase_VSD_transformation_rdfifo_last
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : uz_sixphase_VSD_transformation_rdfifo_data
    USE ENTITY work.uz_sixphase_VSD_transformation_rdfifo_data(rtl);

  FOR ALL : uz_sixphase_VSD_transformation_rdfifo_rid
    USE ENTITY work.uz_sixphase_VSD_transformation_rdfifo_rid(rtl);

  FOR ALL : uz_sixphase_VSD_transformation_rdfifo_last
    USE ENTITY work.uz_sixphase_VSD_transformation_rdfifo_last(rtl);
...
BEGIN
  u_uz_sixphase_VSD_transformation_rdfifo_data_inst : uz_sixphase_VSD_transformation_rdfifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
  ...
  u_uz_sixphase_VSD_transformation_rdfifo_rid_inst : uz_sixphase_VSD_transformation_rdfifo_rid
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
  ...
  u_uz_sixphase_VSD_transformation_rdfifo_last_inst : uz_sixphase_VSD_transformation_rdfifo_last
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
