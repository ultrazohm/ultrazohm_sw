...
void test_uz_delay_compensation_8_set_psiPM(void){
    float psiPM = 1.35f;
    uz_axi_write_float_Expect(TEST_BASE_ADDRESS+psiPM_AXI_Data_parallel_8_delay_compensation,psiPM);
...
void test_uz_delay_compensation_8_set_Lq(void){
    float Lq = 1.35f;
    uz_axi_write_float_Expect(TEST_BASE_ADDRESS+Lq_AXI_Data_parallel_8_delay_compensation,Lq);
...
void test_uz_delay_compensation_8_set_Ld(void){
    float Ld = 1.35f;
    uz_axi_write_float_Expect(TEST_BASE_ADDRESS+Ld_AXI_Data_parallel_8_delay_compensation,Ld);
...
void test_uz_delay_compensation_8_set_Rs(void){
    float Rs = 1.35f;
    uz_axi_write_float_Expect(TEST_BASE_ADDRESS+Rs_AXI_Data_parallel_8_delay_compensation,Rs);
...
void test_uz_delay_compensation_8_set_SampleTime_div_Ld(void){
   ...
   float SampleTime_div_Ld = SampleTime/Ld;
    uz_axi_write_float_Expect(TEST_BASE_ADDRESS+SampleTime_div_Ld_AXI_Data_parallel_8_delay_compensation,SampleTime_div_Ld);
...
void test_uz_delay_compensation_8_set_pole_pairs(void){
    ...
    uz_axi_write_float_Expect(TEST_BASE_ADDRESS+pole_pairs_AXI_Data_parallel_8_delay_compensation,pole_pairs);
...
void test_uz_delay_compensation_8_set_SampleTime_div_Lq(void){
   ...
   float SampleTime_div_Lq = SampleTime/Lq;
    uz_axi_write_float_Expect(TEST_BASE_ADDRESS+SampleTime_div_Lq_AXI_Data_parallel_8_delay_compensation,SampleTime_div_Lq);
...
void test_uz_delay_compensation_8_set_SampleTime_div_Lx(void){
   ...
   float SampleTime_div_Lx = SampleTime/Lx;
    uz_axi_write_float_Expect(TEST_BASE_ADDRESS+SampleTime_div_Lx_AXI_Data_parallel_8_delay_compensation,SampleTime_div_Lx);
...
void test_uz_delay_compensation_8_set_SampleTime_div_Ly(void){
   ...
   float SampleTime_div_Ly = SampleTime/Ly;
    uz_axi_write_float_Expect(TEST_BASE_ADDRESS+SampleTime_div_Ly_AXI_Data_parallel_8_delay_compensation,SampleTime_div_Ly);
