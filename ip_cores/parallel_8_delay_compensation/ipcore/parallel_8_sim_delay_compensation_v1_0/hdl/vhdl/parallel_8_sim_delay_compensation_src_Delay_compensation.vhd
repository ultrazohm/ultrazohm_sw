...
ARCHITECTURE rtl OF parallel_8_sim_delay_compensation_src_Delay_compensation IS
  ...
  SIGNAL Delay19_reg                      : vector_of_signed18(0 TO 1);  -- sfix18 [2]
  SIGNAL Delay19_reg_next                 : vector_of_signed18(0 TO 1);  -- sfix18_En11 [2]
  ...
  SIGNAL Delay18_reg                      : vector_of_signed18(0 TO 1);  -- sfix18 [2]
  SIGNAL Delay18_reg_next                 : vector_of_signed18(0 TO 1);  -- sfix18_En11 [2]
  ...
  SIGNAL Delay17_reg                      : vector_of_signed18(0 TO 1);  -- sfix18 [2]
  SIGNAL Delay17_reg_next                 : vector_of_signed18(0 TO 1);  -- sfix18_En11 [2]
  ...
  SIGNAL Delay16_reg                      : vector_of_signed18(0 TO 1);  -- sfix18 [2]
  SIGNAL Delay16_reg_next                 : vector_of_signed18(0 TO 1);  -- sfix18_En11 [2]
  ...
  SIGNAL Delay34_reg                      : vector_of_signed24(0 TO 1);  -- sfix24 [2]
  SIGNAL Delay34_reg_next                 : vector_of_signed24(0 TO 1);  -- sfix24_En11 [2]
  ...
  SIGNAL Delay26_reg                      : vector_of_signed18(0 TO 1);  -- sfix18 [2]
  SIGNAL Delay26_reg_next                 : vector_of_signed18(0 TO 1);  -- sfix18_En11 [2]
  SIGNAL Delay26_out1                     : signed(17 DOWNTO 0);  -- sfix18_En11
  SIGNAL delayMatch_reg                   : vector_of_signed18(0 TO 5);  -- sfix18 [6]
  SIGNAL delayMatch_reg_next              : vector_of_signed18(0 TO 5);  -- sfix18_En11 [6]
  ...
  SIGNAL Delay25_reg_next                 : vector_of_signed18(0 TO 1);  -- sfix18_En11 [2]
  ...
  SIGNAL Delay24_reg_next                 : vector_of_signed18(0 TO 1);  -- sfix18_En11 [2]
  SIGNAL Delay24_out1                     : signed(17 DOWNTO 0);  -- sfix18_En11
  SIGNAL delayMatch1_reg                  : vector_of_signed18(0 TO 11);  -- sfix18 [12]
  SIGNAL delayMatch1_reg_next             : vector_of_signed18(0 TO 11);  -- sfix18_En11 [12]
  ...
  SIGNAL Delay23_reg_next                 : vector_of_signed18(0 TO 1);  -- sfix18_En11 [2]
  SIGNAL Delay23_out1                     : signed(17 DOWNTO 0);  -- sfix18_En11
  SIGNAL delayMatch2_reg                  : vector_of_signed18(0 TO 11);  -- sfix18 [12]
  SIGNAL delayMatch2_reg_next             : vector_of_signed18(0 TO 11);  -- sfix18_En11 [12]
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay19_reg(0) <= to_signed(16#00000#, 18);
        Delay19_reg(1) <= to_signed(16#00000#, 18);
      ELSIF enb = '1' THEN
  ...
  Delay19_reg_next(0) <= id_measured_signed;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay18_reg(0) <= to_signed(16#00000#, 18);
        Delay18_reg(1) <= to_signed(16#00000#, 18);
      ELSIF enb = '1' THEN
  ...
  Delay18_reg_next(0) <= iq_measured_signed;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay17_reg(0) <= to_signed(16#00000#, 18);
        Delay17_reg(1) <= to_signed(16#00000#, 18);
      ELSIF enb = '1' THEN
  ...
  Delay17_reg_next(0) <= ix_measured_signed;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay16_reg(0) <= to_signed(16#00000#, 18);
        Delay16_reg(1) <= to_signed(16#00000#, 18);
      ELSIF enb = '1' THEN
  ...
  Delay16_reg_next(0) <= iy_measured_signed;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay34_reg(0) <= to_signed(16#000000#, 24);
        Delay34_reg(1) <= to_signed(16#000000#, 24);
      ELSIF enb = '1' THEN
  ...
  Delay34_reg_next(0) <= omega_m_measured_signed;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay26_reg(0) <= to_signed(16#00000#, 18);
        Delay26_reg(1) <= to_signed(16#00000#, 18);
      ELSIF enb = '1' THEN
  ...
  Delay26_reg_next(0) <= last_applied_optimal_voltage_vector_23;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        delayMatch_reg(0) <= to_signed(16#00000#, 18);
        delayMatch_reg(1) <= to_signed(16#00000#, 18);
        delayMatch_reg(2) <= to_signed(16#00000#, 18);
        delayMatch_reg(3) <= to_signed(16#00000#, 18);
        delayMatch_reg(4) <= to_signed(16#00000#, 18);
        delayMatch_reg(5) <= to_signed(16#00000#, 18);
      ELSIF enb = '1' THEN
  ...
  Delay26_out1_1 <= delayMatch_reg(5);
  delayMatch_reg_next(0) <= Delay26_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay25_reg(0) <= to_signed(16#00000#, 18);
        Delay25_reg(1) <= to_signed(16#00000#, 18);
      ELSIF enb = '1' THEN
  ...
  Delay25_reg_next(0) <= last_applied_optimal_voltage_vector_24;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay24_reg(0) <= to_signed(16#00000#, 18);
        Delay24_reg(1) <= to_signed(16#00000#, 18);
      ELSIF enb = '1' THEN
  ...
  Delay24_reg_next(0) <= last_applied_optimal_voltage_vector_25;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        delayMatch1_reg(0) <= to_signed(16#00000#, 18);
        delayMatch1_reg(1) <= to_signed(16#00000#, 18);
        delayMatch1_reg(2) <= to_signed(16#00000#, 18);
        delayMatch1_reg(3) <= to_signed(16#00000#, 18);
        delayMatch1_reg(4) <= to_signed(16#00000#, 18);
        delayMatch1_reg(5) <= to_signed(16#00000#, 18);
        delayMatch1_reg(6) <= to_signed(16#00000#, 18);
        delayMatch1_reg(7) <= to_signed(16#00000#, 18);
        delayMatch1_reg(8) <= to_signed(16#00000#, 18);
        delayMatch1_reg(9) <= to_signed(16#00000#, 18);
        delayMatch1_reg(10) <= to_signed(16#00000#, 18);
        delayMatch1_reg(11) <= to_signed(16#00000#, 18);
      ELSIF enb = '1' THEN
  ...
  Delay24_out1_1 <= delayMatch1_reg(11);
  delayMatch1_reg_next(0) <= Delay24_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay23_reg(0) <= to_signed(16#00000#, 18);
        Delay23_reg(1) <= to_signed(16#00000#, 18);
      ELSIF enb = '1' THEN
  ...
  Delay23_reg_next(0) <= last_applied_optimal_voltage_vector_26;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        delayMatch2_reg(0) <= to_signed(16#00000#, 18);
        delayMatch2_reg(1) <= to_signed(16#00000#, 18);
        delayMatch2_reg(2) <= to_signed(16#00000#, 18);
        delayMatch2_reg(3) <= to_signed(16#00000#, 18);
        delayMatch2_reg(4) <= to_signed(16#00000#, 18);
        delayMatch2_reg(5) <= to_signed(16#00000#, 18);
        delayMatch2_reg(6) <= to_signed(16#00000#, 18);
        delayMatch2_reg(7) <= to_signed(16#00000#, 18);
        delayMatch2_reg(8) <= to_signed(16#00000#, 18);
        delayMatch2_reg(9) <= to_signed(16#00000#, 18);
        delayMatch2_reg(10) <= to_signed(16#00000#, 18);
        delayMatch2_reg(11) <= to_signed(16#00000#, 18);
      ELSIF enb = '1' THEN
  ...
  Delay23_out1_1 <= delayMatch2_reg(11);
  delayMatch2_reg_next(0) <= Delay23_out1;
