-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj123\hdlsrc\uz_pmsm_model_9ph_dq\uz_pmsm_model_9ph_dq_addr_decoder.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_9ph_dq_addr_decoder
-- Source Path: uz_pmsm_model_9ph_dq/uz_pmsm_model_9ph_dq_axi4/uz_pmsm_model_9ph_dq_addr_decoder
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_pmsm_model_9ph_dq_addr_decoder IS
...
END uz_pmsm_model_9ph_dq_addr_decoder;


ARCHITECTURE rtl OF uz_pmsm_model_9ph_dq_addr_decoder IS
  ...
  SIGNAL read_currents_dq_out_axi_unsigned : vector_of_unsigned32(0 TO 8);  -- ufix32 [9]
  SIGNAL sync_reg_currents_dq_out_axi     : vector_of_unsigned32(0 TO 8);  -- ufix32 [9]
  SIGNAL data_slice_currents_dq_out_axi_1 : vector_of_unsigned32(0 TO 8);  -- ufix32 [9]
  ...
  SIGNAL decode_sel_currents_dq_out_axi_1_7 : std_logic;  -- ufix1
  ...
  SIGNAL decode_sel_currents_dq_out_axi_1_8 : std_logic;  -- ufix1
  SIGNAL data_slice_currents_dq_out_axi_1_6 : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_currents_dq_out_axi_1_7 : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_sel_currents_dq_out_axi_1_9 : std_logic;  -- ufix1
  SIGNAL data_slice_currents_dq_out_axi_1_7 : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_currents_dq_out_axi_1_8 : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_sel_voltage_input_dq_out_axi_fb_1_1 : std_logic;  -- ufix1
  SIGNAL data_slice_currents_dq_out_axi_1_8 : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_currents_dq_out_axi_1_9 : unsigned(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL read_voltage_input_dq_out_axi_fb_unsigned : vector_of_unsigned32(0 TO 8);  -- ufix32 [9]
  SIGNAL sync_reg_voltage_input_dq_out_axi_fb : vector_of_unsigned32(0 TO 8);  -- ufix32 [9]
  SIGNAL data_slice_voltage_input_dq_out_axi_fb_1 : vector_of_unsigned32(0 TO 8);  -- ufix32 [9]
  ...
  SIGNAL decode_sel_voltage_input_dq_out_axi_fb_1_7 : std_logic;  -- ufix1
  ...
  SIGNAL decode_sel_voltage_input_dq_out_axi_fb_1_8 : std_logic;  -- ufix1
  SIGNAL data_slice_voltage_input_dq_out_axi_fb_1_6 : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_voltage_input_dq_out_axi_fb_1_7 : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_sel_voltage_input_dq_out_axi_fb_1_9 : std_logic;  -- ufix1
  SIGNAL data_slice_voltage_input_dq_out_axi_fb_1_7 : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_voltage_input_dq_out_axi_fb_1_8 : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL data_slice_voltage_input_dq_out_axi_fb_1_8 : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_voltage_input_dq_out_axi_fb_1_9 : unsigned(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL decode_sel_physical_parameters_L_x3_1_1 : std_logic;  -- ufix1
  SIGNAL reg_enb_physical_parameters_L_x3_1_1 : std_logic;  -- ufix1
  SIGNAL data_reg_physical_parameters_L_x3_1_1 : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_sel_physical_parameters_L_y3_1_1 : std_logic;  -- ufix1
  SIGNAL reg_enb_physical_parameters_L_y3_1_1 : std_logic;  -- ufix1
  SIGNAL data_reg_physical_parameters_L_y3_1_1 : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_sel_physical_parameters_L_zero_1_1 : std_logic;  -- ufix1
  SIGNAL reg_enb_physical_parameters_L_zero_1_1 : std_logic;  -- ufix1
  SIGNAL data_reg_physical_parameters_L_zero_1_1 : unsigned(31 DOWNTO 0);  -- ufix32
...
BEGIN
  ...
  decode_sel_currents_dq_out_axi <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0090#, 14) ELSE
      '0';
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        ...
        sync_reg_currents_dq_out_axi(6) <= to_unsigned(0, 32);
        sync_reg_currents_dq_out_axi(7) <= to_unsigned(0, 32);
        sync_reg_currents_dq_out_axi(8) <= to_unsigned(0, 32);
      ELSIF enb = '1' AND strobe_reg_currents_dq_out_axi = '1' THEN
        ...
        sync_reg_currents_dq_out_axi(6) <= read_currents_dq_out_axi_unsigned(6);
        sync_reg_currents_dq_out_axi(7) <= read_currents_dq_out_axi_unsigned(7);
        sync_reg_currents_dq_out_axi(8) <= read_currents_dq_out_axi_unsigned(8);
      END IF;
    END IF;
  ...
  data_slice_currents_dq_out_axi_1(6) <= sync_reg_currents_dq_out_axi(6);
  data_slice_currents_dq_out_axi_1(7) <= sync_reg_currents_dq_out_axi(7);
  data_slice_currents_dq_out_axi_1(8) <= sync_reg_currents_dq_out_axi(8);
  ...
  decode_sel_currents_dq_out_axi_1_7 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0086#, 14) ELSE
      '0';
  ...
  decode_sel_currents_dq_out_axi_1_8 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0087#, 14) ELSE
      '0';

  data_slice_currents_dq_out_axi_1_6 <= data_slice_currents_dq_out_axi_1(6);

  
  decode_rd_currents_dq_out_axi_1_7 <= decode_rd_currents_dq_out_axi_1_6 WHEN decode_sel_currents_dq_out_axi_1_7 = '0' ELSE
      data_slice_currents_dq_out_axi_1_6;

  
  decode_sel_currents_dq_out_axi_1_9 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0088#, 14) ELSE
      '0';

  data_slice_currents_dq_out_axi_1_7 <= data_slice_currents_dq_out_axi_1(7);

  
  decode_rd_currents_dq_out_axi_1_8 <= decode_rd_currents_dq_out_axi_1_7 WHEN decode_sel_currents_dq_out_axi_1_8 = '0' ELSE
      data_slice_currents_dq_out_axi_1_7;

  
  decode_sel_voltage_input_dq_out_axi_fb_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#00A0#, 14) ELSE
      '0';

  data_slice_currents_dq_out_axi_1_8 <= data_slice_currents_dq_out_axi_1(8);

  
  decode_rd_currents_dq_out_axi_1_9 <= decode_rd_currents_dq_out_axi_1_8 WHEN decode_sel_currents_dq_out_axi_1_9 = '0' ELSE
      data_slice_currents_dq_out_axi_1_8;

  
  decode_sel_voltage_input_dq_out_axi_fb <= '1' WHEN addr_sel_unsigned = to_unsigned(16#00B0#, 14) ELSE
      '0';
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        ...
        sync_reg_voltage_input_dq_out_axi_fb(6) <= to_unsigned(0, 32);
        sync_reg_voltage_input_dq_out_axi_fb(7) <= to_unsigned(0, 32);
        sync_reg_voltage_input_dq_out_axi_fb(8) <= to_unsigned(0, 32);
      ELSIF enb = '1' AND strobe_reg_voltage_input_dq_out_axi_fb = '1' THEN
        ...
        sync_reg_voltage_input_dq_out_axi_fb(6) <= read_voltage_input_dq_out_axi_fb_unsigned(6);
        sync_reg_voltage_input_dq_out_axi_fb(7) <= read_voltage_input_dq_out_axi_fb_unsigned(7);
        sync_reg_voltage_input_dq_out_axi_fb(8) <= read_voltage_input_dq_out_axi_fb_unsigned(8);
      END IF;
    END IF;
  ...
  data_slice_voltage_input_dq_out_axi_fb_1(6) <= sync_reg_voltage_input_dq_out_axi_fb(6);
  data_slice_voltage_input_dq_out_axi_fb_1(7) <= sync_reg_voltage_input_dq_out_axi_fb(7);
  data_slice_voltage_input_dq_out_axi_fb_1(8) <= sync_reg_voltage_input_dq_out_axi_fb(8);
  ...
  decode_rd_voltage_input_dq_out_axi_fb_1_1 <= decode_rd_currents_dq_out_axi_1_9 WHEN decode_sel_voltage_input_dq_out_axi_fb_1_1 = '0' ELSE
  ...
  decode_sel_voltage_input_dq_out_axi_fb_1_7 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#00A6#, 14) ELSE
      '0';
  ...
  decode_sel_voltage_input_dq_out_axi_fb_1_8 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#00A7#, 14) ELSE
      '0';

  data_slice_voltage_input_dq_out_axi_fb_1_6 <= data_slice_voltage_input_dq_out_axi_fb_1(6);

  
  decode_rd_voltage_input_dq_out_axi_fb_1_7 <= decode_rd_voltage_input_dq_out_axi_fb_1_6 WHEN decode_sel_voltage_input_dq_out_axi_fb_1_7 = '0' ELSE
      data_slice_voltage_input_dq_out_axi_fb_1_6;

  
  decode_sel_voltage_input_dq_out_axi_fb_1_9 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#00A8#, 14) ELSE
      '0';

  data_slice_voltage_input_dq_out_axi_fb_1_7 <= data_slice_voltage_input_dq_out_axi_fb_1(7);

  
  decode_rd_voltage_input_dq_out_axi_fb_1_8 <= decode_rd_voltage_input_dq_out_axi_fb_1_7 WHEN decode_sel_voltage_input_dq_out_axi_fb_1_8 = '0' ELSE
      data_slice_voltage_input_dq_out_axi_fb_1_7;

  data_slice_voltage_input_dq_out_axi_fb_1_8 <= data_slice_voltage_input_dq_out_axi_fb_1(8);

  
  decode_rd_voltage_input_dq_out_axi_fb_1_9 <= decode_rd_voltage_input_dq_out_axi_fb_1_8 WHEN decode_sel_voltage_input_dq_out_axi_fb_1_9 = '0' ELSE
      data_slice_voltage_input_dq_out_axi_fb_1_8;

  data_read <= std_logic_vector(decode_rd_voltage_input_dq_out_axi_fb_1_9);
  ...
  decode_sel_voltage_input_dq_axi <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0070#, 14) ELSE
      '0';
  ...
  decode_sel_voltage_input_dq_axi_7_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0066#, 14) ELSE
      '0';

  reg_enb_voltage_input_dq_axi_7_1 <= decode_sel_voltage_input_dq_axi_7_1 AND wr_enb;

  
  decode_sel_voltage_input_dq_axi_8_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0067#, 14) ELSE
      '0';

  reg_enb_voltage_input_dq_axi_8_1 <= decode_sel_voltage_input_dq_axi_8_1 AND wr_enb;

  
  decode_sel_voltage_input_dq_axi_9_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0068#, 14) ELSE
      '0';
  ...
  decode_sel_physical_parameters_L_x1_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#004C#, 14) ELSE
      '0';
  ...
  decode_sel_physical_parameters_L_y1_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#004D#, 14) ELSE
      '0';
  ...
  decode_sel_physical_parameters_L_x2_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#004E#, 14) ELSE
      '0';
  ...
  decode_sel_physical_parameters_L_y2_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#004F#, 14) ELSE
      '0';
  ...
  decode_sel_physical_parameters_L_x3_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0050#, 14) ELSE
      '0';

  reg_enb_physical_parameters_L_x3_1_1 <= decode_sel_physical_parameters_L_x3_1_1 AND wr_enb;

  reg_physical_parameters_L_x3_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_physical_parameters_L_x3_1_1 <= to_unsigned(0, 32);
      ELSIF enb = '1' AND reg_enb_physical_parameters_L_x3_1_1 = '1' THEN
        data_reg_physical_parameters_L_x3_1_1 <= data_write_unsigned;
      END IF;
    END IF;
  END PROCESS reg_physical_parameters_L_x3_1_1_process;


  write_physical_parameters_L_x3 <= std_logic_vector(data_reg_physical_parameters_L_x3_1_1);

  
  decode_sel_physical_parameters_L_y3_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0051#, 14) ELSE
      '0';

  reg_enb_physical_parameters_L_y3_1_1 <= decode_sel_physical_parameters_L_y3_1_1 AND wr_enb;

  reg_physical_parameters_L_y3_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_physical_parameters_L_y3_1_1 <= to_unsigned(0, 32);
      ELSIF enb = '1' AND reg_enb_physical_parameters_L_y3_1_1 = '1' THEN
        data_reg_physical_parameters_L_y3_1_1 <= data_write_unsigned;
      END IF;
    END IF;
  END PROCESS reg_physical_parameters_L_y3_1_1_process;


  write_physical_parameters_L_y3 <= std_logic_vector(data_reg_physical_parameters_L_y3_1_1);

  
  decode_sel_physical_parameters_L_zero_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0052#, 14) ELSE
      '0';

  reg_enb_physical_parameters_L_zero_1_1 <= decode_sel_physical_parameters_L_zero_1_1 AND wr_enb;

  reg_physical_parameters_L_zero_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_physical_parameters_L_zero_1_1 <= to_unsigned(0, 32);
      ELSIF enb = '1' AND reg_enb_physical_parameters_L_zero_1_1 = '1' THEN
        data_reg_physical_parameters_L_zero_1_1 <= data_write_unsigned;
      END IF;
    END IF;
  END PROCESS reg_physical_parameters_L_zero_1_1_process;


  write_physical_parameters_L_zero <= std_logic_vector(data_reg_physical_parameters_L_zero_1_1);
