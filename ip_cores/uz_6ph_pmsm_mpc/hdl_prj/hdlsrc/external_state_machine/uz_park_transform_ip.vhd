-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\external_state_machine\uz_park_transform_ip.vhd
...
ENTITY uz_park_transform_ip IS
  PORT( IPCORE_CLK                        :   IN    std_logic;  -- ufix1
        ...
        angle_el                          :   IN    std_logic_vector(26 DOWNTO 0);  -- ufix27
        ...
        sin                               :   OUT   std_logic_vector(26 DOWNTO 0);  -- ufix27
        cos                               :   OUT   std_logic_vector(26 DOWNTO 0);  -- ufix27
...
ARCHITECTURE rtl OF uz_park_transform_ip IS
  ...
  SIGNAL angle_el_unsigned                : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL angle_el_sig                     : signed(26 DOWNTO 0);  -- sfix27_En20
  ...
  SIGNAL write_offset_angle_el_AXI        : std_logic_vector(17 DOWNTO 0);  -- ufix18
  SIGNAL ce_out_sig                       : std_logic;  -- ufix1
  SIGNAL y1_sig                           : std_logic_vector(26 DOWNTO 0);  -- ufix27
  SIGNAL y2_sig                           : std_logic_vector(26 DOWNTO 0);  -- ufix27
  SIGNAL sin_sig                          : std_logic_vector(26 DOWNTO 0);  -- ufix27
  SIGNAL cos_sig                          : std_logic_vector(26 DOWNTO 0);  -- ufix27
  SIGNAL park_done_sig                    : std_logic;  -- ufix1
  SIGNAL y1_sig_signed                    : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL y1_tmp                           : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL y2_sig_signed                    : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL y2_tmp                           : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL sin_sig_signed                   : signed(26 DOWNTO 0);  -- sfix27_En20
  SIGNAL sin_tmp                          : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL cos_sig_signed                   : signed(26 DOWNTO 0);  -- sfix27_En20
  SIGNAL cos_tmp                          : unsigned(26 DOWNTO 0);  -- ufix27
...
BEGIN
  ...
  u_uz_park_transform_ip_axi_lite_inst : uz_park_transform_ip_axi_lite
    PORT MAP( reset => reset,
              ...
              read_y1_AXI => y1_AXI_sig,  -- sfix27_En24
              read_y2_AXI => y2_AXI_sig,  -- sfix27_En24
              ...
              write_offset_angle_el_AXI => write_offset_angle_el_AXI,  -- sfix18_En14
  ...
  u_uz_park_transform_ip_dut_inst : uz_park_transform_ip_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              ...
              angle_el => std_logic_vector(angle_el_sig),  -- sfix27_En20
              trigger => trigger,  -- ufix1
              factor_angle_el_AXI => write_factor_angle_el_AXI,  -- sfix18_En14
              offset_angle_el_AXI => write_offset_angle_el_AXI,  -- sfix18_En14
              ce_out => ce_out_sig,  -- ufix1
              y1 => y1_sig,  -- sfix27_En24
              y2 => y2_sig,  -- sfix27_En24
              y1_AXI => y1_AXI_sig,  -- sfix27_En24
              y2_AXI => y2_AXI_sig,  -- sfix27_En24
              sin => sin_sig,  -- sfix27_En20
              cos => cos_sig,  -- sfix27_En20
              park_done => park_done_sig  -- ufix1
              );

  ip_timestamp <= unsigned'(X"8985411C");
