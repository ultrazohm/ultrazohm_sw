...
#define UZ_D5_ANGINCREMENTAL_ENCODER_RESOLUTION	5000.0f
#define UZ_D5_POSINCREMENTAL_ENCODER_RESOLUTION 500.0f
#define UZ_D5_INCREMENTAL_ENCODER_RESOLUTION    256.0f
...
#define UZ_PI_CONTROLLER_MAX_INSTANCES                  10U
#define UZ_FOC_MAX_INSTANCES                            2U
#define UZ_INCREMENTALENCODER_MAX_INSTANCES             4U
#define UZ_PWM_SS_2L_MAX_INSTANCES                      4U
#define UZ_MATRIX_MAX_INSTANCES                         5U
#define UZ_NN_LAYER_MAX_INSTANCES                       5U
#define UZ_NN_MAX_INSTANCES                             3U
...
<<<<<<< HEAD
#define UZ_SPEEDCONTROL_MAX_INSTANCES                   5U
#define UZ_IIR_FILTER_MAX_INSTANCES                     5U
