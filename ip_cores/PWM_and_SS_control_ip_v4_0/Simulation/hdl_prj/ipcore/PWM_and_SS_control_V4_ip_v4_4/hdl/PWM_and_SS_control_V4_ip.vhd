...
ENTITY PWM_and_SS_control_V4_ip IS
  PORT( IPCORE_CLK                        :   IN    std_logic;  -- ufix1
        ...
        m_u1_norm                         :   IN    std_logic_vector(17 DOWNTO 0);  -- ufix18
        m_u2_norm                         :   IN    std_logic_vector(17 DOWNTO 0);  -- ufix18
        m_u3_norm                         :   IN    std_logic_vector(17 DOWNTO 0);  -- ufix18
...
ARCHITECTURE rtl OF PWM_and_SS_control_V4_ip IS
  ...
  COMPONENT PWM_and_SS_control_V4_ip_dut
    PORT( clk                             :   IN    std_logic;  -- ufix1
          ...
          m_u1_norm                       :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En16
          m_u2_norm                       :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En16
          m_u3_norm                       :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En16
          m_u1_norm_AXI                   :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En16
          m_u2_norm_AXI                   :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En16
          m_u3_norm_AXI                   :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En16
          SS0_IN_External                 :   IN    std_logic;  -- ufix1
          SS1_IN_External                 :   IN    std_logic;  -- ufix1
          SS2_IN_External                 :   IN    std_logic;  -- ufix1
          SS3_IN_External                 :   IN    std_logic;  -- ufix1
          SS4_IN_External                 :   IN    std_logic;  -- ufix1
          SS5_IN_External                 :   IN    std_logic;  -- ufix1
          TriState_HB_AXI                 :   IN    std_logic_vector(2 DOWNTO 0);  -- ufix3
  ...
  SIGNAL m_u1_norm_unsigned               : unsigned(17 DOWNTO 0);  -- ufix18
  SIGNAL m_u1_norm_sig                    : signed(17 DOWNTO 0);  -- sfix18_En16
  SIGNAL m_u2_norm_unsigned               : unsigned(17 DOWNTO 0);  -- ufix18
  SIGNAL m_u2_norm_sig                    : signed(17 DOWNTO 0);  -- sfix18_En16
  SIGNAL m_u3_norm_unsigned               : unsigned(17 DOWNTO 0);  -- ufix18
  SIGNAL m_u3_norm_sig                    : signed(17 DOWNTO 0);  -- sfix18_En16
  ...
  SIGNAL write_m_u1_norm_AXI              : std_logic_vector(17 DOWNTO 0);  -- ufix18
  SIGNAL write_m_u2_norm_AXI              : std_logic_vector(17 DOWNTO 0);  -- ufix18
  SIGNAL write_m_u3_norm_AXI              : std_logic_vector(17 DOWNTO 0);  -- ufix18
  SIGNAL write_TriState_HB_AXI            : std_logic_vector(2 DOWNTO 0);  -- ufix3
  SIGNAL write_count_src_ext_AXI          : std_logic;  -- ufix1
  SIGNAL write_triangle_shift_HB1_AXI     : std_logic_vector(17 DOWNTO 0);  -- ufix18
  SIGNAL write_triangle_shift_HB2_AXI     : std_logic_vector(17 DOWNTO 0);  -- ufix18
  SIGNAL write_triangle_shift_HB3_AXI     : std_logic_vector(17 DOWNTO 0);  -- ufix18
...
BEGIN
  ...
  u_PWM_and_SS_control_V4_ip_axi_lite_inst : PWM_and_SS_control_V4_ip_axi_lite
    PORT MAP( reset => reset,
              ...
              write_m_u1_norm_AXI => write_m_u1_norm_AXI,  -- sfix18_En16
              write_m_u2_norm_AXI => write_m_u2_norm_AXI,  -- sfix18_En16
              write_m_u3_norm_AXI => write_m_u3_norm_AXI,  -- sfix18_En16
              write_TriState_HB_AXI => write_TriState_HB_AXI,  -- ufix3
              write_count_src_ext_AXI => write_count_src_ext_AXI,  -- ufix1
              write_triangle_shift_HB1_AXI => write_triangle_shift_HB1_AXI,  -- ufix18_En17
              write_triangle_shift_HB2_AXI => write_triangle_shift_HB2_AXI,  -- ufix18_En17
              write_triangle_shift_HB3_AXI => write_triangle_shift_HB3_AXI,  -- ufix18_En17
  ...
  u_PWM_and_SS_control_V4_ip_dut_inst : PWM_and_SS_control_V4_ip_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              ...
              m_u1_norm => std_logic_vector(m_u1_norm_sig),  -- sfix18_En16
              m_u2_norm => std_logic_vector(m_u2_norm_sig),  -- sfix18_En16
              m_u3_norm => std_logic_vector(m_u3_norm_sig),  -- sfix18_En16
              m_u1_norm_AXI => write_m_u1_norm_AXI,  -- sfix18_En16
              m_u2_norm_AXI => write_m_u2_norm_AXI,  -- sfix18_En16
              m_u3_norm_AXI => write_m_u3_norm_AXI,  -- sfix18_En16
              ...
              TriState_HB_AXI => write_TriState_HB_AXI,  -- ufix3
              triangle_in => std_logic_vector(triangle_in_sig),  -- ufix18_En17
              count_src_ext_AXI => write_count_src_ext_AXI,  -- ufix1
              triangle_shift_HB1_AXI => write_triangle_shift_HB1_AXI,  -- ufix18_En17
              triangle_shift_HB2_AXI => write_triangle_shift_HB2_AXI,  -- ufix18_En17
              triangle_shift_HB3_AXI => write_triangle_shift_HB3_AXI,  -- ufix18_En17
  ...
  ip_timestamp <= unsigned'(X"9B2AC37C");
