-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\parallel_8_prediction_and_cost_function\hdlsrc\parallel_8_prediction_and_cost_function\parallel_8_sim_prediction_and_cost_function_src_nfp_convert_single_to_sfix_20_En9.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: parallel_8_sim_prediction_and_cost_function_src_nfp_convert_single_to_sfix_20_En9
-- Source Path: parallel_8_prediction_and_cost_function/Prediction_and_cost_function1/nfp_convert_single_to_sfix_20_En9
-- Hierarchy Level: 1
-- 
...
ENTITY parallel_8_sim_prediction_and_cost_function_src_nfp_convert_single_to_sfix_20_En9 IS
...
END parallel_8_sim_prediction_and_cost_function_src_nfp_convert_single_to_sfix_20_En9;


ARCHITECTURE rtl OF parallel_8_sim_prediction_and_cost_function_src_nfp_convert_single_to_sfix_20_En9 IS
  ...
  SIGNAL Delay4_out1_1                    : unsigned(34 DOWNTO 0);  -- ufix35_En24
  SIGNAL Bit_Set_out1                     : unsigned(34 DOWNTO 0);  -- ufix35_En24
  SIGNAL Switch2_out1_1                   : unsigned(34 DOWNTO 0);  -- ufix35_En24
  ...
  SIGNAL Delay6_out1                      : unsigned(34 DOWNTO 0);  -- ufix35_En24
  SIGNAL Switch1_out1                     : unsigned(34 DOWNTO 0);  -- ufix35_En24
  SIGNAL Delay9_out1                      : unsigned(34 DOWNTO 0);  -- ufix35_En24
  ...
  SIGNAL Data_Type_Conversion2_out1       : signed(19 DOWNTO 0);  -- sfix20_En9
  SIGNAL Delay8_out1                      : signed(19 DOWNTO 0);  -- sfix20_En9
...
BEGIN
  ...
  Data_Type_Conversion_out1 <= resize(Delay2_out1 & '0', 35);
  ...
  Compare_To_Zero1_out1_1 <= '1' WHEN Shift_Arithmetic1_out1 = to_unsigned(0, 35) ELSE
      '0';

  
  Compare_To_Zero_out1_1 <= '1' WHEN Data_Type_Conversion_out1 /= to_unsigned(0, 35) ELSE
      '0';
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay4_out1_1 <= to_unsigned(0, 35);
      ELSIF enb = '1' THEN
  ...
  Bit_Set_out1 <= Delay4_out1_1 OR to_unsigned(1, 35);
  ...
  Data_Type_Conversion1_out1_1 <= resize(Delay2_out1 & '0', 35);
  ...
  Data_Type_Conversion1_out1_2 <= signed(resize(Delay9_out1, 36));
  ...
  Data_Type_Conversion2_out1 <= Switch1_out1_1(34 DOWNTO 15);
