.. _deskbench_terminal_rev01:

============================
Deskbench terminal PCB Rev01
============================
...
.. figure:: anschluss_terminal.jpg
   ...
   uz_per_deskbench_terminal PCB Rev01 in housing
...
.. figure:: uz_per_deskbench_terminal_functional.svg
   ...
   Functional areas of the uz_per_deskbench_terminal PCB rev01
...
:download:`Schematics Rev01 <SCH_UZ_PER_deskbench_terminal_Differential_Input_Rev01a.pdf>`
