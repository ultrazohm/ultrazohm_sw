...
#define  IPCore_Timestamp_Incremental_Encoder_v26              0x8  //contains unique IP timestamp (yymmddHHMM): 2302241023
...
#define  omega_AXI4_Data_Incremental_Encoder_v26               0x118  //data register for Outport omega_AXI4
#define  direction_AXI4_Data_Incremental_Encoder_v26           0x11C  //data register for Outport direction_AXI4
...
#define  countPerPeriod_AXI4_Data_Incremental_Encoder_v26      0x12C  //data register for Outport countPerPeriod_AXI4
#define  timeout_value_AXI4_Data_Incremental_Encoder_v26       0x130  //data register for Inport timeout_value_AXI4
#define  omega_MA_N4_AXI_Data_Incremental_Encoder_v26          0x134  //data register for Outport omega_MA_N4_AXI
#define  position_wOffset_AXI4_Data_Incremental_Encoder_v26    0x138  //data register for Outport position_wOffset_AXI4
#define  Index_found_AXI4_Data_Incremental_Encoder_v26         0x13C  //data register for Outport Index_found_AXI4
