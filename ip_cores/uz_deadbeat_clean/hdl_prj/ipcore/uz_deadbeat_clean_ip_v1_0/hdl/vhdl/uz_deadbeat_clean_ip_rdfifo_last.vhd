-- -------------------------------------------------------------
-- 
-- File Name: C:\UltraZohm\ultrazohm_test\ip_cores\uz_deadbeat_clean\hdl_prj\hdlsrc\uz_deadbeat_clean\uz_deadbeat_clean_ip_rdfifo_last.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_deadbeat_clean_ip_rdfifo_last
-- Source Path: uz_deadbeat_clean_ip/uz_deadbeat_clean_ip_axi4/uz_deadbeat_clean_ip_axi4_module/uz_deadbeat_clean_ip_rdfifo_last
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_deadbeat_clean_ip_rdfifo_last IS
...
END uz_deadbeat_clean_ip_rdfifo_last;


ARCHITECTURE rtl OF uz_deadbeat_clean_ip_rdfifo_last IS

  -- Component Declarations
  COMPONENT uz_deadbeat_clean_ip_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : uz_deadbeat_clean_ip_SimpleDualPortRAM_singlebit
    USE ENTITY work.uz_deadbeat_clean_ip_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_uz_deadbeat_clean_ip_rdfifo_last_classic_ram_singlebit : uz_deadbeat_clean_ip_SimpleDualPortRAM_singlebit
