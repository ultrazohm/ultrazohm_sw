-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_mpc_cost_and_optim_state_machine\uz_6ph_mp_ip.vhd
...
ARCHITECTURE rtl OF uz_6ph_mp_ip IS

  -- Component Declarations
  COMPONENT uz_6ph_mp_ip_reset_sync
  ...
  COMPONENT uz_6ph_mp_ip_axi_lite
  ...
  FOR ALL : uz_6ph_mp_ip_reset_sync
    USE ENTITY work.uz_6ph_mp_ip_reset_sync(rtl);

  FOR ALL : uz_6ph_mp_ip_axi_lite
    USE ENTITY work.uz_6ph_mp_ip_axi_lite(rtl);

  FOR ALL : uz_6ph_mp_ip_dut
    USE ENTITY work.uz_6ph_mp_ip_dut(rtl);
...
BEGIN
  u_uz_6ph_mp_ip_reset_sync_inst : uz_6ph_mp_ip_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_uz_6ph_mp_ip_axi_lite_inst : uz_6ph_mp_ip_axi_lite
  ...
  u_uz_6ph_mp_ip_dut_inst : uz_6ph_mp_ip_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  ip_timestamp <= unsigned'(X"83AD96C5");
