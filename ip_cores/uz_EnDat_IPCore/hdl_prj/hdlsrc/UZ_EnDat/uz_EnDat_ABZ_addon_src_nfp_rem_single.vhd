...
ARCHITECTURE rtl OF uz_EnDat_ABZ_addon_src_nfp_rem_single IS
  ...
  SIGNAL Delay17_reg                      : std_logic_vector(21 DOWNTO 0);  -- ufix1 [22]
  ...
  SIGNAL Delay20_reg                      : std_logic_vector(9 DOWNTO 0);  -- ufix1 [10]
  ...
  SIGNAL Delay_reg                        : std_logic_vector(12 DOWNTO 0);  -- ufix1 [13]
  ...
  SIGNAL Delay17_out1_1                   : signed(27 DOWNTO 0);  -- sfix28
  ...
  SIGNAL Delay6_out1_4                    : signed(9 DOWNTO 0);  -- sfix10
  ...
  SIGNAL Delay18_reg                      : vector_of_unsigned8(0 TO 9);  -- ufix8 [10]
  SIGNAL Delay18_out1_3                   : unsigned(7 DOWNTO 0);  -- ufix8
  SIGNAL if_rem_Exceptional_Check_cfType_out1 : unsigned(7 DOWNTO 0);  -- ufix8
  SIGNAL Switch6_out1_1                   : unsigned(7 DOWNTO 0);  -- ufix8
  SIGNAL Delay6_out1_5                    : unsigned(7 DOWNTO 0);  -- ufix8
  ...
  SIGNAL Delay19_reg                      : vector_of_unsigned23(0 TO 9);  -- ufix23 [10]
  SIGNAL Delay19_out1_3                   : unsigned(22 DOWNTO 0);  -- ufix23
  ...
  SIGNAL Delay7_out1_5                    : unsigned(22 DOWNTO 0);  -- ufix23
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        Delay17_reg(21 DOWNTO 1) <= Delay17_reg(20 DOWNTO 0);
      END IF;
    END IF;
  END PROCESS Delay17_process;

  Delay17_out1 <= Delay17_reg(21);
  ...
  Constant7_out1 <= to_unsigned(16#17#, 8);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        reduced_reg(1 TO 11) <= reduced_reg(0 TO 10);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        reduced_reg_2(1 TO 11) <= reduced_reg_2(0 TO 10);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        Delay20_reg(9 DOWNTO 1) <= Delay20_reg(8 DOWNTO 0);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        reduced_reg_4(1 TO 12) <= reduced_reg_4(0 TO 11);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        Delay_reg(12 DOWNTO 1) <= Delay_reg(11 DOWNTO 0);
      END IF;
    END IF;
  END PROCESS Delay_2_process;

  Delay_out1_2 <= Delay_reg(12);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay17_out1_1 <= to_signed(16#0000000#, 28);
      ELSIF enb = '1' THEN
        Delay17_out1_1 <= Delay12_out1;
      END IF;
    END IF;
  END PROCESS Delay17_1_process;


  Add_add_temp_3 <= resize(Bit_Shift_out1_3, 32) + resize(Delay17_out1_1, 32);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay17_out1_2 <= Delay12_out1_1;
      END IF;
    END IF;
  END PROCESS Delay17_2_process;


  Add_add_temp_7 <= resize(Bit_Shift_out1_7, 32) + resize(Delay17_out1_2, 32);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay17_out1_3 <= Delay12_out1_2;
      END IF;
    END IF;
  END PROCESS Delay17_3_process;


  Add_add_temp_11 <= resize(Bit_Shift_out1_11, 32) + resize(Delay17_out1_3, 32);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        reduced_reg_5(1 TO 12) <= reduced_reg_5(0 TO 11);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        reduced_reg_6(1 TO 12) <= reduced_reg_6(0 TO 11);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay32_reg(0) <= Logical_Operator4_out1_3;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay6_out1_4 <= to_signed(16#000#, 10);
      ELSIF enb = '1' THEN
        Delay6_out1_4 <= DTC3_out1_13;
      END IF;
    END IF;
  ...
  exp_diff_in_2_add_temp_13 <= resize(Delay6_out1_4, 32) + resize(C_out1_16, 32);
  ...
  Bit_Slice3_out1_14 <= Delay6_out1_4(9);
  ...
  BitSlice_out1_2 <= unsigned(Delay15_out1_4(23 DOWNTO 0));
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay24_reg <= (OTHERS => to_signed(16#000#, 10));
      ELSIF enb = '1' THEN
        Delay24_reg(0) <= Delay7_out1;
        Delay24_reg(1 TO 16) <= Delay24_reg(0 TO 15);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        reduced_reg_7(1 TO 15) <= reduced_reg_7(0 TO 14);
      END IF;
    END IF;
  ...
  exp_a_norm_exp_b_norm_out1_1 <= '1' WHEN Delay24_out1 < modrem_Normalize_Exp_Mant_out3_1 ELSE
      '0';
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        Delay18_reg(1 TO 9) <= Delay18_reg(0 TO 8);
      END IF;
    END IF;
  END PROCESS Delay18_3_process;

  Delay18_out1_3 <= Delay18_reg(9);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        Delay19_reg(1 TO 9) <= Delay19_reg(0 TO 8);
      END IF;
    END IF;
  END PROCESS Delay19_3_process;

  Delay19_out1_3 <= Delay19_reg(9);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay7_out1_5 <= to_unsigned(16#000000#, 23);
      ELSIF enb = '1' THEN
        Delay7_out1_5 <= Switch5_out1_1;
      END IF;
    END IF;
  ...
  nfp_out_pack <= Delay5_out1 & Delay6_out1_5 & Delay7_out1_5;
