-- -------------------------------------------------------------
-- 
-- File Name: /home/ts/Documents/integrate_nn_to_uz/ultrazohm_sw/ip_cores/nnAXI_v1_0/hdl_prj/hdlsrc/uz_mlp_three_layer/uz_mlp_three_layer_src_StateMachines1_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_mlp_three_layer_src_StateMachines1_block
-- Source Path: uz_mlp_three_layer/pcu_mlp2_8parallel/reluLayer_8Parallel/StateMachines1
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_mlp_three_layer_src_StateMachines1_block IS
...
END uz_mlp_three_layer_src_StateMachines1_block;


ARCHITECTURE rtl OF uz_mlp_three_layer_src_StateMachines1_block IS

  -- Component Declarations
  COMPONENT uz_mlp_three_layer_src_Detect_Rise_Positive_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  FOR ALL : uz_mlp_three_layer_src_Detect_Rise_Positive_block2
    USE ENTITY work.uz_mlp_three_layer_src_Detect_Rise_Positive_block2(rtl);
...
BEGIN
  u_Detect_Rise_Positive : uz_mlp_three_layer_src_Detect_Rise_Positive_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              U => triggerCalc,
