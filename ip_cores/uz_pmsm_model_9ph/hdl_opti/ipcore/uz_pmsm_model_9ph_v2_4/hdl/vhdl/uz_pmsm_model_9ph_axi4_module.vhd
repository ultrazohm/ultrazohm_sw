-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\valen\Documents\repos\UZ\ultrazohm_sw\ip_cores\uz_pmsm_model_9ph\hdl_opti\hdlsrc\uz_pmsm_model_9ph\uz_pmsm_model_9ph_axi4_module.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_9ph_axi4_module
-- Source Path: uz_pmsm_model_9ph/uz_pmsm_model_9ph_axi4/uz_pmsm_model_9ph_axi4_module
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_pmsm_model_9ph_axi4_module IS
...
END uz_pmsm_model_9ph_axi4_module;


ARCHITECTURE rtl OF uz_pmsm_model_9ph_axi4_module IS

  -- Component Declarations
  COMPONENT uz_pmsm_model_9ph_rdfifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT uz_pmsm_model_9ph_rdfifo_rid
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT uz_pmsm_model_9ph_rdfifo_last
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : uz_pmsm_model_9ph_rdfifo_data
    USE ENTITY work.uz_pmsm_model_9ph_rdfifo_data(rtl);

  FOR ALL : uz_pmsm_model_9ph_rdfifo_rid
    USE ENTITY work.uz_pmsm_model_9ph_rdfifo_rid(rtl);

  FOR ALL : uz_pmsm_model_9ph_rdfifo_last
    USE ENTITY work.uz_pmsm_model_9ph_rdfifo_last(rtl);
...
BEGIN
  u_uz_pmsm_model_9ph_rdfifo_data_inst : uz_pmsm_model_9ph_rdfifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
  ...
  u_uz_pmsm_model_9ph_rdfifo_rid_inst : uz_pmsm_model_9ph_rdfifo_rid
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
  ...
  u_uz_pmsm_model_9ph_rdfifo_last_inst : uz_pmsm_model_9ph_rdfifo_last
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
