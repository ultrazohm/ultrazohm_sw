...
module BGD_scal_float_4u_unsigned_int_25 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output   ap_idle;
output   ap_ready;
input  [127:0] l_weightGradient_dout;
input   l_weightGradient_empty_n;
output   l_weightGradient_read;
output  [127:0] l_weightGradientScal_din;
...
wire   [31:0] l_v_12_fu_219_p1;
wire   [31:0] l_v_11_fu_215_p1;
wire   [31:0] l_v_10_fu_211_p1;
...
always @ (posedge ap_clk) begin
    if ((~((ap_start == 1'b0) | (p_weightSize_out_full_n == 1'b0) | (l_multiplicator_loc_empty_n == 1'b0) | (p_weightSize_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        trunc_ln_reg_244 <= {{p_weightSize_dout[31:2]}};
    end
end
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((icmp_ln59_reg_249_pp0_iter3_reg == 1'd0) & (ap_enable_reg_pp0_iter4 == 1'b1) & (l_weightGradientScal_full_n == 1'b0)) | ((icmp_ln59_reg_249 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (l_weightGradient_empty_n == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((icmp_ln59_reg_249_pp0_iter3_reg == 1'd0) & (ap_enable_reg_pp0_iter4 == 1'b1) & (l_weightGradientScal_full_n == 1'b0)) | ((icmp_ln59_reg_249 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (l_weightGradient_empty_n == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((icmp_ln59_reg_249_pp0_iter3_reg == 1'd0) & (ap_enable_reg_pp0_iter4 == 1'b1) & (l_weightGradientScal_full_n == 1'b0)) | ((icmp_ln59_reg_249 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (l_weightGradient_empty_n == 1'b0)));
end
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter1 = ((icmp_ln59_reg_249 == 1'd0) & (l_weightGradient_empty_n == 1'b0));
end
...
always @ (*) begin
    ap_block_state6_pp0_stage0_iter4 = ((icmp_ln59_reg_249_pp0_iter3_reg == 1'd0) & (l_weightGradientScal_full_n == 1'b0));
end
...
assign i_2_fu_147_p2 = (i_reg_105 + 30'd1);

assign icmp_ln59_fu_142_p2 = ((i_reg_105 == trunc_ln_reg_244) ? 1'b1 : 1'b0);

assign l_v_10_fu_211_p1 = grp_fu_120_p2;

assign l_v_11_fu_215_p1 = grp_fu_124_p2;

assign l_v_12_fu_219_p1 = grp_fu_128_p2;

assign l_v_fu_207_p1 = grp_fu_116_p2;

assign l_weightGradientScal_din = {{{{l_v_12_fu_219_p1}, {l_v_11_fu_215_p1}}, {l_v_10_fu_211_p1}}, {l_v_fu_207_p1}};

assign p_Result_4_i_i_fu_162_p4 = {{l_weightGradient_dout[63:32]}};

assign p_Result_5_i_i_fu_177_p4 = {{l_weightGradient_dout[95:64]}};

assign p_Result_6_i_i_fu_192_p4 = {{l_weightGradient_dout[127:96]}};

assign p_weightSize_out_din = p_weightSize_dout;

assign trunc_ln674_fu_153_p1 = l_weightGradient_dout[31:0];

endmodule //BGD_scal_float_4u_unsigned_int_25
