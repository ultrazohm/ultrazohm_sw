...
ARCHITECTURE rtl OF Delay_compensation_FCS_MPC_6Phase_PMSM_src_HDL_DUT IS
  ...
  COMPONENT Delay_compensation_FCS_MPC_6Phase_PMSM_src_Detect_Rise_Positive1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  FOR ALL : Delay_compensation_FCS_MPC_6Phase_PMSM_src_Detect_Rise_Positive1
    USE ENTITY work.Delay_compensation_FCS_MPC_6Phase_PMSM_src_Detect_Rise_Positive1(rtl);
  ...
  SIGNAL delayMatch17_reg                 : std_logic_vector(0 TO 12);  -- ufix1 [13]
  SIGNAL delayMatch17_reg_next            : std_logic_vector(0 TO 12);  -- ufix1 [13]
  ...
  SIGNAL reduced_reg_next_1               : vector_of_signed18(0 TO 3);  -- sfix18_En11 [4]
  ...
  SIGNAL reduced_reg_2                    : vector_of_signed18(0 TO 18);  -- sfix18 [19]
  SIGNAL reduced_reg_next_2               : vector_of_signed18(0 TO 18);  -- sfix18_En11 [19]
...
BEGIN
  ...
  u_Detect_Rise_Positive1 : Delay_compensation_FCS_MPC_6Phase_PMSM_src_Detect_Rise_Positive1
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              U => Delay35_out1,
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        ...
        delayMatch17_reg(11) <= '0';
        delayMatch17_reg(12) <= '0';
      ELSIF enb = '1' THEN
  ...
  End_Cycle_5 <= delayMatch17_reg(12);
  ...
  switch_compare_1_21 <= '1' WHEN End_Cycle_5 = '1' ELSE
      '0';
  ...
  Data_Type_Conversion_out1_1 <= reduced_reg_1(3);
  reduced_reg_next_1(0) <= Data_Type_Conversion_out1_signed;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        ...
        reduced_reg_2(12) <= to_signed(16#00000#, 18);
        reduced_reg_2(13) <= to_signed(16#00000#, 18);
        reduced_reg_2(14) <= to_signed(16#00000#, 18);
        reduced_reg_2(15) <= to_signed(16#00000#, 18);
        reduced_reg_2(16) <= to_signed(16#00000#, 18);
        reduced_reg_2(17) <= to_signed(16#00000#, 18);
        reduced_reg_2(18) <= to_signed(16#00000#, 18);
      ELSIF enb = '1' THEN
  ...
  Data_Type_Conversion8_out1_1 <= reduced_reg_2(18);
  reduced_reg_next_2(0) <= Data_Type_Conversion8_out1_signed;
  ...
  Data_Type_Conversion9_out1_1 <= reduced_reg_3(18);
  reduced_reg_next_3(0) <= Data_Type_Conversion9_out1_signed;
