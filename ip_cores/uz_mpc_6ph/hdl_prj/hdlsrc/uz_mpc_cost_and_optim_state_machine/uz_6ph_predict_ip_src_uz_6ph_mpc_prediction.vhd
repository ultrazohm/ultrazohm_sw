...
ARCHITECTURE rtl OF uz_6ph_predict_ip_src_uz_6ph_mpc_prediction IS
  ...
  SIGNAL id_delay_pu_signed               : signed(26 DOWNTO 0);  -- sfix27_En16
  ...
  SIGNAL iq_delay_pu_signed               : signed(26 DOWNTO 0);  -- sfix27_En16
  ...
  SIGNAL ix_delay_pu_signed               : signed(26 DOWNTO 0);  -- sfix27_En16
  ...
  SIGNAL Delay7_out1                      : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL ix_k_pu                          : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL Product12_mul_temp               : signed(44 DOWNTO 0);  -- sfix45_En31
  ...
  SIGNAL ix_k_pu_1                        : signed(26 DOWNTO 0);  -- sfix27_En16
  ...
  SIGNAL iy_delay_pu_signed               : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL Delay8_reg                       : vector_of_signed27(0 TO 1);  -- sfix27 [2]
  SIGNAL Delay8_out1                      : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL Switch3_out1                     : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL Delay9_out1                      : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL iy_k_pu                          : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL Product14_mul_temp               : signed(44 DOWNTO 0);  -- sfix45_En31
  ...
  SIGNAL iy_k_pu_1                        : signed(26 DOWNTO 0);  -- sfix27_En16
...
BEGIN
  ...
  Product12_out1 <= Product12_mul_temp(33 DOWNTO 16);
  ...
  Add5_add_cast_1 <= ix_k_pu_1(18 DOWNTO 0) & '0' & '0' & '0' & '0' & '0' & '0' & '0' & '0';
  ...
  Product14_out1 <= Product14_mul_temp(33 DOWNTO 16);
  ...
  Add7_add_cast_1 <= iy_k_pu_1(18 DOWNTO 0) & '0' & '0' & '0' & '0' & '0' & '0' & '0' & '0';
