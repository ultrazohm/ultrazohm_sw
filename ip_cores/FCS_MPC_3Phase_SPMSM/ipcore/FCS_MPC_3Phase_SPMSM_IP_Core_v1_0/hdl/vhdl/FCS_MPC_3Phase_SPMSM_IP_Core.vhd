-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\FCS_MPC_3Phase_SPMSM\hdlsrc\FCS_MPC_3Phase_SPMSM_TEST1\FCS_MPC_3Phase_SPMSM_IP_Core.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: FCS_MPC_3Phase_SPMSM_IP_Core
-- Source Path: FCS_MPC_3Phase_SPMSM_IP_Core
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY FCS_MPC_3Phase_SPMSM_IP_Core IS
...
END FCS_MPC_3Phase_SPMSM_IP_Core;


ARCHITECTURE rtl OF FCS_MPC_3Phase_SPMSM_IP_Core IS

  -- Component Declarations
  COMPONENT FCS_MPC_3Phase_SPMSM_IP_Core_reset_sync
  ...
  COMPONENT FCS_MPC_3Phase_SPMSM_IP_Core_axi_lite
  ...
  COMPONENT FCS_MPC_3Phase_SPMSM_IP_Core_dut
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
  ...
  FOR ALL : FCS_MPC_3Phase_SPMSM_IP_Core_reset_sync
    USE ENTITY work.FCS_MPC_3Phase_SPMSM_IP_Core_reset_sync(rtl);

  FOR ALL : FCS_MPC_3Phase_SPMSM_IP_Core_axi_lite
    USE ENTITY work.FCS_MPC_3Phase_SPMSM_IP_Core_axi_lite(rtl);

  FOR ALL : FCS_MPC_3Phase_SPMSM_IP_Core_dut
    USE ENTITY work.FCS_MPC_3Phase_SPMSM_IP_Core_dut(rtl);
  ...
  SIGNAL write_Ld_AXI                     : std_logic_vector(23 DOWNTO 0);  -- ufix24
  SIGNAL write_Lq_AXI                     : std_logic_vector(23 DOWNTO 0);  -- ufix24
...
BEGIN
  u_FCS_MPC_3Phase_SPMSM_IP_Core_reset_sync_inst : FCS_MPC_3Phase_SPMSM_IP_Core_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_FCS_MPC_3Phase_SPMSM_IP_Core_axi_lite_inst : FCS_MPC_3Phase_SPMSM_IP_Core_axi_lite
    PORT MAP( reset => reset,
              ...
              write_Ld_AXI => write_Ld_AXI,  -- sfix24_En20
              write_Lq_AXI => write_Lq_AXI,  -- sfix24_En20
              write_psiPM_AXI => write_psiPM_AXI,  -- sfix18_En11
              write_pole_pairs_AXI => write_pole_pairs_AXI,  -- sfix32
              reset_internal => reset_internal  -- ufix1
              );

  u_FCS_MPC_3Phase_SPMSM_IP_Core_dut_inst : FCS_MPC_3Phase_SPMSM_IP_Core_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              ...
              Ld_AXI => write_Ld_AXI,  -- sfix24_En20
              Lq_AXI => write_Lq_AXI,  -- sfix24_En20
  ...
  ip_timestamp <= unsigned'(X"83810699");
