-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\IP_Core_SS_Switch_and_PWM\PWM_and_SS_control_V2_ip_src_GenPWM.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: PWM_and_SS_control_V2_ip_src_GenPWM
...
ENTITY PWM_and_SS_control_V2_ip_src_GenPWM IS
  PORT( clk                               :   IN    std_logic;
        reset                             :   IN    std_logic;
        enb                               :   IN    std_logic;
        PWM_en_AXI                        :   IN    std_logic;
        f_carrier_kHz_AXI                 :   IN    std_logic_vector(7 DOWNTO 0);  -- uint8
        T_carrier_us_AXI                  :   IN    std_logic_vector(7 DOWNTO 0);  -- uint8
        ...
        T_carrier_us_rd_AXI               :   OUT   std_logic_vector(7 DOWNTO 0);  -- uint8
        min_pulse_width_rd_AXI            :   OUT   std_logic_vector(7 DOWNTO 0);  -- uint8
        enb_out                           :   OUT   std_logic;
        Period_Center                     :   OUT   std_logic
        );
END PWM_and_SS_control_V2_ip_src_GenPWM;


ARCHITECTURE rtl OF PWM_and_SS_control_V2_ip_src_GenPWM IS

  -- Component Declarations
  COMPONENT PWM_and_SS_control_V2_ip_src_Counter_Ctrl
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT PWM_and_SS_control_V2_ip_src_LimitPulseWidth
  ...
  COMPONENT PWM_and_SS_control_V2_ip_src_LimitPulseWidth1
    PORT( ref_sig                         :   IN    std_logic_vector(13 DOWNTO 0);  -- sfix14_En12
          min_pulse_width                 :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En10
          ref_sig_limit                   :   OUT   std_logic_vector(17 DOWNTO 0)  -- ufix18_En10
          );
  ...
  COMPONENT PWM_and_SS_control_V2_ip_src_LimitPulseWidth2
    PORT( ref_sig                         :   IN    std_logic_vector(13 DOWNTO 0);  -- sfix14_En12
          min_pulse_width                 :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En10
          ref_sig_limit                   :   OUT   std_logic_vector(17 DOWNTO 0)  -- ufix18_En10
          );
  ...
  FOR ALL : PWM_and_SS_control_V2_ip_src_Counter_Ctrl
    USE ENTITY work.PWM_and_SS_control_V2_ip_src_Counter_Ctrl(rtl);

  FOR ALL : PWM_and_SS_control_V2_ip_src_LimitPulseWidth
    USE ENTITY work.PWM_and_SS_control_V2_ip_src_LimitPulseWidth(rtl);

  FOR ALL : PWM_and_SS_control_V2_ip_src_LimitPulseWidth1
    USE ENTITY work.PWM_and_SS_control_V2_ip_src_LimitPulseWidth1(rtl);

  FOR ALL : PWM_and_SS_control_V2_ip_src_LimitPulseWidth2
    USE ENTITY work.PWM_and_SS_control_V2_ip_src_LimitPulseWidth2(rtl);
  ...
  SIGNAL T_carrier_us_AXI_unsigned        : unsigned(7 DOWNTO 0);  -- uint8
  SIGNAL T_carrier_us_AXI_1               : unsigned(7 DOWNTO 0);  -- uint8
  ...
  SIGNAL Gain1_mul_temp                   : unsigned(15 DOWNTO 0);  -- ufix16_En14
  ...
  SIGNAL f_carrier_kHz_AXI_2              : unsigned(7 DOWNTO 0);  -- uint8
  SIGNAL T_carrier_us_AXI_2               : unsigned(7 DOWNTO 0);  -- uint8
  SIGNAL min_pulse_width_AXI_2            : unsigned(7 DOWNTO 0);  -- uint8
...
BEGIN
  u_Counter_Ctrl : PWM_and_SS_control_V2_ip_src_Counter_Ctrl
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              hdl_cnt => std_logic_vector(HDL_Counter2_out1),  -- ufix20
              f_carrier_kHz => std_logic_vector(f_carrier_kHz_AXI_1),  -- uint8
              T_carrier_us => std_logic_vector(T_carrier_us_AXI_1),  -- uint8
              dir_ctrl => Counter_Ctrl_out1,
              triangle_sig => Counter_Ctrl_out2,  -- ufix18_En10
              Period_Center => Counter_Ctrl_out3
              );

  u_LimitPulseWidth : PWM_and_SS_control_V2_ip_src_LimitPulseWidth
    PORT MAP( ref_sig => std_logic_vector(Switch_out1),  -- sfix14_En12
              min_pulse_width => std_logic_vector(Gain1_out1),  -- sfix18_En10
              ref_sig_limit => LimitPulseWidth_out1  -- ufix18_En10
              );

  u_LimitPulseWidth1 : PWM_and_SS_control_V2_ip_src_LimitPulseWidth1
    PORT MAP( ref_sig => std_logic_vector(Switch1_out1),  -- sfix14_En12
              min_pulse_width => std_logic_vector(Gain1_out1),  -- sfix18_En10
              ref_sig_limit => LimitPulseWidth1_out1  -- ufix18_En10
              );

  u_LimitPulseWidth2 : PWM_and_SS_control_V2_ip_src_LimitPulseWidth2
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        T_carrier_us_AXI_1 <= to_unsigned(16#00#, 8);
      ELSIF enb = '1' THEN
  ...
  -- CSD Encoding (164) : 010100100; Cost (Adders) = 2
  Gain1_mul_temp <= (resize(min_pulse_width_AXI_1 & '0' & '0' & '0' & '0' & '0' & '0' & '0', 16) + resize(min_pulse_width_AXI_1 & '0' & '0' & '0' & '0' & '0', 16)) + resize(min_pulse_width_AXI_1 & '0' & '0', 16);
  Gain1_out1 <= signed(resize(Gain1_mul_temp(15 DOWNTO 4), 18));
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        f_carrier_kHz_AXI_2 <= to_unsigned(16#00#, 8);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        T_carrier_us_AXI_2 <= to_unsigned(16#00#, 8);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        min_pulse_width_AXI_2 <= to_unsigned(16#00#, 8);
      ELSIF enb = '1' THEN
  ...
  Period_Center <= Counter_Ctrl_out3_1;
