-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\Philipp\ultrazohm\ultrazohm_sw\ip_cores\uz_pmsm_model_nonlinear\hdl_prj\hdlsrc\uz_pmsm_model_nonlinear\uz_pmsm_model_nonlinear_src_nfp_add_double.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_nonlinear_src_nfp_add_double
-- Source Path: uz_pmsm_model_nonlinear/uz_pmsm_model_nonlinear/nfp_add_double
-- Hierarchy Level: 1
-- 
...
ENTITY uz_pmsm_model_nonlinear_src_nfp_add_double IS
...
END uz_pmsm_model_nonlinear_src_nfp_add_double;


ARCHITECTURE rtl OF uz_pmsm_model_nonlinear_src_nfp_add_double IS
  ...
  SIGNAL Delay42_PS_5_out1                : std_logic;  -- ufix1
  SIGNAL Delay18_PS_7_10_reg              : std_logic_vector(0 TO 1);  -- ufix1 [2]
  SIGNAL Delay18_PS_7_10_reg_next         : std_logic_vector(0 TO 1);  -- ufix1 [2]
  ...
  SIGNAL Delay3_PS_7_out1                 : std_logic;  -- ufix1
  SIGNAL Logical_Operator_out1_1          : std_logic;  -- ufix1
  SIGNAL Delay13_PS_9_out1                : std_logic;  -- ufix1
  SIGNAL Delay1_PS_7_out1                 : unsigned(55 DOWNTO 0);  -- ufix56
  ...
  SIGNAL Delay12_PS_7_out1                : std_logic;  -- ufix1
  ...
  SIGNAL Delay29_PS_5_out1                : std_logic;  -- ufix1
  SIGNAL Delay14_PS_7_10_reg              : std_logic_vector(0 TO 1);  -- ufix1 [2]
  SIGNAL Delay14_PS_7_10_reg_next         : std_logic_vector(0 TO 1);  -- ufix1 [2]
  SIGNAL Delay14_PS_7_10_out1             : std_logic;  -- ufix1
  SIGNAL alphaaSign_1_bSign_1_out1        : std_logic;  -- ufix1
  SIGNAL Delay9_PS_3_out1                 : std_logic;  -- ufix1
  SIGNAL Delay25_PS_5_out1                : std_logic;  -- ufix1
  SIGNAL Delay13_PS_7_10_reg              : std_logic_vector(0 TO 1);  -- ufix1 [2]
  SIGNAL Delay13_PS_7_10_reg_next         : std_logic_vector(0 TO 1);  -- ufix1 [2]
  ...
  SIGNAL Delay32_PS_3_out1                : unsigned(10 DOWNTO 0);  -- ufix11
  SIGNAL Delay34_PS_5_out1                : unsigned(10 DOWNTO 0);  -- ufix11
  SIGNAL Delay15_PS_7_10_reg              : vector_of_unsigned11(0 TO 1);  -- ufix11 [2]
  SIGNAL Delay15_PS_7_10_reg_next         : vector_of_unsigned11(0 TO 1);  -- ufix11 [2]
  ...
  SIGNAL Delay38_PS_5_out1                : unsigned(51 DOWNTO 0);  -- ufix52
  SIGNAL Delay17_PS_7_10_reg              : vector_of_unsigned52(0 TO 1);  -- ufix52 [2]
  SIGNAL Delay17_PS_7_10_reg_next         : vector_of_unsigned52(0 TO 1);  -- ufix52 [2]
...
BEGIN
  ...
  if_bitconcat_aExponent_aMantiss_out1 <= Delay4_PS_1_out1 WHEN Logical_Operator1_out1 = '0' ELSE
      Delay1_PS_1_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay11_PS_3_out1 <= '0';
      ELSIF enb = '1' THEN
        Delay11_PS_3_out1 <= aExponent_cfType_Exponent_I_out1;
      END IF;
    END IF;
  END PROCESS Delay11_PS_3_process;


  Delay42_PS_5_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay42_PS_5_out1 <= '0';
      ELSIF enb = '1' THEN
        Delay42_PS_5_out1 <= Delay11_PS_3_out1;
      END IF;
    END IF;
  END PROCESS Delay42_PS_5_process;


  Delay18_PS_7_10_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
  ...
  Delay18_PS_7_10_out1 <= Delay18_PS_7_10_reg(1);
  Delay18_PS_7_10_reg_next(0) <= Delay42_PS_5_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay4_PS_5_out1 <= Delay1_PS_3_out1;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay2_PS_7_out1 <= to_unsigned(16#000#, 11);
      ELSIF enb = '1' THEN
        Delay2_PS_7_out1 <= Delay4_PS_5_out1;
      END IF;
    END IF;
  ...
  exp_norm_cfType_Exponent_In_out1 <= '1' WHEN Delay2_PS_7_out1 = to_unsigned(16#7FE#, 11) ELSE
      '0';
  ...
  if_bitconcat_aExponent_aMantiss_1_out1 <= Delay5_PS_1_out1 WHEN Logical_Operator1_out1 = '0' ELSE
      Delay2_PS_1_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay1_PS_5_out1 <= to_signed(0, 57);
      ELSIF enb = '1' THEN
        Delay1_PS_5_out1 <= Delay2_PS_3_out1;
      END IF;
    END IF;
  ...
  if_bitconcat_aExponent_aMantiss_2_out1 <= Delay3_PS_1_out1 WHEN Logical_Operator1_out1 = '0' ELSE
      Delay_PS_1_out1;

  
  if_bitconcat_aExponent_aMantiss_5_out1 <= Delay_PS_1_out1 WHEN Logical_Operator1_out1 = '0' ELSE
      Delay3_PS_1_out1;
  ...
  if_bitconcat_aExponent_aMantiss_3_out1 <= Delay1_PS_1_out1 WHEN Logical_Operator1_out1 = '0' ELSE
      Delay4_PS_1_out1;
  ...
  if_bitconcat_aExponent_aMantiss_4_out1 <= Delay2_PS_1_out1 WHEN Logical_Operator1_out1 = '0' ELSE
      Delay5_PS_1_out1;
  ...
  Delay2_PS_3_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
  ...
  Delay1_PS_3_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay3_PS_7_out1 <= '0';
      ELSIF enb = '1' THEN
        Delay3_PS_7_out1 <= BitSlice_out1;
      END IF;
    END IF;
  END PROCESS Delay3_PS_7_process;


  Logical_Operator_out1_1 <= exp_norm_cfType_Exponent_In_out1 AND Delay3_PS_7_out1;

  Delay13_PS_9_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay13_PS_9_out1 <= '0';
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay1_PS_7_out1 <= to_unsigned(0, 56);
      ELSIF enb = '1' THEN
        Delay1_PS_7_out1 <= mant_a_ext_mant_b_shifted_out1;
      END IF;
    END IF;
  ...
  bitsll_Sum_shift_length_out1 <= Delay1_PS_7_out1 sll to_integer(if_shift_length_exp_a_cor_1_out1);

  bitsrl_Sum_1_out1 <= Delay1_PS_7_out1 srl 1;

  
  if_bitget_Sum_Sum_WordLength_out1 <= bitsll_Sum_shift_length_out1 WHEN Delay3_PS_7_out1 = '0' ELSE
      bitsrl_Sum_1_out1;

  Delay15_PS_9_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
  ...
  Delay1_PS_5_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay12_PS_7_out1 <= '0';
      ELSIF enb = '1' THEN
        Delay12_PS_7_out1 <= Delay1_PS_5_out1_1;
      END IF;
    END IF;
  ...
  sticky_bitget_Sum_1_out1 <= BitSlice1_out1 OR Delay1_PS_5_out1_1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay4_PS_7_out1 <= '0';
      ELSIF enb = '1' THEN
        Delay4_PS_7_out1 <= sticky_bitget_Sum_1_out1;
      END IF;
    END IF;
  ...
  if_bitget_Sum_Sum_WordLength_2_out1 <= Delay12_PS_7_out1 WHEN Delay3_PS_7_out1 = '0' ELSE
      Delay4_PS_7_out1;
  ...
  Delay19_PS_9_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay19_PS_9_out1 <= '0';
  ...
  Sum_0_out1 <= '1' WHEN Delay1_PS_7_out1 = to_unsigned(0, 56) ELSE
      '0';
  ...
  BitSlice2_out1_1 <= Delay1_PS_7_out1(54);
  ...
  exp_a_cor_1_out1_1 <= C_out1_2 + Delay2_PS_7_out1;

  
  if_bitget_Sum_Sum_WordLength_1_out1_1 <= if_bitget_Sum_Sum_WordLength_1_out1 WHEN Delay3_PS_7_out1 = '0' ELSE
      exp_a_cor_1_out1_1;

  Delay14_PS_9_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay12_PS_3_out1 <= '0';
      ELSIF enb = '1' THEN
        Delay12_PS_3_out1 <= if_bitconcat_aExponent_aMantiss_2_out1;
      END IF;
    END IF;
  END PROCESS Delay12_PS_3_process;


  Delay29_PS_5_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay29_PS_5_out1 <= '0';
      ELSIF enb = '1' THEN
        Delay29_PS_5_out1 <= Delay12_PS_3_out1;
      END IF;
    END IF;
  END PROCESS Delay29_PS_5_process;


  Delay14_PS_7_10_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
  ...
  Delay14_PS_7_10_out1 <= Delay14_PS_7_10_reg(1);
  Delay14_PS_7_10_reg_next(0) <= Delay29_PS_5_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay9_PS_3_out1 <= '0';
      ELSIF enb = '1' THEN
        Delay9_PS_3_out1 <= alphaaSign_1_bSign_1_out1;
      END IF;
    END IF;
  END PROCESS Delay9_PS_3_process;


  Delay25_PS_5_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay25_PS_5_out1 <= '0';
      ELSIF enb = '1' THEN
        Delay25_PS_5_out1 <= Delay9_PS_3_out1;
      END IF;
    END IF;
  END PROCESS Delay25_PS_5_process;


  Delay13_PS_7_10_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
  ...
  Delay13_PS_7_10_out1 <= Delay13_PS_7_10_reg(1);
  Delay13_PS_7_10_reg_next(0) <= Delay25_PS_5_out1;
  ...
  Delay6_PS_11_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay6_PS_11_out1 <= '0';
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay32_PS_3_out1 <= to_unsigned(16#000#, 11);
      ELSIF enb = '1' THEN
        Delay32_PS_3_out1 <= if_bitconcat_aExponent_aMantiss_out1;
      END IF;
    END IF;
  END PROCESS Delay32_PS_3_process;


  Delay34_PS_5_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay34_PS_5_out1 <= to_unsigned(16#000#, 11);
      ELSIF enb = '1' THEN
        Delay34_PS_5_out1 <= Delay32_PS_3_out1;
      END IF;
    END IF;
  END PROCESS Delay34_PS_5_process;


  Delay15_PS_7_10_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
  ...
  Delay15_PS_7_10_out1 <= Delay15_PS_7_10_reg(1);
  Delay15_PS_7_10_reg_next(0) <= Delay34_PS_5_out1;
  ...
  Delay7_PS_11_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
  ...
  Delay2_PS_3_2_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
  ...
  Delay38_PS_5_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay38_PS_5_out1 <= to_unsigned(0, 52);
      ELSIF enb = '1' THEN
        Delay38_PS_5_out1 <= Delay2_PS_3_out1_2;
      END IF;
    END IF;
  END PROCESS Delay38_PS_5_process;


  Delay17_PS_7_10_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
  ...
  Delay17_PS_7_10_out1 <= Delay17_PS_7_10_reg(1);
  Delay17_PS_7_10_reg_next(0) <= Delay38_PS_5_out1;
  ...
  Delay8_PS_11_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
