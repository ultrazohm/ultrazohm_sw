...
ENTITY uz_dac_spi_interface_src_uz_dac_spi_interface IS
  PORT( clk                               :   IN    std_logic;
        ...
        dac_data_1_pl                     :   IN    std_logic_vector(15 DOWNTO 0);  -- int16
        dac_data_2_pl                     :   IN    std_logic_vector(15 DOWNTO 0);  -- int16
        dac_data_3_pl                     :   IN    std_logic_vector(15 DOWNTO 0);  -- int16
        dac_data_4_pl                     :   IN    std_logic_vector(15 DOWNTO 0);  -- int16
        dac_data_5_pl                     :   IN    std_logic_vector(15 DOWNTO 0);  -- int16
        dac_data_6_pl                     :   IN    std_logic_vector(15 DOWNTO 0);  -- int16
        dac_data_7_pl                     :   IN    std_logic_vector(15 DOWNTO 0);  -- int16
        dac_data_8_pl                     :   IN    std_logic_vector(15 DOWNTO 0);  -- int16
        trigger_write_pl                  :   IN    std_logic;
        use_input_from_axi                :   IN    std_logic;
        reset_value                       :   IN    std_logic_vector(15 DOWNTO 0);  -- int16
        reset_dac_output                  :   IN    std_logic;
        reset_dac_output_pl               :   IN    std_logic;
...
ARCHITECTURE rtl OF uz_dac_spi_interface_src_uz_dac_spi_interface IS
  ...
  COMPONENT uz_dac_spi_interface_src_Detect_Rise_Positive1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  COMPONENT uz_dac_spi_interface_src_keep_high
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT uz_dac_spi_interface_src_Detect_Rise_Positive2
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic_vector(15 DOWNTO 0);  -- int16
  ...
  COMPONENT uz_dac_spi_interface_src_shadow_register
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT uz_dac_spi_interface_src_shadow_register1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic_vector(15 DOWNTO 0);  -- int16
  ...
  COMPONENT uz_dac_spi_interface_src_shadow_register2
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic_vector(15 DOWNTO 0);  -- int16
  ...
  COMPONENT uz_dac_spi_interface_src_shadow_register3
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic_vector(15 DOWNTO 0);  -- int16
  ...
  COMPONENT uz_dac_spi_interface_src_shadow_register4
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic_vector(15 DOWNTO 0);  -- int16
  ...
  COMPONENT uz_dac_spi_interface_src_shadow_register5
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic_vector(15 DOWNTO 0);  -- int16
  ...
  COMPONENT uz_dac_spi_interface_src_shadow_register6
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic_vector(15 DOWNTO 0);  -- int16
  ...
  COMPONENT uz_dac_spi_interface_src_shadow_register7
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic_vector(15 DOWNTO 0);  -- int16
  ...
  FOR ALL : uz_dac_spi_interface_src_Detect_Rise_Positive1
    USE ENTITY work.uz_dac_spi_interface_src_Detect_Rise_Positive1(rtl);

  FOR ALL : uz_dac_spi_interface_src_keep_high
    USE ENTITY work.uz_dac_spi_interface_src_keep_high(rtl);

  FOR ALL : uz_dac_spi_interface_src_Detect_Rise_Positive
    USE ENTITY work.uz_dac_spi_interface_src_Detect_Rise_Positive(rtl);

  FOR ALL : uz_dac_spi_interface_src_Detect_Rise_Positive2
    USE ENTITY work.uz_dac_spi_interface_src_Detect_Rise_Positive2(rtl);

  FOR ALL : uz_dac_spi_interface_src_shadow_register
    USE ENTITY work.uz_dac_spi_interface_src_shadow_register(rtl);

  FOR ALL : uz_dac_spi_interface_src_Subsystem
    USE ENTITY work.uz_dac_spi_interface_src_Subsystem(rtl);

  FOR ALL : uz_dac_spi_interface_src_shadow_register1
    USE ENTITY work.uz_dac_spi_interface_src_shadow_register1(rtl);

  FOR ALL : uz_dac_spi_interface_src_Subsystem1
    USE ENTITY work.uz_dac_spi_interface_src_Subsystem1(rtl);

  FOR ALL : uz_dac_spi_interface_src_shadow_register2
    USE ENTITY work.uz_dac_spi_interface_src_shadow_register2(rtl);

  FOR ALL : uz_dac_spi_interface_src_Subsystem2
    USE ENTITY work.uz_dac_spi_interface_src_Subsystem2(rtl);

  FOR ALL : uz_dac_spi_interface_src_shadow_register3
    USE ENTITY work.uz_dac_spi_interface_src_shadow_register3(rtl);

  FOR ALL : uz_dac_spi_interface_src_Subsystem3
    USE ENTITY work.uz_dac_spi_interface_src_Subsystem3(rtl);

  FOR ALL : uz_dac_spi_interface_src_shadow_register4
    USE ENTITY work.uz_dac_spi_interface_src_shadow_register4(rtl);

  FOR ALL : uz_dac_spi_interface_src_Subsystem4
    USE ENTITY work.uz_dac_spi_interface_src_Subsystem4(rtl);

  FOR ALL : uz_dac_spi_interface_src_shadow_register5
    USE ENTITY work.uz_dac_spi_interface_src_shadow_register5(rtl);

  FOR ALL : uz_dac_spi_interface_src_Subsystem5
    USE ENTITY work.uz_dac_spi_interface_src_Subsystem5(rtl);

  FOR ALL : uz_dac_spi_interface_src_shadow_register6
    USE ENTITY work.uz_dac_spi_interface_src_shadow_register6(rtl);

  FOR ALL : uz_dac_spi_interface_src_Subsystem6
    USE ENTITY work.uz_dac_spi_interface_src_Subsystem6(rtl);

  FOR ALL : uz_dac_spi_interface_src_shadow_register7
    USE ENTITY work.uz_dac_spi_interface_src_shadow_register7(rtl);
  ...
  SIGNAL Rate_Transition11_out1           : std_logic;
  SIGNAL keep_high_out1                   : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL keep_high_out1_signed            : signed(15 DOWNTO 0);  -- int16
  SIGNAL Delay25_out1                     : signed(15 DOWNTO 0);  -- int16
  SIGNAL Rate_Transition2_bypass_reg      : signed(15 DOWNTO 0);  -- sfix16
  SIGNAL Rate_Transition2_out1            : signed(15 DOWNTO 0);  -- int16
  ...
  SIGNAL dac_data_1_pl_signed             : signed(15 DOWNTO 0);  -- int16
  ...
  SIGNAL reset_value_signed               : signed(15 DOWNTO 0);  -- int16
  SIGNAL Delay13_out1                     : signed(15 DOWNTO 0);  -- int16
  SIGNAL Switch9_out1                     : signed(15 DOWNTO 0);  -- int16
  SIGNAL Detect_Rise_Positive2_out1       : std_logic;
  SIGNAL shadow_register_out1             : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL shadow_register_out1_signed      : signed(15 DOWNTO 0);  -- int16
  ...
  SIGNAL dac_data_2_pl_signed             : signed(15 DOWNTO 0);  -- int16
  SIGNAL Delay2_out1                      : signed(15 DOWNTO 0);  -- int16
  SIGNAL dac_data_2_signed                : signed(15 DOWNTO 0);  -- int16
  SIGNAL Delay19_out1                     : signed(15 DOWNTO 0);  -- int16
  SIGNAL Switch1_out1                     : signed(15 DOWNTO 0);  -- int16
  SIGNAL Switch10_out1                    : signed(15 DOWNTO 0);  -- int16
  SIGNAL shadow_register1_out1            : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL shadow_register1_out1_signed     : signed(15 DOWNTO 0);  -- int16
  ...
  SIGNAL dac_data_3_pl_signed             : signed(15 DOWNTO 0);  -- int16
  SIGNAL Delay3_out1                      : signed(15 DOWNTO 0);  -- int16
  SIGNAL dac_data_3_signed                : signed(15 DOWNTO 0);  -- int16
  SIGNAL Delay18_out1                     : signed(15 DOWNTO 0);  -- int16
  SIGNAL Switch2_out1                     : signed(15 DOWNTO 0);  -- int16
  SIGNAL Switch11_out1                    : signed(15 DOWNTO 0);  -- int16
  SIGNAL shadow_register2_out1            : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL shadow_register2_out1_signed     : signed(15 DOWNTO 0);  -- int16
  ...
  SIGNAL dac_data_4_pl_signed             : signed(15 DOWNTO 0);  -- int16
  SIGNAL Delay4_out1                      : signed(15 DOWNTO 0);  -- int16
  SIGNAL dac_data_4_signed                : signed(15 DOWNTO 0);  -- int16
  SIGNAL Delay20_out1                     : signed(15 DOWNTO 0);  -- int16
  SIGNAL Switch3_out1                     : signed(15 DOWNTO 0);  -- int16
  SIGNAL Switch12_out1                    : signed(15 DOWNTO 0);  -- int16
  SIGNAL shadow_register3_out1            : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL shadow_register3_out1_signed     : signed(15 DOWNTO 0);  -- int16
  ...
  SIGNAL dac_data_5_pl_signed             : signed(15 DOWNTO 0);  -- int16
  SIGNAL Delay5_out1                      : signed(15 DOWNTO 0);  -- int16
  SIGNAL dac_data_5_signed                : signed(15 DOWNTO 0);  -- int16
  SIGNAL Delay21_out1                     : signed(15 DOWNTO 0);  -- int16
  SIGNAL Switch4_out1                     : signed(15 DOWNTO 0);  -- int16
  SIGNAL Switch13_out1                    : signed(15 DOWNTO 0);  -- int16
  SIGNAL shadow_register4_out1            : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL shadow_register4_out1_signed     : signed(15 DOWNTO 0);  -- int16
  ...
  SIGNAL dac_data_6_pl_signed             : signed(15 DOWNTO 0);  -- int16
  SIGNAL Delay6_out1                      : signed(15 DOWNTO 0);  -- int16
  SIGNAL dac_data_6_signed                : signed(15 DOWNTO 0);  -- int16
  SIGNAL Delay22_out1                     : signed(15 DOWNTO 0);  -- int16
  SIGNAL Switch5_out1                     : signed(15 DOWNTO 0);  -- int16
  SIGNAL Switch14_out1                    : signed(15 DOWNTO 0);  -- int16
  SIGNAL shadow_register5_out1            : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL shadow_register5_out1_signed     : signed(15 DOWNTO 0);  -- int16
  ...
  SIGNAL dac_data_7_pl_signed             : signed(15 DOWNTO 0);  -- int16
  SIGNAL Delay7_out1                      : signed(15 DOWNTO 0);  -- int16
  SIGNAL dac_data_7_signed                : signed(15 DOWNTO 0);  -- int16
  SIGNAL Delay23_out1                     : signed(15 DOWNTO 0);  -- int16
  SIGNAL Switch6_out1                     : signed(15 DOWNTO 0);  -- int16
  SIGNAL Switch15_out1                    : signed(15 DOWNTO 0);  -- int16
  SIGNAL shadow_register6_out1            : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL shadow_register6_out1_signed     : signed(15 DOWNTO 0);  -- int16
  ...
  SIGNAL dac_data_8_pl_signed             : signed(15 DOWNTO 0);  -- int16
  ...
  SIGNAL Switch7_out1                     : signed(15 DOWNTO 0);  -- int16
  SIGNAL Switch16_out1                    : signed(15 DOWNTO 0);  -- int16
  SIGNAL shadow_register7_out1            : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL shadow_register7_out1_signed     : signed(15 DOWNTO 0);  -- int16
...
BEGIN
  ...
  u_Detect_Rise_Positive1 : uz_dac_spi_interface_src_Detect_Rise_Positive1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              U => Switch8_out1,
  ...
  u_keep_high : uz_dac_spi_interface_src_keep_high
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              trigger => Detect_Rise_Positive1_out1,
              reset => Rate_Transition11_out1,
              Out1 => keep_high_out1  -- int16
              );
  ...
  u_Detect_Rise_Positive : uz_dac_spi_interface_src_Detect_Rise_Positive
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_32_0 => enb_1_32_0,
              U => std_logic_vector(Rate_Transition2_out1),  -- int16
              Y => Detect_Rise_Positive_out1
              );

  u_Detect_Rise_Positive2 : uz_dac_spi_interface_src_Detect_Rise_Positive2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              U => keep_high_out1,  -- int16
              Y => Detect_Rise_Positive2_out1
              );

  u_shadow_register : uz_dac_spi_interface_src_shadow_register
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              In_rsvd => std_logic_vector(Switch9_out1),  -- int16
              trigger => Detect_Rise_Positive2_out1,
              Out1 => shadow_register_out1  -- int16
              );
  ...
  u_shadow_register1 : uz_dac_spi_interface_src_shadow_register1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              In_rsvd => std_logic_vector(Switch10_out1),  -- int16
              trigger => Detect_Rise_Positive2_out1,
              Out1 => shadow_register1_out1  -- int16
              );
  ...
  u_shadow_register2 : uz_dac_spi_interface_src_shadow_register2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              In_rsvd => std_logic_vector(Switch11_out1),  -- int16
              trigger => Detect_Rise_Positive2_out1,
              Out1 => shadow_register2_out1  -- int16
              );
  ...
  u_shadow_register3 : uz_dac_spi_interface_src_shadow_register3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              In_rsvd => std_logic_vector(Switch12_out1),  -- int16
              trigger => Detect_Rise_Positive2_out1,
              Out1 => shadow_register3_out1  -- int16
              );
  ...
  u_shadow_register4 : uz_dac_spi_interface_src_shadow_register4
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              In_rsvd => std_logic_vector(Switch13_out1),  -- int16
              trigger => Detect_Rise_Positive2_out1,
              Out1 => shadow_register4_out1  -- int16
              );
  ...
  u_shadow_register5 : uz_dac_spi_interface_src_shadow_register5
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              In_rsvd => std_logic_vector(Switch14_out1),  -- int16
              trigger => Detect_Rise_Positive2_out1,
              Out1 => shadow_register5_out1  -- int16
              );
  ...
  u_shadow_register6 : uz_dac_spi_interface_src_shadow_register6
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              In_rsvd => std_logic_vector(Switch15_out1),  -- int16
              trigger => Detect_Rise_Positive2_out1,
              Out1 => shadow_register6_out1  -- int16
              );
  ...
  u_shadow_register7 : uz_dac_spi_interface_src_shadow_register7
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              In_rsvd => std_logic_vector(Switch16_out1),  -- int16
              trigger => Detect_Rise_Positive2_out1,
              Out1 => shadow_register7_out1  -- int16
              );
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay15_out1 <= '0';
      ELSIF enb = '1' THEN
        Delay15_out1 <= use_input_from_axi;
      END IF;
    END IF;
  ...
  Switch8_out1 <= Delay9_out1 WHEN Delay15_out1 = '0' ELSE
      Delay14_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Rate_Transition11_out1 <= '0';
      ELSIF enb_1_32_0 = '1' THEN
        Rate_Transition11_out1 <= Detect_Rise_Positive_out1;
      END IF;
    END IF;
  END PROCESS Rate_Transition11_process;


  keep_high_out1_signed <= signed(keep_high_out1);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay25_out1 <= keep_high_out1_signed;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Rate_Transition2_bypass_reg <= to_signed(16#0000#, 16);
      ELSIF enb_1_32_1 = '1' THEN
        Rate_Transition2_bypass_reg <= Delay25_out1;
      END IF;
    END IF;
  END PROCESS Rate_Transition2_bypass_process;

  
  Rate_Transition2_out1 <= Delay25_out1 WHEN enb_1_32_1 = '1' ELSE
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay10_out1 <= '0';
      ELSIF enb = '1' THEN
        Delay10_out1 <= reset_dac_output_pl;
      END IF;
    END IF;
  END PROCESS Delay10_process;


  OR1_out1 <= Delay12_out1 OR Delay10_out1;

  dac_data_1_pl_signed <= signed(dac_data_1_pl);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay1_out1 <= dac_data_1_pl_signed;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay17_out1 <= dac_data_1_signed;
      END IF;
    END IF;
  ...
  Switch_out1 <= Delay1_out1 WHEN Delay15_out1 = '0' ELSE
      Delay17_out1;

  reset_value_signed <= signed(reset_value);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay13_out1 <= reset_value_signed;
      END IF;
    END IF;
  ...
  Switch9_out1 <= Switch_out1 WHEN OR1_out1 = '0' ELSE
      Delay13_out1;

  shadow_register_out1_signed <= signed(shadow_register_out1);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_32_1 = '1' THEN
        Rate_Transition1_bypass_reg <= shadow_register_out1_signed;
      END IF;
    END IF;
  END PROCESS Rate_Transition1_bypass_process;

  
  Rate_Transition1_out1 <= shadow_register_out1_signed WHEN enb_1_32_1 = '1' ELSE
  ...
  switch_compare_1 <= '1' WHEN Delay15_out1 > '0' ELSE
      '0';

  dac_data_2_pl_signed <= signed(dac_data_2_pl);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay2_out1 <= dac_data_2_pl_signed;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay19_out1 <= dac_data_2_signed;
      END IF;
    END IF;
  ...
  Switch10_out1 <= Switch1_out1 WHEN OR1_out1 = '0' ELSE
      Delay13_out1;

  shadow_register1_out1_signed <= signed(shadow_register1_out1);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_32_1 = '1' THEN
        Rate_Transition3_bypass_reg <= shadow_register1_out1_signed;
      END IF;
    END IF;
  END PROCESS Rate_Transition3_bypass_process;

  
  Rate_Transition3_out1 <= shadow_register1_out1_signed WHEN enb_1_32_1 = '1' ELSE
  ...
  switch_compare_1_1 <= '1' WHEN Delay15_out1 > '0' ELSE
      '0';

  dac_data_3_pl_signed <= signed(dac_data_3_pl);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay3_out1 <= dac_data_3_pl_signed;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay18_out1 <= to_signed(16#0000#, 16);
      ELSIF enb = '1' THEN
        Delay18_out1 <= dac_data_3_signed;
      END IF;
    END IF;
  ...
  Switch2_out1 <= Delay3_out1 WHEN switch_compare_1_1 = '0' ELSE
      Delay18_out1;

  
  Switch11_out1 <= Switch2_out1 WHEN OR1_out1 = '0' ELSE
      Delay13_out1;

  shadow_register2_out1_signed <= signed(shadow_register2_out1);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_32_1 = '1' THEN
        Rate_Transition4_bypass_reg <= shadow_register2_out1_signed;
      END IF;
    END IF;
  END PROCESS Rate_Transition4_bypass_process;

  
  Rate_Transition4_out1 <= shadow_register2_out1_signed WHEN enb_1_32_1 = '1' ELSE
  ...
  switch_compare_1_2 <= '1' WHEN Delay15_out1 > '0' ELSE
      '0';

  dac_data_4_pl_signed <= signed(dac_data_4_pl);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay4_out1 <= dac_data_4_pl_signed;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay20_out1 <= to_signed(16#0000#, 16);
      ELSIF enb = '1' THEN
        Delay20_out1 <= dac_data_4_signed;
      END IF;
    END IF;
  ...
  Switch3_out1 <= Delay4_out1 WHEN switch_compare_1_2 = '0' ELSE
      Delay20_out1;

  
  Switch12_out1 <= Switch3_out1 WHEN OR1_out1 = '0' ELSE
      Delay13_out1;

  shadow_register3_out1_signed <= signed(shadow_register3_out1);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_32_1 = '1' THEN
        Rate_Transition5_bypass_reg <= shadow_register3_out1_signed;
      END IF;
    END IF;
  END PROCESS Rate_Transition5_bypass_process;

  
  Rate_Transition5_out1 <= shadow_register3_out1_signed WHEN enb_1_32_1 = '1' ELSE
  ...
  switch_compare_1_3 <= '1' WHEN Delay15_out1 > '0' ELSE
      '0';

  dac_data_5_pl_signed <= signed(dac_data_5_pl);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay5_out1 <= dac_data_5_pl_signed;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay21_out1 <= to_signed(16#0000#, 16);
      ELSIF enb = '1' THEN
        Delay21_out1 <= dac_data_5_signed;
      END IF;
    END IF;
  ...
  Switch4_out1 <= Delay5_out1 WHEN switch_compare_1_3 = '0' ELSE
      Delay21_out1;

  
  Switch13_out1 <= Switch4_out1 WHEN OR1_out1 = '0' ELSE
      Delay13_out1;

  shadow_register4_out1_signed <= signed(shadow_register4_out1);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_32_1 = '1' THEN
        Rate_Transition6_bypass_reg <= shadow_register4_out1_signed;
      END IF;
    END IF;
  END PROCESS Rate_Transition6_bypass_process;

  
  Rate_Transition6_out1 <= shadow_register4_out1_signed WHEN enb_1_32_1 = '1' ELSE
  ...
  switch_compare_1_4 <= '1' WHEN Delay15_out1 > '0' ELSE
      '0';

  dac_data_6_pl_signed <= signed(dac_data_6_pl);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay6_out1 <= dac_data_6_pl_signed;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay22_out1 <= to_signed(16#0000#, 16);
      ELSIF enb = '1' THEN
        Delay22_out1 <= dac_data_6_signed;
      END IF;
    END IF;
  ...
  Switch5_out1 <= Delay6_out1 WHEN switch_compare_1_4 = '0' ELSE
      Delay22_out1;

  
  Switch14_out1 <= Switch5_out1 WHEN OR1_out1 = '0' ELSE
      Delay13_out1;

  shadow_register5_out1_signed <= signed(shadow_register5_out1);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_32_1 = '1' THEN
        Rate_Transition7_bypass_reg <= shadow_register5_out1_signed;
      END IF;
    END IF;
  END PROCESS Rate_Transition7_bypass_process;

  
  Rate_Transition7_out1 <= shadow_register5_out1_signed WHEN enb_1_32_1 = '1' ELSE
  ...
  switch_compare_1_5 <= '1' WHEN Delay15_out1 > '0' ELSE
      '0';

  dac_data_7_pl_signed <= signed(dac_data_7_pl);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay7_out1 <= dac_data_7_pl_signed;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay23_out1 <= dac_data_7_signed;
      END IF;
    END IF;
  ...
  Switch6_out1 <= Delay7_out1 WHEN switch_compare_1_5 = '0' ELSE
      Delay23_out1;

  
  Switch15_out1 <= Switch6_out1 WHEN OR1_out1 = '0' ELSE
      Delay13_out1;

  shadow_register6_out1_signed <= signed(shadow_register6_out1);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_32_1 = '1' THEN
        Rate_Transition8_bypass_reg <= shadow_register6_out1_signed;
      END IF;
    END IF;
  END PROCESS Rate_Transition8_bypass_process;

  
  Rate_Transition8_out1 <= shadow_register6_out1_signed WHEN enb_1_32_1 = '1' ELSE
  ...
  switch_compare_1_6 <= '1' WHEN Delay15_out1 > '0' ELSE
      '0';

  dac_data_8_pl_signed <= signed(dac_data_8_pl);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay8_out1 <= dac_data_8_pl_signed;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay24_out1 <= dac_data_8_signed;
      END IF;
    END IF;
  ...
  Switch7_out1 <= Delay8_out1 WHEN switch_compare_1_6 = '0' ELSE
      Delay24_out1;

  
  Switch16_out1 <= Switch7_out1 WHEN OR1_out1 = '0' ELSE
      Delay13_out1;

  shadow_register7_out1_signed <= signed(shadow_register7_out1);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_32_1 = '1' THEN
        Rate_Transition9_bypass_reg <= shadow_register7_out1_signed;
      END IF;
    END IF;
  END PROCESS Rate_Transition9_bypass_process;

  
  Rate_Transition9_out1 <= shadow_register7_out1_signed WHEN enb_1_32_1 = '1' ELSE
  ...
  spi_clk_out <= Delay26_out1;

  cs_out <= Delay27_out1;

  data_out_1 <= Delay28_out1;

  data_out_2 <= Delay29_out1;

  data_out_3 <= Delay30_out1;

  data_out_4 <= Delay31_out1;

  data_out_5 <= Delay32_out1;

  data_out_6 <= Delay33_out1;

  data_out_7 <= Delay34_out1;

  data_out_8 <= Delay35_out1;
