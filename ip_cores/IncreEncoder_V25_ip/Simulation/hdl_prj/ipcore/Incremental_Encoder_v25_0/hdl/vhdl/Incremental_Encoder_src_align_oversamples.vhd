-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\inc_enc_v25\Incremental_Encoder_src_align_oversamples.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Incremental_Encoder_src_align_oversamples
-- Source Path: inc_enc_v25/IncEnc_V25/speed/OS_factor_logic/align_oversamples
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Incremental_Encoder_src_align_oversamples IS
...
END Incremental_Encoder_src_align_oversamples;


ARCHITECTURE rtl OF Incremental_Encoder_src_align_oversamples IS
    ...
    IF new_transition(0) = '1' THEN 
      ...
      IF oversampling_factor_unsigned >= to_unsigned(16#00000002#, 16) THEN 
        ...
        ELSE 
          ...
          IF (delay(1) AND hdlcoder_to_stdlogic(resize(states_signed(1), 32) = cast_0)) = '1' THEN 
          ...
          ELSE 
            ...
            IF (delay(2) AND hdlcoder_to_stdlogic(resize(states_signed(2), 32) = cast_1)) = '1' THEN 
            ...
            ELSE 
              ...
              IF (delay(3) AND hdlcoder_to_stdlogic(resize(states_signed(3), 32) = cast_3)) = '1' THEN 
