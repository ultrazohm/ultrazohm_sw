...
#define  IPCore_Timestamp_parallel_8_sim_delay_compensation             0x8  //contains unique IP timestamp (yymmddHHMM): 2211081147
...
#define  id_k_1_AXI_Data_parallel_8_sim_delay_compensation              0x14C  //data register for Outport id_k_1_AXI
#define  iq_k_1_AXI_Data_parallel_8_sim_delay_compensation              0x150  //data register for Outport iq_k_1_AXI
#define  ix_k_1_AXI_Data_parallel_8_sim_delay_compensation              0x154  //data register for Outport ix_k_1_AXI
#define  iy_k_1_AXI_Data_parallel_8_sim_delay_compensation              0x158  //data register for Outport iy_k_1_AXI
