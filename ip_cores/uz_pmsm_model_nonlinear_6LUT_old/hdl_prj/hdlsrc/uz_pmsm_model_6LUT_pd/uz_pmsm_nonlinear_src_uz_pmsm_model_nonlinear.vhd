-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\Philipp\ultrazohm\ultrazohm_sw\ip_cores\uz_pmsm_model_nonlinear_6LUT\hdl_prj\hdlsrc\uz_pmsm_model_6LUT_pd\uz_pmsm_nonlinear_src_uz_pmsm_model_nonlinear.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_nonlinear_src_uz_pmsm_model_nonlinear
-- Source Path: uz_pmsm_model_6LUT_pd/uz_pmsm_model_nonlinear
-- Hierarchy Level: 0
-- Model version: 7.30
-- 
-- -------------------------------------------------------------
...
ENTITY uz_pmsm_nonlinear_src_uz_pmsm_model_nonlinear IS
  PORT( clk                               :   IN    std_logic;
        ...
        fitting_parameters_14             :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_15             :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_16             :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_17             :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_18             :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_19             :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_20             :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_21             :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_22             :   IN    std_logic_vector(31 DOWNTO 0);  -- single
...
END uz_pmsm_nonlinear_src_uz_pmsm_model_nonlinear;


ARCHITECTURE rtl OF uz_pmsm_nonlinear_src_uz_pmsm_model_nonlinear IS

  -- Component Declarations
  COMPONENT uz_pmsm_nonlinear_src_uz_pmsm_model_nonlinear_tc
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          clk_enable                      :   IN    std_logic;
          enb                             :   OUT   std_logic;
  ...
  COMPONENT uz_pmsm_nonlinear_src_nfp_sub_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT uz_pmsm_nonlinear_src_nfp_mul_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          nfp_in1                         :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT uz_pmsm_nonlinear_src_nfp_cosh_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT uz_pmsm_nonlinear_src_nfp_recip_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          nfp_in                          :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT uz_pmsm_nonlinear_src_nfp_tanh_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          nfp_in                          :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT uz_pmsm_nonlinear_src_nfp_add_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          nfp_in1                         :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT uz_pmsm_nonlinear_src_nfp_signum_single
    PORT( nfp_in                          :   IN    std_logic_vector(31 DOWNTO 0);  -- single
          nfp_out                         :   OUT   std_logic_vector(31 DOWNTO 0)  -- single
          );
  END COMPONENT;

  COMPONENT uz_pmsm_nonlinear_src_nfp_abs_single
    PORT( nfp_in                          :   IN    std_logic_vector(31 DOWNTO 0);  -- single
          nfp_out                         :   OUT   std_logic_vector(31 DOWNTO 0)  -- single
          );
  END COMPONENT;

  COMPONENT uz_pmsm_nonlinear_src_nfp_log_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          nfp_in                          :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT uz_pmsm_nonlinear_src_nfp_uminus_single
    PORT( nfp_in                          :   IN    std_logic_vector(31 DOWNTO 0);  -- single
          nfp_out                         :   OUT   std_logic_vector(31 DOWNTO 0)  -- single
          );
  END COMPONENT;

  COMPONENT uz_pmsm_nonlinear_src_nfp_div_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          nfp_in1                         :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  FOR ALL : uz_pmsm_nonlinear_src_uz_pmsm_model_nonlinear_tc
    USE ENTITY work.uz_pmsm_nonlinear_src_uz_pmsm_model_nonlinear_tc(rtl);

  FOR ALL : uz_pmsm_nonlinear_src_nfp_sub_single
    USE ENTITY work.uz_pmsm_nonlinear_src_nfp_sub_single(rtl);

  FOR ALL : uz_pmsm_nonlinear_src_nfp_mul_single
    USE ENTITY work.uz_pmsm_nonlinear_src_nfp_mul_single(rtl);

  FOR ALL : uz_pmsm_nonlinear_src_nfp_cosh_single
    USE ENTITY work.uz_pmsm_nonlinear_src_nfp_cosh_single(rtl);

  FOR ALL : uz_pmsm_nonlinear_src_nfp_recip_single
    USE ENTITY work.uz_pmsm_nonlinear_src_nfp_recip_single(rtl);

  FOR ALL : uz_pmsm_nonlinear_src_nfp_tanh_single
    USE ENTITY work.uz_pmsm_nonlinear_src_nfp_tanh_single(rtl);

  FOR ALL : uz_pmsm_nonlinear_src_nfp_add_single
    USE ENTITY work.uz_pmsm_nonlinear_src_nfp_add_single(rtl);

  FOR ALL : uz_pmsm_nonlinear_src_nfp_signum_single
    USE ENTITY work.uz_pmsm_nonlinear_src_nfp_signum_single(rtl);

  FOR ALL : uz_pmsm_nonlinear_src_nfp_abs_single
    USE ENTITY work.uz_pmsm_nonlinear_src_nfp_abs_single(rtl);

  FOR ALL : uz_pmsm_nonlinear_src_nfp_log_single
    USE ENTITY work.uz_pmsm_nonlinear_src_nfp_log_single(rtl);

  FOR ALL : uz_pmsm_nonlinear_src_nfp_uminus_single
    USE ENTITY work.uz_pmsm_nonlinear_src_nfp_uminus_single(rtl);

  FOR ALL : uz_pmsm_nonlinear_src_nfp_div_single
    USE ENTITY work.uz_pmsm_nonlinear_src_nfp_div_single(rtl);
  ...
  SIGNAL fitting_parameters               : vector_of_std_logic_vector32(0 TO 22);  -- ufix32 [23]
  SIGNAL fitting_parameters_23            : vector_of_std_logic_vector32(0 TO 22);  -- ufix32 [23]
  ...
  SIGNAL fitting_parameters_19_1          : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL aq1_aq2                          : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL fitting_parameters_22_1          : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL aq3_aq6                          : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL aq5                              : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL fitting_parameters_18_1          : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL fitting_parameters_21_1          : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL fitting_parameters_20_1          : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL From1_out1_15                    : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL From1_out1_14                    : std_logic_vector(31 DOWNTO 0);  -- ufix32
...
BEGIN
  u_uz_pmsm_model_nonlinear_tc : uz_pmsm_nonlinear_src_uz_pmsm_model_nonlinear_tc
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_nfp_sub_comp : uz_pmsm_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_cosh_comp : uz_pmsm_nonlinear_src_nfp_cosh_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_1 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_recip_comp : uz_pmsm_nonlinear_src_nfp_recip_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_2 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_1 : uz_pmsm_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  -- mul #1
  u_nfp_mul_comp_3 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  -- mul #2
  u_nfp_mul_comp_4 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_2 : uz_pmsm_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1,  -- single
  ...
  u_nfp_mul_comp_5 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_cosh_comp_1 : uz_pmsm_nonlinear_src_nfp_cosh_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_6 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_recip_comp_1 : uz_pmsm_nonlinear_src_nfp_recip_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_7 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_3 : uz_pmsm_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_recip_comp_2 : uz_pmsm_nonlinear_src_nfp_recip_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_8 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_9 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_10 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1_2,  -- single
  ...
  u_nfp_tanh_comp : uz_pmsm_nonlinear_src_nfp_tanh_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_11 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp : uz_pmsm_nonlinear_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_12 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1_2,  -- single
  ...
  u_nfp_tanh_comp_1 : uz_pmsm_nonlinear_src_nfp_tanh_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_13 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_14 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1_2,  -- single
  ...
  u_nfp_cosh_comp_2 : uz_pmsm_nonlinear_src_nfp_cosh_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_15 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_recip_comp_3 : uz_pmsm_nonlinear_src_nfp_recip_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_16 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp_1 : uz_pmsm_nonlinear_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_4 : uz_pmsm_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  -- mul #1
  u_nfp_mul_comp_17 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  -- mul #2
  u_nfp_mul_comp_18 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_19 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1_2,  -- single
  ...
  u_nfp_cosh_comp_3 : uz_pmsm_nonlinear_src_nfp_cosh_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_20 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_recip_comp_4 : uz_pmsm_nonlinear_src_nfp_recip_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_21 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp_2 : uz_pmsm_nonlinear_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_5 : uz_pmsm_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Sum1_out1_2,  -- single
  ...
  u_nfp_mul_comp_22 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1_2,  -- single
  ...
  u_nfp_signum_comp : uz_pmsm_nonlinear_src_nfp_signum_single
    PORT MAP( nfp_in => Delay1_out1_4,  -- single
              nfp_out => Sign1_out1  -- single
              );

  u_nfp_abs_comp : uz_pmsm_nonlinear_src_nfp_abs_single
    PORT MAP( nfp_in => Delay1_out1_4,  -- single
              nfp_out => Abs_out1  -- single
              );

  u_nfp_mul_comp_23 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => mu,  -- single
  ...
  u_nfp_add_comp_3 : uz_pmsm_nonlinear_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_24 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_6 : uz_pmsm_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1,  -- single
  ...
  u_nfp_mul_comp_25 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_cosh_comp_4 : uz_pmsm_nonlinear_src_nfp_cosh_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_log_comp : uz_pmsm_nonlinear_src_nfp_log_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_26 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_7 : uz_pmsm_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1,  -- single
  ...
  u_nfp_mul_comp_27 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_cosh_comp_5 : uz_pmsm_nonlinear_src_nfp_cosh_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_log_comp_1 : uz_pmsm_nonlinear_src_nfp_log_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_28 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_8 : uz_pmsm_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  -- mul #1
  u_nfp_mul_comp_29 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  -- mul #2
  u_nfp_mul_comp_30 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_9 : uz_pmsm_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_31 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1_2,  -- single
  ...
  u_nfp_mul_comp_32 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => i_d,  -- single
  ...
  u_nfp_mul_comp_33 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_10 : uz_pmsm_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_34 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_35 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => M_Mi,  -- single
  ...
  u_nfp_sub_comp_11 : uz_pmsm_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_12 : uz_pmsm_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_36 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_37 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp_4 : uz_pmsm_nonlinear_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_38 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_39 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1_2,  -- single
  ...
  u_nfp_cosh_comp_6 : uz_pmsm_nonlinear_src_nfp_cosh_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_log_comp_2 : uz_pmsm_nonlinear_src_nfp_log_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_40 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_41 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1_2,  -- single
  ...
  u_nfp_mul_comp_42 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_43 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1_2,  -- single
  ...
  u_nfp_cosh_comp_7 : uz_pmsm_nonlinear_src_nfp_cosh_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_log_comp_3 : uz_pmsm_nonlinear_src_nfp_log_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_44 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp_5 : uz_pmsm_nonlinear_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_13 : uz_pmsm_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  -- mul #1
  u_nfp_mul_comp_45 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  -- mul #2
  u_nfp_mul_comp_46 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_14 : uz_pmsm_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_47 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1,  -- single
  ...
  u_nfp_add_comp_6 : uz_pmsm_nonlinear_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_48 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Switch5_out1,  -- single
  ...
  -- mul #1
  u_nfp_mul_comp_49 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  -- mul #2
  u_nfp_mul_comp_50 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_uminus_comp : uz_pmsm_nonlinear_src_nfp_uminus_single
    PORT MAP( nfp_in => Product20_out1,  -- single
              nfp_out => Lqd_approx  -- single
              );

  u_nfp_mul_comp_51 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_15 : uz_pmsm_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => u_q,  -- single
  ...
  u_nfp_sub_comp_16 : uz_pmsm_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_17 : uz_pmsm_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_div_comp : uz_pmsm_nonlinear_src_nfp_div_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_52 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp_7 : uz_pmsm_nonlinear_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_53 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1_2,  -- single
  ...
  u_nfp_add_comp_8 : uz_pmsm_nonlinear_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_18 : uz_pmsm_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_19 : uz_pmsm_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1,  -- single
  ...
  u_nfp_mul_comp_54 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_tanh_comp_2 : uz_pmsm_nonlinear_src_nfp_tanh_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_55 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_20 : uz_pmsm_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1,  -- single
  ...
  u_nfp_mul_comp_56 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_tanh_comp_3 : uz_pmsm_nonlinear_src_nfp_tanh_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_57 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_21 : uz_pmsm_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  -- mul #1
  u_nfp_mul_comp_58 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  -- mul #2
  u_nfp_mul_comp_59 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_uminus_comp_1 : uz_pmsm_nonlinear_src_nfp_uminus_single
    PORT MAP( nfp_in => psiq_cross_2,  -- single
              nfp_out => Ldq_approx  -- single
              );

  u_nfp_mul_comp_60 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_61 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => R1_1,  -- single
  ...
  u_nfp_sub_comp_22 : uz_pmsm_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => u_d,  -- single
  ...
  u_nfp_sub_comp_23 : uz_pmsm_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp_9 : uz_pmsm_nonlinear_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_62 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_63 : uz_pmsm_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp_10 : uz_pmsm_nonlinear_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  fitting_parameters(14) <= fitting_parameters_14;
  fitting_parameters(15) <= fitting_parameters_15;
  fitting_parameters(16) <= fitting_parameters_16;
  fitting_parameters(17) <= fitting_parameters_17;
  fitting_parameters(18) <= fitting_parameters_18;
  fitting_parameters(19) <= fitting_parameters_19;
  fitting_parameters(20) <= fitting_parameters_20;
  fitting_parameters(21) <= fitting_parameters_21;
  fitting_parameters(22) <= fitting_parameters_22;

  fitting_parameters_23 <= fitting_parameters;

  ad3 <= fitting_parameters_23(2);

  fitting_parameters_1_1 <= fitting_parameters_23(1);
  ...
  fitting_parameters_0_1 <= fitting_parameters_23(0);
  ...
  ad6 <= fitting_parameters_23(5);

  fitting_parameters_4_1 <= fitting_parameters_23(4);
  ...
  fitting_parameters_3_1 <= fitting_parameters_23(3);
  ...
  From2_out1_13 <= fitting_parameters_23(13);
  ...
  aq2 <= fitting_parameters_23(7);

  fitting_parameters_19_1 <= fitting_parameters_23(19);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        aq1_aq2 <= X"00000000";
      ELSIF enb = '1' THEN
        aq1_aq2 <= fitting_parameters_19_1;
      END IF;
    END IF;
  END PROCESS delayMatch19_process;


  fitting_parameters_22_1 <= fitting_parameters_23(22);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        aq3_aq6 <= X"00000000";
      ELSIF enb = '1' THEN
        aq3_aq6 <= fitting_parameters_22_1;
      END IF;
    END IF;
  END PROCESS delayMatch20_process;


  aq5 <= fitting_parameters_23(10);

  fitting_parameters_18_1 <= fitting_parameters_23(18);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        aq4_aq5 <= X"00000000";
      ELSIF enb = '1' THEN
        aq4_aq5 <= fitting_parameters_18_1;
      END IF;
    END IF;
  END PROCESS delayMatch21_process;


  fitting_parameters_12_1 <= fitting_parameters_23(12);
  ...
  fitting_parameters_21_1 <= fitting_parameters_23(21);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        ad1_ad2 <= X"00000000";
      ELSIF enb = '1' THEN
        ad1_ad2 <= fitting_parameters_21_1;
      END IF;
    END IF;
  END PROCESS delayMatch10_process;


  fitting_parameters_1_2 <= fitting_parameters_23(1);
  ...
  ad3_1 <= fitting_parameters_23(2);

  fitting_parameters_20_1 <= fitting_parameters_23(20);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        ad4_ad5 <= X"00000000";
      ELSIF enb = '1' THEN
        ad4_ad5 <= fitting_parameters_20_1;
      END IF;
    END IF;
  END PROCESS delayMatch12_process;


  fitting_parameters_4_2 <= fitting_parameters_23(4);
  ...
  ad6_1 <= fitting_parameters_23(5);

  fitting_parameters_13_1 <= fitting_parameters_23(13);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        alpha1_Fid2_Giq2_1 <= fitting_parameters_13_1;
      END IF;
    END IF;
  ...
  aq2_1 <= fitting_parameters_23(7);

  From1_out1_17 <= fitting_parameters_23(17);
  ...
  From1_out1_8 <= fitting_parameters_23(8);
  ...
  aq5_1 <= fitting_parameters_23(10);

  From1_out1_16 <= fitting_parameters_23(16);
  ...
  From1_out1_11 <= fitting_parameters_23(11);
  ...
  From1_out1_13 <= fitting_parameters_23(13);
  ...
  aq3_1 <= fitting_parameters_23(8);

  aq2_2 <= fitting_parameters_23(7);

  fitting_parameters_6_1 <= fitting_parameters_23(6);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        aq1 <= X"00000000";
      ELSIF enb = '1' THEN
        aq1 <= fitting_parameters_6_1;
      END IF;
    END IF;
  END PROCESS delayMatch5_process;


  aq5_2 <= fitting_parameters_23(10);

  fitting_parameters_9_1 <= fitting_parameters_23(9);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        aq4 <= X"00000000";
      ELSIF enb = '1' THEN
        aq4 <= fitting_parameters_9_1;
      END IF;
    END IF;
  END PROCESS delayMatch6_process;


  aq6_1 <= fitting_parameters_23(11);

  From2_out1_12 <= fitting_parameters_23(12);
  ...
  ad3_2 <= fitting_parameters_23(2);

  From1_out1_1 <= fitting_parameters_23(1);
  ...
  From1_out1_15 <= fitting_parameters_23(15);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ad1_ad2_1 <= From1_out1_15;
      END IF;
    END IF;
  END PROCESS delayMatch16_process;


  ad6_2 <= fitting_parameters_23(5);

  From1_out1_4 <= fitting_parameters_23(4);
  ...
  From1_out1_14 <= fitting_parameters_23(14);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ad4_ad5_1 <= From1_out1_14;
      END IF;
    END IF;
  END PROCESS delayMatch18_process;


  From1_out1_12 <= fitting_parameters_23(12);
  ...
  i_q_4 <= omega_mech WHEN simulate_mechanical_1 = '0' ELSE
      Delay1_out1_4;
