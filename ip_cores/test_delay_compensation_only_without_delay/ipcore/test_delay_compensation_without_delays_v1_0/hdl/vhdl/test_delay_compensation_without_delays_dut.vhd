-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\test_delay_compensation_only_without_delay\hdlsrc\test_delay_compensation_without_delay\test_delay_compensation_without_delays_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: test_delay_compensation_without_delays_dut
-- Source Path: test_delay_compensation_without_delays/test_delay_compensation_without_delays_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY test_delay_compensation_without_delays_dut IS
...
END test_delay_compensation_without_delays_dut;


ARCHITECTURE rtl OF test_delay_compensation_without_delays_dut IS

  -- Component Declarations
  COMPONENT test_delay_compensation_without_delays_src_HDL_DUT
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : test_delay_compensation_without_delays_src_HDL_DUT
    USE ENTITY work.test_delay_compensation_without_delays_src_HDL_DUT(rtl);
...
BEGIN
  u_test_delay_compensation_without_delays_src_HDL_DUT : test_delay_compensation_without_delays_src_HDL_DUT
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
