-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\external_state_machine\cost_opt.vhd
...
ARCHITECTURE rtl OF cost_opt IS

  -- Component Declarations
  COMPONENT cost_opt_reset_sync
  ...
  FOR ALL : cost_opt_reset_sync
    USE ENTITY work.cost_opt_reset_sync(rtl);

  FOR ALL : cost_opt_axi_lite
    USE ENTITY work.cost_opt_axi_lite(rtl);

  FOR ALL : cost_opt_dut
    USE ENTITY work.cost_opt_dut(rtl);
...
BEGIN
  u_cost_opt_reset_sync_inst : cost_opt_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_cost_opt_axi_lite_inst : cost_opt_axi_lite
  ...
  u_cost_opt_dut_inst : cost_opt_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  ip_timestamp <= unsigned'(X"89751260");
