...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        reduced_reg(0) <= id_delay_pu_signed;
        reduced_reg(1) <= reduced_reg(0);
      END IF;
    END IF;
  END PROCESS reduced_process;

  id_delay_pu_1 <= reduced_reg(1);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        reduced_reg_1(0) <= iq_delay_pu_signed;
        reduced_reg_1(1) <= reduced_reg_1(0);
      END IF;
    END IF;
  END PROCESS reduced_1_process;

  iq_delay_pu_1 <= reduced_reg_1(1);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        reduced_reg_2(0) <= ix_delay_pu_signed;
        reduced_reg_2(1) <= reduced_reg_2(0);
      END IF;
    END IF;
  END PROCESS reduced_2_process;

  ix_delay_pu_1 <= reduced_reg_2(1);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        reduced_reg_3(0) <= iy_delay_pu_signed;
        reduced_reg_3(1) <= reduced_reg_3(0);
      END IF;
    END IF;
  END PROCESS reduced_3_process;

  iy_delay_pu_1 <= reduced_reg_3(1);
