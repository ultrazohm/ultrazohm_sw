...
int JavaScope_initalize(DS_Data* data)
{
	...
	js_ch_observable[JSO_ia_filt] 				= &data->av.I_U_filt;
	js_ch_observable[JSO_ib_filt] 				= &data->av.I_V_filt;
	js_ch_observable[JSO_ic_filt] 				= &data->av.I_W_filt;
	js_ch_observable[JSO_ua_filt] 				= &data->av.U_U_filt;
	js_ch_observable[JSO_ub_filt] 				= &data->av.U_V_filt;
	js_ch_observable[JSO_uc_filt] 				= &data->av.U_W_filt;
	...
	js_ch_observable[JSO_uq_ref]				= &data->rasv.U_q_ref;
	...
	js_ch_observable[JSO_LMG_Switch]			= &data->av.flg_enable_FU;
