...
ARCHITECTURE rtl OF Incremental_Encoder_v26_src_invt_mult IS
  ...
  COMPONENT Incremental_Encoder_v26_src_Math_Reciprocal
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_5987_0                    :   IN    std_logic;
  ...
  FOR ALL : Incremental_Encoder_v26_src_Math_Reciprocal
    USE ENTITY work.Incremental_Encoder_v26_src_Math_Reciprocal(rtl);
...
BEGIN
  ...
  u_Math_Reciprocal : Incremental_Encoder_v26_src_Math_Reciprocal
    PORT MAP( clk => clk,
              reset_x => reset_x,
