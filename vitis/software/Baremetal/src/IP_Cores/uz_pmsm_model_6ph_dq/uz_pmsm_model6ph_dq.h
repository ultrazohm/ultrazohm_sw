 ...
 * @return uz_pmsm_model6ph_dq_t* Pointer to an initialized instance of the driver
 */
 ...
 * @param omega_mech value for fixed omega if uz_pmsm_model6ph_dq_config_t.simulate_mechanical_system is false
 * @param load_torque value for load torque if uz_pmsm_model6ph_dq_config_t.simulate_mechanical_system is true
 */
 ...
 * 
 * @param self Pointer to driver instance
 * @return struct uz_pmsm_model6ph_dq_outputs_general_t output values
 */
