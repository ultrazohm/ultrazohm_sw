...
ARCHITECTURE rtl OF parallel_8_sim_prediction_and_cost_function_src_Prediction_and_cost_function1 IS
  ...
  SIGNAL reduced_reg_next                 : vector_of_signed32(0 TO 1);  -- sfix32 [2]
  SIGNAL HDL_Counter_out1_1               : signed(31 DOWNTO 0);  -- int32
  SIGNAL reduced_reg_1                    : vector_of_signed32(0 TO 65);  -- sfix32 [66]
  SIGNAL reduced_reg_next_1               : vector_of_signed32(0 TO 65);  -- sfix32 [66]
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        reduced_reg(0) <= to_signed(0, 32);
        reduced_reg(1) <= to_signed(0, 32);
      ELSIF enb = '1' THEN
  ...
  HDL_Counter_out1_1 <= reduced_reg(1);
  reduced_reg_next(0) <= HDL_Counter_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        reduced_reg_1(0) <= to_signed(0, 32);
        reduced_reg_1(1) <= to_signed(0, 32);
        reduced_reg_1(2) <= to_signed(0, 32);
        reduced_reg_1(3) <= to_signed(0, 32);
        reduced_reg_1(4) <= to_signed(0, 32);
        reduced_reg_1(5) <= to_signed(0, 32);
        reduced_reg_1(6) <= to_signed(0, 32);
        reduced_reg_1(7) <= to_signed(0, 32);
        reduced_reg_1(8) <= to_signed(0, 32);
        reduced_reg_1(9) <= to_signed(0, 32);
        reduced_reg_1(10) <= to_signed(0, 32);
        reduced_reg_1(11) <= to_signed(0, 32);
        reduced_reg_1(12) <= to_signed(0, 32);
        reduced_reg_1(13) <= to_signed(0, 32);
        reduced_reg_1(14) <= to_signed(0, 32);
        reduced_reg_1(15) <= to_signed(0, 32);
        reduced_reg_1(16) <= to_signed(0, 32);
        reduced_reg_1(17) <= to_signed(0, 32);
        reduced_reg_1(18) <= to_signed(0, 32);
        reduced_reg_1(19) <= to_signed(0, 32);
        reduced_reg_1(20) <= to_signed(0, 32);
        reduced_reg_1(21) <= to_signed(0, 32);
        reduced_reg_1(22) <= to_signed(0, 32);
        reduced_reg_1(23) <= to_signed(0, 32);
        reduced_reg_1(24) <= to_signed(0, 32);
        reduced_reg_1(25) <= to_signed(0, 32);
        reduced_reg_1(26) <= to_signed(0, 32);
        reduced_reg_1(27) <= to_signed(0, 32);
        reduced_reg_1(28) <= to_signed(0, 32);
        reduced_reg_1(29) <= to_signed(0, 32);
        reduced_reg_1(30) <= to_signed(0, 32);
        reduced_reg_1(31) <= to_signed(0, 32);
        reduced_reg_1(32) <= to_signed(0, 32);
        reduced_reg_1(33) <= to_signed(0, 32);
        reduced_reg_1(34) <= to_signed(0, 32);
        reduced_reg_1(35) <= to_signed(0, 32);
        reduced_reg_1(36) <= to_signed(0, 32);
        reduced_reg_1(37) <= to_signed(0, 32);
        reduced_reg_1(38) <= to_signed(0, 32);
        reduced_reg_1(39) <= to_signed(0, 32);
        reduced_reg_1(40) <= to_signed(0, 32);
        reduced_reg_1(41) <= to_signed(0, 32);
        reduced_reg_1(42) <= to_signed(0, 32);
        reduced_reg_1(43) <= to_signed(0, 32);
        reduced_reg_1(44) <= to_signed(0, 32);
        reduced_reg_1(45) <= to_signed(0, 32);
        reduced_reg_1(46) <= to_signed(0, 32);
        reduced_reg_1(47) <= to_signed(0, 32);
        reduced_reg_1(48) <= to_signed(0, 32);
        reduced_reg_1(49) <= to_signed(0, 32);
        reduced_reg_1(50) <= to_signed(0, 32);
        reduced_reg_1(51) <= to_signed(0, 32);
        reduced_reg_1(52) <= to_signed(0, 32);
        reduced_reg_1(53) <= to_signed(0, 32);
        reduced_reg_1(54) <= to_signed(0, 32);
        reduced_reg_1(55) <= to_signed(0, 32);
        reduced_reg_1(56) <= to_signed(0, 32);
        reduced_reg_1(57) <= to_signed(0, 32);
        reduced_reg_1(58) <= to_signed(0, 32);
        reduced_reg_1(59) <= to_signed(0, 32);
        reduced_reg_1(60) <= to_signed(0, 32);
        reduced_reg_1(61) <= to_signed(0, 32);
        reduced_reg_1(62) <= to_signed(0, 32);
        reduced_reg_1(63) <= to_signed(0, 32);
        reduced_reg_1(64) <= to_signed(0, 32);
        reduced_reg_1(65) <= to_signed(0, 32);
      ELSIF enb = '1' THEN
  ...
  HDL_Counter_out1_2 <= reduced_reg_1(65);
  reduced_reg_next_1(0) <= HDL_Counter_out1_1;
