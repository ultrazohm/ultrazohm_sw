...
void data_aggregator(uint32_t *value1, uint32_t *value2, uint32_t *value3, uint32_t *value4, uint32_t *value5, uint32_t *value6, uint32_t *value7, uint32_t *value8,  uint32_t *value9, uint32_t *value10, uint32_t *value11, uint32_t *value12, uint32_t *value13, uint32_t *value14, uint32_t *value15, uint32_t *value16, uint32_t *control1, uint32_t *control2, float buff[NUM_DATA_IN]);
