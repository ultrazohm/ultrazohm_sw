-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\test_prediction_only\hdlsrc\parallel_prediction_and_cost_function_6phase\test_parallel_prediction_only_src_Prediction_and_cost_function.vhd
-- Created: 2022-10-12 10:08:09
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: test_parallel_prediction_only_src_Prediction_and_cost_function
...
USE work.test_parallel_prediction_only_src_Prediction_and_cost_function_pkg.ALL;

ENTITY test_parallel_prediction_only_src_Prediction_and_cost_function IS
...
END test_parallel_prediction_only_src_Prediction_and_cost_function;


ARCHITECTURE rtl OF test_parallel_prediction_only_src_Prediction_and_cost_function IS

  -- Component Declarations
  COMPONENT test_parallel_prediction_only_src_Detect_Rise_Positive
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  COMPONENT test_parallel_prediction_only_src_Detect_Rise_Positive1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  COMPONENT test_parallel_prediction_only_src_Compare_To_Constant
    PORT( u                               :   IN    std_logic_vector(31 DOWNTO 0);  -- int32
          y                               :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT test_parallel_prediction_only_src_nfp_convert_sfix_18_En11_to_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT test_parallel_prediction_only_src_Detect_Rise_Positive2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  COMPONENT test_parallel_prediction_only_src_nfp_mul_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT test_parallel_prediction_only_src_Subsystem_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : test_parallel_prediction_only_src_Detect_Rise_Positive
    USE ENTITY work.test_parallel_prediction_only_src_Detect_Rise_Positive(rtl);

  FOR ALL : test_parallel_prediction_only_src_Detect_Rise_Positive1
    USE ENTITY work.test_parallel_prediction_only_src_Detect_Rise_Positive1(rtl);

  FOR ALL : test_parallel_prediction_only_src_Compare_To_Constant
    USE ENTITY work.test_parallel_prediction_only_src_Compare_To_Constant(rtl);

  FOR ALL : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    USE ENTITY work.test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single(rtl);

  FOR ALL : test_parallel_prediction_only_src_nfp_convert_sfix_18_En11_to_single
    USE ENTITY work.test_parallel_prediction_only_src_nfp_convert_sfix_18_En11_to_single(rtl);

  FOR ALL : test_parallel_prediction_only_src_Detect_Rise_Positive2
    USE ENTITY work.test_parallel_prediction_only_src_Detect_Rise_Positive2(rtl);

  FOR ALL : test_parallel_prediction_only_src_nfp_mul_single
    USE ENTITY work.test_parallel_prediction_only_src_nfp_mul_single(rtl);

  FOR ALL : test_parallel_prediction_only_src_Subsystem_block
    USE ENTITY work.test_parallel_prediction_only_src_Subsystem_block(rtl);

  FOR ALL : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    USE ENTITY work.test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11(rtl);
  ...
  SIGNAL delayMatch141_reg                : std_logic_vector(0 TO 46);  -- ufix1 [47]
  SIGNAL delayMatch141_reg_next           : std_logic_vector(0 TO 46);  -- ufix1 [47]
  SIGNAL Delay58_out1_1                   : std_logic;
  SIGNAL Delay59_out1                     : signed(31 DOWNTO 0);  -- int32
  SIGNAL delayMatch142_reg                : vector_of_signed32(0 TO 46);  -- sfix32 [47]
  SIGNAL delayMatch142_reg_next           : vector_of_signed32(0 TO 46);  -- sfix32 [47]
  ...
  SIGNAL dqxy_phase_voltage_per_switching_state : vector_of_std_logic_vector24(0 TO 63);  -- ufix24 [64]
  SIGNAL dqxy_phase_voltage_per_switching_state_64 : vector_of_signed24(0 TO 63);  -- sfix24_En11 [64]
  SIGNAL Delay32_out1                     : vector_of_signed24(0 TO 63);  -- sfix24_En11 [64]
...
BEGIN
  u_Detect_Rise_Positive : test_parallel_prediction_only_src_Detect_Rise_Positive
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              U => Delay21_out1,
  ...
  u_Detect_Rise_Positive1 : test_parallel_prediction_only_src_Detect_Rise_Positive1
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              U => Delay57_out1,
  ...
  u_Compare_To_Constant : test_parallel_prediction_only_src_Compare_To_Constant
    PORT MAP( u => std_logic_vector(HDL_Counter_out1),  -- int32
              y => Compare_To_Constant_out1
              );

  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_1 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_2 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_3 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_4 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_5 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_6 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_7 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_8 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_9 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_10 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_11 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_12 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_13 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_14 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_15 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_16 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_17 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_18 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_19 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_20 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_21 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_22 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_23 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_24 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_25 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_26 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_27 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_28 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_29 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_30 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_31 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_32 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in => std_logic_vector(Delay32_out1(32)),  -- sfix24_En11
              nfp_out => nfp_out_33_1  -- single
              );

  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_33 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in => std_logic_vector(Delay32_out1(33)),  -- sfix24_En11
              nfp_out => nfp_out_34_1  -- single
              );

  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_34 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in => std_logic_vector(Delay32_out1(34)),  -- sfix24_En11
              nfp_out => nfp_out_35_1  -- single
              );

  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_35 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in => std_logic_vector(Delay32_out1(35)),  -- sfix24_En11
              nfp_out => nfp_out_36_1  -- single
              );

  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_36 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in => std_logic_vector(Delay32_out1(36)),  -- sfix24_En11
              nfp_out => nfp_out_37_1  -- single
              );

  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_37 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in => std_logic_vector(Delay32_out1(37)),  -- sfix24_En11
              nfp_out => nfp_out_38_1  -- single
              );

  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_38 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in => std_logic_vector(Delay32_out1(38)),  -- sfix24_En11
              nfp_out => nfp_out_39_1  -- single
              );

  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_39 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in => std_logic_vector(Delay32_out1(39)),  -- sfix24_En11
              nfp_out => nfp_out_40_1  -- single
              );

  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_40 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in => std_logic_vector(Delay32_out1(40)),  -- sfix24_En11
              nfp_out => nfp_out_41_1  -- single
              );

  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_41 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in => std_logic_vector(Delay32_out1(41)),  -- sfix24_En11
              nfp_out => nfp_out_42_1  -- single
              );

  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_42 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in => std_logic_vector(Delay32_out1(42)),  -- sfix24_En11
              nfp_out => nfp_out_43_1  -- single
              );

  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_43 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in => std_logic_vector(Delay32_out1(43)),  -- sfix24_En11
              nfp_out => nfp_out_44_1  -- single
              );

  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_44 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in => std_logic_vector(Delay32_out1(44)),  -- sfix24_En11
              nfp_out => nfp_out_45_1  -- single
              );

  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_45 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in => std_logic_vector(Delay32_out1(45)),  -- sfix24_En11
              nfp_out => nfp_out_46_1  -- single
              );

  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_46 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in => std_logic_vector(Delay32_out1(46)),  -- sfix24_En11
              nfp_out => nfp_out_47_1  -- single
              );

  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_47 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in => std_logic_vector(Delay32_out1(47)),  -- sfix24_En11
              nfp_out => nfp_out_48_1  -- single
              );

  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_48 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in => std_logic_vector(Delay32_out1(48)),  -- sfix24_En11
              nfp_out => nfp_out_49_1  -- single
              );

  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_49 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in => std_logic_vector(Delay32_out1(49)),  -- sfix24_En11
              nfp_out => nfp_out_50_1  -- single
              );

  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_50 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in => std_logic_vector(Delay32_out1(50)),  -- sfix24_En11
              nfp_out => nfp_out_51_1  -- single
              );

  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_51 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in => std_logic_vector(Delay32_out1(51)),  -- sfix24_En11
              nfp_out => nfp_out_52_1  -- single
              );

  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_52 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in => std_logic_vector(Delay32_out1(52)),  -- sfix24_En11
              nfp_out => nfp_out_53_1  -- single
              );

  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_53 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in => std_logic_vector(Delay32_out1(53)),  -- sfix24_En11
              nfp_out => nfp_out_54_1  -- single
              );

  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_54 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in => std_logic_vector(Delay32_out1(54)),  -- sfix24_En11
              nfp_out => nfp_out_55_1  -- single
              );

  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_55 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in => std_logic_vector(Delay32_out1(55)),  -- sfix24_En11
              nfp_out => nfp_out_56_1  -- single
              );

  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_56 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in => std_logic_vector(Delay32_out1(56)),  -- sfix24_En11
              nfp_out => nfp_out_57_1  -- single
              );

  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_57 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in => std_logic_vector(Delay32_out1(57)),  -- sfix24_En11
              nfp_out => nfp_out_58_1  -- single
              );

  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_58 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in => std_logic_vector(Delay32_out1(58)),  -- sfix24_En11
              nfp_out => nfp_out_59_1  -- single
              );

  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_59 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in => std_logic_vector(Delay32_out1(59)),  -- sfix24_En11
              nfp_out => nfp_out_60_1  -- single
              );

  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_18_En11_to_single : test_parallel_prediction_only_src_nfp_convert_sfix_18_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_18_En11_to_single_1 : test_parallel_prediction_only_src_nfp_convert_sfix_18_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_18_En11_to_single_2 : test_parallel_prediction_only_src_nfp_convert_sfix_18_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_18_En11_to_single_3 : test_parallel_prediction_only_src_nfp_convert_sfix_18_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_Detect_Rise_Positive2 : test_parallel_prediction_only_src_Detect_Rise_Positive2
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              U => Delay60_out1,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_60 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_nfp_mul_comp : test_parallel_prediction_only_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_61 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in => std_logic_vector(Delay32_out1(60)),  -- sfix24_En11
              nfp_out => nfp_out_61_1  -- single
              );

  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_62 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in => std_logic_vector(Delay32_out1(61)),  -- sfix24_En11
              nfp_out => nfp_out_62_1  -- single
              );

  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_63 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in => std_logic_vector(Delay32_out1(62)),  -- sfix24_En11
              nfp_out => nfp_out_63_1  -- single
              );

  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_sfix_24_En11_to_single_64 : test_parallel_prediction_only_src_nfp_convert_sfix_24_En11_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in => std_logic_vector(Delay32_out1(63)),  -- sfix24_En11
              nfp_out => nfp_out_64_1  -- single
              );

  u_Subsystem : test_parallel_prediction_only_src_Subsystem_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_1 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_2 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_3 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_4 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_5 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_6 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_7 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_8 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_9 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_10 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_11 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_12 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_13 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_14 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_15 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_16 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_17 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_18 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_19 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_20 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_21 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_22 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_23 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_24 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_25 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_26 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_27 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_28 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_29 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_30 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_31 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_32 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_33 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_34 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_35 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_36 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_37 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_38 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_39 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_40 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_41 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_42 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_43 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_44 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_45 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_46 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_47 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_48 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_49 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_50 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_51 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_52 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_53 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_54 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_55 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_56 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_57 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_58 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_59 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_60 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_61 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_62 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_prediction_and_cost_function_6phase_Prediction_and_cost_function_nfp_convert_single_to_sfix_18_En11_63 : test_parallel_prediction_only_src_nfp_convert_single_to_sfix_18_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  Delay58_out1_1 <= delayMatch141_reg(46);
  ...
  Delay59_out1_1 <= delayMatch142_reg(46);
  ...
  dqxy_phase_voltage_per_switching_state(32) <= dqxy_phase_voltage_per_switching_state_32;
  dqxy_phase_voltage_per_switching_state(33) <= dqxy_phase_voltage_per_switching_state_33;
  dqxy_phase_voltage_per_switching_state(34) <= dqxy_phase_voltage_per_switching_state_34;
  dqxy_phase_voltage_per_switching_state(35) <= dqxy_phase_voltage_per_switching_state_35;
  dqxy_phase_voltage_per_switching_state(36) <= dqxy_phase_voltage_per_switching_state_36;
  dqxy_phase_voltage_per_switching_state(37) <= dqxy_phase_voltage_per_switching_state_37;
  dqxy_phase_voltage_per_switching_state(38) <= dqxy_phase_voltage_per_switching_state_38;
  dqxy_phase_voltage_per_switching_state(39) <= dqxy_phase_voltage_per_switching_state_39;
  dqxy_phase_voltage_per_switching_state(40) <= dqxy_phase_voltage_per_switching_state_40;
  dqxy_phase_voltage_per_switching_state(41) <= dqxy_phase_voltage_per_switching_state_41;
  dqxy_phase_voltage_per_switching_state(42) <= dqxy_phase_voltage_per_switching_state_42;
  dqxy_phase_voltage_per_switching_state(43) <= dqxy_phase_voltage_per_switching_state_43;
  dqxy_phase_voltage_per_switching_state(44) <= dqxy_phase_voltage_per_switching_state_44;
  dqxy_phase_voltage_per_switching_state(45) <= dqxy_phase_voltage_per_switching_state_45;
  dqxy_phase_voltage_per_switching_state(46) <= dqxy_phase_voltage_per_switching_state_46;
  dqxy_phase_voltage_per_switching_state(47) <= dqxy_phase_voltage_per_switching_state_47;
  dqxy_phase_voltage_per_switching_state(48) <= dqxy_phase_voltage_per_switching_state_48;
  dqxy_phase_voltage_per_switching_state(49) <= dqxy_phase_voltage_per_switching_state_49;
  dqxy_phase_voltage_per_switching_state(50) <= dqxy_phase_voltage_per_switching_state_50;
  dqxy_phase_voltage_per_switching_state(51) <= dqxy_phase_voltage_per_switching_state_51;
  dqxy_phase_voltage_per_switching_state(52) <= dqxy_phase_voltage_per_switching_state_52;
  dqxy_phase_voltage_per_switching_state(53) <= dqxy_phase_voltage_per_switching_state_53;
  dqxy_phase_voltage_per_switching_state(54) <= dqxy_phase_voltage_per_switching_state_54;
  dqxy_phase_voltage_per_switching_state(55) <= dqxy_phase_voltage_per_switching_state_55;
  dqxy_phase_voltage_per_switching_state(56) <= dqxy_phase_voltage_per_switching_state_56;
  dqxy_phase_voltage_per_switching_state(57) <= dqxy_phase_voltage_per_switching_state_57;
  dqxy_phase_voltage_per_switching_state(58) <= dqxy_phase_voltage_per_switching_state_58;
  dqxy_phase_voltage_per_switching_state(59) <= dqxy_phase_voltage_per_switching_state_59;
  dqxy_phase_voltage_per_switching_state(60) <= dqxy_phase_voltage_per_switching_state_60;
  dqxy_phase_voltage_per_switching_state(61) <= dqxy_phase_voltage_per_switching_state_61;
  dqxy_phase_voltage_per_switching_state(62) <= dqxy_phase_voltage_per_switching_state_62;
  dqxy_phase_voltage_per_switching_state(63) <= dqxy_phase_voltage_per_switching_state_63;

  outputgen: FOR k IN 0 TO 63 GENERATE
    dqxy_phase_voltage_per_switching_state_64(k) <= signed(dqxy_phase_voltage_per_switching_state(k));
  END GENERATE;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        ...
        Delay32_out1(32) <= to_signed(16#000000#, 24);
        Delay32_out1(33) <= to_signed(16#000000#, 24);
        Delay32_out1(34) <= to_signed(16#000000#, 24);
        Delay32_out1(35) <= to_signed(16#000000#, 24);
        Delay32_out1(36) <= to_signed(16#000000#, 24);
        Delay32_out1(37) <= to_signed(16#000000#, 24);
        Delay32_out1(38) <= to_signed(16#000000#, 24);
        Delay32_out1(39) <= to_signed(16#000000#, 24);
        Delay32_out1(40) <= to_signed(16#000000#, 24);
        Delay32_out1(41) <= to_signed(16#000000#, 24);
        Delay32_out1(42) <= to_signed(16#000000#, 24);
        Delay32_out1(43) <= to_signed(16#000000#, 24);
        Delay32_out1(44) <= to_signed(16#000000#, 24);
        Delay32_out1(45) <= to_signed(16#000000#, 24);
        Delay32_out1(46) <= to_signed(16#000000#, 24);
        Delay32_out1(47) <= to_signed(16#000000#, 24);
        Delay32_out1(48) <= to_signed(16#000000#, 24);
        Delay32_out1(49) <= to_signed(16#000000#, 24);
        Delay32_out1(50) <= to_signed(16#000000#, 24);
        Delay32_out1(51) <= to_signed(16#000000#, 24);
        Delay32_out1(52) <= to_signed(16#000000#, 24);
        Delay32_out1(53) <= to_signed(16#000000#, 24);
        Delay32_out1(54) <= to_signed(16#000000#, 24);
        Delay32_out1(55) <= to_signed(16#000000#, 24);
        Delay32_out1(56) <= to_signed(16#000000#, 24);
        Delay32_out1(57) <= to_signed(16#000000#, 24);
        Delay32_out1(58) <= to_signed(16#000000#, 24);
        Delay32_out1(59) <= to_signed(16#000000#, 24);
        Delay32_out1(60) <= to_signed(16#000000#, 24);
        Delay32_out1(61) <= to_signed(16#000000#, 24);
        Delay32_out1(62) <= to_signed(16#000000#, 24);
        Delay32_out1(63) <= to_signed(16#000000#, 24);
      ELSIF enb = '1' THEN
        Delay32_out1(0) <= dqxy_phase_voltage_per_switching_state_64(0);
        Delay32_out1(1) <= dqxy_phase_voltage_per_switching_state_64(1);
        Delay32_out1(2) <= dqxy_phase_voltage_per_switching_state_64(2);
        Delay32_out1(3) <= dqxy_phase_voltage_per_switching_state_64(3);
        Delay32_out1(4) <= dqxy_phase_voltage_per_switching_state_64(4);
        Delay32_out1(5) <= dqxy_phase_voltage_per_switching_state_64(5);
        Delay32_out1(6) <= dqxy_phase_voltage_per_switching_state_64(6);
        Delay32_out1(7) <= dqxy_phase_voltage_per_switching_state_64(7);
        Delay32_out1(8) <= dqxy_phase_voltage_per_switching_state_64(8);
        Delay32_out1(9) <= dqxy_phase_voltage_per_switching_state_64(9);
        Delay32_out1(10) <= dqxy_phase_voltage_per_switching_state_64(10);
        Delay32_out1(11) <= dqxy_phase_voltage_per_switching_state_64(11);
        Delay32_out1(12) <= dqxy_phase_voltage_per_switching_state_64(12);
        Delay32_out1(13) <= dqxy_phase_voltage_per_switching_state_64(13);
        Delay32_out1(14) <= dqxy_phase_voltage_per_switching_state_64(14);
        Delay32_out1(15) <= dqxy_phase_voltage_per_switching_state_64(15);
        Delay32_out1(16) <= dqxy_phase_voltage_per_switching_state_64(16);
        Delay32_out1(17) <= dqxy_phase_voltage_per_switching_state_64(17);
        Delay32_out1(18) <= dqxy_phase_voltage_per_switching_state_64(18);
        Delay32_out1(19) <= dqxy_phase_voltage_per_switching_state_64(19);
        Delay32_out1(20) <= dqxy_phase_voltage_per_switching_state_64(20);
        Delay32_out1(21) <= dqxy_phase_voltage_per_switching_state_64(21);
        Delay32_out1(22) <= dqxy_phase_voltage_per_switching_state_64(22);
        Delay32_out1(23) <= dqxy_phase_voltage_per_switching_state_64(23);
        Delay32_out1(24) <= dqxy_phase_voltage_per_switching_state_64(24);
        Delay32_out1(25) <= dqxy_phase_voltage_per_switching_state_64(25);
        Delay32_out1(26) <= dqxy_phase_voltage_per_switching_state_64(26);
        Delay32_out1(27) <= dqxy_phase_voltage_per_switching_state_64(27);
        Delay32_out1(28) <= dqxy_phase_voltage_per_switching_state_64(28);
        Delay32_out1(29) <= dqxy_phase_voltage_per_switching_state_64(29);
        Delay32_out1(30) <= dqxy_phase_voltage_per_switching_state_64(30);
        Delay32_out1(31) <= dqxy_phase_voltage_per_switching_state_64(31);
        Delay32_out1(32) <= dqxy_phase_voltage_per_switching_state_64(32);
        Delay32_out1(33) <= dqxy_phase_voltage_per_switching_state_64(33);
        Delay32_out1(34) <= dqxy_phase_voltage_per_switching_state_64(34);
        Delay32_out1(35) <= dqxy_phase_voltage_per_switching_state_64(35);
        Delay32_out1(36) <= dqxy_phase_voltage_per_switching_state_64(36);
        Delay32_out1(37) <= dqxy_phase_voltage_per_switching_state_64(37);
        Delay32_out1(38) <= dqxy_phase_voltage_per_switching_state_64(38);
        Delay32_out1(39) <= dqxy_phase_voltage_per_switching_state_64(39);
        Delay32_out1(40) <= dqxy_phase_voltage_per_switching_state_64(40);
        Delay32_out1(41) <= dqxy_phase_voltage_per_switching_state_64(41);
        Delay32_out1(42) <= dqxy_phase_voltage_per_switching_state_64(42);
        Delay32_out1(43) <= dqxy_phase_voltage_per_switching_state_64(43);
        Delay32_out1(44) <= dqxy_phase_voltage_per_switching_state_64(44);
        Delay32_out1(45) <= dqxy_phase_voltage_per_switching_state_64(45);
        Delay32_out1(46) <= dqxy_phase_voltage_per_switching_state_64(46);
        Delay32_out1(47) <= dqxy_phase_voltage_per_switching_state_64(47);
        Delay32_out1(48) <= dqxy_phase_voltage_per_switching_state_64(48);
        Delay32_out1(49) <= dqxy_phase_voltage_per_switching_state_64(49);
        Delay32_out1(50) <= dqxy_phase_voltage_per_switching_state_64(50);
        Delay32_out1(51) <= dqxy_phase_voltage_per_switching_state_64(51);
        Delay32_out1(52) <= dqxy_phase_voltage_per_switching_state_64(52);
        Delay32_out1(53) <= dqxy_phase_voltage_per_switching_state_64(53);
        Delay32_out1(54) <= dqxy_phase_voltage_per_switching_state_64(54);
        Delay32_out1(55) <= dqxy_phase_voltage_per_switching_state_64(55);
        Delay32_out1(56) <= dqxy_phase_voltage_per_switching_state_64(56);
        Delay32_out1(57) <= dqxy_phase_voltage_per_switching_state_64(57);
        Delay32_out1(58) <= dqxy_phase_voltage_per_switching_state_64(58);
        Delay32_out1(59) <= dqxy_phase_voltage_per_switching_state_64(59);
        Delay32_out1(60) <= dqxy_phase_voltage_per_switching_state_64(60);
        Delay32_out1(61) <= dqxy_phase_voltage_per_switching_state_64(61);
        Delay32_out1(62) <= dqxy_phase_voltage_per_switching_state_64(62);
        Delay32_out1(63) <= dqxy_phase_voltage_per_switching_state_64(63);
      END IF;
    END IF;
  ...
  switch_compare_1_67 <= '1' WHEN End_Cycle_3 = '1' ELSE
      '0';
  ...
  switch_compare_1_68 <= '1' WHEN End_Cycle = '1' ELSE
      '0';
  ...
  switch_compare_1_69 <= '1' WHEN End_Cycle_6 = '1' ELSE
      '0';
  ...
  switch_compare_1_70 <= '1' WHEN End_Cycle = '1' ELSE
      '0';
  ...
  switch_compare_1_71 <= '1' WHEN End_Cycle = '1' ELSE
      '0';
  ...
  switch_compare_1_73 <= '1' WHEN End_Cycle_3 = '1' ELSE
      '0';
  ...
  switch_compare_1_74 <= '1' WHEN End_Cycle_3 = '1' ELSE
      '0';
  ...
  switch_compare_1_75 <= '1' WHEN End_Cycle_3 = '1' ELSE
      '0';
  ...
  switch_compare_1_76 <= '1' WHEN End_Cycle_3 = '1' ELSE
      '0';
