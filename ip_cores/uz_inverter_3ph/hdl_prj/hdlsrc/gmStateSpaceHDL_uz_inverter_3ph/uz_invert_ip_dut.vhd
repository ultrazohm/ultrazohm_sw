-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/gmStateSpaceHDL_uz_inverter_3ph/uz_invert_ip_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_invert_ip_dut
-- Source Path: uz_invert_ip/uz_invert_ip_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END uz_invert_ip_dut;


ARCHITECTURE rtl OF uz_invert_ip_dut IS

  -- Component Declarations
  COMPONENT uz_invert_ip_src_uz_inverter_3ph
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : uz_invert_ip_src_uz_inverter_3ph
    USE ENTITY work.uz_invert_ip_src_uz_inverter_3ph(rtl);
...
BEGIN
  u_uz_invert_ip_src_uz_inverter_3ph : uz_invert_ip_src_uz_inverter_3ph
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
              ...
              i_abc_pl_0 => i_abc_pl_0,  -- sfix27_En18
              i_abc_pl_1 => i_abc_pl_1,  -- sfix27_En18
              i_abc_pl_2 => i_abc_pl_2,  -- sfix27_En18
