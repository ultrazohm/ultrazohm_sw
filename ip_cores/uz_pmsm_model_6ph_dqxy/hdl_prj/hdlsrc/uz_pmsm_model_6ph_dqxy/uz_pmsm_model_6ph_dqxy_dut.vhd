-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_pmsm_model_6ph_dqxy\uz_pmsm_model_6ph_dqxy_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_6ph_dqxy_dut
-- Source Path: uz_pmsm_model_6ph_dqxy/uz_pmsm_model_6ph_dqxy_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_pmsm_model_6ph_dqxy_dut IS
...
END uz_pmsm_model_6ph_dqxy_dut;


ARCHITECTURE rtl OF uz_pmsm_model_6ph_dqxy_dut IS

  -- Component Declarations
  COMPONENT uz_pmsm_model_6ph_dqxy_src_uz_pmsm_model
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : uz_pmsm_model_6ph_dqxy_src_uz_pmsm_model
    USE ENTITY work.uz_pmsm_model_6ph_dqxy_src_uz_pmsm_model(rtl);
  ...
  SIGNAL outputs_5_sig                    : std_logic_vector(31 DOWNTO 0);  -- ufix32

BEGIN
  u_uz_pmsm_model_6ph_dqxy_src_uz_pmsm_model : uz_pmsm_model_6ph_dqxy_src_uz_pmsm_model
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
              ...
              reciprocal_L_x => reciprocal_L_x,  -- ufix32
              reciprocal_L_y => reciprocal_L_y,  -- ufix32
              inputs_0 => inputs_0,  -- ufix32
              inputs_1 => inputs_1,  -- ufix32
              inputs_2 => inputs_2,  -- ufix32
              inputs_3 => inputs_3,  -- ufix32
              inputs_4 => inputs_4,  -- ufix32
              inputs_5 => inputs_5,  -- ufix32
              ...
              outputs_5 => outputs_5_sig  -- ufix32
              );
