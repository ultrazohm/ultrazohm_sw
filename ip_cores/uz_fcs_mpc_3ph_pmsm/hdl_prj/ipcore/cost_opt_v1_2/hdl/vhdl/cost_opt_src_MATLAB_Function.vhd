-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_mpc_3ph\cost_opt_src_MATLAB_Function.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: cost_opt_src_MATLAB_Function
-- Source Path: uz_mpc_3ph/cost_opt/MATLAB Function
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY cost_opt_src_MATLAB_Function IS
...
END cost_opt_src_MATLAB_Function;


ARCHITECTURE rtl OF cost_opt_src_MATLAB_Function IS
...
BEGIN
  ...
  MATLAB_Function_output : PROCESS (in_rsvd, index_unsigned, last_optim_index_unsigned)
    ...
    VARIABLE cast : vector_of_signed64(0 TO 2);
    VARIABLE sub_cast_0 : vector_of_signed32(0 TO 2);
    VARIABLE cast_0 : vector_of_signed64(0 TO 2);
  BEGIN
    --MATLAB Function 'cost_opt/MATLAB Function'
    ...
    FOR t_0 IN 0 TO 2 LOOP
      ...
      sub_cast_0(t_0) := signed(last_optim_index_unsigned);
