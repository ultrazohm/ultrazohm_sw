-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\Philipp\ultrazohm\ultrazohm_sw\ip_cores\uz_pmsm_model_nonlinear_6LUT\hdl_prj\hdlsrc\uz_pmsm_model_6LUT_pd\uz_pmsm_6LUT_approx_src_nfp_recip_double.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_6LUT_approx_src_nfp_recip_double
...
ENTITY uz_pmsm_6LUT_approx_src_nfp_recip_double IS
...
END uz_pmsm_6LUT_approx_src_nfp_recip_double;


ARCHITECTURE rtl OF uz_pmsm_6LUT_approx_src_nfp_recip_double IS
  ...
  SIGNAL Delay19_PS_5_57_reg              : std_logic_vector(25 DOWNTO 0);  -- ufix1 [26]
  ...
  SIGNAL Delay12_PS_5_57_reg              : std_logic_vector(25 DOWNTO 0);  -- ufix1 [26]
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay19_PS_5_57_reg <= (OTHERS => '0');
      ELSIF enb = '1' THEN
        Delay19_PS_5_57_reg(0) <= Delay22_PS_3_out1;
        Delay19_PS_5_57_reg(25 DOWNTO 1) <= Delay19_PS_5_57_reg(24 DOWNTO 0);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay12_PS_5_57_reg <= (OTHERS => '0');
      ELSIF enb = '1' THEN
        Delay12_PS_5_57_reg(0) <= Delay29_PS_3_out1;
        Delay12_PS_5_57_reg(25 DOWNTO 1) <= Delay12_PS_5_57_reg(24 DOWNTO 0);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay11_PS_6_58_reg <= (OTHERS => to_unsigned(16#00#, 6));
      ELSIF enb = '1' THEN
        Delay11_PS_6_58_reg(0) <= if_exp_tmp_2_cfType_ExponentB_1_out1;
        Delay11_PS_6_58_reg(1 TO 25) <= Delay11_PS_6_58_reg(0 TO 24);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay8_PS_59_reg <= (OTHERS => to_unsigned(16#000#, 11));
      ELSIF enb = '1' THEN
        Delay8_PS_59_reg(0) <= if_exp_tmp_2_cfType_ExponentB_out1;
        Delay8_PS_59_reg(1 TO 26) <= Delay8_PS_59_reg(0 TO 25);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay16_PS_5_57_reg <= (OTHERS => to_unsigned(16#000#, 11));
      ELSIF enb = '1' THEN
        Delay16_PS_5_57_reg(0) <= Delay23_PS_3_out1;
        Delay16_PS_5_57_reg(1 TO 25) <= Delay16_PS_5_57_reg(0 TO 24);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay13_PS_5_57_reg <= (OTHERS => to_unsigned(0, 52));
      ELSIF enb = '1' THEN
        Delay13_PS_5_57_reg(0) <= Delay26_PS_3_out1;
        Delay13_PS_5_57_reg(1 TO 25) <= Delay13_PS_5_57_reg(0 TO 24);
      END IF;
    END IF;
