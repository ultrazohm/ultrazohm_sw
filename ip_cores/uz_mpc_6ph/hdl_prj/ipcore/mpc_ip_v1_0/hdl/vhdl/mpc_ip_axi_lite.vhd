-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\test_RS_flipflop_statemachine\mpc_ip_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mpc_ip_axi_lite
-- Source Path: mpc_ip/mpc_ip_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF mpc_ip_axi_lite IS

  -- Component Declarations
  COMPONENT mpc_ip_addr_decoder
  ...
  COMPONENT mpc_ip_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : mpc_ip_addr_decoder
    USE ENTITY work.mpc_ip_addr_decoder(rtl);

  FOR ALL : mpc_ip_axi_lite_module
    USE ENTITY work.mpc_ip_axi_lite_module(rtl);
...
BEGIN
  u_mpc_ip_addr_decoder_inst : mpc_ip_addr_decoder
  ...
  u_mpc_ip_axi_lite_module_inst : mpc_ip_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
