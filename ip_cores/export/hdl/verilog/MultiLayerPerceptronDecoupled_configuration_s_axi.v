...
// ==============================================================
`timescale 1ns/1ps
module MultiLayerPerceptronDecoupled_configuration_s_axi
#(parameter
...
localparam
    ...
    ADDR_IER                   = 6'h08,
    ADDR_ISR                   = 6'h0c,
    ADDR_NUMBERINPUTS_DATA_0   = 6'h10,
    ADDR_NUMBERINPUTS_CTRL     = 6'h14,
    ADDR_NUMBEROUTPUTS_DATA_0  = 6'h18,
    ADDR_NUMBEROUTPUTS_CTRL    = 6'h1c,
    ADDR_NUMBERLAYERS_DATA_0   = 6'h20,
    ADDR_NUMBERLAYERS_CTRL     = 6'h24,
    ADDR_NUMBERNEURONS_DATA_0  = 6'h28,
    ADDR_NUMBERNEURONS_CTRL    = 6'h2c,
    ADDR_LOADPARAMETERS_DATA_0 = 6'h30,
    ADDR_LOADPARAMETERS_CTRL   = 6'h34,
    ADDR_EXPORTLAYERS_DATA_0   = 6'h38,
    ADDR_EXPORTLAYERS_CTRL     = 6'h3c,
    WRIDLE                     = 2'd0,
    WRDATA                     = 2'd1,
    WRRESP                     = 2'd2,
    WRRESET                    = 2'd3,
