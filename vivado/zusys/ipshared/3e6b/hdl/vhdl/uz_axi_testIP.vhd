-- -------------------------------------------------------------
-- 
-- File Name: uz_axi_testIP/hdlsrc/uz_axi_testIP/uz_axi_testIP.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_axi_testIP
-- Source Path: uz_axi_testIP
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF uz_axi_testIP IS

  -- Component Declarations
  COMPONENT uz_axi_testIP_reset_sync
  ...
  FOR ALL : uz_axi_testIP_reset_sync
    USE ENTITY work.uz_axi_testIP_reset_sync(rtl);

  FOR ALL : uz_axi_testIP_dut
    USE ENTITY work.uz_axi_testIP_dut(rtl);

  FOR ALL : uz_axi_testIP_axi4
    USE ENTITY work.uz_axi_testIP_axi4(rtl);
...
BEGIN
  u_uz_axi_testIP_reset_sync_inst : uz_axi_testIP_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_uz_axi_testIP_dut_inst : uz_axi_testIP_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  u_uz_axi_testIP_axi4_inst : uz_axi_testIP_axi4
  ...
  ip_timestamp <= to_unsigned(2104181321, 32);
