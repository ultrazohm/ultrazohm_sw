-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\FCS_MPC_3Phase_SPMSM\hdlsrc\FCS_MPC_3Phase_SPMSM_TEST1\FCS_MPC_3Phase_SPMSM_IP_Core_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: FCS_MPC_3Phase_SPMSM_IP_Core_dut
-- Source Path: FCS_MPC_3Phase_SPMSM_IP_Core/FCS_MPC_3Phase_SPMSM_IP_Core_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY FCS_MPC_3Phase_SPMSM_IP_Core_dut IS
...
END FCS_MPC_3Phase_SPMSM_IP_Core_dut;


ARCHITECTURE rtl OF FCS_MPC_3Phase_SPMSM_IP_Core_dut IS

  -- Component Declarations
  COMPONENT FCS_MPC_3Phase_SPMSM_IP_Core_src_Subsystem1
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : FCS_MPC_3Phase_SPMSM_IP_Core_src_Subsystem1
    USE ENTITY work.FCS_MPC_3Phase_SPMSM_IP_Core_src_Subsystem1(rtl);
...
BEGIN
  u_FCS_MPC_3Phase_SPMSM_IP_Core_src_Subsystem1 : FCS_MPC_3Phase_SPMSM_IP_Core_src_Subsystem1
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
              ...
              Ld_AXI => Ld_AXI,  -- sfix24_En20
              Lq_AXI => Lq_AXI,  -- sfix24_En20
