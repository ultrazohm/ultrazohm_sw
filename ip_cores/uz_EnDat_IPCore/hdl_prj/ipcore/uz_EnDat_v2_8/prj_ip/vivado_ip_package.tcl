...
add_files -norecurse {../hdl/uz_EnDat_src_RESPONSESLICER5X.vhd}
...
set_property version {2.8} [ipx::current_core]
...
set_property core_revision 2113335641 [ipx::current_core]
...
ipx::add_file {hdl/uz_EnDat_src_RESPONSESLICER5X.vhd} [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/uz_EnDat_src_RESPONSESLICER5X.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]]
ipx::add_file {hdl/uz_EnDat_src_RESPONSESLICER5X.vhd} [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/uz_EnDat_src_RESPONSESLICER5X.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]]
...
# Package IP
ipx::archive_core {../uz_EnDat_v2_8.zip} [ipx::current_core]
close_project
exit
