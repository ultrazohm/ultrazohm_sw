-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_endat_interface_2023a\uz_endat_interface_src_Sine_HDL_Optimized1.vhd
...
-- Source Path: uz_endat_interface_2023a/uz_endat_interface/position_to_speed_pll/Sine HDL Optimized1
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  Negate_cast <= resize(Look_Up_Table_out1_1, 28);
  ...
  Negate_cast_2 <= resize(Look_Up_Table_out1_3, 28);
