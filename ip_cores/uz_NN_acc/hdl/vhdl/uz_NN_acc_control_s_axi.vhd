...
architecture behave of uz_NN_acc_control_s_axi is
    ...
    constant ADDR_L_INPUT_WEIGHTS_INPUT_DATA_0  : INTEGER := 16#18#;
    constant ADDR_L_INPUT_WEIGHTS_INPUT_CTRL    : INTEGER := 16#1c#;
    constant ADDR_L_1_WEIGHTS_INPUT_DATA_0      : INTEGER := 16#20#;
    constant ADDR_L_1_WEIGHTS_INPUT_CTRL        : INTEGER := 16#24#;
    constant ADDR_L_2_WEIGHTS_INPUT_DATA_0      : INTEGER := 16#28#;
    constant ADDR_L_2_WEIGHTS_INPUT_CTRL        : INTEGER := 16#2c#;
    constant ADDR_L_3_WEIGHTS_INPUT_DATA_0      : INTEGER := 16#30#;
    constant ADDR_L_3_WEIGHTS_INPUT_CTRL        : INTEGER := 16#34#;
    constant ADDR_ACTION_OUTPUT_DATA_0          : INTEGER := 16#38#;
    constant ADDR_ACTION_OUTPUT_CTRL            : INTEGER := 16#3c#;
    constant ADDR_L_INPUT_BIAS_INPUT_DATA_0     : INTEGER := 16#40#;
    constant ADDR_L_INPUT_BIAS_INPUT_CTRL       : INTEGER := 16#44#;
    constant ADDR_L_1_BIAS_INPUT_DATA_0         : INTEGER := 16#48#;
    constant ADDR_L_1_BIAS_INPUT_CTRL           : INTEGER := 16#4c#;
    constant ADDR_L_2_BIAS_INPUT_DATA_0         : INTEGER := 16#50#;
    constant ADDR_L_2_BIAS_INPUT_CTRL           : INTEGER := 16#54#;
    constant ADDR_L_3_BIAS_INPUT_DATA_0         : INTEGER := 16#58#;
    constant ADDR_L_3_BIAS_INPUT_CTRL           : INTEGER := 16#5c#;
    ...
    signal int_L_Input_Weights_input : UNSIGNED(31 downto 0) := (others => '0');
    ...
    signal int_L_Input_Bias_input : UNSIGNED(31 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_L_INPUT_WEIGHTS_INPUT_DATA_0 =>
                        rdata_data <= RESIZE(int_L_Input_Weights_input(31 downto 0), 32);
                    ...
                    when ADDR_L_INPUT_BIAS_INPUT_DATA_0 =>
                        rdata_data <= RESIZE(int_L_Input_Bias_input(31 downto 0), 32);
...
-- ----------------------- Register logic ----------------
    ...
    L_Input_Weights_input <= STD_LOGIC_VECTOR(int_L_Input_Weights_input);
    ...
    L_Input_Bias_input   <= STD_LOGIC_VECTOR(int_L_Input_Bias_input);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_L_INPUT_WEIGHTS_INPUT_DATA_0) then
                    int_L_Input_Weights_input(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_L_Input_Weights_input(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_L_INPUT_BIAS_INPUT_DATA_0) then
                    int_L_Input_Bias_input(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_L_Input_Bias_input(31 downto 0));
                end if;
            end if;
        end if;
    end process;
