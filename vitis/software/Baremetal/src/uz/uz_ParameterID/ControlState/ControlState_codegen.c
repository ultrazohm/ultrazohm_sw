...
static void initParams(ExtU_ControlState0_t *rtControlState0_U,
  ExtY_ControlState0_t *rtControlState0_Y, DW_ControlState0_t
  *rtControlState0_DW);
static void decideIDstates(ExtU_ControlState0_t *rtControlState0_U,
  ExtY_ControlState0_t *rtControlState0_Y, DW_ControlState0_t
  *rtControlState0_DW);
  ...
  *rtControlState0_DW)
{
  ...
  rtControlState0_DW->finishedElectricalID_loc = 0U;

  /* '<S1>:732:4' finishedFrictionID_loc=uint16(0); */
  rtControlState0_DW->finishedFrictionID_loc = 0U;

  /* '<S1>:732:5' finishedTwoMassID_loc=uint16(0); */
  rtControlState0_DW->finishedTwoMassID_loc = 0U;

  /* '<S1>:732:6' finishedFluxMapID_loc=uint16(0); */
  rtControlState0_DW->finishedFluxMapID_loc = 0U;

  /* Outport: '<Root>/ControlFlags' */
  /* Initialize Outputs */
  /* '<S1>:732:9' ControlFlags.startFrictionID             = boolean(0); */
  rtControlState0_Y->ControlFlags.startFrictionID = false;

  /* '<S1>:732:10' ControlFlags.startElectricalID           = boolean(0); */
  rtControlState0_Y->ControlFlags.startElectricalID = false;

  /* '<S1>:732:11' ControlFlags.startTwoMassID              = boolean(0); */
  rtControlState0_Y->ControlFlags.startTwoMassID = false;

  /* '<S1>:732:12' ControlFlags.startFluxMapID              = boolean(0); */
  rtControlState0_Y->ControlFlags.startFluxMapID = false;

  /* Outport: '<Root>/GlobalConfig_out' incorporates:
   *  Inport: '<Root>/GlobalConfig_in'
   */
  /* '<S1>:732:13' GlobalConfig_out                         = GlobalConfig_in; */
  rtControlState0_Y->GlobalConfig_out = rtControlState0_U->GlobalConfig_in;

  /* Outport: '<Root>/ControlFlags' */
  /* '<S1>:732:14' ControlFlags.enableOnlineID              = boolean(0); */
  rtControlState0_Y->ControlFlags.enableOnlineID = false;

  /* '<S1>:732:15' ControlFlags.transNr                     = uint16(0); */
  rtControlState0_Y->ControlFlags.transNr = 0U;

  /* '<S1>:732:16' ControlFlags.finished_all_Offline_states = boolean(0); */
  rtControlState0_Y->ControlFlags.finished_all_Offline_states = false;
}
  ...
  *rtControlState0_DW)
{
  ...
  if (!rtControlState0_U->GlobalConfig_in.ElectricalID) {
    /* '<S1>:709:5' finishedElectricalID_loc=uint16(1); */
    rtControlState0_DW->finishedElectricalID_loc = 1U;
  } else if (rtControlState0_U->finishedElectricalID) {
    /* '<S1>:709:6' elseif(finishedElectricalID==1) */
    /* '<S1>:709:7' finishedElectricalID_loc=uint16(2); */
    rtControlState0_DW->finishedElectricalID_loc = 2U;
  }

  /* '<S1>:709:10' if(GlobalConfig_in.FrictionID==0) */
  if (!rtControlState0_U->GlobalConfig_in.FrictionID) {
    /* '<S1>:709:11' finishedFrictionID_loc=uint16(1); */
    rtControlState0_DW->finishedFrictionID_loc = 1U;
  } else if (rtControlState0_U->finishedFrictionID) {
    /* '<S1>:709:12' elseif(finishedFrictionID==1) */
    /* '<S1>:709:13' finishedFrictionID_loc=uint16(2); */
    rtControlState0_DW->finishedFrictionID_loc = 2U;
  }

  /* '<S1>:709:16' if(GlobalConfig_in.TwoMassID==0) */
  if (!rtControlState0_U->GlobalConfig_in.TwoMassID) {
    /* '<S1>:709:17' finishedTwoMassID_loc=uint16(1); */
    rtControlState0_DW->finishedTwoMassID_loc = 1U;
  } else if (rtControlState0_U->finishedTwoMassID) {
    /* '<S1>:709:18' elseif(finishedTwoMassID==1) */
    /* '<S1>:709:19' finishedTwoMassID_loc=uint16(2); */
    rtControlState0_DW->finishedTwoMassID_loc = 2U;
  }

  /* '<S1>:709:22' if(GlobalConfig_in.FluxMapID==0) */
  if (!rtControlState0_U->GlobalConfig_in.FluxMapID) {
    /* '<S1>:709:23' finishedFluxMapID_loc=uint16(1); */
    rtControlState0_DW->finishedFluxMapID_loc = 1U;
  } else if (rtControlState0_U->finishedFluxMapID) {
    /* '<S1>:709:24' elseif(finishedFluxMapID==1) */
    /* '<S1>:709:25' finishedFluxMapID_loc=uint16(2); */
    rtControlState0_DW->finishedFluxMapID_loc = 2U;
  }
  ...
  if (!rtControlState0_Y->ControlFlags.finished_all_Offline_states) {
    ...
    if (rtControlState0_U->GlobalConfig_in.ElectricalID &&
        (!rtControlState0_U->enteredElectricalID) &&
        (rtControlState0_DW->finishedElectricalID_loc != 2) &&
        (!rtControlState0_U->finishedElectricalID)) {
      /* '<S1>:709:31' ControlFlags.transNr=uint16(1); */
      rtControlState0_Y->ControlFlags.transNr = 1U;
    ...
    if (rtControlState0_U->GlobalConfig_in.TwoMassID &&
        (!rtControlState0_U->enteredTwoMassID) &&
        (rtControlState0_DW->finishedElectricalID_loc != 0) &&
        (rtControlState0_DW->finishedTwoMassID_loc != 2) &&
        (!rtControlState0_U->finishedTwoMassID)) {
      /* '<S1>:709:37' ControlFlags.transNr=uint16(2); */
      rtControlState0_Y->ControlFlags.transNr = 2U;
    ...
    if (rtControlState0_U->GlobalConfig_in.FrictionID &&
        (!rtControlState0_U->enteredFrictionID) &&
        (rtControlState0_DW->finishedElectricalID_loc != 0) &&
        (rtControlState0_DW->finishedTwoMassID_loc != 0) &&
        (rtControlState0_DW->finishedFrictionID_loc != 2) &&
        (!rtControlState0_U->finishedFrictionID)) {
      /* '<S1>:709:44' ControlFlags.transNr=uint16(3); */
      rtControlState0_Y->ControlFlags.transNr = 3U;
    ...
    if (rtControlState0_U->GlobalConfig_in.FluxMapID &&
        (!rtControlState0_U->enteredFluxMapID) &&
        (rtControlState0_DW->finishedElectricalID_loc != 0) &&
        (rtControlState0_DW->finishedTwoMassID_loc != 0) &&
        (rtControlState0_DW->finishedFrictionID_loc != 0) &&
        (rtControlState0_DW->finishedFluxMapID_loc != 2) &&
        (!rtControlState0_U->finishedFluxMapID)) {
      /* '<S1>:709:51' ControlFlags.transNr=uint16(4); */
      rtControlState0_Y->ControlFlags.transNr = 4U;
  ...
  if ((rtControlState0_DW->finishedElectricalID_loc != 0) &&
      (rtControlState0_DW->finishedTwoMassID_loc != 0) &&
      (rtControlState0_DW->finishedFrictionID_loc != 0) &&
      (rtControlState0_DW->finishedFluxMapID_loc != 0)) {
    /* Outport: '<Root>/ControlFlags' */
    /* . */
    /* '<S1>:709:58' ControlFlags.finished_all_Offline_states = boolean(1); */
    rtControlState0_Y->ControlFlags.finished_all_Offline_states = true;
  }
}

/* Model step function */
void ControlState0_step(RT_MODEL_ControlState0_t *const rtControlState0_M)
{
  DW_ControlState0_t *rtControlState0_DW = rtControlState0_M->dwork;
  ExtU_ControlState0_t *rtControlState0_U = (ExtU_ControlState0_t *)
    rtControlState0_M->inputs;
  ExtY_ControlState0_t *rtControlState0_Y = (ExtY_ControlState0_t *)
    rtControlState0_M->outputs;
  ...
  /* During: ControlState */
  if (rtControlState0_DW->is_active_c8_ControlState0 == 0U) {
    /* Entry: ControlState */
    rtControlState0_DW->is_active_c8_ControlState0 = 1U;

    /* Entry Internal: ControlState */
    /* Transition: '<S1>:731' */
    rtControlState0_DW->is_c8_ControlState0 = IN_Waiting;

    /* Entry 'Waiting': '<S1>:726' */
    /* '<S1>:726:3' initParams; */
    initParams(rtControlState0_U, rtControlState0_Y, rtControlState0_DW);

    /* wait for activation of */
    /* FrictionID */
    /* donothing */
  } else if (rtControlState0_DW->is_c8_ControlState0 == IN_ControlState) {
    ...
    /* . */
    if (rtControlState0_U->GlobalConfig_in.Reset ||
        (!rtControlState0_U->GlobalConfig_in.enableParameterID)) {
      /* Transition: '<S1>:722' */
      /* Exit Internal 'ControlState': '<S1>:39' */
      switch (rtControlState0_DW->is_ControlState) {
       case IN_activateElectricalID:
        /* Exit 'activateElectricalID': '<S1>:617' */
        rtControlState0_DW->is_ControlState = IN_NO_ACTIVE_CHILD;
        break;
      ...
      rtControlState0_Y->GlobalConfig_out.Reset =
        rtControlState0_U->GlobalConfig_in.Reset;

      /* '<S1>:39:5' GlobalConfig_out.ACCEPT = GlobalConfig_in.ACCEPT; */
      rtControlState0_Y->GlobalConfig_out.ACCEPT =
        rtControlState0_U->GlobalConfig_in.ACCEPT;

      /* '<S1>:39:6' GlobalConfig_out.enableParameterID = GlobalConfig_in.enableParameterID; */
      rtControlState0_Y->GlobalConfig_out.enableParameterID =
        rtControlState0_U->GlobalConfig_in.enableParameterID;

      /* '<S1>:39:7' GlobalConfig_out.ElectricalID = GlobalConfig_in.ElectricalID; */
      rtControlState0_Y->GlobalConfig_out.ElectricalID =
        rtControlState0_U->GlobalConfig_in.ElectricalID;

      /* '<S1>:39:8' GlobalConfig_out.FrictionID = GlobalConfig_in.FrictionID */
      rtControlState0_Y->GlobalConfig_out.FrictionID =
        rtControlState0_U->GlobalConfig_in.FrictionID;

      /* '<S1>:39:9' GlobalConfig_out.TwoMassID = GlobalConfig_in.TwoMassID; */
      rtControlState0_Y->GlobalConfig_out.TwoMassID =
        rtControlState0_U->GlobalConfig_in.TwoMassID;

      /* '<S1>:39:10' GlobalConfig_out.FluxMapID = GlobalConfig_in.FluxMapID; */
      rtControlState0_Y->GlobalConfig_out.FluxMapID =
        rtControlState0_U->GlobalConfig_in.FluxMapID;

      /* '<S1>:39:11' GlobalConfig_out.OnlineID = GlobalConfig_in.OnlineID; */
      rtControlState0_Y->GlobalConfig_out.OnlineID =
        rtControlState0_U->GlobalConfig_in.OnlineID;

      /* '<S1>:39:12' GlobalConfig_out.sampleTimeISR = GlobalConfig_in.sampleTimeISR; */
      rtControlState0_Y->GlobalConfig_out.sampleTimeISR =
        rtControlState0_U->GlobalConfig_in.sampleTimeISR;
      switch (rtControlState0_DW->is_ControlState) {
       case IN_activateElectricalID:
        /* During 'activateElectricalID': '<S1>:617' */
        /* '<S1>:625:1' sf_internal_predicateOutput = enteredElectricalID==1; */
        if (rtControlState0_U->enteredElectricalID) {
          /* Transition: '<S1>:625' */
          /* Exit 'activateElectricalID': '<S1>:617' */
          rtControlState0_DW->is_ControlState = IN_duringElectricalID;
        ...
        } else if (!rtControlState0_U->GlobalConfig_in.ElectricalID) {
          /* Transition: '<S1>:718' */
          /* '<S1>:718:2' ControlFlags.transNr = 0 */
          rtControlState0_Y->ControlFlags.transNr = 0U;

          /* Exit 'activateElectricalID': '<S1>:617' */
          rtControlState0_DW->is_ControlState = IN_decideMotorID;
       ...
       case IN_activateFluxMapID:
        ...
        if (rtControlState0_U->enteredFluxMapID) {
          /* Transition: '<S1>:687' */
          /* Exit 'activateFluxMapID': '<S1>:684' */
          rtControlState0_DW->is_ControlState = IN_duringFluxMapID;
        ...
        } else if (!rtControlState0_U->GlobalConfig_in.FluxMapID) {
          /* Transition: '<S1>:715' */
       ...
       case IN_activateFrictionID:
        ...
        if (rtControlState0_U->enteredFrictionID) {
          /* Transition: '<S1>:653' */
          /* Exit 'activateFrictionID': '<S1>:655' */
          rtControlState0_DW->is_ControlState = IN_duringFrictionID;
        ...
        } else if (!rtControlState0_U->GlobalConfig_in.FrictionID) {
          /* Transition: '<S1>:716' */
       ...
       case IN_activateTwoMassID:
        ...
        if (rtControlState0_U->enteredTwoMassID) {
          /* Transition: '<S1>:633' */
          /* Exit 'activateTwoMassID': '<S1>:628' */
          rtControlState0_DW->is_ControlState = IN_duringTwoMassID;
        ...
        } else if (!rtControlState0_U->GlobalConfig_in.TwoMassID) {
          /* Transition: '<S1>:717' */
       ...
       case IN_decideMotorID:
        ...
        if ((rtControlState0_Y->ControlFlags.transNr == 1) &&
            (rtControlState0_DW->finishedElectricalID_loc == 0)) {
          /* Transition: '<S1>:618' */
          /* Exit 'decideMotorID': '<S1>:605' */
          rtControlState0_DW->is_ControlState = IN_activateElectricalID;

          /* Entry 'activateElectricalID': '<S1>:617' */
          /* '<S1>:617:3' ControlFlags.startElectricalID=boolean(1); */
          rtControlState0_Y->ControlFlags.startElectricalID = true;

          /* '<S1>:682:1' sf_internal_predicateOutput = ControlFlags.transNr==4 && finishedFluxMapID_loc==0; */
        } else if ((rtControlState0_Y->ControlFlags.transNr == 4) &&
                   (rtControlState0_DW->finishedFluxMapID_loc == 0)) {
          /* Transition: '<S1>:682' */
          /* Exit 'decideMotorID': '<S1>:605' */
          rtControlState0_DW->is_ControlState = IN_activateFluxMapID;

          /* Entry 'activateFluxMapID': '<S1>:684' */
          /* '<S1>:684:3' ControlFlags.startFluxMapID=boolean(1); */
          rtControlState0_Y->ControlFlags.startFluxMapID = true;

          /* '<S1>:672:1' sf_internal_predicateOutput = ControlFlags.transNr==2 && finishedTwoMassID_loc==0; */
        } else if ((rtControlState0_Y->ControlFlags.transNr == 2) &&
                   (rtControlState0_DW->finishedTwoMassID_loc == 0)) {
          /* Transition: '<S1>:672' */
          /* Exit 'decideMotorID': '<S1>:605' */
          rtControlState0_DW->is_ControlState = IN_activateTwoMassID;

          /* Entry 'activateTwoMassID': '<S1>:628' */
          /* '<S1>:628:3' ControlFlags.startTwoMassID=boolean(1); */
          rtControlState0_Y->ControlFlags.startTwoMassID = true;

          /* '<S1>:678:1' sf_internal_predicateOutput = ControlFlags.transNr==3 && finishedFrictionID_loc==0; */
        } else if ((rtControlState0_Y->ControlFlags.transNr == 3) &&
                   (rtControlState0_DW->finishedFrictionID_loc == 0)) {
          /* Transition: '<S1>:678' */
          /* Exit 'decideMotorID': '<S1>:605' */
          rtControlState0_DW->is_ControlState = IN_activateFrictionID;

          /* Entry 'activateFrictionID': '<S1>:655' */
          /* '<S1>:655:3' ControlFlags.startFrictionID=boolean(1); */
          rtControlState0_Y->ControlFlags.startFrictionID = true;
        } else {
          /* '<S1>:605:4' if (GlobalConfig_in.ACCEPT == 1) */
          if (rtControlState0_U->GlobalConfig_in.ACCEPT) {
            /* '<S1>:605:5' decideIDstates; */
            decideIDstates(rtControlState0_U, rtControlState0_Y,
                           rtControlState0_DW);
          }
          ...
          if (rtControlState0_Y->ControlFlags.finished_all_Offline_states &&
              rtControlState0_U->GlobalConfig_in.OnlineID &&
              (!rtControlState0_U->enteredOnlineID)) {
            /* '<S1>:605:8' ControlFlags.enableOnlineID=boolean(1); */
            rtControlState0_Y->ControlFlags.enableOnlineID = true;
          } else if (rtControlState0_Y->ControlFlags.finished_all_Offline_states
                     && (!rtControlState0_U->GlobalConfig_in.OnlineID) &&
                     rtControlState0_U->enteredOnlineID) {
       ...
       case IN_duringElectricalID:
        ...
        if (rtControlState0_U->finishedElectricalID) {
          /* Transition: '<S1>:627' */
          /* Exit 'duringElectricalID': '<S1>:624' */
          rtControlState0_DW->is_ControlState = IN_finishedElectricalID;
          ...
          rtControlState0_Y->GlobalConfig_out.PMSM_config.Ld_Henry =
            rtControlState0_U->ElectricalID_output.PMSM_parameters.Ld_Henry;

          /* '<S1>:624:6' GlobalConfig_out.PMSM_config.Lq_Henry=ElectricalID_output.PMSM_parameters.Lq_Henry; */
          rtControlState0_Y->GlobalConfig_out.PMSM_config.Lq_Henry =
            rtControlState0_U->ElectricalID_output.PMSM_parameters.Lq_Henry;

          /* '<S1>:624:7' GlobalConfig_out.PMSM_config.R_ph_Ohm=ElectricalID_output.PMSM_parameters.R_ph_Ohm; */
          rtControlState0_Y->GlobalConfig_out.PMSM_config.R_ph_Ohm =
            rtControlState0_U->ElectricalID_output.PMSM_parameters.R_ph_Ohm;

          /* '<S1>:624:8' GlobalConfig_out.PMSM_config.Psi_PM_Vs=ElectricalID_output.PMSM_parameters.Psi_PM_Vs; */
          rtControlState0_Y->GlobalConfig_out.PMSM_config.Psi_PM_Vs =
            rtControlState0_U->ElectricalID_output.PMSM_parameters.Psi_PM_Vs;

          /* '<S1>:624:9' GlobalConfig_out.PMSM_config.polePairs=ElectricalID_output.PMSM_parameters.polePairs; */
          rtControlState0_Y->GlobalConfig_out.PMSM_config.polePairs =
            rtControlState0_U->ElectricalID_output.PMSM_parameters.polePairs;

          /* '<S1>:624:10' GlobalConfig_out.PMSM_config.J_kg_m_squared=.... */
          /* '<S1>:624:11'     ElectricalID_output.PMSM_parameters.J_kg_m_squared; */
          rtControlState0_Y->GlobalConfig_out.PMSM_config.J_kg_m_squared =
            rtControlState0_U->ElectricalID_output.PMSM_parameters.J_kg_m_squared;

          /* . */
          /* '<S1>:624:12' GlobalConfig_out.Kp_id=ElectricalID_FOC_output.Kp_id_out; */
          rtControlState0_Y->GlobalConfig_out.Kp_id =
            rtControlState0_U->ElectricalID_FOC_output.Kp_id_out;

          /* '<S1>:624:13' GlobalConfig_out.Kp_iq=ElectricalID_FOC_output.Kp_iq_out; */
          rtControlState0_Y->GlobalConfig_out.Kp_iq =
            rtControlState0_U->ElectricalID_FOC_output.Kp_iq_out;

          /* '<S1>:624:14' GlobalConfig_out.Kp_n=ElectricalID_FOC_output.Kp_n_out; */
          rtControlState0_Y->GlobalConfig_out.Kp_n =
            rtControlState0_U->ElectricalID_FOC_output.Kp_n_out;

          /* '<S1>:624:15' GlobalConfig_out.Ki_id=ElectricalID_FOC_output.Ki_id_out; */
          rtControlState0_Y->GlobalConfig_out.Ki_id =
            rtControlState0_U->ElectricalID_FOC_output.Ki_id_out;

          /* '<S1>:624:16' GlobalConfig_out.Ki_iq=ElectricalID_FOC_output.Ki_iq_out; */
          rtControlState0_Y->GlobalConfig_out.Ki_iq =
            rtControlState0_U->ElectricalID_FOC_output.Ki_iq_out;

          /* '<S1>:624:17' GlobalConfig_out.Ki_n=ElectricalID_FOC_output.Ki_n_out; */
          rtControlState0_Y->GlobalConfig_out.Ki_n =
            rtControlState0_U->ElectricalID_FOC_output.Ki_n_out;

          /* '<S1>:624:18' GlobalConfig_out.PMSM_6ph_inductances = ElectricalID_output.inductances_6ph; */
          rtControlState0_Y->GlobalConfig_out.PMSM_6ph_inductances =
            rtControlState0_U->ElectricalID_output.inductances_6ph;
        }
        break;
       ...
       case IN_duringFluxMapID:
        ...
        if (rtControlState0_U->finishedFluxMapID) {
          /* Transition: '<S1>:683' */
          /* Exit 'duringFluxMapID': '<S1>:685' */
          rtControlState0_DW->is_ControlState = IN_finishedFluxMapID;
       ...
       case IN_duringFrictionID:
        ...
        if (rtControlState0_U->finishedFrictionID) {
          /* Transition: '<S1>:652' */
          /* Exit 'duringFrictionID': '<S1>:656' */
          rtControlState0_DW->is_ControlState = IN_finishedFrictionID;
       ...
       case IN_duringTwoMassID:
        ...
        if (rtControlState0_U->finishedTwoMassID) {
          /* Transition: '<S1>:637' */
          /* Exit 'duringTwoMassID': '<S1>:632' */
          rtControlState0_DW->is_ControlState = IN_finishedTwoMassID;
    ...
    /* . */
  } else if (rtControlState0_U->GlobalConfig_in.enableParameterID &&
             (!rtControlState0_U->GlobalConfig_in.Reset)) {
    /* Transition: '<S1>:723' */
    rtControlState0_DW->is_c8_ControlState0 = IN_ControlState;
  ...
  } else if (rtControlState0_U->GlobalConfig_in.Reset) {
    /* Transition: '<S1>:725' */
    rtControlState0_DW->is_c8_ControlState0 = IN_Waiting;
...
void ControlState0_initialize(RT_MODEL_ControlState0_t *const rtControlState0_M)
{
  DW_ControlState0_t *rtControlState0_DW = rtControlState0_M->dwork;
  ExtY_ControlState0_t *rtControlState0_Y = (ExtY_ControlState0_t *)
    rtControlState0_M->outputs;
  ...
  /* states (dwork) */
  (void) memset((void *)rtControlState0_DW, 0,
                sizeof(DW_ControlState0_t));

  /* external inputs */
  (void)memset(rtControlState0_U, 0, sizeof(ExtU_ControlState0_t));

  /* external outputs */
  (void)memset(rtControlState0_Y, 0, sizeof(ExtY_ControlState0_t));
   ...
   */
  rtControlState0_DW->is_ControlState = IN_NO_ACTIVE_CHILD;
  rtControlState0_DW->is_active_c8_ControlState0 = 0U;
  rtControlState0_DW->is_c8_ControlState0 = IN_NO_ACTIVE_CHILD;
  rtControlState0_DW->finishedElectricalID_loc = 0U;
  rtControlState0_DW->finishedFrictionID_loc = 0U;
  rtControlState0_DW->finishedTwoMassID_loc = 0U;
  rtControlState0_DW->finishedFluxMapID_loc = 0U;
  rtControlState0_Y->GlobalConfig_out.PMSM_config.R_ph_Ohm = 0.0F;
  rtControlState0_Y->GlobalConfig_out.PMSM_config.Ld_Henry = 0.0F;
  rtControlState0_Y->GlobalConfig_out.PMSM_config.Lq_Henry = 0.0F;
  rtControlState0_Y->GlobalConfig_out.PMSM_config.Psi_PM_Vs = 0.0F;
  rtControlState0_Y->GlobalConfig_out.PMSM_config.polePairs = 0.0F;
  rtControlState0_Y->GlobalConfig_out.PMSM_config.J_kg_m_squared = 0.0F;
  rtControlState0_Y->GlobalConfig_out.PMSM_config.I_max_Ampere = 0.0F;
  rtControlState0_Y->GlobalConfig_out.PMSM_6ph_inductances.d = 0.0F;
  rtControlState0_Y->GlobalConfig_out.PMSM_6ph_inductances.q = 0.0F;
  rtControlState0_Y->GlobalConfig_out.PMSM_6ph_inductances.x = 0.0F;
  rtControlState0_Y->GlobalConfig_out.PMSM_6ph_inductances.y = 0.0F;
  rtControlState0_Y->GlobalConfig_out.PMSM_6ph_inductances.z1 = 0.0F;
  rtControlState0_Y->GlobalConfig_out.PMSM_6ph_inductances.z2 = 0.0F;
  rtControlState0_Y->GlobalConfig_out.enableParameterID = false;
  rtControlState0_Y->GlobalConfig_out.Reset = false;
  rtControlState0_Y->GlobalConfig_out.Kp_id = 0.0F;
  rtControlState0_Y->GlobalConfig_out.Kp_iq = 0.0F;
  rtControlState0_Y->GlobalConfig_out.Kp_n = 0.0F;
  rtControlState0_Y->GlobalConfig_out.Ki_id = 0.0F;
  rtControlState0_Y->GlobalConfig_out.Ki_iq = 0.0F;
  rtControlState0_Y->GlobalConfig_out.Ki_n = 0.0F;
  rtControlState0_Y->GlobalConfig_out.ElectricalID = false;
  rtControlState0_Y->GlobalConfig_out.FrictionID = false;
  rtControlState0_Y->GlobalConfig_out.TwoMassID = false;
  rtControlState0_Y->GlobalConfig_out.FluxMapID = false;
  rtControlState0_Y->GlobalConfig_out.OnlineID = false;
  rtControlState0_Y->GlobalConfig_out.ACCEPT = false;
  rtControlState0_Y->GlobalConfig_out.sampleTimeISR = 0.0F;
  rtControlState0_Y->GlobalConfig_out.ratCurrent = 0.0F;
  rtControlState0_Y->GlobalConfig_out.ratSpeed = 0.0F;
  rtControlState0_Y->GlobalConfig_out.i_dq_ref.d = 0.0F;
  rtControlState0_Y->GlobalConfig_out.i_dq_ref.q = 0.0F;
  rtControlState0_Y->GlobalConfig_out.i_dq_ref.zero = 0.0F;
  rtControlState0_Y->GlobalConfig_out.n_ref = 0.0F;
  rtControlState0_Y->GlobalConfig_out.voltage_measurement_C = 0.0F;
  rtControlState0_Y->GlobalConfig_out.voltage_measurement_Rp = 0.0F;
  rtControlState0_Y->GlobalConfig_out.voltage_measurement_Rs = 0.0F;
  rtControlState0_Y->ControlFlags.startFrictionID = false;
  rtControlState0_Y->ControlFlags.startElectricalID = false;
  rtControlState0_Y->ControlFlags.startTwoMassID = false;
  rtControlState0_Y->ControlFlags.startFluxMapID = false;
