...
reg   [8:0] p_accumulator_offset_read_reg_138;
reg    ap_block_state1;
reg   [31:0] l_parBlocks_reg_143;
reg   [0:0] p_initZero_read_reg_148;
wire   [31:0] add_ln410_fu_107_p2;
reg   [31:0] add_ln410_reg_156;
wire    ap_CS_fsm_state2;
reg   [8:0] p_accumulator_addr_reg_161;
wire   [0:0] icmp_ln410_fu_102_p2;
...
wire   [8:0] trunc_ln410_fu_113_p1;
wire   [8:0] sum_i_fu_117_p2;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln410_fu_102_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
assign add_ln410_fu_107_p2 = (i_reg_87 + 32'd1);
...
assign icmp_ln410_fu_102_p2 = ((i_reg_87 == l_parBlocks_reg_143) ? 1'b1 : 1'b0);
...
assign sum_i_fu_117_p2 = (p_accumulator_offset_read_reg_138 + trunc_ln410_fu_113_p1);

assign trunc_ln410_fu_113_p1 = i_reg_87[8:0];
