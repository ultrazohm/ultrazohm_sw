...
void        uz_TempCard_IF_hw_writeReg(uint32_t base_address,uint32_t B);           // write one Register
uint32_t    uz_TempCard_IF_hw_readReg(uint32_t base_address);                       // read one Register
void        uz_TempCard_IF_hw_writeCounterReg(uint32_t base_address,uint32_t B);    // write the Counter Register
int32_t     uz_TempCard_IF_hw_readCounterReg(uint32_t base_address);                // read the Counter Register

//Register-specified
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_A_0(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_A_1(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_A_2(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_A_3(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_A_4(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_A_5(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_A_6(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_A_7(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_A_8(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_A_9(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_A_10(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_A_11(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_A_12(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_A_13(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_A_14(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_A_15(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_A_16(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_A_17(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_A_18(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_A_19(uint32_t base_address);
...
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_B_0(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_B_1(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_B_2(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_B_3(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_B_4(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_B_5(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_B_6(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_B_7(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_B_8(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_B_9(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_B_10(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_B_11(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_B_12(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_B_13(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_B_14(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_B_15(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_B_16(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_B_17(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_B_18(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_B_19(uint32_t base_address);
...
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_C_0(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_C_1(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_C_2(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_C_3(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_C_4(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_C_5(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_C_6(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_C_7(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_C_8(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_C_9(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_C_10(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_C_11(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_C_12(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_C_13(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_C_14(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_C_15(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_C_16(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_C_17(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_C_18(uint32_t base_address);
int32_t     uz_TempCard_IF_hw_readReg_TempCard_IF_Result_C_19(uint32_t base_address);
