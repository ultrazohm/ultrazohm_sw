-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/inc_enc_v26/Incremental_Encoder_v26_src_Counter_Theta_el_wOffset.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Incremental_Encoder_v26_src_Counter_Theta_el_wOffset
-- Source Path: inc_enc_v26/IncEnc_V26/Counter_Theta_el_wOffset
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Incremental_Encoder_v26_src_Counter_Theta_el_wOffset IS
...
END Incremental_Encoder_v26_src_Counter_Theta_el_wOffset;


ARCHITECTURE rtl OF Incremental_Encoder_v26_src_Counter_Theta_el_wOffset IS
  ...
  SIGNAL Position_offset_unsigned         : unsigned(15 DOWNTO 0);  -- uint16
  SIGNAL Reset_unsigned                   : unsigned(7 DOWNTO 0);  -- uint8
  SIGNAL reset_old7_out1                  : unsigned(15 DOWNTO 0);  -- uint16
  SIGNAL reset_old7_out1_dtc              : signed(15 DOWNTO 0);  -- int16
  SIGNAL reset_old5_out1_dtc              : signed(15 DOWNTO 0);  -- int16
  SIGNAL Constant1_out1_dtc               : unsigned(15 DOWNTO 0);  -- uint16
...
BEGIN
  ...
  Position_offset_unsigned <= unsigned(Position_offset);

  Reset_unsigned <= unsigned(Reset);

  reset_old7_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        reset_old7_out1 <= to_unsigned(16#0000#, 16);
      ELSIF enb = '1' THEN
        reset_old7_out1 <= Position_offset_unsigned;
      END IF;
    END IF;
  END PROCESS reset_old7_process;


  reset_old7_out1_dtc <= signed(reset_old7_out1);
  ...
  Relational_Operator1_relop1 <= '1' WHEN Resett_switch3_out1 <= Constant1_out1 ELSE
      '0';
