-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\ELSYS_PC\Documents\repos\ultrazohm_sw\ip_cores\uz_EnDat_IPCore\hdl_prj\hdlsrc\UZ_EnDat\uz_EnDat_src_nfp_convert_single_to_fix_16_En0.vhd
-- Created: 2023-11-03 19:32:40
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: uz_EnDat_src_nfp_convert_single_to_fix_16_En0
-- Source Path: UZ_EnDat/UZ_ENDAT/Subsystem1/Subsystem/nfp_convert_single_to_fix_16_En0
-- Hierarchy Level: 3
-- Model version: 2.127
-- 
...
ENTITY uz_EnDat_src_nfp_convert_single_to_fix_16_En0 IS
...
END uz_EnDat_src_nfp_convert_single_to_fix_16_En0;


ARCHITECTURE rtl OF uz_EnDat_src_nfp_convert_single_to_fix_16_En0 IS
  ...
  SIGNAL Bit_Set_out1                     : unsigned(39 DOWNTO 0);  -- ufix40_En24
  SIGNAL Switch2_out1_1                   : unsigned(39 DOWNTO 0);  -- ufix40_En24
...
BEGIN
  ...
  Compare_To_Zero1_out1_1 <= '1' WHEN Shift_Arithmetic1_out1 = to_unsigned(0, 40) ELSE
      '0';

  
  Compare_To_Zero_out1_1 <= '1' WHEN Data_Type_Conversion_out1 /= to_unsigned(0, 40) ELSE
      '0';
  ...
  Bit_Set_out1 <= Delay4_out1_1 OR to_unsigned(1, 40);
