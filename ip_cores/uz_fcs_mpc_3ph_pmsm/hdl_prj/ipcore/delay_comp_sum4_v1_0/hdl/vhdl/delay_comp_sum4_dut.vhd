-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_mpc_3ph\delay_comp_sum4_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: delay_comp_sum4_dut
-- Source Path: delay_comp_sum4/delay_comp_sum4_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END delay_comp_sum4_dut;


ARCHITECTURE rtl OF delay_comp_sum4_dut IS

  -- Component Declarations
  COMPONENT delay_comp_sum4_src_delay_comp_sum4
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : delay_comp_sum4_src_delay_comp_sum4
    USE ENTITY work.delay_comp_sum4_src_delay_comp_sum4(rtl);
...
BEGIN
  u_delay_comp_sum4_src_delay_comp_sum4 : delay_comp_sum4_src_delay_comp_sum4
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
