-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\valen\Documents\repos\UZ\ultrazohm_sw\ip_cores\uz_ninephase_VSD_transformation\hdl_proj\hdlsrc\uz_ninephase_VSD_transformation\uz_ninephase_VSD_transformation.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_ninephase_VSD_transformation
-- Source Path: uz_ninephase_VSD_transformation
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_ninephase_VSD_transformation IS
  PORT( IPCORE_CLK                        :   IN    std_logic;  -- ufix1
        IPCORE_RESETN                     :   IN    std_logic;  -- ufix1
        x_in_dq_0                         :   IN    std_logic_vector(242 DOWNTO 0);  -- ufix243
        ...
        x_abc3_ll_pl_0                    :   IN    std_logic_vector(80 DOWNTO 0);  -- ufix81
        ...
        x_abc_3_0                         :   OUT   std_logic_vector(80 DOWNTO 0);  -- ufix81
        x_out_dq_0                        :   OUT   std_logic_vector(242 DOWNTO 0);  -- ufix243
...
END uz_ninephase_VSD_transformation;


ARCHITECTURE rtl OF uz_ninephase_VSD_transformation IS

  -- Component Declarations
  COMPONENT uz_ninephase_VSD_transformation_reset_sync
  ...
  COMPONENT uz_ninephase_VSD_transformation_axi4
  ...
  COMPONENT uz_ninephase_VSD_transformation_dut
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
  ...
  FOR ALL : uz_ninephase_VSD_transformation_reset_sync
    USE ENTITY work.uz_ninephase_VSD_transformation_reset_sync(rtl);

  FOR ALL : uz_ninephase_VSD_transformation_axi4
    USE ENTITY work.uz_ninephase_VSD_transformation_axi4(rtl);

  FOR ALL : uz_ninephase_VSD_transformation_dut
    USE ENTITY work.uz_ninephase_VSD_transformation_dut(rtl);

  -- Signals
  SIGNAL reset                            : std_logic;
  SIGNAL ip_timestamp                     : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL reset_cm                         : std_logic;  -- ufix1
  SIGNAL x_in_dq_0_unsigned               : unsigned(242 DOWNTO 0);  -- ufix243
  SIGNAL x_in_dq_0_slice                  : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL x_in_dq_0_sig                    : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL x_in_dq_0_unsigned_1             : unsigned(242 DOWNTO 0);  -- ufix243
  SIGNAL x_in_dq_0_slice_1                : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL x_in_dq_1_sig                    : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL x_in_dq_0_unsigned_2             : unsigned(242 DOWNTO 0);  -- ufix243
  SIGNAL x_in_dq_0_slice_2                : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL x_in_dq_2_sig                    : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL x_in_dq_0_unsigned_3             : unsigned(242 DOWNTO 0);  -- ufix243
  SIGNAL x_in_dq_0_slice_3                : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL x_in_dq_3_sig                    : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL x_in_dq_0_unsigned_4             : unsigned(242 DOWNTO 0);  -- ufix243
  SIGNAL x_in_dq_0_slice_4                : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL x_in_dq_4_sig                    : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL x_in_dq_0_unsigned_5             : unsigned(242 DOWNTO 0);  -- ufix243
  SIGNAL x_in_dq_0_slice_5                : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL x_in_dq_5_sig                    : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL x_in_dq_0_unsigned_6             : unsigned(242 DOWNTO 0);  -- ufix243
  SIGNAL x_in_dq_0_slice_6                : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL x_in_dq_6_sig                    : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL x_in_dq_0_unsigned_7             : unsigned(242 DOWNTO 0);  -- ufix243
  SIGNAL x_in_dq_0_slice_7                : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL x_in_dq_7_sig                    : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL x_in_dq_0_unsigned_8             : unsigned(242 DOWNTO 0);  -- ufix243
  SIGNAL x_in_dq_0_slice_8                : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL x_in_dq_8_sig                    : signed(26 DOWNTO 0);  -- sfix27_En18
  ...
  SIGNAL x_abc3_ll_pl_0_unsigned          : unsigned(80 DOWNTO 0);  -- ufix81
  SIGNAL x_abc3_ll_pl_0_slice             : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL x_abc3_ll_pl_0_sig               : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL x_abc3_ll_pl_0_slice_1           : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL x_abc3_ll_pl_1_sig               : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL x_abc3_ll_pl_0_slice_2           : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL x_abc3_ll_pl_2_sig               : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL reset_internal                   : std_logic;  -- ufix1
  SIGNAL reset_before_sync                : std_logic;  -- ufix1
  SIGNAL read_x_abc_out_axi_vec           : vector_of_std_logic_vector27(0 TO 8);  -- ufix27 [9]
  ...
  SIGNAL x_abc_3_2_sig_signed             : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL x_abc_3_1_sig_signed             : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL x_abc_3_0_sig_signed             : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL x_abc_3_0_tmp                    : unsigned(80 DOWNTO 0);  -- ufix81
  SIGNAL x_out_dq_8_sig_signed            : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL x_out_dq_7_sig_signed            : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL x_out_dq_6_sig_signed            : signed(26 DOWNTO 0);  -- sfix27_En16
  ...
  SIGNAL x_out_dq_0_tmp                   : unsigned(242 DOWNTO 0);  -- ufix243

BEGIN
  u_uz_ninephase_VSD_transformation_reset_sync_inst : uz_ninephase_VSD_transformation_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_uz_ninephase_VSD_transformation_axi4_inst : uz_ninephase_VSD_transformation_axi4
    PORT MAP( reset => reset,
              ...
              read_x_abc_out_axi => read_x_abc_out_axi_vec,  -- sfix27_En18 [9]
  ...
  u_uz_ninephase_VSD_transformation_dut_inst : uz_ninephase_VSD_transformation_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              ...
              x_in_dq_6 => std_logic_vector(x_in_dq_6_sig),  -- sfix27_En18
              x_in_dq_7 => std_logic_vector(x_in_dq_7_sig),  -- sfix27_En18
              x_in_dq_8 => std_logic_vector(x_in_dq_8_sig),  -- sfix27_En18
              ...
              x_abc3_ll_pl_0 => std_logic_vector(x_abc3_ll_pl_0_sig),  -- sfix27_En16
              x_abc3_ll_pl_1 => std_logic_vector(x_abc3_ll_pl_1_sig),  -- sfix27_En16
              x_abc3_ll_pl_2 => std_logic_vector(x_abc3_ll_pl_2_sig),  -- sfix27_En16
              ...
              x_abc_out_axi_6 => read_x_abc_out_axi_vec(6),  -- sfix27_En18
              x_abc_out_axi_7 => read_x_abc_out_axi_vec(7),  -- sfix27_En18
              x_abc_out_axi_8 => read_x_abc_out_axi_vec(8),  -- sfix27_En18
  ...
  ip_timestamp <= unsigned'(X"83BC88E1");
  ...
  x_in_dq_0_unsigned_6 <= unsigned(x_in_dq_0);

  x_in_dq_0_slice_6 <= x_in_dq_0_unsigned_6(188 DOWNTO 162);

  x_in_dq_6_sig <= signed(x_in_dq_0_slice_6);

  x_in_dq_0_unsigned_7 <= unsigned(x_in_dq_0);

  x_in_dq_0_slice_7 <= x_in_dq_0_unsigned_7(215 DOWNTO 189);

  x_in_dq_7_sig <= signed(x_in_dq_0_slice_7);

  x_in_dq_0_unsigned_8 <= unsigned(x_in_dq_0);

  x_in_dq_0_slice_8 <= x_in_dq_0_unsigned_8(242 DOWNTO 216);

  x_in_dq_8_sig <= signed(x_in_dq_0_slice_8);
  ...
  x_abc3_ll_pl_0_unsigned <= unsigned(x_abc3_ll_pl_0);

  x_abc3_ll_pl_0_slice <= x_abc3_ll_pl_0_unsigned(26 DOWNTO 0);

  x_abc3_ll_pl_0_sig <= signed(x_abc3_ll_pl_0_slice);

  x_abc3_ll_pl_0_slice_1 <= x_abc3_ll_pl_0_unsigned(53 DOWNTO 27);

  x_abc3_ll_pl_1_sig <= signed(x_abc3_ll_pl_0_slice_1);

  x_abc3_ll_pl_0_slice_2 <= x_abc3_ll_pl_0_unsigned(80 DOWNTO 54);

  x_abc3_ll_pl_2_sig <= signed(x_abc3_ll_pl_0_slice_2);
  ...
  x_abc_3_2_sig_signed <= signed(x_abc_3_2_sig);

  x_abc_3_1_sig_signed <= signed(x_abc_3_1_sig);

  x_abc_3_0_sig_signed <= signed(x_abc_3_0_sig);

  x_abc_3_0_tmp <= unsigned(x_abc_3_2_sig_signed) & unsigned(x_abc_3_1_sig_signed) & unsigned(x_abc_3_0_sig_signed);

  x_abc_3_0 <= std_logic_vector(x_abc_3_0_tmp);

  x_out_dq_8_sig_signed <= signed(x_out_dq_8_sig);

  x_out_dq_7_sig_signed <= signed(x_out_dq_7_sig);

  x_out_dq_6_sig_signed <= signed(x_out_dq_6_sig);
  ...
  x_out_dq_0_tmp <= unsigned(x_out_dq_8_sig_signed) & unsigned(x_out_dq_7_sig_signed) & unsigned(x_out_dq_6_sig_signed) & unsigned(x_out_dq_5_sig_signed) & unsigned(x_out_dq_4_sig_signed) & unsigned(x_out_dq_3_sig_signed) & unsigned(x_out_dq_2_sig_signed) & unsigned(x_out_dq_1_sig_signed) & unsigned(x_out_dq_0_sig_signed);
