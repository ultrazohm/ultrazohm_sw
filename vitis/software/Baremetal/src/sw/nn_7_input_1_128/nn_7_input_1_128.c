...
// for 9 observations
float x_9[NUMBER_OF_INPUTS_7N] = {0};
static float w_1_9[NUMBER_OF_INPUTS_7N * NUMBER_OF_NEURONS_IN_HIDDEN_LAYER] = {
...
struct uz_nn_layer_config config_9nn[2] = {
    [0] = {
        ...
        .bias = b_1_9,
        .output = y_1_9},
    [1] = {.activation_function = activation_tanh, .number_of_neurons = NUMBER_OF_OUTPUTS, .number_of_inputs = NUMBER_OF_NEURONS_IN_HIDDEN_LAYER, .length_of_weights = UZ_MATRIX_SIZE(w_2_9), .length_of_bias = UZ_MATRIX_SIZE(b_2_9), .length_of_output = UZ_MATRIX_SIZE(y_2_9), .weights = w_2_9, .bias = b_2_9, .output = y_2_9}};
...
void nn_7_input_1_128_init(void)
{

    Global_Data.objects.matrix_input_7n = uz_matrix_init(&input_matrix_9n, x_9, UZ_MATRIX_SIZE(x_9), 1U, NUMBER_OF_INPUTS_7N);
    Global_Data.objects.nn_layer_7n = uz_nn_init(config_9nn, 2U);
}
