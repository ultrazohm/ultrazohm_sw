-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Encoder_Zynq\IncreEncoder_V17_ipcore_src_IncreEncoder_V17.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IncreEncoder_V17_ipcore_src_IncreEncoder_V17
-- Source Path: Encoder_Zynq/IncreEncoder_V17
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
USE work.IncreEncoder_V17_ipcore_src_IncreEncoder_V17_pkg.ALL;

ENTITY IncreEncoder_V17_ipcore_src_IncreEncoder_V17 IS
...
END IncreEncoder_V17_ipcore_src_IncreEncoder_V17;


ARCHITECTURE rtl OF IncreEncoder_V17_ipcore_src_IncreEncoder_V17 IS

  -- Component Declarations
  COMPONENT IncreEncoder_V17_ipcore_src_Counter_speed
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  COMPONENT IncreEncoder_V17_ipcore_src_n_aus_theta
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT IncreEncoder_V17_ipcore_src_Check_Direction
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          A                               :   IN    std_logic;
  ...
  COMPONENT IncreEncoder_V17_ipcore_src_Counter_theta_ele
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          Enable_ctr                      :   IN    std_logic;
  ...
  COMPONENT IncreEncoder_V17_ipcore_src_Counter_theta
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          Enable_ctr                      :   IN    std_logic;
  ...
  FOR ALL : IncreEncoder_V17_ipcore_src_Counter_speed
    USE ENTITY work.IncreEncoder_V17_ipcore_src_Counter_speed(rtl);

  FOR ALL : IncreEncoder_V17_ipcore_src_n_aus_theta
    USE ENTITY work.IncreEncoder_V17_ipcore_src_n_aus_theta(rtl);

  FOR ALL : IncreEncoder_V17_ipcore_src_Check_Direction
    USE ENTITY work.IncreEncoder_V17_ipcore_src_Check_Direction(rtl);

  FOR ALL : IncreEncoder_V17_ipcore_src_Counter_theta_ele
    USE ENTITY work.IncreEncoder_V17_ipcore_src_Counter_theta_ele(rtl);

  FOR ALL : IncreEncoder_V17_ipcore_src_Counter_theta
    USE ENTITY work.IncreEncoder_V17_ipcore_src_Counter_theta(rtl);
...
BEGIN
  -- <S2>/Counter_speed
  u_Counter_speed : IncreEncoder_V17_ipcore_src_Counter_speed
    PORT MAP( clk => clk,
              reset => reset,
  ...
  -- <S2>/n_aus_theta
  u_n_aus_theta : IncreEncoder_V17_ipcore_src_n_aus_theta
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_2_0 => clk_enable,
              count => Counter_speed_out1,  -- uint16
  ...
  -- <S2>/Check_Direction
  u_Check_Direction : IncreEncoder_V17_ipcore_src_Check_Direction
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_2_0 => clk_enable,
              A => A,
  ...
  u_Counter_theta_ele : IncreEncoder_V17_ipcore_src_Counter_theta_ele
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_2_0 => clk_enable,
  ...
  -- <S2>/Counter_theta
  u_Counter_theta : IncreEncoder_V17_ipcore_src_Counter_theta
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_2_0 => clk_enable,
              Enable_ctr => Logical1_out1_1,
  ...
  -- <S2>/IncrementePerTurn_speed
  IncrementePerTurn_speed_out1 <= to_unsigned(16#09C4#, 16);

  -- <S2>/HardwareTimer_FPGA_in_ms
  ...
  -- <S2>/IncrementePerTurn_elek
  IncrementePerTurn_elek_out1 <= to_unsigned(16#09C4#, 16);
