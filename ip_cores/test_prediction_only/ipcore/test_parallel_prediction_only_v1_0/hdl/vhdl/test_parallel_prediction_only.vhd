-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\test_prediction_only\hdlsrc\parallel_prediction_and_cost_function_6phase\test_parallel_prediction_only.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: test_parallel_prediction_only
-- Source Path: test_parallel_prediction_only
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY test_parallel_prediction_only IS
...
END test_parallel_prediction_only;


ARCHITECTURE rtl OF test_parallel_prediction_only IS

  -- Component Declarations
  COMPONENT test_parallel_prediction_only_reset_sync
  ...
  COMPONENT test_parallel_prediction_only_axi_lite
  ...
  COMPONENT test_parallel_prediction_only_dut
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
  ...
  FOR ALL : test_parallel_prediction_only_reset_sync
    USE ENTITY work.test_parallel_prediction_only_reset_sync(rtl);

  FOR ALL : test_parallel_prediction_only_axi_lite
    USE ENTITY work.test_parallel_prediction_only_axi_lite(rtl);

  FOR ALL : test_parallel_prediction_only_dut
    USE ENTITY work.test_parallel_prediction_only_dut(rtl);
...
BEGIN
  u_test_parallel_prediction_only_reset_sync_inst : test_parallel_prediction_only_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_test_parallel_prediction_only_axi_lite_inst : test_parallel_prediction_only_axi_lite
  ...
  u_test_parallel_prediction_only_dut_inst : test_parallel_prediction_only_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  ip_timestamp <= unsigned'(X"83BBC530");
