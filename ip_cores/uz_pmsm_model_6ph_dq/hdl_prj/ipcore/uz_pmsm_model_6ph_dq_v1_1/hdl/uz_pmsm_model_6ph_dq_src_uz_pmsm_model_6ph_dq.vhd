-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/uz_pmsm_model_6ph_dq/uz_pmsm_model_6ph_dq_src_uz_pmsm_model_6ph_dq.vhd
-- Created: 2023-07-12 14:39:49
-- 
...
BEGIN
  ...
  u_nfp_mul_comp_19 : uz_pmsm_model_6ph_dq_src_nfp_mul_double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Data_Type_Conversion5_out1_2,  -- double
              nfp_in2 => Divide1_out1,  -- double
  ...
  u_nfp_mul_comp_31 : uz_pmsm_model_6ph_dq_src_nfp_mul_double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_32 : uz_pmsm_model_6ph_dq_src_nfp_mul_double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_100_1 = '1' THEN
        Delay1_lowered5_bypass_reg <= Delay1_toDel_1;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_100_1 = '1' THEN
        Delay1_lowered4_bypass_reg <= Delay1_toDel_5;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_100_1 = '1' THEN
        Delay1_lowered3_bypass_reg <= Delay1_toDel_7;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_100_1 = '1' THEN
        Delay1_lowered7_bypass_reg <= Delay1_toDel_13;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_100_1 = '1' THEN
        Delay1_lowered6_bypass_reg <= Delay1_toDel_15;
      END IF;
    END IF;
  ...
  Data_Type_Conversion8_out1_2(5) <= Data_Type_Conversion8_out1_1(5) WHEN enb_1_100_1 = '1' ELSE
      t2_bypass_reg(5);
  t2_bypass_reg_next(0) <= Data_Type_Conversion8_out1_1(0);
  t2_bypass_reg_next(1) <= Data_Type_Conversion8_out1_1(1);
  t2_bypass_reg_next(2) <= Data_Type_Conversion8_out1_1(2);
  t2_bypass_reg_next(3) <= Data_Type_Conversion8_out1_1(3);
  t2_bypass_reg_next(4) <= Data_Type_Conversion8_out1_1(4);
  t2_bypass_reg_next(5) <= Data_Type_Conversion8_out1_1(5);
