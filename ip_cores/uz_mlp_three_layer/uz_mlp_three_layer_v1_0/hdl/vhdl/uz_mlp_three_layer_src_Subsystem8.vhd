-- -------------------------------------------------------------
-- 
-- File Name: /home/ts/Documents/integrate_nn_to_uz/ultrazohm_sw/ip_cores/nnAXI_v1_0/hdl_prj/hdlsrc/uz_mlp_three_layer/uz_mlp_three_layer_src_Subsystem8.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_mlp_three_layer_src_Subsystem8
-- Source Path: uz_mlp_three_layer/uz_mlp_three_layer/LastLayer/Subsystem8
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_mlp_three_layer_src_Subsystem8 IS
...
END uz_mlp_three_layer_src_Subsystem8;


ARCHITECTURE rtl OF uz_mlp_three_layer_src_Subsystem8 IS

  -- Component Declarations
  COMPONENT uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block1
  ...
  COMPONENT uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block2
    GENERIC( AddrWidth                    : integer;
             DataWidth                    : integer
             );
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block1
    USE ENTITY work.uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block1(rtl);

  FOR ALL : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block2
    USE ENTITY work.uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block2(rtl);
...
BEGIN
  u_Dual_Port_RAM_System1 : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block1
  ...
  u_Dual_Port_RAM_System3 : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block2
    GENERIC MAP( AddrWidth => 10,
                 DataWidth => 32
                 )
    PORT MAP( clk => clk,
