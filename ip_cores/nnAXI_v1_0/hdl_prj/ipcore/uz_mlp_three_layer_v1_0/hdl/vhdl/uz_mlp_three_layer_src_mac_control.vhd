-- -------------------------------------------------------------
-- 
-- File Name: /home/ts/Documents/integrate_nn_to_uz/ultrazohm_sw/ip_cores/nnAXI_v1_0/hdl_prj/hdlsrc/uz_mlp_three_layer/uz_mlp_three_layer_src_mac_control.vhd
...
-- Source Path: uz_mlp_three_layer/pcu_mlp2_8parallel/LastLayer/StateMachines/mac_control
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        --Entry: pcu_mlp2_8parallel/LastLayer/StateMachines/mac_control
        --Entry Internal: pcu_mlp2_8parallel/LastLayer/StateMachines/mac_control
        --Transition
  ...
  BEGIN
    ...
    --Gateway: pcu_mlp2_8parallel/LastLayer/StateMachines/mac_control
    --During: pcu_mlp2_8parallel/LastLayer/StateMachines/mac_control
