...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x10 axi_referenceValue W 0x0 "Data signal of axi_referenceValue" {{0 32 axi_referenceValue W 0 "Bit 31 to 0 of axi_referenceValue"}}} {0x18 axi_sampletime W 0x0 "Data signal of axi_sampletime" {{0 32 axi_sampletime W 0 "Bit 31 to 0 of axi_sampletime"}}} {0x20 axi_KI W 0x0 "Data signal of axi_KI" {{0 32 axi_KI W 0 "Bit 31 to 0 of axi_KI"}}} {0x28 axi_KP W 0x0 "Data signal of axi_KP" {{0 32 axi_KP W 0 "Bit 31 to 0 of axi_KP"}}} {0x30 axi_limit W 0x0 "Data signal of axi_limit" {{0 32 axi_limit W 0 "Bit 31 to 0 of axi_limit"}}} {0x38 axi_reset W 0x0 "Data signal of axi_reset" {{0 1 axi_reset W 0 "Bit 0 to 0 of axi_reset"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
