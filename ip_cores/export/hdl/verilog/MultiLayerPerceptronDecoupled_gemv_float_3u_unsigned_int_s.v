...
module MultiLayerPerceptronDecoupled_gemv_float_3u_unsigned_int_s (
        ap_start,
        start_full_n,
        start_out,
        start_write,
...
wire    gemv_float_3u_unsigned_int_entry6992_U0_ap_start;
wire    gemv_float_3u_unsigned_int_entry6992_U0_ap_done;
wire    gemv_float_3u_unsigned_int_entry6992_U0_ap_continue;
wire    gemv_float_3u_unsigned_int_entry6992_U0_ap_idle;
wire    gemv_float_3u_unsigned_int_entry6992_U0_ap_ready;
wire    gemv_float_3u_unsigned_int_entry6992_U0_p_m_read;
wire   [31:0] gemv_float_3u_unsigned_int_entry6992_U0_p_m_out_din;
wire    gemv_float_3u_unsigned_int_entry6992_U0_p_m_out_write;
wire    gemv_float_3u_unsigned_int_entry6992_U0_p_n_read;
wire   [31:0] gemv_float_3u_unsigned_int_entry6992_U0_p_m_c_i_din;
wire    gemv_float_3u_unsigned_int_entry6992_U0_p_m_c_i_write;
wire   [31:0] gemv_float_3u_unsigned_int_entry6992_U0_p_m_c9_i_din;
wire    gemv_float_3u_unsigned_int_entry6992_U0_p_m_c9_i_write;
wire   [31:0] gemv_float_3u_unsigned_int_entry6992_U0_p_n_c_i_din;
wire    gemv_float_3u_unsigned_int_entry6992_U0_p_n_c_i_write;
...
wire    ap_sync_done;
wire    ap_sync_ready;
reg    ap_sync_reg_gemv_float_3u_unsigned_int_entry6992_U0_ap_ready;
wire    ap_sync_gemv_float_3u_unsigned_int_entry6992_U0_ap_ready;
reg   [1:0] gemv_float_3u_unsigned_int_entry6992_U0_ap_ready_count;
...
wire    gemv_float_3u_unsigned_int_entry6992_U0_start_full_n;
wire    gemv_float_3u_unsigned_int_entry6992_U0_start_write;
...
#0 ap_sync_reg_gemv_float_3u_unsigned_int_entry6992_U0_ap_ready = 1'b0;
#0 gemv_float_3u_unsigned_int_entry6992_U0_ap_ready_count = 2'd0;
...
MultiLayerPerceptronDecoupled_gemv_float_3u_unsigned_int_entry6992 gemv_float_3u_unsigned_int_entry6992_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
MultiLayerPerceptronDecoupled_gemv_float_3u_unsigned_int_float_s gemv_float_3u_unsigned_int_float_U0(
...
MultiLayerPerceptronDecoupled_scal_float_1u_unsigned_int_s scal_float_1u_unsigned_int_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
MultiLayerPerceptronDecoupled_axpy_float_1u_unsigned_int_s axpy_float_1u_unsigned_int_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
MultiLayerPerceptronDecoupled_fifo_w32_d2_S_x0 p_m_c_i_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
MultiLayerPerceptronDecoupled_fifo_w32_d2_S_x0 p_m_c9_i_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
MultiLayerPerceptronDecoupled_fifo_w32_d2_S_x0 p_n_c_i_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
MultiLayerPerceptronDecoupled_fifo_w32_d2_S_x0 l_x_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
MultiLayerPerceptronDecoupled_fifo_w32_d2_S_x0 p_m_c10_i_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
MultiLayerPerceptronDecoupled_fifo_w32_d2_S_x0 l_y_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
MultiLayerPerceptronDecoupled_start_for_axpy_float_1u_unsigned_int_U0 start_for_axpy_float_1u_unsigned_int_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_sync_reg_gemv_float_3u_unsigned_int_entry6992_U0_ap_ready <= 1'b0;
    end else begin
...
always @ (posedge ap_clk) begin
    if (((gemv_float_3u_unsigned_int_entry6992_U0_ap_ready == 1'b0) & (ap_sync_ready == 1'b1))) begin
        gemv_float_3u_unsigned_int_entry6992_U0_ap_ready_count <= (gemv_float_3u_unsigned_int_entry6992_U0_ap_ready_count - 2'd1);
    end else if (((gemv_float_3u_unsigned_int_entry6992_U0_ap_ready == 1'b1) & (ap_sync_ready == 1'b0))) begin
        gemv_float_3u_unsigned_int_entry6992_U0_ap_ready_count <= (gemv_float_3u_unsigned_int_entry6992_U0_ap_ready_count + 2'd1);
    end
end
...
assign ap_idle = (scal_float_1u_unsigned_int_U0_ap_idle & gemv_float_3u_unsigned_int_float_U0_ap_idle & gemv_float_3u_unsigned_int_entry6992_U0_ap_idle & axpy_float_1u_unsigned_int_U0_ap_idle);

assign ap_ready = internal_ap_ready;

assign ap_sync_continue = (ap_sync_done & ap_continue);

assign ap_sync_done = (gemv_float_3u_unsigned_int_entry6992_U0_ap_done & axpy_float_1u_unsigned_int_U0_ap_done);

assign ap_sync_gemv_float_3u_unsigned_int_entry6992_U0_ap_ready = (gemv_float_3u_unsigned_int_entry6992_U0_ap_ready | ap_sync_reg_gemv_float_3u_unsigned_int_entry6992_U0_ap_ready);
...
assign ap_sync_ready = (ap_sync_scal_float_1u_unsigned_int_U0_ap_ready & ap_sync_gemv_float_3u_unsigned_int_float_U0_ap_ready & ap_sync_gemv_float_3u_unsigned_int_entry6992_U0_ap_ready);
...
assign gemv_float_3u_unsigned_int_entry6992_U0_ap_continue = ap_sync_continue;

assign gemv_float_3u_unsigned_int_entry6992_U0_ap_start = (real_start & (ap_sync_reg_gemv_float_3u_unsigned_int_entry6992_U0_ap_ready ^ 1'b1));

assign gemv_float_3u_unsigned_int_entry6992_U0_start_full_n = 1'b1;

assign gemv_float_3u_unsigned_int_entry6992_U0_start_write = 1'b0;
...
assign l_strBias9_read = scal_float_1u_unsigned_int_U0_l_strBias9_read;

assign l_strInput6_read = gemv_float_3u_unsigned_int_float_U0_p_x_read;

assign l_strMv8_din = axpy_float_1u_unsigned_int_U0_l_strMv8_din;

assign l_strMv8_write = axpy_float_1u_unsigned_int_U0_l_strMv8_write;

assign l_strWeights5_read = gemv_float_3u_unsigned_int_float_U0_p_M_read;

assign p_m_out_din = gemv_float_3u_unsigned_int_entry6992_U0_p_m_out_din;

assign p_m_out_write = gemv_float_3u_unsigned_int_entry6992_U0_p_m_out_write;

assign p_m_read = gemv_float_3u_unsigned_int_entry6992_U0_p_m_read;

assign p_n_read = gemv_float_3u_unsigned_int_entry6992_U0_p_n_read;
...
endmodule //MultiLayerPerceptronDecoupled_gemv_float_3u_unsigned_int_s
