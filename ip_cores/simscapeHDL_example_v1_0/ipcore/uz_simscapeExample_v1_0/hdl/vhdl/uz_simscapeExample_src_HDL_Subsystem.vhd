-- -------------------------------------------------------------
-- 
-- File Name: /home/ts/Dokumente/ultrazohm_testbench/ultrazohm_test/ultrazohm_sw/ip_cores/simscapeHDL_example_v1_0/hdlsrc/gmStateSpaceHDL_HalfWaveRectifier_HDL/uz_simscapeExample_src_HDL_Subsystem.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_simscapeExample_src_HDL_Subsystem
...
USE work.uz_simscapeExample_src_HDL_Subsystem_pkg.ALL;

ENTITY uz_simscapeExample_src_HDL_Subsystem IS
...
END uz_simscapeExample_src_HDL_Subsystem;


ARCHITECTURE rtl OF uz_simscapeExample_src_HDL_Subsystem IS

  -- Component Declarations
  COMPONENT uz_simscapeExample_src_HDL_Subsystem_tc
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          clk_enable                      :   IN    std_logic;
          enb                             :   OUT   std_logic;
  ...
  COMPONENT uz_simscapeExample_src_dot_product_1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT uz_simscapeExample_src_Subsystem1
  ...
  COMPONENT uz_simscapeExample_src_nfp_relop_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT uz_simscapeExample_src_Subsystem1_block
    GENERIC( Index                        : integer
             );
    PORT( In1                             :   IN    std_logic;
          In2                             :   IN    std_logic;  -- ufix1
  ...
  COMPONENT uz_simscapeExample_src_nfp_add_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          nfp_in1                         :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  FOR ALL : uz_simscapeExample_src_HDL_Subsystem_tc
    USE ENTITY work.uz_simscapeExample_src_HDL_Subsystem_tc(rtl);

  FOR ALL : uz_simscapeExample_src_dot_product_1
    USE ENTITY work.uz_simscapeExample_src_dot_product_1(rtl);

  FOR ALL : uz_simscapeExample_src_Subsystem1
    USE ENTITY work.uz_simscapeExample_src_Subsystem1(rtl);

  FOR ALL : uz_simscapeExample_src_nfp_relop_single
    USE ENTITY work.uz_simscapeExample_src_nfp_relop_single(rtl);

  FOR ALL : uz_simscapeExample_src_Subsystem1_block
    USE ENTITY work.uz_simscapeExample_src_Subsystem1_block(rtl);

  FOR ALL : uz_simscapeExample_src_nfp_add_single
    USE ENTITY work.uz_simscapeExample_src_nfp_add_single(rtl);
...
BEGIN
  u_HDL_Subsystem_tc : uz_simscapeExample_src_HDL_Subsystem_tc
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_dot_product_1 : uz_simscapeExample_src_dot_product_1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Subsystem2 : uz_simscapeExample_src_Subsystem1
    GENERIC MAP( Index => 1
                 )
  ...
  u_nfp_relop_comp : uz_simscapeExample_src_nfp_relop_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Subsystem1 : uz_simscapeExample_src_Subsystem1_block
    GENERIC MAP( Index => 0
                 )
    PORT MAP( In1 => Data_Type_Conversion_out1_1,
  ...
  u_dot_product_1_1 : uz_simscapeExample_src_dot_product_1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp : uz_simscapeExample_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_dot_product_1_2 : uz_simscapeExample_src_dot_product_1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp_1 : uz_simscapeExample_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_dot_product_1_3 : uz_simscapeExample_src_dot_product_1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_dot_product_1_4 : uz_simscapeExample_src_dot_product_1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp_2 : uz_simscapeExample_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_dot_product_1_5 : uz_simscapeExample_src_dot_product_1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp_3 : uz_simscapeExample_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
