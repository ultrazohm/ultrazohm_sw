...
#Analog_02
set_property PACKAGE_PIN AJ2 [get_ports 	A3_OUT_CNV_0		]
#ANL_02_P_Ch3 = B64_L21_P
set_property PACKAGE_PIN AK2 [get_ports 	A3_OUT_CNV_1		]
...
set_property IOSTANDARD LVCMOS18    [get_ports A3_OUT_CNV_0]
set_property IOSTANDARD LVCMOS18    [get_ports A3_OUT_CNV_1]
