-- -------------------------------------------------------------
-- 
-- File Name: uz_axi_testIP/hdlsrc/uz_axi_testIP/AXI_testI_ip_reset_sync.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: AXI_testI_ip_reset_sync
-- Source Path: AXI_testI_ip/AXI_testI_ip_reset_sync
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY AXI_testI_ip_reset_sync IS
  PORT( clk                               :   IN    std_logic;
        reset_in                          :   IN    std_logic;  -- ufix1
        reset_out                         :   OUT   std_logic  -- ufix1
        );
END AXI_testI_ip_reset_sync;


ARCHITECTURE rtl OF AXI_testI_ip_reset_sync IS
