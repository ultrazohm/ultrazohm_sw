-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\inc_enc_v25\Incremental_Encoder_src_calc_omega.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Incremental_Encoder_src_calc_omega
-- Source Path: inc_enc_v25/IncEnc_V25/speed/calc_omega
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Incremental_Encoder_src_calc_omega IS
...
END Incremental_Encoder_src_calc_omega;


ARCHITECTURE rtl OF Incremental_Encoder_src_calc_omega IS

  -- Component Declarations
  COMPONENT Incremental_Encoder_src_invt_mult
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Incremental_Encoder_src_invt_mult
    USE ENTITY work.Incremental_Encoder_src_invt_mult(rtl);
...
BEGIN
  ...
  u_invt_mult : Incremental_Encoder_src_invt_mult
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
