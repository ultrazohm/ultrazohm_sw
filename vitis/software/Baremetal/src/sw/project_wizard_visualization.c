...
void project_wizard_visualization_update(struct _DS_Data_* data)
{
    ...
    project_wizard_visualization_data.viz_inverter_adapter_d3_chip_temp_l2 = data->av.inverter_adapter_d3.ChipTempDegreesCelsius_L2;
    project_wizard_visualization_data.viz_inverter_adapter_d3_chip_temp_h3 = data->av.inverter_adapter_d3.ChipTempDegreesCelsius_H3;
    project_wizard_visualization_data.viz_inverter_adapter_d3_chip_temp_l3 = data->av.inverter_adapter_d3.ChipTempDegreesCelsius_L3;
    ...
    project_wizard_visualization_data.viz_inverter_adapter_d3_oc = ((float)data->av.inverter_adapter_d3.OC);
    project_wizard_visualization_data.viz_inverter_adapter_d3_oc_h1 = (data->av.inverter_adapter_d3.OC_H1 ? 1.0f : 0.0f);
    project_wizard_visualization_data.viz_inverter_adapter_d3_oc_l1 = (data->av.inverter_adapter_d3.OC_L1 ? 1.0f : 0.0f);
    project_wizard_visualization_data.viz_inverter_adapter_d3_oc_h2 = (data->av.inverter_adapter_d3.OC_H2 ? 1.0f : 0.0f);
    project_wizard_visualization_data.viz_inverter_adapter_d3_oc_l2 = (data->av.inverter_adapter_d3.OC_L2 ? 1.0f : 0.0f);
    project_wizard_visualization_data.viz_inverter_adapter_d3_oc_h3 = (data->av.inverter_adapter_d3.OC_H3 ? 1.0f : 0.0f);
    project_wizard_visualization_data.viz_inverter_adapter_d3_oc_l3 = (data->av.inverter_adapter_d3.OC_L3 ? 1.0f : 0.0f);
    project_wizard_visualization_data.viz_inverter_adapter_d3_fault = ((float)data->av.inverter_adapter_d3.FAULT);
}
