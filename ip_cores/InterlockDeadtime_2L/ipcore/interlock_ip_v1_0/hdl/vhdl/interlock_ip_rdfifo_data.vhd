-- -------------------------------------------------------------
-- 
-- File Name: /home/ts/Dokumente/ultrazohm_testbench/ultrazohm_sw/ip_cores/InterlockDeadtime_2L/hdlsrc/interlock_deadtime/interlock_ip_rdfifo_data.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: interlock_ip_rdfifo_data
-- Source Path: interlock_ip/interlock_ip_axi4/interlock_ip_axi4_module/interlock_ip_rdfifo_data
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY interlock_ip_rdfifo_data IS
...
END interlock_ip_rdfifo_data;


ARCHITECTURE rtl OF interlock_ip_rdfifo_data IS

  -- Component Declarations
  COMPONENT interlock_ip_SimpleDualPortRAM_generic
  ...
  FOR ALL : interlock_ip_SimpleDualPortRAM_generic
    USE ENTITY work.interlock_ip_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_interlock_ip_rdfifo_data_classic_ram_generic : interlock_ip_SimpleDualPortRAM_generic
