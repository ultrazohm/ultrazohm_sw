-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/inc_enc_v26/IncEnc_V2_ip_src_OS_factor_logic.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IncEnc_V2_ip_src_OS_factor_logic
...
ENTITY IncEnc_V2_ip_src_OS_factor_logic IS
...
END IncEnc_V2_ip_src_OS_factor_logic;


ARCHITECTURE rtl OF IncEnc_V2_ip_src_OS_factor_logic IS

  -- Component Declarations
  COMPONENT IncEnc_V2_ip_src_oversample_factor
  ...
  COMPONENT IncEnc_V2_ip_src_align_oversamples
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : IncEnc_V2_ip_src_oversample_factor
    USE ENTITY work.IncEnc_V2_ip_src_oversample_factor(rtl);

  FOR ALL : IncEnc_V2_ip_src_align_oversamples
    USE ENTITY work.IncEnc_V2_ip_src_align_oversamples(rtl);
...
BEGIN
  u_oversample_factor : IncEnc_V2_ip_src_oversample_factor
  ...
  u_align_oversamples : IncEnc_V2_ip_src_align_oversamples
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
