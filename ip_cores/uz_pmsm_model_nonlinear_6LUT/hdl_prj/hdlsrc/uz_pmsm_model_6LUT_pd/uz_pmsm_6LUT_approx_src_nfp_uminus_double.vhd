-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\Philipp\ultrazohm\ultrazohm_sw\ip_cores\uz_pmsm_model_nonlinear_6LUT\hdl_prj\hdlsrc\uz_pmsm_model_6LUT_pd\uz_pmsm_6LUT_approx_src_nfp_uminus_double.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_6LUT_approx_src_nfp_uminus_double
-- Source Path: uz_pmsm_model_6LUT_pd/uz_pmsm_model_6LUT/nfp_uminus_double
-- Hierarchy Level: 1
-- Model version: 7.14
-- 
-- -------------------------------------------------------------
...
ENTITY uz_pmsm_6LUT_approx_src_nfp_uminus_double IS
  PORT( nfp_in                            :   IN    std_logic_vector(63 DOWNTO 0);  -- ufix64
        nfp_out                           :   OUT   std_logic_vector(63 DOWNTO 0)  -- ufix64
        );
END uz_pmsm_6LUT_approx_src_nfp_uminus_double;


ARCHITECTURE rtl OF uz_pmsm_6LUT_approx_src_nfp_uminus_double IS
