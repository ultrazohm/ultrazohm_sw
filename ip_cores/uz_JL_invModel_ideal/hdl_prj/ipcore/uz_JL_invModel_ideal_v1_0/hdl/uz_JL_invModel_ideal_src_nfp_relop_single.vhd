-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\jonat\Documents\MA_JL_CIL\ip_cores\uz_JL_invModel_ideal\hdl_prj\hdlsrc\uz_JL_invModel_ideal\uz_JL_invModel_ideal_src_nfp_relop_single.vhd
-- Created: 2026-05-13 15:33:50
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: uz_JL_invModel_ideal_src_nfp_relop_single
-- Source Path: uz_JL_invModel_ideal/uz_JL_invModel_ideal/nfp_relop_single
-- Hierarchy Level: 1
-- Model version: 1.46
-- 
...
ENTITY uz_JL_invModel_ideal_src_nfp_relop_single IS
...
END uz_JL_invModel_ideal_src_nfp_relop_single;


ARCHITECTURE rtl OF uz_JL_invModel_ideal_src_nfp_relop_single IS
...
BEGIN
  ...
  Logical_Operator1_out1 <=  NOT Relational_Operator_out1;
  ...
  Relational_Operator2_out1 <= '1' WHEN Constant1_out1 = Delay5_out1_1 ELSE
      '0';
  ...
  Relational_Operator2_out1_1 <= '1' WHEN Delay_out1 = Delay1_out1_2 ELSE
      '0';
  ...
  Relational_Operator6_out1_1 <= '1' WHEN Delay3_out1 = Delay5_out1_1 ELSE
      '0';
  ...
  Relational_Operator5_out1_1 <= '1' WHEN Delay_out1 < Delay1_out1_2 ELSE
      '0';
  ...
  Relational_Operator3_out1_1 <= '1' WHEN Delay3_out1 > Delay5_out1_1 ELSE
      '0';
