-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_mpc_cost_and_optim_state_machine\uz_6_ph_dc_ip_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_6_ph_dc_ip_axi_lite
-- Source Path: uz_6_ph_dc_ip/uz_6_ph_dc_ip_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_6_ph_dc_ip_axi_lite IS
...
END uz_6_ph_dc_ip_axi_lite;


ARCHITECTURE rtl OF uz_6_ph_dc_ip_axi_lite IS

  -- Component Declarations
  COMPONENT uz_6_ph_dc_ip_addr_decoder
  ...
  COMPONENT uz_6_ph_dc_ip_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : uz_6_ph_dc_ip_addr_decoder
    USE ENTITY work.uz_6_ph_dc_ip_addr_decoder(rtl);

  FOR ALL : uz_6_ph_dc_ip_axi_lite_module
    USE ENTITY work.uz_6_ph_dc_ip_axi_lite_module(rtl);
...
BEGIN
  u_uz_6_ph_dc_ip_addr_decoder_inst : uz_6_ph_dc_ip_addr_decoder
  ...
  u_uz_6_ph_dc_ip_axi_lite_module_inst : uz_6_ph_dc_ip_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
