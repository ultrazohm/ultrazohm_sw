...
if {[file isfile uz_FOC_sample.autotvin.dat]} {
	file delete -force uz_FOC_sample.autotvin.dat
}

if {[file isfile uz_FOC_sample.autotvout.dat]} {
	file delete -force uz_FOC_sample.autotvout.dat
}
