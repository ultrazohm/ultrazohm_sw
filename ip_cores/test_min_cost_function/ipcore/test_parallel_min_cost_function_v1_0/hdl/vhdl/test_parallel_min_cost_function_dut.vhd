-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\test_min_cost_function\hdlsrc\parallel_min_cost_function_vopt_6phase\test_parallel_min_cost_function_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: test_parallel_min_cost_function_dut
-- Source Path: test_parallel_min_cost_function/test_parallel_min_cost_function_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY test_parallel_min_cost_function_dut IS
...
END test_parallel_min_cost_function_dut;


ARCHITECTURE rtl OF test_parallel_min_cost_function_dut IS

  -- Component Declarations
  COMPONENT test_parallel_min_cost_function_src_Min_cost_function_and_vopt
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : test_parallel_min_cost_function_src_Min_cost_function_and_vopt
    USE ENTITY work.test_parallel_min_cost_function_src_Min_cost_function_and_vopt(rtl);
...
BEGIN
  u_test_parallel_min_cost_function_src_Min_cost_function_and_vopt : test_parallel_min_cost_function_src_Min_cost_function_and_vopt
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
