...
reg    p_m_out_blk_n;
reg   [29:0] i_reg_136;
reg   [13:0] p_in_offset_read_reg_269;
reg    ap_block_state1;
...
wire   [13:0] tmp_7_fu_178_p3;
reg   [13:0] tmp_7_reg_291;
...
wire   [11:0] empty_fu_174_p1;
wire   [13:0] add_ln60_fu_186_p2;
wire   [13:0] or_ln60_fu_196_p2;
wire   [13:0] add_ln60_1_fu_202_p2;
wire   [13:0] or_ln60_1_fu_212_p2;
wire   [13:0] add_ln60_2_fu_217_p2;
wire   [13:0] or_ln60_2_fu_227_p2;
wire   [13:0] add_ln60_3_fu_232_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln55_fu_163_p2 == 1'd0))) begin
        tmp_7_reg_291[13 : 2] <= tmp_7_fu_178_p3[13 : 2];
    end
end
...
assign empty_fu_174_p1 = ap_phi_mux_i_phi_fu_140_p4[11:0];
...
assign or_ln60_1_fu_212_p2 = (tmp_7_reg_291 | 14'd2);

assign or_ln60_2_fu_227_p2 = (tmp_7_reg_291 | 14'd3);

assign or_ln60_fu_196_p2 = (tmp_7_fu_178_p3 | 14'd1);
