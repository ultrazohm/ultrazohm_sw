-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\parallel_8_delay_compensation\hdlsrc\parallel_8_delay_compensation\parallel_8_sim_delay_compensation_src_nfp_convert_sfix_27_En18_to_single.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: parallel_8_sim_delay_compensation_src_nfp_convert_sfix_27_En18_to_single
-- Source Path: parallel_8_delay_compensation/Delay_compensation/nfp_convert_sfix_27_En18_to_single
-- Hierarchy Level: 1
-- 
...
ENTITY parallel_8_sim_delay_compensation_src_nfp_convert_sfix_27_En18_to_single IS
...
END parallel_8_sim_delay_compensation_src_nfp_convert_sfix_27_En18_to_single;


ARCHITECTURE rtl OF parallel_8_sim_delay_compensation_src_nfp_convert_sfix_27_En18_to_single IS

  -- Signals
  SIGNAL nfp_in_signed                    : signed(26 DOWNTO 0);  -- sfix27_En18
  ...
  SIGNAL Delay_out1_dtc                   : unsigned(26 DOWNTO 0);  -- ufix27_En18
  SIGNAL Unary_Minus_cast                 : signed(27 DOWNTO 0);  -- sfix28_En18
  SIGNAL Unary_Minus_cast_1               : signed(27 DOWNTO 0);  -- sfix28_En18
  SIGNAL Unary_Minus_out1                 : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL Unary_Minus_out1_dtc             : unsigned(26 DOWNTO 0);  -- ufix27_En18
  SIGNAL Switch_out1                      : unsigned(26 DOWNTO 0);  -- ufix27_En18
  SIGNAL Data_Type_Conversion_out1        : unsigned(127 DOWNTO 0);  -- ufix128_En18
  ...
  SIGNAL Delay2_reg_next                  : vector_of_unsigned128(0 TO 2);  -- ufix128_En18 [3]
  SIGNAL Delay2_out1_3                    : unsigned(127 DOWNTO 0);  -- ufix128_En18
  ...
  SIGNAL Shift_Arithmetic_out1            : unsigned(127 DOWNTO 0);  -- ufix128_En18
...
BEGIN
  ...
  Constant_out1 <= to_signed(16#6C#, 8);
