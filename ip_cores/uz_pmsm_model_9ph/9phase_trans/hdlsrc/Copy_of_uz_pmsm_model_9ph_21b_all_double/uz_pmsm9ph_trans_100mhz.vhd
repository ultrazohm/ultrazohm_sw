-- -------------------------------------------------------------
-- 
-- File Name: 9phase_trans/hdlsrc/Copy_of_uz_pmsm_model_9ph_21b_all_double/uz_pmsm9ph_trans_100mhz.vhd
...
ENTITY uz_pmsm9ph_trans_100mhz IS
  PORT( IPCORE_CLK                        :   IN    std_logic;  -- ufix1
        ...
        current_in_dq_0                   :   IN    std_logic_vector(242 DOWNTO 0);  -- ufix243
        theta_el1                         :   IN    std_logic_vector(17 DOWNTO 0);  -- ufix18
        trigger_new_values                :   IN    std_logic;  -- ufix1
        u_abc1_pl_0                       :   IN    std_logic_vector(80 DOWNTO 0);  -- ufix81
        u_abc2_pl_0                       :   IN    std_logic_vector(80 DOWNTO 0);  -- ufix81
        u_abc3_pl_0                       :   IN    std_logic_vector(80 DOWNTO 0);  -- ufix81
        ...
        voltage_out_dq_1_0                :   OUT   std_logic_vector(80 DOWNTO 0);  -- ufix81
        voltage_out_dq_2_0                :   OUT   std_logic_vector(80 DOWNTO 0);  -- ufix81
        voltage_out_dq_3_0                :   OUT   std_logic_vector(80 DOWNTO 0);  -- ufix81
        I_abc_1_0                         :   OUT   std_logic_vector(80 DOWNTO 0);  -- ufix81
        I_abc_2_0                         :   OUT   std_logic_vector(80 DOWNTO 0);  -- ufix81
        I_abc_3_0                         :   OUT   std_logic_vector(80 DOWNTO 0);  -- ufix81
...
ARCHITECTURE rtl OF uz_pmsm9ph_trans_100mhz IS
  ...
  SIGNAL current_in_dq_0_unsigned         : unsigned(242 DOWNTO 0);  -- ufix243
  SIGNAL current_in_dq_0_slice            : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL current_in_dq_0_sig              : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL current_in_dq_0_unsigned_1       : unsigned(242 DOWNTO 0);  -- ufix243
  SIGNAL current_in_dq_0_slice_1          : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL current_in_dq_1_sig              : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL current_in_dq_0_unsigned_2       : unsigned(242 DOWNTO 0);  -- ufix243
  SIGNAL current_in_dq_0_slice_2          : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL current_in_dq_2_sig              : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL current_in_dq_0_unsigned_3       : unsigned(242 DOWNTO 0);  -- ufix243
  SIGNAL current_in_dq_0_slice_3          : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL current_in_dq_3_sig              : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL current_in_dq_0_unsigned_4       : unsigned(242 DOWNTO 0);  -- ufix243
  SIGNAL current_in_dq_0_slice_4          : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL current_in_dq_4_sig              : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL current_in_dq_0_unsigned_5       : unsigned(242 DOWNTO 0);  -- ufix243
  SIGNAL current_in_dq_0_slice_5          : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL current_in_dq_5_sig              : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL current_in_dq_0_unsigned_6       : unsigned(242 DOWNTO 0);  -- ufix243
  SIGNAL current_in_dq_0_slice_6          : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL current_in_dq_6_sig              : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL current_in_dq_0_unsigned_7       : unsigned(242 DOWNTO 0);  -- ufix243
  SIGNAL current_in_dq_0_slice_7          : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL current_in_dq_7_sig              : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL current_in_dq_0_unsigned_8       : unsigned(242 DOWNTO 0);  -- ufix243
  SIGNAL current_in_dq_0_slice_8          : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL current_in_dq_8_sig              : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL theta_el1_unsigned               : unsigned(17 DOWNTO 0);  -- ufix18
  SIGNAL theta_el1_sig                    : signed(17 DOWNTO 0);  -- sfix18_En14
  SIGNAL u_abc1_pl_0_unsigned             : unsigned(80 DOWNTO 0);  -- ufix81
  SIGNAL u_abc1_pl_0_slice                : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL u_abc1_pl_0_sig                  : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL u_abc1_pl_0_slice_1              : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL u_abc1_pl_1_sig                  : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL u_abc1_pl_0_slice_2              : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL u_abc1_pl_2_sig                  : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL u_abc2_pl_0_unsigned             : unsigned(80 DOWNTO 0);  -- ufix81
  SIGNAL u_abc2_pl_0_slice                : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL u_abc2_pl_0_sig                  : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL u_abc2_pl_0_slice_1              : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL u_abc2_pl_1_sig                  : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL u_abc2_pl_0_slice_2              : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL u_abc2_pl_2_sig                  : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL u_abc3_pl_0_unsigned             : unsigned(80 DOWNTO 0);  -- ufix81
  SIGNAL u_abc3_pl_0_slice                : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL u_abc3_pl_0_sig                  : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL u_abc3_pl_0_slice_1              : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL u_abc3_pl_1_sig                  : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL u_abc3_pl_0_slice_2              : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL u_abc3_pl_2_sig                  : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL reset_internal                   : std_logic;  -- ufix1
  SIGNAL reset_before_sync                : std_logic;  -- ufix1
  SIGNAL read_i_abc_out_axi_vec           : vector_of_std_logic_vector27(0 TO 8);  -- ufix27 [9]
  ...
  SIGNAL voltage_out_dq_1_2_sig_signed    : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL voltage_out_dq_1_1_sig_signed    : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL voltage_out_dq_1_0_sig_signed    : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL voltage_out_dq_1_0_tmp           : unsigned(80 DOWNTO 0);  -- ufix81
  SIGNAL voltage_out_dq_2_2_sig_signed    : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL voltage_out_dq_2_1_sig_signed    : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL voltage_out_dq_2_0_sig_signed    : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL voltage_out_dq_2_0_tmp           : unsigned(80 DOWNTO 0);  -- ufix81
  SIGNAL voltage_out_dq_3_2_sig_signed    : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL voltage_out_dq_3_1_sig_signed    : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL voltage_out_dq_3_0_sig_signed    : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL voltage_out_dq_3_0_tmp           : unsigned(80 DOWNTO 0);  -- ufix81
  SIGNAL I_abc_1_2_sig_signed             : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL I_abc_1_1_sig_signed             : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL I_abc_1_0_sig_signed             : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL I_abc_1_0_tmp                    : unsigned(80 DOWNTO 0);  -- ufix81
  SIGNAL I_abc_2_2_sig_signed             : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL I_abc_2_1_sig_signed             : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL I_abc_2_0_sig_signed             : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL I_abc_2_0_tmp                    : unsigned(80 DOWNTO 0);  -- ufix81
  SIGNAL I_abc_3_2_sig_signed             : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL I_abc_3_1_sig_signed             : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL I_abc_3_0_sig_signed             : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL I_abc_3_0_tmp                    : unsigned(80 DOWNTO 0);  -- ufix81
...
BEGIN
  ...
  u_uz_pmsm9ph_trans_100mhz_axi4_inst : uz_pmsm9ph_trans_100mhz_axi4
    PORT MAP( reset => reset,
              ...
              read_i_abc_out_axi => read_i_abc_out_axi_vec,  -- sfix27_En18 [9]
  ...
  u_uz_pmsm9ph_trans_100mhz_dut_inst : uz_pmsm9ph_trans_100mhz_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              ...
              current_in_dq_0 => std_logic_vector(current_in_dq_0_sig),  -- sfix27_En18
              current_in_dq_1 => std_logic_vector(current_in_dq_1_sig),  -- sfix27_En18
              current_in_dq_2 => std_logic_vector(current_in_dq_2_sig),  -- sfix27_En18
              current_in_dq_3 => std_logic_vector(current_in_dq_3_sig),  -- sfix27_En18
              current_in_dq_4 => std_logic_vector(current_in_dq_4_sig),  -- sfix27_En18
              current_in_dq_5 => std_logic_vector(current_in_dq_5_sig),  -- sfix27_En18
              current_in_dq_6 => std_logic_vector(current_in_dq_6_sig),  -- sfix27_En18
              current_in_dq_7 => std_logic_vector(current_in_dq_7_sig),  -- sfix27_En18
              current_in_dq_8 => std_logic_vector(current_in_dq_8_sig),  -- sfix27_En18
              theta_el1 => std_logic_vector(theta_el1_sig),  -- sfix18_En14
              trigger_new_values => trigger_new_values,  -- ufix1
              u_abc1_pl_0 => std_logic_vector(u_abc1_pl_0_sig),  -- sfix27_En16
              u_abc1_pl_1 => std_logic_vector(u_abc1_pl_1_sig),  -- sfix27_En16
              u_abc1_pl_2 => std_logic_vector(u_abc1_pl_2_sig),  -- sfix27_En16
              u_abc2_pl_0 => std_logic_vector(u_abc2_pl_0_sig),  -- sfix27_En16
              u_abc2_pl_1 => std_logic_vector(u_abc2_pl_1_sig),  -- sfix27_En16
              u_abc2_pl_2 => std_logic_vector(u_abc2_pl_2_sig),  -- sfix27_En16
              u_abc3_pl_0 => std_logic_vector(u_abc3_pl_0_sig),  -- sfix27_En16
              u_abc3_pl_1 => std_logic_vector(u_abc3_pl_1_sig),  -- sfix27_En16
              u_abc3_pl_2 => std_logic_vector(u_abc3_pl_2_sig),  -- sfix27_En16
              ...
              i_abc_out_axi_0 => read_i_abc_out_axi_vec(0),  -- sfix27_En18
              i_abc_out_axi_1 => read_i_abc_out_axi_vec(1),  -- sfix27_En18
              i_abc_out_axi_2 => read_i_abc_out_axi_vec(2),  -- sfix27_En18
              i_abc_out_axi_3 => read_i_abc_out_axi_vec(3),  -- sfix27_En18
              i_abc_out_axi_4 => read_i_abc_out_axi_vec(4),  -- sfix27_En18
              i_abc_out_axi_5 => read_i_abc_out_axi_vec(5),  -- sfix27_En18
              i_abc_out_axi_6 => read_i_abc_out_axi_vec(6),  -- sfix27_En18
              i_abc_out_axi_7 => read_i_abc_out_axi_vec(7),  -- sfix27_En18
              i_abc_out_axi_8 => read_i_abc_out_axi_vec(8),  -- sfix27_En18
  ...
  u_abc1_pl_0_slice <= u_abc1_pl_0_unsigned(26 DOWNTO 0);

  u_abc1_pl_0_sig <= signed(u_abc1_pl_0_slice);

  u_abc1_pl_0_slice_1 <= u_abc1_pl_0_unsigned(53 DOWNTO 27);

  u_abc1_pl_1_sig <= signed(u_abc1_pl_0_slice_1);

  u_abc1_pl_0_slice_2 <= u_abc1_pl_0_unsigned(80 DOWNTO 54);

  u_abc1_pl_2_sig <= signed(u_abc1_pl_0_slice_2);

  u_abc2_pl_0_unsigned <= unsigned(u_abc2_pl_0);

  u_abc2_pl_0_slice <= u_abc2_pl_0_unsigned(26 DOWNTO 0);

  u_abc2_pl_0_sig <= signed(u_abc2_pl_0_slice);

  u_abc2_pl_0_slice_1 <= u_abc2_pl_0_unsigned(53 DOWNTO 27);

  u_abc2_pl_1_sig <= signed(u_abc2_pl_0_slice_1);

  u_abc2_pl_0_slice_2 <= u_abc2_pl_0_unsigned(80 DOWNTO 54);

  u_abc2_pl_2_sig <= signed(u_abc2_pl_0_slice_2);

  u_abc3_pl_0_unsigned <= unsigned(u_abc3_pl_0);

  u_abc3_pl_0_slice <= u_abc3_pl_0_unsigned(26 DOWNTO 0);

  u_abc3_pl_0_sig <= signed(u_abc3_pl_0_slice);

  u_abc3_pl_0_slice_1 <= u_abc3_pl_0_unsigned(53 DOWNTO 27);

  u_abc3_pl_1_sig <= signed(u_abc3_pl_0_slice_1);

  u_abc3_pl_0_slice_2 <= u_abc3_pl_0_unsigned(80 DOWNTO 54);
  ...
  I_abc_1_0_tmp <= unsigned(I_abc_1_2_sig_signed) & unsigned(I_abc_1_1_sig_signed) & unsigned(I_abc_1_0_sig_signed);

  I_abc_1_0 <= std_logic_vector(I_abc_1_0_tmp);
  ...
  I_abc_2_0_tmp <= unsigned(I_abc_2_2_sig_signed) & unsigned(I_abc_2_1_sig_signed) & unsigned(I_abc_2_0_sig_signed);

  I_abc_2_0 <= std_logic_vector(I_abc_2_0_tmp);
  ...
  I_abc_3_0_tmp <= unsigned(I_abc_3_2_sig_signed) & unsigned(I_abc_3_1_sig_signed) & unsigned(I_abc_3_0_sig_signed);

  I_abc_3_0 <= std_logic_vector(I_abc_3_0_tmp);
