...
\
  ...
  connect_bd_intf_net -intf_net S00_AXI_2 [get_bd_intf_pins uz_system/M10_AXI] [get_bd_intf_pins uz_user/S00_AXI]
  ...
  # Create port connections
  connect_bd_net -net uz_analog_adapter_Din [get_bd_pins uz_analog_adapter/Din] [get_bd_pins uz_system/ADC_A1]
  connect_bd_net -net uz_analog_adapter_RAW_VALUE [get_bd_pins uz_analog_adapter/RAW_VALUE] [get_bd_pins uz_system/ADC_A3]
  connect_bd_net -net uz_analog_adapter_RAW_VALUE1 [get_bd_pins uz_analog_adapter/RAW_VALUE1] [get_bd_pins uz_system/ADC_A2]
  connect_bd_net -net uz_analog_adapter_probe4 [get_bd_pins uz_analog_adapter/probe4] [get_bd_pins uz_system/Trigger_AXI2TCM]
  connect_bd_net -net uz_digital_adapter_Carrier_triangular_max [get_bd_pins uz_digital_adapter/Carrier_triangular_max] [get_bd_pins uz_system/Interrupt2]
  connect_bd_net -net uz_digital_adapter_Carrier_triangular_max_min [get_bd_pins uz_digital_adapter/Carrier_triangular_max_min] [get_bd_pins uz_system/Interrupt0]
  connect_bd_net -net uz_digital_adapter_Carrier_triangular_min [get_bd_pins uz_digital_adapter/Carrier_triangular_min] [get_bd_pins uz_system/Interrupt1]
  connect_bd_net -net uz_digital_adapter_Interrupt_Center [get_bd_pins uz_digital_adapter/Interrupt_Center] [get_bd_pins uz_system/Interrupt5]
  connect_bd_net -net uz_digital_adapter_Interrupt_Start [get_bd_pins uz_digital_adapter/Interrupt_Start] [get_bd_pins uz_system/Interrupt4]
  connect_bd_net -net uz_digital_adapter_Interrupt_Start_Center [get_bd_pins uz_digital_adapter/Interrupt_Start_Center] [get_bd_pins uz_system/Interrupt3]
  ...
  assign_bd_address -offset 0x800C0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs uz_digital_adapter/D5_adapter/IncreEncoder_V24_ip_0/AXI4_Lite/reg0] -force
