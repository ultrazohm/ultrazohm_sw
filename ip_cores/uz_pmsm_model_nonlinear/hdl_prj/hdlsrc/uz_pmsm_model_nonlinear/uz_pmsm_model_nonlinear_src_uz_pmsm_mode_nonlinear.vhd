-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_pmsm_model_nonlinear\uz_pmsm_model_nonlinear_src_uz_pmsm_mode_nonlinear.vhd
...
-- -------------------------------------------------------------
-- Model base rate: 1.5873e-08
-- Target subsystem base rate: 1.5873e-08
-- Explicit user oversample request: 126x
-- 
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_nonlinear_src_uz_pmsm_mode_nonlinear
-- Source Path: uz_pmsm_model_nonlinear/uz_pmsm_mode_nonlinear
-- Hierarchy Level: 0
-- Model version: 9.10
-- 
-- -------------------------------------------------------------
...
ENTITY uz_pmsm_model_nonlinear_src_uz_pmsm_mode_nonlinear IS
...
END uz_pmsm_model_nonlinear_src_uz_pmsm_mode_nonlinear;


ARCHITECTURE rtl OF uz_pmsm_model_nonlinear_src_uz_pmsm_mode_nonlinear IS

  -- Component Declarations
  COMPONENT uz_pmsm_model_nonlinear_src_uz_pmsm_mode_nonlinear_tc
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          clk_enable                      :   IN    std_logic;
          enb                             :   OUT   std_logic;
          enb_1_126_1                     :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT uz_pmsm_model_nonlinear_src_nfp_sub_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          nfp_in1                         :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT uz_pmsm_model_nonlinear_src_nfp_cosh_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT uz_pmsm_model_nonlinear_src_nfp_abs_single
    PORT( nfp_in                          :   IN    std_logic_vector(31 DOWNTO 0);  -- single
          nfp_out                         :   OUT   std_logic_vector(31 DOWNTO 0)  -- single
          );
  END COMPONENT;

  COMPONENT uz_pmsm_model_nonlinear_src_nfp_recip_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          nfp_in                          :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT uz_pmsm_model_nonlinear_src_nfp_tanh_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          nfp_in                          :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT uz_pmsm_model_nonlinear_src_nfp_add_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          nfp_in1                         :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT uz_pmsm_model_nonlinear_src_nfp_signum_single
    PORT( nfp_in                          :   IN    std_logic_vector(31 DOWNTO 0);  -- single
          nfp_out                         :   OUT   std_logic_vector(31 DOWNTO 0)  -- single
          );
  END COMPONENT;

  COMPONENT uz_pmsm_model_nonlinear_src_nfp_log_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          nfp_in                          :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT uz_pmsm_model_nonlinear_src_nfp_uminus_single
    PORT( nfp_in                          :   IN    std_logic_vector(31 DOWNTO 0);  -- single
          nfp_out                         :   OUT   std_logic_vector(31 DOWNTO 0)  -- single
          );
  END COMPONENT;

  COMPONENT uz_pmsm_model_nonlinear_src_nfp_div_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          nfp_in1                         :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  FOR ALL : uz_pmsm_model_nonlinear_src_uz_pmsm_mode_nonlinear_tc
    USE ENTITY work.uz_pmsm_model_nonlinear_src_uz_pmsm_mode_nonlinear_tc(rtl);

  FOR ALL : uz_pmsm_model_nonlinear_src_nfp_sub_single
    USE ENTITY work.uz_pmsm_model_nonlinear_src_nfp_sub_single(rtl);

  FOR ALL : uz_pmsm_model_nonlinear_src_nfp_mul_single
    USE ENTITY work.uz_pmsm_model_nonlinear_src_nfp_mul_single(rtl);

  FOR ALL : uz_pmsm_model_nonlinear_src_nfp_cosh_single
    USE ENTITY work.uz_pmsm_model_nonlinear_src_nfp_cosh_single(rtl);

  FOR ALL : uz_pmsm_model_nonlinear_src_nfp_abs_single
    USE ENTITY work.uz_pmsm_model_nonlinear_src_nfp_abs_single(rtl);

  FOR ALL : uz_pmsm_model_nonlinear_src_nfp_recip_single
    USE ENTITY work.uz_pmsm_model_nonlinear_src_nfp_recip_single(rtl);

  FOR ALL : uz_pmsm_model_nonlinear_src_nfp_tanh_single
    USE ENTITY work.uz_pmsm_model_nonlinear_src_nfp_tanh_single(rtl);

  FOR ALL : uz_pmsm_model_nonlinear_src_nfp_add_single
    USE ENTITY work.uz_pmsm_model_nonlinear_src_nfp_add_single(rtl);

  FOR ALL : uz_pmsm_model_nonlinear_src_nfp_signum_single
    USE ENTITY work.uz_pmsm_model_nonlinear_src_nfp_signum_single(rtl);

  FOR ALL : uz_pmsm_model_nonlinear_src_nfp_log_single
    USE ENTITY work.uz_pmsm_model_nonlinear_src_nfp_log_single(rtl);

  FOR ALL : uz_pmsm_model_nonlinear_src_nfp_uminus_single
    USE ENTITY work.uz_pmsm_model_nonlinear_src_nfp_uminus_single(rtl);

  FOR ALL : uz_pmsm_model_nonlinear_src_nfp_div_single
    USE ENTITY work.uz_pmsm_model_nonlinear_src_nfp_div_single(rtl);

  -- Signals
  SIGNAL enb_1_126_1                      : std_logic;
  ...
  SIGNAL From17_out1_1                    : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL ad2                              : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL From17_out1_0                    : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL ad1                              : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL ad6                              : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL From17_out1_4                    : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL ad5                              : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL From17_out1_3                    : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL From17_out1_19                   : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL aq1_aq2                          : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL From17_out1_22                   : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL aq3_aq6                          : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL aq5                              : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL From17_out1_18                   : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL aq4_aq5                          : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL From17_out1_12                   : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL From14_out1_21                   : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL ad1_ad2                          : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL From14_out1_1                    : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL From14_out1_20                   : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL ad4_ad5                          : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL From14_out1_4                    : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL ad5_1                            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL ad6_1                            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL From14_out1_13                   : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL R_1_1                            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL From_out1_timer                  : std_logic;
  SIGNAL delayMatch41_reg                 : std_logic_vector(96 DOWNTO 0);  -- ufix1 [97]
  SIGNAL From_out1_timer_1                : std_logic;
  SIGNAL From_out1_default                : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL psiq_cross_s1_integrated_2       : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL psiq_approx_1                    : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL psid_cross_s1_integrated_2       : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL From_out1_zp                     : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL psiq_approx_2                    : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL psiq_cross_s1_4                  : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL psid_cross_s1_7                  : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL psid_cross_s1_8                  : std_logic_vector(31 DOWNTO 0);  -- ufix32
...
BEGIN
  u_uz_pmsm_mode_nonlinear_tc : uz_pmsm_model_nonlinear_src_uz_pmsm_mode_nonlinear_tc
    PORT MAP( clk => clk,
              reset => reset,
              clk_enable => clk_enable,
              enb => enb,
              enb_1_126_1 => enb_1_126_1
              );

  u_nfp_sub_comp : uz_pmsm_model_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_cosh_comp : uz_pmsm_model_nonlinear_src_nfp_cosh_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_1 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_abs_comp : uz_pmsm_model_nonlinear_src_nfp_abs_single
    PORT MAP( nfp_in => Product15_out1,  -- single
              nfp_out => Switch1_control_abs  -- single
              );

  u_nfp_recip_comp : uz_pmsm_model_nonlinear_src_nfp_recip_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_2 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_1 : uz_pmsm_model_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  -- mul #1
  u_nfp_mul_comp_3 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => psid_cross_s1_abgeleitet,  -- single
              nfp_in2 => psiq_cross_s1_integrated_2,  -- single
              nfp_out => Product10_out_1  -- single
              );

  -- mul #2
  u_nfp_mul_comp_4 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_2 : uz_pmsm_model_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1,  -- single
  ...
  u_nfp_mul_comp_5 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_cosh_comp_1 : uz_pmsm_model_nonlinear_src_nfp_cosh_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_6 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_abs_comp_1 : uz_pmsm_model_nonlinear_src_nfp_abs_single
    PORT MAP( nfp_in => Product14_out1,  -- single
              nfp_out => Switch_control_abs  -- single
              );

  u_nfp_recip_comp_1 : uz_pmsm_model_nonlinear_src_nfp_recip_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_7 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_3 : uz_pmsm_model_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_abs_comp_2 : uz_pmsm_model_nonlinear_src_nfp_abs_single
    PORT MAP( nfp_in => psid_cross_s1,  -- single
              nfp_out => Switch_control_abs_1  -- single
              );

  u_nfp_recip_comp_2 : uz_pmsm_model_nonlinear_src_nfp_recip_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_8 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Product13_out1,  -- single
              nfp_in2 => psiq_approx_1,  -- single
              nfp_out => Product3_out1  -- single
              );

  u_nfp_mul_comp_9 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_10 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1_1,  -- single
  ...
  u_nfp_tanh_comp : uz_pmsm_model_nonlinear_src_nfp_tanh_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_11 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp : uz_pmsm_model_nonlinear_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_12 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1_1,  -- single
  ...
  u_nfp_tanh_comp_1 : uz_pmsm_model_nonlinear_src_nfp_tanh_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_13 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_14 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1_1,  -- single
  ...
  u_nfp_cosh_comp_2 : uz_pmsm_model_nonlinear_src_nfp_cosh_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_15 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_abs_comp_3 : uz_pmsm_model_nonlinear_src_nfp_abs_single
    PORT MAP( nfp_in => Product15_out1_1,  -- single
              nfp_out => Switch1_control_abs_1  -- single
              );

  u_nfp_recip_comp_3 : uz_pmsm_model_nonlinear_src_nfp_recip_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_16 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp_1 : uz_pmsm_model_nonlinear_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_4 : uz_pmsm_model_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  -- mul #1
  u_nfp_mul_comp_17 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Sum2_out1,  -- single
              nfp_in2 => psid_cross_s1_integrated_2,  -- single
              nfp_out => Product20_out_1  -- single
              );

  -- mul #2
  u_nfp_mul_comp_18 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_19 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1_1,  -- single
  ...
  u_nfp_cosh_comp_3 : uz_pmsm_model_nonlinear_src_nfp_cosh_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_20 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_abs_comp_4 : uz_pmsm_model_nonlinear_src_nfp_abs_single
    PORT MAP( nfp_in => Product14_out1_1,  -- single
              nfp_out => Switch_control_abs_2  -- single
              );

  u_nfp_recip_comp_4 : uz_pmsm_model_nonlinear_src_nfp_recip_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_21 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp_2 : uz_pmsm_model_nonlinear_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_5 : uz_pmsm_model_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Sum1_out1_2,  -- single
  ...
  u_nfp_abs_comp_5 : uz_pmsm_model_nonlinear_src_nfp_abs_single
    PORT MAP( nfp_in => Lqq,  -- single
              nfp_out => Switch8_control_abs  -- single
              );

  u_nfp_mul_comp_22 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1_1,  -- single
              nfp_in2 => R_1_1,  -- single
              nfp_out => Product9_out1  -- single
              );

  u_nfp_signum_comp : uz_pmsm_model_nonlinear_src_nfp_signum_single
    PORT MAP( nfp_in => Delay1_out1_3,  -- single
              nfp_out => Sign1_out1  -- single
              );

  u_nfp_abs_comp_6 : uz_pmsm_model_nonlinear_src_nfp_abs_single
    PORT MAP( nfp_in => Delay1_out1_3,  -- single
              nfp_out => Abs_out1  -- single
              );

  u_nfp_mul_comp_23 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => mu,  -- single
  ...
  u_nfp_add_comp_3 : uz_pmsm_model_nonlinear_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_24 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_6 : uz_pmsm_model_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1,  -- single
  ...
  u_nfp_mul_comp_25 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_cosh_comp_4 : uz_pmsm_model_nonlinear_src_nfp_cosh_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_abs_comp_7 : uz_pmsm_model_nonlinear_src_nfp_abs_single
    PORT MAP( nfp_in => Tanh2_out1,  -- single
              nfp_out => Switch1_control_abs_2  -- single
              );

  u_nfp_log_comp : uz_pmsm_model_nonlinear_src_nfp_log_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in => Switch1_out1_2,  -- single
              nfp_out => Log1_out1  -- single
              );

  u_nfp_mul_comp_26 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_7 : uz_pmsm_model_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1,  -- single
  ...
  u_nfp_mul_comp_27 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_cosh_comp_5 : uz_pmsm_model_nonlinear_src_nfp_cosh_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_abs_comp_8 : uz_pmsm_model_nonlinear_src_nfp_abs_single
    PORT MAP( nfp_in => Tanh4_out1_1,  -- single
              nfp_out => Switch_control_abs_3  -- single
              );

  u_nfp_log_comp_1 : uz_pmsm_model_nonlinear_src_nfp_log_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_28 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_8 : uz_pmsm_model_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  -- mul #1
  u_nfp_mul_comp_29 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  -- mul #2
  u_nfp_mul_comp_30 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_9 : uz_pmsm_model_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_31 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => i_d,  -- single
              nfp_in2 => psiq_approx_2,  -- single
              nfp_out => Product2_out1_3  -- single
              );

  u_nfp_mul_comp_32 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => psi_d_approx_1,  -- single
              nfp_in2 => i_q_1,  -- single
              nfp_out => Product3_out1_1  -- single
              );

  u_nfp_sub_comp_10 : uz_pmsm_model_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_33 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_34 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => M_Mi,  -- single
  ...
  u_nfp_sub_comp_11 : uz_pmsm_model_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_12 : uz_pmsm_model_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_35 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_36 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp_4 : uz_pmsm_model_nonlinear_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_37 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_38 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1_1,  -- single
  ...
  u_nfp_cosh_comp_6 : uz_pmsm_model_nonlinear_src_nfp_cosh_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_abs_comp_9 : uz_pmsm_model_nonlinear_src_nfp_abs_single
    PORT MAP( nfp_in => error_id,  -- single
              nfp_out => Switch1_control_abs_3  -- single
              );

  u_nfp_log_comp_2 : uz_pmsm_model_nonlinear_src_nfp_log_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_39 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_40 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1_1,  -- single
  ...
  u_nfp_mul_comp_41 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_42 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1_1,  -- single
  ...
  u_nfp_cosh_comp_7 : uz_pmsm_model_nonlinear_src_nfp_cosh_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_abs_comp_10 : uz_pmsm_model_nonlinear_src_nfp_abs_single
    PORT MAP( nfp_in => Tanh2_out1_1,  -- single
              nfp_out => Switch_control_abs_4  -- single
              );

  u_nfp_log_comp_3 : uz_pmsm_model_nonlinear_src_nfp_log_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_43 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp_5 : uz_pmsm_model_nonlinear_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_13 : uz_pmsm_model_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  -- mul #1
  u_nfp_mul_comp_44 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  -- mul #2
  u_nfp_mul_comp_45 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_14 : uz_pmsm_model_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_46 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => psi_d_approx_2,  -- single
              nfp_in2 => Product13_out1,  -- single
              nfp_out => psi_d_omega_ell  -- single
              );

  -- mul #1
  u_nfp_mul_comp_47 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => psid_cross_s1_6,  -- single
              nfp_in2 => psiq_cross_s1_3,  -- single
              nfp_out => Product20_out_1_2  -- single
              );

  -- mul #2
  u_nfp_mul_comp_48 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_uminus_comp : uz_pmsm_model_nonlinear_src_nfp_uminus_single
    PORT MAP( nfp_in => Product20_out1,  -- single
              nfp_out => Lqd  -- single
              );

  u_nfp_mul_comp_49 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_15 : uz_pmsm_model_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => u_q,  -- single
  ...
  u_nfp_sub_comp_16 : uz_pmsm_model_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_17 : uz_pmsm_model_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_div_comp : uz_pmsm_model_nonlinear_src_nfp_div_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Sum4_out1_1,  -- single
              nfp_in2 => From_out1_zp,  -- single
              nfp_out => diq_dt  -- single
              );

  u_nfp_mul_comp_50 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp_6 : uz_pmsm_model_nonlinear_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_51 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1_1,  -- single
  ...
  u_nfp_add_comp_7 : uz_pmsm_model_nonlinear_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_18 : uz_pmsm_model_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_19 : uz_pmsm_model_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1,  -- single
  ...
  u_nfp_mul_comp_52 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_tanh_comp_2 : uz_pmsm_model_nonlinear_src_nfp_tanh_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_53 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_20 : uz_pmsm_model_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1,  -- single
  ...
  u_nfp_mul_comp_54 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Sum_out1_3,  -- single
              nfp_in2 => ad2,  -- single
              nfp_out => Product_out1_3  -- single
              );

  u_nfp_tanh_comp_3 : uz_pmsm_model_nonlinear_src_nfp_tanh_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_55 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_21 : uz_pmsm_model_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  -- mul #1
  u_nfp_mul_comp_56 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => psid_cross_s1_8,  -- single
              nfp_in2 => psiq_cross_s1_4,  -- single
              nfp_out => Product20_out_1_3  -- single
              );

  -- mul #2
  u_nfp_mul_comp_57 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_uminus_comp_1 : uz_pmsm_model_nonlinear_src_nfp_uminus_single
    PORT MAP( nfp_in => Product20_out1_1,  -- single
              nfp_out => Ldq  -- single
              );

  u_nfp_mul_comp_58 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Ldq,  -- single
  ...
  u_nfp_mul_comp_59 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => R_1,  -- single
  ...
  u_nfp_sub_comp_22 : uz_pmsm_model_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => u_d,  -- single
  ...
  u_nfp_sub_comp_23 : uz_pmsm_model_nonlinear_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Sum3_op_stage1_1,  -- single
              nfp_in2 => Product12_out1_2,  -- single
              nfp_out => Sum3_op_stage2  -- single
              );

  u_nfp_add_comp_8 : uz_pmsm_model_nonlinear_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_60 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_61 : uz_pmsm_model_nonlinear_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp_9 : uz_pmsm_model_nonlinear_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  From17_out1_1 <= fitting_parameter_23(1);
  ...
  From17_out1_0 <= fitting_parameter_23(0);
  ...
  From17_out1_4 <= fitting_parameter_23(4);
  ...
  From17_out1_3 <= fitting_parameter_23(3);
  ...
  From17_out1_19 <= fitting_parameter_23(19);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        aq1_aq2 <= X"00000000";
      ELSIF enb = '1' THEN
        aq1_aq2 <= From17_out1_19;
      END IF;
    END IF;
  END PROCESS delayMatch16_process;


  From17_out1_22 <= fitting_parameter_23(22);
  ...
  From17_out1_18 <= fitting_parameter_23(18);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        aq4_aq5 <= X"00000000";
      ELSIF enb = '1' THEN
        aq4_aq5 <= From17_out1_18;
      END IF;
    END IF;
  END PROCESS delayMatch18_process;


  From17_out1_12 <= fitting_parameter_23(12);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Reciprodical_F1G1 <= From17_out1_12;
      END IF;
    END IF;
  ...
  From14_out1_21 <= fitting_parameter_23(21);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        ad1_ad2 <= X"00000000";
      ELSIF enb = '1' THEN
        ad1_ad2 <= From14_out1_21;
      END IF;
    END IF;
  END PROCESS delayMatch9_process;


  From14_out1_1 <= fitting_parameter_23(1);
  ...
  From14_out1_20 <= fitting_parameter_23(20);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        ad4_ad5 <= X"00000000";
      ELSIF enb = '1' THEN
        ad4_ad5 <= From14_out1_20;
      END IF;
    END IF;
  END PROCESS delayMatch10_process;


  From14_out1_4 <= fitting_parameter_23(4);
  ...
  From14_out1_13 <= fitting_parameter_23(13);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        alpha1_Fid2_Giq2_1 <= From14_out1_13;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        delayMatch41_reg(0) <= From_out1_timer;
        delayMatch41_reg(96 DOWNTO 1) <= delayMatch41_reg(95 DOWNTO 0);
      END IF;
    END IF;
  END PROCESS delayMatch41_process;

  From_out1_timer_1 <= delayMatch41_reg(96);

  From_out1_default <= X"3f800000";
  ...
  From14_out1_6 <= fitting_parameter_23(6);
  ...
  From14_out1_9 <= fitting_parameter_23(9);
  ...
  From21_out1_12 <= fitting_parameter_23(12);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        alpha1_Fid1_Giq1 <= From21_out1_12;
      END IF;
    END IF;
  ...
  psid_cross_s1_1 <= psid_cross_s1;

  psiq_cross_s1_integrated_1 <= psiq_cross_s1_integrated;

  psiq_cross_s1_integrated_2 <= psiq_cross_s1_integrated_1;
  ...
  Unit_Delay1_out1 <= diq_dt_1 WHEN enb_1_126_1 = '1' ELSE
  ...
  psid_cross_s1_integrated_2 <= psid_cross_s1_integrated_1;
  ...
  From_out1_zp <= From_out1_default WHEN From_out1_timer_1 = '0' ELSE
      Switch8_out1;
  ...
  Switch1_out1_2 <= Constant2_out1_1 WHEN Switch1_control_abs_2 = X"00000000" ELSE
      Tanh2_out1;
  ...
  Delay_out1 <= Sum_out1_2 WHEN enb_1_126_1 = '1' ELSE
      Delay_bypass_reg;
  ...
  Delay1_delOut <= Delay1_toDel_1 WHEN enb_1_126_1 = '1' ELSE
  ...
  Switch1_out1_3 <= Constant2_out1 WHEN Switch1_control_abs_3 = X"00000000" ELSE
      error_id;
  ...
  psi_d_approx_2 <= psi_d_approx;

  psiq_cross_s1_2 <= psiq_cross_s1;

  psiq_cross_s1_3 <= psiq_cross_s1_2;
  ...
  Unit_Delay_out1 <= did_dt_1 WHEN enb_1_126_1 = '1' ELSE
  ...
  Delay1_delOut_2 <= Delay1_toDel_2 WHEN enb_1_126_1 = '1' ELSE
  ...
  psiq_cross_s1_4 <= psiq_cross_s1;

  psid_cross_s1_7 <= psid_cross_s1_4;

  psid_cross_s1_8 <= psid_cross_s1_7;

  
  Delay1_toDel_3 <= Sum5_out1_2 WHEN reset_integrators_2 = '0' ELSE
      Delay1_iv_2;
  ...
  Delay1_delOut_4 <= Delay1_toDel_4 WHEN enb_1_126_1 = '1' ELSE
  ...
  Mux_out1_1 <= Mux_out1 WHEN enb_1_126_1 = '1' ELSE
      t_bypass_reg;
