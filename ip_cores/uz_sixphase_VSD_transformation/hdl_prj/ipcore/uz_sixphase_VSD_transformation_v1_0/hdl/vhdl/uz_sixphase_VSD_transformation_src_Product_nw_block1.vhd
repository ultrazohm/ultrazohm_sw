-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\valen\Documents\repos\UZ\ultrazohm_sw_working\ip_cores\uz_sixphase_VSD_transformation\hdl_prj\hdlsrc\uz_sixphase_VSD_transformation\uz_sixphase_VSD_transformation_src_Product_nw_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_sixphase_VSD_transformation_src_Product_nw_block1
-- Source Path: 
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
...
ENTITY uz_sixphase_VSD_transformation_src_Product_nw_block1 IS
...
END uz_sixphase_VSD_transformation_src_Product_nw_block1;


ARCHITECTURE rtl OF uz_sixphase_VSD_transformation_src_Product_nw_block1 IS
  ...
  SIGNAL Product_Re_BD_bypass             : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL Product_Re_BD_last_value         : signed(26 DOWNTO 0);  -- sfix27_En16
...
BEGIN
  ...
  Product_mul_temp <= Product_C2ReIm_1_C2ReIm_B * Product_C2ReIm_2_C2ReIm_B;
  Product_Re_BD <= Product_mul_temp(42 DOWNTO 16);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Product_Re_BD_last_value <= to_signed(16#0000000#, 27);
      ELSIF enb_gated = '1' THEN
        Product_Re_BD_last_value <= Product_Re_BD_bypass;
      END IF;
    END IF;
  ...
  Product_Re_BD_bypass <= Product_Re_BD_last_value WHEN globalSchedule = '0' ELSE
      Product_Re_BD_1;

  out0 <= std_logic_vector(Product_Re_BD_bypass);
