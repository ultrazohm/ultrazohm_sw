...
void FOC_FCF_step(RT_MODEL_FOC_FCF_T *const FOC_FCF_M)
{
  ...
  if (FOC_FCF_P.FOC_Calibrate_I_ph > 0.0F) {
    ...
    for (i_0 = 0; i_0 < 9; i_0++) {
      ...
      UnitDelay1_p = FOC_FCF_DW->UnitDelay1_DSTATE_c[i_0];
      FOC_FCF_B->UnitDelay1_p[i_0] = UnitDelay1_p;

      /* Gain: '<S22>/Gain' */
      Gain_a = FOC_FCF_P.Gain_Gain * FOC_FCF_B->Sum[i_0];
      FOC_FCF_B->Gain_a[i_0] = Gain_a;

      /* Sum: '<S22>/Add' */
      Gain_a -= UnitDelay1_p;
      FOC_FCF_B->Add_p[i_0] = Gain_a;

      /* Product: '<S22>/Divide' */
      Gain_a /= FOC_FCF_B->VermeidungDivisionDurchNull;
      FOC_FCF_B->Divide[i_0] = Gain_a;

      /* Product: '<S23>/Product' incorporates:
       *  Constant: '<S23>/FOC_T_fast'
       */
      Gain_a *= FOC_FCF_P.FOC_T_fast_Value;
      FOC_FCF_B->Product_cdf[i_0] = Gain_a;

      /* Sum: '<S23>/Sum2' */
      UnitDelay1_p += Gain_a;
      FOC_FCF_B->Sum2_k[i_0] = UnitDelay1_p;

      /* Update for UnitDelay: '<S23>/Unit Delay1' */
      FOC_FCF_DW->UnitDelay1_DSTATE_c[i_0] = UnitDelay1_p;
    }
  }
  ...
  /* MultiPortSwitch: '<S64>/Selectphicalc3' incorporates:
   *  Constant: '<S64>/FOC_ENABLE_Undervoltage_U_DC1'
   */
  if ((int32_T)FOC_FCF_P.FOC_ENABLE_Undervoltage_U_DC == 0) {
    ...
    /* MultiPortSwitch: '<S64>/Selectphicalc3' */
    FOC_FCF_B->Selectphicalc3 = FOC_FCF_B->FixPtRelationalOperator_j;
  }

  /* End of MultiPortSwitch: '<S64>/Selectphicalc3' */
  ...
  i_0 = (int32_T)(((uint32_T)i_0 << 1) + tmp_1);
  tmp_1 = FOC_FCF_B->Memory;
  i_0 = (int32_T)(((uint32_T)i_0 << 1) + tmp_1);
  FOC_FCF_B->Logic[0U] = FOC_FCF_P.Logic_table[(uint32_T)i_0];
  FOC_FCF_B->Logic[1U] = FOC_FCF_P.Logic_table[(uint32_T)i_0 + 8U];

  /* MultiPortSwitch: '<S64>/Selectphicalc1' incorporates:
   *  Constant: '<S64>/FOC_ENABLE_Undervoltage_U_DC1'
   */
  if ((int32_T)FOC_FCF_P.FOC_ENABLE_Undervoltage_U_DC == 0) {
    /* MultiPortSwitch: '<S64>/Selectphicalc1' incorporates:
    ...
    /* MultiPortSwitch: '<S64>/Selectphicalc1' */
    FOC_FCF_B->U_DC_Undervoltage_Error = FOC_FCF_B->Logic[0];
  }

  /* End of MultiPortSwitch: '<S64>/Selectphicalc1' */
  ...
  /* MultiPortSwitch: '<S64>/Selectphicalc4' incorporates:
   *  Constant: '<S64>/FOC_ENABLE_Overvoltage_U_DC1'
   */
  if ((int32_T)FOC_FCF_P.FOC_ENABLE_Overvoltage_U_DC == 0) {
    ...
    /* MultiPortSwitch: '<S64>/Selectphicalc4' */
    FOC_FCF_B->Selectphicalc4 = FOC_FCF_B->FixPtRelationalOperator_m;
  }

  /* End of MultiPortSwitch: '<S64>/Selectphicalc4' */
  ...
  i_0 = (int32_T)(((uint32_T)i_0 << 1) + tmp_1);
  FOC_FCF_B->Logic_c[0U] = FOC_FCF_P.Logic_table_l[(uint32_T)i_0];
  FOC_FCF_B->Logic_c[1U] = FOC_FCF_P.Logic_table_l[(uint32_T)i_0 + 8U];

  /* MultiPortSwitch: '<S64>/Selectphicalc2' incorporates:
   *  Constant: '<S64>/FOC_ENABLE_Overvoltage_U_DC1'
   */
  if ((int32_T)FOC_FCF_P.FOC_ENABLE_Overvoltage_U_DC == 0) {
    /* MultiPortSwitch: '<S64>/Selectphicalc2' incorporates:
    ...
    /* MultiPortSwitch: '<S64>/Selectphicalc2' */
    FOC_FCF_B->U_DC_Overvoltage_Error = FOC_FCF_B->Logic_c[0];
  }

  /* End of MultiPortSwitch: '<S64>/Selectphicalc2' */
  for (i_0 = 0; i_0 < 9; i_0++) {
    /* Abs: '<S63>/Abs' */
  ...
  for (i_0 = 0; i_0 < 8; i_0++) {
    UnitDelay1_p = fmaxf(UnitDelay1_p, FOC_FCF_B->Abs[i_0 + 1]);
  }
   ...
   *  Constant: '<S63>/FOC_ENABLE_Overcurrent_I_uvw1'
   */
  ...
  i_0 = (int32_T)(((uint32_T)i_0 << 1) + tmp_1);
  FOC_FCF_B->Logic_a[0U] = FOC_FCF_P.Logic_table_o[(uint32_T)i_0];
  FOC_FCF_B->Logic_a[1U] = FOC_FCF_P.Logic_table_o[(uint32_T)i_0 + 8U];
  ...
  for (i_1 = 0; i_1 < 2; i_1++) {
    /* Gain: '<S34>/TrafoMatrix uvw->alphabeta' */
    TrafoMatrixuvwalphabeta = FOC_FCF_P.TrafoMatrixuvwalphabeta_Gain[i_1] *
      UnitDelay1_p;
    TrafoMatrixuvwalphabeta += FOC_FCF_P.TrafoMatrixuvwalphabeta_Gain[i_1 + 2] *
      Gain_a;
    TrafoMatrixuvwalphabeta += FOC_FCF_P.TrafoMatrixuvwalphabeta_Gain[i_1 + 4] *
      I_ph;
    FOC_FCF_B->TrafoMatrixuvwalphabeta[i_1] = TrafoMatrixuvwalphabeta;
  }
   ...
   *  Inport: '<Root>/bus_SCF'
   */
  FOC_FCF_B->IdqErr[0] = FOC_FCF_U->bus_SCF.I_dq_Ref[0] - FOC_FCF_B->I_d1_Act;
  FOC_FCF_B->IdqErr[1] = FOC_FCF_U->bus_SCF.I_dq_Ref[1] - FOC_FCF_B->I_q1_Act;

  /* Product: '<S38>/KP*e[k]1' incorporates:
   *  Constant: '<S38>/FOC_KP1'
   */
  FOC_FCF_B->KPek1[0] = FOC_FCF_B->IdqErr[0] * FOC_FCF_P.FOC_KP;

  /* UnitDelay: '<S38>/IntegDelay1' */
  ...
  i_0 = (int32_T)(((uint32_T)i_0 << 1) + tmp_1);
  FOC_FCF_B->Logic_a0[0U] = FOC_FCF_P.Logic_table_e[(uint32_T)i_0];
  FOC_FCF_B->Logic_a0[1U] = FOC_FCF_P.Logic_table_e[(uint32_T)i_0 + 8U];
  ...
  if (FOC_FCF_B->FOC_Enable_Bus[0]) {
    ...
    /* Switch: '<S38>/IntegEnaSwitch1' incorporates:
     *  Constant: '<S38>/Zero'
     */
  ...
  /* End of Switch: '<S38>/IntegEnaSwitch1' */
  ...
  for (i_1 = 0; i_1 < 2; i_1++) {
    /* Gain: '<S35>/TrafoMatrix uvw->alphabeta' */
    TrafoMatrixuvwalphabeta = FOC_FCF_P.TrafoMatrixuvwalphabeta_Gain_p[i_1] *
      UnitDelay1_p;
    TrafoMatrixuvwalphabeta += FOC_FCF_P.TrafoMatrixuvwalphabeta_Gain_p[i_1 + 2]
      * Gain_a;
    TrafoMatrixuvwalphabeta += FOC_FCF_P.TrafoMatrixuvwalphabeta_Gain_p[i_1 + 4]
      * I_ph;
    FOC_FCF_B->TrafoMatrixuvwalphabeta_h[i_1] = TrafoMatrixuvwalphabeta;
  }
  ...
  /* Product: '<S42>/KP*e[k]1' incorporates:
   *  Constant: '<S42>/FOC_KP1'
   */
  FOC_FCF_B->KPek1_l[0] = FOC_FCF_B->IdqErr_l[0] * FOC_FCF_P.FOC_KP;

  /* UnitDelay: '<S42>/IntegDelay1' */
  ...
  if (FOC_FCF_B->FOC_Enable_Bus[1]) {
    ...
    /* Switch: '<S42>/IntegEnaSwitch1' incorporates:
     *  Constant: '<S42>/Zero'
     */
  ...
  /* End of Switch: '<S42>/IntegEnaSwitch1' */
  ...
  for (i_1 = 0; i_1 < 2; i_1++) {
    /* Gain: '<S36>/TrafoMatrix uvw->alphabeta' */
    TrafoMatrixuvwalphabeta = FOC_FCF_P.TrafoMatrixuvwalphabeta_Gain_j[i_1] *
      UnitDelay1_p;
    TrafoMatrixuvwalphabeta += FOC_FCF_P.TrafoMatrixuvwalphabeta_Gain_j[i_1 + 2]
      * Gain_a;
    TrafoMatrixuvwalphabeta += FOC_FCF_P.TrafoMatrixuvwalphabeta_Gain_j[i_1 + 4]
      * I_ph;
    FOC_FCF_B->TrafoMatrixuvwalphabeta_m[i_1] = TrafoMatrixuvwalphabeta;
  }
  ...
  /* Product: '<S46>/KP*e[k]1' incorporates:
   *  Constant: '<S46>/FOC_KP1'
   */
  FOC_FCF_B->KPek1_h[0] = FOC_FCF_B->IdqErr_e[0] * FOC_FCF_P.FOC_KP;

  /* UnitDelay: '<S46>/IntegDelay1' */
  ...
  if (FOC_FCF_B->FOC_Enable_Bus[2]) {
    ...
    /* Switch: '<S46>/IntegEnaSwitch1' incorporates:
     *  Constant: '<S46>/Zero'
     */
  ...
  /* End of Switch: '<S46>/IntegEnaSwitch1' */
   ...
   */
  for (i_1 = 0; i_1 < 6; i_1++) {
    tmp[i_1] = FOC_FCF_P.Constant_Value_d[i_1];
  }

  TrafoMatrixuvwalphabeta = FOC_FCF_B->Product_c0[0];
  Gain_l = FOC_FCF_B->Product_c0[1];
  for (i_1 = 0; i_1 < 3; i_1++) {
    I_ph = tmp[i_1] * TrafoMatrixuvwalphabeta;
    I_ph += tmp[i_1 + 3] * Gain_l;

    /* Product: '<S102>/Product' */
    FOC_FCF_B->U_uvw1[i_1] = I_ph;
  }

  /* End of Product: '<S102>/Product' */
   ...
   */
  for (i_1 = 0; i_1 < 6; i_1++) {
    tmp[i_1] = FOC_FCF_P.Constant_Value_g[i_1];
  }
   ...
   */
  for (i_1 = 0; i_1 < 6; i_1++) {
    tmp[i_1] = FOC_FCF_P.Constant_Value_o[i_1];
  }
  ...
  /* MinMax: '<S99>/AvoidDivBy0' incorporates:
   *  Constant: '<S99>/Constant2'
   */
  UnitDelay1_p = fmaxf(FOC_FCF_P.Constant2_Value_g, FOC_FCF_B->U_DC2);

  /* MinMax: '<S99>/AvoidDivBy0' */
  FOC_FCF_B->AvoidDivBy0 = UnitDelay1_p;
  for (i_0 = 0; i_0 < 3; i_0++) {
    /* Product: '<S104>/Product' */
    UnitDelay1_p = tmp[i_0] * TrafoMatrixuvwalphabeta;
    UnitDelay1_p += tmp[i_0 + 3] * Gain_l;

    /* Product: '<S104>/Product' */
    FOC_FCF_B->Product_fb[i_0] = UnitDelay1_p;

    /* Product: '<S99>/DutyCycle_normalized' */
    ...
    FOC_FCF_B->DutyCycle_normed[i_0 + 3] = FOC_FCF_B->Product_f3[i_0] /
      FOC_FCF_B->AvoidDivBy0;
    FOC_FCF_B->DutyCycle_normed[i_0 + 6] = UnitDelay1_p / FOC_FCF_B->AvoidDivBy0;
  }
  ...
  /* Sum: '<S101>/DutyCycle_SuperSinus_1' */
  ...
  /* Sum: '<S101>/DutyCycle_SuperSinus_2' */
  ...
  /* Sum: '<S101>/DutyCycle_SuperSinus_3' */
  ...
  for (i_0 = 0; i_0 < 9; i_0++) {
    /* Bias: '<S97>/Scale [0..2]' */
    UnitDelay1_p = FOC_FCF_B->SelMod_DutyCycles[i_0] + FOC_FCF_P.Scale02_Bias;
    FOC_FCF_B->Scale02[i_0] = UnitDelay1_p;

    /* Gain: '<S97>/Scale  [0..1]' */
    UnitDelay1_p *= FOC_FCF_P.Scale01_Gain;
    FOC_FCF_B->Scale01[i_0] = UnitDelay1_p;

    /* Saturate: '<S97>/Limit [0..1]' */
    ...
    /* Saturate: '<S97>/Limit [0..1]' */
    FOC_FCF_B->Limit01[i_0] = UnitDelay1_p;
  }

  /* MultiPortSwitch: '<S100>/Select_GateDriver_Assignment_1' incorporates:
   *  Constant: '<S100>/Constant6'
   */
  switch ((int32_T)FOC_FCF_P.FOC_SELECT_Voltage_Assignment_UVW) {
   case 1:
    /* MultiPortSwitch: '<S100>/Select_GateDriver_Assignment_1' */
    ...
    /* MultiPortSwitch: '<S100>/Select_GateDriver_Assignment_2' */
    ...
    /* MultiPortSwitch: '<S100>/Select_GateDriver_Assignment_3' */
  ...
  /* End of MultiPortSwitch: '<S100>/Select_GateDriver_Assignment_1' */
  ...
  i_0 = (int32_T)(((uint32_T)i_0 << 1) + tmp_1);
  FOC_FCF_B->Logic_e[0U] = FOC_FCF_P.Logic_table_lc[(uint32_T)i_0];
  FOC_FCF_B->Logic_e[1U] = FOC_FCF_P.Logic_table_lc[(uint32_T)i_0 + 8U];
  ...
  /* S-Function (sfix_bitop): '<S50>/Bitwise NOT' */
  ...
  /* ArithShift: '<S50>/get_U_HS_FLT' incorporates:
   *  S-Function (sfix_bitop): '<S50>/MaskBit0'
   */
  ...
  /* ArithShift: '<S50>/get_U_LS_FLT' incorporates:
   *  S-Function (sfix_bitop): '<S50>/MaskBit1'
   */
  ...
  /* ArithShift: '<S50>/get_V_HS_FLT' incorporates:
   *  S-Function (sfix_bitop): '<S50>/MaskBit2'
   */
  ...
  /* ArithShift: '<S50>/get_V_LS_FLT' incorporates:
   *  S-Function (sfix_bitop): '<S50>/MaskBit3'
   */
  ...
  /* ArithShift: '<S50>/get_W_HS_FLT' incorporates:
   *  S-Function (sfix_bitop): '<S50>/MaskBit4'
   */
  ...
  /* ArithShift: '<S50>/get_W_LS_FLT' incorporates:
   *  S-Function (sfix_bitop): '<S50>/MaskBit5'
   */
  ...
  /* ArithShift: '<S51>/get_U_HS_RDY' incorporates:
   *  S-Function (sfix_bitop): '<S51>/MaskBit0'
   */
  ...
  /* ArithShift: '<S51>/get_U_LS_RDY' incorporates:
   *  S-Function (sfix_bitop): '<S51>/MaskBit1'
   */
  ...
  /* ArithShift: '<S51>/get_V_HS_RDY' incorporates:
   *  S-Function (sfix_bitop): '<S51>/MaskBit2'
   */
  ...
  /* ArithShift: '<S51>/get_V_LS_RDY' incorporates:
   *  S-Function (sfix_bitop): '<S51>/MaskBit3'
   */
  ...
  /* ArithShift: '<S51>/get_W_HS_RDY' incorporates:
   *  S-Function (sfix_bitop): '<S51>/MaskBit4'
   */
  ...
  /* ArithShift: '<S51>/get_W_LS_RDY' incorporates:
   *  S-Function (sfix_bitop): '<S51>/MaskBit5'
   */
  ...
  /* MultiPortSwitch: '<S49>/EN_FLT_Switch_1' incorporates:
   *  Constant: '<S49>/ENABLE_GateDriver_FLT_Error_Sys1'
   */
  if ((int32_T)FOC_FCF_P.ENABLE_GateDriver_FLT_Error_Sys1 == 0) {
    /* MultiPortSwitch: '<S49>/EN_FLT_Switch_1' incorporates:
     *  Constant: '<S49>/NO_ERROR'
     */
    FOC_FCF_B->EN_FLT_Switch_1 = FOC_FCF_P.NO_ERROR_Value;
  } else {
    /* MultiPortSwitch: '<S49>/EN_FLT_Switch_1' */
    FOC_FCF_B->EN_FLT_Switch_1 = FOC_FCF_B->bus_InvStatus.FLT_Error_Sys1;
  }

  /* End of MultiPortSwitch: '<S49>/EN_FLT_Switch_1' */

  /* MultiPortSwitch: '<S49>/EN_FLT_Switch_2' incorporates:
   *  Constant: '<S49>/ENABLE_GateDriver_FLT_Error_Sys2'
   */
  if ((int32_T)FOC_FCF_P.ENABLE_GateDriver_FLT_Error_Sys2 == 0) {
    ...
    /* MultiPortSwitch: '<S49>/EN_FLT_Switch_2' */
    FOC_FCF_B->EN_FLT_Switch_2 = FOC_FCF_B->bus_InvStatus.FLT_Error_Sys2;
  }

  /* End of MultiPortSwitch: '<S49>/EN_FLT_Switch_2' */

  /* MultiPortSwitch: '<S49>/EN_FLT_Switch_3' incorporates:
   *  Constant: '<S49>/ENABLE_GateDriver_FLT_Error_Sys3'
   */
  if ((int32_T)FOC_FCF_P.ENABLE_GateDriver_FLT_Error_Sys3 == 0) {
    ...
    /* MultiPortSwitch: '<S49>/EN_FLT_Switch_3' */
    FOC_FCF_B->EN_FLT_Switch_3 = FOC_FCF_B->bus_InvStatus.FLT_Error_Sys3;
  }

  /* End of MultiPortSwitch: '<S49>/EN_FLT_Switch_3' */

  /* MultiPortSwitch: '<S49>/EN_RDY_Switch_1' incorporates:
   *  Constant: '<S49>/ENABLE_GateDriver_RDY_Error_Sys1'
   */
  if ((int32_T)FOC_FCF_P.ENABLE_GateDriver_RDY_Error_Sys1 == 0) {
    ...
    /* MultiPortSwitch: '<S49>/EN_RDY_Switch_1' */
    FOC_FCF_B->EN_RDY_Switch_1 = FOC_FCF_B->bus_InvStatus.RDY_Error_Sys1;
  }

  /* End of MultiPortSwitch: '<S49>/EN_RDY_Switch_1' */

  /* MultiPortSwitch: '<S49>/EN_RDY_Switch_2' incorporates:
   *  Constant: '<S49>/ENABLE_GateDriver_RDY_Error_Sys2'
   */
  if ((int32_T)FOC_FCF_P.ENABLE_GateDriver_RDY_Error_Sys2 == 0) {
    ...
    /* MultiPortSwitch: '<S49>/EN_RDY_Switch_2' */
    FOC_FCF_B->EN_RDY_Switch_2 = FOC_FCF_B->bus_InvStatus.RDY_Error_Sys2;
  }

  /* End of MultiPortSwitch: '<S49>/EN_RDY_Switch_2' */

  /* MultiPortSwitch: '<S49>/EN_RDY_Switch_3' incorporates:
   *  Constant: '<S49>/ENABLE_GateDriver_RDY_Error_Sys3'
   */
  if ((int32_T)FOC_FCF_P.ENABLE_GateDriver_RDY_Error_Sys3 == 0) {
    ...
    /* MultiPortSwitch: '<S49>/EN_RDY_Switch_3' */
  ...
  for (i_0 = 0; i_0 < 6; i_0++) {
    ...
    i_1 = i_0 * 19;
    i = 1;
    UnitDelay1_p = FOC_FCF_B->TmpSignalConversionAtDiscreteFI[i_0] *
      FOC_FCF_P.DiscreteFIRFilter20thorderUdq_C[0];
    for (tmp_0 = FOC_FCF_DW->DiscreteFIRFilter20thorderUdq_c; tmp_0 < 19; tmp_0
         ++) {
      Gain_a = FOC_FCF_DW->DiscreteFIRFilter20thorderUdq_s[i_1 + tmp_0] *
        FOC_FCF_P.DiscreteFIRFilter20thorderUdq_C[i];
      UnitDelay1_p += Gain_a;
      i++;
    }

    for (tmp_0 = 0; tmp_0 < FOC_FCF_DW->DiscreteFIRFilter20thorderUdq_c; tmp_0++)
    {
      Gain_a = FOC_FCF_DW->DiscreteFIRFilter20thorderUdq_s[i_1 + tmp_0] *
        FOC_FCF_P.DiscreteFIRFilter20thorderUdq_C[i];
      UnitDelay1_p += Gain_a;
  ...
  if (FOC_FCF_B->FOC_Enable_Bus[0]) {
    ...
    /* Switch: '<S38>/IntegStopSwitch2' incorporates:
     *  Constant: '<S38>/Zero1'
     */
  ...
  /* End of Switch: '<S38>/IntegStopSwitch2' */
  ...
  /* Switch: '<S42>/IntegStopSwitch2' */
  if (FOC_FCF_B->FOC_Enable_Bus[1]) {
    /* RelationalOperator: '<S41>/AntiWindupLE' incorporates:
     *  Constant: '<S41>/FOC_MaxModInd'
     */
    FOC_FCF_B->AntiWindupLE_f = (FOC_FCF_B->ModInd[1] <= FOC_FCF_P.FOC_MaxModInd);

    /* Switch: '<S42>/IntegStopSwitch3' */
    UnitDelay1_p = FOC_FCF_B->IntegDelay1_o[0];
    if (FOC_FCF_B->Product1_k > FOC_FCF_P.IntegStopSwitch3_Threshold_a) {
      /* Switch: '<S42>/IntegStopSwitch3' */
      Gain_a = UnitDelay1_p;
    } else {
      /* Switch: '<S42>/IntegStopSwitch3' incorporates:
       *  Constant: '<S42>/Zero1'
       */
    ...
    /* Switch: '<S42>/IntegStopSwitch2' incorporates:
     *  Constant: '<S42>/Zero1'
     */
  ...
  /* End of Switch: '<S42>/IntegStopSwitch2' */

  /* Switch: '<S46>/IntegStopSwitch2' */
  if (FOC_FCF_B->FOC_Enable_Bus[2]) {
    /* RelationalOperator: '<S45>/AntiWindupLE' incorporates:
     *  Constant: '<S45>/FOC_MaxModInd'
     */
    FOC_FCF_B->AntiWindupLE = (FOC_FCF_B->ModInd[2] <= FOC_FCF_P.FOC_MaxModInd);

    /* Switch: '<S46>/IntegStopSwitch3' */
    UnitDelay1_p = FOC_FCF_B->IntegDelay1_d[0];
    if (FOC_FCF_B->Product1_b > FOC_FCF_P.IntegStopSwitch3_Threshold_ad) {
      /* Switch: '<S46>/IntegStopSwitch3' */
      Gain_a = UnitDelay1_p;
    } else {
      /* Switch: '<S46>/IntegStopSwitch3' incorporates:
       *  Constant: '<S46>/Zero1'
       */
    ...
    /* Switch: '<S46>/IntegStopSwitch2' incorporates:
     *  Constant: '<S46>/Zero1'
     */
  ...
  /* End of Switch: '<S46>/IntegStopSwitch2' */

  /* DiscreteFir: '<S6>/Discrete FIR Filter 20th order Idq' */
  for (i_0 = 0; i_0 < 6; i_0++) {
    i_1 = i_0 * 19;
    i = 1;
    UnitDelay1_p = FOC_FCF_B->I_dq_Act[i_0] *
      FOC_FCF_P.DiscreteFIRFilter20thorderIdq_C[0];
    for (tmp_0 = FOC_FCF_DW->DiscreteFIRFilter20thorderIdq_c; tmp_0 < 19; tmp_0
         ++) {
      Gain_a = FOC_FCF_DW->DiscreteFIRFilter20thorderIdq_s[i_1 + tmp_0] *
        FOC_FCF_P.DiscreteFIRFilter20thorderIdq_C[i];
      UnitDelay1_p += Gain_a;
      i++;
    }

    for (tmp_0 = 0; tmp_0 < FOC_FCF_DW->DiscreteFIRFilter20thorderIdq_c; tmp_0++)
    {
      Gain_a = FOC_FCF_DW->DiscreteFIRFilter20thorderIdq_s[i_1 + tmp_0] *
        FOC_FCF_P.DiscreteFIRFilter20thorderIdq_C[i];
      UnitDelay1_p += Gain_a;
    ...
    FOC_FCF_B->I_dq_Act_filt[i_0] = UnitDelay1_p;
  }
  ...
  i_0 = (int32_T)(((uint32_T)i_0 << 1) + tmp_1);
  FOC_FCF_B->Logic_g[0U] = FOC_FCF_P.Logic_table_l5[(uint32_T)i_0];
  FOC_FCF_B->Logic_g[1U] = FOC_FCF_P.Logic_table_l5[(uint32_T)i_0 + 8U];
  ...
  i_0 = (int32_T)(((uint32_T)i_0 << 1) + tmp_1);
  FOC_FCF_B->Logic_i[0U] = FOC_FCF_P.Logic_table_p[(uint32_T)i_0];
  FOC_FCF_B->Logic_i[1U] = FOC_FCF_P.Logic_table_p[(uint32_T)i_0 + 8U];
  ...
  i_0 = (int32_T)(((uint32_T)i_0 << 1) + tmp_1);
  FOC_FCF_B->Logic_b[0U] = FOC_FCF_P.Logic_table_j[(uint32_T)i_0];
  FOC_FCF_B->Logic_b[1U] = FOC_FCF_P.Logic_table_j[(uint32_T)i_0 + 8U];
  ...
  i_0 = (int32_T)(((uint32_T)i_0 << 1) + tmp_1);
  FOC_FCF_B->Logic_p[0U] = FOC_FCF_P.Logic_table_o1[(uint32_T)i_0];
  FOC_FCF_B->Logic_p[1U] = FOC_FCF_P.Logic_table_o1[(uint32_T)i_0 + 8U];
  ...
  i_0 = (int32_T)(((uint32_T)i_0 << 1) + tmp_1);
  FOC_FCF_B->Logic_d[0U] = FOC_FCF_P.Logic_table_i[(uint32_T)i_0];
  FOC_FCF_B->Logic_d[1U] = FOC_FCF_P.Logic_table_i[(uint32_T)i_0 + 8U];
  ...
  i_0 = (int32_T)(((uint32_T)i_0 << 1) + tmp_1);
  FOC_FCF_B->Logic_ev[0U] = FOC_FCF_P.Logic_table_c[(uint32_T)i_0];
  FOC_FCF_B->Logic_ev[1U] = FOC_FCF_P.Logic_table_c[(uint32_T)i_0 + 8U];
  ...
  i_0 = (int32_T)(((uint32_T)i_0 << 1) + tmp_1);
  FOC_FCF_B->Logic_bw[0U] = FOC_FCF_P.Logic_table_ij[(uint32_T)i_0];
  FOC_FCF_B->Logic_bw[1U] = FOC_FCF_P.Logic_table_ij[(uint32_T)i_0 + 8U];
  ...
  i_0 = (int32_T)(((uint32_T)i_0 << 1) + tmp_1);
  FOC_FCF_B->Logic_ag[0U] = FOC_FCF_P.Logic_table_pd[(uint32_T)i_0];
  FOC_FCF_B->Logic_ag[1U] = FOC_FCF_P.Logic_table_pd[(uint32_T)i_0 + 8U];
  ...
  i_0 = (int32_T)(((uint32_T)i_0 << 1) + tmp_1);
  FOC_FCF_B->Logic_f[0U] = FOC_FCF_P.Logic_table_a[(uint32_T)i_0];
  FOC_FCF_B->Logic_f[1U] = FOC_FCF_P.Logic_table_a[(uint32_T)i_0 + 8U];
...
void FOC_FCF_initialize(RT_MODEL_FOC_FCF_T *const FOC_FCF_M)
{
...

  {
    ...
    /* InitializeConditions for UnitDelay: '<S38>/IntegDelay1' */
    FOC_FCF_DW->IntegDelay1_DSTATE[0] = FOC_FCF_P.IntegDelay1_InitialCondition;

    /* InitializeConditions for UnitDelay: '<S42>/IntegDelay1' */
    FOC_FCF_DW->IntegDelay1_DSTATE_p[0] =
      FOC_FCF_P.IntegDelay1_InitialCondition_m;

    /* InitializeConditions for UnitDelay: '<S46>/IntegDelay1' */
