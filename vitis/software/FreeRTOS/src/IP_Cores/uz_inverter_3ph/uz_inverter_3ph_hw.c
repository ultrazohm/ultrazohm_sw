...
//general Inputs
void uz_inverter_3ph_hw_write_switch_pspl_abc(uint32_t base_address,  bool switch_pspl_abc){
    uz_assert_not_zero(base_address);
    uz_axi_write_bool(base_address + switch_pspl_abc_Data_uz_inverter_3ph, switch_pspl_abc);
}

void uz_inverter_3ph_hw_write_switch_pspl_gate(uint32_t base_address,  bool switch_pspl_gate){
    uz_assert_not_zero(base_address);
    uz_axi_write_bool(base_address + switch_pspl_gate_Data_uz_inverter_3ph, switch_pspl_gate);
}

void uz_inverter_3ph_hw_write_udc(uint32_t base_address, float udc){
    uz_assert_not_zero(base_address);
    uz_axi_write_float(base_address + u_dc_Data_uz_inverter_3ph, 0.5f*udc);
}
...
void uz_inverter_3ph_hw_write_i_a_ps(uint32_t base_address, float i_a_ps){
    uz_assert_not_zero(base_address);
    uz_axi_write_float(base_address + i_a_ps_Data_uz_inverter_3ph, i_a_ps);
}

void uz_inverter_3ph_hw_write_i_b_ps(uint32_t base_address, float i_b_ps){
    uz_assert_not_zero(base_address);
    uz_axi_write_float(base_address + i_b_ps_Data_uz_inverter_3ph, i_b_ps);
}

void uz_inverter_3ph_hw_write_i_c_ps(uint32_t base_address, float i_c_ps){
    uz_assert_not_zero(base_address);
    uz_axi_write_float(base_address + i_c_ps_Data_uz_inverter_3ph, i_c_ps);
}
...
void uz_inverter_3ph_hw_write_gate1(uint32_t base_address,  bool gate1){
    uz_assert_not_zero(base_address);
    uz_axi_write_bool(base_address + gate1_ps_Data_uz_inverter_3ph, gate1);
}

void uz_inverter_3ph_hw_write_gate2(uint32_t base_address,  bool gate2){
    uz_assert_not_zero(base_address);
    uz_axi_write_bool(base_address + gate2_ps_Data_uz_inverter_3ph, gate2);
}

void uz_inverter_3ph_hw_write_gate3(uint32_t base_address,  bool gate3){
    uz_assert_not_zero(base_address);
    uz_axi_write_bool(base_address + gate3_ps_Data_uz_inverter_3ph, gate3);
}

void uz_inverter_3ph_hw_write_gate4(uint32_t base_address,  bool gate4){
    uz_assert_not_zero(base_address);
    uz_axi_write_bool(base_address + gate4_ps_Data_uz_inverter_3ph, gate4);
}

void uz_inverter_3ph_hw_write_gate5(uint32_t base_address, bool gate5){
    uz_assert_not_zero(base_address);
    uz_axi_write_bool(base_address + gate5_ps_Data_uz_inverter_3ph, gate5);
}

void uz_inverter_3ph_hw_write_gate6(uint32_t base_address, bool gate6){
    uz_assert_not_zero(base_address);
    uz_axi_write_bool(base_address + gate6_ps_Data_uz_inverter_3ph, gate6);
}
