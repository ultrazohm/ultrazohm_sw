...
int JavaScope_initialize(DS_Data* data)
{
	...
	js_ch_observable[JSO_CurrentSector] = &data->av.current_sector;
	js_ch_observable[JSO_SV_Angle] = &data->av.SV_angle;
	js_ch_observable[JSO_AlphaTrafo] = &data->av.alpha_trafo;
	js_ch_observable[JSO_BetaTrafo] = &data->av.beta_trafo;
	js_ch_observable[JSO_XTrafo] = &data->av.x_trafo;
