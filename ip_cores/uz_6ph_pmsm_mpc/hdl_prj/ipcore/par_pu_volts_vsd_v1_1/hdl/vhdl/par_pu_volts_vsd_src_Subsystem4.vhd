-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_mpc_6ph_parallel\par_pu_volts_vsd_src_Subsystem4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: par_pu_volts_vsd_src_Subsystem4
-- Source Path: uz_mpc_6ph_parallel/pu_voltages_vsd/Subsystem4
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY par_pu_volts_vsd_src_Subsystem4 IS
...
END par_pu_volts_vsd_src_Subsystem4;


ARCHITECTURE rtl OF par_pu_volts_vsd_src_Subsystem4 IS
...
BEGIN
  ...
  Logical_Operator3_out1 <=  NOT Switch1_out1;

  Q <= Switch1_out1;

  alphaQ <= Logical_Operator3_out1;
