-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\Philipp\ultrazohm\ultrazohm_sw\ip_cores\uz_pmsm_model_nonlinear_6LUT\hdl_prj\hdlsrc\uz_pmsm_model_6LUT_pd\uz_pmsm_6LUT_approx_src_nfp_mul_double.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_6LUT_approx_src_nfp_mul_double
-- Source Path: uz_pmsm_model_6LUT_pd/uz_pmsm_model_6LUT/nfp_mul_double
-- Hierarchy Level: 1
-- Model version: 7.18
-- 
...
ENTITY uz_pmsm_6LUT_approx_src_nfp_mul_double IS
...
END uz_pmsm_6LUT_approx_src_nfp_mul_double;


ARCHITECTURE rtl OF uz_pmsm_6LUT_approx_src_nfp_mul_double IS
  ...
  SIGNAL Delay6_PS_9_reg                  : std_logic_vector(4 DOWNTO 0);  -- ufix1 [5]
  SIGNAL Delay6_PS_9_out1                 : std_logic;  -- ufix1
  SIGNAL Delay11_PS_2_8_reg               : std_logic_vector(3 DOWNTO 0);  -- ufix1 [4]
  ...
  SIGNAL Delay10_PS_2_8_reg               : std_logic_vector(3 DOWNTO 0);  -- ufix1 [4]
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        Delay6_PS_9_reg(4 DOWNTO 1) <= Delay6_PS_9_reg(3 DOWNTO 0);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        Delay11_PS_2_8_reg(3 DOWNTO 1) <= Delay11_PS_2_8_reg(2 DOWNTO 0);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        Delay10_PS_2_8_reg(3 DOWNTO 1) <= Delay10_PS_2_8_reg(2 DOWNTO 0);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        Delay2_PS_4_7_reg(1) <= Delay2_PS_4_7_reg(0);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        Delay9_PS_2_8_reg(1 TO 3) <= Delay9_PS_2_8_reg(0 TO 2);
      END IF;
    END IF;
