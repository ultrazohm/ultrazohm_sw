-- -------------------------------------------------------------
-- 
-- File Name: /home/ts/Dokumente/ultrazohm_testbench/ultrazohm_test/ultrazohm_sw/ip_cores/InterlockDeadtime2L/hdlsrc/uz_interlockDeadtime2L/uz_interlockDeadtime2L_axi4_module.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_interlockDeadtime2L_axi4_module
-- Source Path: uz_interlockDeadtime2L/uz_interlockDeadtime2L_axi4/uz_interlockDeadtime2L_axi4_module
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_interlockDeadtime2L_axi4_module IS
...
END uz_interlockDeadtime2L_axi4_module;


ARCHITECTURE rtl OF uz_interlockDeadtime2L_axi4_module IS

  -- Component Declarations
  COMPONENT uz_interlockDeadtime2L_rdfifo_data
    PORT( clk                             :   IN    std_logic;
  ...
  COMPONENT uz_interlockDeadtime2L_rdfifo_rid
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT uz_interlockDeadtime2L_rdfifo_last
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : uz_interlockDeadtime2L_rdfifo_data
    USE ENTITY work.uz_interlockDeadtime2L_rdfifo_data(rtl);

  FOR ALL : uz_interlockDeadtime2L_rdfifo_rid
    USE ENTITY work.uz_interlockDeadtime2L_rdfifo_rid(rtl);

  FOR ALL : uz_interlockDeadtime2L_rdfifo_last
    USE ENTITY work.uz_interlockDeadtime2L_rdfifo_last(rtl);
...
BEGIN
  u_uz_interlockDeadtime2L_rdfifo_data_inst : uz_interlockDeadtime2L_rdfifo_data
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => const_1,
  ...
  u_uz_interlockDeadtime2L_rdfifo_rid_inst : uz_interlockDeadtime2L_rdfifo_rid
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => const_1,
  ...
  u_uz_interlockDeadtime2L_rdfifo_last_inst : uz_interlockDeadtime2L_rdfifo_last
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => const_1,
