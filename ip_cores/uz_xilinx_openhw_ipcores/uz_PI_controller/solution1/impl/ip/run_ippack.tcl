...
set Library     "hls"
set IPName      "uz_PI_controller"
set Version     "1.0"
set DisplayName "Uz_pi_controller"
set Revision    "2113062099"
...
set xo_kernel_name "uz_PI_controller"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "C:/Users/valen/Documents/repos/UZ/ultrazohm_sw/ip_cores/uz_xilinx_openhw_ipcores/uz_PI_controller/solution1"
set debug_dir "C:/Users/valen/Documents/repos/UZ/ultrazohm_sw/ip_cores/uz_xilinx_openhw_ipcores/uz_PI_controller/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {uz_PI_controller_faddfsub_32ns_32ns_32_4_full_dsp_1
...
## Variables
set Top "uz_PI_controller"
set TopNoPrefix "uz_PI_controller"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x10 referenceValue W 0x0 "Data signal of referenceValue" {{0 32 referenceValue W 0 "Bit 31 to 0 of referenceValue"}}} {0x18 sampletime W 0x0 "Data signal of sampletime" {{0 32 sampletime W 0 "Bit 31 to 0 of sampletime"}}} {0x20 KI W 0x0 "Data signal of KI" {{0 32 KI W 0 "Bit 31 to 0 of KI"}}} {0x28 KP W 0x0 "Data signal of KP" {{0 32 KP W 0 "Bit 31 to 0 of KP"}}} {0x30 limit W 0x0 "Data signal of limit" {{0 32 limit W 0 "Bit 31 to 0 of limit"}}} {0x38 reset W 0x0 "Data signal of reset" {{0 1 reset W 0 "Bit 0 to 0 of reset"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x40 axi_referenceValue R 0x0 "Data signal of axi_referenceValue" {{0 32 axi_referenceValue R 0 "Bit 31 to 0 of axi_referenceValue"}}} {0x44 axi_referenceValue_ctrl R 0x0 "Control signal of axi_referenceValue" {{0 1 axi_referenceValue_ap_vld R 0 "Control signal axi_referenceValue_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x50 axi_actualValue R 0x0 "Data signal of axi_actualValue" {{0 32 axi_actualValue R 0 "Bit 31 to 0 of axi_actualValue"}}} {0x54 axi_actualValue_ctrl R 0x0 "Control signal of axi_actualValue" {{0 1 axi_actualValue_ap_vld R 0 "Control signal axi_actualValue_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x60 error R 0x0 "Data signal of error" {{0 32 error R 0 "Bit 31 to 0 of error"}}} {0x64 error_ctrl R 0x0 "Control signal of error" {{0 1 error_ap_vld R 0 "Control signal error_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x70 P_sum R 0x0 "Data signal of P_sum" {{0 32 P_sum R 0 "Bit 31 to 0 of P_sum"}}} {0x74 P_sum_ctrl R 0x0 "Control signal of P_sum" {{0 1 P_sum_ap_vld R 0 "Control signal P_sum_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
