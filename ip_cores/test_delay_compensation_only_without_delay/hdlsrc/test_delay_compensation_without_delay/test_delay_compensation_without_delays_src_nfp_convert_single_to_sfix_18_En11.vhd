-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\test_delay_compensation_only_without_delay\hdlsrc\test_delay_compensation_without_delay\test_delay_compensation_without_delays_src_nfp_convert_single_to_sfix_18_En11.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: test_delay_compensation_without_delays_src_nfp_convert_single_to_sfix_18_En11
-- Source Path: test_delay_compensation_without_delay/HDL_DUT/nfp_convert_single_to_sfix_18_En11
-- Hierarchy Level: 1
-- 
...
ENTITY test_delay_compensation_without_delays_src_nfp_convert_single_to_sfix_18_En11 IS
...
END test_delay_compensation_without_delays_src_nfp_convert_single_to_sfix_18_En11;


ARCHITECTURE rtl OF test_delay_compensation_without_delays_src_nfp_convert_single_to_sfix_18_En11 IS
  ...
  SIGNAL Data_Type_Conversion_out1        : unsigned(30 DOWNTO 0);  -- ufix31_En24
  ...
  SIGNAL Delay4_out1_1                    : unsigned(30 DOWNTO 0);  -- ufix31_En24
  SIGNAL Bit_Set_out1                     : unsigned(30 DOWNTO 0);  -- ufix31_En24
  SIGNAL Switch2_out1_1                   : unsigned(30 DOWNTO 0);  -- ufix31_En24
  SIGNAL shift_arithmetic2_zerosig        : signed(8 DOWNTO 0);  -- sfix9
  SIGNAL shift_arithmetic2_selsig         : signed(8 DOWNTO 0);  -- sfix9
  SIGNAL Data_Type_Conversion1_out1_1     : unsigned(30 DOWNTO 0);  -- ufix31_En24
  ...
  SIGNAL Shift_Arithmetic2_out1           : unsigned(30 DOWNTO 0);  -- ufix31_En24
  SIGNAL Delay6_out1                      : unsigned(30 DOWNTO 0);  -- ufix31_En24
  SIGNAL Switch1_out1                     : unsigned(30 DOWNTO 0);  -- ufix31_En24
  SIGNAL Delay9_out1                      : unsigned(30 DOWNTO 0);  -- ufix31_En24
  SIGNAL Data_Type_Conversion1_out1_2     : signed(31 DOWNTO 0);  -- sfix32_En24
  SIGNAL Unary_Minus_cast                 : signed(32 DOWNTO 0);  -- sfix33_En24
  SIGNAL Unary_Minus_cast_1               : signed(32 DOWNTO 0);  -- sfix33_En24
  SIGNAL Unary_Minus_out1                 : signed(31 DOWNTO 0);  -- sfix32_En24
  SIGNAL Switch1_out1_1                   : signed(31 DOWNTO 0);  -- sfix32_En24
...
BEGIN
  ...
  Data_Type_Conversion_out1 <= resize(Delay2_out1 & '0', 31);
  ...
  Compare_To_Zero1_out1_1 <= '1' WHEN Shift_Arithmetic1_out1 = to_unsigned(16#00000000#, 31) ELSE
      '0';

  
  Compare_To_Zero_out1_1 <= '1' WHEN Data_Type_Conversion_out1 /= to_unsigned(16#00000000#, 31) ELSE
      '0';
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay4_out1_1 <= to_unsigned(16#00000000#, 31);
      ELSIF enb = '1' THEN
  ...
  Bit_Set_out1 <= Delay4_out1_1 OR to_unsigned(16#00000001#, 31);
  ...
  Data_Type_Conversion1_out1_1 <= resize(Delay2_out1 & '0', 31);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay6_out1 <= to_unsigned(16#00000000#, 31);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay9_out1 <= to_unsigned(16#00000000#, 31);
      ELSIF enb = '1' THEN
  ...
  Data_Type_Conversion1_out1_2 <= signed(resize(Delay9_out1, 32));

  Unary_Minus_cast <= resize(Data_Type_Conversion1_out1_2, 33);
  ...
  Data_Type_Conversion2_out1 <= Switch1_out1_1(30 DOWNTO 13);
