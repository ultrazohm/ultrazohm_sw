...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((m_axi_arrays_WREADY == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((m_axi_arrays_WREADY == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end
...
assign m_axi_arrays_WDATA = tmp_1_reg_178;
