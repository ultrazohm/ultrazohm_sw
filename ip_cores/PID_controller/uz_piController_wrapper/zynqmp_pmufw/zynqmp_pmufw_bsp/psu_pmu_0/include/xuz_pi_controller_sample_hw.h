...
// 0x4c : Control signal of output_r
...
#define XUZ_PI_CONTROLLER_SAMPLE_DIN_ADDR_OUTPUT_R_DATA       0x48
#define XUZ_PI_CONTROLLER_SAMPLE_DIN_BITS_OUTPUT_R_DATA       32
#define XUZ_PI_CONTROLLER_SAMPLE_DIN_ADDR_OUTPUT_R_CTRL       0x4c
