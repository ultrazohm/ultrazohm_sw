-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\IP_Core_SS_Switch_and_PWM\PWM_and_SS_control_ip_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: PWM_and_SS_control_ip_axi_lite
-- Source Path: PWM_and_SS_control_ip/PWM_and_SS_control_ip_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY PWM_and_SS_control_ip_axi_lite IS
...
END PWM_and_SS_control_ip_axi_lite;


ARCHITECTURE rtl OF PWM_and_SS_control_ip_axi_lite IS

  -- Component Declarations
  COMPONENT PWM_and_SS_control_ip_addr_decoder
  ...
  COMPONENT PWM_and_SS_control_ip_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : PWM_and_SS_control_ip_addr_decoder
    USE ENTITY work.PWM_and_SS_control_ip_addr_decoder(rtl);

  FOR ALL : PWM_and_SS_control_ip_axi_lite_module
    USE ENTITY work.PWM_and_SS_control_ip_axi_lite_module(rtl);
...
BEGIN
  u_PWM_and_SS_control_ip_addr_decoder_inst : PWM_and_SS_control_ip_addr_decoder
  ...
  u_PWM_and_SS_control_ip_axi_lite_module_inst : PWM_and_SS_control_ip_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
