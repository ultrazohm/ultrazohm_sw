-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_mpc_cost_and_optim_state_machine\uz_6ph_dc_ip_src_uz_6ph_mpc_delay_comp.vhd
-- Created: 2022-09-29 16:21:21
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: uz_6ph_dc_ip_src_uz_6ph_mpc_delay_comp
...
USE work.uz_6ph_dc_ip_src_uz_6ph_mpc_delay_comp_pkg.ALL;

ENTITY uz_6ph_dc_ip_src_uz_6ph_mpc_delay_comp IS
...
END uz_6ph_dc_ip_src_uz_6ph_mpc_delay_comp;


ARCHITECTURE rtl OF uz_6ph_dc_ip_src_uz_6ph_mpc_delay_comp IS

  -- Component Declarations
  COMPONENT uz_6ph_dc_ip_src_Detect_Rise_Positive
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  COMPONENT uz_6ph_dc_ip_src_Detect_Rise_Positive1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  COMPONENT uz_6ph_dc_ip_src_Subsystem
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          Set                             :   IN    std_logic;
  ...
  FOR ALL : uz_6ph_dc_ip_src_Detect_Rise_Positive
    USE ENTITY work.uz_6ph_dc_ip_src_Detect_Rise_Positive(rtl);

  FOR ALL : uz_6ph_dc_ip_src_Detect_Rise_Positive1
    USE ENTITY work.uz_6ph_dc_ip_src_Detect_Rise_Positive1(rtl);

  FOR ALL : uz_6ph_dc_ip_src_Subsystem
    USE ENTITY work.uz_6ph_dc_ip_src_Subsystem(rtl);
...
BEGIN
  ...
  u_Detect_Rise_Positive : uz_6ph_dc_ip_src_Detect_Rise_Positive
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              U => Delay_out1,
  ...
  u_Detect_Rise_Positive1 : uz_6ph_dc_ip_src_Detect_Rise_Positive1
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              U => Delay50_out1,
  ...
  u_Subsystem : uz_6ph_dc_ip_src_Subsystem
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
