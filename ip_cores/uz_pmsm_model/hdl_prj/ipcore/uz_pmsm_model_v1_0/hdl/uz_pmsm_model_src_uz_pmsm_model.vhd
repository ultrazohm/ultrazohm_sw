...
ARCHITECTURE rtl OF uz_pmsm_model_src_uz_pmsm_model IS
  ...
  SIGNAL error_id_1                       : std_logic_vector(31 DOWNTO 0);  -- ufix32
...
BEGIN
  ...
  u_nfp_abs_comp_1 : uz_pmsm_model_src_nfp_abs_single
    PORT MAP( nfp_in => error_id_1,  -- single
  ...
  From1_out1_1 <= fitting_parameter_23(1);
  ...
  From1_out1_15 <= fitting_parameter_23(15);
  ...
  From1_out1_4 <= fitting_parameter_23(4);
  ...
  From1_out1_14 <= fitting_parameter_23(14);
  ...
  From1_out1_12 <= fitting_parameter_23(12);
  ...
  error_id <= Ld_2 WHEN simulate_nonlinear_2 = '0' ELSE
      Ldd_modell;
  ...
  error_id_1 <= Lq_2 WHEN simulate_nonlinear_2 = '0' ELSE
      Lqq_modell;
  ...
  delayMatch_42_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        i_q_5 <= X"00000000";
