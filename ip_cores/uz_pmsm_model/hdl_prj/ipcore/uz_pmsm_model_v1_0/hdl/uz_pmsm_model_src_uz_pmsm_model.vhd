...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        alpha1_Fid2_Giq2 <= reciprocal_F2G2_1;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        alpha1_Fid2_Giq2_1 <= reciprocal_F2G2_1;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        alpha1_Fid2_Giq2_2 <= reciprocal_F2G2_1;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        alpha1_Fid1_Giq1 <= reciprocal_F1G1_1;
      END IF;
    END IF;
