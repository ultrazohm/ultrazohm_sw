...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "uz_SPWM_3ph.autotvin.dat"
	set constFileTvOut       "uz_SPWM_3ph.autotvout.dat"
	set constFileHdlTvIn     "uz_SPWM_3ph.autohdltvin.dat"
	set constFileHdlTvOut    "uz_SPWM_3ph.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
