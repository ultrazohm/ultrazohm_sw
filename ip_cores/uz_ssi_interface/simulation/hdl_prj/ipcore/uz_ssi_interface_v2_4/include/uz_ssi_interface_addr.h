/*
 * File Name:         hdl_prj\ipcore\uz_ssi_interface_v2_4\include\uz_ssi_interface_addr.h
 * Description:       C Header File
 * Created:           2025-05-27 14:42:15
*/
...
#define  IPCore_Timestamp_uz_ssi_interface                             0x8  //contains unique IP timestamp (yymmddHHMM): 2505271442
...
#define  position_mech_offset_si_AXI_Data_uz_ssi_interface             0x138  //data register for Inport position_mech_offset_si_AXI
#define  position_raw_single_turn_AXI_Data_uz_ssi_interface            0x13C  //data register for Outport position_raw_single_turn_AXI
#define  position_raw_multi_turn_AXI_Data_uz_ssi_interface             0x140  //data register for Outport position_raw_multi_turn_AXI
#define  status_raw_AXI_Data_uz_ssi_interface                          0x144  //data register for Outport status_raw_AXI
#define  position_mech_SI_single_turn_AXI_Data_uz_ssi_interface        0x148  //data register for Outport position_mech_SI_single_turn_AXI
#define  position_el_SI_AXI_Data_uz_ssi_interface                      0x14C  //data register for Outport position_el_SI_AXI
