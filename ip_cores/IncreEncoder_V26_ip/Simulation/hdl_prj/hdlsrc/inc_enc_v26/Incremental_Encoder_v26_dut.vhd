...
ARCHITECTURE rtl OF Incremental_Encoder_v26_dut IS
  ...
  COMPONENT Incremental_Encoder_v26_src_IncEnc_V25
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : Incremental_Encoder_v26_src_IncEnc_V25
    USE ENTITY work.Incremental_Encoder_v26_src_IncEnc_V25(rtl);
...
BEGIN
  u_Incremental_Encoder_v26_src_IncEnc_V25 : Incremental_Encoder_v26_src_IncEnc_V25
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset_x => reset_x,
              A => A_sig,  -- ufix1
