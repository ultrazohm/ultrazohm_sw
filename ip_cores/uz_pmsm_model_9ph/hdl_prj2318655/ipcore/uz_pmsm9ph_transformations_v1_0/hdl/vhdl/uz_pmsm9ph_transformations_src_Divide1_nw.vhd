-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj2318655/hdlsrc/uz_pmsm_model_9ph_21b_all_double/uz_pmsm9ph_transformations_src_Divide1_nw.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm9ph_transformations_src_Divide1_nw
-- Source Path: 
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
...
ENTITY uz_pmsm9ph_transformations_src_Divide1_nw IS
...
END uz_pmsm9ph_transformations_src_Divide1_nw;


ARCHITECTURE rtl OF uz_pmsm9ph_transformations_src_Divide1_nw IS
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        sin_theta_hdl <= to_signed(16#00000#, 17);
      ELSIF enb_gated = '1' THEN
        sin_theta_hdl <= in0_signed;
      END IF;
    END IF;
  ...
  Divide1_mul_temp <= sin_theta_hdl * u_beta;
