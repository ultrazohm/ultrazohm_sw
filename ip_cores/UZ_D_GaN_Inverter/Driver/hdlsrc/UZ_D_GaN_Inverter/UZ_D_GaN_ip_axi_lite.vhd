-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\UZ_D_GaN_Inverter\UZ_D_GaN_ip_axi_lite.vhd
-- Created: 2021-04-29 17:19:40
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: UZ_D_GaN_ip_axi_lite
-- Source Path: UZ_D_GaN_ip/UZ_D_GaN_ip_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY UZ_D_GaN_ip_axi_lite IS
...
END UZ_D_GaN_ip_axi_lite;


ARCHITECTURE rtl OF UZ_D_GaN_ip_axi_lite IS

  -- Component Declarations
  COMPONENT UZ_D_GaN_ip_addr_decoder
  ...
  COMPONENT UZ_D_GaN_ip_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : UZ_D_GaN_ip_addr_decoder
    USE ENTITY work.UZ_D_GaN_ip_addr_decoder(rtl);

  FOR ALL : UZ_D_GaN_ip_axi_lite_module
    USE ENTITY work.UZ_D_GaN_ip_axi_lite_module(rtl);
...
BEGIN
  u_UZ_D_GaN_ip_addr_decoder_inst : UZ_D_GaN_ip_addr_decoder
  ...
  u_UZ_D_GaN_ip_axi_lite_module_inst : UZ_D_GaN_ip_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
