...
void uz_pmsmModel_hw_write_L_d(uint32_t base_address, float L_d)
{
    ...
    uz_axi_write_float(base_address + Ld_Data_uz_pmsm_model, (1.0f / L_d));
}
...
void uz_pmsmModel_hw_write_L_q(uint32_t base_address, float L_q)
{
    ...
    uz_axi_write_float(base_address + Lq_Data_uz_pmsm_model, (1.0f / L_q));
}
...
void uz_pmsmModel_hw_write_fitting_parameters(uint32_t base_address, float reciprocal_F1G1, float reciprocal_F2G2, float ad4_mul_ad5, float ad1_mul_ad2, float aq4_mul_aq5, float aq1_mul_aq2, float aq4_div_aq5, float aq1_div_aq2, float ad4_div_ad5, float ad1_div_ad2, float aq3_min_aq6){
    uz_assert_not_zero(base_address);
    uz_axi_write_float(base_address+reciprocal_F1G1_Data_uz_pmsm_model,reciprocal_F1G1);
    uz_axi_write_float(base_address+reciprocal_F2G2_Data_uz_pmsm_model,reciprocal_F2G2);
    uz_axi_write_float(base_address+ad4_mul_ad5_Data_uz_pmsm_model,ad4_mul_ad5);
    uz_axi_write_float(base_address+ad1_mul_ad2_Data_uz_pmsm_model,ad1_mul_ad2);
    uz_axi_write_float(base_address+aq4_mul_aq5_Data_uz_pmsm_model,aq4_mul_aq5);
    uz_axi_write_float(base_address+aq1_mul_aq2_Data_uz_pmsm_model,aq1_mul_aq2);
    uz_axi_write_float(base_address+aq4_div_aq5_Data_uz_pmsm_model,aq4_div_aq5);
    uz_axi_write_float(base_address+aq1_div_aq2_Data_uz_pmsm_model,aq1_div_aq2);
    uz_axi_write_float(base_address+ad4_div_ad5_Data_uz_pmsm_model,ad4_div_ad5);
    uz_axi_write_float(base_address+ad1_div_ad2_Data_uz_pmsm_model,ad1_div_ad2);
    uz_axi_write_float(base_address+aq3_min_aq6_Data_uz_pmsm_model,aq3_min_aq6);
}
