-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\inc_enc_v25\Incremental_Encoder.vhd
...
-- Source Path: Incremental_Encoder
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Incremental_Encoder IS

  -- Component Declarations
  COMPONENT Incremental_Encoder_reset_sync
  ...
  COMPONENT Incremental_Encoder_axi_lite
  ...
  COMPONENT Incremental_Encoder_dut
    PORT( clk                             :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : Incremental_Encoder_reset_sync
    USE ENTITY work.Incremental_Encoder_reset_sync(rtl);

  FOR ALL : Incremental_Encoder_axi_lite
    USE ENTITY work.Incremental_Encoder_axi_lite(rtl);

  FOR ALL : Incremental_Encoder_dut
    USE ENTITY work.Incremental_Encoder_dut(rtl);
...
BEGIN
  u_Incremental_Encoder_reset_sync_inst : Incremental_Encoder_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset_x
              );

  u_Incremental_Encoder_axi_lite_inst : Incremental_Encoder_axi_lite
  ...
  u_Incremental_Encoder_dut_inst : Incremental_Encoder_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_x => reset_x,
  ...
  ip_timestamp <= unsigned'(X"8361711B");
