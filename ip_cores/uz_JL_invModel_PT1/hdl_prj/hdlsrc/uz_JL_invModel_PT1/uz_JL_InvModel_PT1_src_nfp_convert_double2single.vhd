-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\jonat\Documents\MA_JL_CIL\ip_cores\uz_JL_invModel_PT1\hdl_prj\hdlsrc\uz_JL_invModel_PT1\uz_JL_InvModel_PT1_src_nfp_convert_double2single.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_JL_InvModel_PT1_src_nfp_convert_double2single
-- Source Path: uz_JL_invModel_PT1/HDL_DUT/nfp_convert_double2single
-- Hierarchy Level: 1
-- Model version: 1.37
-- 
...
ENTITY uz_JL_InvModel_PT1_src_nfp_convert_double2single IS
...
END uz_JL_InvModel_PT1_src_nfp_convert_double2single;


ARCHITECTURE rtl OF uz_JL_InvModel_PT1_src_nfp_convert_double2single IS
  ...
  SIGNAL Delay32_PS_2_5_reg               : std_logic_vector(4 DOWNTO 0);  -- ufix1 [5]
  ...
  SIGNAL Delay33_PS_2_5_reg               : std_logic_vector(3 DOWNTO 0);  -- ufix1 [4]
  ...
  SIGNAL alpha_inExponent_0_inMantis_out1 : std_logic;  -- ufix1
  SIGNAL Delay23_PS_5_reg                 : std_logic_vector(3 DOWNTO 0);  -- ufix1 [4]
  ...
  SIGNAL Delay18_PS_5_reg                 : std_logic_vector(2 DOWNTO 0);  -- ufix1 [3]
  SIGNAL Delay18_PS_5_out1                : std_logic;  -- ufix1
  SIGNAL e_cfType_MantissaLength_out1     : std_logic;  -- ufix1
  SIGNAL Delay17_PS_5_reg                 : std_logic_vector(2 DOWNTO 0);  -- ufix1 [3]
...
BEGIN
  ...
  Delay32_PS_2_5_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay32_PS_2_5_reg <= (OTHERS => '0');
      ELSIF enb = '1' THEN
        Delay32_PS_2_5_reg(0) <= inSign;
        Delay32_PS_2_5_reg(4 DOWNTO 1) <= Delay32_PS_2_5_reg(3 DOWNTO 0);
      END IF;
    END IF;
  ...
  Delay33_PS_2_5_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay33_PS_2_5_reg <= (OTHERS => '0');
      ELSIF enb = '1' THEN
        Delay33_PS_2_5_reg(0) <= inExponent_inType_Exponent_out1;
        Delay33_PS_2_5_reg(3 DOWNTO 1) <= Delay33_PS_2_5_reg(2 DOWNTO 0);
      END IF;
    END IF;
  ...
  alpha_inExponent_0_inMantis_out1 <= inExponent_0_out1 AND inMantissa_0_out1;

  Delay23_PS_5_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay23_PS_5_reg <= (OTHERS => '0');
      ELSIF enb = '1' THEN
        Delay23_PS_5_reg(0) <= alpha_inExponent_0_inMantis_out1;
        Delay23_PS_5_reg(3 DOWNTO 1) <= Delay23_PS_5_reg(2 DOWNTO 0);
      END IF;
    END IF;
  END PROCESS Delay23_PS_5_process;

  Delay23_PS_5_out1 <= Delay23_PS_5_reg(3);
  ...
  Delay34_PS_2_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
  ...
  alpha_Exponent_0_cfType_Exp_out1 <= Exponent_0_out1_1 OR cfType_Exponent_Inf_or_NaN_out1;
  ...
  if_Exponent_0_cfType_Exp_out1 <= Bit_Concat1_out1 WHEN alpha_Exponent_0_cfType_Exp_out1 = '0' ELSE
      Bit_Concat_out1;
  ...
  Delay35_PS_2_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
  ...
  Delay18_PS_5_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay18_PS_5_reg <= (OTHERS => '0');
      ELSIF enb = '1' THEN
        Delay18_PS_5_reg(0) <= e_int32_255_out1;
        Delay18_PS_5_reg(2 DOWNTO 1) <= Delay18_PS_5_reg(1 DOWNTO 0);
      END IF;
    END IF;
  ...
  Delay17_PS_5_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay17_PS_5_reg <= (OTHERS => '0');
      ELSIF enb = '1' THEN
        Delay17_PS_5_reg(0) <= e_cfType_MantissaLength_out1;
        Delay17_PS_5_reg(2 DOWNTO 1) <= Delay17_PS_5_reg(1 DOWNTO 0);
      END IF;
    END IF;
  ...
  Delay29_PS_2_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
  ...
  Data_Type_Conversion_out1 <= unsigned(Delay11_PS_3_out1(5 DOWNTO 0));

  bitsrl_MantExtended_x_shift_l_out1 <= SHIFT_RIGHT(Delay9_PS_3_out1, to_integer(Data_Type_Conversion_out1));

  
  if_e_0_MantExtended_x_out1 <= bitsrl_MantExtended_x_shift_l_out1 WHEN Delay12_PS_3_out1 = '0' ELSE
      Delay9_PS_3_out1;

  Delay7_PS_4_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
  ...
  Delay21_PS_5_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
  ...
  bitget_Mant_tmp_2_0_out1 <= BitSlice1_out1_1;

  
  shift_length1_0_out1 <= '1' WHEN Delay11_PS_3_out1 > to_signed(16#000#, 12) ELSE
      '0';

  Delay3_PS_4_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay3_PS_4_out1 <= '0';
  ...
  Delay6_PS_4_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
  ...
  Delay15_PS_4_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay15_PS_4_out1 <= '0';
  ...
  Delay4_PS_4_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay4_PS_4_out1 <= '0';
  ...
  bitget_Mant_tmp_1_0_out1 <= BitSlice_out1;

  Delay19_PS_5_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay19_PS_5_out1 <= '0';
  ...
  alpha_bitget_Mant_tmp_2_0_out1 <= bitget_Mant_tmp_2_0_out1 OR Delay19_PS_5_out1;

  alpha_bitget_Mant_tmp_1_0_out1 <= bitget_Mant_tmp_1_0_out1 AND alpha_bitget_Mant_tmp_2_0_out1;
  ...
  if_bitget_Mant_tmp_1_0_out1 <= Bit_Concat_out1_1 WHEN alpha_bitget_Mant_tmp_1_0_out1 = '0' ELSE
      DTC_out1;

  BitSlice2_out1 <= if_bitget_Mant_tmp_1_0_out1(24);

  bitget_Mant_tmp_Mant_tmp_Word_out1 <= BitSlice2_out1;
  ...
  Delay20_PS_5_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay20_PS_5_reg <= (OTHERS => to_unsigned(16#00#, 8));
      ELSIF enb = '1' THEN
        Delay20_PS_5_reg(0) <= if_e_0_Exponent_out1;
        Delay20_PS_5_reg(1 TO 2) <= Delay20_PS_5_reg(0 TO 1);
      END IF;
    END IF;
  ...
  Delay22_PS_5_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay22_PS_5_reg <= (OTHERS => to_unsigned(16#000000#, 23));
      ELSIF enb = '1' THEN
        Delay22_PS_5_reg(0) <= if_inMantissa_0_out1;
        Delay22_PS_5_reg(1) <= Delay22_PS_5_reg(0);
      END IF;
    END IF;
