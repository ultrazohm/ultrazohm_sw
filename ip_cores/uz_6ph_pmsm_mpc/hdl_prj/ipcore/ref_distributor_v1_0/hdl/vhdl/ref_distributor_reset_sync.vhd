-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_mpc_6ph_parallel\ref_distributor_reset_sync.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ref_distributor_reset_sync
-- Source Path: ref_distributor/ref_distributor_reset_sync
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY ref_distributor_reset_sync IS
  PORT( clk                               :   IN    std_logic;
        reset_in                          :   IN    std_logic;  -- ufix1
        reset_out                         :   OUT   std_logic  -- ufix1
        );
END ref_distributor_reset_sync;


ARCHITECTURE rtl OF ref_distributor_reset_sync IS
