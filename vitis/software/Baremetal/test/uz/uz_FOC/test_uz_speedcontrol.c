...
void test_uz_SpeedControl_sample_NULL(void){
    TEST_ASSERT_FAIL_ASSERT(uz_SpeedControl_sample(NULL, omega_m_rad_per_sec, n_ref_rpm, V_dc_volts, id_ref_Ampere));
}

void test_uz_SpeedControl_init_assert_Rph_negative(void){
    config.config_PMSM.R_ph_Ohm = -0.08f;
    TEST_ASSERT_FAIL_ASSERT(uz_SpeedControl_init(config));
}

void test_uz_SpeedControl_init_assert_Rph_zero(void){
    config.config_PMSM.R_ph_Ohm = 0.0f;
    TEST_ASSERT_FAIL_ASSERT(uz_SpeedControl_init(config));
}

void test_uz_SpeedControl_init_assert_Ld_negative(void){
    config.config_PMSM.Ld_Henry = -0.08f;
    TEST_ASSERT_FAIL_ASSERT(uz_SpeedControl_init(config));
}

void test_uz_SpeedControl_init_assert_Ld_zero(void){
    config.config_PMSM.Ld_Henry = 0.0f;
    TEST_ASSERT_FAIL_ASSERT(uz_SpeedControl_init(config));
}

void test_uz_SpeedControl_init_assert_Lq_negative(void){
    config.config_PMSM.Lq_Henry = -0.08f;
    TEST_ASSERT_FAIL_ASSERT(uz_SpeedControl_init(config));
}

void test_uz_SpeedControl_init_assert_Lq_zero(void){
    config.config_PMSM.Lq_Henry = 0.0f;
    TEST_ASSERT_FAIL_ASSERT(uz_SpeedControl_init(config));
}

void test_uz_SpeedControl_init_assert_Psi_pm(void){
    config.config_PMSM.Psi_PM_Vs = -0.08f;
    TEST_ASSERT_FAIL_ASSERT(uz_SpeedControl_init(config));
}

void test_uz_SpeedControl_init_assert_polePairs_negative(void){
    config.config_PMSM.polePairs = -2.0f;
    TEST_ASSERT_FAIL_ASSERT(uz_SpeedControl_init(config));
}

void test_uz_SpeedControl_init_assert_polePairs_zero(void){
    config.config_PMSM.polePairs = 0.0f;
    TEST_ASSERT_FAIL_ASSERT(uz_SpeedControl_init(config));
}

void test_uz_SpeedControl_init_assert_polePairs_decimal_value(void){
    config.config_PMSM.polePairs = 0.5f;
    TEST_ASSERT_FAIL_ASSERT(uz_SpeedControl_init(config));
}

void test_uz_SpeedControl_init_assert_I_max_negative(void){
    config.config_PMSM.I_max_Ampere = -5.08f;
    TEST_ASSERT_FAIL_ASSERT(uz_SpeedControl_init(config));
}

void test_uz_SpeedControl_init_assert_I_max_zero(void){
...
void test_uz_SpeedControl_sample_output(void){
    ...
    for(int i=0;i<5;i++){
        ...
        uz_3ph_dq_t output = uz_SpeedControl_sample(instance, omega_m_rad_per_sec, n_ref_rpm, V_dc_volts, id_ref_Ampere);
...
void test_uz_SpeedControl_set_field_weakening_change(void){
    ...
    uz_SpeedControl_t* instance = uz_SpeedControl_init(config);
    float id_out = -0.613f;
    omega_m_rad_per_sec = 366.525f;
    uz_3ph_dq_t output = uz_SpeedControl_sample(instance, omega_m_rad_per_sec, n_ref_rpm, V_dc_volts, id_ref_Ampere);
	TEST_ASSERT_FLOAT_WITHIN(1e-03, id_out, output.d);
    //Tests, if the disabling works
    uz_SpeedControl_set_field_weakening(instance, false);
    output = uz_SpeedControl_sample(instance, omega_m_rad_per_sec, n_ref_rpm, V_dc_volts, id_ref_Ampere);
...
void test_uz_SpeedControl_set_PMSM_config_assert_Rph_negative(void){
    uz_SpeedControl_t* instance = uz_SpeedControl_init(config);
    config.config_PMSM.R_ph_Ohm = -0.08f;
    TEST_ASSERT_FAIL_ASSERT(uz_SpeedControl_set_PMSM_config(instance, config.config_PMSM));
}

void test_uz_SpeedControl_set_PMSM_config_assert_Rph_zero(void){
    uz_SpeedControl_t* instance = uz_SpeedControl_init(config);
    config.config_PMSM.R_ph_Ohm = 0.0f;
    TEST_ASSERT_FAIL_ASSERT(uz_SpeedControl_set_PMSM_config(instance, config.config_PMSM));
}

void test_uz_SpeedControl_set_PMSM_config_assert_Ld_negative(void){
    uz_SpeedControl_t* instance = uz_SpeedControl_init(config);
    config.config_PMSM.Ld_Henry = -0.08f;
    TEST_ASSERT_FAIL_ASSERT(uz_SpeedControl_set_PMSM_config(instance, config.config_PMSM));
}

void test_uz_SpeedControl_set_PMSM_config_assert_Ld_zero(void){
    uz_SpeedControl_t* instance = uz_SpeedControl_init(config);
    config.config_PMSM.Ld_Henry = 0.0f;
    TEST_ASSERT_FAIL_ASSERT(uz_SpeedControl_set_PMSM_config(instance, config.config_PMSM));
}

void test_uz_SpeedControl_set_PMSM_config_assert_Lq_negative(void){
    uz_SpeedControl_t* instance = uz_SpeedControl_init(config);
    config.config_PMSM.Lq_Henry = -0.08f;
    TEST_ASSERT_FAIL_ASSERT(uz_SpeedControl_set_PMSM_config(instance, config.config_PMSM));
}

void test_uz_SpeedControl_set_PMSM_config_assert_Lq_zero(void){
    uz_SpeedControl_t* instance = uz_SpeedControl_init(config);
    config.config_PMSM.Lq_Henry = 0.0f;
    TEST_ASSERT_FAIL_ASSERT(uz_SpeedControl_set_PMSM_config(instance, config.config_PMSM));
}

void test_uz_SpeedControl_set_PMSM_config_assert_Psi_pm(void){
    uz_SpeedControl_t* instance = uz_SpeedControl_init(config);
    config.config_PMSM.Psi_PM_Vs = -0.08f;
    TEST_ASSERT_FAIL_ASSERT(uz_SpeedControl_set_PMSM_config(instance, config.config_PMSM));
}

void test_uz_SpeedControl_set_PMSM_config_assert_polePairs_negative(void){
    uz_SpeedControl_t* instance = uz_SpeedControl_init(config);
    config.config_PMSM.polePairs = -2.0f;
    TEST_ASSERT_FAIL_ASSERT(uz_SpeedControl_set_PMSM_config(instance, config.config_PMSM));
}

void test_uz_SpeedControl_set_PMSM_config_assert_polePairs_zero(void){
    uz_SpeedControl_t* instance = uz_SpeedControl_init(config);
    config.config_PMSM.polePairs = 0.0f;
    TEST_ASSERT_FAIL_ASSERT(uz_SpeedControl_set_PMSM_config(instance, config.config_PMSM));
}

void test_uz_SpeedControl_set_PMSM_config_assert_polePairs_decimal_value(void){
    uz_SpeedControl_t* instance = uz_SpeedControl_init(config);
    config.config_PMSM.polePairs = 0.5f;
    TEST_ASSERT_FAIL_ASSERT(uz_SpeedControl_set_PMSM_config(instance, config.config_PMSM));
}

void test_uz_SpeedControl_set_PMSM_config_assert_I_max_negative(void){
    uz_SpeedControl_t* instance = uz_SpeedControl_init(config);
    config.config_PMSM.I_max_Ampere = -5.08f;
    TEST_ASSERT_FAIL_ASSERT(uz_SpeedControl_set_PMSM_config(instance, config.config_PMSM));
}

void test_uz_SpeedControl_set_PMSM_config_assert_I_max_zero(void){
    uz_SpeedControl_t* instance = uz_SpeedControl_init(config);
    config.config_PMSM.I_max_Ampere = 0.0f;
    TEST_ASSERT_FAIL_ASSERT(uz_SpeedControl_set_PMSM_config(instance, config.config_PMSM));
}

void test_uz_SpeedControl_set_PMSM_config_assert_NULL(void) {
    TEST_ASSERT_FAIL_ASSERT(uz_SpeedControl_set_PMSM_config(NULL, config.config_PMSM));
}
