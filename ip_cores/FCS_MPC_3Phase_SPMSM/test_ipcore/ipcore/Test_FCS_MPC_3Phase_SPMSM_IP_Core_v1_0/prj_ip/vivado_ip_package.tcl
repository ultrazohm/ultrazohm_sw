...
add_files -norecurse {../hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_dut.vhd}
add_files -norecurse {../hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_addr_decoder.vhd}
add_files -norecurse {../hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_axi_lite_module.vhd}
add_files -norecurse {../hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_axi_lite.vhd}
add_files -norecurse {../hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core.vhd}
set_property top Test_FCS_MPC_3Phase_SPMSM_IP_Core [get_filesets sources_1]
set_property top Test_FCS_MPC_3Phase_SPMSM_IP_Core [get_filesets sim_1]
...
# Set IP properties
set_property name Test_FCS_MPC_3Phase_SPMSM_IP_Core [ipx::current_core]
set_property display_name Test_FCS_MPC_3Phase_SPMSM_IP_Core [ipx::current_core]
...
set_property type {{vhdlSource}} [ipx::get_files {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_src_nfp_add_single.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]]
ipx::add_file {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_src_nfp_mul_single.vhd} [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_src_nfp_mul_single.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]]
ipx::add_file {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_src_nfp_mul_single.vhd} [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_src_nfp_mul_single.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]]
ipx::add_file {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_src_nfp_sub_single.vhd} [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_src_nfp_sub_single.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]]
ipx::add_file {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_src_nfp_sub_single.vhd} [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_src_nfp_sub_single.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]]
ipx::add_file {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_src_nfp_sincos_single.vhd} [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_src_nfp_sincos_single.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]]
ipx::add_file {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_src_nfp_sincos_single.vhd} [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_src_nfp_sincos_single.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]]
ipx::add_file {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_src_MATLAB_Function.vhd} [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]
...
set_property type {{vhdlSource}} [ipx::get_files {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_src_Subsystem1_tc.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]]
ipx::add_file {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_src_Subsystem1.vhd} [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_src_Subsystem1.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]]
ipx::add_file {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_src_Subsystem1.vhd} [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_src_Subsystem1.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]]
ipx::add_file {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_reset_sync.vhd} [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_reset_sync.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]]
ipx::add_file {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_reset_sync.vhd} [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_reset_sync.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]]
ipx::add_file {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_dut.vhd} [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_dut.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]]
ipx::add_file {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_dut.vhd} [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_dut.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]]
ipx::add_file {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_addr_decoder.vhd} [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_addr_decoder.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]]
ipx::add_file {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_addr_decoder.vhd} [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_addr_decoder.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]]
ipx::add_file {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_axi_lite_module.vhd} [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_axi_lite_module.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]]
ipx::add_file {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_axi_lite_module.vhd} [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_axi_lite_module.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]]
ipx::add_file {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_axi_lite.vhd} [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_axi_lite.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]]
ipx::add_file {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_axi_lite.vhd} [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core_axi_lite.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]]
ipx::add_file {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core.vhd} [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]]
ipx::add_file {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core.vhd} [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/vhdl/Test_FCS_MPC_3Phase_SPMSM_IP_Core.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]]
...
ipx::add_file {include/Test_FCS_MPC_3Phase_SPMSM_IP_Core_addr.h} [ipx::get_file_groups xilinx_miscfiles -of_objects [ipx::current_core]]
set_property type {{cSource}} [ipx::get_files {include/Test_FCS_MPC_3Phase_SPMSM_IP_Core_addr.h} -of_objects [ipx::get_file_groups xilinx_miscfiles -of_objects [ipx::current_core]]]
ipx::create_xgui_files [ipx::current_core]
ipx::check_integrity -quiet [ipx::current_core]
ipx::save_core [ipx::current_core]

# Package IP
ipx::archive_core {../Test_FCS_MPC_3Phase_SPMSM_IP_Core_v1_0.zip} [ipx::current_core]
close_project
exit
