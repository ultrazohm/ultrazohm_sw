-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Transformation_V12\Trans_123_dq_V12_ip_addr_decoder.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Trans_123_dq_V12_ip_addr_decoder
-- Source Path: Trans_123_dq_V12_ip/Trans_123_dq_V12_ip_axi_lite/Trans_123_dq_V12_ip_addr_decoder
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Trans_123_dq_V12_ip_addr_decoder IS
...
END Trans_123_dq_V12_ip_addr_decoder;


ARCHITECTURE rtl OF Trans_123_dq_V12_ip_addr_decoder IS
  ...
  SIGNAL decode_sel_i2_AXI                : std_logic;  -- ufix1
  ...
  SIGNAL data_in_i2_AXI                   : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_i2_AXI                 : unsigned(31 DOWNTO 0);  -- ufix32
...
BEGIN
  ...
  decode_sel_i3_AXI <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0045#, 14) ELSE
      '0';

  
  decode_sel_i2_AXI <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0044#, 14) ELSE
      '0';
  ...
  data_in_i2_AXI <= unsigned(resize(read_reg_i2_AXI, 32));

  
  decode_rd_i2_AXI <= decode_rd_i1_AXI WHEN decode_sel_i2_AXI = '0' ELSE
      data_in_i2_AXI;
  ...
  decode_rd_i3_AXI <= decode_rd_i2_AXI WHEN decode_sel_i3_AXI = '0' ELSE
      data_in_i3_AXI;
