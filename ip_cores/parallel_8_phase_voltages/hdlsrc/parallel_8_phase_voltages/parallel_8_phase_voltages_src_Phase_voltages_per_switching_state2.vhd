...
ARCHITECTURE rtl OF parallel_8_phase_voltages_src_Phase_voltages_per_switching_state2 IS
  ...
  SIGNAL delayMatch1_reg_next             : std_logic_vector(0 TO 2);  -- ufix1 [3]
  ...
  SIGNAL Gain_mul_temp                    : signed(47 DOWNTO 0);  -- sfix48_En45
  SIGNAL Gain_out1                        : signed(23 DOWNTO 0);  -- sfix24_En20
  SIGNAL Delay48_out1                     : signed(23 DOWNTO 0);  -- sfix24_En20
  ...
  SIGNAL delayMatch3_reg_next             : std_logic_vector(0 TO 2);  -- ufix1 [3]
...
BEGIN
  ...
  u_Sine_HDL_Optimized : parallel_8_phase_voltages_src_Sine_HDL_Optimized
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              u => std_logic_vector(Delay48_out1),  -- sfix24_En20
              x => Sine,  -- sfix25_En20
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay6_out1 <= '0';
      ELSIF enb = '1' THEN
        Delay6_out1 <= valid_in_delay_compensation;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay7_out1 <= '0';
      ELSIF enb = '1' THEN
        Delay7_out1 <= valid_in_min_cost_function_and_vopt;
      END IF;
    END IF;
  ...
  Delay10_out1_1 <= delayMatch5_reg(20);
  delayMatch5_reg_next(0) <= Delay10_out1;
  ...
  Add4_out1 <= Delay3_out1 - Delay4_out1;
  ...
  Gain_mul_temp <= to_signed(16#517CC2#, 24) * End_Cycle_4;
  Gain_out1 <= resize(Gain_mul_temp(47 DOWNTO 25), 24);
  ...
  switch_compare_1_3 <= '1' WHEN End_Cycle_2 = '1' ELSE
      '0';
  ...
  stateControl_4 <= delayMatch3_reg(2);
