...
localparam
    ...
    ADDR_A_ROWS_DATA_1    = 7'h38,
    ADDR_A_ROWS_CTRL      = 7'h3c,
    ADDR_B_ROWS_DATA_0    = 7'h40,
    ADDR_B_ROWS_DATA_1    = 7'h44,
    ADDR_B_ROWS_CTRL      = 7'h48,
    ADDR_B_COLUMNS_DATA_0 = 7'h4c,
    ADDR_B_COLUMNS_DATA_1 = 7'h50,
    ADDR_B_COLUMNS_CTRL   = 7'h54,
    WRIDLE                = 2'd0,
    WRDATA                = 2'd1,
    WRRESP                = 2'd2,
    WRRESET               = 2'd3,
