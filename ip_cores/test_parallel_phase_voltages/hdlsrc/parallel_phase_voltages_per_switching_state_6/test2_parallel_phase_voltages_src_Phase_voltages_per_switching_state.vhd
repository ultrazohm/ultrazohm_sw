-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\test_parallel_phase_voltages\hdlsrc\parallel_phase_voltages_per_switching_state_6\test2_parallel_phase_voltages_src_Phase_voltages_per_switching_state.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: test2_parallel_phase_voltages_src_Phase_voltages_per_switching_state
...
ENTITY test2_parallel_phase_voltages_src_Phase_voltages_per_switching_state IS
...
END test2_parallel_phase_voltages_src_Phase_voltages_per_switching_state;


ARCHITECTURE rtl OF test2_parallel_phase_voltages_src_Phase_voltages_per_switching_state IS

  -- Component Declarations
  COMPONENT test2_parallel_phase_voltages_src_Detect_Rise_Positive1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  COMPONENT test2_parallel_phase_voltages_src_Detect_Rise_Positive
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  COMPONENT test2_parallel_phase_voltages_src_nfp_convert_sfix_24_En20_to_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT test2_parallel_phase_voltages_src_nfp_sub_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT test2_parallel_phase_voltages_src_nfp_relop_single_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          nfp_in1                         :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT test2_parallel_phase_voltages_src_nfp_relop_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          nfp_in1                         :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT test2_parallel_phase_voltages_src_Subsystem
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : test2_parallel_phase_voltages_src_Detect_Rise_Positive1
    USE ENTITY work.test2_parallel_phase_voltages_src_Detect_Rise_Positive1(rtl);

  FOR ALL : test2_parallel_phase_voltages_src_Detect_Rise_Positive
    USE ENTITY work.test2_parallel_phase_voltages_src_Detect_Rise_Positive(rtl);

  FOR ALL : test2_parallel_phase_voltages_src_nfp_convert_sfix_24_En20_to_single
    USE ENTITY work.test2_parallel_phase_voltages_src_nfp_convert_sfix_24_En20_to_single(rtl);

  FOR ALL : test2_parallel_phase_voltages_src_nfp_sub_single
    USE ENTITY work.test2_parallel_phase_voltages_src_nfp_sub_single(rtl);

  FOR ALL : test2_parallel_phase_voltages_src_nfp_relop_single_block
    USE ENTITY work.test2_parallel_phase_voltages_src_nfp_relop_single_block(rtl);

  FOR ALL : test2_parallel_phase_voltages_src_nfp_relop_single
    USE ENTITY work.test2_parallel_phase_voltages_src_nfp_relop_single(rtl);
  ...
  FOR ALL : test2_parallel_phase_voltages_src_Subsystem
    USE ENTITY work.test2_parallel_phase_voltages_src_Subsystem(rtl);

  FOR ALL : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    USE ENTITY work.test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11(rtl);
...
BEGIN
  u_Detect_Rise_Positive1 : test2_parallel_phase_voltages_src_Detect_Rise_Positive1
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_Detect_Rise_Positive : test2_parallel_phase_voltages_src_Detect_Rise_Positive
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              U => Delay21_out1,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_sfix_24_En20_to_single : test2_parallel_phase_voltages_src_nfp_convert_sfix_24_En20_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_nfp_sub_comp : test2_parallel_phase_voltages_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_nfp_relop_comp : test2_parallel_phase_voltages_src_nfp_relop_single_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_nfp_relop_comp_1 : test2_parallel_phase_voltages_src_nfp_relop_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in1 => Add1_out1,  -- single
  ...
  u_nfp_sub_comp_1 : test2_parallel_phase_voltages_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in1 => Add1_out1,  -- single
  ...
  u_Subsystem : test2_parallel_phase_voltages_src_Subsystem
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_1 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_2 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_3 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_4 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_5 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_6 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_7 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_8 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_9 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_10 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_11 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_12 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_13 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_14 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_15 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_16 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_17 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_18 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_19 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_20 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_21 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_22 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_23 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_24 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_25 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_26 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_27 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_28 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_29 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_30 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_31 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_32 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_33 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_34 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_35 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_36 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_37 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_38 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_39 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_40 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_41 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_42 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_43 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_44 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_45 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_46 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_47 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_48 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_49 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_50 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_51 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_52 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_53 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_54 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_55 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_56 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_57 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_58 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_59 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_60 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_61 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_62 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_63 : test2_parallel_phase_voltages_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
