#ifndef UZ_PMSMMODEL_6PH_DQXY_H
#define UZ_PMSMMODEL_6PH_DQXY_H
 ...
 * 
 */
typedef struct uz_pmsmModel_6ph_dqxy_t uz_pmsmModel_6ph_dqxy_t;

/**
 * @brief Configuration struct for the PMSM model IP-Core driver
 * 
 */
struct uz_pmsmModel_6ph_dqxy_config_t
{
    ...
    float L_x; /**< Inductance of x-axis in Henry */
    float L_y; /**< Inductance of y-axis in Henry */
 ...
 * 
 */
struct uz_pmsmModel_6ph_dqxy_outputs_t
{
    float i_d_A; /**< Current in d-axis in A */
    float i_q_A; /**< Current in q-Axis in A */
    float i_x_A; /**< Current in x-Axis in A */
    float i_y_A; /**< Current in y-Axis in A */
 ...
 * 
 */
struct uz_pmsmModel_6ph_dqxy_inputs_t
{
    float v_d_V; /**< Voltage in d-axis in V */
    float v_q_V; /**< Voltage in q-axis in V */
    float v_x_V; /**< Voltage in x-axis in V */
    float v_y_V; /**< Voltage in y-axis in V */
    float omega_mech_1_s; /**< Rotational speed of PMSM in 1/s */
