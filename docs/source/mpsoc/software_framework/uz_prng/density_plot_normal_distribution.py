...
normal_dist_data_1=pd.read_csv('../../../../../vitis/software/Baremetal/test/uz/uz_prng/uz_prng_normal_distribution_1.csv',header=None, names=columns)
normal_dist_data_2=pd.read_csv('../../../../../vitis/software/Baremetal/test/uz/uz_prng/uz_prng_normal_distribution_2.csv',header=None, names=columns)
normal_dist_data_3=pd.read_csv('../../../../../vitis/software/Baremetal/test/uz/uz_prng/uz_prng_normal_distribution_3.csv',header=None, names=columns)
