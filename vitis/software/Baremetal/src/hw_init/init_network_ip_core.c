...
#include "Weights_Layer_1.csv" //to be changed
};
float b_1[NUMBER_OF_NEURONS_IN_FIRST_LAYER] MEMORY_ALIGN = {
#include "Bias_Layer_1.csv"//to be changed
};
...
#include "Weights_Layer_2.csv"//to be changed
};
float b_2[NUMBER_OF_NEURONS_IN_SECOND_LAYER] MEMORY_ALIGN = {
#include "Bias_Layer_2.csv"//to be changed
};
...
#include "Weights_Layer_3.csv"//to be changed
};
float b_3[NUMBER_OF_NEURONS_IN_THIRD_LAYER] MEMORY_ALIGN = {
#include "Bias_Layer_3.csv"//to be changed
};
...
#include "Weights_Layer_out.csv"//to be changed
};
float b_4[NUMBER_OF_OUTPUTS] MEMORY_ALIGN = {
#include "Bias_Layer_out.csv"//to be changed
};
