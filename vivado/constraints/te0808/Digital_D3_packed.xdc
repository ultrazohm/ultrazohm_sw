...
set_property PACKAGE_PIN W1 [get_ports {D3_OUT[0]}]
set_property PACKAGE_PIN V7 [get_ports {D3_OUT[1]}]
set_property PACKAGE_PIN W2 [get_ports {D3_OUT[2]}]
set_property PACKAGE_PIN W5 [get_ports {D3_OUT[3]}]
set_property PACKAGE_PIN Y1 [get_ports {D3_OUT[4]}]
set_property PACKAGE_PIN Y5 [get_ports {D3_OUT[5]}]
set_property PACKAGE_PIN Y2 [get_ports {D3_OUT[6]}]
set_property PACKAGE_PIN M12 [get_ports {D3_OUT[7]}]
set_property PACKAGE_PIN U9 [get_ports {D3_OUT[8]}]
set_property PACKAGE_PIN N12 [get_ports {D3_OUT[9]}]
set_property PACKAGE_PIN V9 [get_ports {D3_OUT[10]}]
set_property PACKAGE_PIN P10 [get_ports {D3_OUT[11]}]
set_property PACKAGE_PIN P11 [get_ports {D3_OUT[12]}]
set_property PACKAGE_PIN W6 [get_ports {D3_OUT[13]}]
set_property PACKAGE_PIN W7 [get_ports {D3_OUT[14]}]
set_property PACKAGE_PIN F10 [get_ports {D3_OUT[15]}]
set_property PACKAGE_PIN D10 [get_ports {D3_OUT[16]}]
