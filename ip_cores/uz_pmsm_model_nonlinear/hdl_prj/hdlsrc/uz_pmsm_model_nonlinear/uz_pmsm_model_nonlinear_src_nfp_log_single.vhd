-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_pmsm_model_nonlinear\uz_pmsm_model_nonlinear_src_nfp_log_single.vhd
-- Created: 2026-02-20 11:35:33
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_nonlinear_src_nfp_log_single
-- Source Path: uz_pmsm_model_nonlinear/uz_pmsm_mode_nonlinear/nfp_log_single
-- Hierarchy Level: 1
-- Model version: 9.10
-- 
...
USE work.uz_pmsm_model_nonlinear_src_uz_pmsm_mode_nonlinear_pkg.ALL;

ENTITY uz_pmsm_model_nonlinear_src_nfp_log_single IS
...
END uz_pmsm_model_nonlinear_src_nfp_log_single;


ARCHITECTURE rtl OF uz_pmsm_model_nonlinear_src_nfp_log_single IS
...
BEGIN
  ...
  Switch1_out1_8 <= Constant1_out1 WHEN Relational_Operator_out1 = '0' ELSE
      Switch_out1_9;
  ...
  Switch6_out1_13 <= Constant3_out1_1 WHEN Relational_Operator_out1 = '0' ELSE
      Switch2_out1_16;
  ...
  Switch5_out1_14 <= Constant2_out1_2 WHEN Relational_Operator_out1 = '0' ELSE
      Switch3_out1_1;
