-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\jonat\Documents\MA_JL_CIL\ip_cores\uz_JL_pmsmModel\hdl_prj\hdlsrc\uz_JL_pmsmModel\uz_JL_pmsmModel_src_nfp_sincos_single.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_JL_pmsmModel_src_nfp_sincos_single
-- Source Path: uz_JL_pmsmModel/uz_JL_pmsmModel/Elektrik/abc -> dq/Park-Transformation/nfp_sincos_single
-- Hierarchy Level: 4
-- Model version: 1.50
-- 
...
ENTITY uz_JL_pmsmModel_src_nfp_sincos_single IS
...
END uz_JL_pmsmModel_src_nfp_sincos_single;


ARCHITECTURE rtl OF uz_JL_pmsmModel_src_nfp_sincos_single IS
  ...
  SIGNAL RelOp_out1                       : std_logic;
  SIGNAL Delay19_reg                      : std_logic_vector(23 DOWNTO 0);  -- ufix1 [24]
  ...
  SIGNAL reduced_reg                      : std_logic_vector(9 DOWNTO 0);  -- ufix1 [10]
  SIGNAL Delay12_out1_4                   : std_logic;  -- ufix1
  SIGNAL Logical_Operator_out1            : std_logic;
  SIGNAL Switch1_out1                     : std_logic;
  SIGNAL Delay20_out1                     : std_logic;
  SIGNAL Delay28_reg                      : std_logic_vector(13 DOWNTO 0);  -- ufix1 [14]
  SIGNAL Delay28_out1                     : std_logic;  -- ufix1
  SIGNAL reduced_reg_1                    : std_logic_vector(14 DOWNTO 0);  -- ufix1 [15]
  ...
  SIGNAL Delay4_reg                       : std_logic_vector(13 DOWNTO 0);  -- ufix1 [14]
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        Delay7_reg(1 TO 24) <= Delay7_reg(0 TO 23);
      END IF;
    END IF;
  ...
  RelOp_out1 <= '1' WHEN Delay14_out1 < Constant_out1 ELSE
      '0';
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay19_reg(0) <= RelOp_out1;
        Delay19_reg(23 DOWNTO 1) <= Delay19_reg(22 DOWNTO 0);
      END IF;
    END IF;
  ...
  Relational_Operator_cast <= signed(resize(Constant5_out1, 16));
  
  Relational_Operator_out1 <= '1' WHEN Delay4_out1 < Relational_Operator_cast ELSE
      '0';

  Delay4_out1_dtc <= unsigned(Delay4_out1(7 DOWNTO 0));

  
  Switch24_out1 <= Delay4_out1_dtc WHEN Relational_Operator_out1 = '0' ELSE
      Constant5_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay3_reg <= (OTHERS => to_unsigned(0, 51));
      ELSIF enb = '1' THEN
        Delay3_reg(0) <= Data_Type_Conversion_out1_2;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        reduced_reg(0) <= Delay12_out1_3;
        reduced_reg(9 DOWNTO 1) <= reduced_reg(8 DOWNTO 0);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay28_reg(0) <= Delay20_out1;
        Delay28_reg(13 DOWNTO 1) <= Delay28_reg(12 DOWNTO 0);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        reduced_reg_1(0) <= Delay12_out1_4;
        reduced_reg_1(14 DOWNTO 1) <= reduced_reg_1(13 DOWNTO 0);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay4_out1_2 <= '0';
      ELSIF enb = '1' THEN
        Delay4_out1_2 <= Relational_Operator_out1_1;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay2_reg <= (OTHERS => to_unsigned(16#0000000#, 27));
      ELSIF enb = '1' THEN
        Delay2_reg(0) <= Data_Type_Conversion_out1_9;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay7_reg_1 <= (OTHERS => to_unsigned(16#00#, 8));
      ELSIF enb = '1' THEN
        Delay7_reg_1(0) <= Delay13_out1_3;
        Delay7_reg_1(1 TO 2) <= Delay7_reg_1(0 TO 1);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay10_reg(0) <= Selector2_out1_6;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay5_reg_1 <= (OTHERS => to_unsigned(0, 54));
      ELSIF enb = '1' THEN
        Delay5_reg_1(0) <= Data_Type_Conversion_out1_8;
        Delay5_reg_1(1 TO 6) <= Delay5_reg_1(0 TO 5);
      END IF;
    END IF;
  ...
  Switch3_out1_1 <= Constant1_out1 WHEN Relational_Operator_out1_1 = '0' ELSE
      Switch8_out1_1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay6_reg <= (OTHERS => to_unsigned(16#000000#, 23));
      ELSIF enb = '1' THEN
        Delay6_reg(0) <= Delay14_out1_1;
        Delay6_reg(1 TO 24) <= Delay6_reg(0 TO 23);
      END IF;
    END IF;
  ...
  Switch2_out1_2 <= Constant_out1_22 WHEN Relational_Operator_out1_1 = '0' ELSE
      Switch6_out1_1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay4_reg <= (OTHERS => '0');
      ELSIF enb = '1' THEN
        Delay4_reg(0) <= Delay1_out1_13;
        Delay4_reg(13 DOWNTO 1) <= Delay4_reg(12 DOWNTO 0);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay2_reg_1 <= (OTHERS => to_unsigned(16#0000000#, 27));
      ELSIF enb = '1' THEN
        Delay2_reg_1(0) <= Data_Type_Conversion_out1_17;
        Delay2_reg_1(1 TO 2) <= Delay2_reg_1(0 TO 1);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay9_reg_1 <= (OTHERS => to_signed(16#0000000#, 27));
      ELSIF enb = '1' THEN
        Delay9_reg_1(0) <= Selector1_out1_9;
        Delay9_reg_1(1) <= Delay9_reg_1(0);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay7_reg_2 <= (OTHERS => to_unsigned(16#00#, 8));
      ELSIF enb = '1' THEN
        Delay7_reg_2(0) <= Delay13_out1_8;
        Delay7_reg_2(1 TO 2) <= Delay7_reg_2(0 TO 1);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay10_reg_1 <= (OTHERS => to_signed(16#0000000#, 27));
      ELSIF enb = '1' THEN
        Delay10_reg_1(0) <= Selector2_out1_11;
        Delay10_reg_1(1) <= Delay10_reg_1(0);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay5_reg_2 <= (OTHERS => to_unsigned(0, 54));
      ELSIF enb = '1' THEN
        Delay5_reg_2(0) <= Data_Type_Conversion_out1_16;
        Delay5_reg_2(1 TO 6) <= Delay5_reg_2(0 TO 5);
      END IF;
    END IF;
  ...
  Switch1_out1_6 <= Constant2_out1_2 WHEN Relational_Operator_out1_1 = '0' ELSE
      Switch8_out1_3;
  ...
  Switch_out1_7 <= Constant3_out1_2 WHEN Relational_Operator_out1_1 = '0' ELSE
      Switch6_out1_3;
