/*
 * File Name:         C:\Users\valen\Documents\repos\UZ\ultrazohm_sw_working\ip_cores\uz_pmsm_model\hdl_prj\ipcore\uz_pmsm_model_v1_1\include\uz_pmsm_model_addr.h
 * Description:       C Header File
 * Created:           2022-10-31 15:24:07
*/
...
#define  IPCore_Timestamp_uz_pmsm_model                     0x8  //contains unique IP timestamp (yymmddHHMM): 2210311523
...
#define  use_axi_input_Data_uz_pmsm_model                   0x128  //data register for Inport use_axi_input
...
#define  outputs_Data_uz_pmsm_model                         0x1A0  //data register for Outport outputs, vector with 5 elements, address ends at 0x1B0
#define  outputs_Strobe_uz_pmsm_model                       0x1C0  //strobe register for port outputs
#define  voltage_input_dq_out_axi_fb_Data_uz_pmsm_model     0x280  //data register for Outport voltage_input_dq_out_axi_fb, vector with 2 elements, address ends at 0x284
#define  voltage_input_dq_out_axi_fb_Strobe_uz_pmsm_model   0x288  //strobe register for port voltage_input_dq_out_axi_fb
