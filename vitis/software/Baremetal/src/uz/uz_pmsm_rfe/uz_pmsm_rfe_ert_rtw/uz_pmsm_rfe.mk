...
PRODUCT_NAME              = uz_pmsm_rfe
MAKEFILE                  = uz_pmsm_rfe.mk
MATLAB_ROOT               = /usr/local/MATLAB/R2023a
MATLAB_BIN                = /usr/local/MATLAB/R2023a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/glnxa64
START_DIR                 = /home/ts/Documents/pr_review/ultrazohm_sw/vitis/software/Baremetal/src/Codegen
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = GNU
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/uz_pmsm_rfe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/uz_pmsm_rfe_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=uz_pmsm_rfe -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/uz_pmsm_rfe_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/uz_pmsm_rfe_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
