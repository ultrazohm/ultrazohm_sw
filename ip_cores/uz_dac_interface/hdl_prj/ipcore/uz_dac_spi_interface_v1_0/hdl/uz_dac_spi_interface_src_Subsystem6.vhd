-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/uz_dac_spi_interface/uz_dac_spi_interface_src_Subsystem6.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_dac_spi_interface_src_Subsystem6
-- Source Path: uz_dac_spi_interface/uz_dac_spi_interface/Subsystem6
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_dac_spi_interface_src_Subsystem6 IS
  PORT( u                                 :   IN    std_logic_vector(15 DOWNTO 0);  -- int16
        Out1                              :   OUT   std_logic_vector(0 TO 31)  -- ufix1 [32]
        );
END uz_dac_spi_interface_src_Subsystem6;


ARCHITECTURE rtl OF uz_dac_spi_interface_src_Subsystem6 IS
