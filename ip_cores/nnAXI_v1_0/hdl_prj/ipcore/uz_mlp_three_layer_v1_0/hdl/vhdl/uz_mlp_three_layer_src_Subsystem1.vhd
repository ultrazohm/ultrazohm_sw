-- -------------------------------------------------------------
-- 
-- File Name: /home/ts/Documents/integrate_nn_to_uz/ultrazohm_sw/ip_cores/nnAXI_v1_0/hdl_prj/hdlsrc/uz_mlp_three_layer/uz_mlp_three_layer_src_Subsystem1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_mlp_three_layer_src_Subsystem1
-- Source Path: uz_mlp_three_layer/pcu_mlp2_8parallel/LastLayer/Subsystem1
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_mlp_three_layer_src_Subsystem1 IS
...
END uz_mlp_three_layer_src_Subsystem1;


ARCHITECTURE rtl OF uz_mlp_three_layer_src_Subsystem1 IS

  -- Component Declarations
  COMPONENT uz_mlp_three_layer_src_SimpleDualPortRAM_generic
  ...
  COMPONENT uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block
    GENERIC( AddrWidth                    : integer;
             DataWidth                    : integer
             );
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : uz_mlp_three_layer_src_SimpleDualPortRAM_generic
    USE ENTITY work.uz_mlp_three_layer_src_SimpleDualPortRAM_generic(rtl);

  FOR ALL : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block
    USE ENTITY work.uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block(rtl);
  ...
  SIGNAL mac_counter_unsigned             : unsigned(9 DOWNTO 0);  -- ufix10
...
BEGIN
  u_Dual_Port_RAM_System1 : uz_mlp_three_layer_src_SimpleDualPortRAM_generic
    ...
    PORT MAP( clk => clk,
              ...
              wr_en => AND1_out1,
              rd_addr => n_perceptron,
              rd_dout => c
              );

  u_Dual_Port_RAM_System3 : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block
    GENERIC MAP( AddrWidth => 10,
                 DataWidth => 32
                 )
    PORT MAP( clk => clk,
  ...
  Compare_To_Constant2_out1 <= '1' WHEN axi_layerNr = to_unsigned(16#04#, 8) ELSE
      '0';
  ...
  Gain_cast <= resize(n_perceptron_unsigned & '0' & '0' & '0' & '0' & '0' & '0' & '0' & '0' & '0', 20);
  Gain_out1 <= Gain_cast(12 DOWNTO 3);

  AND_out1 <= Compare_To_Constant_out1 AND Compare_To_Constant2_out1;

  mac_counter_unsigned <= unsigned(mac_counter);

  Sum1_out1 <= Gain_out1 + mac_counter_unsigned;
