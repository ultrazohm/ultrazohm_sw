-- -------------------------------------------------------------
-- 
-- File Name: /home/ts/Documents/integrate_nn_to_uz/ultrazohm_sw/ip_cores/nnAXI_v1_0/hdl_prj/hdlsrc/uz_mlp_three_layer/uz_mlp_three_layer_src_MAC_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_mlp_three_layer_src_MAC_block1
-- Source Path: uz_mlp_three_layer/uz_mlp_three_layer/reluLayer_8Parallel1/MAC
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_mlp_three_layer_src_MAC_block1 IS
...
END uz_mlp_three_layer_src_MAC_block1;


ARCHITECTURE rtl OF uz_mlp_three_layer_src_MAC_block1 IS

  -- Component Declarations
  COMPONENT uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block39
  ...
  COMPONENT uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block41
    GENERIC( AddrWidth                    : integer;
             DataWidth                    : integer
             );
    PORT( clk                             :   IN    std_logic;
  ...
  COMPONENT uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block40
    GENERIC( AddrWidth                    : integer;
             DataWidth                    : integer
             );
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block39
    USE ENTITY work.uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block39(rtl);

  FOR ALL : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block41
    USE ENTITY work.uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block41(rtl);

  FOR ALL : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block40
    USE ENTITY work.uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block40(rtl);
...
BEGIN
  u_Dual_Port_RAM_System1 : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block39
  ...
  u_Dual_Port_RAM_System3 : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block41
    GENERIC MAP( AddrWidth => 10,
                 DataWidth => 32
                 )
    PORT MAP( clk => clk,
  ...
  u_Dual_Port_RAM_System2 : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block40
    GENERIC MAP( AddrWidth => 10,
                 DataWidth => 32
                 )
    PORT MAP( clk => clk,
  ...
  Constant_out1 <= to_unsigned(16#019#, 10);
