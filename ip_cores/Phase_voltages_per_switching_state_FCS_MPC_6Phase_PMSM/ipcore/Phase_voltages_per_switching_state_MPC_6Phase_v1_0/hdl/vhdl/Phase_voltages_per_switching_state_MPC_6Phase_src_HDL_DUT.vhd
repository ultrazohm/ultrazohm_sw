...
ARCHITECTURE rtl OF Phase_voltages_per_switching_state_MPC_6Phase_src_HDL_DUT IS
  ...
  COMPONENT Phase_voltages_per_switching_state_MPC_6Phase_src_Detect_Rise_Positive2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  FOR ALL : Phase_voltages_per_switching_state_MPC_6Phase_src_Detect_Rise_Positive2
    USE ENTITY work.Phase_voltages_per_switching_state_MPC_6Phase_src_Detect_Rise_Positive2(rtl);
  ...
  SIGNAL End_Cycle_2                      : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL Delay15_reg                      : std_logic_vector(0 TO 2);  -- ufix1 [3]
  SIGNAL Delay15_reg_next                 : std_logic_vector(0 TO 2);  -- ufix1 [3]
...
BEGIN
  ...
  u_Detect_Rise_Positive2 : Phase_voltages_per_switching_state_MPC_6Phase_src_Detect_Rise_Positive2
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  End_Cycle_1 <= delayMatch8_reg(27);
  delayMatch8_reg_next(0) <= End_Cycle;
  ...
  End_Cycle_4 <= Switch_Limit_High_out1 WHEN Compare_Limit_Low_out1_1 = '0' ELSE
      Add3_out1;
  ...
  Delay15_reg_next(0) <= valid_in_delay_compensation;
  ...
  Logical_Operator_out1 <= Delay15_out1 OR Delay11_out1;

  
  switch_compare_1_2 <= '1' WHEN End_Cycle_5 = '1' ELSE
      '0';
  ...
  switch_compare_1_3 <= '1' WHEN End_Cycle_5 = '1' ELSE
      '0';
  ...
  Delay16_out1_1 <= delayMatch9_reg(86);
  delayMatch9_reg_next(0) <= Delay16_out1;
