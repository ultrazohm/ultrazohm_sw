-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\IP_Core_SS_Switch_and_PWM\PWM_and_SS_control_V3_ip_src_GenPWM.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: PWM_and_SS_control_V3_ip_src_GenPWM
...
ENTITY PWM_and_SS_control_V3_ip_src_GenPWM IS
...
END PWM_and_SS_control_V3_ip_src_GenPWM;


ARCHITECTURE rtl OF PWM_and_SS_control_V3_ip_src_GenPWM IS

  -- Component Declarations
  COMPONENT PWM_and_SS_control_V3_ip_src_Counter_Ctrl
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT PWM_and_SS_control_V3_ip_src_LimitPulseWidth
  ...
  COMPONENT PWM_and_SS_control_V3_ip_src_LimitPulseWidth1
    PORT( ref_sig                         :   IN    std_logic_vector(13 DOWNTO 0);  -- sfix14_En12
          min_pulse_width                 :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En16
          ref_sig_limit                   :   OUT   std_logic_vector(17 DOWNTO 0)  -- sfix18_En16
          );
  ...
  COMPONENT PWM_and_SS_control_V3_ip_src_LimitPulseWidth2
    PORT( ref_sig                         :   IN    std_logic_vector(13 DOWNTO 0);  -- sfix14_En12
          min_pulse_width                 :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En16
          ref_sig_limit                   :   OUT   std_logic_vector(17 DOWNTO 0)  -- sfix18_En16
          );
  ...
  FOR ALL : PWM_and_SS_control_V3_ip_src_Counter_Ctrl
    USE ENTITY work.PWM_and_SS_control_V3_ip_src_Counter_Ctrl(rtl);

  FOR ALL : PWM_and_SS_control_V3_ip_src_LimitPulseWidth
    USE ENTITY work.PWM_and_SS_control_V3_ip_src_LimitPulseWidth(rtl);

  FOR ALL : PWM_and_SS_control_V3_ip_src_LimitPulseWidth1
    USE ENTITY work.PWM_and_SS_control_V3_ip_src_LimitPulseWidth1(rtl);

  FOR ALL : PWM_and_SS_control_V3_ip_src_LimitPulseWidth2
    USE ENTITY work.PWM_and_SS_control_V3_ip_src_LimitPulseWidth2(rtl);
...
BEGIN
  ...
  u_Counter_Ctrl : PWM_and_SS_control_V3_ip_src_Counter_Ctrl
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_LimitPulseWidth : PWM_and_SS_control_V3_ip_src_LimitPulseWidth
  ...
  u_LimitPulseWidth1 : PWM_and_SS_control_V3_ip_src_LimitPulseWidth1
    PORT MAP( ref_sig => std_logic_vector(Switch1_out1),  -- sfix14_En12
              min_pulse_width => std_logic_vector(min_pulse_width_AXI_1),  -- sfix18_En16
              ref_sig_limit => LimitPulseWidth1_out1  -- sfix18_En16
              );

  u_LimitPulseWidth2 : PWM_and_SS_control_V3_ip_src_LimitPulseWidth2
