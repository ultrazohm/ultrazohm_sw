-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_mpc_delay_comp\delay_com_ip_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: delay_com_ip_axi_lite
-- Source Path: delay_com_ip/delay_com_ip_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY delay_com_ip_axi_lite IS
...
END delay_com_ip_axi_lite;


ARCHITECTURE rtl OF delay_com_ip_axi_lite IS

  -- Component Declarations
  COMPONENT delay_com_ip_addr_decoder
  ...
  COMPONENT delay_com_ip_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : delay_com_ip_addr_decoder
    USE ENTITY work.delay_com_ip_addr_decoder(rtl);

  FOR ALL : delay_com_ip_axi_lite_module
    USE ENTITY work.delay_com_ip_axi_lite_module(rtl);
...
BEGIN
  u_delay_com_ip_addr_decoder_inst : delay_com_ip_addr_decoder
  ...
  u_delay_com_ip_axi_lite_module_inst : delay_com_ip_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
