-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\parallel_8_cost_function\hdlsrc\parallel_8_cost_function\parallel_8_cost_function_src_nfp_convert_single_to_sfix_20_En11.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: parallel_8_cost_function_src_nfp_convert_single_to_sfix_20_En11
-- Source Path: parallel_8_cost_function/HDL_DUT1/nfp_convert_single_to_sfix_20_En11
-- Hierarchy Level: 1
-- 
...
ENTITY parallel_8_cost_function_src_nfp_convert_single_to_sfix_20_En11 IS
...
END parallel_8_cost_function_src_nfp_convert_single_to_sfix_20_En11;


ARCHITECTURE rtl OF parallel_8_cost_function_src_nfp_convert_single_to_sfix_20_En11 IS
  ...
  SIGNAL Bit_Set_out1                     : unsigned(32 DOWNTO 0);  -- ufix33_En24
  SIGNAL Switch2_out1_1                   : unsigned(32 DOWNTO 0);  -- ufix33_En24
  ...
  SIGNAL Data_Type_Conversion2_out1       : signed(19 DOWNTO 0);  -- sfix20_En11
...
BEGIN
  ...
  Compare_To_Zero1_out1_1 <= '1' WHEN Shift_Arithmetic1_out1 = to_unsigned(0, 33) ELSE
      '0';

  
  Compare_To_Zero_out1_1 <= '1' WHEN Data_Type_Conversion_out1 /= to_unsigned(0, 33) ELSE
      '0';
  ...
  Bit_Set_out1 <= Delay4_out1_1 OR to_unsigned(1, 33);
  ...
  Data_Type_Conversion2_out1 <= Switch1_out1_1(32 DOWNTO 13);
