-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj7/hdlsrc/uz_pmsm_model_9ph_21b_all_double/uz_pmsm_model_9ph3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_9ph3
-- Source Path: uz_pmsm_model_9ph3
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END uz_pmsm_model_9ph3;


ARCHITECTURE rtl OF uz_pmsm_model_9ph3 IS

  -- Component Declarations
  COMPONENT uz_pmsm_model_9ph3_reset_sync
  ...
  COMPONENT uz_pmsm_model_9ph3_axi4
  ...
  COMPONENT uz_pmsm_model_9ph3_dut
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          ...
          i_abc_ps_0                      :   OUT   std_logic_vector(31 DOWNTO 0);  -- ufix32
          i_abc_ps_1                      :   OUT   std_logic_vector(31 DOWNTO 0);  -- ufix32
          i_abc_ps_2                      :   OUT   std_logic_vector(31 DOWNTO 0);  -- ufix32
          i_abc_ps_3                      :   OUT   std_logic_vector(31 DOWNTO 0);  -- ufix32
          i_abc_ps_4                      :   OUT   std_logic_vector(31 DOWNTO 0);  -- ufix32
          i_abc_ps_5                      :   OUT   std_logic_vector(31 DOWNTO 0);  -- ufix32
          i_abc_ps_6                      :   OUT   std_logic_vector(31 DOWNTO 0);  -- ufix32
          i_abc_ps_7                      :   OUT   std_logic_vector(31 DOWNTO 0);  -- ufix32
          i_abc_ps_8                      :   OUT   std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  FOR ALL : uz_pmsm_model_9ph3_reset_sync
    USE ENTITY work.uz_pmsm_model_9ph3_reset_sync(rtl);

  FOR ALL : uz_pmsm_model_9ph3_axi4
    USE ENTITY work.uz_pmsm_model_9ph3_axi4(rtl);

  FOR ALL : uz_pmsm_model_9ph3_dut
    USE ENTITY work.uz_pmsm_model_9ph3_dut(rtl);
  ...
  SIGNAL write_input_unsigned             : vector_of_std_logic_vector32(0 TO 1);  -- ufix32 [2]
  SIGNAL reset_internal                   : std_logic;  -- ufix1
  SIGNAL reset_before_sync                : std_logic;  -- ufix1
  SIGNAL read_i_abc_ps_vec                : vector_of_std_logic_vector32(0 TO 8);  -- ufix32 [9]
  SIGNAL read_outputs_vec                 : vector_of_std_logic_vector32(0 TO 2);  -- ufix32 [3]
...
BEGIN
  u_uz_pmsm_model_9ph3_reset_sync_inst : uz_pmsm_model_9ph3_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_uz_pmsm_model_9ph3_axi4_inst : uz_pmsm_model_9ph3_axi4
    PORT MAP( reset => reset,
              ...
              read_outputs => read_outputs_vec,  -- ufix32 [3]
              read_i_abc_ps => read_i_abc_ps_vec,  -- ufix32 [9]
              ...
              write_input => write_input_unsigned,  -- ufix32 [2]
  ...
  u_uz_pmsm_model_9ph3_dut_inst : uz_pmsm_model_9ph3_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              ...
              pwm_trig => pwm_trig,  -- ufix1
              ce_out => ce_out_sig,  -- ufix1
              outputs_0 => read_outputs_vec(0),  -- ufix32
              outputs_1 => read_outputs_vec(1),  -- ufix32
              outputs_2 => read_outputs_vec(2),  -- ufix32
              i_abc_ps_0 => read_i_abc_ps_vec(0),  -- ufix32
              i_abc_ps_1 => read_i_abc_ps_vec(1),  -- ufix32
              i_abc_ps_2 => read_i_abc_ps_vec(2),  -- ufix32
              i_abc_ps_3 => read_i_abc_ps_vec(3),  -- ufix32
              i_abc_ps_4 => read_i_abc_ps_vec(4),  -- ufix32
              i_abc_ps_5 => read_i_abc_ps_vec(5),  -- ufix32
              i_abc_ps_6 => read_i_abc_ps_vec(6),  -- ufix32
              i_abc_ps_7 => read_i_abc_ps_vec(7),  -- ufix32
              i_abc_ps_8 => read_i_abc_ps_vec(8),  -- ufix32
  ...
  ip_timestamp <= unsigned'(X"837D868B");
