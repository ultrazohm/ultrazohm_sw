-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj123\hdlsrc\uz_pmsm_model_9ph_dq\uz_pmsm_model_9ph_dq_axi4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_9ph_dq_axi4
-- Source Path: uz_pmsm_model_9ph_dq/uz_pmsm_model_9ph_dq_axi4
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_pmsm_model_9ph_dq_axi4 IS
...
END uz_pmsm_model_9ph_dq_axi4;


ARCHITECTURE rtl OF uz_pmsm_model_9ph_dq_axi4 IS

  -- Component Declarations
  COMPONENT uz_pmsm_model_9ph_dq_addr_decoder
  ...
  COMPONENT uz_pmsm_model_9ph_dq_axi4_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_ARESETN                    :   IN    std_logic;  -- ufix1
          AXI4_AWID                       :   IN    std_logic_vector(11 DOWNTO 0);  -- ufix12
          AXI4_AWADDR                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  FOR ALL : uz_pmsm_model_9ph_dq_addr_decoder
    USE ENTITY work.uz_pmsm_model_9ph_dq_addr_decoder(rtl);

  FOR ALL : uz_pmsm_model_9ph_dq_axi4_module
    USE ENTITY work.uz_pmsm_model_9ph_dq_axi4_module(rtl);
  ...
  SIGNAL write_physical_parameters_L_x3_tmp : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_physical_parameters_L_y3_tmp : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_physical_parameters_L_zero_tmp : std_logic_vector(31 DOWNTO 0);  -- ufix32
...
BEGIN
  u_uz_pmsm_model_9ph_dq_addr_decoder_inst : uz_pmsm_model_9ph_dq_addr_decoder
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
              ...
              read_currents_dq_out_axi => read_currents_dq_out_axi,  -- ufix32 [9]
              read_voltage_input_dq_out_axi_fb => read_voltage_input_dq_out_axi_fb,  -- ufix32 [9]
              ...
              write_physical_parameters_L_x3 => write_physical_parameters_L_x3_tmp,  -- ufix32
              write_physical_parameters_L_y3 => write_physical_parameters_L_y3_tmp,  -- ufix32
              write_physical_parameters_L_zero => write_physical_parameters_L_zero_tmp,  -- ufix32
              write_physical_parameters_1_J => write_physical_parameters_1_J_tmp  -- ufix32
              );

  u_uz_pmsm_model_9ph_dq_axi4_module_inst : uz_pmsm_model_9ph_dq_axi4_module
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
  ...
  write_physical_parameters_L_x3 <= write_physical_parameters_L_x3_tmp;

  write_physical_parameters_L_y3 <= write_physical_parameters_L_y3_tmp;

  write_physical_parameters_L_zero <= write_physical_parameters_L_zero_tmp;
