-- -------------------------------------------------------------
-- 
-- File Name: C:\UltraZohm\ultrazohm_test\ip_cores\uz_Deadbeat\hdl_prj\hdlsrc\uz_Deadbeat\uz_Deadbe_ip_rdfifo_data.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_Deadbe_ip_rdfifo_data
-- Source Path: uz_Deadbe_ip/uz_Deadbe_ip_axi4/uz_Deadbe_ip_axi4_module/uz_Deadbe_ip_rdfifo_data
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_Deadbe_ip_rdfifo_data IS
...
END uz_Deadbe_ip_rdfifo_data;


ARCHITECTURE rtl OF uz_Deadbe_ip_rdfifo_data IS

  -- Component Declarations
  COMPONENT uz_Deadbe_ip_SimpleDualPortRAM_generic
  ...
  FOR ALL : uz_Deadbe_ip_SimpleDualPortRAM_generic
    USE ENTITY work.uz_Deadbe_ip_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_uz_Deadbe_ip_rdfifo_data_classic_ram_generic : uz_Deadbe_ip_SimpleDualPortRAM_generic
