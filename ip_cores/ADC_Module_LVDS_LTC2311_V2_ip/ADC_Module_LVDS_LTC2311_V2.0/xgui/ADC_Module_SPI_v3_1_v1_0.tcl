...
proc init_gui { IPINST } {
  ...
  #Adding Page
  set Config [ipgui::add_page $IPINST -name "Config"]
  set_property tooltip {Config} ${Config}
  ipgui::add_param $IPINST -name "INPUT_CLK_FREQUENCY" -parent ${Config}
  ipgui::add_param $IPINST -name "SPI_CLK_FREQUENCY" -parent ${Config}
  ipgui::add_param $IPINST -name "W_LENGTH" -parent ${Config}
  ipgui::add_param $IPINST -name "Number_of_ADCs" -parent ${Config}

  #Adding Page
  set Conversion [ipgui::add_page $IPINST -name "Conversion"]
  ipgui::add_param $IPINST -name "CONVERSION_RATE_ADC" -parent ${Conversion}
  ipgui::add_param $IPINST -name "ADC_SET_USER_OFFSET_1" -parent ${Conversion}
  ipgui::add_param $IPINST -name "ADC_USER_OFFSET_1" -parent ${Conversion}
