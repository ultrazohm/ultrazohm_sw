-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\valen\Documents\repos\UZ\ultrazohm_sw\ip_cores\uz_pmsm_model_9ph\hdl_opti\hdlsrc\uz_pmsm_model_9ph\uz_pmsm_model_9ph_opti_src_nfp_convert_sfix_25_En12_to_single.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_9ph_opti_src_nfp_convert_sfix_25_En12_to_single
-- Source Path: uz_pmsm_model_9ph/uz_pmsm_model_9ph/nfp_convert_sfix_25_En12_to_single
-- Hierarchy Level: 1
-- 
...
ENTITY uz_pmsm_model_9ph_opti_src_nfp_convert_sfix_25_En12_to_single IS
...
END uz_pmsm_model_9ph_opti_src_nfp_convert_sfix_25_En12_to_single;


ARCHITECTURE rtl OF uz_pmsm_model_9ph_opti_src_nfp_convert_sfix_25_En12_to_single IS

  -- Signals
  SIGNAL nfp_in_signed                    : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL Delay_out1                       : signed(24 DOWNTO 0);  -- sfix25_En12
  ...
  SIGNAL Delay_out1_dtc                   : unsigned(24 DOWNTO 0);  -- ufix25_En12
  ...
  SIGNAL Data_Type_Conversion_out1        : unsigned(127 DOWNTO 0);  -- ufix128_En12
  ...
  SIGNAL Delay2_reg_next                  : vector_of_unsigned128(0 TO 2);  -- ufix128_En12 [3]
  SIGNAL Delay2_out1_3                    : unsigned(127 DOWNTO 0);  -- ufix128_En12
  ...
  SIGNAL Shift_Arithmetic_out1            : unsigned(127 DOWNTO 0);  -- ufix128_En12
...
BEGIN
  ...
  Constant_out1 <= to_signed(16#72#, 8);
