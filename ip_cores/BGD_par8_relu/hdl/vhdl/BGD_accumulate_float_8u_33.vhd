...
attribute shreg_extract : string;
    ...
    signal tmp_s_fu_234_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_s_reg_438 : STD_LOGIC_VECTOR (8 downto 0);
...
begin
    fadd_32ns_32ns_32_5_full_dsp_1_U465 : component BGD_fadd_32ns_32ns_32_5_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln409_fu_219_p2 = ap_const_lv1_0))) then
                    ...
                    tmp_s_reg_438(8 downto 3) <= tmp_s_fu_234_p3(8 downto 3);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    or_ln416_1_fu_332_p2 <= (tmp_s_reg_438 or ap_const_lv9_2);
    or_ln416_2_fu_342_p2 <= (tmp_s_reg_438 or ap_const_lv9_3);
    or_ln416_3_fu_356_p2 <= (tmp_s_reg_438 or ap_const_lv9_4);
    or_ln416_4_fu_366_p2 <= (tmp_s_reg_438 or ap_const_lv9_5);
    or_ln416_5_fu_380_p2 <= (tmp_s_reg_438 or ap_const_lv9_6);
    or_ln416_6_fu_390_p2 <= (tmp_s_reg_438 or ap_const_lv9_7);
    or_ln416_fu_247_p2 <= (tmp_s_fu_234_p3 or ap_const_lv9_1);
