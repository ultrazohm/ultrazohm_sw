...
ARCHITECTURE rtl OF UZ_D_GaN_Inverter_src_UZ_D_GaN_Inverter IS
  ...
  COMPONENT UZ_D_GaN_Inverter_src_PWMdutycycFreqDetection
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          PWMin                           :   IN    std_logic;
  ...
  FOR ALL : UZ_D_GaN_Inverter_src_PWMdutycycFreqDetection
    USE ENTITY work.UZ_D_GaN_Inverter_src_PWMdutycycFreqDetection(rtl);
...
BEGIN
  u_PWMdutycycFreqDetection : UZ_D_GaN_Inverter_src_PWMdutycycFreqDetection
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              PWMin => GaN_Temp1,
  ...
  u_PWMdutycycFreqDetection1 : UZ_D_GaN_Inverter_src_PWMdutycycFreqDetection
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              PWMin => GaN_Temp2,
  ...
  u_PWMdutycycFreqDetection2 : UZ_D_GaN_Inverter_src_PWMdutycycFreqDetection
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              PWMin => GaN_Temp3,
  ...
  u_PWMdutycycFreqDetection3 : UZ_D_GaN_Inverter_src_PWMdutycycFreqDetection
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              PWMin => GaN_Temp4,
  ...
  u_PWMdutycycFreqDetection4 : UZ_D_GaN_Inverter_src_PWMdutycycFreqDetection
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              PWMin => GaN_Temp5,
  ...
  u_PWMdutycycFreqDetection5 : UZ_D_GaN_Inverter_src_PWMdutycycFreqDetection
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              PWMin => GaN_Temp6,
