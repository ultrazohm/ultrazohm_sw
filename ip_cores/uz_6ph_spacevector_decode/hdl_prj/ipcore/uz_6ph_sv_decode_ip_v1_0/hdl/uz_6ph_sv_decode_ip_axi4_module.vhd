-- -------------------------------------------------------------
-- 
-- File Name: C:\utrazohm_sw_2\ultrazohm_sw\ip_cores\uz_6ph_spacevector_decode\hdl_prj\hdlsrc\uz_6ph_spacevector_decode\uz_6ph_sv_decode_ip_axi4_module.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_6ph_sv_decode_ip_axi4_module
-- Source Path: uz_6ph_sv_decode_ip/uz_6ph_sv_decode_ip_axi4/uz_6ph_sv_decode_ip_axi4_module
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_6ph_sv_decode_ip_axi4_module IS
...
END uz_6ph_sv_decode_ip_axi4_module;


ARCHITECTURE rtl OF uz_6ph_sv_decode_ip_axi4_module IS

  -- Component Declarations
  COMPONENT uz_6ph_sv_decode_ip_rdfifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT uz_6ph_sv_decode_ip_rdfifo_rid
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT uz_6ph_sv_decode_ip_rdfifo_last
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : uz_6ph_sv_decode_ip_rdfifo_data
    USE ENTITY work.uz_6ph_sv_decode_ip_rdfifo_data(rtl);

  FOR ALL : uz_6ph_sv_decode_ip_rdfifo_rid
    USE ENTITY work.uz_6ph_sv_decode_ip_rdfifo_rid(rtl);

  FOR ALL : uz_6ph_sv_decode_ip_rdfifo_last
    USE ENTITY work.uz_6ph_sv_decode_ip_rdfifo_last(rtl);
...
BEGIN
  u_uz_6ph_sv_decode_ip_rdfifo_data_inst : uz_6ph_sv_decode_ip_rdfifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
  ...
  u_uz_6ph_sv_decode_ip_rdfifo_rid_inst : uz_6ph_sv_decode_ip_rdfifo_rid
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
  ...
  u_uz_6ph_sv_decode_ip_rdfifo_last_inst : uz_6ph_sv_decode_ip_rdfifo_last
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
