-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Encoder_Zynq\IncreEncoder_V16_ipcore_src_IncreEncoder_V16.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IncreEncoder_V16_ipcore_src_IncreEncoder_V16
-- Source Path: Encoder_Zynq/IncreEncoder_V16
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY IncreEncoder_V16_ipcore_src_IncreEncoder_V16 IS
  PORT( clk                               :   IN    std_logic;
        ...
        thete_el                          :   OUT   std_logic_vector(23 DOWNTO 0);  -- ufix24_En20
        thete_el_AXI4                     :   OUT   std_logic_vector(23 DOWNTO 0);  -- ufix24_En20
        theta_mech_AXI4                   :   OUT   std_logic_vector(23 DOWNTO 0);  -- ufix24_En20
        edge_rsvd                         :   OUT   std_logic;
        count                             :   OUT   std_logic;
        direction_AXI4                    :   OUT   std_logic_vector(3 DOWNTO 0)  -- sfix4
        );
END IncreEncoder_V16_ipcore_src_IncreEncoder_V16;


ARCHITECTURE rtl OF IncreEncoder_V16_ipcore_src_IncreEncoder_V16 IS

  -- Component Declarations
  COMPONENT IncreEncoder_V16_ipcore_src_Counter_speed
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  COMPONENT IncreEncoder_V16_ipcore_src_n_aus_theta
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  COMPONENT IncreEncoder_V16_ipcore_src_Check_Direction
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          A                               :   IN    std_logic;
  ...
  COMPONENT IncreEncoder_V16_ipcore_src_Counter_theta_ele
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          Enable_ctr                      :   IN    std_logic;
  ...
  COMPONENT IncreEncoder_V16_ipcore_src_Counter_theta
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
          Enable_ctr                      :   IN    std_logic;
  ...
  FOR ALL : IncreEncoder_V16_ipcore_src_Counter_speed
    USE ENTITY work.IncreEncoder_V16_ipcore_src_Counter_speed(rtl);

  FOR ALL : IncreEncoder_V16_ipcore_src_n_aus_theta
    USE ENTITY work.IncreEncoder_V16_ipcore_src_n_aus_theta(rtl);

  FOR ALL : IncreEncoder_V16_ipcore_src_Check_Direction
    USE ENTITY work.IncreEncoder_V16_ipcore_src_Check_Direction(rtl);

  FOR ALL : IncreEncoder_V16_ipcore_src_Counter_theta_ele
    USE ENTITY work.IncreEncoder_V16_ipcore_src_Counter_theta_ele(rtl);

  FOR ALL : IncreEncoder_V16_ipcore_src_Counter_theta
    USE ENTITY work.IncreEncoder_V16_ipcore_src_Counter_theta(rtl);

  -- Signals
  SIGNAL enb_1_2_0                        : std_logic;
  SIGNAL Logical2_out1                    : std_logic;
  SIGNAL Logical2_out1_1                  : std_logic;
  SIGNAL IncrementePerTurn_speed_out1     : unsigned(15 DOWNTO 0);  -- uint16
  SIGNAL Counter_speed_out1               : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL HardwareTimer_FPGA_in_ms_out1    : unsigned(29 DOWNTO 0);  -- ufix30_En24
  ...
  SIGNAL IncrementePerTurn_elek_out1      : unsigned(15 DOWNTO 0);  -- uint16
  ...
  SIGNAL Product_out1                     : unsigned(23 DOWNTO 0);  -- ufix24_En20
  SIGNAL reset_old4_out1                  : unsigned(23 DOWNTO 0);  -- ufix24_En20
  SIGNAL reset_old4_out1_1                : unsigned(23 DOWNTO 0);  -- ufix24_En20
  SIGNAL IncrementePerTurn_mech_out1      : unsigned(15 DOWNTO 0);  -- uint16
  ...
  SIGNAL Inc_PerTurn_mech_out1            : unsigned(23 DOWNTO 0);  -- ufix24_En24
  SIGNAL Product1_mul_temp                : unsigned(39 DOWNTO 0);  -- ufix40_En24
  SIGNAL Product1_out1                    : unsigned(23 DOWNTO 0);  -- ufix24_En20
  SIGNAL out_4_pipe_reg                   : vector_of_unsigned24(0 TO 1);  -- ufix24 [2]
  SIGNAL reset_old3_out1                  : unsigned(23 DOWNTO 0);  -- ufix24_En20
...
BEGIN
  -- <S1>/Counter_speed
  u_Counter_speed : IncreEncoder_V16_ipcore_src_Counter_speed
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_2_0 => clk_enable,
              Enable_ctr => Logical2_out1_1,
              Reset_1 => I,
              IncsPerTurn => std_logic_vector(IncrementePerTurn_speed_out1),  -- uint16
              count => Counter_speed_out1  -- uint16
              );

  -- <S1>/n_aus_theta
  u_n_aus_theta : IncreEncoder_V16_ipcore_src_n_aus_theta
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_2_0 => clk_enable,
              count => Counter_speed_out1,  -- uint16
              IncsPerTurn => std_logic_vector(IncrementePerTurn_speed_out1),  -- uint16
              T => std_logic_vector(HardwareTimer_FPGA_in_ms_out1),  -- ufix30_En24
              rps => n_aus_theta_out1  -- ufix30_En24
              );

  -- <S1>/Check_Direction
  u_Check_Direction : IncreEncoder_V16_ipcore_src_Check_Direction
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_2_0 => clk_enable,
              A => A,
  ...
  u_Counter_theta_ele : IncreEncoder_V16_ipcore_src_Counter_theta_ele
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_2_0 => clk_enable,
              Enable_ctr => Logical1_out1_1,
              Reset_1 => I,
              IncsPerTurn => std_logic_vector(IncrementePerTurn_elek_out1),  -- uint16
              Dir => std_logic_vector(hold1_out1),  -- sfix4
              count => Counter_theta_ele_out1  -- int16
              );

  -- <S1>/Counter_theta
  u_Counter_theta : IncreEncoder_V16_ipcore_src_Counter_theta
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_2_0 => clk_enable,
              Enable_ctr => Logical1_out1_1,
              Reset_1 => I,
              IncsPerTurn => std_logic_vector(IncrementePerTurn_mech_out1),  -- uint16
              Dir => std_logic_vector(hold1_out1),  -- sfix4
  ...
  -- <S1>/IncrementePerTurn_speed
  IncrementePerTurn_speed_out1 <= to_unsigned(16#09C4#, 16);

  -- <S1>/HardwareTimer_FPGA_in_ms
  HardwareTimer_FPGA_in_ms_out1 <= to_unsigned(16#00000150#, 30);
  ...
  -- <S1>/IncrementePerTurn_elek
  IncrementePerTurn_elek_out1 <= to_unsigned(16#07D0#, 16);
  ...
  Product_out1 <= Product_mul_temp(27 DOWNTO 4);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        reset_old4_out1 <= to_unsigned(16#000000#, 24);
      ELSIF enb_1_2_0 = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        reset_old4_out1_1 <= to_unsigned(16#000000#, 24);
      ELSIF enb_1_2_0 = '1' THEN
  ...
  -- <S1>/IncrementePerTurn_mech
  IncrementePerTurn_mech_out1 <= to_unsigned(16#2710#, 16);
  ...
  -- <S1>/Inc_PerTurn_mech
  Inc_PerTurn_mech_out1 <= to_unsigned(16#00292D#, 24);

  -- <S1>/Product1
  Product1_mul_temp <= reset_old5_out1 * Inc_PerTurn_mech_out1;
  Product1_out1 <= Product1_mul_temp(27 DOWNTO 4);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        out_4_pipe_reg <= (OTHERS => to_unsigned(16#000000#, 24));
      ELSIF enb_1_2_0 = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        delayMatch1_reg(0) <= hold1_out1;
        delayMatch1_reg(1) <= delayMatch1_reg(0);
      END IF;
    END IF;
  END PROCESS delayMatch1_process;

  hold1_out1_1 <= delayMatch1_reg(1);
