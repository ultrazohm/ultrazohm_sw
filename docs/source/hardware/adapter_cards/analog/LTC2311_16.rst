...
The pinout of the RJ45 ethernet plug is **NOT** intuitive, as shown in :numref:`rj45pinout`. Moreover, the pinout is flipped compared to the MAX11331 analog card.
