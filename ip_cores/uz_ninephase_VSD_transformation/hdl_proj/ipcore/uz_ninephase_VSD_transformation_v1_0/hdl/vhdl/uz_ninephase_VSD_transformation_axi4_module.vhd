-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\valen\Documents\repos\UZ\ultrazohm_sw\ip_cores\uz_ninephase_VSD_transformation\hdl_proj\hdlsrc\uz_ninephase_VSD_transformation\uz_ninephase_VSD_transformation_axi4_module.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_ninephase_VSD_transformation_axi4_module
-- Source Path: uz_ninephase_VSD_transformation/uz_ninephase_VSD_transformation_axi4/uz_ninephase_VSD_transformation_axi4_module
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_ninephase_VSD_transformation_axi4_module IS
...
END uz_ninephase_VSD_transformation_axi4_module;


ARCHITECTURE rtl OF uz_ninephase_VSD_transformation_axi4_module IS

  -- Component Declarations
  COMPONENT uz_ninephase_VSD_transformation_rdfifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT uz_ninephase_VSD_transformation_rdfifo_rid
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT uz_ninephase_VSD_transformation_rdfifo_last
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : uz_ninephase_VSD_transformation_rdfifo_data
    USE ENTITY work.uz_ninephase_VSD_transformation_rdfifo_data(rtl);

  FOR ALL : uz_ninephase_VSD_transformation_rdfifo_rid
    USE ENTITY work.uz_ninephase_VSD_transformation_rdfifo_rid(rtl);

  FOR ALL : uz_ninephase_VSD_transformation_rdfifo_last
    USE ENTITY work.uz_ninephase_VSD_transformation_rdfifo_last(rtl);
...
BEGIN
  u_uz_ninephase_VSD_transformation_rdfifo_data_inst : uz_ninephase_VSD_transformation_rdfifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
  ...
  u_uz_ninephase_VSD_transformation_rdfifo_rid_inst : uz_ninephase_VSD_transformation_rdfifo_rid
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
  ...
  u_uz_ninephase_VSD_transformation_rdfifo_last_inst : uz_ninephase_VSD_transformation_rdfifo_last
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
