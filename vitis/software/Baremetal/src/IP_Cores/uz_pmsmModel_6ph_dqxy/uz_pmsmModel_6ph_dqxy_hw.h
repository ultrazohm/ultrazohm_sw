#ifndef UZ_PMSMMODEL_6PH_DQXY_HW_H
#define UZ_PMSMMODEL_6PH_DQXY_HW_H
...
void uz_pmsmModel_6ph_dqxy_hw_write_v_q(uint32_t base_address, float v_d);
void uz_pmsmModel_6ph_dqxy_hw_write_v_d(uint32_t base_address, float v_q);
...
#endif // UZ_PMSMMODEL_6PH_DQXY_HW_H
