-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\ELSYS_PC\Documents\repos\ultrazohm_sw\ip_cores\uz_EnDat_IPCore\hdl_prj\hdlsrc\UZ_EnDat\uz_EnDat_ABZ_addon_src_nfp_convert_fix_32_En0_to_single.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_EnDat_ABZ_addon_src_nfp_convert_fix_32_En0_to_single
-- Source Path: UZ_EnDat/UZ_ENDAT_ABZ_ADDON/nfp_convert_fix_32_En0_to_single
-- Hierarchy Level: 1
-- Model version: 3.2
-- 
...
ENTITY uz_EnDat_ABZ_addon_src_nfp_convert_fix_32_En0_to_single IS
...
END uz_EnDat_ABZ_addon_src_nfp_convert_fix_32_En0_to_single;


ARCHITECTURE rtl OF uz_EnDat_ABZ_addon_src_nfp_convert_fix_32_En0_to_single IS

  -- Signals
  SIGNAL nfp_in_unsigned                  : unsigned(31 DOWNTO 0);  -- uint32
  SIGNAL Delay_out1                       : unsigned(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL Unary_Minus_cast                 : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL Unary_Minus_cast_1               : signed(32 DOWNTO 0);  -- sfix33
  SIGNAL Unary_Minus_cast_2               : signed(32 DOWNTO 0);  -- sfix33
  SIGNAL Unary_Minus_out1                 : unsigned(31 DOWNTO 0);  -- ufix32
...
BEGIN
  ...
  CompareToZero1_out1 <= '1' WHEN Delay_out1 = to_unsigned(0, 32) ELSE
      '0';
  ...
  Unary_Minus_cast_1 <= signed(resize(Unary_Minus_cast, 33));
  Unary_Minus_cast_2 <=  - (Unary_Minus_cast_1);
  Unary_Minus_out1 <= unsigned(Unary_Minus_cast_2(31 DOWNTO 0));
