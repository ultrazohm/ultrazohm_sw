/*
 * File Name:         hdl_prj\ipcore\prediction_v1_0\include\prediction_addr.h
 * Description:       C Header File
 * Created:           2023-06-15 09:30:02
*/
...
#define  IPCore_Timestamp_prediction               0x8  //contains unique IP timestamp (yymmddHHMM): 2306150929
...
#define  ix_pred_pu_AXI_Data_prediction            0x10C  //data register for Outport ix_pred_pu_AXI
#define  iy_pred_pu_AXI_Data_prediction            0x110  //data register for Outport iy_pred_pu_AXI
...
#define  Ts_times_ZB_over_Lx_AXI_Data_prediction   0x124  //data register for Inport Ts_times_ZB_over_Lx_AXI
#define  Ts_times_ZB_over_Ly_AXI_Data_prediction   0x128  //data register for Inport Ts_times_ZB_over_Ly_AXI
