  ...
  ExtY_ControlState_t *rtControlState_Y, DW_ControlState_t *rtControlState_DW)
{
  ...
  if (!rtControlState_U->GlobalConfig_in.FrictionID) {
		/* '<S1>:709:8' finishedFrictionID_loc=uint16(1); */
  ...
  if (!rtControlState_U->GlobalConfig_in.TwoMassID) {
		/* '<S1>:709:11' finishedTwoMassID_loc=uint16(1); */
  ...
  if (!rtControlState_U->GlobalConfig_in.FluxMapID) {
		/* '<S1>:709:14' finishedFluxMapID_loc=uint16(1); */
	 ...
	 */
	/* '<S1>:709:16' if(ControlFlags.finished_all_Offline_states == 0) */
	if (!rtControlState_Y->ControlFlags.finished_all_Offline_states) {
		/* Determine path through the ElectricalID-Stateflows */
		/* '<S1>:709:18' if(GlobalConfig_in.ElectricalID==1 && enteredElectricalID==0 && finishedElectricalID_loc~=2) */
		if (rtControlState_U->GlobalConfig_in.ElectricalID && (!rtControlState_U->enteredElectricalID) && (rtControlState_DW->finishedElectricalID_loc != 2)) {
			/* '<S1>:709:19' ControlFlags.transNr=uint16(1); */
			rtControlState_Y->ControlFlags.transNr = 1U;

			/* '<S1>:709:20' finishedElectricalID_loc = uint16(0); */
			rtControlState_DW->finishedElectricalID_loc = 0U;
		}

		/* Determine path through the TwoMassID-Stateflows */
		/* '<S1>:709:24' if(GlobalConfig_in.TwoMassID==1 && enteredTwoMassID==0 && finishedElectricalID_loc~=0 && finishedTwoMassID_loc~=2) */
		if (rtControlState_U->GlobalConfig_in.TwoMassID && (!rtControlState_U->enteredTwoMassID) && (rtControlState_DW->finishedElectricalID_loc != 0)
			...
			/* '<S1>:709:25' ControlFlags.transNr=uint16(2); */
			rtControlState_Y->ControlFlags.transNr = 2U;

			/* '<S1>:709:26' finishedTwoMassID_loc = uint16(0); */
			rtControlState_DW->finishedTwoMassID_loc = 0U;
		}

		/* Determine path through the FrictionID-Stateflows */
		/* '<S1>:709:30' if(GlobalConfig_in.FrictionID==1 && enteredFrictionID==0 && finishedElectricalID_loc~=0.... */
		/* '<S1>:709:31'        && finishedTwoMassID_loc~=0 && finishedFrictionID_loc~=2) */
		if (rtControlState_U->GlobalConfig_in.FrictionID && (!rtControlState_U->enteredFrictionID) && (rtControlState_DW->finishedElectricalID_loc != 0)
		                && (rtControlState_DW->finishedTwoMassID_loc != 0) && (rtControlState_DW->finishedFrictionID_loc != 2)) {
			/* '<S1>:709:32' ControlFlags.transNr=uint16(3); */
			rtControlState_Y->ControlFlags.transNr = 3U;

			/* '<S1>:709:33' finishedFrictionID_loc = uint16(0); */
			rtControlState_DW->finishedFrictionID_loc = 0U;
		}

		/* Determine path through the FluxMapID-Stateflows */
		/* '<S1>:709:37' if(GlobalConfig_in.FluxMapID==1 && enteredFluxMapID==0 && finishedElectricalID_loc~=0.... */
		/* '<S1>:709:38'       && finishedTwoMassID_loc~=0 && finishedFrictionID_loc~=0 && finishedFluxMapID_loc~=2) */
		if (rtControlState_U->GlobalConfig_in.FluxMapID && (!rtControlState_U->enteredFluxMapID) && (rtControlState_DW->finishedElectricalID_loc != 0)
			...
			/* '<S1>:709:40' finishedFluxMapID_loc = uint16(0); */
			rtControlState_DW->finishedFluxMapID_loc = 0U;
		}
  }

	/* '<S1>:709:44' if(finishedElectricalID_loc~=0 && finishedTwoMassID_loc~=0 && .... */
	/* '<S1>:709:45'         finishedFrictionID_loc~=0 && finishedFluxMapID_loc~=0) */
    ...
    /* . */
		/* '<S1>:709:46' ControlFlags.finished_all_Offline_states = boolean(1); */
  ...
  ExtY_ControlState_t *rtControlState_Y, DW_ControlState_t *rtControlState_DW)
{
  /* MATLAB Function 'initParams': '<S1>:566' */
	/* '<S1>:566:3' finishedElectricalID_loc=uint16(0); */
	rtControlState_DW->finishedElectricalID_loc = 0U;

	/* '<S1>:566:4' finishedFrictionID_loc=uint16(0); */
	rtControlState_DW->finishedFrictionID_loc = 0U;

	/* '<S1>:566:5' finishedTwoMassID_loc=uint16(0); */
	rtControlState_DW->finishedTwoMassID_loc = 0U;

	/* '<S1>:566:6' finishedFluxMapID_loc=uint16(0); */
	rtControlState_DW->finishedFluxMapID_loc = 0U;
  ...
  /* Outport: '<Root>/ControlFlags' */
	/* '<S1>:566:14' ControlFlags.enableOnlineID              = boolean(0); */
  rtControlState_Y->ControlFlags.enableOnlineID = false;

	/* '<S1>:566:15' ControlFlags.transNr                     = uint16(0); */
  rtControlState_Y->ControlFlags.transNr = 0U;

	/* '<S1>:566:16' ControlFlags.finished_all_Offline_states = boolean(0); */
