...
set_property core_revision 2114368080 [ipx::current_core]
...
ipx::add_file {hdl/uz_endat_interface_src_sample_serial_endat_data.vhd} [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]
...
# Package IP
ipx::archive_core {../uz_endat_interface_v0_3.zip} [ipx::current_core]
close_project
exit
