-- -------------------------------------------------------------
-- 
-- File Name: /home/ts/Documents/integrate_nn_to_uz/ultrazohm_sw/ip_cores/nnAXI_v1_0/hdl_prj/hdlsrc/uz_mlp_three_layer/uz_mlp_three_layer_src_MAC1_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_mlp_three_layer_src_MAC1_block1
-- Source Path: uz_mlp_three_layer/pcu_mlp2_8parallel/reluLayer_8Parallel1/MAC1
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_mlp_three_layer_src_MAC1_block1 IS
...
END uz_mlp_three_layer_src_MAC1_block1;


ARCHITECTURE rtl OF uz_mlp_three_layer_src_MAC1_block1 IS

  -- Component Declarations
  COMPONENT uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block42
  ...
  COMPONENT uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block44
    GENERIC( AddrWidth                    : integer;
             DataWidth                    : integer
             );
    PORT( clk                             :   IN    std_logic;
  ...
  COMPONENT uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block43
    GENERIC( AddrWidth                    : integer;
             DataWidth                    : integer
             );
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block42
    USE ENTITY work.uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block42(rtl);

  FOR ALL : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block44
    USE ENTITY work.uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block44(rtl);

  FOR ALL : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block43
    USE ENTITY work.uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block43(rtl);
...
BEGIN
  u_Dual_Port_RAM_System1 : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block42
  ...
  u_Dual_Port_RAM_System3 : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block44
    GENERIC MAP( AddrWidth => 10,
                 DataWidth => 32
                 )
    PORT MAP( clk => clk,
  ...
  u_Dual_Port_RAM_System2 : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block43
    GENERIC MAP( AddrWidth => 10,
                 DataWidth => 32
                 )
    PORT MAP( clk => clk,
