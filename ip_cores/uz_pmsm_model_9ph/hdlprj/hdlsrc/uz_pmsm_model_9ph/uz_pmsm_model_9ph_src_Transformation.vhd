-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\valen\Documents\repos\UZ\ultrazohm_sw\ip_cores\uz_pmsm_model_9ph\hdlprj\hdlsrc\uz_pmsm_model_9ph\uz_pmsm_model_9ph_src_Transformation.vhd
-- Created: 2022-04-15 14:11:15
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_9ph_src_Transformation
...
ENTITY uz_pmsm_model_9ph_src_Transformation IS
...
END uz_pmsm_model_9ph_src_Transformation;


ARCHITECTURE rtl OF uz_pmsm_model_9ph_src_Transformation IS

  -- Component Declarations
  COMPONENT uz_pmsm_model_9ph_src_Transformation_MAC_block3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          in0                             :   IN    vector_of_std_logic_vector18(0 TO 8);  -- sfix18_En19 [9]
          in1                             :   IN    vector_of_std_logic_vector25(0 TO 8);  -- sfix25_En12 [9]
          globalSchedule                  :   IN    std_logic;
          out0                            :   OUT   std_logic_vector(42 DOWNTO 0)  -- sfix43_En31
          );
  END COMPONENT;

  COMPONENT uz_pmsm_model_9ph_src_nfp_convert_sfix_43_En31_to_single
    PORT( nfp_in                          :   IN    std_logic_vector(42 DOWNTO 0);  -- sfix43_En31
  ...
  COMPONENT uz_pmsm_model_9ph_src_Transformation_MAC_block4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          in0                             :   IN    vector_of_std_logic_vector18(0 TO 8);  -- sfix18_En19 [9]
  ...
  COMPONENT uz_pmsm_model_9ph_src_Transformation_MAC_block5
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          in0                             :   IN    vector_of_std_logic_vector18(0 TO 8);  -- sfix18_En19 [9]
  ...
  COMPONENT uz_pmsm_model_9ph_src_Transformation_MAC
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          in0                             :   IN    vector_of_std_logic_vector18(0 TO 8);  -- sfix18_En19 [9]
  ...
  COMPONENT uz_pmsm_model_9ph_src_Transformation_MAC_block6
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          in0                             :   IN    vector_of_std_logic_vector18(0 TO 8);  -- sfix18_En19 [9]
  ...
  COMPONENT uz_pmsm_model_9ph_src_Transformation_MAC_block7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          in0                             :   IN    vector_of_std_logic_vector18(0 TO 8);  -- sfix18_En19 [9]
  ...
  COMPONENT uz_pmsm_model_9ph_src_Transformation_MAC_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          in0                             :   IN    vector_of_std_logic_vector18(0 TO 8);  -- sfix18_En19 [9]
  ...
  COMPONENT uz_pmsm_model_9ph_src_Transformation_MAC_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          in0                             :   IN    vector_of_std_logic_vector18(0 TO 8);  -- sfix18_En19 [9]
  ...
  COMPONENT uz_pmsm_model_9ph_src_Transformation_MAC_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          in0                             :   IN    vector_of_std_logic_vector18(0 TO 8);  -- sfix18_En19 [9]
  ...
  FOR ALL : uz_pmsm_model_9ph_src_Transformation_MAC_block3
    USE ENTITY work.uz_pmsm_model_9ph_src_Transformation_MAC_block3(rtl);

  FOR ALL : uz_pmsm_model_9ph_src_nfp_convert_sfix_43_En31_to_single
    USE ENTITY work.uz_pmsm_model_9ph_src_nfp_convert_sfix_43_En31_to_single(rtl);

  FOR ALL : uz_pmsm_model_9ph_src_nfp_mul_single
    USE ENTITY work.uz_pmsm_model_9ph_src_nfp_mul_single(rtl);

  FOR ALL : uz_pmsm_model_9ph_src_Transformation_MAC_block4
    USE ENTITY work.uz_pmsm_model_9ph_src_Transformation_MAC_block4(rtl);
  ...
  FOR ALL : uz_pmsm_model_9ph_src_Transformation_MAC_block5
    USE ENTITY work.uz_pmsm_model_9ph_src_Transformation_MAC_block5(rtl);

  FOR ALL : uz_pmsm_model_9ph_src_Transformation_MAC
    USE ENTITY work.uz_pmsm_model_9ph_src_Transformation_MAC(rtl);

  FOR ALL : uz_pmsm_model_9ph_src_Transformation_MAC_block6
    USE ENTITY work.uz_pmsm_model_9ph_src_Transformation_MAC_block6(rtl);

  FOR ALL : uz_pmsm_model_9ph_src_Transformation_MAC_block7
    USE ENTITY work.uz_pmsm_model_9ph_src_Transformation_MAC_block7(rtl);

  FOR ALL : uz_pmsm_model_9ph_src_Transformation_MAC_block2
    USE ENTITY work.uz_pmsm_model_9ph_src_Transformation_MAC_block2(rtl);

  FOR ALL : uz_pmsm_model_9ph_src_Transformation_MAC_block
    USE ENTITY work.uz_pmsm_model_9ph_src_Transformation_MAC_block(rtl);

  FOR ALL : uz_pmsm_model_9ph_src_Transformation_MAC_block1
    USE ENTITY work.uz_pmsm_model_9ph_src_Transformation_MAC_block1(rtl);
  ...
  SIGNAL Constant1_out1t_0                : vector_of_signed18(0 TO 8);  -- sfix18_En19 [9]
  SIGNAL Constant1_out1t_0_1              : vector_of_std_logic_vector18(0 TO 8);  -- ufix18 [9]
  SIGNAL in_signed                        : vector_of_signed25(0 TO 8);  -- sfix25_En12 [9]
  SIGNAL Data_Type_Conversion31_out1      : vector_of_signed25(0 TO 8);  -- sfix25_En12 [9]
  SIGNAL Data_Type_Conversion31_out1_1    : vector_of_std_logic_vector25(0 TO 8);  -- ufix25 [9]
  SIGNAL enb_counter_unsigned             : unsigned(7 DOWNTO 0);  -- ufix8
  SIGNAL uz_pmsm_model_9ph_uz_pmsm_model_9ph_Transformation_enb_phase_0_8 : std_logic;
  SIGNAL MatrixMultiply_0_0               : std_logic_vector(42 DOWNTO 0);  -- ufix43
  SIGNAL nfp_out_1_1                      : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Divide_out1                      : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Constant1_out1t_1                : vector_of_signed18(0 TO 8);  -- sfix18_En19 [9]
  SIGNAL Constant1_out1t_1_1              : vector_of_std_logic_vector18(0 TO 8);  -- ufix18 [9]
  SIGNAL Data_Type_Conversion31_out1_2    : vector_of_std_logic_vector25(0 TO 8);  -- ufix25 [9]
  SIGNAL MatrixMultiply_1_0               : std_logic_vector(42 DOWNTO 0);  -- ufix43
  SIGNAL nfp_out_2_1                      : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Divide3_out1                     : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Constant1_out1t_2                : vector_of_signed18(0 TO 8);  -- sfix18_En19 [9]
  SIGNAL Constant1_out1t_2_1              : vector_of_std_logic_vector18(0 TO 8);  -- ufix18 [9]
  SIGNAL Data_Type_Conversion31_out1_3    : vector_of_std_logic_vector25(0 TO 8);  -- ufix25 [9]
  SIGNAL Constant1_out1t_3                : vector_of_signed18(0 TO 8);  -- sfix18_En19 [9]
  SIGNAL Constant1_out1t_3_1              : vector_of_std_logic_vector18(0 TO 8);  -- ufix18 [9]
  SIGNAL Data_Type_Conversion31_out1_4    : vector_of_std_logic_vector25(0 TO 8);  -- ufix25 [9]
  SIGNAL Constant1_out1t_4                : vector_of_signed18(0 TO 8);  -- sfix18_En19 [9]
  SIGNAL Constant1_out1t_4_1              : vector_of_std_logic_vector18(0 TO 8);  -- ufix18 [9]
  SIGNAL Data_Type_Conversion31_out1_5    : vector_of_std_logic_vector25(0 TO 8);  -- ufix25 [9]
  SIGNAL Constant1_out1t_5                : vector_of_signed18(0 TO 8);  -- sfix18_En19 [9]
  SIGNAL Constant1_out1t_5_1              : vector_of_std_logic_vector18(0 TO 8);  -- ufix18 [9]
  SIGNAL Data_Type_Conversion31_out1_6    : vector_of_std_logic_vector25(0 TO 8);  -- ufix25 [9]
  SIGNAL Constant1_out1t_6                : vector_of_signed18(0 TO 8);  -- sfix18_En19 [9]
  SIGNAL Constant1_out1t_6_1              : vector_of_std_logic_vector18(0 TO 8);  -- ufix18 [9]
  SIGNAL Data_Type_Conversion31_out1_7    : vector_of_std_logic_vector25(0 TO 8);  -- ufix25 [9]
  SIGNAL Constant1_out1t_7                : vector_of_signed18(0 TO 8);  -- sfix18_En19 [9]
  SIGNAL Constant1_out1t_7_1              : vector_of_std_logic_vector18(0 TO 8);  -- ufix18 [9]
  SIGNAL Data_Type_Conversion31_out1_8    : vector_of_std_logic_vector25(0 TO 8);  -- ufix25 [9]
  SIGNAL Constant1_out1t_8                : vector_of_signed18(0 TO 8);  -- sfix18_En19 [9]
  SIGNAL Constant1_out1t_8_1              : vector_of_std_logic_vector18(0 TO 8);  -- ufix18 [9]
  SIGNAL Data_Type_Conversion31_out1_9    : vector_of_std_logic_vector25(0 TO 8);  -- ufix25 [9]
  SIGNAL Divide1_out1                     : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Divide2_out1                     : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL MatrixMultiply_2_0               : std_logic_vector(42 DOWNTO 0);  -- ufix43
  SIGNAL MatrixMultiply_3_0               : std_logic_vector(42 DOWNTO 0);  -- ufix43
  SIGNAL MatrixMultiply_4_0               : std_logic_vector(42 DOWNTO 0);  -- ufix43
  SIGNAL MatrixMultiply_5_0               : std_logic_vector(42 DOWNTO 0);  -- ufix43
  SIGNAL MatrixMultiply_6_0               : std_logic_vector(42 DOWNTO 0);  -- ufix43
  SIGNAL MatrixMultiply_7_0               : std_logic_vector(42 DOWNTO 0);  -- ufix43
  SIGNAL MatrixMultiply_8_0               : std_logic_vector(42 DOWNTO 0);  -- ufix43
  SIGNAL Mux_out1                         : vector_of_std_logic_vector32(0 TO 8);  -- ufix32 [9]

BEGIN
  u_Transformation_MAC4 : uz_pmsm_model_9ph_src_Transformation_MAC_block3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              in0 => Constant1_out1t_0_1,  -- sfix18_En19 [9]
              in1 => Data_Type_Conversion31_out1_1,  -- sfix25_En12 [9]
              globalSchedule => uz_pmsm_model_9ph_uz_pmsm_model_9ph_Transformation_enb_phase_0_8,
              out0 => MatrixMultiply_0_0  -- sfix43_En31
              );

  u_uz_pmsm_model_9ph_uz_pmsm_model_9ph_Transformation_nfp_convert_sfix_43_En31_to_single : uz_pmsm_model_9ph_src_nfp_convert_sfix_43_En31_to_single
    PORT MAP( nfp_in => MatrixMultiply_0_0,  -- sfix43_En31
  ...
  u_Transformation_MAC5 : uz_pmsm_model_9ph_src_Transformation_MAC_block4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              in0 => Constant1_out1t_1_1,  -- sfix18_En19 [9]
              in1 => Data_Type_Conversion31_out1_2,  -- sfix25_En12 [9]
              globalSchedule => uz_pmsm_model_9ph_uz_pmsm_model_9ph_Transformation_enb_phase_0_8,
              out0 => MatrixMultiply_1_0  -- sfix43_En31
              );

  u_uz_pmsm_model_9ph_uz_pmsm_model_9ph_Transformation_nfp_convert_sfix_43_En31_to_single_1 : uz_pmsm_model_9ph_src_nfp_convert_sfix_43_En31_to_single
    PORT MAP( nfp_in => MatrixMultiply_1_0,  -- sfix43_En31
  ...
  u_nfp_sub_comp : uz_pmsm_model_9ph_src_nfp_sub_single
    PORT MAP( nfp_in1 => Divide3_out1,  -- single
              nfp_in2 => Divide2_out1,  -- single
              nfp_out => Mux_out1(1)  -- single
              );

  u_Transformation_MAC6 : uz_pmsm_model_9ph_src_Transformation_MAC_block5
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              in0 => Constant1_out1t_2_1,  -- sfix18_En19 [9]
              in1 => Data_Type_Conversion31_out1_3,  -- sfix25_En12 [9]
              globalSchedule => uz_pmsm_model_9ph_uz_pmsm_model_9ph_Transformation_enb_phase_0_8,
              out0 => MatrixMultiply_2_0  -- sfix43_En31
              );

  u_uz_pmsm_model_9ph_uz_pmsm_model_9ph_Transformation_nfp_convert_sfix_43_En31_to_single_2 : uz_pmsm_model_9ph_src_nfp_convert_sfix_43_En31_to_single
    PORT MAP( nfp_in => MatrixMultiply_2_0,  -- sfix43_En31
              nfp_out => Mux_out1(2)  -- single
              );

  u_Transformation_MAC : uz_pmsm_model_9ph_src_Transformation_MAC
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              in0 => Constant1_out1t_3_1,  -- sfix18_En19 [9]
              in1 => Data_Type_Conversion31_out1_4,  -- sfix25_En12 [9]
              globalSchedule => uz_pmsm_model_9ph_uz_pmsm_model_9ph_Transformation_enb_phase_0_8,
              out0 => MatrixMultiply_3_0  -- sfix43_En31
              );

  u_uz_pmsm_model_9ph_uz_pmsm_model_9ph_Transformation_nfp_convert_sfix_43_En31_to_single_3 : uz_pmsm_model_9ph_src_nfp_convert_sfix_43_En31_to_single
    PORT MAP( nfp_in => MatrixMultiply_3_0,  -- sfix43_En31
              nfp_out => Mux_out1(3)  -- single
              );

  u_Transformation_MAC7 : uz_pmsm_model_9ph_src_Transformation_MAC_block6
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              in0 => Constant1_out1t_4_1,  -- sfix18_En19 [9]
              in1 => Data_Type_Conversion31_out1_5,  -- sfix25_En12 [9]
              globalSchedule => uz_pmsm_model_9ph_uz_pmsm_model_9ph_Transformation_enb_phase_0_8,
              out0 => MatrixMultiply_4_0  -- sfix43_En31
              );

  u_uz_pmsm_model_9ph_uz_pmsm_model_9ph_Transformation_nfp_convert_sfix_43_En31_to_single_4 : uz_pmsm_model_9ph_src_nfp_convert_sfix_43_En31_to_single
    PORT MAP( nfp_in => MatrixMultiply_4_0,  -- sfix43_En31
              nfp_out => Mux_out1(4)  -- single
              );

  u_Transformation_MAC8 : uz_pmsm_model_9ph_src_Transformation_MAC_block7
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              in0 => Constant1_out1t_5_1,  -- sfix18_En19 [9]
              in1 => Data_Type_Conversion31_out1_6,  -- sfix25_En12 [9]
              globalSchedule => uz_pmsm_model_9ph_uz_pmsm_model_9ph_Transformation_enb_phase_0_8,
              out0 => MatrixMultiply_5_0  -- sfix43_En31
              );

  u_uz_pmsm_model_9ph_uz_pmsm_model_9ph_Transformation_nfp_convert_sfix_43_En31_to_single_5 : uz_pmsm_model_9ph_src_nfp_convert_sfix_43_En31_to_single
    PORT MAP( nfp_in => MatrixMultiply_5_0,  -- sfix43_En31
              nfp_out => Mux_out1(5)  -- single
              );

  u_Transformation_MAC3 : uz_pmsm_model_9ph_src_Transformation_MAC_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              in0 => Constant1_out1t_6_1,  -- sfix18_En19 [9]
              in1 => Data_Type_Conversion31_out1_7,  -- sfix25_En12 [9]
              globalSchedule => uz_pmsm_model_9ph_uz_pmsm_model_9ph_Transformation_enb_phase_0_8,
              out0 => MatrixMultiply_6_0  -- sfix43_En31
              );

  u_uz_pmsm_model_9ph_uz_pmsm_model_9ph_Transformation_nfp_convert_sfix_43_En31_to_single_6 : uz_pmsm_model_9ph_src_nfp_convert_sfix_43_En31_to_single
    PORT MAP( nfp_in => MatrixMultiply_6_0,  -- sfix43_En31
              nfp_out => Mux_out1(6)  -- single
              );

  u_Transformation_MAC1 : uz_pmsm_model_9ph_src_Transformation_MAC_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              in0 => Constant1_out1t_7_1,  -- sfix18_En19 [9]
              in1 => Data_Type_Conversion31_out1_8,  -- sfix25_En12 [9]
              globalSchedule => uz_pmsm_model_9ph_uz_pmsm_model_9ph_Transformation_enb_phase_0_8,
              out0 => MatrixMultiply_7_0  -- sfix43_En31
              );

  u_uz_pmsm_model_9ph_uz_pmsm_model_9ph_Transformation_nfp_convert_sfix_43_En31_to_single_7 : uz_pmsm_model_9ph_src_nfp_convert_sfix_43_En31_to_single
    PORT MAP( nfp_in => MatrixMultiply_7_0,  -- sfix43_En31
              nfp_out => Mux_out1(7)  -- single
              );

  u_Transformation_MAC2 : uz_pmsm_model_9ph_src_Transformation_MAC_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              in0 => Constant1_out1t_8_1,  -- sfix18_En19 [9]
              in1 => Data_Type_Conversion31_out1_9,  -- sfix25_En12 [9]
              globalSchedule => uz_pmsm_model_9ph_uz_pmsm_model_9ph_Transformation_enb_phase_0_8,
              out0 => MatrixMultiply_8_0  -- sfix43_En31
              );

  u_uz_pmsm_model_9ph_uz_pmsm_model_9ph_Transformation_nfp_convert_sfix_43_En31_to_single_8 : uz_pmsm_model_9ph_src_nfp_convert_sfix_43_En31_to_single
    PORT MAP( nfp_in => MatrixMultiply_8_0,  -- sfix43_En31
  ...
  Data_Type_Conversion31_out1(0) <= in_signed(0);
  Data_Type_Conversion31_out1(1) <= in_signed(1);
  Data_Type_Conversion31_out1(2) <= in_signed(2);
  Data_Type_Conversion31_out1(3) <= in_signed(3);
  Data_Type_Conversion31_out1(4) <= in_signed(4);
  Data_Type_Conversion31_out1(5) <= in_signed(5);
  Data_Type_Conversion31_out1(6) <= in_signed(6);
  Data_Type_Conversion31_out1(7) <= in_signed(7);
  Data_Type_Conversion31_out1(8) <= in_signed(8);

  outputgen16: FOR k IN 0 TO 8 GENERATE
    Data_Type_Conversion31_out1_1(k) <= std_logic_vector(Data_Type_Conversion31_out1(k));
  END GENERATE;

  enb_counter_unsigned <= unsigned(enb_counter);

  
  uz_pmsm_model_9ph_uz_pmsm_model_9ph_Transformation_enb_phase_0_8 <= '1' WHEN enb_counter_unsigned <= to_unsigned(16#08#, 8) ELSE
      '0';
  ...
  outputgen14: FOR k IN 0 TO 8 GENERATE
    Data_Type_Conversion31_out1_2(k) <= std_logic_vector(Data_Type_Conversion31_out1(k));
  END GENERATE;
  ...
  outputgen12: FOR k IN 0 TO 8 GENERATE
    Data_Type_Conversion31_out1_3(k) <= std_logic_vector(Data_Type_Conversion31_out1(k));
  END GENERATE;
  ...
  outputgen10: FOR k IN 0 TO 8 GENERATE
    Data_Type_Conversion31_out1_4(k) <= std_logic_vector(Data_Type_Conversion31_out1(k));
  END GENERATE;
  ...
  outputgen8: FOR k IN 0 TO 8 GENERATE
    Data_Type_Conversion31_out1_5(k) <= std_logic_vector(Data_Type_Conversion31_out1(k));
  END GENERATE;
  ...
  outputgen6: FOR k IN 0 TO 8 GENERATE
    Data_Type_Conversion31_out1_6(k) <= std_logic_vector(Data_Type_Conversion31_out1(k));
  END GENERATE;
  ...
  outputgen4: FOR k IN 0 TO 8 GENERATE
    Data_Type_Conversion31_out1_7(k) <= std_logic_vector(Data_Type_Conversion31_out1(k));
  END GENERATE;
  ...
  outputgen2: FOR k IN 0 TO 8 GENERATE
    Data_Type_Conversion31_out1_8(k) <= std_logic_vector(Data_Type_Conversion31_out1(k));
  END GENERATE;
  ...
  outputgen: FOR k IN 0 TO 8 GENERATE
    Data_Type_Conversion31_out1_9(k) <= std_logic_vector(Data_Type_Conversion31_out1(k));
  END GENERATE;
