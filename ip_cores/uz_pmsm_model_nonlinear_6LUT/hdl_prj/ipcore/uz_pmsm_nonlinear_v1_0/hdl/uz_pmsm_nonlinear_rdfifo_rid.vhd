-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\Philipp\ultrazohm\ultrazohm_sw\ip_cores\uz_pmsm_model_nonlinear_6LUT\hdl_prj\hdlsrc\uz_pmsm_model_6LUT_pd\uz_pmsm_nonlinear_rdfifo_rid.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_nonlinear_rdfifo_rid
-- Source Path: uz_pmsm_nonlinear/uz_pmsm_nonlinear_axi4/uz_pmsm_nonlinear_axi4_module/uz_pmsm_nonlinear_rdfifo_rid
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_pmsm_nonlinear_rdfifo_rid IS
...
END uz_pmsm_nonlinear_rdfifo_rid;


ARCHITECTURE rtl OF uz_pmsm_nonlinear_rdfifo_rid IS
...
BEGIN
  ...
  u_uz_pmsm_nonlinear_rdfifo_rid_classic_ram : uz_pmsm_nonlinear_SimpleDualPortRAM_generic
