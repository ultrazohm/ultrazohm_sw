-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\Philipp\ultrazohm\ultrazohm_sw\ip_cores\uz_pmsm_model_nonlinear_6LUT\hdl_prj\hdlsrc\uz_pmsm_model_6LUT_pd\uz_pmsm_nonlinear_src_nfp_uminus_single.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_nonlinear_src_nfp_uminus_single
-- Source Path: uz_pmsm_model_6LUT_pd/uz_pmsm_model_nonlinear/nfp_uminus_single
-- Hierarchy Level: 1
-- Model version: 7.30
-- 
-- -------------------------------------------------------------
...
ENTITY uz_pmsm_nonlinear_src_nfp_uminus_single IS
  PORT( nfp_in                            :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_out                           :   OUT   std_logic_vector(31 DOWNTO 0)  -- ufix32
        );
END uz_pmsm_nonlinear_src_nfp_uminus_single;


ARCHITECTURE rtl OF uz_pmsm_nonlinear_src_nfp_uminus_single IS
