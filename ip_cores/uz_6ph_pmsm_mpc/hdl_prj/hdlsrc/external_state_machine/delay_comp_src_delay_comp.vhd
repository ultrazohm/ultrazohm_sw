-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\external_state_machine\delay_comp_src_delay_comp.vhd
-- Created: 2023-07-20 18:52:46
-- 
...
-- ix_delay_pu                   ce_out        1e-08
-- iy_delay_pu                   ce_out        1e-08
-- id_delay_pu_AXI               ce_out        1e-08
-- iq_delay_pu_AXI               ce_out        1e-08
-- ix_delay_pu_AXI               ce_out        1e-08
-- iy_delay_pu_AXI               ce_out        1e-08
...
-- -------------------------------------------------------------
-- 
-- Module: delay_comp_src_delay_comp
-- Source Path: external_state_machine/delay_comp
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
USE work.delay_comp_src_delay_comp_pkg.ALL;

ENTITY delay_comp_src_delay_comp IS
...
END delay_comp_src_delay_comp;


ARCHITECTURE rtl OF delay_comp_src_delay_comp IS

  -- Component Declarations
  COMPONENT delay_comp_src_Detect_Rise_Positive1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  COMPONENT delay_comp_src_Detect_Rise_Positive
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  FOR ALL : delay_comp_src_Detect_Rise_Positive1
    USE ENTITY work.delay_comp_src_Detect_Rise_Positive1(rtl);

  FOR ALL : delay_comp_src_Detect_Rise_Positive
    USE ENTITY work.delay_comp_src_Detect_Rise_Positive(rtl);
  ...
  SIGNAL Ts_times_ZB_over_Ld_1            : signed(17 DOWNTO 0);  -- sfix18_En15
  ...
  SIGNAL Delay20_reg                      : vector_of_signed18(0 TO 1);  -- sfix18 [2]
  ...
  SIGNAL Delay23_reg                      : vector_of_signed27(0 TO 1);  -- sfix27 [2]
  ...
  SIGNAL Delay24_reg                      : vector_of_signed18(0 TO 1);  -- sfix18 [2]
  ...
  SIGNAL Switch7_out1                     : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL Switch7_out1_1                   : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL Switch7_out1_2                   : signed(26 DOWNTO 0);  -- sfix27_En24
  ...
  SIGNAL Rs_over_ZB_4                     : signed(17 DOWNTO 0);  -- sfix18_En15
  ...
  SIGNAL Switch8_out1                     : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL Switch8_out1_1                   : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL Switch8_out1_2                   : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL Delay11_reg                      : std_logic_vector(0 TO 1);  -- ufix1 [2]
  SIGNAL Delay11_out1                     : std_logic;
  SIGNAL switch_compare_1_22              : std_logic;
  SIGNAL Switch9_out1                     : signed(17 DOWNTO 0);  -- sfix18_En15
  SIGNAL Switch9_out1_1                   : signed(17 DOWNTO 0);  -- sfix18_En15
  SIGNAL Switch9_out1_2                   : signed(17 DOWNTO 0);  -- sfix18_En15
  SIGNAL switch_compare_1_23              : std_logic;
  SIGNAL Switch10_out1                    : signed(17 DOWNTO 0);  -- sfix18_En15
  SIGNAL Switch10_out1_1                  : signed(17 DOWNTO 0);  -- sfix18_En15
  SIGNAL Switch10_out1_2                  : signed(17 DOWNTO 0);  -- sfix18_En15
...
BEGIN
  ...
  u_Detect_Rise_Positive1 : delay_comp_src_Detect_Rise_Positive1
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              U => Delay50_out1,
  ...
  u_Detect_Rise_Positive : delay_comp_src_Detect_Rise_Positive
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              U => Delay_out1,
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay49_reg(0) <= delay_comp_done_1;
  ...
  switch_compare_1_2 <= '1' WHEN delay_comp_done_1 > '0' ELSE
      '0';
  ...
  Switch28_out1 <= Delay57_out1 WHEN switch_compare_1_2 = '0' ELSE
      Delay59_out1;
  ...
  switch_compare_1_11 <= '1' WHEN delay_comp_done_1 > '0' ELSE
      '0';
  ...
  Switch15_out1 <= Delay32_out1 WHEN switch_compare_1_15 = '0' ELSE
      Delay31_out1;

  
  switch_compare_1_16 <= '1' WHEN delay_comp_done_1 > '0' ELSE
      '0';
  ...
  Switch30_out1 <= Delay70_out1 WHEN switch_compare_1_16 = '0' ELSE
      Delay71_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay23_reg <= (OTHERS => to_signed(16#0000000#, 27));
      ELSIF enb = '1' THEN
        Delay23_reg(0) <= vx_pu_1;
  ...
  Switch2_out1 <= Delay7_out1 WHEN switch_compare_1_17 = '0' ELSE
      Delay6_out1;

  ix_k_pu <= Switch2_out1;

  Product12_mul_temp <= Rs_over_ZB_3 * ix_k_pu;
  ...
  Switch7_out1_1 <= Switch7_out1 WHEN switch_compare_1_14 = '0' ELSE
      Add5_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Switch7_out1 <= to_signed(16#0000000#, 27);
      ELSIF enb = '1' THEN
        Switch7_out1 <= Switch7_out1_1;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Switch7_out1_2 <= to_signed(16#0000000#, 27);
      ELSIF enb = '1' THEN
        Switch7_out1_2 <= Switch7_out1;
      END IF;
    END IF;
  END PROCESS reduced_5_process;


  ix_delay_pu <= std_logic_vector(Switch7_out1_2);

  
  switch_compare_1_18 <= '1' WHEN Delay49_out1 > '0' ELSE
      '0';
  ...
  Switch16_out1 <= Delay34_out1 WHEN switch_compare_1_19 = '0' ELSE
      Delay33_out1;

  
  switch_compare_1_20 <= '1' WHEN delay_comp_done_1 > '0' ELSE
      '0';
  ...
  Switch31_out1 <= Delay72_out1 WHEN switch_compare_1_20 = '0' ELSE
      Delay73_out1;
  ...
  Switch3_out1 <= Delay9_out1 WHEN switch_compare_1_21 = '0' ELSE
      Delay8_out1;

  iy_k_pu <= Switch3_out1;

  Product14_mul_temp <= Rs_over_ZB_4 * iy_k_pu;
  ...
  Switch8_out1_1 <= Switch8_out1 WHEN switch_compare_1_18 = '0' ELSE
      Add7_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Switch8_out1 <= to_signed(16#0000000#, 27);
      ELSIF enb = '1' THEN
        Switch8_out1 <= Switch8_out1_1;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Switch8_out1_2 <= to_signed(16#0000000#, 27);
      ELSIF enb = '1' THEN
        Switch8_out1_2 <= Switch8_out1;
      END IF;
    END IF;
  END PROCESS reduced_7_process;


  iy_delay_pu <= std_logic_vector(Switch8_out1_2);

  id_delay_pu_AXI <= std_logic_vector(Switch4_out1_2);

  iq_delay_pu_AXI <= std_logic_vector(Switch6_out1_2);

  ix_delay_pu_AXI <= std_logic_vector(Switch7_out1_2);

  iy_delay_pu_AXI <= std_logic_vector(Switch8_out1_2);
  ...
  switch_compare_1_22 <= '1' WHEN Delay49_out1 > '0' ELSE
      '0';

  
  Switch9_out1_1 <= Switch9_out1 WHEN switch_compare_1_22 = '0' ELSE
      Switch12_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Switch9_out1 <= to_signed(16#00000#, 18);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Switch9_out1_2 <= to_signed(16#00000#, 18);
      ELSIF enb = '1' THEN
  ...
  switch_compare_1_23 <= '1' WHEN Delay49_out1 > '0' ELSE
      '0';

  
  Switch10_out1_1 <= Switch10_out1 WHEN switch_compare_1_23 = '0' ELSE
      Switch13_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Switch10_out1 <= to_signed(16#00000#, 18);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Switch10_out1_2 <= to_signed(16#00000#, 18);
      ELSIF enb = '1' THEN
