...
psid_cross_s1 = repmat(psid_cross_s1, 33, 1);
psiq_cross_s1 = repmat(psiq_cross_s1, 1, 9);
...
psidself_padded = repmat(Fluxd_iqnull_fitted, 33, 1);
psiqself_padded = repmat(Fluxq_idnull_fitted, 1, 9);
