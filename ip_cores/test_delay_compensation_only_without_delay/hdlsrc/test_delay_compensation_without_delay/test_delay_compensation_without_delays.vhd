-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\test_delay_compensation_only_without_delay\hdlsrc\test_delay_compensation_without_delay\test_delay_compensation_without_delays.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: test_delay_compensation_without_delays
-- Source Path: test_delay_compensation_without_delays
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY test_delay_compensation_without_delays IS
...
END test_delay_compensation_without_delays;


ARCHITECTURE rtl OF test_delay_compensation_without_delays IS

  -- Component Declarations
  COMPONENT test_delay_compensation_without_delays_reset_sync
  ...
  COMPONENT test_delay_compensation_without_delays_axi_lite
  ...
  COMPONENT test_delay_compensation_without_delays_dut
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
  ...
  FOR ALL : test_delay_compensation_without_delays_reset_sync
    USE ENTITY work.test_delay_compensation_without_delays_reset_sync(rtl);

  FOR ALL : test_delay_compensation_without_delays_axi_lite
    USE ENTITY work.test_delay_compensation_without_delays_axi_lite(rtl);

  FOR ALL : test_delay_compensation_without_delays_dut
    USE ENTITY work.test_delay_compensation_without_delays_dut(rtl);
...
BEGIN
  u_test_delay_compensation_without_delays_reset_sync_inst : test_delay_compensation_without_delays_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_test_delay_compensation_without_delays_axi_lite_inst : test_delay_compensation_without_delays_axi_lite
  ...
  u_test_delay_compensation_without_delays_dut_inst : test_delay_compensation_without_delays_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  ip_timestamp <= unsigned'(X"83BC1363");
