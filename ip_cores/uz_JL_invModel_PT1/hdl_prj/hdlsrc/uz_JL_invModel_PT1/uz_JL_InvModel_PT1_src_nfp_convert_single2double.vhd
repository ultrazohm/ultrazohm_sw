-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\jonat\Documents\MA_JL_CIL\ip_cores\uz_JL_invModel_PT1\hdl_prj\hdlsrc\uz_JL_invModel_PT1\uz_JL_InvModel_PT1_src_nfp_convert_single2double.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_JL_InvModel_PT1_src_nfp_convert_single2double
-- Source Path: uz_JL_invModel_PT1/HDL_DUT/nfp_convert_single2double
-- Hierarchy Level: 1
-- Model version: 1.37
-- 
...
ENTITY uz_JL_InvModel_PT1_src_nfp_convert_single2double IS
...
END uz_JL_InvModel_PT1_src_nfp_convert_single2double;


ARCHITECTURE rtl OF uz_JL_InvModel_PT1_src_nfp_convert_single2double IS
  ...
  SIGNAL Delay12_PS_2_4_reg               : std_logic_vector(3 DOWNTO 0);  -- ufix1 [4]
  ...
  SIGNAL Delay13_PS_2_4_reg               : std_logic_vector(2 DOWNTO 0);  -- ufix1 [3]
  ...
  SIGNAL Delay14_PS_2_4_reg               : std_logic_vector(2 DOWNTO 0);  -- ufix1 [3]
  ...
  SIGNAL Delay24_PS_4_out1                : unsigned(10 DOWNTO 0);  -- ufix11
  ...
  SIGNAL Delay5_PS_5_out1                 : unsigned(10 DOWNTO 0);  -- ufix11
  ...
  SIGNAL Delay23_PS_4_out1                : unsigned(51 DOWNTO 0);  -- ufix52
  ...
  SIGNAL Delay22_PS_4_reg                 : vector_of_unsigned52(0 TO 1);  -- ufix52 [2]
  SIGNAL Delay22_PS_4_out1                : unsigned(51 DOWNTO 0);  -- ufix52
  ...
  SIGNAL Delay4_PS_5_out1                 : unsigned(51 DOWNTO 0);  -- ufix52
...
BEGIN
  ...
  Constant7_out1 <= to_unsigned(16#03#, 6);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay12_PS_2_4_reg <= (OTHERS => '0');
      ELSIF enb = '1' THEN
        Delay12_PS_2_4_reg(0) <= inSign;
        Delay12_PS_2_4_reg(3 DOWNTO 1) <= Delay12_PS_2_4_reg(2 DOWNTO 0);
      END IF;
    END IF;
  END PROCESS Delay12_PS_2_4_process;

  Delay12_PS_2_4_out1 <= Delay12_PS_2_4_reg(3);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay13_PS_2_4_reg <= (OTHERS => '0');
      ELSIF enb = '1' THEN
        Delay13_PS_2_4_reg(0) <= inExponent_inType_Exponent_out1;
        Delay13_PS_2_4_reg(2 DOWNTO 1) <= Delay13_PS_2_4_reg(1 DOWNTO 0);
      END IF;
    END IF;
  END PROCESS Delay13_PS_2_4_process;

  Delay13_PS_2_4_out1 <= Delay13_PS_2_4_reg(2);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay14_PS_2_4_reg <= (OTHERS => '0');
      ELSIF enb = '1' THEN
        Delay14_PS_2_4_reg(0) <= alpha_inExponent_0_inMantis_out1;
        Delay14_PS_2_4_reg(2 DOWNTO 1) <= Delay14_PS_2_4_reg(1 DOWNTO 0);
      END IF;
    END IF;
  END PROCESS Delay14_PS_2_4_process;

  Delay14_PS_2_4_out1 <= Delay14_PS_2_4_reg(2);
  ...
  Delay24_PS_4_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay24_PS_4_out1 <= to_unsigned(16#000#, 11);
      ELSIF enb = '1' THEN
        Delay24_PS_4_out1 <= e_int32_shift_length_out1;
      END IF;
    END IF;
  END PROCESS Delay24_PS_4_process;


  C11_out1 <= to_unsigned(16#000#, 11);

  
  if_inExponent_0_inMantis_Exponent_out1 <= Delay24_PS_4_out1 WHEN Delay14_PS_2_4_out1 = '0' ELSE
      C11_out1;
  ...
  Delay5_PS_5_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay5_PS_5_out1 <= to_unsigned(16#000#, 11);
      ELSIF enb = '1' THEN
        Delay5_PS_5_out1 <= Switch5_out1;
      END IF;
    END IF;
  ...
  Delay23_PS_4_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay23_PS_4_out1 <= to_unsigned(0, 52);
      ELSIF enb = '1' THEN
        Delay23_PS_4_out1 <= Bit_Slice_out1;
      END IF;
    END IF;
  END PROCESS Delay23_PS_4_process;


  C13_out1 <= to_unsigned(0, 52);

  
  if_inExponent_0_inMantis_Mantissa_out1 <= Delay23_PS_4_out1 WHEN Delay14_PS_2_4_out1 = '0' ELSE
      C13_out1;
  ...
  Delay22_PS_4_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay22_PS_4_reg <= (OTHERS => to_unsigned(0, 52));
      ELSIF enb = '1' THEN
        Delay22_PS_4_reg(0) <= Bit_Concat1_out1_1;
        Delay22_PS_4_reg(1) <= Delay22_PS_4_reg(0);
      END IF;
    END IF;
  END PROCESS Delay22_PS_4_process;

  Delay22_PS_4_out1 <= Delay22_PS_4_reg(1);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay4_PS_5_out1 <= to_unsigned(0, 52);
      ELSIF enb = '1' THEN
  ...
  nfp_out_pack <= Delay3_PS_5_out1 & Delay5_PS_5_out1 & Delay4_PS_5_out1;
