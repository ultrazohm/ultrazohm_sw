-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\valen\Documents\repos\UZ\ultrazohm_sw_pr\ip_cores\uz_pmsm_model_6ph_dq\hdl_prj\hdlsrc\uz_pmsm_model_6ph_dq\uz_pmsm_model_6ph_dq_src_uz_pmsm_model_6ph_dq.vhd
-- Created: 2022-12-21 11:20:01
-- 
...
BEGIN
  ...
  u_uz_pmsm_model_6ph_dq_uz_pmsm_model_6ph_dq_nfp_convert_single_to_sfix_24_En11 : uz_pmsm_model_6ph_dq_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in => Data_Type_Conversion4_out1_2,  -- single
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_100_1 = '1' THEN
        Delay2_bypass_reg <= Data_Type_Conversion4_out1_1;
      END IF;
    END IF;
  ...
  Data_Type_Conversion3_out1_3(5) <= Data_Type_Conversion3_out1_2(5) WHEN enb_1_100_1 = '1' ELSE
      t2_bypass_reg(5);
  t2_bypass_reg_next(0) <= Data_Type_Conversion3_out1_2(0);
  t2_bypass_reg_next(1) <= Data_Type_Conversion3_out1_2(1);
  t2_bypass_reg_next(2) <= Data_Type_Conversion3_out1_2(2);
  t2_bypass_reg_next(3) <= Data_Type_Conversion3_out1_2(3);
  t2_bypass_reg_next(4) <= Data_Type_Conversion3_out1_2(4);
  t2_bypass_reg_next(5) <= Data_Type_Conversion3_out1_2(5);
  ...
  Data_Type_Conversion8_out1_2(5) <= Data_Type_Conversion8_out1_1(5) WHEN enb_1_100_1 = '1' ELSE
      t6_bypass_reg(5);
  t6_bypass_reg_next(0) <= Data_Type_Conversion8_out1_1(0);
  t6_bypass_reg_next(1) <= Data_Type_Conversion8_out1_1(1);
  t6_bypass_reg_next(2) <= Data_Type_Conversion8_out1_1(2);
  t6_bypass_reg_next(3) <= Data_Type_Conversion8_out1_1(3);
  t6_bypass_reg_next(4) <= Data_Type_Conversion8_out1_1(4);
  t6_bypass_reg_next(5) <= Data_Type_Conversion8_out1_1(5);
