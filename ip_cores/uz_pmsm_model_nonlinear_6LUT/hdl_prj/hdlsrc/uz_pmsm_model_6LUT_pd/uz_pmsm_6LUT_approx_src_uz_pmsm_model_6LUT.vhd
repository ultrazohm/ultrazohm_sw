...
-- -------------------------------------------------------------
-- Model base rate: 2.5e-09
-- Target subsystem base rate: 2.5e-09
...
ARCHITECTURE rtl OF uz_pmsm_6LUT_approx_src_uz_pmsm_model_6LUT IS
  ...
  COMPONENT uz_pmsm_6LUT_approx_src_nfp_gain_pow2_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          nfp_in1                         :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  FOR ALL : uz_pmsm_6LUT_approx_src_nfp_gain_pow2_single
    USE ENTITY work.uz_pmsm_6LUT_approx_src_nfp_gain_pow2_single(rtl);
  ...
  SIGNAL delayMatch_reg                   : std_logic_vector(96 DOWNTO 0);  -- ufix1 [97]
  ...
  SIGNAL Delay1_lowered_bypass_reg_1      : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL Delay1_lowered_bypass_reg_2      : std_logic_vector(31 DOWNTO 0);  -- ufix32
...
BEGIN
  ...
  u_nfp_recip_comp_1 : uz_pmsm_6LUT_approx_src_nfp_recip_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_recip_comp_2 : uz_pmsm_6LUT_approx_src_nfp_recip_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_recip_comp_3 : uz_pmsm_6LUT_approx_src_nfp_recip_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_recip_comp_4 : uz_pmsm_6LUT_approx_src_nfp_recip_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  -- mul #2
  u_nfp_gain_pow2_single : uz_pmsm_6LUT_approx_src_nfp_gain_pow2_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        delayMatch_reg(96 DOWNTO 1) <= delayMatch_reg(95 DOWNTO 0);
      END IF;
    END IF;
  END PROCESS delayMatch_15_process;

  Switch1_out1_timer_1 <= delayMatch_reg(96);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay1_lowered_bypass_reg_1 <= X"00000000";
      ELSIF enb_1_200_1 = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay1_lowered_bypass_reg_2 <= X"00000000";
      ELSIF enb_1_200_1 = '1' THEN
