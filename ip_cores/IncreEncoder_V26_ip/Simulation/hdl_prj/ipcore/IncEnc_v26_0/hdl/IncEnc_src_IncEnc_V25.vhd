-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\inc_enc_v26\IncEnc_src_IncEnc_V25.vhd
-- Created: 2023-02-22 15:54:24
-- 
...
-- position_AXI_wOffset          ce_out        1e-08
...
ENTITY IncEnc_src_IncEnc_V25 IS
  PORT( clk                               :   IN    std_logic;
        ...
        position_AXI_wOffset              :   OUT   std_logic_vector(15 DOWNTO 0);  -- uint16
        Index_found                       :   OUT   std_logic;
        Index_found_AXI4                  :   OUT   std_logic;
        d_Axis_Hit                        :   OUT   std_logic
        );
END IncEnc_src_IncEnc_V25;


ARCHITECTURE rtl OF IncEnc_src_IncEnc_V25 IS

  -- Component Declarations
  COMPONENT IncEnc_src_Direction
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
  ...
  COMPONENT IncEnc_src_Counter_Theta_el_wOffset
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_5987_0                    :   IN    std_logic;
  ...
  COMPONENT IncEnc_src_Counter_position
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_5987_0                    :   IN    std_logic;
          Edge_rsvd                       :   IN    std_logic_vector(7 DOWNTO 0);  -- int8
  ...
  COMPONENT IncEnc_src_count_lines
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_5987_0                    :   IN    std_logic;
          Edge_rsvd                       :   IN    std_logic_vector(7 DOWNTO 0);  -- int8
  ...
  COMPONENT IncEnc_src_Index_Latch
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_5987_0                    :   IN    std_logic;
  ...
  COMPONENT IncEnc_src_Check_d_Axis_Hit
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_5987_0                    :   IN    std_logic;
  ...
  FOR ALL : IncEnc_src_Direction
    USE ENTITY work.IncEnc_src_Direction(rtl);

  FOR ALL : IncEnc_src_speed
    USE ENTITY work.IncEnc_src_speed(rtl);

  FOR ALL : IncEnc_src_Counter
    USE ENTITY work.IncEnc_src_Counter(rtl);

  FOR ALL : IncEnc_src_Counter_Theta_el_wOffset
    USE ENTITY work.IncEnc_src_Counter_Theta_el_wOffset(rtl);

  FOR ALL : IncEnc_src_Counter_position
    USE ENTITY work.IncEnc_src_Counter_position(rtl);

  FOR ALL : IncEnc_src_count_lines
    USE ENTITY work.IncEnc_src_count_lines(rtl);

  FOR ALL : IncEnc_src_Index_Latch
    USE ENTITY work.IncEnc_src_Index_Latch(rtl);

  FOR ALL : IncEnc_src_Check_d_Axis_Hit
    USE ENTITY work.IncEnc_src_Check_d_Axis_Hit(rtl);
...
BEGIN
  ...
  u_Direction : IncEnc_src_Direction
    PORT MAP( clk => clk,
              reset_x => reset_x,
  ...
  u_Counter_Theta_el_wOffset : IncEnc_src_Counter_Theta_el_wOffset
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_5987_0 => clk_enable,
              Edge_rsvd => Counter_out1,  -- int8
  ...
  u_Counter_position : IncEnc_src_Counter_position
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_5987_0 => clk_enable,
              Edge_rsvd => Counter_out1,  -- int8
  ...
  u_count_lines : IncEnc_src_count_lines
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_5987_0 => clk_enable,
              Edge_rsvd => Counter_out1,  -- int8
  ...
  u_Counter_position_wOffset : IncEnc_src_Counter_Theta_el_wOffset
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_5987_0 => clk_enable,
              Edge_rsvd => Counter_out1,  -- int8
  ...
  u_Index_Latch : IncEnc_src_Index_Latch
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_5987_0 => clk_enable,
  ...
  u_Check_d_Axis_Hit : IncEnc_src_Check_d_Axis_Hit
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_5987_0 => clk_enable,
  ...
  position_AXI_wOffset <= std_logic_vector(position_w_offset);
