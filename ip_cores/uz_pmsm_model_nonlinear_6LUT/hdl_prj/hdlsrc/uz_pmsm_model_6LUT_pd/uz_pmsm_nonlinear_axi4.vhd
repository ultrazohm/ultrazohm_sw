-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\Philipp\ultrazohm\ultrazohm_sw\ip_cores\uz_pmsm_model_nonlinear_6LUT\hdl_prj\hdlsrc\uz_pmsm_model_6LUT_pd\uz_pmsm_nonlinear_axi4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_nonlinear_axi4
-- Source Path: uz_pmsm_nonlinear/uz_pmsm_nonlinear_axi4
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_pmsm_nonlinear_axi4 IS
...
END uz_pmsm_nonlinear_axi4;


ARCHITECTURE rtl OF uz_pmsm_nonlinear_axi4 IS

  -- Component Declarations
  COMPONENT uz_pmsm_nonlinear_addr_decoder
  ...
  COMPONENT uz_pmsm_nonlinear_axi4_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_ARESETN                    :   IN    std_logic;  -- ufix1
          AXI4_AWID                       :   IN    std_logic_vector(11 DOWNTO 0);  -- ufix12
          AXI4_AWADDR                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  FOR ALL : uz_pmsm_nonlinear_addr_decoder
    USE ENTITY work.uz_pmsm_nonlinear_addr_decoder(rtl);

  FOR ALL : uz_pmsm_nonlinear_axi4_module
    USE ENTITY work.uz_pmsm_nonlinear_axi4_module(rtl);
  ...
  SIGNAL write_fitting_parameters_tmp     : vector_of_std_logic_vector32(0 TO 22);  -- ufix32 [23]
...
BEGIN
  u_uz_pmsm_nonlinear_addr_decoder_inst : uz_pmsm_nonlinear_addr_decoder
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
              ...
              write_fitting_parameters => write_fitting_parameters_tmp  -- ufix32 [23]
              );

  u_uz_pmsm_nonlinear_axi4_module_inst : uz_pmsm_nonlinear_axi4_module
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
