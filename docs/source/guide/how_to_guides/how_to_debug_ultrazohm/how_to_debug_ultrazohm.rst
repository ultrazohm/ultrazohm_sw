...
- If the Javascope does not work, check if you can ping the UltraZohm at he IP stated in the Serial Terminal during the start up procedure (default: ``192.168.1.233``)
