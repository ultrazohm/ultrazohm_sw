...
extern uz_3ph_dq_t ddpg_output_V;
extern uz_3ph_dq_t FOC_output_Volts;
...
int JavaScope_initalize(DS_Data* data)
{
	...
	//   js_ch_observable[JSO_omega] = &pmsm_inputs.omega_mech_1_s;
	  // js_ch_observable[JSO_u_d] = &pmsm_inputs.v_d_V;
	  // js_ch_observable[JSO_u_q] = &pmsm_inputs.v_q_V;
	//
	...
	//js_ch_observable[JSO_u_d]			= &FOC_output_Volts.d;
	//js_ch_observable[JSO_u_q]			= &FOC_output_Volts.q;
	js_ch_observable[JSO_u_d]			= &ddpg_output_V.d;
	js_ch_observable[JSO_u_q]			= &ddpg_output_V.q;
	...
	js_ch_observable[JSO_theta_elec] 	= &data->av.theta_elec_left;
