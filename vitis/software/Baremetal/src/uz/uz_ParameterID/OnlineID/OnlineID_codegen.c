...
static void identParams(ExtU_OnlineID_t *rtOnlineID_U, ExtY_OnlineID_t
  *rtOnlineID_Y, DW_OnlineID_t *rtOnlineID_DW);
static void RefreshDataRegister_i1(ExtU_OnlineID_t *rtOnlineID_U, DW_OnlineID_t *
  rtOnlineID_DW);
...
static void RefreshDataRegister_i(ExtU_OnlineID_t *rtOnlineID_U, DW_OnlineID_t
  *rtOnlineID_DW);
