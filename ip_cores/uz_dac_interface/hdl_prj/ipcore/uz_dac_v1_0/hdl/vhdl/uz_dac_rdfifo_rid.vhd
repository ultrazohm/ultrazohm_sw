-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/dac_spi/uz_dac_rdfifo_rid.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_dac_rdfifo_rid
-- Source Path: uz_dac/uz_dac_axi4/uz_dac_axi4_module/uz_dac_rdfifo_rid
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END uz_dac_rdfifo_rid;


ARCHITECTURE rtl OF uz_dac_rdfifo_rid IS
...
BEGIN
  ...
  u_uz_dac_rdfifo_rid_classic_ram : uz_dac_SimpleDualPortRAM_generic
