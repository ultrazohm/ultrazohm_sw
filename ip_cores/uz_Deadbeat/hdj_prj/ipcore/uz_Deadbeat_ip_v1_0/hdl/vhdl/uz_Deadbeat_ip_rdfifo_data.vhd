-- -------------------------------------------------------------
-- 
-- File Name: C:\UltraZohm\ultrazohm_fpga_control\ultrazohm_sw\ip_cores\uz_Deadbeat\hdj_prj\hdlsrc\uz_Deadbeat\uz_Deadbeat_ip_rdfifo_data.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_Deadbeat_ip_rdfifo_data
-- Source Path: uz_Deadbeat_ip/uz_Deadbeat_ip_axi4/uz_Deadbeat_ip_axi4_module/uz_Deadbeat_ip_rdfifo_data
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_Deadbeat_ip_rdfifo_data IS
...
END uz_Deadbeat_ip_rdfifo_data;


ARCHITECTURE rtl OF uz_Deadbeat_ip_rdfifo_data IS

  -- Component Declarations
  COMPONENT uz_Deadbeat_ip_SimpleDualPortRAM_generic
  ...
  FOR ALL : uz_Deadbeat_ip_SimpleDualPortRAM_generic
    USE ENTITY work.uz_Deadbeat_ip_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_uz_Deadbeat_ip_rdfifo_data_classic_ram_generic : uz_Deadbeat_ip_SimpleDualPortRAM_generic
