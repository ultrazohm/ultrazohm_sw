-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/dac_spi/uz_dac_src_Subsystem1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_dac_src_Subsystem1
-- Source Path: dac_spi/HDL_DUT/Subsystem1
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_dac_src_Subsystem1 IS
  PORT( u                                 :   IN    std_logic_vector(15 DOWNTO 0);  -- int16
        Out1                              :   OUT   std_logic_vector(0 TO 31)  -- ufix1 [32]
        );
END uz_dac_src_Subsystem1;


ARCHITECTURE rtl OF uz_dac_src_Subsystem1 IS
