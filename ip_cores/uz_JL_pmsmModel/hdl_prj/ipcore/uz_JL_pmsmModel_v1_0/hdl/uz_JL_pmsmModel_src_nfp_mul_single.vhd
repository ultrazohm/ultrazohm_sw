-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\jonat\Documents\MA_JL_CIL\ip_cores\uz_JL_pmsmModel\hdl_prj\hdlsrc\uz_JL_pmsmModel\uz_JL_pmsmModel_src_nfp_mul_single.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_JL_pmsmModel_src_nfp_mul_single
-- Source Path: uz_JL_pmsmModel/uz_JL_pmsmModel/Elektrik/Psi/nfp_mul_single
-- Hierarchy Level: 3
-- Model version: 1.50
-- 
...
ENTITY uz_JL_pmsmModel_src_nfp_mul_single IS
...
END uz_JL_pmsmModel_src_nfp_mul_single;


ARCHITECTURE rtl OF uz_JL_pmsmModel_src_nfp_mul_single IS
...
BEGIN
  ...
  switch_compare_1 <= '1' WHEN Bit_Slice1_out1_3 /= to_unsigned(0, 49) ELSE
      '0';
  ...
  Switch2_out1_3 <= Bit_Slice_out1_3 WHEN switch_compare_1 = '0' ELSE
      Bit_Set_out1;
  ...
  Switch6_out1_1 <= Constant6_out1 WHEN Relational_Operator_out1 = '0' ELSE
      Switch4_out1_1;
