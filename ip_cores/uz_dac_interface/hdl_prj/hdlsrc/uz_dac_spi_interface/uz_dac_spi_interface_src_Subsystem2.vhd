-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/uz_dac_spi_interface/uz_dac_spi_interface_src_Subsystem2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_dac_spi_interface_src_Subsystem2
-- Source Path: uz_dac_spi_interface/uz_dac_spi_interface/Subsystem2
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_dac_spi_interface_src_Subsystem2 IS
  PORT( u                                 :   IN    std_logic_vector(15 DOWNTO 0);  -- int16
        Out1                              :   OUT   std_logic_vector(0 TO 31)  -- ufix1 [32]
        );
END uz_dac_spi_interface_src_Subsystem2;


ARCHITECTURE rtl OF uz_dac_spi_interface_src_Subsystem2 IS
