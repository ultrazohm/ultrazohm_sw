...
#define UZ_APPROXIMATE_FLUX_D_MAX_INSTANCES             1U
#define UZ_APPROXIMATE_FLUX_Q_MAX_INSTANCES             1U
#define UZ_CURRENTCONTROL_KP_ID_ADJUSTMENT_MAX_INSTANCES 1U
#define UZ_CURRENTCONTROL_KP_IQ_ADJUSTMENT_MAX_INSTANCES 1U
#endif
