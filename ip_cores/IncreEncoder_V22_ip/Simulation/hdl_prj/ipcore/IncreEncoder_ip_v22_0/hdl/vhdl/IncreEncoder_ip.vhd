-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Encoder_Zynq\IncreEncoder_ip.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IncreEncoder_ip
-- Source Path: IncreEncoder_ip
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF IncreEncoder_ip IS

  -- Component Declarations
  COMPONENT IncreEncoder_ip_axi_lite
  ...
  FOR ALL : IncreEncoder_ip_axi_lite
    USE ENTITY work.IncreEncoder_ip_axi_lite(rtl);

  FOR ALL : IncreEncoder_ip_dut
    USE ENTITY work.IncreEncoder_ip_dut(rtl);
...
BEGIN
  u_IncreEncoder_ip_axi_lite_inst : IncreEncoder_ip_axi_lite
  ...
  u_IncreEncoder_ip_dut_inst : IncreEncoder_ip_dut
  ...
  ip_timestamp <= to_unsigned(1810010932, 32);
