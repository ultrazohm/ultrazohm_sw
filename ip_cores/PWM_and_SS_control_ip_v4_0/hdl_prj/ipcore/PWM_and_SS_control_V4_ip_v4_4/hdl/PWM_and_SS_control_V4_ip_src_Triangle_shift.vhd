-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/IP_Core_SS_Switch_and_PWM/PWM_and_SS_control_V4_ip_src_Triangle_shift.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: PWM_and_SS_control_V4_ip_src_Triangle_shift
-- Source Path: IP_Core_SS_Switch_and_PWM/PWM_and_Switching_Signal_Control/GenPWM/Triangle shift
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY PWM_and_SS_control_V4_ip_src_Triangle_shift IS
...
END PWM_and_SS_control_V4_ip_src_Triangle_shift;


ARCHITECTURE rtl OF PWM_and_SS_control_V4_ip_src_Triangle_shift IS

  -- Component Declarations
  COMPONENT PWM_and_SS_control_V4_ip_src_Subsystem2
  ...
  COMPONENT PWM_and_SS_control_V4_ip_src_Subsystem1
  ...
  COMPONENT PWM_and_SS_control_V4_ip_src_Subsystem
  ...
  COMPONENT PWM_and_SS_control_V4_ip_src_Subsystem3
    PORT( triangle_in                     :   IN    std_logic_vector(19 DOWNTO 0);  -- sfix20_En17
          modified_triangle_shift         :   IN    std_logic_vector(19 DOWNTO 0);  -- sfix20_En17
          direction_up                    :   IN    std_logic;
          shifted_triangle_in_signal      :   OUT   std_logic_vector(20 DOWNTO 0)  -- sfix21_En17
  ...
  FOR ALL : PWM_and_SS_control_V4_ip_src_Subsystem2
    USE ENTITY work.PWM_and_SS_control_V4_ip_src_Subsystem2(rtl);

  FOR ALL : PWM_and_SS_control_V4_ip_src_Subsystem1
    USE ENTITY work.PWM_and_SS_control_V4_ip_src_Subsystem1(rtl);

  FOR ALL : PWM_and_SS_control_V4_ip_src_Subsystem
    USE ENTITY work.PWM_and_SS_control_V4_ip_src_Subsystem(rtl);

  FOR ALL : PWM_and_SS_control_V4_ip_src_Subsystem3
    USE ENTITY work.PWM_and_SS_control_V4_ip_src_Subsystem3(rtl);
...
BEGIN
  ...
  u_Subsystem2 : PWM_and_SS_control_V4_ip_src_Subsystem2
  ...
  u_Subsystem1 : PWM_and_SS_control_V4_ip_src_Subsystem1
  ...
  u_Subsystem : PWM_and_SS_control_V4_ip_src_Subsystem
  ...
  u_Subsystem3 : PWM_and_SS_control_V4_ip_src_Subsystem3
    PORT MAP( triangle_in => std_logic_vector(triangle_in_1),  -- sfix20_En17
              modified_triangle_shift => std_logic_vector(modified_triangle_shift),  -- sfix20_En17
