...
ARCHITECTURE rtl OF VSD_6ph_ip_src_VSD_6ph_30deg IS
  ...
  CONSTANT a                              : matrix_of_signed18(0 TO 5, 0 TO 5) := 
    (( to_signed(16#15555#, 18), to_signed(-16#0AAAB#, 18), to_signed(-16#0AAAB#, 18), to_signed(16#1279A#, 18),
     to_signed(-16#1279B#, 18), to_signed(16#00000#, 18) ), ( to_signed(16#00000#, 18), to_signed(16#1279A#, 18),
     to_signed(-16#1279B#, 18), to_signed(16#0AAAA#, 18), to_signed(16#0AAAA#, 18), to_signed(-16#15556#, 18) ),
     ( to_signed(16#15555#, 18), to_signed(-16#0AAAB#, 18), to_signed(-16#0AAAB#, 18), to_signed(-16#1279B#, 18),
     to_signed(16#1279A#, 18), to_signed(16#00000#, 18) ), ( to_signed(16#00000#, 18), to_signed(-16#1279B#, 18),
     to_signed(16#1279A#, 18), to_signed(16#0AAAA#, 18), to_signed(16#0AAAA#, 18), to_signed(-16#15556#, 18) ),
     ( to_signed(16#0AAAA#, 18), to_signed(16#0AAAA#, 18), to_signed(16#0AAAA#, 18), to_signed(16#00000#, 18),
     to_signed(16#00000#, 18), to_signed(16#00000#, 18) ), ( to_signed(16#00000#, 18), to_signed(16#00000#, 18),
     to_signed(16#00000#, 18), to_signed(16#0AAAA#, 18), to_signed(16#0AAAA#, 18), to_signed(16#0AAAA#, 18) ));  -- sfix18 [6x6]
...
BEGIN
  ...
  BEGIN
    ...
    alpha_tmp <= resize(c(0)(38 DOWNTO 22), 18);
    beta_tmp <= resize(c(1)(38 DOWNTO 22), 18);
    x1_tmp <= resize(c(2)(38 DOWNTO 22), 18);
    y1_tmp <= resize(c(3)(38 DOWNTO 22), 18);
    z1_tmp <= resize(c(4)(38 DOWNTO 22), 18);
    z2_tmp <= resize(c(5)(38 DOWNTO 22), 18);
