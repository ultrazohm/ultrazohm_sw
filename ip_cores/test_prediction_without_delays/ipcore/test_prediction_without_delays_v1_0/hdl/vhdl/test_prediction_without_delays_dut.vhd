-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\test_prediction_without_delays\hdlsrc\test_prediction_without_delays\test_prediction_without_delays_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: test_prediction_without_delays_dut
-- Source Path: test_prediction_without_delays/test_prediction_without_delays_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY test_prediction_without_delays_dut IS
...
END test_prediction_without_delays_dut;


ARCHITECTURE rtl OF test_prediction_without_delays_dut IS

  -- Component Declarations
  COMPONENT test_prediction_without_delays_src_Prediction_and_cost_function1
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : test_prediction_without_delays_src_Prediction_and_cost_function1
    USE ENTITY work.test_prediction_without_delays_src_Prediction_and_cost_function1(rtl);
...
BEGIN
  u_test_prediction_without_delays_src_Prediction_and_cost_function1 : test_prediction_without_delays_src_Prediction_and_cost_function1
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
