...
entity BGD_accumulate_float_1u_36 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of BGD_accumulate_float_1u_36 is 
...
begin
    fadd_32ns_32ns_32_5_full_dsp_1_U76 : component BGD_fadd_32ns_32ns_32_5_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
