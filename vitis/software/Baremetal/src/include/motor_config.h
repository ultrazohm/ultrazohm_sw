 ...
 *   - Protection and safe-operating-region limits
...
/* MOTOR_CONFIG_SELECT is defined by testbenchsetup.h. */
#ifndef MOTOR_CONFIG_SELECT
#error "Select a motor in testbenchsetup.h before including motor_config.h"
#endif
...
#define MOTOR_SOR_speed_upper_rpm          MOTOR_Speed_max_rpm
#define MOTOR_SOR_speed_lower_rpm         (-MOTOR_Speed_max_rpm)
#define MOTOR_SOR_i_d_upper_A             MOTOR_Control_current_max_A
#define MOTOR_SOR_i_d_lower_A             (-MOTOR_Control_current_max_A)
#define MOTOR_SOR_i_q_upper_A             MOTOR_Control_current_max_A
#define MOTOR_SOR_i_q_lower_A             (-MOTOR_Control_current_max_A)
#define MOTOR_SOR_i_abc_upper_A           MOTOR_Protection_phase_max_A
#define MOTOR_SOR_i_abc_lower_A           (-MOTOR_Protection_phase_max_A)
#define MOTOR_SOR_v_dc_upper_V            vdc_max_v
#define MOTOR_SOR_v_dc_lower_V            vdc_min_v
#define MOTOR_SOR_i_dc_upper_A            MOTOR_Protection_phase_max_A
#define MOTOR_SOR_i_dc_lower_A            (-MOTOR_Protection_phase_max_A)
...
#define MOTOR_Setpoint_filter_i_dq_cutoff_Hz           	0.0f
#define MOTOR_Setpoint_filter_speed_cutoff_Hz          	0.0f
#define MOTOR_Speed_actual_filter_cutoff_Hz            	0.0f
#define MOTOR_Default_duty_cycle                       	0.5f
#define MOTOR_Default_i_d_reference_A                  	(MOTOR_Psi_rated_Vs / MOTOR_Lm_H)
#define MOTOR_Default_i_q_reference_A                  	0.0f
#define MOTOR_Default_u_f_frequency_Hz                 	0.0f
