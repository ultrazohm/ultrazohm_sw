-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_mpc_6ph_sca_hex_new\MPC_incr_encoder_conversion_addr_decoder.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MPC_incr_encoder_conversion_addr_decoder
-- Source Path: MPC_incr_encoder_conversion/MPC_incr_encoder_conversion_axi_lite/MPC_incr_encoder_conversion_addr_decoder
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY MPC_incr_encoder_conversion_addr_decoder IS
...
END MPC_incr_encoder_conversion_addr_decoder;


ARCHITECTURE rtl OF MPC_incr_encoder_conversion_addr_decoder IS
  ...
  SIGNAL read_out1_AXI_signed             : signed(26 DOWNTO 0);  -- sfix27_En20
  SIGNAL decode_sel_out1_AXI_1_1          : std_logic;  -- ufix1
  SIGNAL read_reg_ip_timestamp            : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_ip_timestamp_1_1       : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL read_reg_out1_AXI                : signed(26 DOWNTO 0);  -- sfix27_En20
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        read_reg_out1_AXI <= to_signed(16#0000000#, 27);
      ELSIF enb = '1' THEN
