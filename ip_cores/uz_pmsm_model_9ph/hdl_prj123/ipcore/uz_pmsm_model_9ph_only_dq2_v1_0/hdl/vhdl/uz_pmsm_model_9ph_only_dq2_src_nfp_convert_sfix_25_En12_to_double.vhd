-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj123/hdlsrc/uz_pmsm_model_9ph_21b_all_double/uz_pmsm_model_9ph_only_dq2_src_nfp_convert_sfix_25_En12_to_double.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_9ph_only_dq2_src_nfp_convert_sfix_25_En12_to_double
-- Source Path: uz_pmsm_model_9ph_21b_all_double/uz_pmsm_model_9ph/dq_model_9ph/nfp_convert_sfix_25_En12_to_double
-- Hierarchy Level: 1
-- 
...
ENTITY uz_pmsm_model_9ph_only_dq2_src_nfp_convert_sfix_25_En12_to_double IS
...
END uz_pmsm_model_9ph_only_dq2_src_nfp_convert_sfix_25_En12_to_double;


ARCHITECTURE rtl OF uz_pmsm_model_9ph_only_dq2_src_nfp_convert_sfix_25_En12_to_double IS
  ...
  SIGNAL Delay_PS_1_out1                  : signed(24 DOWNTO 0);  -- sfix25_En12
  ...
  SIGNAL reduced_reg_next                 : vector_of_unsigned32(0 TO 1);  -- ufix32_En12 [2]
  ...
  SIGNAL Delay3_PS_5_out1_1               : unsigned(31 DOWNTO 0);  -- ufix32_En12
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay_PS_1_out1 <= to_signed(16#0000000#, 25);
      ELSIF enb = '1' THEN
        Delay_PS_1_out1 <= nfp_in_signed;
      END IF;
    END IF;
  ...
  CompareToZero1_out1 <= '1' WHEN Delay_PS_1_out1 = to_signed(16#0000000#, 25) ELSE
      '0';
  ...
  Compare_To_Zero_out1 <= '1' WHEN Delay_PS_1_out1 < to_signed(16#0000000#, 25) ELSE
      '0';
  ...
  Delay_PS_1_out1_dtc <= unsigned(Delay_PS_1_out1);

  Unary_Minus_cast <= resize(Delay_PS_1_out1, 26);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay1_PS_3_out1 <= Switch1_out1_1;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay3_PS_5_out1 <= Data_Type_Conversion_out1_1;
      END IF;
    END IF;
  ...
  Switch1_out1_2 <= Delay3_PS_5_out1 WHEN Delay5_PS_2_5_out1 = '0' ELSE
      Constant_out1_2;
  ...
  reduced_reg_next(0) <= Data_Type_Conversion2_out1_1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay3_PS_5_out1_1 <= to_unsigned(0, 32);
      ELSIF enb = '1' THEN
  ...
  Bit_Slice1_out1_2 <= Delay3_PS_5_out1_1(30 DOWNTO 0);
