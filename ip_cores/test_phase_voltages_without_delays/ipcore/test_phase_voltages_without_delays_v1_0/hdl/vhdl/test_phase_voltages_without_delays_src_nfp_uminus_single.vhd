-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\test_phase_voltages_without_delays\hdlsrc\test_phase_voltages_without_delays\test_phase_voltages_without_delays_src_nfp_uminus_single.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: test_phase_voltages_without_delays_src_nfp_uminus_single
-- Source Path: test_phase_voltages_without_delays/Phase_voltages_per_switching_state1/Subsystem/MATLAB Function/nfp_uminus_single
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY test_phase_voltages_without_delays_src_nfp_uminus_single IS
  PORT( nfp_in                            :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_out                           :   OUT   std_logic_vector(31 DOWNTO 0)  -- ufix32
        );
END test_phase_voltages_without_delays_src_nfp_uminus_single;


ARCHITECTURE rtl OF test_phase_voltages_without_delays_src_nfp_uminus_single IS
