...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "uz_FOC_sample.autotvin.dat"
	set constFileTvOut       "uz_FOC_sample.autotvout.dat"
	set constFileHdlTvIn     "uz_FOC_sample.autohdltvin.dat"
	set constFileHdlTvOut    "uz_FOC_sample.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
