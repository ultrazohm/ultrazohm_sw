/*
 * File Name:         C:\Users\valen\Documents\repos\UZ\ultrazohm_sw\ip_cores\uz_pmsm_model_9ph\hdl_opti\ipcore\uz_pmsm_model_9ph_opti_v2_3\include\uz_pmsm_model_9ph_opti_addr.h
 * Description:       C Header File
 * Created:           2022-06-01 13:40:23
*/
...
#define  IPCore_Timestamp_uz_pmsm_model_9ph_opti                           0x8  //contains unique IP timestamp (yymmddHHMM): 2206011340
#define  input_Data_uz_pmsm_model_9ph_opti                                 0x180  //data register for Inport input, vector with 2 elements, address ends at 0x184
#define  input_Strobe_uz_pmsm_model_9ph_opti                               0x188  //strobe register for port input
...
#define  outputs_Strobe_uz_pmsm_model_9ph_opti                             0x220  //strobe register for port outputs
#define  i_abc_ps_Data_uz_pmsm_model_9ph_opti                              0x400  //data register for Outport i_abc_ps, vector with 9 elements, address ends at 0x420
#define  i_abc_ps_Strobe_uz_pmsm_model_9ph_opti                            0x440  //strobe register for port i_abc_ps
