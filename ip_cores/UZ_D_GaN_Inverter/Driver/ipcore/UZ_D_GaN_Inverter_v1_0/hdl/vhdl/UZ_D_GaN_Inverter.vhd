-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\UZ_D_GaN_Inverter_reduced\UZ_D_GaN_Inverter.vhd
...
ARCHITECTURE rtl OF UZ_D_GaN_Inverter IS
  ...
  COMPONENT UZ_D_GaN_Inverter_dut
    PORT( clk                             :   IN    std_logic;  -- ufix1
          ...
          AXI_GaN_FAULT                   :   OUT   std_logic_vector(31 DOWNTO 0);  -- ufix32
          AXI_GaN_OC                      :   OUT   std_logic_vector(31 DOWNTO 0);  -- ufix32
          AXI_I_DIAG                      :   OUT   std_logic_vector(31 DOWNTO 0);  -- ufix32
          PWM_EN                          :   OUT   std_logic  -- ufix1
          );
  END COMPONENT;
  ...
  SIGNAL AXI_GaN_FAULT_sig                : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL AXI_GaN_OC_sig                   : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL AXI_I_DIAG_sig                   : std_logic_vector(31 DOWNTO 0);  -- ufix32
...
BEGIN
  ...
  u_UZ_D_GaN_Inverter_axi_lite_inst : UZ_D_GaN_Inverter_axi_lite
    PORT MAP( reset => reset,
              ...
              read_AXI_GaN_FAULT => AXI_GaN_FAULT_sig,  -- ufix32
              read_AXI_GaN_OC => AXI_GaN_OC_sig,  -- ufix32
              read_AXI_I_DIAG => AXI_I_DIAG_sig,  -- ufix32
  ...
  u_UZ_D_GaN_Inverter_dut_inst : UZ_D_GaN_Inverter_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              ...
              AXI_GaN_FAULT => AXI_GaN_FAULT_sig,  -- ufix32
              AXI_GaN_OC => AXI_GaN_OC_sig,  -- ufix32
              AXI_I_DIAG => AXI_I_DIAG_sig,  -- ufix32
              PWM_EN => PWM_EN_sig  -- ufix1
              );

  ip_timestamp <= to_unsigned(2105061332, 32);
