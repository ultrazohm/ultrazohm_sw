...
#define  IPCore_Timestamp_uz_JL_InvModel_PT1   0x8  //contains unique IP timestamp (yymmddHHMM): 2605191733
...
#define  InvOut_PS_Data_uz_JL_InvModel_PT1     0x120  //data register for Outport InvOut_PS. Vector with 3 elements. Register is split across a total of 3 addresses, last address is 0x128.
#define  InvOut_PS_Strobe_uz_JL_InvModel_PT1   0x130  //strobe register for port InvOut_PS
