...
set_property PACKAGE_PIN Y10 [get_ports {D2_IN[0]}]
set_property PACKAGE_PIN Y7 [get_ports {D2_IN[1]}]
set_property PACKAGE_PIN Y8 [get_ports {D2_IN[2]}]
set_property PACKAGE_PIN V3 	[get_ports D2_IN[3]]
