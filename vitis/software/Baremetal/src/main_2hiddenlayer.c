...
float m3[NUMBER_OF_OUTPUTS+NUMBER_OF_OUTPUTS * NUMBER_OF_NEURONS_IN_HIDDEN_LAYER] = {0.0f};
float v3[NUMBER_OF_OUTPUTS+NUMBER_OF_OUTPUTS * NUMBER_OF_NEURONS_IN_HIDDEN_LAYER] = {0.0f};
...
float copy_ts_3[NUMBER_OF_OUTPUTS] = {0};
...
float copy_tw_3[NUMBER_OF_NEURONS_IN_HIDDEN_LAYER * NUMBER_OF_OUTPUTS] = {0};
float copy_tb_3[NUMBER_OF_OUTPUTS] = {0};
float copy_ty_3[NUMBER_OF_OUTPUTS] = {0};
...
float cacheg_3[NUMBER_OF_NEURONS_IN_HIDDEN_LAYER * NUMBER_OF_OUTPUTS] = {0};
