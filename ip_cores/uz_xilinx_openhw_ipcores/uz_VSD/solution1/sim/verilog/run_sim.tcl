...
if {[file isfile uz_VSD_6ph_asym.autotvin.dat]} {
	file delete -force uz_VSD_6ph_asym.autotvin.dat
}

if {[file isfile uz_VSD_6ph_asym.autotvout.dat]} {
	file delete -force uz_VSD_6ph_asym.autotvout.dat
}
