-- -------------------------------------------------------------
-- 
-- File Name: /home/ts/Documents/integrate_nn_to_uz/ultrazohm_sw/ip_cores/nnAXI_v1_0/hdl_prj/hdlsrc/uz_mlp_three_layer/uz_mlp_three_layer_src_MAC7_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_mlp_three_layer_src_MAC7_block
-- Source Path: uz_mlp_three_layer/uz_mlp_three_layer/reluLayer_8Parallel1/MAC7
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_mlp_three_layer_src_MAC7_block IS
...
END uz_mlp_three_layer_src_MAC7_block;


ARCHITECTURE rtl OF uz_mlp_three_layer_src_MAC7_block IS

  -- Component Declarations
  COMPONENT uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block60
  ...
  COMPONENT uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block62
    GENERIC( AddrWidth                    : integer;
             DataWidth                    : integer
             );
    PORT( clk                             :   IN    std_logic;
  ...
  COMPONENT uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block61
    GENERIC( AddrWidth                    : integer;
             DataWidth                    : integer
             );
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block60
    USE ENTITY work.uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block60(rtl);

  FOR ALL : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block62
    USE ENTITY work.uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block62(rtl);

  FOR ALL : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block61
    USE ENTITY work.uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block61(rtl);
...
BEGIN
  u_Dual_Port_RAM_System1 : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block60
  ...
  u_Dual_Port_RAM_System3 : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block62
    GENERIC MAP( AddrWidth => 10,
                 DataWidth => 32
                 )
    PORT MAP( clk => clk,
  ...
  u_Dual_Port_RAM_System2 : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block61
    GENERIC MAP( AddrWidth => 10,
                 DataWidth => 32
                 )
    PORT MAP( clk => clk,
  ...
  Compare_To_Constant1_out1 <= '1' WHEN axi_biasWriteEnable = to_unsigned(16#08#, 8) ELSE
      '0';
  ...
  Compare_To_Constant_out1 <= '1' WHEN axi_weightsWriteEnable = to_unsigned(16#08#, 8) ELSE
      '0';
  ...
  Constant_out1 <= to_unsigned(16#039#, 10);
