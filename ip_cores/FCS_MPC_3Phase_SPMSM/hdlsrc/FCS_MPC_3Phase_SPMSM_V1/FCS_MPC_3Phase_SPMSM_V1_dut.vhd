-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\FCS_MPC_3Phase_SPMSM\hdlsrc\FCS_MPC_3Phase_SPMSM_V1\FCS_MPC_3Phase_SPMSM_V1_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: FCS_MPC_3Phase_SPMSM_V1_dut
-- Source Path: FCS_MPC_3Phase_SPMSM_V1/FCS_MPC_3Phase_SPMSM_V1_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY FCS_MPC_3Phase_SPMSM_V1_dut IS
...
END FCS_MPC_3Phase_SPMSM_V1_dut;


ARCHITECTURE rtl OF FCS_MPC_3Phase_SPMSM_V1_dut IS

  -- Component Declarations
  COMPONENT FCS_MPC_3Phase_SPMSM_V1_src_Subsystem1
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : FCS_MPC_3Phase_SPMSM_V1_src_Subsystem1
    USE ENTITY work.FCS_MPC_3Phase_SPMSM_V1_src_Subsystem1(rtl);
...
BEGIN
  u_FCS_MPC_3Phase_SPMSM_V1_src_Subsystem1 : FCS_MPC_3Phase_SPMSM_V1_src_Subsystem1
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
              ...
              u_dc_link_AXI => u_dc_link_AXI,  -- ufix32
              SampleTime_AXI => SampleTime_AXI,  -- ufix32
