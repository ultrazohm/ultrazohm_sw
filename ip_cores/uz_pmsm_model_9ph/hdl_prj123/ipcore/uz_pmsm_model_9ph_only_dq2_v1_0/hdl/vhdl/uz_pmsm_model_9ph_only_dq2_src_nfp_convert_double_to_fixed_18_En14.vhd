-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj123/hdlsrc/uz_pmsm_model_9ph_21b_all_double/uz_pmsm_model_9ph_only_dq2_src_nfp_convert_double_to_fixed_18_En14.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_9ph_only_dq2_src_nfp_convert_double_to_fixed_18_En14
-- Source Path: uz_pmsm_model_9ph_21b_all_double/uz_pmsm_model_9ph/dq_model_9ph/nfp_convert_double_to_fixed_18_En14
-- Hierarchy Level: 1
-- 
...
ENTITY uz_pmsm_model_9ph_only_dq2_src_nfp_convert_double_to_fixed_18_En14 IS
...
END uz_pmsm_model_9ph_only_dq2_src_nfp_convert_double_to_fixed_18_En14;


ARCHITECTURE rtl OF uz_pmsm_model_9ph_only_dq2_src_nfp_convert_double_to_fixed_18_En14 IS
  ...
  SIGNAL Data_Type_Conversion2_out1       : signed(17 DOWNTO 0);  -- sfix18_En14
  SIGNAL Delay8_out1_1                    : signed(17 DOWNTO 0);  -- sfix18_En14
...
BEGIN
  ...
  Data_Type_Conversion2_out1 <= Delay1_out1(56 DOWNTO 39) + ('0' & Delay1_out1(38));

  Delay8_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay8_out1_1 <= to_signed(16#00000#, 18);
      ELSIF enb = '1' THEN
