...
typedef struct uz_lin_decoupling_config{
    ...
    float Psi_PM_Vs;/**< permanent magnet flux linkage in Volt-seconds. Must be greater than 0.0f */
 ...
 */
struct uz_dq_t uz_FOC_linear_decoupling(uz_lin_decoupling_config config, struct uz_dq_t i_dq_meas_Ampere, float omega_el_rad_per_sec);
