-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/inc_enc_v26/IncEnc_V2_ip_addr_decoder.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IncEnc_V2_ip_addr_decoder
-- Source Path: IncEnc_V2_ip/IncEnc_V2_ip_axi_lite/IncEnc_V2_ip_addr_decoder
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY IncEnc_V2_ip_addr_decoder IS
...
END IncEnc_V2_ip_addr_decoder;


ARCHITECTURE rtl OF IncEnc_V2_ip_addr_decoder IS
...
BEGIN
  ...
  write_dMinaxisMinHitMinCompare_AXI <= std_logic_vector(data_reg_d_axis_Hit_Compare_AXI_1_1);
