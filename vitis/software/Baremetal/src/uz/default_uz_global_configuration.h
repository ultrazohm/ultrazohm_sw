...
#define EBM_LRC_PARAMETERS 1     // 0 is l_d=30 uH as was used until the fix, where 1 is L_d=55 uH and L_q=65 uH
#define HEIDRIVE_LRC_PARAMETERS 1
...
#define AGENT 321
#define D1_MACHINE HEIDRIVE_D1 // EBM, Brose, Hoerner, HEIDRIVE_D1, BECKHOFF_DESKBENCH_D1
#define D2_MACHINE HEIDRIVE_D2 // HEIDRIVE_D2, BUEHLER, BECKHOFF, BECKHOFF_DESKBENCH_D2
 ...
 * 6 for Interrupt_axi2tcm_write_done
 */
