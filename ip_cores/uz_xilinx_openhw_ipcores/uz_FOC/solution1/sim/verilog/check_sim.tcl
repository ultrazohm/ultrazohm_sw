...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.uz_FOC.autotvin_axi_id_reference.dat"
         "c.uz_FOC.autotvin_axi_iq_reference.dat"
         "c.uz_FOC.autotvin_axi_sampletime.dat"
         "c.uz_FOC.autotvin_axi_id_KI.dat"
         "c.uz_FOC.autotvin_axi_id_KP.dat"
         "c.uz_FOC.autotvin_axi_iq_KI.dat"
         "c.uz_FOC.autotvin_axi_iq_KP.dat"
         "c.uz_FOC.autotvin_axi_limit.dat"
         "c.uz_FOC.autotvin_axi_reset.dat"
         "c.uz_FOC.autotvin_id_actual.dat"
         "c.uz_FOC.autotvin_iq_actual.dat"
         "c.uz_FOC.autotvin_reset_PL.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.uz_FOC.autotvout_ud_ref.dat"
         "rtl.uz_FOC.autotvout_uq_ref.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
