...
typedef struct {
  ...
  real32_T i_d_ref_AMM_loc_f;     /* '<S1>/AMMstate.IdentificationDQ.Fluxmap' */
  real32_T i_q_ref_AMM_loc_h;     /* '<S1>/AMMstate.IdentificationDQ.Fluxmap' */
...
typedef struct {
  DW_AMMstateIdentificationDQFl_t sf_AMMstateIdentificationXY1Flu;
  ...
  uint8_T is_IdentificationXY1;        /* '<Root>/FluxMapID_6ph_codegen' */
  boolean_T finished_calculation;/* '<S1>/AMMstate.IdentificationXY1.Fluxmap' */
 ...
 * '<S4>'   : 'uz_ParameterID_6ph/Subsystem Reference1/FluxMapID_6ph_codegen/AMMstate.IdentificationXY1.Fluxmap'
 */
