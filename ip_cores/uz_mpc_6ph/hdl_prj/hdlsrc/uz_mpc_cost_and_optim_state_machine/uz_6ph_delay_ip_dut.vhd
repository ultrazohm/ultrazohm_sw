-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_mpc_cost_and_optim_state_machine\uz_6ph_delay_ip_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_6ph_delay_ip_dut
-- Source Path: uz_6ph_delay_ip/uz_6ph_delay_ip_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END uz_6ph_delay_ip_dut;


ARCHITECTURE rtl OF uz_6ph_delay_ip_dut IS

  -- Component Declarations
  COMPONENT uz_6ph_delay_ip_src_uz_6ph_mpc_delay_comp
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : uz_6ph_delay_ip_src_uz_6ph_mpc_delay_comp
    USE ENTITY work.uz_6ph_delay_ip_src_uz_6ph_mpc_delay_comp(rtl);
...
BEGIN
  u_uz_6ph_delay_ip_src_uz_6ph_mpc_delay_comp : uz_6ph_delay_ip_src_uz_6ph_mpc_delay_comp
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
