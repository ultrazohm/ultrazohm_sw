-- -------------------------------------------------------------
-- 
-- File Name: /home/ts/Documents/integrate_nn_to_uz/ultrazohm_sw/ip_cores/nnAXI_v1_0/hdl_prj/hdlsrc/uz_mlp_three_layer/uz_mlp_three_layer_rdfifo_data.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_mlp_three_layer_rdfifo_data
-- Source Path: uz_mlp_three_layer/uz_mlp_three_layer_axi4/uz_mlp_three_layer_axi4_module/uz_mlp_three_layer_rdfifo_data
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_mlp_three_layer_rdfifo_data IS
...
END uz_mlp_three_layer_rdfifo_data;


ARCHITECTURE rtl OF uz_mlp_three_layer_rdfifo_data IS

  -- Component Declarations
  COMPONENT uz_mlp_three_layer_SimpleDualPortRAM_generic
  ...
  FOR ALL : uz_mlp_three_layer_SimpleDualPortRAM_generic
    USE ENTITY work.uz_mlp_three_layer_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_uz_mlp_three_layer_rdfifo_data_classic_ram_generic : uz_mlp_three_layer_SimpleDualPortRAM_generic
