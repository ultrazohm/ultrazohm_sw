...
ARCHITECTURE rtl OF uz_pmsm_model_src_uz_pmsm_model IS
  ...
  COMPONENT uz_pmsm_model_src_nfp_relop_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          nfp_in1                         :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  FOR ALL : uz_pmsm_model_src_nfp_relop_single
    USE ENTITY work.uz_pmsm_model_src_nfp_relop_single(rtl);
  ...
  SIGNAL Switch7_out1_timer               : std_logic;
  SIGNAL delayMatch50_reg                 : std_logic_vector(96 DOWNTO 0);  -- ufix1 [97]
  SIGNAL Switch7_out1_timer_1             : std_logic;
  SIGNAL Switch7_out1_default             : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL Switch7_threshold                : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL Switch8_threshold                : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL Switch8_control                  : std_logic;
  ...
  SIGNAL error_id_2                       : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL error_id_3                       : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL Switch7_control                  : std_logic;
  SIGNAL Switch7_out1                     : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Switch7_out1_zp                  : std_logic_vector(31 DOWNTO 0);  -- ufix32
...
BEGIN
  ...
  u_uz_pmsm_model_uz_pmsm_model_nfp_convert_double2single : uz_pmsm_model_src_nfp_convert_double2single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in => Constant4_out1,  -- double
              nfp_out => i_d_soll  -- single
              );
  ...
  u_nfp_relop_comp : uz_pmsm_model_src_nfp_relop_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Abs1_out1,  -- single
              nfp_in2 => Switch8_threshold,  -- single
              nfp_out1 => Switch8_control
              );
  ...
  u_nfp_abs_comp_1 : uz_pmsm_model_src_nfp_abs_single
    PORT MAP( nfp_in => error_id_2,  -- single
              nfp_out => Abs_out1  -- single
              );

  u_nfp_relop_comp_1 : uz_pmsm_model_src_nfp_relop_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Abs_out1,  -- single
              nfp_in2 => Switch7_threshold,  -- single
              nfp_out1 => Switch7_control
              );
  ...
  u_nfp_div_comp : uz_pmsm_model_src_nfp_div_single
    PORT MAP( clk => clk,
              ...
              nfp_in2 => Switch7_out1_zp,  -- single
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        delayMatch50_reg(0) <= Switch7_out1_timer;
        delayMatch50_reg(96 DOWNTO 1) <= delayMatch50_reg(95 DOWNTO 0);
      END IF;
    END IF;
  END PROCESS delayMatch50_process;

  Switch7_out1_timer_1 <= delayMatch50_reg(96);

  Switch7_out1_default <= X"3f800000";
  ...
  Switch7_threshold <= X"25800000";

  Constant4_out1 <= X"3f747ae147ae147b";
  ...
  Switch8_threshold <= X"25800000";

  Constant1_out1 <= X"3f747ae147ae147b";
  ...
  Switch8_out1 <= i_d_soll_1 WHEN Switch8_control = '0' ELSE
      error_id_1;
  ...
  error_id_2 <= Lq_2 WHEN simulate_nonlinear_2 = '0' ELSE
      Lqq_modell;

  
  Switch7_out1 <= i_d_soll WHEN Switch7_control = '0' ELSE
      error_id_3;

  
  Switch7_out1_zp <= Switch7_out1_default WHEN Switch7_out1_timer_1 = '0' ELSE
      Switch7_out1;
