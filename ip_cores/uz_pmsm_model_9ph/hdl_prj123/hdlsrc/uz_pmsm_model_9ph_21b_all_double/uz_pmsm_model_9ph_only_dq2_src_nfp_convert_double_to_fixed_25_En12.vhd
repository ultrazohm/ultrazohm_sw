-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj123/hdlsrc/uz_pmsm_model_9ph_21b_all_double/uz_pmsm_model_9ph_only_dq2_src_nfp_convert_double_to_fixed_25_En12.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_9ph_only_dq2_src_nfp_convert_double_to_fixed_25_En12
-- Source Path: uz_pmsm_model_9ph_21b_all_double/uz_pmsm_model_9ph/dq_model_9ph/nfp_convert_double_to_fixed_25_En12
-- Hierarchy Level: 1
-- 
...
ENTITY uz_pmsm_model_9ph_only_dq2_src_nfp_convert_double_to_fixed_25_En12 IS
...
END uz_pmsm_model_9ph_only_dq2_src_nfp_convert_double_to_fixed_25_En12;


ARCHITECTURE rtl OF uz_pmsm_model_9ph_only_dq2_src_nfp_convert_double_to_fixed_25_En12 IS
  ...
  SIGNAL Delay4_out1_1                    : unsigned(65 DOWNTO 0);  -- ufix66_En53
  ...
  SIGNAL Delay6_out1                      : unsigned(65 DOWNTO 0);  -- ufix66_En53
  ...
  SIGNAL Delay1_out1                      : signed(66 DOWNTO 0);  -- sfix67_En53
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay4_out1_1 <= to_unsigned(0, 66);
      ELSIF enb = '1' THEN
  ...
  Data_Type_Conversion2_out1 <= Delay1_out1(65 DOWNTO 41) + ('0' & Delay1_out1(40));
