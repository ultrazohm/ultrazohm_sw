...
float s_3[NUMBER_OF_NEURONS_IN_THIRD_LAYER] = {0};
float s_4[NUMBER_OF_OUTPUTS] = {0};

float delta_1[NUMBER_OF_NEURONS_IN_FIRST_LAYER] = {0};
float delta_2[NUMBER_OF_NEURONS_IN_SECOND_LAYER] = {0};
float delta_3[NUMBER_OF_NEURONS_IN_THIRD_LAYER] = {0};
...
float cacheg_3[NUMBER_OF_NEURONS_IN_THIRD_LAYER * NUMBER_OF_NEURONS_IN_SECOND_LAYER] = {0};
float cacheg_4[NUMBER_OF_OUTPUTS * NUMBER_OF_NEURONS_IN_THIRD_LAYER] = {0};
...
float g_3[NUMBER_OF_NEURONS_IN_THIRD_LAYER + NUMBER_OF_NEURONS_IN_THIRD_LAYER * NUMBER_OF_NEURONS_IN_SECOND_LAYER] = {0};
float g_4[NUMBER_OF_OUTPUTS+NUMBER_OF_OUTPUTS * NUMBER_OF_NEURONS_IN_THIRD_LAYER] = {0};
...
float e_3[NUMBER_OF_NEURONS_IN_THIRD_LAYER]={0.0f};
float e_4[NUMBER_OF_OUTPUTS]={0.0f};

float T1[NUMBER_OF_NEURONS_IN_FIRST_LAYER * NUMBER_OF_NEURONS_IN_SECOND_LAYER] = {0};
float T2[NUMBER_OF_NEURONS_IN_SECOND_LAYER * NUMBER_OF_NEURONS_IN_THIRD_LAYER] = {0};
float T3[NUMBER_OF_NEURONS_IN_THIRD_LAYER * NUMBER_OF_OUTPUTS] = {0};
float T4[4] = {0};
...
struct uz_nn_layer_config software_nn_config[4] = {
    ...
    [1] = {.activation_function = activation_ReLU,       
      ...
      .number_of_temporarycolumns = NUMBER_OF_NEURONS_IN_THIRD_LAYER,
   ...
   .number_of_neurons = NUMBER_OF_NEURONS_IN_THIRD_LAYER,
   .number_of_inputs = NUMBER_OF_NEURONS_IN_SECOND_LAYER,
   .number_of_cachegradrows = NUMBER_OF_NEURONS_IN_THIRD_LAYER,
   .number_of_cachegradcolumns = NUMBER_OF_NEURONS_IN_SECOND_LAYER,
   .number_of_temporarycolumns = NUMBER_OF_NEURONS_IN_THIRD_LAYER,
   .number_of_temporaryrows = NUMBER_OF_OUTPUTS,
   ...
   .number_of_inputs = NUMBER_OF_NEURONS_IN_THIRD_LAYER,
   .number_of_cachegradrows = NUMBER_OF_OUTPUTS,
   .number_of_cachegradcolumns = NUMBER_OF_NEURONS_IN_THIRD_LAYER,
   ...
   .length_of_sumout = UZ_MATRIX_SIZE(s_4),
