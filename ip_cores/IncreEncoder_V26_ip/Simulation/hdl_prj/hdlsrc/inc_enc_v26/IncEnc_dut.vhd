-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\inc_enc_v26\IncEnc_dut.vhd
...
ARCHITECTURE rtl OF IncEnc_dut IS

  -- Component Declarations
  COMPONENT IncEnc_src_IncEnc_V25
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : IncEnc_src_IncEnc_V25
    USE ENTITY work.IncEnc_src_IncEnc_V25(rtl);
...
BEGIN
  u_IncEnc_src_IncEnc_V25 : IncEnc_src_IncEnc_V25
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset_x => reset_x,
              A => A_sig,  -- ufix1
  ...
  position_AXI_wOffset <= position_AXI_wOffset_sig;
