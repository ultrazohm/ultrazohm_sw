...
proc create_ipi_design { offsetfile design_name } {
	...
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins ADC_MAX11331_AXI_0/S_AXI_Lite]
	connect_bd_net [get_bd_pins ADC_MAX11331_AXI_0/s_axi_lite_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins ADC_MAX11331_AXI_0/s_axi_lite_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Copy all address to ADC_MAX11331_AXI_v3_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/ADC_MAX11331_AXI_v3_0_include.tcl"
	set fp [open $offset_file "w"]
	puts $fp "# Configuration address parameters"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_ADC_MAX11331_AXI_0_S_AXI_Lite_* ]]
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/ADC_MAX11331_AXI_v3_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "ADC_MAX11331_AXI_v3_0_hw_${i}"
