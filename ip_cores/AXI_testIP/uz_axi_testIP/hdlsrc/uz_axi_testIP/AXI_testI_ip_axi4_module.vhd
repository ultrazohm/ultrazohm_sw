-- -------------------------------------------------------------
-- 
-- File Name: uz_axi_testIP/hdlsrc/uz_axi_testIP/AXI_testI_ip_axi4_module.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: AXI_testI_ip_axi4_module
-- Source Path: AXI_testI_ip/AXI_testI_ip_axi4/AXI_testI_ip_axi4_module
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY AXI_testI_ip_axi4_module IS
...
END AXI_testI_ip_axi4_module;


ARCHITECTURE rtl OF AXI_testI_ip_axi4_module IS

  -- Component Declarations
  COMPONENT AXI_testI_ip_rdfifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT AXI_testI_ip_rdfifo_rid
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT AXI_testI_ip_rdfifo_last
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : AXI_testI_ip_rdfifo_data
    USE ENTITY work.AXI_testI_ip_rdfifo_data(rtl);

  FOR ALL : AXI_testI_ip_rdfifo_rid
    USE ENTITY work.AXI_testI_ip_rdfifo_rid(rtl);

  FOR ALL : AXI_testI_ip_rdfifo_last
    USE ENTITY work.AXI_testI_ip_rdfifo_last(rtl);
...
BEGIN
  u_AXI_testI_ip_rdfifo_data_inst : AXI_testI_ip_rdfifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
  ...
  u_AXI_testI_ip_rdfifo_rid_inst : AXI_testI_ip_rdfifo_rid
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
  ...
  u_AXI_testI_ip_rdfifo_last_inst : AXI_testI_ip_rdfifo_last
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
