###########################################################################
## Makefile generated for component 'uz_codegen'. 
## 
## Makefile     : uz_codegen.mk
## Generated on : Thu Mar 13 14:42:27 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/uz_codegen.exe
...
COMPILER_COMMAND_FILE     = uz_codegen_comp.rsp
CMD_FILE                  = uz_codegen.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/uz_codegen.exe
...
DEFINES_STANDARD = -DMODEL=uz_codegen -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/uz_codegen_ert_rtw/uz_codegen.c
...
%.obj : $(START_DIR)/uz_codegen_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/uz_codegen_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/uz_codegen_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/uz_codegen_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/uz_codegen_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
uz_codegen.obj : $(START_DIR)/uz_codegen_ert_rtw/uz_codegen.c
	$(CC) $(CFLAGS) -o "$@" "$<"
