...
/**
 * @brief Copies the matrix source into the matrix destination. Requres that source and destination have the same length. Rows, columns, and data will be overwritten by this function!
 * 
