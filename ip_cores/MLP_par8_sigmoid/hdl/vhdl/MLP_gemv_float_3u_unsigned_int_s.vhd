...
entity MLP_gemv_float_3u_unsigned_int_s is
port (
...
architecture behav of MLP_gemv_float_3u_unsigned_int_s is 
...
attribute shreg_extract : string;
    ...
    signal gemv_float_3u_unsigned_int_entry111136_U0_ap_start : STD_LOGIC;
    signal gemv_float_3u_unsigned_int_entry111136_U0_ap_done : STD_LOGIC;
    signal gemv_float_3u_unsigned_int_entry111136_U0_ap_continue : STD_LOGIC;
    signal gemv_float_3u_unsigned_int_entry111136_U0_ap_idle : STD_LOGIC;
    signal gemv_float_3u_unsigned_int_entry111136_U0_ap_ready : STD_LOGIC;
    signal gemv_float_3u_unsigned_int_entry111136_U0_p_m_read : STD_LOGIC;
    signal gemv_float_3u_unsigned_int_entry111136_U0_p_m_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal gemv_float_3u_unsigned_int_entry111136_U0_p_m_out_write : STD_LOGIC;
    signal gemv_float_3u_unsigned_int_entry111136_U0_p_n_read : STD_LOGIC;
    signal gemv_float_3u_unsigned_int_entry111136_U0_p_m_c_i_din : STD_LOGIC_VECTOR (31 downto 0);
    signal gemv_float_3u_unsigned_int_entry111136_U0_p_m_c_i_write : STD_LOGIC;
    signal gemv_float_3u_unsigned_int_entry111136_U0_p_m_c9_i_din : STD_LOGIC_VECTOR (31 downto 0);
    signal gemv_float_3u_unsigned_int_entry111136_U0_p_m_c9_i_write : STD_LOGIC;
    signal gemv_float_3u_unsigned_int_entry111136_U0_p_n_c_i_din : STD_LOGIC_VECTOR (31 downto 0);
    signal gemv_float_3u_unsigned_int_entry111136_U0_p_n_c_i_write : STD_LOGIC;
    ...
    signal ap_sync_reg_gemv_float_3u_unsigned_int_entry111136_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_gemv_float_3u_unsigned_int_entry111136_U0_ap_ready : STD_LOGIC;
    signal gemv_float_3u_unsigned_int_entry111136_U0_ap_ready_count : STD_LOGIC_VECTOR (1 downto 0) := "00";
    ...
    signal gemv_float_3u_unsigned_int_entry111136_U0_start_full_n : STD_LOGIC;
    signal gemv_float_3u_unsigned_int_entry111136_U0_start_write : STD_LOGIC;
    ...
    component MLP_gemv_float_3u_unsigned_int_entry111136 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component MLP_gemv_float_3u_unsigned_int_float_s IS
    port (
        ap_start : IN STD_LOGIC;
        start_full_n : IN STD_LOGIC;
        start_out : OUT STD_LOGIC;
...
begin
    gemv_float_3u_unsigned_int_entry111136_U0 : component MLP_gemv_float_3u_unsigned_int_entry111136
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => gemv_float_3u_unsigned_int_entry111136_U0_ap_start,
        ap_done => gemv_float_3u_unsigned_int_entry111136_U0_ap_done,
        ap_continue => gemv_float_3u_unsigned_int_entry111136_U0_ap_continue,
        ap_idle => gemv_float_3u_unsigned_int_entry111136_U0_ap_idle,
        ap_ready => gemv_float_3u_unsigned_int_entry111136_U0_ap_ready,
        p_m_dout => p_m_dout,
        p_m_empty_n => p_m_empty_n,
        p_m_read => gemv_float_3u_unsigned_int_entry111136_U0_p_m_read,
        p_m_out_din => gemv_float_3u_unsigned_int_entry111136_U0_p_m_out_din,
        p_m_out_full_n => p_m_out_full_n,
        p_m_out_write => gemv_float_3u_unsigned_int_entry111136_U0_p_m_out_write,
        p_n_dout => p_n_dout,
        p_n_empty_n => p_n_empty_n,
        p_n_read => gemv_float_3u_unsigned_int_entry111136_U0_p_n_read,
        p_m_c_i_din => gemv_float_3u_unsigned_int_entry111136_U0_p_m_c_i_din,
        p_m_c_i_full_n => p_m_c_i_full_n,
        p_m_c_i_write => gemv_float_3u_unsigned_int_entry111136_U0_p_m_c_i_write,
        p_m_c9_i_din => gemv_float_3u_unsigned_int_entry111136_U0_p_m_c9_i_din,
        p_m_c9_i_full_n => p_m_c9_i_full_n,
        p_m_c9_i_write => gemv_float_3u_unsigned_int_entry111136_U0_p_m_c9_i_write,
        p_n_c_i_din => gemv_float_3u_unsigned_int_entry111136_U0_p_n_c_i_din,
        p_n_c_i_full_n => p_n_c_i_full_n,
        p_n_c_i_write => gemv_float_3u_unsigned_int_entry111136_U0_p_n_c_i_write);

    gemv_float_3u_unsigned_int_float_U0 : component MLP_gemv_float_3u_unsigned_int_float_s
    port map (
    ...
    port map (
        ...
        if_din => gemv_float_3u_unsigned_int_entry111136_U0_p_m_c_i_din,
        if_full_n => p_m_c_i_full_n,
        if_write => gemv_float_3u_unsigned_int_entry111136_U0_p_m_c_i_write,
    ...
    port map (
        ...
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => gemv_float_3u_unsigned_int_entry111136_U0_p_m_c9_i_din,
        if_full_n => p_m_c9_i_full_n,
        if_write => gemv_float_3u_unsigned_int_entry111136_U0_p_m_c9_i_write,
    ...
    port map (
        ...
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => gemv_float_3u_unsigned_int_entry111136_U0_p_n_c_i_din,
        if_full_n => p_n_c_i_full_n,
        if_write => gemv_float_3u_unsigned_int_entry111136_U0_p_n_c_i_write,
    ...
    ap_sync_reg_gemv_float_3u_unsigned_int_entry111136_U0_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ap_sync_reg_gemv_float_3u_unsigned_int_entry111136_U0_ap_ready <= ap_const_logic_0;
            else
                if (((real_start and ap_sync_ready) = ap_const_logic_1)) then 
                    ap_sync_reg_gemv_float_3u_unsigned_int_entry111136_U0_ap_ready <= ap_const_logic_0;
                else 
                    ap_sync_reg_gemv_float_3u_unsigned_int_entry111136_U0_ap_ready <= ap_sync_gemv_float_3u_unsigned_int_entry111136_U0_ap_ready;
                end if; 
            end if;
        end if;
    end process;
    ...
    gemv_float_3u_unsigned_int_entry111136_U0_ap_ready_count_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((gemv_float_3u_unsigned_int_entry111136_U0_ap_ready = ap_const_logic_0) and (ap_sync_ready = ap_const_logic_1))) then 
                gemv_float_3u_unsigned_int_entry111136_U0_ap_ready_count <= std_logic_vector(unsigned(gemv_float_3u_unsigned_int_entry111136_U0_ap_ready_count) - unsigned(ap_const_lv2_1));
            elsif (((gemv_float_3u_unsigned_int_entry111136_U0_ap_ready = ap_const_logic_1) and (ap_sync_ready = ap_const_logic_0))) then 
                gemv_float_3u_unsigned_int_entry111136_U0_ap_ready_count <= std_logic_vector(unsigned(gemv_float_3u_unsigned_int_entry111136_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;
    ...
    ap_idle <= (scal_float_1u_unsigned_int_U0_ap_idle and gemv_float_3u_unsigned_int_float_U0_ap_idle and gemv_float_3u_unsigned_int_entry111136_U0_ap_idle and axpy_float_1u_unsigned_int_U0_ap_idle);
    ap_ready <= internal_ap_ready;
    ap_sync_continue <= (ap_sync_done and ap_continue);
    ap_sync_done <= (gemv_float_3u_unsigned_int_entry111136_U0_ap_done and axpy_float_1u_unsigned_int_U0_ap_done);
    ap_sync_gemv_float_3u_unsigned_int_entry111136_U0_ap_ready <= (gemv_float_3u_unsigned_int_entry111136_U0_ap_ready or ap_sync_reg_gemv_float_3u_unsigned_int_entry111136_U0_ap_ready);
    ...
    ap_sync_ready <= (ap_sync_scal_float_1u_unsigned_int_U0_ap_ready and ap_sync_gemv_float_3u_unsigned_int_float_U0_ap_ready and ap_sync_gemv_float_3u_unsigned_int_entry111136_U0_ap_ready);
    ...
    gemv_float_3u_unsigned_int_entry111136_U0_ap_continue <= ap_sync_continue;
    gemv_float_3u_unsigned_int_entry111136_U0_ap_start <= (real_start and (ap_sync_reg_gemv_float_3u_unsigned_int_entry111136_U0_ap_ready xor ap_const_logic_1));
    gemv_float_3u_unsigned_int_entry111136_U0_start_full_n <= ap_const_logic_1;
    gemv_float_3u_unsigned_int_entry111136_U0_start_write <= ap_const_logic_0;
    ...
    l_strInput5_read <= gemv_float_3u_unsigned_int_float_U0_p_x_read;
    l_strMv6_din <= axpy_float_1u_unsigned_int_U0_l_strMv8_din;
    l_strMv6_write <= axpy_float_1u_unsigned_int_U0_l_strMv8_write;
    l_strWeights4_read <= gemv_float_3u_unsigned_int_float_U0_p_M_read;
    p_m_out_din <= gemv_float_3u_unsigned_int_entry111136_U0_p_m_out_din;
    p_m_out_write <= gemv_float_3u_unsigned_int_entry111136_U0_p_m_out_write;
    p_m_read <= gemv_float_3u_unsigned_int_entry111136_U0_p_m_read;
    p_n_read <= gemv_float_3u_unsigned_int_entry111136_U0_p_n_read;
