-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_d_inverter_adapter\uz_d_inverter_adapter_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_d_inverter_adapter_axi_lite
-- Source Path: uz_d_inverter_adapter/uz_d_inverter_adapter_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_d_inverter_adapter_axi_lite IS
...
END uz_d_inverter_adapter_axi_lite;


ARCHITECTURE rtl OF uz_d_inverter_adapter_axi_lite IS

  -- Component Declarations
  COMPONENT uz_d_inverter_adapter_addr_decoder
  ...
  COMPONENT uz_d_inverter_adapter_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : uz_d_inverter_adapter_addr_decoder
    USE ENTITY work.uz_d_inverter_adapter_addr_decoder(rtl);

  FOR ALL : uz_d_inverter_adapter_axi_lite_module
    USE ENTITY work.uz_d_inverter_adapter_axi_lite_module(rtl);
...
BEGIN
  u_uz_d_inverter_adapter_addr_decoder_inst : uz_d_inverter_adapter_addr_decoder
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
              ...
              read_AXI_Temp_1_period => read_AXI_Temp_1_period,  -- ufix32
              read_AXI_Temp_1_hightime => read_AXI_Temp_1_hightime,  -- ufix32
              read_AXI_Temp_1_lowtime => read_AXI_Temp_1_lowtime,  -- ufix32
              read_AXI_Temp_1_dutycyc => read_AXI_Temp_1_dutycyc,  -- ufix32_En31
              read_AXI_Temp_2_period => read_AXI_Temp_2_period,  -- ufix32
              read_AXI_Temp_2_hightime => read_AXI_Temp_2_hightime,  -- ufix32
              read_AXI_Temp_2_lowtime => read_AXI_Temp_2_lowtime,  -- ufix32
              read_AXI_Temp_2_dutycyc => read_AXI_Temp_2_dutycyc,  -- ufix32_En31
              read_AXI_Temp_3_period => read_AXI_Temp_3_period,  -- ufix32
              read_AXI_Temp_3_hightime => read_AXI_Temp_3_hightime,  -- ufix32
              read_AXI_Temp_3_lowtime => read_AXI_Temp_3_lowtime,  -- ufix32
              read_AXI_Temp_3_dutycyc => read_AXI_Temp_3_dutycyc,  -- ufix32_En31
              read_AXI_Temp_4_period => read_AXI_Temp_4_period,  -- ufix32
              read_AXI_Temp_4_hightime => read_AXI_Temp_4_hightime,  -- ufix32
              read_AXI_Temp_4_lowtime => read_AXI_Temp_4_lowtime,  -- ufix32
              read_AXI_Temp_4_dutycyc => read_AXI_Temp_4_dutycyc,  -- ufix32_En31
              read_AXI_Temp_5_period => read_AXI_Temp_5_period,  -- ufix32
              read_AXI_Temp_5_hightime => read_AXI_Temp_5_hightime,  -- ufix32
              read_AXI_Temp_5_lowtime => read_AXI_Temp_5_lowtime,  -- ufix32
              read_AXI_Temp_5_dutycyc => read_AXI_Temp_5_dutycyc,  -- ufix32_En31
              read_AXI_Temp_6_period => read_AXI_Temp_6_period,  -- ufix32
              read_AXI_Temp_6_hightime => read_AXI_Temp_6_hightime,  -- ufix32
              read_AXI_Temp_6_lowtime => read_AXI_Temp_6_lowtime,  -- ufix32
              read_AXI_Temp_6_dutycyc => read_AXI_Temp_6_dutycyc,  -- ufix32_En31
              read_AXI_FAULT => read_AXI_FAULT,  -- ufix6
              read_AXI_OC => read_AXI_OC,  -- ufix6
  ...
  u_uz_d_inverter_adapter_axi_lite_module_inst : uz_d_inverter_adapter_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
