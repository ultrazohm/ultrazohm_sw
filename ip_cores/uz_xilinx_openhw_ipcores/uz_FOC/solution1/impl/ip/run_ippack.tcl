...
set xo_kernel_name "uz_FOC"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "C:/Users/valen/Documents/repos/UZ/ultrazohm_sw/ip_cores/uz_xilinx_openhw_ipcores/uz_FOC/solution1"
set debug_dir "C:/Users/valen/Documents/repos/UZ/ultrazohm_sw/ip_cores/uz_xilinx_openhw_ipcores/uz_FOC/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {uz_FOC_faddfsub_32ns_32ns_32_5_full_dsp_1
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x10 sampletime W 0x0 "Data signal of sampletime" {{0 32 sampletime W 0 "Bit 31 to 0 of sampletime"}}} {0x18 set_i_d W 0x0 "Data signal of set_i_d" {{0 32 set_i_d W 0 "Bit 31 to 0 of set_i_d"}}} {0x20 set_i_q W 0x0 "Data signal of set_i_q" {{0 32 set_i_q W 0 "Bit 31 to 0 of set_i_q"}}} {0x28 KP_d W 0x0 "Data signal of KP_d" {{0 32 KP_d W 0 "Bit 31 to 0 of KP_d"}}} {0x30 KI_d W 0x0 "Data signal of KI_d" {{0 32 KI_d W 0 "Bit 31 to 0 of KI_d"}}} {0x38 KP_q W 0x0 "Data signal of KP_q" {{0 32 KP_q W 0 "Bit 31 to 0 of KP_q"}}} {0x40 KI_q W 0x0 "Data signal of KI_q" {{0 32 KI_q W 0 "Bit 31 to 0 of KI_q"}}} {0x48 reset_PS W 0x0 "Data signal of reset_PS" {{0 1 reset_PS W 0 "Bit 0 to 0 of reset_PS"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x50 limit W 0x0 "Data signal of limit" {{0 32 limit W 0 "Bit 31 to 0 of limit"}}} {0x58 out_KP_d R 0x0 "Data signal of out_KP_d" {{0 32 out_KP_d R 0 "Bit 31 to 0 of out_KP_d"}}} {0x5c out_KP_d_ctrl R 0x0 "Control signal of out_KP_d" {{0 1 out_KP_d_ap_vld R 0 "Control signal out_KP_d_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x68 out_idref R 0x0 "Data signal of out_idref" {{0 32 out_idref R 0 "Bit 31 to 0 of out_idref"}}} {0x6c out_idref_ctrl R 0x0 "Control signal of out_idref" {{0 1 out_idref_ap_vld R 0 "Control signal out_idref_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x78 out_status R 0x0 "Data signal of out_status" {{0 1 out_status R 0 "Bit 0 to 0 of out_status"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x7c out_status_ctrl R 0x0 "Control signal of out_status" {{0 1 out_status_ap_vld R 0 "Control signal out_status_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
