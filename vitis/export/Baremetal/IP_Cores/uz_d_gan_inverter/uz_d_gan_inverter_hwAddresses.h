...
#define  IPCore_Timestamp_UZ_D_GaN_ip               0x8  //contains unique IP timestamp (yymmddHHMM): 2104272122
...
#define  AXI_GaN_FAULT_H1_Data_UZ_D_GaN_ip          0x160  //data register for Outport AXI_GaN_FAULT_H1
#define  AXI_GaN_FAULT_L1_Data_UZ_D_GaN_ip          0x164  //data register for Outport AXI_GaN_FAULT_L1
#define  AXI_GaN_FAULT_H2_Data_UZ_D_GaN_ip          0x168  //data register for Outport AXI_GaN_FAULT_H2
#define  AXI_GaN_FAULT_L2_Data_UZ_D_GaN_ip          0x16C  //data register for Outport AXI_GaN_FAULT_L2
#define  AXI_GaN_FAULT_H3_Data_UZ_D_GaN_ip          0x170  //data register for Outport AXI_GaN_FAULT_H3
#define  AXI_GaN_FAULT_L3_Data_UZ_D_GaN_ip          0x174  //data register for Outport AXI_GaN_FAULT_L3
#define  AXI_GaN_OC_H1_Data_UZ_D_GaN_ip             0x178  //data register for Outport AXI_GaN_OC_H1
#define  AXI_GaN_OC_L1_Data_UZ_D_GaN_ip             0x17C  //data register for Outport AXI_GaN_OC_L1
#define  AXI_GaN_OC_H2_Data_UZ_D_GaN_ip             0x180  //data register for Outport AXI_GaN_OC_H2
#define  AXI_GaN_OC_L2_Data_UZ_D_GaN_ip             0x184  //data register for Outport AXI_GaN_OC_L2
#define  AXI_GaN_OC_H3_Data_UZ_D_GaN_ip             0x188  //data register for Outport AXI_GaN_OC_H3
#define  AXI_GaN_OC_L3_Data_UZ_D_GaN_ip             0x18C  //data register for Outport AXI_GaN_OC_L3
#define  AXI_I_DIAG_Data_UZ_D_GaN_ip                0x190  //data register for Outport AXI_I_DIAG
#define  AXI_I1_DIAG_Data_UZ_D_GaN_ip               0x194  //data register for Outport AXI_I1_DIAG
#define  AXI_I2_DIAG_Data_UZ_D_GaN_ip               0x198  //data register for Outport AXI_I2_DIAG
#define  AXI_I3_DIAG_Data_UZ_D_GaN_ip               0x19C  //data register for Outport AXI_I3_DIAG
#define  AXI_PWM_Enable_Data_UZ_D_GaN_ip            0x1A0  //data register for Inport AXI_PWM_Enable
