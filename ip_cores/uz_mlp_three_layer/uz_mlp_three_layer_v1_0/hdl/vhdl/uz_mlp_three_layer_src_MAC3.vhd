-- -------------------------------------------------------------
-- 
-- File Name: /home/ts/Documents/integrate_nn_to_uz/ultrazohm_sw/ip_cores/nnAXI_v1_0/hdl_prj/hdlsrc/uz_mlp_three_layer/uz_mlp_three_layer_src_MAC3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_mlp_three_layer_src_MAC3
-- Source Path: uz_mlp_three_layer/uz_mlp_three_layer/reluLayer_4Parallel/MAC3
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_mlp_three_layer_src_MAC3 IS
...
END uz_mlp_three_layer_src_MAC3;


ARCHITECTURE rtl OF uz_mlp_three_layer_src_MAC3 IS

  -- Component Declarations
  COMPONENT uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block12
  ...
  COMPONENT uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block14
    GENERIC( AddrWidth                    : integer;
             DataWidth                    : integer
             );
    PORT( clk                             :   IN    std_logic;
  ...
  COMPONENT uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block13
    GENERIC( AddrWidth                    : integer;
             DataWidth                    : integer
             );
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block12
    USE ENTITY work.uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block12(rtl);

  FOR ALL : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block14
    USE ENTITY work.uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block14(rtl);

  FOR ALL : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block13
    USE ENTITY work.uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block13(rtl);
  ...
  SIGNAL Gain_mul_temp                    : unsigned(19 DOWNTO 0);  -- ufix20_En6
...
BEGIN
  u_Dual_Port_RAM_System1 : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block12
  ...
  u_Dual_Port_RAM_System3 : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block14
    GENERIC MAP( AddrWidth => 10,
                 DataWidth => 32
                 )
    PORT MAP( clk => clk,
  ...
  u_Dual_Port_RAM_System2 : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block13
    GENERIC MAP( AddrWidth => 10,
                 DataWidth => 32
                 )
    PORT MAP( clk => clk,
  ...
  Compare_To_Constant1_out1 <= '1' WHEN axi_biasWriteEnable = to_unsigned(16#01#, 8) ELSE
      '0';

  axi_layerNr <= unsigned(axi_signals_axi_layerNr);

  
  Compare_To_Constant2_out1 <= '1' WHEN axi_layerNr = to_unsigned(16#01#, 8) ELSE
      '0';
  ...
  Compare_To_Constant_out1 <= '1' WHEN axi_weightsWriteEnable = to_unsigned(16#01#, 8) ELSE
      '0';
  ...
  -- CSD Encoding (832) : 01101000000; Cost (Adders) = 2
  Gain_mul_temp <= (resize(n_perceptron & '0' & '0' & '0' & '0' & '0' & '0' & '0' & '0' & '0', 20) + resize(n_perceptron & '0' & '0' & '0' & '0' & '0' & '0' & '0' & '0', 20)) + resize(n_perceptron & '0' & '0' & '0' & '0' & '0' & '0', 20);
  Gain_out1 <= Gain_mul_temp(15 DOWNTO 6);
  ...
  Multiply_Accumulate1_delay_startout_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        startout_1 <= '0';
      ELSIF enb = '1' THEN
        startout_1 <= Multiply_Accumulate1_and1_out;
      END IF;
    END IF;
  END PROCESS Multiply_Accumulate1_delay_startout_process;


  endin <= fromStateMachine_endin;

  Multiply_Accumulate1_and2_out <= validIn AND endin;

  Multiply_Accumulate1_delay_endout_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        endout_1 <= '0';
      ELSIF enb = '1' THEN
        endout_1 <= Multiply_Accumulate1_and2_out;
      END IF;
    END IF;
  END PROCESS Multiply_Accumulate1_delay_endout_process;
