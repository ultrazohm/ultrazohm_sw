...
enum JS_OberservableData {
	...
	JSO_Resolver_theta_mech,
	JSO_Resolver_theta_elec,
	JSO_Resolver_Speed_rpm,
	JSO_Resolver_el_Speed_rad_s,
	JSO_ENDMARKER
};
...
enum JS_SlowData {
	...
	JSSD_FLOAT_Resolver_theta_mech,
	JSSD_FLOAT_Resolver_theta_elec,
	JSSD_FLOAT_Resolver_Speed_rpm,
	JSSD_FLOAT_Resolver_el_Speed_rad_s,
	JSSD_ENDMARKER
};
