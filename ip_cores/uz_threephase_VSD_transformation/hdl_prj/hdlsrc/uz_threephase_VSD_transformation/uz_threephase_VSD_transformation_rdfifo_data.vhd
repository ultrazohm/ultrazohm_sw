-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\valen\Documents\repos\UZ\ultrazohm_sw_working\ip_cores\uz_threephase_VSD_transformation\hdl_pj\hdlsrc\uz_threephase_VSD_transformation\uz_threephase_VSD_transformation_rdfifo_data.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_threephase_VSD_transformation_rdfifo_data
-- Source Path: uz_threephase_VSD_transformation/uz_threephase_VSD_transformation_axi4/uz_threephase_VSD_transformation_axi4_module/uz_threephase_VSD_transformation_rdfifo_data
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_threephase_VSD_transformation_rdfifo_data IS
...
END uz_threephase_VSD_transformation_rdfifo_data;


ARCHITECTURE rtl OF uz_threephase_VSD_transformation_rdfifo_data IS

  -- Component Declarations
  COMPONENT uz_threephase_VSD_transformation_SimpleDualPortRAM_generic
  ...
  FOR ALL : uz_threephase_VSD_transformation_SimpleDualPortRAM_generic
    USE ENTITY work.uz_threephase_VSD_transformation_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_uz_threephase_VSD_transformation_rdfifo_data_classic_ram_generic : uz_threephase_VSD_transformation_SimpleDualPortRAM_generic
