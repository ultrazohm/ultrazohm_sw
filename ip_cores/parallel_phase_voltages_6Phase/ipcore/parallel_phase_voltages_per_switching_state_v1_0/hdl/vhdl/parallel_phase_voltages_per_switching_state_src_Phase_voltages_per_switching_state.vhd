-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\parallel_phase_voltages_6Phase\hdlsrc\parallel_phase_voltages_per_switching_state_6\parallel_phase_voltages_per_switching_state_src_Phase_voltages_per_switching_state.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: parallel_phase_voltages_per_switching_state_src_Phase_voltages_per_switching_state
...
ENTITY parallel_phase_voltages_per_switching_state_src_Phase_voltages_per_switching_state IS
...
END parallel_phase_voltages_per_switching_state_src_Phase_voltages_per_switching_state;


ARCHITECTURE rtl OF parallel_phase_voltages_per_switching_state_src_Phase_voltages_per_switching_state IS

  -- Component Declarations
  COMPONENT parallel_phase_voltages_per_switching_state_src_Detect_Rise_Positive1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  COMPONENT parallel_phase_voltages_per_switching_state_src_Detect_Rise_Positive
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  COMPONENT parallel_phase_voltages_per_switching_state_src_nfp_convert_sfix_24_En20_to_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT parallel_phase_voltages_per_switching_state_src_nfp_sub_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT parallel_phase_voltages_per_switching_state_src_nfp_relop_single_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          nfp_in1                         :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT parallel_phase_voltages_per_switching_state_src_nfp_relop_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          nfp_in1                         :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT parallel_phase_voltages_per_switching_state_src_Subsystem
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : parallel_phase_voltages_per_switching_state_src_Detect_Rise_Positive1
    USE ENTITY work.parallel_phase_voltages_per_switching_state_src_Detect_Rise_Positive1(rtl);

  FOR ALL : parallel_phase_voltages_per_switching_state_src_Detect_Rise_Positive
    USE ENTITY work.parallel_phase_voltages_per_switching_state_src_Detect_Rise_Positive(rtl);

  FOR ALL : parallel_phase_voltages_per_switching_state_src_nfp_convert_sfix_24_En20_to_single
    USE ENTITY work.parallel_phase_voltages_per_switching_state_src_nfp_convert_sfix_24_En20_to_single(rtl);

  FOR ALL : parallel_phase_voltages_per_switching_state_src_nfp_sub_single
    USE ENTITY work.parallel_phase_voltages_per_switching_state_src_nfp_sub_single(rtl);

  FOR ALL : parallel_phase_voltages_per_switching_state_src_nfp_relop_single_block
    USE ENTITY work.parallel_phase_voltages_per_switching_state_src_nfp_relop_single_block(rtl);

  FOR ALL : parallel_phase_voltages_per_switching_state_src_nfp_relop_single
    USE ENTITY work.parallel_phase_voltages_per_switching_state_src_nfp_relop_single(rtl);
  ...
  FOR ALL : parallel_phase_voltages_per_switching_state_src_Subsystem
    USE ENTITY work.parallel_phase_voltages_per_switching_state_src_Subsystem(rtl);

  FOR ALL : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    USE ENTITY work.parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11(rtl);
...
BEGIN
  u_Detect_Rise_Positive1 : parallel_phase_voltages_per_switching_state_src_Detect_Rise_Positive1
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_Detect_Rise_Positive : parallel_phase_voltages_per_switching_state_src_Detect_Rise_Positive
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              U => Delay21_out1,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_sfix_24_En20_to_single : parallel_phase_voltages_per_switching_state_src_nfp_convert_sfix_24_En20_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_nfp_sub_comp : parallel_phase_voltages_per_switching_state_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_nfp_relop_comp : parallel_phase_voltages_per_switching_state_src_nfp_relop_single_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_nfp_relop_comp_1 : parallel_phase_voltages_per_switching_state_src_nfp_relop_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in1 => Add1_out1,  -- single
  ...
  u_nfp_sub_comp_1 : parallel_phase_voltages_per_switching_state_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in1 => Add1_out1,  -- single
  ...
  u_Subsystem : parallel_phase_voltages_per_switching_state_src_Subsystem
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_1 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_2 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_3 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_4 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_5 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_6 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_7 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_8 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_9 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_10 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_11 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_12 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_13 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_14 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_15 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_16 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_17 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_18 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_19 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_20 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_21 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_22 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_23 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_24 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_25 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_26 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_27 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_28 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_29 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_30 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_31 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_32 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_33 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_34 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_35 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_36 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_37 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_38 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_39 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_40 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_41 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_42 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_43 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_44 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_45 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_46 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_47 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_48 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_49 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_50 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_51 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_52 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_53 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_54 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_55 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_56 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_57 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_58 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_59 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_60 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_61 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_62 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_parallel_phase_voltages_per_switching_state_6_Phase_voltages_per_switching_state_nfp_convert_single_to_sfix_24_En11_63 : parallel_phase_voltages_per_switching_state_src_nfp_convert_single_to_sfix_24_En11
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
