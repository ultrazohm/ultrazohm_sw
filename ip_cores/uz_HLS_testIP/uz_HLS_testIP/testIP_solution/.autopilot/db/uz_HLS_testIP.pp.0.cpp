...
# 2 "./uz_HLS_testIP.cpp" 2
# 1 "./uz_HLS_testIP.h" 1
__attribute__((sdx_kernel("uz_HLS_testIP", 0))) void uz_HLS_testIP(int32_t a, int32_t b, int32_t *result);
# 3 "./uz_HLS_testIP.cpp" 2

__attribute__((sdx_kernel("uz_HLS_testIP", 0))) void uz_HLS_testIP(int32_t a, int32_t b, int32_t *result) {
#line 15 "C:/Repos/ultrazohm_sw2/ip_cores/uz_HLS_testIP/testIP_solution/script.tcl"
#pragma HLSDIRECTIVE TOP name=uz_HLS_testIP
# 4 "./uz_HLS_testIP.cpp"
