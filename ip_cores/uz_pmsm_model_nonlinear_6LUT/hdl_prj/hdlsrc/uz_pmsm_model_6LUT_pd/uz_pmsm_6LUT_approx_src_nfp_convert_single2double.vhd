-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\Philipp\ultrazohm\ultrazohm_sw\ip_cores\uz_pmsm_model_nonlinear_6LUT\hdl_prj\hdlsrc\uz_pmsm_model_6LUT_pd\uz_pmsm_6LUT_approx_src_nfp_convert_single2double.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_6LUT_approx_src_nfp_convert_single2double
-- Source Path: uz_pmsm_model_6LUT_pd/uz_pmsm_model_6LUT/nfp_convert_single2double
-- Hierarchy Level: 1
-- Model version: 7.14
-- 
...
ENTITY uz_pmsm_6LUT_approx_src_nfp_convert_single2double IS
...
END uz_pmsm_6LUT_approx_src_nfp_convert_single2double;


ARCHITECTURE rtl OF uz_pmsm_6LUT_approx_src_nfp_convert_single2double IS
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay14_PS_2_4_reg(0) <= alphainExponent_0_inMantis_out1;
