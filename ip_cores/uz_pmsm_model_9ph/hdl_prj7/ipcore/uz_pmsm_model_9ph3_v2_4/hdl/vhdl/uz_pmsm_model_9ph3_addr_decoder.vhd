-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj7/hdlsrc/uz_pmsm_model_9ph_21b_all_double/uz_pmsm_model_9ph3_addr_decoder.vhd
-- Created: 2022-06-04 17:39:15
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_9ph3_addr_decoder
-- Source Path: uz_pmsm_model_9ph3/uz_pmsm_model_9ph3_axi4/uz_pmsm_model_9ph3_addr_decoder
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_pmsm_model_9ph3_addr_decoder IS
...
END uz_pmsm_model_9ph3_addr_decoder;


ARCHITECTURE rtl OF uz_pmsm_model_9ph3_addr_decoder IS
  ...
  SIGNAL read_outputs_unsigned            : vector_of_unsigned32(0 TO 2);  -- ufix32 [3]
  SIGNAL sync_reg_outputs                 : vector_of_unsigned32(0 TO 2);  -- ufix32 [3]
  SIGNAL data_slice_outputs_1             : vector_of_unsigned32(0 TO 2);  -- ufix32 [3]
  ...
  SIGNAL read_i_abc_ps_unsigned           : vector_of_unsigned32(0 TO 8);  -- ufix32 [9]
  SIGNAL sync_reg_i_abc_ps                : vector_of_unsigned32(0 TO 8);  -- ufix32 [9]
  SIGNAL data_slice_i_abc_ps_1            : vector_of_unsigned32(0 TO 8);  -- ufix32 [9]
  SIGNAL decode_sel_i_abc_ps_1_2          : std_logic;  -- ufix1
  SIGNAL data_slice_i_abc_ps_1_0          : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_i_abc_ps_1_1           : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_sel_i_abc_ps_1_3          : std_logic;  -- ufix1
  SIGNAL data_slice_i_abc_ps_1_1          : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_i_abc_ps_1_2           : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_sel_i_abc_ps_1_4          : std_logic;  -- ufix1
  SIGNAL data_slice_i_abc_ps_1_2          : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_i_abc_ps_1_3           : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_sel_i_abc_ps_1_5          : std_logic;  -- ufix1
  SIGNAL data_slice_i_abc_ps_1_3          : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_i_abc_ps_1_4           : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_sel_i_abc_ps_1_6          : std_logic;  -- ufix1
  SIGNAL data_slice_i_abc_ps_1_4          : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_i_abc_ps_1_5           : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_sel_i_abc_ps_1_7          : std_logic;  -- ufix1
  SIGNAL data_slice_i_abc_ps_1_5          : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_i_abc_ps_1_6           : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_sel_i_abc_ps_1_8          : std_logic;  -- ufix1
  SIGNAL data_slice_i_abc_ps_1_6          : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_i_abc_ps_1_7           : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_sel_i_abc_ps_1_9          : std_logic;  -- ufix1
  SIGNAL data_slice_i_abc_ps_1_7          : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_i_abc_ps_1_8           : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL data_slice_i_abc_ps_1_8          : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_i_abc_ps_1_9           : unsigned(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL write_reg_input                  : vector_of_unsigned32(0 TO 1);  -- ufix32 [2]
  SIGNAL sync_reg_input_1                 : vector_of_unsigned32(0 TO 1);  -- ufix32 [2]
...
BEGIN
  ...
  decode_sel_outputs <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0084#, 14) ELSE
      '0';
  ...
  decode_sel_i_abc_ps_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0100#, 14) ELSE
      '0';
  ...
  decode_sel_i_abc_ps <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0110#, 14) ELSE
      '0';
  ...
  outputgen1: FOR k IN 0 TO 8 GENERATE
    read_i_abc_ps_unsigned(k) <= unsigned(read_i_abc_ps(k));
  END GENERATE;

  reg_i_abc_ps_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        sync_reg_i_abc_ps(0) <= to_unsigned(0, 32);
        sync_reg_i_abc_ps(1) <= to_unsigned(0, 32);
        sync_reg_i_abc_ps(2) <= to_unsigned(0, 32);
        sync_reg_i_abc_ps(3) <= to_unsigned(0, 32);
        sync_reg_i_abc_ps(4) <= to_unsigned(0, 32);
        sync_reg_i_abc_ps(5) <= to_unsigned(0, 32);
        sync_reg_i_abc_ps(6) <= to_unsigned(0, 32);
        sync_reg_i_abc_ps(7) <= to_unsigned(0, 32);
        sync_reg_i_abc_ps(8) <= to_unsigned(0, 32);
      ELSIF enb = '1' AND strobe_reg_i_abc_ps = '1' THEN
        sync_reg_i_abc_ps(0) <= read_i_abc_ps_unsigned(0);
        sync_reg_i_abc_ps(1) <= read_i_abc_ps_unsigned(1);
        sync_reg_i_abc_ps(2) <= read_i_abc_ps_unsigned(2);
        sync_reg_i_abc_ps(3) <= read_i_abc_ps_unsigned(3);
        sync_reg_i_abc_ps(4) <= read_i_abc_ps_unsigned(4);
        sync_reg_i_abc_ps(5) <= read_i_abc_ps_unsigned(5);
        sync_reg_i_abc_ps(6) <= read_i_abc_ps_unsigned(6);
        sync_reg_i_abc_ps(7) <= read_i_abc_ps_unsigned(7);
        sync_reg_i_abc_ps(8) <= read_i_abc_ps_unsigned(8);
      END IF;
    END IF;
  END PROCESS reg_i_abc_ps_process;


  data_slice_i_abc_ps_1(0) <= sync_reg_i_abc_ps(0);
  data_slice_i_abc_ps_1(1) <= sync_reg_i_abc_ps(1);
  data_slice_i_abc_ps_1(2) <= sync_reg_i_abc_ps(2);
  data_slice_i_abc_ps_1(3) <= sync_reg_i_abc_ps(3);
  data_slice_i_abc_ps_1(4) <= sync_reg_i_abc_ps(4);
  data_slice_i_abc_ps_1(5) <= sync_reg_i_abc_ps(5);
  data_slice_i_abc_ps_1(6) <= sync_reg_i_abc_ps(6);
  data_slice_i_abc_ps_1(7) <= sync_reg_i_abc_ps(7);
  data_slice_i_abc_ps_1(8) <= sync_reg_i_abc_ps(8);

  
  decode_sel_i_abc_ps_1_2 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0101#, 14) ELSE
      '0';

  data_slice_i_abc_ps_1_0 <= data_slice_i_abc_ps_1(0);

  
  decode_rd_i_abc_ps_1_1 <= decode_rd_outputs_1_3 WHEN decode_sel_i_abc_ps_1_1 = '0' ELSE
      data_slice_i_abc_ps_1_0;

  
  decode_sel_i_abc_ps_1_3 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0102#, 14) ELSE
      '0';

  data_slice_i_abc_ps_1_1 <= data_slice_i_abc_ps_1(1);

  
  decode_rd_i_abc_ps_1_2 <= decode_rd_i_abc_ps_1_1 WHEN decode_sel_i_abc_ps_1_2 = '0' ELSE
      data_slice_i_abc_ps_1_1;

  
  decode_sel_i_abc_ps_1_4 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0103#, 14) ELSE
      '0';

  data_slice_i_abc_ps_1_2 <= data_slice_i_abc_ps_1(2);

  
  decode_rd_i_abc_ps_1_3 <= decode_rd_i_abc_ps_1_2 WHEN decode_sel_i_abc_ps_1_3 = '0' ELSE
      data_slice_i_abc_ps_1_2;

  
  decode_sel_i_abc_ps_1_5 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0104#, 14) ELSE
      '0';

  data_slice_i_abc_ps_1_3 <= data_slice_i_abc_ps_1(3);

  
  decode_rd_i_abc_ps_1_4 <= decode_rd_i_abc_ps_1_3 WHEN decode_sel_i_abc_ps_1_4 = '0' ELSE
      data_slice_i_abc_ps_1_3;

  
  decode_sel_i_abc_ps_1_6 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0105#, 14) ELSE
      '0';

  data_slice_i_abc_ps_1_4 <= data_slice_i_abc_ps_1(4);

  
  decode_rd_i_abc_ps_1_5 <= decode_rd_i_abc_ps_1_4 WHEN decode_sel_i_abc_ps_1_5 = '0' ELSE
      data_slice_i_abc_ps_1_4;

  
  decode_sel_i_abc_ps_1_7 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0106#, 14) ELSE
      '0';

  data_slice_i_abc_ps_1_5 <= data_slice_i_abc_ps_1(5);

  
  decode_rd_i_abc_ps_1_6 <= decode_rd_i_abc_ps_1_5 WHEN decode_sel_i_abc_ps_1_6 = '0' ELSE
      data_slice_i_abc_ps_1_5;

  
  decode_sel_i_abc_ps_1_8 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0107#, 14) ELSE
      '0';

  data_slice_i_abc_ps_1_6 <= data_slice_i_abc_ps_1(6);

  
  decode_rd_i_abc_ps_1_7 <= decode_rd_i_abc_ps_1_6 WHEN decode_sel_i_abc_ps_1_7 = '0' ELSE
      data_slice_i_abc_ps_1_6;

  
  decode_sel_i_abc_ps_1_9 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0108#, 14) ELSE
      '0';

  data_slice_i_abc_ps_1_7 <= data_slice_i_abc_ps_1(7);

  
  decode_rd_i_abc_ps_1_8 <= decode_rd_i_abc_ps_1_7 WHEN decode_sel_i_abc_ps_1_8 = '0' ELSE
      data_slice_i_abc_ps_1_7;

  data_slice_i_abc_ps_1_8 <= data_slice_i_abc_ps_1(8);

  
  decode_rd_i_abc_ps_1_9 <= decode_rd_i_abc_ps_1_8 WHEN decode_sel_i_abc_ps_1_9 = '0' ELSE
      data_slice_i_abc_ps_1_8;

  data_read <= std_logic_vector(decode_rd_i_abc_ps_1_9);
  ...
  decode_sel_input <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0062#, 14) ELSE
      '0';
