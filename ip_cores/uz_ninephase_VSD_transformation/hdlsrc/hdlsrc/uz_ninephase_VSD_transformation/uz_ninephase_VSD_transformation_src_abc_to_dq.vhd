-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\valen\Documents\repos\UZ\ultrazohm_sw\ip_cores\uz_ninephase_VSD_transformation\hdlsrc\hdlsrc\uz_ninephase_VSD_transformation\uz_ninephase_VSD_transformation_src_abc_to_dq.vhd
...
-- x_abc_out_axi_6               ce_out        1e-06
-- x_abc_out_axi_7               ce_out        1e-06
-- x_abc_out_axi_8               ce_out        1e-06
...
-- x_abc_3_0                     ce_out        1e-06
-- x_abc_3_1                     ce_out        1e-06
-- x_abc_3_2                     ce_out        1e-06
...
-- x_out_dq_6                    ce_out        1e-06
-- x_out_dq_7                    ce_out        1e-06
-- x_out_dq_8                    ce_out        1e-06
...
ARCHITECTURE rtl OF uz_ninephase_VSD_transformation_src_abc_to_dq IS
  ...
  SIGNAL Gain4_out1_1                     : vector_of_std_logic_vector27(0 TO 2);  -- ufix27 [3]
  ...
  SIGNAL delayMatch36_reg                 : vector_of_signed18(0 TO 8);  -- sfix18 [9]
  SIGNAL delayMatch36_reg_next            : vector_of_signed18(0 TO 8);  -- sfix18_En16 [9]
  ...
  SIGNAL s_7                              : vector_of_signed27(0 TO 8);  -- sfix27_En16 [9]
  ...
  SIGNAL s_8                              : vector_of_signed27(0 TO 2);  -- sfix27_En16 [3]
  ...
  SIGNAL s_13                             : vector_of_signed27(0 TO 8);  -- sfix27_En16 [9]
  ...
  SIGNAL s_14                             : vector_of_signed27(0 TO 2);  -- sfix27_En16 [3]
  SIGNAL Gain4_out1_3                     : vector_of_signed27(0 TO 2);  -- sfix27_En16 [3]
  SIGNAL Gain4_out1_4                     : vector_of_std_logic_vector27(0 TO 2);  -- ufix27 [3]
  ...
  SIGNAL delayMatch31_reg                 : vector_of_signed18(0 TO 8);  -- sfix18 [9]
  SIGNAL delayMatch31_reg_next            : vector_of_signed18(0 TO 8);  -- sfix18_En16 [9]
  ...
  SIGNAL s_16                             : vector_of_signed27(0 TO 8);  -- sfix27_En16 [9]
  ...
  SIGNAL s_17                             : vector_of_signed27(0 TO 2);  -- sfix27_En16 [3]
  ...
  SIGNAL s_22                             : vector_of_signed27(0 TO 8);  -- sfix27_En16 [9]
  ...
  SIGNAL s_23                             : vector_of_signed27(0 TO 2);  -- sfix27_En16 [3]
  SIGNAL Gain4_out1_6                     : vector_of_signed27(0 TO 2);  -- sfix27_En16 [3]
  SIGNAL Gain4_out1_7                     : vector_of_std_logic_vector27(0 TO 2);  -- ufix27 [3]
  ...
  SIGNAL delayMatch26_reg                 : vector_of_signed18(0 TO 8);  -- sfix18 [9]
  SIGNAL delayMatch26_reg_next            : vector_of_signed18(0 TO 8);  -- sfix18_En16 [9]
...
BEGIN
  ...
  u_Gain22 : uz_ninephase_VSD_transformation_src_Gain2_nw_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              in0 => Gain4_out1_1,  -- sfix27_En16 [3]
  ...
  u_Product8 : uz_ninephase_VSD_transformation_src_Product_nw_block7
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              in0 => std_logic_vector(Gain2_out1_1(0)),  -- sfix27_En16
  ...
  u_Product10 : uz_ninephase_VSD_transformation_src_Product_nw_block9
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              in0 => std_logic_vector(Gain2_out1_1(1)),  -- sfix27_En16
  ...
  u_Gain21 : uz_ninephase_VSD_transformation_src_Gain2_nw_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              in0 => Gain4_out1_4,  -- sfix27_En16 [3]
  ...
  u_Product4 : uz_ninephase_VSD_transformation_src_Product_nw_block3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              in0 => std_logic_vector(Gain2_out1_3(0)),  -- sfix27_En16
  ...
  u_Product6 : uz_ninephase_VSD_transformation_src_Product_nw_block5
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              in0 => std_logic_vector(Gain2_out1_3(1)),  -- sfix27_En16
  ...
  u_Gain2 : uz_ninephase_VSD_transformation_src_Gain2_nw
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              in0 => Gain4_out1_7,  -- sfix27_En16 [3]
  ...
  u_Product : uz_ninephase_VSD_transformation_src_Product_nw
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              in0 => std_logic_vector(Gain2_out1_5(0)),  -- sfix27_En16
  ...
  u_Product2 : uz_ninephase_VSD_transformation_src_Product_nw_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              in0 => std_logic_vector(Gain2_out1_5(1)),  -- sfix27_En16
  ...
  u_adder_MultiplyAdd : uz_ninephase_VSD_transformation_src_adder_MultiplyAdd_nw
    PORT MAP( clk => clk,
              ...
              in1 => std_logic_vector(Gain4_out1_8(0)),  -- sfix27_En16
  ...
  u_adder_MultiplyAdd1 : uz_ninephase_VSD_transformation_src_adder_MultiplyAdd_nw_block
    PORT MAP( clk => clk,
              ...
              in1 => std_logic_vector(Gain4_out1_8(1)),  -- sfix27_En16
  ...
  u_adder_MultiplyAdd2 : uz_ninephase_VSD_transformation_src_adder_MultiplyAdd_nw_block1
    PORT MAP( clk => clk,
              ...
              in1 => std_logic_vector(Gain4_out1_8(2)),  -- sfix27_En16
  ...
  u_adder_MultiplyAdd6 : uz_ninephase_VSD_transformation_src_adder_MultiplyAdd_nw_block5
    PORT MAP( clk => clk,
              ...
              in1 => std_logic_vector(Gain4_out1_2(0)),  -- sfix27_En16
  ...
  u_adder_MultiplyAdd7 : uz_ninephase_VSD_transformation_src_adder_MultiplyAdd_nw_block6
    PORT MAP( clk => clk,
              ...
              in1 => std_logic_vector(Gain4_out1_2(1)),  -- sfix27_En16
  ...
  u_adder_MultiplyAdd8 : uz_ninephase_VSD_transformation_src_adder_MultiplyAdd_nw_block7
    PORT MAP( clk => clk,
              ...
              in1 => std_logic_vector(Gain4_out1_2(2)),  -- sfix27_En16
  ...
  selector_out_2(0) <= x_abc3_ll_pl_4(0);
  selector_out_2(1) <= x_abc3_ll_pl_4(1);
  selector_out_2(2) <= x_abc3_ll_pl_4(2);
  selector_out_2(3) <= x_abc3_ll_pl_4(0);
  selector_out_2(4) <= x_abc3_ll_pl_4(1);
  selector_out_2(5) <= x_abc3_ll_pl_4(2);
  selector_out_2(6) <= x_abc3_ll_pl_4(0);
  selector_out_2(7) <= x_abc3_ll_pl_4(1);
  selector_out_2(8) <= x_abc3_ll_pl_4(2);

  s_4GEN_LABEL: FOR d0 IN 0 TO 8 GENERATE
    s_4(d0) <= selector_out_2(d0);
  END GENERATE;

  outputgen24: FOR k IN 0 TO 8 GENERATE
  ...
  s_5(0) <= "011111111111111111111111111" WHEN (MMul_add_124_add_temp(27) = '0') AND (MMul_add_124_add_temp(26) /= '0') ELSE
  ...
  s_5(1) <= "011111111111111111111111111" WHEN (MMul_add_124_add_temp_1(27) = '0') AND (MMul_add_124_add_temp_1(26) /= '0') ELSE
  ...
  s_5(2) <= "011111111111111111111111111" WHEN (MMul_add_124_add_temp_2(27) = '0') AND (MMul_add_124_add_temp_2(26) /= '0') ELSE
  ...
  outputgen22: FOR k IN 0 TO 2 GENERATE
  ...
  outputgen21: FOR k IN 0 TO 2 GENERATE
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        delayMatch36_reg(0) <= to_signed(16#00000#, 18);
        delayMatch36_reg(1) <= to_signed(16#00000#, 18);
        delayMatch36_reg(2) <= to_signed(16#00000#, 18);
        delayMatch36_reg(3) <= to_signed(16#00000#, 18);
        delayMatch36_reg(4) <= to_signed(16#00000#, 18);
        delayMatch36_reg(5) <= to_signed(16#00000#, 18);
        delayMatch36_reg(6) <= to_signed(16#00000#, 18);
        delayMatch36_reg(7) <= to_signed(16#00000#, 18);
        delayMatch36_reg(8) <= to_signed(16#00000#, 18);
      ELSIF enb = '1' THEN
  ...
  s_6(0) <= delayMatch36_reg(0);
  s_6(1) <= delayMatch36_reg(1);
  s_6(2) <= delayMatch36_reg(2);
  s_6(3) <= delayMatch36_reg(3);
  s_6(4) <= delayMatch36_reg(4);
  s_6(5) <= delayMatch36_reg(5);
  s_6(6) <= delayMatch36_reg(6);
  s_6(7) <= delayMatch36_reg(7);
  s_6(8) <= delayMatch36_reg(8);
  delayMatch36_reg_next(0) <= s_1(0);
  delayMatch36_reg_next(1) <= s_1(1);
  delayMatch36_reg_next(2) <= s_1(2);
  delayMatch36_reg_next(3) <= s_1(3);
  delayMatch36_reg_next(4) <= s_1(4);
  delayMatch36_reg_next(5) <= s_1(5);
  delayMatch36_reg_next(6) <= s_1(6);
  delayMatch36_reg_next(7) <= s_1(7);
  delayMatch36_reg_next(8) <= s_1(8);
  ...
  s_8(0) <= "011111111111111111111111111" WHEN (MMul_add_125_add_temp(27) = '0') AND (MMul_add_125_add_temp(26) /= '0') ELSE
  ...
  s_8(1) <= "011111111111111111111111111" WHEN (MMul_add_125_add_temp_1(27) = '0') AND (MMul_add_125_add_temp_1(26) /= '0') ELSE
  ...
  s_8(2) <= "011111111111111111111111111" WHEN (MMul_add_125_add_temp_2(27) = '0') AND (MMul_add_125_add_temp_2(26) /= '0') ELSE
  ...
  selector_out_12(0) <= x_abc2_ll_pl_4(0);
  selector_out_12(1) <= x_abc2_ll_pl_4(1);
  selector_out_12(2) <= x_abc2_ll_pl_4(2);
  selector_out_12(3) <= x_abc2_ll_pl_4(0);
  selector_out_12(4) <= x_abc2_ll_pl_4(1);
  selector_out_12(5) <= x_abc2_ll_pl_4(2);
  selector_out_12(6) <= x_abc2_ll_pl_4(0);
  selector_out_12(7) <= x_abc2_ll_pl_4(1);
  selector_out_12(8) <= x_abc2_ll_pl_4(2);
  ...
  s_14(0) <= "011111111111111111111111111" WHEN (MMul_add_122_add_temp(27) = '0') AND (MMul_add_122_add_temp(26) /= '0') ELSE
  ...
  s_14(1) <= "011111111111111111111111111" WHEN (MMul_add_122_add_temp_1(27) = '0') AND (MMul_add_122_add_temp_1(26) /= '0') ELSE
  ...
  s_14(2) <= "011111111111111111111111111" WHEN (MMul_add_122_add_temp_2(27) = '0') AND (MMul_add_122_add_temp_2(26) /= '0') ELSE
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        delayMatch31_reg(0) <= to_signed(16#00000#, 18);
        delayMatch31_reg(1) <= to_signed(16#00000#, 18);
        delayMatch31_reg(2) <= to_signed(16#00000#, 18);
        delayMatch31_reg(3) <= to_signed(16#00000#, 18);
        delayMatch31_reg(4) <= to_signed(16#00000#, 18);
        delayMatch31_reg(5) <= to_signed(16#00000#, 18);
        delayMatch31_reg(6) <= to_signed(16#00000#, 18);
        delayMatch31_reg(7) <= to_signed(16#00000#, 18);
        delayMatch31_reg(8) <= to_signed(16#00000#, 18);
      ELSIF enb = '1' THEN
  ...
  s_15(0) <= delayMatch31_reg(0);
  s_15(1) <= delayMatch31_reg(1);
  s_15(2) <= delayMatch31_reg(2);
  s_15(3) <= delayMatch31_reg(3);
  s_15(4) <= delayMatch31_reg(4);
  s_15(5) <= delayMatch31_reg(5);
  s_15(6) <= delayMatch31_reg(6);
  s_15(7) <= delayMatch31_reg(7);
  s_15(8) <= delayMatch31_reg(8);
  delayMatch31_reg_next(0) <= s_10(0);
  delayMatch31_reg_next(1) <= s_10(1);
  delayMatch31_reg_next(2) <= s_10(2);
  delayMatch31_reg_next(3) <= s_10(3);
  delayMatch31_reg_next(4) <= s_10(4);
  delayMatch31_reg_next(5) <= s_10(5);
  delayMatch31_reg_next(6) <= s_10(6);
  delayMatch31_reg_next(7) <= s_10(7);
  delayMatch31_reg_next(8) <= s_10(8);
  ...
  s_17(0) <= "011111111111111111111111111" WHEN (MMul_add_123_add_temp(27) = '0') AND (MMul_add_123_add_temp(26) /= '0') ELSE
  ...
  s_17(1) <= "011111111111111111111111111" WHEN (MMul_add_123_add_temp_1(27) = '0') AND (MMul_add_123_add_temp_1(26) /= '0') ELSE
  ...
  s_17(2) <= "011111111111111111111111111" WHEN (MMul_add_123_add_temp_2(27) = '0') AND (MMul_add_123_add_temp_2(26) /= '0') ELSE
  ...
  selector_out_22(0) <= x_abc1_ll_pl_4(0);
  selector_out_22(1) <= x_abc1_ll_pl_4(1);
  selector_out_22(2) <= x_abc1_ll_pl_4(2);
  selector_out_22(3) <= x_abc1_ll_pl_4(0);
  selector_out_22(4) <= x_abc1_ll_pl_4(1);
  selector_out_22(5) <= x_abc1_ll_pl_4(2);
  selector_out_22(6) <= x_abc1_ll_pl_4(0);
  selector_out_22(7) <= x_abc1_ll_pl_4(1);
  selector_out_22(8) <= x_abc1_ll_pl_4(2);
  ...
  s_23(0) <= "011111111111111111111111111" WHEN (MMul_add_12_add_temp(27) = '0') AND (MMul_add_12_add_temp(26) /= '0') ELSE
  ...
  s_23(1) <= "011111111111111111111111111" WHEN (MMul_add_12_add_temp_1(27) = '0') AND (MMul_add_12_add_temp_1(26) /= '0') ELSE
  ...
  s_23(2) <= "011111111111111111111111111" WHEN (MMul_add_12_add_temp_2(27) = '0') AND (MMul_add_12_add_temp_2(26) /= '0') ELSE
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        delayMatch26_reg(0) <= to_signed(16#00000#, 18);
        delayMatch26_reg(1) <= to_signed(16#00000#, 18);
        delayMatch26_reg(2) <= to_signed(16#00000#, 18);
        delayMatch26_reg(3) <= to_signed(16#00000#, 18);
        delayMatch26_reg(4) <= to_signed(16#00000#, 18);
        delayMatch26_reg(5) <= to_signed(16#00000#, 18);
        delayMatch26_reg(6) <= to_signed(16#00000#, 18);
        delayMatch26_reg(7) <= to_signed(16#00000#, 18);
        delayMatch26_reg(8) <= to_signed(16#00000#, 18);
      ELSIF enb = '1' THEN
  ...
  s_24(0) <= delayMatch26_reg(0);
  s_24(1) <= delayMatch26_reg(1);
  s_24(2) <= delayMatch26_reg(2);
  s_24(3) <= delayMatch26_reg(3);
  s_24(4) <= delayMatch26_reg(4);
  s_24(5) <= delayMatch26_reg(5);
  s_24(6) <= delayMatch26_reg(6);
  s_24(7) <= delayMatch26_reg(7);
  s_24(8) <= delayMatch26_reg(8);
  delayMatch26_reg_next(0) <= s_19(0);
  delayMatch26_reg_next(1) <= s_19(1);
  delayMatch26_reg_next(2) <= s_19(2);
  delayMatch26_reg_next(3) <= s_19(3);
  delayMatch26_reg_next(4) <= s_19(4);
  delayMatch26_reg_next(5) <= s_19(5);
  delayMatch26_reg_next(6) <= s_19(6);
  delayMatch26_reg_next(7) <= s_19(7);
  delayMatch26_reg_next(8) <= s_19(8);
  ...
  s_26(0) <= "011111111111111111111111111" WHEN (MMul_add_121_add_temp(27) = '0') AND (MMul_add_121_add_temp(26) /= '0') ELSE
  ...
  s_26(1) <= "011111111111111111111111111" WHEN (MMul_add_121_add_temp_1(27) = '0') AND (MMul_add_121_add_temp_1(26) /= '0') ELSE
  ...
  s_26(2) <= "011111111111111111111111111" WHEN (MMul_add_121_add_temp_2(27) = '0') AND (MMul_add_121_add_temp_2(26) /= '0') ELSE
