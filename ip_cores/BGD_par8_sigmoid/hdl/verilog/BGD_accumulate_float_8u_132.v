...
module BGD_accumulate_float_8u_132 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [15:0] tmp_s_fu_234_p3;
reg   [15:0] tmp_s_reg_438;
reg   [15:0] p_accumulator_addr_reg_448;
reg   [15:0] p_accumulator_addr_22_reg_453;
reg   [15:0] p_accumulator_addr_22_reg_453_pp0_iter1_reg;
...
reg   [31:0] p_Result_66_i_reg_469;
reg   [31:0] p_Result_67_i_reg_474;
reg   [31:0] p_Result_68_i_reg_479;
reg   [31:0] p_Result_69_i_reg_484;
reg   [31:0] p_Result_70_i_reg_489;
reg   [31:0] p_Result_71_i_reg_494;
reg   [31:0] p_accumulator_load_reg_499;
reg   [31:0] p_accumulator_load_22_reg_504;
reg   [15:0] p_accumulator_addr_23_reg_509;
reg   [15:0] p_accumulator_addr_23_reg_509_pp0_iter1_reg;
reg   [15:0] p_accumulator_addr_24_reg_515;
reg   [15:0] p_accumulator_addr_24_reg_515_pp0_iter1_reg;
wire   [31:0] bitcast_ln101_fu_352_p1;
wire    ap_CS_fsm_pp0_stage2;
wire    ap_block_state4_pp0_stage2_iter0;
wire    ap_block_state12_pp0_stage2_iter1;
wire    ap_block_pp0_stage2_11001;
reg   [31:0] p_accumulator_load_23_reg_526;
reg   [31:0] p_accumulator_load_24_reg_531;
reg   [15:0] p_accumulator_addr_25_reg_536;
reg   [15:0] p_accumulator_addr_25_reg_536_pp0_iter1_reg;
reg   [15:0] p_accumulator_addr_26_reg_542;
reg   [15:0] p_accumulator_addr_26_reg_542_pp0_iter1_reg;
wire   [31:0] bitcast_ln101_65_fu_376_p1;
wire    ap_CS_fsm_pp0_stage3;
wire    ap_block_state5_pp0_stage3_iter0;
wire    ap_block_state13_pp0_stage3_iter1;
wire    ap_block_pp0_stage3_11001;
reg   [31:0] p_accumulator_load_25_reg_553;
reg   [31:0] p_accumulator_load_26_reg_558;
reg   [15:0] p_accumulator_addr_27_reg_563;
reg   [15:0] p_accumulator_addr_27_reg_563_pp0_iter1_reg;
reg   [15:0] p_accumulator_addr_28_reg_569;
reg   [15:0] p_accumulator_addr_28_reg_569_pp0_iter1_reg;
wire   [31:0] bitcast_ln101_66_fu_400_p1;
reg   [31:0] p_accumulator_load_27_reg_579;
reg   [31:0] p_accumulator_load_28_reg_584;
wire   [31:0] bitcast_ln101_67_fu_404_p1;
wire   [31:0] bitcast_ln101_68_fu_408_p1;
wire   [31:0] bitcast_ln101_69_fu_412_p1;
wire   [31:0] bitcast_ln101_70_fu_416_p1;
wire   [31:0] bitcast_ln101_71_fu_420_p1;
...
wire   [63:0] zext_ln416_22_fu_253_p1;
wire   [63:0] zext_ln416_23_fu_337_p1;
wire   [63:0] zext_ln416_24_fu_347_p1;
wire   [63:0] zext_ln416_25_fu_361_p1;
wire    ap_block_pp0_stage2;
wire   [63:0] zext_ln416_26_fu_371_p1;
wire   [63:0] zext_ln416_27_fu_385_p1;
wire    ap_block_pp0_stage3;
wire   [63:0] zext_ln416_28_fu_395_p1;
...
wire   [15:0] or_ln416_fu_247_p2;
wire   [15:0] or_ln416_19_fu_332_p2;
wire   [15:0] or_ln416_20_fu_342_p2;
wire   [15:0] or_ln416_21_fu_356_p2;
wire   [15:0] or_ln416_22_fu_366_p2;
wire   [15:0] or_ln416_23_fu_380_p2;
wire   [15:0] or_ln416_24_fu_390_p2;
reg    grp_fu_194_ce;
...
BGD_fadd_32ns_32ns_32_5_full_dsp_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
fadd_32ns_32ns_32_5_full_dsp_1_U459(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_194_p0),
    .din1(grp_fu_194_p1),
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        p_accumulator_addr_22_reg_453_pp0_iter1_reg[15 : 3] <= p_accumulator_addr_22_reg_453[15 : 3];
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln409_reg_429 == 1'd0) & (1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        p_Result_66_i_reg_469 <= {{p_values_dout[95:64]}};
        p_Result_67_i_reg_474 <= {{p_values_dout[127:96]}};
        p_Result_68_i_reg_479 <= {{p_values_dout[159:128]}};
        p_Result_69_i_reg_484 <= {{p_values_dout[191:160]}};
        p_Result_70_i_reg_489 <= {{p_values_dout[223:192]}};
        p_Result_71_i_reg_494 <= {{p_values_dout[255:224]}};
        p_Result_i_reg_464 <= {{p_values_dout[63:32]}};
        p_accumulator_addr_23_reg_509[15 : 3] <= zext_ln416_23_fu_337_p1[15 : 3];
        p_accumulator_addr_24_reg_515[15 : 3] <= zext_ln416_24_fu_347_p1[15 : 3];
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln409_fu_219_p2 == 1'd0))) begin
        p_accumulator_addr_22_reg_453[15 : 3] <= zext_ln416_22_fu_253_p1[15 : 3];
        p_accumulator_addr_reg_448[15 : 3] <= zext_ln416_fu_242_p1[15 : 3];
        tmp_s_reg_438[15 : 3] <= tmp_s_fu_234_p3[15 : 3];
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        p_accumulator_addr_23_reg_509_pp0_iter1_reg[15 : 3] <= p_accumulator_addr_23_reg_509[15 : 3];
        p_accumulator_addr_24_reg_515_pp0_iter1_reg[15 : 3] <= p_accumulator_addr_24_reg_515[15 : 3];
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln409_reg_429 == 1'd0) & (1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        p_accumulator_addr_25_reg_536[15 : 3] <= zext_ln416_25_fu_361_p1[15 : 3];
        p_accumulator_addr_26_reg_542[15 : 3] <= zext_ln416_26_fu_371_p1[15 : 3];
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        p_accumulator_addr_25_reg_536_pp0_iter1_reg[15 : 3] <= p_accumulator_addr_25_reg_536[15 : 3];
        p_accumulator_addr_26_reg_542_pp0_iter1_reg[15 : 3] <= p_accumulator_addr_26_reg_542[15 : 3];
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln409_reg_429 == 1'd0) & (1'b0 == ap_block_pp0_stage3_11001) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        p_accumulator_addr_27_reg_563[15 : 3] <= zext_ln416_27_fu_385_p1[15 : 3];
        p_accumulator_addr_28_reg_569[15 : 3] <= zext_ln416_28_fu_395_p1[15 : 3];
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        p_accumulator_addr_27_reg_563_pp0_iter1_reg[15 : 3] <= p_accumulator_addr_27_reg_563[15 : 3];
        p_accumulator_addr_28_reg_569_pp0_iter1_reg[15 : 3] <= p_accumulator_addr_28_reg_569[15 : 3];
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage7) & (1'b1 == ap_CS_fsm_pp0_stage7) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
        ...
        p_accumulator_address0 = zext_ln416_28_fu_395_p1;
    end else if (((1'b0 == ap_block_pp0_stage2) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        p_accumulator_address0 = zext_ln416_26_fu_371_p1;
    end else if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        p_accumulator_address0 = zext_ln416_24_fu_347_p1;
    end else if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        p_accumulator_address0 = zext_ln416_22_fu_253_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6) & (1'b1 == ap_CS_fsm_pp0_stage6) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
        ...
        p_accumulator_address1 = zext_ln416_27_fu_385_p1;
    end else if (((1'b0 == ap_block_pp0_stage2) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        p_accumulator_address1 = zext_ln416_25_fu_361_p1;
    end else if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        p_accumulator_address1 = zext_ln416_23_fu_337_p1;
    end else if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign bitcast_ln101_65_fu_376_p1 = p_Result_i_reg_464;

assign bitcast_ln101_66_fu_400_p1 = p_Result_66_i_reg_469;

assign bitcast_ln101_67_fu_404_p1 = p_Result_67_i_reg_474;

assign bitcast_ln101_68_fu_408_p1 = p_Result_68_i_reg_479;

assign bitcast_ln101_69_fu_412_p1 = p_Result_69_i_reg_484;

assign bitcast_ln101_70_fu_416_p1 = p_Result_70_i_reg_489;

assign bitcast_ln101_71_fu_420_p1 = p_Result_71_i_reg_494;

assign bitcast_ln101_fu_352_p1 = trunc_ln674_reg_459;

assign empty_fu_230_p1 = ap_phi_mux_i_phi_fu_187_p4[12:0];

assign icmp_ln409_fu_219_p2 = ((ap_phi_mux_i_phi_fu_187_p4 == trunc_ln_reg_424) ? 1'b1 : 1'b0);

assign or_ln416_19_fu_332_p2 = (tmp_s_reg_438 | 16'd2);

assign or_ln416_20_fu_342_p2 = (tmp_s_reg_438 | 16'd3);

assign or_ln416_21_fu_356_p2 = (tmp_s_reg_438 | 16'd4);

assign or_ln416_22_fu_366_p2 = (tmp_s_reg_438 | 16'd5);

assign or_ln416_23_fu_380_p2 = (tmp_s_reg_438 | 16'd6);

assign or_ln416_24_fu_390_p2 = (tmp_s_reg_438 | 16'd7);

assign or_ln416_fu_247_p2 = (tmp_s_fu_234_p3 | 16'd1);

assign tmp_s_fu_234_p3 = {{empty_fu_230_p1}, {3'd0}};

assign trunc_ln674_fu_258_p1 = p_values_dout[31:0];

assign zext_ln416_22_fu_253_p1 = or_ln416_fu_247_p2;

assign zext_ln416_23_fu_337_p1 = or_ln416_19_fu_332_p2;

assign zext_ln416_24_fu_347_p1 = or_ln416_20_fu_342_p2;

assign zext_ln416_25_fu_361_p1 = or_ln416_21_fu_356_p2;

assign zext_ln416_26_fu_371_p1 = or_ln416_22_fu_366_p2;

assign zext_ln416_27_fu_385_p1 = or_ln416_23_fu_380_p2;

assign zext_ln416_28_fu_395_p1 = or_ln416_24_fu_390_p2;

assign zext_ln416_fu_242_p1 = tmp_s_fu_234_p3;

always @ (posedge ap_clk) begin
    tmp_s_reg_438[2:0] <= 3'b000;
    p_accumulator_addr_reg_448[2:0] <= 3'b000;
    p_accumulator_addr_22_reg_453[2:0] <= 3'b001;
    p_accumulator_addr_22_reg_453_pp0_iter1_reg[2:0] <= 3'b001;
    p_accumulator_addr_23_reg_509[2:0] <= 3'b010;
    p_accumulator_addr_23_reg_509_pp0_iter1_reg[2:0] <= 3'b010;
    p_accumulator_addr_24_reg_515[2:0] <= 3'b011;
    p_accumulator_addr_24_reg_515_pp0_iter1_reg[2:0] <= 3'b011;
    p_accumulator_addr_25_reg_536[2:0] <= 3'b100;
    p_accumulator_addr_25_reg_536_pp0_iter1_reg[2:0] <= 3'b100;
    p_accumulator_addr_26_reg_542[2:0] <= 3'b101;
    p_accumulator_addr_26_reg_542_pp0_iter1_reg[2:0] <= 3'b101;
    p_accumulator_addr_27_reg_563[2:0] <= 3'b110;
    p_accumulator_addr_27_reg_563_pp0_iter1_reg[2:0] <= 3'b110;
    p_accumulator_addr_28_reg_569[2:0] <= 3'b111;
    p_accumulator_addr_28_reg_569_pp0_iter1_reg[2:0] <= 3'b111;
end

endmodule //BGD_accumulate_float_8u_132
