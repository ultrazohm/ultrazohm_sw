-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_6ph_pu_vsd_voltages\uz_6ph_pu_ip_reset_sync.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_6ph_pu_ip_reset_sync
-- Source Path: uz_6ph_pu_ip/uz_6ph_pu_ip_reset_sync
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_6ph_pu_ip_reset_sync IS
  PORT( clk                               :   IN    std_logic;
        reset_in                          :   IN    std_logic;  -- ufix1
        reset_out                         :   OUT   std_logic  -- ufix1
        );
END uz_6ph_pu_ip_reset_sync;


ARCHITECTURE rtl OF uz_6ph_pu_ip_reset_sync IS
