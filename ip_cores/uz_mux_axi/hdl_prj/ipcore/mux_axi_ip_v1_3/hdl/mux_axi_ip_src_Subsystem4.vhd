-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mux_axi\mux_axi_ip_src_Subsystem4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mux_axi_ip_src_Subsystem4
-- Source Path: mux_axi/mux_axi/Subsystem4
-- Hierarchy Level: 1
-- Model version: 9.8
-- 
-- -------------------------------------------------------------
...
ENTITY mux_axi_ip_src_Subsystem4 IS
...
END mux_axi_ip_src_Subsystem4;


ARCHITECTURE rtl OF mux_axi_ip_src_Subsystem4 IS

  -- Component Declarations
  COMPONENT mux_axi_ip_src_Detect_Rise_Positive_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT mux_axi_ip_src_Detect_Fall_Nonpositive2_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : mux_axi_ip_src_Detect_Rise_Positive_block2
    USE ENTITY work.mux_axi_ip_src_Detect_Rise_Positive_block2(rtl);

  FOR ALL : mux_axi_ip_src_Detect_Fall_Nonpositive2_block2
    USE ENTITY work.mux_axi_ip_src_Detect_Fall_Nonpositive2_block2(rtl);
...
BEGIN
  ...
  u_Detect_Rise_Positive : mux_axi_ip_src_Detect_Rise_Positive_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Detect_Fall_Nonpositive2 : mux_axi_ip_src_Detect_Fall_Nonpositive2_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
