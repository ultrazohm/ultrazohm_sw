...
reg   [29:0] k_reg_172;
reg   [31:0] i_reg_183;
reg   [15:0] p_in_offset_read_reg_404;
reg    ap_block_state1;
wire   [29:0] trunc_ln_fu_194_p4;
reg   [29:0] trunc_ln_reg_412;
wire  signed [13:0] trunc_ln180_fu_204_p1;
reg  signed [13:0] trunc_ln180_reg_417;
wire  signed [15:0] trunc_ln180_1_fu_208_p1;
reg  signed [15:0] trunc_ln180_1_reg_422;
...
wire   [15:0] trunc_ln172_fu_296_p1;
reg   [15:0] trunc_ln172_reg_489;
...
wire  signed [13:0] grp_fu_376_p2;
wire   [15:0] shl_ln180_1_fu_300_p3;
wire   [15:0] add_ln180_fu_307_p2;
wire   [15:0] add_ln180_1_fu_312_p2;
wire  signed [15:0] grp_fu_382_p3;
(* use_dsp48 = "no" *) wire   [15:0] add_ln180_3_fu_322_p2;
wire  signed [15:0] grp_fu_390_p3;
(* use_dsp48 = "no" *) wire   [15:0] add_ln180_5_fu_331_p2;
wire  signed [15:0] grp_fu_397_p3;
(* use_dsp48 = "no" *) wire   [15:0] add_ln180_7_fu_340_p2;
...
always @ (posedge ap_clk) begin
    if ((~((p_k_out_full_n == 1'b0) | (p_n_out_full_n == 1'b0) | (p_in_offset_empty_n == 1'b0) | (p_k_empty_n == 1'b0) | (p_n_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (real_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        trunc_ln_reg_412 <= {{p_n_dout[31:2]}};
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln172_fu_226_p2 == 1'd0))) begin
        ...
        shl_ln_reg_453[15 : 2] <= shl_ln_fu_248_p3[15 : 2];
    end
end
...
assign bound_fu_220_p10 = trunc_ln_fu_194_p4;

assign empty_fu_244_p1 = select_ln172_fu_236_p3[13:0];

assign grp_fu_382_p1 = (shl_ln_fu_248_p3 | 16'd1);

assign grp_fu_382_p2 = select_ln172_1_fu_289_p3[15:0];

assign grp_fu_390_p1 = (shl_ln_reg_453 | 16'd2);

assign grp_fu_397_p1 = (shl_ln_reg_453 | 16'd3);

assign icmp_ln172_fu_226_p2 = ((ap_phi_mux_indvar_flatten_phi_fu_164_p4 == bound_reg_429) ? 1'b1 : 1'b0);

assign icmp_ln174_fu_231_p2 = ((ap_phi_mux_k_phi_fu_176_p4 == trunc_ln_reg_412) ? 1'b1 : 1'b0);
...
assign shl_ln_fu_248_p3 = {{empty_fu_244_p1}, {2'd0}};

assign start_out = real_start;

assign trunc_ln172_fu_296_p1 = select_ln172_1_fu_289_p3[15:0];

assign trunc_ln180_1_fu_208_p1 = p_k_dout[15:0];

assign trunc_ln180_fu_204_p1 = p_k_dout[13:0];

assign trunc_ln_fu_194_p4 = {{p_n_dout[31:2]}};
