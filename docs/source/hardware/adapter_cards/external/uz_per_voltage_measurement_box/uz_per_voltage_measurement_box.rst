...
=========  =======    ==========================    ===================================
Connected                         Pin on RJ45       (:ref:`RJ45-Pinout <rj45pinout>`)
---------  -------    -----------------------------------------------------------------
...
The assembly with all necessary parts, including a bill of materials (BOM), is shown below. The PCB can be used without the housing, but the setup is more rugged and clean with the housing.
...
Downloads
*********
* :download:`Schematics 60V <uz_per_voltage_measurement_60V.pdf>`
* :download:`BOM 60V <BOM_JLC_uz_per_voltage_measurement_60V_Rev01.xlsx>`
* :download:`Schematics 1000V <uz_per_voltage_measurement_1000V.pdf>`
