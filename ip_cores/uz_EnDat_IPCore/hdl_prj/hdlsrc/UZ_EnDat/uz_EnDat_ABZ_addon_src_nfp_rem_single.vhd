-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\ELSYS_PC\Documents\repos\ultrazohm_sw\ip_cores\uz_EnDat_IPCore\hdl_prj\hdlsrc\UZ_EnDat\uz_EnDat_ABZ_addon_src_nfp_rem_single.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_EnDat_ABZ_addon_src_nfp_rem_single
-- Source Path: UZ_EnDat/UZ_ENDAT_ABZ_ADDON/nfp_rem_single
-- Hierarchy Level: 1
-- Model version: 3.0
-- 
...
ENTITY uz_EnDat_ABZ_addon_src_nfp_rem_single IS
...
END uz_EnDat_ABZ_addon_src_nfp_rem_single;


ARCHITECTURE rtl OF uz_EnDat_ABZ_addon_src_nfp_rem_single IS
  ...
  SIGNAL Delay17_reg                      : std_logic_vector(12 DOWNTO 0);  -- ufix1 [13]
  ...
  SIGNAL Delay_reg                        : std_logic_vector(6 DOWNTO 0);  -- ufix1 [7]
  SIGNAL Delay_out1_2                     : std_logic;  -- ufix1
  ...
  SIGNAL Delay4_out1_2                    : signed(27 DOWNTO 0);  -- sfix28
  ...
  SIGNAL Delay_out1_5                     : signed(27 DOWNTO 0);  -- sfix28
  ...
  SIGNAL bitsll_R_1_mant_b_norm_out1      : std_logic;  -- ufix1
  ...
  SIGNAL Delay4_out1_7                    : signed(27 DOWNTO 0);  -- sfix28
  ...
  SIGNAL Delay2_out1_6                    : signed(27 DOWNTO 0);  -- sfix28
  ...
  SIGNAL alpha0_out1_4                    : std_logic;  -- ufix1
  SIGNAL Bit_Concat_out1_3                : unsigned(24 DOWNTO 0);  -- ufix25
  SIGNAL Delay2_out1_7                    : unsigned(24 DOWNTO 0);  -- ufix25
  ...
  SIGNAL exp_a_norm_exp_b_norm_out1_1     : std_logic;  -- ufix1
  SIGNAL if_exp_a_norm_exp_b_norm_out1    : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL Delay1_out1_5                    : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL Delay4_out1_8                    : signed(9 DOWNTO 0);  -- sfix10
  ...
  SIGNAL Delay1_out1_6                    : unsigned(24 DOWNTO 0);  -- ufix25
  SIGNAL bitsll_tmp2_shift1_out1          : unsigned(24 DOWNTO 0);  -- ufix25
  SIGNAL C_out1_17                        : unsigned(24 DOWNTO 0);  -- ufix25
  ...
  SIGNAL Delay1_out1_7                    : unsigned(23 DOWNTO 0);  -- ufix24
  SIGNAL Bit_Concat_out1_4                : unsigned(24 DOWNTO 0);  -- ufix25
  SIGNAL BitSlice1_out1_1                 : std_logic;  -- ufix1
  SIGNAL C_out1_18                        : std_logic;  -- ufix1
  SIGNAL Delay_out1_7                     : std_logic;  -- ufix1
  ...
  SIGNAL Delay_out1_8                     : unsigned(7 DOWNTO 0);  -- ufix8
  ...
  SIGNAL C_out1_19                        : unsigned(7 DOWNTO 0);  -- ufix8
  ...
  SIGNAL C_out1_20                        : unsigned(22 DOWNTO 0);  -- ufix23
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay17_reg(0) <= Delay_out1;
        Delay17_reg(12 DOWNTO 1) <= Delay17_reg(11 DOWNTO 0);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        reduced_reg <= (OTHERS => to_unsigned(16#000000#, 23));
      ELSIF enb = '1' THEN
        reduced_reg(0) <= Switch_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        reduced_reg_1 <= (OTHERS => to_unsigned(16#00#, 8));
      ELSIF enb = '1' THEN
        reduced_reg_1(0) <= Delay1_out1;
        reduced_reg_1(1 TO 5) <= reduced_reg_1(0 TO 4);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        reduced_reg_2 <= (OTHERS => to_unsigned(16#00#, 8));
      ELSIF enb = '1' THEN
        reduced_reg_2(0) <= Delay3_out1_1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        reduced_reg_3 <= (OTHERS => to_unsigned(16#000000#, 23));
      ELSIF enb = '1' THEN
        reduced_reg_3(0) <= Switch_out1_1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay20_reg(0) <= alphaaExponent_cfType_Exponent_out1_2;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay_out1_1 <= if_Exponent_0_out1_1;
      END IF;
    END IF;
  END PROCESS Delay_1_process;


  DTC1_out1 <= signed(resize(Delay_out1_1, 10));
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        reduced_reg_4 <= (OTHERS => to_signed(16#000#, 10));
      ELSIF enb = '1' THEN
        reduced_reg_4(0) <= modrem_Prep_out1;
        reduced_reg_4(1 TO 6) <= reduced_reg_4(0 TO 5);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        modrem_Normalize_Exp_Mant_out3 <= DTC1_out1;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay_reg <= (OTHERS => '0');
      ELSIF enb = '1' THEN
        Delay_reg(0) <= Logical_Operator_out1_1;
        Delay_reg(6 DOWNTO 1) <= Delay_reg(5 DOWNTO 0);
      END IF;
    END IF;
  END PROCESS Delay_2_process;

  Delay_out1_2 <= Delay_reg(6);

  
  Compare_To_Zero_out1_2 <= '1' WHEN modrem_Prep_out1_1 < to_signed(16#000#, 10) ELSE
      '0';

  Logical_Operator_out1_2 <=  NOT (Delay_out1_2 OR Compare_To_Zero_out1_2);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay5_out1_1 <= DTC2_out1;
      END IF;
    END IF;
  END PROCESS Delay5_1_process;


  Bit_Slice_out1_1 <= Delay5_out1_1(9);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay4_out1_2 <= to_signed(16#0000000#, 28);
      ELSIF enb = '1' THEN
        Delay4_out1_2 <= alphatmp2_out1;
      END IF;
    END IF;
  END PROCESS Delay4_2_process;


  tmp1_m3B_add_temp <= resize(bitsll_mant_a_norm_1_out1, 32) + resize(Delay4_out1_2, 32);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay_out1_3 <= if_exp_diff_0_out1;
      END IF;
    END IF;
  END PROCESS Delay_3_process;


  Bit_Shift_out1 <= Delay_out1_3 sll 2;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay4_out1_3 <= Delay4_out1_2;
      END IF;
    END IF;
  END PROCESS Delay4_3_process;


  Add2_add_temp <= resize(Bit_Shift_out1, 32) + resize(Delay4_out1_3, 32);
  ...
  Add1_add_temp_1 <= resize(Bit_Shift_out1_1, 32) + resize(Delay3_out1_4, 32);
  Add1_out1_1 <= Add1_add_temp_1(27 DOWNTO 0);

  Bit_Slice1_out1_4 <= Add1_out1_1(27);

  Add2_add_temp_1 <= resize(Bit_Shift_out1_1, 32) + resize(Delay4_out1_3, 32);
  ...
  Add_add_temp_1 <= resize(Bit_Shift_out1_1, 32) + resize(Delay2_out1_3, 32);
  ...
  Add2_add_temp_3 <= resize(Bit_Shift_out1_3, 32) + resize(Delay14_out1, 32);
  ...
  Add_add_temp_3 <= resize(Bit_Shift_out1_3, 32) + resize(Delay12_out1, 32);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay_out1_4 <= if_exp_diff_in_0_out1_3;
      END IF;
    END IF;
  END PROCESS Delay_4_process;


  Bit_Shift_out1_4 <= Delay_out1_4 sll 2;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay4_out1_4 <= Delay14_out1;
      END IF;
    END IF;
  END PROCESS Delay4_4_process;


  Add2_add_temp_4 <= resize(Bit_Shift_out1_4, 32) + resize(Delay4_out1_4, 32);
  ...
  Add1_add_temp_5 <= resize(Bit_Shift_out1_5, 32) + resize(Delay3_out1_5, 32);
  Add1_out1_5 <= Add1_add_temp_5(27 DOWNTO 0);

  Bit_Slice1_out1_8 <= Add1_out1_5(27);

  Add2_add_temp_5 <= resize(Bit_Shift_out1_5, 32) + resize(Delay4_out1_4, 32);
  ...
  Add_add_temp_5 <= resize(Bit_Shift_out1_5, 32) + resize(Delay2_out1_4, 32);
  ...
  Add2_add_temp_7 <= resize(Bit_Shift_out1_7, 32) + resize(Delay14_out1_1, 32);
  ...
  Add_add_temp_7 <= resize(Bit_Shift_out1_7, 32) + resize(Delay12_out1_1, 32);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay_out1_5 <= to_signed(16#0000000#, 28);
      ELSIF enb = '1' THEN
        Delay_out1_5 <= if_exp_diff_in_0_out1_7;
      END IF;
    END IF;
  END PROCESS Delay_5_process;


  Bit_Shift_out1_8 <= Delay_out1_5 sll 2;
  ...
  Add2_add_temp_8 <= resize(Bit_Shift_out1_8, 32) + resize(Delay4_out1_5, 32);
  ...
  Add1_add_temp_9 <= resize(Bit_Shift_out1_9, 32) + resize(Delay3_out1_6, 32);
  Add1_out1_9 <= Add1_add_temp_9(27 DOWNTO 0);

  Bit_Slice1_out1_12 <= Add1_out1_9(27);

  Add2_add_temp_9 <= resize(Bit_Shift_out1_9, 32) + resize(Delay4_out1_5, 32);
  ...
  Add_add_temp_9 <= resize(Bit_Shift_out1_9, 32) + resize(Delay2_out1_5, 32);
  ...
  Add2_add_temp_11 <= resize(Bit_Shift_out1_11, 32) + resize(Delay14_out1_2, 32);
  ...
  Add_add_temp_11 <= resize(Bit_Shift_out1_11, 32) + resize(Delay12_out1_2, 32);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        reduced_reg_5 <= (OTHERS => to_signed(16#0000000#, 28));
      ELSIF enb = '1' THEN
        reduced_reg_5(0) <= modrem_Normalize_Exp_Mant_out4;
        reduced_reg_5(1 TO 6) <= reduced_reg_5(0 TO 5);
      END IF;
    END IF;
  ...
  bitsll_R_1_mant_b_norm_out1 <= '1' WHEN bitsll_R_1_out1 >= modrem_Normalize_Exp_Mant_out4_1 ELSE
      '0';
  ...
  if_bitsll_R_1_mant_b_norm_out1 <= modrem_12_Iterations_out1 WHEN bitsll_R_1_mant_b_norm_out1 = '0' ELSE
      DTC_out1_3;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay15_out1 <= if_bitsll_R_1_mant_b_norm_out1;
      END IF;
    END IF;
  ...
  Shift_Arithmetic_out1 <= SHIFT_RIGHT(Delay15_out1, to_integer(dynamic_shift_selsig));
  ...
  bitsll_x_shift_length_selsig <= Delay5_out1_1 WHEN Delay5_out1_1 >= bitsll_x_shift_length_zerosig ELSE
  ...
  bitsll_x_shift_length_out1 <= Delay15_out1 sll to_integer(dynamic_shift_selsig_1);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        reduced_reg_6 <= (OTHERS => to_signed(16#0000000#, 28));
      ELSIF enb = '1' THEN
        reduced_reg_6(0) <= modrem_Normalize_Exp_Mant_out2;
        reduced_reg_6(1 TO 6) <= reduced_reg_6(0 TO 5);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay4_out1_6 <= '0';
      ELSIF enb = '1' THEN
        Delay4_out1_6 <= Logical_Operator_out1_2;
      END IF;
    END IF;
  ...
  x_0_out1 <= '1' WHEN Delay15_out1 = to_signed(16#0000000#, 28) ELSE
      '0';
  ...
  tmp2_tmp3_out1 <= '1' WHEN BitSlice_out1_1 < Delay10_out1_3 ELSE
      '0';

  Logical_Operator2_out1_1 <= tmp2_tmp3_out1 AND (bitsrl_x_pos_0_out1 AND pos_0_out1);

  Logical_Operator3_out1 <= Logical_Operator2_out1_1 OR (Bit_Slice_out1_1 OR x_0_out1);

  Logical_Operator1_out1_1 <= Delay4_out1_6 AND Logical_Operator3_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay_out1_6 <= '0';
      ELSIF enb = '1' THEN
        Delay_out1_6 <= Logical_Operator4_out1_3;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay4_out1_7 <= to_signed(16#0000000#, 28);
      ELSIF enb = '1' THEN
        Delay4_out1_7 <= Delay14_out1_2;
      END IF;
    END IF;
  END PROCESS Delay4_7_process;


  Add2_add_temp_12 <= resize(Bit_Shift_out1_12, 32) + resize(Delay4_out1_7, 32);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay2_out1_6 <= to_signed(16#0000000#, 28);
      ELSIF enb = '1' THEN
        Delay2_out1_6 <= Delay12_out1_2;
      END IF;
    END IF;
  END PROCESS Delay2_6_process;


  Add_add_temp_12 <= resize(Bit_Shift_out1_12, 32) + resize(Delay2_out1_6, 32);
  ...
  Add1_add_temp_13 <= resize(Bit_Shift_out1_13, 32) + resize(Delay3_out1_7, 32);
  Add1_out1_13 <= Add1_add_temp_13(27 DOWNTO 0);

  Bit_Slice1_out1_16 <= Add1_out1_13(27);

  Add2_add_temp_13 <= resize(Bit_Shift_out1_13, 32) + resize(Delay4_out1_7, 32);
  ...
  Add_add_temp_13 <= resize(Bit_Shift_out1_13, 32) + resize(Delay2_out1_6, 32);
  ...
  BitSlice_out1_2 <= unsigned(if_exp_diff_in_0_out1_14(23 DOWNTO 0));

  alpha0_out1_4 <= '0';

  Bit_Concat_out1_3 <= BitSlice_out1_2 & alpha0_out1_4;

  Delay2_7_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay2_out1_7 <= to_unsigned(16#0000000#, 25);
      ELSIF enb = '1' THEN
        Delay2_out1_7 <= Bit_Concat_out1_3;
      END IF;
    END IF;
  ...
  R_0_out1 <= '1' WHEN Delay2_out1_7 = to_unsigned(16#0000000#, 25) ELSE
      '0';

  reset_to_zero_R_0_out1 <= Delay_out1_6 OR R_0_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay21_reg <= (OTHERS => to_signed(16#000#, 10));
      ELSIF enb = '1' THEN
        Delay21_reg(0) <= DTC_out1;
        Delay21_reg(1 TO 8) <= Delay21_reg(0 TO 7);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        reduced_reg_7 <= (OTHERS => to_signed(16#000#, 10));
      ELSIF enb = '1' THEN
        reduced_reg_7(0) <= modrem_Normalize_Exp_Mant_out3;
        reduced_reg_7(1 TO 7) <= reduced_reg_7(0 TO 6);
      END IF;
    END IF;
  ...
  exp_a_norm_exp_b_norm_out1_1 <= '1' WHEN Delay21_out1 < modrem_Normalize_Exp_Mant_out3_1 ELSE
      '0';

  
  if_exp_a_norm_exp_b_norm_out1 <= modrem_Normalize_Exp_Mant_out3_1 WHEN exp_a_norm_exp_b_norm_out1_1 = '0' ELSE
      Delay21_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay1_out1_5 <= to_signed(16#000#, 10);
      ELSIF enb = '1' THEN
        Delay1_out1_5 <= if_exp_a_norm_exp_b_norm_out1;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay4_out1_8 <= to_signed(16#000#, 10);
      ELSIF enb = '1' THEN
        Delay4_out1_8 <= Delay1_out1_5;
      END IF;
    END IF;
  END PROCESS Delay4_8_process;


  BitSlice_out1_3 <= Delay2_out1_7(24 DOWNTO 1);
  ...
  Logical_Operator3_out1_1 <= Bit_Slice6_out1 OR Bit_Slice5_out1;
  ...
  Logical_Operator2_out1_2 <= Logical_Operator1_out1_2 OR Logical_Operator3_out1_1;
  ...
  exp_R_shift1_sub_temp <= resize(Delay4_out1_8, 32) - exp_R_shift1_sub_cast;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay1_out1_6 <= to_unsigned(16#0000000#, 25);
      ELSIF enb = '1' THEN
        Delay1_out1_6 <= Delay2_out1_7;
      END IF;
    END IF;
  END PROCESS Delay1_6_process;


  bitsll_tmp2_shift1_out1 <= Delay1_out1_6 sll to_integer(Delay2_out1_8);

  C_out1_17 <= to_unsigned(16#0000000#, 25);
  ...
  BitSlice3_out1 <= bitsrl_tmp3_1_out1(23 DOWNTO 0);

  C1_out1 <= to_unsigned(16#000000#, 24);

  
  if_exp_rem_0_out1 <= BitSlice3_out1 WHEN exp_rem_0_out1_1 = '0' ELSE
      C1_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay1_out1_7 <= to_unsigned(16#000000#, 24);
      ELSIF enb = '1' THEN
        Delay1_out1_7 <= if_reset_to_zero_R_0_1_out1;
      END IF;
    END IF;
  END PROCESS Delay1_7_process;


  Bit_Concat_out1_4 <= alpha0_out1 & Delay1_out1_7;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay2_out1_9 <= '0';
      ELSIF enb = '1' THEN
        Delay2_out1_9 <= Delay_out1_7;
      END IF;
    END IF;
  END PROCESS Delay2_9_process;


  alphabitget_Mant_tmp_2_0_out1 <= BitSlice1_out1_1 OR Delay2_out1_9;
  ...
  Logical_Operator_out1_5 <= exp_rem_0_out1 OR Delay3_out1_8;
  ...
  if_reset_to_zero_R_0_out1 <= DTC2_out1_2 WHEN Logical_Operator_out1_5 = '0' ELSE
      C3_out1;

  Delay_8_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay_out1_8 <= to_unsigned(16#00#, 8);
      ELSIF enb = '1' THEN
        Delay_out1_8 <= if_reset_to_zero_R_0_out1;
      END IF;
    END IF;
  ...
  Exp_cast_1_like_Exp_out1 <= Delay_out1_8 + cast_1_like_Exp_out1;

  
  if_bitget_Mant_tmp_Mant_tmp_Wor_out1 <= Delay_out1_8 WHEN BitSlice2_out1_1 = '0' ELSE
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay18_reg(0) <= if_aExponent_0_aMantissa_out1;
        Delay18_reg(1 TO 6) <= Delay18_reg(0 TO 5);
      END IF;
    END IF;
  ...
  Switch6_out1_1 <= Constant3_out1 WHEN Relational_Operator_out1 = '0' ELSE
  ...
  Logical_Operator_out1_6 <= Compare_To_Zero_out1_3 OR BitSlice2_out1_1;

  BitSlice3_out1_1 <= if_bitget_Mant_tmp_1_0_out1(23 DOWNTO 1);

  C_out1_20 <= to_unsigned(16#000000#, 23);

  
  if_bitget_Mant_tmp_Mant_tmp_Wor_1_out1 <= BitSlice3_out1_1 WHEN Logical_Operator_out1_6 = '0' ELSE
      C_out1_20;

  C3_out1_1 <= to_unsigned(16#400000#, 23);

  C2_out1_1 <= to_unsigned(16#000000#, 23);

  
  if_aExponent_0_aMantissa_1_out1 <= C3_out1_1 WHEN alphaaExponent_0_aMantissa_out1_3 = '0' ELSE
      C2_out1_1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay19_reg <= (OTHERS => to_unsigned(16#000000#, 23));
      ELSIF enb = '1' THEN
        Delay19_reg(0) <= if_aExponent_0_aMantissa_1_out1;
        Delay19_reg(1 TO 6) <= Delay19_reg(0 TO 5);
      END IF;
    END IF;
  ...
  Switch5_out1_1 <= Constant2_out1_1 WHEN Relational_Operator_out1 = '0' ELSE
  ...
  nfp_out_pack <= Delay5_out1 & Delay6_out1 & Delay7_out1;
