-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Encoder_Zynq\IncreEncoder_V16_ipcore.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IncreEncoder_V16_ipcore
-- Source Path: IncreEncoder_V16_ipcore
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY IncreEncoder_V16_ipcore IS
...
END IncreEncoder_V16_ipcore;


ARCHITECTURE rtl OF IncreEncoder_V16_ipcore IS

  -- Component Declarations
  COMPONENT IncreEncoder_V16_ipcore_axi_lite
  ...
  COMPONENT IncreEncoder_V16_ipcore_dut
  ...
  FOR ALL : IncreEncoder_V16_ipcore_axi_lite
    USE ENTITY work.IncreEncoder_V16_ipcore_axi_lite(rtl);

  FOR ALL : IncreEncoder_V16_ipcore_dut
    USE ENTITY work.IncreEncoder_V16_ipcore_dut(rtl);
...
BEGIN
  u_IncreEncoder_V16_ipcore_axi_lite_inst : IncreEncoder_V16_ipcore_axi_lite
    PORT MAP( reset => reset,
              ...
              read_thete_el_AXI4 => thete_el_AXI4_sig,  -- ufix24_En20
              read_theta_mech_AXI4 => theta_mech_AXI4_sig,  -- ufix24_En20
  ...
  u_IncreEncoder_V16_ipcore_dut_inst : IncreEncoder_V16_ipcore_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              ...
              thete_el => thete_el_sig,  -- ufix24_En20
              thete_el_AXI4 => thete_el_AXI4_sig,  -- ufix24_En20
              theta_mech_AXI4 => theta_mech_AXI4_sig,  -- ufix24_En20
