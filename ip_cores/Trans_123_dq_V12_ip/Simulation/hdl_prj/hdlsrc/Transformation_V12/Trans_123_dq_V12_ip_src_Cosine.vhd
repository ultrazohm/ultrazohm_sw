-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Transformation_V12\Trans_123_dq_V12_ip_src_Cosine.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Trans_123_dq_V12_ip_src_Cosine
-- Source Path: Transformation_V12/Trans_123_dq_fix_V12/Cosine
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Trans_123_dq_V12_ip_src_Cosine IS
...
END Trans_123_dq_V12_ip_src_Cosine;


ARCHITECTURE rtl OF Trans_123_dq_V12_ip_src_Cosine IS

  -- Constants
  CONSTANT nc                             : vector_of_signed16(0 TO 512) := 
  ...
  CONSTANT nc_2                           : vector_of_signed16(0 TO 512) := 
    (to_signed(16#0000#, 16), to_signed(16#0032#, 16), to_signed(16#0065#, 16), to_signed(16#0097#, 16),
     to_signed(16#00C9#, 16), to_signed(16#00FB#, 16), to_signed(16#012E#, 16), to_signed(16#0160#, 16),
     to_signed(16#0192#, 16), to_signed(16#01C4#, 16), to_signed(16#01F7#, 16), to_signed(16#0229#, 16),
     to_signed(16#025B#, 16), to_signed(16#028D#, 16), to_signed(16#02C0#, 16), to_signed(16#02F2#, 16),
...
BEGIN
  ...
  BEGIN
    ...
    IF k = to_unsigned(16#200#, 10) THEN 
      NULL;
    ELSE 
    ...
    sub_temp := nc(to_integer(k)) - dout_low;
  ...
  BEGIN
    ...
    IF k1 = to_unsigned(16#200#, 10) THEN 
      NULL;
    ELSE 
    ...
    sub_temp1 := nc_2(to_integer(k1)) - dout_low1;
