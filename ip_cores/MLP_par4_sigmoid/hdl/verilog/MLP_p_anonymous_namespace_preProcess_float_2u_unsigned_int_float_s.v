...
module MLP_p_anonymous_namespace_preProcess_float_2u_unsigned_int_float_s (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
reg   [31:0] p_Result_8_i_i_reg_239;
reg   [31:0] p_Result_9_i_i_reg_244;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln50_reg_220 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        p_Result_8_i_i_reg_239 <= {{p_x_dout[95:64]}};
        p_Result_9_i_i_reg_244 <= {{p_x_dout[127:96]}};
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((icmp_ln50_reg_220_pp0_iter11_reg == 1'd0) & (ap_enable_reg_pp0_iter12 == 1'b1) & (p_data_full_n == 1'b0)) | ((icmp_ln50_reg_220 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (p_x_empty_n == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((icmp_ln50_reg_220_pp0_iter11_reg == 1'd0) & (ap_enable_reg_pp0_iter12 == 1'b1) & (p_data_full_n == 1'b0)) | ((icmp_ln50_reg_220 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (p_x_empty_n == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((icmp_ln50_reg_220_pp0_iter11_reg == 1'd0) & (ap_enable_reg_pp0_iter12 == 1'b1) & (p_data_full_n == 1'b0)) | ((icmp_ln50_reg_220 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (p_x_empty_n == 1'b0)));
end
...
always @ (*) begin
    ap_block_state14_pp0_stage0_iter12 = ((icmp_ln50_reg_220_pp0_iter11_reg == 1'd0) & (p_data_full_n == 1'b0));
end
...
assign grp_fu_128_p0 = p_Result_8_i_i_reg_239;

assign grp_fu_128_p1 = p_Result_9_i_i_reg_244;
...
assign p_data_din = l_sum_reg_279;
...
endmodule //MLP_p_anonymous_namespace_preProcess_float_2u_unsigned_int_float_s
