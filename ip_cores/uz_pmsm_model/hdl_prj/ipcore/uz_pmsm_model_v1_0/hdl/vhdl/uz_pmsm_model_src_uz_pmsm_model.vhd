...
ARCHITECTURE rtl OF uz_pmsm_model_src_uz_pmsm_model IS
  ...
  SIGNAL Sum6_out1                        : std_logic_vector(63 DOWNTO 0);  -- ufix64
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_100_1 = '1' THEN
        Delay_lowered2_bypass_reg <= Delay_toDel;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_100_1 = '1' THEN
        Delay_lowered1_bypass_reg <= Delay_toDel_2;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_100_1 = '1' THEN
        Delay1_bypass_reg <= Data_Type_Conversion3_out1;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_100_1 = '1' THEN
        Delay_bypass_reg <= Data_Type_Conversion4_out1;
      END IF;
    END IF;
