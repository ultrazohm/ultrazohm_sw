-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\test_phase_voltages_without_delays\hdlsrc\test_phase_voltages_without_delays\test_phase_voltages_without_delays_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: test_phase_voltages_without_delays_dut
-- Source Path: test_phase_voltages_without_delays/test_phase_voltages_without_delays_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY test_phase_voltages_without_delays_dut IS
...
END test_phase_voltages_without_delays_dut;


ARCHITECTURE rtl OF test_phase_voltages_without_delays_dut IS

  -- Component Declarations
  COMPONENT test_phase_voltages_without_delays_src_Phase_voltages_per_switching_state1
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : test_phase_voltages_without_delays_src_Phase_voltages_per_switching_state1
    USE ENTITY work.test_phase_voltages_without_delays_src_Phase_voltages_per_switching_state1(rtl);
...
BEGIN
  u_test_phase_voltages_without_delays_src_Phase_voltages_per_switching_state1 : test_phase_voltages_without_delays_src_Phase_voltages_per_switching_state1
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
