% Read the CSV file
data = csvread('i_d_i_q_data_step3000.csv', 1, 0); % Assuming the data starts from the second row
...
fig.PaperPosition = [-.01, .05, 9, 7]; % Width and height in centimeters
print('python3000min_step.pdf', '-dpdf', '-r300'); % Specify the resolution if needed
