...
#define ENDAT_D4_MACHINE_POLEPAIRS 3U
#define ENDAT_D4_CLK_FREQUENCY_HZ 2500000U
#define ENDAT_D4_POSITION_MECH_OFFSET_RAD 1.021435 //UZ_PIf/3.0f + 1.021435f
...
#define ENDAT_D4_SAMPLING_INTERVAL_SECONDS 1.0f/UZ_PWM_FREQUENCY
