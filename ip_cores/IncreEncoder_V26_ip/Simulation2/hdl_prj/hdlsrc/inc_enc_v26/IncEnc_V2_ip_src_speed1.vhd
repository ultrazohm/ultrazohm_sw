-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/inc_enc_v26/IncEnc_V2_ip_src_speed1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IncEnc_V2_ip_src_speed1
-- Source Path: inc_enc_v26/IncEnc_V26/speed1
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY IncEnc_V2_ip_src_speed1 IS
...
END IncEnc_V2_ip_src_speed1;


ARCHITECTURE rtl OF IncEnc_V2_ip_src_speed1 IS

  -- Component Declarations
  COMPONENT IncEnc_V2_ip_src_OS_factor_logic
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT IncEnc_V2_ip_src_calc_omega
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT IncEnc_V2_ip_src_Average
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : IncEnc_V2_ip_src_OS_factor_logic
    USE ENTITY work.IncEnc_V2_ip_src_OS_factor_logic(rtl);

  FOR ALL : IncEnc_V2_ip_src_calc_omega
    USE ENTITY work.IncEnc_V2_ip_src_calc_omega(rtl);

  FOR ALL : IncEnc_V2_ip_src_Average
    USE ENTITY work.IncEnc_V2_ip_src_Average(rtl);
...
BEGIN
  u_OS_factor_logic : IncEnc_V2_ip_src_OS_factor_logic
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_Average : IncEnc_V2_ip_src_Average
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  GEN_LABEL: FOR k IN 0 TO 3 GENERATE
    u_calc_omega : IncEnc_V2_ip_src_calc_omega
      PORT MAP( clk => clk,
                reset_x => reset_x,
                enb => enb,
