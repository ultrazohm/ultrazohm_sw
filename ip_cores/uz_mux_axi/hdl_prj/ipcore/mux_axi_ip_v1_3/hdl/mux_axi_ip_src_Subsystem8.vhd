-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mux_axi\mux_axi_ip_src_Subsystem8.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mux_axi_ip_src_Subsystem8
-- Source Path: mux_axi/mux_axi/Subsystem8
-- Hierarchy Level: 1
-- Model version: 9.8
-- 
-- -------------------------------------------------------------
...
ENTITY mux_axi_ip_src_Subsystem8 IS
...
END mux_axi_ip_src_Subsystem8;


ARCHITECTURE rtl OF mux_axi_ip_src_Subsystem8 IS

  -- Component Declarations
  COMPONENT mux_axi_ip_src_Detect_Rise_Positive_block6
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT mux_axi_ip_src_Detect_Fall_Nonpositive2_block6
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : mux_axi_ip_src_Detect_Rise_Positive_block6
    USE ENTITY work.mux_axi_ip_src_Detect_Rise_Positive_block6(rtl);

  FOR ALL : mux_axi_ip_src_Detect_Fall_Nonpositive2_block6
    USE ENTITY work.mux_axi_ip_src_Detect_Fall_Nonpositive2_block6(rtl);
...
BEGIN
  ...
  u_Detect_Rise_Positive : mux_axi_ip_src_Detect_Rise_Positive_block6
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Detect_Fall_Nonpositive2 : mux_axi_ip_src_Detect_Fall_Nonpositive2_block6
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
