-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_inverter_3phgm\uz_invert_3ph_src_uz_inverter_3ph.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_invert_3ph_src_uz_inverter_3ph
...
USE work.uz_invert_3ph_src_uz_inverter_3ph_pkg.ALL;

ENTITY uz_invert_3ph_src_uz_inverter_3ph IS
...
END uz_invert_3ph_src_uz_inverter_3ph;


ARCHITECTURE rtl OF uz_invert_3ph_src_uz_inverter_3ph IS

  -- Component Declarations
  COMPONENT uz_invert_3ph_src_uz_inverter_3ph_tc
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          clk_enable                      :   IN    std_logic;
          enb                             :   OUT   std_logic;
  ...
  COMPONENT uz_invert_3ph_src_nfp_convert_sfix_25_En12_to_double
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT uz_invert_3ph_src_nfp_convert_single2double
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT uz_invert_3ph_src_nfp_convert_double2single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT uz_invert_3ph_src_dot_product_1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT uz_invert_3ph_src_nfp_add_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT uz_invert_3ph_src_dot_product_2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT uz_invert_3ph_src_nfp_convert_double_to_fixed_25_En12
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          nfp_in                          :   IN    std_logic_vector(63 DOWNTO 0);  -- double
  ...
  FOR ALL : uz_invert_3ph_src_uz_inverter_3ph_tc
    USE ENTITY work.uz_invert_3ph_src_uz_inverter_3ph_tc(rtl);

  FOR ALL : uz_invert_3ph_src_nfp_convert_sfix_25_En12_to_double
    USE ENTITY work.uz_invert_3ph_src_nfp_convert_sfix_25_En12_to_double(rtl);

  FOR ALL : uz_invert_3ph_src_nfp_convert_single2double
    USE ENTITY work.uz_invert_3ph_src_nfp_convert_single2double(rtl);

  FOR ALL : uz_invert_3ph_src_nfp_convert_double2single
    USE ENTITY work.uz_invert_3ph_src_nfp_convert_double2single(rtl);

  FOR ALL : uz_invert_3ph_src_dot_product_1
    USE ENTITY work.uz_invert_3ph_src_dot_product_1(rtl);

  FOR ALL : uz_invert_3ph_src_nfp_add_single
    USE ENTITY work.uz_invert_3ph_src_nfp_add_single(rtl);

  FOR ALL : uz_invert_3ph_src_dot_product_2
    USE ENTITY work.uz_invert_3ph_src_dot_product_2(rtl);

  FOR ALL : uz_invert_3ph_src_nfp_convert_double_to_fixed_25_En12
    USE ENTITY work.uz_invert_3ph_src_nfp_convert_double_to_fixed_25_En12(rtl);
...
BEGIN
  ...
  u_uz_inverter_3ph_tc : uz_invert_3ph_src_uz_inverter_3ph_tc
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_uz_inverter_3phgm_uz_inverter_3ph_nfp_convert_sfix_25_En12_to_double : uz_invert_3ph_src_nfp_convert_sfix_25_En12_to_double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_uz_inverter_3phgm_uz_inverter_3ph_nfp_convert_sfix_25_En12_to_double_1 : uz_invert_3ph_src_nfp_convert_sfix_25_En12_to_double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_uz_inverter_3phgm_uz_inverter_3ph_nfp_convert_single2double : uz_invert_3ph_src_nfp_convert_single2double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_uz_inverter_3phgm_uz_inverter_3ph_nfp_convert_single2double_1 : uz_invert_3ph_src_nfp_convert_single2double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_uz_inverter_3phgm_uz_inverter_3ph_nfp_convert_sfix_25_En12_to_double_2 : uz_invert_3ph_src_nfp_convert_sfix_25_En12_to_double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_uz_inverter_3phgm_uz_inverter_3ph_nfp_convert_single2double_2 : uz_invert_3ph_src_nfp_convert_single2double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_uz_inverter_3phgm_uz_inverter_3ph_nfp_convert_double2single : uz_invert_3ph_src_nfp_convert_double2single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in => Iab(0),  -- double
  ...
  u_dot_product_1 : uz_invert_3ph_src_dot_product_1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp : uz_invert_3ph_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_uz_inverter_3phgm_uz_inverter_3ph_nfp_convert_double2single_1 : uz_invert_3ph_src_nfp_convert_double2single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in => Iab(1),  -- double
  ...
  u_dot_product_1_1 : uz_invert_3ph_src_dot_product_1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp_1 : uz_invert_3ph_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_dot_product_2 : uz_invert_3ph_src_dot_product_2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              in1 => row3,  -- single [2]
  ...
  u_nfp_add_comp_2 : uz_invert_3ph_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_dot_product_1_2 : uz_invert_3ph_src_dot_product_1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp_3 : uz_invert_3ph_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_dot_product_1_3 : uz_invert_3ph_src_dot_product_1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp_4 : uz_invert_3ph_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_dot_product_2_1 : uz_invert_3ph_src_dot_product_2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              in1 => row6,  -- single [2]
  ...
  u_nfp_add_comp_5 : uz_invert_3ph_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_dot_product_2_2 : uz_invert_3ph_src_dot_product_2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              in1 => row7,  -- single [2]
  ...
  u_nfp_add_comp_6 : uz_invert_3ph_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_dot_product_1_4 : uz_invert_3ph_src_dot_product_1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp_7 : uz_invert_3ph_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_dot_product_1_5 : uz_invert_3ph_src_dot_product_1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp_8 : uz_invert_3ph_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_dot_product_1_6 : uz_invert_3ph_src_dot_product_1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp_9 : uz_invert_3ph_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_dot_product_2_3 : uz_invert_3ph_src_dot_product_2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              in1 => row11,  -- single [2]
  ...
  u_nfp_add_comp_10 : uz_invert_3ph_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_dot_product_1_7 : uz_invert_3ph_src_dot_product_1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp_11 : uz_invert_3ph_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_dot_product_2_4 : uz_invert_3ph_src_dot_product_2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              in1 => row1,  -- single [2]
  ...
  u_uz_inverter_3phgm_uz_inverter_3ph_nfp_convert_single2double_3 : uz_invert_3ph_src_nfp_convert_single2double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_uz_inverter_3phgm_uz_inverter_3ph_nfp_convert_double2single_2 : uz_invert_3ph_src_nfp_convert_double2single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_dot_product_2_5 : uz_invert_3ph_src_dot_product_2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              in1 => row2,  -- single [2]
  ...
  u_uz_inverter_3phgm_uz_inverter_3ph_nfp_convert_single2double_4 : uz_invert_3ph_src_nfp_convert_single2double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_uz_inverter_3phgm_uz_inverter_3ph_nfp_convert_double2single_3 : uz_invert_3ph_src_nfp_convert_double2single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_dot_product_2_6 : uz_invert_3ph_src_dot_product_2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              in1 => row3_1,  -- single [2]
  ...
  u_uz_inverter_3phgm_uz_inverter_3ph_nfp_convert_single2double_5 : uz_invert_3ph_src_nfp_convert_single2double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_uz_inverter_3phgm_uz_inverter_3ph_nfp_convert_double2single_4 : uz_invert_3ph_src_nfp_convert_double2single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_uz_inverter_3phgm_uz_inverter_3ph_nfp_convert_double_to_fixed_25_En12 : uz_invert_3ph_src_nfp_convert_double_to_fixed_25_En12
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in => Data_Type_Conversion6_out1,  -- double
  ...
  u_uz_inverter_3phgm_uz_inverter_3ph_nfp_convert_double_to_fixed_25_En12_1 : uz_invert_3ph_src_nfp_convert_double_to_fixed_25_En12
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in => Data_Type_Conversion8_out1,  -- double
  ...
  u_uz_inverter_3phgm_uz_inverter_3ph_nfp_convert_double_to_fixed_25_En12_2 : uz_invert_3ph_src_nfp_convert_double_to_fixed_25_En12
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in => Data_Type_Conversion7_out1,  -- double
  ...
  row1(0) <= configuration1(0);
  row1(1) <= configuration1(2);

  col1(0) <= Switch_out1_1(0);
  col1(1) <= Switch_out1_1(1);

  row2(0) <= configuration1(3);
  row2(1) <= configuration1(4);

  col2(0) <= Switch_out1_1(1);
  col2(1) <= Switch_out1_1(2);
