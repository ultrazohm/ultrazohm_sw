...
static struct uz_inverter_adapter_config_t inverter_config_d1 = {
		.base_address = XPAR_UZ_DIGITAL_ADAPTER_D1_ADAPTER_INVERTER_0_UZ_D_INVERTER_ADAPTER_0_BASEADDR,
		.ip_clk_frequency_Hz = 100000000,
		.linear_interpolation_params = {-289.01f, 218.72f}
};

static struct uz_inverter_adapter_config_t inverter_config_d2 = {
		.base_address = XPAR_UZ_DIGITAL_ADAPTER_D2_ADAPTER_INVERTER_1_UZ_D_INVERTER_ADAPTER_1_BASEADDR,
		.ip_clk_frequency_Hz = 100000000,
		.linear_interpolation_params = {-289.01f, 218.72f}
};
...
static struct uz_inverter_adapter_outputs_t inverter_outputs_d2 = {
   .PWMdutyCycNormalized_H1 = 0.0f,
   .PWMdutyCycNormalized_L1 = 0.0f,
   .PWMdutyCycNormalized_H2 = 0.0f,
   .PWMdutyCycNormalized_L2 = 0.0f,
...
uz_inverter_adapter_t* initialize_inverter_D1(void) {
       return(uz_inverter_adapter_init(inverter_config_d1, inverter_outputs_d1));
}

uz_inverter_adapter_t* initialize_inverter_D2(void) {
       return(uz_inverter_adapter_init(inverter_config_d2, inverter_outputs_d2));
}
