...
// ==============================================================
# 1 "C:/Users/ponpr/Documents/ultrazohm_sw/ip_cores/FOC/foc/uz_FOC.c"
# 1 "C:/Users/ponpr/Documents/ultrazohm_sw/ip_cores/FOC/foc/uz_FOC.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Users/ponpr/Documents/ultrazohm_sw/ip_cores/FOC/foc/uz_FOC.c" 2
# 17 "C:/Users/ponpr/Documents/ultrazohm_sw/ip_cores/FOC/foc/uz_FOC.c"
...
# 18 "C:/Users/ponpr/Documents/ultrazohm_sw/ip_cores/FOC/foc/uz_FOC.c" 2
...
void uz_FOC_sample(uz_FOC* self, struct uz_dq_t i_reference_Ampere, struct uz_dq_t i_actual_Ampere, float V_dc_volts, float omega_el_rad_per_sec, struct uz_dq_t* u_output_Volts) {
#pragma HLS INTERFACE m_axi port=u_output_Volts offset=slave bundle=Dout depth=50
...
#ifndef HLS_FASTSIM
struct __cosim_s1__{char data[sizeof(struct uz_dq_t)];};
struct __cosim_s2__{char data[sizeof(struct uz_dq_t)];};
#ifdef __cplusplus
extern "C"
#endif
void apatb_uz_FOC_sample_hw(struct uz_FOC *, struct __cosim_s1__, struct __cosim_s2__, float, float, struct uz_dq_t *);
#ifdef __cplusplus
extern "C"
#endif
void uz_FOC_sample_hw_stub(struct uz_FOC *self, struct __cosim_s1__ i_reference_Ampere, struct __cosim_s2__ i_actual_Ampere, float V_dc_volts, float omega_el_rad_per_sec, struct uz_dq_t *u_output_Volts){
uz_FOC_sample(self, *((struct uz_dq_t*)&i_reference_Ampere), *((struct uz_dq_t*)&i_actual_Ampere), V_dc_volts, omega_el_rad_per_sec, u_output_Volts);
return ;
}
#ifdef __cplusplus
extern "C"
#endif
void apatb_uz_FOC_sample_sw(struct uz_FOC *self, struct uz_dq_t i_reference_Ampere, struct uz_dq_t i_actual_Ampere, float V_dc_volts, float omega_el_rad_per_sec, struct uz_dq_t *u_output_Volts){
apatb_uz_FOC_sample_hw(self, *((struct __cosim_s1__*)&i_reference_Ampere), *((struct __cosim_s2__*)&i_actual_Ampere), V_dc_volts, omega_el_rad_per_sec, u_output_Volts);
return ;
}
#endif
# 34 "C:/Users/ponpr/Documents/ultrazohm_sw/ip_cores/FOC/foc/uz_FOC.c"


static struct uz_dq_t uz_FOC_CurrentControl(uz_FOC* self, struct uz_dq_t i_reference_Ampere, struct uz_dq_t i_actual_Ampere) {
 struct uz_dq_t u_output_Volts = { 0 };
 u_output_Volts.q = uz_PI_Controller_sample(&self->config_iq,self->I_rst, i_reference_Ampere.q, i_actual_Ampere.q, self->ext_clamping);
 u_output_Volts.d = uz_PI_Controller_sample(&self->config_id,self->I_rst, i_reference_Ampere.d, i_actual_Ampere.d, self->ext_clamping);
