...
extern float Action[4];
extern float Action2[4];
...
int JavaScope_initialize(DS_Data* data)
{
	...
	js_ch_observable[JSO_ia] 					= &Action[0];
	js_ch_observable[JSO_ib] 					= &Action[1];
	js_ch_observable[JSO_ic] 					= &Action[2];
	js_ch_observable[JSO_ua] 					= &Action[3];
	js_ch_observable[JSO_ub] 					= & Action2[0];
	js_ch_observable[JSO_uc] 					= & Action2[1];
	js_ch_observable[JSO_iq] 					= & Action2[2];
	js_ch_observable[JSO_id] 					= & Action2[3];
