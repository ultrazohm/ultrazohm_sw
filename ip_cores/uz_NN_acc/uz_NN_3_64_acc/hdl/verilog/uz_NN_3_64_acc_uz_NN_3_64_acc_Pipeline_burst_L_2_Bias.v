...
module uz_NN_3_64_acc_uz_NN_3_64_acc_Pipeline_burst_L_2_Bias (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [29:0] sext_ln308;
output  [5:0] L_2_Bias_address0;
output   L_2_Bias_ce0;
output   L_2_Bias_we0;
output  [31:0] L_2_Bias_d0;
...
wire   [5:0] trunc_ln310_fu_110_p1;
reg   [5:0] trunc_ln310_reg_149;
reg   [5:0] trunc_ln310_reg_149_pp0_iter1_reg;
reg   [31:0] arrays_addr_read_reg_154;
reg    ap_condition_exit_pp0_iter1_stage0;
wire   [31:0] zext_ln310_fu_129_p1;
reg   [6:0] i_fu_58;
wire   [6:0] add_ln308_fu_104_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln308_fu_98_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln308_reg_145 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        arrays_addr_read_reg_154 <= m_axi_arrays_RDATA;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln308_fu_98_p2 == 1'd0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln308_fu_98_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln308_reg_145 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (icmp_ln308_reg_145 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln308_reg_145 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign L_2_Bias_address0 = zext_ln310_fu_129_p1;

assign L_2_Bias_d0 = arrays_addr_read_reg_154;

assign add_ln308_fu_104_p2 = (ap_sig_allocacmp_i_5 + 7'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((icmp_ln308_reg_145 == 1'd0) & (m_axi_arrays_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((icmp_ln308_reg_145 == 1'd0) & (m_axi_arrays_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((icmp_ln308_reg_145 == 1'd0) & (m_axi_arrays_RVALID == 1'b0));
end
...
assign icmp_ln308_fu_98_p2 = ((ap_sig_allocacmp_i_5 == 7'd64) ? 1'b1 : 1'b0);
...
assign trunc_ln310_fu_110_p1 = ap_sig_allocacmp_i_5[5:0];

assign zext_ln310_fu_129_p1 = trunc_ln310_reg_149_pp0_iter1_reg;

endmodule //uz_NN_3_64_acc_uz_NN_3_64_acc_Pipeline_burst_L_2_Bias
