-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\inc_enc_v25\Incremental_Encoder_src_HDL_Reciprocal.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Incremental_Encoder_src_HDL_Reciprocal
-- Source Path: inc_enc_v25/IncEnc_V25/speed/calc_omega/invt_mult/HDL Reciprocal
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
USE work.Incremental_Encoder_src_IncEnc_V25_pac.ALL;

ENTITY Incremental_Encoder_src_HDL_Reciprocal IS
...
END Incremental_Encoder_src_HDL_Reciprocal;


ARCHITECTURE rtl OF Incremental_Encoder_src_HDL_Reciprocal IS

  -- Component Declarations
  COMPONENT Incremental_Encoder_src_HDL_Reciprocal_core
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Incremental_Encoder_src_HDL_Reciprocal_core
    USE ENTITY work.Incremental_Encoder_src_HDL_Reciprocal_core(rtl);
...
BEGIN
  ...
  u_core_stage1_inst : Incremental_Encoder_src_HDL_Reciprocal_core
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_core_stage2_inst : Incremental_Encoder_src_HDL_Reciprocal_core
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_core_stage3_inst : Incremental_Encoder_src_HDL_Reciprocal_core
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
