-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj123/hdlsrc/uz_pmsm_model_9ph_21b_all_double/uz_pmsm_model_9ph_only_dq2_src_nfp_convert_single2double.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_9ph_only_dq2_src_nfp_convert_single2double
-- Source Path: uz_pmsm_model_9ph_21b_all_double/uz_pmsm_model_9ph/dq_model_9ph/nfp_convert_single2double
-- Hierarchy Level: 1
-- 
...
ENTITY uz_pmsm_model_9ph_only_dq2_src_nfp_convert_single2double IS
...
END uz_pmsm_model_9ph_only_dq2_src_nfp_convert_single2double;


ARCHITECTURE rtl OF uz_pmsm_model_9ph_only_dq2_src_nfp_convert_single2double IS
  ...
  SIGNAL Delay12_PS_2_4_reg               : std_logic_vector(0 TO 3);  -- ufix1 [4]
  SIGNAL Delay12_PS_2_4_reg_next          : std_logic_vector(0 TO 3);  -- ufix1 [4]
  ...
  SIGNAL Delay13_PS_2_4_reg               : std_logic_vector(0 TO 2);  -- ufix1 [3]
  SIGNAL Delay13_PS_2_4_reg_next          : std_logic_vector(0 TO 2);  -- ufix1 [3]
  ...
  SIGNAL Delay14_PS_2_4_reg               : std_logic_vector(0 TO 2);  -- ufix1 [3]
  SIGNAL Delay14_PS_2_4_reg_next          : std_logic_vector(0 TO 2);  -- ufix1 [3]
  ...
  SIGNAL Delay22_PS_4_reg_next            : vector_of_unsigned52(0 TO 1);  -- ufix52 [2]
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        Delay12_PS_2_4_reg(3) <= Delay12_PS_2_4_reg_next(3);
      END IF;
    END IF;
  ...
  Delay12_PS_2_4_reg_next(3) <= Delay12_PS_2_4_reg(2);
  ...
  Delay13_PS_2_4_reg_next(2) <= Delay13_PS_2_4_reg(1);
  ...
  Delay14_PS_2_4_reg_next(2) <= Delay14_PS_2_4_reg(1);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay22_PS_4_reg(0) <= to_unsigned(0, 52);
        Delay22_PS_4_reg(1) <= to_unsigned(0, 52);
      ELSIF enb = '1' THEN
        Delay22_PS_4_reg(0) <= Delay22_PS_4_reg_next(0);
        Delay22_PS_4_reg(1) <= Delay22_PS_4_reg_next(1);
      END IF;
    END IF;
  END PROCESS Delay22_PS_4_process;

  Delay22_PS_4_out1 <= Delay22_PS_4_reg(1);
  Delay22_PS_4_reg_next(0) <= Bit_Concat1_out1_1;
  Delay22_PS_4_reg_next(1) <= Delay22_PS_4_reg(0);
