-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\jonat\Documents\MA_JL_CIL\ip_cores\uz_JL_invModel_PT1\hdl_prj\hdlsrc\uz_JL_invModel_PT1\uz_JL_Inv_PT1_axi4_module.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_JL_Inv_PT1_axi4_module
-- Source Path: uz_JL_Inv_PT1/uz_JL_Inv_PT1_axi4/uz_JL_Inv_PT1_axi4_module
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_JL_Inv_PT1_axi4_module IS
...
END uz_JL_Inv_PT1_axi4_module;


ARCHITECTURE rtl OF uz_JL_Inv_PT1_axi4_module IS

  -- Component Declarations
  COMPONENT uz_JL_Inv_PT1_rdfifo_data
    PORT( clk                             :   IN    std_logic;
  ...
  COMPONENT uz_JL_Inv_PT1_rdfifo_rid
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT uz_JL_Inv_PT1_rdfifo_last
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : uz_JL_Inv_PT1_rdfifo_data
    USE ENTITY work.uz_JL_Inv_PT1_rdfifo_data(rtl);

  FOR ALL : uz_JL_Inv_PT1_rdfifo_rid
    USE ENTITY work.uz_JL_Inv_PT1_rdfifo_rid(rtl);

  FOR ALL : uz_JL_Inv_PT1_rdfifo_last
    USE ENTITY work.uz_JL_Inv_PT1_rdfifo_last(rtl);
...
BEGIN
  u_uz_JL_Inv_PT1_rdfifo_data_inst : uz_JL_Inv_PT1_rdfifo_data
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => const_1,
  ...
  u_uz_JL_Inv_PT1_rdfifo_rid_inst : uz_JL_Inv_PT1_rdfifo_rid
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => const_1,
  ...
  u_uz_JL_Inv_PT1_rdfifo_last_inst : uz_JL_Inv_PT1_rdfifo_last
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => const_1,
