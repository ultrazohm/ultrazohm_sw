...
void uz_codegen0_step(RT_MODEL *const rtM)
{
   ...
   *  Inport: '<Root>/summand1'
   *  Inport: '<Root>/summand2'
   *  Inport: '<Root>/summand3'
   */
   ...
   *  Inport: '<Root>/reset_SumIntegrator'
   */
   ...
   *  Inport: '<Root>/reset_TimeIntegrator'
   */
  ...
  /* Outport: '<Root>/fb_summand1' incorporates:
   *  Inport: '<Root>/summand1'
   */
  rtY->fb_summand1 = rtU->summand1;

  /* Outport: '<Root>/fb_time' incorporates:
   *  Inport: '<Root>/time'
   */
