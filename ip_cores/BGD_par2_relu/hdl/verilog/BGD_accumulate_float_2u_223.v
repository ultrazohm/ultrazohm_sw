...
module BGD_accumulate_float_2u_223 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [30:0] i_15_fu_149_p2;
reg   [30:0] i_15_reg_249;
...
wire   [15:0] add_ln416_1_fu_183_p2;
reg   [15:0] add_ln416_1_reg_259;
reg   [15:0] add_ln416_1_reg_259_pp0_iter1_reg;
reg   [15:0] add_ln416_1_reg_259_pp0_iter2_reg;
reg   [15:0] add_ln416_1_reg_259_pp0_iter3_reg;
...
reg   [15:0] p_accumulator_addr_2_reg_294;
reg   [15:0] p_accumulator_addr_2_reg_294_pp0_iter5_reg;
reg   [15:0] p_accumulator_addr_2_reg_294_pp0_iter6_reg;
reg   [15:0] p_accumulator_addr_2_reg_294_pp0_iter7_reg;
reg   [15:0] p_accumulator_addr_2_reg_294_pp0_iter8_reg;
wire   [31:0] select_ln403_1_fu_217_p3;
reg   [31:0] select_ln403_1_reg_299;
wire   [31:0] bitcast_ln101_9_fu_224_p1;
...
wire   [63:0] zext_ln416_2_fu_213_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln409_reg_245_pp0_iter3_reg == 1'd0))) begin
        p_accumulator_addr_2_reg_294 <= zext_ln416_2_fu_213_p1;
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((ap_start == 1'b0) | (p_initZero_empty_n == 1'b0) | (mul_ln481_loc_empty_n == 1'b0) | (p_weightGradientAvg_offset_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        trunc_ln_reg_240 <= {{mul_ln481_loc_dout[31:1]}};
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter8 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        p_accumulator_address0 = zext_ln416_2_fu_213_p1;
    end else begin
...
assign add_ln416_1_fu_183_p2 = (p_weightGradientAvg_offset_read_reg_228 + or_ln416_fu_177_p2);
...
assign bitcast_ln101_9_fu_224_p1 = p_Result_i_i_reg_269_pp0_iter4_reg;

assign bitcast_ln101_fu_202_p1 = trunc_ln674_reg_264;

assign empty_fu_155_p1 = ap_phi_mux_i_phi_fu_123_p4[14:0];

assign i_15_fu_149_p2 = (ap_phi_mux_i_phi_fu_123_p4 + 31'd1);
...
assign select_ln403_1_fu_217_p3 = ((p_initZero_read_reg_234[0:0] === 1'b1) ? 32'd0 : p_accumulator_q0);
...
assign zext_ln416_2_fu_213_p1 = add_ln416_1_reg_259_pp0_iter3_reg;

assign zext_ln416_fu_172_p1 = add_ln416_fu_167_p2;

endmodule //BGD_accumulate_float_2u_223
