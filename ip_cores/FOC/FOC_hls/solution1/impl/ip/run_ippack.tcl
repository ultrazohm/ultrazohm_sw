...
set Library     "hls"
set IPName      "uz_FOC_sample"
set Version     "1.0"
set DisplayName "uz_FOC"
set Revision    "2112512259"
...
set xo_kernel_name "uz_FOC_sample"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "C:/Users/ponpr/Documents/ultrazohm_sw/ip_cores/FOC/FOC_hls/solution1"
set debug_dir "C:/Users/ponpr/Documents/ultrazohm_sw/ip_cores/FOC/FOC_hls/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {uz_FOC_sample_mul_4ns_39ns_43_1_1
...
## Variables
set Top "uz_FOC_sample"
set TopNoPrefix "uz_FOC_sample"
...
set Interfaces {
    s_axi_Din {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_Din"
        param_prefix "C_S_AXI_DIN"
        addr_bits "8"
        port_width "AWADDR 8 WDATA 32 WSTRB 4 ARADDR 8 RDATA 32"
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 Controller_id_1 W 0x0 "Data signal of Controller_id" {{0 32 Controller_id W 0 "Bit 31 to 0 of Controller_id"}}} {0x14 Controller_id_2 W 0x0 "Data signal of Controller_id" {{0 32 Controller_id W 0 "Bit 63 to 32 of Controller_id"}}} {0x18 Controller_id_3 W 0x0 "Data signal of Controller_id" {{0 32 Controller_id W 0 "Bit 95 to 64 of Controller_id"}}} {0x1c Controller_id_4 W 0x0 "Data signal of Controller_id" {{0 32 Controller_id W 0 "Bit 127 to 96 of Controller_id"}}} {0x20 Controller_id_5 W 0x0 "Data signal of Controller_id" {{0 32 Controller_id W 0 "Bit 159 to 128 of Controller_id"}}} {0x28 Controller_iq_1 W 0x0 "Data signal of Controller_iq" {{0 32 Controller_iq W 0 "Bit 31 to 0 of Controller_iq"}}} {0x2c Controller_iq_2 W 0x0 "Data signal of Controller_iq" {{0 32 Controller_iq W 0 "Bit 63 to 32 of Controller_iq"}}} {0x30 Controller_iq_3 W 0x0 "Data signal of Controller_iq" {{0 32 Controller_iq W 0 "Bit 95 to 64 of Controller_iq"}}} {0x34 Controller_iq_4 W 0x0 "Data signal of Controller_iq" {{0 32 Controller_iq W 0 "Bit 127 to 96 of Controller_iq"}}} {0x38 Controller_iq_5 W 0x0 "Data signal of Controller_iq" {{0 32 Controller_iq W 0 "Bit 159 to 128 of Controller_iq"}}} {0x40 self_i_1 W 0x0 "Data signal of self_i" {{0 32 self_i W 0 "Bit 31 to 0 of self_i"}}} {0x44 self_i_2 W 0x0 "Data signal of self_i" {{0 32 self_i W 0 "Bit 63 to 32 of self_i"}}} {0x48 self_i_3 W 0x0 "Data signal of self_i" {{0 32 self_i W 0 "Bit 95 to 64 of self_i"}}} {0x4c self_i_4 W 0x0 "Data signal of self_i" {{0 32 self_i W 0 "Bit 127 to 96 of self_i"}}} {0x50 self_i_5 W 0x0 "Data signal of self_i" {{0 32 self_i W 0 "Bit 159 to 128 of self_i"}}} {0x54 self_i_6 W 0x0 "Data signal of self_i" {{0 32 self_i W 0 "Bit 191 to 160 of self_i"}}} {0x58 self_i_7 W 0x0 "Data signal of self_i" {{0 32 self_i W 0 "Bit 223 to 192 of self_i"}}} {0x5c self_i_8 W 0x0 "Data signal of self_i" {{0 32 self_i W 0 "Bit 255 to 224 of self_i"}}} {0x60 self_i_9 W 0x0 "Data signal of self_i" {{0 32 self_i W 0 "Bit 287 to 256 of self_i"}}} {0x68 self_o_1 R 0x0 "Data signal of self_o" {{0 32 self_o R 0 "Bit 31 to 0 of self_o"}}} {0x6c self_o_2 R 0x0 "Data signal of self_o" {{0 32 self_o R 0 "Bit 63 to 32 of self_o"}}} {0x70 self_o_3 R 0x0 "Data signal of self_o" {{0 32 self_o R 0 "Bit 95 to 64 of self_o"}}} {0x74 self_o_4 R 0x0 "Data signal of self_o" {{0 32 self_o R 0 "Bit 127 to 96 of self_o"}}} {0x78 self_o_5 R 0x0 "Data signal of self_o" {{0 32 self_o R 0 "Bit 159 to 128 of self_o"}}} {0x7c self_o_6 R 0x0 "Data signal of self_o" {{0 32 self_o R 0 "Bit 191 to 160 of self_o"}}} {0x80 self_o_7 R 0x0 "Data signal of self_o" {{0 32 self_o R 0 "Bit 223 to 192 of self_o"}}} {0x84 self_o_8 R 0x0 "Data signal of self_o" {{0 32 self_o R 0 "Bit 255 to 224 of self_o"}}} {0x88 self_o_9 R 0x0 "Data signal of self_o" {{0 32 self_o R 0 "Bit 287 to 256 of self_o"}}} {0x8c self_o_ctrl R 0x0 "Control signal of self_o" {{0 1 self_o_ap_vld R 0 "Control signal self_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x90 i_actual_Ampere_1 W 0x0 "Data signal of i_actual_Ampere" {{0 32 i_actual_Ampere W 0 "Bit 31 to 0 of i_actual_Ampere"}}} {0x94 i_actual_Ampere_2 W 0x0 "Data signal of i_actual_Ampere" {{0 32 i_actual_Ampere W 0 "Bit 63 to 32 of i_actual_Ampere"}}} {0x98 i_actual_Ampere_3 W 0x0 "Data signal of i_actual_Ampere" {{0 32 i_actual_Ampere W 0 "Bit 95 to 64 of i_actual_Ampere"}}} {0xa0 V_dc_volts W 0x0 "Data signal of V_dc_volts" {{0 32 V_dc_volts W 0 "Bit 31 to 0 of V_dc_volts"}}} {0xa8 omega_el_rad_per_sec W 0x0 "Data signal of omega_el_rad_per_sec" {{0 32 omega_el_rad_per_sec W 0 "Bit 31 to 0 of omega_el_rad_per_sec"}}} {0xb0 i_reference_Ampere_1 W 0x0 "Data signal of i_reference_Ampere" {{0 32 i_reference_Ampere W 0 "Bit 31 to 0 of i_reference_Ampere"}}} {0xb4 i_reference_Ampere_2 W 0x0 "Data signal of i_reference_Ampere" {{0 32 i_reference_Ampere W 0 "Bit 63 to 32 of i_reference_Ampere"}}} {0xb8 i_reference_Ampere_3 W 0x0 "Data signal of i_reference_Ampere" {{0 32 i_reference_Ampere W 0 "Bit 95 to 64 of i_reference_Ampere"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    s_axi_control {
        ...
        registers {{0x10 output_volts_d_1 W 0x0 "Data signal of output_volts_d" {{0 32 output_volts_d W 0 "Bit 31 to 0 of output_volts_d"}}} {0x14 output_volts_d_2 W 0x0 "Data signal of output_volts_d" {{0 32 output_volts_d W 0 "Bit 63 to 32 of output_volts_d"}}} {0x1c output_volts_q_1 W 0x0 "Data signal of output_volts_q" {{0 32 output_volts_q W 0 "Bit 31 to 0 of output_volts_q"}}} {0x20 output_volts_q_2 W 0x0 "Data signal of output_volts_q" {{0 32 output_volts_q W 0 "Bit 63 to 32 of output_volts_q"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_Din s_axi_control m_axi_Dout"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_Dout {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_Dout"
        data_width "32"
        param_prefix "C_M_AXI_DOUT"
