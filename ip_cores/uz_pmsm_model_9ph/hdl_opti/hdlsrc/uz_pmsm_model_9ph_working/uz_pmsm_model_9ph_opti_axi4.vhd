-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\valen\Documents\repos\UZ\ultrazohm_sw\ip_cores\new_ninephase\hdl_opti\hdlsrc\uz_pmsm_model_9ph_working\uz_pmsm_model_9ph_opti_axi4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_9ph_opti_axi4
-- Source Path: uz_pmsm_model_9ph_opti/uz_pmsm_model_9ph_opti_axi4
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_pmsm_model_9ph_opti_axi4 IS
...
END uz_pmsm_model_9ph_opti_axi4;


ARCHITECTURE rtl OF uz_pmsm_model_9ph_opti_axi4 IS

  -- Component Declarations
  COMPONENT uz_pmsm_model_9ph_opti_addr_decoder
  ...
  COMPONENT uz_pmsm_model_9ph_opti_axi4_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_ARESETN                    :   IN    std_logic;  -- ufix1
          AXI4_AWID                       :   IN    std_logic_vector(11 DOWNTO 0);  -- ufix12
          AXI4_AWADDR                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  FOR ALL : uz_pmsm_model_9ph_opti_addr_decoder
    USE ENTITY work.uz_pmsm_model_9ph_opti_addr_decoder(rtl);

  FOR ALL : uz_pmsm_model_9ph_opti_axi4_module
    USE ENTITY work.uz_pmsm_model_9ph_opti_axi4_module(rtl);
...
BEGIN
  u_uz_pmsm_model_9ph_opti_addr_decoder_inst : uz_pmsm_model_9ph_opti_addr_decoder
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
              ...
              read_i_dq_ps => read_i_dq_ps,  -- ufix32 [9]
  ...
  u_uz_pmsm_model_9ph_opti_axi4_module_inst : uz_pmsm_model_9ph_opti_axi4_module
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
