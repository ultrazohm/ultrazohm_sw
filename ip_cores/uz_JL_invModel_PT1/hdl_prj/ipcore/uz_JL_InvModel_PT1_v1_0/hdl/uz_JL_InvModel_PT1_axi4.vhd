-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\jonat\Documents\MA_JL_CIL\ip_cores\uz_JL_invModel_PT1\hdl_prj\hdlsrc\uz_JL_invModel_PT1\uz_JL_InvModel_PT1_axi4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_JL_InvModel_PT1_axi4
-- Source Path: uz_JL_InvModel_PT1/uz_JL_InvModel_PT1_axi4
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_JL_InvModel_PT1_axi4 IS
...
END uz_JL_InvModel_PT1_axi4;


ARCHITECTURE rtl OF uz_JL_InvModel_PT1_axi4 IS

  -- Component Declarations
  COMPONENT uz_JL_InvModel_PT1_addr_decoder
  ...
  COMPONENT uz_JL_InvModel_PT1_axi4_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_ARESETN                    :   IN    std_logic;  -- ufix1
          AXI4_AWID                       :   IN    std_logic_vector(12 DOWNTO 0);  -- ufix13
          AXI4_AWADDR                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  FOR ALL : uz_JL_InvModel_PT1_addr_decoder
    USE ENTITY work.uz_JL_InvModel_PT1_addr_decoder(rtl);

  FOR ALL : uz_JL_InvModel_PT1_axi4_module
    USE ENTITY work.uz_JL_InvModel_PT1_axi4_module(rtl);
  ...
  SIGNAL write_Ualpha_tmp                 : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_Ubeta_tmp                  : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_PT1_Gain_tmp               : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_PT1_Ts_tmp                 : std_logic_vector(31 DOWNTO 0);  -- ufix32
...
BEGIN
  u_uz_JL_InvModel_PT1_addr_decoder_inst : uz_JL_InvModel_PT1_addr_decoder
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
              ...
              write_Ualpha => write_Ualpha_tmp,  -- ufix32
              write_Ubeta => write_Ubeta_tmp,  -- ufix32
              write_PT1_Gain => write_PT1_Gain_tmp,  -- ufix32
              write_PT1_Ts => write_PT1_Ts_tmp,  -- ufix32
              write_PT1_reset => write_PT1_reset  -- ufix1
              );

  u_uz_JL_InvModel_PT1_axi4_module_inst : uz_JL_InvModel_PT1_axi4_module
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
  ...
  write_Ualpha <= write_Ualpha_tmp;

  write_Ubeta <= write_Ubeta_tmp;

  write_PT1_Gain <= write_PT1_Gain_tmp;

  write_PT1_Ts <= write_PT1_Ts_tmp;
