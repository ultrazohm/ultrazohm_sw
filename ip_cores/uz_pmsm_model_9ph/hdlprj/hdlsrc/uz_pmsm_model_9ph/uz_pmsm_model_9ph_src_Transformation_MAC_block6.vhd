-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\valen\Documents\repos\UZ\ultrazohm_sw\ip_cores\uz_pmsm_model_9ph\hdlprj\hdlsrc\uz_pmsm_model_9ph\uz_pmsm_model_9ph_src_Transformation_MAC_block6.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_9ph_src_Transformation_MAC_block6
-- Source Path: 
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
...
ENTITY uz_pmsm_model_9ph_src_Transformation_MAC_block6 IS
...
END uz_pmsm_model_9ph_src_Transformation_MAC_block6;


ARCHITECTURE rtl OF uz_pmsm_model_9ph_src_Transformation_MAC_block6 IS

  -- Signals
  SIGNAL enb_gated                        : std_logic;
  SIGNAL t_counterSig                     : unsigned(3 DOWNTO 0);  -- ufix4
  SIGNAL t_reset_sig                      : std_logic;
  SIGNAL t_initial_value                  : signed(42 DOWNTO 0);  -- sfix43_En31
  SIGNAL in0_signed                       : vector_of_signed18(0 TO 8);  -- sfix18_En19 [9]
  SIGNAL t_multiportswitch_out            : signed(17 DOWNTO 0);  -- sfix18_En19
  SIGNAL in1_signed                       : vector_of_signed25(0 TO 8);  -- sfix25_En12 [9]
  SIGNAL t_multiportswitch_out_1          : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL t_multiply_out                   : signed(42 DOWNTO 0);  -- sfix43_En31
  SIGNAL t_multiplyadd_out                : signed(42 DOWNTO 0);  -- sfix43_En31
  SIGNAL t_delay_loop                     : signed(42 DOWNTO 0);  -- sfix43_En31
  SIGNAL t_switch_out                     : signed(42 DOWNTO 0);  -- sfix43_En31
  SIGNAL t_multiplyadd_out_bypass         : signed(42 DOWNTO 0);  -- sfix43_En31
  SIGNAL t_multiplyadd_out_last_value     : signed(42 DOWNTO 0);  -- sfix43_En31
