-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_d_inverter_adapter\uz_d_inverter_adapter_src_Reciprocal.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_d_inverter_adapter_src_Reciprocal
-- Source Path: uz_d_inverter_adapter/uz_d_inverter_adapter/PWMdutyFreqDetection/Reciprocal
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_d_inverter_adapter_src_Reciprocal IS
...
END uz_d_inverter_adapter_src_Reciprocal;


ARCHITECTURE rtl OF uz_d_inverter_adapter_src_Reciprocal IS

  -- Component Declarations
  COMPONENT uz_d_inverter_adapter_src_Reciprocal_iv
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT uz_d_inverter_adapter_src_Reciprocal_core
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : uz_d_inverter_adapter_src_Reciprocal_iv
    USE ENTITY work.uz_d_inverter_adapter_src_Reciprocal_iv(rtl);

  FOR ALL : uz_d_inverter_adapter_src_Reciprocal_core
    USE ENTITY work.uz_d_inverter_adapter_src_Reciprocal_core(rtl);
...
BEGIN
  ...
  u_iv_stage_inst : uz_d_inverter_adapter_src_Reciprocal_iv
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_core_stage1_inst : uz_d_inverter_adapter_src_Reciprocal_core
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_core_stage2_inst : uz_d_inverter_adapter_src_Reciprocal_core
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_core_stage3_inst : uz_d_inverter_adapter_src_Reciprocal_core
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
