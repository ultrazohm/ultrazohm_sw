...
ARCHITECTURE rtl OF PWM_and_SS_control_V4_ip_addr_decoder IS
  ...
  SIGNAL decode_sel_triangle_shift_HB1_1_1 : std_logic;  -- ufix1
  SIGNAL reg_enb_triangle_shift_HB1_1_1   : std_logic;  -- ufix1
  SIGNAL data_in_triangle_shift_HB1       : unsigned(17 DOWNTO 0);  -- ufix18_En17
  SIGNAL data_reg_triangle_shift_HB1_1_1  : unsigned(17 DOWNTO 0);  -- ufix18_En17
  ...
  SIGNAL decode_sel_triangle_shift_HB2_1_1 : std_logic;  -- ufix1
  SIGNAL reg_enb_triangle_shift_HB2_1_1   : std_logic;  -- ufix1
  SIGNAL data_in_triangle_shift_HB2       : unsigned(17 DOWNTO 0);  -- ufix18_En17
  SIGNAL data_reg_triangle_shift_HB2_1_1  : unsigned(17 DOWNTO 0);  -- ufix18_En17
  SIGNAL decode_sel_triangle_shift_HB3_1_1 : std_logic;  -- ufix1
  SIGNAL reg_enb_triangle_shift_HB3_1_1   : std_logic;  -- ufix1
  SIGNAL data_in_triangle_shift_HB3       : unsigned(17 DOWNTO 0);  -- ufix18_En17
  SIGNAL data_reg_triangle_shift_HB3_1_1  : unsigned(17 DOWNTO 0);  -- ufix18_En17
...
BEGIN
  ...
  decode_sel_triangle_shift_HB1_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#004B#, 14) ELSE
      '0';

  reg_enb_triangle_shift_HB1_1_1 <= decode_sel_triangle_shift_HB1_1_1 AND wr_enb;

  data_in_triangle_shift_HB1 <= data_write_unsigned(17 DOWNTO 0);

  reg_triangle_shift_HB1_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_triangle_shift_HB1_1_1 <= to_unsigned(16#00000#, 18);
      ELSIF enb = '1' AND reg_enb_triangle_shift_HB1_1_1 = '1' THEN
        data_reg_triangle_shift_HB1_1_1 <= data_in_triangle_shift_HB1;
      END IF;
    END IF;
  END PROCESS reg_triangle_shift_HB1_1_1_process;


  write_triangle_shift_HB1 <= std_logic_vector(data_reg_triangle_shift_HB1_1_1);
  ...
  decode_sel_triangle_shift_HB2_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#004D#, 14) ELSE
      '0';

  reg_enb_triangle_shift_HB2_1_1 <= decode_sel_triangle_shift_HB2_1_1 AND wr_enb;

  data_in_triangle_shift_HB2 <= data_write_unsigned(17 DOWNTO 0);

  reg_triangle_shift_HB2_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_triangle_shift_HB2_1_1 <= to_unsigned(16#00000#, 18);
      ELSIF enb = '1' AND reg_enb_triangle_shift_HB2_1_1 = '1' THEN
        data_reg_triangle_shift_HB2_1_1 <= data_in_triangle_shift_HB2;
      END IF;
    END IF;
  END PROCESS reg_triangle_shift_HB2_1_1_process;


  write_triangle_shift_HB2 <= std_logic_vector(data_reg_triangle_shift_HB2_1_1);

  
  decode_sel_triangle_shift_HB3_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#004E#, 14) ELSE
      '0';

  reg_enb_triangle_shift_HB3_1_1 <= decode_sel_triangle_shift_HB3_1_1 AND wr_enb;

  data_in_triangle_shift_HB3 <= data_write_unsigned(17 DOWNTO 0);

  reg_triangle_shift_HB3_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_triangle_shift_HB3_1_1 <= to_unsigned(16#00000#, 18);
      ELSIF enb = '1' AND reg_enb_triangle_shift_HB3_1_1 = '1' THEN
        data_reg_triangle_shift_HB3_1_1 <= data_in_triangle_shift_HB3;
      END IF;
    END IF;
  END PROCESS reg_triangle_shift_HB3_1_1_process;


  write_triangle_shift_HB3 <= std_logic_vector(data_reg_triangle_shift_HB3_1_1);
