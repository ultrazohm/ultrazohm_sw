-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_resolver_mech_revolution_float\resolver_mech_rev_calc_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: resolver_mech_rev_calc_dut
-- Source Path: resolver_mech_rev_calc/resolver_mech_rev_calc_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY resolver_mech_rev_calc_dut IS
...
END resolver_mech_rev_calc_dut;


ARCHITECTURE rtl OF resolver_mech_rev_calc_dut IS

  -- Component Declarations
  COMPONENT resolver_mech_rev_calc_src_uz_resolver_mech_rev_calc
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : resolver_mech_rev_calc_src_uz_resolver_mech_rev_calc
    USE ENTITY work.resolver_mech_rev_calc_src_uz_resolver_mech_rev_calc(rtl);
...
BEGIN
  u_resolver_mech_rev_calc_src_uz_resolver_mech_rev_calc : resolver_mech_rev_calc_src_uz_resolver_mech_rev_calc
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
