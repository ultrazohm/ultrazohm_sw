-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\ThreeL_PWM_direct\PWM_SS_3L_ip_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: PWM_SS_3L_ip_axi_lite
-- Source Path: PWM_SS_3L_ip/PWM_SS_3L_ip_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY PWM_SS_3L_ip_axi_lite IS
...
END PWM_SS_3L_ip_axi_lite;


ARCHITECTURE rtl OF PWM_SS_3L_ip_axi_lite IS

  -- Component Declarations
  COMPONENT PWM_SS_3L_ip_addr_decoder
  ...
  COMPONENT PWM_SS_3L_ip_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : PWM_SS_3L_ip_addr_decoder
    USE ENTITY work.PWM_SS_3L_ip_addr_decoder(rtl);

  FOR ALL : PWM_SS_3L_ip_axi_lite_module
    USE ENTITY work.PWM_SS_3L_ip_axi_lite_module(rtl);
  ...
  SIGNAL write_PWM_counter_max_value_int_AXI_tmp : std_logic_vector(19 DOWNTO 0);  -- ufix20
  SIGNAL write_PWM_min_pulse_width_0to1_AXI_tmp : std_logic_vector(13 DOWNTO 0);  -- ufix14
...
BEGIN
  u_PWM_SS_3L_ip_addr_decoder_inst : PWM_SS_3L_ip_addr_decoder
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
              ...
              write_PWM_counter_max_value_int_AXI => write_PWM_counter_max_value_int_AXI_tmp,  -- ufix20
              write_PWM_min_pulse_width_0to1_AXI => write_PWM_min_pulse_width_0to1_AXI_tmp,  -- sfix14_En12
  ...
  u_PWM_SS_3L_ip_axi_lite_module_inst : PWM_SS_3L_ip_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
  ...
  write_PWM_counter_max_value_int_AXI <= write_PWM_counter_max_value_int_AXI_tmp;

  write_PWM_min_pulse_width_0to1_AXI <= write_PWM_min_pulse_width_0to1_AXI_tmp;
