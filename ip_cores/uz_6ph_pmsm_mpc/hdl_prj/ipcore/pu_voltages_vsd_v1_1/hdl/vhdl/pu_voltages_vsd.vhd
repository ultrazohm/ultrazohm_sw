-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\external_state_machine\pu_voltages_vsd.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: pu_voltages_vsd
-- Source Path: pu_voltages_vsd
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF pu_voltages_vsd IS

  -- Component Declarations
  COMPONENT pu_voltages_vsd_reset_sync
  ...
  COMPONENT pu_voltages_vsd_axi_lite
  ...
  FOR ALL : pu_voltages_vsd_reset_sync
    USE ENTITY work.pu_voltages_vsd_reset_sync(rtl);

  FOR ALL : pu_voltages_vsd_axi_lite
    USE ENTITY work.pu_voltages_vsd_axi_lite(rtl);

  FOR ALL : pu_voltages_vsd_dut
    USE ENTITY work.pu_voltages_vsd_dut(rtl);
...
BEGIN
  u_pu_voltages_vsd_reset_sync_inst : pu_voltages_vsd_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_pu_voltages_vsd_axi_lite_inst : pu_voltages_vsd_axi_lite
  ...
  u_pu_voltages_vsd_dut_inst : pu_voltages_vsd_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  ip_timestamp <= unsigned'(X"8986527C");
