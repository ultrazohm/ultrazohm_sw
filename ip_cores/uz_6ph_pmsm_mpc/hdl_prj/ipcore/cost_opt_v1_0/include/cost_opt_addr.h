/*
 * File Name:         hdl_prj\ipcore\cost_opt_v1_0\include\cost_opt_addr.h
...
#define  IPCore_Timestamp_cost_opt          0x8  //contains unique IP timestamp (yymmddHHMM): 2306151008
...
#define  ix_ref_pu_AXI_Data_cost_opt        0x108  //data register for Inport ix_ref_pu_AXI
#define  iy_ref_pu_AXI_Data_cost_opt        0x10C  //data register for Inport iy_ref_pu_AXI
...
#define  lambda_x_AXI_Data_cost_opt         0x11C  //data register for Inport lambda_x_AXI
#define  lambda_y_AXI_Data_cost_opt         0x120  //data register for Inport lambda_y_AXI
