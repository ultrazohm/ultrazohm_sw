-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\test_parallel_phase_voltages\hdlsrc\parallel_phase_voltages_per_switching_state_6\tets_parallel_phase_voltages_src_Subsystem.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: tets_parallel_phase_voltages_src_Subsystem
...
ENTITY tets_parallel_phase_voltages_src_Subsystem IS
...
END tets_parallel_phase_voltages_src_Subsystem;


ARCHITECTURE rtl OF tets_parallel_phase_voltages_src_Subsystem IS

  -- Component Declarations
  COMPONENT tets_parallel_phase_voltages_src_nfp_sincos_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT tets_parallel_phase_voltages_src_MATLAB_Function15
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT tets_parallel_phase_voltages_src_MATLAB_Function14
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          sin_theta_el                    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT tets_parallel_phase_voltages_src_MATLAB_Function13
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          sin_theta_el                    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT tets_parallel_phase_voltages_src_MATLAB_Function12
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          sin_theta_el                    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT tets_parallel_phase_voltages_src_MATLAB_Function11
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          sin_theta_el                    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT tets_parallel_phase_voltages_src_MATLAB_Function10
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          sin_theta_el                    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT tets_parallel_phase_voltages_src_MATLAB_Function9
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          sin_theta_el                    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT tets_parallel_phase_voltages_src_MATLAB_Function8
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          sin_theta_el                    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT tets_parallel_phase_voltages_src_MATLAB_Function7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          sin_theta_el                    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT tets_parallel_phase_voltages_src_MATLAB_Function6
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          sin_theta_el                    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT tets_parallel_phase_voltages_src_MATLAB_Function5
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          sin_theta_el                    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT tets_parallel_phase_voltages_src_MATLAB_Function4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          sin_theta_el                    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT tets_parallel_phase_voltages_src_MATLAB_Function3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          sin_theta_el                    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT tets_parallel_phase_voltages_src_MATLAB_Function2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          sin_theta_el                    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT tets_parallel_phase_voltages_src_MATLAB_Function1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          sin_theta_el                    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT tets_parallel_phase_voltages_src_MATLAB_Function
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          sin_theta_el                    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  FOR ALL : tets_parallel_phase_voltages_src_nfp_sincos_single
    USE ENTITY work.tets_parallel_phase_voltages_src_nfp_sincos_single(rtl);

  FOR ALL : tets_parallel_phase_voltages_src_MATLAB_Function15
    USE ENTITY work.tets_parallel_phase_voltages_src_MATLAB_Function15(rtl);

  FOR ALL : tets_parallel_phase_voltages_src_MATLAB_Function14
    USE ENTITY work.tets_parallel_phase_voltages_src_MATLAB_Function14(rtl);

  FOR ALL : tets_parallel_phase_voltages_src_MATLAB_Function13
    USE ENTITY work.tets_parallel_phase_voltages_src_MATLAB_Function13(rtl);

  FOR ALL : tets_parallel_phase_voltages_src_MATLAB_Function12
    USE ENTITY work.tets_parallel_phase_voltages_src_MATLAB_Function12(rtl);

  FOR ALL : tets_parallel_phase_voltages_src_MATLAB_Function11
    USE ENTITY work.tets_parallel_phase_voltages_src_MATLAB_Function11(rtl);

  FOR ALL : tets_parallel_phase_voltages_src_MATLAB_Function10
    USE ENTITY work.tets_parallel_phase_voltages_src_MATLAB_Function10(rtl);

  FOR ALL : tets_parallel_phase_voltages_src_MATLAB_Function9
    USE ENTITY work.tets_parallel_phase_voltages_src_MATLAB_Function9(rtl);

  FOR ALL : tets_parallel_phase_voltages_src_MATLAB_Function8
    USE ENTITY work.tets_parallel_phase_voltages_src_MATLAB_Function8(rtl);

  FOR ALL : tets_parallel_phase_voltages_src_MATLAB_Function7
    USE ENTITY work.tets_parallel_phase_voltages_src_MATLAB_Function7(rtl);

  FOR ALL : tets_parallel_phase_voltages_src_MATLAB_Function6
    USE ENTITY work.tets_parallel_phase_voltages_src_MATLAB_Function6(rtl);

  FOR ALL : tets_parallel_phase_voltages_src_MATLAB_Function5
    USE ENTITY work.tets_parallel_phase_voltages_src_MATLAB_Function5(rtl);

  FOR ALL : tets_parallel_phase_voltages_src_MATLAB_Function4
    USE ENTITY work.tets_parallel_phase_voltages_src_MATLAB_Function4(rtl);

  FOR ALL : tets_parallel_phase_voltages_src_MATLAB_Function3
    USE ENTITY work.tets_parallel_phase_voltages_src_MATLAB_Function3(rtl);

  FOR ALL : tets_parallel_phase_voltages_src_MATLAB_Function2
    USE ENTITY work.tets_parallel_phase_voltages_src_MATLAB_Function2(rtl);

  FOR ALL : tets_parallel_phase_voltages_src_MATLAB_Function1
    USE ENTITY work.tets_parallel_phase_voltages_src_MATLAB_Function1(rtl);

  FOR ALL : tets_parallel_phase_voltages_src_MATLAB_Function
    USE ENTITY work.tets_parallel_phase_voltages_src_MATLAB_Function(rtl);
...
BEGIN
  u_nfp_sincos_comp : tets_parallel_phase_voltages_src_nfp_sincos_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_MATLAB_Function15 : tets_parallel_phase_voltages_src_MATLAB_Function15
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_MATLAB_Function14 : tets_parallel_phase_voltages_src_MATLAB_Function14
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              sin_theta_el => Sincos_out1,  -- single
  ...
  u_MATLAB_Function13 : tets_parallel_phase_voltages_src_MATLAB_Function13
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              sin_theta_el => Sincos_out1,  -- single
  ...
  u_MATLAB_Function12 : tets_parallel_phase_voltages_src_MATLAB_Function12
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              sin_theta_el => Sincos_out1,  -- single
  ...
  u_MATLAB_Function11 : tets_parallel_phase_voltages_src_MATLAB_Function11
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              sin_theta_el => Sincos_out1,  -- single
  ...
  u_MATLAB_Function10 : tets_parallel_phase_voltages_src_MATLAB_Function10
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              sin_theta_el => Sincos_out1,  -- single
  ...
  u_MATLAB_Function9 : tets_parallel_phase_voltages_src_MATLAB_Function9
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              sin_theta_el => Sincos_out1,  -- single
  ...
  u_MATLAB_Function8 : tets_parallel_phase_voltages_src_MATLAB_Function8
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              sin_theta_el => Sincos_out1,  -- single
  ...
  u_MATLAB_Function7 : tets_parallel_phase_voltages_src_MATLAB_Function7
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              sin_theta_el => Sincos_out1,  -- single
  ...
  u_MATLAB_Function6 : tets_parallel_phase_voltages_src_MATLAB_Function6
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              sin_theta_el => Sincos_out1,  -- single
  ...
  u_MATLAB_Function5 : tets_parallel_phase_voltages_src_MATLAB_Function5
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              sin_theta_el => Sincos_out1,  -- single
  ...
  u_MATLAB_Function4 : tets_parallel_phase_voltages_src_MATLAB_Function4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              sin_theta_el => Sincos_out1,  -- single
  ...
  u_MATLAB_Function3 : tets_parallel_phase_voltages_src_MATLAB_Function3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              sin_theta_el => Sincos_out1,  -- single
  ...
  u_MATLAB_Function2 : tets_parallel_phase_voltages_src_MATLAB_Function2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              sin_theta_el => Sincos_out1,  -- single
  ...
  u_MATLAB_Function1 : tets_parallel_phase_voltages_src_MATLAB_Function1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              sin_theta_el => Sincos_out1,  -- single
  ...
  u_MATLAB_Function : tets_parallel_phase_voltages_src_MATLAB_Function
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              sin_theta_el => Sincos_out1,  -- single
