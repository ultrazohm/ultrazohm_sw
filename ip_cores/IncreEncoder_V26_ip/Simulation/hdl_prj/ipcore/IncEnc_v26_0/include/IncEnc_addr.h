...
#define  IPCore_Timestamp_IncEnc              0x8  //contains unique IP timestamp (yymmddHHMM): 2302221415
...
#define  omega_MA_N4_AXI_Data_IncEnc          0x134  //data register for Outport omega_MA_N4_AXI
#define  position_AXI_wOffset_Data_IncEnc     0x138  //data register for Outport position_AXI_wOffset
