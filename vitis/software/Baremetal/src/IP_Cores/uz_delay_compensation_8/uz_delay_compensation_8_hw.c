...
void uz_delay_compensation_8_set_psiPM(uint32_t base_address, float psiPM)
{
    ...
    //single
    uz_axi_write_float(base_address + psiPM_AXI_Data_parallel_8_sim_delay_compensation, psiPM);
}
...
void uz_delay_compensation_8_set_Lq(uint32_t base_address, float Lq)
{
    uz_assert_not_zero_uint32(base_address);
    //single
    uz_axi_write_float(base_address + Lq_AXI_Data_parallel_8_sim_delay_compensation, Lq);
}
...
void uz_delay_compensation_8_set_Ld(uint32_t base_address, float Ld)
{
    uz_assert_not_zero_uint32(base_address);
    //single
    uz_axi_write_float(base_address + Ld_AXI_Data_parallel_8_sim_delay_compensation, Ld);
}
...
void uz_delay_compensation_8_set_Rs(uint32_t base_address, float Rs)
{
    uz_assert_not_zero_uint32(base_address);
    //single
    uz_axi_write_float(base_address + Rs_AXI_Data_parallel_8_sim_delay_compensation, Rs);
}
...
void uz_delay_compensation_8_set_SampleTime_div_Ld(uint32_t base_address, float SampleTime, float Ld)
{
    ...
    uz_axi_write_float(base_address + SampleTime_div_Ld_AXI_Data_parallel_8_sim_delay_compensation, SampleTime_div_Ld);
}
...
void uz_delay_compensation_8_set_pole_pairs(uint32_t base_address, float pole_pairs)
{
    uz_assert_not_zero_uint32(base_address);
    //single
    uz_axi_write_float(base_address + pole_pairs_AXI_Data_parallel_8_sim_delay_compensation, pole_pairs);
}
...
void uz_delay_compensation_8_set_SampleTime_div_Lq(uint32_t base_address, float SampleTime, float Lq)
{
    ...
    uz_axi_write_float(base_address + SampleTime_div_Lq_AXI_Data_parallel_8_sim_delay_compensation, SampleTime_div_Lq);
}
...
void uz_delay_compensation_8_set_SampleTime_div_Lx(uint32_t base_address, float SampleTime, float Lx)
{
    ...
    uz_axi_write_float(base_address + SampleTime_div_Lx_AXI_Data_parallel_8_sim_delay_compensation, SampleTime_div_Lx);
}
