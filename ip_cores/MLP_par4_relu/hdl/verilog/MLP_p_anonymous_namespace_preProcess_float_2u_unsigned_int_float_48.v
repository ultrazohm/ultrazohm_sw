...
module MLP_p_anonymous_namespace_preProcess_float_2u_unsigned_int_float_48 (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
reg   [31:0] p_Result_4_i_i_reg_239;
reg   [31:0] p_Result_5_i_i_reg_244;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln50_reg_220 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        p_Result_4_i_i_reg_239 <= {{p_x_dout[95:64]}};
        p_Result_5_i_i_reg_244 <= {{p_x_dout[127:96]}};
...
assign grp_fu_128_p0 = p_Result_4_i_i_reg_239;

assign grp_fu_128_p1 = p_Result_5_i_i_reg_244;
...
assign mul_ln43_fu_144_p10 = p_n_dout;
...
endmodule //MLP_p_anonymous_namespace_preProcess_float_2u_unsigned_int_float_48
