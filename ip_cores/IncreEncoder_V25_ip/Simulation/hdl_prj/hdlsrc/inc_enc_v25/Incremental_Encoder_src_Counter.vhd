-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\inc_enc_v25\Incremental_Encoder_src_Counter.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Incremental_Encoder_src_Counter
-- Source Path: inc_enc_v25/IncEnc_V25/Counter
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Incremental_Encoder_src_Counter IS
...
END Incremental_Encoder_src_Counter;


ARCHITECTURE rtl OF Incremental_Encoder_src_Counter IS
