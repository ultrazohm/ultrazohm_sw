-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\jonat\Documents\MA_JL_CIL\ip_cores\uz_JL_invModel_ideal\hdl_prj\hdlsrc\uz_JL_invModel_ideal\uz_JL_invModel_ideal_src_nfp_div_single.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_JL_invModel_ideal_src_nfp_div_single
-- Source Path: uz_JL_invModel_ideal/uz_JL_invModel_ideal/MATLAB Function/nfp_div_single
-- Hierarchy Level: 2
-- Model version: 1.57
-- 
...
ENTITY uz_JL_invModel_ideal_src_nfp_div_single IS
...
END uz_JL_invModel_ideal_src_nfp_div_single;


ARCHITECTURE rtl OF uz_JL_invModel_ideal_src_nfp_div_single IS
  ...
  SIGNAL Delay54_reg                      : std_logic_vector(29 DOWNTO 0);  -- ufix1 [30]
  ...
  SIGNAL Delay51_reg                      : std_logic_vector(29 DOWNTO 0);  -- ufix1 [30]
  ...
  SIGNAL Delay53_reg                      : std_logic_vector(29 DOWNTO 0);  -- ufix1 [30]
  ...
  SIGNAL alpha_bExponent_0_bMantissa_out1 : std_logic;  -- ufix1
  SIGNAL Delay52_reg                      : std_logic_vector(29 DOWNTO 0);  -- ufix1 [30]
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        Delay54_reg(29 DOWNTO 1) <= Delay54_reg(28 DOWNTO 0);
      END IF;
    END IF;
  ...
  alpha_aExponent_cfType_Exponent_out1 <= aExponent_cfType_Exponent_I_out1 OR bExponent_cfType_Exponent_I_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        Delay51_reg(29 DOWNTO 1) <= Delay51_reg(28 DOWNTO 0);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        Delay53_reg(29 DOWNTO 1) <= Delay53_reg(28 DOWNTO 0);
      END IF;
    END IF;
  ...
  alpha_bExponent_0_bMantissa_out1 <= bExponent_0_out1 AND bMantissa_0_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        Delay52_reg(29 DOWNTO 1) <= Delay52_reg(28 DOWNTO 0);
      END IF;
    END IF;
  ...
  alpha_Exponent_0_cfType_Exp_out1_1 <= bExponent_0_out1 OR bExponent_cfType_Exponent_I_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay1_reg <= (OTHERS => to_unsigned(16#000000#, 24));
      ELSIF enb = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        Delay11_reg(1 TO 23) <= Delay11_reg(0 TO 22);
      END IF;
    END IF;
  ...
  alpha_bitget_Mant_tmp_2_0_out1 <= BitSlice1_out1 OR Delay10_out1;
  ...
  if_bitget_Mant_tmp_1_0_out1 <= Bit_Concat_out1_26 WHEN alpha_bitget_Mant_tmp_1_0_out1 = '0' ELSE
      Mant_tmp_2_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        Delay8_reg(1 TO 24) <= Delay8_reg(0 TO 23);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        Delay55_reg(1 TO 28) <= Delay55_reg(0 TO 27);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay56_reg <= (OTHERS => to_unsigned(16#000000#, 23));
      ELSIF enb = '1' THEN
        Delay56_reg(0) <= if_exp_a_cfType_Exponent_Inf_1_out1;
        Delay56_reg(1 TO 28) <= Delay56_reg(0 TO 27);
      END IF;
    END IF;
