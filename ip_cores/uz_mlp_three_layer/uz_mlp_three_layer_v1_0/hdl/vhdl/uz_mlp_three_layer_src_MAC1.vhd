-- -------------------------------------------------------------
-- 
-- File Name: /home/ts/Documents/integrate_nn_to_uz/ultrazohm_sw/ip_cores/nnAXI_v1_0/hdl_prj/hdlsrc/uz_mlp_three_layer/uz_mlp_three_layer_src_MAC1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_mlp_three_layer_src_MAC1
-- Source Path: uz_mlp_three_layer/uz_mlp_three_layer/reluLayer_4Parallel/MAC1
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_mlp_three_layer_src_MAC1 IS
...
END uz_mlp_three_layer_src_MAC1;


ARCHITECTURE rtl OF uz_mlp_three_layer_src_MAC1 IS

  -- Component Declarations
  COMPONENT uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block6
  ...
  COMPONENT uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block8
    GENERIC( AddrWidth                    : integer;
             DataWidth                    : integer
             );
    PORT( clk                             :   IN    std_logic;
  ...
  COMPONENT uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block7
    GENERIC( AddrWidth                    : integer;
             DataWidth                    : integer
             );
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block6
    USE ENTITY work.uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block6(rtl);

  FOR ALL : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block8
    USE ENTITY work.uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block8(rtl);

  FOR ALL : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block7
    USE ENTITY work.uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block7(rtl);
...
BEGIN
  u_Dual_Port_RAM_System1 : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block6
  ...
  u_Dual_Port_RAM_System3 : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block8
    GENERIC MAP( AddrWidth => 10,
                 DataWidth => 32
                 )
    PORT MAP( clk => clk,
  ...
  u_Dual_Port_RAM_System2 : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block7
    GENERIC MAP( AddrWidth => 10,
                 DataWidth => 32
                 )
    PORT MAP( clk => clk,
  ...
  Constant_out1 <= to_unsigned(16#021#, 10);
