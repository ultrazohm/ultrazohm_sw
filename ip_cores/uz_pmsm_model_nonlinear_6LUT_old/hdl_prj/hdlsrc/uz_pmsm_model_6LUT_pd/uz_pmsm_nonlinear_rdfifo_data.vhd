-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\Philipp\ultrazohm\ultrazohm_sw\ip_cores\uz_pmsm_model_nonlinear_6LUT\hdl_prj\hdlsrc\uz_pmsm_model_6LUT_pd\uz_pmsm_nonlinear_rdfifo_data.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_nonlinear_rdfifo_data
-- Source Path: uz_pmsm_nonlinear/uz_pmsm_nonlinear_axi4/uz_pmsm_nonlinear_axi4_module/uz_pmsm_nonlinear_rdfifo_data
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_pmsm_nonlinear_rdfifo_data IS
...
END uz_pmsm_nonlinear_rdfifo_data;


ARCHITECTURE rtl OF uz_pmsm_nonlinear_rdfifo_data IS

  -- Component Declarations
  COMPONENT uz_pmsm_nonlinear_SimpleDualPortRAM_generic
  ...
  FOR ALL : uz_pmsm_nonlinear_SimpleDualPortRAM_generic
    USE ENTITY work.uz_pmsm_nonlinear_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_uz_pmsm_nonlinear_rdfifo_data_classic_ram_generic : uz_pmsm_nonlinear_SimpleDualPortRAM_generic
