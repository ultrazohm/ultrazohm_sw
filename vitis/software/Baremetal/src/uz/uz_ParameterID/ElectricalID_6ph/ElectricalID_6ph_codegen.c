 ...
 * C/C++ source code generated on : Thu Jan 19 14:09:17 2023
 *
  ...
  *rtElectricalID_6ph_codegen_DW)
{
  ...
  switch (rtElectricalID_6ph_codegen_DW->is_ElectricalID) {
   case IN_Subchart_Step_Response:
    ...
    switch (rtElectricalID_6ph_codegen_DW->is_c14_suJr77aDRcBapkR34CUCR6C_) {
     case IN_Levenberg_Marquardt:
      /* Exit 'Levenberg_Marquardt': '<S2>:40' */
      rtElectricalID_6ph_codegen_DW->is_c14_suJr77aDRcBapkR34CUCR6C_ =
        IN_NO_ACTIVE_CHILD;
      break;
   ...
   case IN_Subchart_Step_Response1:
    /* Exit Internal: Subchart_Step_Response */
    switch (rtElectricalID_6ph_codegen_DW->is_c14_sEdmSWeEzJRvMrK23NRhcl_S) {
     case IN_Levenberg_Marquardt:
      /* Exit 'Levenberg_Marquardt': '<S3>:40' */
      rtElectricalID_6ph_codegen_DW->is_c14_sEdmSWeEzJRvMrK23NRhcl_S =
        IN_NO_ACTIVE_CHILD;
      break;
   ...
   case IN_Subchart_Step_Response2:
    /* Exit Internal: Subchart_Step_Response */
    switch (rtElectricalID_6ph_codegen_DW->is_c14_stn3vDFYFw0ytAi5iqWnJAE_) {
     case IN_Levenberg_Marquardt:
      /* Exit 'Levenberg_Marquardt': '<S4>:40' */
      rtElectricalID_6ph_codegen_DW->is_c14_stn3vDFYFw0ytAi5iqWnJAE_ =
        IN_NO_ACTIVE_CHILD;
      break;
   ...
   case IN_Subchart_Step_Response3:
    /* Exit Internal: Subchart_Step_Response */
    switch (rtElectricalID_6ph_codegen_DW->is_c14_sjmcPFOtCN9FQrBXqO15cxD_) {
     case IN_Levenberg_Marquardt:
      /* Exit 'Levenberg_Marquardt': '<S5>:40' */
      rtElectricalID_6ph_codegen_DW->is_c14_sjmcPFOtCN9FQrBXqO15cxD_ =
        IN_NO_ACTIVE_CHILD;
      break;
   ...
   case IN_Subchart_Step_Response4:
    /* Exit Internal: Subchart_Step_Response */
    switch (rtElectricalID_6ph_codegen_DW->is_c14_shV5vdCrOZuYWyfJ79CjAGC_) {
     case IN_Levenberg_Marquardt:
      /* Exit 'Levenberg_Marquardt': '<S6>:40' */
      rtElectricalID_6ph_codegen_DW->is_c14_shV5vdCrOZuYWyfJ79CjAGC_ =
        IN_NO_ACTIVE_CHILD;
      break;
   ...
   case IN_Subchart_Step_Response5:
    /* Exit Internal: Subchart_Step_Response */
    switch (rtElectricalID_6ph_codegen_DW->is_c14_sCHQlK7mZLkMj1oUC6g0nTD_) {
     case IN_Levenberg_Marquardt:
      /* Exit 'Levenberg_Marquardt': '<S7>:40' */
      rtElectricalID_6ph_codegen_DW->is_c14_sCHQlK7mZLkMj1oUC6g0nTD_ =
        IN_NO_ACTIVE_CHILD;
      break;
  ...
  if (rtElectricalID_6ph_codegen_U->GlobalConfig_out.Reset ||
    ...
    switch (rtElectricalID_6ph_codegen_DW->is_ElectricalID) {
     case IN_Subchart_Step_Response:
      ...
      if (rtElectricalID_6ph_codegen_DW->is_c14_suJr77aDRcBapkR34CUCR6C_ ==
        ...
        /* Inport: '<Root>/ActualValues' */
        /* '<S2>:35:8' MeasureStepResponse(ref_amplitude,ActualValues.i_dq_6ph); */
     ...
     case IN_Subchart_Step_Response1:
      ...
      /* During: Subchart_Step_Response */
      if (rtElectricalID_6ph_codegen_DW->is_c14_sEdmSWeEzJRvMrK23NRhcl_S ==
          IN_Levenberg_Marquardt) {
        ...
        /* Inport: '<Root>/ActualValues' */
        /* '<S3>:35:8' MeasureStepResponse(ref_amplitude,ActualValues.i_dq_6ph); */
     ...
     case IN_Subchart_Step_Response2:
      ...
      /* During: Subchart_Step_Response */
      if (rtElectricalID_6ph_codegen_DW->is_c14_stn3vDFYFw0ytAi5iqWnJAE_ ==
          IN_Levenberg_Marquardt) {
        ...
        /* Inport: '<Root>/ActualValues' */
        /* '<S4>:35:8' MeasureStepResponse(ref_amplitude,ActualValues.i_dq_6ph); */
     ...
     case IN_Subchart_Step_Response3:
      ...
      /* During: Subchart_Step_Response */
      if (rtElectricalID_6ph_codegen_DW->is_c14_sjmcPFOtCN9FQrBXqO15cxD_ ==
          IN_Levenberg_Marquardt) {
        ...
        /* Inport: '<Root>/ActualValues' */
        /* '<S5>:35:8' MeasureStepResponse(ref_amplitude,ActualValues.i_dq_6ph); */
     ...
     case IN_Subchart_Step_Response4:
      ...
      /* During: Subchart_Step_Response */
      if (rtElectricalID_6ph_codegen_DW->is_c14_shV5vdCrOZuYWyfJ79CjAGC_ ==
          IN_Levenberg_Marquardt) {
        ...
        /* Inport: '<Root>/ActualValues' */
        /* '<S6>:35:8' MeasureStepResponse(ref_amplitude,ActualValues.i_dq_6ph); */
     ...
     case IN_Subchart_Step_Response5:
      ...
      /* During: Subchart_Step_Response */
      if (rtElectricalID_6ph_codegen_DW->is_c14_sCHQlK7mZLkMj1oUC6g0nTD_ ==
          IN_Levenberg_Marquardt) {
        ...
        /* Inport: '<Root>/ActualValues' */
        /* '<S7>:35:8' MeasureStepResponse(ref_amplitude,ActualValues.i_dq_6ph); */
     ...
     case IN_findDutyCycle:
      ...
      if (rtElectricalID_6ph_codegen_DW->DC_valid) {
        ...
        rtElectricalID_6ph_codegen_DW->e_h4 = roundf(0.4F /
          rtElectricalID_6ph_codegen_U->GlobalConfig_out.sampleTimeISR);
        if (rtElectricalID_6ph_codegen_DW->e_h4 < 4.2949673E+9F) {
          if (rtElectricalID_6ph_codegen_DW->e_h4 >= 0.0F) {
        ...
        if (rtElectricalID_6ph_codegen_DW->counter <
          ...
          if (rtElectricalID_6ph_codegen_DW->counter >=
              rtElectricalID_6ph_codegen_DW->exitPortIndex) {
            rtElectricalID_6ph_codegen_DW->e_h4 = roundf(0.5F /
              rtElectricalID_6ph_codegen_U->GlobalConfig_out.sampleTimeISR);
            if (rtElectricalID_6ph_codegen_DW->e_h4 < 4.2949673E+9F) {
              if (rtElectricalID_6ph_codegen_DW->e_h4 >= 0.0F) {
                rtElectricalID_6ph_codegen_DW->exitPortIndex = (uint32_T)
