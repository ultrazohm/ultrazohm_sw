# 1 "foc/uz_space_vector_limitation.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 359 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "foc/uz_space_vector_limitation.c" 2
# 17 "foc/uz_space_vector_limitation.c"
...
# 4 "foc/uz_space_vector_limitation.h" 2
...
# 6 "foc/uz_space_vector_limitation.h" 2
...
#pragma pack(pop)
# 19 "foc/uz_space_vector_limitation.c" 2
