...
BEGIN
  ...
  SwitchUserOffset_out1 <= ADC_IN_signed WHEN ADC_SET_USER_OFFSET = '0' ELSE
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        DelayOffset_out1 <= to_signed(16#0000#, 16);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        AddOffset_out1_1 <= to_signed(16#00000#, 18);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        PipelineRegister_reg <= (OTHERS => to_signed(16#00000#, 18));
      ELSIF enb = '1' THEN
