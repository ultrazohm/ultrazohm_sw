function [ElectricalID_output] = SetpVectorToDutyCycle6ph(ElectricalID_output_in,VDC,SetpVector)
    ...
    ElectricalID_output.PWM_Switch_0 = GenerateDutyCycle(VDC,SetpVector(1));
    ElectricalID_output.PWM_Switch_2 = GenerateDutyCycle(VDC,SetpVector(2));
    ElectricalID_output.PWM_Switch_4 = GenerateDutyCycle(VDC,SetpVector(3));
