-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/gmStateSpaceHDL_uz_inverter_3ph/uz_invert_ip_src_nfp_convert_single2double_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_invert_ip_src_nfp_convert_single2double_block
-- Source Path: gmStateSpaceHDL_uz_inverter_3ph/uz_inverter_3ph/nfp_convert_single2double
-- Hierarchy Level: 1
-- 
...
ENTITY uz_invert_ip_src_nfp_convert_single2double_block IS
  PORT( nfp_in                            :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_out                           :   OUT   std_logic_vector(63 DOWNTO 0)  -- ufix64
        );
END uz_invert_ip_src_nfp_convert_single2double_block;


ARCHITECTURE rtl OF uz_invert_ip_src_nfp_convert_single2double_block IS
