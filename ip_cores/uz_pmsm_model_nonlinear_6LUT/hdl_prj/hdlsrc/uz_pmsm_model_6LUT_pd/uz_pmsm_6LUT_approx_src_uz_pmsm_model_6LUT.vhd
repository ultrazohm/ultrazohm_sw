...
ENTITY uz_pmsm_6LUT_approx_src_uz_pmsm_model_6LUT IS
  PORT( clk                               :   IN    std_logic;
        ...
        fitting_parameters_ad1            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_ad2            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_ad3            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_ad4            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_ad5            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_ad6            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_aq1            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_aq2            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_aq3            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_aq4            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_aq5            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_aq6            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_1_Fid1_Giq1    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_1_Fid2_Giq2    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_ad4ad5         :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_ad1ad2         :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_aq4aq5         :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_aq1aq2         :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_aq4_aq5        :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_aq1_aq2        :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_ad4_ad5        :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_ad1_ad2        :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_aq3_aq6        :   IN    std_logic_vector(31 DOWNTO 0);  -- single
...
ARCHITECTURE rtl OF uz_pmsm_6LUT_approx_src_uz_pmsm_model_6LUT IS
  ...
  SIGNAL fitting_parameters_ad3_1         : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL ad3                              : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL fitting_parameters_ad2_1         : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL fitting_parameters_ad6_1         : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL ad6                              : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL fitting_parameters_ad5_1         : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL fitting_parameters_aq2_1         : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL aq3_aq6_1                        : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL fitting_parameters_aq5_1         : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL aq1aq2                           : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL aq1_aq2_2                        : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL fitting_parameters_aq3_1         : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL aq4aq5                           : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL aq4_aq5_2                        : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL fitting_parameters_aq6_1         : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL aq6                              : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL aq6_1                            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL alpha1_Fid2_Giq2_3               : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL alpha1_Fid1_Giq1_1               : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Ld_2                             : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL ad3_1                            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL ad2_3                            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL ad1ad2                           : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL ad1_ad2_2                        : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL ad6_1                            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL ad5_3                            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL ad4ad5                           : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL ad4_ad5_2                        : std_logic_vector(31 DOWNTO 0);  -- ufix32
...
BEGIN
  ...
  u_nfp_mul_comp_9 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              ...
              nfp_in2 => fitting_parameters_aq6_1,  -- single
  ...
  u_nfp_mul_comp_10 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              ...
              enb => enb,
              nfp_in1 => Delay1_out1_2,  -- single
              nfp_in2 => fitting_parameters_aq5_1,  -- single
  ...
  u_nfp_mul_comp_12 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              ...
              enb => enb,
              nfp_in1 => Delay1_out1_2,  -- single
              nfp_in2 => fitting_parameters_aq2_1,  -- single
  ...
  u_nfp_mul_comp_18 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              ...
              nfp_in2 => alpha1_Fid2_Giq2_3,  -- single
  ...
  u_nfp_sub_comp_6 : uz_pmsm_6LUT_approx_src_nfp_sub_single
    PORT MAP( clk => clk,
              ...
              enb => enb,
              nfp_in1 => Delay1_out1,  -- single
              nfp_in2 => fitting_parameters_ad6_1,  -- single
  ...
  u_nfp_sub_comp_7 : uz_pmsm_6LUT_approx_src_nfp_sub_single
    PORT MAP( clk => clk,
              ...
              enb => enb,
              nfp_in1 => Delay1_out1,  -- single
              nfp_in2 => fitting_parameters_ad3_1,  -- single
  ...
  u_nfp_mul_comp_53 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              ...
              enb => enb,
              nfp_in1 => Delay1_out1_2,  -- single
              nfp_in2 => fitting_parameters_aq3_1,  -- single
  ...
  u_nfp_mul_comp_59 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              ...
              nfp_in2 => alpha1_Fid1_Giq1_1,  -- single
  ...
  fitting_parameters_ad3_1 <= fitting_parameters_ad3;

  ad3 <= fitting_parameters_ad3_1;

  fitting_parameters_ad2_1 <= fitting_parameters_ad2;
  ...
  fitting_parameters_ad6_1 <= fitting_parameters_ad6;

  ad6 <= fitting_parameters_ad6_1;

  fitting_parameters_ad5_1 <= fitting_parameters_ad5;
  ...
  alpha1_Fid2_Giq2 <= fitting_parameters_1_Fid2_Giq2;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        alpha1_Fid2_Giq2_1 <= alpha1_Fid2_Giq2;
      END IF;
    END IF;
  ...
  fitting_parameters_aq2_1 <= fitting_parameters_aq2;

  aq2 <= fitting_parameters_aq2_1;

  aq1_aq2 <= fitting_parameters_aq1_aq2;
  ...
  aq3_aq6 <= fitting_parameters_aq3_aq6;

  delayMatch20_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        aq3_aq6_1 <= X"00000000";
      ELSIF enb = '1' THEN
        aq3_aq6_1 <= aq3_aq6;
      END IF;
    END IF;
  ...
  fitting_parameters_aq5_1 <= fitting_parameters_aq5;

  aq5 <= fitting_parameters_aq5_1;

  aq4_aq5 <= fitting_parameters_aq4_aq5;
  ...
  alpha1_Fid1_Giq1 <= fitting_parameters_1_Fid1_Giq1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Reciprodical_F1G1 <= alpha1_Fid1_Giq1;
      END IF;
    END IF;
  ...
  ad1_ad2 <= fitting_parameters_ad1_ad2;
  ...
  ad4_ad5 <= fitting_parameters_ad4_ad5;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        alpha1_Fid2_Giq2_2 <= alpha1_Fid2_Giq2;
      END IF;
    END IF;
  ...
  aq2_1 <= fitting_parameters_aq2_1;

  aq1aq2 <= fitting_parameters_aq1aq2;

  delayMatch43_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        aq1_aq2_2 <= X"00000000";
      ELSIF enb = '1' THEN
        aq1_aq2_2 <= aq1aq2;
      END IF;
    END IF;
  ...
  fitting_parameters_aq3_1 <= fitting_parameters_aq3;

  aq3 <= fitting_parameters_aq3_1;
  ...
  aq5_1 <= fitting_parameters_aq5_1;

  aq4aq5 <= fitting_parameters_aq4aq5;

  delayMatch45_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        aq4_aq5_2 <= X"00000000";
      ELSIF enb = '1' THEN
        aq4_aq5_2 <= aq4aq5;
      END IF;
    END IF;
  ...
  fitting_parameters_aq6_1 <= fitting_parameters_aq6;

  aq6 <= fitting_parameters_aq6_1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        alpha1_Fid2_Giq2_3 <= X"00000000";
      ELSIF enb = '1' THEN
        alpha1_Fid2_Giq2_3 <= alpha1_Fid2_Giq2;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        alpha1_Fid1_Giq1_1 <= X"00000000";
      ELSIF enb = '1' THEN
        alpha1_Fid1_Giq1_1 <= alpha1_Fid1_Giq1;
      END IF;
    END IF;
  ...
  ad3_1 <= fitting_parameters_ad3_1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        ad2_3 <= X"00000000";
      ELSIF enb = '1' THEN
        ad2_3 <= fitting_parameters_ad2_1;
      END IF;
    END IF;
  END PROCESS delayMatch15_process;


  ad1ad2 <= fitting_parameters_ad1ad2;

  delayMatch16_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        ad1_ad2_2 <= X"00000000";
      ELSIF enb = '1' THEN
        ad1_ad2_2 <= ad1ad2;
      END IF;
    END IF;
  ...
  ad6_1 <= fitting_parameters_ad6_1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        ad5_3 <= X"00000000";
      ELSIF enb = '1' THEN
        ad5_3 <= fitting_parameters_ad5_1;
      END IF;
    END IF;
  END PROCESS delayMatch17_process;


  ad4ad5 <= fitting_parameters_ad4ad5;

  delayMatch18_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        ad4_ad5_2 <= X"00000000";
      ELSIF enb = '1' THEN
        ad4_ad5_2 <= ad4ad5;
      END IF;
    END IF;
