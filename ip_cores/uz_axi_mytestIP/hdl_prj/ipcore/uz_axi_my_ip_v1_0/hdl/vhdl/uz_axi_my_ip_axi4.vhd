-- -------------------------------------------------------------
-- 
-- File Name: C:\UltraZohm\ultrazohm_test\ip_cores\uz_axi_mytestIP\hdl_prj\hdlsrc\uz_axi_mytestIP\uz_axi_my_ip_axi4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_axi_my_ip_axi4
-- Source Path: uz_axi_my_ip/uz_axi_my_ip_axi4
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END uz_axi_my_ip_axi4;


ARCHITECTURE rtl OF uz_axi_my_ip_axi4 IS

  -- Component Declarations
  COMPONENT uz_axi_my_ip_addr_decoder
  ...
  COMPONENT uz_axi_my_ip_axi4_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_ARESETN                    :   IN    std_logic;  -- ufix1
          AXI4_AWID                       :   IN    std_logic_vector(11 DOWNTO 0);  -- ufix12
          AXI4_AWADDR                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  FOR ALL : uz_axi_my_ip_addr_decoder
    USE ENTITY work.uz_axi_my_ip_addr_decoder(rtl);

  FOR ALL : uz_axi_my_ip_axi4_module
    USE ENTITY work.uz_axi_my_ip_axi4_module(rtl);
...
BEGIN
  u_uz_axi_my_ip_addr_decoder_inst : uz_axi_my_ip_addr_decoder
  ...
  u_uz_axi_my_ip_axi4_module_inst : uz_axi_my_ip_axi4_module
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
