-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Encoder_Zynq\IncreEncoder_V22_ipcore_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IncreEncoder_V22_ipcore_dut
-- Source Path: IncreEncoder_V22_ipcore/IncreEncoder_V22_ipcore_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY IncreEncoder_V22_ipcore_dut IS
...
END IncreEncoder_V22_ipcore_dut;


ARCHITECTURE rtl OF IncreEncoder_V22_ipcore_dut IS

  -- Component Declarations
  COMPONENT IncreEncoder_V22_ipcore_src_IncreEncoder_V22
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : IncreEncoder_V22_ipcore_src_IncreEncoder_V22
    USE ENTITY work.IncreEncoder_V22_ipcore_src_IncreEncoder_V22(rtl);
...
BEGIN
  u_IncreEncoder_V22_ipcore_src_IncreEncoder_V22 : IncreEncoder_V22_ipcore_src_IncreEncoder_V22
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
              A => A_sig,  -- ufix1
