...
ARCHITECTURE rtl OF Test_FCS_MPC_3Phase_SPMSM_IP_Core_src_MATLAB_Function IS
  ...
  SIGNAL reciprocal_Ls_1                  : std_logic_vector(31 DOWNTO 0);  -- ufix32
...
BEGIN
  ...
  u_nfp_mul_comp_18 : Test_FCS_MPC_3Phase_SPMSM_IP_Core_src_nfp_mul_single
    PORT MAP( clk => clk,
              ...
              nfp_in2 => reciprocal_Ls_1,  -- single
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        reciprocal_Ls_1 <= X"00000000";
      ELSIF enb = '1' THEN
        reciprocal_Ls_1 <= reciprocal_Ls;
      END IF;
    END IF;
