-- -------------------------------------------------------------
-- 
-- File Name: C:\UltraZohm\ultrazohm_test\ip_cores\uz_axi_mytestIP\hdl_prj\hdlsrc\uz_axi_mytestIP\uz_axi_my_ip_addr_decoder.vhd
...
BEGIN
  ...
  decode_sel_C_fx_1_16_5_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0048#, 14) ELSE
      '0';
  ...
  decode_rd_C_fx_1_16_5_1_1 <= decode_rd_C_uint32_1_1 WHEN decode_sel_C_fx_1_16_5_1_1 = '0' ELSE
  ...
  decode_sel_A_fx_1_16_5_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0044#, 14) ELSE
      '0';
  ...
  decode_sel_B_fx_1_16_5_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0045#, 14) ELSE
      '0';
