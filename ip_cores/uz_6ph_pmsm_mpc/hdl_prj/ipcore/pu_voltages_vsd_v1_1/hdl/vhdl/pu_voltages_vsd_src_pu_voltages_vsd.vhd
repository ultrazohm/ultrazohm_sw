-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\external_state_machine\pu_voltages_vsd_src_pu_voltages_vsd.vhd
-- Created: 2023-07-28 15:32:34
-- 
...
-- Source Path: external_state_machine/pu_voltages_vsd
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF pu_voltages_vsd_src_pu_voltages_vsd IS
  ...
  SIGNAL pu_ux                            : std_logic_vector(26 DOWNTO 0);  -- ufix27
  SIGNAL pu_uy                            : std_logic_vector(26 DOWNTO 0);  -- ufix27
...
BEGIN
  ...
  u_finite_control_set : pu_voltages_vsd_src_finite_control_set
    PORT MAP( v_DC_pu => std_logic_vector(Switch8_out1),  -- sfix18_En15
              ...
              pu_ux => pu_ux,  -- sfix27_En24
              pu_uy => pu_uy  -- sfix27_En24
              );
  ...
  pu_ux_1 <= reduced_reg_2(1);

  pu_vx <= std_logic_vector(pu_ux_1);

  pu_uy_signed <= signed(pu_uy);
  ...
  pu_uy_1 <= reduced_reg_3(1);

  pu_vy <= std_logic_vector(pu_uy_1);

  pu_vd_AXI <= std_logic_vector(pu_ud_1);

  pu_vq_AXI <= std_logic_vector(pu_uq_1);

  pu_vx_AXI <= std_logic_vector(pu_ux_1);

  pu_vy_AXI <= std_logic_vector(pu_uy_1);
