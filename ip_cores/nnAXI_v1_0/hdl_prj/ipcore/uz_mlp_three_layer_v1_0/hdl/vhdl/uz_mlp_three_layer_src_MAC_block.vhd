-- -------------------------------------------------------------
-- 
-- File Name: /home/ts/Documents/integrate_nn_to_uz/ultrazohm_sw/ip_cores/nnAXI_v1_0/hdl_prj/hdlsrc/uz_mlp_three_layer/uz_mlp_three_layer_src_MAC_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_mlp_three_layer_src_MAC_block
-- Source Path: uz_mlp_three_layer/pcu_mlp2_8parallel/reluLayer_8Parallel/MAC
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_mlp_three_layer_src_MAC_block IS
...
END uz_mlp_three_layer_src_MAC_block;


ARCHITECTURE rtl OF uz_mlp_three_layer_src_MAC_block IS

  -- Component Declarations
  COMPONENT uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block15
  ...
  COMPONENT uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block17
    GENERIC( AddrWidth                    : integer;
             DataWidth                    : integer
             );
    PORT( clk                             :   IN    std_logic;
  ...
  COMPONENT uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block16
    GENERIC( AddrWidth                    : integer;
             DataWidth                    : integer
             );
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block15
    USE ENTITY work.uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block15(rtl);

  FOR ALL : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block17
    USE ENTITY work.uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block17(rtl);

  FOR ALL : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block16
    USE ENTITY work.uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block16(rtl);
...
BEGIN
  u_Dual_Port_RAM_System1 : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block15
  ...
  u_Dual_Port_RAM_System3 : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block17
    GENERIC MAP( AddrWidth => 10,
                 DataWidth => 32
                 )
    PORT MAP( clk => clk,
  ...
  u_Dual_Port_RAM_System2 : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block16
    GENERIC MAP( AddrWidth => 10,
                 DataWidth => 32
                 )
    PORT MAP( clk => clk,
