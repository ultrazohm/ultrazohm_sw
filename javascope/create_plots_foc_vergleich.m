...
foc_cil_end_300_rpm=changes(6);
foc_cil_end_550_rpm=changes(8);
...
foc_real_end_300_rpm=changes(6);
foc_real_end_550_rpm=changes(8);
% ddpg_cil_end_3000_rpm=changes(10);
...
% hold on
% grid minor
% plot(foc_time_real,foc_real.log.start_marker(foc_real_start_0_rpm:foc_real_end_0_rpm),'c--' ,'LineWidth',2);
% 
% % 
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 500 rpm
% figure
