-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\ELSYS_PC\Documents\repos\ultrazohm_sw\ip_cores\uz_EnDat_IPCore\hdl_prj\hdlsrc\UZ_EnDat\uz_EnDat_src_FF0_block2.vhd
-- Created: 2023-12-12 23:22:24
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: uz_EnDat_src_FF0_block2
-- Source Path: UZ_EnDat/UZ_ENDAT/ManualSerialize/FF0
-- Hierarchy Level: 2
-- Model version: 2.291
-- 
-- -------------------------------------------------------------
...
ENTITY uz_EnDat_src_FF0_block2 IS
...
END uz_EnDat_src_FF0_block2;


ARCHITECTURE rtl OF uz_EnDat_src_FF0_block2 IS
...
BEGIN
  ...
  stateControl_6 <= delayMatch4_reg(1);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        delayMatch5_reg(0) <= stateControl_7;
        delayMatch5_reg(1) <= delayMatch5_reg(0);
      END IF;
    END IF;
  END PROCESS delayMatch5_process;

  stateControl_8 <= delayMatch5_reg(1);

  enb_gated_3 <= stateControl_8 AND enb;

  Logical_Operator2_out1 <=  NOT (Delay3_out1 AND (Delay1_out1 AND CLK_2));
  ...
  Logical_Operator3_out1 <=  NOT (RST AND (Delay2_out1 AND DATA_1));
  ...
  Logical_Operator1_out1 <=  NOT (RST AND (Delay_out1 AND CLK_2));
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        delayMatch6_reg(0) <= stateControl_9;
        delayMatch6_reg(1) <= delayMatch6_reg(0);
      END IF;
    END IF;
  END PROCESS delayMatch6_process;

  stateControl_10 <= delayMatch6_reg(1);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        delayMatch7_reg(0) <= stateControl_11;
        delayMatch7_reg(1) <= delayMatch7_reg(0);
      END IF;
    END IF;
  END PROCESS delayMatch7_process;

  stateControl_12 <= delayMatch7_reg(1);
