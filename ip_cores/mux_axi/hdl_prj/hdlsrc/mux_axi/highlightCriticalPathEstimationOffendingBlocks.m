...
cs.BackgroundColor = 'gray';
set_param(0, 'HiliteAncestorsData', cs);
hilite_system('gm_mux_axi/mux_axi/Subsystem1/Delay', 'user2');
annotate_port('gm_mux_axi/mux_axi/Subsystem1/Delay', 1, 1, 'Block not characterized');
hilite_system('mux_axi/mux_axi/Subsystem1/Delay', 'user2');
annotate_port('mux_axi/mux_axi/Subsystem1/Delay', 1, 1, 'Block not characterized');
cs.HiliteType = 'user2';
cs.ForegroundColor = 'black';
cs.BackgroundColor = 'gray';
set_param(0, 'HiliteAncestorsData', cs);
hilite_system('gm_mux_axi/mux_axi/Subsystem1/PipelineDelay', 'user2');
annotate_port('gm_mux_axi/mux_axi/Subsystem1/PipelineDelay', 1, 1, 'Block not characterized');
hilite_system('mux_axi/mux_axi/Subsystem1/PipelineDelay', 'user2');
annotate_port('mux_axi/mux_axi/Subsystem1/PipelineDelay', 1, 1, 'Block not characterized');
