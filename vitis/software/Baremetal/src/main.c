...
// buffer
#define EXPERIENCE_BUFFER_LENGTH 1000000U
...
// random array
uint32_t array[NUMBEROFBITS] = {0U, 0U, 0U, 0U,0U, 0U, 0U, 0U};
uint32_t tararray[NUMBEROFBITS] = {1U, 1U, 1U, 1U,1U, 1U, 1U, 1U};
...
float m2[NUMBER_OF_NEURONS_IN_HIDDEN_LAYER + NUMBER_OF_NEURONS_IN_HIDDEN_LAYER * NUMBER_OF_NEURONS_IN_HIDDEN_LAYER] = {0.0f};
float v2[NUMBER_OF_NEURONS_IN_HIDDEN_LAYER + NUMBER_OF_NEURONS_IN_HIDDEN_LAYER * NUMBER_OF_NEURONS_IN_HIDDEN_LAYER] = {0.0f};
float m3[NUMBER_OF_NEURONS_IN_HIDDEN_LAYER + NUMBER_OF_NEURONS_IN_HIDDEN_LAYER * NUMBER_OF_NEURONS_IN_HIDDEN_LAYER] = {0.0f};
float v3[NUMBER_OF_NEURONS_IN_HIDDEN_LAYER + NUMBER_OF_NEURONS_IN_HIDDEN_LAYER * NUMBER_OF_NEURONS_IN_HIDDEN_LAYER] = {0.0f};
float m4[NUMBER_OF_OUTPUTS+NUMBER_OF_OUTPUTS * NUMBER_OF_NEURONS_IN_HIDDEN_LAYER] = {0.0f};
float v4[NUMBER_OF_OUTPUTS+NUMBER_OF_OUTPUTS * NUMBER_OF_NEURONS_IN_HIDDEN_LAYER] = {0.0f};
...
float ts_3[NUMBER_OF_NEURONS_IN_HIDDEN_LAYER] = {0};
float ts_4[NUMBER_OF_OUTPUTS] = {0};
...
float tw_3[NUMBER_OF_NEURONS_IN_HIDDEN_LAYER * NUMBER_OF_NEURONS_IN_HIDDEN_LAYER] = {0};
float tb_3[NUMBER_OF_NEURONS_IN_HIDDEN_LAYER] = {0};
float ty_3[NUMBER_OF_NEURONS_IN_HIDDEN_LAYER] = {0};
float tw_4[NUMBER_OF_NEURONS_IN_HIDDEN_LAYER * NUMBER_OF_OUTPUTS] = {0};
float tb_4[NUMBER_OF_OUTPUTS] = {0};
float ty_4[NUMBER_OF_OUTPUTS] = {0};

float copy_ts_1[NUMBER_OF_NEURONS_IN_HIDDEN_LAYER] = {0};
float copy_ts_2[NUMBER_OF_NEURONS_IN_HIDDEN_LAYER] = {0};
float copy_ts_3[NUMBER_OF_NEURONS_IN_HIDDEN_LAYER] = {0};
float copy_ts_4[NUMBER_OF_OUTPUTS] = {0};
...
float copy_tw_2[NUMBER_OF_NEURONS_IN_HIDDEN_LAYER * NUMBER_OF_NEURONS_IN_HIDDEN_LAYER] = {0};
float copy_tb_2[NUMBER_OF_NEURONS_IN_HIDDEN_LAYER] = {0};
float copy_ty_2[NUMBER_OF_NEURONS_IN_HIDDEN_LAYER] = {0};
float copy_tw_3[NUMBER_OF_NEURONS_IN_HIDDEN_LAYER * NUMBER_OF_NEURONS_IN_HIDDEN_LAYER] = {0};
float copy_tb_3[NUMBER_OF_NEURONS_IN_HIDDEN_LAYER] = {0};
float copy_ty_3[NUMBER_OF_NEURONS_IN_HIDDEN_LAYER] = {0};
float copy_tw_4[NUMBER_OF_NEURONS_IN_HIDDEN_LAYER * NUMBER_OF_OUTPUTS] = {0};
float copy_tb_4[NUMBER_OF_OUTPUTS] = {0};
float copy_ty_4[NUMBER_OF_OUTPUTS] = {0};

// critic
float cs_1[NUMBER_OF_NEURONS_IN_HIDDEN_LAYER] = {0};
float cs_2[NUMBER_OF_NEURONS_IN_HIDDEN_LAYER] = {0};
float cs_3[NUMBER_OF_NEURONS_IN_HIDDEN_LAYER] = {0};
float cs_4[NUMBER_OF_OUTPUTS] = {0};

// deltas
float delta_1[NUMBER_OF_NEURONS_IN_HIDDEN_LAYER] = {0};
float delta_2[NUMBER_OF_NEURONS_IN_HIDDEN_LAYER] = {0};
float delta_3[NUMBER_OF_NEURONS_IN_HIDDEN_LAYER] = {0};
float delta_4[NUMBER_OF_OUTPUTS] = {0};
...
float cacheg_3[NUMBER_OF_NEURONS_IN_HIDDEN_LAYER * NUMBER_OF_NEURONS_IN_HIDDEN_LAYER] = {0};
float cacheg_4[NUMBER_OF_NEURONS_IN_HIDDEN_LAYER * NUMBER_OF_OUTPUTS] = {0};
...
float g_3[NUMBER_OF_NEURONS_IN_HIDDEN_LAYER + NUMBER_OF_NEURONS_IN_HIDDEN_LAYER * NUMBER_OF_NEURONS_IN_HIDDEN_LAYER] = {0};
float g_4[NUMBER_OF_OUTPUTS + NUMBER_OF_NEURONS_IN_HIDDEN_LAYER * NUMBER_OF_OUTPUTS] = {0};
...
float cw_3[NUMBER_OF_NEURONS_IN_HIDDEN_LAYER * NUMBER_OF_NEURONS_IN_HIDDEN_LAYER] = {0.0f};
float cb_3[NUMBER_OF_NEURONS_IN_HIDDEN_LAYER] = {0.0f};
float cy_3[NUMBER_OF_NEURONS_IN_HIDDEN_LAYER] = {0.0f};

float cw_4[NUMBER_OF_NEURONS_IN_HIDDEN_LAYER * NUMBER_OF_OUTPUTS] = {0.0f};
float cb_4[NUMBER_OF_OUTPUTS] = {0.0f};
float cy_4[NUMBER_OF_OUTPUTS] = {0.0f};

// error
float e_1[NUMBER_OF_NEURONS_IN_HIDDEN_LAYER]={0.0f};
float e_2[NUMBER_OF_NEURONS_IN_HIDDEN_LAYER]={0.0f};
float e_3[NUMBER_OF_NEURONS_IN_HIDDEN_LAYER]={0.0f};
float e_4[NUMBER_OF_OUTPUTS]={0.0f};

// Temporary buffer storage
float T1[NUMBER_OF_NEURONS_IN_HIDDEN_LAYER * NUMBER_OF_NEURONS_IN_HIDDEN_LAYER] = {0};
float T2[NUMBER_OF_NEURONS_IN_HIDDEN_LAYER * NUMBER_OF_NEURONS_IN_HIDDEN_LAYER] = {0};
float T3[NUMBER_OF_NEURONS_IN_HIDDEN_LAYER * NUMBER_OF_OUTPUTS] = {0};
float T4[4] = {0}; // eigentlich nicht n�tig da man cachebackprop im letzten layer nicht ben�tigt, aber fest definiert in layerconfig
...
struct uz_nn_layer_config config_copy[NUMBER_OF_HIDDEN_LAYER] = {
		 [0] = {
		    ...
		    [1] = {
		      ...
		      .length_of_weights = UZ_MATRIX_SIZE(copy_tw_2),
		      .length_of_bias = UZ_MATRIX_SIZE(copy_tb_2),
		      .length_of_output = UZ_MATRIX_SIZE(copy_ty_2),
		      .length_of_sumout = UZ_MATRIX_SIZE(copy_ts_2),
		      .weights = copy_tw_2,
		      .bias = copy_tb_2,
		      .output = copy_ty_2,
		      .sumout = copy_ts_2},
			  [2] = {.activation_function = activation_ReLU,
			   .number_of_neurons = NUMBER_OF_NEURONS_IN_HIDDEN_LAYER,
			   .number_of_inputs = NUMBER_OF_NEURONS_IN_HIDDEN_LAYER,
			   .length_of_weights = UZ_MATRIX_SIZE(copy_tw_3),
			   .length_of_bias = UZ_MATRIX_SIZE(copy_tb_3),
			   .length_of_output = UZ_MATRIX_SIZE(copy_ty_3),
			   .length_of_sumout = UZ_MATRIX_SIZE(copy_ts_3),
			   .weights = copy_tw_3,
			   .bias = copy_tb_3,
			   .output = copy_ty_3,
			   .sumout = copy_ts_3},
		  [3] = {.activation_function = activation_linear,
		   .number_of_neurons = NUMBER_OF_OUTPUTS,
		   .number_of_inputs = NUMBER_OF_NEURONS_IN_HIDDEN_LAYER,
		   .length_of_weights = UZ_MATRIX_SIZE(copy_tw_4),
		   .length_of_bias = UZ_MATRIX_SIZE(copy_tb_4),
		   .length_of_output = UZ_MATRIX_SIZE(copy_ty_4),
		   .length_of_sumout = UZ_MATRIX_SIZE(copy_ts_4),
		   .weights = copy_tw_4,
		   .bias = copy_tb_4,
		   .output = copy_ty_4,
		   .sumout = copy_ts_4}
...
struct uz_nn_layer_config config_target[NUMBER_OF_HIDDEN_LAYER] = {
		 [0] = {
		  ...
		  [3] = {.activation_function = activation_linear,
		   .number_of_neurons = NUMBER_OF_OUTPUTS,
		   .number_of_inputs = NUMBER_OF_NEURONS_IN_HIDDEN_LAYER,
		   .length_of_weights = UZ_MATRIX_SIZE(tw_4),
		   .length_of_bias = UZ_MATRIX_SIZE(tb_4),
		   .length_of_output = UZ_MATRIX_SIZE(ty_4),
		   .length_of_sumout = UZ_MATRIX_SIZE(ts_4),
		   .weights = tw_4,
		   .bias = tb_4,
		   .output = ty_4,
		   .sumout = ts_4}
...
struct uz_nn_layer_config config_critic[NUMBER_OF_HIDDEN_LAYER] = {
		 [0] = {
		  ...
		  [3] = {.activation_function = activation_linear,
		   ...
		   .length_of_weights = UZ_MATRIX_SIZE(cw_4),
		   .length_of_bias = UZ_MATRIX_SIZE(cb_4),
		   .length_of_output = UZ_MATRIX_SIZE(cy_4),
		   .length_of_sumout = UZ_MATRIX_SIZE(cs_4),
		   .length_of_delta = UZ_MATRIX_SIZE(delta_4),
		   .length_of_gradients = UZ_MATRIX_SIZE(g_4),
		   .length_of_error = UZ_MATRIX_SIZE(e_4),
		   .length_of_temporarybackprop = UZ_MATRIX_SIZE(T4),
		   .length_of_cachegradients = UZ_MATRIX_SIZE(cacheg_4),
		    .m = m4,
		    .v = v4,
		   .weights = cw_4,
		   .bias = cb_4,
		   ...
		   .sumout = cs_4,
		   .delta = delta_4,
		   .temporarybackprop = T4,
		   .gradients = g_4,
		   .cachegradients = cacheg_4,
		   .error= e_4}
		  };
// config buffer
...
int main(void)
{
    ...
    while (1)
    {
        ...
        case infinite_loop:
            ...
            float error[NUMBER_OF_OUTPUTS] = {0.0f};
            for (uint32_t numberoftrial = 0; numberoftrial < MAXTRIALS;numberoftrial++)
            {
            timeflag += 1.0f;
