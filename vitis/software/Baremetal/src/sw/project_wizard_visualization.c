...
void project_wizard_visualization_update(struct _DS_Data_* data)
{
    ...
    project_wizard_visualization_data.viz_resolver_pl_interface_d5_1_position_el_2pi = data->av.resolver_pl_interface_d5_1_position_el_2pi;
    project_wizard_visualization_data.viz_resolver_pl_interface_d5_1_omega_mech_rad_s = data->av.resolver_pl_interface_d5_1_omega_mech_rad_s;
    project_wizard_visualization_data.viz_resolver_pl_interface_d5_1_n_mech_rpm = data->av.resolver_pl_interface_d5_1_n_mech_rpm;
    project_wizard_visualization_data.viz_resolver_pl_interface_d5_1_omega_el_rad_s = data->av.resolver_pl_interface_d5_1_omega_el_rad_s;
    project_wizard_visualization_data.viz_resolver_pl_interface_d5_1_revolution_counter = ((float)data->av.resolver_pl_interface_d5_1_revolution_counter);
    ...
    project_wizard_visualization_data.viz_resolver_pl_interface_d5_2_position_el_2pi = data->av.resolver_pl_interface_d5_2_position_el_2pi;
    project_wizard_visualization_data.viz_resolver_pl_interface_d5_2_omega_mech_rad_s = data->av.resolver_pl_interface_d5_2_omega_mech_rad_s;
    project_wizard_visualization_data.viz_resolver_pl_interface_d5_2_n_mech_rpm = data->av.resolver_pl_interface_d5_2_n_mech_rpm;
    project_wizard_visualization_data.viz_resolver_pl_interface_d5_2_omega_el_rad_s = data->av.resolver_pl_interface_d5_2_omega_el_rad_s;
    project_wizard_visualization_data.viz_resolver_pl_interface_d5_2_revolution_counter = ((float)data->av.resolver_pl_interface_d5_2_revolution_counter);
}
