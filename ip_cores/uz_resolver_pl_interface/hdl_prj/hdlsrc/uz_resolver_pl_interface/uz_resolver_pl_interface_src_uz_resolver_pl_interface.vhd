...
ARCHITECTURE rtl OF uz_resolver_pl_interface_src_uz_resolver_pl_interface IS
  ...
  SIGNAL theta_m_offset_rad_AXI_1         : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL theta_m_offset_rad_AXI_2         : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL theta_m_offset_rad_AXI_3         : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL theta_m_offset_rad_AXI_4         : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL bitToRPS_Factor_AXI_1            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL bitToRPS_Factor_AXI_2            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL bitToRPS_Factor_AXI_3            : std_logic_vector(31 DOWNTO 0);  -- ufix32
...
BEGIN
  ...
  u_nfp_add_comp_3 : uz_resolver_pl_interface_src_nfp_add_single
    PORT MAP( clk => clk,
              ...
              nfp_in2 => theta_m_offset_rad_AXI_4,  -- single
  ...
  u_nfp_mul_comp_4 : uz_resolver_pl_interface_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              nfp_in1 => theta_m_offset_rad_AXI_3,  -- single
  ...
  u_nfp_mul_comp_5 : uz_resolver_pl_interface_src_nfp_mul_single
    PORT MAP( clk => clk,
              ...
              nfp_in2 => bitToRPS_Factor_AXI_3,  -- single
  ...
  theta_m_offset_rad_AXI_2 <= theta_m_offset_rad_AXI_1 WHEN Detect_Rise_Positive_out1 = '0' ELSE
      Delay27_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        theta_m_offset_rad_AXI_1 <= X"00000000";
      ELSIF enb = '1' THEN
        theta_m_offset_rad_AXI_1 <= theta_m_offset_rad_AXI_2;
      END IF;
    END IF;
  ...
  theta_m_offset_rad_AXI_3 <= reduced_reg_5(4);
  reduced_reg_next_5(0) <= theta_m_offset_rad_AXI_1;
  ...
  theta_m_offset_rad_AXI_4 <= reduced_reg_6(69);
  reduced_reg_next_6(0) <= theta_m_offset_rad_AXI_3;
  ...
  bitToRPS_Factor_AXI_2 <= bitToRPS_Factor_AXI_1 WHEN Detect_Rise_Positive_out1 = '0' ELSE
      Delay19_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        bitToRPS_Factor_AXI_1 <= X"00000000";
      ELSIF enb = '1' THEN
        bitToRPS_Factor_AXI_1 <= bitToRPS_Factor_AXI_2;
      END IF;
    END IF;
  ...
  bitToRPS_Factor_AXI_3 <= reduced_reg_7(4);
  reduced_reg_next_7(0) <= bitToRPS_Factor_AXI_1;
