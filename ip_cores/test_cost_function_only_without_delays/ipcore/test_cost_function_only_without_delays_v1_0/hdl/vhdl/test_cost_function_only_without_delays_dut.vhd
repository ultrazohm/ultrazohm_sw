-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\test_cost_function_only_without_delays\hdlsrc\test_cost_function_only_without_delays\test_cost_function_only_without_delays_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: test_cost_function_only_without_delays_dut
-- Source Path: test_cost_function_only_without_delays/test_cost_function_only_without_delays_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY test_cost_function_only_without_delays_dut IS
...
END test_cost_function_only_without_delays_dut;


ARCHITECTURE rtl OF test_cost_function_only_without_delays_dut IS

  -- Component Declarations
  COMPONENT test_cost_function_only_without_delays_src_HDL_DUT1
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : test_cost_function_only_without_delays_src_HDL_DUT1
    USE ENTITY work.test_cost_function_only_without_delays_src_HDL_DUT1(rtl);
...
BEGIN
  u_test_cost_function_only_without_delays_src_HDL_DUT1 : test_cost_function_only_without_delays_src_HDL_DUT1
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
