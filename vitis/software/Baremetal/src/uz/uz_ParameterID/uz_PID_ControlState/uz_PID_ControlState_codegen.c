...
static void decideIDstates(ExtU_ControlState_t *rtControlState_U, ExtY_ControlState_t *rtControlState_Y, DW_ControlState_t *rtControlState_DW);
static void initParams(ExtU_ControlState_t *rtControlState_U, ExtY_ControlState_t *rtControlState_Y, DW_ControlState_t *rtControlState_DW);
...
static void decideIDstates(ExtU_ControlState_t *rtControlState_U, ExtY_ControlState_t *rtControlState_Y, DW_ControlState_t *rtControlState_DW)
{
  ...
  /* '<S1>:709:18' if(GlobalConfig_in.ElectricalID==1 && enteredElectricalID==0) */
	if (rtControlState_U->GlobalConfig_in.ElectricalID && (!rtControlState_U->enteredElectricalID)) {
    ...
    /* '<S1>:709:21' ControlFlags.transNr=uint16(1); */
		rtControlState_Y->ControlFlags_p.transNr = 1U;
  ...
  /* '<S1>:709:26' if(GlobalConfig_in.TwoMassID==1 && enteredTwoMassID==0 && finishedElectricalID_loc==1) */
	if (rtControlState_U->GlobalConfig_in.TwoMassID && (!rtControlState_U->enteredTwoMassID) && rtControlState_DW->finishedElectricalID_loc) {
    /* Outport: '<Root>/ControlFlags' */
    /* '<S1>:709:27' ControlFlags.transNr=uint16(2); */
		rtControlState_Y->ControlFlags_p.transNr = 2U;
  }
  ...
  /* '<S1>:709:32'     && finishedTwoMassID_loc==1) */
	if (rtControlState_U->GlobalConfig_in.FrictionID && (!rtControlState_U->enteredFrictionID) && rtControlState_DW->finishedElectricalID_loc && rtControlState_DW->finishedTwoMassID_loc) {
    /* Outport: '<Root>/ControlFlags' */
    /* '<S1>:709:33' ControlFlags.transNr=uint16(3); */
		rtControlState_Y->ControlFlags_p.transNr = 3U;
  }
  ...
  /* '<S1>:709:38'     && finishedTwoMassID_loc==1 && finishedFrictionID_loc==1) */
	if (rtControlState_U->GlobalConfig_in.FluxMapID && (!rtControlState_U->enteredFluxMapID) && rtControlState_DW->finishedElectricalID_loc && rtControlState_DW->finishedTwoMassID_loc
	                && rtControlState_DW->finishedFrictionID_loc) {
    /* Outport: '<Root>/ControlFlags' */
    /* '<S1>:709:39' ControlFlags.transNr=uint16(4); */
		rtControlState_Y->ControlFlags_p.transNr = 4U;
  }
  ...
  /* '<S1>:709:43'         finishedFrictionID_loc==1 && finishedFluxMapID_loc==1) */
	if (rtControlState_DW->finishedElectricalID_loc && rtControlState_DW->finishedTwoMassID_loc && rtControlState_DW->finishedFrictionID_loc && rtControlState_DW->finishedFluxMapID_loc) {
...
static void initParams(ExtU_ControlState_t *rtControlState_U, ExtY_ControlState_t *rtControlState_Y, DW_ControlState_t *rtControlState_DW)
{
  ...
  /* '<S1>:566:9' ControlFlags.startFrictionID         = boolean(0); */
	rtControlState_Y->ControlFlags_p.startFrictionID = false;

  /* '<S1>:566:10' ControlFlags.startElectricalID       = boolean(0); */
	rtControlState_Y->ControlFlags_p.startElectricalID = false;

  /* '<S1>:566:11' ControlFlags.startTwoMassID          = boolean(0); */
	rtControlState_Y->ControlFlags_p.startTwoMassID = false;

  /* '<S1>:566:12' ControlFlags.startFluxMapID          = boolean(0); */
	rtControlState_Y->ControlFlags_p.startFluxMapID = false;
  ...
  /* '<S1>:566:15' ControlFlags.enableFOCcurrentState   = boolean(0); */
	rtControlState_Y->ControlFlags_p.enableFOCcurrentState = false;

  /* '<S1>:566:16' ControlFlags.enableFOCspeedState     = boolean(0); */
	rtControlState_Y->ControlFlags_p.enableFOCspeedState = false;

  /* '<S1>:566:17' ControlFlags.enableOnlineID          = boolean(0); */
	rtControlState_Y->ControlFlags_p.enableOnlineID = false;

  /* '<S1>:566:18' ControlFlags.transNr                 = uint16(0); */
	rtControlState_Y->ControlFlags_p.transNr = 0U;
}
...
void ControlState_step(RT_MODEL_ControlState_t * const rtControlState_M)
{
	...
	ExtU_ControlState_t *rtControlState_U = (ExtU_ControlState_t *) rtControlState_M->inputs;
	ExtY_ControlState_t *rtControlState_Y = (ExtY_ControlState_t *) rtControlState_M->outputs;
  ...
  /* During: ControlState */
    ...
    /* '<S1>:39:5' GlobalConfig_out.Reset = GlobalConfig_in.Reset; */
		rtControlState_Y->GlobalConfig_out.Reset = rtControlState_U->GlobalConfig_in.Reset;

    /* '<S1>:39:6' GlobalConfig_out.ACCEPT = GlobalConfig_in.ACCEPT; */
		rtControlState_Y->GlobalConfig_out.ACCEPT = rtControlState_U->GlobalConfig_in.ACCEPT;

    /* '<S1>:39:7' GlobalConfig_out.controlType = GlobalConfig_in.controlType; */
		rtControlState_Y->GlobalConfig_out.controlType = rtControlState_U->GlobalConfig_in.controlType;

    /* '<S1>:39:8' GlobalConfig_out.VibOn = GlobalConfig_in.VibOn; */
		rtControlState_Y->GlobalConfig_out.VibOn = rtControlState_U->GlobalConfig_in.VibOn;

    /* '<S1>:39:9' GlobalConfig_out.VibAmp = GlobalConfig_in.VibAmp; */
		rtControlState_Y->GlobalConfig_out.VibAmp = rtControlState_U->GlobalConfig_in.VibAmp;

    /* '<S1>:39:10' GlobalConfig_out.VibFreq = GlobalConfig_in.VibFreq; */
		rtControlState_Y->GlobalConfig_out.VibFreq = rtControlState_U->GlobalConfig_in.VibFreq;

    /* '<S1>:39:11' GlobalConfig_out.ElectricalID = GlobalConfig_in.ElectricalID; */
		rtControlState_Y->GlobalConfig_out.ElectricalID = rtControlState_U->GlobalConfig_in.ElectricalID;

    /* '<S1>:39:12' GlobalConfig_out.FrictionID = GlobalConfig_in.FrictionID */
		rtControlState_Y->GlobalConfig_out.FrictionID = rtControlState_U->GlobalConfig_in.FrictionID;

    /* '<S1>:39:13' GlobalConfig_out.TwoMassID = GlobalConfig_in.TwoMassID; */
		rtControlState_Y->GlobalConfig_out.TwoMassID = rtControlState_U->GlobalConfig_in.TwoMassID;

    /* '<S1>:39:14' GlobalConfig_out.FluxMapID = GlobalConfig_in.FluxMapID; */
		rtControlState_Y->GlobalConfig_out.FluxMapID = rtControlState_U->GlobalConfig_in.FluxMapID;

    /* '<S1>:39:15' GlobalConfig_out.OnlineID = GlobalConfig_in.OnlineID; */
		rtControlState_Y->GlobalConfig_out.OnlineID = rtControlState_U->GlobalConfig_in.OnlineID;
		switch (rtControlState_DW->is_ControlState) {
     case IN_CurrentControl:
      ...
      /* '<S1>:666:5' if(GlobalConfig_in.OnlineID==1) */
        ...
        /* '<S1>:666:6' ControlFlags.enableOnlineID=boolean(1); */
				rtControlState_Y->ControlFlags_p.enableOnlineID = true;
      } else {
        /* '<S1>:666:7' else */
     ...
     case IN_activateElectricalID:
      ...
      /* '<S1>:625:1' sf_internal_predicateOutput = enteredElectricalID==1; */
        ...
        /* '<S1>:624:4' thetaOffset=ElectricalID_output.thetaOffset; */
				rtControlState_Y->thetaOffset = rtControlState_U->ElectricalID_output_n.thetaOffset;
      } else {
        /* Outport: '<Root>/thetaOffset' incorporates:
         *  Inport: '<Root>/ElectricalID_output'
         */
     ...
     case IN_decideMotorID:
      ...
      /* . */
			if ((rtControlState_Y->ControlFlags_p.transNr == 1) && (!rtControlState_DW->finishedElectricalID_loc) && rtControlState_U->GlobalConfig_in.ACCEPT) {
        /* Transition: '<S1>:618' */
        /* Exit 'decideMotorID': '<S1>:605' */
        ...
        /* '<S1>:617:3' ControlFlags.startElectricalID=boolean(1); */
				rtControlState_Y->ControlFlags_p.startElectricalID = true;
        ...
        /* '<S1>:682:2' && GlobalConfig_in.ACCEPT==1; */
			} else if ((rtControlState_Y->ControlFlags_p.transNr == 4) && (!rtControlState_DW->finishedFluxMapID_loc) && rtControlState_U->GlobalConfig_in.ACCEPT) {
        /* Transition: '<S1>:682' */
        /* Exit 'decideMotorID': '<S1>:605' */
        ...
        /* '<S1>:684:3' ControlFlags.startFluxMapID=boolean(1); */
				rtControlState_Y->ControlFlags_p.startFluxMapID = true;

        /* '<S1>:672:1' sf_internal_predicateOutput = ControlFlags.transNr==2 && finishedTwoMassID_loc==0.... */
        /* '<S1>:672:2' && GlobalConfig_in.ACCEPT==1; */
			} else if ((rtControlState_Y->ControlFlags_p.transNr == 2) && (!rtControlState_DW->finishedTwoMassID_loc) && rtControlState_U->GlobalConfig_in.ACCEPT) {
        /* Transition: '<S1>:672' */
        /* Exit 'decideMotorID': '<S1>:605' */
        ...
        /* '<S1>:628:3' ControlFlags.startTwoMassID=boolean(1); */
				rtControlState_Y->ControlFlags_p.startTwoMassID = true;

        /* '<S1>:678:1' sf_internal_predicateOutput = ControlFlags.transNr==3 && finishedFrictionID_loc==0.... */
        /* '<S1>:678:2' && GlobalConfig_in.ACCEPT==1; */
			} else if ((rtControlState_Y->ControlFlags_p.transNr == 3) && (!rtControlState_DW->finishedFrictionID_loc) && rtControlState_U->GlobalConfig_in.ACCEPT) {
        /* Transition: '<S1>:678' */
        /* Exit 'decideMotorID': '<S1>:605' */
        ...
        /* '<S1>:655:3' ControlFlags.startFrictionID=boolean(1); */
				rtControlState_Y->ControlFlags_p.startFrictionID = true;

        /* '<S1>:692:1' sf_internal_predicateOutput = ControlFlags.transNr==6.... */
        /* '<S1>:692:2' && GlobalConfig_in.ACCEPT==1; */
			} else if ((rtControlState_Y->ControlFlags_p.transNr == 6) && rtControlState_U->GlobalConfig_in.ACCEPT) {
        /* Transition: '<S1>:692' */
        /* Exit 'decideMotorID': '<S1>:605' */
        ...
        /* '<S1>:668:3' ControlFlags.enableFOCspeedState=boolean(1); */
				rtControlState_Y->ControlFlags_p.enableFOCspeedState = true;

        /* '<S1>:695:1' sf_internal_predicateOutput = ControlFlags.transNr==5.... */
        /* '<S1>:695:2' && GlobalConfig_in.ACCEPT==1; */
			} else if ((rtControlState_Y->ControlFlags_p.transNr == 5) && rtControlState_U->GlobalConfig_in.ACCEPT) {
        /* Transition: '<S1>:695' */
        /* Exit 'decideMotorID': '<S1>:605' */
        ...
        /* '<S1>:666:3' ControlFlags.enableFOCcurrentState=boolean(1); */
				rtControlState_Y->ControlFlags_p.enableFOCcurrentState = true;
      }
      break;
     ...
     case IN_duringElectricalID:
      ...
      /* '<S1>:627:1' sf_internal_predicateOutput = finishedElectricalID==1; */
        ...
        /* '<S1>:626:4' GlobalConfig_out.Kp_id=ElectricalID_FOC_output.Kp_id_out; */
				rtControlState_Y->GlobalConfig_out.Kp_id = rtControlState_U->ElectricalID_FOC_output.Kp_id_out;

        /* '<S1>:626:5' GlobalConfig_out.Kp_iq=ElectricalID_FOC_output.Kp_iq_out; */
				rtControlState_Y->GlobalConfig_out.Kp_iq = rtControlState_U->ElectricalID_FOC_output.Kp_iq_out;

        /* '<S1>:626:6' GlobalConfig_out.Kp_n=ElectricalID_FOC_output.Kp_n_out; */
				rtControlState_Y->GlobalConfig_out.Kp_n = rtControlState_U->ElectricalID_FOC_output.Kp_n_out;

        /* '<S1>:626:7' GlobalConfig_out.Ki_id=ElectricalID_FOC_output.Ki_id_out; */
				rtControlState_Y->GlobalConfig_out.Ki_id = rtControlState_U->ElectricalID_FOC_output.Ki_id_out;

        /* '<S1>:626:8' GlobalConfig_out.Ki_iq=ElectricalID_FOC_output.Ki_iq_out; */
				rtControlState_Y->GlobalConfig_out.Ki_iq = rtControlState_U->ElectricalID_FOC_output.Ki_iq_out;

        /* '<S1>:626:9' GlobalConfig_out.Ki_n=ElectricalID_FOC_output.Ki_n_out; */
				rtControlState_Y->GlobalConfig_out.Ki_n = rtControlState_U->ElectricalID_FOC_output.Ki_n_out;

        /* '<S1>:626:10' GlobalConfig_out.thetaOffset=ElectricalID_output.thetaOffset; */
				rtControlState_Y->GlobalConfig_out.thetaOffset = rtControlState_U->ElectricalID_output_n.thetaOffset;
        ...
        /* '<S1>:624:7' GlobalConfig_out.L_d=ElectricalID_output.L_d; */
				rtControlState_Y->GlobalConfig_out.L_d = rtControlState_U->ElectricalID_output_n.L_d;

        /* '<S1>:624:8' GlobalConfig_out.L_q=ElectricalID_output.L_q; */
				rtControlState_Y->GlobalConfig_out.L_q = rtControlState_U->ElectricalID_output_n.L_q;

        /* '<S1>:624:9' GlobalConfig_out.R_ph=ElectricalID_output.R_s; */
				rtControlState_Y->GlobalConfig_out.R_ph = rtControlState_U->ElectricalID_output_n.R_s;

        /* '<S1>:624:10' GlobalConfig_out.psi_pm=ElectricalID_output.psiPM; */
				rtControlState_Y->GlobalConfig_out.psi_pm = rtControlState_U->ElectricalID_output_n.psiPM;
      }
      break;
...
void ControlState_initialize(RT_MODEL_ControlState_t * const rtControlState_M)
{
  ...
  /* states (dwork) */
	(void) memset((void *) rtControlState_DW, 0, sizeof(DW_ControlState_t));

  /* external inputs */
	(void) memset(rtControlState_U, 0, sizeof(ExtU_ControlState_t));

  /* external outputs */
	(void) memset((void *) rtControlState_Y, 0, sizeof(ExtY_ControlState_t));
