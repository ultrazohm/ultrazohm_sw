...
add_files -norecurse {../hdl/uz_EnDat_src_Detect_Decrease.vhd}
...
set_property version {7.3} [ipx::current_core]
...
set_property core_revision 2113348672 [ipx::current_core]
...
ipx::add_file {hdl/uz_EnDat_src_Detect_Decrease.vhd} [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/uz_EnDat_src_Detect_Decrease.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]]
ipx::add_file {hdl/uz_EnDat_src_Detect_Decrease.vhd} [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/uz_EnDat_src_Detect_Decrease.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]]
...
# Package IP
ipx::archive_core {../uz_EnDat_v7_3.zip} [ipx::current_core]
close_project
exit
