-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\inc_enc_v26\IncEnc_addr_decoder.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IncEnc_addr_decoder
-- Source Path: IncEnc/IncEnc_axi_lite/IncEnc_addr_decoder
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END IncEnc_addr_decoder;


ARCHITECTURE rtl OF IncEnc_addr_decoder IS
  ...
  SIGNAL read_position_AXI_wOffset_unsigned : unsigned(15 DOWNTO 0);  -- ufix16
  SIGNAL decode_sel_Index_found_AXI4_1_1  : std_logic;  -- ufix1
  SIGNAL decode_sel_position_AXI_wOffset_1_1 : std_logic;  -- ufix1
  ...
  SIGNAL read_reg_position_AXI_wOffset    : unsigned(15 DOWNTO 0);  -- ufix16
  SIGNAL data_slice_position_AXI_wOffset_1 : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_position_AXI_wOffset_1_1 : unsigned(31 DOWNTO 0);  -- ufix32
...
BEGIN
  ...
  read_position_AXI_wOffset_unsigned <= unsigned(read_position_AXI_wOffset);

  
  decode_sel_Index_found_AXI4_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#004F#, 14) ELSE
      '0';

  
  decode_sel_position_AXI_wOffset_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#004E#, 14) ELSE
      '0';

  
  decode_sel_omega_MA_N4_AXI_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#004D#, 14) ELSE
      '0';

  
  decode_sel_countPerPeriod_AXI4_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#004B#, 14) ELSE
      '0';
  ...
  decode_sel_direction_AXI4_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0047#, 14) ELSE
      '0';

  
  decode_sel_omega_AXI4_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0046#, 14) ELSE
      '0';
  ...
  decode_rd_omega_AXI4_1_1 <= decode_rd_ip_timestamp_1_1 WHEN decode_sel_omega_AXI4_1_1 = '0' ELSE
  ...
  decode_rd_direction_AXI4_1_1 <= decode_rd_omega_AXI4_1_1 WHEN decode_sel_direction_AXI4_1_1 = '0' ELSE
  ...
  decode_rd_theta_el_AXI4_1_1 <= decode_rd_direction_AXI4_1_1 WHEN decode_sel_theta_el_AXI4_1_1 = '0' ELSE
  ...
  decode_rd_countPerPeriod_AXI4_1_1 <= decode_rd_position_AXI4_1_1 WHEN decode_sel_countPerPeriod_AXI4_1_1 = '0' ELSE
  ...
  reg_position_AXI_wOffset_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        read_reg_position_AXI_wOffset <= to_unsigned(16#0000#, 16);
      ELSIF enb = '1' THEN
        read_reg_position_AXI_wOffset <= read_position_AXI_wOffset_unsigned;
      END IF;
    END IF;
  END PROCESS reg_position_AXI_wOffset_process;


  data_slice_position_AXI_wOffset_1 <= resize(read_reg_position_AXI_wOffset, 32);

  
  decode_rd_position_AXI_wOffset_1_1 <= decode_rd_omega_MA_N4_AXI_1_1 WHEN decode_sel_position_AXI_wOffset_1_1 = '0' ELSE
      data_slice_position_AXI_wOffset_1;
  ...
  decode_rd_Index_found_AXI4_1_1 <= decode_rd_position_AXI_wOffset_1_1 WHEN decode_sel_Index_found_AXI4_1_1 = '0' ELSE
