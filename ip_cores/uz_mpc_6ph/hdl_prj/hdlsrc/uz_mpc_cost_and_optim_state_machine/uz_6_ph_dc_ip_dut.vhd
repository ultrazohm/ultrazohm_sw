-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_mpc_cost_and_optim_state_machine\uz_6_ph_dc_ip_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_6_ph_dc_ip_dut
-- Source Path: uz_6_ph_dc_ip/uz_6_ph_dc_ip_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END uz_6_ph_dc_ip_dut;


ARCHITECTURE rtl OF uz_6_ph_dc_ip_dut IS

  -- Component Declarations
  COMPONENT uz_6_ph_dc_ip_src_uz_6_ph_mpc_delay_comp
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : uz_6_ph_dc_ip_src_uz_6_ph_mpc_delay_comp
    USE ENTITY work.uz_6_ph_dc_ip_src_uz_6_ph_mpc_delay_comp(rtl);
...
BEGIN
  u_uz_6_ph_dc_ip_src_uz_6_ph_mpc_delay_comp : uz_6_ph_dc_ip_src_uz_6_ph_mpc_delay_comp
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
