...
int main(void)
{
    ...
    while (1)
    {
        ...
        case init_software:
            ...
            Global_Data.objects.approximate_flux_instance = uz_init_approximate_flux();
            Global_Data.objects.CC_instance = uz_init_CC();
        ...
        case init_ip_cores:
            ...
            Global_Data.objects.pmsm_model = uz_init_pmsm_model();
