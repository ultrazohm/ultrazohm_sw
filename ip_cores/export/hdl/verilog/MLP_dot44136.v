...
wire    grp_dot44_fu_48_p_x_read;
wire    grp_dot44_fu_48_p_y_read;
wire   [31:0] grp_dot44_fu_48_p_res_din;
wire    grp_dot44_fu_48_p_res_write;
wire    grp_dot44_fu_48_ap_start;
wire    grp_dot44_fu_48_ap_done;
wire    grp_dot44_fu_48_ap_ready;
wire    grp_dot44_fu_48_ap_idle;
reg    grp_dot44_fu_48_ap_continue;
...
reg    grp_dot44_fu_48_ap_start_reg;
reg    ap_block_state1_ignore_call13;
wire    ap_CS_fsm_state2;
wire    ap_sync_grp_dot44_fu_48_ap_ready;
wire    ap_sync_grp_dot44_fu_48_ap_done;
reg    ap_block_state2_on_subcall_done;
reg    ap_sync_reg_grp_dot44_fu_48_ap_ready;
reg    ap_sync_reg_grp_dot44_fu_48_ap_done;
...
#0 ap_done_reg = 1'b0;
#0 ap_CS_fsm = 2'd1;
#0 grp_dot44_fu_48_ap_start_reg = 1'b0;
#0 ap_sync_reg_grp_dot44_fu_48_ap_ready = 1'b0;
#0 ap_sync_reg_grp_dot44_fu_48_ap_done = 1'b0;
end

MLP_dot44 grp_dot44_fu_48(
    .p_x_dout(p_M_r_dout),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_sync_reg_grp_dot44_fu_48_ap_done <= 1'b0;
    end else begin
        if (((1'b1 == ap_CS_fsm_state2) & (1'b0 == ap_block_state2_on_subcall_done))) begin
            ap_sync_reg_grp_dot44_fu_48_ap_done <= 1'b0;
        end else if ((grp_dot44_fu_48_ap_done == 1'b1)) begin
            ap_sync_reg_grp_dot44_fu_48_ap_done <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_sync_reg_grp_dot44_fu_48_ap_ready <= 1'b0;
    end else begin
        if (((1'b1 == ap_CS_fsm_state2) & (1'b0 == ap_block_state2_on_subcall_done))) begin
            ap_sync_reg_grp_dot44_fu_48_ap_ready <= 1'b0;
        end else if ((grp_dot44_fu_48_ap_ready == 1'b1)) begin
            ap_sync_reg_grp_dot44_fu_48_ap_ready <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_dot44_fu_48_ap_start_reg <= 1'b0;
    end else begin
        if (((~((ap_start == 1'b0) | (call_ln59_p_prop_scalar_p_m_proc_fu_62_p_m_out_blk_n == 1'b0) | (p_n_empty_n == 1'b0) | (p_m_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1)) | ((1'b1 == ap_CS_fsm_state2) & (ap_sync_grp_dot44_fu_48_ap_ready == 1'b0)))) begin
            grp_dot44_fu_48_ap_start_reg <= 1'b1;
        end else if ((grp_dot44_fu_48_ap_ready == 1'b1)) begin
            grp_dot44_fu_48_ap_start_reg <= 1'b0;
        end
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (1'b0 == ap_block_state2_on_subcall_done))) begin
        grp_dot44_fu_48_ap_continue = 1'b1;
    end else begin
        grp_dot44_fu_48_ap_continue = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_state2_on_subcall_done = ((ap_sync_grp_dot44_fu_48_ap_ready & ap_sync_grp_dot44_fu_48_ap_done) == 1'b0);
end

assign ap_sync_grp_dot44_fu_48_ap_done = (grp_dot44_fu_48_ap_done | ap_sync_reg_grp_dot44_fu_48_ap_done);

assign ap_sync_grp_dot44_fu_48_ap_ready = (grp_dot44_fu_48_ap_ready | ap_sync_reg_grp_dot44_fu_48_ap_ready);

assign grp_dot44_fu_48_ap_start = grp_dot44_fu_48_ap_start_reg;

assign p_m_out_din = call_ln59_p_prop_scalar_p_m_proc_fu_62_p_m_out_din;

assign p_y_din = grp_dot44_fu_48_p_res_din;

endmodule //MLP_dot44136
