-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_mpc_6ph_parallel\conv_theta_addr_decoder.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: conv_theta_addr_decoder
-- Source Path: conv_theta/conv_theta_axi_lite/conv_theta_addr_decoder
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY conv_theta_addr_decoder IS
...
END conv_theta_addr_decoder;


ARCHITECTURE rtl OF conv_theta_addr_decoder IS
  ...
  SIGNAL read_theta_el_out_AXI_signed     : signed(26 DOWNTO 0);  -- sfix27_En20
  SIGNAL decode_sel_theta_el_out_AXI_1_1  : std_logic;  -- ufix1
  SIGNAL const_0                          : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL read_reg_ip_timestamp            : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_ip_timestamp_1_1       : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL read_reg_theta_el_out_AXI        : signed(26 DOWNTO 0);  -- sfix27_En20
  SIGNAL data_slice_theta_el_out_AXI_1    : unsigned(31 DOWNTO 0);  -- ufix32
...
BEGIN
  ...
  read_theta_el_out_AXI_signed <= signed(read_theta_el_out_AXI);

  
  decode_sel_theta_el_out_AXI_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#007F#, 14) ELSE
      '0';
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        read_reg_theta_el_out_AXI <= to_signed(16#0000000#, 27);
      ELSIF enb = '1' THEN
        read_reg_theta_el_out_AXI <= read_theta_el_out_AXI_signed;
      END IF;
    END IF;
  END PROCESS reg_theta_el_out_AXI_process;


  data_slice_theta_el_out_AXI_1 <= unsigned(resize(read_reg_theta_el_out_AXI, 32));

  
  decode_rd_theta_el_out_AXI_1_1 <= decode_rd_ip_timestamp_1_1 WHEN decode_sel_theta_el_out_AXI_1_1 = '0' ELSE
      data_slice_theta_el_out_AXI_1;

  data_read <= std_logic_vector(decode_rd_theta_el_out_AXI_1_1);
