...
int JavaScope_initalize(DS_Data* data)
{
	...
	js_ch_observable[JSO_Theta_el] 		= &data->av.theta_elec_LR;
	...
	js_ch_observable[JSO_i_imag] 		= &data->av.I_q;
	js_ch_observable[JSO_i_real] 		= &data->av.I_d;
	js_ch_observable[JSO_au] 			= &data->av.a_u;
