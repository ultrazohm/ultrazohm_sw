-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\external_state_machine\prediction.vhd
...
ARCHITECTURE rtl OF prediction IS
  ...
  COMPONENT prediction_reset_sync
  ...
  FOR ALL : prediction_reset_sync
    USE ENTITY work.prediction_reset_sync(rtl);

  FOR ALL : prediction_axi_lite
    USE ENTITY work.prediction_axi_lite(rtl);

  FOR ALL : prediction_dut
    USE ENTITY work.prediction_dut(rtl);
  ...
  SIGNAL id_delay_pu_sig                  : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL iq_delay_pu_unsigned             : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL iq_delay_pu_sig                  : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL ix_delay_pu_unsigned             : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL ix_delay_pu_sig                  : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL iy_delay_pu_unsigned             : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL iy_delay_pu_sig                  : signed(26 DOWNTO 0);  -- sfix27_En24
...
BEGIN
  u_prediction_reset_sync_inst : prediction_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_prediction_axi_lite_inst : prediction_axi_lite
  ...
  u_prediction_dut_inst : prediction_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              dut_enable => write_axi_enable,  -- ufix1
              id_delay_pu => std_logic_vector(id_delay_pu_sig),  -- sfix27_En24
              iq_delay_pu => std_logic_vector(iq_delay_pu_sig),  -- sfix27_En24
              ix_delay_pu => std_logic_vector(ix_delay_pu_sig),  -- sfix27_En24
              iy_delay_pu => std_logic_vector(iy_delay_pu_sig),  -- sfix27_En24
              ...
              trigger_prediction => trigger_prediction,  -- ufix1
  ...
  ip_timestamp <= unsigned'(X"89751211");
