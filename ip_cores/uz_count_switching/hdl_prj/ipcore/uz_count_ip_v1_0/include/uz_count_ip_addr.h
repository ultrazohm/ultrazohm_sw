...
#define  IPCore_Timestamp_uz_count_ip         0x8  //contains unique IP timestamp (yymmddHHMM): 2604021653
...
#define  count_out_sum_AXI_Data_uz_count_ip   0x124  //data register for Outport count_out_sum_AXI
