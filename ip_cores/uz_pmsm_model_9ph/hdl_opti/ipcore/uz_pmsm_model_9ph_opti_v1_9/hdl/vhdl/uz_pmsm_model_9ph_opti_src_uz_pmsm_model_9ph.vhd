...
ARCHITECTURE rtl OF uz_pmsm_model_9ph_opti_src_uz_pmsm_model_9ph IS
  ...
  SIGNAL delayMatch18_reg                 : vector_of_std_logic_vector64(0 TO 5);  -- ufix64 [6]
  SIGNAL delayMatch18_reg_next            : vector_of_std_logic_vector64(0 TO 5);  -- ufix64 [6]
  ...
  SIGNAL delayMatch22_reg                 : vector_of_std_logic_vector32(0 TO 35);  -- ufix32 [36]
  SIGNAL delayMatch22_reg_next            : vector_of_std_logic_vector32(0 TO 35);  -- ufix32 [36]
  ...
  SIGNAL delayMatch20_reg                 : vector_of_std_logic_vector32(0 TO 14);  -- ufix32 [15]
  SIGNAL delayMatch20_reg_next            : vector_of_std_logic_vector32(0 TO 14);  -- ufix32 [15]
  ...
  SIGNAL plus                             : std_logic_vector(63 DOWNTO 0);  -- ufix64
  ...
  SIGNAL minus                            : std_logic_vector(63 DOWNTO 0);  -- ufix64
  ...
  SIGNAL delayMatch19_reg                 : vector_of_std_logic_vector32(0 TO 8);  -- ufix32 [9]
  SIGNAL delayMatch19_reg_next            : vector_of_std_logic_vector32(0 TO 8);  -- ufix32 [9]
  ...
  SIGNAL delayMatch30_reg                 : vector_of_std_logic_vector32(0 TO 44);  -- ufix32 [45]
  SIGNAL delayMatch30_reg_next            : vector_of_std_logic_vector32(0 TO 44);  -- ufix32 [45]
  SIGNAL torque                           : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL delayMatch31_reg                 : vector_of_std_logic_vector32(0 TO 83);  -- ufix32 [84]
  SIGNAL delayMatch31_reg_next            : vector_of_std_logic_vector32(0 TO 83);  -- ufix32 [84]
  SIGNAL omega_mech_1                     : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL delayMatch25_reg                 : vector_of_std_logic_vector32(0 TO 61);  -- ufix32 [62]
  SIGNAL delayMatch25_reg_next            : vector_of_std_logic_vector32(0 TO 61);  -- ufix32 [62]
  SIGNAL From10_out1_1                    : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL delayMatch26_reg                 : vector_of_std_logic_vector32(0 TO 64);  -- ufix32 [65]
  SIGNAL delayMatch26_reg_next            : vector_of_std_logic_vector32(0 TO 64);  -- ufix32 [65]
  SIGNAL From5_out1                       : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL delayMatch32_reg                 : std_logic_vector(0 TO 86);  -- ufix1 [87]
  SIGNAL delayMatch32_reg_next            : std_logic_vector(0 TO 86);  -- ufix1 [87]
  ...
  SIGNAL delayMatch33_reg                 : vector_of_std_logic_vector32(0 TO 86);  -- ufix32 [87]
  SIGNAL delayMatch33_reg_next            : vector_of_std_logic_vector32(0 TO 86);  -- ufix32 [87]
  ...
  SIGNAL delayMatch34_reg                 : vector_of_std_logic_vector32(0 TO 86);  -- ufix32 [87]
  SIGNAL delayMatch34_reg_next            : vector_of_std_logic_vector32(0 TO 86);  -- ufix32 [87]
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        ...
        delayMatch18_reg(3) <= X"0000000000000000";
        delayMatch18_reg(4) <= X"0000000000000000";
        delayMatch18_reg(5) <= X"0000000000000000";
      ELSIF enb = '1' THEN
  ...
  From10_out1 <= delayMatch18_reg(5);
  delayMatch18_reg_next(0) <= Data_Type_Conversion11_out1;
  ...
  psi_q <= delayMatch16_reg(2);
  delayMatch16_reg_next(0) <= Delay1_out1_2;
  ...
  M_Mi_3 <= M_Mi_2 WHEN enb_1_100_1 = '1' ELSE
      Delay8_bypass_reg;
  ...
  psi_d <= delayMatch17_reg(2);
  delayMatch17_reg_next(0) <= Delay1_out1_3;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        ...
        delayMatch30_reg(30) <= X"00000000";
        delayMatch30_reg(31) <= X"00000000";
        delayMatch30_reg(32) <= X"00000000";
        delayMatch30_reg(33) <= X"00000000";
        delayMatch30_reg(34) <= X"00000000";
        delayMatch30_reg(35) <= X"00000000";
        delayMatch30_reg(36) <= X"00000000";
        delayMatch30_reg(37) <= X"00000000";
        delayMatch30_reg(38) <= X"00000000";
        delayMatch30_reg(39) <= X"00000000";
        delayMatch30_reg(40) <= X"00000000";
        delayMatch30_reg(41) <= X"00000000";
        delayMatch30_reg(42) <= X"00000000";
        delayMatch30_reg(43) <= X"00000000";
        delayMatch30_reg(44) <= X"00000000";
      ELSIF enb = '1' THEN
        ...
        delayMatch30_reg(30) <= delayMatch30_reg_next(30);
        delayMatch30_reg(31) <= delayMatch30_reg_next(31);
        delayMatch30_reg(32) <= delayMatch30_reg_next(32);
        delayMatch30_reg(33) <= delayMatch30_reg_next(33);
        delayMatch30_reg(34) <= delayMatch30_reg_next(34);
        delayMatch30_reg(35) <= delayMatch30_reg_next(35);
        delayMatch30_reg(36) <= delayMatch30_reg_next(36);
        delayMatch30_reg(37) <= delayMatch30_reg_next(37);
        delayMatch30_reg(38) <= delayMatch30_reg_next(38);
        delayMatch30_reg(39) <= delayMatch30_reg_next(39);
        delayMatch30_reg(40) <= delayMatch30_reg_next(40);
        delayMatch30_reg(41) <= delayMatch30_reg_next(41);
        delayMatch30_reg(42) <= delayMatch30_reg_next(42);
        delayMatch30_reg(43) <= delayMatch30_reg_next(43);
        delayMatch30_reg(44) <= delayMatch30_reg_next(44);
      END IF;
    END IF;
  END PROCESS delayMatch30_process;

  torque <= delayMatch30_reg(44);
  ...
  delayMatch30_reg_next(30) <= delayMatch30_reg(29);
  delayMatch30_reg_next(31) <= delayMatch30_reg(30);
  delayMatch30_reg_next(32) <= delayMatch30_reg(31);
  delayMatch30_reg_next(33) <= delayMatch30_reg(32);
  delayMatch30_reg_next(34) <= delayMatch30_reg(33);
  delayMatch30_reg_next(35) <= delayMatch30_reg(34);
  delayMatch30_reg_next(36) <= delayMatch30_reg(35);
  delayMatch30_reg_next(37) <= delayMatch30_reg(36);
  delayMatch30_reg_next(38) <= delayMatch30_reg(37);
  delayMatch30_reg_next(39) <= delayMatch30_reg(38);
  delayMatch30_reg_next(40) <= delayMatch30_reg(39);
  delayMatch30_reg_next(41) <= delayMatch30_reg(40);
  delayMatch30_reg_next(42) <= delayMatch30_reg(41);
  delayMatch30_reg_next(43) <= delayMatch30_reg(42);
  delayMatch30_reg_next(44) <= delayMatch30_reg(43);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        ...
        delayMatch31_reg(66) <= X"00000000";
        delayMatch31_reg(67) <= X"00000000";
        delayMatch31_reg(68) <= X"00000000";
        delayMatch31_reg(69) <= X"00000000";
        delayMatch31_reg(70) <= X"00000000";
        delayMatch31_reg(71) <= X"00000000";
        delayMatch31_reg(72) <= X"00000000";
        delayMatch31_reg(73) <= X"00000000";
        delayMatch31_reg(74) <= X"00000000";
        delayMatch31_reg(75) <= X"00000000";
        delayMatch31_reg(76) <= X"00000000";
        delayMatch31_reg(77) <= X"00000000";
        delayMatch31_reg(78) <= X"00000000";
        delayMatch31_reg(79) <= X"00000000";
        delayMatch31_reg(80) <= X"00000000";
        delayMatch31_reg(81) <= X"00000000";
        delayMatch31_reg(82) <= X"00000000";
        delayMatch31_reg(83) <= X"00000000";
      ELSIF enb = '1' THEN
        ...
        delayMatch31_reg(66) <= delayMatch31_reg_next(66);
        delayMatch31_reg(67) <= delayMatch31_reg_next(67);
        delayMatch31_reg(68) <= delayMatch31_reg_next(68);
        delayMatch31_reg(69) <= delayMatch31_reg_next(69);
        delayMatch31_reg(70) <= delayMatch31_reg_next(70);
        delayMatch31_reg(71) <= delayMatch31_reg_next(71);
        delayMatch31_reg(72) <= delayMatch31_reg_next(72);
        delayMatch31_reg(73) <= delayMatch31_reg_next(73);
        delayMatch31_reg(74) <= delayMatch31_reg_next(74);
        delayMatch31_reg(75) <= delayMatch31_reg_next(75);
        delayMatch31_reg(76) <= delayMatch31_reg_next(76);
        delayMatch31_reg(77) <= delayMatch31_reg_next(77);
        delayMatch31_reg(78) <= delayMatch31_reg_next(78);
        delayMatch31_reg(79) <= delayMatch31_reg_next(79);
        delayMatch31_reg(80) <= delayMatch31_reg_next(80);
        delayMatch31_reg(81) <= delayMatch31_reg_next(81);
        delayMatch31_reg(82) <= delayMatch31_reg_next(82);
        delayMatch31_reg(83) <= delayMatch31_reg_next(83);
      END IF;
    END IF;
  END PROCESS delayMatch31_process;

  omega_mech_1 <= delayMatch31_reg(83);
  ...
  delayMatch31_reg_next(66) <= delayMatch31_reg(65);
  delayMatch31_reg_next(67) <= delayMatch31_reg(66);
  delayMatch31_reg_next(68) <= delayMatch31_reg(67);
  delayMatch31_reg_next(69) <= delayMatch31_reg(68);
  delayMatch31_reg_next(70) <= delayMatch31_reg(69);
  delayMatch31_reg_next(71) <= delayMatch31_reg(70);
  delayMatch31_reg_next(72) <= delayMatch31_reg(71);
  delayMatch31_reg_next(73) <= delayMatch31_reg(72);
  delayMatch31_reg_next(74) <= delayMatch31_reg(73);
  delayMatch31_reg_next(75) <= delayMatch31_reg(74);
  delayMatch31_reg_next(76) <= delayMatch31_reg(75);
  delayMatch31_reg_next(77) <= delayMatch31_reg(76);
  delayMatch31_reg_next(78) <= delayMatch31_reg(77);
  delayMatch31_reg_next(79) <= delayMatch31_reg(78);
  delayMatch31_reg_next(80) <= delayMatch31_reg(79);
  delayMatch31_reg_next(81) <= delayMatch31_reg(80);
  delayMatch31_reg_next(82) <= delayMatch31_reg(81);
  delayMatch31_reg_next(83) <= delayMatch31_reg(82);
  ...
  From10_out1_1 <= delayMatch25_reg(61);
  ...
  From5_out1 <= delayMatch26_reg(64);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        ...
        delayMatch32_reg(69) <= '0';
        delayMatch32_reg(70) <= '0';
        delayMatch32_reg(71) <= '0';
        delayMatch32_reg(72) <= '0';
        delayMatch32_reg(73) <= '0';
        delayMatch32_reg(74) <= '0';
        delayMatch32_reg(75) <= '0';
        delayMatch32_reg(76) <= '0';
        delayMatch32_reg(77) <= '0';
        delayMatch32_reg(78) <= '0';
        delayMatch32_reg(79) <= '0';
        delayMatch32_reg(80) <= '0';
        delayMatch32_reg(81) <= '0';
        delayMatch32_reg(82) <= '0';
        delayMatch32_reg(83) <= '0';
        delayMatch32_reg(84) <= '0';
        delayMatch32_reg(85) <= '0';
        delayMatch32_reg(86) <= '0';
      ELSIF enb = '1' THEN
        ...
        delayMatch32_reg(69) <= delayMatch32_reg_next(69);
        delayMatch32_reg(70) <= delayMatch32_reg_next(70);
        delayMatch32_reg(71) <= delayMatch32_reg_next(71);
        delayMatch32_reg(72) <= delayMatch32_reg_next(72);
        delayMatch32_reg(73) <= delayMatch32_reg_next(73);
        delayMatch32_reg(74) <= delayMatch32_reg_next(74);
        delayMatch32_reg(75) <= delayMatch32_reg_next(75);
        delayMatch32_reg(76) <= delayMatch32_reg_next(76);
        delayMatch32_reg(77) <= delayMatch32_reg_next(77);
        delayMatch32_reg(78) <= delayMatch32_reg_next(78);
        delayMatch32_reg(79) <= delayMatch32_reg_next(79);
        delayMatch32_reg(80) <= delayMatch32_reg_next(80);
        delayMatch32_reg(81) <= delayMatch32_reg_next(81);
        delayMatch32_reg(82) <= delayMatch32_reg_next(82);
        delayMatch32_reg(83) <= delayMatch32_reg_next(83);
        delayMatch32_reg(84) <= delayMatch32_reg_next(84);
        delayMatch32_reg(85) <= delayMatch32_reg_next(85);
        delayMatch32_reg(86) <= delayMatch32_reg_next(86);
      END IF;
    END IF;
  END PROCESS delayMatch32_process;

  reset_integrators_2 <= delayMatch32_reg(86);
  ...
  delayMatch32_reg_next(69) <= delayMatch32_reg(68);
  delayMatch32_reg_next(70) <= delayMatch32_reg(69);
  delayMatch32_reg_next(71) <= delayMatch32_reg(70);
  delayMatch32_reg_next(72) <= delayMatch32_reg(71);
  delayMatch32_reg_next(73) <= delayMatch32_reg(72);
  delayMatch32_reg_next(74) <= delayMatch32_reg(73);
  delayMatch32_reg_next(75) <= delayMatch32_reg(74);
  delayMatch32_reg_next(76) <= delayMatch32_reg(75);
  delayMatch32_reg_next(77) <= delayMatch32_reg(76);
  delayMatch32_reg_next(78) <= delayMatch32_reg(77);
  delayMatch32_reg_next(79) <= delayMatch32_reg(78);
  delayMatch32_reg_next(80) <= delayMatch32_reg(79);
  delayMatch32_reg_next(81) <= delayMatch32_reg(80);
  delayMatch32_reg_next(82) <= delayMatch32_reg(81);
  delayMatch32_reg_next(83) <= delayMatch32_reg(82);
  delayMatch32_reg_next(84) <= delayMatch32_reg(83);
  delayMatch32_reg_next(85) <= delayMatch32_reg(84);
  delayMatch32_reg_next(86) <= delayMatch32_reg(85);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        ...
        delayMatch33_reg(69) <= X"00000000";
        delayMatch33_reg(70) <= X"00000000";
        delayMatch33_reg(71) <= X"00000000";
        delayMatch33_reg(72) <= X"00000000";
        delayMatch33_reg(73) <= X"00000000";
        delayMatch33_reg(74) <= X"00000000";
        delayMatch33_reg(75) <= X"00000000";
        delayMatch33_reg(76) <= X"00000000";
        delayMatch33_reg(77) <= X"00000000";
        delayMatch33_reg(78) <= X"00000000";
        delayMatch33_reg(79) <= X"00000000";
        delayMatch33_reg(80) <= X"00000000";
        delayMatch33_reg(81) <= X"00000000";
        delayMatch33_reg(82) <= X"00000000";
        delayMatch33_reg(83) <= X"00000000";
        delayMatch33_reg(84) <= X"00000000";
        delayMatch33_reg(85) <= X"00000000";
        delayMatch33_reg(86) <= X"00000000";
      ELSIF enb = '1' THEN
        ...
        delayMatch33_reg(69) <= delayMatch33_reg_next(69);
        delayMatch33_reg(70) <= delayMatch33_reg_next(70);
        delayMatch33_reg(71) <= delayMatch33_reg_next(71);
        delayMatch33_reg(72) <= delayMatch33_reg_next(72);
        delayMatch33_reg(73) <= delayMatch33_reg_next(73);
        delayMatch33_reg(74) <= delayMatch33_reg_next(74);
        delayMatch33_reg(75) <= delayMatch33_reg_next(75);
        delayMatch33_reg(76) <= delayMatch33_reg_next(76);
        delayMatch33_reg(77) <= delayMatch33_reg_next(77);
        delayMatch33_reg(78) <= delayMatch33_reg_next(78);
        delayMatch33_reg(79) <= delayMatch33_reg_next(79);
        delayMatch33_reg(80) <= delayMatch33_reg_next(80);
        delayMatch33_reg(81) <= delayMatch33_reg_next(81);
        delayMatch33_reg(82) <= delayMatch33_reg_next(82);
        delayMatch33_reg(83) <= delayMatch33_reg_next(83);
        delayMatch33_reg(84) <= delayMatch33_reg_next(84);
        delayMatch33_reg(85) <= delayMatch33_reg_next(85);
        delayMatch33_reg(86) <= delayMatch33_reg_next(86);
      END IF;
    END IF;
  END PROCESS delayMatch33_process;

  Data_Type_Conversion24_out1 <= delayMatch33_reg(86);
  ...
  delayMatch33_reg_next(69) <= delayMatch33_reg(68);
  delayMatch33_reg_next(70) <= delayMatch33_reg(69);
  delayMatch33_reg_next(71) <= delayMatch33_reg(70);
  delayMatch33_reg_next(72) <= delayMatch33_reg(71);
  delayMatch33_reg_next(73) <= delayMatch33_reg(72);
  delayMatch33_reg_next(74) <= delayMatch33_reg(73);
  delayMatch33_reg_next(75) <= delayMatch33_reg(74);
  delayMatch33_reg_next(76) <= delayMatch33_reg(75);
  delayMatch33_reg_next(77) <= delayMatch33_reg(76);
  delayMatch33_reg_next(78) <= delayMatch33_reg(77);
  delayMatch33_reg_next(79) <= delayMatch33_reg(78);
  delayMatch33_reg_next(80) <= delayMatch33_reg(79);
  delayMatch33_reg_next(81) <= delayMatch33_reg(80);
  delayMatch33_reg_next(82) <= delayMatch33_reg(81);
  delayMatch33_reg_next(83) <= delayMatch33_reg(82);
  delayMatch33_reg_next(84) <= delayMatch33_reg(83);
  delayMatch33_reg_next(85) <= delayMatch33_reg(84);
  delayMatch33_reg_next(86) <= delayMatch33_reg(85);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        ...
        delayMatch34_reg(69) <= X"00000000";
        delayMatch34_reg(70) <= X"00000000";
        delayMatch34_reg(71) <= X"00000000";
        delayMatch34_reg(72) <= X"00000000";
        delayMatch34_reg(73) <= X"00000000";
        delayMatch34_reg(74) <= X"00000000";
        delayMatch34_reg(75) <= X"00000000";
        delayMatch34_reg(76) <= X"00000000";
        delayMatch34_reg(77) <= X"00000000";
        delayMatch34_reg(78) <= X"00000000";
        delayMatch34_reg(79) <= X"00000000";
        delayMatch34_reg(80) <= X"00000000";
        delayMatch34_reg(81) <= X"00000000";
        delayMatch34_reg(82) <= X"00000000";
        delayMatch34_reg(83) <= X"00000000";
        delayMatch34_reg(84) <= X"00000000";
        delayMatch34_reg(85) <= X"00000000";
        delayMatch34_reg(86) <= X"00000000";
      ELSIF enb = '1' THEN
        ...
        delayMatch34_reg(69) <= delayMatch34_reg_next(69);
        delayMatch34_reg(70) <= delayMatch34_reg_next(70);
        delayMatch34_reg(71) <= delayMatch34_reg_next(71);
        delayMatch34_reg(72) <= delayMatch34_reg_next(72);
        delayMatch34_reg(73) <= delayMatch34_reg_next(73);
        delayMatch34_reg(74) <= delayMatch34_reg_next(74);
        delayMatch34_reg(75) <= delayMatch34_reg_next(75);
        delayMatch34_reg(76) <= delayMatch34_reg_next(76);
        delayMatch34_reg(77) <= delayMatch34_reg_next(77);
        delayMatch34_reg(78) <= delayMatch34_reg_next(78);
        delayMatch34_reg(79) <= delayMatch34_reg_next(79);
        delayMatch34_reg(80) <= delayMatch34_reg_next(80);
        delayMatch34_reg(81) <= delayMatch34_reg_next(81);
        delayMatch34_reg(82) <= delayMatch34_reg_next(82);
        delayMatch34_reg(83) <= delayMatch34_reg_next(83);
        delayMatch34_reg(84) <= delayMatch34_reg_next(84);
        delayMatch34_reg(85) <= delayMatch34_reg_next(85);
        delayMatch34_reg(86) <= delayMatch34_reg_next(86);
      END IF;
    END IF;
  END PROCESS delayMatch34_process;

  Data_Type_Conversion25_out1 <= delayMatch34_reg(86);
  ...
  delayMatch34_reg_next(69) <= delayMatch34_reg(68);
  delayMatch34_reg_next(70) <= delayMatch34_reg(69);
  delayMatch34_reg_next(71) <= delayMatch34_reg(70);
  delayMatch34_reg_next(72) <= delayMatch34_reg(71);
  delayMatch34_reg_next(73) <= delayMatch34_reg(72);
  delayMatch34_reg_next(74) <= delayMatch34_reg(73);
  delayMatch34_reg_next(75) <= delayMatch34_reg(74);
  delayMatch34_reg_next(76) <= delayMatch34_reg(75);
  delayMatch34_reg_next(77) <= delayMatch34_reg(76);
  delayMatch34_reg_next(78) <= delayMatch34_reg(77);
  delayMatch34_reg_next(79) <= delayMatch34_reg(78);
  delayMatch34_reg_next(80) <= delayMatch34_reg(79);
  delayMatch34_reg_next(81) <= delayMatch34_reg(80);
  delayMatch34_reg_next(82) <= delayMatch34_reg(81);
  delayMatch34_reg_next(83) <= delayMatch34_reg(82);
  delayMatch34_reg_next(84) <= delayMatch34_reg(83);
  delayMatch34_reg_next(85) <= delayMatch34_reg(84);
  delayMatch34_reg_next(86) <= delayMatch34_reg(85);
  ...
  Mux1_out1_1(0) <= Mux1_out1(0) WHEN enb_1_100_1 = '1' ELSE
      t_bypass_reg(0);
  
  Mux1_out1_1(1) <= Mux1_out1(1) WHEN enb_1_100_1 = '1' ELSE
      t_bypass_reg(1);
  
  Mux1_out1_1(2) <= Mux1_out1(2) WHEN enb_1_100_1 = '1' ELSE
      t_bypass_reg(2);
  
  Mux1_out1_1(3) <= Mux1_out1(3) WHEN enb_1_100_1 = '1' ELSE
      t_bypass_reg(3);
  
  Mux1_out1_1(4) <= Mux1_out1(4) WHEN enb_1_100_1 = '1' ELSE
      t_bypass_reg(4);
  ...
  Delay1_out1_5 <= Delay1_delOut_3 WHEN reset_integrators = '0' ELSE
      Delay1_iv_3;
  ...
  Delay1_toDel_14 <= Delay1_toDel_13 WHEN enb_1_100_1 = '1' ELSE
      Delay1_lowered4_bypass_reg;

  Delay1_delOut_4 <= Delay1_toDel_14;

  
  Delay1_out1_6 <= Delay1_delOut_4 WHEN reset_integrators = '0' ELSE
      Delay1_iv_4;
  ...
  Delay1_out1_7 <= Delay1_delOut_5 WHEN reset_integrators = '0' ELSE
      Delay1_iv_5;
  ...
  Delay1_toDel_20 <= Delay1_toDel_19 WHEN enb_1_100_1 = '1' ELSE
      Delay1_lowered6_bypass_reg;

  Delay1_delOut_6 <= Delay1_toDel_20;

  
  Delay1_out1_8 <= Delay1_delOut_6 WHEN reset_integrators = '0' ELSE
      Delay1_iv_6;
  ...
  Delay1_toDel_23 <= Delay1_toDel_22 WHEN enb_1_100_1 = '1' ELSE
      Delay1_lowered7_bypass_reg;

  Delay1_delOut_7 <= Delay1_toDel_23;

  
  Delay1_out1_9 <= Delay1_delOut_7 WHEN reset_integrators = '0' ELSE
      Delay1_iv_7;
  ...
  Delay1_toDel_26 <= Delay1_toDel_25 WHEN enb_1_100_1 = '1' ELSE
      Delay1_lowered8_bypass_reg;

  Delay1_delOut_8 <= Delay1_toDel_26;

  
  Delay1_out1_10 <= Delay1_delOut_8 WHEN reset_integrators = '0' ELSE
      Delay1_iv_8;

  psi_5 <= Delay1_out1_10;
  ...
  Delay1_toDel_29 <= Delay1_toDel_28 WHEN enb_1_100_1 = '1' ELSE
      Delay1_lowered9_bypass_reg;

  Delay1_delOut_9 <= Delay1_toDel_29;

  
  Delay1_out1_11 <= Delay1_delOut_9 WHEN reset_integrators = '0' ELSE
      Delay1_iv_9;

  psi_6 <= Delay1_out1_11;
  ...
  Mux_out1_3(5) <= Mux_out1_2(5) WHEN enb_1_100_1 = '1' ELSE
      t7_bypass_reg(5);
  
  Mux_out1_3(6) <= Mux_out1_2(6) WHEN enb_1_100_1 = '1' ELSE
      t7_bypass_reg(6);
  
  Mux_out1_3(7) <= Mux_out1_2(7) WHEN enb_1_100_1 = '1' ELSE
      t7_bypass_reg(7);
  
  Mux_out1_3(8) <= Mux_out1_2(8) WHEN enb_1_100_1 = '1' ELSE
      t7_bypass_reg(8);
  ...
  Data_Type_Conversion1_out1_5 <= delayMatch38_reg(1);
  delayMatch38_reg_next(0) <= Data_Type_Conversion1_out1_4;
