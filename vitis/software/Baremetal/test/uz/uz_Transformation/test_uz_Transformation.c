...
uz_3ph_alphabeta_t XY_multiphase_test = {0};
uz_3ph_dq_t dq_multiphase_test = {0};
uz_3ph_dq_t xy_multiphase_test = {0};
...
void test_uz_6ph_abc_to_dq_xy_transformation_output(void){
    ...
    alphabeta_multiphase_test.beta  = alphabeta.beta;
    alphabeta_multiphase_test.gamma = 0.0f;
    XY_multiphase_test.alpha = alphabeta.x;
    XY_multiphase_test.beta = alphabeta.y;
    ...
    TEST_ASSERT_FLOAT_WITHIN(1e-03, xy_calc.q, output.y);
    TEST_ASSERT_FLOAT_WITHIN(1e-03, 2.0000f, output.z1);
    TEST_ASSERT_FLOAT_WITHIN(1e-03, 5.0000f, output.z2);
}
...
void test_uz_6ph_dq_xy_to_abc_transformation_output(void){
    sixphase_dq.d = -1.0f;
    sixphase_dq.q = -2.0f;
    sixphase_dq.x = -3.0f;
    sixphase_dq.y = -4.0f;
    ...
    dq_multiphase_test.d = sixphase_dq.d;
    dq_multiphase_test.q  = sixphase_dq.q;
    xy_multiphase_test.d = sixphase_dq.x;
    xy_multiphase_test.q = sixphase_dq.y;
    dq_multiphase_test.zero = 0.0f;
    uz_3ph_alphabeta_t alphabeta_calc = uz_transformation_3ph_dq_to_alphabeta(dq_multiphase_test, theta_el);
    uz_3ph_alphabeta_t XY_calc = uz_transformation_3ph_dq_to_alphabeta(xy_multiphase_test, -theta_el);
    sixphase_alphabeta.alpha = alphabeta_calc.alpha;
    sixphase_alphabeta.beta = alphabeta_calc.beta;
    sixphase_alphabeta.x = XY_calc.alpha;
    sixphase_alphabeta.y = XY_calc.beta;
    sixphase_alphabeta.z1 = sixphase_dq.z1;
    sixphase_alphabeta.z2 = sixphase_dq.z2;
