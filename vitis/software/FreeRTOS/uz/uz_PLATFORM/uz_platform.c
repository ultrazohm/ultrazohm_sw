...
typedef struct uz_platform_ {
 ...
 static uz_platform_iomap uzp_iomap_UltraZohmRev04withExtensionBoardRev02 = {
	{
		...
		{UZP_GPIOTYPE_I2C,  0},			// I2CLED_1RDY
		{UZP_GPIOTYPE_I2C,  1},			// I2CLED_2RUN
		{UZP_GPIOTYPE_I2C,  2},			// I2CLED_3ERR
		{UZP_GPIOTYPE_I2C,  3},			// I2CLED_4USR
		{UZP_GPIOTYPE_I2C,  4},			// I2CLED_RING
 ...
 static uz_platform_iomap uzp_iomap_MicroZohmRev01onBreakoutBoardRev01 = {
	{
		// Cf. uz_platform_gpo_id in uz_platform.h:
		UZ_PLATFORM_GPIO_UNAVAILABLE,	// I2CLED_1RDY
		UZ_PLATFORM_GPIO_UNAVAILABLE,	// I2CLED_2RUN
		UZ_PLATFORM_GPIO_UNAVAILABLE,	// I2CLED_3ERR
		UZ_PLATFORM_GPIO_UNAVAILABLE,	// I2CLED_4USR
		UZ_PLATFORM_GPIO_UNAVAILABLE,	// I2CLED_RING
