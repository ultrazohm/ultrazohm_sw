-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\valen\Documents\repos\UZ\ultrazohm_sw_working\ip_cores\uz_sixphase_VSD_transformation\hdl_prj\hdlsrc\uz_sixphase_VSD_transformation\uz_sixphase_VSD_transformation_src_adder_MultiplyAdd_nw.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_sixphase_VSD_transformation_src_adder_MultiplyAdd_nw
-- Source Path: 
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
...
ENTITY uz_sixphase_VSD_transformation_src_adder_MultiplyAdd_nw IS
...
END uz_sixphase_VSD_transformation_src_adder_MultiplyAdd_nw;


ARCHITECTURE rtl OF uz_sixphase_VSD_transformation_src_adder_MultiplyAdd_nw IS
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_gated = '1' THEN
        MatrixMultiply_0_0_1 <= MatrixMultiply_0_0;
      END IF;
    END IF;
