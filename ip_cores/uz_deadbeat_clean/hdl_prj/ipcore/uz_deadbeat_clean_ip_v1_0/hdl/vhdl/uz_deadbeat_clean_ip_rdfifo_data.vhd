-- -------------------------------------------------------------
-- 
-- File Name: C:\UltraZohm\ultrazohm_test\ip_cores\uz_deadbeat_clean\hdl_prj\hdlsrc\uz_deadbeat_clean\uz_deadbeat_clean_ip_rdfifo_data.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_deadbeat_clean_ip_rdfifo_data
-- Source Path: uz_deadbeat_clean_ip/uz_deadbeat_clean_ip_axi4/uz_deadbeat_clean_ip_axi4_module/uz_deadbeat_clean_ip_rdfifo_data
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_deadbeat_clean_ip_rdfifo_data IS
...
END uz_deadbeat_clean_ip_rdfifo_data;


ARCHITECTURE rtl OF uz_deadbeat_clean_ip_rdfifo_data IS

  -- Component Declarations
  COMPONENT uz_deadbeat_clean_ip_SimpleDualPortRAM_generic
  ...
  FOR ALL : uz_deadbeat_clean_ip_SimpleDualPortRAM_generic
    USE ENTITY work.uz_deadbeat_clean_ip_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_uz_deadbeat_clean_ip_rdfifo_data_classic_ram_generic : uz_deadbeat_clean_ip_SimpleDualPortRAM_generic
