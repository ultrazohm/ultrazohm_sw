...
VIO IP core at `1:02 <https://youtu.be/jtIzec7ymQA?t=62>`_ has a different name now. Furthermore, the output ports are labeled **D3_OUT[25:0]** instead of **Dig_Ch4[25:0]**.

.. image:: ./img/Block_Design.png

Furthermore, the selection for the **hw_vio** channel at `1:25 <https://youtu.be/jtIzec7ymQA?t=85>`_ changed as well. It is now **hw_vio_6** instead of **hw_vio_5**.
