...
--Date        : Wed May 10 08:04:01 2023
--Host        : DESKTOP-571OEC2 running 64-bit major release  (build 9200)
...
entity zusys_wrapper is
  port (
    ...
    D1_OUT : out STD_LOGIC_VECTOR ( 8 downto 0 );
...
zusys_i: component zusys
     port map (
      ...
      D1_OUT(8 downto 0) => D1_OUT(8 downto 0),
