-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\jonat\Documents\ultrazohm_sw\ip_cores\uz_JL_SDDemod\hdlsrc\uz_JL_SDDemodulator\uz_JL_SDDemod_rdfifo_last.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_JL_SDDemod_rdfifo_last
-- Source Path: uz_JL_SDDemod/uz_JL_SDDemod_axi4/uz_JL_SDDemod_axi4_module/uz_JL_SDDemod_rdfifo_last
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_JL_SDDemod_rdfifo_last IS
...
END uz_JL_SDDemod_rdfifo_last;


ARCHITECTURE rtl OF uz_JL_SDDemod_rdfifo_last IS

  -- Component Declarations
  COMPONENT uz_JL_SDDemod_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : uz_JL_SDDemod_SimpleDualPortRAM_singlebit
    USE ENTITY work.uz_JL_SDDemod_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_uz_JL_SDDemod_rdfifo_last_classic_ram_singlebit : uz_JL_SDDemod_SimpleDualPortRAM_singlebit
