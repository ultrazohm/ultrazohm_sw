...
if {[file isfile uz_SPWM_3ph.autotvin.dat]} {
	file delete -force uz_SPWM_3ph.autotvin.dat
}

if {[file isfile uz_SPWM_3ph.autotvout.dat]} {
	file delete -force uz_SPWM_3ph.autotvout.dat
}
