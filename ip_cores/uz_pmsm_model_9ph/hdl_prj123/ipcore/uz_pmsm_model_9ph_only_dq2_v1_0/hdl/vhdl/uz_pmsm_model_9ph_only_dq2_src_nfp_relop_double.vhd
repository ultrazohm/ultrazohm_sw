-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj123/hdlsrc/uz_pmsm_model_9ph_21b_all_double/uz_pmsm_model_9ph_only_dq2_src_nfp_relop_double.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_9ph_only_dq2_src_nfp_relop_double
-- Source Path: uz_pmsm_model_9ph_21b_all_double/uz_pmsm_model_9ph/dq_model_9ph/nfp_relop_double
-- Hierarchy Level: 1
-- 
...
ENTITY uz_pmsm_model_9ph_only_dq2_src_nfp_relop_double IS
...
END uz_pmsm_model_9ph_only_dq2_src_nfp_relop_double;


ARCHITECTURE rtl OF uz_pmsm_model_9ph_only_dq2_src_nfp_relop_double IS
...
BEGIN
  ...
  Delay1_PS_2_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
  ...
  Logical_Operator2_out1_1 <= Relational_Operator2_relop1 OR Logical_Operator3_out1_1;

  Logical_Operator4_out1_1 <= Relational_Operator1_relop1 AND Logical_Operator2_out1_1;
  ...
  Delay_PS_2_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay_PS_2_out1_1 <= '0';
  ...
  Logical_Operator2_out1_2 <= Delay_PS_3_out1 OR Delay1_PS_3_out1;
