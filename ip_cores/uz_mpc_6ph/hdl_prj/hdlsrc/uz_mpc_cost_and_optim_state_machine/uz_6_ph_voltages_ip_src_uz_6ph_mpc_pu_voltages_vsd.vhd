-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_mpc_cost_and_optim_state_machine\uz_6_ph_voltages_ip_src_uz_6ph_mpc_pu_voltages_vsd.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_6_ph_voltages_ip_src_uz_6ph_mpc_pu_voltages_vsd
...
USE work.uz_6_ph_voltages_ip_src_uz_6ph_mpc_pu_voltages_vsd_pkg.ALL;

ENTITY uz_6_ph_voltages_ip_src_uz_6ph_mpc_pu_voltages_vsd IS
...
END uz_6_ph_voltages_ip_src_uz_6ph_mpc_pu_voltages_vsd;


ARCHITECTURE rtl OF uz_6_ph_voltages_ip_src_uz_6ph_mpc_pu_voltages_vsd IS
  ...
  COMPONENT uz_6_ph_voltages_ip_src_Subsystem
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          Set                             :   IN    std_logic;
  ...
  FOR ALL : uz_6_ph_voltages_ip_src_Subsystem
    USE ENTITY work.uz_6_ph_voltages_ip_src_Subsystem(rtl);
...
BEGIN
  ...
  u_Subsystem : uz_6_ph_voltages_ip_src_Subsystem
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
