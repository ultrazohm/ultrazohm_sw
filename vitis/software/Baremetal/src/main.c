...
int main(void)
{
    ...
    while (1)
    {
        ...
        case init_ip_cores:
            ...
            Global_Data.objects.encoder_D4 = initialize_incremental_encoder_ipcore_on_D4(UZ_D4_INCREMENTAL_ENCODER_RESOLUTION, UZ_D4_MOTOR_POLE_PAIR_NUMBER);
            ...
            Global_Data.objects.inverter_d2_right = initialize_uz_inverter_on_D2_right();
