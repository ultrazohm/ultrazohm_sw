...
#define  IPCore_Timestamp_PWM_and_SS_control_V4_ip                  0x8  //contains unique IP timestamp (yymmddHHMM): 2206031500
...
#define  triangle_shift_Data_PWM_and_SS_control_V4_ip               0x12C  //data register for Inport triangle_shift
