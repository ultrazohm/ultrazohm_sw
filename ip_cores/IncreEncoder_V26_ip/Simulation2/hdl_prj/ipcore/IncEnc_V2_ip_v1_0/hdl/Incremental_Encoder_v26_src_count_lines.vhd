-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/inc_enc_v26/Incremental_Encoder_v26_src_count_lines.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Incremental_Encoder_v26_src_count_lines
...
ENTITY Incremental_Encoder_v26_src_count_lines IS
...
END Incremental_Encoder_v26_src_count_lines;


ARCHITECTURE rtl OF Incremental_Encoder_v26_src_count_lines IS

  -- Signals
  SIGNAL Use_new_value                    : std_logic;
  SIGNAL Use_new_value_1                  : std_logic;
  SIGNAL Constant4_out1                   : signed(15 DOWNTO 0);  -- int16
  SIGNAL Constant4_out1_1                 : signed(15 DOWNTO 0);  -- int16
  SIGNAL IncsPerTurn_unsigned             : unsigned(15 DOWNTO 0);  -- uint16
  SIGNAL rd_1_reg                         : vector_of_unsigned16(0 TO 1);  -- ufix16 [2]
  ...
  SIGNAL Resett_switch1_out1_1            : signed(15 DOWNTO 0);  -- int16
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        rd_1_reg <= (OTHERS => to_unsigned(16#0000#, 16));
      ELSIF enb = '1' THEN
        rd_1_reg(0) <= IncsPerTurn_unsigned;
        rd_1_reg(1) <= rd_1_reg(0);
      END IF;
    END IF;
  END PROCESS rd_1_process;

  IncsPerTurn_1 <= rd_1_reg(1);

  Reset_when_overflow_add_cast <= signed(resize(IncsPerTurn_1, 18));
  Reset_when_overflow_add_temp <= resize(Constant4_out1_1, 18) + Reset_when_overflow_add_cast;
  ...
  Relational_Operator_relop1 <= '1' WHEN Resett_switch1_out1 > Reset_when_overflow_out1 ELSE
      '0';

  
  Resett_switch1_out1_1 <= Resett_switch2_out1 WHEN Relational_Operator_relop1 = '0' ELSE
      Constant1_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Resett_switch1_out1 <= to_signed(16#0000#, 16);
      ELSIF enb = '1' THEN
