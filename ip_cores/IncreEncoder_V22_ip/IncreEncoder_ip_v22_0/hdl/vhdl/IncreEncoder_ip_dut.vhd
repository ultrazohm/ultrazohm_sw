-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Encoder_Zynq\IncreEncoder_ip_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IncreEncoder_ip_dut
-- Source Path: IncreEncoder_ip/IncreEncoder_ip_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END IncreEncoder_ip_dut;


ARCHITECTURE rtl OF IncreEncoder_ip_dut IS

  -- Component Declarations
  COMPONENT IncreEncoder_ip_src_IncreEncoder_V22
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : IncreEncoder_ip_src_IncreEncoder_V22
    USE ENTITY work.IncreEncoder_ip_src_IncreEncoder_V22(rtl);
...
BEGIN
  u_IncreEncoder_ip_src_IncreEncoder_V22 : IncreEncoder_ip_src_IncreEncoder_V22
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
              A => A_sig,  -- ufix1
