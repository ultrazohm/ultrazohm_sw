-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj2318655/hdlsrc/uz_pmsm_model_9ph_21b_all_double/uz_pmsm9ph_transformations_src_Divide2_nw_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm9ph_transformations_src_Divide2_nw_block
-- Source Path: 
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
...
ENTITY uz_pmsm9ph_transformations_src_Divide2_nw_block IS
...
END uz_pmsm9ph_transformations_src_Divide2_nw_block;


ARCHITECTURE rtl OF uz_pmsm9ph_transformations_src_Divide2_nw_block IS
  ...
  SIGNAL Divide2_out1_bypass              : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL Divide2_out1_last_value          : signed(24 DOWNTO 0);  -- sfix25_En12
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        u_alpha <= to_signed(16#0000000#, 25);
      ELSIF enb_gated = '1' THEN
        u_alpha <= in1_signed;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Divide2_out1_last_value <= to_signed(16#0000000#, 25);
      ELSIF enb_gated = '1' THEN
