-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\inc_enc_v25\Incremental_Encoder_src_oversample_factor.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Incremental_Encoder_src_oversample_factor
-- Source Path: inc_enc_v25/IncEnc_V25/speed/OS_factor_logic/oversample_factor
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Incremental_Encoder_src_oversample_factor IS
...
END Incremental_Encoder_src_oversample_factor;


ARCHITECTURE rtl OF Incremental_Encoder_src_oversample_factor IS
...
BEGIN
  ...
  BEGIN
    ...
    IF (hdlcoder_to_stdlogic(ReadBack_Omega_signed > Omega_ADD) AND AllowCheckOverSampl) = '1' THEN 
      state_Out_tmp <= state_unsigned + to_unsigned(16#0001#, 16);
      --Count up the measure-state
      InternalOmega_Out_tmp <= Omega_ADD;
    ELSIF (hdlcoder_to_stdlogic(ReadBack_Omega_signed < Omega_SUB) AND AllowCheckOverSampl) = '1' THEN 
      state_Out_tmp <= state_unsigned - to_unsigned(16#0001#, 16);
    ...
    ELSE 
      ...
      IF (hdlcoder_to_stdlogic(cast < cast_0) AND AllowCheckOverSampl) = '1' THEN 
