...
int JavaScope_initialize(DS_Data* data)
{
	...
	// the addresses in Global_Data do not change during runtime, this can be done in the init
	    ...
	    js_ch_observable[JSO_Speed_rpm]		= &data->av.mechanicalRotorSpeed; //Speichere die Adresse von mechanicalRotorSpeed aus dem av-Feld der Struktur, auf die data zeigt, in das Array js_ch_observable an der Stelle JSO_Speed_rpm.
	    js_ch_observable[JSO_ia] 			= &data->av.I_a;
	   	js_ch_observable[JSO_ib] 			= &data->av.I_b;
	   	js_ch_observable[JSO_ic] 			= &data->av.I_c;
