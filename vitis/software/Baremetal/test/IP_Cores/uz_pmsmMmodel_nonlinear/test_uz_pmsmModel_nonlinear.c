...
#include "mock_uz_pmsmModel_nonlinear_hw.h"
...
uz_pmsmModel_nonlinear_t *successful_init(struct uz_pmsmModel_nonlinear_config_t configuration);
uz_pmsmModel_nonlinear_t *successful_init(struct uz_pmsmModel_nonlinear_config_t configuration)
{
    ...
    if (configuration.simulate_mechanical_system)
    {
        ...
        uz_pmsmModel_nonlinear_hw_write_coulomb_friction_constant_Expect(BASE_ADDRESS, configuration.coulomb_friction_constant);
        uz_pmsmModel_nonlinear_hw_write_inertia_Expect(BASE_ADDRESS, configuration.inertia);
    }
    else
    {
        // if mechanical part is not simulated, expect the hw write functions to be called with the default values
        uz_pmsmModel_nonlinear_hw_write_friction_coefficient_Expect(BASE_ADDRESS, 1.0f);
        uz_pmsmModel_nonlinear_hw_write_coulomb_friction_constant_Expect(BASE_ADDRESS, 0.0f);
...
void test_uz_pmsmModel_nonlinear_successful_init(void)
{
    uz_pmsmModel_nonlinear_t *test_instance = successful_init(config);
    TEST_ASSERT_NOT_NULL(test_instance);
}

void test_uz_pmsmModel_nonlinear_reset_model(void)
{
    uz_pmsmModel_nonlinear_t *test_instance = successful_init(config);

    // write zeros to the model
    uz_pmsmModel_nonlinear_hw_write_v_d_Expect(BASE_ADDRESS, 0.0f);
    uz_pmsmModel_nonlinear_hw_write_v_q_Expect(BASE_ADDRESS, 0.0f);
    uz_pmsmModel_nonlinear_hw_write_omega_mech_Expect(BASE_ADDRESS, 0.0f);
    uz_pmsmModel_nonlinear_hw_write_load_torque_Expect(BASE_ADDRESS,0.0f);
    // force rising edge on inputs strobe
    uz_pmsmModel_nonlinear_hw_trigger_input_strobe_Expect(BASE_ADDRESS);
    uz_pmsmModel_nonlinear_hw_write_reset_Expect(BASE_ADDRESS, false);
    uz_pmsmModel_nonlinear_hw_write_reset_Expect(BASE_ADDRESS, true);
    uz_pmsmModel_nonlinear_hw_write_reset_Expect(BASE_ADDRESS, false);
    uz_pmsmModel_nonlinear_reset(test_instance);
}

void test_uz_pmsmModel_nonlinear_normal_usage(void)
{
    ...
    uz_pmsmModel_nonlinear_hw_trigger_output_strobe_Expect(BASE_ADDRESS);
    uz_pmsmModel_nonlinear_trigger_output_strobe(test_instance);
    uz_pmsmModel_nonlinear_hw_trigger_output_strobe_Expect(BASE_ADDRESS);
    uz_pmsmModel_nonlinear_trigger_output_strobe(test_instance);
    ...
    uz_pmsmModel_nonlinear_hw_read_i_d_ExpectAndReturn(BASE_ADDRESS, i_d_expect);
    uz_pmsmModel_nonlinear_hw_read_i_q_ExpectAndReturn(BASE_ADDRESS, i_q_expect);
    uz_pmsmModel_nonlinear_hw_read_torque_ExpectAndReturn(BASE_ADDRESS, torque_expect);
    uz_pmsmModel_nonlinear_hw_read_omega_mech_ExpectAndReturn(BASE_ADDRESS,omega_mech_expect);

    struct uz_pmsmModel_nonlinear_outputs_t out = uz_pmsmModel_nonlinear_get_outputs(test_instance);
    ...
    uz_pmsmModel_nonlinear_hw_write_v_d_Expect(BASE_ADDRESS, inputs.v_d_V);
    uz_pmsmModel_nonlinear_hw_write_v_q_Expect(BASE_ADDRESS, inputs.v_q_V);
    uz_pmsmModel_nonlinear_hw_write_omega_mech_Expect(BASE_ADDRESS, inputs.omega_mech_1_s);
    uz_pmsmModel_nonlinear_hw_write_load_torque_Expect(BASE_ADDRESS,inputs.load_torque);
    uz_pmsmModel_nonlinear_set_inputs(test_instance, inputs);
}
