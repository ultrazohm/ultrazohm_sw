...
#define INTERRUPT_ADC_TO_ISR_RATIO_USER_CHOICE	40U

#define UZ_D5_INCREMENTAL_ENCODER_RESOLUTION    5000.0f
#define UZ_D5_MOTOR_POLE_PAIR_NUMBER            4.0f
#define UZ_PWM_FREQUENCY_RIGHT                  10.0e3f
#define UZ_PWM_FREQUENCY_LEFT                   400.0e3f
...
// Configuration defines for the number of used instances for testing with ceedling
    ...
    #define UZ_TRAJECTORY_MAX_INSTANCES                     15U
#endif
