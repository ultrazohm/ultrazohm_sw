...
ARCHITECTURE rtl OF uz_JL_SDDemod IS
  ...
  SIGNAL write_switch_clk                 : std_logic;  -- ufix1
...
BEGIN
  ...
  u_uz_JL_SDDemod_axi4_inst : uz_JL_SDDemod_axi4
    PORT MAP( reset => reset,
              ...
              read_data_out_ps => data_out_ps_sig,  -- sfix32
              ...
              write_Dezimation => write_Dezimation,  -- sfix16
              write_clk_ratio => write_clk_ratio,  -- sfix16
              write_switch_clk => write_switch_clk,  -- ufix1
  ...
  u_uz_JL_SDDemod_dut_inst : uz_JL_SDDemod_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              ...
              in_data_ads => in_data_ads,  -- ufix1
              Dezimation => write_Dezimation,  -- sfix16
              clk_ratio => write_clk_ratio,  -- sfix16
              in_clk_ads => in_clk_ads,  -- ufix1
              switch_clk => write_switch_clk,  -- ufix1
  ...
  ip_timestamp <= unsigned'(X"9B56DE0A");
