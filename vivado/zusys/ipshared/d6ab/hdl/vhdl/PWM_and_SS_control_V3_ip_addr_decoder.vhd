-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\IP_Core_SS_Switch_and_PWM\PWM_and_SS_control_V3_ip_addr_decoder.vhd
-- Created: 2020-02-07 14:12:00
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: PWM_and_SS_control_V3_ip_addr_decoder
-- Source Path: PWM_and_SS_control_V3_ip/PWM_and_SS_control_V3_ip_axi_lite/PWM_and_SS_control_V3_ip_addr_decoder
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY PWM_and_SS_control_V3_ip_addr_decoder IS
...
END PWM_and_SS_control_V3_ip_addr_decoder;


ARCHITECTURE rtl OF PWM_and_SS_control_V3_ip_addr_decoder IS
  ...
  SIGNAL decode_sel_Scal_f_carrier_AXI    : std_logic;  -- ufix1
  SIGNAL reg_enb_Scal_f_carrier_AXI       : std_logic;  -- ufix1
  SIGNAL data_in_Scal_f_carrier_AXI       : unsigned(24 DOWNTO 0);  -- ufix25_En26
  SIGNAL write_reg_Scal_f_carrier_AXI     : unsigned(24 DOWNTO 0);  -- ufix25_En26
  SIGNAL decode_sel_Scal_T_carrier_AXI    : std_logic;  -- ufix1
  SIGNAL reg_enb_Scal_T_carrier_AXI       : std_logic;  -- ufix1
  SIGNAL data_in_Scal_T_carrier_AXI       : unsigned(24 DOWNTO 0);  -- ufix25
  SIGNAL write_reg_Scal_T_carrier_AXI     : unsigned(24 DOWNTO 0);  -- ufix25
  SIGNAL decode_sel_PWM_min_pulse_width_AXI : std_logic;  -- ufix1
  SIGNAL reg_enb_PWM_min_pulse_width_AXI  : std_logic;  -- ufix1
  SIGNAL data_in_PWM_min_pulse_width_AXI  : signed(17 DOWNTO 0);  -- sfix18_En16
  SIGNAL write_reg_PWM_min_pulse_width_AXI : signed(17 DOWNTO 0);  -- sfix18_En16
...
BEGIN
  ...
  data_in_PWM_min_pulse_width_rd_AXI <= unsigned(resize(read_reg_PWM_min_pulse_width_rd_AXI, 32));
  ...
  decode_sel_Scal_f_carrier_AXI <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0042#, 14) ELSE
      '0';

  reg_enb_Scal_f_carrier_AXI <= decode_sel_Scal_f_carrier_AXI AND wr_enb;

  data_in_Scal_f_carrier_AXI <= data_write_unsigned(24 DOWNTO 0);

  reg_Scal_f_carrier_AXI_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        write_reg_Scal_f_carrier_AXI <= to_unsigned(16#0000000#, 25);
      ELSIF enb = '1' AND reg_enb_Scal_f_carrier_AXI = '1' THEN
        write_reg_Scal_f_carrier_AXI <= data_in_Scal_f_carrier_AXI;
      END IF;
    END IF;
  END PROCESS reg_Scal_f_carrier_AXI_process;


  write_Scal_f_carrier_AXI <= std_logic_vector(write_reg_Scal_f_carrier_AXI);

  
  decode_sel_Scal_T_carrier_AXI <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0043#, 14) ELSE
      '0';

  reg_enb_Scal_T_carrier_AXI <= decode_sel_Scal_T_carrier_AXI AND wr_enb;

  data_in_Scal_T_carrier_AXI <= data_write_unsigned(24 DOWNTO 0);

  reg_Scal_T_carrier_AXI_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        write_reg_Scal_T_carrier_AXI <= to_unsigned(16#0000000#, 25);
      ELSIF enb = '1' AND reg_enb_Scal_T_carrier_AXI = '1' THEN
        write_reg_Scal_T_carrier_AXI <= data_in_Scal_T_carrier_AXI;
      END IF;
    END IF;
  END PROCESS reg_Scal_T_carrier_AXI_process;


  write_Scal_T_carrier_AXI <= std_logic_vector(write_reg_Scal_T_carrier_AXI);

  
  decode_sel_PWM_min_pulse_width_AXI <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0044#, 14) ELSE
      '0';

  reg_enb_PWM_min_pulse_width_AXI <= decode_sel_PWM_min_pulse_width_AXI AND wr_enb;

  data_in_PWM_min_pulse_width_AXI <= signed(data_write_unsigned(17 DOWNTO 0));

  reg_PWM_min_pulse_width_AXI_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        write_reg_PWM_min_pulse_width_AXI <= to_signed(16#00000#, 18);
      ELSIF enb = '1' AND reg_enb_PWM_min_pulse_width_AXI = '1' THEN
        write_reg_PWM_min_pulse_width_AXI <= data_in_PWM_min_pulse_width_AXI;
      END IF;
    END IF;
  END PROCESS reg_PWM_min_pulse_width_AXI_process;


  write_PWM_min_pulse_width_AXI <= std_logic_vector(write_reg_PWM_min_pulse_width_AXI);
