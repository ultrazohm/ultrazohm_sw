-- -------------------------------------------------------------
-- 
-- File Name: C:\UltraZohm\ultrazohm_test\ip_cores\uz_Deadbeat\hdl_prj\hdlsrc\uz_Deadbeat\uz_Deadbe_ip_axi4_module.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_Deadbe_ip_axi4_module
-- Source Path: uz_Deadbe_ip/uz_Deadbe_ip_axi4/uz_Deadbe_ip_axi4_module
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_Deadbe_ip_axi4_module IS
...
END uz_Deadbe_ip_axi4_module;


ARCHITECTURE rtl OF uz_Deadbe_ip_axi4_module IS

  -- Component Declarations
  COMPONENT uz_Deadbe_ip_rdfifo_data
    PORT( clk                             :   IN    std_logic;
  ...
  COMPONENT uz_Deadbe_ip_rdfifo_rid
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT uz_Deadbe_ip_rdfifo_last
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : uz_Deadbe_ip_rdfifo_data
    USE ENTITY work.uz_Deadbe_ip_rdfifo_data(rtl);

  FOR ALL : uz_Deadbe_ip_rdfifo_rid
    USE ENTITY work.uz_Deadbe_ip_rdfifo_rid(rtl);

  FOR ALL : uz_Deadbe_ip_rdfifo_last
    USE ENTITY work.uz_Deadbe_ip_rdfifo_last(rtl);
...
BEGIN
  u_uz_Deadbe_ip_rdfifo_data_inst : uz_Deadbe_ip_rdfifo_data
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => const_1,
  ...
  u_uz_Deadbe_ip_rdfifo_rid_inst : uz_Deadbe_ip_rdfifo_rid
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => const_1,
  ...
  u_uz_Deadbe_ip_rdfifo_last_inst : uz_Deadbe_ip_rdfifo_last
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => const_1,
