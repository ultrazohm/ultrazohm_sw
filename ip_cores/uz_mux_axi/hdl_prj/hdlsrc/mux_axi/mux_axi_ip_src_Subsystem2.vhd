-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mux_axi\mux_axi_ip_src_Subsystem2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mux_axi_ip_src_Subsystem2
-- Source Path: mux_axi/mux_axi/Subsystem2
-- Hierarchy Level: 1
-- Model version: 9.8
-- 
-- -------------------------------------------------------------
...
ENTITY mux_axi_ip_src_Subsystem2 IS
...
END mux_axi_ip_src_Subsystem2;


ARCHITECTURE rtl OF mux_axi_ip_src_Subsystem2 IS

  -- Component Declarations
  COMPONENT mux_axi_ip_src_Detect_Rise_Positive_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT mux_axi_ip_src_Detect_Fall_Nonpositive2_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : mux_axi_ip_src_Detect_Rise_Positive_block
    USE ENTITY work.mux_axi_ip_src_Detect_Rise_Positive_block(rtl);

  FOR ALL : mux_axi_ip_src_Detect_Fall_Nonpositive2_block
    USE ENTITY work.mux_axi_ip_src_Detect_Fall_Nonpositive2_block(rtl);
...
BEGIN
  ...
  u_Detect_Rise_Positive : mux_axi_ip_src_Detect_Rise_Positive_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Detect_Fall_Nonpositive2 : mux_axi_ip_src_Detect_Fall_Nonpositive2_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
