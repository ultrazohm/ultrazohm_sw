-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\valen\Documents\repos\UZ\ultrazohm_sw_pr\ip_cores\uz_pmsm_model_6ph_dq\hdl_prj\hdlsrc\uz_pmsm_model_6ph_dq\uz_pmsm_model_6ph_dq_src_nfp_mul_double.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_6ph_dq_src_nfp_mul_double
-- Source Path: uz_pmsm_model_6ph_dq/uz_pmsm_model_6ph_dq/nfp_mul_double
-- Hierarchy Level: 1
-- 
...
ENTITY uz_pmsm_model_6ph_dq_src_nfp_mul_double IS
...
END uz_pmsm_model_6ph_dq_src_nfp_mul_double;


ARCHITECTURE rtl OF uz_pmsm_model_6ph_dq_src_nfp_mul_double IS
...
BEGIN
  ...
  if_exp_out_cast_cfType_Expone_4_out1 <= Delay3_PS_6_out1 WHEN BitSlice1_out1 = '0' ELSE
      Add_out1;
  ...
  if_bitget_Mant_tmp_Mant_tmp_Wor_out1 <= Delay_PS_8_out1 WHEN BitSlice2_out1_1 = '0' ELSE
      Exp_Incr_out1;
  ...
  Compare_To_Zero_out1_3 <= '1' WHEN Delay_PS_8_out1 = to_unsigned(16#000#, 11) ELSE
      '0';
