...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln409_fu_155_p2 == 1'd0))) begin
        ...
        tmp_s_reg_278[8 : 2] <= tmp_s_fu_170_p3[8 : 2];
    end
end
...
assign or_ln416_1_fu_228_p2 = (tmp_s_reg_278 | 9'd2);

assign or_ln416_2_fu_238_p2 = (tmp_s_reg_278 | 9'd3);

assign or_ln416_fu_183_p2 = (tmp_s_fu_170_p3 | 9'd1);
