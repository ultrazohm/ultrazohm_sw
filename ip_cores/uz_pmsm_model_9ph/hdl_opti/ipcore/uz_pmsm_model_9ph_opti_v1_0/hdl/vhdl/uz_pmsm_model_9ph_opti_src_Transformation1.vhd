-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\valen\Documents\repos\UZ\ultrazohm_sw\ip_cores\new_ninephase\hdl_opti\hdlsrc\uz_pmsm_model_9ph_working\uz_pmsm_model_9ph_opti_src_Transformation1.vhd
...
-- Source Path: uz_pmsm_model_9ph_working/uz_pmsm_model_9ph/Transformation1
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF uz_pmsm_model_9ph_opti_src_Transformation1 IS
  ...
  SIGNAL enb_counter_ge_33_1              : std_logic;
  SIGNAL enb_counter_le_41_1              : std_logic;
  SIGNAL uz_pmsm_model_9ph_working_uz_pmsm_model_9ph_Transformation1_enb_phase_33_8 : std_logic;
...
BEGIN
  ...
  u_uz_pmsm_model_9ph_working_uz_pmsm_model_9ph_nfp_convert_single_to_sfix_25_En12_1 : uz_pmsm_model_9ph_opti_src_nfp_convert_single_to_sfix_25_En12
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_uz_pmsm_model_9ph_working_uz_pmsm_model_9ph_nfp_convert_single_to_sfix_25_En12_2 : uz_pmsm_model_9ph_opti_src_nfp_convert_single_to_sfix_25_En12
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_uz_pmsm_model_9ph_working_uz_pmsm_model_9ph_nfp_convert_single_to_sfix_25_En12_3 : uz_pmsm_model_9ph_opti_src_nfp_convert_single_to_sfix_25_En12
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_uz_pmsm_model_9ph_working_uz_pmsm_model_9ph_nfp_convert_single_to_sfix_25_En12_4 : uz_pmsm_model_9ph_opti_src_nfp_convert_single_to_sfix_25_En12
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_uz_pmsm_model_9ph_working_uz_pmsm_model_9ph_nfp_convert_single_to_sfix_25_En12_5 : uz_pmsm_model_9ph_opti_src_nfp_convert_single_to_sfix_25_En12
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_uz_pmsm_model_9ph_working_uz_pmsm_model_9ph_nfp_convert_single_to_sfix_25_En12_6 : uz_pmsm_model_9ph_opti_src_nfp_convert_single_to_sfix_25_En12
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_uz_pmsm_model_9ph_working_uz_pmsm_model_9ph_nfp_convert_single_to_sfix_25_En12_7 : uz_pmsm_model_9ph_opti_src_nfp_convert_single_to_sfix_25_En12
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_uz_pmsm_model_9ph_working_uz_pmsm_model_9ph_nfp_convert_single_to_sfix_25_En12_8 : uz_pmsm_model_9ph_opti_src_nfp_convert_single_to_sfix_25_En12
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Transformation1_MAC3 : uz_pmsm_model_9ph_opti_src_Transformation1_MAC_block2
    PORT MAP( clk => clk,
              ...
              globalSchedule => uz_pmsm_model_9ph_working_uz_pmsm_model_9ph_Transformation1_enb_phase_33_8,
  ...
  enb_counter_ge_33_1 <= '1' WHEN enb_counter_unsigned >= to_unsigned(16#0021#, 16) ELSE
      '0';

  
  enb_counter_le_41_1 <= '1' WHEN enb_counter_unsigned <= to_unsigned(16#0029#, 16) ELSE
      '0';

  uz_pmsm_model_9ph_working_uz_pmsm_model_9ph_Transformation1_enb_phase_33_8 <= enb_counter_ge_33_1 AND enb_counter_le_41_1;
