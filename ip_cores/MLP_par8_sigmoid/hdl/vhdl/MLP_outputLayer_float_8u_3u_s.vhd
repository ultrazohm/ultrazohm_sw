...
entity MLP_outputLayer_float_8u_3u_s is
port (
...
architecture behav of MLP_outputLayer_float_8u_3u_s is 
...
attribute shreg_extract : string;
    signal outputLayer_float_8u_3u_entry117_U0_ap_start : STD_LOGIC;
    signal outputLayer_float_8u_3u_entry117_U0_ap_done : STD_LOGIC;
    signal outputLayer_float_8u_3u_entry117_U0_ap_continue : STD_LOGIC;
    signal outputLayer_float_8u_3u_entry117_U0_ap_idle : STD_LOGIC;
    signal outputLayer_float_8u_3u_entry117_U0_ap_ready : STD_LOGIC;
    signal outputLayer_float_8u_3u_entry117_U0_p_weights_offset_out_din : STD_LOGIC_VECTOR (15 downto 0);
    signal outputLayer_float_8u_3u_entry117_U0_p_weights_offset_out_write : STD_LOGIC;
    signal outputLayer_float_8u_3u_entry117_U0_p_bias_offset_out_din : STD_LOGIC_VECTOR (8 downto 0);
    signal outputLayer_float_8u_3u_entry117_U0_p_bias_offset_out_write : STD_LOGIC;
    signal outputLayer_float_8u_3u_entry117_U0_p_n_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal outputLayer_float_8u_3u_entry117_U0_p_n_out_write : STD_LOGIC;
    signal outputLayer_float_8u_3u_entry117_U0_p_n_out1_din : STD_LOGIC_VECTOR (31 downto 0);
    signal outputLayer_float_8u_3u_entry117_U0_p_n_out1_write : STD_LOGIC;
    signal outputLayer_float_8u_3u_entry117_U0_p_n_out2_din : STD_LOGIC_VECTOR (31 downto 0);
    signal outputLayer_float_8u_3u_entry117_U0_p_n_out2_write : STD_LOGIC;
    signal outputLayer_float_8u_3u_entry117_U0_p_k_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal outputLayer_float_8u_3u_entry117_U0_p_k_out_write : STD_LOGIC;
    signal outputLayer_float_8u_3u_entry117_U0_p_k_out3_din : STD_LOGIC_VECTOR (31 downto 0);
    signal outputLayer_float_8u_3u_entry117_U0_p_k_out3_write : STD_LOGIC;
    ...
    signal gem2Stream_float_8u_U0_p_in_address0 : STD_LOGIC_VECTOR (15 downto 0);
    signal gem2Stream_float_8u_U0_p_in_ce0 : STD_LOGIC;
    signal gem2Stream_float_8u_U0_p_in_address1 : STD_LOGIC_VECTOR (15 downto 0);
    signal gem2Stream_float_8u_U0_p_in_ce1 : STD_LOGIC;
    signal gem2Stream_float_8u_U0_p_in_offset_read : STD_LOGIC;
    ...
    signal vec2GemStream_float_8u_1_U0_p_in_address0 : STD_LOGIC_VECTOR (6 downto 0);
    signal vec2GemStream_float_8u_1_U0_p_in_ce0 : STD_LOGIC;
    signal vec2GemStream_float_8u_1_U0_p_in_address1 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal gemv_float_3u_unsigned_int_U0_l_strWeights4_read : STD_LOGIC;
    signal gemv_float_3u_unsigned_int_U0_l_strInput5_read : STD_LOGIC;
    signal gemv_float_3u_unsigned_int_U0_l_strBias7_read : STD_LOGIC;
    signal gemv_float_3u_unsigned_int_U0_l_strMv6_din : STD_LOGIC_VECTOR (31 downto 0);
    signal gemv_float_3u_unsigned_int_U0_l_strMv6_write : STD_LOGIC;
    ...
    signal ap_sync_reg_outputLayer_float_8u_3u_entry117_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_outputLayer_float_8u_3u_entry117_U0_ap_ready : STD_LOGIC;
    signal outputLayer_float_8u_3u_entry117_U0_ap_ready_count : STD_LOGIC_VECTOR (1 downto 0) := "00";
    ...
    signal outputLayer_float_8u_3u_entry117_U0_start_full_n : STD_LOGIC;
    signal outputLayer_float_8u_3u_entry117_U0_start_write : STD_LOGIC;
    ...
    component MLP_outputLayer_float_8u_3u_entry117 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component MLP_gem2Stream_float_8u_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component MLP_vec2GemStream_float_8u_1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component MLP_gemv_float_3u_unsigned_int_s IS
    port (
        ap_start : IN STD_LOGIC;
        start_full_n : IN STD_LOGIC;
        start_out : OUT STD_LOGIC;
    ...
    component MLP_fifo_w256_d2_S_x3 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component MLP_start_for_gemv_float_3u_unsigned_int_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    outputLayer_float_8u_3u_entry117_U0 : component MLP_outputLayer_float_8u_3u_entry117
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    gem2Stream_float_8u_U0 : component MLP_gem2Stream_float_8u_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    vec2GemStream_float_8u_1_U0 : component MLP_vec2GemStream_float_8u_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    gemv_float_3u_unsigned_int_U0 : component MLP_gemv_float_3u_unsigned_int_s
    port map (
    ...
    l_strWeights_U : component MLP_fifo_w256_d2_S_x3
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    l_strInput_U : component MLP_fifo_w256_d2_S_x3
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_gemv_float_3u_unsigned_int_U0_U : component MLP_start_for_gemv_float_3u_unsigned_int_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ap_sync_reg_outputLayer_float_8u_3u_entry117_U0_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ap_sync_reg_outputLayer_float_8u_3u_entry117_U0_ap_ready <= ap_const_logic_0;
            else
                if (((ap_sync_ready and ap_start) = ap_const_logic_1)) then 
                    ap_sync_reg_outputLayer_float_8u_3u_entry117_U0_ap_ready <= ap_const_logic_0;
                else 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((gem2Stream_float_8u_U0_ap_ready = ap_const_logic_0) and (ap_sync_ready = ap_const_logic_1))) then 
            ...
            elsif (((gem2Stream_float_8u_U0_ap_ready = ap_const_logic_1) and (ap_sync_ready = ap_const_logic_0))) then 
                gem2Stream_float_8u_U0_ap_ready_count <= std_logic_vector(unsigned(gem2Stream_float_8u_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;

    outputLayer_float_8u_3u_entry117_U0_ap_ready_count_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((outputLayer_float_8u_3u_entry117_U0_ap_ready = ap_const_logic_0) and (ap_sync_ready = ap_const_logic_1))) then 
                outputLayer_float_8u_3u_entry117_U0_ap_ready_count <= std_logic_vector(unsigned(outputLayer_float_8u_3u_entry117_U0_ap_ready_count) - unsigned(ap_const_lv2_1));
            elsif (((outputLayer_float_8u_3u_entry117_U0_ap_ready = ap_const_logic_1) and (ap_sync_ready = ap_const_logic_0))) then 
                outputLayer_float_8u_3u_entry117_U0_ap_ready_count <= std_logic_vector(unsigned(outputLayer_float_8u_3u_entry117_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;
    ...
    ap_done <= writeStream2Vec_float_1u_U0_ap_done;
    ap_idle <= (writeStream2Vec_float_1u_U0_ap_idle and vec2GemStream_float_8u_1_U0_ap_idle and readVec2Stream_float_1u_U0_ap_idle and outputLayer_float_8u_3u_entry117_U0_ap_idle and gemv_float_3u_unsigned_int_U0_ap_idle and gem2Stream_float_8u_U0_ap_idle);
    ...
    ap_sync_outputLayer_float_8u_3u_entry117_U0_ap_ready <= (outputLayer_float_8u_3u_entry117_U0_ap_ready or ap_sync_reg_outputLayer_float_8u_3u_entry117_U0_ap_ready);
    ...
    ap_sync_ready <= (ap_sync_vec2GemStream_float_8u_1_U0_ap_ready and ap_sync_readVec2Stream_float_1u_U0_ap_ready and ap_sync_outputLayer_float_8u_3u_entry117_U0_ap_ready and ap_sync_gem2Stream_float_8u_U0_ap_ready);
    ...
    outputLayer_float_8u_3u_entry117_U0_ap_continue <= ap_const_logic_1;
    outputLayer_float_8u_3u_entry117_U0_ap_start <= ((ap_sync_reg_outputLayer_float_8u_3u_entry117_U0_ap_ready xor ap_const_logic_1) and ap_start);
    outputLayer_float_8u_3u_entry117_U0_start_full_n <= ap_const_logic_1;
    outputLayer_float_8u_3u_entry117_U0_start_write <= ap_const_logic_0;
    ...
    p_input_address0 <= vec2GemStream_float_8u_1_U0_p_in_address0;
    p_input_address1 <= vec2GemStream_float_8u_1_U0_p_in_address1;
    p_input_ce0 <= vec2GemStream_float_8u_1_U0_p_in_ce0;
    p_input_ce1 <= vec2GemStream_float_8u_1_U0_p_in_ce1;
    ...
    p_weights_address0 <= gem2Stream_float_8u_U0_p_in_address0;
    p_weights_address1 <= gem2Stream_float_8u_U0_p_in_address1;
    p_weights_ce0 <= gem2Stream_float_8u_U0_p_in_ce0;
    p_weights_ce1 <= gem2Stream_float_8u_U0_p_in_ce1;
