...
// Baremetal application selection
#define UZ_APP_DQN_PT1       1U
#define UZ_APP_DDPG_PT1      2U
...
#error UZ_APP must be UZ_APP_DQN_PT1, UZ_APP_DDPG_PT1, or UZ_APP_DESKBENCH
#endif

#if (UZ_APP == UZ_APP_DDPG_PT1)
#define PT1_CONTROL_AGENT PT1_CONTROL_AGENT_DDPG
#else
#define PT1_CONTROL_AGENT PT1_CONTROL_AGENT_DQN
#endif

// Deskbench control selection. These flags are evaluated at compile time.
#define UZ_DESKBENCH_CONTROL_BOTH                1U
#define UZ_DESKBENCH_CONTROL_DUT_ONLY            2U
#define UZ_DESKBENCH_CONTROL_PRIME_ONLY          3U
...
#error UZ_DESKBENCH_CONTROL_MODE must be UZ_DESKBENCH_CONTROL_BOTH, UZ_DESKBENCH_CONTROL_DUT_ONLY, UZ_DESKBENCH_CONTROL_PRIME_ONLY, or UZ_DESKBENCH_CONTROL_DUT_PMSM_MODEL
#endif

#define UZ_DESKBENCH_CONTROL_DUT_ACTIVE ((UZ_DESKBENCH_CONTROL_MODE == UZ_DESKBENCH_CONTROL_BOTH) || (UZ_DESKBENCH_CONTROL_MODE == UZ_DESKBENCH_CONTROL_DUT_ONLY))
#define UZ_DESKBENCH_CONTROL_PRIME_MOVER_ACTIVE ((UZ_DESKBENCH_CONTROL_MODE == UZ_DESKBENCH_CONTROL_BOTH) || (UZ_DESKBENCH_CONTROL_MODE == UZ_DESKBENCH_CONTROL_PRIME_ONLY))
#define UZ_DESKBENCH_CONTROL_DUT_PMSM_MODEL_ACTIVE (UZ_DESKBENCH_CONTROL_MODE == UZ_DESKBENCH_CONTROL_DUT_PMSM_MODEL)

#ifndef UZ_DESKBENCH_DUT_PMSM_MODEL_BASE_ADDRESS
#ifdef XPAR_UZ_USER_UZ_PMSMMODEL_0_BASEADDR
#define UZ_DESKBENCH_DUT_PMSM_MODEL_BASE_ADDRESS XPAR_UZ_USER_UZ_PMSMMODEL_0_BASEADDR
#else
#define UZ_DESKBENCH_DUT_PMSM_MODEL_BASE_ADDRESS 0U
#endif
#endif

#ifndef UZ_DESKBENCH_DUT_PMSM_MODEL_V_DC
#define UZ_DESKBENCH_DUT_PMSM_MODEL_V_DC 48.0f
#endif
...
// Configuration defines for the number of used instances for testing with ceedling
    ...
    #define UZ_ADCMAX11331_MAX_INSTANCES                    30U
