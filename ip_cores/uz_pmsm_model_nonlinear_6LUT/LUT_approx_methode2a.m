...
crossfluxd1 = Flux_d(10,:);
crossfluxd2 = Flux_d(15,:);
crossfluxd3 = Flux_d(20,:);

tacos = (((psidself*1e3) .* (crossfluxd1*1e3)).*1e-3); 
tacos = psidself_padded -  (psidself.*crossfluxd1);

tacos2 = fluxd_real./psidself_padded;
