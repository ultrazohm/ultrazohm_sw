-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/gmStateSpaceHDL_uz_inverter_3ph/uz_invert_ip_src_nfp_uminus_double.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_invert_ip_src_nfp_uminus_double
-- Source Path: gmStateSpaceHDL_uz_inverter_3ph/uz_inverter_3ph/nfp_uminus_double
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_invert_ip_src_nfp_uminus_double IS
  PORT( nfp_in                            :   IN    std_logic_vector(63 DOWNTO 0);  -- ufix64
        nfp_out                           :   OUT   std_logic_vector(63 DOWNTO 0)  -- ufix64
        );
END uz_invert_ip_src_nfp_uminus_double;


ARCHITECTURE rtl OF uz_invert_ip_src_nfp_uminus_double IS
