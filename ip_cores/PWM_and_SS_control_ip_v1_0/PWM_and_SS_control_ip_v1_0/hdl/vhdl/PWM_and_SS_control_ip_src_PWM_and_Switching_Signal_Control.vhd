-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\IP_Core_SS_Switch_and_PWM\PWM_and_SS_control_ip_src_PWM_and_Switching_Signal_Control.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: PWM_and_SS_control_ip_src_PWM_and_Switching_Signal_Control
...
ENTITY PWM_and_SS_control_ip_src_PWM_and_Switching_Signal_Control IS
...
END PWM_and_SS_control_ip_src_PWM_and_Switching_Signal_Control;


ARCHITECTURE rtl OF PWM_and_SS_control_ip_src_PWM_and_Switching_Signal_Control IS

  -- Component Declarations
  COMPONENT PWM_and_SS_control_ip_src_GenPWM
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          PWM_en_AXI                      :   IN    std_logic;
  ...
  COMPONENT PWM_and_SS_control_ip_src_VSI_Control_Signal_Switch
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : PWM_and_SS_control_ip_src_GenPWM
    USE ENTITY work.PWM_and_SS_control_ip_src_GenPWM(rtl);

  FOR ALL : PWM_and_SS_control_ip_src_VSI_Control_Signal_Switch
    USE ENTITY work.PWM_and_SS_control_ip_src_VSI_Control_Signal_Switch(rtl);
...
BEGIN
  ...
  u_GenPWM : PWM_and_SS_control_ip_src_GenPWM
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_VSI_Control_Signal_Switch : PWM_and_SS_control_ip_src_VSI_Control_Signal_Switch
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
