...
ARCHITECTURE rtl OF Incremental_Encoder_v26_src_Direction IS
  ...
  SIGNAL Trn_Right_1                      : signed(3 DOWNTO 0);  -- sfix4
  ...
  SIGNAL TrnLeft_2                        : signed(3 DOWNTO 0);  -- sfix4
...
BEGIN
  ...
  count_old_switch_out1_1 <= count_old_switch_out1 WHEN Edge_A = to_signed(16#0#, 4) ELSE
      A;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        count_old_switch_out1 <= '0';
      ELSIF enb = '1' THEN
        count_old_switch_out1 <= count_old_switch_out1_1;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Trn_Right_1 <= to_signed(16#0#, 4);
      ELSIF enb = '1' THEN
        Trn_Right_1 <= Trn_Right;
      END IF;
    END IF;
  ...
  switch_compare_1 <= '1' WHEN Trn_Right_1 >= to_signed(16#1#, 4) ELSE
      '0';
  ...
  count_old_switch1_out1_1 <= count_old_switch1_out1 WHEN Edge_B = to_signed(16#0#, 4) ELSE
      B;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        count_old_switch1_out1 <= '0';
      ELSIF enb = '1' THEN
        count_old_switch1_out1 <= count_old_switch1_out1_1;
      END IF;
    END IF;
  ...
  switch_compare_1_1 <= '1' WHEN TrnLeft_2 >= to_signed(16#1#, 4) ELSE
      '0';
