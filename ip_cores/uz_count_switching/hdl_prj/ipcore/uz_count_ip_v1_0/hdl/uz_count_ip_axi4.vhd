-- -------------------------------------------------------------
-- 
-- File Name: C:\utrazohm_sw_2\ultrazohm_sw\ip_cores\uz_count_switching\hdl_prj\hdlsrc\uz_count_switching\uz_count_ip_axi4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_count_ip_axi4
-- Source Path: uz_count_ip/uz_count_ip_axi4
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END uz_count_ip_axi4;


ARCHITECTURE rtl OF uz_count_ip_axi4 IS

  -- Component Declarations
  COMPONENT uz_count_ip_addr_decoder
  ...
  COMPONENT uz_count_ip_axi4_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_ARESETN                    :   IN    std_logic;  -- ufix1
          AXI4_AWID                       :   IN    std_logic_vector(11 DOWNTO 0);  -- ufix12
          AXI4_AWADDR                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  FOR ALL : uz_count_ip_addr_decoder
    USE ENTITY work.uz_count_ip_addr_decoder(rtl);

  FOR ALL : uz_count_ip_axi4_module
    USE ENTITY work.uz_count_ip_axi4_module(rtl);
...
BEGIN
  u_uz_count_ip_addr_decoder_inst : uz_count_ip_addr_decoder
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
              ...
              read_count_out_0_AXI => read_count_out_0_AXI,  -- ufix32
              read_count_out_1_AXI => read_count_out_1_AXI,  -- ufix32
              read_count_out_2_AXI => read_count_out_2_AXI,  -- ufix32
              read_count_out_3_AXI => read_count_out_3_AXI,  -- ufix32
              read_count_out_4_AXI => read_count_out_4_AXI,  -- ufix32
              read_count_out_5_AXI => read_count_out_5_AXI,  -- ufix32
              read_count_out_6_AXI => read_count_out_6_AXI,  -- ufix32
              read_count_out_7_AXI => read_count_out_7_AXI,  -- ufix32
              read_count_out_8_AXI => read_count_out_8_AXI,  -- ufix32
              read_count_out_sum_AXI1 => read_count_out_sum_AXI1,  -- ufix32
              data_read => top_data_read,  -- ufix32
              write_axi_enable => write_axi_enable,  -- ufix1
              write_bResetAXI => write_bResetAXI  -- ufix1
              );

  u_uz_count_ip_axi4_module_inst : uz_count_ip_axi4_module
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
