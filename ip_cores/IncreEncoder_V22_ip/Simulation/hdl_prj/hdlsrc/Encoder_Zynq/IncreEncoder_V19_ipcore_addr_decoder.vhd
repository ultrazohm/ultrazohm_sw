-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Encoder_Zynq\IncreEncoder_V19_ipcore_addr_decoder.vhd
-- Created: 2017-10-15 22:12:41
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: IncreEncoder_V19_ipcore_addr_decoder
-- Source Path: IncreEncoder_V19_ipcore/IncreEncoder_V19_ipcore_axi_lite/IncreEncoder_V19_ipcore_addr_decoder
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY IncreEncoder_V19_ipcore_addr_decoder IS
  PORT( clk                               :   IN    std_logic;
        ...
        read_omega_rps_AXI4               :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En8
...
END IncreEncoder_V19_ipcore_addr_decoder;


ARCHITECTURE rtl OF IncreEncoder_V19_ipcore_addr_decoder IS

  -- Signals
  SIGNAL enb                              : std_logic;
  SIGNAL addr_sel_unsigned                : unsigned(13 DOWNTO 0);  -- ufix14
  SIGNAL decode_sel_omega_rps_AXI4        : std_logic;  -- ufix1
  SIGNAL read_omega_rps_AXI4_signed       : signed(17 DOWNTO 0);  -- sfix18_En8
  SIGNAL const_1                          : std_logic;  -- ufix1
  SIGNAL read_direction_AXI4_signed       : signed(3 DOWNTO 0);  -- sfix4
  SIGNAL read_thete_el_AXI4_signed        : signed(23 DOWNTO 0);  -- sfix24_En20
  ...
  SIGNAL read_reg_omega_rps_AXI4          : signed(17 DOWNTO 0);  -- sfix18_En8
  SIGNAL data_in_omega_rps_AXI4           : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_omega_rps_AXI4         : unsigned(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL read_reg_thete_el_AXI4           : signed(23 DOWNTO 0);  -- sfix24_En20
  ...
  SIGNAL decode_sel_IncPerTurn_AXI4       : std_logic;  -- ufix1
  SIGNAL reg_enb_IncPerTurn_AXI4          : std_logic;  -- ufix1
  SIGNAL data_in_IncPerTurn_AXI4          : unsigned(15 DOWNTO 0);  -- ufix16
  SIGNAL write_reg_IncPerTurn_AXI4        : unsigned(15 DOWNTO 0);  -- ufix16
  SIGNAL decode_sel_Timer_FPGA_ms_AXI4    : std_logic;  -- ufix1
  SIGNAL reg_enb_Timer_FPGA_ms_AXI4       : std_logic;  -- ufix1
  SIGNAL data_in_Timer_FPGA_ms_AXI4       : unsigned(29 DOWNTO 0);  -- ufix30_En24
  SIGNAL write_reg_Timer_FPGA_ms_AXI4     : unsigned(29 DOWNTO 0);  -- ufix30_En24
...
BEGIN
  ...
  decode_sel_omega_rps_AXI4 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0046#, 14) ELSE
      '0';

  read_omega_rps_AXI4_signed <= signed(read_omega_rps_AXI4);
  ...
  read_thete_el_AXI4_signed <= signed(read_thete_el_AXI4);
  ...
  reg_omega_rps_AXI4_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        read_reg_omega_rps_AXI4 <= to_signed(16#00000#, 18);
      ELSIF enb = '1' THEN
        read_reg_omega_rps_AXI4 <= read_omega_rps_AXI4_signed;
      END IF;
    END IF;
  END PROCESS reg_omega_rps_AXI4_process;


  data_in_omega_rps_AXI4 <= unsigned(resize(read_reg_omega_rps_AXI4, 32));

  
  decode_rd_omega_rps_AXI4 <= const_0 WHEN decode_sel_omega_rps_AXI4 = '0' ELSE
      data_in_omega_rps_AXI4;
  ...
  decode_rd_direction_AXI4 <= decode_rd_omega_rps_AXI4 WHEN decode_sel_direction_AXI4 = '0' ELSE
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        read_reg_thete_el_AXI4 <= to_signed(16#000000#, 24);
      ELSIF enb = '1' THEN
        read_reg_thete_el_AXI4 <= read_thete_el_AXI4_signed;
      END IF;
    END IF;
  END PROCESS reg_thete_el_AXI4_process;


  data_in_thete_el_AXI4 <= unsigned(resize(read_reg_thete_el_AXI4, 32));
  ...
  decode_sel_IncPerTurn_AXI4 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0040#, 14) ELSE
      '0';

  reg_enb_IncPerTurn_AXI4 <= decode_sel_IncPerTurn_AXI4 AND wr_enb;

  data_in_IncPerTurn_AXI4 <= data_write_unsigned(15 DOWNTO 0);

  reg_IncPerTurn_AXI4_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        write_reg_IncPerTurn_AXI4 <= to_unsigned(16#0000#, 16);
      ELSIF enb = '1' AND reg_enb_IncPerTurn_AXI4 = '1' THEN
        write_reg_IncPerTurn_AXI4 <= data_in_IncPerTurn_AXI4;
      END IF;
    END IF;
  END PROCESS reg_IncPerTurn_AXI4_process;


  write_IncPerTurn_AXI4 <= std_logic_vector(write_reg_IncPerTurn_AXI4);
  ...
  data_in_Timer_FPGA_ms_AXI4 <= data_write_unsigned(29 DOWNTO 0);

  reg_Timer_FPGA_ms_AXI4_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        write_reg_Timer_FPGA_ms_AXI4 <= to_unsigned(16#00000000#, 30);
