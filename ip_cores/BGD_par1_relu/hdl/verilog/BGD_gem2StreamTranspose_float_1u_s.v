...
reg    ap_block_state1;
reg   [15:0] p_in_offset_read_reg_239;
wire  signed [15:0] empty_fu_143_p1;
reg  signed [15:0] empty_reg_244;
...
wire  signed [15:0] grp_fu_226_p3;
(* use_dsp48 = "no" *) wire   [15:0] sum_i_fu_212_p2;
...
assign empty_fu_143_p1 = p_k_dout[15:0];

assign grp_fu_226_p1 = select_ln172_fu_177_p3[15:0];

assign grp_fu_226_p2 = select_ln172_1_fu_201_p3[15:0];
