-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_mpc_cost_and_optim_state_machine\uz_6ph_delay_ip_src_uz_6ph_mpc_delay_comp.vhd
-- Created: 2022-10-04 11:18:43
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: uz_6ph_delay_ip_src_uz_6ph_mpc_delay_comp
-- Source Path: uz_mpc_cost_and_optim_state_machine/uz_6ph_mpc_delay_comp
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
USE work.uz_6ph_delay_ip_src_uz_6ph_mpc_delay_comp_pkg.ALL;

ENTITY uz_6ph_delay_ip_src_uz_6ph_mpc_delay_comp IS
...
END uz_6ph_delay_ip_src_uz_6ph_mpc_delay_comp;


ARCHITECTURE rtl OF uz_6ph_delay_ip_src_uz_6ph_mpc_delay_comp IS

  -- Component Declarations
  COMPONENT uz_6ph_delay_ip_src_Detect_Rise_Positive
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  COMPONENT uz_6ph_delay_ip_src_Detect_Rise_Positive1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  COMPONENT uz_6ph_delay_ip_src_Subsystem
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          Set                             :   IN    std_logic;
  ...
  FOR ALL : uz_6ph_delay_ip_src_Detect_Rise_Positive
    USE ENTITY work.uz_6ph_delay_ip_src_Detect_Rise_Positive(rtl);

  FOR ALL : uz_6ph_delay_ip_src_Detect_Rise_Positive1
    USE ENTITY work.uz_6ph_delay_ip_src_Detect_Rise_Positive1(rtl);

  FOR ALL : uz_6ph_delay_ip_src_Subsystem
    USE ENTITY work.uz_6ph_delay_ip_src_Subsystem(rtl);
...
BEGIN
  -- mpc state machine - just calculate once with the voltages of the last optim. index. Then reset the S flip flop 
  -- and onl
  -- get triggered again with the next adc trigger
  -- 
  ...
  u_Detect_Rise_Positive : uz_6ph_delay_ip_src_Detect_Rise_Positive
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              U => Delay_out1,
  ...
  u_Detect_Rise_Positive1 : uz_6ph_delay_ip_src_Detect_Rise_Positive1
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              U => Delay50_out1,
  ...
  u_Subsystem : uz_6ph_delay_ip_src_Subsystem
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              Set => Detect_Rise_Positive_out1,
              Reset_1 => delay_comp_done_2,
              Q => Q
              );
  ...
  id_delay_pu <= std_logic_vector(From16_out1);
  ...
  iq_delay_pu <= std_logic_vector(From19_out1);
  ...
  ix_delay_pu <= std_logic_vector(From20_out1);
  ...
  iy_delay_pu <= std_logic_vector(From21_out1);

  id_delay_pu_AXI <= std_logic_vector(From16_out1);

  iq_delay_pu_AXI <= std_logic_vector(From19_out1);

  ix_delay_pu_AXI <= std_logic_vector(From20_out1);

  iy_delay_pu_AXI <= std_logic_vector(From21_out1);
  ...
  delay_comp_done_3 <= TmpGroundAtSwitch4Inport3_out1 WHEN switch_compare_1_18 = '0' ELSE
      delay_comp_done_1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        delay_comp_done_2 <= '0';
      ELSIF enb = '1' THEN
        delay_comp_done_2 <= delay_comp_done_3;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        delay_comp_done <= '0';
      ELSIF enb = '1' THEN
        delay_comp_done <= delay_comp_done_2;
      END IF;
    END IF;
