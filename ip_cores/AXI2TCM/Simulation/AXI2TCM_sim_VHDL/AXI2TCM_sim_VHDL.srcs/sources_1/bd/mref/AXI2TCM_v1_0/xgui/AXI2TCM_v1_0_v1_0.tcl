...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_M00_NUMBER_of_ADCs" -parent ${Page_0}
...
proc update_PARAM_VALUE.C_M00_NUMBER_of_ADCs { PARAM_VALUE.C_M00_NUMBER_of_ADCs } {
	# Procedure called to update C_M00_NUMBER_of_ADCs when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_M00_NUMBER_of_ADCs { PARAM_VALUE.C_M00_NUMBER_of_ADCs } {
	# Procedure called to validate C_M00_NUMBER_of_ADCs
	return true
}


proc update_MODELPARAM_VALUE.C_M00_NUMBER_of_ADCs { MODELPARAM_VALUE.C_M00_NUMBER_of_ADCs PARAM_VALUE.C_M00_NUMBER_of_ADCs } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_M00_NUMBER_of_ADCs}] ${MODELPARAM_VALUE.C_M00_NUMBER_of_ADCs}
}
