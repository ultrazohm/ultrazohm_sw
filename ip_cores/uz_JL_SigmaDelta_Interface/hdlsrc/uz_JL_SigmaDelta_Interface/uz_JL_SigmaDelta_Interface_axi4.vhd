-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\jonat\Documents\ultrazohm_sw\ip_cores\uz_JL_SigmaDelta_Interface\hdlsrc\uz_JL_SigmaDelta_Interface\uz_JL_SigmaDelta_Interface_axi4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_JL_SigmaDelta_Interface_axi4
-- Source Path: uz_JL_SigmaDelta_Interface/uz_JL_SigmaDelta_Interface_axi4
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_JL_SigmaDelta_Interface_axi4 IS
...
END uz_JL_SigmaDelta_Interface_axi4;


ARCHITECTURE rtl OF uz_JL_SigmaDelta_Interface_axi4 IS

  -- Component Declarations
  COMPONENT uz_JL_SigmaDelta_Interface_addr_decoder
  ...
  COMPONENT uz_JL_SigmaDelta_Interface_axi4_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_ARESETN                    :   IN    std_logic;  -- ufix1
          AXI4_AWID                       :   IN    std_logic_vector(11 DOWNTO 0);  -- ufix12
          AXI4_AWADDR                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  FOR ALL : uz_JL_SigmaDelta_Interface_addr_decoder
    USE ENTITY work.uz_JL_SigmaDelta_Interface_addr_decoder(rtl);

  FOR ALL : uz_JL_SigmaDelta_Interface_axi4_module
    USE ENTITY work.uz_JL_SigmaDelta_Interface_axi4_module(rtl);
  ...
  SIGNAL write_Dezimation_tmp             : std_logic_vector(15 DOWNTO 0);  -- ufix16
...
BEGIN
  u_uz_JL_SigmaDelta_Interface_addr_decoder_inst : uz_JL_SigmaDelta_Interface_addr_decoder
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
              ...
              read_data_out_ps => read_data_out_ps,  -- sfix32 [5]
              ...
              write_Dezimation => write_Dezimation_tmp,  -- ufix16
  ...
  u_uz_JL_SigmaDelta_Interface_axi4_module_inst : uz_JL_SigmaDelta_Interface_axi4_module
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
  ...
  write_Dezimation <= write_Dezimation_tmp;
