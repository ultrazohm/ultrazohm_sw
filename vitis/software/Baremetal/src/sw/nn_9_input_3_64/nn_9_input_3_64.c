...
[0] = {
    ...
    .length_of_weights = UZ_MATRIX_SIZE(w_4_9),
    .length_of_bias = UZ_MATRIX_SIZE(b_4_9),
    .length_of_output = UZ_MATRIX_SIZE(y_4_9),
    .weights = w_4_9,
    .bias = b_4_9,
    .output = y_4_9}
};
