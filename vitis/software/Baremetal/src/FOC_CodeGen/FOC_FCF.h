...
typedef struct {
  ...
  uint32_T get_U_HS_FLT;               /* '<S50>/get_U_HS_FLT' */
  uint32_T MaskBit1;                   /* '<S50>/MaskBit1' */
  uint32_T get_U_LS_FLT;               /* '<S50>/get_U_LS_FLT' */
  uint32_T MaskBit2;                   /* '<S50>/MaskBit2' */
  uint32_T get_V_HS_FLT;               /* '<S50>/get_V_HS_FLT' */
  uint32_T MaskBit3;                   /* '<S50>/MaskBit3' */
  uint32_T get_V_LS_FLT;               /* '<S50>/get_V_LS_FLT' */
  uint32_T MaskBit4;                   /* '<S50>/MaskBit4' */
  uint32_T get_W_HS_FLT;               /* '<S50>/get_W_HS_FLT' */
  uint32_T MaskBit5;                   /* '<S50>/MaskBit5' */
  uint32_T get_W_LS_FLT;               /* '<S50>/get_W_LS_FLT' */
  uint32_T Mask_6Bits_Inv1_RDY;        /* '<S8>/Mask_6Bits_Inv1_RDY' */
  uint32_T MaskBit0_c;                 /* '<S51>/MaskBit0' */
  uint32_T get_U_HS_RDY;               /* '<S51>/get_U_HS_RDY' */
  uint32_T MaskBit1_b;                 /* '<S51>/MaskBit1' */
  uint32_T get_U_LS_RDY;               /* '<S51>/get_U_LS_RDY' */
  uint32_T MaskBit2_n;                 /* '<S51>/MaskBit2' */
  uint32_T get_V_HS_RDY;               /* '<S51>/get_V_HS_RDY' */
  uint32_T MaskBit3_a;                 /* '<S51>/MaskBit3' */
  uint32_T get_V_LS_RDY;               /* '<S51>/get_V_LS_RDY' */
  uint32_T MaskBit4_c;                 /* '<S51>/MaskBit4' */
  uint32_T get_W_HS_RDY;               /* '<S51>/get_W_HS_RDY' */
  uint32_T MaskBit5_l;                 /* '<S51>/MaskBit5' */
  uint32_T get_W_LS_RDY;               /* '<S51>/get_W_LS_RDY' */
  uint32_T Mask_6Bits_Inv2_FLT;        /* '<S8>/Mask_6Bits_Inv2_FLT' */
  uint32_T BitwiseNOT_j;               /* '<S52>/Bitwise NOT' */
  uint32_T MaskBit0_o;                 /* '<S52>/MaskBit0' */
  uint32_T get_U_HS_FLT_i;             /* '<S52>/get_U_HS_FLT' */
  uint32_T MaskBit1_ba;                /* '<S52>/MaskBit1' */
  uint32_T get_U_LS_FLT_a;             /* '<S52>/get_U_LS_FLT' */
  uint32_T MaskBit2_d;                 /* '<S52>/MaskBit2' */
  uint32_T get_V_HS_FLT_i;             /* '<S52>/get_V_HS_FLT' */
  uint32_T MaskBit3_d;                 /* '<S52>/MaskBit3' */
  uint32_T get_V_LS_FLT_c;             /* '<S52>/get_V_LS_FLT' */
  uint32_T MaskBit4_p;                 /* '<S52>/MaskBit4' */
  uint32_T get_W_HS_FLT_f;             /* '<S52>/get_W_HS_FLT' */
  uint32_T MaskBit5_o;                 /* '<S52>/MaskBit5' */
  uint32_T get_W_LS_FLT_l;             /* '<S52>/get_W_LS_FLT' */
  uint32_T Mask_6Bits_Inv2_RDY;        /* '<S8>/Mask_6Bits_Inv2_RDY' */
  uint32_T MaskBit0_p;                 /* '<S53>/MaskBit0' */
  uint32_T get_U_HS_RDY_i;             /* '<S53>/get_U_HS_RDY' */
  uint32_T MaskBit1_m;                 /* '<S53>/MaskBit1' */
  uint32_T get_U_LS_RDY_f;             /* '<S53>/get_U_LS_RDY' */
  uint32_T MaskBit2_g;                 /* '<S53>/MaskBit2' */
  uint32_T get_V_HS_RDY_j;             /* '<S53>/get_V_HS_RDY' */
  uint32_T MaskBit3_k;                 /* '<S53>/MaskBit3' */
  uint32_T get_V_LS_RDY_a;             /* '<S53>/get_V_LS_RDY' */
  uint32_T MaskBit4_l;                 /* '<S53>/MaskBit4' */
  uint32_T get_W_HS_RDY_n;             /* '<S53>/get_W_HS_RDY' */
  uint32_T MaskBit5_lb;                /* '<S53>/MaskBit5' */
  uint32_T get_W_LS_RDY_l;             /* '<S53>/get_W_LS_RDY' */
  uint32_T Mask_6Bits_Inv3_FLT;        /* '<S8>/Mask_6Bits_Inv3_FLT' */
  uint32_T BitwiseNOT_c;               /* '<S54>/Bitwise NOT' */
  uint32_T MaskBit0_ph;                /* '<S54>/MaskBit0' */
  uint32_T get_U_HS_FLT_m;             /* '<S54>/get_U_HS_FLT' */
  uint32_T MaskBit1_k;                 /* '<S54>/MaskBit1' */
  uint32_T get_U_LS_FLT_h;             /* '<S54>/get_U_LS_FLT' */
  uint32_T MaskBit2_f;                 /* '<S54>/MaskBit2' */
  uint32_T get_V_HS_FLT_h;             /* '<S54>/get_V_HS_FLT' */
  uint32_T MaskBit3_a2;                /* '<S54>/MaskBit3' */
  uint32_T get_V_LS_FLT_g;             /* '<S54>/get_V_LS_FLT' */
  uint32_T MaskBit4_f;                 /* '<S54>/MaskBit4' */
  uint32_T get_W_HS_FLT_m;             /* '<S54>/get_W_HS_FLT' */
  uint32_T MaskBit5_h;                 /* '<S54>/MaskBit5' */
  uint32_T get_W_LS_FLT_g;             /* '<S54>/get_W_LS_FLT' */
  uint32_T Mask_6Bits_Inv3_RDY;        /* '<S8>/Mask_6Bits_Inv3_RDY' */
  uint32_T MaskBit0_k;                 /* '<S55>/MaskBit0' */
  uint32_T get_U_HS_RDY_e;             /* '<S55>/get_U_HS_RDY' */
  uint32_T MaskBit1_o;                 /* '<S55>/MaskBit1' */
  uint32_T get_U_LS_RDY_l;             /* '<S55>/get_U_LS_RDY' */
  uint32_T MaskBit2_a;                 /* '<S55>/MaskBit2' */
  uint32_T get_V_HS_RDY_e;             /* '<S55>/get_V_HS_RDY' */
  uint32_T MaskBit3_kg;                /* '<S55>/MaskBit3' */
  uint32_T get_V_LS_RDY_k;             /* '<S55>/get_V_LS_RDY' */
  uint32_T MaskBit4_ch;                /* '<S55>/MaskBit4' */
  uint32_T get_W_HS_RDY_h;             /* '<S55>/get_W_HS_RDY' */
  uint32_T MaskBit5_p;                 /* '<S55>/MaskBit5' */
  uint32_T get_W_LS_RDY_m;             /* '<S55>/get_W_LS_RDY' */
  ...
  real32_T U_DC_Undervoltage_Error;    /* '<S64>/Selectphicalc1' */
  real32_T U_DC_Overvoltage_Error;     /* '<S64>/Selectphicalc2' */
  real32_T Abs[9];                     /* '<S63>/Abs' */
  real32_T MinMax;                     /* '<S63>/MinMax' */
  ...
  real32_T Product_h;                  /* '<S62>/Product' */
  real32_T UnitDelay_j;                /* '<S62>/Unit Delay' */
  real32_T Add_mp;                     /* '<S62>/Add' */
  real32_T Use_If_Mode[2];             /* '<S1>/Use_If_Mode' */
  real32_T TrigonometricFunction1;     /* '<S34>/Trigonometric Function1' */
  real32_T TrafoProd;                  /* '<S34>/TrafoProd' */
  real32_T TrigonometricFunction;      /* '<S34>/Trigonometric Function' */
  real32_T TrafoProd3;                 /* '<S34>/TrafoProd3' */
  real32_T I_d1_Act;                   /* '<S34>/I_d1_Act' */
  ...
  real32_T TrigonometricFunction1_b;   /* '<S35>/Trigonometric Function1' */
  real32_T TrafoProd_a;                /* '<S35>/TrafoProd' */
  real32_T TrigonometricFunction_l;    /* '<S35>/Trigonometric Function' */
  real32_T TrafoProd3_i;               /* '<S35>/TrafoProd3' */
  real32_T TrafoSum;                   /* '<S35>/TrafoSum' */
  ...
  real32_T Product1_k;                 /* '<S42>/Product1' */
  real32_T IntegEnaSwitch1_n[2];       /* '<S42>/IntegEnaSwitch1' */
  real32_T TrafoMatrixuvwalphabeta_m[2];/* '<S36>/TrafoMatrix uvw->alphabeta' */
  real32_T Sum2_m;                     /* '<S6>/Sum2' */
  real32_T TrigonometricFunction1_k;   /* '<S36>/Trigonometric Function1' */
  real32_T TrafoProd_n;                /* '<S36>/TrafoProd' */
  real32_T TrigonometricFunction_k;    /* '<S36>/Trigonometric Function' */
  real32_T TrafoProd3_o;               /* '<S36>/TrafoProd3' */
  real32_T TrafoSum_n;                 /* '<S36>/TrafoSum' */
  ...
  real32_T Product1_b;                 /* '<S46>/Product1' */
  real32_T IntegEnaSwitch1_h[2];       /* '<S46>/IntegEnaSwitch1' */
  ...
  real32_T Sign_d;                     /* '<S62>/Sign' */
  real32_T Gain1_j;                    /* '<S62>/Gain1' */
  real32_T IntegStopSwitch3[2];        /* '<S46>/IntegStopSwitch3' */
  real32_T IntSum2[2];                 /* '<S46>/IntSum2' */
  real32_T FOC_IntegDamp[2];           /* '<S46>/FOC_IntegDamp' */
  real32_T antiWindupProd[2];          /* '<S45>/antiWindupProd' */
  real32_T IntegStopSwitch1[2];        /* '<S46>/IntegStopSwitch1' */
  real32_T Product2_e[2];              /* '<S46>/Product2' */
  real32_T IntSum1[2];                 /* '<S46>/IntSum1' */
  real32_T IntegStopSwitch3_n[2];      /* '<S42>/IntegStopSwitch3' */
  real32_T IntSum2_f[2];               /* '<S42>/IntSum2' */
  real32_T FOC_IntegDamp_g[2];         /* '<S42>/FOC_IntegDamp' */
  real32_T antiWindupProd_d[2];        /* '<S41>/antiWindupProd' */
  real32_T IntegStopSwitch1_g[2];      /* '<S42>/IntegStopSwitch1' */
  real32_T Product2_b[2];              /* '<S42>/Product2' */
  real32_T IntSum1_l[2];               /* '<S42>/IntSum1' */
  real32_T IntegStopSwitch3_h[2];      /* '<S38>/IntegStopSwitch3' */
  real32_T IntSum2_j[2];               /* '<S38>/IntSum2' */
  real32_T FOC_IntegDamp_c[2];         /* '<S38>/FOC_IntegDamp' */
  real32_T antiWindupProd_o[2];        /* '<S37>/antiWindupProd' */
  real32_T IntegStopSwitch1_f[2];      /* '<S38>/IntegStopSwitch1' */
  real32_T Product2_j[2];              /* '<S38>/Product2' */
  real32_T IntSum1_p[2];               /* '<S38>/IntSum1' */
  ...
  uint8_T Compare_k;                   /* '<S47>/Compare' */
  uint8_T Compare_g;                   /* '<S44>/Compare' */
  uint8_T Compare_i;                   /* '<S43>/Compare' */
  uint8_T Compare_o;                   /* '<S40>/Compare' */
  uint8_T Compare_f;                   /* '<S39>/Compare' */
  boolean_T Compare_e;                 /* '<S80>/Compare' */
  boolean_T LogicalOperator2;          /* '<S64>/Logical Operator2' */
  boolean_T LogicalOperator4;          /* '<S64>/Logical Operator4' */
  boolean_T Compare_d;                 /* '<S87>/Compare' */
  boolean_T Uk1;                       /* '<S83>/Delay Input1' */
  boolean_T Selectphicalc3;            /* '<S64>/Selectphicalc3' */
  boolean_T Memory;                    /* '<S84>/Memory' */
  boolean_T Logic[2];                  /* '<S84>/Logic' */
  boolean_T Compare_n;                 /* '<S81>/Compare' */
  boolean_T LogicalOperator3;          /* '<S64>/Logical Operator3' */
  boolean_T Compare_iz;                /* '<S86>/Compare' */
  boolean_T Uk1_m;                     /* '<S82>/Delay Input1' */
  boolean_T Selectphicalc4;            /* '<S64>/Selectphicalc4' */
  boolean_T Memory_o;                  /* '<S85>/Memory' */
  boolean_T Logic_c[2];                /* '<S85>/Logic' */
  boolean_T Compare_j;                 /* '<S65>/Compare' */
  boolean_T LogicalOperator3_i;        /* '<S63>/Logical Operator3' */
  boolean_T Compare_in;                /* '<S70>/Compare' */
  boolean_T Uk1_g;                     /* '<S67>/Delay Input1' */
  boolean_T Selectphicalc2_m;          /* '<S63>/Selectphicalc2' */
  boolean_T Memory_n;                  /* '<S69>/Memory' */
  boolean_T Logic_a[2];                /* '<S69>/Logic' */
  boolean_T I_ph_Overcurrent_Error;    /* '<S63>/Selectphicalc1' */
  ...
  boolean_T Compare_gt;                /* '<S91>/Compare' */
  boolean_T Uk1_h;                     /* '<S89>/Delay Input1' */
  ...
  boolean_T Compare_gv[9];             /* '<S66>/Compare' */
  boolean_T Memory_f;                  /* '<S71>/Memory' */
  boolean_T Logic_g[2];                /* '<S71>/Logic' */
  boolean_T Memory_b;                  /* '<S72>/Memory' */
  boolean_T Logic_i[2];                /* '<S72>/Logic' */
  boolean_T Memory_ok;                 /* '<S73>/Memory' */
  boolean_T Logic_b[2];                /* '<S73>/Logic' */
  boolean_T Memory_c;                  /* '<S74>/Memory' */
  boolean_T Logic_p[2];                /* '<S74>/Logic' */
  boolean_T Memory_g;                  /* '<S75>/Memory' */
  boolean_T Logic_d[2];                /* '<S75>/Logic' */
  boolean_T Memory_j;                  /* '<S76>/Memory' */
  boolean_T Logic_ev[2];               /* '<S76>/Logic' */
  boolean_T Memory_nb;                 /* '<S77>/Memory' */
  boolean_T Logic_bw[2];               /* '<S77>/Logic' */
  boolean_T Memory_kp;                 /* '<S78>/Memory' */
  ...
  boolean_T AntiWindupLE_f;            /* '<S41>/AntiWindupLE' */
  boolean_T AntiWindupOR_q_l;          /* '<S41>/AntiWindupOR_q' */
  boolean_T AntiWindupOR_d_m;          /* '<S41>/AntiWindupOR_d' */
  boolean_T AntiWindupLE_l;            /* '<S37>/AntiWindupLE' */
  boolean_T AntiWindupOR_q_o;          /* '<S37>/AntiWindupOR_q' */
  boolean_T AntiWindupOR_d_e;          /* '<S37>/AntiWindupOR_d' */
} B_FOC_FCF_T;
...
typedef struct {
  ...
  real32_T UnitDelay_DSTATE_f;         /* '<S62>/Unit Delay' */
  real32_T IntegDelay1_DSTATE[2];      /* '<S38>/IntegDelay1' */
  ...
  boolean_T Memory_PreviousInput_nm;   /* '<S73>/Memory' */
  boolean_T Memory_PreviousInput_ef;   /* '<S74>/Memory' */
  boolean_T Memory_PreviousInput_c;    /* '<S75>/Memory' */
  boolean_T Memory_PreviousInput_d;    /* '<S76>/Memory' */
  boolean_T Memory_PreviousInput_os;   /* '<S77>/Memory' */
  boolean_T Memory_PreviousInput_f;    /* '<S78>/Memory' */
  boolean_T Memory_PreviousInput_b;    /* '<S79>/Memory' */
} DW_FOC_FCF_T;
 ...
 * '<S31>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/Current_Controller/PI_Controller_1'
 * '<S32>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/Current_Controller/PI_Controller_2'
 * '<S33>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/Current_Controller/PI_Controller_3'
 * '<S34>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/Current_Controller/UVW_DQ_1'
 * '<S35>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/Current_Controller/UVW_DQ_2'
 * '<S36>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/Current_Controller/UVW_DQ_3'
 * '<S37>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/Current_Controller/PI_Controller_1/AntiWindup'
 * '<S38>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/Current_Controller/PI_Controller_1/FeedbackPI'
 * '<S39>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/Current_Controller/PI_Controller_1/AntiWindup/AntiWindupGT_d'
 * '<S40>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/Current_Controller/PI_Controller_1/AntiWindup/AntiWindupGT_q'
 * '<S41>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/Current_Controller/PI_Controller_2/AntiWindup'
 * '<S42>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/Current_Controller/PI_Controller_2/FeedbackPI'
 * '<S43>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/Current_Controller/PI_Controller_2/AntiWindup/AntiWindupGT_d'
 * '<S44>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/Current_Controller/PI_Controller_2/AntiWindup/AntiWindupGT_q'
 * '<S45>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/Current_Controller/PI_Controller_3/AntiWindup'
 * '<S46>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/Current_Controller/PI_Controller_3/FeedbackPI'
 * '<S47>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/Current_Controller/PI_Controller_3/AntiWindup/AntiWindupGT_d'
 * '<S48>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/Current_Controller/PI_Controller_3/AntiWindup/AntiWindupGT_q'
 * '<S49>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/Error_Handling/Gate_Driver_FLT_RDY_Error'
 * '<S50>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/Gate_Driver_Status/Inv1_FLT'
 * '<S51>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/Gate_Driver_Status/Inv1_RDY'
 * '<S52>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/Gate_Driver_Status/Inv2_FLT'
 * '<S53>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/Gate_Driver_Status/Inv2_RDY'
 * '<S54>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/Gate_Driver_Status/Inv3_FLT'
 * '<S55>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/Gate_Driver_Status/Inv3_RDY'
 * '<S56>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/Gate_Driver_Status/Inv1_FLT/Compare To Zero'
 * '<S57>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/Gate_Driver_Status/Inv1_RDY/Compare To Constant'
 * '<S58>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/Gate_Driver_Status/Inv2_FLT/Compare To Zero'
 * '<S59>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/Gate_Driver_Status/Inv2_RDY/Compare To Constant'
 * '<S60>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/Gate_Driver_Status/Inv3_FLT/Compare To Zero'
 * '<S61>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/Gate_Driver_Status/Inv3_RDY/Compare To Constant'
 * '<S62>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/I_f/SubS_2pi_Integrator'
 * '<S63>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/OC_OV_UV_Diagnosis/OC_Detection'
 * '<S64>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/OC_OV_UV_Diagnosis/OV_UV_Detection'
 * '<S65>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/OC_OV_UV_Diagnosis/OC_Detection/Compare To Constant'
 * '<S66>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/OC_OV_UV_Diagnosis/OC_Detection/Compare To Constant1'
 * '<S67>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/OC_OV_UV_Diagnosis/OC_Detection/Detect Rise Positive'
 * '<S68>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/OC_OV_UV_Diagnosis/OC_Detection/Overcurrent_Latching'
 * '<S69>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/OC_OV_UV_Diagnosis/OC_Detection/S-R Flip-Flop'
 * '<S70>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/OC_OV_UV_Diagnosis/OC_Detection/Detect Rise Positive/Positive'
 * '<S71>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/OC_OV_UV_Diagnosis/OC_Detection/Overcurrent_Latching/OverTemp_Latching_1'
 * '<S72>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/OC_OV_UV_Diagnosis/OC_Detection/Overcurrent_Latching/OverTemp_Latching_2'
 * '<S73>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/OC_OV_UV_Diagnosis/OC_Detection/Overcurrent_Latching/OverTemp_Latching_3'
 * '<S74>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/OC_OV_UV_Diagnosis/OC_Detection/Overcurrent_Latching/OverTemp_Latching_4'
 * '<S75>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/OC_OV_UV_Diagnosis/OC_Detection/Overcurrent_Latching/OverTemp_Latching_5'
 * '<S76>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/OC_OV_UV_Diagnosis/OC_Detection/Overcurrent_Latching/OverTemp_Latching_6'
 * '<S77>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/OC_OV_UV_Diagnosis/OC_Detection/Overcurrent_Latching/OverTemp_Latching_7'
 * '<S78>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/OC_OV_UV_Diagnosis/OC_Detection/Overcurrent_Latching/OverTemp_Latching_8'
 * '<S79>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/OC_OV_UV_Diagnosis/OC_Detection/Overcurrent_Latching/OverTemp_Latching_9'
 * '<S80>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/OC_OV_UV_Diagnosis/OV_UV_Detection/Compare To Constant'
 * '<S81>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/OC_OV_UV_Diagnosis/OV_UV_Detection/Compare To Constant1'
 * '<S82>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/OC_OV_UV_Diagnosis/OV_UV_Detection/Detect Rise Positive'
 * '<S83>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/OC_OV_UV_Diagnosis/OV_UV_Detection/Detect Rise Positive1'
 * '<S84>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/OC_OV_UV_Diagnosis/OV_UV_Detection/S-R Flip-Flop'
 * '<S85>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/OC_OV_UV_Diagnosis/OV_UV_Detection/S-R Flip-Flop1'
 * '<S86>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/OC_OV_UV_Diagnosis/OV_UV_Detection/Detect Rise Positive/Positive'
 * '<S87>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/OC_OV_UV_Diagnosis/OV_UV_Detection/Detect Rise Positive1/Positive'
 * '<S88>'  : 'MotorControl_HeadModel/Motor_Control_Model/FOC_FCF/Overspeed_Diagnosis/Compare To Constant1'
