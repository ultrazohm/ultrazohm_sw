-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\FCS_MPC_3Phase_SPMSM\hdlsrc\FCS_MPC_3Phase_SPMSM_V1\FCS_MPC_3Phase_SPMSM_V1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: FCS_MPC_3Phase_SPMSM_V1
-- Source Path: FCS_MPC_3Phase_SPMSM_V1
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY FCS_MPC_3Phase_SPMSM_V1 IS
...
END FCS_MPC_3Phase_SPMSM_V1;


ARCHITECTURE rtl OF FCS_MPC_3Phase_SPMSM_V1 IS

  -- Component Declarations
  COMPONENT FCS_MPC_3Phase_SPMSM_V1_reset_sync
  ...
  COMPONENT FCS_MPC_3Phase_SPMSM_V1_axi_lite
  ...
  COMPONENT FCS_MPC_3Phase_SPMSM_V1_dut
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          ...
          u_dc_link_AXI                   :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
          SampleTime_AXI                  :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  FOR ALL : FCS_MPC_3Phase_SPMSM_V1_reset_sync
    USE ENTITY work.FCS_MPC_3Phase_SPMSM_V1_reset_sync(rtl);

  FOR ALL : FCS_MPC_3Phase_SPMSM_V1_axi_lite
    USE ENTITY work.FCS_MPC_3Phase_SPMSM_V1_axi_lite(rtl);

  FOR ALL : FCS_MPC_3Phase_SPMSM_V1_dut
    USE ENTITY work.FCS_MPC_3Phase_SPMSM_V1_dut(rtl);
  ...
  SIGNAL write_u_dc_link_AXI              : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_SampleTime_AXI             : std_logic_vector(31 DOWNTO 0);  -- ufix32
...
BEGIN
  u_FCS_MPC_3Phase_SPMSM_V1_reset_sync_inst : FCS_MPC_3Phase_SPMSM_V1_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_FCS_MPC_3Phase_SPMSM_V1_axi_lite_inst : FCS_MPC_3Phase_SPMSM_V1_axi_lite
    PORT MAP( reset => reset,
              ...
              write_u_dc_link_AXI => write_u_dc_link_AXI,  -- ufix32
              write_SampleTime_AXI => write_SampleTime_AXI,  -- ufix32
  ...
  u_FCS_MPC_3Phase_SPMSM_V1_dut_inst : FCS_MPC_3Phase_SPMSM_V1_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              ...
              u_dc_link_AXI => write_u_dc_link_AXI,  -- ufix32
              SampleTime_AXI => write_SampleTime_AXI,  -- ufix32
  ...
  ip_timestamp <= unsigned'(X"838DFFB5");
