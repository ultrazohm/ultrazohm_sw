-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\valen\Documents\repos\UZ\ultrazohm_sw_working\ip_cores\uz_threephase_VSD_transformation\hdl_pj\hdlsrc\uz_threephase_VSD_transformation\uz_threephase_VSD_transformation_axi4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_threephase_VSD_transformation_axi4
-- Source Path: uz_threephase_VSD_transformation/uz_threephase_VSD_transformation_axi4
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_threephase_VSD_transformation_axi4 IS
...
END uz_threephase_VSD_transformation_axi4;


ARCHITECTURE rtl OF uz_threephase_VSD_transformation_axi4 IS

  -- Component Declarations
  COMPONENT uz_threephase_VSD_transformation_addr_decoder
  ...
  COMPONENT uz_threephase_VSD_transformation_axi4_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_ARESETN                    :   IN    std_logic;  -- ufix1
          AXI4_AWID                       :   IN    std_logic_vector(11 DOWNTO 0);  -- ufix12
          AXI4_AWADDR                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  FOR ALL : uz_threephase_VSD_transformation_addr_decoder
    USE ENTITY work.uz_threephase_VSD_transformation_addr_decoder(rtl);

  FOR ALL : uz_threephase_VSD_transformation_axi4_module
    USE ENTITY work.uz_threephase_VSD_transformation_axi4_module(rtl);
...
BEGIN
  u_uz_threephase_VSD_transformation_addr_decoder_inst : uz_threephase_VSD_transformation_addr_decoder
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
              ...
              read_x_abc_out_axi => read_x_abc_out_axi,  -- sfix27_En18 [3]
              data_read => top_data_read,  -- ufix32
              write_axi_enable => write_axi_enable  -- ufix1
              );

  u_uz_threephase_VSD_transformation_axi4_module_inst : uz_threephase_VSD_transformation_axi4_module
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
