...
ARCHITECTURE rtl OF uz_resolver_mech_rev_calc_src_uz_resolver_mech_rev_calc IS
  ...
  SIGNAL delayMatch16_reg                 : vector_of_signed24(0 TO 48);  -- sfix24 [49]
  SIGNAL delayMatch16_reg_next            : vector_of_signed24(0 TO 48);  -- sfix24_En11 [49]
  ...
  SIGNAL delayMatch17_reg                 : vector_of_signed24(0 TO 56);  -- sfix24 [57]
  SIGNAL delayMatch17_reg_next            : vector_of_signed24(0 TO 56);  -- sfix24_En11 [57]
  ...
  SIGNAL reduced_reg_8                    : std_logic_vector(0 TO 110);  -- ufix1 [111]
  SIGNAL reduced_reg_next_8               : std_logic_vector(0 TO 110);  -- ufix1 [111]
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        delayMatch16_reg(0) <= to_signed(16#000000#, 24);
        delayMatch16_reg(1) <= to_signed(16#000000#, 24);
        delayMatch16_reg(2) <= to_signed(16#000000#, 24);
        delayMatch16_reg(3) <= to_signed(16#000000#, 24);
        delayMatch16_reg(4) <= to_signed(16#000000#, 24);
        delayMatch16_reg(5) <= to_signed(16#000000#, 24);
        delayMatch16_reg(6) <= to_signed(16#000000#, 24);
        delayMatch16_reg(7) <= to_signed(16#000000#, 24);
        delayMatch16_reg(8) <= to_signed(16#000000#, 24);
        delayMatch16_reg(9) <= to_signed(16#000000#, 24);
        delayMatch16_reg(10) <= to_signed(16#000000#, 24);
        delayMatch16_reg(11) <= to_signed(16#000000#, 24);
        delayMatch16_reg(12) <= to_signed(16#000000#, 24);
        delayMatch16_reg(13) <= to_signed(16#000000#, 24);
        delayMatch16_reg(14) <= to_signed(16#000000#, 24);
        delayMatch16_reg(15) <= to_signed(16#000000#, 24);
        delayMatch16_reg(16) <= to_signed(16#000000#, 24);
        delayMatch16_reg(17) <= to_signed(16#000000#, 24);
        delayMatch16_reg(18) <= to_signed(16#000000#, 24);
        delayMatch16_reg(19) <= to_signed(16#000000#, 24);
        delayMatch16_reg(20) <= to_signed(16#000000#, 24);
        delayMatch16_reg(21) <= to_signed(16#000000#, 24);
        delayMatch16_reg(22) <= to_signed(16#000000#, 24);
        delayMatch16_reg(23) <= to_signed(16#000000#, 24);
        delayMatch16_reg(24) <= to_signed(16#000000#, 24);
        delayMatch16_reg(25) <= to_signed(16#000000#, 24);
        delayMatch16_reg(26) <= to_signed(16#000000#, 24);
        delayMatch16_reg(27) <= to_signed(16#000000#, 24);
        delayMatch16_reg(28) <= to_signed(16#000000#, 24);
        delayMatch16_reg(29) <= to_signed(16#000000#, 24);
        delayMatch16_reg(30) <= to_signed(16#000000#, 24);
        delayMatch16_reg(31) <= to_signed(16#000000#, 24);
        delayMatch16_reg(32) <= to_signed(16#000000#, 24);
        delayMatch16_reg(33) <= to_signed(16#000000#, 24);
        delayMatch16_reg(34) <= to_signed(16#000000#, 24);
        delayMatch16_reg(35) <= to_signed(16#000000#, 24);
        delayMatch16_reg(36) <= to_signed(16#000000#, 24);
        delayMatch16_reg(37) <= to_signed(16#000000#, 24);
        delayMatch16_reg(38) <= to_signed(16#000000#, 24);
        delayMatch16_reg(39) <= to_signed(16#000000#, 24);
        delayMatch16_reg(40) <= to_signed(16#000000#, 24);
        delayMatch16_reg(41) <= to_signed(16#000000#, 24);
        delayMatch16_reg(42) <= to_signed(16#000000#, 24);
        delayMatch16_reg(43) <= to_signed(16#000000#, 24);
        delayMatch16_reg(44) <= to_signed(16#000000#, 24);
        delayMatch16_reg(45) <= to_signed(16#000000#, 24);
        delayMatch16_reg(46) <= to_signed(16#000000#, 24);
        delayMatch16_reg(47) <= to_signed(16#000000#, 24);
        delayMatch16_reg(48) <= to_signed(16#000000#, 24);
      ELSIF enb = '1' THEN
  ...
  Data_Type_Conversion11_out1_1 <= delayMatch16_reg(48);
  delayMatch16_reg_next(0) <= Data_Type_Conversion11_out1_signed;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        delayMatch17_reg(0) <= to_signed(16#000000#, 24);
        delayMatch17_reg(1) <= to_signed(16#000000#, 24);
        delayMatch17_reg(2) <= to_signed(16#000000#, 24);
        delayMatch17_reg(3) <= to_signed(16#000000#, 24);
        delayMatch17_reg(4) <= to_signed(16#000000#, 24);
        delayMatch17_reg(5) <= to_signed(16#000000#, 24);
        delayMatch17_reg(6) <= to_signed(16#000000#, 24);
        delayMatch17_reg(7) <= to_signed(16#000000#, 24);
        delayMatch17_reg(8) <= to_signed(16#000000#, 24);
        delayMatch17_reg(9) <= to_signed(16#000000#, 24);
        delayMatch17_reg(10) <= to_signed(16#000000#, 24);
        delayMatch17_reg(11) <= to_signed(16#000000#, 24);
        delayMatch17_reg(12) <= to_signed(16#000000#, 24);
        delayMatch17_reg(13) <= to_signed(16#000000#, 24);
        delayMatch17_reg(14) <= to_signed(16#000000#, 24);
        delayMatch17_reg(15) <= to_signed(16#000000#, 24);
        delayMatch17_reg(16) <= to_signed(16#000000#, 24);
        delayMatch17_reg(17) <= to_signed(16#000000#, 24);
        delayMatch17_reg(18) <= to_signed(16#000000#, 24);
        delayMatch17_reg(19) <= to_signed(16#000000#, 24);
        delayMatch17_reg(20) <= to_signed(16#000000#, 24);
        delayMatch17_reg(21) <= to_signed(16#000000#, 24);
        delayMatch17_reg(22) <= to_signed(16#000000#, 24);
        delayMatch17_reg(23) <= to_signed(16#000000#, 24);
        delayMatch17_reg(24) <= to_signed(16#000000#, 24);
        delayMatch17_reg(25) <= to_signed(16#000000#, 24);
        delayMatch17_reg(26) <= to_signed(16#000000#, 24);
        delayMatch17_reg(27) <= to_signed(16#000000#, 24);
        delayMatch17_reg(28) <= to_signed(16#000000#, 24);
        delayMatch17_reg(29) <= to_signed(16#000000#, 24);
        delayMatch17_reg(30) <= to_signed(16#000000#, 24);
        delayMatch17_reg(31) <= to_signed(16#000000#, 24);
        delayMatch17_reg(32) <= to_signed(16#000000#, 24);
        delayMatch17_reg(33) <= to_signed(16#000000#, 24);
        delayMatch17_reg(34) <= to_signed(16#000000#, 24);
        delayMatch17_reg(35) <= to_signed(16#000000#, 24);
        delayMatch17_reg(36) <= to_signed(16#000000#, 24);
        delayMatch17_reg(37) <= to_signed(16#000000#, 24);
        delayMatch17_reg(38) <= to_signed(16#000000#, 24);
        delayMatch17_reg(39) <= to_signed(16#000000#, 24);
        delayMatch17_reg(40) <= to_signed(16#000000#, 24);
        delayMatch17_reg(41) <= to_signed(16#000000#, 24);
        delayMatch17_reg(42) <= to_signed(16#000000#, 24);
        delayMatch17_reg(43) <= to_signed(16#000000#, 24);
        delayMatch17_reg(44) <= to_signed(16#000000#, 24);
        delayMatch17_reg(45) <= to_signed(16#000000#, 24);
        delayMatch17_reg(46) <= to_signed(16#000000#, 24);
        delayMatch17_reg(47) <= to_signed(16#000000#, 24);
        delayMatch17_reg(48) <= to_signed(16#000000#, 24);
        delayMatch17_reg(49) <= to_signed(16#000000#, 24);
        delayMatch17_reg(50) <= to_signed(16#000000#, 24);
        delayMatch17_reg(51) <= to_signed(16#000000#, 24);
        delayMatch17_reg(52) <= to_signed(16#000000#, 24);
        delayMatch17_reg(53) <= to_signed(16#000000#, 24);
        delayMatch17_reg(54) <= to_signed(16#000000#, 24);
        delayMatch17_reg(55) <= to_signed(16#000000#, 24);
        delayMatch17_reg(56) <= to_signed(16#000000#, 24);
      ELSIF enb = '1' THEN
        ...
        delayMatch17_reg(54) <= delayMatch17_reg_next(54);
        delayMatch17_reg(55) <= delayMatch17_reg_next(55);
        delayMatch17_reg(56) <= delayMatch17_reg_next(56);
      END IF;
    END IF;
  END PROCESS delayMatch17_process;

  Data_Type_Conversion12_out1_1 <= delayMatch17_reg(56);
  delayMatch17_reg_next(0) <= Data_Type_Conversion12_out1_signed;
  ...
  delayMatch17_reg_next(54) <= delayMatch17_reg(53);
  delayMatch17_reg_next(55) <= delayMatch17_reg(54);
  delayMatch17_reg_next(56) <= delayMatch17_reg(55);
  ...
  Detect_Rise_Positive_out1_2 <= reduced_reg_8(110);
