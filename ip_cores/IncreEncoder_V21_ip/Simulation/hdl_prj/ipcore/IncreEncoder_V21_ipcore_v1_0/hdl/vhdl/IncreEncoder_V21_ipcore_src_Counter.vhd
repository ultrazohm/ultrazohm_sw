-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Encoder_Zynq\IncreEncoder_V21_ipcore_src_Counter.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IncreEncoder_V21_ipcore_src_Counter
-- Source Path: Encoder_Zynq/IncreEncoder_V21/Counter
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY IncreEncoder_V21_ipcore_src_Counter IS
...
END IncreEncoder_V21_ipcore_src_Counter;


ARCHITECTURE rtl OF IncreEncoder_V21_ipcore_src_Counter IS
...
BEGIN
  ...
  Reset_1 <= std_logic_vector(Reset_flag_out1);
