-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\jonat\Documents\ultrazohm_sw\ip_cores\uz_JL_SigmaDelta_Interface\hdlsrc\uz_JL_SigmaDelta_Interface\uz_JL_SigmaDelta_Interface_axi4_module.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_JL_SigmaDelta_Interface_axi4_module
-- Source Path: uz_JL_SigmaDelta_Interface/uz_JL_SigmaDelta_Interface_axi4/uz_JL_SigmaDelta_Interface_axi4_module
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_JL_SigmaDelta_Interface_axi4_module IS
...
END uz_JL_SigmaDelta_Interface_axi4_module;


ARCHITECTURE rtl OF uz_JL_SigmaDelta_Interface_axi4_module IS

  -- Component Declarations
  COMPONENT uz_JL_SigmaDelta_Interface_rdfifo_data
    PORT( clk                             :   IN    std_logic;
  ...
  COMPONENT uz_JL_SigmaDelta_Interface_rdfifo_rid
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT uz_JL_SigmaDelta_Interface_rdfifo_last
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : uz_JL_SigmaDelta_Interface_rdfifo_data
    USE ENTITY work.uz_JL_SigmaDelta_Interface_rdfifo_data(rtl);

  FOR ALL : uz_JL_SigmaDelta_Interface_rdfifo_rid
    USE ENTITY work.uz_JL_SigmaDelta_Interface_rdfifo_rid(rtl);

  FOR ALL : uz_JL_SigmaDelta_Interface_rdfifo_last
    USE ENTITY work.uz_JL_SigmaDelta_Interface_rdfifo_last(rtl);
  ...
  SIGNAL addr_write_tmp                   : unsigned(13 DOWNTO 0);  -- ufix14
...
BEGIN
  u_uz_JL_SigmaDelta_Interface_rdfifo_data_inst : uz_JL_SigmaDelta_Interface_rdfifo_data
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => const_1,
  ...
  u_uz_JL_SigmaDelta_Interface_rdfifo_rid_inst : uz_JL_SigmaDelta_Interface_rdfifo_rid
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => const_1,
  ...
  u_uz_JL_SigmaDelta_Interface_rdfifo_last_inst : uz_JL_SigmaDelta_Interface_rdfifo_last
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => const_1,
  ...
  BEGIN
    ...
    CASE axi4_wstate IS
      WHEN "00000000" =>
        IF axi4_rstate = to_unsigned(16#00#, 8) THEN 
          AXI4_AWREADY <= '1';
        ELSE 
          AXI4_AWREADY <= '0';
        END IF;
        ...
        END CASE;
        IF awvalid = '1' AND (axi4_rstate = to_unsigned(16#00#, 8)) THEN 
    ...
    CASE axi4_rstate IS
      WHEN "00000000" =>
        AXI4_ARREADY <= hdlcoder_to_stdlogic(axi4_wstate = to_unsigned(16#00#, 8)) AND ( NOT awvalid);
        ...
        END CASE;
        IF ((AXI4_ARVALID /= '0') AND (axi4_wstate = to_unsigned(16#00#, 8))) AND ( NOT awvalid) = '1' THEN 
  ...
  addr_write_tmp <= waddr(15 DOWNTO 2);

  addr_write <= std_logic_vector(addr_write_tmp);
  ...
  addr_read_tmp <= raddr_r(15 DOWNTO 2);
  ...
  strobe_addr <= '1' WHEN addr_write_tmp = to_unsigned(16#0000#, 14) ELSE
      '0';
