-- -------------------------------------------------------------
-- 
-- File Name: /home/ts/Dokumente/simscapeHDL/hdlsrc/gmStateSpaceHDL_HalfWaveRectifier_HDL/simscapeHDL_example_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: simscapeHDL_example_axi_lite
-- Source Path: simscapeHDL_example/simscapeHDL_example_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY simscapeHDL_example_axi_lite IS
...
END simscapeHDL_example_axi_lite;


ARCHITECTURE rtl OF simscapeHDL_example_axi_lite IS

  -- Component Declarations
  COMPONENT simscapeHDL_example_addr_decoder
  ...
  COMPONENT simscapeHDL_example_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : simscapeHDL_example_addr_decoder
    USE ENTITY work.simscapeHDL_example_addr_decoder(rtl);

  FOR ALL : simscapeHDL_example_axi_lite_module
    USE ENTITY work.simscapeHDL_example_axi_lite_module(rtl);
...
BEGIN
  u_simscapeHDL_example_addr_decoder_inst : simscapeHDL_example_addr_decoder
  ...
  u_simscapeHDL_example_axi_lite_module_inst : simscapeHDL_example_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
