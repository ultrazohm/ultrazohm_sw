...
ARCHITECTURE rtl OF uz_JL_pmsmModel_axi4 IS
  ...
  SIGNAL write_Ud_tmp                     : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_Uq_tmp                     : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_rec_mot_Ld_tmp             : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL write_polpaare_tmp               : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_mot_J_tmp                  : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_Reibungskoeffizient_tmp    : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_Coulomb_Reibung_tmp        : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_rec_mot_Lq_tmp             : std_logic_vector(31 DOWNTO 0);  -- ufix32
...
BEGIN
  u_uz_JL_pmsmModel_addr_decoder_inst : uz_JL_pmsmModel_addr_decoder
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
              ...
              read_pmsm_out => read_pmsm_out,  -- ufix32 [6]
              ...
              write_Ud => write_Ud_tmp,  -- ufix32
              write_Uq => write_Uq_tmp,  -- ufix32
              write_rec_mot_Ld => write_rec_mot_Ld_tmp,  -- ufix32
              write_r1 => write_r1_tmp,  -- ufix32
              write_psi_pm => write_psi_pm_tmp,  -- ufix32
              write_Ld => write_Ld_tmp,  -- ufix32
              write_Lq => write_Lq_tmp,  -- ufix32
              write_polpaare => write_polpaare_tmp,  -- ufix32
              write_mot_J => write_mot_J_tmp,  -- ufix32
              write_Reibungskoeffizient => write_Reibungskoeffizient_tmp,  -- ufix32
              write_Coulomb_Reibung => write_Coulomb_Reibung_tmp,  -- ufix32
              write_rec_mot_Lq => write_rec_mot_Lq_tmp  -- ufix32
              );
  ...
  write_Ud <= write_Ud_tmp;

  write_Uq <= write_Uq_tmp;

  write_rec_mot_Ld <= write_rec_mot_Ld_tmp;
  ...
  write_polpaare <= write_polpaare_tmp;

  write_mot_J <= write_mot_J_tmp;

  write_Reibungskoeffizient <= write_Reibungskoeffizient_tmp;

  write_Coulomb_Reibung <= write_Coulomb_Reibung_tmp;

  write_rec_mot_Lq <= write_rec_mot_Lq_tmp;
