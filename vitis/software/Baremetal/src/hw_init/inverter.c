...
static struct uz_inverter_adapter_config_t inverter_config_left = {
		.base_address = XPAR_UZ_USER_UZ_INVERTER_ADAPTER_D1_D2_UZ_D_INVERTER_ADAPTER_D1_BASEADDR,
		.ip_clk_frequency_Hz = 100000000,
		.linear_interpolation_params = {-289.01f, 218.72f}
};

static struct uz_inverter_adapter_config_t inverter_config_right = {
		.base_address = XPAR_UZ_USER_UZ_INVERTER_ADAPTER_D1_D2_UZ_D_INVERTER_ADAPTER_D2_BASEADDR,
		.ip_clk_frequency_Hz = 100000000,
		.linear_interpolation_params = {-289.01f, 218.72f}
};

static struct uz_inverter_adapter_outputs_t inverter_outputs_left = {
...
static struct uz_inverter_adapter_outputs_t inverter_outputs_right = {
   .PWMdutyCycNormalized_H1 = 0.0f,
   .PWMdutyCycNormalized_L1 = 0.0f,
   .PWMdutyCycNormalized_H2 = 0.0f,
   .PWMdutyCycNormalized_L2 = 0.0f,
...
uz_inverter_adapter_t* initialize_inverter_left(void) {
       return(uz_inverter_adapter_init(inverter_config_left, inverter_outputs_left));
}

uz_inverter_adapter_t* initialize_inverter_right(void) {
       return(uz_inverter_adapter_init(inverter_config_right, inverter_outputs_right));
}
