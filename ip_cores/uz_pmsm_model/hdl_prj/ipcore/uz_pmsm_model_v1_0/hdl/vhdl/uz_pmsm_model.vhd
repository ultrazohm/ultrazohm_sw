...
ARCHITECTURE rtl OF uz_pmsm_model IS
  ...
  COMPONENT uz_pmsm_model_dut
    PORT( clk                             :   IN    std_logic;  -- ufix1
          ...
          out_omega_mech                  :   OUT   std_logic_vector(31 DOWNTO 0)  -- ufix32
          );
  END COMPONENT;
  ...
  SIGNAL out_omega_mech_sig               : std_logic_vector(31 DOWNTO 0);  -- ufix32
...
BEGIN
  ...
  u_uz_pmsm_model_dut_inst : uz_pmsm_model_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              ...
              out_omega_mech => out_omega_mech_sig  -- ufix32
              );
  ...
  u_uz_pmsm_model_axi_lite_inst : uz_pmsm_model_axi_lite
    PORT MAP( reset => reset,
              ...
              read_out_omega_mech => out_omega_mech_sig,  -- ufix32
  ...
  ip_timestamp <= to_unsigned(2107220941, 32);
