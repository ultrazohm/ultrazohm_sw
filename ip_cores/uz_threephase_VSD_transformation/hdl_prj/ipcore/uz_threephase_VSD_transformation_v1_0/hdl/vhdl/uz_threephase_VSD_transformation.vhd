-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\valen\Documents\repos\UZ\ultrazohm_sw_working\ip_cores\uz_threephase_VSD_transformation\hdl_pj\hdlsrc\uz_threephase_VSD_transformation\uz_threephase_VSD_transformation.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_threephase_VSD_transformation
-- Source Path: uz_threephase_VSD_transformation
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_threephase_VSD_transformation IS
  PORT( IPCORE_CLK                        :   IN    std_logic;  -- ufix1
        IPCORE_RESETN                     :   IN    std_logic;  -- ufix1
        x_in_dq_0                         :   IN    std_logic_vector(53 DOWNTO 0);  -- ufix54
        ...
        x_abc_0                           :   OUT   std_logic_vector(80 DOWNTO 0);  -- ufix81
        x_out_dq_0                        :   OUT   std_logic_vector(53 DOWNTO 0);  -- ufix54
...
END uz_threephase_VSD_transformation;


ARCHITECTURE rtl OF uz_threephase_VSD_transformation IS

  -- Component Declarations
  COMPONENT uz_threephase_VSD_transformation_reset_sync
  ...
  COMPONENT uz_threephase_VSD_transformation_axi4
  ...
  COMPONENT uz_threephase_VSD_transformation_dut
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
  ...
  FOR ALL : uz_threephase_VSD_transformation_reset_sync
    USE ENTITY work.uz_threephase_VSD_transformation_reset_sync(rtl);

  FOR ALL : uz_threephase_VSD_transformation_axi4
    USE ENTITY work.uz_threephase_VSD_transformation_axi4(rtl);

  FOR ALL : uz_threephase_VSD_transformation_dut
    USE ENTITY work.uz_threephase_VSD_transformation_dut(rtl);

  -- Signals
  SIGNAL reset                            : std_logic;
  SIGNAL ip_timestamp                     : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL reset_cm                         : std_logic;  -- ufix1
  SIGNAL x_in_dq_0_unsigned               : unsigned(53 DOWNTO 0);  -- ufix54
  ...
  SIGNAL read_x_abc_out_axi_vec           : vector_of_std_logic_vector27(0 TO 2);  -- ufix27 [3]
  ...
  SIGNAL x_abc_2_sig_signed               : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL x_abc_1_sig_signed               : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL x_abc_0_sig_signed               : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL x_abc_0_tmp                      : unsigned(80 DOWNTO 0);  -- ufix81
  SIGNAL x_out_dq_1_sig_signed            : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL x_out_dq_0_sig_signed            : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL x_out_dq_0_tmp                   : unsigned(53 DOWNTO 0);  -- ufix54

BEGIN
  u_uz_threephase_VSD_transformation_reset_sync_inst : uz_threephase_VSD_transformation_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_uz_threephase_VSD_transformation_axi4_inst : uz_threephase_VSD_transformation_axi4
    PORT MAP( reset => reset,
              ...
              read_x_abc_out_axi => read_x_abc_out_axi_vec,  -- sfix27_En18 [3]
  ...
  u_uz_threephase_VSD_transformation_dut_inst : uz_threephase_VSD_transformation_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  ip_timestamp <= unsigned'(X"83BEAB0A");
  ...
  x_in_dq_0_slice_1 <= x_in_dq_0_unsigned(53 DOWNTO 27);
  ...
  x_abc_2_sig_signed <= signed(x_abc_2_sig);

  x_abc_1_sig_signed <= signed(x_abc_1_sig);

  x_abc_0_sig_signed <= signed(x_abc_0_sig);

  x_abc_0_tmp <= unsigned(x_abc_2_sig_signed) & unsigned(x_abc_1_sig_signed) & unsigned(x_abc_0_sig_signed);

  x_abc_0 <= std_logic_vector(x_abc_0_tmp);

  x_out_dq_1_sig_signed <= signed(x_out_dq_1_sig);

  x_out_dq_0_sig_signed <= signed(x_out_dq_0_sig);

  x_out_dq_0_tmp <= unsigned(x_out_dq_1_sig_signed) & unsigned(x_out_dq_0_sig_signed);
