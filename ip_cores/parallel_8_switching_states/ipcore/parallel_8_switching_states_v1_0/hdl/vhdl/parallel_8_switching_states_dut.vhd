-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\parallel_8_switching_states\hdlsrc\parallel_8_switching_states\parallel_8_switching_states_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: parallel_8_switching_states_dut
-- Source Path: parallel_8_switching_states/parallel_8_switching_states_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY parallel_8_switching_states_dut IS
...
END parallel_8_switching_states_dut;


ARCHITECTURE rtl OF parallel_8_switching_states_dut IS

  -- Component Declarations
  COMPONENT parallel_8_switching_states_src_HDL_DUT
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : parallel_8_switching_states_src_HDL_DUT
    USE ENTITY work.parallel_8_switching_states_src_HDL_DUT(rtl);
...
BEGIN
  u_parallel_8_switching_states_src_HDL_DUT : parallel_8_switching_states_src_HDL_DUT
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
              I => I,  -- sfix32
