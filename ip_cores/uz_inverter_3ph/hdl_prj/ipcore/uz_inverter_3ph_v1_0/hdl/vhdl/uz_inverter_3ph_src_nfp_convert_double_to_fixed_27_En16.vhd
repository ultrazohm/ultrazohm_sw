-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\valen\Documents\repos\UZ\ultrazohm_sw_working\ip_cores\uz_inverter_3ph\hdl_prj\hdlsrc\gmStateSpaceHDL_uz_inverter_3ph\uz_inverter_3ph_src_nfp_convert_double_to_fixed_27_En16.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_inverter_3ph_src_nfp_convert_double_to_fixed_27_En16
-- Source Path: gmStateSpaceHDL_uz_inverter_3ph/uz_inverter_3ph/nfp_convert_double_to_fixed_27_En16
-- Hierarchy Level: 1
-- 
...
ENTITY uz_inverter_3ph_src_nfp_convert_double_to_fixed_27_En16 IS
...
END uz_inverter_3ph_src_nfp_convert_double_to_fixed_27_En16;


ARCHITECTURE rtl OF uz_inverter_3ph_src_nfp_convert_double_to_fixed_27_En16 IS
  ...
  SIGNAL Data_Type_Conversion1_out1_1     : unsigned(63 DOWNTO 0);  -- ufix64_En53
  SIGNAL Data_Type_Conversion1_out1_2     : unsigned(63 DOWNTO 0);  -- ufix64_En53
  ...
  SIGNAL Shift_Arithmetic1_out1           : unsigned(63 DOWNTO 0);  -- ufix64_En53
  ...
  SIGNAL Shift_Arithmetic2_out1           : unsigned(63 DOWNTO 0);  -- ufix64_En53
  SIGNAL Switch1_out1                     : unsigned(63 DOWNTO 0);  -- ufix64_En53
  SIGNAL Delay2_out1                      : unsigned(63 DOWNTO 0);  -- ufix64_En53
  SIGNAL Data_Type_Conversion3_out1       : signed(64 DOWNTO 0);  -- sfix65_En53
  SIGNAL Unary_Minus_cast                 : signed(65 DOWNTO 0);  -- sfix66_En53
  SIGNAL Unary_Minus_cast_1               : signed(65 DOWNTO 0);  -- sfix66_En53
  SIGNAL Unary_Minus_out1                 : signed(64 DOWNTO 0);  -- sfix65_En53
  SIGNAL Switch1_out1_1                   : signed(64 DOWNTO 0);  -- sfix65_En53
  SIGNAL Data_Type_Conversion2_out1       : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL Delay8_out1_1                    : signed(26 DOWNTO 0);  -- sfix27_En16
...
BEGIN
  ...
  Data_Type_Conversion1_out1_1 <= resize(Data_Type_Conversion1_out1 & '0', 64);

  reduced_1_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Data_Type_Conversion1_out1_2 <= to_unsigned(0, 64);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  Data_Type_Conversion3_out1 <= signed(resize(Delay2_out1, 65));

  Unary_Minus_cast <= resize(Data_Type_Conversion3_out1, 66);
  Unary_Minus_cast_1 <=  - (Unary_Minus_cast);
  Unary_Minus_out1 <= Unary_Minus_cast_1(64 DOWNTO 0);

  
  Switch1_out1_1 <= Data_Type_Conversion3_out1 WHEN Delay8_out1 = '0' ELSE
      Unary_Minus_out1;

  Data_Type_Conversion2_out1 <= Switch1_out1_1(63 DOWNTO 37) + ('0' & Switch1_out1_1(36));
