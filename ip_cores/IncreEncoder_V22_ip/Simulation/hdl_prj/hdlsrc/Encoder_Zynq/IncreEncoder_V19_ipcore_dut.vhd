-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Encoder_Zynq\IncreEncoder_V19_ipcore_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IncreEncoder_V19_ipcore_dut
-- Source Path: IncreEncoder_V19_ipcore/IncreEncoder_V19_ipcore_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY IncreEncoder_V19_ipcore_dut IS
...
END IncreEncoder_V19_ipcore_dut;


ARCHITECTURE rtl OF IncreEncoder_V19_ipcore_dut IS

  -- Component Declarations
  COMPONENT IncreEncoder_V19_ipcore_src_IncreEncoder_V19
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : IncreEncoder_V19_ipcore_src_IncreEncoder_V19
    USE ENTITY work.IncreEncoder_V19_ipcore_src_IncreEncoder_V19(rtl);
...
BEGIN
  u_IncreEncoder_V19_ipcore_src_IncreEncoder_V19 : IncreEncoder_V19_ipcore_src_IncreEncoder_V19
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
              A => A_sig,  -- ufix1
  ...
  omega_rps_AXI4 <= omega_rps_AXI4_sig;
