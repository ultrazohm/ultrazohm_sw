-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\jonat\Documents\MA_JL_CIL\ip_cores\uz_JL_invModel_PT1\hdl_prj\hdlsrc\uz_JL_invModel_PT1\uz_JL_Inv_PT1_axi4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_JL_Inv_PT1_axi4
-- Source Path: uz_JL_Inv_PT1/uz_JL_Inv_PT1_axi4
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END uz_JL_Inv_PT1_axi4;


ARCHITECTURE rtl OF uz_JL_Inv_PT1_axi4 IS

  -- Component Declarations
  COMPONENT uz_JL_Inv_PT1_addr_decoder
  ...
  COMPONENT uz_JL_Inv_PT1_axi4_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_ARESETN                    :   IN    std_logic;  -- ufix1
          AXI4_AWID                       :   IN    std_logic_vector(12 DOWNTO 0);  -- ufix13
          AXI4_AWADDR                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  FOR ALL : uz_JL_Inv_PT1_addr_decoder
    USE ENTITY work.uz_JL_Inv_PT1_addr_decoder(rtl);

  FOR ALL : uz_JL_Inv_PT1_axi4_module
    USE ENTITY work.uz_JL_Inv_PT1_axi4_module(rtl);
  ...
  SIGNAL write_InvConf_SwitchInv_tmp      : std_logic_vector(1 DOWNTO 0);  -- ufix2
  SIGNAL write_InvConf_Udc_tmp            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_InvConf_PT1_Gain_tmp       : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_InvConf_PT1_Ts_tmp         : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_InvIn_PWM_H_safe_tmp       : vector_of_std_logic_vector32(0 TO 2);  -- ufix32 [3]
  SIGNAL write_InvIn_Ualpha_tmp           : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_InvIn_Ubeta_tmp            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_InvIn_PWM_L_safe_tmp       : vector_of_std_logic_vector32(0 TO 2);  -- ufix32 [3]
...
BEGIN
  u_uz_JL_Inv_PT1_addr_decoder_inst : uz_JL_Inv_PT1_addr_decoder
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
              ...
              write_InvConf_SwitchInv => write_InvConf_SwitchInv_tmp,  -- sfix2
              write_InvConf_Udc => write_InvConf_Udc_tmp,  -- ufix32
              write_InvConf_PT1_Gain => write_InvConf_PT1_Gain_tmp,  -- ufix32
              write_InvConf_PT1_Ts => write_InvConf_PT1_Ts_tmp,  -- ufix32
              write_InvConf_PT1_reset => write_InvConf_PT1_reset,  -- ufix1
              write_InvIn_PWM_H_safe => write_InvIn_PWM_H_safe_tmp,  -- ufix32 [3]
              write_InvIn_Ualpha => write_InvIn_Ualpha_tmp,  -- ufix32
              write_InvIn_Ubeta => write_InvIn_Ubeta_tmp,  -- ufix32
              write_InvIn_PWM_L_safe => write_InvIn_PWM_L_safe_tmp  -- ufix32 [3]
              );

  u_uz_JL_Inv_PT1_axi4_module_inst : uz_JL_Inv_PT1_axi4_module
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
  ...
  write_InvConf_SwitchInv <= write_InvConf_SwitchInv_tmp;

  write_InvConf_Udc <= write_InvConf_Udc_tmp;

  write_InvConf_PT1_Gain <= write_InvConf_PT1_Gain_tmp;

  write_InvConf_PT1_Ts <= write_InvConf_PT1_Ts_tmp;

  write_InvIn_PWM_H_safe <= write_InvIn_PWM_H_safe_tmp;

  write_InvIn_Ualpha <= write_InvIn_Ualpha_tmp;

  write_InvIn_Ubeta <= write_InvIn_Ubeta_tmp;

  write_InvIn_PWM_L_safe <= write_InvIn_PWM_L_safe_tmp;
