-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\valen\Documents\repos\UZ\ultrazohm_sw_working\ip_cores\uz_rs_flip_flop\hdl_prj\hdlsrc\uz_rs_flip_flop\uz_rs_flip_flop_src_S_R_Flip_Flop.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_rs_flip_flop_src_S_R_Flip_Flop
-- Source Path: uz_rs_flip_flop/uz_rs_flip_flop/S-R Flip Flop
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
USE work.uz_rs_flip_flop_src_uz_rs_flip_flop_pkg.ALL;

ENTITY uz_rs_flip_flop_src_S_R_Flip_Flop IS
...
END uz_rs_flip_flop_src_S_R_Flip_Flop;


ARCHITECTURE rtl OF uz_rs_flip_flop_src_S_R_Flip_Flop IS
