...
module MLP_vec2GemStream_float_8u_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [4:0] or_ln92_13_fu_268_p2;
wire   [4:0] or_ln92_14_fu_278_p2;
wire   [4:0] or_ln92_15_fu_288_p2;
wire   [4:0] or_ln92_16_fu_298_p2;
wire   [4:0] or_ln92_17_fu_308_p2;
wire   [4:0] or_ln92_18_fu_318_p2;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln86_fu_216_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_3_reg_404[4 : 3] <= tmp_3_fu_244_p3[4 : 3];
    end
end
...
assign or_ln92_13_fu_268_p2 = (tmp_3_reg_404 | 5'd2);

assign or_ln92_14_fu_278_p2 = (tmp_3_reg_404 | 5'd3);

assign or_ln92_15_fu_288_p2 = (tmp_3_reg_404 | 5'd4);

assign or_ln92_16_fu_298_p2 = (tmp_3_reg_404 | 5'd5);

assign or_ln92_17_fu_308_p2 = (tmp_3_reg_404 | 5'd6);

assign or_ln92_18_fu_318_p2 = (tmp_3_reg_404 | 5'd7);

assign or_ln92_fu_257_p2 = (tmp_3_fu_244_p3 | 5'd1);
...
endmodule //MLP_vec2GemStream_float_8u_s
