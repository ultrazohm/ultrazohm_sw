...
log=parquetread('/home/ts/Documents/pr_review/hoerner/ultrazohm_sw/javascope/beckhoff_rs_ident.parquet');
...
for i=1:length(speeds)
    ...
    L_d_over_speed_second_method(i)=(positive.dut_vq_ref-omega_el_mean*psi_pm)./(omega_el_mean*positive.dut_id);
end
...
legend('L_d (Kellner)','L_q (Kellner)','L_d','L_q');
