...
int JavaScope_initialize(DS_Data* data)
{
	...
	js_ch_observable[JSO_i_b] 					= &data->av.i_b_Last;
	js_ch_observable[JSO_i_c] 					= &data->av.i_c_Last;
	js_ch_observable[JSO_u_a] 					= &data->av.u_a_Last;
	js_ch_observable[JSO_u_b] 					= &data->av.u_b_Last;
	...
	js_ch_observable[JSO_Theta_mech_Pruef] 		= &(data->av.theta_mech_Pruef);
	...
	js_ch_observable[JSO_Theta_mech_Last_rad] 	= &(data->av.resolver_outputs_d4_Last.position_mech_2pi);
