-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\valen\Documents\repos\UZ\ultrazohm_sw\ip_cores\uz_pmsm_model_6ph_dq\hdl_prj\hdlsrc\uz_pmsm_model_6ph_dq\uz_pmsm_model_6ph_dq_src_nfp_convert_single_to_sfix_18_En14.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_6ph_dq_src_nfp_convert_single_to_sfix_18_En14
-- Source Path: uz_pmsm_model_6ph_dq/uz_pmsm_model_6ph_dq/nfp_convert_single_to_sfix_18_En14
-- Hierarchy Level: 1
-- 
...
ENTITY uz_pmsm_model_6ph_dq_src_nfp_convert_single_to_sfix_18_En14 IS
...
END uz_pmsm_model_6ph_dq_src_nfp_convert_single_to_sfix_18_En14;


ARCHITECTURE rtl OF uz_pmsm_model_6ph_dq_src_nfp_convert_single_to_sfix_18_En14 IS
  ...
  SIGNAL Data_Type_Conversion_out1        : unsigned(27 DOWNTO 0);  -- ufix28_En24
  ...
  SIGNAL Shift_Arithmetic1_out1           : unsigned(27 DOWNTO 0);  -- ufix28_En24
  SIGNAL Delay4_out1_1                    : unsigned(27 DOWNTO 0);  -- ufix28_En24
  SIGNAL shift_arithmetic2_zerosig        : signed(8 DOWNTO 0);  -- sfix9
  SIGNAL shift_arithmetic2_selsig         : signed(8 DOWNTO 0);  -- sfix9
  SIGNAL Data_Type_Conversion1_out1_1     : unsigned(27 DOWNTO 0);  -- ufix28_En24
  ...
  SIGNAL Shift_Arithmetic2_out1           : unsigned(27 DOWNTO 0);  -- ufix28_En24
  SIGNAL Delay6_out1                      : unsigned(27 DOWNTO 0);  -- ufix28_En24
  SIGNAL Switch1_out1                     : unsigned(27 DOWNTO 0);  -- ufix28_En24
  SIGNAL Delay9_out1                      : unsigned(27 DOWNTO 0);  -- ufix28_En24
  SIGNAL Data_Type_Conversion1_out1_2     : signed(28 DOWNTO 0);  -- sfix29_En24
  SIGNAL Unary_Minus_cast                 : signed(29 DOWNTO 0);  -- sfix30_En24
  SIGNAL Unary_Minus_cast_1               : signed(29 DOWNTO 0);  -- sfix30_En24
  SIGNAL Unary_Minus_out1                 : signed(28 DOWNTO 0);  -- sfix29_En24
  SIGNAL Switch1_out1_1                   : signed(28 DOWNTO 0);  -- sfix29_En24
...
BEGIN
  ...
  Data_Type_Conversion_out1 <= resize(Delay2_out1 & '0', 28);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay4_out1_1 <= to_unsigned(16#0000000#, 28);
      ELSIF enb = '1' THEN
  ...
  Data_Type_Conversion1_out1_1 <= resize(Delay2_out1 & '0', 28);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay6_out1 <= to_unsigned(16#0000000#, 28);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay9_out1 <= to_unsigned(16#0000000#, 28);
      ELSIF enb = '1' THEN
  ...
  Data_Type_Conversion1_out1_2 <= signed(resize(Delay9_out1, 29));

  Unary_Minus_cast <= resize(Data_Type_Conversion1_out1_2, 30);
  ...
  Data_Type_Conversion2_out1 <= Switch1_out1_1(27 DOWNTO 10) + ('0' & Switch1_out1_1(9));
