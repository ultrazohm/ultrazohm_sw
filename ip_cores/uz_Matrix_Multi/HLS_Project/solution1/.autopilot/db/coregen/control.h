...
#define CONTROL_ADDR_A_ROWS_DATA    0x10
#define CONTROL_BITS_A_ROWS_DATA    64
#define CONTROL_ADDR_B_ROWS_DATA    0x60
#define CONTROL_BITS_B_ROWS_DATA    64
#define CONTROL_ADDR_B_COLUMNS_DATA 0x6c
#define CONTROL_BITS_B_COLUMNS_DATA 64
#define CONTROL_ADDR_A_BASE         0x20
#define CONTROL_ADDR_A_HIGH         0x3f
#define CONTROL_WIDTH_A             32
#define CONTROL_DEPTH_A             5
#define CONTROL_ADDR_C_OUT_BASE     0x40
#define CONTROL_ADDR_C_OUT_HIGH     0x5f
#define CONTROL_WIDTH_C_OUT         32
#define CONTROL_DEPTH_C_OUT         5
#define CONTROL_ADDR_B_BASE         0x80
#define CONTROL_ADDR_B_HIGH         0xff
#define CONTROL_WIDTH_B             32
#define CONTROL_DEPTH_B             25
