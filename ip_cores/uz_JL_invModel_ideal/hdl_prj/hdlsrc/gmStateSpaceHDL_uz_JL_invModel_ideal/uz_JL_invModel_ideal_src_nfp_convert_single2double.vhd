-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\jonat\Documents\MA_JL_CIL\ip_cores\uz_JL_invModel_ideal\hdl_prj\hdlsrc\gmStateSpaceHDL_uz_JL_invModel_ideal\uz_JL_invModel_ideal_src_nfp_convert_single2double.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_JL_invModel_ideal_src_nfp_convert_single2double
-- Source Path: gmStateSpaceHDL_uz_JL_invModel_ideal/uz_JL_invModel_ideal/nfp_convert_single2double
-- Hierarchy Level: 1
-- Model version: 1.33
-- 
...
ENTITY uz_JL_invModel_ideal_src_nfp_convert_single2double IS
...
END uz_JL_invModel_ideal_src_nfp_convert_single2double;


ARCHITECTURE rtl OF uz_JL_invModel_ideal_src_nfp_convert_single2double IS
  ...
  SIGNAL Delay12_PS_2_4_reg               : std_logic_vector(2 DOWNTO 0);  -- ufix1 [3]
  ...
  SIGNAL Delay13_PS_2_4_reg               : std_logic_vector(1 DOWNTO 0);  -- ufix1 [2]
  ...
  SIGNAL Delay14_PS_2_4_reg               : std_logic_vector(1 DOWNTO 0);  -- ufix1 [2]
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        Delay12_PS_2_4_reg(2 DOWNTO 1) <= Delay12_PS_2_4_reg(1 DOWNTO 0);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        Delay13_PS_2_4_reg(1) <= Delay13_PS_2_4_reg(0);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        Delay14_PS_2_4_reg(1) <= Delay14_PS_2_4_reg(0);
      END IF;
    END IF;
