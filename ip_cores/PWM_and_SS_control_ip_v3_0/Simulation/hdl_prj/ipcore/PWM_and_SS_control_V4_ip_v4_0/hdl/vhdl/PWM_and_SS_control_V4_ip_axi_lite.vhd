...
ARCHITECTURE rtl OF PWM_and_SS_control_V4_ip_axi_lite IS
  ...
  SIGNAL write_m_u4_norm_AXI_tmp          : std_logic_vector(13 DOWNTO 0);  -- ufix14
  SIGNAL write_m_u5_norm_AXI_tmp          : std_logic_vector(13 DOWNTO 0);  -- ufix14
  SIGNAL write_m_u6_norm_AXI_tmp          : std_logic_vector(13 DOWNTO 0);  -- ufix14
  SIGNAL write_m_u7_norm_AXI_tmp          : std_logic_vector(13 DOWNTO 0);  -- ufix14
  SIGNAL write_m_u8_norm_AXI_tmp          : std_logic_vector(13 DOWNTO 0);  -- ufix14
  SIGNAL write_m_u9_norm_AXI_tmp          : std_logic_vector(13 DOWNTO 0);  -- ufix14
  SIGNAL write_m_u10_norm_AXI_tmp         : std_logic_vector(13 DOWNTO 0);  -- ufix14
  SIGNAL write_m_u11_norm_AXI_tmp         : std_logic_vector(13 DOWNTO 0);  -- ufix14
  SIGNAL write_m_u12_norm_AXI_tmp         : std_logic_vector(13 DOWNTO 0);  -- ufix14
  ...
  SIGNAL write_TriState_HB4_AXI_tmp       : std_logic_vector(1 DOWNTO 0);  -- ufix2
  SIGNAL write_TriState_HB5_AXI_tmp       : std_logic_vector(1 DOWNTO 0);  -- ufix2
  SIGNAL write_TriState_HB6_AXI_tmp       : std_logic_vector(1 DOWNTO 0);  -- ufix2
  SIGNAL write_TriState_HB7_AXI_tmp       : std_logic_vector(1 DOWNTO 0);  -- ufix2
  SIGNAL write_TriState_HB8_AXI_tmp       : std_logic_vector(1 DOWNTO 0);  -- ufix2
  SIGNAL write_TriState_HB9_AXI_tmp       : std_logic_vector(1 DOWNTO 0);  -- ufix2
  SIGNAL write_TriState_HB10_AXI_tmp      : std_logic_vector(1 DOWNTO 0);  -- ufix2
  SIGNAL write_TriState_HB11_AXI_tmp      : std_logic_vector(1 DOWNTO 0);  -- ufix2
  SIGNAL write_TriState_HB12_AXI_tmp      : std_logic_vector(1 DOWNTO 0);  -- ufix2
...
BEGIN
  u_PWM_and_SS_control_V4_ip_addr_decoder_inst : PWM_and_SS_control_V4_ip_addr_decoder
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
              ...
              write_m_u4_norm_AXI => write_m_u4_norm_AXI_tmp,  -- sfix14_En12
              write_m_u5_norm_AXI => write_m_u5_norm_AXI_tmp,  -- sfix14_En12
              write_m_u6_norm_AXI => write_m_u6_norm_AXI_tmp,  -- sfix14_En12
              write_m_u7_norm_AXI => write_m_u7_norm_AXI_tmp,  -- sfix14_En12
              write_m_u8_norm_AXI => write_m_u8_norm_AXI_tmp,  -- sfix14_En12
              write_m_u9_norm_AXI => write_m_u9_norm_AXI_tmp,  -- sfix14_En12
              write_m_u10_norm_AXI => write_m_u10_norm_AXI_tmp,  -- sfix14_En12
              write_m_u11_norm_AXI => write_m_u11_norm_AXI_tmp,  -- sfix14_En12
              write_m_u12_norm_AXI => write_m_u12_norm_AXI_tmp,  -- sfix14_En12
              ...
              write_TriState_HB4_AXI => write_TriState_HB4_AXI_tmp,  -- ufix2
              write_TriState_HB5_AXI => write_TriState_HB5_AXI_tmp,  -- ufix2
              write_TriState_HB6_AXI => write_TriState_HB6_AXI_tmp,  -- ufix2
              write_TriState_HB7_AXI => write_TriState_HB7_AXI_tmp,  -- ufix2
              write_TriState_HB8_AXI => write_TriState_HB8_AXI_tmp,  -- ufix2
              write_TriState_HB9_AXI => write_TriState_HB9_AXI_tmp,  -- ufix2
              write_TriState_HB10_AXI => write_TriState_HB10_AXI_tmp,  -- ufix2
              write_TriState_HB11_AXI => write_TriState_HB11_AXI_tmp,  -- ufix2
              write_TriState_HB12_AXI => write_TriState_HB12_AXI_tmp  -- ufix2
              );
  ...
  write_m_u4_norm_AXI <= write_m_u4_norm_AXI_tmp;

  write_m_u5_norm_AXI <= write_m_u5_norm_AXI_tmp;

  write_m_u6_norm_AXI <= write_m_u6_norm_AXI_tmp;

  write_m_u7_norm_AXI <= write_m_u7_norm_AXI_tmp;

  write_m_u8_norm_AXI <= write_m_u8_norm_AXI_tmp;

  write_m_u9_norm_AXI <= write_m_u9_norm_AXI_tmp;

  write_m_u10_norm_AXI <= write_m_u10_norm_AXI_tmp;

  write_m_u11_norm_AXI <= write_m_u11_norm_AXI_tmp;

  write_m_u12_norm_AXI <= write_m_u12_norm_AXI_tmp;
  ...
  write_TriState_HB4_AXI <= write_TriState_HB4_AXI_tmp;

  write_TriState_HB5_AXI <= write_TriState_HB5_AXI_tmp;

  write_TriState_HB6_AXI <= write_TriState_HB6_AXI_tmp;

  write_TriState_HB7_AXI <= write_TriState_HB7_AXI_tmp;

  write_TriState_HB8_AXI <= write_TriState_HB8_AXI_tmp;

  write_TriState_HB9_AXI <= write_TriState_HB9_AXI_tmp;

  write_TriState_HB10_AXI <= write_TriState_HB10_AXI_tmp;

  write_TriState_HB11_AXI <= write_TriState_HB11_AXI_tmp;

  write_TriState_HB12_AXI <= write_TriState_HB12_AXI_tmp;
