...
-- Source Path: uz_mlp_three_layer/pcu_mlp2_8parallel/reluLayer_4Parallel/MAC3
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF uz_mlp_three_layer_src_MAC3 IS
  ...
  SIGNAL Gain_mul_temp                    : unsigned(19 DOWNTO 0);  -- ufix20_En7
...
BEGIN
  ...
  -- CSD Encoding (640) : 01010000000; Cost (Adders) = 1
  Gain_mul_temp <= resize(n_perceptron & '0' & '0' & '0' & '0' & '0' & '0' & '0' & '0' & '0', 20) + resize(n_perceptron & '0' & '0' & '0' & '0' & '0' & '0' & '0', 20);
  Gain_out1 <= Gain_mul_temp(16 DOWNTO 7);
