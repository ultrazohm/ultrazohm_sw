-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_inverter_3phgm\uz_invert_3ph_axi4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_invert_3ph_axi4
-- Source Path: uz_invert_3ph/uz_invert_3ph_axi4
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END uz_invert_3ph_axi4;


ARCHITECTURE rtl OF uz_invert_3ph_axi4 IS

  -- Component Declarations
  COMPONENT uz_invert_3ph_addr_decoder
  ...
  COMPONENT uz_invert_3ph_axi4_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_ARESETN                    :   IN    std_logic;  -- ufix1
          AXI4_AWID                       :   IN    std_logic_vector(11 DOWNTO 0);  -- ufix12
          AXI4_AWADDR                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  FOR ALL : uz_invert_3ph_addr_decoder
    USE ENTITY work.uz_invert_3ph_addr_decoder(rtl);

  FOR ALL : uz_invert_3ph_axi4_module
    USE ENTITY work.uz_invert_3ph_axi4_module(rtl);
...
BEGIN
  u_uz_invert_3ph_addr_decoder_inst : uz_invert_3ph_addr_decoder
  ...
  u_uz_invert_3ph_axi4_module_inst : uz_invert_3ph_axi4_module
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
