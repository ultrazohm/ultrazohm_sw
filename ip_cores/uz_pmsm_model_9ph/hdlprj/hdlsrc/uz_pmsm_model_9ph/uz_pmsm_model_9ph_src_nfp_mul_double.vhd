-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\valen\Documents\repos\UZ\ultrazohm_sw\ip_cores\uz_pmsm_model_9ph\hdlprj\hdlsrc\uz_pmsm_model_9ph\uz_pmsm_model_9ph_src_nfp_mul_double.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_9ph_src_nfp_mul_double
...
ENTITY uz_pmsm_model_9ph_src_nfp_mul_double IS
...
END uz_pmsm_model_9ph_src_nfp_mul_double;


ARCHITECTURE rtl OF uz_pmsm_model_9ph_src_nfp_mul_double IS
...
BEGIN
  ...
  Compare_To_Zero_out1 <= '1' WHEN aExponent = to_unsigned(16#000#, 11) ELSE
      '0';

  alphaaExponent_0_aMantZero_out1 <= Compare_To_Zero_out1 AND aMantissa_0_out1;

  
  Compare_To_Zero_out1_1 <= '1' WHEN bExponent = to_unsigned(16#000#, 11) ELSE
      '0';
  ...
  Bit_Concat_out1 <= if_Exponent_0_cfType_Exp_out1 & aMantissa;
  ...
  bitsll_mant_b_ib_out1 <= Bit_Concat_out1 sll to_integer(Switch6_out1_1);
  ...
  Bit_Concat_out1_1 <= if_Exponent_0_cfType_Exp_out1_1 & bMantissa;
  ...
  bitsll_mant_b_ib_out1_1 <= Bit_Concat_out1_1 sll to_integer(Switch6_out1_3);

  
  if_bitget_mant_b_mant_b_WordLen_1_out1_1 <= bitsll_mant_b_ib_out1_1 WHEN BitSlice1_out1_1 = '0' ELSE
      Bit_Concat_out1_1;

  z2_out1 <= if_bitget_mant_b_mant_b_WordLen_1_out1 * if_bitget_mant_b_mant_b_WordLen_1_out1_1;

  BitSlice1_out1_2 <= z2_out1(105);

  alpha1_out1_2 <= to_signed(16#01#, 7);

  DTC3_out1 <= signed(resize(Switch6_out1_1, 7));
  ...
  if_Exponent_0_out1 <= aExponent WHEN Compare_To_Zero_out1 = '0' ELSE
      C_out1;

  DTC5_out1 <= signed(resize(if_Exponent_0_out1, 14));
  ...
  DTC3_out1_1 <= signed(resize(Switch6_out1_3, 7));
  ...
  if_Exponent_0_out1_1 <= bExponent WHEN Compare_To_Zero_out1_1 = '0' ELSE
      C_out1_1;

  DTC5_out1_1 <= signed(resize(if_Exponent_0_out1_1, 14));

  
  if_bitget_mant_b_mant_b_WordLen_out1_1 <= DTC4_out1_1 WHEN BitSlice1_out1_1 = '0' ELSE
      DTC5_out1_1;
  ...
  exp_out_cfType_MantissaLeng_out1 <= '1' WHEN exp_sum_cfType_ExponentBias_out1 < to_signed(-16#0035#, 14) ELSE
      '0';

  
  exp_out_cfType_MantissaLeng_1_out1 <= '1' WHEN exp_sum_cfType_ExponentBias_out1 = to_signed(-16#0035#, 14) ELSE
      '0';
  ...
  BitSlice3_out1 <= exp_sum_cfType_ExponentBias_out1(13);

  
  exp_out_0_out1 <= '1' WHEN exp_sum_cfType_ExponentBias_out1 = to_signed(16#0000#, 14) ELSE
      '0';
  ...
  Bit_Slice1_out1_4 <= z2_out1(104 DOWNTO 51);
  ...
  alphaExp_Incr_1_out1 <= resize(const_1_out1, 14) - exp_sum_cfType_ExponentBias_out1;

  DTC1_out1 <= unsigned(alphaExp_Incr_1_out1(5 DOWNTO 0));

  Unary_Minus_in0 <=  - (resize(exp_sum_cfType_ExponentBias_out1, 15));
  ...
  Bit_Slice2_out1_4 <= z2_out1(50 DOWNTO 0);
  ...
  Exp_Incr_53_out1 <= const_53_out1 + exp_sum_cfType_ExponentBias_out1;

  DTC2_out1 <= unsigned(Exp_Incr_53_out1(5 DOWNTO 0));

  const_52_out1 <= to_signed(16#0034#, 14);

  Exp_Incr_52_out1 <= const_52_out1 + exp_sum_cfType_ExponentBias_out1;
  ...
  alphabitget_Mant_tmp_2_0_out1 <= BitSlice1_out1_3 OR if_exp_out_cast_cfType_Expone_3_out1;
  ...
  Mant_tmp_Incr_out1 <= BitSlice4_out1 + const_2_out1;
  ...
  Exp_Incr_1_out1 <= exp_sum_cfType_ExponentBias_out1 + const_1_out1_1;

  Logical_Operator1_out1_22 <= if_bitget_mant_ext_mant_ext_Word_4_out1 OR if_bitget_mant_ext_mant_ext_Word_3_out1;

  
  if_exp_out_cfType_MantissaLen_1_out1 <= exp_sum_cfType_ExponentBias_out1 WHEN BitSlice1_out1_2 = '0' ELSE
      Exp_Incr_1_out1;
  ...
  Exp_Incr_out1 <= if_exp_out_cast_cfType_Expone_out1 + const_1_out1_2;

  
  if_bitget_Mant_tmp_Mant_tmp_Wor_out1 <= if_exp_out_cast_cfType_Expone_out1 WHEN BitSlice2_out1 = '0' ELSE
      Exp_Incr_out1;
  ...
  Logical_Operator_out1_5 <= alphaaIsZero_bIsZero_out1 OR BitSlice2_out1;
  ...
  if_aIsZero_out1 <= bMantissa WHEN alphaaExponent_0_aMantZero_out1 = '0' ELSE
      C1_out1_1;

  C_out1_3 <= unsigned'(X"8000000000000");

  
  if_bIsZero_out1 <= aMantissa WHEN alphabExponent_0_bMantZero_out1 = '0' ELSE
      C_out1_3;
