...
#include "CC_Kp_id_adjustment.h"
#include "rtwtypes.h"
#include <string.h>

/* Model step function */
void CC_Kp_id_adjustment_step(RT_MODEL *const rtM)
{
...
void CC_Kp_id_adjustment_initialize(RT_MODEL *const rtM)
{
  ExtU *rtU = (ExtU *) rtM->inputs;
  ExtY *rtY = (ExtY *) rtM->outputs;
