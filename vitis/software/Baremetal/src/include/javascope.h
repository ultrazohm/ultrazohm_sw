...
//	JSO_SD_PH4,
	...
	JSO_theta_mech,
	JSO_n_rpm,
	JSO_dpt_state, // uz_dpt_state_t of the running/last DPT, see uz_dpt.h
	JSO_dpt_current, // Sinc3_Filter.data_PH1, the DUT current channel used by the DPT charging phase
	JSO_conv_pwr_en,
	JSO_conv_board_en,
	JSO_conv_board_rst,
...
// Do not change the first (zero) and last (end) entries.
	...
	Soll_id,
	Soll_iq,
	Soll_Square_DutyCycle,
	Soll_Square_Frequency_Hz,
	Soll_DPT_Current_A,
	Soll_DPT_MaxCurrent_A,
	Soll_DPT_ChargeTimeout_ms,
	Soll_DPT_Deadtime_us,
	Soll_DPT_Pulse2_us,
	send_field_17,
	send_field_18,
	send_field_19,
