...
int JavaScope_initalize(DS_Data* data)
{
	...
	js_ch_observable[JSO_ub] = &PID_Data.PID_ActualValues.V_UVW.V;
	js_ch_observable[JSO_uc] = &PID_Data.PID_ActualValues.V_UVW.W;
	...
	js_slowDataArray[JSSD_FLOAT_I_rated] = &(PID_Data.PID_GlobalConfig.ratCurrent);
	js_slowDataArray[JSSD_FLOAT_totalRotorInertia] = &(PID_Data.PID_TwoMassID_Output->rotorInertia);
