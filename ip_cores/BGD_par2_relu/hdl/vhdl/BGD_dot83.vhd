...
architecture behav of BGD_dot83 is 
...
attribute shreg_extract : string;
    ...
    component BGD_p_prop_scalar_p_m_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    grp_dot_fu_48 : component BGD_dot
    port map (
        p_x_dout => p_M_r_dout,
    ...
    call_ln59_p_prop_scalar_p_m_proc_fu_62 : component BGD_p_prop_scalar_p_m_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
