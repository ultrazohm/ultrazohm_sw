...
entity MultiLayerPerceptronDecoupled_dot90 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of MultiLayerPerceptronDecoupled_dot90 is 
...
attribute shreg_extract : string;
    ...
    signal call_ln59_p_prop_scalar_p_m_proc72_fu_62_p_m_out_blk_n : STD_LOGIC;
    ...
    signal call_ln59_p_prop_scalar_p_m_proc72_fu_62_ap_start : STD_LOGIC;
    signal call_ln59_p_prop_scalar_p_m_proc72_fu_62_ap_done : STD_LOGIC;
    signal call_ln59_p_prop_scalar_p_m_proc72_fu_62_ap_idle : STD_LOGIC;
    signal call_ln59_p_prop_scalar_p_m_proc72_fu_62_ap_ready : STD_LOGIC;
    signal call_ln59_p_prop_scalar_p_m_proc72_fu_62_p_m_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal call_ln59_p_prop_scalar_p_m_proc72_fu_62_p_m_out_write : STD_LOGIC;
    ...
    component MultiLayerPerceptronDecoupled_dot IS
    port (
        p_x_dout : IN STD_LOGIC_VECTOR (255 downto 0);
        p_x_empty_n : IN STD_LOGIC;
        p_x_read : OUT STD_LOGIC;
    ...
    component MultiLayerPerceptronDecoupled_p_prop_scalar_p_m_proc72 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    grp_dot_fu_48 : component MultiLayerPerceptronDecoupled_dot
    port map (
        p_x_dout => p_M_r_dout,
    ...
    call_ln59_p_prop_scalar_p_m_proc72_fu_62 : component MultiLayerPerceptronDecoupled_p_prop_scalar_p_m_proc72
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => call_ln59_p_prop_scalar_p_m_proc72_fu_62_ap_start,
        ap_done => call_ln59_p_prop_scalar_p_m_proc72_fu_62_ap_done,
        ap_idle => call_ln59_p_prop_scalar_p_m_proc72_fu_62_ap_idle,
        ap_ready => call_ln59_p_prop_scalar_p_m_proc72_fu_62_ap_ready,
        scalar_p_m => p_m_dout,
        p_m_out_din => call_ln59_p_prop_scalar_p_m_proc72_fu_62_p_m_out_din,
        p_m_out_full_n => p_m_out_full_n,
        p_m_out_write => call_ln59_p_prop_scalar_p_m_proc72_fu_62_p_m_out_write,
        p_m_out_blk_n => call_ln59_p_prop_scalar_p_m_proc72_fu_62_p_m_out_blk_n);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((ap_start = ap_const_logic_0) or (call_ln59_p_prop_scalar_p_m_proc72_fu_62_p_m_out_blk_n = ap_const_logic_0) or (p_n_empty_n = ap_const_logic_0) or (p_m_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, p_m_empty_n, p_n_empty_n, call_ln59_p_prop_scalar_p_m_proc72_fu_62_p_m_out_blk_n, ap_CS_fsm_state2, ap_block_state2_on_subcall_done)
    begin
        case ap_CS_fsm is
    ...
    ap_block_state1_assign_proc : process(ap_start, ap_done_reg, p_m_empty_n, p_n_empty_n, call_ln59_p_prop_scalar_p_m_proc72_fu_62_p_m_out_blk_n)
    begin
                ap_block_state1 <= ((ap_start = ap_const_logic_0) or (call_ln59_p_prop_scalar_p_m_proc72_fu_62_p_m_out_blk_n = ap_const_logic_0) or (p_n_empty_n = ap_const_logic_0) or (p_m_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1));
    end process;
    ...
    ap_block_state1_ignore_call13_assign_proc : process(ap_start, ap_done_reg, p_m_empty_n, p_n_empty_n, call_ln59_p_prop_scalar_p_m_proc72_fu_62_p_m_out_blk_n)
    begin
                ap_block_state1_ignore_call13 <= ((ap_start = ap_const_logic_0) or (call_ln59_p_prop_scalar_p_m_proc72_fu_62_p_m_out_blk_n = ap_const_logic_0) or (p_n_empty_n = ap_const_logic_0) or (p_m_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1));
    end process;
    ...
    call_ln59_p_prop_scalar_p_m_proc72_fu_62_ap_start_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, p_m_empty_n, p_n_empty_n)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (p_n_empty_n = ap_const_logic_0) or (p_m_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            call_ln59_p_prop_scalar_p_m_proc72_fu_62_ap_start <= ap_const_logic_1;
        else 
            call_ln59_p_prop_scalar_p_m_proc72_fu_62_ap_start <= ap_const_logic_0;
        end if; 
    end process;
    ...
    p_m_out_blk_n_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, call_ln59_p_prop_scalar_p_m_proc72_fu_62_p_m_out_blk_n)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            p_m_out_blk_n <= call_ln59_p_prop_scalar_p_m_proc72_fu_62_p_m_out_blk_n;
        else 
    ...
    p_m_out_write_assign_proc : process(ap_CS_fsm_state1, call_ln59_p_prop_scalar_p_m_proc72_fu_62_p_m_out_write)
    begin
    ...
    p_m_read_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, p_m_empty_n, p_n_empty_n, call_ln59_p_prop_scalar_p_m_proc72_fu_62_p_m_out_blk_n)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (call_ln59_p_prop_scalar_p_m_proc72_fu_62_p_m_out_blk_n = ap_const_logic_0) or (p_n_empty_n = ap_const_logic_0) or (p_m_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    p_n_read_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, p_m_empty_n, p_n_empty_n, call_ln59_p_prop_scalar_p_m_proc72_fu_62_p_m_out_blk_n)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (call_ln59_p_prop_scalar_p_m_proc72_fu_62_p_m_out_blk_n = ap_const_logic_0) or (p_n_empty_n = ap_const_logic_0) or (p_m_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
