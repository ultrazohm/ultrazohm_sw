...
BEGIN
  ...
  AXI_GaN_FAULT_H1 <= GaN_FAULT_H1;

  AXI_GaN_FAULT_L1 <= GaN_FAULT_L1;

  AXI_GaN_FAULT_H2 <= GaN_FAULT_H2;

  AXI_GaN_FAULT_L2 <= GaN_FAULT_L2;

  AXI_GaN_FAULT_H3 <= GaN_FAULT_H3;

  AXI_GaN_FAULT_L3 <= GaN_FAULT_L3;

  AXI_GaN_OC_H1 <= GaN_OC_H1;

  AXI_GaN_OC_L1 <= GaN_OC_L1;

  AXI_GaN_OC_H2 <= GaN_OC_H2;

  AXI_GaN_OC_L2 <= GaN_OC_L2;

  AXI_GaN_OC_H3 <= GaN_OC_H3;

  AXI_GaN_OC_L3 <= GaN_OC_L3;
