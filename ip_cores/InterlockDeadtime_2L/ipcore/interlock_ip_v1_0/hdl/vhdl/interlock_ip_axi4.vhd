-- -------------------------------------------------------------
-- 
-- File Name: /home/ts/Dokumente/ultrazohm_testbench/ultrazohm_sw/ip_cores/InterlockDeadtime_2L/hdlsrc/interlock_deadtime/interlock_ip_axi4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: interlock_ip_axi4
-- Source Path: interlock_ip/interlock_ip_axi4
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END interlock_ip_axi4;


ARCHITECTURE rtl OF interlock_ip_axi4 IS
  ...
  COMPONENT interlock_ip_axi4_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_ARESETN                    :   IN    std_logic;  -- ufix1
          AXI4_AWID                       :   IN    std_logic_vector(11 DOWNTO 0);  -- ufix12
          AXI4_AWADDR                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  FOR ALL : interlock_ip_axi4_module
    USE ENTITY work.interlock_ip_axi4_module(rtl);
...
BEGIN
  ...
  u_interlock_ip_axi4_module_inst : interlock_ip_axi4_module
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
