-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\jonat\Documents\ultrazohm_sw\ip_cores\uz_JL_SigmaDelta_Interface\hdlsrc\uz_JL_SigmaDelta_Interface\uz_JL_SigmaDelta_Interface_rdfifo_last.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_JL_SigmaDelta_Interface_rdfifo_last
-- Source Path: uz_JL_SigmaDelta_Interface/uz_JL_SigmaDelta_Interface_axi4/uz_JL_SigmaDelta_Interface_axi4_module/uz_JL_SigmaDelta_Interface_rdfifo_last
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_JL_SigmaDelta_Interface_rdfifo_last IS
...
END uz_JL_SigmaDelta_Interface_rdfifo_last;


ARCHITECTURE rtl OF uz_JL_SigmaDelta_Interface_rdfifo_last IS

  -- Component Declarations
  COMPONENT uz_JL_SigmaDelta_Interface_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : uz_JL_SigmaDelta_Interface_SimpleDualPortRAM_singlebit
    USE ENTITY work.uz_JL_SigmaDelta_Interface_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_uz_JL_SigmaDelta_Interface_rdfifo_last_classic_ram_singlebit : uz_JL_SigmaDelta_Interface_SimpleDualPortRAM_singlebit
