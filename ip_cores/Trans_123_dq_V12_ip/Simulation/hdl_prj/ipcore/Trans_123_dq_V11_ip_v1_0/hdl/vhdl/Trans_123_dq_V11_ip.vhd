-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Transformation_V11\Trans_123_dq_V11_ip.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Trans_123_dq_V11_ip
-- Source Path: Trans_123_dq_V11_ip
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END Trans_123_dq_V11_ip;


ARCHITECTURE rtl OF Trans_123_dq_V11_ip IS

  -- Component Declarations
  COMPONENT Trans_123_dq_V11_ip_axi_lite
  ...
  COMPONENT Trans_123_dq_V11_ip_dut
  ...
  FOR ALL : Trans_123_dq_V11_ip_axi_lite
    USE ENTITY work.Trans_123_dq_V11_ip_axi_lite(rtl);

  FOR ALL : Trans_123_dq_V11_ip_dut
    USE ENTITY work.Trans_123_dq_V11_ip_dut(rtl);
...
BEGIN
  u_Trans_123_dq_V11_ip_axi_lite_inst : Trans_123_dq_V11_ip_axi_lite
    PORT MAP( reset => reset,
              ...
              read_CurrentValid_out_AXI => CurrentValid_out_AXI_sig,  -- ufix1
  ...
  u_Trans_123_dq_V11_ip_dut_inst : Trans_123_dq_V11_ip_dut
  ...
  ip_timestamp <= to_unsigned(1811221308, 32);
