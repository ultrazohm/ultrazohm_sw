...
#if (UZ_DESKBENCH_CONTROL_MODE != UZ_DESKBENCH_CONTROL_BOTH) && (UZ_DESKBENCH_CONTROL_MODE != UZ_DESKBENCH_CONTROL_DUT_ONLY) && (UZ_DESKBENCH_CONTROL_MODE != UZ_DESKBENCH_CONTROL_PRIME_ONLY)
#error UZ_DESKBENCH_CONTROL_MODE must be UZ_DESKBENCH_CONTROL_BOTH, UZ_DESKBENCH_CONTROL_DUT_ONLY, or UZ_DESKBENCH_CONTROL_PRIME_ONLY
#endif
