-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/uz_dac_spi_interface/uz_dac_spi_interface_axi4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_dac_spi_interface_axi4
-- Source Path: uz_dac_spi_interface/uz_dac_spi_interface_axi4
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_dac_spi_interface_axi4 IS
...
END uz_dac_spi_interface_axi4;


ARCHITECTURE rtl OF uz_dac_spi_interface_axi4 IS

  -- Component Declarations
  COMPONENT uz_dac_spi_interface_addr_decoder
  ...
  COMPONENT uz_dac_spi_interface_axi4_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_ARESETN                    :   IN    std_logic;  -- ufix1
          AXI4_AWID                       :   IN    std_logic_vector(11 DOWNTO 0);  -- ufix12
          AXI4_AWADDR                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  FOR ALL : uz_dac_spi_interface_addr_decoder
    USE ENTITY work.uz_dac_spi_interface_addr_decoder(rtl);

  FOR ALL : uz_dac_spi_interface_axi4_module
    USE ENTITY work.uz_dac_spi_interface_axi4_module(rtl);
  ...
  SIGNAL write_dac_data_1_tmp             : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL write_dac_data_2_tmp             : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL write_dac_data_3_tmp             : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL write_dac_data_4_tmp             : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL write_dac_data_5_tmp             : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL write_dac_data_6_tmp             : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL write_dac_data_7_tmp             : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL write_dac_data_8_tmp             : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL write_reset_value_tmp            : std_logic_vector(15 DOWNTO 0);  -- ufix16
...
BEGIN
  u_uz_dac_spi_interface_addr_decoder_inst : uz_dac_spi_interface_addr_decoder
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
              ...
              write_dac_data_1 => write_dac_data_1_tmp,  -- sfix16
              write_dac_data_2 => write_dac_data_2_tmp,  -- sfix16
              write_dac_data_3 => write_dac_data_3_tmp,  -- sfix16
              write_dac_data_4 => write_dac_data_4_tmp,  -- sfix16
              write_dac_data_5 => write_dac_data_5_tmp,  -- sfix16
              write_dac_data_6 => write_dac_data_6_tmp,  -- sfix16
              write_dac_data_7 => write_dac_data_7_tmp,  -- sfix16
              write_dac_data_8 => write_dac_data_8_tmp,  -- sfix16
              write_use_input_from_axi => write_use_input_from_axi,  -- ufix1
              write_reset_value => write_reset_value_tmp,  -- sfix16
              write_reset_dac_output => write_reset_dac_output  -- ufix1
              );

  u_uz_dac_spi_interface_axi4_module_inst : uz_dac_spi_interface_axi4_module
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
  ...
  write_dac_data_1 <= write_dac_data_1_tmp;

  write_dac_data_2 <= write_dac_data_2_tmp;

  write_dac_data_3 <= write_dac_data_3_tmp;

  write_dac_data_4 <= write_dac_data_4_tmp;

  write_dac_data_5 <= write_dac_data_5_tmp;

  write_dac_data_6 <= write_dac_data_6_tmp;

  write_dac_data_7 <= write_dac_data_7_tmp;

  write_dac_data_8 <= write_dac_data_8_tmp;

  write_reset_value <= write_reset_value_tmp;
