-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\FCS_MPC_3Phase_SPMSM\hdlsrc\FCS_MPC_3Phase_SPMSM_TEST1\FCS_MPC_3Phase_SPMSM_IP_Core_src_nfp_convert_sfix_48_En31_to_single.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: FCS_MPC_3Phase_SPMSM_IP_Core_src_nfp_convert_sfix_48_En31_to_single
-- Source Path: FCS_MPC_3Phase_SPMSM_TEST1/Microcontroller Software/Subsystem1/nfp_convert_sfix_48_En31_to_single
-- Hierarchy Level: 1
-- 
...
ENTITY FCS_MPC_3Phase_SPMSM_IP_Core_src_nfp_convert_sfix_48_En31_to_single IS
  PORT( nfp_in                            :   IN    std_logic_vector(47 DOWNTO 0);  -- sfix48_En31
        nfp_out                           :   OUT   std_logic_vector(31 DOWNTO 0)  -- ufix32
        );
END FCS_MPC_3Phase_SPMSM_IP_Core_src_nfp_convert_sfix_48_En31_to_single;


ARCHITECTURE rtl OF FCS_MPC_3Phase_SPMSM_IP_Core_src_nfp_convert_sfix_48_En31_to_single IS

  -- Signals
  SIGNAL nfp_in_signed                    : signed(47 DOWNTO 0);  -- sfix48_En31
  ...
  SIGNAL Delay_out1_dtc                   : unsigned(47 DOWNTO 0);  -- ufix48_En31
  SIGNAL Unary_Minus_cast                 : signed(48 DOWNTO 0);  -- sfix49_En31
  SIGNAL Unary_Minus_cast_1               : signed(48 DOWNTO 0);  -- sfix49_En31
  SIGNAL Unary_Minus_out1                 : signed(47 DOWNTO 0);  -- sfix48_En31
  SIGNAL Unary_Minus_out1_dtc             : unsigned(47 DOWNTO 0);  -- ufix48_En31
  SIGNAL Switch_out1                      : unsigned(47 DOWNTO 0);  -- ufix48_En31
...
BEGIN
  ...
  CompareToZero1_out1 <= '1' WHEN nfp_in_signed = to_signed(0, 48) ELSE
      '0';

  Constant3_out1 <= '1';

  
  Compare_To_Zero_out1 <= '1' WHEN nfp_in_signed < to_signed(0, 48) ELSE
      '0';
  ...
  Unary_Minus_cast <= resize(nfp_in_signed, 49);
  Unary_Minus_cast_1 <=  - (Unary_Minus_cast);
  Unary_Minus_out1 <= Unary_Minus_cast_1(47 DOWNTO 0);
