-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\UZ_D_GaN_Inverter_reduced\UZ_D_GaN_ip_addr_decoder.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: UZ_D_GaN_ip_addr_decoder
-- Source Path: UZ_D_GaN_ip/UZ_D_GaN_ip_axi_lite/UZ_D_GaN_ip_addr_decoder
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY UZ_D_GaN_ip_addr_decoder IS
...
END UZ_D_GaN_ip_addr_decoder;


ARCHITECTURE rtl OF UZ_D_GaN_ip_addr_decoder IS
...
BEGIN
  ...
  data_read <= std_logic_vector(decode_rd_AXI_Gan_Temp_6_dutycyc_1_1);
