-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\jonat\Documents\MA_JL_HIL\ip_cores\uz_JL_SDDemod\hdlsrc\uz_JL_SDDemodulator\uz_JL_SDDemod.vhd
...
ARCHITECTURE rtl OF uz_JL_SDDemod IS
  ...
  SIGNAL write_R_axi                      : std_logic_vector(15 DOWNTO 0);  -- ufix16
...
BEGIN
  ...
  u_uz_JL_SDDemod_axi4_inst : uz_JL_SDDemod_axi4
    PORT MAP( reset => reset,
              ...
              write_R_axi => write_R_axi,  -- sfix16
  ...
  u_uz_JL_SDDemod_dut_inst : uz_JL_SDDemod_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              ...
              data_in => data_in,  -- ufix1
              R_axi => write_R_axi,  -- sfix16
              ce_out => ce_out_sig,  -- ufix1
              data_out_ps => data_out_ps_sig,  -- sfix32
              out_clk_ads => out_clk_ads_sig  -- ufix1
              );

  ip_timestamp <= unsigned'(X"9B55A717");
