-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\parallel_8_prediction_and_cost_function\hdlsrc\parallel_8_prediction_and_cost_function\parallel_8_prediction_and_cost_function_src_Subsystem.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: parallel_8_prediction_and_cost_function_src_Subsystem
-- Source Path: parallel_8_prediction_and_cost_function/Prediction_and_cost_function/Subsystem
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY parallel_8_prediction_and_cost_function_src_Subsystem IS
...
END parallel_8_prediction_and_cost_function_src_Subsystem;


ARCHITECTURE rtl OF parallel_8_prediction_and_cost_function_src_Subsystem IS

  -- Component Declarations
  COMPONENT parallel_8_prediction_and_cost_function_src_MATLAB_Function10
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : parallel_8_prediction_and_cost_function_src_MATLAB_Function10
    USE ENTITY work.parallel_8_prediction_and_cost_function_src_MATLAB_Function10(rtl);
...
BEGIN
  u_MATLAB_Function15 : parallel_8_prediction_and_cost_function_src_MATLAB_Function10
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_MATLAB_Function14 : parallel_8_prediction_and_cost_function_src_MATLAB_Function10
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              SampleTime_div_Ld => SampleTime_div_Ld15,  -- single
  ...
  u_MATLAB_Function13 : parallel_8_prediction_and_cost_function_src_MATLAB_Function10
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              SampleTime_div_Ld => SampleTime_div_Ld15,  -- single
  ...
  u_MATLAB_Function12 : parallel_8_prediction_and_cost_function_src_MATLAB_Function10
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              SampleTime_div_Ld => SampleTime_div_Ld15,  -- single
  ...
  u_MATLAB_Function11 : parallel_8_prediction_and_cost_function_src_MATLAB_Function10
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              SampleTime_div_Ld => SampleTime_div_Ld15,  -- single
  ...
  u_MATLAB_Function10 : parallel_8_prediction_and_cost_function_src_MATLAB_Function10
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              SampleTime_div_Ld => SampleTime_div_Ld15,  -- single
  ...
  u_MATLAB_Function9 : parallel_8_prediction_and_cost_function_src_MATLAB_Function10
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              SampleTime_div_Ld => SampleTime_div_Ld15,  -- single
  ...
  u_MATLAB_Function8 : parallel_8_prediction_and_cost_function_src_MATLAB_Function10
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              SampleTime_div_Ld => SampleTime_div_Ld15,  -- single
