-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\Philipp\ultrazohm\ultrazohm_sw\ip_cores\uz_pmsm_model_nonlinear_6LUT\hdl_prj\hdlsrc\uz_pmsm_model_6LUT_pd\uz_pmsm_nonlinear_rdfifo_last.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_nonlinear_rdfifo_last
-- Source Path: uz_pmsm_nonlinear/uz_pmsm_nonlinear_axi4/uz_pmsm_nonlinear_axi4_module/uz_pmsm_nonlinear_rdfifo_last
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_pmsm_nonlinear_rdfifo_last IS
...
END uz_pmsm_nonlinear_rdfifo_last;


ARCHITECTURE rtl OF uz_pmsm_nonlinear_rdfifo_last IS

  -- Component Declarations
  COMPONENT uz_pmsm_nonlinear_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : uz_pmsm_nonlinear_SimpleDualPortRAM_singlebit
    USE ENTITY work.uz_pmsm_nonlinear_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_uz_pmsm_nonlinear_rdfifo_last_classic_ram_singlebit : uz_pmsm_nonlinear_SimpleDualPortRAM_singlebit
