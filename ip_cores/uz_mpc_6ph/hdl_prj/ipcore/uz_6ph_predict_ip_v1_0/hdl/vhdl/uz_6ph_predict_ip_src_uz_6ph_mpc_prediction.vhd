-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_mpc_cost_and_optim_state_machine\uz_6ph_predict_ip_src_uz_6ph_mpc_prediction.vhd
-- Created: 2022-10-04 14:19:11
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: uz_6ph_predict_ip_src_uz_6ph_mpc_prediction
-- Source Path: uz_mpc_cost_and_optim_state_machine/uz_6ph_mpc_prediction
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
USE work.uz_6ph_predict_ip_src_uz_6ph_mpc_prediction_pkg.ALL;

ENTITY uz_6ph_predict_ip_src_uz_6ph_mpc_prediction IS
  PORT( clk                               :   IN    std_logic;
        reset                             :   IN    std_logic;
        clk_enable                        :   IN    std_logic;
        id_delay_pu                       :   IN    std_logic_vector(26 DOWNTO 0);  -- sfix27_En24
        iq_delay_pu                       :   IN    std_logic_vector(26 DOWNTO 0);  -- sfix27_En24
        ix_delay_pu                       :   IN    std_logic_vector(26 DOWNTO 0);  -- sfix27_En24
        iy_delay_pu                       :   IN    std_logic_vector(26 DOWNTO 0);  -- sfix27_En24
...
END uz_6ph_predict_ip_src_uz_6ph_mpc_prediction;


ARCHITECTURE rtl OF uz_6ph_predict_ip_src_uz_6ph_mpc_prediction IS

  -- Component Declarations
  COMPONENT uz_6ph_predict_ip_src_Detect_Rise_Positive
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  COMPONENT uz_6ph_predict_ip_src_Detect_Rise_Positive1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  COMPONENT uz_6ph_predict_ip_src_Detect_Rise_Positive2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  COMPONENT uz_6ph_predict_ip_src_Detect_Rise_Positive3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  COMPONENT uz_6ph_predict_ip_src_Subsystem
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          Set                             :   IN    std_logic;
  ...
  FOR ALL : uz_6ph_predict_ip_src_Detect_Rise_Positive
    USE ENTITY work.uz_6ph_predict_ip_src_Detect_Rise_Positive(rtl);

  FOR ALL : uz_6ph_predict_ip_src_Detect_Rise_Positive1
    USE ENTITY work.uz_6ph_predict_ip_src_Detect_Rise_Positive1(rtl);

  FOR ALL : uz_6ph_predict_ip_src_Detect_Rise_Positive2
    USE ENTITY work.uz_6ph_predict_ip_src_Detect_Rise_Positive2(rtl);

  FOR ALL : uz_6ph_predict_ip_src_Detect_Rise_Positive3
    USE ENTITY work.uz_6ph_predict_ip_src_Detect_Rise_Positive3(rtl);

  FOR ALL : uz_6ph_predict_ip_src_Subsystem
    USE ENTITY work.uz_6ph_predict_ip_src_Subsystem(rtl);
  ...
  SIGNAL ix_k_pu                          : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL Product12_mul_temp               : signed(44 DOWNTO 0);  -- sfix45_En39
  ...
  SIGNAL ix_k_pu_1                        : signed(26 DOWNTO 0);  -- sfix27_En24
  ...
  SIGNAL iy_k_pu                          : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL Product14_mul_temp               : signed(44 DOWNTO 0);  -- sfix45_En39
  ...
  SIGNAL iy_k_pu_1                        : signed(26 DOWNTO 0);  -- sfix27_En24
  ...
  SIGNAL TmpGroundAtSwitch6Inport3_out1   : std_logic;
...
BEGIN
  -- voltages are triggered from voltage calculation ip every iteration
  -- 
  ...
  u_Detect_Rise_Positive : uz_6ph_predict_ip_src_Detect_Rise_Positive
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              U => Delay_out1,
  ...
  u_Detect_Rise_Positive1 : uz_6ph_predict_ip_src_Detect_Rise_Positive1
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              U => Delay50_out1,
  ...
  u_Detect_Rise_Positive2 : uz_6ph_predict_ip_src_Detect_Rise_Positive2
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              U => Delay53_out1,
  ...
  u_Detect_Rise_Positive3 : uz_6ph_predict_ip_src_Detect_Rise_Positive3
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              U => Delay54_out1,
  ...
  u_Subsystem : uz_6ph_predict_ip_src_Subsystem
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              Set => Delay55_out1,
              Reset_1 => Detect_Rise_Positive3_out1,
              Q => Q
              );
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay50_reg(0) <= trigger_voltages_done;
  ...
  switch_compare_1_13 <= '1' WHEN delay_comp_done > '0' ELSE
      '0';
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay6_reg(0) <= ix_delay_pu_signed;
  ...
  Product12_out1 <= Product12_mul_temp(41 DOWNTO 24);
  ...
  Add5_out1 <= Add5_add_cast + ix_k_pu_1;
  ...
  switch_compare_1_16 <= '1' WHEN delay_comp_done > '0' ELSE
      '0';
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay8_reg(0) <= iy_delay_pu_signed;
  ...
  Product14_out1 <= Product14_mul_temp(41 DOWNTO 24);
  ...
  Add7_out1 <= Add7_add_cast + iy_k_pu_1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay55_out1 <= '0';
      ELSIF enb = '1' THEN
        Delay55_out1 <= Detect_Rise_Positive2_out1;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay54_out1 <= '0';
      ELSIF enb = '1' THEN
        Delay54_out1 <= Detect_Rise_Positive_out1;
      END IF;
    END IF;
  ...
  switch_compare_1_18 <= '1' WHEN Q > '0' ELSE
      '0';

  TmpGroundAtSwitch7Inport3_out1 <= '0';

  
  trigger_predict <= TmpGroundAtSwitch7Inport3_out1 WHEN switch_compare_1_18 = '0' ELSE
      Detect_Rise_Positive2_out1;

  Constant_out1 <= to_unsigned(63, 32);

  
  switch_compare_1_19 <= '1' WHEN Relational_Operator_relop1 > '0' ELSE
      '0';

  
  Switch4_out1 <= TmpGroundAtSwitch4Inport3_out1 WHEN switch_compare_1_19 = '0' ELSE
      trigger_predict;
  ...
  Relational_Operator_relop1 <= '1' WHEN HDL_Counter_out1 <= Constant_out1 ELSE
      '0';

  
  switch_compare_1_20 <= '1' WHEN Relational_Operator_relop1 > '0' ELSE
      '0';

  TmpGroundAtSwitch6Inport3_out1 <= '0';

  
  Switch6_out1 <= TmpGroundAtSwitch6Inport3_out1 WHEN switch_compare_1_20 = '0' ELSE
      trigger_predict;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay49_out1 <= HDL_Counter_out1;
      END IF;
    END IF;
  END PROCESS Delay49_process;


  index <= std_logic_vector(Delay49_out1);
