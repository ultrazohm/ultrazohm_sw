...
proc init_gui { IPINST } {
  ...
  #Adding Page
  set Page_0 [ipgui::add_page $IPINST -name "Page 0" -display_name {Config}]
  set_property tooltip {Config} ${Page_0}
  ...
  ipgui::add_param $IPINST -name "Enable_Multiple_CLK" -parent ${Page_0}
  ...
  #Adding Page
  set Conversion [ipgui::add_page $IPINST -name "Conversion"]
  set_property tooltip {Conversion} ${Conversion}
  ipgui::add_param $IPINST -name "TRIGGER_ADC" -parent ${Conversion}
  ipgui::add_param $IPINST -name "ADC_SET_USER_OFFSET_1" -parent ${Conversion}

  #Adding Page
  set AXI [ipgui::add_page $IPINST -name "AXI"]
  set_property tooltip {AXI} ${AXI}
...
proc update_PARAM_VALUE.Enable_Multiple_CLK { PARAM_VALUE.Enable_Multiple_CLK } {
	# Procedure called to update Enable_Multiple_CLK when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.Enable_Multiple_CLK { PARAM_VALUE.Enable_Multiple_CLK } {
	# Procedure called to validate Enable_Multiple_CLK
	return true
}
...
proc update_PARAM_VALUE.TRIGGER_ADC { PARAM_VALUE.TRIGGER_ADC } {
	# Procedure called to update TRIGGER_ADC when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.TRIGGER_ADC { PARAM_VALUE.TRIGGER_ADC } {
	# Procedure called to validate TRIGGER_ADC
	return true
}
...
proc update_MODELPARAM_VALUE.TRIGGER_ADC { MODELPARAM_VALUE.TRIGGER_ADC PARAM_VALUE.TRIGGER_ADC } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.TRIGGER_ADC}] ${MODELPARAM_VALUE.TRIGGER_ADC}
}

proc update_MODELPARAM_VALUE.Enable_Multiple_CLK { MODELPARAM_VALUE.Enable_Multiple_CLK PARAM_VALUE.Enable_Multiple_CLK } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.Enable_Multiple_CLK}] ${MODELPARAM_VALUE.Enable_Multiple_CLK}
}
