...
ENTITY uz_dac_spi_interface IS
  PORT( IPCORE_CLK                        :   IN    std_logic;  -- ufix1
        ...
        dac_data_1_pl                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
        dac_data_2_pl                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
        dac_data_3_pl                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
        dac_data_4_pl                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
        dac_data_5_pl                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
        dac_data_6_pl                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
        dac_data_7_pl                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
        dac_data_8_pl                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
...
ARCHITECTURE rtl OF uz_dac_spi_interface IS
  ...
  COMPONENT uz_dac_spi_interface_axi4
    PORT( reset_x                         :   IN    std_logic;
          ...
          write_use_input_from_axi        :   OUT   std_logic;  -- ufix1
          write_reset_value               :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16
          write_reset_dac_output          :   OUT   std_logic;  -- ufix1
  ...
  SIGNAL write_use_input_from_axi         : std_logic;  -- ufix1
  SIGNAL write_reset_value                : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL write_reset_dac_output           : std_logic;  -- ufix1
  SIGNAL dac_data_1_pl_unsigned           : unsigned(15 DOWNTO 0);  -- ufix16
  SIGNAL dac_data_1_pl_sig                : signed(15 DOWNTO 0);  -- sfix16
  SIGNAL dac_data_2_pl_unsigned           : unsigned(15 DOWNTO 0);  -- ufix16
  SIGNAL dac_data_2_pl_sig                : signed(15 DOWNTO 0);  -- sfix16
  SIGNAL dac_data_3_pl_unsigned           : unsigned(15 DOWNTO 0);  -- ufix16
  SIGNAL dac_data_3_pl_sig                : signed(15 DOWNTO 0);  -- sfix16
  SIGNAL dac_data_4_pl_unsigned           : unsigned(15 DOWNTO 0);  -- ufix16
  SIGNAL dac_data_4_pl_sig                : signed(15 DOWNTO 0);  -- sfix16
  SIGNAL dac_data_5_pl_unsigned           : unsigned(15 DOWNTO 0);  -- ufix16
  SIGNAL dac_data_5_pl_sig                : signed(15 DOWNTO 0);  -- sfix16
  SIGNAL dac_data_6_pl_unsigned           : unsigned(15 DOWNTO 0);  -- ufix16
  SIGNAL dac_data_6_pl_sig                : signed(15 DOWNTO 0);  -- sfix16
  SIGNAL dac_data_7_pl_unsigned           : unsigned(15 DOWNTO 0);  -- ufix16
  SIGNAL dac_data_7_pl_sig                : signed(15 DOWNTO 0);  -- sfix16
  SIGNAL dac_data_8_pl_unsigned           : unsigned(15 DOWNTO 0);  -- ufix16
  SIGNAL dac_data_8_pl_sig                : signed(15 DOWNTO 0);  -- sfix16
...
BEGIN
  ...
  u_uz_dac_spi_interface_axi4_inst : uz_dac_spi_interface_axi4
    PORT MAP( reset_x => reset_x,
              ...
              write_use_input_from_axi => write_use_input_from_axi,  -- ufix1
              write_reset_value => write_reset_value,  -- sfix16
              write_reset_dac_output => write_reset_dac_output,  -- ufix1
  ...
  u_uz_dac_spi_interface_dut_inst : uz_dac_spi_interface_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              ...
              dac_data_1_pl => std_logic_vector(dac_data_1_pl_sig),  -- sfix16
              dac_data_2_pl => std_logic_vector(dac_data_2_pl_sig),  -- sfix16
              dac_data_3_pl => std_logic_vector(dac_data_3_pl_sig),  -- sfix16
              dac_data_4_pl => std_logic_vector(dac_data_4_pl_sig),  -- sfix16
              dac_data_5_pl => std_logic_vector(dac_data_5_pl_sig),  -- sfix16
              dac_data_6_pl => std_logic_vector(dac_data_6_pl_sig),  -- sfix16
              dac_data_7_pl => std_logic_vector(dac_data_7_pl_sig),  -- sfix16
              dac_data_8_pl => std_logic_vector(dac_data_8_pl_sig),  -- sfix16
              trigger_write_pl => trigger_write_pl,  -- ufix1
              use_input_from_axi => write_use_input_from_axi,  -- ufix1
              reset_value => write_reset_value,  -- sfix16
              reset_dac_output => write_reset_dac_output,  -- ufix1
              reset_dac_output_pl => reset_dac_output_pl,  -- ufix1
  ...
  ip_timestamp <= unsigned'(X"8F794BD1");

  reset_cm <=  NOT IPCORE_RESETN;

  reset_before_sync <= reset_cm OR reset_internal;

  dac_data_1_pl_unsigned <= unsigned(dac_data_1_pl);

  dac_data_1_pl_sig <= signed(dac_data_1_pl_unsigned);

  dac_data_2_pl_unsigned <= unsigned(dac_data_2_pl);

  dac_data_2_pl_sig <= signed(dac_data_2_pl_unsigned);

  dac_data_3_pl_unsigned <= unsigned(dac_data_3_pl);

  dac_data_3_pl_sig <= signed(dac_data_3_pl_unsigned);

  dac_data_4_pl_unsigned <= unsigned(dac_data_4_pl);

  dac_data_4_pl_sig <= signed(dac_data_4_pl_unsigned);

  dac_data_5_pl_unsigned <= unsigned(dac_data_5_pl);

  dac_data_5_pl_sig <= signed(dac_data_5_pl_unsigned);

  dac_data_6_pl_unsigned <= unsigned(dac_data_6_pl);

  dac_data_6_pl_sig <= signed(dac_data_6_pl_unsigned);

  dac_data_7_pl_unsigned <= unsigned(dac_data_7_pl);

  dac_data_7_pl_sig <= signed(dac_data_7_pl_unsigned);

  dac_data_8_pl_unsigned <= unsigned(dac_data_8_pl);

  dac_data_8_pl_sig <= signed(dac_data_8_pl_unsigned);
