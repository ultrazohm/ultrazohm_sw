...
module uz_NN_acc_Loop_1_proc1_Pipeline_burst_Observation (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [4:0] trunc_ln57_fu_108_p1;
reg   [4:0] trunc_ln57_reg_147;
reg   [4:0] trunc_ln57_reg_147_pp0_iter1_reg;
reg   [31:0] arrays_addr_read_reg_152;
reg    ap_condition_exit_pp0_iter1_stage0;
wire   [31:0] zext_ln57_fu_127_p1;
reg   [31:0] i_fu_50;
wire   [31:0] add_ln54_fu_102_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln54_fu_96_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln54_reg_143 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        arrays_addr_read_reg_152 <= m_axi_arrays_RDATA;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln54_fu_96_p2 == 1'd0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln54_fu_96_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln54_reg_143 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (icmp_ln54_reg_143 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln54_reg_143 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign Observation_address0 = zext_ln57_fu_127_p1;

assign Observation_d0 = arrays_addr_read_reg_152;

assign add_ln54_fu_102_p2 = (ap_sig_allocacmp_i_4 + 32'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((icmp_ln54_reg_143 == 1'd0) & (m_axi_arrays_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((icmp_ln54_reg_143 == 1'd0) & (m_axi_arrays_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((icmp_ln54_reg_143 == 1'd0) & (m_axi_arrays_RVALID == 1'b0));
end
...
assign icmp_ln54_fu_96_p2 = ((ap_sig_allocacmp_i_4 == Observation_size_input) ? 1'b1 : 1'b0);
...
assign trunc_ln57_fu_108_p1 = ap_sig_allocacmp_i_4[4:0];

assign zext_ln57_fu_127_p1 = trunc_ln57_reg_147_pp0_iter1_reg;

endmodule //uz_NN_acc_Loop_1_proc1_Pipeline_burst_Observation
