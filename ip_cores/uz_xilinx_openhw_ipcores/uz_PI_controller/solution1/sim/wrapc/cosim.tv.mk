...
$(ObjDir)/uz_PI_controller.cpp_pre.cpp.tb.o : uz_PI_controller.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling uz_PI_controller.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
