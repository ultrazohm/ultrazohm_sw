...
ARCHITECTURE rtl OF uz_dac_spi_interface_addr_decoder IS
  ...
  SIGNAL decode_sel_use_input_from_axi_1_1 : std_logic;  -- ufix1
  SIGNAL reg_enb_use_input_from_axi_1_1   : std_logic;  -- ufix1
  SIGNAL data_in_use_input_from_axi       : std_logic;  -- ufix1
  SIGNAL data_reg_use_input_from_axi_1_1  : std_logic;  -- ufix1
  SIGNAL decode_sel_reset_value_1_1       : std_logic;  -- ufix1
  SIGNAL reg_enb_reset_value_1_1          : std_logic;  -- ufix1
  SIGNAL data_in_reset_value              : signed(15 DOWNTO 0);  -- sfix16
  SIGNAL data_reg_reset_value_1_1         : signed(15 DOWNTO 0);  -- sfix16
  SIGNAL decode_sel_reset_dac_output_1_1  : std_logic;  -- ufix1
  SIGNAL reg_enb_reset_dac_output_1_1     : std_logic;  -- ufix1
  SIGNAL data_in_reset_dac_output         : std_logic;  -- ufix1
  SIGNAL data_reg_reset_dac_output_1_1    : std_logic;  -- ufix1
...
BEGIN
  ...
  decode_sel_use_input_from_axi_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0052#, 14) ELSE
      '0';

  reg_enb_use_input_from_axi_1_1 <= decode_sel_use_input_from_axi_1_1 AND wr_enb;

  data_in_use_input_from_axi <= data_write_unsigned(0);

  reg_use_input_from_axi_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        data_reg_use_input_from_axi_1_1 <= '0';
      ELSIF enb = '1' AND reg_enb_use_input_from_axi_1_1 = '1' THEN
        data_reg_use_input_from_axi_1_1 <= data_in_use_input_from_axi;
      END IF;
    END IF;
  END PROCESS reg_use_input_from_axi_1_1_process;


  
  decode_sel_reset_value_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0053#, 14) ELSE
      '0';

  reg_enb_reset_value_1_1 <= decode_sel_reset_value_1_1 AND wr_enb;

  data_in_reset_value <= signed(data_write_unsigned(15 DOWNTO 0));

  reg_reset_value_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        data_reg_reset_value_1_1 <= to_signed(16#0000#, 16);
      ELSIF enb = '1' AND reg_enb_reset_value_1_1 = '1' THEN
        data_reg_reset_value_1_1 <= data_in_reset_value;
      END IF;
    END IF;
  END PROCESS reg_reset_value_1_1_process;


  write_reset_value <= std_logic_vector(data_reg_reset_value_1_1);

  
  decode_sel_reset_dac_output_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0054#, 14) ELSE
      '0';

  reg_enb_reset_dac_output_1_1 <= decode_sel_reset_dac_output_1_1 AND wr_enb;

  data_in_reset_dac_output <= data_write_unsigned(0);

  reg_reset_dac_output_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        data_reg_reset_dac_output_1_1 <= '0';
      ELSIF enb = '1' AND reg_enb_reset_dac_output_1_1 = '1' THEN
        data_reg_reset_dac_output_1_1 <= data_in_reset_dac_output;
      END IF;
    END IF;
  END PROCESS reg_reset_dac_output_1_1_process;
  ...
  write_use_input_from_axi <= data_reg_use_input_from_axi_1_1;

  write_reset_dac_output <= data_reg_reset_dac_output_1_1;
