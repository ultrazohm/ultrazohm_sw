-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\IP_Core_SS_Switch_and_PWM\PWM_and_SS_control_ip_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: PWM_and_SS_control_ip_dut
-- Source Path: PWM_and_SS_control_ip/PWM_and_SS_control_ip_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY PWM_and_SS_control_ip_dut IS
...
END PWM_and_SS_control_ip_dut;


ARCHITECTURE rtl OF PWM_and_SS_control_ip_dut IS

  -- Component Declarations
  COMPONENT PWM_and_SS_control_ip_src_PWM_and_Switching_Signal_Control
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : PWM_and_SS_control_ip_src_PWM_and_Switching_Signal_Control
    USE ENTITY work.PWM_and_SS_control_ip_src_PWM_and_Switching_Signal_Control(rtl);
...
BEGIN
  u_PWM_and_SS_control_ip_src_PWM_and_Switching_Signal_Control : PWM_and_SS_control_ip_src_PWM_and_Switching_Signal_Control
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
