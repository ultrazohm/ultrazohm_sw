-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Transformation_V12\Trans_123_dq_V12_ip_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Trans_123_dq_V12_ip_axi_lite
-- Source Path: Trans_123_dq_V12_ip/Trans_123_dq_V12_ip_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Trans_123_dq_V12_ip_axi_lite IS
...
END Trans_123_dq_V12_ip_axi_lite;


ARCHITECTURE rtl OF Trans_123_dq_V12_ip_axi_lite IS

  -- Component Declarations
  COMPONENT Trans_123_dq_V12_ip_addr_decoder
  ...
  COMPONENT Trans_123_dq_V12_ip_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : Trans_123_dq_V12_ip_addr_decoder
    USE ENTITY work.Trans_123_dq_V12_ip_addr_decoder(rtl);

  FOR ALL : Trans_123_dq_V12_ip_axi_lite_module
    USE ENTITY work.Trans_123_dq_V12_ip_axi_lite_module(rtl);
...
BEGIN
  u_Trans_123_dq_V12_ip_addr_decoder_inst : Trans_123_dq_V12_ip_addr_decoder
  ...
  u_Trans_123_dq_V12_ip_axi_lite_module_inst : Trans_123_dq_V12_ip_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
