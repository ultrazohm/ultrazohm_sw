...
void XBgd_Start(XBgd *InstancePtr) {
    ...
    Data = XBgd_ReadReg(InstancePtr->Control_BaseAddress, XBGD_CONTROL_ADDR_AP_CTRL) & 0x80;
    XBgd_WriteReg(InstancePtr->Control_BaseAddress, XBGD_CONTROL_ADDR_AP_CTRL, Data | 0x01);
}
...
u32 XBgd_IsDone(XBgd *InstancePtr) {
    ...
    Data = XBgd_ReadReg(InstancePtr->Control_BaseAddress, XBGD_CONTROL_ADDR_AP_CTRL);
    return (Data >> 1) & 0x1;
}
...
void XBgd_EnableAutoRestart(XBgd *InstancePtr) {
    ...
    XBgd_WriteReg(InstancePtr->Control_BaseAddress, XBGD_CONTROL_ADDR_AP_CTRL, 0x80);
}
...
void XBgd_DisableAutoRestart(XBgd *InstancePtr) {
    ...
    XBgd_WriteReg(InstancePtr->Control_BaseAddress, XBGD_CONTROL_ADDR_AP_CTRL, 0);
}
...
void XBgd_InterruptGlobalEnable(XBgd *InstancePtr) {
    ...
    XBgd_WriteReg(InstancePtr->Control_BaseAddress, XBGD_CONTROL_ADDR_GIE, 1);
}
...
void XBgd_InterruptGlobalDisable(XBgd *InstancePtr) {
    ...
    XBgd_WriteReg(InstancePtr->Control_BaseAddress, XBGD_CONTROL_ADDR_GIE, 0);
}
...
void XBgd_InterruptEnable(XBgd *InstancePtr, u32 Mask) {
    ...
    Register =  XBgd_ReadReg(InstancePtr->Control_BaseAddress, XBGD_CONTROL_ADDR_IER);
    XBgd_WriteReg(InstancePtr->Control_BaseAddress, XBGD_CONTROL_ADDR_IER, Register | Mask);
}
...
void XBgd_InterruptClear(XBgd *InstancePtr, u32 Mask) {
    ...
    XBgd_WriteReg(InstancePtr->Control_BaseAddress, XBGD_CONTROL_ADDR_ISR, Mask);
}
...
u32 XBgd_InterruptGetEnabled(XBgd *InstancePtr) {
    ...
    return XBgd_ReadReg(InstancePtr->Control_BaseAddress, XBGD_CONTROL_ADDR_IER);
}
...
u32 XBgd_InterruptGetStatus(XBgd *InstancePtr) {
    ...
    return XBgd_ReadReg(InstancePtr->Control_BaseAddress, XBGD_CONTROL_ADDR_ISR);
}
