-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\IP_Core_SS_Switch_and_PWM\IP_Core_S_ip_addr_decoder.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IP_Core_S_ip_addr_decoder
-- Source Path: IP_Core_S_ip/IP_Core_S_ip_axi_lite/IP_Core_S_ip_addr_decoder
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY IP_Core_S_ip_addr_decoder IS
...
END IP_Core_S_ip_addr_decoder;


ARCHITECTURE rtl OF IP_Core_S_ip_addr_decoder IS
...
BEGIN
  ...
  decode_sel_Mode_rd_AXI <= '1' WHEN addr_sel_unsigned = to_unsigned(16#004A#, 14) ELSE
      '0';

  
  decode_sel_PWM_min_pulse_width_rd_AXI <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0049#, 14) ELSE
      '0';

  
  decode_sel_PWM_f_carrier_kHz_rd_AXI <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0048#, 14) ELSE
      '0';

  
  decode_sel_PWM_en_rd_AXI <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0047#, 14) ELSE
      '0';
  ...
  decode_rd_PWM_min_pulse_width_rd_AXI <= decode_rd_PWM_f_carrier_kHz_rd_AXI WHEN decode_sel_PWM_min_pulse_width_rd_AXI = '0' ELSE
  ...
  decode_sel_PWM_min_pulse_wiidth_AXI <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0043#, 14) ELSE
      '0';
  ...
  decode_sel_m_u1_norm_AXI <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0044#, 14) ELSE
      '0';
  ...
  decode_sel_m_u2_norm_AXI <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0045#, 14) ELSE
      '0';
  ...
  decode_sel_m_u3_norm_AXI <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0046#, 14) ELSE
      '0';
