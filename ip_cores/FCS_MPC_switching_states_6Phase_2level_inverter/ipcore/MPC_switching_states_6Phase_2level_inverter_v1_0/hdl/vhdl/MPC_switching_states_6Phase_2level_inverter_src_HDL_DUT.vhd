-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\FCS_MPC_switching_states_6Phase_2level_inverter\hdlsrc\FCS_MPC_switching_states_6Phase_2level_inverter\MPC_switching_states_6Phase_2level_inverter_src_HDL_DUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MPC_switching_states_6Phase_2level_inverter_src_HDL_DUT
-- Source Path: FCS_MPC_switching_states_6Phase_2level_inverter/HDL_DUT
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY MPC_switching_states_6Phase_2level_inverter_src_HDL_DUT IS
...
END MPC_switching_states_6Phase_2level_inverter_src_HDL_DUT;


ARCHITECTURE rtl OF MPC_switching_states_6Phase_2level_inverter_src_HDL_DUT IS

  -- Component Declarations
  COMPONENT MPC_switching_states_6Phase_2level_inverter_src_Detect_Rise_Positive
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  COMPONENT MPC_switching_states_6Phase_2level_inverter_src_MATLAB_Function1
  ...
  FOR ALL : MPC_switching_states_6Phase_2level_inverter_src_Detect_Rise_Positive
    USE ENTITY work.MPC_switching_states_6Phase_2level_inverter_src_Detect_Rise_Positive(rtl);

  FOR ALL : MPC_switching_states_6Phase_2level_inverter_src_MATLAB_Function1
    USE ENTITY work.MPC_switching_states_6Phase_2level_inverter_src_MATLAB_Function1(rtl);
...
BEGIN
  u_Detect_Rise_Positive : MPC_switching_states_6Phase_2level_inverter_src_Detect_Rise_Positive
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              U => Delay_out1,
  ...
  u_MATLAB_Function1 : MPC_switching_states_6Phase_2level_inverter_src_MATLAB_Function1
