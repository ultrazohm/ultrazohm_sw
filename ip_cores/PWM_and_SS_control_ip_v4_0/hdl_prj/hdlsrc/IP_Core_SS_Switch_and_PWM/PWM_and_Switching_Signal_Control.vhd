-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/IP_Core_SS_Switch_and_PWM/PWM_and_Switching_Signal_Control.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: PWM_and_Switching_Signal_Control
...
ENTITY PWM_and_Switching_Signal_Control IS
...
END PWM_and_Switching_Signal_Control;


ARCHITECTURE rtl OF PWM_and_Switching_Signal_Control IS
  ...
  COMPONENT VSI_Control_Signal_Switch
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : GenPWM
    USE ENTITY work.GenPWM(rtl);

  FOR ALL : VSI_Control_Signal_Switch
    USE ENTITY work.VSI_Control_Signal_Switch(rtl);

  -- Signals
  SIGNAL enb                              : std_logic;
  SIGNAL Mode_AXI_unsigned                : unsigned(1 DOWNTO 0);  -- ufix2
  SIGNAL m_u1_norm_AXI_signed             : signed(17 DOWNTO 0);  -- sfix18_En16
  SIGNAL m_u1_norm_signed                 : signed(17 DOWNTO 0);  -- sfix18_En16
  SIGNAL Switch7_out1                     : signed(17 DOWNTO 0);  -- sfix18_En16
  SIGNAL m_u2_norm_AXI_signed             : signed(17 DOWNTO 0);  -- sfix18_En16
  SIGNAL m_u2_norm_signed                 : signed(17 DOWNTO 0);  -- sfix18_En16
  SIGNAL Switch8_out1                     : signed(17 DOWNTO 0);  -- sfix18_En16
  SIGNAL m_u3_norm_AXI_signed             : signed(17 DOWNTO 0);  -- sfix18_En16
  SIGNAL m_u3_norm_signed                 : signed(17 DOWNTO 0);  -- sfix18_En16
  SIGNAL Switch9_out1                     : signed(17 DOWNTO 0);  -- sfix18_En16
  ...
  SIGNAL TriState_HB_AXI_unsigned         : unsigned(2 DOWNTO 0);  -- ufix3
...
BEGIN
  ...
  u_GenPWM : GenPWM
    PORT MAP( clk => clk,
              ...
              U1_norm => std_logic_vector(Switch7_out1),  -- sfix18_En16
              U2_norm => std_logic_vector(Switch8_out1),  -- sfix18_En16
              U3_norm => std_logic_vector(Switch9_out1),  -- sfix18_En16
  ...
  u_VSI_Control_Signal_Switch : VSI_Control_Signal_Switch
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              ...
              TriState_HB1_AXI => Bit_Slice_out1,  -- ufix1
              TriState_HB2_AXI => Bit_Slice1_out1,  -- ufix1
              TriState_HB3_AXI => Bit_Slice2_out1,  -- ufix1
  ...
  TriState_HB_AXI_unsigned <= unsigned(TriState_HB_AXI);

  Bit_Slice_out1 <= TriState_HB_AXI_unsigned(0);

  Bit_Slice1_out1 <= TriState_HB_AXI_unsigned(1);

  Bit_Slice2_out1 <= TriState_HB_AXI_unsigned(2);
