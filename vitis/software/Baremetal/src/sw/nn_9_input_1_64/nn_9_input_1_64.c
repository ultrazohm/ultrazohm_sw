...
void nn_init(void){
	 Global_Data.objects.matrix_input =uz_matrix_init(&input_matrix_9n,x_9,UZ_MATRIX_SIZE(x_9),1U,NUMBER_OF_INPUTS_9N);
	 Global_Data.objects.nn_layer = uz_nn_init(config_9nn, 2U);
}
