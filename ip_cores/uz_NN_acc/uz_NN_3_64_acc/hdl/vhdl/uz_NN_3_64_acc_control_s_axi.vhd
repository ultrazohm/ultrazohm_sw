...
entity uz_NN_3_64_acc_control_s_axi is
generic (
...
end entity uz_NN_3_64_acc_control_s_axi;
...
architecture behave of uz_NN_3_64_acc_control_s_axi is
    ...
    constant ADDR_L_4_WEIGHTS_INPUT_DATA_0      : INTEGER := 16#30#;
    constant ADDR_L_4_WEIGHTS_INPUT_CTRL        : INTEGER := 16#34#;
    constant ADDR_L_5_WEIGHTS_INPUT_DATA_0      : INTEGER := 16#38#;
    constant ADDR_L_5_WEIGHTS_INPUT_CTRL        : INTEGER := 16#3c#;
    constant ADDR_L_OUTPUT_WEIGHTS_INPUT_DATA_0 : INTEGER := 16#40#;
    constant ADDR_L_OUTPUT_WEIGHTS_INPUT_CTRL   : INTEGER := 16#44#;
    constant ADDR_ACTION_OUTPUT_DATA_0          : INTEGER := 16#48#;
    constant ADDR_ACTION_OUTPUT_CTRL            : INTEGER := 16#4c#;
    constant ADDR_L_1_BIAS_INPUT_DATA_0         : INTEGER := 16#50#;
    constant ADDR_L_1_BIAS_INPUT_CTRL           : INTEGER := 16#54#;
    constant ADDR_L_2_BIAS_INPUT_DATA_0         : INTEGER := 16#58#;
    constant ADDR_L_2_BIAS_INPUT_CTRL           : INTEGER := 16#5c#;
    constant ADDR_L_3_BIAS_INPUT_DATA_0         : INTEGER := 16#60#;
    constant ADDR_L_3_BIAS_INPUT_CTRL           : INTEGER := 16#64#;
    constant ADDR_L_4_BIAS_INPUT_DATA_0         : INTEGER := 16#68#;
    constant ADDR_L_4_BIAS_INPUT_CTRL           : INTEGER := 16#6c#;
    constant ADDR_L_5_BIAS_INPUT_DATA_0         : INTEGER := 16#70#;
    constant ADDR_L_5_BIAS_INPUT_CTRL           : INTEGER := 16#74#;
    constant ADDR_L_OUTPUT_BIAS_INPUT_DATA_0    : INTEGER := 16#78#;
    constant ADDR_L_OUTPUT_BIAS_INPUT_CTRL      : INTEGER := 16#7c#;
    constant ADDR_COPY_MATS_FLAG_DATA_0         : INTEGER := 16#80#;
    constant ADDR_COPY_MATS_FLAG_CTRL           : INTEGER := 16#84#;
    constant ADDR_OBSERVATION_SIZE_INPUT_DATA_0 : INTEGER := 16#88#;
    constant ADDR_OBSERVATION_SIZE_INPUT_CTRL   : INTEGER := 16#8c#;
    constant ADDR_ACTION_SIZE_INPUT_DATA_0      : INTEGER := 16#90#;
    constant ADDR_ACTION_SIZE_INPUT_CTRL        : INTEGER := 16#94#;
    constant ADDR_COPY_FLAG_OUT_DATA_0          : INTEGER := 16#98#;
    constant ADDR_COPY_FLAG_OUT_CTRL            : INTEGER := 16#9c#;
    constant ADDR_MATRICES_UPDATED_OUT_DATA_0   : INTEGER := 16#a8#;
    constant ADDR_MATRICES_UPDATED_OUT_CTRL     : INTEGER := 16#ac#;
    constant ADDR_COMPUTE_FLAG_DATA_0           : INTEGER := 16#b8#;
    constant ADDR_COMPUTE_FLAG_CTRL             : INTEGER := 16#bc#;
