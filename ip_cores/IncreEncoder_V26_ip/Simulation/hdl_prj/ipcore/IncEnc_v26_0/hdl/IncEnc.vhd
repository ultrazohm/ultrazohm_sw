-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\inc_enc_v26\IncEnc.vhd
...
ARCHITECTURE rtl OF IncEnc IS
  ...
  COMPONENT IncEnc_dut
    PORT( clk                             :   IN    std_logic;  -- ufix1
          ...
          new_measurement                 :   OUT   std_logic;  -- ufix1
          position_wOffset                :   OUT   std_logic_vector(15 DOWNTO 0);  -- ufix16
          position_AXI_wOffset            :   OUT   std_logic_vector(15 DOWNTO 0);  -- ufix16
          Index_found                     :   OUT   std_logic;  -- ufix1
          d_Axis_Hit                      :   OUT   std_logic  -- ufix1
          );
  END COMPONENT;
  ...
  FOR ALL : IncEnc_reset_sync
    USE ENTITY work.IncEnc_reset_sync(rtl);

  FOR ALL : IncEnc_axi_lite
    USE ENTITY work.IncEnc_axi_lite(rtl);

  FOR ALL : IncEnc_dut
    USE ENTITY work.IncEnc_dut(rtl);
  ...
  SIGNAL position_AXI_wOffset_sig         : std_logic_vector(15 DOWNTO 0);  -- ufix16
...
BEGIN
  u_IncEnc_reset_sync_inst : IncEnc_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset_x
              );

  u_IncEnc_axi_lite_inst : IncEnc_axi_lite
    PORT MAP( reset_x => reset_x,
              ...
              read_position_AXI_wOffset => position_AXI_wOffset_sig,  -- ufix16
  ...
  u_IncEnc_dut_inst : IncEnc_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              ...
              position_AXI_wOffset => position_AXI_wOffset_sig,  -- ufix16
              Index_found => Index_found_sig,  -- ufix1
              d_Axis_Hit => d_Axis_Hit_sig  -- ufix1
              );

  ip_timestamp <= unsigned'(X"89391C67");
