...
################################################################
# This is a generated script based on design: pi_bd
#
...
xilinx.com:hls:uz_PI_Controller_sample:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: uz_PI_Controller_sam_0, and set properties
  set uz_PI_Controller_sam_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:uz_PI_Controller_sample:1.0 uz_PI_Controller_sam_0 ]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins ps8_0_axi_periph/M00_AXI] [get_bd_intf_pins uz_PI_Controller_sam_0/s_axi_control]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins ps8_0_axi_periph/M01_AXI] [get_bd_intf_pins uz_PI_Controller_sam_0/s_axi_Din]
  connect_bd_intf_net -intf_net uz_PI_Controller_sam_0_m_axi_Dout [get_bd_intf_pins axi_smc/S00_AXI] [get_bd_intf_pins uz_PI_Controller_sam_0/m_axi_Dout]
connect_bd_intf_net -intf_net [get_bd_intf_nets uz_PI_Controller_sam_0_m_axi_Dout] [get_bd_intf_pins axi_smc/S00_AXI] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets uz_PI_Controller_sam_0_m_axi_Dout]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_FPD [get_bd_intf_pins ps8_0_axi_periph/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD]

  # Create port connections
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins axi_smc/aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn] [get_bd_pins system_ila_0/resetn] [get_bd_pins uz_PI_Controller_sam_0/ap_rst_n]
  connect_bd_net -net uz_PI_Controller_sam_0_interrupt [get_bd_pins uz_PI_Controller_sam_0/interrupt] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_smc/aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins uz_PI_Controller_sam_0/ap_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxiacp_fpd_aclk]
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces uz_PI_Controller_sam_0/Data_m_axi_Dout] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIACP/ACP_DDR_LOW] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces uz_PI_Controller_sam_0/Data_m_axi_Dout] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIACP/ACP_QSPI] -force
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs uz_PI_Controller_sam_0/s_axi_control/Reg] -force
  assign_bd_address -offset 0xA0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs uz_PI_Controller_sam_0/s_axi_Din/Reg] -force

  # Exclude Address Segments
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces uz_PI_Controller_sam_0/Data_m_axi_Dout] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIACP/ACP_LPS_OCM]
