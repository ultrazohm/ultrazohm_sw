-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\Philipp\uz_temp\ultrazohm_sw\ip_cores\uz_pmsm_model\hdl_prj\hdlsrc\uz_pmsm_model\uz_pmsm_model_axi4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_axi4
-- Source Path: uz_pmsm_model/uz_pmsm_model_axi4
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END uz_pmsm_model_axi4;


ARCHITECTURE rtl OF uz_pmsm_model_axi4 IS
  ...
  COMPONENT uz_pmsm_model_axi4_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_ARESETN                    :   IN    std_logic;  -- ufix1
          AXI4_AWID                       :   IN    std_logic_vector(11 DOWNTO 0);  -- ufix12
          AXI4_AWADDR                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  FOR ALL : uz_pmsm_model_axi4_module
    USE ENTITY work.uz_pmsm_model_axi4_module(rtl);
  ...
  SIGNAL write_ad1_tmp                    : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_ad2_tmp                    : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_ad3_tmp                    : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_ad4_tmp                    : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_ad5_tmp                    : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_ad6_tmp                    : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_aq1_tmp                    : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_aq2_tmp                    : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_aq3_tmp                    : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_aq4_tmp                    : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_aq5_tmp                    : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_aq6_tmp                    : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_reciprocal_F1G1_tmp        : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_reciprocal_F2G2_tmp        : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_ad4_mul_ad5_tmp            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_ad1_mul_ad2_tmp            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_aq4_mul_aq5_tmp            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_aq1_mul_aq2_tmp            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_aq4_div_aq5_tmp            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_aq1_div_aq2_tmp            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_ad4_div_ad5_tmp            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_ad1_div_ad2_tmp            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_aq3_min_aq6_tmp            : std_logic_vector(31 DOWNTO 0);  -- ufix32
...
BEGIN
  u_uz_pmsm_model_addr_decoder_inst : uz_pmsm_model_addr_decoder
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
              ...
              read_outputs_fitting_parameter => read_outputs_fitting_parameter,  -- ufix32 [23]
              ...
              write_ad1 => write_ad1_tmp,  -- ufix32
              write_ad2 => write_ad2_tmp,  -- ufix32
              write_ad3 => write_ad3_tmp,  -- ufix32
              write_ad4 => write_ad4_tmp,  -- ufix32
              write_ad5 => write_ad5_tmp,  -- ufix32
              write_ad6 => write_ad6_tmp,  -- ufix32
              write_aq1 => write_aq1_tmp,  -- ufix32
              write_aq2 => write_aq2_tmp,  -- ufix32
              write_aq3 => write_aq3_tmp,  -- ufix32
              write_aq4 => write_aq4_tmp,  -- ufix32
              write_aq5 => write_aq5_tmp,  -- ufix32
              write_aq6 => write_aq6_tmp,  -- ufix32
              write_reciprocal_F1G1 => write_reciprocal_F1G1_tmp,  -- ufix32
              write_reciprocal_F2G2 => write_reciprocal_F2G2_tmp,  -- ufix32
              write_ad4_mul_ad5 => write_ad4_mul_ad5_tmp,  -- ufix32
              write_ad1_mul_ad2 => write_ad1_mul_ad2_tmp,  -- ufix32
              write_aq4_mul_aq5 => write_aq4_mul_aq5_tmp,  -- ufix32
              write_aq1_mul_aq2 => write_aq1_mul_aq2_tmp,  -- ufix32
              write_aq4_div_aq5 => write_aq4_div_aq5_tmp,  -- ufix32
              write_aq1_div_aq2 => write_aq1_div_aq2_tmp,  -- ufix32
              write_ad4_div_ad5 => write_ad4_div_ad5_tmp,  -- ufix32
              write_ad1_div_ad2 => write_ad1_div_ad2_tmp,  -- ufix32
              write_aq3_min_aq6 => write_aq3_min_aq6_tmp  -- ufix32
              );

  u_uz_pmsm_model_axi4_module_inst : uz_pmsm_model_axi4_module
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
  ...
  write_ad1 <= write_ad1_tmp;

  write_ad2 <= write_ad2_tmp;

  write_ad3 <= write_ad3_tmp;

  write_ad4 <= write_ad4_tmp;

  write_ad5 <= write_ad5_tmp;

  write_ad6 <= write_ad6_tmp;

  write_aq1 <= write_aq1_tmp;

  write_aq2 <= write_aq2_tmp;

  write_aq3 <= write_aq3_tmp;

  write_aq4 <= write_aq4_tmp;

  write_aq5 <= write_aq5_tmp;

  write_aq6 <= write_aq6_tmp;

  write_reciprocal_F1G1 <= write_reciprocal_F1G1_tmp;

  write_reciprocal_F2G2 <= write_reciprocal_F2G2_tmp;

  write_ad4_mul_ad5 <= write_ad4_mul_ad5_tmp;

  write_ad1_mul_ad2 <= write_ad1_mul_ad2_tmp;

  write_aq4_mul_aq5 <= write_aq4_mul_aq5_tmp;

  write_aq1_mul_aq2 <= write_aq1_mul_aq2_tmp;

  write_aq4_div_aq5 <= write_aq4_div_aq5_tmp;

  write_aq1_div_aq2 <= write_aq1_div_aq2_tmp;

  write_ad4_div_ad5 <= write_ad4_div_ad5_tmp;

  write_ad1_div_ad2 <= write_ad1_div_ad2_tmp;

  write_aq3_min_aq6 <= write_aq3_min_aq6_tmp;
