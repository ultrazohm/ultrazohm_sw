-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_pmsm_model_nonlinear\uz_pmsm_model_nonlinear.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_nonlinear
-- Source Path: uz_pmsm_model_nonlinear
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_pmsm_model_nonlinear IS
...
END uz_pmsm_model_nonlinear;


ARCHITECTURE rtl OF uz_pmsm_model_nonlinear IS

  -- Component Declarations
  COMPONENT uz_pmsm_model_nonlinear_reset_sync
  ...
  COMPONENT uz_pmsm_model_nonlinear_dut
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
  ...
  COMPONENT uz_pmsm_model_nonlinear_axi4
  ...
  FOR ALL : uz_pmsm_model_nonlinear_reset_sync
    USE ENTITY work.uz_pmsm_model_nonlinear_reset_sync(rtl);

  FOR ALL : uz_pmsm_model_nonlinear_dut
    USE ENTITY work.uz_pmsm_model_nonlinear_dut(rtl);

  FOR ALL : uz_pmsm_model_nonlinear_axi4
    USE ENTITY work.uz_pmsm_model_nonlinear_axi4(rtl);
...
BEGIN
  u_uz_pmsm_model_nonlinear_reset_sync_inst : uz_pmsm_model_nonlinear_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_uz_pmsm_model_nonlinear_dut_inst : uz_pmsm_model_nonlinear_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  u_uz_pmsm_model_nonlinear_axi4_inst : uz_pmsm_model_nonlinear_axi4
  ...
  ip_timestamp <= unsigned'(X"9B1A702F");
