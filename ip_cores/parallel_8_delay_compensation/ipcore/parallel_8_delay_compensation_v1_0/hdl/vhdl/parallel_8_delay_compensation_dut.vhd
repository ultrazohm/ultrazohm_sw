-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\parallel_8_delay_compensation\hdlsrc\parallel_8_delay_compensation\parallel_8_delay_compensation_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: parallel_8_delay_compensation_dut
-- Source Path: parallel_8_delay_compensation/parallel_8_delay_compensation_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY parallel_8_delay_compensation_dut IS
...
END parallel_8_delay_compensation_dut;


ARCHITECTURE rtl OF parallel_8_delay_compensation_dut IS

  -- Component Declarations
  COMPONENT parallel_8_delay_compensation_src_HDL_DUT
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : parallel_8_delay_compensation_src_HDL_DUT
    USE ENTITY work.parallel_8_delay_compensation_src_HDL_DUT(rtl);
...
BEGIN
  u_parallel_8_delay_compensation_src_HDL_DUT : parallel_8_delay_compensation_src_HDL_DUT
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
