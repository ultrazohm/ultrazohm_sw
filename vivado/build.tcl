...
#    "${origin_dir}/src/hdl/uz_usr_access_bridge.vhd"
...
#    "${origin_dir}/constraints/te0808/uz_dac8831_A2.xdc"
#    "${origin_dir}/constraints/te0808/Analog_A3_ADC_MAX11331.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/constraints/$board_family/uz_dac8831_A2.xdc"]"\
 "[file normalize "$origin_dir/constraints/$board_family/Analog_A3_ADC_MAX11331.xdc"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/constraints/$board_family/uz_dac8831_A2.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/constraints/$board_family/uz_dac8831_A2.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj

# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/constraints/$board_family/Analog_A3_ADC_MAX11331.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/constraints/$board_family/Analog_A3_ADC_MAX11331.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
