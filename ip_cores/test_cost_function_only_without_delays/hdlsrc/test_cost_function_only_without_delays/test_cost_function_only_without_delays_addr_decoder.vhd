-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\test_cost_function_only_without_delays\hdlsrc\test_cost_function_only_without_delays\test_cost_function_only_without_delays_addr_decoder.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: test_cost_function_only_without_delays_addr_decoder
-- Source Path: test_cost_function_only_without_delays/test_cost_function_only_without_delays_axi_lite/test_cost_function_only_without_delays_addr_decoder
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY test_cost_function_only_without_delays_addr_decoder IS
...
END test_cost_function_only_without_delays_addr_decoder;


ARCHITECTURE rtl OF test_cost_function_only_without_delays_addr_decoder IS
  ...
  SIGNAL data_in_ix_ref_AXI               : signed(17 DOWNTO 0);  -- sfix18_En11
  SIGNAL data_reg_ix_ref_AXI_1_1          : signed(17 DOWNTO 0);  -- sfix18_En11
  SIGNAL decode_sel_iy_ref_AXI_1_1        : std_logic;  -- ufix1
  SIGNAL reg_enb_iy_ref_AXI_1_1           : std_logic;  -- ufix1
  SIGNAL data_in_iy_ref_AXI               : signed(17 DOWNTO 0);  -- sfix18_En11
  SIGNAL data_reg_iy_ref_AXI_1_1          : signed(17 DOWNTO 0);  -- sfix18_En11
...
BEGIN
  ...
  data_in_ix_ref_AXI <= signed(data_write_unsigned(17 DOWNTO 0));

  reg_ix_ref_AXI_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_ix_ref_AXI_1_1 <= to_signed(16#00000#, 18);
      ELSIF enb = '1' AND reg_enb_ix_ref_AXI_1_1 = '1' THEN
        data_reg_ix_ref_AXI_1_1 <= data_in_ix_ref_AXI;
      END IF;
    END IF;
  ...
  data_in_iy_ref_AXI <= signed(data_write_unsigned(17 DOWNTO 0));

  reg_iy_ref_AXI_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_iy_ref_AXI_1_1 <= to_signed(16#00000#, 18);
      ELSIF enb = '1' AND reg_enb_iy_ref_AXI_1_1 = '1' THEN
        data_reg_iy_ref_AXI_1_1 <= data_in_iy_ref_AXI;
      END IF;
    END IF;
