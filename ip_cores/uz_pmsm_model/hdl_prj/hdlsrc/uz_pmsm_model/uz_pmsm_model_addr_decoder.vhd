...
ENTITY uz_pmsm_model_addr_decoder IS
  PORT( clk                               :   IN    std_logic;
        ...
        read_out_omega_mech               :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
...
ARCHITECTURE rtl OF uz_pmsm_model_addr_decoder IS
  ...
  SIGNAL read_out_omega_mech_unsigned     : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_sel_out_omega_mech_1_1    : std_logic;  -- ufix1
  ...
  SIGNAL read_reg_out_omega_mech          : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_out_omega_mech_1_1     : unsigned(31 DOWNTO 0);  -- ufix32
...
BEGIN
  ...
  read_out_omega_mech_unsigned <= unsigned(read_out_omega_mech);

  
  decode_sel_out_omega_mech_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0051#, 14) ELSE
      '0';
  ...
  reg_out_omega_mech_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        read_reg_out_omega_mech <= to_unsigned(0, 32);
      ELSIF enb = '1' THEN
        read_reg_out_omega_mech <= read_out_omega_mech_unsigned;
      END IF;
    END IF;
  END PROCESS reg_out_omega_mech_process;


  
  decode_rd_out_omega_mech_1_1 <= decode_rd_torque_1_1 WHEN decode_sel_out_omega_mech_1_1 = '0' ELSE
      read_reg_out_omega_mech;

  data_read <= std_logic_vector(decode_rd_out_omega_mech_1_1);
  ...
  decode_sel_simulate_mechanical_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0040#, 14) ELSE
      '0';
  ...
  decode_sel_reciprocal_J_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0041#, 14) ELSE
      '0';
  ...
  decode_sel_reset_integrators_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0042#, 14) ELSE
      '0';
  ...
  decode_sel_reciprocal_L_d_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0044#, 14) ELSE
      '0';
  ...
  decode_sel_reciprocal_L_q_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0045#, 14) ELSE
      '0';
  ...
  decode_sel_M_n0_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0046#, 14) ELSE
      '0';
  ...
  decode_sel_u_d_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#004A#, 14) ELSE
      '0';
  ...
  decode_sel_u_q_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#004B#, 14) ELSE
      '0';
  ...
  decode_sel_in_omega_mech_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#004C#, 14) ELSE
      '0';
