-- -------------------------------------------------------------
-- 
-- File Name: C:\utrazohm_sw_2\ultrazohm_sw\ip_cores\uz_count_switching\hdl_prj\hdlsrc\uz_count_switching\uz_count_ip_axi4_module.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_count_ip_axi4_module
-- Source Path: uz_count_ip/uz_count_ip_axi4/uz_count_ip_axi4_module
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_count_ip_axi4_module IS
...
END uz_count_ip_axi4_module;


ARCHITECTURE rtl OF uz_count_ip_axi4_module IS

  -- Component Declarations
  COMPONENT uz_count_ip_rdfifo_data
    PORT( clk                             :   IN    std_logic;
  ...
  COMPONENT uz_count_ip_rdfifo_rid
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT uz_count_ip_rdfifo_last
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : uz_count_ip_rdfifo_data
    USE ENTITY work.uz_count_ip_rdfifo_data(rtl);

  FOR ALL : uz_count_ip_rdfifo_rid
    USE ENTITY work.uz_count_ip_rdfifo_rid(rtl);

  FOR ALL : uz_count_ip_rdfifo_last
    USE ENTITY work.uz_count_ip_rdfifo_last(rtl);
...
BEGIN
  u_uz_count_ip_rdfifo_data_inst : uz_count_ip_rdfifo_data
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => const_1,
  ...
  u_uz_count_ip_rdfifo_rid_inst : uz_count_ip_rdfifo_rid
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => const_1,
  ...
  u_uz_count_ip_rdfifo_last_inst : uz_count_ip_rdfifo_last
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => const_1,
  ...
  axi4_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  reg_wdata_in_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  reg_waddr_in_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  reg_wstrb_reduce_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      wstrb_reduce_reg <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
