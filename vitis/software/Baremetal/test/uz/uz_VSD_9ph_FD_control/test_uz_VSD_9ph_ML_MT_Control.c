...
void test_fault_indices_to_OPF_index(void){
        uz_9ph_abc_t indices = {
            ...
            .b3 = 0.0f,
            .c3 = 0.0f};//MSB
    int OPF_index = fault_indices_to_OPF_index(indices);
    TEST_ASSERT_EQUAL(OPF_index, 77); //=0b001001101
}

void test_uz_get_k_parameter_9ph_ML_N1(void){
    uz_9ph_abc_t indices = { //0b000001001=(int)9
            ...
            .b3 = 0.0f,
            .c3 = 0.0f};//MSB
    uz_9ph_MLMT_kparameter_t param = uz_get_k_parameter_9ph(indices, ML, 1);
    ...
    indices.a3 = 1.0f;
    indices.c3 = 1.0f;
    param = uz_get_k_parameter_9ph(indices, ML, 1);
    TEST_ASSERT_EQUAL(false, param.valid);
}

void test_uz_get_k_parameter_9ph_MT_N1(void){
    uz_9ph_abc_t indices = { //0b000001001=(int)9
            .a1 = 1.0f,//LSB
            .b1 = 0.0f,
            .c1 = 0.0f,
    ...
    indices.a3 = 1.0f;
    indices.c3 = 1.0f;
    param = uz_get_k_parameter_9ph(indices, MT, 1);
    TEST_ASSERT_EQUAL(false, param.valid);
}
