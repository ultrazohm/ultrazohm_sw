...
entity MultiLayerPerceptronDecoupled_configuration_s_axi is
generic (
...
end entity MultiLayerPerceptronDecoupled_configuration_s_axi;
...
architecture behave of MultiLayerPerceptronDecoupled_configuration_s_axi is
    ...
    constant ADDR_NUMBERINPUTS_DATA_0   : INTEGER := 16#10#;
    constant ADDR_NUMBERINPUTS_CTRL     : INTEGER := 16#14#;
    constant ADDR_NUMBEROUTPUTS_DATA_0  : INTEGER := 16#18#;
    constant ADDR_NUMBEROUTPUTS_CTRL    : INTEGER := 16#1c#;
    constant ADDR_NUMBERLAYERS_DATA_0   : INTEGER := 16#20#;
    constant ADDR_NUMBERLAYERS_CTRL     : INTEGER := 16#24#;
    constant ADDR_NUMBERNEURONS_DATA_0  : INTEGER := 16#28#;
    constant ADDR_NUMBERNEURONS_CTRL    : INTEGER := 16#2c#;
    constant ADDR_LOADPARAMETERS_DATA_0 : INTEGER := 16#30#;
    constant ADDR_LOADPARAMETERS_CTRL   : INTEGER := 16#34#;
    constant ADDR_EXPORTLAYERS_DATA_0   : INTEGER := 16#38#;
    constant ADDR_EXPORTLAYERS_CTRL     : INTEGER := 16#3c#;
