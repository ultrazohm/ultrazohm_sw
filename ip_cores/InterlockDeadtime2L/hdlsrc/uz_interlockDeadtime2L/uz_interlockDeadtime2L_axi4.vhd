-- -------------------------------------------------------------
-- 
-- File Name: /home/ts/Dokumente/ultrazohm_testbench/ultrazohm_test/ultrazohm_sw/ip_cores/InterlockDeadtime2L/hdlsrc/uz_interlockDeadtime2L/uz_interlockDeadtime2L_axi4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_interlockDeadtime2L_axi4
-- Source Path: uz_interlockDeadtime2L/uz_interlockDeadtime2L_axi4
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_interlockDeadtime2L_axi4 IS
...
END uz_interlockDeadtime2L_axi4;


ARCHITECTURE rtl OF uz_interlockDeadtime2L_axi4 IS

  -- Component Declarations
  COMPONENT uz_interlockDeadtime2L_addr_decoder
  ...
  COMPONENT uz_interlockDeadtime2L_axi4_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_ARESETN                    :   IN    std_logic;  -- ufix1
          AXI4_AWID                       :   IN    std_logic_vector(11 DOWNTO 0);  -- ufix12
          AXI4_AWADDR                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  FOR ALL : uz_interlockDeadtime2L_addr_decoder
    USE ENTITY work.uz_interlockDeadtime2L_addr_decoder(rtl);

  FOR ALL : uz_interlockDeadtime2L_axi4_module
    USE ENTITY work.uz_interlockDeadtime2L_axi4_module(rtl);
  ...
  SIGNAL write_axi_DelayCycles_tmp        : std_logic_vector(9 DOWNTO 0);  -- ufix10
...
BEGIN
  u_uz_interlockDeadtime2L_addr_decoder_inst : uz_interlockDeadtime2L_addr_decoder
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
              ...
              read_axi_fb_InverseBotSwitch => read_axi_fb_InverseBotSwitch,  -- ufix1
              read_axi_fb_DelayCycles => read_axi_fb_DelayCycles,  -- ufix10
              read_axi_fb_enable => read_axi_fb_enable,  -- ufix1
              ...
              write_axi_DelayCycles => write_axi_DelayCycles_tmp  -- ufix10
              );

  u_uz_interlockDeadtime2L_axi4_module_inst : uz_interlockDeadtime2L_axi4_module
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
