-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\valen\Documents\repos\UZ\ultrazohm_sw\ip_cores\uz_pmsm_model_9ph\hdl_opti\hdlsrc\uz_pmsm_model_9ph\uz_pmsm_model_9ph_src_abc_to_alpha_beta_0_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_9ph_src_abc_to_alpha_beta_0_block
-- Source Path: uz_pmsm_model_9ph/uz_pmsm_model_9ph/Line-Line to Phase voltage1/abc   to   alpha_beta_0
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_pmsm_model_9ph_src_abc_to_alpha_beta_0_block IS
...
END uz_pmsm_model_9ph_src_abc_to_alpha_beta_0_block;


ARCHITECTURE rtl OF uz_pmsm_model_9ph_src_abc_to_alpha_beta_0_block IS
...
BEGIN
  ...
  u_nfp_mul_comp_4 : uz_pmsm_model_9ph_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_20_0 => enb_1_20_0,
  ...
  u_nfp_mul_comp_6 : uz_pmsm_model_9ph_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_20_0 => enb_1_20_0,
  ...
  u_nfp_mul_comp_7 : uz_pmsm_model_9ph_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_20_0 => enb_1_20_0,
  ...
  u_nfp_mul_comp_8 : uz_pmsm_model_9ph_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_20_0 => enb_1_20_0,
  ...
  u_nfp_add_comp_2 : uz_pmsm_model_9ph_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_20_0 => enb_1_20_0,
  ...
  u_nfp_add_comp_3 : uz_pmsm_model_9ph_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_20_0 => enb_1_20_0,
  ...
  u_nfp_add_comp_4 : uz_pmsm_model_9ph_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_20_0 => enb_1_20_0,
  ...
  u_nfp_add_comp_5 : uz_pmsm_model_9ph_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_20_0 => enb_1_20_0,
  ...
  u_nfp_mul_comp_9 : uz_pmsm_model_9ph_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_20_0 => enb_1_20_0,
  ...
  u_nfp_mul_comp_10 : uz_pmsm_model_9ph_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_20_0 => enb_1_20_0,
  ...
  u_nfp_mul_comp_11 : uz_pmsm_model_9ph_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_20_0 => enb_1_20_0,
