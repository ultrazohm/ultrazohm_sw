...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      alpha_tmp <= to_signed(16#00000#, 18);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        alpha_tmp <= alpha_signed;
      END IF;
    END IF;
  ...
  BEGIN
    IF reset = '1' THEN
      beta_tmp <= to_signed(16#00000#, 18);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        beta_tmp <= beta_signed;
      END IF;
    END IF;
