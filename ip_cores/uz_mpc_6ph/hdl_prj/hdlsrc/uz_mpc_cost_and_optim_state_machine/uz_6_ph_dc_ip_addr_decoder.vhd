-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_mpc_cost_and_optim_state_machine\uz_6_ph_dc_ip_addr_decoder.vhd
-- Created: 2022-09-29 16:15:03
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: uz_6_ph_dc_ip_addr_decoder
-- Source Path: uz_6_ph_dc_ip/uz_6_ph_dc_ip_axi_lite/uz_6_ph_dc_ip_addr_decoder
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_6_ph_dc_ip_addr_decoder IS
...
END uz_6_ph_dc_ip_addr_decoder;


ARCHITECTURE rtl OF uz_6_ph_dc_ip_addr_decoder IS
  ...
  SIGNAL read_id_delay_pu_AXI_signed      : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL read_iq_delay_pu_AXI_signed      : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL read_ix_delay_pu_AXI_signed      : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL read_iy_delay_pu_AXI_signed      : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL decode_sel_iy_delay_pu_AXI_1_1   : std_logic;  -- ufix1
  SIGNAL decode_sel_ix_delay_pu_AXI_1_1   : std_logic;  -- ufix1
  SIGNAL decode_sel_iq_delay_pu_AXI_1_1   : std_logic;  -- ufix1
  SIGNAL decode_sel_id_delay_pu_AXI_1_1   : std_logic;  -- ufix1
  SIGNAL const_0                          : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL read_reg_ip_timestamp            : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_ip_timestamp_1_1       : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL read_reg_id_delay_pu_AXI         : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL data_slice_id_delay_pu_AXI_1     : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_id_delay_pu_AXI_1_1    : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL read_reg_iq_delay_pu_AXI         : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL data_slice_iq_delay_pu_AXI_1     : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_iq_delay_pu_AXI_1_1    : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL read_reg_ix_delay_pu_AXI         : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL data_slice_ix_delay_pu_AXI_1     : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_ix_delay_pu_AXI_1_1    : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL read_reg_iy_delay_pu_AXI         : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL data_slice_iy_delay_pu_AXI_1     : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_iy_delay_pu_AXI_1_1    : unsigned(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL decode_sel_omega_m_pu_1_1        : std_logic;  -- ufix1
  SIGNAL reg_enb_omega_m_pu_1_1           : std_logic;  -- ufix1
  SIGNAL data_in_omega_m_pu               : signed(17 DOWNTO 0);  -- sfix18_En15
  SIGNAL data_reg_omega_m_pu_1_1          : signed(17 DOWNTO 0);  -- sfix18_En15
...
BEGIN
  ...
  read_id_delay_pu_AXI_signed <= signed(read_id_delay_pu_AXI);

  read_iq_delay_pu_AXI_signed <= signed(read_iq_delay_pu_AXI);

  read_ix_delay_pu_AXI_signed <= signed(read_ix_delay_pu_AXI);

  read_iy_delay_pu_AXI_signed <= signed(read_iy_delay_pu_AXI);

  
  decode_sel_iy_delay_pu_AXI_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0044#, 14) ELSE
      '0';

  
  decode_sel_ix_delay_pu_AXI_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0043#, 14) ELSE
      '0';

  
  decode_sel_iq_delay_pu_AXI_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0042#, 14) ELSE
      '0';

  
  decode_sel_id_delay_pu_AXI_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0041#, 14) ELSE
      '0';
  ...
  reg_id_delay_pu_AXI_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        read_reg_id_delay_pu_AXI <= to_signed(16#0000000#, 27);
      ELSIF enb = '1' THEN
        read_reg_id_delay_pu_AXI <= read_id_delay_pu_AXI_signed;
      END IF;
    END IF;
  END PROCESS reg_id_delay_pu_AXI_process;


  data_slice_id_delay_pu_AXI_1 <= unsigned(resize(read_reg_id_delay_pu_AXI, 32));

  
  decode_rd_id_delay_pu_AXI_1_1 <= decode_rd_ip_timestamp_1_1 WHEN decode_sel_id_delay_pu_AXI_1_1 = '0' ELSE
      data_slice_id_delay_pu_AXI_1;

  reg_iq_delay_pu_AXI_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        read_reg_iq_delay_pu_AXI <= to_signed(16#0000000#, 27);
      ELSIF enb = '1' THEN
        read_reg_iq_delay_pu_AXI <= read_iq_delay_pu_AXI_signed;
      END IF;
    END IF;
  END PROCESS reg_iq_delay_pu_AXI_process;


  data_slice_iq_delay_pu_AXI_1 <= unsigned(resize(read_reg_iq_delay_pu_AXI, 32));

  
  decode_rd_iq_delay_pu_AXI_1_1 <= decode_rd_id_delay_pu_AXI_1_1 WHEN decode_sel_iq_delay_pu_AXI_1_1 = '0' ELSE
      data_slice_iq_delay_pu_AXI_1;

  reg_ix_delay_pu_AXI_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        read_reg_ix_delay_pu_AXI <= to_signed(16#0000000#, 27);
      ELSIF enb = '1' THEN
        read_reg_ix_delay_pu_AXI <= read_ix_delay_pu_AXI_signed;
      END IF;
    END IF;
  END PROCESS reg_ix_delay_pu_AXI_process;


  data_slice_ix_delay_pu_AXI_1 <= unsigned(resize(read_reg_ix_delay_pu_AXI, 32));

  
  decode_rd_ix_delay_pu_AXI_1_1 <= decode_rd_iq_delay_pu_AXI_1_1 WHEN decode_sel_ix_delay_pu_AXI_1_1 = '0' ELSE
      data_slice_ix_delay_pu_AXI_1;

  reg_iy_delay_pu_AXI_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        read_reg_iy_delay_pu_AXI <= to_signed(16#0000000#, 27);
      ELSIF enb = '1' THEN
        read_reg_iy_delay_pu_AXI <= read_iy_delay_pu_AXI_signed;
      END IF;
    END IF;
  END PROCESS reg_iy_delay_pu_AXI_process;


  data_slice_iy_delay_pu_AXI_1 <= unsigned(resize(read_reg_iy_delay_pu_AXI, 32));

  
  decode_rd_iy_delay_pu_AXI_1_1 <= decode_rd_ix_delay_pu_AXI_1_1 WHEN decode_sel_iy_delay_pu_AXI_1_1 = '0' ELSE
      data_slice_iy_delay_pu_AXI_1;

  data_read <= std_logic_vector(decode_rd_iy_delay_pu_AXI_1_1);
  ...
  decode_sel_omega_m_pu_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0040#, 14) ELSE
      '0';

  reg_enb_omega_m_pu_1_1 <= decode_sel_omega_m_pu_1_1 AND wr_enb;

  data_in_omega_m_pu <= signed(data_write_unsigned(17 DOWNTO 0));

  reg_omega_m_pu_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_omega_m_pu_1_1 <= to_signed(16#00000#, 18);
      ELSIF enb = '1' AND reg_enb_omega_m_pu_1_1 = '1' THEN
        data_reg_omega_m_pu_1_1 <= data_in_omega_m_pu;
      END IF;
    END IF;
  END PROCESS reg_omega_m_pu_1_1_process;


  write_omega_m_pu <= std_logic_vector(data_reg_omega_m_pu_1_1);
