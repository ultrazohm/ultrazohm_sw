...
HD_PWD='C:/XilinxEyke/MPSOC/007_AXI_TCM/ip_repo/edit_AXI2TCM_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI2TCM_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXI2TCM_v1_0.tcl
