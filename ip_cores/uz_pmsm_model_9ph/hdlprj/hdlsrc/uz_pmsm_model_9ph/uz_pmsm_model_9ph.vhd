...
ENTITY uz_pmsm_model_9ph IS
  PORT( IPCORE_CLK                        :   IN    std_logic;  -- ufix1
        ...
        u_abc1_pl_out_0                   :   OUT   std_logic_vector(74 DOWNTO 0);  -- ufix75
        u_abc2_pl_out_0                   :   OUT   std_logic_vector(74 DOWNTO 0);  -- ufix75
        u_abc3_pl_out_0                   :   OUT   std_logic_vector(74 DOWNTO 0);  -- ufix75
...
ARCHITECTURE rtl OF uz_pmsm_model_9ph IS
  ...
  SIGNAL u_abc1_pl_out_2_sig_signed       : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL u_abc1_pl_out_1_sig_signed       : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL u_abc1_pl_out_0_sig_signed       : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL u_abc1_pl_out_0_tmp              : unsigned(74 DOWNTO 0);  -- ufix75
  SIGNAL u_abc2_pl_out_2_sig_signed       : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL u_abc2_pl_out_1_sig_signed       : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL u_abc2_pl_out_0_sig_signed       : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL u_abc2_pl_out_0_tmp              : unsigned(74 DOWNTO 0);  -- ufix75
  SIGNAL u_abc3_pl_out_2_sig_signed       : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL u_abc3_pl_out_1_sig_signed       : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL u_abc3_pl_out_0_sig_signed       : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL u_abc3_pl_out_0_tmp              : unsigned(74 DOWNTO 0);  -- ufix75
...
BEGIN
  ...
  ip_timestamp <= unsigned'(X"8360AE7B");
  ...
  u_abc1_pl_out_2_sig_signed <= signed(u_abc1_pl_out_2_sig);

  u_abc1_pl_out_1_sig_signed <= signed(u_abc1_pl_out_1_sig);

  u_abc1_pl_out_0_sig_signed <= signed(u_abc1_pl_out_0_sig);

  u_abc1_pl_out_0_tmp <= unsigned(u_abc1_pl_out_2_sig_signed) & unsigned(u_abc1_pl_out_1_sig_signed) & unsigned(u_abc1_pl_out_0_sig_signed);

  u_abc1_pl_out_0 <= std_logic_vector(u_abc1_pl_out_0_tmp);

  u_abc2_pl_out_2_sig_signed <= signed(u_abc2_pl_out_2_sig);

  u_abc2_pl_out_1_sig_signed <= signed(u_abc2_pl_out_1_sig);

  u_abc2_pl_out_0_sig_signed <= signed(u_abc2_pl_out_0_sig);

  u_abc2_pl_out_0_tmp <= unsigned(u_abc2_pl_out_2_sig_signed) & unsigned(u_abc2_pl_out_1_sig_signed) & unsigned(u_abc2_pl_out_0_sig_signed);

  u_abc2_pl_out_0 <= std_logic_vector(u_abc2_pl_out_0_tmp);

  u_abc3_pl_out_2_sig_signed <= signed(u_abc3_pl_out_2_sig);

  u_abc3_pl_out_1_sig_signed <= signed(u_abc3_pl_out_1_sig);

  u_abc3_pl_out_0_sig_signed <= signed(u_abc3_pl_out_0_sig);

  u_abc3_pl_out_0_tmp <= unsigned(u_abc3_pl_out_2_sig_signed) & unsigned(u_abc3_pl_out_1_sig_signed) & unsigned(u_abc3_pl_out_0_sig_signed);

  u_abc3_pl_out_0 <= std_logic_vector(u_abc3_pl_out_0_tmp);
