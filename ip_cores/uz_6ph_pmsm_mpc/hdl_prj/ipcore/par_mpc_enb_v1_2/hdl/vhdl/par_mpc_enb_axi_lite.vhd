-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_mpc_6ph_parallel\par_mpc_enb_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: par_mpc_enb_axi_lite
-- Source Path: par_mpc_enb/par_mpc_enb_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY par_mpc_enb_axi_lite IS
...
END par_mpc_enb_axi_lite;


ARCHITECTURE rtl OF par_mpc_enb_axi_lite IS

  -- Component Declarations
  COMPONENT par_mpc_enb_addr_decoder
  ...
  COMPONENT par_mpc_enb_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : par_mpc_enb_addr_decoder
    USE ENTITY work.par_mpc_enb_addr_decoder(rtl);

  FOR ALL : par_mpc_enb_axi_lite_module
    USE ENTITY work.par_mpc_enb_axi_lite_module(rtl);
...
BEGIN
  u_par_mpc_enb_addr_decoder_inst : par_mpc_enb_addr_decoder
  ...
  u_par_mpc_enb_axi_lite_module_inst : par_mpc_enb_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
