...
set_property version {0.6} [ipx::current_core]
...
set_property core_revision 2114422847 [ipx::current_core]
...
# Package IP
ipx::archive_core {../uz_endat_interface_v0_6.zip} [ipx::current_core]
close_project
exit
