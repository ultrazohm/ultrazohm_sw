-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\test_prediction_only\hdlsrc\parallel_prediction_and_cost_function_6phase\test_parallel_prediction_only_src_Subsystem11.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: test_parallel_prediction_only_src_Subsystem11
-- Source Path: parallel_prediction_and_cost_function_6phase/Prediction_and_cost_function/Subsystem/Subsystem11
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY test_parallel_prediction_only_src_Subsystem11 IS
...
END test_parallel_prediction_only_src_Subsystem11;


ARCHITECTURE rtl OF test_parallel_prediction_only_src_Subsystem11 IS
  ...
  COMPONENT test_parallel_prediction_only_src_nfp_sub_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          nfp_in1                         :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT test_parallel_prediction_only_src_nfp_add_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          nfp_in1                         :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  FOR ALL : test_parallel_prediction_only_src_nfp_sub_single
    USE ENTITY work.test_parallel_prediction_only_src_nfp_sub_single(rtl);

  FOR ALL : test_parallel_prediction_only_src_nfp_add_single
    USE ENTITY work.test_parallel_prediction_only_src_nfp_add_single(rtl);
...
BEGIN
  ...
  u_nfp_sub_comp : test_parallel_prediction_only_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  -- mul #1
  u_nfp_mul_comp_1 : test_parallel_prediction_only_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  -- mul #2
  u_nfp_mul_comp_2 : test_parallel_prediction_only_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp : test_parallel_prediction_only_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_3 : test_parallel_prediction_only_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp_1 : test_parallel_prediction_only_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_4 : test_parallel_prediction_only_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => iq_k,  -- single
  ...
  u_nfp_sub_comp_1 : test_parallel_prediction_only_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_5 : test_parallel_prediction_only_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => id_k,  -- single
  ...
  u_nfp_add_comp_2 : test_parallel_prediction_only_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_6 : test_parallel_prediction_only_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_2 : test_parallel_prediction_only_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_7 : test_parallel_prediction_only_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp_3 : test_parallel_prediction_only_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_8 : test_parallel_prediction_only_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => ix_k,  -- single
  ...
  u_nfp_sub_comp_3 : test_parallel_prediction_only_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_9 : test_parallel_prediction_only_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp_4 : test_parallel_prediction_only_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_10 : test_parallel_prediction_only_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => iy_k,  -- single
  ...
  u_nfp_sub_comp_4 : test_parallel_prediction_only_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_11 : test_parallel_prediction_only_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp_5 : test_parallel_prediction_only_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
