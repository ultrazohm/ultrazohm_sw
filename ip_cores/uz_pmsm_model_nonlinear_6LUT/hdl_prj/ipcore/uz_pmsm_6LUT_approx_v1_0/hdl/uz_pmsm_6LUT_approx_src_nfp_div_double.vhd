-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\Philipp\ultrazohm\ultrazohm_sw\ip_cores\uz_pmsm_model_nonlinear_6LUT\hdl_prj\hdlsrc\uz_pmsm_model_6LUT_pd\uz_pmsm_6LUT_approx_src_nfp_div_double.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_6LUT_approx_src_nfp_div_double
...
ENTITY uz_pmsm_6LUT_approx_src_nfp_div_double IS
...
END uz_pmsm_6LUT_approx_src_nfp_div_double;


ARCHITECTURE rtl OF uz_pmsm_6LUT_approx_src_nfp_div_double IS
  ...
  SIGNAL Delay26_PS_6_58_reg              : std_logic_vector(26 DOWNTO 0);  -- ufix1 [27]
  ...
  SIGNAL Delay21_PS_6_58_reg              : std_logic_vector(26 DOWNTO 0);  -- ufix1 [27]
  ...
  SIGNAL Delay23_PS_6_58_reg              : std_logic_vector(26 DOWNTO 0);  -- ufix1 [27]
  ...
  SIGNAL Delay22_PS_6_58_reg              : std_logic_vector(26 DOWNTO 0);  -- ufix1 [27]
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay26_PS_6_58_reg <= (OTHERS => '0');
      ELSIF enb = '1' THEN
        Delay26_PS_6_58_reg(0) <= Delay29_PS_3_out1;
        Delay26_PS_6_58_reg(26 DOWNTO 1) <= Delay26_PS_6_58_reg(25 DOWNTO 0);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay21_PS_6_58_reg <= (OTHERS => '0');
      ELSIF enb = '1' THEN
        Delay21_PS_6_58_reg(0) <= Delay38_PS_3_out1;
        Delay21_PS_6_58_reg(26 DOWNTO 1) <= Delay21_PS_6_58_reg(25 DOWNTO 0);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay23_PS_6_58_reg <= (OTHERS => '0');
      ELSIF enb = '1' THEN
        Delay23_PS_6_58_reg(0) <= Delay32_PS_3_out1;
        Delay23_PS_6_58_reg(26 DOWNTO 1) <= Delay23_PS_6_58_reg(25 DOWNTO 0);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay22_PS_6_58_reg <= (OTHERS => '0');
      ELSIF enb = '1' THEN
        Delay22_PS_6_58_reg(0) <= Delay35_PS_3_out1;
        Delay22_PS_6_58_reg(26 DOWNTO 1) <= Delay22_PS_6_58_reg(25 DOWNTO 0);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay11_PS_7_59_reg <= (OTHERS => to_unsigned(16#00#, 6));
      ELSIF enb = '1' THEN
        Delay11_PS_7_59_reg(0) <= if_exp_tmp_2_cfType_ExponentB_1_out1;
        Delay11_PS_7_59_reg(1 TO 25) <= Delay11_PS_7_59_reg(0 TO 24);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay8_PS_60_reg <= (OTHERS => to_unsigned(16#000#, 11));
      ELSIF enb = '1' THEN
        Delay8_PS_60_reg(0) <= if_exp_tmp_2_cfType_ExponentB_out1;
        Delay8_PS_60_reg(1 TO 26) <= Delay8_PS_60_reg(0 TO 25);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay25_PS_6_58_reg <= (OTHERS => to_unsigned(16#000#, 11));
      ELSIF enb = '1' THEN
        Delay25_PS_6_58_reg(0) <= Delay39PS_5_out1;
        Delay25_PS_6_58_reg(1 TO 25) <= Delay25_PS_6_58_reg(0 TO 24);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay24_PS_6_58_reg <= (OTHERS => to_unsigned(0, 52));
      ELSIF enb = '1' THEN
        Delay24_PS_6_58_reg(0) <= Delay49_PS_5_out1;
        Delay24_PS_6_58_reg(1 TO 25) <= Delay24_PS_6_58_reg(0 TO 24);
      END IF;
    END IF;
