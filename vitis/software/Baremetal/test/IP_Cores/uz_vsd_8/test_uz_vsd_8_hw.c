...
void test_uz_vsd_8_hw_set_thetaOffset(void){
    ...
    uz_fixedpoint_axi_write_Expect(TEST_BASE_ADDRESS+theta_el_offset__Data_parallel_8_VSD_and_Park,theta_offset,def);
...
void test_uz_vsd_8_hw_get_i_a1(void){
    ...
    uz_fixedpoint_axi_read_ExpectAndReturn(TEST_BASE_ADDRESS+i_a1_axi_Data_parallel_8_VSD_and_Park,fixedpoint_definition,expected_return_value);
...
void test_uz_vsd_8_hw_get_i_b1(void){
        ...
        .is_signed = true};
    float expected_return_value = -1.0;
    uz_fixedpoint_axi_read_ExpectAndReturn(TEST_BASE_ADDRESS+i_b1_axi_Data_parallel_8_VSD_and_Park,fixedpoint_definition,expected_return_value);
...
void test_uz_vsd_8_hw_get_i_c1(void){
        ...
        .is_signed = true};
    float expected_return_value = -1.0;
    uz_fixedpoint_axi_read_ExpectAndReturn(TEST_BASE_ADDRESS+i_c1_axi_Data_parallel_8_VSD_and_Park,fixedpoint_definition,expected_return_value);
...
void test_uz_vsd_8_hw_get_i_a2(void){
        ...
        .is_signed = true};
    float expected_return_value = -1.0;
    uz_fixedpoint_axi_read_ExpectAndReturn(TEST_BASE_ADDRESS+i_a2_axi_Data_parallel_8_VSD_and_Park,fixedpoint_definition,expected_return_value);
...
void test_uz_vsd_8_hw_get_i_b2(void){
        ...
        .is_signed = true};
    float expected_return_value = -1.0;
    uz_fixedpoint_axi_read_ExpectAndReturn(TEST_BASE_ADDRESS+i_b2_axi_Data_parallel_8_VSD_and_Park,fixedpoint_definition,expected_return_value);
...
void test_uz_vsd_8_hw_get_i_c2(void){
        ...
        .is_signed = true};
    float expected_return_value = -1.0;
    uz_fixedpoint_axi_read_ExpectAndReturn(TEST_BASE_ADDRESS+i_c2_axi_Data_parallel_8_VSD_and_Park,fixedpoint_definition,expected_return_value);
