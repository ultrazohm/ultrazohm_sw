-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\test_min_cost_function_without_delays\hdlsrc\test_min_cost_function_without_delays\test_min_cost_function_without_delays_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: test_min_cost_function_without_delays_dut
-- Source Path: test_min_cost_function_without_delays/test_min_cost_function_without_delays_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY test_min_cost_function_without_delays_dut IS
...
END test_min_cost_function_without_delays_dut;


ARCHITECTURE rtl OF test_min_cost_function_without_delays_dut IS

  -- Component Declarations
  COMPONENT test_min_cost_function_without_delays_src_Min_cost_function_and_vopt1
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : test_min_cost_function_without_delays_src_Min_cost_function_and_vopt1
    USE ENTITY work.test_min_cost_function_without_delays_src_Min_cost_function_and_vopt1(rtl);
...
BEGIN
  u_test_min_cost_function_without_delays_src_Min_cost_function_and_vopt1 : test_min_cost_function_without_delays_src_Min_cost_function_and_vopt1
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
