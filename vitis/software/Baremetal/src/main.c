...
int main(void)
{
    ...
    while (1)
    {
        ...
        case init_CurrentControl_rsm:
            ...
            Global_Data.av.theta_offset = 2.398694800f;   //3.212256451778497f; //2.749744200f;//0.420242264561247f; //0.8042147f; //2.762601667f; //5.870765333f; //2.762601667f; //2.762601667f;  // 3.104602333f; // 2.450550333f; // 4.291866f; //4.291866f;  //4.3317f;//4.291866f; //4.327050f; 4.291866; 4.306316; 1.183702; 1.152288; 4.291238;
