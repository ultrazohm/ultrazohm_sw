-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj2318655/hdlsrc/uz_pmsm_model_9ph_21b_all_double/uz_pmsm9ph_transformations_src_Product_nw_block10.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm9ph_transformations_src_Product_nw_block10
-- Source Path: 
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
...
ENTITY uz_pmsm9ph_transformations_src_Product_nw_block10 IS
...
END uz_pmsm9ph_transformations_src_Product_nw_block10;


ARCHITECTURE rtl OF uz_pmsm9ph_transformations_src_Product_nw_block10 IS
  ...
  SIGNAL Product_Im_BC_bypass             : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL Product_Im_BC_last_value         : signed(24 DOWNTO 0);  -- sfix25_En12
...
BEGIN
  ...
  Product_Im_BC <= Product_mul_temp(40 DOWNTO 16);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Product_Im_BC_last_value <= to_signed(16#0000000#, 25);
      ELSIF enb_gated = '1' THEN
