...
void project_wizard_visualization_update(struct _DS_Data_* data)
{
    ...
    project_wizard_visualization_data.viz_resolver_ip_d4_2_position_mech_2pi = data->av.resolver_ip_d4_2_position_mech_2pi;
    project_wizard_visualization_data.viz_resolver_ip_d4_3_position_mech_2pi = data->av.resolver_ip_d4_3_position_mech_2pi;
    ...
    project_wizard_visualization_data.viz_endat_encoder_d5_1_position_multi_turn = ((float)data->av.endat_encoder_d5_1_position_multi_turn);
    ...
    project_wizard_visualization_data.viz_endat_encoder_d5_1_speed_mech_si = data->av.endat_encoder_d5_1_speed_mech_si;
    project_wizard_visualization_data.viz_endat_encoder_d5_1_speed_el_si = data->av.endat_encoder_d5_1_speed_el_si;
    project_wizard_visualization_data.viz_endat_encoder_d5_1_speed_mech_rpm = data->av.endat_encoder_d5_1_speed_mech_rpm;
    project_wizard_visualization_data.viz_temp_d3_a_4 = data->av.temperature_card_d3_channel_A.temperature[4];
    project_wizard_visualization_data.viz_temp_d3_a_5 = data->av.temperature_card_d3_channel_A.temperature[5];
    project_wizard_visualization_data.viz_temp_d3_a_19 = data->av.temperature_card_d3_channel_A.temperature[19];
}
