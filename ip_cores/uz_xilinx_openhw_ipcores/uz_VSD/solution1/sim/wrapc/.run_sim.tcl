...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "uz_VSD_6ph_asym.autotvin.dat"
	set constFileTvOut       "uz_VSD_6ph_asym.autotvout.dat"
	set constFileHdlTvIn     "uz_VSD_6ph_asym.autohdltvin.dat"
	set constFileHdlTvOut    "uz_VSD_6ph_asym.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
