-- -------------------------------------------------------------
-- 
-- File Name: /home/ts/Dokumente/ultrazohm_testbench/ultrazohm_test/ultrazohm_sw/ip_cores/InterlockDeadtime2L/hdlsrc/uz_interlockDeadtime2L/uz_interlockDeadtime2L_src_DeadtimeModule.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_interlockDeadtime2L_src_DeadtimeModule
-- Source Path: uz_interlockDeadtime2L/uz_interlockDeadtime2L/DeadtimeModule
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_interlockDeadtime2L_src_DeadtimeModule IS
...
END uz_interlockDeadtime2L_src_DeadtimeModule;


ARCHITECTURE rtl OF uz_interlockDeadtime2L_src_DeadtimeModule IS

  -- Component Declarations
  COMPONENT uz_interlockDeadtime2L_src_Detect_Fall_Nonpositive2
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  FOR ALL : uz_interlockDeadtime2L_src_Detect_Fall_Nonpositive2
    USE ENTITY work.uz_interlockDeadtime2L_src_Detect_Fall_Nonpositive2(rtl);
...
BEGIN
  ...
  u_Detect_Fall_Nonpositive2 : uz_interlockDeadtime2L_src_Detect_Fall_Nonpositive2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              U => In1,
