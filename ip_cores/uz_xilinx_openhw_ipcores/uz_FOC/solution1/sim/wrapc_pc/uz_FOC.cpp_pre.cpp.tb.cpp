...
// ==============================================================
# 1 "C:/Users/valen/Documents/repos/UZ/ultrazohm_sw/ip_cores/uz_xilinx_openhw_ipcores/uz_FOC/uz_FOC.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/Users/valen/Documents/repos/UZ/ultrazohm_sw/ip_cores/uz_xilinx_openhw_ipcores/uz_FOC/uz_FOC.cpp"
...
# 2 "C:/Users/valen/Documents/repos/UZ/ultrazohm_sw/ip_cores/uz_xilinx_openhw_ipcores/uz_FOC/uz_FOC.cpp" 2
void uz_FOC(
...
extern "C"
#endif
void apatb_uz_FOC_ir(float, float, float, float, float, float, float, float, bool, float, float, bool, float *, float *);
#ifdef __cplusplus
extern "C"
#endif
void uz_FOC_hw_stub(float axi_id_reference, float axi_iq_reference, float axi_sampletime, float axi_id_KI, float axi_id_KP, float axi_iq_KI, float axi_iq_KP, float axi_limit, bool axi_reset, float id_actual, float iq_actual, bool reset_PL, float *ud_ref, float *uq_ref){
uz_FOC(axi_id_reference, axi_iq_reference, axi_sampletime, axi_id_KI, axi_id_KP, axi_iq_KI, axi_iq_KP, axi_limit, axi_reset, id_actual, iq_actual, reset_PL, ud_ref, uq_ref);
return ;
}
#ifdef __cplusplus
extern "C"
#endif
void apatb_uz_FOC_sw(float axi_id_reference, float axi_iq_reference, float axi_sampletime, float axi_id_KI, float axi_id_KP, float axi_iq_KI, float axi_iq_KP, float axi_limit, bool axi_reset, float id_actual, float iq_actual, bool reset_PL, float *ud_ref, float *uq_ref){
apatb_uz_FOC_ir(axi_id_reference, axi_iq_reference, axi_sampletime, axi_id_KI, axi_id_KP, axi_iq_KI, axi_iq_KP, axi_limit, axi_reset, id_actual, iq_actual, reset_PL, ud_ref, uq_ref);
return ;
}
#endif
# 31 "C:/Users/valen/Documents/repos/UZ/ultrazohm_sw/ip_cores/uz_xilinx_openhw_ipcores/uz_FOC/uz_FOC.cpp"
