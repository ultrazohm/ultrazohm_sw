...
.. warning::
	Please note that in Rev05 the :ref:`carrier_board_rev05_s3c` is responsible for the Powersequence of the Carrierboard. If the configuration is changed this graph is no longer valid.
