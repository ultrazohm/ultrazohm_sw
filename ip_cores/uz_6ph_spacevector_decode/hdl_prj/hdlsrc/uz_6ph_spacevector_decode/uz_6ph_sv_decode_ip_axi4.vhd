-- -------------------------------------------------------------
-- 
-- File Name: C:\utrazohm_sw_2\ultrazohm_sw\ip_cores\uz_6ph_spacevector_decode\hdl_prj\hdlsrc\uz_6ph_spacevector_decode\uz_6ph_sv_decode_ip_axi4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_6ph_sv_decode_ip_axi4
-- Source Path: uz_6ph_sv_decode_ip/uz_6ph_sv_decode_ip_axi4
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_6ph_sv_decode_ip_axi4 IS
...
END uz_6ph_sv_decode_ip_axi4;


ARCHITECTURE rtl OF uz_6ph_sv_decode_ip_axi4 IS

  -- Component Declarations
  COMPONENT uz_6ph_sv_decode_ip_addr_decoder
  ...
  COMPONENT uz_6ph_sv_decode_ip_axi4_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_ARESETN                    :   IN    std_logic;  -- ufix1
          AXI4_AWID                       :   IN    std_logic_vector(11 DOWNTO 0);  -- ufix12
          AXI4_AWADDR                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  FOR ALL : uz_6ph_sv_decode_ip_addr_decoder
    USE ENTITY work.uz_6ph_sv_decode_ip_addr_decoder(rtl);

  FOR ALL : uz_6ph_sv_decode_ip_axi4_module
    USE ENTITY work.uz_6ph_sv_decode_ip_axi4_module(rtl);
...
BEGIN
  u_uz_6ph_sv_decode_ip_addr_decoder_inst : uz_6ph_sv_decode_ip_addr_decoder
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
              ...
              read_out1_AXI => read_out1_AXI,  -- ufix6
              read_out2_AXI => read_out2_AXI,  -- ufix6
              read_out3_AXI => read_out3_AXI,  -- ufix6
              read_out4_AXI => read_out4_AXI,  -- ufix6
              read_out5_AXI => read_out5_AXI,  -- ufix6
              read_out6_AXI => read_out6_AXI,  -- ufix6
              read_out7_AXI => read_out7_AXI,  -- ufix6
              read_out8_AXI => read_out8_AXI,  -- ufix6
              read_out9_AXI => read_out9_AXI,  -- ufix6
              read_out10_AXI => read_out10_AXI,  -- ufix6
              read_out11_AXI => read_out11_AXI,  -- ufix6
              read_out12_AXI => read_out12_AXI,  -- ufix6
              read_out13_AXI => read_out13_AXI,  -- ufix6
              read_out14_AXI => read_out14_AXI,  -- ufix6
              data_read => top_data_read,  -- ufix32
              write_axi_enable => write_axi_enable  -- ufix1
              );

  u_uz_6ph_sv_decode_ip_axi4_module_inst : uz_6ph_sv_decode_ip_axi4_module
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
