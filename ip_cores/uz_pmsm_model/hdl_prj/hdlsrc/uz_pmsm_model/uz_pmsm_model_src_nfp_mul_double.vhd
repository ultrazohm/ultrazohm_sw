-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/uz_pmsm_model/uz_pmsm_model_src_nfp_mul_double.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_src_nfp_mul_double
-- Source Path: uz_pmsm_model/uz_pmsm_model/nfp_mul_double
-- Hierarchy Level: 1
-- 
-- {Latency Strategy = "Max", Denormal Handling = "on"}
...
ENTITY uz_pmsm_model_src_nfp_mul_double IS
...
END uz_pmsm_model_src_nfp_mul_double;


ARCHITECTURE rtl OF uz_pmsm_model_src_nfp_mul_double IS
  ...
  SIGNAL Delay2_PS_4_7_reg                : vector_of_unsigned106(0 TO 2);  -- ufix106 [3]
  SIGNAL Delay2_PS_4_7_reg_next           : vector_of_unsigned106(0 TO 2);  -- ufix106 [3]
  ...
  SIGNAL Delay5_PS_7_out1                 : std_logic;  -- ufix1
  ...
  SIGNAL Delay7_PS_7_out1                 : std_logic;  -- ufix1
  ...
  SIGNAL Delay10_PS_7_out1                : unsigned(5 DOWNTO 0);  -- ufix6
  ...
  SIGNAL Delay6_PS_7_out1                 : unsigned(5 DOWNTO 0);  -- ufix6
  ...
  SIGNAL Delay9_PS_7_out1                 : unsigned(5 DOWNTO 0);  -- ufix6
  ...
  SIGNAL Delay2_PS_7_out1                 : signed(13 DOWNTO 0);  -- sfix14
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay_PS_3_out1 <= if_bitget_mant_b_mant_b_WordLen_1_out1;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay1_PS_3_out1 <= if_bitget_mant_b_mant_b_WordLen_1_out1_1;
      END IF;
    END IF;
  ...
  Delay2_PS_4_7_out1 <= Delay2_PS_4_7_reg(2);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay4_PS_3_out1 <= if_bitget_mant_b_mant_b_WordLen_out1;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay5_PS_3_out1 <= if_bitget_mant_b_mant_b_WordLen_out1_1;
      END IF;
    END IF;
  ...
  Delay5_PS_7_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay5_PS_7_out1 <= '0';
      ELSIF enb = '1' THEN
        Delay5_PS_7_out1 <= exp_out_cast_cfType_Exponen_out1;
      END IF;
    END IF;
  END PROCESS Delay5_PS_7_process;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay1_PS_7_out1 <= '0';
      ELSIF enb = '1' THEN
        Delay1_PS_7_out1 <= Logical_Operator5_out1_10;
      END IF;
    END IF;
  ...
  if_bitget_mant_ext_mant_ext_Word_2_out1 <= Delay5_PS_7_out1 WHEN BitSlice1_out1_2 = '0' ELSE
      Delay1_PS_7_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay8_PS_7_out1 <= '0';
      ELSIF enb = '1' THEN
        Delay8_PS_7_out1 <= Logical_Operator4_out1_12;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay3_PS_7_out1 <= '0';
      ELSIF enb = '1' THEN
        Delay3_PS_7_out1 <= exp_out_cfType_MantissaLeng_out1;
      END IF;
    END IF;
  ...
  if_bitget_mant_ext_mant_ext_Word_4_out1 <= Delay8_PS_7_out1 WHEN BitSlice1_out1_2 = '0' ELSE
      Delay3_PS_7_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay4_PS_7_out1 <= '0';
      ELSIF enb = '1' THEN
        Delay4_PS_7_out1 <= Logical_Operator3_out1_4;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay7_PS_7_out1 <= '0';
      ELSIF enb = '1' THEN
        Delay7_PS_7_out1 <= BitSlice3_out1;
      END IF;
    END IF;
  ...
  if_bitget_mant_ext_mant_ext_Word_3_out1 <= Delay4_PS_7_out1 WHEN BitSlice1_out1_2 = '0' ELSE
      Delay7_PS_7_out1;
  ...
  Delay10_PS_7_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay10_PS_7_out1 <= to_unsigned(16#00#, 6);
      ELSIF enb = '1' THEN
        Delay10_PS_7_out1 <= DTC4_out1_2;
      END IF;
    END IF;
  END PROCESS Delay10_PS_7_process;


  
  if_bitget_mant_ext_mant_ext_Word_6_out1 <= Delay_PS_7_out1 WHEN BitSlice1_out1_2 = '0' ELSE
      Delay10_PS_7_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay6_PS_7_out1 <= to_unsigned(16#00#, 6);
      ELSIF enb = '1' THEN
        Delay6_PS_7_out1 <= DTC2_out1;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay9_PS_7_out1 <= to_unsigned(16#00#, 6);
      ELSIF enb = '1' THEN
        Delay9_PS_7_out1 <= DTC3_out1_2;
      END IF;
    END IF;
  ...
  if_bitget_mant_ext_mant_ext_Word_5_out1 <= Delay6_PS_7_out1 WHEN BitSlice1_out1_2 = '0' ELSE
      Delay9_PS_7_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay3_PS_2N_out1 <= Mant_tmp_Incr_out1;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay2_PS_7_out1 <= to_signed(16#0000#, 14);
      ELSIF enb = '1' THEN
        Delay2_PS_7_out1 <= Exp_Incr_1_out1;
      END IF;
    END IF;
  ...
  if_exp_out_cfType_MantissaLen_1_out1 <= Delay12_PS_7_out1 WHEN BitSlice1_out1_2 = '0' ELSE
      Delay2_PS_7_out1;
  ...
  if_bitget_Mant_tmp_Mant_tmp_Wor_out1 <= Delay1_PS_2N_out1 WHEN BitSlice2_out1 = '0' ELSE
      Delay_PS_2N_out1;
