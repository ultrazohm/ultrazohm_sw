-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\external_state_machine\uz_park_transform_ip_src_uz_park_transformation.vhd
-- Created: 2023-07-21 15:48:38
-- 
...
-- Source Path: external_state_machine/uz_park_transformation
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_park_transform_ip_src_uz_park_transformation IS
  PORT( clk                               :   IN    std_logic;
        ...
        angle_el                          :   IN    std_logic_vector(26 DOWNTO 0);  -- sfix27_En20
        ...
        y1                                :   OUT   std_logic_vector(26 DOWNTO 0);  -- sfix27_En24
        y2                                :   OUT   std_logic_vector(26 DOWNTO 0);  -- sfix27_En24
        y1_AXI                            :   OUT   std_logic_vector(26 DOWNTO 0);  -- sfix27_En24
        y2_AXI                            :   OUT   std_logic_vector(26 DOWNTO 0);  -- sfix27_En24
        sin                               :   OUT   std_logic_vector(26 DOWNTO 0);  -- sfix27_En20
        cos                               :   OUT   std_logic_vector(26 DOWNTO 0);  -- sfix27_En20
...
ARCHITECTURE rtl OF uz_park_transform_ip_src_uz_park_transformation IS
  ...
  SIGNAL offset_angle_el_AXI_signed       : signed(17 DOWNTO 0);  -- sfix18_En14
  SIGNAL Delay20_out1                     : signed(17 DOWNTO 0);  -- sfix18_En14
  SIGNAL Switch4_out1                     : signed(17 DOWNTO 0);  -- sfix18_En14
  SIGNAL Delay21_out1                     : signed(17 DOWNTO 0);  -- sfix18_En14
  ...
  SIGNAL angle_el_signed                  : signed(26 DOWNTO 0);  -- sfix27_En20
  SIGNAL Delay2_out1                      : signed(26 DOWNTO 0);  -- sfix27_En20
  SIGNAL Switch2_out1                     : signed(26 DOWNTO 0);  -- sfix27_En20
  SIGNAL Delay6_out1                      : signed(26 DOWNTO 0);  -- sfix27_En20
  SIGNAL Product_mul_temp                 : signed(44 DOWNTO 0);  -- sfix45_En34
  SIGNAL Product_out1                     : signed(26 DOWNTO 0);  -- sfix27_En20
  SIGNAL Delay15_out1                     : signed(26 DOWNTO 0);  -- sfix27_En20
  SIGNAL Add2_add_cast                    : signed(26 DOWNTO 0);  -- sfix27_En20
  SIGNAL Add2_out1                        : signed(26 DOWNTO 0);  -- sfix27_En20
  SIGNAL Gain_mul_temp                    : signed(53 DOWNTO 0);  -- sfix54_En48
  ...
  SIGNAL Cosine_1                         : signed(26 DOWNTO 0);  -- sfix27_En20
  ...
  SIGNAL reduced_reg_1                    : vector_of_signed18(0 TO 2);  -- sfix18 [3]
  SIGNAL u2_3                             : signed(17 DOWNTO 0);  -- sfix18_En11
  SIGNAL Divide1_mul_temp                 : signed(44 DOWNTO 0);  -- sfix45_En31
  ...
  SIGNAL Data_Type_Conversion4_out1       : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL Divide3_mul_temp                 : signed(44 DOWNTO 0);  -- sfix45_En31
  SIGNAL Divide3_out1                     : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL Divide2_mul_temp                 : signed(44 DOWNTO 0);  -- sfix45_En31
  ...
  SIGNAL Data_Type_Conversion2_out1       : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL Data_Type_Conversion1_out1       : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL Data_Type_Conversion3_out1       : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL delayMatch4_reg                  : std_logic_vector(0 TO 4);  -- ufix1 [5]
  SIGNAL Delay13_out1                     : std_logic;
  SIGNAL Sine_2                           : signed(26 DOWNTO 0);  -- sfix27_En20
  SIGNAL Cosine_2                         : signed(26 DOWNTO 0);  -- sfix27_En20
  SIGNAL u1_4                             : signed(17 DOWNTO 0);  -- sfix18_En11
  SIGNAL u2_4                             : signed(17 DOWNTO 0);  -- sfix18_En11
...
BEGIN
  ...
  offset_angle_el_AXI_signed <= signed(offset_angle_el_AXI);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay20_out1 <= offset_angle_el_AXI_signed;
      END IF;
    END IF;
  ...
  Switch3_out1 <= Delay12_out1 WHEN switch_compare_1_1 = '0' ELSE
      Delay11_out1;
  ...
  Product_out1 <= Product_mul_temp(40 DOWNTO 14);
  ...
  Add2_add_cast <= resize(Switch4_out1 & '0' & '0' & '0' & '0' & '0' & '0', 27);
  Add2_out1 <= Add2_add_cast + Delay15_out1;

  Gain_mul_temp <= to_signed(16#28BE60E#, 27) * Add2_out1;
  Gain_out1 <= resize(Gain_mul_temp(53 DOWNTO 28), 27);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Cosine_1 <= to_signed(16#0000000#, 27);
      ELSIF enb = '1' THEN
  ...
  u1_2 <= u1_1 WHEN switch_compare_1_3 = '0' ELSE
      Delay_out1;
  ...
  Divide_mul_temp <= Cosine_1 * u1_3;
  Divide_out1 <= Divide_mul_temp(41 DOWNTO 15);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Sine_1 <= to_signed(16#0000000#, 27);
      ELSIF enb = '1' THEN
        Sine_1 <= Sine_signed;
      END IF;
    END IF;
  ...
  u2_2 <= u2_1 WHEN switch_compare_1_4 = '0' ELSE
      Delay1_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        reduced_reg_1(0) <= u2_1;
        reduced_reg_1(1 TO 2) <= reduced_reg_1(0 TO 1);
      END IF;
    END IF;
  END PROCESS reduced_5_process;

  u2_3 <= reduced_reg_1(2);

  Divide1_mul_temp <= Sine_1 * u2_3;
  Divide1_out1 <= Divide1_mul_temp(41 DOWNTO 15);
  ...
  Data_Type_Conversion4_out1 <= Add_out1_1(18 DOWNTO 0) & '0' & '0' & '0' & '0' & '0' & '0' & '0' & '0';

  y1 <= std_logic_vector(Data_Type_Conversion4_out1);

  Divide3_mul_temp <= Cosine_1 * u2_3;
  Divide3_out1 <= Divide3_mul_temp(41 DOWNTO 15);

  Divide2_mul_temp <= Sine_1 * u1_3;
  Divide2_out1 <= Divide2_mul_temp(41 DOWNTO 15);
  ...
  Data_Type_Conversion2_out1 <= Add1_out1_1(18 DOWNTO 0) & '0' & '0' & '0' & '0' & '0' & '0' & '0' & '0';

  y2 <= std_logic_vector(Data_Type_Conversion2_out1);

  Data_Type_Conversion1_out1 <= Add_out1_1(18 DOWNTO 0) & '0' & '0' & '0' & '0' & '0' & '0' & '0' & '0';

  y1_AXI <= std_logic_vector(Data_Type_Conversion1_out1);

  Data_Type_Conversion3_out1 <= Add1_out1_1(18 DOWNTO 0) & '0' & '0' & '0' & '0' & '0' & '0' & '0' & '0';

  y2_AXI <= std_logic_vector(Data_Type_Conversion3_out1);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        delayMatch4_reg(1 TO 4) <= delayMatch4_reg(0 TO 3);
      END IF;
    END IF;
  END PROCESS delayMatch4_process;

  Delay13_out1 <= delayMatch4_reg(4);
