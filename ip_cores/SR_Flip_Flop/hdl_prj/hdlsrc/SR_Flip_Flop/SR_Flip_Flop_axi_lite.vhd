-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\valen\Documents\repos\UZ\ultrazohm_sw\ip_cores\SR_Flip_Flop\hdl_prj\hdlsrc\SR_Flip_Flop\SR_Flip_Flop_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SR_Flip_Flop_axi_lite
-- Source Path: SR_Flip_Flop/SR_Flip_Flop_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SR_Flip_Flop_axi_lite IS
...
END SR_Flip_Flop_axi_lite;


ARCHITECTURE rtl OF SR_Flip_Flop_axi_lite IS

  -- Component Declarations
  COMPONENT SR_Flip_Flop_addr_decoder
  ...
  COMPONENT SR_Flip_Flop_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : SR_Flip_Flop_addr_decoder
    USE ENTITY work.SR_Flip_Flop_addr_decoder(rtl);

  FOR ALL : SR_Flip_Flop_axi_lite_module
    USE ENTITY work.SR_Flip_Flop_axi_lite_module(rtl);
...
BEGIN
  u_SR_Flip_Flop_addr_decoder_inst : SR_Flip_Flop_addr_decoder
  ...
  u_SR_Flip_Flop_axi_lite_module_inst : SR_Flip_Flop_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
