-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/IP_Core_SS_Switch_and_PWM/PWM_and_SS_control_V4_ip_src_Subsystem_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: PWM_and_SS_control_V4_ip_src_Subsystem_block1
-- Source Path: IP_Core_SS_Switch_and_PWM/PWM_and_Switching_Signal_Control/GenPWM/Triangle shift2/Subsystem
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY PWM_and_SS_control_V4_ip_src_Subsystem_block1 IS
...
END PWM_and_SS_control_V4_ip_src_Subsystem_block1;


ARCHITECTURE rtl OF PWM_and_SS_control_V4_ip_src_Subsystem_block1 IS
...
BEGIN
  ...
  and2_1_out1 <= Zero_input WHEN switch_compare_1_1 = '0' ELSE
      converted_triangle_shift_dtc;

  
  and2_2_out1 <= Zero_input WHEN switch_compare_1 = '0' ELSE
      and2_1_out1;
