...
#define L_6_Weights_max_rows Neurons_5th_Hidden_Layer
#define L_6_Weights_max_columns Neurons_6th_Hidden_Layer
#define y6_max_rows 1
#define y6_max_columns Neurons_6th_Hidden_Layer

#define L_7_Weights_max_rows Neurons_6th_Hidden_Layer
#define L_7_Weights_max_columns Neurons_7th_Hidden_Layer
#define y7_max_rows 1
#define y7_max_columns Neurons_7th_Hidden_Layer

#define L_8_Weights_max_rows Neurons_7th_Hidden_Layer
#define L_8_Weights_max_columns Neurons_8th_Hidden_Layer
#define y8_max_rows 1
#define y8_max_columns Neurons_8th_Hidden_Layer

#define L_9_Weights_max_rows Neurons_8th_Hidden_Layer
#define L_9_Weights_max_columns Neurons_9th_Hidden_Layer
#define y9_max_rows 1
#define y9_max_columns Neurons_9th_Hidden_Layer

#define L_10_Weights_max_rows Neurons_9th_Hidden_Layer
#define L_10_Weights_max_columns Neurons_10th_Hidden_Layer
#define y10_max_rows 1
#define y10_max_columns Neurons_10th_Hidden_Layer
	...
	#define L_Output_Weights_max_rows Neurons_6th_Hidden_Layer
#elif Hidden_Layers==7
	#define L_Output_Weights_max_rows Neurons_7th_Hidden_Layer
#elif Hidden_Layers==8
	#define L_Output_Weights_max_rows Neurons_8th_Hidden_Layer
#elif Hidden_Layers==9
	#define L_Output_Weights_max_rows Neurons_9th_Hidden_Layer
#elif Hidden_Layers==10
	#define L_Output_Weights_max_rows Neurons_10th_Hidden_Layer
#endif
