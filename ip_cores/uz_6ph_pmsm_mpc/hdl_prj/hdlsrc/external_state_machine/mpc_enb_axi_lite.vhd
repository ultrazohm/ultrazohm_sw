-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\external_state_machine\mpc_enb_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mpc_enb_axi_lite
-- Source Path: mpc_enb/mpc_enb_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END mpc_enb_axi_lite;


ARCHITECTURE rtl OF mpc_enb_axi_lite IS

  -- Component Declarations
  COMPONENT mpc_enb_addr_decoder
  ...
  COMPONENT mpc_enb_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : mpc_enb_addr_decoder
    USE ENTITY work.mpc_enb_addr_decoder(rtl);

  FOR ALL : mpc_enb_axi_lite_module
    USE ENTITY work.mpc_enb_axi_lite_module(rtl);
...
BEGIN
  u_mpc_enb_addr_decoder_inst : mpc_enb_addr_decoder
  ...
  u_mpc_enb_axi_lite_module_inst : mpc_enb_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
