...
ENTITY uz_pmsm_model_src_uz_pmsm_model IS
  PORT( clk                               :   IN    std_logic;
        ...
        recirprocal_L_q                   :   IN    std_logic_vector(31 DOWNTO 0);  -- single
...
BEGIN
  ...
  Data_Type_Conversion3_out1_1 <= out_0_pipe_in_pipe_reg(3);
  out_0_pipe_in_pipe_reg_next(0) <= Data_Type_Conversion3_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_100_1 = '1' THEN
        t_bypass_reg <= Data_Type_Conversion3_out1_1;
      END IF;
    END IF;
  END PROCESS t_bypass_process;

  
  Data_Type_Conversion3_out1_2 <= Data_Type_Conversion3_out1_1 WHEN enb_1_100_1 = '1' ELSE
      t_bypass_reg;
  ...
  Data_Type_Conversion4_out1_1 <= out_1_pipe_in_pipe_reg(3);
  out_1_pipe_in_pipe_reg_next(0) <= Data_Type_Conversion4_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_100_1 = '1' THEN
        t1_bypass_reg <= Data_Type_Conversion4_out1_1;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay2_out1_3 <= X"00000000";
      ELSIF enb_1_100_0 = '1' THEN
        Delay2_out1_3 <= t2_ds_out;
      END IF;
    END IF;
  ...
  i_d <= Data_Type_Conversion3_out1_2;

  i_q <= Data_Type_Conversion4_out1_2;

  torque <= Delay2_out1_3;
