-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_d_inverter_adapter\uz_d_inverter_adapter.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_d_inverter_adapter
-- Source Path: uz_d_inverter_adapter
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_d_inverter_adapter IS
...
END uz_d_inverter_adapter;


ARCHITECTURE rtl OF uz_d_inverter_adapter IS

  -- Component Declarations
  COMPONENT uz_d_inverter_adapter_reset_sync
  ...
  COMPONENT uz_d_inverter_adapter_axi_lite
  ...
  COMPONENT uz_d_inverter_adapter_dut
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
  ...
  FOR ALL : uz_d_inverter_adapter_reset_sync
    USE ENTITY work.uz_d_inverter_adapter_reset_sync(rtl);

  FOR ALL : uz_d_inverter_adapter_axi_lite
    USE ENTITY work.uz_d_inverter_adapter_axi_lite(rtl);

  FOR ALL : uz_d_inverter_adapter_dut
    USE ENTITY work.uz_d_inverter_adapter_dut(rtl);
  ...
  SIGNAL write_AXI_en_in                  : std_logic;  -- ufix1
  SIGNAL write_AXI_PWM_Enable             : std_logic;  -- ufix1
  SIGNAL ce_out_sig                       : std_logic;  -- ufix1
  SIGNAL PWM_EN_sig                       : std_logic;  -- ufix1

BEGIN
  u_uz_d_inverter_adapter_reset_sync_inst : uz_d_inverter_adapter_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_uz_d_inverter_adapter_axi_lite_inst : uz_d_inverter_adapter_axi_lite
    PORT MAP( reset => reset,
              ...
              read_AXI_Temp_1_period => AXI_Temp_1_period_sig,  -- ufix32
              read_AXI_Temp_1_hightime => AXI_Temp_1_hightime_sig,  -- ufix32
              read_AXI_Temp_1_lowtime => AXI_Temp_1_lowtime_sig,  -- ufix32
              read_AXI_Temp_1_dutycyc => AXI_Temp_1_dutycyc_sig,  -- ufix32_En31
              read_AXI_Temp_2_period => AXI_Temp_2_period_sig,  -- ufix32
              read_AXI_Temp_2_hightime => AXI_Temp_2_hightime_sig,  -- ufix32
              read_AXI_Temp_2_lowtime => AXI_Temp_2_lowtime_sig,  -- ufix32
              read_AXI_Temp_2_dutycyc => AXI_Temp_2_dutycyc_sig,  -- ufix32_En31
              read_AXI_Temp_3_period => AXI_Temp_3_period_sig,  -- ufix32
              read_AXI_Temp_3_hightime => AXI_Temp_3_hightime_sig,  -- ufix32
              read_AXI_Temp_3_lowtime => AXI_Temp_3_lowtime_sig,  -- ufix32
              read_AXI_Temp_3_dutycyc => AXI_Temp_3_dutycyc_sig,  -- ufix32_En31
              read_AXI_Temp_4_period => AXI_Temp_4_period_sig,  -- ufix32
              read_AXI_Temp_4_hightime => AXI_Temp_4_hightime_sig,  -- ufix32
              read_AXI_Temp_4_lowtime => AXI_Temp_4_lowtime_sig,  -- ufix32
              read_AXI_Temp_4_dutycyc => AXI_Temp_4_dutycyc_sig,  -- ufix32_En31
              read_AXI_Temp_5_period => AXI_Temp_5_period_sig,  -- ufix32
              read_AXI_Temp_5_hightime => AXI_Temp_5_hightime_sig,  -- ufix32
              read_AXI_Temp_5_lowtime => AXI_Temp_5_lowtime_sig,  -- ufix32
              read_AXI_Temp_5_dutycyc => AXI_Temp_5_dutycyc_sig,  -- ufix32_En31
              read_AXI_Temp_6_period => AXI_Temp_6_period_sig,  -- ufix32
              read_AXI_Temp_6_hightime => AXI_Temp_6_hightime_sig,  -- ufix32
              read_AXI_Temp_6_lowtime => AXI_Temp_6_lowtime_sig,  -- ufix32
              read_AXI_Temp_6_dutycyc => AXI_Temp_6_dutycyc_sig,  -- ufix32_En31
              read_AXI_FAULT => AXI_FAULT_sig,  -- ufix6
              read_AXI_OC => AXI_OC_sig,  -- ufix6
  ...
  u_uz_d_inverter_adapter_dut_inst : uz_d_inverter_adapter_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              ...
              AXI_en_in => write_AXI_en_in,  -- ufix1
  ...
  ip_timestamp <= unsigned'(X"8372630B");
