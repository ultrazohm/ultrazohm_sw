...
#define OFFSET_STEP_RAD 0.005f                       // set stepsize to step through thetas
#define OFFSET_RANGE_RAD 0.1f                       // set range to measure around inital theta (start at init_theta-OFFSET_RANGE_RAD and end at init_theta+OFFSET_RANGE_RAD), should be integer multiple of OFFSET_STEP_RAD
