/*
 * File Name:         hdl_prj\ipcore\par_cost_opt_v1_1\include\par_cost_opt_addr.h
 * Description:       C Header File
 * Created:           2024-01-04 08:35:58
*/
...
#define  IPCore_Timestamp_par_cost_opt          0x8  //contains unique IP timestamp (yymmddHHMM): 2401040835
#define  id_ref_pu_AXI_Data_par_cost_opt        0x100  //data register for Inport id_ref_pu_AXI
#define  iq_ref_pu_AXI_Data_par_cost_opt        0x104  //data register for Inport iq_ref_pu_AXI
#define  ix_ref_pu_AXI_Data_par_cost_opt        0x108  //data register for Inport ix_ref_pu_AXI
#define  iy_ref_pu_AXI_Data_par_cost_opt        0x10C  //data register for Inport iy_ref_pu_AXI
