-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\FCS_MPC_3Phase_SPMSM\hdlsrc\FCS_MPC_3Phase_SPMSM_V1\FCS_MPC_3Phase_SPMSM_V1_src_MATLAB_Function1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: FCS_MPC_3Phase_SPMSM_V1_src_MATLAB_Function1
-- Source Path: FCS_MPC_3Phase_SPMSM_V1/Microcontroller Software/Subsystem1/MATLAB Function1
-- Hierarchy Level: 1
-- 
...
ENTITY FCS_MPC_3Phase_SPMSM_V1_src_MATLAB_Function1 IS
...
END FCS_MPC_3Phase_SPMSM_V1_src_MATLAB_Function1;


ARCHITECTURE rtl OF FCS_MPC_3Phase_SPMSM_V1_src_MATLAB_Function1 IS

  -- Component Declarations
  COMPONENT FCS_MPC_3Phase_SPMSM_V1_src_nfp_relop_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : FCS_MPC_3Phase_SPMSM_V1_src_nfp_relop_single
    USE ENTITY work.FCS_MPC_3Phase_SPMSM_V1_src_nfp_relop_single(rtl);
...
BEGIN
  u_nfp_relop_comp : FCS_MPC_3Phase_SPMSM_V1_src_nfp_relop_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => J(1),  -- single
  ...
  u_nfp_relop_comp_1 : FCS_MPC_3Phase_SPMSM_V1_src_nfp_relop_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => J(2),  -- single
  ...
  u_nfp_relop_comp_2 : FCS_MPC_3Phase_SPMSM_V1_src_nfp_relop_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => J(3),  -- single
  ...
  u_nfp_relop_comp_3 : FCS_MPC_3Phase_SPMSM_V1_src_nfp_relop_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => J(4),  -- single
  ...
  u_nfp_relop_comp_4 : FCS_MPC_3Phase_SPMSM_V1_src_nfp_relop_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => J(5),  -- single
  ...
  u_nfp_relop_comp_5 : FCS_MPC_3Phase_SPMSM_V1_src_nfp_relop_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => J(6),  -- single
  ...
  u_nfp_relop_comp_6 : FCS_MPC_3Phase_SPMSM_V1_src_nfp_relop_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => J(7),  -- single
