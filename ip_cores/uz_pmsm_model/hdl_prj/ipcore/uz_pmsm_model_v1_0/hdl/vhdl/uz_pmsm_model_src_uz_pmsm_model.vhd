...
-- -------------------------------------------------------------
-- output_signals_0              ce_out        1e-06
-- output_signals_1              ce_out        1e-06
-- output_signals_2              ce_out        1e-06
-- output_signals_3              ce_out        1e-06
-- -------------------------------------------------------------
-- 
-- -------------------------------------------------------------
...
ENTITY uz_pmsm_model_src_uz_pmsm_model IS
  PORT( clk                               :   IN    std_logic;
        ...
        input_signals_0                   :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        input_signals_1                   :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        input_signals_2                   :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        input_signals_3                   :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        ...
        output_signals_0                  :   OUT   std_logic_vector(31 DOWNTO 0);  -- single
        output_signals_1                  :   OUT   std_logic_vector(31 DOWNTO 0);  -- single
        output_signals_2                  :   OUT   std_logic_vector(31 DOWNTO 0);  -- single
        output_signals_3                  :   OUT   std_logic_vector(31 DOWNTO 0)  -- single
        );
...
ARCHITECTURE rtl OF uz_pmsm_model_src_uz_pmsm_model IS
  ...
  SIGNAL input_signals                    : vector_of_std_logic_vector32(0 TO 3);  -- ufix32 [4]
  SIGNAL input_signals_4                  : vector_of_std_logic_vector32(0 TO 3);  -- ufix32 [4]
  ...
  SIGNAL out_0_pipe_in_pipe_out_1         : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL out_0_pipe_in_pipe_1_reg         : vector_of_std_logic_vector32(0 TO 3);  -- ufix32 [4]
  SIGNAL out_0_pipe_in_pipe_out_2         : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL out_0_pipe_in_pipe_out_3         : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL out_0_pipe_in_pipe_out_4         : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL out_0_pipe_in_pipe_1_reg_1       : vector_of_std_logic_vector32(0 TO 3);  -- ufix32 [4]
  SIGNAL out_0_pipe_in_pipe_1_reg_2       : vector_of_std_logic_vector32(0 TO 3);  -- ufix32 [4]
  SIGNAL out_0_pipe_in_pipe_1_reg_3       : vector_of_std_logic_vector32(0 TO 3);  -- ufix32 [4]
  SIGNAL out_0_pipe_in_pipe_1_reg_next    : vector_of_std_logic_vector32(0 TO 3);  -- ufix32 [4]
  SIGNAL out_0_pipe_in_pipe_1_reg_next_1  : vector_of_std_logic_vector32(0 TO 3);  -- ufix32 [4]
  SIGNAL out_0_pipe_in_pipe_1_reg_next_2  : vector_of_std_logic_vector32(0 TO 3);  -- ufix32 [4]
  SIGNAL out_0_pipe_in_pipe_1_reg_next_3  : vector_of_std_logic_vector32(0 TO 3);  -- ufix32 [4]
  SIGNAL Switch1_out1                     : std_logic_vector(63 DOWNTO 0);  -- ufix64
  SIGNAL i_q_2                            : vector_of_std_logic_vector32(0 TO 3);  -- ufix32 [4]
  ...
  SIGNAL i_q_3                            : vector_of_std_logic_vector32(0 TO 3);  -- ufix32 [4]
...
BEGIN
  ...
  u_uz_pmsm_model_uz_pmsm_model_nfp_convert_single2double_1 : uz_pmsm_model_src_nfp_convert_single2double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in => input_signals_4(0),  -- single
  ...
  u_uz_pmsm_model_uz_pmsm_model_nfp_convert_single2double_3 : uz_pmsm_model_src_nfp_convert_single2double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in => input_signals_4(2),  -- single
  ...
  u_uz_pmsm_model_uz_pmsm_model_nfp_convert_single2double_5 : uz_pmsm_model_src_nfp_convert_single2double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in => input_signals_4(1),  -- single
  ...
  u_uz_pmsm_model_uz_pmsm_model_nfp_convert_single2double_10 : uz_pmsm_model_src_nfp_convert_single2double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in => input_signals_4(3),  -- single
  ...
  input_signals(0) <= input_signals_0;
  input_signals(1) <= input_signals_1;
  input_signals(2) <= input_signals_2;
  input_signals(3) <= input_signals_3;

  input_signals_4 <= input_signals;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_100_1 = '1' THEN
        Delay_bypass_reg <= nfp_out_4_1;
      END IF;
    END IF;
  END PROCESS Delay_bypass_process;

  
  load_torque <= nfp_out_4_1 WHEN enb_1_100_1 = '1' ELSE
      Delay_bypass_reg;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_100_1 = '1' THEN
        Delay2_lowered1_bypass_reg <= Delay2_toDel;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_100_1 = '1' THEN
        Delay2_lowered2_bypass_reg <= Delay2_toDel_2;
      END IF;
    END IF;
  ...
  Switch_out1 <= nfp_out_3_1 WHEN simulate_mechanical_1 = '0' ELSE
      Sum3_out1_1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_100_1 = '1' THEN
        Delay2_lowered_bypass_reg <= Delay2_toDel_4;
      END IF;
    END IF;
  ...
  out_0_pipe_in_pipe_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        out_0_pipe_in_pipe_1_reg(0) <= X"00000000";
        out_0_pipe_in_pipe_1_reg(1) <= X"00000000";
        out_0_pipe_in_pipe_1_reg(2) <= X"00000000";
        out_0_pipe_in_pipe_1_reg(3) <= X"00000000";
        out_0_pipe_in_pipe_1_reg_1(0) <= X"00000000";
        out_0_pipe_in_pipe_1_reg_1(1) <= X"00000000";
        out_0_pipe_in_pipe_1_reg_1(2) <= X"00000000";
        out_0_pipe_in_pipe_1_reg_1(3) <= X"00000000";
        out_0_pipe_in_pipe_1_reg_2(0) <= X"00000000";
        out_0_pipe_in_pipe_1_reg_2(1) <= X"00000000";
        out_0_pipe_in_pipe_1_reg_2(2) <= X"00000000";
        out_0_pipe_in_pipe_1_reg_2(3) <= X"00000000";
        out_0_pipe_in_pipe_1_reg_3(0) <= X"00000000";
        out_0_pipe_in_pipe_1_reg_3(1) <= X"00000000";
        out_0_pipe_in_pipe_1_reg_3(2) <= X"00000000";
        out_0_pipe_in_pipe_1_reg_3(3) <= X"00000000";
      ELSIF enb = '1' THEN
        out_0_pipe_in_pipe_1_reg(0) <= out_0_pipe_in_pipe_1_reg_next(0);
        out_0_pipe_in_pipe_1_reg(1) <= out_0_pipe_in_pipe_1_reg_next(1);
        out_0_pipe_in_pipe_1_reg(2) <= out_0_pipe_in_pipe_1_reg_next(2);
        out_0_pipe_in_pipe_1_reg(3) <= out_0_pipe_in_pipe_1_reg_next(3);
        out_0_pipe_in_pipe_1_reg_1(0) <= out_0_pipe_in_pipe_1_reg_next_1(0);
        out_0_pipe_in_pipe_1_reg_1(1) <= out_0_pipe_in_pipe_1_reg_next_1(1);
        out_0_pipe_in_pipe_1_reg_1(2) <= out_0_pipe_in_pipe_1_reg_next_1(2);
        out_0_pipe_in_pipe_1_reg_1(3) <= out_0_pipe_in_pipe_1_reg_next_1(3);
        out_0_pipe_in_pipe_1_reg_2(0) <= out_0_pipe_in_pipe_1_reg_next_2(0);
        out_0_pipe_in_pipe_1_reg_2(1) <= out_0_pipe_in_pipe_1_reg_next_2(1);
        out_0_pipe_in_pipe_1_reg_2(2) <= out_0_pipe_in_pipe_1_reg_next_2(2);
        out_0_pipe_in_pipe_1_reg_2(3) <= out_0_pipe_in_pipe_1_reg_next_2(3);
        out_0_pipe_in_pipe_1_reg_3(0) <= out_0_pipe_in_pipe_1_reg_next_3(0);
        out_0_pipe_in_pipe_1_reg_3(1) <= out_0_pipe_in_pipe_1_reg_next_3(1);
        out_0_pipe_in_pipe_1_reg_3(2) <= out_0_pipe_in_pipe_1_reg_next_3(2);
        out_0_pipe_in_pipe_1_reg_3(3) <= out_0_pipe_in_pipe_1_reg_next_3(3);
      END IF;
    END IF;
  END PROCESS out_0_pipe_in_pipe_1_process;

  out_0_pipe_in_pipe_1_reg_next(0) <= nfp_out_1_1_1;
  out_0_pipe_in_pipe_1_reg_next(1) <= out_0_pipe_in_pipe_1_reg(0);
  out_0_pipe_in_pipe_1_reg_next(2) <= out_0_pipe_in_pipe_1_reg(1);
  out_0_pipe_in_pipe_1_reg_next(3) <= out_0_pipe_in_pipe_1_reg(2);
  out_0_pipe_in_pipe_out_1 <= out_0_pipe_in_pipe_1_reg(3);
  out_0_pipe_in_pipe_1_reg_next_1(0) <= nfp_out_2_1_1;
  out_0_pipe_in_pipe_1_reg_next_1(1) <= out_0_pipe_in_pipe_1_reg_1(0);
  out_0_pipe_in_pipe_1_reg_next_1(2) <= out_0_pipe_in_pipe_1_reg_1(1);
  out_0_pipe_in_pipe_1_reg_next_1(3) <= out_0_pipe_in_pipe_1_reg_1(2);
  out_0_pipe_in_pipe_out_2 <= out_0_pipe_in_pipe_1_reg_1(3);
  out_0_pipe_in_pipe_1_reg_next_2(0) <= nfp_out_3_1_1;
  out_0_pipe_in_pipe_1_reg_next_2(1) <= out_0_pipe_in_pipe_1_reg_2(0);
  out_0_pipe_in_pipe_1_reg_next_2(2) <= out_0_pipe_in_pipe_1_reg_2(1);
  out_0_pipe_in_pipe_1_reg_next_2(3) <= out_0_pipe_in_pipe_1_reg_2(2);
  out_0_pipe_in_pipe_out_3 <= out_0_pipe_in_pipe_1_reg_2(3);
  out_0_pipe_in_pipe_1_reg_next_3(0) <= nfp_out_4_1_1;
  out_0_pipe_in_pipe_1_reg_next_3(1) <= out_0_pipe_in_pipe_1_reg_3(0);
  out_0_pipe_in_pipe_1_reg_next_3(2) <= out_0_pipe_in_pipe_1_reg_3(1);
  out_0_pipe_in_pipe_1_reg_next_3(3) <= out_0_pipe_in_pipe_1_reg_3(2);
  out_0_pipe_in_pipe_out_4 <= out_0_pipe_in_pipe_1_reg_3(3);

  
  Switch1_out1 <= nfp_out_3_1 WHEN simulate_mechanical_1 = '0' ELSE
      Sum3_out1_1;

  i_q_2(0) <= out_0_pipe_in_pipe_out_1;
  i_q_2(1) <= out_0_pipe_in_pipe_out_2;
  i_q_2(2) <= out_0_pipe_in_pipe_out_3;
  i_q_2(3) <= out_0_pipe_in_pipe_out_4;
  ...
  i_q_3(0) <= i_q_2(0) WHEN enb_1_100_1 = '1' ELSE
      t1_bypass_reg(0);
  
  i_q_3(1) <= i_q_2(1) WHEN enb_1_100_1 = '1' ELSE
      t1_bypass_reg(1);
  
  i_q_3(2) <= i_q_2(2) WHEN enb_1_100_1 = '1' ELSE
      t1_bypass_reg(2);
  
  i_q_3(3) <= i_q_2(3) WHEN enb_1_100_1 = '1' ELSE
      t1_bypass_reg(3);
  t1_bypass_reg_next(0) <= i_q_2(0);
  t1_bypass_reg_next(1) <= i_q_2(1);
  t1_bypass_reg_next(2) <= i_q_2(2);
  t1_bypass_reg_next(3) <= i_q_2(3);

  ce_out <= enb_1_100_1;

  output_signals_0 <= i_q_3(0);

  output_signals_1 <= i_q_3(1);

  output_signals_2 <= i_q_3(2);

  output_signals_3 <= i_q_3(3);
