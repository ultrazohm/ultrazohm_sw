...
#
# build_2EG.tcl: Tcl script for re-creating project 'ultrazohm'
#
# Generated by Vivado on Tue Mar 15 08:43:53 +0100 2022
...
#
# 1. This project restoration tcl script (build_2EG.tcl) that was generated.
#
...
# Create project
create_project ${_xil_proj_name_} ./project -part xczu2eg-sfvc784-1-e
...
set_property -name "board_part" -value "trenz.biz:te0803_2eg_1e:part0:1.0" -objects $obj
...
# Create block design
source $origin_dir/bd/zusys_2EG.tcl
