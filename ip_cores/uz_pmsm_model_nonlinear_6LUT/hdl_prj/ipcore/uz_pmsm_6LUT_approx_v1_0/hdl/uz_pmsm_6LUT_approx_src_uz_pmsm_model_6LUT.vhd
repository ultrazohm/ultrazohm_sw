...
ARCHITECTURE rtl OF uz_pmsm_6LUT_approx_src_uz_pmsm_model_6LUT IS
  ...
  SIGNAL delayMatch49_reg                 : std_logic_vector(96 DOWNTO 0);  -- ufix1 [97]
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        delayMatch49_reg(0) <= Switch1_out1_timer;
        delayMatch49_reg(96 DOWNTO 1) <= delayMatch49_reg(95 DOWNTO 0);
      END IF;
    END IF;
  END PROCESS delayMatch49_process;

  Switch1_out1_timer_1 <= delayMatch49_reg(96);
