-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\parallel_8_delay_compensation\hdlsrc\parallel_8_delay_compensation\parallel_8_delay_compensation.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: parallel_8_delay_compensation
-- Source Path: parallel_8_delay_compensation
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY parallel_8_delay_compensation IS
...
END parallel_8_delay_compensation;


ARCHITECTURE rtl OF parallel_8_delay_compensation IS

  -- Component Declarations
  COMPONENT parallel_8_delay_compensation_reset_sync
  ...
  COMPONENT parallel_8_delay_compensation_axi_lite
  ...
  COMPONENT parallel_8_delay_compensation_dut
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
  ...
  FOR ALL : parallel_8_delay_compensation_reset_sync
    USE ENTITY work.parallel_8_delay_compensation_reset_sync(rtl);

  FOR ALL : parallel_8_delay_compensation_axi_lite
    USE ENTITY work.parallel_8_delay_compensation_axi_lite(rtl);

  FOR ALL : parallel_8_delay_compensation_dut
    USE ENTITY work.parallel_8_delay_compensation_dut(rtl);
...
BEGIN
  u_parallel_8_delay_compensation_reset_sync_inst : parallel_8_delay_compensation_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_parallel_8_delay_compensation_axi_lite_inst : parallel_8_delay_compensation_axi_lite
  ...
  u_parallel_8_delay_compensation_dut_inst : parallel_8_delay_compensation_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  ip_timestamp <= unsigned'(X"83BCB062");
