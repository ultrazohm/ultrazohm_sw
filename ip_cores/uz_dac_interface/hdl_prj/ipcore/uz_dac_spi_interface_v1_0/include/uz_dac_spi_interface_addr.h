...
#define  IPCore_Timestamp_uz_dac_spi_interface          0x8  //contains unique IP timestamp (yymmddHHMM): 2407091153
...
#define  use_input_from_axi_Data_uz_dac_spi_interface   0x148  //data register for Inport use_input_from_axi
#define  reset_value_Data_uz_dac_spi_interface          0x14C  //data register for Inport reset_value
#define  reset_dac_output_Data_uz_dac_spi_interface     0x150  //data register for Inport reset_dac_output
