...
ARCHITECTURE rtl OF parallel_8_sim_delay_compensation_addr_decoder IS
  ...
  SIGNAL data_reg_omega_m_measured_AXI_1_1 : unsigned(31 DOWNTO 0);  -- ufix32
...
BEGIN
  ...
  decode_sel_iy_k_1_AXI_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#004C#, 14) ELSE
      '0';

  
  decode_sel_ix_k_1_AXI_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#004B#, 14) ELSE
      '0';

  
  decode_sel_iq_k_1_AXI_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#004A#, 14) ELSE
      '0';

  
  decode_sel_id_k_1_AXI_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0049#, 14) ELSE
      '0';
  ...
  decode_sel_omega_m_measured_AXI_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#004D#, 14) ELSE
      '0';
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_omega_m_measured_AXI_1_1 <= to_unsigned(0, 32);
      ELSIF enb = '1' AND reg_enb_omega_m_measured_AXI_1_1 = '1' THEN
        data_reg_omega_m_measured_AXI_1_1 <= data_write_unsigned;
      END IF;
    END IF;
