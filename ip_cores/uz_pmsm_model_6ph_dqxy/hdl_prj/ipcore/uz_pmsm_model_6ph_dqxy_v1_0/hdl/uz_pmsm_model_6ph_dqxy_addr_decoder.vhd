-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_pmsm_model_6ph_dqxy\uz_pmsm_model_6ph_dqxy_addr_decoder.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_6ph_dqxy_addr_decoder
-- Source Path: uz_pmsm_model_6ph_dqxy/uz_pmsm_model_6ph_dqxy_axi4/uz_pmsm_model_6ph_dqxy_addr_decoder
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
USE work.uz_pmsm_model_6ph_dqxy_pkg.ALL;

ENTITY uz_pmsm_model_6ph_dqxy_addr_decoder IS
  PORT( clk                               :   IN    std_logic;
        ...
        read_outputs                      :   IN    vector_of_std_logic_vector32(0 TO 5);  -- ufix32 [6]
        ...
        write_reciprocal_L_x              :   OUT   std_logic_vector(31 DOWNTO 0);  -- ufix32
        write_reciprocal_L_y              :   OUT   std_logic_vector(31 DOWNTO 0);  -- ufix32
        write_inputs                      :   OUT   vector_of_std_logic_vector32(0 TO 5)  -- ufix32 [6]
        );
END uz_pmsm_model_6ph_dqxy_addr_decoder;


ARCHITECTURE rtl OF uz_pmsm_model_6ph_dqxy_addr_decoder IS
  ...
  SIGNAL read_outputs_unsigned            : vector_of_unsigned32(0 TO 5);  -- ufix32 [6]
  SIGNAL sync_reg_outputs                 : vector_of_unsigned32(0 TO 5);  -- ufix32 [6]
  ...
  SIGNAL data_slice_outputs_1_5           : unsigned(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL decode_sel_reciprocal_L_x_1_1    : std_logic;  -- ufix1
  SIGNAL reg_enb_reciprocal_L_x_1_1       : std_logic;  -- ufix1
  SIGNAL data_reg_reciprocal_L_x_1_1      : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_sel_reciprocal_L_y_1_1    : std_logic;  -- ufix1
  SIGNAL reg_enb_reciprocal_L_y_1_1       : std_logic;  -- ufix1
  SIGNAL data_reg_reciprocal_L_y_1_1      : unsigned(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL decode_sel_inputs_5_1            : std_logic;  -- ufix1
  SIGNAL reg_enb_inputs_5_1               : std_logic;  -- ufix1
  SIGNAL data_reg_inputs_5_1              : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_sel_inputs_6_1            : std_logic;  -- ufix1
  SIGNAL reg_enb_inputs_6_1               : std_logic;  -- ufix1
  SIGNAL strobe_reg_inputs                : std_logic;  -- ufix1
  SIGNAL data_reg_inputs_6_1              : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL write_reg_inputs                 : vector_of_unsigned32(0 TO 5);  -- ufix32 [6]
  SIGNAL sync_reg_inputs_1                : vector_of_unsigned32(0 TO 5);  -- ufix32 [6]
...
BEGIN
  ...
  decode_sel_outputs <= '1' WHEN addr_write_unsigned = to_unsigned(16#0068#, 14) ELSE
      '0';
  ...
  data_slice_outputs_1_4 <= sync_reg_outputs(4);

  data_slice_outputs_1_5 <= sync_reg_outputs(5);

  const_0 <= to_unsigned(0, 32);

  mux0_level1_output : PROCESS (address_select_level1, const_0, data_slice_outputs_1_0, data_slice_outputs_1_1,
       data_slice_outputs_1_2, data_slice_outputs_1_3, data_slice_outputs_1_4,
       data_slice_outputs_1_5, read_reg_ip_timestamp)
  BEGIN
    CASE address_select_level1 IS
      WHEN "0000010" =>
        mux_out0_level1 <= read_reg_ip_timestamp;
      WHEN "1100000" =>
        mux_out0_level1 <= data_slice_outputs_1_0;
      WHEN "1100001" =>
        mux_out0_level1 <= data_slice_outputs_1_1;
      WHEN "1100010" =>
        mux_out0_level1 <= data_slice_outputs_1_2;
      WHEN "1100011" =>
        mux_out0_level1 <= data_slice_outputs_1_3;
      WHEN "1100100" =>
        mux_out0_level1 <= data_slice_outputs_1_4;
      WHEN "1100101" =>
        mux_out0_level1 <= data_slice_outputs_1_5;
      WHEN OTHERS => 
  ...
  decode_sel_reset_integrators_1_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#0040#, 14) ELSE
      '0';
  ...
  decode_sel_simulate_mechanical_1_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#0041#, 14) ELSE
      '0';
  ...
  decode_sel_reciprocal_J_1_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#0042#, 14) ELSE
      '0';
  ...
  decode_sel_mu_1_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#0043#, 14) ELSE
      '0';
  ...
  decode_sel_M_n0_1_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#0044#, 14) ELSE
      '0';
  ...
  decode_sel_reciprocal_L_d_1_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#0045#, 14) ELSE
      '0';
  ...
  decode_sel_reciprocal_L_q_1_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#0046#, 14) ELSE
      '0';
  ...
  decode_sel_polepairs_1_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#0048#, 14) ELSE
      '0';
  ...
  decode_sel_psi_pm_1_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#0049#, 14) ELSE
      '0';
  ...
  decode_sel_reciprocal_L_x_1_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#004A#, 14) ELSE
      '0';

  reg_enb_reciprocal_L_x_1_1 <= decode_sel_reciprocal_L_x_1_1 AND wr_enb;

  reg_reciprocal_L_x_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_reciprocal_L_x_1_1 <= to_unsigned(0, 32);
      ELSIF enb = '1' AND reg_enb_reciprocal_L_x_1_1 = '1' THEN
        data_reg_reciprocal_L_x_1_1 <= data_write_unsigned;
      END IF;
    END IF;
  END PROCESS reg_reciprocal_L_x_1_1_process;


  write_reciprocal_L_x <= std_logic_vector(data_reg_reciprocal_L_x_1_1);

  
  decode_sel_reciprocal_L_y_1_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#004B#, 14) ELSE
      '0';

  reg_enb_reciprocal_L_y_1_1 <= decode_sel_reciprocal_L_y_1_1 AND wr_enb;

  reg_reciprocal_L_y_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_reciprocal_L_y_1_1 <= to_unsigned(0, 32);
      ELSIF enb = '1' AND reg_enb_reciprocal_L_y_1_1 = '1' THEN
        data_reg_reciprocal_L_y_1_1 <= data_write_unsigned;
      END IF;
    END IF;
  END PROCESS reg_reciprocal_L_y_1_1_process;


  write_reciprocal_L_y <= std_logic_vector(data_reg_reciprocal_L_y_1_1);

  
  decode_sel_inputs <= '1' WHEN addr_write_unsigned = to_unsigned(16#0058#, 14) ELSE
      '0';
  ...
  decode_sel_inputs_1_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#0050#, 14) ELSE
      '0';
  ...
  decode_sel_inputs_2_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#0051#, 14) ELSE
      '0';
  ...
  decode_sel_inputs_3_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#0052#, 14) ELSE
      '0';
  ...
  decode_sel_inputs_4_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#0053#, 14) ELSE
      '0';
  ...
  decode_sel_inputs_5_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#0054#, 14) ELSE
      '0';

  reg_enb_inputs_5_1 <= decode_sel_inputs_5_1 AND wr_enb;

  reg_inputs_5_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_inputs_5_1 <= to_unsigned(0, 32);
      ELSIF enb = '1' AND reg_enb_inputs_5_1 = '1' THEN
        data_reg_inputs_5_1 <= data_write_unsigned;
      END IF;
    END IF;
  END PROCESS reg_inputs_5_1_process;


  
  decode_sel_inputs_6_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#0055#, 14) ELSE
      '0';

  reg_enb_inputs_6_1 <= decode_sel_inputs_6_1 AND wr_enb;
  ...
  reg_inputs_6_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_inputs_6_1 <= to_unsigned(0, 32);
      ELSIF enb = '1' AND reg_enb_inputs_6_1 = '1' THEN
        data_reg_inputs_6_1 <= data_write_unsigned;
      END IF;
    END IF;
  END PROCESS reg_inputs_6_1_process;
  ...
  write_reg_inputs(4) <= data_reg_inputs_5_1;
  write_reg_inputs(5) <= data_reg_inputs_6_1;
