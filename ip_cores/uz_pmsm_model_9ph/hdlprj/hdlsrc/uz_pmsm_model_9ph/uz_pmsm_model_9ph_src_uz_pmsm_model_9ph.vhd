...
-- u_abc_pl_out_0                ce_out        1e-06
-- u_abc_pl_out_1                ce_out        1e-06
-- u_abc_pl_out_2                ce_out        1e-06
-- u_abc_pl_out_3                ce_out        1e-06
-- u_abc_pl_out_4                ce_out        1e-06
-- u_abc_pl_out_5                ce_out        1e-06
-- u_abc_pl_out_6                ce_out        1e-06
-- u_abc_pl_out_7                ce_out        1e-06
-- u_abc_pl_out_8                ce_out        1e-06
-- -------------------------------------------------------------
-- 
-- -------------------------------------------------------------
...
ARCHITECTURE rtl OF uz_pmsm_model_9ph_src_uz_pmsm_model_9ph IS
  ...
  SIGNAL u_abc_pl                         : vector_of_std_logic_vector25(0 TO 8);  -- ufix25 [9]
  SIGNAL u_abc_pl_9                       : vector_of_signed25(0 TO 8);  -- sfix25_En12 [9]
  SIGNAL u_abc_pl_10                      : vector_of_signed25(0 TO 8);  -- sfix25_En12 [9]
  ...
  SIGNAL t3_bypass_reg                    : vector_of_std_logic_vector32(0 TO 4);  -- ufix32 [5]
  SIGNAL t3_bypass_reg_next               : vector_of_std_logic_vector32(0 TO 4);  -- ufix32 [5]
  ...
  SIGNAL Data_Type_Conversion7_out1_3     : vector_of_signed25(0 TO 8);  -- sfix25_En12 [9]
  SIGNAL t4_bypass_reg                    : vector_of_signed25(0 TO 8);  -- sfix25 [9]
  SIGNAL t4_bypass_reg_next               : vector_of_signed25(0 TO 8);  -- sfix25_En12 [9]
  SIGNAL Data_Type_Conversion7_out1_4     : vector_of_signed25(0 TO 8);  -- sfix25_En12 [9]
...
BEGIN
  ...
  u_abc_pl(0) <= u_abc_pl_0;
  u_abc_pl(1) <= u_abc_pl_1;
  u_abc_pl(2) <= u_abc_pl_2;
  u_abc_pl(3) <= u_abc_pl_3;
  u_abc_pl(4) <= u_abc_pl_4;
  u_abc_pl(5) <= u_abc_pl_5;
  u_abc_pl(6) <= u_abc_pl_6;
  u_abc_pl(7) <= u_abc_pl_7;
  u_abc_pl(8) <= u_abc_pl_8;

  outputgen3: FOR k IN 0 TO 8 GENERATE
    u_abc_pl_9(k) <= signed(u_abc_pl(k));
  END GENERATE;

  u_abc_pl_10 <= u_abc_pl_9;
  ...
  Switch4_out1(0) <= u_abc_pl_10(0) WHEN switch_pspl_2 = '0' ELSE
      Data_Type_Conversion31_out1_1(0);
  
  Switch4_out1(1) <= u_abc_pl_10(1) WHEN switch_pspl_2 = '0' ELSE
      Data_Type_Conversion31_out1_1(1);
  
  Switch4_out1(2) <= u_abc_pl_10(2) WHEN switch_pspl_2 = '0' ELSE
      Data_Type_Conversion31_out1_1(2);
  
  Switch4_out1(3) <= u_abc_pl_10(3) WHEN switch_pspl_2 = '0' ELSE
      Data_Type_Conversion31_out1_1(3);
  
  Switch4_out1(4) <= u_abc_pl_10(4) WHEN switch_pspl_2 = '0' ELSE
      Data_Type_Conversion31_out1_1(4);
  
  Switch4_out1(5) <= u_abc_pl_10(5) WHEN switch_pspl_2 = '0' ELSE
      Data_Type_Conversion31_out1_1(5);
  
  Switch4_out1(6) <= u_abc_pl_10(6) WHEN switch_pspl_2 = '0' ELSE
      Data_Type_Conversion31_out1_1(6);
  
  Switch4_out1(7) <= u_abc_pl_10(7) WHEN switch_pspl_2 = '0' ELSE
      Data_Type_Conversion31_out1_1(7);
  
  Switch4_out1(8) <= u_abc_pl_10(8) WHEN switch_pspl_2 = '0' ELSE
  ...
  Mux_out1_3(4) <= Mux_out1_2(4) WHEN enb_1_100_1 = '1' ELSE
      t3_bypass_reg(4);
  t3_bypass_reg_next(0) <= Mux_out1_2(0);
  t3_bypass_reg_next(1) <= Mux_out1_2(1);
  t3_bypass_reg_next(2) <= Mux_out1_2(2);
  t3_bypass_reg_next(3) <= Mux_out1_2(3);
  t3_bypass_reg_next(4) <= Mux_out1_2(4);
  ...
  Data_Type_Conversion17_out1_3(8) <= Data_Type_Conversion17_out1_2(8) WHEN enb_1_100_1 = '1' ELSE
      t6_bypass_reg(8);
  t6_bypass_reg_next(0) <= Data_Type_Conversion17_out1_2(0);
  t6_bypass_reg_next(1) <= Data_Type_Conversion17_out1_2(1);
  t6_bypass_reg_next(2) <= Data_Type_Conversion17_out1_2(2);
  t6_bypass_reg_next(3) <= Data_Type_Conversion17_out1_2(3);
  t6_bypass_reg_next(4) <= Data_Type_Conversion17_out1_2(4);
  t6_bypass_reg_next(5) <= Data_Type_Conversion17_out1_2(5);
  t6_bypass_reg_next(6) <= Data_Type_Conversion17_out1_2(6);
  t6_bypass_reg_next(7) <= Data_Type_Conversion17_out1_2(7);
  t6_bypass_reg_next(8) <= Data_Type_Conversion17_out1_2(8);
  ...
  Data_Type_Conversion6_out1_4(8) <= Data_Type_Conversion6_out1_3(8) WHEN enb_1_100_1 = '1' ELSE
      t5_bypass_reg(8);
  t5_bypass_reg_next(0) <= Data_Type_Conversion6_out1_3(0);
  t5_bypass_reg_next(1) <= Data_Type_Conversion6_out1_3(1);
  t5_bypass_reg_next(2) <= Data_Type_Conversion6_out1_3(2);
  t5_bypass_reg_next(3) <= Data_Type_Conversion6_out1_3(3);
  t5_bypass_reg_next(4) <= Data_Type_Conversion6_out1_3(4);
  t5_bypass_reg_next(5) <= Data_Type_Conversion6_out1_3(5);
  t5_bypass_reg_next(6) <= Data_Type_Conversion6_out1_3(6);
  t5_bypass_reg_next(7) <= Data_Type_Conversion6_out1_3(7);
  t5_bypass_reg_next(8) <= Data_Type_Conversion6_out1_3(8);
  ...
  Data_Type_Conversion7_out1_2_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Data_Type_Conversion7_out1_3(0) <= to_signed(16#0000000#, 25);
        Data_Type_Conversion7_out1_3(1) <= to_signed(16#0000000#, 25);
        Data_Type_Conversion7_out1_3(2) <= to_signed(16#0000000#, 25);
        Data_Type_Conversion7_out1_3(3) <= to_signed(16#0000000#, 25);
        Data_Type_Conversion7_out1_3(4) <= to_signed(16#0000000#, 25);
        Data_Type_Conversion7_out1_3(5) <= to_signed(16#0000000#, 25);
        Data_Type_Conversion7_out1_3(6) <= to_signed(16#0000000#, 25);
        Data_Type_Conversion7_out1_3(7) <= to_signed(16#0000000#, 25);
        Data_Type_Conversion7_out1_3(8) <= to_signed(16#0000000#, 25);
      ELSIF enb = '1' THEN
        Data_Type_Conversion7_out1_3(0) <= Data_Type_Conversion7_out1_1(0);
        Data_Type_Conversion7_out1_3(1) <= Data_Type_Conversion7_out1_1(1);
        Data_Type_Conversion7_out1_3(2) <= Data_Type_Conversion7_out1_1(2);
        Data_Type_Conversion7_out1_3(3) <= Data_Type_Conversion7_out1_1(3);
        Data_Type_Conversion7_out1_3(4) <= Data_Type_Conversion7_out1_1(4);
        Data_Type_Conversion7_out1_3(5) <= Data_Type_Conversion7_out1_1(5);
        Data_Type_Conversion7_out1_3(6) <= Data_Type_Conversion7_out1_1(6);
        Data_Type_Conversion7_out1_3(7) <= Data_Type_Conversion7_out1_1(7);
        Data_Type_Conversion7_out1_3(8) <= Data_Type_Conversion7_out1_1(8);
      END IF;
    END IF;
  END PROCESS Data_Type_Conversion7_out1_2_process;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        t4_bypass_reg(0) <= to_signed(16#0000000#, 25);
        t4_bypass_reg(1) <= to_signed(16#0000000#, 25);
        t4_bypass_reg(2) <= to_signed(16#0000000#, 25);
        t4_bypass_reg(3) <= to_signed(16#0000000#, 25);
        t4_bypass_reg(4) <= to_signed(16#0000000#, 25);
        t4_bypass_reg(5) <= to_signed(16#0000000#, 25);
        t4_bypass_reg(6) <= to_signed(16#0000000#, 25);
        t4_bypass_reg(7) <= to_signed(16#0000000#, 25);
        t4_bypass_reg(8) <= to_signed(16#0000000#, 25);
      ELSIF enb_1_100_1 = '1' THEN
  ...
  Data_Type_Conversion7_out1_4(0) <= Data_Type_Conversion7_out1_3(0) WHEN enb_1_100_1 = '1' ELSE
      t4_bypass_reg(0);
  
  Data_Type_Conversion7_out1_4(1) <= Data_Type_Conversion7_out1_3(1) WHEN enb_1_100_1 = '1' ELSE
      t4_bypass_reg(1);
  
  Data_Type_Conversion7_out1_4(2) <= Data_Type_Conversion7_out1_3(2) WHEN enb_1_100_1 = '1' ELSE
      t4_bypass_reg(2);
  
  Data_Type_Conversion7_out1_4(3) <= Data_Type_Conversion7_out1_3(3) WHEN enb_1_100_1 = '1' ELSE
      t4_bypass_reg(3);
  
  Data_Type_Conversion7_out1_4(4) <= Data_Type_Conversion7_out1_3(4) WHEN enb_1_100_1 = '1' ELSE
      t4_bypass_reg(4);
  
  Data_Type_Conversion7_out1_4(5) <= Data_Type_Conversion7_out1_3(5) WHEN enb_1_100_1 = '1' ELSE
      t4_bypass_reg(5);
  
  Data_Type_Conversion7_out1_4(6) <= Data_Type_Conversion7_out1_3(6) WHEN enb_1_100_1 = '1' ELSE
      t4_bypass_reg(6);
  
  Data_Type_Conversion7_out1_4(7) <= Data_Type_Conversion7_out1_3(7) WHEN enb_1_100_1 = '1' ELSE
      t4_bypass_reg(7);
  
  Data_Type_Conversion7_out1_4(8) <= Data_Type_Conversion7_out1_3(8) WHEN enb_1_100_1 = '1' ELSE
      t4_bypass_reg(8);
  t4_bypass_reg_next(0) <= Data_Type_Conversion7_out1_3(0);
  t4_bypass_reg_next(1) <= Data_Type_Conversion7_out1_3(1);
  t4_bypass_reg_next(2) <= Data_Type_Conversion7_out1_3(2);
  t4_bypass_reg_next(3) <= Data_Type_Conversion7_out1_3(3);
  t4_bypass_reg_next(4) <= Data_Type_Conversion7_out1_3(4);
  t4_bypass_reg_next(5) <= Data_Type_Conversion7_out1_3(5);
  t4_bypass_reg_next(6) <= Data_Type_Conversion7_out1_3(6);
  t4_bypass_reg_next(7) <= Data_Type_Conversion7_out1_3(7);
  t4_bypass_reg_next(8) <= Data_Type_Conversion7_out1_3(8);

  u_abc_pl_out_0 <= std_logic_vector(Data_Type_Conversion7_out1_4(0));

  u_abc_pl_out_1 <= std_logic_vector(Data_Type_Conversion7_out1_4(1));

  u_abc_pl_out_2 <= std_logic_vector(Data_Type_Conversion7_out1_4(2));

  u_abc_pl_out_3 <= std_logic_vector(Data_Type_Conversion7_out1_4(3));

  u_abc_pl_out_4 <= std_logic_vector(Data_Type_Conversion7_out1_4(4));

  u_abc_pl_out_5 <= std_logic_vector(Data_Type_Conversion7_out1_4(5));

  u_abc_pl_out_6 <= std_logic_vector(Data_Type_Conversion7_out1_4(6));

  u_abc_pl_out_7 <= std_logic_vector(Data_Type_Conversion7_out1_4(7));

  u_abc_pl_out_8 <= std_logic_vector(Data_Type_Conversion7_out1_4(8));
