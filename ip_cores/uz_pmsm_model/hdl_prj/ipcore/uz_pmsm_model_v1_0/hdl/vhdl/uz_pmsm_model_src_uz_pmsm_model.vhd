...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_50_1 = '1' THEN
        Delay1_lowered2_bypass_reg <= Delay1_toDel_4;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_50_1 = '1' THEN
        t2_bypass_reg <= Data_Type_Conversion11_out1;
      END IF;
    END IF;
  END PROCESS t2_bypass_process;

  
  Data_Type_Conversion11_out1_1 <= Data_Type_Conversion11_out1 WHEN enb_1_50_1 = '1' ELSE
      t2_bypass_reg;
  ...
  i_q <= i_q_4 WHEN enb_1_50_1 = '1' ELSE
      t3_bypass_reg;
  ...
  i_q_6 <= i_q_5 WHEN enb_1_50_1 = '1' ELSE
      t_bypass_reg;
  ...
  i_q_8 <= i_q_7 WHEN enb_1_50_1 = '1' ELSE
      t1_bypass_reg;

  ce_out <= enb_1_50_1;

  i_d <= Data_Type_Conversion11_out1_1;

  torque <= i_q_6;

  out_omega_mech <= i_q_8;
