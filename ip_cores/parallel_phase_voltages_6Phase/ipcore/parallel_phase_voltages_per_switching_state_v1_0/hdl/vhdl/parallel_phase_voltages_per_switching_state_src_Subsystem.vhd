-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\parallel_phase_voltages_6Phase\hdlsrc\parallel_phase_voltages_per_switching_state_6\parallel_phase_voltages_per_switching_state_src_Subsystem.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: parallel_phase_voltages_per_switching_state_src_Subsystem
...
ENTITY parallel_phase_voltages_per_switching_state_src_Subsystem IS
...
END parallel_phase_voltages_per_switching_state_src_Subsystem;


ARCHITECTURE rtl OF parallel_phase_voltages_per_switching_state_src_Subsystem IS

  -- Component Declarations
  COMPONENT parallel_phase_voltages_per_switching_state_src_MATLAB_Function15
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT parallel_phase_voltages_per_switching_state_src_MATLAB_Function14
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          theta_el_with_offset            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT parallel_phase_voltages_per_switching_state_src_MATLAB_Function13
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          theta_el_with_offset            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT parallel_phase_voltages_per_switching_state_src_MATLAB_Function12
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          theta_el_with_offset            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT parallel_phase_voltages_per_switching_state_src_MATLAB_Function11
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          theta_el_with_offset            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT parallel_phase_voltages_per_switching_state_src_MATLAB_Function10
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          theta_el_with_offset            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT parallel_phase_voltages_per_switching_state_src_MATLAB_Function9
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          theta_el_with_offset            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT parallel_phase_voltages_per_switching_state_src_MATLAB_Function8
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          theta_el_with_offset            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT parallel_phase_voltages_per_switching_state_src_MATLAB_Function7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          theta_el_with_offset            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT parallel_phase_voltages_per_switching_state_src_MATLAB_Function6
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          theta_el_with_offset            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT parallel_phase_voltages_per_switching_state_src_MATLAB_Function5
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          theta_el_with_offset            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT parallel_phase_voltages_per_switching_state_src_MATLAB_Function4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          theta_el_with_offset            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT parallel_phase_voltages_per_switching_state_src_MATLAB_Function3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          theta_el_with_offset            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT parallel_phase_voltages_per_switching_state_src_MATLAB_Function2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          theta_el_with_offset            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT parallel_phase_voltages_per_switching_state_src_MATLAB_Function1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          theta_el_with_offset            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT parallel_phase_voltages_per_switching_state_src_MATLAB_Function
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          theta_el_with_offset            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  FOR ALL : parallel_phase_voltages_per_switching_state_src_MATLAB_Function15
    USE ENTITY work.parallel_phase_voltages_per_switching_state_src_MATLAB_Function15(rtl);

  FOR ALL : parallel_phase_voltages_per_switching_state_src_MATLAB_Function14
    USE ENTITY work.parallel_phase_voltages_per_switching_state_src_MATLAB_Function14(rtl);

  FOR ALL : parallel_phase_voltages_per_switching_state_src_MATLAB_Function13
    USE ENTITY work.parallel_phase_voltages_per_switching_state_src_MATLAB_Function13(rtl);

  FOR ALL : parallel_phase_voltages_per_switching_state_src_MATLAB_Function12
    USE ENTITY work.parallel_phase_voltages_per_switching_state_src_MATLAB_Function12(rtl);

  FOR ALL : parallel_phase_voltages_per_switching_state_src_MATLAB_Function11
    USE ENTITY work.parallel_phase_voltages_per_switching_state_src_MATLAB_Function11(rtl);

  FOR ALL : parallel_phase_voltages_per_switching_state_src_MATLAB_Function10
    USE ENTITY work.parallel_phase_voltages_per_switching_state_src_MATLAB_Function10(rtl);

  FOR ALL : parallel_phase_voltages_per_switching_state_src_MATLAB_Function9
    USE ENTITY work.parallel_phase_voltages_per_switching_state_src_MATLAB_Function9(rtl);

  FOR ALL : parallel_phase_voltages_per_switching_state_src_MATLAB_Function8
    USE ENTITY work.parallel_phase_voltages_per_switching_state_src_MATLAB_Function8(rtl);

  FOR ALL : parallel_phase_voltages_per_switching_state_src_MATLAB_Function7
    USE ENTITY work.parallel_phase_voltages_per_switching_state_src_MATLAB_Function7(rtl);

  FOR ALL : parallel_phase_voltages_per_switching_state_src_MATLAB_Function6
    USE ENTITY work.parallel_phase_voltages_per_switching_state_src_MATLAB_Function6(rtl);

  FOR ALL : parallel_phase_voltages_per_switching_state_src_MATLAB_Function5
    USE ENTITY work.parallel_phase_voltages_per_switching_state_src_MATLAB_Function5(rtl);

  FOR ALL : parallel_phase_voltages_per_switching_state_src_MATLAB_Function4
    USE ENTITY work.parallel_phase_voltages_per_switching_state_src_MATLAB_Function4(rtl);

  FOR ALL : parallel_phase_voltages_per_switching_state_src_MATLAB_Function3
    USE ENTITY work.parallel_phase_voltages_per_switching_state_src_MATLAB_Function3(rtl);

  FOR ALL : parallel_phase_voltages_per_switching_state_src_MATLAB_Function2
    USE ENTITY work.parallel_phase_voltages_per_switching_state_src_MATLAB_Function2(rtl);

  FOR ALL : parallel_phase_voltages_per_switching_state_src_MATLAB_Function1
    USE ENTITY work.parallel_phase_voltages_per_switching_state_src_MATLAB_Function1(rtl);

  FOR ALL : parallel_phase_voltages_per_switching_state_src_MATLAB_Function
    USE ENTITY work.parallel_phase_voltages_per_switching_state_src_MATLAB_Function(rtl);
...
BEGIN
  u_MATLAB_Function15 : parallel_phase_voltages_per_switching_state_src_MATLAB_Function15
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_MATLAB_Function14 : parallel_phase_voltages_per_switching_state_src_MATLAB_Function14
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              theta_el_with_offset => theta_el_with_offset15,  -- single
  ...
  u_MATLAB_Function13 : parallel_phase_voltages_per_switching_state_src_MATLAB_Function13
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              theta_el_with_offset => theta_el_with_offset15,  -- single
  ...
  u_MATLAB_Function12 : parallel_phase_voltages_per_switching_state_src_MATLAB_Function12
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              theta_el_with_offset => theta_el_with_offset15,  -- single
  ...
  u_MATLAB_Function11 : parallel_phase_voltages_per_switching_state_src_MATLAB_Function11
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              theta_el_with_offset => theta_el_with_offset15,  -- single
  ...
  u_MATLAB_Function10 : parallel_phase_voltages_per_switching_state_src_MATLAB_Function10
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              theta_el_with_offset => theta_el_with_offset15,  -- single
  ...
  u_MATLAB_Function9 : parallel_phase_voltages_per_switching_state_src_MATLAB_Function9
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              theta_el_with_offset => theta_el_with_offset15,  -- single
  ...
  u_MATLAB_Function8 : parallel_phase_voltages_per_switching_state_src_MATLAB_Function8
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              theta_el_with_offset => theta_el_with_offset15,  -- single
  ...
  u_MATLAB_Function7 : parallel_phase_voltages_per_switching_state_src_MATLAB_Function7
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              theta_el_with_offset => theta_el_with_offset15,  -- single
  ...
  u_MATLAB_Function6 : parallel_phase_voltages_per_switching_state_src_MATLAB_Function6
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              theta_el_with_offset => theta_el_with_offset15,  -- single
  ...
  u_MATLAB_Function5 : parallel_phase_voltages_per_switching_state_src_MATLAB_Function5
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              theta_el_with_offset => theta_el_with_offset15,  -- single
  ...
  u_MATLAB_Function4 : parallel_phase_voltages_per_switching_state_src_MATLAB_Function4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              theta_el_with_offset => theta_el_with_offset15,  -- single
  ...
  u_MATLAB_Function3 : parallel_phase_voltages_per_switching_state_src_MATLAB_Function3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              theta_el_with_offset => theta_el_with_offset15,  -- single
  ...
  u_MATLAB_Function2 : parallel_phase_voltages_per_switching_state_src_MATLAB_Function2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              theta_el_with_offset => theta_el_with_offset15,  -- single
  ...
  u_MATLAB_Function1 : parallel_phase_voltages_per_switching_state_src_MATLAB_Function1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              theta_el_with_offset => theta_el_with_offset15,  -- single
  ...
  u_MATLAB_Function : parallel_phase_voltages_per_switching_state_src_MATLAB_Function
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              theta_el_with_offset => theta_el_with_offset15,  -- single
