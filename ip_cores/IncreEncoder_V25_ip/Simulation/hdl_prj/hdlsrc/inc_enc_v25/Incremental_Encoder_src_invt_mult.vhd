-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\inc_enc_v25\Incremental_Encoder_src_invt_mult.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Incremental_Encoder_src_invt_mult
-- Source Path: inc_enc_v25/IncEnc_V25/speed/calc_omega/invt_mult
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Incremental_Encoder_src_invt_mult IS
...
END Incremental_Encoder_src_invt_mult;


ARCHITECTURE rtl OF Incremental_Encoder_src_invt_mult IS

  -- Component Declarations
  COMPONENT Incremental_Encoder_src_HDL_Reciprocal
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Incremental_Encoder_src_HDL_Reciprocal
    USE ENTITY work.Incremental_Encoder_src_HDL_Reciprocal(rtl);
  ...
  SIGNAL rd_2_reg                         : vector_of_unsigned6(0 TO 7);  -- ufix6 [8]
...
BEGIN
  ...
  u_HDL_Reciprocal : Incremental_Encoder_src_HDL_Reciprocal
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        rd_2_reg(1 TO 7) <= rd_2_reg(0 TO 6);
      END IF;
    END IF;
  END PROCESS rd_2_process;

  before_invert_2 <= rd_2_reg(7);
