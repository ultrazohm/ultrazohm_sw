...
extern float observation_ip_7n[7];
...
int JavaScope_initalize(DS_Data* data)
{
	...
	js_ch_observable[JSO_obs_1]			= &observation_ip_7n[0];
	js_ch_observable[JSO_obs_2]			= &observation_ip_7n[1];
	js_ch_observable[JSO_obs_3]			= &observation_ip_7n[2];
	js_ch_observable[JSO_obs_4]			= &observation_ip_7n[3];
	js_ch_observable[JSO_obs_5]			= &observation_ip_7n[4];
	js_ch_observable[JSO_obs_6]			= &observation_ip_7n[5];
	js_ch_observable[JSO_obs_7]			= &observation_ip_7n[6];
