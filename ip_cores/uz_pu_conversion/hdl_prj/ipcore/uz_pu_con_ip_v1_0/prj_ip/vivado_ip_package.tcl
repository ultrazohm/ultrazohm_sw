...
add_files -norecurse {../hdl/vhdl/uz_pu_con_ip_src_uz_pu_conversion_tc.vhd}
...
set_property core_revision 2112392466 [ipx::current_core]
...
ipx::add_file {hdl/vhdl/uz_pu_con_ip_src_uz_pu_conversion_tc.vhd} [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/vhdl/uz_pu_con_ip_src_uz_pu_conversion_tc.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]]
ipx::add_file {hdl/vhdl/uz_pu_con_ip_src_uz_pu_conversion_tc.vhd} [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/vhdl/uz_pu_con_ip_src_uz_pu_conversion_tc.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]]
