-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_mpc_3ph\clarke_ip_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: clarke_ip_axi_lite
-- Source Path: clarke_ip/clarke_ip_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END clarke_ip_axi_lite;


ARCHITECTURE rtl OF clarke_ip_axi_lite IS

  -- Component Declarations
  COMPONENT clarke_ip_addr_decoder
  ...
  COMPONENT clarke_ip_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : clarke_ip_addr_decoder
    USE ENTITY work.clarke_ip_addr_decoder(rtl);

  FOR ALL : clarke_ip_axi_lite_module
    USE ENTITY work.clarke_ip_axi_lite_module(rtl);
...
BEGIN
  u_clarke_ip_addr_decoder_inst : clarke_ip_addr_decoder
  ...
  u_clarke_ip_axi_lite_module_inst : clarke_ip_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
