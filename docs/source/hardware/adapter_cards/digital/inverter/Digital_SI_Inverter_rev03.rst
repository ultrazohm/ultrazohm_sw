...
.. note:: The displayed measurings are made from Rev03 version, which are upgraded Rev02 Cards with fixes directly applied on the pcb. The Rev03 production version contains all these fixes on the pcb. Both PCB's have the same functionality.
...
* unused pads from Rev03 have been removed
