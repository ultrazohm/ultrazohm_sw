...
set_param(0, 'HiliteAncestorsData', cs);
hilite_system('gm_uz_pu_conversion/uz_pu_conversion/Delay100', 'user1');
annotate_port('gm_uz_pu_conversion/uz_pu_conversion/Delay100', 1, 1, 'cp : 5.674 ns');
cs.HiliteType = 'user1';
cs.ForegroundColor = 'black';
cs.BackgroundColor = 'blue';
set_param(0, 'HiliteAncestorsData', cs);
...
cs.BackgroundColor = 'lightblue';
set_param(0, 'HiliteAncestorsData', cs);
hilite_system('gm_uz_pu_conversion/uz_pu_conversion/Product17', 'user2');
annotate_port('gm_uz_pu_conversion/uz_pu_conversion/Product17', 0, 1, 'cp : 5.674 ns');
cs.HiliteType = 'user2';
cs.ForegroundColor = 'black';
cs.BackgroundColor = 'lightblue';
set_param(0, 'HiliteAncestorsData', cs);
hilite_system('gm_uz_pu_conversion/uz_pu_conversion/Switch17', 'user2');
annotate_port('gm_uz_pu_conversion/uz_pu_conversion/Switch17', 0, 1, 'cp : 1.726 ns');
cs.HiliteType = 'user2';
cs.ForegroundColor = 'black';
cs.BackgroundColor = 'lightblue';
set_param(0, 'HiliteAncestorsData', cs);
