-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\inc_enc_v25\Incremental_Encoder_src_Average.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Incremental_Encoder_src_Average
-- Source Path: inc_enc_v25/IncEnc_V25/speed/Average
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Incremental_Encoder_src_Average IS
...
END Incremental_Encoder_src_Average;


ARCHITECTURE rtl OF Incremental_Encoder_src_Average IS
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' AND enable_delayed = '1' THEN
        omega_delay1 <= x_k;
      END IF;
    END IF;
