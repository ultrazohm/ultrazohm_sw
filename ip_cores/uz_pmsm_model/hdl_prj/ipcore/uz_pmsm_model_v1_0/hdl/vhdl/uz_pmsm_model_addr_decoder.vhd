...
ARCHITECTURE rtl OF uz_pmsm_model_addr_decoder IS
  ...
  SIGNAL decode_sel_recirprocal_L_q_1_1   : std_logic;  -- ufix1
  SIGNAL reg_enb_recirprocal_L_q_1_1      : std_logic;  -- ufix1
  SIGNAL data_reg_recirprocal_L_q_1_1     : unsigned(31 DOWNTO 0);  -- ufix32
...
BEGIN
  ...
  decode_sel_omega_mech_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0051#, 14) ELSE
      '0';

  
  decode_sel_torque_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0050#, 14) ELSE
      '0';

  
  decode_sel_i_q_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#004F#, 14) ELSE
      '0';

  
  decode_sel_i_d_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#004E#, 14) ELSE
      '0';
  ...
  decode_rd_omega_mech_1_1 <= decode_rd_torque_1_1 WHEN decode_sel_omega_mech_1_1 = '0' ELSE
      read_reg_omega_mech;

  data_read <= std_logic_vector(decode_rd_omega_mech_1_1);
  ...
  decode_sel_R1_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0042#, 14) ELSE
      '0';
  ...
  decode_sel_polepairs_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0043#, 14) ELSE
      '0';
  ...
  decode_sel_psi_pm_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0044#, 14) ELSE
      '0';
  ...
  decode_sel_recirprocal_L_q_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0045#, 14) ELSE
      '0';

  reg_enb_recirprocal_L_q_1_1 <= decode_sel_recirprocal_L_q_1_1 AND wr_enb;

  reg_recirprocal_L_q_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_recirprocal_L_q_1_1 <= to_unsigned(0, 32);
      ELSIF enb = '1' AND reg_enb_recirprocal_L_q_1_1 = '1' THEN
        data_reg_recirprocal_L_q_1_1 <= data_write_unsigned;
      END IF;
    END IF;
  END PROCESS reg_recirprocal_L_q_1_1_process;


  write_recirprocal_L_q <= std_logic_vector(data_reg_recirprocal_L_q_1_1);

  
  decode_sel_reciprocal_L_d_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0046#, 14) ELSE
      '0';
  ...
  decode_sel_reset_integrators_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0047#, 14) ELSE
      '0';
  ...
  decode_sel_reciprocal_J_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#004A#, 14) ELSE
      '0';
  ...
  decode_sel_in_omega_mech_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#004B#, 14) ELSE
      '0';
  ...
  decode_sel_simulate_mechanical_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#004C#, 14) ELSE
      '0';
  ...
  decode_sel_load_torque_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#004D#, 14) ELSE
      '0';
