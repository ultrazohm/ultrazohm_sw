...
ARCHITECTURE rtl OF parallel_8_min_cost_function_src_Min_cost_function_and_vopt2 IS
  ...
  SIGNAL Delay14_out1                     : signed(19 DOWNTO 0);  -- sfix20_En11
  ...
  SIGNAL Delay79_out1                     : signed(23 DOWNTO 0);  -- sfix24_En11
  ...
  SIGNAL Delay78_out1                     : signed(23 DOWNTO 0);  -- sfix24_En11
  ...
  SIGNAL Delay77_out1                     : signed(23 DOWNTO 0);  -- sfix24_En11
  ...
  SIGNAL Delay76_out1                     : signed(23 DOWNTO 0);  -- sfix24_En11
  ...
  SIGNAL Delay13_out1                     : signed(19 DOWNTO 0);  -- sfix20_En11
  ...
  SIGNAL Delay69_out1                     : signed(23 DOWNTO 0);  -- sfix24_En11
  ...
  SIGNAL Delay68_out1                     : signed(23 DOWNTO 0);  -- sfix24_En11
  ...
  SIGNAL Delay57_out1                     : signed(23 DOWNTO 0);  -- sfix24_En11
  ...
  SIGNAL Delay56_out1                     : signed(23 DOWNTO 0);  -- sfix24_En11
  ...
  SIGNAL Delay11_out1                     : signed(19 DOWNTO 0);  -- sfix20_En11
  ...
  SIGNAL Delay10_out1                     : signed(19 DOWNTO 0);  -- sfix20_En11
  ...
  SIGNAL Delay46_out1                     : signed(23 DOWNTO 0);  -- sfix24_En11
  ...
  SIGNAL Delay9_out1                      : signed(19 DOWNTO 0);  -- sfix20_En11
  ...
  SIGNAL Delay45_out1                     : signed(23 DOWNTO 0);  -- sfix24_En11
  ...
  SIGNAL Delay44_out1                     : signed(23 DOWNTO 0);  -- sfix24_En11
  ...
  SIGNAL Delay8_out1                      : signed(19 DOWNTO 0);  -- sfix20_En11
  ...
  SIGNAL Delay30_out1                     : signed(23 DOWNTO 0);  -- sfix24_En11
  ...
  SIGNAL Delay29_out1                     : signed(23 DOWNTO 0);  -- sfix24_En11
  ...
  SIGNAL Delay7_out1                      : signed(19 DOWNTO 0);  -- sfix20_En11
  ...
  SIGNAL Delay16_out1                     : signed(23 DOWNTO 0);  -- sfix24_En11
  ...
  SIGNAL Delay97_out1                     : signed(19 DOWNTO 0);  -- sfix20_En11
  SIGNAL Index_signed                     : signed(31 DOWNTO 0);  -- int32
  SIGNAL Delay93_out1                     : signed(31 DOWNTO 0);  -- int32
  SIGNAL voltages_signed                  : vector_of_signed24(0 TO 3);  -- sfix24_En11 [4]
  SIGNAL Delay92_out1                     : vector_of_signed24(0 TO 3);  -- sfix24_En11 [4]
  SIGNAL Delay94_out1                     : signed(31 DOWNTO 0);  -- int32
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay91_out1 <= '0';
      ELSIF enb = '1' THEN
        Delay91_out1 <= Logical_Operator_out1;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay79_out1 <= to_signed(16#000000#, 24);
      ELSIF enb = '1' THEN
        Delay79_out1 <= End_Cycle_4;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay78_out1 <= to_signed(16#000000#, 24);
      ELSIF enb = '1' THEN
        Delay78_out1 <= End_Cycle_5;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay77_out1 <= to_signed(16#000000#, 24);
      ELSIF enb = '1' THEN
        Delay77_out1 <= End_Cycle_6;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay76_out1 <= to_signed(16#000000#, 24);
      ELSIF enb = '1' THEN
        Delay76_out1 <= End_Cycle_7;
      END IF;
    END IF;
  ...
  Add_out1 <= resize(Delay15_out1, 33) + resize(Constant18_out1, 33);
  ...
  Add1_out1 <= resize(Delay15_out1, 33) + resize(Constant19_out1, 33);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay69_out1 <= to_signed(16#000000#, 24);
      ELSIF enb = '1' THEN
        Delay69_out1 <= End_Cycle_14;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay68_out1 <= to_signed(16#000000#, 24);
      ELSIF enb = '1' THEN
        Delay68_out1 <= End_Cycle_15;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay57_out1 <= to_signed(16#000000#, 24);
      ELSIF enb = '1' THEN
        Delay57_out1 <= End_Cycle_16;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay11_out1 <= to_signed(16#00000#, 20);
      ELSIF enb = '1' THEN
        Delay11_out1 <= End_Cycle_18;
      END IF;
    END IF;
  ...
  Add2_out1 <= resize(Delay15_out1, 33) + resize(Constant20_out1, 33);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay10_out1 <= to_signed(16#00000#, 20);
      ELSIF enb = '1' THEN
        Delay10_out1 <= End_Cycle_23;
      END IF;
    END IF;
  ...
  Add3_out1 <= resize(Delay15_out1, 33) + resize(Constant21_out1, 33);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay46_out1 <= to_signed(16#000000#, 24);
      ELSIF enb = '1' THEN
        Delay46_out1 <= End_Cycle_27;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay9_out1 <= to_signed(16#00000#, 20);
      ELSIF enb = '1' THEN
        Delay9_out1 <= End_Cycle_28;
      END IF;
    END IF;
  ...
  Add4_out1 <= resize(Delay15_out1, 33) + resize(Constant22_out1, 33);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay45_out1 <= to_signed(16#000000#, 24);
      ELSIF enb = '1' THEN
        Delay45_out1 <= End_Cycle_29;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay44_out1 <= to_signed(16#000000#, 24);
      ELSIF enb = '1' THEN
        Delay44_out1 <= End_Cycle_30;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay8_out1 <= to_signed(16#00000#, 20);
      ELSIF enb = '1' THEN
        Delay8_out1 <= End_Cycle_33;
      END IF;
    END IF;
  ...
  Add5_out1 <= resize(Delay15_out1, 33) + resize(Constant23_out1, 33);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay30_out1 <= to_signed(16#000000#, 24);
      ELSIF enb = '1' THEN
        Delay30_out1 <= End_Cycle_35;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay29_out1 <= to_signed(16#000000#, 24);
      ELSIF enb = '1' THEN
        Delay29_out1 <= End_Cycle_36;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay7_out1 <= to_signed(16#00000#, 20);
      ELSIF enb = '1' THEN
        Delay7_out1 <= End_Cycle_38;
      END IF;
    END IF;
  ...
  Add6_out1 <= resize(Delay15_out1, 33) + resize(Constant24_out1, 33);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay23_out1 <= to_signed(16#000000#, 24);
      ELSIF enb = '1' THEN
        Delay23_out1 <= End_Cycle_41;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay16_out1 <= to_signed(16#000000#, 24);
      ELSIF enb = '1' THEN
        Delay16_out1 <= End_Cycle_42;
      END IF;
    END IF;
  ...
  switch_compare_1_105 <= '1' WHEN End_Cycle_43 = '1' ELSE
      '0';
  ...
  switch_compare_1_106 <= '1' WHEN End_Cycle_43 = '1' ELSE
      '0';
  ...
  switch_compare_1_107 <= '1' WHEN End_Cycle_43 = '1' ELSE
      '0';
  ...
  switch_compare_1_108 <= '1' WHEN End_Cycle_43 = '1' ELSE
      '0';
  ...
  switch_compare_1_109 <= '1' WHEN End_Cycle_43 = '1' ELSE
      '0';
  ...
  switch_compare_1_110 <= '1' WHEN End_Cycle_43 = '1' ELSE
      '0';
  ...
  switch_compare_1_111 <= '1' WHEN End_Cycle_43 = '1' ELSE
      '0';
  ...
  switch_compare_1_112 <= '1' WHEN End_Cycle_43 = '1' ELSE
      '0';
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay97_out1 <= to_signed(16#00000#, 20);
      ELSIF enb = '1' THEN
        Delay97_out1 <= J_signed;
      END IF;
    END IF;
  END PROCESS Delay97_process;


  J_AXI <= std_logic_vector(Delay97_out1);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay93_out1 <= to_signed(0, 32);
      ELSIF enb = '1' THEN
        Delay93_out1 <= Index_signed;
      END IF;
    END IF;
  END PROCESS Delay93_process;


  Index <= std_logic_vector(Delay93_out1);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay92_out1 <= (OTHERS => to_signed(16#000000#, 24));
      ELSIF enb = '1' THEN
        Delay92_out1 <= voltages_signed;
      END IF;
    END IF;
  END PROCESS Delay92_process;


  voltages_0 <= std_logic_vector(Delay92_out1(0));

  voltages_1 <= std_logic_vector(Delay92_out1(1));

  voltages_2 <= std_logic_vector(Delay92_out1(2));

  voltages_3 <= std_logic_vector(Delay92_out1(3));

  Delay94_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay94_out1 <= to_signed(0, 32);
      ELSIF enb = '1' THEN
        Delay94_out1 <= Index_signed;
      END IF;
    END IF;
  END PROCESS Delay94_process;


  Index_AXI <= std_logic_vector(Delay94_out1);

  ce_out <= clk_enable;

  done <= Delay80_out1;

  done_complete <= Delay91_out1;
