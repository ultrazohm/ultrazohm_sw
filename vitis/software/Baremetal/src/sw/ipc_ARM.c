...
void ipc_Control_func(uint32_t msgId, float value, DS_Data *data)
{
	...
	if (msgId != 0)
	{
		...
		case (Set_Send_Field_4):
			data->av.i_X_ref = value;
			break;

		case (Set_Send_Field_5):
			data->av.i_Y_ref = value;
			break;
		...
		case (My_Button_1):
			data->av.select_Real = false;
			data->av.select_CIL = true;
			break;

		case (My_Button_2):
			data->av.select_Real = true;
			data->av.select_CIL = false;
			break;

		case (My_Button_3):
			data->av.select_CurrentControl = true;
			break;

		case (My_Button_4):
			data->av.select_CurrentControl = false;
			break;
	...
	/* Bit 6 - My_Button_3 */
	if (data->av.select_CurrentControl == true) {
