...
struct uz_abc_9ph_t ninephase_abc = {0};
struct uz_alphabeta_9ph_t ninephase_alphabeta = {0};
struct uz_alphabeta_t alphabeta_multiphase_test = {0};
struct uz_dq_t dq_multiphase_test = {0};
...
void test_uz_9ph_clarke_transformation_output(void){
    ...
    struct uz_alphabeta_9ph_t output = uz_9ph_clarke_transformation(ninephase_abc);
...
void test_uz_9ph_clarke_inverse_transformation_output(void){
    ...
    struct uz_abc_9ph_t output = uz_9ph_clarke_inverse_transformation(ninephase_alphabeta);
...
void test_uz_ab_to_dq_transformation_output_positive_theta(void){
    ...
    struct uz_dq_t output = uz_ab_to_dq_transformation(alphabeta_multiphase_test, theta_el_rad);
...
void test_uz_dq_to_ab_inverse_transformation_positive_theta(void){
    ...
    float theta_el_rad = UZ_PIf / 8.0f;
    struct uz_alphabeta_t output = uz_dq_to_ab_inverse_transformation(dq_multiphase_test, theta_el_rad);
