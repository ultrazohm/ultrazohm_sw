...
typedef struct {
  ...
  real32_T PI_d_loc_c;            /* '<S1>/AMMstate.IdentificationDQ.Fluxmap' */
  real32_T PI_q_loc_p;            /* '<S1>/AMMstate.IdentificationDQ.Fluxmap' */
...
typedef struct {
  ...
  uz_3ph_dq_t actual_currents_f;       /* '<Root>/FluxMapID_6ph_codegen' */
  uz_3ph_dq_t actual_voltages_m;       /* '<Root>/FluxMapID_6ph_codegen' */
  uz_3ph_dq_t actual_currents_l;       /* '<Root>/FluxMapID_6ph_codegen' */
  ...
  uz_3ph_dq_t mean_voltages_h;    /* '<S1>/AMMstate.IdentificationXY.Fluxmap' */
  uz_3ph_dq_t mean_currents_a;    /* '<S1>/AMMstate.IdentificationXY.Fluxmap' */
  uz_3ph_dq_t mean_voltages_l;    /* '<S1>/AMMstate.IdentificationDQ.Fluxmap' */
  ...
  real32_T omega_el_e;                 /* '<Root>/FluxMapID_6ph_codegen' */
  ...
  real32_T PI_d_ref_e;            /* '<S1>/AMMstate.IdentificationXY.Fluxmap' */
  real32_T PI_q_ref_l;            /* '<S1>/AMMstate.IdentificationXY.Fluxmap' */
  real32_T mean_omega_el_j;       /* '<S1>/AMMstate.IdentificationXY.Fluxmap' */
  real32_T PI_d_ref_i;            /* '<S1>/AMMstate.IdentificationDQ.Fluxmap' */
  real32_T PI_q_ref_i;            /* '<S1>/AMMstate.IdentificationDQ.Fluxmap' */
  real32_T mean_omega_el_m;       /* '<S1>/AMMstate.IdentificationDQ.Fluxmap' */
  ...
  uint32_T three_sec_transition_counter_a;/* '<Root>/FluxMapID_6ph_codegen' */
  uint32_T repetitionCounter;   /* '<S1>/AMMstate.IdentificationZero.Fluxmap' */
  uint32_T repetitionCounter_a;   /* '<S1>/AMMstate.IdentificationXY.Fluxmap' */
  uint32_T repetitionCounter_n;   /* '<S1>/AMMstate.IdentificationDQ.Fluxmap' */
  ...
  uint16_T activeState_i;         /* '<S1>/AMMstate.IdentificationXY.Fluxmap' */
  uint16_T activeState_c;         /* '<S1>/AMMstate.IdentificationDQ.Fluxmap' */
 ...
 *
 * hilite_system('uz_6ph_ParameterID/Subsystem Reference1/FluxMapID_6ph_codegen')    - opens subsystem uz_6ph_ParameterID/Subsystem Reference1/FluxMapID_6ph_codegen
 * hilite_system('uz_6ph_ParameterID/Subsystem Reference1/FluxMapID_6ph_codegen/Kp') - opens and selects block Kp
 *
 * Here is the system hierarchy for this model
 *
 * '<Root>' : 'uz_6ph_ParameterID/Subsystem Reference1'
 * '<S1>'   : 'uz_6ph_ParameterID/Subsystem Reference1/FluxMapID_6ph_codegen'
 * '<S2>'   : 'uz_6ph_ParameterID/Subsystem Reference1/FluxMapID_6ph_codegen/AMMstate.IdentificationDQ.Fluxmap'
 * '<S3>'   : 'uz_6ph_ParameterID/Subsystem Reference1/FluxMapID_6ph_codegen/AMMstate.IdentificationXY.Fluxmap'
 * '<S4>'   : 'uz_6ph_ParameterID/Subsystem Reference1/FluxMapID_6ph_codegen/AMMstate.IdentificationZero.Fluxmap'
 */
