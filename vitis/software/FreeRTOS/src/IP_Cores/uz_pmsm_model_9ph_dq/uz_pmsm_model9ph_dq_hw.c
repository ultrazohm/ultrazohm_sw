...
#pragma GCC diagnostic ignored "-Wint-to-pointer-cast" // base address is uint32_t, axi_x_input is unsigned int, void is 4 or 8 byte depending if the code runs in the test environment or UZ - thus suppress this warning
    memcpy((void *)(base_address + voltage_input_dq_axi_Data_uz_pmsm_model_9ph_dq), &phase_voltage, sizeof(struct uz_9ph_dq_t));
...
void uz_pmsm_model9ph_hw_write_u_d(uint32_t base_address, float voltage){
    uz_assert_not_zero(base_address);
    uz_axi_write_float(base_address + voltage_input_dq_axi_Data_uz_pmsm_model_9ph_dq+0x00, voltage);
}
void uz_pmsm_model9ph_hw_write_u_q(uint32_t base_address, float voltage){
    uz_assert_not_zero(base_address);
    uz_axi_write_float(base_address + voltage_input_dq_axi_Data_uz_pmsm_model_9ph_dq+0x04, voltage);
}
void uz_pmsm_model9ph_hw_write_u_x1(uint32_t base_address, float voltage){
    uz_assert_not_zero(base_address);
    uz_axi_write_float(base_address + voltage_input_dq_axi_Data_uz_pmsm_model_9ph_dq+0x08, voltage);
}
void uz_pmsm_model9ph_hw_write_u_y1(uint32_t base_address, float voltage){
    uz_assert_not_zero(base_address);
    uz_axi_write_float(base_address + voltage_input_dq_axi_Data_uz_pmsm_model_9ph_dq+0x0C, voltage);
}
void uz_pmsm_model9ph_hw_write_u_x2(uint32_t base_address, float voltage){
    uz_assert_not_zero(base_address);
    uz_axi_write_float(base_address + voltage_input_dq_axi_Data_uz_pmsm_model_9ph_dq+0x10, voltage);
}
void uz_pmsm_model9ph_hw_write_u_y2(uint32_t base_address, float voltage){
    uz_assert_not_zero(base_address);
    uz_axi_write_float(base_address + voltage_input_dq_axi_Data_uz_pmsm_model_9ph_dq+0x14, voltage);
}
void uz_pmsm_model9ph_hw_write_u_x3(uint32_t base_address, float voltage){
    uz_assert_not_zero(base_address);
    uz_axi_write_float(base_address + voltage_input_dq_axi_Data_uz_pmsm_model_9ph_dq+0x18, voltage);
}
void uz_pmsm_model9ph_hw_write_u_y3(uint32_t base_address, float voltage){
    uz_assert_not_zero(base_address);
    uz_axi_write_float(base_address + voltage_input_dq_axi_Data_uz_pmsm_model_9ph_dq+0x1C, voltage);
}
void uz_pmsm_model9ph_hw_write_u_zero(uint32_t base_address, float voltage){
    uz_assert_not_zero(base_address);
    uz_axi_write_float(base_address + voltage_input_dq_axi_Data_uz_pmsm_model_9ph_dq+0x20, voltage);
}
...
#pragma GCC diagnostic push                            // http://gcc.gnu.org/onlinedocs/gcc/Diagnostic-Pragmas.html
#pragma GCC diagnostic ignored "-Wint-to-pointer-cast" // base address is uint32_t, axi_x_input is unsigned int, void is 4 or 8 byte depending if the code runs in the test environment or UZ - thus suppress this warning
    memcpy(&readout, (void *)(base_address + voltage_input_dq_out_axi_fb_Data_uz_pmsm_model_9ph_dq), sizeof(struct uz_9ph_dq_t));
#pragma GCC diagnostic pop
...
float uz_pmsm_model9ph_hw_read_u_d(uint32_t base_address){
    uz_assert_not_zero(base_address);
    return uz_axi_read_float(base_address + voltage_input_dq_out_axi_fb_Data_uz_pmsm_model_9ph_dq+0x00);
}
float uz_pmsm_model9ph_hw_read_u_q(uint32_t base_address){
    uz_assert_not_zero(base_address);
    return uz_axi_read_float(base_address + voltage_input_dq_out_axi_fb_Data_uz_pmsm_model_9ph_dq+0x04);
}
float uz_pmsm_model9ph_hw_read_u_x1(uint32_t base_address){
    uz_assert_not_zero(base_address);
    return uz_axi_read_float(base_address + voltage_input_dq_out_axi_fb_Data_uz_pmsm_model_9ph_dq+0x08);
}
float uz_pmsm_model9ph_hw_read_u_y1(uint32_t base_address){
    uz_assert_not_zero(base_address);
    return uz_axi_read_float(base_address + voltage_input_dq_out_axi_fb_Data_uz_pmsm_model_9ph_dq+0x0C);
}
float uz_pmsm_model9ph_hw_read_u_x2(uint32_t base_address){
    uz_assert_not_zero(base_address);
    return uz_axi_read_float(base_address + voltage_input_dq_out_axi_fb_Data_uz_pmsm_model_9ph_dq+0x10);
}
float uz_pmsm_model9ph_hw_read_u_y2(uint32_t base_address){
    uz_assert_not_zero(base_address);
    return uz_axi_read_float(base_address + voltage_input_dq_out_axi_fb_Data_uz_pmsm_model_9ph_dq+0x14);
}
float uz_pmsm_model9ph_hw_read_u_x3(uint32_t base_address){
    uz_assert_not_zero(base_address);
    return uz_axi_read_float(base_address + voltage_input_dq_out_axi_fb_Data_uz_pmsm_model_9ph_dq+0x18);
}
float uz_pmsm_model9ph_hw_read_u_y3(uint32_t base_address){
    uz_assert_not_zero(base_address);
    return uz_axi_read_float(base_address + voltage_input_dq_out_axi_fb_Data_uz_pmsm_model_9ph_dq+0x1C);
}
float uz_pmsm_model9ph_hw_read_u_zero(uint32_t base_address){
    uz_assert_not_zero(base_address);
    return uz_axi_read_float(base_address + voltage_input_dq_out_axi_fb_Data_uz_pmsm_model_9ph_dq+0x20);
}
...
#pragma GCC diagnostic push                            // http://gcc.gnu.org/onlinedocs/gcc/Diagnostic-Pragmas.html
#pragma GCC diagnostic ignored "-Wint-to-pointer-cast" // base address is uint32_t, axi_x_input is unsigned int, void is 4 or 8 byte depending if the code runs in the test environment or UZ - thus suppress this warning
    memcpy(&readout, (void *)(base_address + currents_dq_out_axi_Data_uz_pmsm_model_9ph_dq), sizeof(struct uz_9ph_dq_t));
#pragma GCC diagnostic pop
...
float uz_pmsm_model9ph_hw_read_i_d(uint32_t base_address){
    uz_assert_not_zero(base_address);
    return uz_axi_read_float(base_address + currents_dq_out_axi_Data_uz_pmsm_model_9ph_dq+0x00);
}
float uz_pmsm_model9ph_hw_read_i_q(uint32_t base_address){
    uz_assert_not_zero(base_address);
    return uz_axi_read_float(base_address + currents_dq_out_axi_Data_uz_pmsm_model_9ph_dq+0x04);
}
float uz_pmsm_model9ph_hw_read_i_x1(uint32_t base_address){
    uz_assert_not_zero(base_address);
    return uz_axi_read_float(base_address + currents_dq_out_axi_Data_uz_pmsm_model_9ph_dq+0x08);
}
float uz_pmsm_model9ph_hw_read_i_y1(uint32_t base_address){
    uz_assert_not_zero(base_address);
    return uz_axi_read_float(base_address + currents_dq_out_axi_Data_uz_pmsm_model_9ph_dq+0x0C);
}
float uz_pmsm_model9ph_hw_read_i_x2(uint32_t base_address){
    uz_assert_not_zero(base_address);
    return uz_axi_read_float(base_address + currents_dq_out_axi_Data_uz_pmsm_model_9ph_dq+0x10);
}
float uz_pmsm_model9ph_hw_read_i_y2(uint32_t base_address){
    uz_assert_not_zero(base_address);
    return uz_axi_read_float(base_address + currents_dq_out_axi_Data_uz_pmsm_model_9ph_dq+0x14);
}
float uz_pmsm_model9ph_hw_read_i_x3(uint32_t base_address){
    uz_assert_not_zero(base_address);
    return uz_axi_read_float(base_address + currents_dq_out_axi_Data_uz_pmsm_model_9ph_dq+0x18);
}
float uz_pmsm_model9ph_hw_read_i_y3(uint32_t base_address){
    uz_assert_not_zero(base_address);
    return uz_axi_read_float(base_address + currents_dq_out_axi_Data_uz_pmsm_model_9ph_dq+0x1C);
}
float uz_pmsm_model9ph_hw_read_i_zero(uint32_t base_address){
    uz_assert_not_zero(base_address);
    return uz_axi_read_float(base_address + currents_dq_out_axi_Data_uz_pmsm_model_9ph_dq+0x20);
}
...
void uz_pmsm_model9ph_hw_write_L_d(uint32_t base_address, float inductance){
    ...
    uz_axi_write_float(base_address + physical_parameters_1_L_d_Data_uz_pmsm_model_9ph_dq, (1.0f / inductance));
}
