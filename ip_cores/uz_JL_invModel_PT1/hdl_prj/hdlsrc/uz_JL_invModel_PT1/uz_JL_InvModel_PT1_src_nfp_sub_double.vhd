-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\jonat\Documents\MA_JL_CIL\ip_cores\uz_JL_invModel_PT1\hdl_prj\hdlsrc\uz_JL_invModel_PT1\uz_JL_InvModel_PT1_src_nfp_sub_double.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_JL_InvModel_PT1_src_nfp_sub_double
-- Source Path: uz_JL_invModel_PT1/HDL_DUT/nfp_sub_double
-- Hierarchy Level: 1
-- Model version: 1.36
-- 
...
ENTITY uz_JL_InvModel_PT1_src_nfp_sub_double IS
...
END uz_JL_InvModel_PT1_src_nfp_sub_double;


ARCHITECTURE rtl OF uz_JL_InvModel_PT1_src_nfp_sub_double IS
...
BEGIN
  ...
  Delay_PS_2_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay_PS_2_out1 <= '0';
  ...
  Delay8_PS_8_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
  ...
  Delay3_PS_2_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay3_PS_2_out1 <= '0';
  ...
  Delay7_PS_8_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
  ...
  Delay6_PS_8_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
  ...
  Delay6_PS_6_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay6_PS_6_out1 <= '0';
  ...
  Delay5_PS_8_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
