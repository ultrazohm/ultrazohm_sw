...
void uz_mlp_three_layer_hw_write_input(uint32_t base_address, uz_matrix_t* input_data)
{
    ...
    struct uz_fixedpoint_definition_t fixedpoint_definition = {
        ...
        .fractional_bits = 14,
        .integer_bits = 18};
    for (uint32_t i = 0; i < input_data->length_of_data; i++)
    {
...
void uz_mlp_three_layer_hw_write_input_unsafe(uint32_t base_address, uz_matrix_t* input_data)
{
    ...
    if (input_data->length_of_data < 9)
    {
...
{
    uz_assert_not_zero_uint32(base_address);
    bool correct_outputs = (output_data->length_of_data == 2) || (output_data->length_of_data == 4) || (output_data->length_of_data == 6) || (output_data->length_of_data == 8);
    uz_assert(correct_outputs);
    struct uz_fixedpoint_definition_t fixedpoint_definition = {
        .is_signed = true,
        .fractional_bits = 14,
