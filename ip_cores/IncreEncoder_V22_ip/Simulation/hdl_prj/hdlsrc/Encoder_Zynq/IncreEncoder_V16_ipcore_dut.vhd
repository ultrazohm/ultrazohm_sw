-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Encoder_Zynq\IncreEncoder_V16_ipcore_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IncreEncoder_V16_ipcore_dut
-- Source Path: IncreEncoder_V16_ipcore/IncreEncoder_V16_ipcore_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY IncreEncoder_V16_ipcore_dut IS
...
END IncreEncoder_V16_ipcore_dut;


ARCHITECTURE rtl OF IncreEncoder_V16_ipcore_dut IS

  -- Component Declarations
  COMPONENT IncreEncoder_V16_ipcore_src_IncreEncoder_V16
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : IncreEncoder_V16_ipcore_src_IncreEncoder_V16
    USE ENTITY work.IncreEncoder_V16_ipcore_src_IncreEncoder_V16(rtl);
...
BEGIN
  u_IncreEncoder_V16_ipcore_src_IncreEncoder_V16 : IncreEncoder_V16_ipcore_src_IncreEncoder_V16
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
              A => A_sig,  -- ufix1
