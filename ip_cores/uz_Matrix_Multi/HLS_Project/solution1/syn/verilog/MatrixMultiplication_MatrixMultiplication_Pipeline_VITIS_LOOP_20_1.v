...
module MatrixMultiplication_MatrixMultiplication_Pipeline_VITIS_LOOP_20_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] icmp_ln20_reg_142;
reg    ap_block_state2_pp0_stage0_iter1;
wire    ap_block_state3_pp0_stage0_iter2;
reg    ap_block_pp0_stage0_subdone;
wire   [0:0] icmp_ln20_fu_94_p2;
...
reg   [2:0] i_2_reg_137;
reg   [2:0] i_2_reg_137_pp0_iter1_reg;
reg   [31:0] arrays_addr_read_reg_146;
reg    ap_condition_exit_pp0_iter1_stage0;
wire   [63:0] i_cast_fu_117_p1;
reg   [2:0] i_fu_54;
wire   [2:0] add_ln20_fu_100_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln20_fu_94_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln20_reg_142 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln20_fu_94_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln20_reg_142 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (icmp_ln20_reg_142 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln20_reg_142 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign A_address0 = i_cast_fu_117_p1;

assign A_d0 = arrays_addr_read_reg_146;

assign add_ln20_fu_100_p2 = (ap_sig_allocacmp_i_2 + 3'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((icmp_ln20_reg_142 == 1'd0) & (m_axi_arrays_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((icmp_ln20_reg_142 == 1'd0) & (m_axi_arrays_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((icmp_ln20_reg_142 == 1'd0) & (m_axi_arrays_RVALID == 1'b0));
end
...
assign i_cast_fu_117_p1 = i_2_reg_137_pp0_iter1_reg;

assign icmp_ln20_fu_94_p2 = ((ap_sig_allocacmp_i_2 == 3'd5) ? 1'b1 : 1'b0);
...
endmodule //MatrixMultiplication_MatrixMultiplication_Pipeline_VITIS_LOOP_20_1
