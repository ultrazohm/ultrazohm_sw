-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_mpc_6ph\cost_opt_src_cost_opt.vhd
...
-- Source Path: uz_mpc_6ph/cost_opt
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF cost_opt_src_cost_opt IS
  ...
  SIGNAL c209_G                           : std_logic_vector(0 TO 767);  -- boolean [768]
...
BEGIN
  ...
  BEGIN
    ...
    G_1(8, 10) <= c209_G(648);
    G_1(9, 10) <= c209_G(649);
    G_1(10, 10) <= c209_G(650);
    G_1(11, 10) <= c209_G(651);
    G_1(12, 10) <= c209_G(652);
    G_1(13, 10) <= c209_G(653);
    G_1(14, 10) <= c209_G(654);
    G_1(15, 10) <= c209_G(655);
    G_1(16, 10) <= c209_G(656);
    G_1(17, 10) <= c209_G(657);
    G_1(18, 10) <= c209_G(658);
    G_1(19, 10) <= c209_G(659);
    G_1(20, 10) <= c209_G(660);
    G_1(21, 10) <= c209_G(661);
    G_1(22, 10) <= c209_G(662);
    G_1(23, 10) <= c209_G(663);
    G_1(24, 10) <= c209_G(664);
    G_1(25, 10) <= c209_G(665);
    G_1(26, 10) <= c209_G(666);
    G_1(27, 10) <= c209_G(667);
    G_1(28, 10) <= c209_G(668);
    G_1(29, 10) <= c209_G(669);
    G_1(30, 10) <= c209_G(670);
    G_1(31, 10) <= c209_G(671);
    G_1(32, 10) <= c209_G(672);
    G_1(33, 10) <= c209_G(673);
    G_1(34, 10) <= c209_G(674);
    G_1(35, 10) <= c209_G(675);
    G_1(36, 10) <= c209_G(676);
    G_1(37, 10) <= c209_G(677);
    G_1(38, 10) <= c209_G(678);
    G_1(39, 10) <= c209_G(679);
    G_1(40, 10) <= c209_G(680);
    G_1(41, 10) <= c209_G(681);
    G_1(42, 10) <= c209_G(682);
    G_1(43, 10) <= c209_G(683);
    G_1(44, 10) <= c209_G(684);
    G_1(45, 10) <= c209_G(685);
    G_1(46, 10) <= c209_G(686);
    G_1(47, 10) <= c209_G(687);
    G_1(48, 10) <= c209_G(688);
    G_1(49, 10) <= c209_G(689);
    G_1(50, 10) <= c209_G(690);
    G_1(51, 10) <= c209_G(691);
    G_1(52, 10) <= c209_G(692);
    G_1(53, 10) <= c209_G(693);
    G_1(54, 10) <= c209_G(694);
    G_1(55, 10) <= c209_G(695);
    G_1(56, 10) <= c209_G(696);
    G_1(57, 10) <= c209_G(697);
    G_1(58, 10) <= c209_G(698);
    G_1(59, 10) <= c209_G(699);
    G_1(60, 10) <= c209_G(700);
    G_1(61, 10) <= c209_G(701);
    G_1(62, 10) <= c209_G(702);
    G_1(63, 10) <= c209_G(703);
    G_1(0, 11) <= c209_G(704);
    G_1(1, 11) <= c209_G(705);
    G_1(2, 11) <= c209_G(706);
    G_1(3, 11) <= c209_G(707);
    ...
    G_1(8, 11) <= c209_G(712);
    G_1(9, 11) <= c209_G(713);
    G_1(10, 11) <= c209_G(714);
    G_1(11, 11) <= c209_G(715);
    G_1(12, 11) <= c209_G(716);
    G_1(13, 11) <= c209_G(717);
    G_1(14, 11) <= c209_G(718);
    G_1(15, 11) <= c209_G(719);
    G_1(16, 11) <= c209_G(720);
    G_1(17, 11) <= c209_G(721);
    G_1(18, 11) <= c209_G(722);
    G_1(19, 11) <= c209_G(723);
    G_1(20, 11) <= c209_G(724);
    G_1(21, 11) <= c209_G(725);
    G_1(22, 11) <= c209_G(726);
    G_1(23, 11) <= c209_G(727);
    G_1(24, 11) <= c209_G(728);
    G_1(25, 11) <= c209_G(729);
    G_1(26, 11) <= c209_G(730);
    G_1(27, 11) <= c209_G(731);
    G_1(28, 11) <= c209_G(732);
    G_1(29, 11) <= c209_G(733);
    G_1(30, 11) <= c209_G(734);
    G_1(31, 11) <= c209_G(735);
    G_1(32, 11) <= c209_G(736);
    G_1(33, 11) <= c209_G(737);
    G_1(34, 11) <= c209_G(738);
    G_1(35, 11) <= c209_G(739);
    G_1(36, 11) <= c209_G(740);
    G_1(37, 11) <= c209_G(741);
    G_1(38, 11) <= c209_G(742);
    G_1(39, 11) <= c209_G(743);
    G_1(40, 11) <= c209_G(744);
    G_1(41, 11) <= c209_G(745);
    G_1(42, 11) <= c209_G(746);
    G_1(43, 11) <= c209_G(747);
    G_1(44, 11) <= c209_G(748);
    G_1(45, 11) <= c209_G(749);
    G_1(46, 11) <= c209_G(750);
    G_1(47, 11) <= c209_G(751);
    G_1(48, 11) <= c209_G(752);
    G_1(49, 11) <= c209_G(753);
    G_1(50, 11) <= c209_G(754);
    G_1(51, 11) <= c209_G(755);
    G_1(52, 11) <= c209_G(756);
    G_1(53, 11) <= c209_G(757);
    G_1(54, 11) <= c209_G(758);
    G_1(55, 11) <= c209_G(759);
    G_1(56, 11) <= c209_G(760);
    G_1(57, 11) <= c209_G(761);
    G_1(58, 11) <= c209_G(762);
    G_1(59, 11) <= c209_G(763);
    G_1(60, 11) <= c209_G(764);
    G_1(61, 11) <= c209_G(765);
    G_1(62, 11) <= c209_G(766);
    G_1(63, 11) <= c209_G(767);
