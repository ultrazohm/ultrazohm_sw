-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\jonat\Documents\MA_JL_CIL\ip_cores\uz_JL_invModel_ideal\hdl_prj\hdlsrc\gmStateSpaceHDL_uz_JL_invModel_ideal\uz_JL_invModel_ideal_src_nfp_convert_double2single.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_JL_invModel_ideal_src_nfp_convert_double2single
-- Source Path: gmStateSpaceHDL_uz_JL_invModel_ideal/uz_JL_invModel_ideal/nfp_convert_double2single
-- Hierarchy Level: 1
-- Model version: 1.39
-- 
...
ENTITY uz_JL_invModel_ideal_src_nfp_convert_double2single IS
...
END uz_JL_invModel_ideal_src_nfp_convert_double2single;


ARCHITECTURE rtl OF uz_JL_invModel_ideal_src_nfp_convert_double2single IS
  ...
  SIGNAL Delay32_PS_2_5_reg               : std_logic_vector(2 DOWNTO 0);  -- ufix1 [3]
  ...
  SIGNAL Delay33_PS_2_5_reg               : std_logic_vector(1 DOWNTO 0);  -- ufix1 [2]
  ...
  SIGNAL Delay23_PS_5_reg                 : std_logic_vector(1 DOWNTO 0);  -- ufix1 [2]
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        Delay32_PS_2_5_reg(2 DOWNTO 1) <= Delay32_PS_2_5_reg(1 DOWNTO 0);
      END IF;
    END IF;
  END PROCESS Delay32_PS_2_5_process;

  Delay32_PS_2_5_out1 <= Delay32_PS_2_5_reg(2);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        Delay33_PS_2_5_reg(1) <= Delay33_PS_2_5_reg(0);
      END IF;
    END IF;
  END PROCESS Delay33_PS_2_5_process;

  Delay33_PS_2_5_out1 <= Delay33_PS_2_5_reg(1);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        Delay23_PS_5_reg(1) <= Delay23_PS_5_reg(0);
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay18_PS_5_out1 <= '0';
      ELSIF enb = '1' THEN
        Delay18_PS_5_out1 <= e_int32_255_out1;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay17_PS_5_out1 <= '0';
      ELSIF enb = '1' THEN
        Delay17_PS_5_out1 <= e_cfType_MantissaLength_out1;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay20_PS_5_out1 <= to_unsigned(16#00#, 8);
      ELSIF enb = '1' THEN
        Delay20_PS_5_out1 <= if_e_0_Exponent_out1;
      END IF;
    END IF;
  ...
  nfp_out_pack <= Switch1_out1 & Switch5_out1_1 & Switch6_out1_2;
