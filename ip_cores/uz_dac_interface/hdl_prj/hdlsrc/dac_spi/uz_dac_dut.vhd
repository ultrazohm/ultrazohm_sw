-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/dac_spi/uz_dac_dut.vhd
...
ARCHITECTURE rtl OF uz_dac_dut IS

  -- Component Declarations
  COMPONENT uz_dac_src_HDL_DUT
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : uz_dac_src_HDL_DUT
    USE ENTITY work.uz_dac_src_HDL_DUT(rtl);
...
BEGIN
  u_uz_dac_src_HDL_DUT : uz_dac_src_HDL_DUT
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
