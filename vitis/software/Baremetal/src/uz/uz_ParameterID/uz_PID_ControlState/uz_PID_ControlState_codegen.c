  ...
  ExtY_ControlState_t *rtControlState_Y, DW_ControlState_t *rtControlState_DW)
{
  ...
  if (!rtControlState_U->GlobalConfig_in.FluxMapID) {
	...
	if (!rtControlState_Y->ControlFlags.finished_all_Offline_states) {
		...
		if (rtControlState_U->GlobalConfig_in.ElectricalID && (!rtControlState_U->enteredElectricalID) && (rtControlState_DW->finishedElectricalID_loc != 2)
		...
		if (rtControlState_U->GlobalConfig_in.TwoMassID && (!rtControlState_U->enteredTwoMassID) && (rtControlState_DW->finishedElectricalID_loc != 0)
		                && (rtControlState_DW->finishedTwoMassID_loc != 2) && (!rtControlState_U->finishedTwoMassID)) {
		...
		if (rtControlState_U->GlobalConfig_in.FrictionID && (!rtControlState_U->enteredFrictionID) && (rtControlState_DW->finishedElectricalID_loc != 0)
		                && (rtControlState_DW->finishedTwoMassID_loc != 0) && (rtControlState_DW->finishedFrictionID_loc != 2) && (!rtControlState_U->finishedFrictionID)) {
		...
		if (rtControlState_U->GlobalConfig_in.FluxMapID && (!rtControlState_U->enteredFluxMapID) && (rtControlState_DW->finishedElectricalID_loc != 0)
		                && (rtControlState_DW->finishedTwoMassID_loc != 0) && (rtControlState_DW->finishedFrictionID_loc != 0) && (rtControlState_DW->finishedFluxMapID_loc != 2)
	...
	if ((rtControlState_DW->finishedElectricalID_loc != 0) && (rtControlState_DW->finishedTwoMassID_loc != 0) && (rtControlState_DW->finishedFrictionID_loc != 0)
...
void ControlState_step(RT_MODEL_ControlState_t *const rtControlState_M)
{
  ...
  if (rtControlState_DW->is_active_c8_ControlState == 0U) {
    ...
    initParams(rtControlState_U, rtControlState_Y, rtControlState_DW);
		...
		/* . */
		if (rtControlState_U->GlobalConfig_in.Reset || (!rtControlState_U->GlobalConfig_in.enableParameterID)) {
			/* Transition: '<S1>:722' */
			...
			case IN_finishedElectricalID:
				...
				/* '<S1>:626:12' ControlFlags.transNr=uint16(0); */
				rtControlState_Y->ControlFlags.transNr = 0U;
				rtControlState_DW->is_ControlState = IN_NO_ACTIVE_CHILD;
				break;
			...
			rtControlState_Y->GlobalConfig_out.enableParameterID = rtControlState_U->GlobalConfig_in.enableParameterID;
			...
			case IN_activateElectricalID:
				...
				if (rtControlState_U->enteredElectricalID) {
					...
					rtControlState_Y->GlobalConfig_out.thetaOffset = rtControlState_U->ElectricalID_output.thetaOffset;
			...
			case IN_decideMotorID:
				...
				if ((rtControlState_Y->ControlFlags.transNr == 1) && (rtControlState_DW->finishedElectricalID_loc == 0)) {
					/* Transition: '<S1>:618' */
					/* Exit 'decideMotorID': '<S1>:605' */
				...
				} else if ((rtControlState_Y->ControlFlags.transNr == 4) && (rtControlState_DW->finishedFluxMapID_loc == 0)) {
					/* Transition: '<S1>:682' */
					/* Exit 'decideMotorID': '<S1>:605' */
				...
				} else if ((rtControlState_Y->ControlFlags.transNr == 2) && (rtControlState_DW->finishedTwoMassID_loc == 0)) {
					/* Transition: '<S1>:672' */
					/* Exit 'decideMotorID': '<S1>:605' */
				...
				} else if ((rtControlState_Y->ControlFlags.transNr == 3) && (rtControlState_DW->finishedFrictionID_loc == 0)) {
					/* Transition: '<S1>:678' */
					/* Exit 'decideMotorID': '<S1>:605' */
			...
			case IN_duringElectricalID:
				...
				if (rtControlState_U->finishedElectricalID) {
					...
					rtControlState_Y->GlobalConfig_out.PMSM_config.Ld_Henry = rtControlState_U->ElectricalID_output.PMSM_parameters.Ld_Henry;

					/* '<S1>:624:8' GlobalConfig_out.PMSM_config.Lq_Henry=ElectricalID_output.PMSM_parameters.Lq_Henry; */
					rtControlState_Y->GlobalConfig_out.PMSM_config.Lq_Henry = rtControlState_U->ElectricalID_output.PMSM_parameters.Lq_Henry;

					/* '<S1>:624:9' GlobalConfig_out.PMSM_config.R_ph_Ohm=ElectricalID_output.PMSM_parameters.R_ph_Ohm; */
					rtControlState_Y->GlobalConfig_out.PMSM_config.R_ph_Ohm = rtControlState_U->ElectricalID_output.PMSM_parameters.R_ph_Ohm;

					/* '<S1>:624:10' GlobalConfig_out.PMSM_config.Psi_PM_Vs=ElectricalID_output.PMSM_parameters.Psi_PM_Vs; */
					rtControlState_Y->GlobalConfig_out.PMSM_config.Psi_PM_Vs = rtControlState_U->ElectricalID_output.PMSM_parameters.Psi_PM_Vs;
		...
		/* . */
	} else if (rtControlState_U->GlobalConfig_in.enableParameterID && (!rtControlState_U->GlobalConfig_in.Reset)) {
		/* Transition: '<S1>:723' */
