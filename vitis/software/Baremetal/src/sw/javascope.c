...
/* Project Wizard BEGIN: javascope_observable_pointers */
	...
	js_ch_observable[JSO_m1_phase_voltage_a]=&data->m1_phase_voltage.a;
	js_ch_observable[JSO_m1_phase_voltage_b]=&data->m1_phase_voltage.b;
	js_ch_observable[JSO_m1_phase_voltage_c]=&data->m1_phase_voltage.c;
	js_ch_observable[JSO_m12_dc_voltage] = &data->m12_dc_voltage;
	js_ch_observable[JSO_m1_phase_current_a]=&data->m1_phase_current.a;
	js_ch_observable[JSO_m1_phase_current_b]=&data->m1_phase_current.b;
	js_ch_observable[JSO_m1_phase_current_c]=&data->m1_phase_current.c;
	js_ch_observable[JSO_m2_phase_current_a]=&data->m2_phase_current.a;
	js_ch_observable[JSO_m2_phase_voltage_a]=&data->m2_phase_voltage.a;
	js_ch_observable[JSO_m2_phase_voltage_b]=&data->m2_phase_voltage.b;
	js_ch_observable[JSO_m2_phase_voltage_c]=&data->m2_phase_voltage.c;
	js_ch_observable[JSO_m2_phase_current_b]=&data->m2_phase_current.b;
	js_ch_observable[JSO_m2_phase_current_c]=&data->m2_phase_current.c;
	js_ch_observable[JSO_m1_dc_current]=&data->m1_dc_current;
	js_ch_observable[JSO_m2_dc_current]=&data->m2_dc_current;
	js_ch_observable[JSO_M1_I_A_A] = &data->objects.m1_measurements->i_abc_in_A.a;
	js_ch_observable[JSO_M1_I_B_A] = &data->objects.m1_measurements->i_abc_in_A.b;
	js_ch_observable[JSO_M1_I_C_A] = &data->objects.m1_measurements->i_abc_in_A.c;
	js_ch_observable[JSO_M1_I_D_A] = &data->objects.m1_actual_data->i_dq_in_A.d;
	js_ch_observable[JSO_M1_I_Q_A] = &data->objects.m1_actual_data->i_dq_in_A.q;
	js_ch_observable[JSO_M1_V_DC_V] = &data->objects.m1_measurements->v_dc_in_V;
	js_ch_observable[JSO_M1_V_D_V] = &data->objects.m1_reference_values->v_dq_in_V.d;
	js_ch_observable[JSO_M1_V_Q_V] = &data->objects.m1_reference_values->v_dq_in_V.q;
	js_ch_observable[JSO_M1_SPEED_RPM] = &data->objects.m1_actual_data->speed_in_rpm;
	js_ch_observable[JSO_M1_THETA_EL_RAD] = &data->objects.m1_actual_data->theta_el;
	js_ch_observable[JSO_M1_I_D_REF_A] = &data->objects.m1_reference_values->i_dq_in_A.d;
	js_ch_observable[JSO_M1_I_Q_REF_A] = &data->objects.m1_reference_values->i_dq_in_A.q;
	js_ch_observable[JSO_M1_N_REF_RPM] = &data->objects.m1_reference_values->speed_in_rpm;
	js_ch_observable[JSO_M2_I_A_A] = &data->objects.m2_measurements->i_abc_in_A.a;
	js_ch_observable[JSO_M2_I_B_A] = &data->objects.m2_measurements->i_abc_in_A.b;
	js_ch_observable[JSO_M2_I_C_A] = &data->objects.m2_measurements->i_abc_in_A.c;
	js_ch_observable[JSO_M2_I_D_A] = &data->objects.m2_actual_data->i_dq_in_A.d;
	js_ch_observable[JSO_M2_I_Q_A] = &data->objects.m2_actual_data->i_dq_in_A.q;
	js_ch_observable[JSO_M2_V_DC_V] = &data->objects.m2_measurements->v_dc_in_V;
	js_ch_observable[JSO_M2_V_D_V] = &data->objects.m2_reference_values->v_dq_in_V.d;
	js_ch_observable[JSO_M2_V_Q_V] = &data->objects.m2_reference_values->v_dq_in_V.q;
	js_ch_observable[JSO_M2_SPEED_RPM] = &data->objects.m2_actual_data->speed_in_rpm;
	js_ch_observable[JSO_M2_THETA_EL_RAD] = &data->objects.m2_actual_data->theta_el;
	js_ch_observable[JSO_M2_I_D_REF_A] = &data->objects.m2_reference_values->i_dq_in_A.d;
	js_ch_observable[JSO_M2_I_Q_REF_A] = &data->objects.m2_reference_values->i_dq_in_A.q;
	js_ch_observable[JSO_M2_N_REF_RPM] = &data->objects.m2_reference_values->speed_in_rpm;
	js_ch_observable[JSO_M3_I_A_A] = &data->objects.m3_measurements->i_abc_in_A.a;
	js_ch_observable[JSO_M3_I_B_A] = &data->objects.m3_measurements->i_abc_in_A.b;
	js_ch_observable[JSO_M3_I_C_A] = &data->objects.m3_measurements->i_abc_in_A.c;
	js_ch_observable[JSO_M3_I_D_A] = &data->objects.m3_actual_data->i_dq_in_A.d;
	js_ch_observable[JSO_M3_I_Q_A] = &data->objects.m3_actual_data->i_dq_in_A.q;
	js_ch_observable[JSO_M3_V_DC_V] = &data->objects.m3_measurements->v_dc_in_V;
	js_ch_observable[JSO_M3_V_D_V] = &data->objects.m3_reference_values->v_dq_in_V.d;
	js_ch_observable[JSO_M3_V_Q_V] = &data->objects.m3_reference_values->v_dq_in_V.q;
	js_ch_observable[JSO_M3_SPEED_RPM] = &data->objects.m3_actual_data->speed_in_rpm;
	js_ch_observable[JSO_M3_THETA_EL_RAD] = &data->objects.m3_actual_data->theta_el;
	js_ch_observable[JSO_M3_I_D_REF_A] = &data->objects.m3_reference_values->i_dq_in_A.d;
	js_ch_observable[JSO_M3_I_Q_REF_A] = &data->objects.m3_reference_values->i_dq_in_A.q;
	js_ch_observable[JSO_M3_N_REF_RPM] = &data->objects.m3_reference_values->speed_in_rpm;
	js_ch_observable[JSO_M4_I_A_A] = &data->objects.m4_measurements->i_abc_in_A.a;
	js_ch_observable[JSO_M4_I_B_A] = &data->objects.m4_measurements->i_abc_in_A.b;
	js_ch_observable[JSO_M4_I_C_A] = &data->objects.m4_measurements->i_abc_in_A.c;
	js_ch_observable[JSO_M4_I_D_A] = &data->objects.m4_actual_data->i_dq_in_A.d;
	js_ch_observable[JSO_M4_I_Q_A] = &data->objects.m4_actual_data->i_dq_in_A.q;
	js_ch_observable[JSO_M4_V_DC_V] = &data->objects.m4_measurements->v_dc_in_V;
	js_ch_observable[JSO_M4_V_D_V] = &data->objects.m4_reference_values->v_dq_in_V.d;
	js_ch_observable[JSO_M4_V_Q_V] = &data->objects.m4_reference_values->v_dq_in_V.q;
	js_ch_observable[JSO_M4_SPEED_RPM] = &data->objects.m4_actual_data->speed_in_rpm;
	js_ch_observable[JSO_M4_THETA_EL_RAD] = &data->objects.m4_actual_data->theta_el;
	js_ch_observable[JSO_M4_I_D_REF_A] = &data->objects.m4_reference_values->i_dq_in_A.d;
	js_ch_observable[JSO_M4_I_Q_REF_A] = &data->objects.m4_reference_values->i_dq_in_A.q;
	js_ch_observable[JSO_M4_N_REF_RPM] = &data->objects.m4_reference_values->speed_in_rpm;
	...
	js_ch_observable[JSO_RESOLVER_PL_D5_CH1_POS_EL_2PI] = &project_wizard_visualization_data.viz_resolver_pl_interface_d5_1_position_el_2pi;
	js_ch_observable[JSO_RESOLVER_PL_D5_CH1_OMEGA_MECH_RAD_S] = &project_wizard_visualization_data.viz_resolver_pl_interface_d5_1_omega_mech_rad_s;
	js_ch_observable[JSO_RESOLVER_PL_D5_CH1_N_MECH_RPM] = &project_wizard_visualization_data.viz_resolver_pl_interface_d5_1_n_mech_rpm;
	js_ch_observable[JSO_RESOLVER_PL_D5_CH1_OMEGA_EL_RAD_S] = &project_wizard_visualization_data.viz_resolver_pl_interface_d5_1_omega_el_rad_s;
	js_ch_observable[JSO_RESOLVER_PL_D5_CH1_REVOLUTION_COUNTER] = &project_wizard_visualization_data.viz_resolver_pl_interface_d5_1_revolution_counter;
	...
	js_ch_observable[JSO_RESOLVER_PL_D5_CH2_POS_EL_2PI] = &project_wizard_visualization_data.viz_resolver_pl_interface_d5_2_position_el_2pi;
	js_ch_observable[JSO_RESOLVER_PL_D5_CH2_OMEGA_MECH_RAD_S] = &project_wizard_visualization_data.viz_resolver_pl_interface_d5_2_omega_mech_rad_s;
