...
ARCHITECTURE rtl OF PWM_and_SS_control_V4_ip_src_GenPWM IS
  ...
  SIGNAL count_in_1                       : unsigned(19 DOWNTO 0);  -- ufix20
  ...
  SIGNAL Delay3_out1                      : unsigned(19 DOWNTO 0);  -- ufix20
  ...
  SIGNAL Delay3_out1_1                    : unsigned(19 DOWNTO 0);  -- ufix20
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        count_in_1 <= to_unsigned(16#00000#, 20);
      ELSIF enb = '1' THEN
        count_in_1 <= count_in_unsigned;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay3_out1 <= to_unsigned(16#00000#, 20);
      ELSIF enb = '1' THEN
  ...
  Switch10_out1 <= Delay3_out1 WHEN count_src_ext_AXI_1 = '0' ELSE
      count_in_1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay3_out1_1 <= to_unsigned(16#00000#, 20);
      ELSIF enb = '1' THEN
  ...
  count_out <= std_logic_vector(Delay3_out1_1);
