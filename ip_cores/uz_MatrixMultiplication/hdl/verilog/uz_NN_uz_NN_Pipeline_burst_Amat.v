...
module uz_NN_uz_NN_Pipeline_burst_Amat (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] icmp_ln53_reg_215;
reg    ap_predicate_op24_read_state2;
reg    ap_block_state2_pp0_stage0_iter1;
wire    ap_block_state3_pp0_stage0_iter2;
reg    ap_block_pp0_stage0_subdone;
wire   [0:0] icmp_ln51_fu_118_p2;
...
reg   [4:0] i_6_reg_206;
reg   [4:0] i_6_reg_206_pp0_iter1_reg;
reg   [0:0] icmp_ln51_reg_211_pp0_iter1_reg;
wire   [0:0] icmp_ln53_fu_134_p2;
reg   [0:0] icmp_ln53_reg_215_pp0_iter1_reg;
reg   [127:0] arrays_addr_read_reg_219;
reg    ap_condition_exit_pp0_iter1_stage0;
reg   [127:0] ap_phi_mux_empty_74_phi_fu_95_p4;
wire   [127:0] ap_phi_reg_pp0_iter2_empty_74_reg_92;
wire   [127:0] zext_ln51_fu_154_p1;
wire   [63:0] zext_ln51_1_fu_159_p1;
reg   [95:0] shiftreg68_fu_60;
wire    ap_loop_init;
reg   [4:0] i_fu_64;
wire   [4:0] add_ln51_fu_124_p2;
reg   [4:0] ap_sig_allocacmp_i_6;
wire   [1:0] trunc_ln51_fu_130_p1;
wire   [31:0] trunc_ln53_fu_163_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln51_fu_118_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            shiftreg68_fu_60 <= 96'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            shiftreg68_fu_60 <= {{ap_phi_mux_empty_74_phi_fu_95_p4[127:32]}};
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln51_fu_118_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln51_fu_118_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
always @ (*) begin
    if (((icmp_ln51_reg_211 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
always @ (*) begin
    if ((icmp_ln51_reg_211_pp0_iter1_reg == 1'd0)) begin
        if ((icmp_ln53_reg_215_pp0_iter1_reg == 1'd0)) begin
            ap_phi_mux_empty_74_phi_fu_95_p4 = zext_ln51_fu_154_p1;
        end else if ((icmp_ln53_reg_215_pp0_iter1_reg == 1'd1)) begin
...
assign A_address0 = zext_ln51_1_fu_159_p1;

assign A_d0 = trunc_ln53_fu_163_p1;

assign add_ln51_fu_124_p2 = (ap_sig_allocacmp_i_6 + 5'd1);
...
assign ap_phi_reg_pp0_iter2_empty_74_reg_92 = 'bx;

always @ (*) begin
    ap_predicate_op24_read_state2 = ((icmp_ln53_reg_215 == 1'd1) & (icmp_ln51_reg_211 == 1'd0));
end

assign icmp_ln51_fu_118_p2 = ((ap_sig_allocacmp_i_6 == 5'd20) ? 1'b1 : 1'b0);

assign icmp_ln53_fu_134_p2 = ((trunc_ln51_fu_130_p1 == 2'd0) ? 1'b1 : 1'b0);
...
assign trunc_ln51_fu_130_p1 = ap_sig_allocacmp_i_6[1:0];

assign trunc_ln53_fu_163_p1 = ap_phi_mux_empty_74_phi_fu_95_p4[31:0];

assign zext_ln51_1_fu_159_p1 = i_6_reg_206_pp0_iter1_reg;

assign zext_ln51_fu_154_p1 = shiftreg68_fu_60;

endmodule //uz_NN_uz_NN_Pipeline_burst_Amat
