...
#(parameter
    ...
    output wire [31:0]                   L_Input_Weights_input,
    ...
    output wire [31:0]                   L_Input_Bias_input,
...
localparam
    ...
    ADDR_L_INPUT_WEIGHTS_INPUT_DATA_0  = 8'h18,
    ADDR_L_INPUT_WEIGHTS_INPUT_CTRL    = 8'h1c,
    ADDR_L_1_WEIGHTS_INPUT_DATA_0      = 8'h20,
    ADDR_L_1_WEIGHTS_INPUT_CTRL        = 8'h24,
    ADDR_L_2_WEIGHTS_INPUT_DATA_0      = 8'h28,
    ADDR_L_2_WEIGHTS_INPUT_CTRL        = 8'h2c,
    ADDR_L_3_WEIGHTS_INPUT_DATA_0      = 8'h30,
    ADDR_L_3_WEIGHTS_INPUT_CTRL        = 8'h34,
    ADDR_ACTION_OUTPUT_DATA_0          = 8'h38,
    ADDR_ACTION_OUTPUT_CTRL            = 8'h3c,
    ADDR_L_INPUT_BIAS_INPUT_DATA_0     = 8'h40,
    ADDR_L_INPUT_BIAS_INPUT_CTRL       = 8'h44,
    ADDR_L_1_BIAS_INPUT_DATA_0         = 8'h48,
    ADDR_L_1_BIAS_INPUT_CTRL           = 8'h4c,
    ADDR_L_2_BIAS_INPUT_DATA_0         = 8'h50,
    ADDR_L_2_BIAS_INPUT_CTRL           = 8'h54,
    ADDR_L_3_BIAS_INPUT_DATA_0         = 8'h58,
    ADDR_L_3_BIAS_INPUT_CTRL           = 8'h5c,
...
//------------------------Local signal-------------------
    ...
    reg  [31:0]                   int_L_Input_Weights_input = 'b0;
    ...
    reg  [31:0]                   int_L_Input_Bias_input = 'b0;
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_L_INPUT_WEIGHTS_INPUT_DATA_0: begin
                    rdata <= int_L_Input_Weights_input[31:0];
                end
                ...
                ADDR_L_INPUT_BIAS_INPUT_DATA_0: begin
                    rdata <= int_L_Input_Bias_input[31:0];
                end
...
assign L_Input_Weights_input  = int_L_Input_Weights_input;
...
assign L_Input_Bias_input     = int_L_Input_Bias_input;
...
// int_L_Input_Weights_input[31:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_L_Input_Weights_input[31:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_L_INPUT_WEIGHTS_INPUT_DATA_0)
            int_L_Input_Weights_input[31:0] <= (WDATA[31:0] & wmask) | (int_L_Input_Weights_input[31:0] & ~wmask);
    end
end
...
// int_L_Input_Bias_input[31:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_L_Input_Bias_input[31:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_L_INPUT_BIAS_INPUT_DATA_0)
            int_L_Input_Bias_input[31:0] <= (WDATA[31:0] & wmask) | (int_L_Input_Bias_input[31:0] & ~wmask);
    end
end
