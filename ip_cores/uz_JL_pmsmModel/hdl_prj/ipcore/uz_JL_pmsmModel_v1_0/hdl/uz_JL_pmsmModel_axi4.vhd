-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\jonat\Documents\MA_JL_CIL\ip_cores\uz_JL_pmsmModel\hdl_prj\hdlsrc\uz_JL_pmsmModel\uz_JL_pmsmModel_axi4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_JL_pmsmModel_axi4
-- Source Path: uz_JL_pmsmModel/uz_JL_pmsmModel_axi4
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_JL_pmsmModel_axi4 IS
...
END uz_JL_pmsmModel_axi4;


ARCHITECTURE rtl OF uz_JL_pmsmModel_axi4 IS

  -- Component Declarations
  COMPONENT uz_JL_pmsmModel_addr_decoder
  ...
  COMPONENT uz_JL_pmsmModel_axi4_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_ARESETN                    :   IN    std_logic;  -- ufix1
          AXI4_AWID                       :   IN    std_logic_vector(11 DOWNTO 0);  -- ufix12
          AXI4_AWADDR                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  FOR ALL : uz_JL_pmsmModel_addr_decoder
    USE ENTITY work.uz_JL_pmsmModel_addr_decoder(rtl);

  FOR ALL : uz_JL_pmsmModel_axi4_module
    USE ENTITY work.uz_JL_pmsmModel_axi4_module(rtl);
  ...
  SIGNAL write_Last_J_tmp                 : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_Last_M_tmp                 : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_PMSM_config_mot_R1_tmp     : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_PMSM_config_mot_psi_pm_tmp : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_PMSM_config_mot_Ld_tmp     : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_PMSM_config_mot_Lq_tmp     : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_PMSM_config_mot_p_tmp      : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_PMSM_config_mot_J_tmp      : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_PMSM_config_mot_n_N_tmp    : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_PMSM_config_mot_M_N_tmp    : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_PMSM_config_mot_I_max_tmp  : std_logic_vector(31 DOWNTO 0);  -- ufix32
...
BEGIN
  u_uz_JL_pmsmModel_addr_decoder_inst : uz_JL_pmsmModel_addr_decoder
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
              ...
              read_PMSM_Out_pmsm_Iuvw => read_PMSM_Out_pmsm_Iuvw,  -- ufix32 [3]
              read_PMSM_Out_pmsm_Omega_mech => read_PMSM_Out_pmsm_Omega_mech,  -- ufix32
              read_PMSM_Out_pmsm_phi_mech => read_PMSM_Out_pmsm_phi_mech,  -- ufix32
              read_PMSM_Out_pmsm_m_mot => read_PMSM_Out_pmsm_m_mot,  -- ufix32
              data_read => top_data_read,  -- ufix32
              write_axi_enable => write_axi_enable,  -- ufix1
              write_Last_J => write_Last_J_tmp,  -- ufix32
              write_Last_M => write_Last_M_tmp,  -- ufix32
              write_Bremse => write_Bremse,  -- ufix1
              write_PMSM_config_mot_R1 => write_PMSM_config_mot_R1_tmp,  -- ufix32
              write_PMSM_config_mot_psi_pm => write_PMSM_config_mot_psi_pm_tmp,  -- ufix32
              write_PMSM_config_mot_Ld => write_PMSM_config_mot_Ld_tmp,  -- ufix32
              write_PMSM_config_mot_Lq => write_PMSM_config_mot_Lq_tmp,  -- ufix32
              write_PMSM_config_mot_p => write_PMSM_config_mot_p_tmp,  -- ufix32
              write_PMSM_config_mot_J => write_PMSM_config_mot_J_tmp,  -- ufix32
              write_PMSM_config_mot_n_N => write_PMSM_config_mot_n_N_tmp,  -- ufix32
              write_PMSM_config_mot_M_N => write_PMSM_config_mot_M_N_tmp,  -- ufix32
              write_PMSM_config_mot_I_max => write_PMSM_config_mot_I_max_tmp  -- ufix32
              );

  u_uz_JL_pmsmModel_axi4_module_inst : uz_JL_pmsmModel_axi4_module
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
  ...
  write_Last_J <= write_Last_J_tmp;

  write_Last_M <= write_Last_M_tmp;

  write_PMSM_config_mot_R1 <= write_PMSM_config_mot_R1_tmp;

  write_PMSM_config_mot_psi_pm <= write_PMSM_config_mot_psi_pm_tmp;

  write_PMSM_config_mot_Ld <= write_PMSM_config_mot_Ld_tmp;

  write_PMSM_config_mot_Lq <= write_PMSM_config_mot_Lq_tmp;

  write_PMSM_config_mot_p <= write_PMSM_config_mot_p_tmp;

  write_PMSM_config_mot_J <= write_PMSM_config_mot_J_tmp;

  write_PMSM_config_mot_n_N <= write_PMSM_config_mot_n_N_tmp;

  write_PMSM_config_mot_M_N <= write_PMSM_config_mot_M_N_tmp;

  write_PMSM_config_mot_I_max <= write_PMSM_config_mot_I_max_tmp;
