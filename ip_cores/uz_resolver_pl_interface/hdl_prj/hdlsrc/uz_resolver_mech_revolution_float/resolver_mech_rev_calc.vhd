-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_resolver_mech_revolution_float\resolver_mech_rev_calc.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: resolver_mech_rev_calc
-- Source Path: resolver_mech_rev_calc
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY resolver_mech_rev_calc IS
  PORT( IPCORE_CLK                        :   IN    std_logic;  -- ufix1
        ...
        cnt                               :   OUT   std_logic_vector(31 DOWNTO 0);  -- ufix32
...
END resolver_mech_rev_calc;


ARCHITECTURE rtl OF resolver_mech_rev_calc IS

  -- Component Declarations
  COMPONENT resolver_mech_rev_calc_reset_sync
  ...
  COMPONENT resolver_mech_rev_calc_axi_lite
  ...
  COMPONENT resolver_mech_rev_calc_dut
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          ...
          cnt                             :   OUT   std_logic_vector(31 DOWNTO 0);  -- sfix32
          done                            :   OUT   std_logic;  -- ufix1
  ...
  FOR ALL : resolver_mech_rev_calc_reset_sync
    USE ENTITY work.resolver_mech_rev_calc_reset_sync(rtl);

  FOR ALL : resolver_mech_rev_calc_axi_lite
    USE ENTITY work.resolver_mech_rev_calc_axi_lite(rtl);

  FOR ALL : resolver_mech_rev_calc_dut
    USE ENTITY work.resolver_mech_rev_calc_dut(rtl);
  ...
  SIGNAL cnt_sig                          : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL cnt_sig_signed                   : signed(31 DOWNTO 0);  -- sfix32
  SIGNAL cnt_tmp                          : unsigned(31 DOWNTO 0);  -- ufix32

BEGIN
  u_resolver_mech_rev_calc_reset_sync_inst : resolver_mech_rev_calc_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_resolver_mech_rev_calc_axi_lite_inst : resolver_mech_rev_calc_axi_lite
  ...
  u_resolver_mech_rev_calc_dut_inst : resolver_mech_rev_calc_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  ip_timestamp <= unsigned'(X"892962FD");
  ...
  cnt_sig_signed <= signed(cnt_sig);

  cnt_tmp <= unsigned(cnt_sig_signed);
