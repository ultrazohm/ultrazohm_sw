...
#define  IPCore_Timestamp_uz_plantModel_pt1     0x8  //contains unique IP timestamp (yymmddHHMM): 2106161358
...
#define  time_constant_Data_uz_plantModel_pt1   0x108  //data register for Inport time_constant
