-- -------------------------------------------------------------
-- 
-- File Name: C:\IPcoreTest\hdlsrc\PWMdutyFreqDetection\PWMdutyFreqDetection_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: PWMdutyFreqDetection_axi_lite
-- Source Path: PWMdutyFreqDetection/PWMdutyFreqDetection_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY PWMdutyFreqDetection_axi_lite IS
...
END PWMdutyFreqDetection_axi_lite;


ARCHITECTURE rtl OF PWMdutyFreqDetection_axi_lite IS

  -- Component Declarations
  COMPONENT PWMdutyFreqDetection_addr_decoder
  ...
  COMPONENT PWMdutyFreqDetection_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : PWMdutyFreqDetection_addr_decoder
    USE ENTITY work.PWMdutyFreqDetection_addr_decoder(rtl);

  FOR ALL : PWMdutyFreqDetection_axi_lite_module
    USE ENTITY work.PWMdutyFreqDetection_axi_lite_module(rtl);
...
BEGIN
  u_PWMdutyFreqDetection_addr_decoder_inst : PWMdutyFreqDetection_addr_decoder
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
              ...
              read_AXI_freq => read_AXI_freq,  -- sfix32
              read_AXI_hightime => read_AXI_hightime,  -- sfix32
              read_AXI_lowtime => read_AXI_lowtime,  -- sfix32
              read_AXI_dutycyc => read_AXI_dutycyc,  -- sfix32_En24
              data_read => top_data_read,  -- ufix32
              write_axi_enable => write_axi_enable  -- ufix1
              );

  u_PWMdutyFreqDetection_axi_lite_module_inst : PWMdutyFreqDetection_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
