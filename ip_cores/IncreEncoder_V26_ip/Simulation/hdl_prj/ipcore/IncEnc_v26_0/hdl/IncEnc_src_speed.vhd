-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\inc_enc_v26\IncEnc_src_speed.vhd
...
END IncEnc_src_speed;


ARCHITECTURE rtl OF IncEnc_src_speed IS

  -- Component Declarations
  COMPONENT IncEnc_src_OS_factor_logic
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_5987_0                    :   IN    std_logic;
  ...
  COMPONENT IncEnc_src_calc_omega
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_5987_0                    :   IN    std_logic;
  ...
  FOR ALL : IncEnc_src_OS_factor_logic
    USE ENTITY work.IncEnc_src_OS_factor_logic(rtl);

  FOR ALL : IncEnc_src_calc_omega
    USE ENTITY work.IncEnc_src_calc_omega(rtl);

  FOR ALL : IncEnc_src_Average
    USE ENTITY work.IncEnc_src_Average(rtl);
...
BEGIN
  u_OS_factor_logic : IncEnc_src_OS_factor_logic
    PORT MAP( clk => clk,
              reset_x => reset_x,
  ...
  GEN_LABEL: FOR k IN 0 TO 3 GENERATE
    u_calc_omega : IncEnc_src_calc_omega
      PORT MAP( clk => clk,
                reset_x => reset_x,
                enb_1_5987_0 => enb_1_5987_0,
