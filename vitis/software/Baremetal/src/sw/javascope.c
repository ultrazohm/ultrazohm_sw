...
int JavaScope_initialize(DS_Data* data)
{
	...
	js_ch_observable[JSO_iX1] 			= &data->av.full_currents_dq.x1;
	js_ch_observable[JSO_iY1] 			= &data->av.full_currents_dq.y1;
	js_ch_observable[JSO_iX2] 			= &data->av.full_currents_dq.x2;
	js_ch_observable[JSO_iY2] 			= &data->av.full_currents_dq.y2;
	js_ch_observable[JSO_iX3] 			= &data->av.full_currents_dq.x3;
	js_ch_observable[JSO_iY3] 			= &data->av.full_currents_dq.y3;
	js_ch_observable[JSO_iZero] 		= &data->av.full_currents_dq.zero;
	js_ch_observable[JSO_ud] 			= &data->av.full_voltages_dq.d;
	js_ch_observable[JSO_uq] 			= &data->av.full_voltages_dq.q;
	js_ch_observable[JSO_uX1] 			= &data->av.full_voltages_dq.x1;
	js_ch_observable[JSO_uY1] 			= &data->av.full_voltages_dq.y1;
	js_ch_observable[JSO_uX2] 			= &data->av.full_voltages_dq.x2;
	js_ch_observable[JSO_uY2] 			= &data->av.full_voltages_dq.y2;
	...
	js_ch_observable[JSO_step]			= &step_float;
