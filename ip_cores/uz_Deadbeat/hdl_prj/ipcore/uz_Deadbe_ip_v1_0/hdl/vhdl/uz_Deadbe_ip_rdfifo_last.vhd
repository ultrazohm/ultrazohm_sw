-- -------------------------------------------------------------
-- 
-- File Name: C:\UltraZohm\ultrazohm_test\ip_cores\uz_Deadbeat\hdl_prj\hdlsrc\uz_Deadbeat\uz_Deadbe_ip_rdfifo_last.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_Deadbe_ip_rdfifo_last
-- Source Path: uz_Deadbe_ip/uz_Deadbe_ip_axi4/uz_Deadbe_ip_axi4_module/uz_Deadbe_ip_rdfifo_last
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_Deadbe_ip_rdfifo_last IS
...
END uz_Deadbe_ip_rdfifo_last;


ARCHITECTURE rtl OF uz_Deadbe_ip_rdfifo_last IS

  -- Component Declarations
  COMPONENT uz_Deadbe_ip_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : uz_Deadbe_ip_SimpleDualPortRAM_singlebit
    USE ENTITY work.uz_Deadbe_ip_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_uz_Deadbe_ip_rdfifo_last_classic_ram_singlebit : uz_Deadbe_ip_SimpleDualPortRAM_singlebit
