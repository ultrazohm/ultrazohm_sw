-- -------------------------------------------------------------
-- 
-- File Name: C:\utrazohm_sw_2\ultrazohm_sw\ip_cores\uz_count_switching\hdl_prj\hdlsrc\uz_count_switching\uz_count_ip_rdfifo_last.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_count_ip_rdfifo_last
-- Source Path: uz_count_ip/uz_count_ip_axi4/uz_count_ip_axi4_module/uz_count_ip_rdfifo_last
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_count_ip_rdfifo_last IS
...
END uz_count_ip_rdfifo_last;


ARCHITECTURE rtl OF uz_count_ip_rdfifo_last IS

  -- Component Declarations
  COMPONENT uz_count_ip_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : uz_count_ip_SimpleDualPortRAM_singlebit
    USE ENTITY work.uz_count_ip_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_uz_count_ip_rdfifo_last_classic_ram_singlebit : uz_count_ip_SimpleDualPortRAM_singlebit
