/*
 * File Name:         hdl_prj\ipcore\uz_ssi_interface_v2_6\include\uz_ssi_interface_addr.h
 * Description:       C Header File
 * Created:           2025-09-15 11:10:46
*/
...
#define  IPCore_Timestamp_uz_ssi_interface                             0x8  //contains unique IP timestamp (yymmddHHMM): 2509151110
...
#define  speed_mech_SI_AXI_Data_uz_ssi_interface                       0x154  //data register for Outport speed_mech_SI_AXI
#define  speed_el_SI_AXI_Data_uz_ssi_interface                         0x158  //data register for Outport speed_el_SI_AXI
#define  speed_mech_rpm_AXI_Data_uz_ssi_interface                      0x15C  //data register for Outport speed_mech_rpm_AXI
