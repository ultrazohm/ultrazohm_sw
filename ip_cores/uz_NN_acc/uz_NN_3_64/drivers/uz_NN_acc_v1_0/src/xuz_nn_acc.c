...
void XUz_nn_acc_Set_L_4_Weights_input(XUz_nn_acc *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XUz_nn_acc_WriteReg(InstancePtr->Control_BaseAddress, XUZ_NN_ACC_CONTROL_ADDR_L_4_WEIGHTS_INPUT_DATA, Data);
}

u32 XUz_nn_acc_Get_L_4_Weights_input(XUz_nn_acc *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XUz_nn_acc_ReadReg(InstancePtr->Control_BaseAddress, XUZ_NN_ACC_CONTROL_ADDR_L_4_WEIGHTS_INPUT_DATA);
    return Data;
}

void XUz_nn_acc_Set_L_5_Weights_input(XUz_nn_acc *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XUz_nn_acc_WriteReg(InstancePtr->Control_BaseAddress, XUZ_NN_ACC_CONTROL_ADDR_L_5_WEIGHTS_INPUT_DATA, Data);
}

u32 XUz_nn_acc_Get_L_5_Weights_input(XUz_nn_acc *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XUz_nn_acc_ReadReg(InstancePtr->Control_BaseAddress, XUZ_NN_ACC_CONTROL_ADDR_L_5_WEIGHTS_INPUT_DATA);
    return Data;
}

void XUz_nn_acc_Set_L_6_Weights_input(XUz_nn_acc *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XUz_nn_acc_WriteReg(InstancePtr->Control_BaseAddress, XUZ_NN_ACC_CONTROL_ADDR_L_6_WEIGHTS_INPUT_DATA, Data);
}

u32 XUz_nn_acc_Get_L_6_Weights_input(XUz_nn_acc *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XUz_nn_acc_ReadReg(InstancePtr->Control_BaseAddress, XUZ_NN_ACC_CONTROL_ADDR_L_6_WEIGHTS_INPUT_DATA);
    return Data;
}

void XUz_nn_acc_Set_L_7_Weights_input(XUz_nn_acc *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XUz_nn_acc_WriteReg(InstancePtr->Control_BaseAddress, XUZ_NN_ACC_CONTROL_ADDR_L_7_WEIGHTS_INPUT_DATA, Data);
}

u32 XUz_nn_acc_Get_L_7_Weights_input(XUz_nn_acc *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XUz_nn_acc_ReadReg(InstancePtr->Control_BaseAddress, XUZ_NN_ACC_CONTROL_ADDR_L_7_WEIGHTS_INPUT_DATA);
    return Data;
}

void XUz_nn_acc_Set_L_8_Weights_input(XUz_nn_acc *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XUz_nn_acc_WriteReg(InstancePtr->Control_BaseAddress, XUZ_NN_ACC_CONTROL_ADDR_L_8_WEIGHTS_INPUT_DATA, Data);
}

u32 XUz_nn_acc_Get_L_8_Weights_input(XUz_nn_acc *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XUz_nn_acc_ReadReg(InstancePtr->Control_BaseAddress, XUZ_NN_ACC_CONTROL_ADDR_L_8_WEIGHTS_INPUT_DATA);
    return Data;
}

void XUz_nn_acc_Set_L_9_Weights_input(XUz_nn_acc *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XUz_nn_acc_WriteReg(InstancePtr->Control_BaseAddress, XUZ_NN_ACC_CONTROL_ADDR_L_9_WEIGHTS_INPUT_DATA, Data);
}

u32 XUz_nn_acc_Get_L_9_Weights_input(XUz_nn_acc *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XUz_nn_acc_ReadReg(InstancePtr->Control_BaseAddress, XUZ_NN_ACC_CONTROL_ADDR_L_9_WEIGHTS_INPUT_DATA);
    return Data;
}

void XUz_nn_acc_Set_L_10_Weights_input(XUz_nn_acc *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XUz_nn_acc_WriteReg(InstancePtr->Control_BaseAddress, XUZ_NN_ACC_CONTROL_ADDR_L_10_WEIGHTS_INPUT_DATA, Data);
}

u32 XUz_nn_acc_Get_L_10_Weights_input(XUz_nn_acc *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XUz_nn_acc_ReadReg(InstancePtr->Control_BaseAddress, XUZ_NN_ACC_CONTROL_ADDR_L_10_WEIGHTS_INPUT_DATA);
    return Data;
}
...
void XUz_nn_acc_Set_L_4_Bias_input(XUz_nn_acc *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XUz_nn_acc_WriteReg(InstancePtr->Control_BaseAddress, XUZ_NN_ACC_CONTROL_ADDR_L_4_BIAS_INPUT_DATA, Data);
}

u32 XUz_nn_acc_Get_L_4_Bias_input(XUz_nn_acc *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XUz_nn_acc_ReadReg(InstancePtr->Control_BaseAddress, XUZ_NN_ACC_CONTROL_ADDR_L_4_BIAS_INPUT_DATA);
    return Data;
}

void XUz_nn_acc_Set_L_5_Bias_input(XUz_nn_acc *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XUz_nn_acc_WriteReg(InstancePtr->Control_BaseAddress, XUZ_NN_ACC_CONTROL_ADDR_L_5_BIAS_INPUT_DATA, Data);
}

u32 XUz_nn_acc_Get_L_5_Bias_input(XUz_nn_acc *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XUz_nn_acc_ReadReg(InstancePtr->Control_BaseAddress, XUZ_NN_ACC_CONTROL_ADDR_L_5_BIAS_INPUT_DATA);
    return Data;
}

void XUz_nn_acc_Set_L_6_Bias_input(XUz_nn_acc *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XUz_nn_acc_WriteReg(InstancePtr->Control_BaseAddress, XUZ_NN_ACC_CONTROL_ADDR_L_6_BIAS_INPUT_DATA, Data);
}

u32 XUz_nn_acc_Get_L_6_Bias_input(XUz_nn_acc *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XUz_nn_acc_ReadReg(InstancePtr->Control_BaseAddress, XUZ_NN_ACC_CONTROL_ADDR_L_6_BIAS_INPUT_DATA);
    return Data;
}

void XUz_nn_acc_Set_L_7_Bias_input(XUz_nn_acc *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XUz_nn_acc_WriteReg(InstancePtr->Control_BaseAddress, XUZ_NN_ACC_CONTROL_ADDR_L_7_BIAS_INPUT_DATA, Data);
}

u32 XUz_nn_acc_Get_L_7_Bias_input(XUz_nn_acc *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XUz_nn_acc_ReadReg(InstancePtr->Control_BaseAddress, XUZ_NN_ACC_CONTROL_ADDR_L_7_BIAS_INPUT_DATA);
    return Data;
}

void XUz_nn_acc_Set_L_8_Bias_input(XUz_nn_acc *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XUz_nn_acc_WriteReg(InstancePtr->Control_BaseAddress, XUZ_NN_ACC_CONTROL_ADDR_L_8_BIAS_INPUT_DATA, Data);
}

u32 XUz_nn_acc_Get_L_8_Bias_input(XUz_nn_acc *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XUz_nn_acc_ReadReg(InstancePtr->Control_BaseAddress, XUZ_NN_ACC_CONTROL_ADDR_L_8_BIAS_INPUT_DATA);
    return Data;
}

void XUz_nn_acc_Set_L_9_Bias_input(XUz_nn_acc *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XUz_nn_acc_WriteReg(InstancePtr->Control_BaseAddress, XUZ_NN_ACC_CONTROL_ADDR_L_9_BIAS_INPUT_DATA, Data);
}

u32 XUz_nn_acc_Get_L_9_Bias_input(XUz_nn_acc *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XUz_nn_acc_ReadReg(InstancePtr->Control_BaseAddress, XUZ_NN_ACC_CONTROL_ADDR_L_9_BIAS_INPUT_DATA);
    return Data;
}

void XUz_nn_acc_Set_L_10_Bias_input(XUz_nn_acc *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XUz_nn_acc_WriteReg(InstancePtr->Control_BaseAddress, XUZ_NN_ACC_CONTROL_ADDR_L_10_BIAS_INPUT_DATA, Data);
}

u32 XUz_nn_acc_Get_L_10_Bias_input(XUz_nn_acc *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XUz_nn_acc_ReadReg(InstancePtr->Control_BaseAddress, XUZ_NN_ACC_CONTROL_ADDR_L_10_BIAS_INPUT_DATA);
    return Data;
}
...
void XUz_nn_acc_Set_compute_flag(XUz_nn_acc *InstancePtr, u32 Data) {
    ...
    XUz_nn_acc_WriteReg(InstancePtr->Control_BaseAddress, XUZ_NN_ACC_CONTROL_ADDR_COMPUTE_FLAG_DATA, Data);
}
...
u32 XUz_nn_acc_Get_compute_flag(XUz_nn_acc *InstancePtr) {
    ...
    Data = XUz_nn_acc_ReadReg(InstancePtr->Control_BaseAddress, XUZ_NN_ACC_CONTROL_ADDR_COMPUTE_FLAG_DATA);
    return Data;
}
