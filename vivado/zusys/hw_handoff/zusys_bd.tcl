...
proc create_hier_cell_adc_debug { parentCell nameHier } {
  ...
  connect_bd_net -net pu_valid_1 -boundary_type lower [get_bd_pins pu_valid]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: ila_puconv, and set properties
  set ila_puconv [ create_bd_cell -type ip -vlnv xilinx.com:ip:ila:6.2 ila_puconv ]
  set_property -dict [ list \
   CONFIG.C_DATA_DEPTH {8192} \
   CONFIG.C_ENABLE_ILA_AXI_MON {false} \
   CONFIG.C_MONITOR_TYPE {Native} \
  ...
  # Create instance: uz_pu_con_ip_0, and set properties
  set uz_pu_con_ip_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:uz_pu_con_ip:1.0 uz_pu_con_ip_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__PROTECTION__DDR_SEGMENTS {SA:0x0; SIZE:32; UNIT:MB; RegionTZ:Secure; WrAllowed:Read/Write; subsystemId:APU| SA:0x60000000; SIZE:1; UNIT:MB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU| SA:0x40000000; SIZE:16; UNIT:MB; RegionTZ:Secure; WrAllowed:Read/Write; subsystemId:RPU| SA:0x60000000; SIZE:1; UNIT:MB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:RPU} \
   ...
   CONFIG.PSU__PROTECTION__LPD_SEGMENTS {SA:0xFF000000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU| SA:0xFF060000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU| SA:0xFF0A0000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU| SA:0xFF020000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU| SA:0xFF110000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU| SA:0xFF060000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:RPU| SA:0xFF0A0000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:RPU| SA:0xFF020000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:RPU| SA:0xFF000000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:RPU| SA:0xFF110000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:RPU| SA:0xFF980000; SIZE:64; UNIT:KB; RegionTZ:Secure; WrAllowed:Read/Write; subsystemId:PMU Firmware| SA:0xFF5E0000; SIZE:2560; UNIT:KB; RegionTZ:Secure; WrAllowed:Read/Write; subsystemId:PMU Firmware| SA:0xFFCC0000; SIZE:64; UNIT:KB; RegionTZ:Secure; WrAllowed:Read/Write; subsystemId:PMU Firmware| SA:0xFF180000; SIZE:768; UNIT:KB; RegionTZ:Secure; WrAllowed:Read/Write; subsystemId:PMU Firmware| SA:0xFF410000; SIZE:640; UNIT:KB; RegionTZ:Secure; WrAllowed:Read/Write; subsystemId:PMU Firmware| SA:0xFFA70000; SIZE:64; UNIT:KB; RegionTZ:Secure; WrAllowed:Read/Write; subsystemId:PMU Firmware| SA:0xFF9A0000; SIZE:64; UNIT:KB; RegionTZ:Secure; WrAllowed:Read/Write; subsystemId:PMU Firmware|SA:0xFF0E0000 ;SIZE:64;UNIT:KB ;RegionTZ:NonSecure ;WrAllowed:Read/Write;subsystemId:APU|SA:0xFF380000 ;SIZE:512;UNIT:KB ;RegionTZ:NonSecure ;WrAllowed:Read/Write;subsystemId:APU|SA:0xFF380000 ;SIZE:512;UNIT:KB ;RegionTZ:NonSecure ;WrAllowed:Read/Write;subsystemId:RPU|SA:0xFF160000 ;SIZE:64;UNIT:KB ;RegionTZ:NonSecure ;WrAllowed:Read/Write;subsystemId:APU|SA:0xFF170000 ;SIZE:64;UNIT:KB ;RegionTZ:NonSecure ;WrAllowed:Read/Write;subsystemId:APU} \
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M13_AXI [get_bd_intf_pins smartconnect_0/M13_AXI] [get_bd_intf_pins uz_pu_con_ip_0/AXI4_Lite]
  ...
  connect_bd_net -net A1_ADC_LTC2311_SI_VALID [get_bd_pins A1_ADC_LTC2311/SI_VALID] [get_bd_pins adc_debug/probe7] [get_bd_pins ila_puconv/probe8] [get_bd_pins uz_pu_con_ip_0/adc_trigger]
  connect_bd_net -net A1_ADC_LTC2311_SI_VALUE [get_bd_pins A1_ADC_LTC2311/SI_VALUE] [get_bd_pins adc_debug/Din1] [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_1/Din] [get_bd_pins xlslice_2/Din]
  ...
  connect_bd_net -net pu_valid_1 [get_bd_pins adc_debug/pu_valid] [get_bd_pins ila_puconv/probe9] [get_bd_pins uz_pu_con_ip_0/out_valid]
  connect_bd_net -net uz_pu_con_ip_0_out0 [get_bd_pins ila_puconv/probe0] [get_bd_pins uz_pu_con_ip_0/out0]
  connect_bd_net -net uz_pu_con_ip_0_out1 [get_bd_pins ila_puconv/probe1] [get_bd_pins uz_pu_con_ip_0/out1]
  connect_bd_net -net uz_pu_con_ip_0_out2 [get_bd_pins ila_puconv/probe2] [get_bd_pins uz_pu_con_ip_0/out2]
  connect_bd_net -net uz_pu_con_ip_0_out3 [get_bd_pins ila_puconv/probe3] [get_bd_pins uz_pu_con_ip_0/out3]
  connect_bd_net -net uz_pu_con_ip_0_out4 [get_bd_pins ila_puconv/probe4] [get_bd_pins uz_pu_con_ip_0/out4]
  connect_bd_net -net uz_pu_con_ip_0_out5 [get_bd_pins ila_puconv/probe5] [get_bd_pins uz_pu_con_ip_0/out5]
  connect_bd_net -net uz_pu_con_ip_0_out6 [get_bd_pins ila_puconv/probe6] [get_bd_pins uz_pu_con_ip_0/out6]
  connect_bd_net -net uz_pu_con_ip_0_out7 [get_bd_pins ila_puconv/probe7] [get_bd_pins uz_pu_con_ip_0/out7]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins uz_pu_con_ip_0/in3] [get_bd_pins uz_pu_con_ip_0/in4] [get_bd_pins uz_pu_con_ip_0/in5] [get_bd_pins uz_pu_con_ip_0/in6] [get_bd_pins uz_pu_con_ip_0/in7] [get_bd_pins uz_pu_con_ip_0/in8] [get_bd_pins uz_pu_con_ip_0/in9] [get_bd_pins uz_pu_con_ip_0/in10] [get_bd_pins uz_pu_con_ip_0/in11] [get_bd_pins uz_pu_con_ip_0/in12] [get_bd_pins uz_pu_con_ip_0/in13] [get_bd_pins uz_pu_con_ip_0/in14] [get_bd_pins uz_pu_con_ip_0/in15] [get_bd_pins uz_pu_con_ip_0/in16] [get_bd_pins uz_pu_con_ip_0/in17] [get_bd_pins uz_pu_con_ip_0/in18] [get_bd_pins uz_pu_con_ip_0/in19] [get_bd_pins uz_pu_con_ip_0/in20] [get_bd_pins uz_pu_con_ip_0/in21] [get_bd_pins uz_pu_con_ip_0/in22] [get_bd_pins uz_pu_con_ip_0/in23] [get_bd_pins uz_pu_con_ip_0/in24] [get_bd_pins uz_pu_con_ip_0/in25] [get_bd_pins uz_pu_con_ip_0/in26] [get_bd_pins uz_pu_con_ip_0/in27] [get_bd_pins uz_pu_con_ip_0/in28] [get_bd_pins uz_pu_con_ip_0/in29] [get_bd_pins uz_pu_con_ip_0/in30] [get_bd_pins uz_pu_con_ip_0/in31] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins uz_pu_con_ip_0/in0] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins uz_pu_con_ip_0/in1] [get_bd_pins xlslice_1/Dout]
  connect_bd_net -net xlslice_2_Dout [get_bd_pins uz_pu_con_ip_0/in2] [get_bd_pins xlslice_2/Dout]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk1 [get_bd_pins A1_ADC_LTC2311/s00_axi_aclk] [get_bd_pins A2_ADC_LTC2311/s00_axi_aclk] [get_bd_pins A3_ADC_LTC2311/s00_axi_aclk] [get_bd_pins DataMover/m00_axi_aclk] [get_bd_pins Gates/AXI4_Lite_ACLK] [get_bd_pins Gates_3L/AXI4_Lite_ACLK] [get_bd_pins Interrupt/clk] [get_bd_pins adc_debug/clk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins ila_Encoder/clk] [get_bd_pins ila_puconv/clk] [get_bd_pins proc_sys_reset_100MHz/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins smartconnect_1/aclk] [get_bd_pins timer_uptime_64bit/s_axi_aclk] [get_bd_pins uz_axi_testIP_0/AXI4_ACLK] [get_bd_pins uz_axi_testIP_0/IPCORE_CLK] [get_bd_pins uz_pu_con_ip_0/AXI4_Lite_ACLK] [get_bd_pins uz_pu_con_ip_0/IPCORE_CLK] [get_bd_pins vio_D34_test/clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxi_lpd_aclk]
  ...
  assign_bd_address -offset 0x800D0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs uz_pu_con_ip_0/AXI4_Lite/reg0] -force
  ...
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces DataMover/AXI2TCM_0/M00_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP6/LPD_DDR_HIGH]
