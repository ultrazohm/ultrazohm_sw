-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_park_transformation\uz_park_t_ip_src_uz_park_transformation.vhd
-- Created: 2022-08-11 11:31:04
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: uz_park_t_ip_src_uz_park_transformation
...
ENTITY uz_park_t_ip_src_uz_park_transformation IS
  PORT( clk                               :   IN    std_logic;
        reset                             :   IN    std_logic;
        clk_enable                        :   IN    std_logic;
        u1                                :   IN    std_logic_vector(26 DOWNTO 0);  -- sfix27_En24
        u2                                :   IN    std_logic_vector(26 DOWNTO 0);  -- sfix27_En24
...
END uz_park_t_ip_src_uz_park_transformation;


ARCHITECTURE rtl OF uz_park_t_ip_src_uz_park_transformation IS

  -- Component Declarations
  COMPONENT uz_park_t_ip_src_Detect_Rise_Positive
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  COMPONENT uz_park_t_ip_src_Sine_HDL_Optimized
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : uz_park_t_ip_src_Detect_Rise_Positive
    USE ENTITY work.uz_park_t_ip_src_Detect_Rise_Positive(rtl);

  FOR ALL : uz_park_t_ip_src_Sine_HDL_Optimized
    USE ENTITY work.uz_park_t_ip_src_Sine_HDL_Optimized(rtl);
  ...
  SIGNAL angle_el_signed                  : signed(23 DOWNTO 0);  -- sfix24_En20
  SIGNAL Delay2_out1                      : signed(23 DOWNTO 0);  -- sfix24_En20
  SIGNAL Switch2_out1                     : signed(23 DOWNTO 0);  -- sfix24_En20
  SIGNAL Delay6_out1                      : signed(23 DOWNTO 0);  -- sfix24_En20
  SIGNAL Product_mul_temp                 : signed(41 DOWNTO 0);  -- sfix42_En34
  ...
  SIGNAL Delay17_out1                     : signed(17 DOWNTO 0);  -- sfix18_En16
  SIGNAL switch_compare_1_2               : std_logic;
  SIGNAL u1_signed                        : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL Delay_out1                       : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL u1_1                             : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL u1_2                             : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL Divide_mul_temp                  : signed(44 DOWNTO 0);  -- sfix45_En40
  ...
  SIGNAL u2_signed                        : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL Delay1_out1                      : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL u2_1                             : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL u2_2                             : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL Divide1_mul_temp                 : signed(44 DOWNTO 0);  -- sfix45_En40
  ...
  SIGNAL Divide3_mul_temp                 : signed(44 DOWNTO 0);  -- sfix45_En40
  SIGNAL Divide3_out1                     : signed(26 DOWNTO 0);  -- sfix27_En16
  SIGNAL Divide2_mul_temp                 : signed(44 DOWNTO 0);  -- sfix45_En40
  ...
  SIGNAL u1_3                             : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL u2_3                             : signed(26 DOWNTO 0);  -- sfix27_En24

BEGIN
  u_Detect_Rise_Positive : uz_park_t_ip_src_Detect_Rise_Positive
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              U => Delay3_out1,
  ...
  u_Sine_HDL_Optimized : uz_park_t_ip_src_Sine_HDL_Optimized
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  Product_out1 <= Product_mul_temp(37 DOWNTO 20);
  ...
  Divide_mul_temp <= Delay17_out1 * u1_1;
  Divide_out1 <= resize(Divide_mul_temp(44 DOWNTO 24), 27);
  ...
  Divide1_mul_temp <= Delay16_out1 * u2_1;
  Divide1_out1 <= resize(Divide1_mul_temp(44 DOWNTO 24), 27);
  ...
  Divide3_mul_temp <= Delay17_out1 * u2_1;
  Divide3_out1 <= resize(Divide3_mul_temp(44 DOWNTO 24), 27);

  Divide2_mul_temp <= Delay16_out1 * u1_1;
  Divide2_out1 <= resize(Divide2_mul_temp(44 DOWNTO 24), 27);
