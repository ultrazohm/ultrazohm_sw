...
ARCHITECTURE rtl OF PWM_and_SS_control_V4_ip_src_LimitPulseWidth1 IS
  ...
  -- Signals
  SIGNAL ref_sig_signed                   : signed(17 DOWNTO 0);  -- sfix18_En16
...
BEGIN
  ...
  Relational_Operator_relop1 <= '1' WHEN ref_sig_signed > Add_out1 ELSE
      '0';
  ...
  Relational_Operator1_relop1 <= '1' WHEN ref_sig_signed < Saturation_out1 ELSE
      '0';
