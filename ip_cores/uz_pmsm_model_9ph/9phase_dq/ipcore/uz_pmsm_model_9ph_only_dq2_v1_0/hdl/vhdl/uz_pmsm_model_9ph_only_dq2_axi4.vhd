-- -------------------------------------------------------------
-- 
-- File Name: 9phase_dq/hdlsrc/Copy_of_uz_pmsm_model_9ph_21b_all_double/uz_pmsm_model_9ph_only_dq2_axi4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_9ph_only_dq2_axi4
-- Source Path: uz_pmsm_model_9ph_only_dq2/uz_pmsm_model_9ph_only_dq2_axi4
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_pmsm_model_9ph_only_dq2_axi4 IS
...
END uz_pmsm_model_9ph_only_dq2_axi4;


ARCHITECTURE rtl OF uz_pmsm_model_9ph_only_dq2_axi4 IS

  -- Component Declarations
  COMPONENT uz_pmsm_model_9ph_only_dq2_addr_decoder
  ...
  COMPONENT uz_pmsm_model_9ph_only_dq2_axi4_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_ARESETN                    :   IN    std_logic;  -- ufix1
          AXI4_AWID                       :   IN    std_logic_vector(11 DOWNTO 0);  -- ufix12
          AXI4_AWADDR                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  FOR ALL : uz_pmsm_model_9ph_only_dq2_addr_decoder
    USE ENTITY work.uz_pmsm_model_9ph_only_dq2_addr_decoder(rtl);

  FOR ALL : uz_pmsm_model_9ph_only_dq2_axi4_module
    USE ENTITY work.uz_pmsm_model_9ph_only_dq2_axi4_module(rtl);
  ...
  SIGNAL write_voltage_input_dq_axi_tmp   : vector_of_std_logic_vector32(0 TO 8);  -- ufix32 [9]
...
BEGIN
  u_uz_pmsm_model_9ph_only_dq2_addr_decoder_inst : uz_pmsm_model_9ph_only_dq2_addr_decoder
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
              ...
              read_M_Mi_axi => read_M_Mi_axi,  -- ufix32
              read_omega_out_axi => read_omega_out_axi,  -- ufix32
              read_theta_el_axi => read_theta_el_axi,  -- ufix32
              read_currents_dq_output_axi => read_currents_dq_output_axi,  -- ufix32 [9]
              read_voltage_input_dq_axi_fb => read_voltage_input_dq_axi_fb,  -- ufix32 [9]
              ...
              write_voltage_input_dq_axi => write_voltage_input_dq_axi_tmp,  -- ufix32 [9]
  ...
  u_uz_pmsm_model_9ph_only_dq2_axi4_module_inst : uz_pmsm_model_9ph_only_dq2_axi4_module
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
