-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\valen\Documents\repos\UZ\ultrazohm_sw\ip_cores\uz_inverter_3ph\hdl_prj\hdlsrc\uz_inverter_3phgm\uz_inverter_3ph_axi4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_inverter_3ph_axi4
-- Source Path: uz_inverter_3ph/uz_inverter_3ph_axi4
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_inverter_3ph_axi4 IS
...
END uz_inverter_3ph_axi4;


ARCHITECTURE rtl OF uz_inverter_3ph_axi4 IS

  -- Component Declarations
  COMPONENT uz_inverter_3ph_addr_decoder
  ...
  COMPONENT uz_inverter_3ph_axi4_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_ARESETN                    :   IN    std_logic;  -- ufix1
          AXI4_AWID                       :   IN    std_logic_vector(11 DOWNTO 0);  -- ufix12
          AXI4_AWADDR                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  FOR ALL : uz_inverter_3ph_addr_decoder
    USE ENTITY work.uz_inverter_3ph_addr_decoder(rtl);

  FOR ALL : uz_inverter_3ph_axi4_module
    USE ENTITY work.uz_inverter_3ph_axi4_module(rtl);
  ...
  SIGNAL write_u_dc_tmp                   : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_i_abc_ps_tmp               : vector_of_std_logic_vector32(0 TO 2);  -- ufix32 [3]
...
BEGIN
  u_uz_inverter_3ph_addr_decoder_inst : uz_inverter_3ph_addr_decoder
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
              ...
              read_u_abc_ps => read_u_abc_ps,  -- ufix32 [3]
              ...
              write_u_dc => write_u_dc_tmp,  -- ufix32
              write_i_abc_ps => write_i_abc_ps_tmp,  -- ufix32 [3]
              write_gate_ps => write_gate_ps  -- ufix1 [6]
              );

  u_uz_inverter_3ph_axi4_module_inst : uz_inverter_3ph_axi4_module
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
  ...
  write_u_dc <= write_u_dc_tmp;

  write_i_abc_ps <= write_i_abc_ps_tmp;
