-- -------------------------------------------------------------
-- 
-- File Name: /home/ts/Dokumente/ultrazohm_testbench/ultrazohm_sw/ip_cores/InterlockDeadtime_2L/hdlsrc/interlock_deadtime/interlock_ip_axi4_module.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: interlock_ip_axi4_module
-- Source Path: interlock_ip/interlock_ip_axi4/interlock_ip_axi4_module
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY interlock_ip_axi4_module IS
...
END interlock_ip_axi4_module;


ARCHITECTURE rtl OF interlock_ip_axi4_module IS

  -- Component Declarations
  COMPONENT interlock_ip_rdfifo_data
    PORT( clk                             :   IN    std_logic;
  ...
  COMPONENT interlock_ip_rdfifo_rid
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT interlock_ip_rdfifo_last
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : interlock_ip_rdfifo_data
    USE ENTITY work.interlock_ip_rdfifo_data(rtl);

  FOR ALL : interlock_ip_rdfifo_rid
    USE ENTITY work.interlock_ip_rdfifo_rid(rtl);

  FOR ALL : interlock_ip_rdfifo_last
    USE ENTITY work.interlock_ip_rdfifo_last(rtl);
...
BEGIN
  u_interlock_ip_rdfifo_data_inst : interlock_ip_rdfifo_data
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => const_1,
  ...
  u_interlock_ip_rdfifo_rid_inst : interlock_ip_rdfifo_rid
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => const_1,
  ...
  u_interlock_ip_rdfifo_last_inst : interlock_ip_rdfifo_last
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => const_1,
