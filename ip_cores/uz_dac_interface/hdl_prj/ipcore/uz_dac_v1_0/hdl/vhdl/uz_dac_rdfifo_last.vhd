-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/dac_spi/uz_dac_rdfifo_last.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_dac_rdfifo_last
-- Source Path: uz_dac/uz_dac_axi4/uz_dac_axi4_module/uz_dac_rdfifo_last
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END uz_dac_rdfifo_last;


ARCHITECTURE rtl OF uz_dac_rdfifo_last IS

  -- Component Declarations
  COMPONENT uz_dac_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : uz_dac_SimpleDualPortRAM_singlebit
    USE ENTITY work.uz_dac_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_uz_dac_rdfifo_last_classic_ram_singlebit : uz_dac_SimpleDualPortRAM_singlebit
