...
void test_uz_dqn_get_minibatch_from_buffer(void){
    ...
    uint32_t testindizes[MINIBATCHSIZE] = {2,0};
    ...
    uz_dqn_get_minibatch_from_buffer(buffertesting,r,q,a,getbackobs,MINIBATCHSIZE,NUMBEROFOBS,ind);
    float testrew[MINIBATCHSIZE] = {300.0f,-777.7f};
    float testqval[MINIBATCHSIZE] = {7.99f,543.3f};
