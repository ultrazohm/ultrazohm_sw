-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\parallel_delay_compensation_6phase\hdlsrc\parallel_delay_compensation_6phase\parallel_delay_compensation_6Phase_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: parallel_delay_compensation_6Phase_dut
-- Source Path: parallel_delay_compensation_6Phase/parallel_delay_compensation_6Phase_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY parallel_delay_compensation_6Phase_dut IS
...
END parallel_delay_compensation_6Phase_dut;


ARCHITECTURE rtl OF parallel_delay_compensation_6Phase_dut IS

  -- Component Declarations
  COMPONENT parallel_delay_compensation_6Phase_src_HDL_DUT
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : parallel_delay_compensation_6Phase_src_HDL_DUT
    USE ENTITY work.parallel_delay_compensation_6Phase_src_HDL_DUT(rtl);
...
BEGIN
  u_parallel_delay_compensation_6Phase_src_HDL_DUT : parallel_delay_compensation_6Phase_src_HDL_DUT
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
