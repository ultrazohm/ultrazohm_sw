...
set part_name [lindex $argv 12]

set cache_line_size [expr {16 * ($databus_width / 8)}]


# TODO replace design_dir and system_dir proj_path
...
synth_design -flatten_hierarchy rebuilt -top $top -part $part_name -mode out_of_context \
             -generic C_WAVEFRONT_SIZE=$wf_size \
	     -generic C_USABLE_ADDR_BITS=$vaddr_bits -generic C_NUM_COMPUTE_UNITS=$num_cus \
             ...
             -generic C_MAX_GRID_SIZE_BITS=$grid_bits -generic C_SECURE_TRANSACTION=$secure_txn

# TODO checkpoint_name $checkpoint_dir/trial_synth_${kernel_name}_cu${num_cus}_wf${wf_size}.dcp
write_checkpoint -force $checkpoint_name 
close_project
