-- -------------------------------------------------------------
-- 
-- File Name: /home/ts/Documents/integrate_nn_to_uz/ultrazohm_sw/ip_cores/nnAXI_v1_0/hdl_prj/hdlsrc/uz_mlp_three_layer/uz_mlp_three_layer_src_StateMachines.vhd
...
-- Source Path: uz_mlp_three_layer/pcu_mlp2_8parallel/LastLayer/StateMachines
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  Compare_To_Constant1_out1 <= '1' WHEN n_perceptron_tmp = to_unsigned(16#003#, 10) ELSE
      '0';
    ...
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        ELSIF cnt_enable = '1' THEN 
          IF n_perceptron_tmp >= to_unsigned(16#064#, 10) THEN 
            n_perceptron_tmp <= to_unsigned(16#000#, 10);
          ELSE 
