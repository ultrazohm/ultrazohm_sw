...
# %% Compare to quasi-random generator
fig, axs = plt.subplots(2, 1,layout='constrained')
axs[0].plot(xoshiro.number[start_x1:end_x1],xoshiro.number[start_x2:end_x2],'o')
axs[1].plot(halton.number[start_x1:end_x1],halton.number[start_x2:end_x2],'x')
axs[1].plot(halton_x.number[start_x1:end_x1],halton_y.number[start_x1:end_x1],'ro')
plt.show()