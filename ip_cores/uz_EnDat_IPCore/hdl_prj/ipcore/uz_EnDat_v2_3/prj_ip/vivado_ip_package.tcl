...
add_files -norecurse {../hdl/uz_EnDat_src_CLKCNTER_RAMPUP_block.vhd}
...
add_files -norecurse {../hdl/uz_EnDat_src_Subsystem6_block1.vhd}
...
set_property core_revision 2113325554 [ipx::current_core]
...
ipx::add_file {hdl/uz_EnDat_src_CLKCNTER_RAMPUP_block.vhd} [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/uz_EnDat_src_CLKCNTER_RAMPUP_block.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]]
ipx::add_file {hdl/uz_EnDat_src_CLKCNTER_RAMPUP_block.vhd} [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/uz_EnDat_src_CLKCNTER_RAMPUP_block.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]]
...
ipx::add_file {hdl/uz_EnDat_src_Subsystem6_block1.vhd} [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/uz_EnDat_src_Subsystem6_block1.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]]
ipx::add_file {hdl/uz_EnDat_src_Subsystem6_block1.vhd} [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/uz_EnDat_src_Subsystem6_block1.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]]
...
# Package IP
ipx::archive_core {../uz_EnDat_v2_3.zip} [ipx::current_core]
close_project
exit
