...
set_property PACKAGE_PIN K10 [get_ports {D3_OUT_inv[0]}]
set_property PACKAGE_PIN U2 [get_ports {D3_OUT_inv[1]}]
set_property PACKAGE_PIN L10 [get_ports {D3_OUT_inv[2]}]
set_property PACKAGE_PIN U3 [get_ports {D3_OUT_inv[3]}]
set_property PACKAGE_PIN U8 [get_ports {D3_OUT_inv[4]}]
set_property PACKAGE_PIN V1 [get_ports {D3_OUT_inv[5]}]
set_property PACKAGE_PIN V8 [get_ports {D3_OUT_inv_aux[0]}]
set_property PACKAGE_PIN V2 [get_ports {D3_OUT_inv_aux[1]}]
set_property PACKAGE_PIN V6 [get_ports {D3_OUT_inv_aux[2]}]
set_property PACKAGE_PIN W1 [get_ports {D3_OUT_inv_aux[3]}]
set_property PACKAGE_PIN V7 [get_ports {D3_OUT_inv_aux[4]}]
set_property PACKAGE_PIN W2 [get_ports {D3_OUT_inv_aux[5]}]
...
set_property PULLDOWN true [get_ports {D3_OUT_inv_aux[5]}]
set_property PULLDOWN true [get_ports {D3_OUT_inv_aux[4]}]
set_property PULLDOWN true [get_ports {D3_OUT_inv_aux[3]}]
set_property PULLDOWN true [get_ports {D3_OUT_inv_aux[2]}]
set_property PULLDOWN true [get_ports {D3_OUT_inv_aux[1]}]
set_property PULLDOWN true [get_ports {D3_OUT_inv_aux[0]}]
set_property PULLDOWN true [get_ports {D3_OUT_inv[5]}]
set_property PULLDOWN true [get_ports {D3_OUT_inv[4]}]
set_property PULLDOWN true [get_ports {D3_OUT_inv[3]}]
set_property PULLDOWN true [get_ports {D3_OUT_inv[2]}]
set_property PULLDOWN true [get_ports {D3_OUT_inv[1]}]
set_property PULLDOWN true [get_ports {D3_OUT_inv[0]}]
