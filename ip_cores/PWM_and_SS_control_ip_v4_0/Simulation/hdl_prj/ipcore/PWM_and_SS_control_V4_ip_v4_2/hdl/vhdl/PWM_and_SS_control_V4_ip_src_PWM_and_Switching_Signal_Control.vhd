...
BEGIN
  ...
  -- 
  -- sync enable of PWM instances

  u_GenPWM : PWM_and_SS_control_V4_ip_src_GenPWM
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              PWM_en_AXI => PWM_en_AXI_1,
  ...
  NOT_out1 <=  NOT count_src_ext_AXI;

  
  switch_compare_1 <= '1' WHEN NOT_out1 > '0' ELSE
      '0';
  ...
  PWM_en_AXI_1 <= Constant14_out1 WHEN switch_compare_1 = '0' ELSE
      AND_out1;
