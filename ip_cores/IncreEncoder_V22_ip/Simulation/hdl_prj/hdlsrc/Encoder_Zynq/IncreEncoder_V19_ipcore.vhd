-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Encoder_Zynq\IncreEncoder_V19_ipcore.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IncreEncoder_V19_ipcore
-- Source Path: IncreEncoder_V19_ipcore
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY IncreEncoder_V19_ipcore IS
  PORT( IPCORE_CLK                        :   IN    std_logic;  -- ufix1
        ...
        omega_rps                         :   OUT   std_logic_vector(17 DOWNTO 0);  -- ufix18
...
END IncreEncoder_V19_ipcore;


ARCHITECTURE rtl OF IncreEncoder_V19_ipcore IS

  -- Component Declarations
  COMPONENT IncreEncoder_V19_ipcore_axi_lite
  ...
  COMPONENT IncreEncoder_V19_ipcore_dut
  ...
  FOR ALL : IncreEncoder_V19_ipcore_axi_lite
    USE ENTITY work.IncreEncoder_V19_ipcore_axi_lite(rtl);

  FOR ALL : IncreEncoder_V19_ipcore_dut
    USE ENTITY work.IncreEncoder_V19_ipcore_dut(rtl);

  -- Signals
  SIGNAL reset                            : std_logic;
  SIGNAL reset_cm                         : std_logic;  -- ufix1
  SIGNAL reset_internal                   : std_logic;  -- ufix1
  SIGNAL omega_rps_AXI4_sig               : std_logic_vector(17 DOWNTO 0);  -- ufix18
  ...
  SIGNAL omega_rps_sig                    : std_logic_vector(17 DOWNTO 0);  -- ufix18
...
BEGIN
  u_IncreEncoder_V19_ipcore_axi_lite_inst : IncreEncoder_V19_ipcore_axi_lite
    PORT MAP( reset => reset,
              ...
              read_omega_rps_AXI4 => omega_rps_AXI4_sig,  -- sfix18_En8
  ...
  u_IncreEncoder_V19_ipcore_dut_inst : IncreEncoder_V19_ipcore_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              ...
              omega_rps => omega_rps_sig,  -- sfix18_En8
              omega_rps_AXI4 => omega_rps_AXI4_sig,  -- sfix18_En8
