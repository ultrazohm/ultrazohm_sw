-- -------------------------------------------------------------
-- 
-- File Name: uz_axi_testIP/hdlsrc/uz_axi_testIP/AXI_testI_ip_dut.vhd
...
ARCHITECTURE rtl OF AXI_testI_ip_dut IS
  ...
  COMPONENT AXI_testI_ip_src_uz_axi_testIP
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : AXI_testI_ip_src_uz_axi_testIP
    USE ENTITY work.AXI_testI_ip_src_uz_axi_testIP(rtl);
...
BEGIN
  u_AXI_testI_ip_src_uz_axi_testIP : AXI_testI_ip_src_uz_axi_testIP
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
