...
/**
 * @brief Resets the PMSM software model to its configured initial state.
 *
 * Mechanical speed and electrical states reset to zero, except that the d-axis flux
 * resets to Psi_PM_Vs when flux integration and preload_flux_state are enabled.
