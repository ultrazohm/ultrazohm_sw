-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_inverter_3phgm\uz_invert_3ph.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_invert_3ph
-- Source Path: uz_invert_3ph
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF uz_invert_3ph IS

  -- Component Declarations
  COMPONENT uz_invert_3ph_reset_sync
  ...
  FOR ALL : uz_invert_3ph_reset_sync
    USE ENTITY work.uz_invert_3ph_reset_sync(rtl);

  FOR ALL : uz_invert_3ph_axi4
    USE ENTITY work.uz_invert_3ph_axi4(rtl);

  FOR ALL : uz_invert_3ph_dut
    USE ENTITY work.uz_invert_3ph_dut(rtl);
...
BEGIN
  u_uz_invert_3ph_reset_sync_inst : uz_invert_3ph_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_uz_invert_3ph_axi4_inst : uz_invert_3ph_axi4
  ...
  u_uz_invert_3ph_dut_inst : uz_invert_3ph_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  ip_timestamp <= unsigned'(X"8362826F");
