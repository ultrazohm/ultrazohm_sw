-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\parallel_phase_voltages_6Phase\hdlsrc\parallel_phase_voltages_per_switching_state_6\parallel_phase_voltages_per_switching_state_src_nfp_convert_sfix_24_En20_to_single.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: parallel_phase_voltages_per_switching_state_src_nfp_convert_sfix_24_En20_to_single
-- Source Path: parallel_phase_voltages_per_switching_state_6/Phase_voltages_per_switching_state/nfp_convert_sfix_24_En20_to_single
-- Hierarchy Level: 1
-- 
...
ENTITY parallel_phase_voltages_per_switching_state_src_nfp_convert_sfix_24_En20_to_single IS
...
END parallel_phase_voltages_per_switching_state_src_nfp_convert_sfix_24_En20_to_single;


ARCHITECTURE rtl OF parallel_phase_voltages_per_switching_state_src_nfp_convert_sfix_24_En20_to_single IS

  -- Signals
  SIGNAL nfp_in_signed                    : signed(23 DOWNTO 0);  -- sfix24_En20
  SIGNAL Delay_out1                       : signed(23 DOWNTO 0);  -- sfix24_En20
  ...
  SIGNAL Delay_out1_dtc                   : unsigned(23 DOWNTO 0);  -- ufix24_En20
  SIGNAL Unary_Minus_cast                 : signed(24 DOWNTO 0);  -- sfix25_En20
  SIGNAL Unary_Minus_cast_1               : signed(24 DOWNTO 0);  -- sfix25_En20
  SIGNAL Unary_Minus_out1                 : signed(23 DOWNTO 0);  -- sfix24_En20
  SIGNAL Unary_Minus_out1_dtc             : unsigned(23 DOWNTO 0);  -- ufix24_En20
  SIGNAL Switch_out1                      : unsigned(23 DOWNTO 0);  -- ufix24_En20
  SIGNAL Data_Type_Conversion_out1        : unsigned(127 DOWNTO 0);  -- ufix128_En20
  ...
  SIGNAL Delay2_reg_next                  : vector_of_unsigned128(0 TO 2);  -- ufix128_En20 [3]
  SIGNAL Delay2_out1_3                    : unsigned(127 DOWNTO 0);  -- ufix128_En20
  ...
  SIGNAL Shift_Arithmetic_out1            : unsigned(127 DOWNTO 0);  -- ufix128_En20
...
BEGIN
  ...
  CompareToZero1_out1 <= '1' WHEN Delay_out1 = to_signed(16#000000#, 24) ELSE
      '0';
  ...
  Compare_To_Zero_out1 <= '1' WHEN Delay_out1 < to_signed(16#000000#, 24) ELSE
      '0';
  ...
  Unary_Minus_cast <= resize(Delay_out1, 25);
  ...
  Constant_out1 <= to_signed(16#6A#, 8);
