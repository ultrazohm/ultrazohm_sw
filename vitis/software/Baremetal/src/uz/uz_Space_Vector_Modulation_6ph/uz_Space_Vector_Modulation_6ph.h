...
struct uz_svm_asym_6ph_CSVPWM24_out{
    ...
    bool limited_alphabeta;                     /**< limited flag for setpoints in alpha beta */
    bool limited_xy;                            /**< limited flag for setpoints in xy */
};

/**
 * @brief SVM 6ph with stationary input
 * 
 * @param setpoints reference voltages (controller output)
