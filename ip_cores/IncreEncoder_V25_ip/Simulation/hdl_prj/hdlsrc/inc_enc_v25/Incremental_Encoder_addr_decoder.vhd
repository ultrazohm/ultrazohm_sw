-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\inc_enc_v25\Incremental_Encoder_addr_decoder.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Incremental_Encoder_addr_decoder
-- Source Path: Incremental_Encoder/Incremental_Encoder_axi_lite/Incremental_Encoder_addr_decoder
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Incremental_Encoder_addr_decoder IS
...
END Incremental_Encoder_addr_decoder;


ARCHITECTURE rtl OF Incremental_Encoder_addr_decoder IS
...
BEGIN
  ...
  decode_sel_omega_MA_N4_AXI_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0040#, 14) ELSE
      '0';
  ...
  decode_rd_omega_MA_N4_AXI_1_1 <= decode_rd_ip_timestamp_1_1 WHEN decode_sel_omega_MA_N4_AXI_1_1 = '0' ELSE
  ...
  decode_rd_omega_AXI4_1_1 <= decode_rd_omega_MA_N4_AXI_1_1 WHEN decode_sel_omega_AXI4_1_1 = '0' ELSE
  ...
  data_read <= std_logic_vector(decode_rd_countPerPeriod_AXI4_1_1);
