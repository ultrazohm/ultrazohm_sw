...
void JavaScope_update(DS_Data* data){
	...
	js_slowDataArray[JSSD_FLOAT_u_d].f = PID_Data.PID_ActualValues.v_dq.d;
	js_slowDataArray[JSSD_FLOAT_u_q].f = PID_Data.PID_ActualValues.v_dq.q;
	...
	js_slowDataArray[JSSD_FLOAT_Stribtorque].f = PID_Data.PID_FrictionID_Output.BrkTorque;
	js_slowDataArray[JSSD_FLOAT_Coulombtorque].f = PID_Data.PID_FrictionID_Output.CoulTorque;
	js_slowDataArray[JSSD_FLOAT_Viscotorque].f = PID_Data.PID_FrictionID_Output.ViscoTorque;
	...
	js_slowDataArray[JSSD_FLOAT_Wtemp].f = PID_Data.PID_OnlineID_Output.Wtemp;
	...
	js_slowDataArray[JSSD_FLOAT_Ld_Online].f = PID_Data.PID_OnlineID_Output.Ld_out;
	js_slowDataArray[JSSD_FLOAT_Lq_Online].f = PID_Data.PID_OnlineID_Output.Lq_out;
	js_slowDataArray[JSSD_FLOAT_PsiPM_Online].f = PID_Data.PID_OnlineID_Output.psi_pm_out;
	js_slowDataArray[JSSD_FLOAT_Rs_Online].f = PID_Data.PID_OnlineID_Output.Rph_out;
