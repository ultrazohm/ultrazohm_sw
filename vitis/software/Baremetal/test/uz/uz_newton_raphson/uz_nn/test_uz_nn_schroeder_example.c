...
//delta
float delt_1[NUMBER_OF_NEURONS_IN_FIRST_LAYER] = {0};
float delt_2[NUMBER_OF_NEURONS_IN_SECOND_LAYER] = {0};
float delt_3[NUMBER_OF_OUTPUTS] = {0};
// error
float e_1[2]={1.0f};
float e_2[2]={1.0f};
float e_3[1]={1.0f};
...
struct uz_nn_layer_config config[NUMBER_OF_HIDDEN_LAYER] = {
    [0] = {
        ...
        .length_of_delta = UZ_MATRIX_SIZE(delt_1),
