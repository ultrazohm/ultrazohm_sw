-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_pmsm_model_6ph_dqxy\uz_pmsm_model_6ph_dqxy_axi4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_6ph_dqxy_axi4
-- Source Path: uz_pmsm_model_6ph_dqxy/uz_pmsm_model_6ph_dqxy_axi4
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_pmsm_model_6ph_dqxy_axi4 IS
...
END uz_pmsm_model_6ph_dqxy_axi4;


ARCHITECTURE rtl OF uz_pmsm_model_6ph_dqxy_axi4 IS

  -- Component Declarations
  COMPONENT uz_pmsm_model_6ph_dqxy_addr_decoder
  ...
  COMPONENT uz_pmsm_model_6ph_dqxy_axi4_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_ARESETN                    :   IN    std_logic;  -- ufix1
          AXI4_AWID                       :   IN    std_logic_vector(11 DOWNTO 0);  -- ufix12
          AXI4_AWADDR                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  FOR ALL : uz_pmsm_model_6ph_dqxy_addr_decoder
    USE ENTITY work.uz_pmsm_model_6ph_dqxy_addr_decoder(rtl);

  FOR ALL : uz_pmsm_model_6ph_dqxy_axi4_module
    USE ENTITY work.uz_pmsm_model_6ph_dqxy_axi4_module(rtl);
  ...
  SIGNAL write_reciprocal_L_x_tmp         : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_reciprocal_L_y_tmp         : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_inputs_tmp                 : vector_of_std_logic_vector32(0 TO 5);  -- ufix32 [6]
...
BEGIN
  u_uz_pmsm_model_6ph_dqxy_addr_decoder_inst : uz_pmsm_model_6ph_dqxy_addr_decoder
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
              ...
              read_outputs => read_outputs,  -- ufix32 [6]
              ...
              write_reciprocal_L_x => write_reciprocal_L_x_tmp,  -- ufix32
              write_reciprocal_L_y => write_reciprocal_L_y_tmp,  -- ufix32
              write_inputs => write_inputs_tmp  -- ufix32 [6]
              );

  u_uz_pmsm_model_6ph_dqxy_axi4_module_inst : uz_pmsm_model_6ph_dqxy_axi4_module
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
  ...
  write_reciprocal_L_x <= write_reciprocal_L_x_tmp;

  write_reciprocal_L_y <= write_reciprocal_L_y_tmp;
