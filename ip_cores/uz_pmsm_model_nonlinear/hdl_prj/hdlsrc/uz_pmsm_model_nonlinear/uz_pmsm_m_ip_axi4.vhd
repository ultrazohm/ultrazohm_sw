-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\Philipp\ultrazohm\ultrazohm_sw\ip_cores\uz_pmsm_model_nonlinear\hdl_prj\hdlsrc\uz_pmsm_model_nonlinear\uz_pmsm_m_ip_axi4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_m_ip_axi4
-- Source Path: uz_pmsm_m_ip/uz_pmsm_m_ip_axi4
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END uz_pmsm_m_ip_axi4;


ARCHITECTURE rtl OF uz_pmsm_m_ip_axi4 IS
  ...
  COMPONENT uz_pmsm_m_ip_axi4_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_ARESETN                    :   IN    std_logic;  -- ufix1
          AXI4_AWID                       :   IN    std_logic_vector(11 DOWNTO 0);  -- ufix12
          AXI4_AWADDR                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  FOR ALL : uz_pmsm_m_ip_axi4_module
    USE ENTITY work.uz_pmsm_m_ip_axi4_module(rtl);
...
BEGIN
  ...
  u_uz_pmsm_m_ip_axi4_module_inst : uz_pmsm_m_ip_axi4_module
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
