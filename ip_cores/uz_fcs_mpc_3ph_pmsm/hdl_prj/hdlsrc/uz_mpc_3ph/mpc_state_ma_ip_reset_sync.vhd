-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_mpc_3ph\mpc_state_ma_ip_reset_sync.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mpc_state_ma_ip_reset_sync
-- Source Path: mpc_state_ma_ip/mpc_state_ma_ip_reset_sync
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mpc_state_ma_ip_reset_sync IS
  PORT( clk                               :   IN    std_logic;
        reset_in                          :   IN    std_logic;  -- ufix1
        reset_out                         :   OUT   std_logic  -- ufix1
        );
END mpc_state_ma_ip_reset_sync;


ARCHITECTURE rtl OF mpc_state_ma_ip_reset_sync IS
