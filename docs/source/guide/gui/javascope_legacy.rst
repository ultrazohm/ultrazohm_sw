...
The GUI is shown in :numref:`javascope_legacy_gui`. 

.. _javascope_legacy_gui:

.. figure:: ./images_javascope_legacy/gui1.png
   :align: center
...
.. _javascope_legacy_setup:

.. figure:: ./images_javascope_legacy/setupscope.png
   :scale: 90 %
   :align: center
...
.. _javascope_legacy_control:

.. figure:: ./images_javascope_legacy/control.png
   :align: center
   :scale: 90 %
...
.. figure:: ./images_javascope_legacy/loggingpanel.png
   :align: center
...
#. The button ``Log FastData`` enables or disables the logging of the fast data (the selection in the :ref:`javascope_legacy_setup_scope` panel). 
...
The customization workflow for the legacy GUI and the current GUI is documented in :ref:`javascope_customizing`.
...
.. warning::
   If the legacy GUI is distorted or the font is not readable, verify the Java installation as described in :ref:`install_java`.
