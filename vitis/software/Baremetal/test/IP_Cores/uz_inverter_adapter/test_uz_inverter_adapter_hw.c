...
void tearDown(void)
{
    ...
    void test_uz_inverter_adapter_hw_get_PWMFreqTicks_H1_with_zero_base_address(void)
    {
        uint32_t PWMFreqTicks_H1 = 11000;
    ...
    void test_uz_inverter_adapter_hw_get_PWMhightimeTicks_H1_with_zero_base_address(void)
    {
        uint32_t PWMhightimeTicks_H1 = 715;
        // Tell the test that we do not care how often this function is called
    ...
    void test_uz_inverter_adapter_hw_get_PWMlowtimeTicks_H1_with_zero_base_address(void)
    {
        uint32_t PWMlowtimeTicks_H1 = 10284;
        // Tell the test that we do not care how often this function is called
    ...
    void test_uz_inverter_adapter_hw_get_PWMFreqTicks_L1_with_zero_base_address(void)
    {
        uint32_t PWMFreqTicks_L1 = 11000;
        // Tell the test that we do not care how often this function is called
    ...
    void test_uz_inverter_adapter_hw_get_PWMhightimeTicks_L1_with_zero_base_address(void)
    {
        uint32_t PWMhightimeTicks_L1 = 715;
        // Tell the test that we do not care how often this function is called
    ...
    void test_uz_inverter_adapter_hw_get_PWMlowtimeTicks_L1_with_zero_base_address(void)
    {
        uint32_t PWMlowtimeTicks_L1 = 10285;
        // Tell the test that we do not care how often this function is called
    ...
    void test_uz_inverter_adapter_hw_get_PWMFreqTicks_H2_with_zero_base_address(void)
    {
        uint32_t PWMFreqTicks_H2 = 11000;
        // Tell the test that we do not care how often this function is called
    ...
    void test_uz_inverter_adapter_hw_get_PWMhightimeTicks_H2_with_zero_base_address(void)
    {
        uint32_t PWMhightimeTicks_H2 = 715;
        // Tell the test that we do not care how often this function is called
    ...
    void test_uz_inverter_adapter_hw_get_PWMlowtimeTicks_H2_with_zero_base_address(void)
    {
        uint32_t PWMlowtimeTicks_H2 = 10285;
        // Tell the test that we do not care how often this function is called
    ...
    void test_uz_inverter_adapter_hw_get_PWMFreqTicks_L2_with_zero_base_address(void)
    {
        uint32_t PWMFreqTicks_L2 = 11000;
        // Tell the test that we do not care how often this function is called
    ...
    void test_uz_inverter_adapter_hw_get_PWMhightimeTicks_L2_with_zero_base_address(void)
    {
        uint32_t PWMhightimeTicks_L2 = 715;
        // Tell the test that we do not care how often this function is called
    ...
    void test_uz_inverter_adapter_hw_get_PWMlowtimeTicks_L2_with_zero_base_address(void)
    {
        uint32_t PWMlowtimeTicks_L2 = 10285;
        // Tell the test that we do not care how often this function is called
    ...
    void test_uz_inverter_adapter_hw_get_PWMFreqTicks_H3_with_zero_base_address(void)
    {
        uint32_t PWMFreqTicks_H3 = 11000;
        // Tell the test that we do not care how often this function is called
    ...
    void test_uz_inverter_adapter_hw_get_PWMhightimeTicks_H3_with_zero_base_address(void)
    {
        uint32_t PWMhightimeTicks_H3 = 715;
        // Tell the test that we do not care how often this function is called
    ...
    void test_uz_inverter_adapter_hw_get_PWMlowtimeTicks_H3_with_zero_base_address(void)
    {
        uint32_t PWMlowtimeTicks_H3 = 10285;
        // Tell the test that we do not care how often this function is called
    ...
    void test_uz_inverter_adapter_hw_get_PWMFreqTicks_L3_with_zero_base_address(void)
    {
        uint32_t PWMFreqTicks_L3 = 11000;
        // Tell the test that we do not care how often this function is called
    ...
    void test_uz_inverter_adapter_hw_get_PWMhightimeTicks_L3_with_zero_base_address(void)
    {
        uint32_t PWMhightimeTicks_L3 = 715;
        // Tell the test that we do not care how often this function is called
    ...
    void test_uz_inverter_adapter_hw_get_PWMlowtimeTicks_L3_with_zero_base_address(void)
    {
        uint32_t PWMlowtimeTicks_L3 = 10285;
        // Tell the test that we do not care how often this function is called
    ...
    void test_uz_inverter_adapter_hw_get_OC_with_zero_base_address(void)
    {
        uint32_t axi_read_OC = 63;
        // Tell the test that we do not care how often this function is called
    ...
    void test_uz_inverter_adapter_hw_get_FAULT_with_zero_base_address(void)
    {
        uint32_t axi_read_FAULT = 63;
        // Tell the test that we do not care how often this function is called
    ...
    void test_uz_inverter_adapter_hw_get_I_DIAG_with_zero_base_address(void)
    {
        uint32_t axi_read_I_DIAG = 15;
        // Tell the test that we do not care how often this function is called
    ...
    void test_uz_inverter_adapter_hw_set_PWM_EN(void)
    {
        ...
        uz_axi_write_uint32_Expect(TEST_BASE_ADDRESS + AXI_PWM_Enable_Data_uz_d_inverter_adapter, PWM_on_off);
        uz_inverter_adapter_hw_set_PWM_EN(TEST_BASE_ADDRESS, PWM_on_off);
    }

    void test_uz_inverter_adapter_hw_set_PWM_EN_with_zero_base_address(void)
    {
        uint32_t PWM_on_off = true;
        // Tell the test that we do not care how often this function is called
        uz_axi_write_uint32_Ignore();
        // Test passes if an assert fails in the function under test
        TEST_ASSERT_FAIL_ASSERT(uz_inverter_adapter_hw_set_PWM_EN(0,PWM_on_off))
    }
