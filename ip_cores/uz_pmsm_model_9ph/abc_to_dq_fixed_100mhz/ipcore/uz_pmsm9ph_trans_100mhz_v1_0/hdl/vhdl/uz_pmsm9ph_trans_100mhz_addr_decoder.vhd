-- -------------------------------------------------------------
-- 
-- File Name: abc_to_dq_fixed_100mhz/hdlsrc/Copy_of_uz_pmsm_model_9ph_21b_all_double/uz_pmsm9ph_trans_100mhz_addr_decoder.vhd
...
ARCHITECTURE rtl OF uz_pmsm9ph_trans_100mhz_addr_decoder IS
  ...
  SIGNAL read_i_abc_out_axi_signed        : vector_of_signed25(0 TO 8);  -- sfix25_En12 [9]
  SIGNAL sync_reg_i_abc_out_axi           : vector_of_signed25(0 TO 8);  -- sfix25_En12 [9]
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        sync_reg_i_abc_out_axi(0) <= to_signed(16#0000000#, 25);
        sync_reg_i_abc_out_axi(1) <= to_signed(16#0000000#, 25);
        sync_reg_i_abc_out_axi(2) <= to_signed(16#0000000#, 25);
        sync_reg_i_abc_out_axi(3) <= to_signed(16#0000000#, 25);
        sync_reg_i_abc_out_axi(4) <= to_signed(16#0000000#, 25);
        sync_reg_i_abc_out_axi(5) <= to_signed(16#0000000#, 25);
        sync_reg_i_abc_out_axi(6) <= to_signed(16#0000000#, 25);
        sync_reg_i_abc_out_axi(7) <= to_signed(16#0000000#, 25);
        sync_reg_i_abc_out_axi(8) <= to_signed(16#0000000#, 25);
