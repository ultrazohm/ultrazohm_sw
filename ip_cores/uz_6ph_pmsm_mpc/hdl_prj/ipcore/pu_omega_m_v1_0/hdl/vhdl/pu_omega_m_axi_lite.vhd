-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\external_state_machine\pu_omega_m_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: pu_omega_m_axi_lite
-- Source Path: pu_omega_m/pu_omega_m_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END pu_omega_m_axi_lite;


ARCHITECTURE rtl OF pu_omega_m_axi_lite IS

  -- Component Declarations
  COMPONENT pu_omega_m_addr_decoder
  ...
  COMPONENT pu_omega_m_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : pu_omega_m_addr_decoder
    USE ENTITY work.pu_omega_m_addr_decoder(rtl);

  FOR ALL : pu_omega_m_axi_lite_module
    USE ENTITY work.pu_omega_m_axi_lite_module(rtl);
...
BEGIN
  u_pu_omega_m_addr_decoder_inst : pu_omega_m_addr_decoder
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
              ...
              read_out1_AXI => read_out1_AXI,  -- sfix24_En11
              data_read => top_data_read,  -- ufix32
              write_axi_enable => write_axi_enable,  -- ufix1
              write_AXI_pu_conv_in => write_AXI_pu_conv_in_tmp  -- ufix18_En18
              );

  u_pu_omega_m_axi_lite_module_inst : pu_omega_m_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
