...
int32_t uz_iic_write_reg16(struct uz_iic_ *self, uint8_t regaddr, uint16_t data);
int32_t uz_iic_write_raw(struct uz_iic_ *self, uint8_t* data, int32_t cnt);
int32_t uz_iic_a8read_data(struct uz_iic_ *self, uint8_t regaddr, uint8_t*, int32_t cnt);
int32_t uz_iic_a16read_data(struct uz_iic_ *self, uint16_t regaddr, uint8_t*, int32_t cnt);
