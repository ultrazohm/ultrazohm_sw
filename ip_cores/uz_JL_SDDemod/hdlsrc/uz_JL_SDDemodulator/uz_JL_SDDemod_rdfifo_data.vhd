-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\jonat\Documents\ultrazohm_sw\ip_cores\uz_JL_SDDemod\hdlsrc\uz_JL_SDDemodulator\uz_JL_SDDemod_rdfifo_data.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_JL_SDDemod_rdfifo_data
-- Source Path: uz_JL_SDDemod/uz_JL_SDDemod_axi4/uz_JL_SDDemod_axi4_module/uz_JL_SDDemod_rdfifo_data
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_JL_SDDemod_rdfifo_data IS
...
END uz_JL_SDDemod_rdfifo_data;


ARCHITECTURE rtl OF uz_JL_SDDemod_rdfifo_data IS

  -- Component Declarations
  COMPONENT uz_JL_SDDemod_SimpleDualPortRAM_generic
  ...
  FOR ALL : uz_JL_SDDemod_SimpleDualPortRAM_generic
    USE ENTITY work.uz_JL_SDDemod_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_uz_JL_SDDemod_rdfifo_data_classic_ram_generic : uz_JL_SDDemod_SimpleDualPortRAM_generic
