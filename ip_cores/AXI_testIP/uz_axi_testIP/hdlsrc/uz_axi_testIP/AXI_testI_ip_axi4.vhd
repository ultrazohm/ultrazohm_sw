-- -------------------------------------------------------------
-- 
-- File Name: uz_axi_testIP/hdlsrc/uz_axi_testIP/AXI_testI_ip_axi4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: AXI_testI_ip_axi4
-- Source Path: AXI_testI_ip/AXI_testI_ip_axi4
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END AXI_testI_ip_axi4;


ARCHITECTURE rtl OF AXI_testI_ip_axi4 IS

  -- Component Declarations
  COMPONENT AXI_testI_ip_addr_decoder
  ...
  COMPONENT AXI_testI_ip_axi4_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_ARESETN                    :   IN    std_logic;  -- ufix1
          AXI4_AWID                       :   IN    std_logic_vector(11 DOWNTO 0);  -- ufix12
          AXI4_AWADDR                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  FOR ALL : AXI_testI_ip_addr_decoder
    USE ENTITY work.AXI_testI_ip_addr_decoder(rtl);

  FOR ALL : AXI_testI_ip_axi4_module
    USE ENTITY work.AXI_testI_ip_axi4_module(rtl);
...
BEGIN
  u_AXI_testI_ip_addr_decoder_inst : AXI_testI_ip_addr_decoder
  ...
  u_AXI_testI_ip_axi4_module_inst : AXI_testI_ip_axi4_module
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
