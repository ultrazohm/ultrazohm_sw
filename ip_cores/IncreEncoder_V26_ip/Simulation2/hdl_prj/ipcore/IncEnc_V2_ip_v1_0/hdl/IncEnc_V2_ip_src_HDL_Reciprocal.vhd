-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/inc_enc_v26/IncEnc_V2_ip_src_HDL_Reciprocal.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IncEnc_V2_ip_src_HDL_Reciprocal
...
ENTITY IncEnc_V2_ip_src_HDL_Reciprocal IS
...
END IncEnc_V2_ip_src_HDL_Reciprocal;


ARCHITECTURE rtl OF IncEnc_V2_ip_src_HDL_Reciprocal IS

  -- Component Declarations
  COMPONENT IncEnc_V2_ip_src_HDL_Reciprocal_core
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : IncEnc_V2_ip_src_HDL_Reciprocal_core
    USE ENTITY work.IncEnc_V2_ip_src_HDL_Reciprocal_core(rtl);
...
BEGIN
  ...
  u_core_stage1_inst : IncEnc_V2_ip_src_HDL_Reciprocal_core
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_core_stage2_inst : IncEnc_V2_ip_src_HDL_Reciprocal_core
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_core_stage3_inst : IncEnc_V2_ip_src_HDL_Reciprocal_core
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
