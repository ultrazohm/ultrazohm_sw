-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\inc_enc_v26\IncEnc_src_invt_mult.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IncEnc_src_invt_mult
-- Source Path: inc_enc_v26/IncEnc_V25/speed/calc_omega/invt_mult
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY IncEnc_src_invt_mult IS
...
END IncEnc_src_invt_mult;


ARCHITECTURE rtl OF IncEnc_src_invt_mult IS

  -- Component Declarations
  COMPONENT IncEnc_src_Math_Reciprocal
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_5987_0                    :   IN    std_logic;
  ...
  FOR ALL : IncEnc_src_Math_Reciprocal
    USE ENTITY work.IncEnc_src_Math_Reciprocal(rtl);
...
BEGIN
  ...
  u_Math_Reciprocal : IncEnc_src_Math_Reciprocal
    PORT MAP( clk => clk,
              reset_x => reset_x,
