-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\parallel_8_vsd_and_park\hdlsrc\VSD_and_Park_transformation_6Phase\parallel_8_sim_vsd_and_park_src_Sine_HDL_Optimized1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: parallel_8_sim_vsd_and_park_src_Sine_HDL_Optimized1
-- Source Path: VSD_and_Park_transformation_6Phase/vsd_and_park_tra1/Sine HDL Optimized1
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY parallel_8_sim_vsd_and_park_src_Sine_HDL_Optimized1 IS
...
END parallel_8_sim_vsd_and_park_src_Sine_HDL_Optimized1;


ARCHITECTURE rtl OF parallel_8_sim_vsd_and_park_src_Sine_HDL_Optimized1 IS
  ...
  CONSTANT Look_Up_Table_data_2           : vector_of_signed16(0 TO 511) := 
    (to_signed(16#0000#, 16), to_signed(16#0032#, 16), to_signed(16#0065#, 16), to_signed(16#0097#, 16),
     to_signed(16#00C9#, 16), to_signed(16#00FC#, 16), to_signed(16#012E#, 16), to_signed(16#0161#, 16),
     to_signed(16#0193#, 16), to_signed(16#01C5#, 16), to_signed(16#01F8#, 16), to_signed(16#022A#, 16),
     to_signed(16#025C#, 16), to_signed(16#028F#, 16), to_signed(16#02C1#, 16), to_signed(16#02F3#, 16),
  ...
  -- Signals
  SIGNAL u_signed                         : signed(17 DOWNTO 0);  -- sfix18_En14
...
BEGIN
  ...
  insig_out1 <= unsigned(u_signed(13 DOWNTO 3));

  Point50_out1 <= to_unsigned(16#8000#, 16);

  LTEp50_1_cast <= insig_out1 & '0' & '0' & '0' & '0' & '0';
  ...
  insig_out1_1 <= unsigned(u_signed(13 DOWNTO 3));

  Point25_out1_1 <= to_unsigned(16#4000#, 16);

  LTEp25_1_cast_1 <= insig_out1_1 & '0' & '0' & '0' & '0' & '0';
  ...
  LTEp50_1_cast_1 <= insig_out1_1 & '0' & '0' & '0' & '0' & '0';
  ...
  Negate_cast_2 <= resize(Look_Up_Table_out1_3, 17);
