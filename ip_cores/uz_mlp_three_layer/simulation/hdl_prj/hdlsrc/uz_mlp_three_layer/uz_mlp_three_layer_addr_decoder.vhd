...
ARCHITECTURE rtl OF uz_mlp_three_layer_addr_decoder IS
  ...
  SIGNAL decode_sel_disable_pl_trigger_1_1 : std_logic;  -- ufix1
  SIGNAL reg_enb_disable_pl_trigger_1_1   : std_logic;  -- ufix1
  SIGNAL data_in_disable_pl_trigger       : std_logic;  -- ufix1
  SIGNAL data_reg_disable_pl_trigger_1_1  : std_logic;  -- ufix1
  SIGNAL write_concats_disable_pl_trigger_1 : std_logic;  -- ufix1
...
BEGIN
  ...
  decode_sel_axi_bias_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0041#, 14) ELSE
      '0';
  ...
  decode_sel_axi_weight_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0042#, 14) ELSE
      '0';
  ...
  decode_sel_axi_bias_addr_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0043#, 14) ELSE
      '0';
  ...
  decode_sel_axi_weight_addr_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0044#, 14) ELSE
      '0';
  ...
  decode_sel_axi_wrEnBias_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0045#, 14) ELSE
      '0';
  ...
  decode_sel_axi_wrEnWeights_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0046#, 14) ELSE
      '0';
  ...
  decode_sel_axi_layerNr_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0047#, 14) ELSE
      '0';
  ...
  decode_sel_use_axi_input_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0048#, 14) ELSE
      '0';
  ...
  decode_sel_axi_number_of_inputs_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0049#, 14) ELSE
      '0';
  ...
  decode_sel_axi_output_number_configuration_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#004A#, 14) ELSE
      '0';
  ...
  decode_sel_disable_pl_trigger_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#004B#, 14) ELSE
      '0';

  reg_enb_disable_pl_trigger_1_1 <= decode_sel_disable_pl_trigger_1_1 AND wr_enb;

  data_in_disable_pl_trigger <= data_write_unsigned(0);

  reg_disable_pl_trigger_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_disable_pl_trigger_1_1 <= '0';
      ELSIF enb = '1' AND reg_enb_disable_pl_trigger_1_1 = '1' THEN
        data_reg_disable_pl_trigger_1_1 <= data_in_disable_pl_trigger;
      END IF;
    END IF;
  END PROCESS reg_disable_pl_trigger_1_1_process;


  write_concats_disable_pl_trigger_1 <= data_reg_disable_pl_trigger_1_1;

  write_disable_pl_trigger <= write_concats_disable_pl_trigger_1;
