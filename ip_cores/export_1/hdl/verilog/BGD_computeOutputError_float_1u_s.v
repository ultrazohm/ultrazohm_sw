...
input  [14:0] p_results_offset_dout;
...
input  [8:0] p_classes_offset_dout;
...
reg   [0:0] icmp_ln316_reg_190;
reg   [0:0] icmp_ln316_reg_190_pp0_iter6_reg;
reg    p_n_blk_n;
...
reg    ap_block_state1;
reg   [14:0] p_results_offset_read_reg_180;
reg   [8:0] p_classes_offset_read_reg_185;
wire   [0:0] icmp_ln316_fu_132_p2;
...
reg   [0:0] icmp_ln316_reg_190_pp0_iter1_reg;
reg   [0:0] icmp_ln316_reg_190_pp0_iter2_reg;
reg   [0:0] icmp_ln316_reg_190_pp0_iter3_reg;
reg   [0:0] icmp_ln316_reg_190_pp0_iter4_reg;
reg   [0:0] icmp_ln316_reg_190_pp0_iter5_reg;
wire   [31:0] add_ln316_fu_137_p2;
...
wire   [14:0] trunc_ln316_1_fu_147_p1;
wire   [14:0] sum_i_fu_151_p2;
wire   [8:0] trunc_ln316_fu_143_p1;
wire   [8:0] sum3_i_fu_161_p2;
reg    grp_fu_128_ce;
...
always @ (posedge ap_clk) begin
    if ((~((ap_start == 1'b0) | (p_n_out_full_n == 1'b0) | (p_classes_offset_empty_n == 1'b0) | (p_results_offset_empty_n == 1'b0) | (p_n_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        i_reg_117 <= 32'd0;
    end else if (((icmp_ln316_fu_132_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln316_reg_190_pp0_iter5_reg == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln316_reg_190 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if ((icmp_ln316_fu_132_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((icmp_ln316_reg_190_pp0_iter6_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter7 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln316_reg_190_pp0_iter6_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter7 == 1'b1))) begin
        p_out_write = 1'b1;
    end else begin
        p_out_write = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((icmp_ln316_fu_132_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) & ~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter7 == 1'b1) & (ap_enable_reg_pp0_iter6 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((icmp_ln316_fu_132_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter7 == 1'b1) & (ap_enable_reg_pp0_iter6 == 1'b0)))) begin
...
assign add_ln316_fu_137_p2 = (i_reg_117 + 32'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((icmp_ln316_reg_190_pp0_iter6_reg == 1'd0) & (ap_enable_reg_pp0_iter7 == 1'b1) & (p_out_full_n == 1'b0));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((icmp_ln316_reg_190_pp0_iter6_reg == 1'd0) & (ap_enable_reg_pp0_iter7 == 1'b1) & (p_out_full_n == 1'b0));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((icmp_ln316_reg_190_pp0_iter6_reg == 1'd0) & (ap_enable_reg_pp0_iter7 == 1'b1) & (p_out_full_n == 1'b0));
end
...
always @ (*) begin
    ap_block_state9_pp0_stage0_iter7 = ((icmp_ln316_reg_190_pp0_iter6_reg == 1'd0) & (p_out_full_n == 1'b0));
end

assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);

assign icmp_ln316_fu_132_p2 = ((i_reg_117 == l_parBlocks_reg_175) ? 1'b1 : 1'b0);
...
assign sum3_i_fu_161_p2 = (p_classes_offset_read_reg_185 + trunc_ln316_fu_143_p1);

assign sum_cast_i_fu_156_p1 = sum_i_fu_151_p2;

assign sum_i_fu_151_p2 = (p_results_offset_read_reg_180 + trunc_ln316_1_fu_147_p1);

assign trunc_ln316_1_fu_147_p1 = i_reg_117[14:0];

assign trunc_ln316_fu_143_p1 = i_reg_117[8:0];
