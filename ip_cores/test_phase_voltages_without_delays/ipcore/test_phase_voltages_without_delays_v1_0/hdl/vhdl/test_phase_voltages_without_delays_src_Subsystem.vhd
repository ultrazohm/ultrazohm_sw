-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\test_phase_voltages_without_delays\hdlsrc\test_phase_voltages_without_delays\test_phase_voltages_without_delays_src_Subsystem.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: test_phase_voltages_without_delays_src_Subsystem
-- Source Path: test_phase_voltages_without_delays/Phase_voltages_per_switching_state1/Subsystem
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY test_phase_voltages_without_delays_src_Subsystem IS
...
END test_phase_voltages_without_delays_src_Subsystem;


ARCHITECTURE rtl OF test_phase_voltages_without_delays_src_Subsystem IS

  -- Component Declarations
  COMPONENT test_phase_voltages_without_delays_src_MATLAB_Function15
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          sin_theta_el                    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT test_phase_voltages_without_delays_src_MATLAB_Function14
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          sin_theta_el                    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT test_phase_voltages_without_delays_src_MATLAB_Function13
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          sin_theta_el                    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT test_phase_voltages_without_delays_src_MATLAB_Function12
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          sin_theta_el                    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT test_phase_voltages_without_delays_src_MATLAB_Function11
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          sin_theta_el                    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT test_phase_voltages_without_delays_src_MATLAB_Function10
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          sin_theta_el                    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT test_phase_voltages_without_delays_src_MATLAB_Function9
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          sin_theta_el                    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT test_phase_voltages_without_delays_src_MATLAB_Function8
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          sin_theta_el                    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT test_phase_voltages_without_delays_src_MATLAB_Function7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          sin_theta_el                    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT test_phase_voltages_without_delays_src_MATLAB_Function6
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          sin_theta_el                    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT test_phase_voltages_without_delays_src_MATLAB_Function5
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          sin_theta_el                    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT test_phase_voltages_without_delays_src_MATLAB_Function4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          sin_theta_el                    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT test_phase_voltages_without_delays_src_MATLAB_Function3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          sin_theta_el                    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT test_phase_voltages_without_delays_src_MATLAB_Function2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          sin_theta_el                    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT test_phase_voltages_without_delays_src_MATLAB_Function1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          sin_theta_el                    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT test_phase_voltages_without_delays_src_MATLAB_Function
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          sin_theta_el                    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  FOR ALL : test_phase_voltages_without_delays_src_MATLAB_Function15
    USE ENTITY work.test_phase_voltages_without_delays_src_MATLAB_Function15(rtl);

  FOR ALL : test_phase_voltages_without_delays_src_MATLAB_Function14
    USE ENTITY work.test_phase_voltages_without_delays_src_MATLAB_Function14(rtl);

  FOR ALL : test_phase_voltages_without_delays_src_MATLAB_Function13
    USE ENTITY work.test_phase_voltages_without_delays_src_MATLAB_Function13(rtl);

  FOR ALL : test_phase_voltages_without_delays_src_MATLAB_Function12
    USE ENTITY work.test_phase_voltages_without_delays_src_MATLAB_Function12(rtl);

  FOR ALL : test_phase_voltages_without_delays_src_MATLAB_Function11
    USE ENTITY work.test_phase_voltages_without_delays_src_MATLAB_Function11(rtl);

  FOR ALL : test_phase_voltages_without_delays_src_MATLAB_Function10
    USE ENTITY work.test_phase_voltages_without_delays_src_MATLAB_Function10(rtl);

  FOR ALL : test_phase_voltages_without_delays_src_MATLAB_Function9
    USE ENTITY work.test_phase_voltages_without_delays_src_MATLAB_Function9(rtl);

  FOR ALL : test_phase_voltages_without_delays_src_MATLAB_Function8
    USE ENTITY work.test_phase_voltages_without_delays_src_MATLAB_Function8(rtl);

  FOR ALL : test_phase_voltages_without_delays_src_MATLAB_Function7
    USE ENTITY work.test_phase_voltages_without_delays_src_MATLAB_Function7(rtl);

  FOR ALL : test_phase_voltages_without_delays_src_MATLAB_Function6
    USE ENTITY work.test_phase_voltages_without_delays_src_MATLAB_Function6(rtl);

  FOR ALL : test_phase_voltages_without_delays_src_MATLAB_Function5
    USE ENTITY work.test_phase_voltages_without_delays_src_MATLAB_Function5(rtl);

  FOR ALL : test_phase_voltages_without_delays_src_MATLAB_Function4
    USE ENTITY work.test_phase_voltages_without_delays_src_MATLAB_Function4(rtl);

  FOR ALL : test_phase_voltages_without_delays_src_MATLAB_Function3
    USE ENTITY work.test_phase_voltages_without_delays_src_MATLAB_Function3(rtl);

  FOR ALL : test_phase_voltages_without_delays_src_MATLAB_Function2
    USE ENTITY work.test_phase_voltages_without_delays_src_MATLAB_Function2(rtl);

  FOR ALL : test_phase_voltages_without_delays_src_MATLAB_Function1
    USE ENTITY work.test_phase_voltages_without_delays_src_MATLAB_Function1(rtl);

  FOR ALL : test_phase_voltages_without_delays_src_MATLAB_Function
    USE ENTITY work.test_phase_voltages_without_delays_src_MATLAB_Function(rtl);
...
BEGIN
  u_MATLAB_Function15 : test_phase_voltages_without_delays_src_MATLAB_Function15
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              sin_theta_el => sin_theta_el,  -- single
              cos_theta_el => cos_theta_el1,  -- single
  ...
  u_MATLAB_Function14 : test_phase_voltages_without_delays_src_MATLAB_Function14
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              sin_theta_el => sin_theta_el,  -- single
  ...
  u_MATLAB_Function13 : test_phase_voltages_without_delays_src_MATLAB_Function13
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              sin_theta_el => sin_theta_el,  -- single
  ...
  u_MATLAB_Function12 : test_phase_voltages_without_delays_src_MATLAB_Function12
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              sin_theta_el => sin_theta_el,  -- single
  ...
  u_MATLAB_Function11 : test_phase_voltages_without_delays_src_MATLAB_Function11
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              sin_theta_el => sin_theta_el,  -- single
  ...
  u_MATLAB_Function10 : test_phase_voltages_without_delays_src_MATLAB_Function10
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              sin_theta_el => sin_theta_el,  -- single
  ...
  u_MATLAB_Function9 : test_phase_voltages_without_delays_src_MATLAB_Function9
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              sin_theta_el => sin_theta_el,  -- single
  ...
  u_MATLAB_Function8 : test_phase_voltages_without_delays_src_MATLAB_Function8
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              sin_theta_el => sin_theta_el,  -- single
  ...
  u_MATLAB_Function7 : test_phase_voltages_without_delays_src_MATLAB_Function7
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              sin_theta_el => sin_theta_el,  -- single
  ...
  u_MATLAB_Function6 : test_phase_voltages_without_delays_src_MATLAB_Function6
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              sin_theta_el => sin_theta_el,  -- single
  ...
  u_MATLAB_Function5 : test_phase_voltages_without_delays_src_MATLAB_Function5
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              sin_theta_el => sin_theta_el,  -- single
  ...
  u_MATLAB_Function4 : test_phase_voltages_without_delays_src_MATLAB_Function4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              sin_theta_el => sin_theta_el,  -- single
  ...
  u_MATLAB_Function3 : test_phase_voltages_without_delays_src_MATLAB_Function3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              sin_theta_el => sin_theta_el,  -- single
  ...
  u_MATLAB_Function2 : test_phase_voltages_without_delays_src_MATLAB_Function2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              sin_theta_el => sin_theta_el,  -- single
  ...
  u_MATLAB_Function1 : test_phase_voltages_without_delays_src_MATLAB_Function1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              sin_theta_el => sin_theta_el,  -- single
  ...
  u_MATLAB_Function : test_phase_voltages_without_delays_src_MATLAB_Function
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              sin_theta_el => sin_theta_el,  -- single
