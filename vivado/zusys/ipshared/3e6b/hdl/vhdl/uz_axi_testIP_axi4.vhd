-- -------------------------------------------------------------
-- 
-- File Name: uz_axi_testIP/hdlsrc/uz_axi_testIP/uz_axi_testIP_axi4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_axi_testIP_axi4
-- Source Path: uz_axi_testIP/uz_axi_testIP_axi4
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END uz_axi_testIP_axi4;


ARCHITECTURE rtl OF uz_axi_testIP_axi4 IS

  -- Component Declarations
  COMPONENT uz_axi_testIP_addr_decoder
  ...
  COMPONENT uz_axi_testIP_axi4_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_ARESETN                    :   IN    std_logic;  -- ufix1
          AXI4_AWID                       :   IN    std_logic_vector(11 DOWNTO 0);  -- ufix12
          AXI4_AWADDR                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  FOR ALL : uz_axi_testIP_addr_decoder
    USE ENTITY work.uz_axi_testIP_addr_decoder(rtl);

  FOR ALL : uz_axi_testIP_axi4_module
    USE ENTITY work.uz_axi_testIP_axi4_module(rtl);
  ...
  SIGNAL write_A_float_tmp                : vector_of_std_logic_vector32(0 TO 3);  -- ufix32 [4]
  SIGNAL write_B_float_tmp                : vector_of_std_logic_vector32(0 TO 3);  -- ufix32 [4]
  SIGNAL write_A_uint32_tmp               : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_B_uint32_tmp               : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_A_int32_tmp                : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_B_int32_tmp                : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_A_fx_1_16_5_tmp            : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL write_B_fx_1_16_5_tmp            : std_logic_vector(15 DOWNTO 0);  -- ufix16
...
BEGIN
  u_uz_axi_testIP_addr_decoder_inst : uz_axi_testIP_addr_decoder
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
              ...
              read_C_int32 => read_C_int32,  -- sfix32
              read_C_uint32 => read_C_uint32,  -- ufix32
              read_C_float => read_C_float,  -- ufix32 [4]
              read_C_fx_1_16_5 => read_C_fx_1_16_5,  -- sfix16_En5
              data_read => top_data_read,  -- ufix32
              write_axi_enable => write_axi_enable,  -- ufix1
              write_A_float => write_A_float_tmp,  -- ufix32 [4]
              write_B_float => write_B_float_tmp,  -- ufix32 [4]
              write_A_uint32 => write_A_uint32_tmp,  -- ufix32
              write_B_uint32 => write_B_uint32_tmp,  -- ufix32
              write_A_int32 => write_A_int32_tmp,  -- sfix32
              write_B_int32 => write_B_int32_tmp,  -- sfix32
              write_A_fx_1_16_5 => write_A_fx_1_16_5_tmp,  -- sfix16_En5
              write_B_fx_1_16_5 => write_B_fx_1_16_5_tmp  -- sfix16_En5
              );

  u_uz_axi_testIP_axi4_module_inst : uz_axi_testIP_axi4_module
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
  ...
  write_A_float <= write_A_float_tmp;

  write_B_float <= write_B_float_tmp;

  write_A_uint32 <= write_A_uint32_tmp;

  write_B_uint32 <= write_B_uint32_tmp;

  write_A_int32 <= write_A_int32_tmp;

  write_B_int32 <= write_B_int32_tmp;

  write_A_fx_1_16_5 <= write_A_fx_1_16_5_tmp;

  write_B_fx_1_16_5 <= write_B_fx_1_16_5_tmp;
