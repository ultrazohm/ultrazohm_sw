-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_pmsm_model_6ph_dqxy\uz_pmsm_model_6ph_dqxy_src_nfp_abs_double.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_6ph_dqxy_src_nfp_abs_double
-- Source Path: uz_pmsm_model_6ph_dqxy/uz_pmsm_model/nfp_abs_double
-- Hierarchy Level: 1
-- Model version: 9.7
-- 
-- -------------------------------------------------------------
...
ENTITY uz_pmsm_model_6ph_dqxy_src_nfp_abs_double IS
  PORT( nfp_in                            :   IN    std_logic_vector(63 DOWNTO 0);  -- ufix64
        nfp_out                           :   OUT   std_logic_vector(63 DOWNTO 0)  -- ufix64
        );
END uz_pmsm_model_6ph_dqxy_src_nfp_abs_double;


ARCHITECTURE rtl OF uz_pmsm_model_6ph_dqxy_src_nfp_abs_double IS
