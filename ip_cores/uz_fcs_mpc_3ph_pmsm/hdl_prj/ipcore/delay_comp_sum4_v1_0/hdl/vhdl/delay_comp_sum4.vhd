-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_mpc_3ph\delay_comp_sum4.vhd
-- Created: 2024-03-28 11:37:16
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: delay_comp_sum4
-- Source Path: delay_comp_sum4
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF delay_comp_sum4 IS

  -- Component Declarations
  COMPONENT delay_comp_sum4_reset_sync
  ...
  COMPONENT delay_comp_sum4_axi_lite
  ...
  FOR ALL : delay_comp_sum4_reset_sync
    USE ENTITY work.delay_comp_sum4_reset_sync(rtl);

  FOR ALL : delay_comp_sum4_axi_lite
    USE ENTITY work.delay_comp_sum4_axi_lite(rtl);

  FOR ALL : delay_comp_sum4_dut
    USE ENTITY work.delay_comp_sum4_dut(rtl);
...
BEGIN
  u_delay_comp_sum4_reset_sync_inst : delay_comp_sum4_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_delay_comp_sum4_axi_lite_inst : delay_comp_sum4_axi_lite
  ...
  u_delay_comp_sum4_dut_inst : delay_comp_sum4_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  ip_timestamp <= unsigned'(X"8F3F28F1");
