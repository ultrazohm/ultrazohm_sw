-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_mpc_cost_and_optim_state_machine\uz_6ph_delay_ip_src_Subsystem.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_6ph_delay_ip_src_Subsystem
-- Source Path: uz_mpc_cost_and_optim_state_machine/uz_6ph_mpc_delay_comp/Subsystem
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_6ph_delay_ip_src_Subsystem IS
...
END uz_6ph_delay_ip_src_Subsystem;


ARCHITECTURE rtl OF uz_6ph_delay_ip_src_Subsystem IS
  ...
  SIGNAL Unit_Delay_Initial_Val_out       : std_logic;
  ...
  SIGNAL Unit_Delay_out                   : std_logic;
...
BEGIN
  ...
  Unit_Delay_ctrl_delay_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Unit_Delay_ctrl_delay_out <= '0';
      ELSIF enb = '1' THEN
        Unit_Delay_ctrl_delay_out <= Unit_Delay_ctrl_const_out;
      END IF;
    END IF;
  END PROCESS Unit_Delay_ctrl_delay_process;


  Unit_Delay_Initial_Val_out <= '1';
