 ...
 * C/C++ source code generated on : Mon Nov 22 16:47:21 2021
 *
...
static void DutyCycle_mod_o(real32_T ia_reg_in, ExtU_ElectricalID_t
  *rtElectricalID_U, DW_ElectricalID_t *rtElectricalID_DW);
static void findDutyCycle(ExtU_ElectricalID_t *rtElectricalID_U,
  ExtY_ElectricalID_t *rtElectricalID_Y, DW_ElectricalID_t *rtElectricalID_DW);
static void measure_psiPM(ExtU_ElectricalID_t *rtElectricalID_U,
  ExtY_ElectricalID_t *rtElectricalID_Y, DW_ElectricalID_t *rtElectricalID_DW);
static real32_T goertzel(ExtU_ElectricalID_t *rtElectricalID_U,
  ExtY_ElectricalID_t *rtElectricalID_Y, DW_ElectricalID_t *rtElectricalID_DW);
  ...
  *rtElectricalID_DW)
{
  ...
  if (rtElectricalID_U->ElectricalIDConfig_l.identLq) {
    /* Outport: '<Root>/ElectricalID_output' */
  ...
  *rtElectricalID_U, DW_ElectricalID_t *rtElectricalID_DW)
{
  ...
  if (!rtElectricalID_DW->om_con) {
    ...
    if (mean_om_reg > rtElectricalID_U->ElectricalIDConfig_l.min_n_ratio *
  ...
  ExtY_ElectricalID_t *rtElectricalID_Y, DW_ElectricalID_t *rtElectricalID_DW)
{
  ...
  if (rtElectricalID_U->GlobalConfig_out.ACCEPT && (rtElectricalID_DW->om_con ||
       rtElectricalID_DW->DC_manual)) {
    /* Outport: '<Root>/ElectricalID_output' */
    /* Transition: '<S1>:383' */
    ...
    if (!rtElectricalID_DW->DC_manual) {
      ...
      rtElectricalID_DW->omega_sum += rtElectricalID_U->ActualValues_i.omega_m;
  ...
  ExtY_ElectricalID_t *rtElectricalID_Y, DW_ElectricalID_t *rtElectricalID_DW)
{
  ...
  if (rtElectricalID_U->GlobalConfig_out.ACCEPT && (rtElectricalID_DW->ia_valid ||
       rtElectricalID_DW->DC_manual)) {
    /* Outport: '<Root>/ElectricalID_output' */
    /* Transition: '<S1>:790' */
  ...
  } else if ((!rtElectricalID_DW->DC_manual) && (!rtElectricalID_DW->ia_valid))
  {
    ...
    tmp_0 = 0.4F / rtElectricalID_U->GlobalConfig_out.sampleTimeISR;
    if (rtElectricalID_DW->counter < tmp_0) {
    ...
    } else if ((rtElectricalID_DW->counter >= tmp_0) && ((real_T)
                rtElectricalID_DW->counter < 0.5F /
                rtElectricalID_U->GlobalConfig_out.sampleTimeISR)) {
      ...
      rtElectricalID_DW->ia_sum += rtElectricalID_U->ActualValues_i.i_a;
    } else {
  ...
  if (rtElectricalID_Y->ElectricalID_output_o.psiPM > 0.0F) {
    ...
    if ((rtElectricalID_DW->counter > rtElectricalID_DW->wait_count) &&
      ...
      rtElectricalID_DW->i_est[(int32_T)qY - 1] =
        rtElectricalID_U->ActualValues_i.omega_el;
    }
  ...
  if (rtElectricalID_DW->counter == 1026U) {
    ...
    if (rtElectricalID_DW->counter <= 1024U) {
      ...
      if (rtElectricalID_DW->counter > 1U) {
        ...
        /* Inport: '<Root>/ActualValues' */
        rtElectricalID_DW->measArray1[(int32_T)qY - 1] =
          rtElectricalID_U->ActualValues_i.i_a;
        ...
        if (rtElectricalID_DW->counter - rtElectricalID_DW->counter / 5U * 5U ==
          ...
          rtElectricalID_DW->Ustep[(int32_T)qY - 1] =
            rtElectricalID_U->ActualValues_i.u_a;
      ...
      if (rtElectricalID_DW->counter == 1U) {
        ...
        rtElectricalID_DW->Ustep[0] = rtElectricalID_U->ActualValues_i.u_a;
  ...
  if (rtElectricalID_DW->counter == 1026U) {
    ...
    if (rtElectricalID_DW->counter <= 1024U) {
      ...
      if (rtElectricalID_DW->counter > 1U) {
        ...
        /* Inport: '<Root>/ActualValues' */
        rtElectricalID_DW->measArray1[(int32_T)qY - 1] =
          rtElectricalID_U->ActualValues_i.i_c;
        ...
        if (rtElectricalID_DW->counter - rtElectricalID_DW->counter / 5U * 5U ==
          ...
          /* Inport: '<Root>/ActualValues' */
          rtElectricalID_DW->Ustep[(int32_T)qY - 1] =
            rtElectricalID_U->ActualValues_i.u_b +
            rtElectricalID_U->ActualValues_i.u_c;
      ...
      if (rtElectricalID_DW->counter == 1U) {
        ...
        rtElectricalID_DW->Ustep[0] = rtElectricalID_U->ActualValues_i.u_b +
          rtElectricalID_U->ActualValues_i.u_c;
  ...
  switch (rtElectricalID_DW->is_ElectricalID) {
   ...
   case IN_alignRotor_d_off:
    ...
    rtElectricalID_Y->ElectricalID_output_o.thetaOffset =
      rtElectricalID_U->ActualValues_i.theta_m;
    rtElectricalID_DW->is_ElectricalID = IN_NO_ACTIVE_CHILD;
    break;
    ...
    switch (rtElectricalID_DW->is_ElectricalID) {
     case IN_Levenberg_Marquardt:
      ...
      if (rtElectricalID_U->GlobalConfig_out.ACCEPT &&
          (!rtElectricalID_U->ElectricalIDConfig_l.identLq)) {
        /* Transition: '<S1>:426' */
        /* Exit 'Levenberg_Marquardt': '<S1>:91' */
     ...
     case IN_alignRotor_q_on:
      ...
      if (rtElectricalID_DW->temporalCounter_i1 >= 10000U) {
        ...
        DutyCycle_filt = roundf(1.57079637F / fabsf
          (rtElectricalID_U->ActualValues_i.theta_m));
     ...
     case IN_calculatePIcontroller:
      ...
      if (rtElectricalID_U->GlobalConfig_out.ACCEPT) {
        ...
        rtElectricalID_Y->ElectricalID_FOC_output.n_ref_FOC =
          rtElectricalID_U->ElectricalIDConfig_l.n_ref_measurement;
     ...
     case IN_findDutyCycle:
      findDutyCycle(rtElectricalID_U, rtElectricalID_Y, rtElectricalID_DW);
      break;
     ...
     case IN_rotorInertiaEstimation:
      ...
      if (rtElectricalID_DW->counter == qY) {
        ...
        if ((rtElectricalID_DW->counter > rtElectricalID_DW->wait_count) &&
          ...
          /* Inport: '<Root>/ActualValues' */
          rtElectricalID_DW->i_est[(int32_T)qY - 1] =
            rtElectricalID_U->ActualValues_i.omega_m;
        }
     ...
     case IN_stop:
      ...
      if (rtElectricalID_DW->temporalCounter_i1 >= 10000U) {
        ...
        rtElectricalID_Y->ElectricalID_FOC_output.VibAmp_out =
          rtElectricalID_U->ElectricalIDConfig_l.goertzlAmp;
...
void ElectricalID_step(RT_MODEL_ElectricalID_t *const rtElectricalID_M)
{
  ...
  if (rtElectricalID_DW->is_active_c3_ElectricalID == 0U) {
    ...
    /* . */
  } else if (rtElectricalID_U->ControlFlags_o.startElectricalID &&
