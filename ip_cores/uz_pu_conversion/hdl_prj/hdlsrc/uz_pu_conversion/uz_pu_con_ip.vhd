...
ENTITY uz_pu_con_ip IS
  PORT( IPCORE_CLK                        :   IN    std_logic;  -- ufix1
        ...
        in_rsvd                           :   IN    std_logic_vector(26 DOWNTO 0);  -- ufix27
        ...
        out_rsvd                          :   OUT   std_logic_vector(17 DOWNTO 0);  -- ufix18
...
ARCHITECTURE rtl OF uz_pu_con_ip IS
  ...
  SIGNAL in_rsvd_unsigned                 : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL in_rsvd_sig                      : signed(26 DOWNTO 0);  -- sfix27_En15
  ...
  SIGNAL out_rsvd_sig                     : std_logic_vector(17 DOWNTO 0);  -- ufix18
  ...
  SIGNAL out_rsvd_sig_signed              : signed(17 DOWNTO 0);  -- sfix18_En15
  SIGNAL out_rsvd_tmp                     : unsigned(17 DOWNTO 0);  -- ufix18
...
BEGIN
  ...
  u_uz_pu_con_ip_dut_inst : uz_pu_con_ip_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              ...
              in_rsvd => std_logic_vector(in_rsvd_sig),  -- sfix27_En15
              ...
              out_rsvd => out_rsvd_sig,  -- sfix18_En15
  ...
  ip_timestamp <= unsigned'(X"8343B0F2");

  reset_cm <=  NOT IPCORE_RESETN;

  reset_before_sync <= reset_cm OR reset_internal;

  in_rsvd_unsigned <= unsigned(in_rsvd);

  in_rsvd_sig <= signed(in_rsvd_unsigned);
