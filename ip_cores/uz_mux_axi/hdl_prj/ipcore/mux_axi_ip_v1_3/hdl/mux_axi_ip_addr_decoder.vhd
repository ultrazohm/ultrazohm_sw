...
ENTITY mux_axi_ip_addr_decoder IS
  PORT( clk                               :   IN    std_logic;
        ...
        write_delay_ADC_trigger_in_clk_cycles_AXI :   OUT   std_logic_vector(9 DOWNTO 0)  -- ufix10
        );
...
ARCHITECTURE rtl OF mux_axi_ip_addr_decoder IS
  ...
  SIGNAL decode_sel_delay_ADC_trigger_in_clk_cycles_AXI_1_1 : std_logic;  -- ufix1
  ...
  SIGNAL reg_enb_delay_ADC_trigger_in_clk_cycles_AXI_1_1 : std_logic;  -- ufix1
  SIGNAL data_in_delay_ADC_trigger_in_clk_cycles_AXI : unsigned(9 DOWNTO 0);  -- ufix10
  SIGNAL data_reg_delay_ADC_trigger_in_clk_cycles_AXI_1_1 : unsigned(9 DOWNTO 0);  -- ufix10
  SIGNAL data_slice_delay_ADC_trigger_in_clk_cycles_AXI_1 : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_delay_ADC_trigger_in_clk_cycles_AXI_1_1 : unsigned(31 DOWNTO 0);  -- ufix32

BEGIN
  addr_sel_unsigned <= unsigned(addr_sel);

  
  decode_sel_delay_ADC_trigger_in_clk_cycles_AXI_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0042#, 14) ELSE
      '0';
  ...
  reg_enb_delay_ADC_trigger_in_clk_cycles_AXI_1_1 <= decode_sel_delay_ADC_trigger_in_clk_cycles_AXI_1_1 AND wr_enb;

  data_in_delay_ADC_trigger_in_clk_cycles_AXI <= data_write_unsigned(9 DOWNTO 0);

  reg_delay_ADC_trigger_in_clk_cycles_AXI_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_delay_ADC_trigger_in_clk_cycles_AXI_1_1 <= to_unsigned(16#000#, 10);
      ELSIF enb = '1' AND reg_enb_delay_ADC_trigger_in_clk_cycles_AXI_1_1 = '1' THEN
        data_reg_delay_ADC_trigger_in_clk_cycles_AXI_1_1 <= data_in_delay_ADC_trigger_in_clk_cycles_AXI;
      END IF;
    END IF;
  END PROCESS reg_delay_ADC_trigger_in_clk_cycles_AXI_1_1_process;


  data_slice_delay_ADC_trigger_in_clk_cycles_AXI_1 <= resize(data_reg_delay_ADC_trigger_in_clk_cycles_AXI_1_1, 32);

  
  decode_rd_delay_ADC_trigger_in_clk_cycles_AXI_1_1 <= decode_rd_select_n_th_adc_interrupt_1_1 WHEN decode_sel_delay_ADC_trigger_in_clk_cycles_AXI_1_1 = '0' ELSE
      data_slice_delay_ADC_trigger_in_clk_cycles_AXI_1;

  data_read <= std_logic_vector(decode_rd_delay_ADC_trigger_in_clk_cycles_AXI_1_1);
  ...
  write_delay_ADC_trigger_in_clk_cycles_AXI <= std_logic_vector(data_reg_delay_ADC_trigger_in_clk_cycles_AXI_1_1);
