...
int JavaScope_initialize(DS_Data* data)
{
	...
	js_ch_observable[JSO_angle_d5_1] 			= &data->av.angle_d5_1;
	js_ch_observable[JSO_angle_d5_2] 			= &data->av.angle_d5_2;
	js_ch_observable[JSO_angle_d5_3] 			= &data->av.angle_d5_3;
