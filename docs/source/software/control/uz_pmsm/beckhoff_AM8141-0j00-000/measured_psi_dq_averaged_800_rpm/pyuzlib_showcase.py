...
PARAMETER_CSV = Path(
    "/workspaces/ultrazohm_sw/docs/source/software/control/uz_pmsm/beckhoff_AM8141-0j00-000/measured_psi_dq_averaged_800_rpm/machine_parameters.csv"
)
...
operation_area = motor.calculate_operation_area(
    ...
    modulation="svpwm",
    grid_points=80,
    speeds_rpm=np.linspace(0.0, 1500.0, 30),
)
