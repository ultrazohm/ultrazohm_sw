...
ARCHITECTURE rtl OF uz_pmsm_model_9ph_opti_src_uz_pmsm_model_9ph IS
  ...
  SIGNAL delayMatch23_reg                 : vector_of_std_logic_vector32(0 TO 61);  -- ufix32 [62]
  SIGNAL delayMatch23_reg_next            : vector_of_std_logic_vector32(0 TO 61);  -- ufix32 [62]
  ...
  SIGNAL Data_Type_Conversion16_out1      : std_logic_vector(63 DOWNTO 0);  -- ufix64
  ...
  SIGNAL Data_Type_Conversion17_out1      : std_logic_vector(63 DOWNTO 0);  -- ufix64
...
BEGIN
  ...
  u_uz_pmsm_model_9ph_uz_pmsm_model_9ph_nfp_convert_single2double_12 : uz_pmsm_model_9ph_opti_src_nfp_convert_single2double
    PORT MAP( clk => clk,
              ...
              enb => enb,
              nfp_in => L_x1,  -- single
              nfp_out => Data_Type_Conversion16_out1  -- double
              );

  u_nfp_mul_comp_21 : uz_pmsm_model_9ph_opti_src_nfp_mul_double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Data_Type_Conversion33_out1,  -- double
              nfp_in2 => Divide5_out1,  -- double
              nfp_out => Divide4_out1  -- double
              );

  u_nfp_sub_comp_7 : uz_pmsm_model_9ph_opti_src_nfp_sub_double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Data_Type_Conversion26_out1,  -- double
  ...
  u_nfp_mul_comp_23 : uz_pmsm_model_9ph_opti_src_nfp_mul_double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1_7,  -- double
              nfp_in2 => Data_Type_Conversion16_out1,  -- double
  ...
  u_uz_pmsm_model_9ph_uz_pmsm_model_9ph_nfp_convert_single2double_13 : uz_pmsm_model_9ph_opti_src_nfp_convert_single2double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in => Switch_out1(5),  -- single
              nfp_out => Data_Type_Conversion17_out1  -- double
              );
  ...
  u_nfp_mul_comp_24 : uz_pmsm_model_9ph_opti_src_nfp_mul_double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Data_Type_Conversion33_out1,  -- double
  ...
  u_nfp_sub_comp_8 : uz_pmsm_model_9ph_opti_src_nfp_sub_double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Data_Type_Conversion17_out1,  -- double
  ...
  u_nfp_mul_comp_26 : uz_pmsm_model_9ph_opti_src_nfp_mul_double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1_8,  -- double
  ...
  u_uz_pmsm_model_9ph_uz_pmsm_model_9ph_nfp_convert_single2double_16 : uz_pmsm_model_9ph_opti_src_nfp_convert_single2double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_uz_pmsm_model_9ph_uz_pmsm_model_9ph_nfp_convert_single2double_17 : uz_pmsm_model_9ph_opti_src_nfp_convert_single2double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        ...
        delayMatch23_reg(54) <= X"00000000";
        delayMatch23_reg(55) <= X"00000000";
        delayMatch23_reg(56) <= X"00000000";
        delayMatch23_reg(57) <= X"00000000";
        delayMatch23_reg(58) <= X"00000000";
        delayMatch23_reg(59) <= X"00000000";
        delayMatch23_reg(60) <= X"00000000";
        delayMatch23_reg(61) <= X"00000000";
      ELSIF enb = '1' THEN
  ...
  From10_out1_1 <= delayMatch23_reg(61);
