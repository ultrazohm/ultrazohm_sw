-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\parallel_8_vsd_and_park\hdlsrc\VSD_and_Park_transformation_6Phase\parallel_8_VSD_and_Park_src_MATLAB_Function.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: parallel_8_VSD_and_Park_src_MATLAB_Function
-- Source Path: VSD_and_Park_transformation_6Phase/vsd_and_park_tra/MATLAB Function
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY parallel_8_VSD_and_Park_src_MATLAB_Function IS
...
END parallel_8_VSD_and_Park_src_MATLAB_Function;


ARCHITECTURE rtl OF parallel_8_VSD_and_Park_src_MATLAB_Function IS
  ...
  SIGNAL sin_theta_el_signed              : signed(17 DOWNTO 0);  -- sfix18_En11
  SIGNAL cos_theta_el_signed              : signed(17 DOWNTO 0);  -- sfix18_En11
  ...
  SIGNAL i_d_tmp                          : signed(57 DOWNTO 0);  -- sfix58_En40
  SIGNAL i_q_tmp                          : signed(57 DOWNTO 0);  -- sfix58_En40
...
BEGIN
  ...
  MATLAB_Function_output : PROCESS (cos_theta_el_signed, i_a1_1, i_a2_1, i_b1_1, i_b2_1, i_c1_1, i_c2_1,
    ...
    VARIABLE add_cast_1 : signed(57 DOWNTO 0);
    VARIABLE mul_temp_0 : signed(56 DOWNTO 0);
    VARIABLE add_cast_2 : signed(57 DOWNTO 0);
    VARIABLE mul_temp_1 : signed(56 DOWNTO 0);
    VARIABLE add_cast_3 : signed(57 DOWNTO 0);
    VARIABLE mul_temp_2 : signed(56 DOWNTO 0);
    VARIABLE add_cast_4 : signed(57 DOWNTO 0);
  BEGIN
    ...
    --   i_d = B(1);
    --   i_q = B(2);
    cast := resize(sin_theta_el_signed, 19);
    cast_0 :=  - (cast);
    yfi := cast_0(17 DOWNTO 0);
    i_alpha_tmp <= c(0);
    i_beta_tmp <= c(1);
    i_x_tmp <= c(2);
    i_y_tmp <= c(3);
    ...
    add_cast_1 := resize(mul_temp, 58);
    mul_temp_0 := sin_theta_el_signed * c(1);
    add_cast_2 := resize(mul_temp_0, 58);
    i_d_tmp <= add_cast_1 + add_cast_2;
    mul_temp_1 := yfi * c(0);
    add_cast_3 := resize(mul_temp_1, 58);
    mul_temp_2 := cos_theta_el_signed * c(1);
    add_cast_4 := resize(mul_temp_2, 58);
