-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/inc_enc_v26/IncEnc_V2_ip_src_Counter_position.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IncEnc_V2_ip_src_Counter_position
...
ENTITY IncEnc_V2_ip_src_Counter_position IS
...
END IncEnc_V2_ip_src_Counter_position;


ARCHITECTURE rtl OF IncEnc_V2_ip_src_Counter_position IS
  ...
  SIGNAL speed_old_switch2_out1_1         : signed(15 DOWNTO 0);  -- int16
  ...
  SIGNAL Resett_switch1_out1_1            : unsigned(15 DOWNTO 0);  -- uint16
...
BEGIN
  ...
  switch_compare_1_1 <= '1' WHEN Dir_1 >= to_signed(16#1#, 4) ELSE
      '0';
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        speed_old_switch2_out1_1 <= to_signed(16#0000#, 16);
      ELSIF enb = '1' THEN
        speed_old_switch2_out1_1 <= speed_old_switch2_out1;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Resett_switch1_out1 <= to_unsigned(16#0000#, 16);
      ELSIF enb = '1' THEN
        Resett_switch1_out1 <= Resett_switch1_out1_1;
      END IF;
    END IF;
  ...
  Resett_switch1_out1_1 <= Resett_switch3_out1_dtc WHEN Relational_Operator_relop1 = '0' ELSE
      Constant4_out1_dtc;

  count <= std_logic_vector(Resett_switch1_out1_1);
