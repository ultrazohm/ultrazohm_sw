-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_mpc_6ph\cost_opt_src_iterativesearch.vhd
...
-- Source Path: uz_mpc_6ph/cost_opt/iterativesearch
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  BEGIN
    ...
    IF index_unsigned /= index_old THEN 
      IF (index_unsigned <= to_unsigned(16#00000040#, 32)) AND (cost_unsigned <= cost_old) THEN 
        opt_idx_old_temp := index_unsigned;
        cost_old_temp := cost_unsigned;
      ELSE 
        -- do nothing 
      END IF;
      IF index_unsigned = to_unsigned(16#00000040#, 32) THEN 
        opt_done <= '1';
