...
ENTITY PWM_and_SS_control_V4_ip_addr_decoder IS
  PORT( clk                               :   IN    std_logic;
        ...
        write_m_u1_norm_AXI               :   OUT   std_logic_vector(17 DOWNTO 0);  -- sfix18_En16
        write_m_u2_norm_AXI               :   OUT   std_logic_vector(17 DOWNTO 0);  -- sfix18_En16
        write_m_u3_norm_AXI               :   OUT   std_logic_vector(17 DOWNTO 0);  -- sfix18_En16
        write_TriState_HB_AXI             :   OUT   std_logic_vector(2 DOWNTO 0);  -- ufix3
...
ARCHITECTURE rtl OF PWM_and_SS_control_V4_ip_addr_decoder IS
  ...
  SIGNAL data_in_m_u1_norm_AXI            : signed(17 DOWNTO 0);  -- sfix18_En16
  SIGNAL data_reg_m_u1_norm_AXI_1_1       : signed(17 DOWNTO 0);  -- sfix18_En16
  SIGNAL decode_sel_m_u2_norm_AXI_1_1     : std_logic;  -- ufix1
  SIGNAL reg_enb_m_u2_norm_AXI_1_1        : std_logic;  -- ufix1
  SIGNAL data_in_m_u2_norm_AXI            : signed(17 DOWNTO 0);  -- sfix18_En16
  SIGNAL data_reg_m_u2_norm_AXI_1_1       : signed(17 DOWNTO 0);  -- sfix18_En16
  SIGNAL decode_sel_m_u3_norm_AXI_1_1     : std_logic;  -- ufix1
  SIGNAL reg_enb_m_u3_norm_AXI_1_1        : std_logic;  -- ufix1
  SIGNAL data_in_m_u3_norm_AXI            : signed(17 DOWNTO 0);  -- sfix18_En16
  SIGNAL data_reg_m_u3_norm_AXI_1_1       : signed(17 DOWNTO 0);  -- sfix18_En16
  SIGNAL decode_sel_TriState_HB_AXI_1_1   : std_logic;  -- ufix1
  SIGNAL reg_enb_TriState_HB_AXI_1_1      : std_logic;  -- ufix1
  SIGNAL data_in_TriState_HB_AXI          : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL data_reg_TriState_HB_AXI_1_1     : unsigned(2 DOWNTO 0);  -- ufix3
  ...
  SIGNAL decode_sel_triangle_shift_HB1_AXI_1_1 : std_logic;  -- ufix1
  SIGNAL reg_enb_triangle_shift_HB1_AXI_1_1 : std_logic;  -- ufix1
  SIGNAL data_in_triangle_shift_HB1_AXI   : unsigned(17 DOWNTO 0);  -- ufix18_En17
  SIGNAL data_reg_triangle_shift_HB1_AXI_1_1 : unsigned(17 DOWNTO 0);  -- ufix18_En17
  SIGNAL decode_sel_triangle_shift_HB2_AXI_1_1 : std_logic;  -- ufix1
  SIGNAL reg_enb_triangle_shift_HB2_AXI_1_1 : std_logic;  -- ufix1
  SIGNAL data_in_triangle_shift_HB2_AXI   : unsigned(17 DOWNTO 0);  -- ufix18_En17
  SIGNAL data_reg_triangle_shift_HB2_AXI_1_1 : unsigned(17 DOWNTO 0);  -- ufix18_En17
  SIGNAL decode_sel_triangle_shift_HB3_AXI_1_1 : std_logic;  -- ufix1
  SIGNAL reg_enb_triangle_shift_HB3_AXI_1_1 : std_logic;  -- ufix1
  SIGNAL data_in_triangle_shift_HB3_AXI   : unsigned(17 DOWNTO 0);  -- ufix18_En17
  SIGNAL data_reg_triangle_shift_HB3_AXI_1_1 : unsigned(17 DOWNTO 0);  -- ufix18_En17
...
BEGIN
  ...
  decode_sel_Mode_rd_AXI_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0052#, 14) ELSE
      '0';

  
  decode_sel_PWM_min_pulse_width_rd_AXI_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0051#, 14) ELSE
      '0';

  
  decode_sel_PWM_T_carrier_us_rd_AXI_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0050#, 14) ELSE
      '0';

  
  decode_sel_PWM_f_carrier_kHz_rd_AXI_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#004F#, 14) ELSE
      '0';

  
  decode_sel_PWM_en_rd_AXI_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#004E#, 14) ELSE
      '0';
  ...
  data_in_m_u1_norm_AXI <= signed(data_write_unsigned(17 DOWNTO 0));

  reg_m_u1_norm_AXI_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_m_u1_norm_AXI_1_1 <= to_signed(16#00000#, 18);
  ...
  data_in_m_u2_norm_AXI <= signed(data_write_unsigned(17 DOWNTO 0));

  reg_m_u2_norm_AXI_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_m_u2_norm_AXI_1_1 <= to_signed(16#00000#, 18);
  ...
  data_in_m_u3_norm_AXI <= signed(data_write_unsigned(17 DOWNTO 0));

  reg_m_u3_norm_AXI_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_m_u3_norm_AXI_1_1 <= to_signed(16#00000#, 18);
  ...
  decode_sel_TriState_HB_AXI_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0048#, 14) ELSE
      '0';

  reg_enb_TriState_HB_AXI_1_1 <= decode_sel_TriState_HB_AXI_1_1 AND wr_enb;

  data_in_TriState_HB_AXI <= data_write_unsigned(2 DOWNTO 0);

  reg_TriState_HB_AXI_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_TriState_HB_AXI_1_1 <= to_unsigned(16#0#, 3);
      ELSIF enb = '1' AND reg_enb_TriState_HB_AXI_1_1 = '1' THEN
        data_reg_TriState_HB_AXI_1_1 <= data_in_TriState_HB_AXI;
      END IF;
    END IF;
  END PROCESS reg_TriState_HB_AXI_1_1_process;


  write_TriState_HB_AXI <= std_logic_vector(data_reg_TriState_HB_AXI_1_1);

  
  decode_sel_count_src_ext_AXI_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0049#, 14) ELSE
      '0';
  ...
  decode_sel_triangle_shift_HB1_AXI_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#004A#, 14) ELSE
      '0';

  reg_enb_triangle_shift_HB1_AXI_1_1 <= decode_sel_triangle_shift_HB1_AXI_1_1 AND wr_enb;

  data_in_triangle_shift_HB1_AXI <= data_write_unsigned(17 DOWNTO 0);

  reg_triangle_shift_HB1_AXI_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_triangle_shift_HB1_AXI_1_1 <= to_unsigned(16#00000#, 18);
      ELSIF enb = '1' AND reg_enb_triangle_shift_HB1_AXI_1_1 = '1' THEN
        data_reg_triangle_shift_HB1_AXI_1_1 <= data_in_triangle_shift_HB1_AXI;
      END IF;
    END IF;
  END PROCESS reg_triangle_shift_HB1_AXI_1_1_process;


  write_triangle_shift_HB1_AXI <= std_logic_vector(data_reg_triangle_shift_HB1_AXI_1_1);

  
  decode_sel_triangle_shift_HB2_AXI_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#004B#, 14) ELSE
      '0';

  reg_enb_triangle_shift_HB2_AXI_1_1 <= decode_sel_triangle_shift_HB2_AXI_1_1 AND wr_enb;

  data_in_triangle_shift_HB2_AXI <= data_write_unsigned(17 DOWNTO 0);

  reg_triangle_shift_HB2_AXI_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_triangle_shift_HB2_AXI_1_1 <= to_unsigned(16#00000#, 18);
      ELSIF enb = '1' AND reg_enb_triangle_shift_HB2_AXI_1_1 = '1' THEN
        data_reg_triangle_shift_HB2_AXI_1_1 <= data_in_triangle_shift_HB2_AXI;
      END IF;
    END IF;
  END PROCESS reg_triangle_shift_HB2_AXI_1_1_process;


  write_triangle_shift_HB2_AXI <= std_logic_vector(data_reg_triangle_shift_HB2_AXI_1_1);

  
  decode_sel_triangle_shift_HB3_AXI_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#004C#, 14) ELSE
      '0';

  reg_enb_triangle_shift_HB3_AXI_1_1 <= decode_sel_triangle_shift_HB3_AXI_1_1 AND wr_enb;

  data_in_triangle_shift_HB3_AXI <= data_write_unsigned(17 DOWNTO 0);

  reg_triangle_shift_HB3_AXI_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_triangle_shift_HB3_AXI_1_1 <= to_unsigned(16#00000#, 18);
      ELSIF enb = '1' AND reg_enb_triangle_shift_HB3_AXI_1_1 = '1' THEN
        data_reg_triangle_shift_HB3_AXI_1_1 <= data_in_triangle_shift_HB3_AXI;
      END IF;
    END IF;
  END PROCESS reg_triangle_shift_HB3_AXI_1_1_process;


  write_triangle_shift_HB3_AXI <= std_logic_vector(data_reg_triangle_shift_HB3_AXI_1_1);

  
  decode_sel_PWM_trigger_source_AXI_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#004D#, 14) ELSE
      '0';
