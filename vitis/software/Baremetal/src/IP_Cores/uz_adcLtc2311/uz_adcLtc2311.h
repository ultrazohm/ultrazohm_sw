...
#define UZ_ADCLTC2311_SET_CONV_FAILED (1U<<0)
#define UZ_ADCLTC2311_SET_OFFSET_FAILED (1U<<1)
#define UZ_ADCLTC2311_SET_SAMPLES_FAILED (1U<<2)

// status SPI config
#define UZ_ADCLTC2311_CLK_DIV_INVALID (1U<<0)
#define UZ_ADCLTC2311_PRE_DELAY_INVALID (1U<<0)
#define UZ_ADCLTC2311_POST_DELAY_INVALID (1U<<0)
...
#define UZ_ADCLTC2311_NS_TIMEOUT (1U<<4)
#define UZ_ADCLTC2311_NS_NO_SELECTION (1U<<5)
#define UZ_ADCLTC2311_NAP_PULSES 2U
#define UZ_ADCLTC2311_SLEEP_PULSES 4U
