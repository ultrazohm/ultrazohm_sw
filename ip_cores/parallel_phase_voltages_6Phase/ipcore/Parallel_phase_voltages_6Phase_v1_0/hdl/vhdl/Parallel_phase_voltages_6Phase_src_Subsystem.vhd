-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\parallel_phase_voltages_6Phase\hdlsrc\parallel_phase_voltages_per_switching_state_6\Parallel_phase_voltages_6Phase_src_Subsystem.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Parallel_phase_voltages_6Phase_src_Subsystem
...
ENTITY Parallel_phase_voltages_6Phase_src_Subsystem IS
...
END Parallel_phase_voltages_6Phase_src_Subsystem;


ARCHITECTURE rtl OF Parallel_phase_voltages_6Phase_src_Subsystem IS

  -- Component Declarations
  COMPONENT Parallel_phase_voltages_6Phase_src_MATLAB_Function15
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT Parallel_phase_voltages_6Phase_src_MATLAB_Function14
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          theta_el_with_offset            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT Parallel_phase_voltages_6Phase_src_MATLAB_Function13
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          theta_el_with_offset            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT Parallel_phase_voltages_6Phase_src_MATLAB_Function12
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          theta_el_with_offset            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT Parallel_phase_voltages_6Phase_src_MATLAB_Function11
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          theta_el_with_offset            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT Parallel_phase_voltages_6Phase_src_MATLAB_Function10
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          theta_el_with_offset            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT Parallel_phase_voltages_6Phase_src_MATLAB_Function9
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          theta_el_with_offset            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT Parallel_phase_voltages_6Phase_src_MATLAB_Function8
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          theta_el_with_offset            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT Parallel_phase_voltages_6Phase_src_MATLAB_Function7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          theta_el_with_offset            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT Parallel_phase_voltages_6Phase_src_MATLAB_Function6
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          theta_el_with_offset            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT Parallel_phase_voltages_6Phase_src_MATLAB_Function5
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          theta_el_with_offset            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT Parallel_phase_voltages_6Phase_src_MATLAB_Function4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          theta_el_with_offset            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT Parallel_phase_voltages_6Phase_src_MATLAB_Function3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          theta_el_with_offset            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT Parallel_phase_voltages_6Phase_src_MATLAB_Function2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          theta_el_with_offset            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT Parallel_phase_voltages_6Phase_src_MATLAB_Function1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          theta_el_with_offset            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT Parallel_phase_voltages_6Phase_src_MATLAB_Function
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          theta_el_with_offset            :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  FOR ALL : Parallel_phase_voltages_6Phase_src_MATLAB_Function15
    USE ENTITY work.Parallel_phase_voltages_6Phase_src_MATLAB_Function15(rtl);

  FOR ALL : Parallel_phase_voltages_6Phase_src_MATLAB_Function14
    USE ENTITY work.Parallel_phase_voltages_6Phase_src_MATLAB_Function14(rtl);

  FOR ALL : Parallel_phase_voltages_6Phase_src_MATLAB_Function13
    USE ENTITY work.Parallel_phase_voltages_6Phase_src_MATLAB_Function13(rtl);

  FOR ALL : Parallel_phase_voltages_6Phase_src_MATLAB_Function12
    USE ENTITY work.Parallel_phase_voltages_6Phase_src_MATLAB_Function12(rtl);

  FOR ALL : Parallel_phase_voltages_6Phase_src_MATLAB_Function11
    USE ENTITY work.Parallel_phase_voltages_6Phase_src_MATLAB_Function11(rtl);

  FOR ALL : Parallel_phase_voltages_6Phase_src_MATLAB_Function10
    USE ENTITY work.Parallel_phase_voltages_6Phase_src_MATLAB_Function10(rtl);

  FOR ALL : Parallel_phase_voltages_6Phase_src_MATLAB_Function9
    USE ENTITY work.Parallel_phase_voltages_6Phase_src_MATLAB_Function9(rtl);

  FOR ALL : Parallel_phase_voltages_6Phase_src_MATLAB_Function8
    USE ENTITY work.Parallel_phase_voltages_6Phase_src_MATLAB_Function8(rtl);

  FOR ALL : Parallel_phase_voltages_6Phase_src_MATLAB_Function7
    USE ENTITY work.Parallel_phase_voltages_6Phase_src_MATLAB_Function7(rtl);

  FOR ALL : Parallel_phase_voltages_6Phase_src_MATLAB_Function6
    USE ENTITY work.Parallel_phase_voltages_6Phase_src_MATLAB_Function6(rtl);

  FOR ALL : Parallel_phase_voltages_6Phase_src_MATLAB_Function5
    USE ENTITY work.Parallel_phase_voltages_6Phase_src_MATLAB_Function5(rtl);

  FOR ALL : Parallel_phase_voltages_6Phase_src_MATLAB_Function4
    USE ENTITY work.Parallel_phase_voltages_6Phase_src_MATLAB_Function4(rtl);

  FOR ALL : Parallel_phase_voltages_6Phase_src_MATLAB_Function3
    USE ENTITY work.Parallel_phase_voltages_6Phase_src_MATLAB_Function3(rtl);

  FOR ALL : Parallel_phase_voltages_6Phase_src_MATLAB_Function2
    USE ENTITY work.Parallel_phase_voltages_6Phase_src_MATLAB_Function2(rtl);

  FOR ALL : Parallel_phase_voltages_6Phase_src_MATLAB_Function1
    USE ENTITY work.Parallel_phase_voltages_6Phase_src_MATLAB_Function1(rtl);

  FOR ALL : Parallel_phase_voltages_6Phase_src_MATLAB_Function
    USE ENTITY work.Parallel_phase_voltages_6Phase_src_MATLAB_Function(rtl);
...
BEGIN
  u_MATLAB_Function15 : Parallel_phase_voltages_6Phase_src_MATLAB_Function15
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_MATLAB_Function14 : Parallel_phase_voltages_6Phase_src_MATLAB_Function14
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              theta_el_with_offset => theta_el_with_offset15,  -- single
  ...
  u_MATLAB_Function13 : Parallel_phase_voltages_6Phase_src_MATLAB_Function13
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              theta_el_with_offset => theta_el_with_offset15,  -- single
  ...
  u_MATLAB_Function12 : Parallel_phase_voltages_6Phase_src_MATLAB_Function12
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              theta_el_with_offset => theta_el_with_offset15,  -- single
  ...
  u_MATLAB_Function11 : Parallel_phase_voltages_6Phase_src_MATLAB_Function11
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              theta_el_with_offset => theta_el_with_offset15,  -- single
  ...
  u_MATLAB_Function10 : Parallel_phase_voltages_6Phase_src_MATLAB_Function10
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              theta_el_with_offset => theta_el_with_offset15,  -- single
  ...
  u_MATLAB_Function9 : Parallel_phase_voltages_6Phase_src_MATLAB_Function9
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              theta_el_with_offset => theta_el_with_offset15,  -- single
  ...
  u_MATLAB_Function8 : Parallel_phase_voltages_6Phase_src_MATLAB_Function8
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              theta_el_with_offset => theta_el_with_offset15,  -- single
  ...
  u_MATLAB_Function7 : Parallel_phase_voltages_6Phase_src_MATLAB_Function7
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              theta_el_with_offset => theta_el_with_offset15,  -- single
  ...
  u_MATLAB_Function6 : Parallel_phase_voltages_6Phase_src_MATLAB_Function6
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              theta_el_with_offset => theta_el_with_offset15,  -- single
  ...
  u_MATLAB_Function5 : Parallel_phase_voltages_6Phase_src_MATLAB_Function5
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              theta_el_with_offset => theta_el_with_offset15,  -- single
  ...
  u_MATLAB_Function4 : Parallel_phase_voltages_6Phase_src_MATLAB_Function4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              theta_el_with_offset => theta_el_with_offset15,  -- single
  ...
  u_MATLAB_Function3 : Parallel_phase_voltages_6Phase_src_MATLAB_Function3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              theta_el_with_offset => theta_el_with_offset15,  -- single
  ...
  u_MATLAB_Function2 : Parallel_phase_voltages_6Phase_src_MATLAB_Function2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              theta_el_with_offset => theta_el_with_offset15,  -- single
  ...
  u_MATLAB_Function1 : Parallel_phase_voltages_6Phase_src_MATLAB_Function1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              theta_el_with_offset => theta_el_with_offset15,  -- single
  ...
  u_MATLAB_Function : Parallel_phase_voltages_6Phase_src_MATLAB_Function
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              theta_el_with_offset => theta_el_with_offset15,  -- single
