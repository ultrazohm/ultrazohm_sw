-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\jonat\Documents\MA_JL_CIL\ip_cores\uz_JL_pmsmModel\hdl_prj\hdlsrc\uz_JL_pmsmModel\uz_JL_pmsmModel_src_nfp_recip_single.vhd
-- Created: 2026-05-15 11:32:46
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: uz_JL_pmsmModel_src_nfp_recip_single
-- Source Path: uz_JL_pmsmModel/uz_JL_pmsmModel/Elektrik/Subsystem2/nfp_recip_single
-- Hierarchy Level: 3
-- Model version: 1.66
-- 
...
ENTITY uz_JL_pmsmModel_src_nfp_recip_single IS
...
END uz_JL_pmsmModel_src_nfp_recip_single;


ARCHITECTURE rtl OF uz_JL_pmsmModel_src_nfp_recip_single IS
  ...
  SIGNAL alpha_aExponent_0_aMantissa_out1 : std_logic;  -- ufix1
  SIGNAL alpha_aExponent_cfType_Exponent_out1 : std_logic;  -- ufix1
  ...
  SIGNAL alpha_Exponent_0_cfType_Exp_out1 : std_logic;
  ...
  SIGNAL alpha_bitget_Mant_tmp_2_0_out1   : std_logic;
  SIGNAL alpha_bitget_Mant_tmp_1_0_out1   : std_logic;
...
BEGIN
  ...
  alpha_aExponent_0_aMantissa_out1 <= aExponent_0_out1 AND aMantissa_0_out1;

  alpha_aExponent_cfType_Exponent_out1 <= aExponent_cfType_Exponent_I_out1 OR alpha_aExponent_0_aMantissa_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay12_P5_28_reg(0) <= alpha_aExponent_cfType_Exponent_out1;
  ...
  alpha_Exponent_0_cfType_Exp_out1 <= aExponent_0_out1 OR aExponent_cfType_Exponent_I_out1;
  ...
  alpha_bitget_Mant_tmp_2_0_out1 <= BitSlice1_out1_1 OR sticky_bitsll_Q_Q_WordLen_out1;

  alpha_bitget_Mant_tmp_1_0_out1 <= BitSlice_out1_2 AND alpha_bitget_Mant_tmp_2_0_out1;
  ...
  if_bitget_Mant_tmp_1_0_out1 <= Bit_Concat_out1_25 WHEN alpha_bitget_Mant_tmp_1_0_out1 = '0' ELSE
      Mant_tmp_2_out1;
