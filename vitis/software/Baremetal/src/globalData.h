...
typedef struct{
	...
	uz_SetPoint_t* torque_to_current_dq_3ph_Last;
	uz_SetPoint_t* torque_to_current_dq_6ph_Pruef;
	uz_SpeedControl_t* speed_control_3ph_Last;
	uz_SpeedControl_t* speed_control_6ph_Pruef;
	uz_CurrentControl_t* current_control_3ph_Last;
	uz_CurrentControl_t* current_control_dq_6ph_Pruef;
	uz_CurrentControl_t* current_control_xy_6ph_Pruef;
