-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\parallel_8_delay_compensation\hdlsrc\parallel_8_delay_compensation\parallel_8_delay_compensation_src_MATLAB_Function.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: parallel_8_delay_compensation_src_MATLAB_Function
-- Source Path: parallel_8_delay_compensation/HDL_DUT/MATLAB Function
-- Hierarchy Level: 1
-- 
...
ENTITY parallel_8_delay_compensation_src_MATLAB_Function IS
...
END parallel_8_delay_compensation_src_MATLAB_Function;


ARCHITECTURE rtl OF parallel_8_delay_compensation_src_MATLAB_Function IS
  ...
  COMPONENT parallel_8_delay_compensation_src_nfp_sub_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          nfp_in1                         :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT parallel_8_delay_compensation_src_nfp_add_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          nfp_in1                         :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  FOR ALL : parallel_8_delay_compensation_src_nfp_sub_single
    USE ENTITY work.parallel_8_delay_compensation_src_nfp_sub_single(rtl);

  FOR ALL : parallel_8_delay_compensation_src_nfp_add_single
    USE ENTITY work.parallel_8_delay_compensation_src_nfp_add_single(rtl);
...
BEGIN
  ...
  u_nfp_sub_comp : parallel_8_delay_compensation_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_1 : parallel_8_delay_compensation_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_2 : parallel_8_delay_compensation_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp : parallel_8_delay_compensation_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_3 : parallel_8_delay_compensation_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp_1 : parallel_8_delay_compensation_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_4 : parallel_8_delay_compensation_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_1 : parallel_8_delay_compensation_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_5 : parallel_8_delay_compensation_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => id_measured,  -- single
  ...
  u_nfp_add_comp_2 : parallel_8_delay_compensation_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_6 : parallel_8_delay_compensation_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_2 : parallel_8_delay_compensation_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_7 : parallel_8_delay_compensation_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp_3 : parallel_8_delay_compensation_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_8 : parallel_8_delay_compensation_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_3 : parallel_8_delay_compensation_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_9 : parallel_8_delay_compensation_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp_4 : parallel_8_delay_compensation_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_10 : parallel_8_delay_compensation_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_4 : parallel_8_delay_compensation_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_11 : parallel_8_delay_compensation_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp_5 : parallel_8_delay_compensation_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
