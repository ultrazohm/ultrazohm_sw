...
static void uz_ParameterID_initialize_data_structs(uz_ParameterID_t *self, uz_ParameterID_Data_t *Data) {
	...
	Data->GlobalConfig.PMSM_config.Ld_Henry = 0.0f;
	Data->GlobalConfig.PMSM_config.Lq_Henry = 0.0f;
	Data->GlobalConfig.PMSM_config.R_ph_Ohm = 0.0f;
	Data->GlobalConfig.PMSM_config.Psi_PM_Vs = 0.00f;
	Data->GlobalConfig.PMSM_config.polePairs = 0.0f;
	Data->GlobalConfig.PMSM_config.J_kg_m_squared = 0.0f;
	Data->GlobalConfig.PMSM_config.I_max_Ampere = 0.0f;
