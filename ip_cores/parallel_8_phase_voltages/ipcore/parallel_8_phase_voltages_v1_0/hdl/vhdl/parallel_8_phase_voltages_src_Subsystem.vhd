-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\parallel_8_phase_voltages\hdlsrc\parallel_8_phase_voltages\parallel_8_phase_voltages_src_Subsystem.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: parallel_8_phase_voltages_src_Subsystem
-- Source Path: parallel_8_phase_voltages/Phase_voltages_per_switching_state2/Subsystem
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY parallel_8_phase_voltages_src_Subsystem IS
...
END parallel_8_phase_voltages_src_Subsystem;


ARCHITECTURE rtl OF parallel_8_phase_voltages_src_Subsystem IS

  -- Component Declarations
  COMPONENT parallel_8_phase_voltages_src_MATLAB_Function15
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          sin_theta_el                    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT parallel_8_phase_voltages_src_MATLAB_Function14
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          sin_theta_el                    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT parallel_8_phase_voltages_src_MATLAB_Function13
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          sin_theta_el                    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT parallel_8_phase_voltages_src_MATLAB_Function12
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          sin_theta_el                    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT parallel_8_phase_voltages_src_MATLAB_Function11
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          sin_theta_el                    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT parallel_8_phase_voltages_src_MATLAB_Function10
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          sin_theta_el                    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT parallel_8_phase_voltages_src_MATLAB_Function9
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          sin_theta_el                    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT parallel_8_phase_voltages_src_MATLAB_Function8
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          sin_theta_el                    :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  FOR ALL : parallel_8_phase_voltages_src_MATLAB_Function15
    USE ENTITY work.parallel_8_phase_voltages_src_MATLAB_Function15(rtl);

  FOR ALL : parallel_8_phase_voltages_src_MATLAB_Function14
    USE ENTITY work.parallel_8_phase_voltages_src_MATLAB_Function14(rtl);

  FOR ALL : parallel_8_phase_voltages_src_MATLAB_Function13
    USE ENTITY work.parallel_8_phase_voltages_src_MATLAB_Function13(rtl);

  FOR ALL : parallel_8_phase_voltages_src_MATLAB_Function12
    USE ENTITY work.parallel_8_phase_voltages_src_MATLAB_Function12(rtl);

  FOR ALL : parallel_8_phase_voltages_src_MATLAB_Function11
    USE ENTITY work.parallel_8_phase_voltages_src_MATLAB_Function11(rtl);

  FOR ALL : parallel_8_phase_voltages_src_MATLAB_Function10
    USE ENTITY work.parallel_8_phase_voltages_src_MATLAB_Function10(rtl);

  FOR ALL : parallel_8_phase_voltages_src_MATLAB_Function9
    USE ENTITY work.parallel_8_phase_voltages_src_MATLAB_Function9(rtl);

  FOR ALL : parallel_8_phase_voltages_src_MATLAB_Function8
    USE ENTITY work.parallel_8_phase_voltages_src_MATLAB_Function8(rtl);
...
BEGIN
  u_MATLAB_Function15 : parallel_8_phase_voltages_src_MATLAB_Function15
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_MATLAB_Function14 : parallel_8_phase_voltages_src_MATLAB_Function14
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              sin_theta_el => sin_theta_el,  -- single
  ...
  u_MATLAB_Function13 : parallel_8_phase_voltages_src_MATLAB_Function13
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              sin_theta_el => sin_theta_el,  -- single
  ...
  u_MATLAB_Function12 : parallel_8_phase_voltages_src_MATLAB_Function12
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              sin_theta_el => sin_theta_el,  -- single
  ...
  u_MATLAB_Function11 : parallel_8_phase_voltages_src_MATLAB_Function11
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              sin_theta_el => sin_theta_el,  -- single
  ...
  u_MATLAB_Function10 : parallel_8_phase_voltages_src_MATLAB_Function10
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              sin_theta_el => sin_theta_el,  -- single
  ...
  u_MATLAB_Function9 : parallel_8_phase_voltages_src_MATLAB_Function9
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              sin_theta_el => sin_theta_el,  -- single
  ...
  u_MATLAB_Function8 : parallel_8_phase_voltages_src_MATLAB_Function8
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              sin_theta_el => sin_theta_el,  -- single
