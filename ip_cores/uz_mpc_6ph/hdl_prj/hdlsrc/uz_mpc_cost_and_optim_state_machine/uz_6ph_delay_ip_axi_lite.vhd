-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_mpc_cost_and_optim_state_machine\uz_6ph_delay_ip_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_6ph_delay_ip_axi_lite
-- Source Path: uz_6ph_delay_ip/uz_6ph_delay_ip_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_6ph_delay_ip_axi_lite IS
...
END uz_6ph_delay_ip_axi_lite;


ARCHITECTURE rtl OF uz_6ph_delay_ip_axi_lite IS

  -- Component Declarations
  COMPONENT uz_6ph_delay_ip_addr_decoder
  ...
  COMPONENT uz_6ph_delay_ip_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : uz_6ph_delay_ip_addr_decoder
    USE ENTITY work.uz_6ph_delay_ip_addr_decoder(rtl);

  FOR ALL : uz_6ph_delay_ip_axi_lite_module
    USE ENTITY work.uz_6ph_delay_ip_axi_lite_module(rtl);
  ...
  SIGNAL write_omega_m_pu_tmp             : std_logic_vector(17 DOWNTO 0);  -- ufix18
...
BEGIN
  u_uz_6ph_delay_ip_addr_decoder_inst : uz_6ph_delay_ip_addr_decoder
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
              ...
              read_ix_delay_pu_AXI => read_ix_delay_pu_AXI,  -- sfix27_En24
              read_iy_delay_pu_AXI => read_iy_delay_pu_AXI,  -- sfix27_En24
              data_read => top_data_read,  -- ufix32
              write_axi_enable => write_axi_enable,  -- ufix1
              write_omega_m_pu => write_omega_m_pu_tmp,  -- sfix18_En15
  ...
  u_uz_6ph_delay_ip_axi_lite_module_inst : uz_6ph_delay_ip_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
  ...
  write_omega_m_pu <= write_omega_m_pu_tmp;
