...
int main(void)
{
 ...
 initialization_chain = init_gpios;
        ...
        case init_gpios:
            ...
            uz_frontplane_button_and_led_init(apu_version_final); // This has to be the third line of code since the assertion callback uses the LEDs to indicate an error
