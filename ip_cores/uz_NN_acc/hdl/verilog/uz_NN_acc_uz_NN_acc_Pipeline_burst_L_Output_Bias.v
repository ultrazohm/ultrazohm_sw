...
reg   [0:0] icmp_ln136_reg_164;
reg    ap_block_state2_pp0_stage0_iter1;
wire    ap_block_state3_pp0_stage0_iter2;
reg    ap_block_pp0_stage0_subdone;
wire   [0:0] icmp_ln136_fu_116_p2;
...
reg   [3:0] i_3_reg_159;
reg   [3:0] i_3_reg_159_pp0_iter1_reg;
reg   [31:0] arrays_addr_read_reg_168;
reg    ap_condition_exit_pp0_iter1_stage0;
wire   [63:0] zext_ln136_fu_139_p1;
reg   [3:0] i_fu_66;
wire   [3:0] add_ln136_fu_122_p2;
wire    ap_loop_init;
reg   [3:0] ap_sig_allocacmp_i_3;
wire   [31:0] zext_ln136_1_fu_112_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln136_fu_116_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln136_reg_164 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln136_fu_116_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln136_reg_164 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (icmp_ln136_reg_164 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln136_reg_164 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign L_Output_Bias_address0 = zext_ln136_fu_139_p1;

assign L_Output_Bias_d0 = arrays_addr_read_reg_168;

assign add_ln136_fu_122_p2 = (ap_sig_allocacmp_i_3 + 4'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((icmp_ln136_reg_164 == 1'd0) & (m_axi_arrays_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((icmp_ln136_reg_164 == 1'd0) & (m_axi_arrays_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((icmp_ln136_reg_164 == 1'd0) & (m_axi_arrays_RVALID == 1'b0));
end
...
assign icmp_ln136_fu_116_p2 = ((zext_ln136_1_fu_112_p1 == Action_size_input) ? 1'b1 : 1'b0);
...
assign zext_ln136_1_fu_112_p1 = ap_sig_allocacmp_i_3;

assign zext_ln136_fu_139_p1 = i_3_reg_159_pp0_iter1_reg;
