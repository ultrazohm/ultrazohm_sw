-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\Philipp\ultrazohm\ultrazohm_sw\ip_cores\uz_pmsm_model_nonlinear_6LUT\hdl_prj\hdlsrc\uz_pmsm_model_6LUT_pd\uz_pmsm_6LUT_approx_src_nfp_convert_double2single.vhd
-- Created: 2023-12-04 18:00:53
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_6LUT_approx_src_nfp_convert_double2single
-- Source Path: uz_pmsm_model_6LUT_pd/uz_pmsm_model_6LUT/nfp_convert_double2single
-- Hierarchy Level: 1
-- Model version: 7.21
-- 
...
ENTITY uz_pmsm_6LUT_approx_src_nfp_convert_double2single IS
...
END uz_pmsm_6LUT_approx_src_nfp_convert_double2single;


ARCHITECTURE rtl OF uz_pmsm_6LUT_approx_src_nfp_convert_double2single IS
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay23_PS_5_reg(0) <= alphainExponent_0_inMantis_out1;
