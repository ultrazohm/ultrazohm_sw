...
static uz_interlockDeadtime2L interlock_slotD1_pin_6_to_11 = { .base_address = XPAR_UZ_DIGITAL_ADAPTER_D1_ADAPTER_GATES_UZ_INTERLOCKDEADTIME_1_BASEADDR, .clock_frequency_MHz = 100, .deadtime_us = 0, .inverse_bottom_switch = true };
