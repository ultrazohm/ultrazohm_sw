-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\valen\Documents\repos\UZ\ultrazohm_sw\ip_cores\new_ninephase\hdl_opti\hdlsrc\uz_pmsm_model_9ph_working\uz_pmsm_model_9ph_opti_src_nfp_convert_sfix_17_En15_to_single.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_9ph_opti_src_nfp_convert_sfix_17_En15_to_single
-- Source Path: uz_pmsm_model_9ph_working/uz_pmsm_model_9ph/nfp_convert_sfix_17_En15_to_single
-- Hierarchy Level: 1
-- 
...
ENTITY uz_pmsm_model_9ph_opti_src_nfp_convert_sfix_17_En15_to_single IS
...
END uz_pmsm_model_9ph_opti_src_nfp_convert_sfix_17_En15_to_single;


ARCHITECTURE rtl OF uz_pmsm_model_9ph_opti_src_nfp_convert_sfix_17_En15_to_single IS

  -- Signals
  SIGNAL nfp_in_signed                    : signed(16 DOWNTO 0);  -- sfix17_En15
  ...
  SIGNAL Delay_out1_dtc                   : unsigned(16 DOWNTO 0);  -- ufix17_En15
  SIGNAL Unary_Minus_cast                 : signed(17 DOWNTO 0);  -- sfix18_En15
  SIGNAL Unary_Minus_cast_1               : signed(17 DOWNTO 0);  -- sfix18_En15
  SIGNAL Unary_Minus_out1                 : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL Unary_Minus_out1_dtc             : unsigned(16 DOWNTO 0);  -- ufix17_En15
  SIGNAL Switch_out1                      : unsigned(16 DOWNTO 0);  -- ufix17_En15
...
BEGIN
  ...
  CompareToZero1_out1 <= '1' WHEN Delay_out1 = to_signed(16#00000#, 17) ELSE
      '0';
  ...
  Compare_To_Zero_out1 <= '1' WHEN Delay_out1 < to_signed(16#00000#, 17) ELSE
      '0';
  ...
  Unary_Minus_cast <= resize(Delay_out1, 18);
