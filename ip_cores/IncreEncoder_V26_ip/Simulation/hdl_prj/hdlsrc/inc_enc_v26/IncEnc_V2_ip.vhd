-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/inc_enc_v26/IncEnc_V2_ip.vhd
...
ARCHITECTURE rtl OF IncEnc_V2_ip IS

  -- Component Declarations
  COMPONENT IncEnc_V2_ip_reset_sync
  ...
  COMPONENT IncEnc_V2_ip_axi_lite
  ...
  FOR ALL : IncEnc_V2_ip_reset_sync
    USE ENTITY work.IncEnc_V2_ip_reset_sync(rtl);

  FOR ALL : IncEnc_V2_ip_axi_lite
    USE ENTITY work.IncEnc_V2_ip_axi_lite(rtl);

  FOR ALL : IncEnc_V2_ip_dut
    USE ENTITY work.IncEnc_V2_ip_dut(rtl);
  ...
  SIGNAL write_dMinaxisMinHitMinCompare_AXI : std_logic_vector(31 DOWNTO 0);  -- ufix32
...
BEGIN
  u_IncEnc_V2_ip_reset_sync_inst : IncEnc_V2_ip_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset_x
              );

  u_IncEnc_V2_ip_axi_lite_inst : IncEnc_V2_ip_axi_lite
    PORT MAP( reset_x => reset_x,
              ...
              write_dMinaxisMinHitMinCompare_AXI => write_dMinaxisMinHitMinCompare_AXI,  -- ufix32
  ...
  u_IncEnc_V2_ip_dut_inst : IncEnc_V2_ip_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_x => reset_x,
              ...
              d_axis_Hit_Compare_AXI => write_dMinaxisMinHitMinCompare_AXI,  -- ufix32
  ...
  ip_timestamp <= unsigned'(X"8FC6852B");
