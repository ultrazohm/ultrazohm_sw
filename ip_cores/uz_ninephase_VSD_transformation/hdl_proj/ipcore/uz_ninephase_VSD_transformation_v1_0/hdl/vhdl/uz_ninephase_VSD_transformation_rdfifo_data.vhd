-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\valen\Documents\repos\UZ\ultrazohm_sw\ip_cores\uz_ninephase_VSD_transformation\hdl_proj\hdlsrc\uz_ninephase_VSD_transformation\uz_ninephase_VSD_transformation_rdfifo_data.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_ninephase_VSD_transformation_rdfifo_data
-- Source Path: uz_ninephase_VSD_transformation/uz_ninephase_VSD_transformation_axi4/uz_ninephase_VSD_transformation_axi4_module/uz_ninephase_VSD_transformation_rdfifo_data
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_ninephase_VSD_transformation_rdfifo_data IS
...
END uz_ninephase_VSD_transformation_rdfifo_data;


ARCHITECTURE rtl OF uz_ninephase_VSD_transformation_rdfifo_data IS

  -- Component Declarations
  COMPONENT uz_ninephase_VSD_transformation_SimpleDualPortRAM_generic
  ...
  FOR ALL : uz_ninephase_VSD_transformation_SimpleDualPortRAM_generic
    USE ENTITY work.uz_ninephase_VSD_transformation_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_uz_ninephase_VSD_transformation_rdfifo_data_classic_ram_generic : uz_ninephase_VSD_transformation_SimpleDualPortRAM_generic
