-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\FCS_MPC_3Phase_SPMSM\test_ipcore\hdlsrc\FCS_MPC_3Phase_SPMSM_TEST1\Test_FCS_MPC_3Phase_SPMSM_IP_Core_src_nfp_convert_sfix_56_En11_to_single.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Test_FCS_MPC_3Phase_SPMSM_IP_Core_src_nfp_convert_sfix_56_En11_to_single
-- Source Path: FCS_MPC_3Phase_SPMSM_TEST1/Microcontroller Software/Subsystem1/nfp_convert_sfix_56_En11_to_single
-- Hierarchy Level: 1
-- 
...
ENTITY Test_FCS_MPC_3Phase_SPMSM_IP_Core_src_nfp_convert_sfix_56_En11_to_single IS
...
END Test_FCS_MPC_3Phase_SPMSM_IP_Core_src_nfp_convert_sfix_56_En11_to_single;


ARCHITECTURE rtl OF Test_FCS_MPC_3Phase_SPMSM_IP_Core_src_nfp_convert_sfix_56_En11_to_single IS

  -- Signals
  SIGNAL nfp_in_signed                    : signed(55 DOWNTO 0);  -- sfix56_En11
  SIGNAL Delay_out1                       : signed(55 DOWNTO 0);  -- sfix56_En11
  ...
  SIGNAL Delay_out1_dtc                   : unsigned(55 DOWNTO 0);  -- ufix56_En11
  SIGNAL Unary_Minus_cast                 : signed(56 DOWNTO 0);  -- sfix57_En11
  SIGNAL Unary_Minus_cast_1               : signed(56 DOWNTO 0);  -- sfix57_En11
  SIGNAL Unary_Minus_out1                 : signed(55 DOWNTO 0);  -- sfix56_En11
  SIGNAL Unary_Minus_out1_dtc             : unsigned(55 DOWNTO 0);  -- ufix56_En11
  SIGNAL Switch_out1                      : unsigned(55 DOWNTO 0);  -- ufix56_En11
...
BEGIN
  ...
  CompareToZero1_out1 <= '1' WHEN Delay_out1 = to_signed(0, 56) ELSE
      '0';
  ...
  Compare_To_Zero_out1 <= '1' WHEN Delay_out1 < to_signed(0, 56) ELSE
      '0';
  ...
  Unary_Minus_cast <= resize(Delay_out1, 57);
