#ifndef UZ_PMSMMODEL_NONLINEAR_HW_H
#define UZ_PMSMMODEL_NONLINEAR_HW_H
...
void uz_pmsmModel_nonlinear_hw_write_v_q(uint32_t base_address, float v_d);
void uz_pmsmModel_nonlinear_hw_write_v_d(uint32_t base_address, float v_q);
...
void uz_pmsmModel_nonlinear_hw_write_reciprocal_F1G1(uint32_t base_address, float reciprocal_F1G1);
void uz_pmsmModel_nonlinear_hw_write_reciprocal_F2G2(uint32_t base_address, float reciprocal_F2G2);
...
float uz_pmsmModel_nonlinear_hw_read_psi_q_approx(uint32_t base_address);
float uz_pmsmModel_nonlinear_hw_read_psi_d_approx(uint32_t base_address);
float uz_pmsmModel_nonlinear_hw_read_Lqq_approx(uint32_t base_address);
float uz_pmsmModel_nonlinear_hw_read_Ldd_approx(uint32_t base_address);
float uz_pmsmModel_nonlinear_hw_read_Lqd_approx(uint32_t base_address);
float uz_pmsmModel_nonlinear_hw_read_Ldq_approx(uint32_t base_address);
...
#endif // UZ_PMSMMODEL_NONLINEAR_HW_H
