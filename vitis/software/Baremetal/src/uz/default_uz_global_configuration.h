...
#define UZ_MIN_COST_FUNCTION_AND_VOPT_FCS_MPC_6PHASE_PMSM_MAX_INSTANCES 1U
#define UZ_PHASE_VOLTAGES_PER_SWITCHING_STATE_FCS_MPC_6PHASE_MAX_INSTANCES 1U
#define UZ_PREDICTION_AND_COST_FUNCTION_FCS_MPC_6PHASE_PMSM_MAX_INSTANCES       1U
...
=======
    ...
    #define UZ_MIN_COST_FUNCTION_AND_VOPT_FCS_MPC_6PHASE_PMSM_MAX_INSTANCES     11U
    #define UZ_PHASE_VOLTAGES_PER_SWITCHING_STATE_FCS_MPC_6PHASE_MAX_INSTANCES 11U
    #define UZ_PREDICTION_AND_COST_FUNCTION_FCS_MPC_6PHASE_PMSM_MAX_INSTANCES       11U
