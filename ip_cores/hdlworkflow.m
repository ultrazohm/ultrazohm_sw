%--------------------------------------------------------------------------
% HDL Workflow Script
% Generated with MATLAB 9.12 (R2022a) at 17:20:10 on 10/04/2026
% This script was generated using the following parameter values:
%     Filename  : 'C:\UltraZohm\ultrazohm_test\ip_cores\hdlworkflow.m'
%     Overwrite : true
%     Comments  : true
%     Headers   : true
...
hdlset_param('uz_axi_mytestIP', 'SynthesisToolDeviceName', 'xczu9eg-ffvc900-1L-i');
hdlset_param('uz_axi_mytestIP', 'SynthesisToolPackageName', '');
hdlset_param('uz_axi_mytestIP', 'SynthesisToolSpeedValue', '');
hdlset_param('uz_axi_mytestIP', 'TargetDirectory', 'hdl_prj\hdlsrc');
...
hdlset_param('uz_axi_mytestIP/uz_axi_mytestIP', 'IPCoreName', 'uz_axi_mytestIP');
...
% Set Inport HDL parameters
hdlset_param('uz_axi_mytestIP/uz_axi_mytestIP/A_fx_1_16_5', 'IOInterface', 'AXI4');
hdlset_param('uz_axi_mytestIP/uz_axi_mytestIP/A_fx_1_16_5', 'IOInterfaceMapping', 'x"110"');

% Set Inport HDL parameters
hdlset_param('uz_axi_mytestIP/uz_axi_mytestIP/B_fx_1_16_5', 'IOInterface', 'AXI4');
hdlset_param('uz_axi_mytestIP/uz_axi_mytestIP/B_fx_1_16_5', 'IOInterfaceMapping', 'x"114"');
...
% Set Outport HDL parameters
hdlset_param('uz_axi_mytestIP/uz_axi_mytestIP/C_fx_1_16_5', 'IOInterface', 'AXI4');
hdlset_param('uz_axi_mytestIP/uz_axi_mytestIP/C_fx_1_16_5', 'IOInterfaceMapping', 'x"120"');
