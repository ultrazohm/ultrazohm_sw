-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\IPCore_3Level_PWM\PWM_3Level_control_src_nfp_convert_double_to_fixed_20_En17.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: PWM_3Level_control_src_nfp_convert_double_to_fixed_20_En17
-- Source Path: IPCore_3Level_PWM/IP_Core_3-Level_PWM/GenPWM/PWM_Direct_Comparison/nfp_convert_double_to_fixed_20_En17
-- Hierarchy Level: 3
-- Model version: 1.13
-- 
...
ENTITY PWM_3Level_control_src_nfp_convert_double_to_fixed_20_En17 IS
...
END PWM_3Level_control_src_nfp_convert_double_to_fixed_20_En17;


ARCHITECTURE rtl OF PWM_3Level_control_src_nfp_convert_double_to_fixed_20_En17 IS
  ...
  SIGNAL Data_Type_Conversion1_out1_1     : unsigned(55 DOWNTO 0);  -- ufix56_En53
  SIGNAL Data_Type_Conversion1_out1_2     : unsigned(55 DOWNTO 0);  -- ufix56_En53
  ...
  SIGNAL Shift_Arithmetic1_out1           : unsigned(55 DOWNTO 0);  -- ufix56_En53
  SIGNAL Delay4_out1_1                    : unsigned(55 DOWNTO 0);  -- ufix56_En53
  ...
  SIGNAL Shift_Arithmetic2_out1           : unsigned(55 DOWNTO 0);  -- ufix56_En53
  SIGNAL Delay6_out1                      : unsigned(55 DOWNTO 0);  -- ufix56_En53
  SIGNAL Switch1_out1                     : unsigned(55 DOWNTO 0);  -- ufix56_En53
  SIGNAL Delay2_out1                      : unsigned(55 DOWNTO 0);  -- ufix56_En53
  SIGNAL Data_Type_Conversion3_out1       : signed(56 DOWNTO 0);  -- sfix57_En53
  SIGNAL Unary_Minus_cast                 : signed(57 DOWNTO 0);  -- sfix58_En53
  SIGNAL Unary_Minus_cast_1               : signed(57 DOWNTO 0);  -- sfix58_En53
  SIGNAL Unary_Minus_out1                 : signed(56 DOWNTO 0);  -- sfix57_En53
  SIGNAL Switch1_out1_1                   : signed(56 DOWNTO 0);  -- sfix57_En53
  SIGNAL Delay1_out1                      : signed(56 DOWNTO 0);  -- sfix57_En53
  SIGNAL Data_Type_Conversion2_out1       : signed(19 DOWNTO 0);  -- sfix20_En17
  SIGNAL Delay8_out1_1                    : signed(19 DOWNTO 0);  -- sfix20_En17
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Data_Type_Conversion1_out1_2 <= to_unsigned(0, 56);
      ELSIF enb = '1' THEN
  ...
  Data_Type_Conversion3_out1 <= signed(resize(Delay2_out1, 57));

  Unary_Minus_cast <= resize(Data_Type_Conversion3_out1, 58);
  ...
  Data_Type_Conversion2_out1 <= Delay1_out1(55 DOWNTO 36) + ('0' & Delay1_out1(35));

  Delay8_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay8_out1_1 <= to_signed(16#00000#, 20);
      ELSIF enb = '1' THEN
