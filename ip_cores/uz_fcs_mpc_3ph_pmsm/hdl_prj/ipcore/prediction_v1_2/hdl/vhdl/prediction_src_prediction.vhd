...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay50_out1 <= '0';
      ELSIF enb_1_2_0 = '1' THEN
        Delay50_out1 <= trigger_prediction;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        From16_out1 <= to_signed(16#0000000#, 27);
      ELSIF enb_1_2_0 = '1' THEN
        From16_out1 <= Add1_out1;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        From19_out1 <= to_signed(16#0000000#, 27);
      ELSIF enb_1_2_0 = '1' THEN
        From19_out1 <= Add3_out1;
      END IF;
    END IF;
