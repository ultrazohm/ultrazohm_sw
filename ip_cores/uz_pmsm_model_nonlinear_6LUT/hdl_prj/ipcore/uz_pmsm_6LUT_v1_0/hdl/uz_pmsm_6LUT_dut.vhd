-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\Philipp\ultrazohm\ultrazohm_sw\ip_cores\uz_pmsm_model_nonlinear_6LUT\hdl_prj\hdlsrc\uz_pmsm_model_6LUT_pd\uz_pmsm_6LUT_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_6LUT_dut
-- Source Path: uz_pmsm_6LUT/uz_pmsm_6LUT_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END uz_pmsm_6LUT_dut;


ARCHITECTURE rtl OF uz_pmsm_6LUT_dut IS

  -- Component Declarations
  COMPONENT uz_pmsm_6LUT_src_uz_pmsm_model_6LUT
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : uz_pmsm_6LUT_src_uz_pmsm_model_6LUT
    USE ENTITY work.uz_pmsm_6LUT_src_uz_pmsm_model_6LUT(rtl);
...
BEGIN
  u_uz_pmsm_6LUT_src_uz_pmsm_model_6LUT : uz_pmsm_6LUT_src_uz_pmsm_model_6LUT
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
