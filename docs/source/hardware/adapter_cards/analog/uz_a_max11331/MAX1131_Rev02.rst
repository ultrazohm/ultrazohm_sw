...
.. image:: Rev02/MAX11_AdapterBoard_V2.png
   :width: 500
...
.. note ::
   :math:`{C_\mathrm{Diff}}` must have at least :math:`{10\,\mathrm{nF}}` so that the voltage does not drop when switching the MAX1131 multiplexer. This ensures that the measuring channel remains stable.
...
* :download:`LTSpice simulation Rev02 <Rev02/ltspice_MAX11331_Rev02.zip>`
