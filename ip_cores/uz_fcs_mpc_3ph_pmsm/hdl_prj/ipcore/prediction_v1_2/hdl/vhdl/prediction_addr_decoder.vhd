-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_mpc_3ph\prediction_addr_decoder.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: prediction_addr_decoder
-- Source Path: prediction/prediction_axi_lite/prediction_addr_decoder
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY prediction_addr_decoder IS
...
END prediction_addr_decoder;


ARCHITECTURE rtl OF prediction_addr_decoder IS
...
BEGIN
  ...
  data_read <= std_logic_vector(decode_rd_iq_pred_pu_AXI_1_1);
