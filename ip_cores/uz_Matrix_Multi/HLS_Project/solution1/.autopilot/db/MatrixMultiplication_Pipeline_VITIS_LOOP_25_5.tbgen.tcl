set moduleName MatrixMultiplication_Pipeline_VITIS_LOOP_25_5
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {MatrixMultiplication_Pipeline_VITIS_LOOP_25_5}
set C_modelType { void 0 }
set C_modelArgList {
	{ bitcast_ln26 float 32 regular  }
	{ B_rows int 64 regular  }
	{ acc float 32 regular {array 25 { 1 3 } 1 1 }  }
	{ add3211_out float 32 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "bitcast_ln26", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "B_rows", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "acc", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "add3211_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ bitcast_ln26 sc_in sc_lv 32 signal 0 } 
	...
	{ add3211_out sc_out sc_lv 32 signal 3 } 
	{ add3211_out_ap_vld sc_out sc_logic 1 outvld 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bitcast_ln26", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bitcast_ln26", "role": "default" }} , 
 	...
 	{ "name": "add3211_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "add3211_out", "role": "default" }} , 
 	{ "name": "add3211_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add3211_out", "role": "ap_vld" }}  ]}
...
set Spec2ImplPortList { 
	bitcast_ln26 { ap_none {  { bitcast_ln26 in_data 0 32 } } }
	B_rows { ap_none {  { B_rows in_data 0 64 } } }
	acc { ap_memory {  { acc_address0 mem_address 1 5 }  { acc_ce0 mem_ce 1 1 }  { acc_q0 in_data 0 32 } } }
	add3211_out { ap_vld {  { add3211_out out_data 1 32 }  { add3211_out_ap_vld out_vld 1 1 } } }
}
