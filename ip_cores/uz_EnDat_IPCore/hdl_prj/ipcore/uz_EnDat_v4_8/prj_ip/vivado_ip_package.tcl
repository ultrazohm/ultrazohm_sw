...
add_files -norecurse {../hdl/uz_EnDat_src_padding3.vhd}
...
add_files -norecurse {../hdl/uz_EnDat_src_Detect_Increase_block4.vhd}
...
set_property version {4.8} [ipx::current_core]
...
set_property core_revision 2113338953 [ipx::current_core]
...
ipx::add_file {hdl/uz_EnDat_src_padding3.vhd} [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/uz_EnDat_src_padding3.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]]
ipx::add_file {hdl/uz_EnDat_src_padding3.vhd} [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/uz_EnDat_src_padding3.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]]
...
ipx::add_file {hdl/uz_EnDat_src_Detect_Increase_block4.vhd} [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/uz_EnDat_src_Detect_Increase_block4.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]]
ipx::add_file {hdl/uz_EnDat_src_Detect_Increase_block4.vhd} [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/uz_EnDat_src_Detect_Increase_block4.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]]
...
# Package IP
ipx::archive_core {../uz_EnDat_v4_8.zip} [ipx::current_core]
close_project
exit
