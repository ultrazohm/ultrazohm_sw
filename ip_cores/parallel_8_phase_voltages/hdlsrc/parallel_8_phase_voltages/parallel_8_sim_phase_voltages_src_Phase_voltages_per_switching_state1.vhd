...
ARCHITECTURE rtl OF parallel_8_sim_phase_voltages_src_Phase_voltages_per_switching_state1 IS
  ...
  COMPONENT parallel_8_sim_phase_voltages_src_Detect_Rise_Positive2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  COMPONENT parallel_8_sim_phase_voltages_src_Detect_Rise_Positive3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  FOR ALL : parallel_8_sim_phase_voltages_src_Detect_Rise_Positive2
    USE ENTITY work.parallel_8_sim_phase_voltages_src_Detect_Rise_Positive2(rtl);

  FOR ALL : parallel_8_sim_phase_voltages_src_Detect_Rise_Positive3
    USE ENTITY work.parallel_8_sim_phase_voltages_src_Detect_Rise_Positive3(rtl);
  ...
  SIGNAL Delay5_reg_next                  : std_logic_vector(0 TO 1);  -- ufix1 [2]
  ...
  SIGNAL Delay3_reg_next                  : vector_of_signed18(0 TO 1);  -- sfix18_En14 [2]
  SIGNAL Delay3_out1                      : signed(17 DOWNTO 0);  -- sfix18_En14
  SIGNAL Switch_on2_out1                  : signed(17 DOWNTO 0);  -- sfix18_En14
  ...
  SIGNAL Delay4_reg_next                  : vector_of_signed18(0 TO 1);  -- sfix18_En14 [2]
  SIGNAL Delay4_out1                      : signed(17 DOWNTO 0);  -- sfix18_En14
  SIGNAL Switch_on13_out1                 : signed(17 DOWNTO 0);  -- sfix18_En14
  SIGNAL Delay13_out1                     : signed(17 DOWNTO 0);  -- sfix18_En14
  SIGNAL Add4_out1                        : signed(17 DOWNTO 0);  -- sfix18_En14
  SIGNAL Add4_out1_1                      : signed(17 DOWNTO 0);  -- sfix18_En14
  ...
  SIGNAL Add4_out1_2                      : signed(17 DOWNTO 0);  -- sfix18_En14
  SIGNAL Constant2_out1                   : signed(17 DOWNTO 0);  -- sfix18_En14
  SIGNAL Add5_out1                        : signed(17 DOWNTO 0);  -- sfix18_En14
  SIGNAL Compare_Limit_Low1_out1_1        : std_logic;
  SIGNAL Add5_out1_1                      : signed(17 DOWNTO 0);  -- sfix18_En14
  SIGNAL Switch_Limit_High1_out1          : signed(17 DOWNTO 0);  -- sfix18_En14
  SIGNAL Constant3_out1                   : signed(17 DOWNTO 0);  -- sfix18_En14
  SIGNAL Add6_out1                        : signed(17 DOWNTO 0);  -- sfix18_En14
  SIGNAL Add6_out1_1                      : signed(17 DOWNTO 0);  -- sfix18_En14
  SIGNAL End_Cycle_4                      : signed(17 DOWNTO 0);  -- sfix18_En14
...
BEGIN
  u_Detect_Rise_Positive2 : parallel_8_sim_phase_voltages_src_Detect_Rise_Positive2
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              U => Delay6_out1,
  ...
  u_Detect_Rise_Positive3 : parallel_8_sim_phase_voltages_src_Detect_Rise_Positive3
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              U => Delay7_out1,
  ...
  u_Sine_HDL_Optimized2 : parallel_8_sim_phase_voltages_src_Sine_HDL_Optimized2
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              u => std_logic_vector(Delay12_out1),  -- sfix18_En14
              x => Sine,  -- sfix16_En14
  ...
  End_Cycle_2 <= End_Cycle OR End_Cycle_1;
  ...
  Delay5_reg_next(0) <= current_valid_in;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay3_reg(0) <= to_signed(16#00000#, 18);
        Delay3_reg(1) <= to_signed(16#00000#, 18);
      ELSIF enb = '1' THEN
  ...
  Delay3_reg_next(0) <= theta_el_signed;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay4_reg(0) <= to_signed(16#00000#, 18);
        Delay4_reg(1) <= to_signed(16#00000#, 18);
      ELSIF enb = '1' THEN
  ...
  Delay4_reg_next(0) <= theta_el_offset_AXI_signed;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Add4_out1_1 <= to_signed(16#00000#, 18);
      ELSIF enb = '1' THEN
  ...
  Compare_Limit_Low1_out1 <= '1' WHEN Add4_out1_1 < to_signed(16#00000#, 18) ELSE
      '0';

  
  Compare_Limit_High1_out1 <= '1' WHEN Add4_out1_1 >= to_signed(16#19220#, 18) ELSE
      '0';
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Add4_out1_2 <= to_signed(16#00000#, 18);
      ELSIF enb = '1' THEN
  ...
  Constant2_out1 <= to_signed(16#19220#, 18);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Add5_out1_1 <= to_signed(16#00000#, 18);
      ELSIF enb = '1' THEN
  ...
  Constant3_out1 <= to_signed(16#19220#, 18);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Add6_out1_1 <= to_signed(16#00000#, 18);
      ELSIF enb = '1' THEN
  ...
  End_Cycle_4 <= Switch_Limit_High1_out1 WHEN Compare_Limit_Low1_out1_1 = '0' ELSE
      Add6_out1_1;

  Gain1_mul_temp <= to_signed(16#00A30#, 18) * End_Cycle_4;
