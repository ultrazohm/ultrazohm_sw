...
entity uz_VSD_6ph_asym_multiply_line14_Block_split1_proc174 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of uz_VSD_6ph_asym_multiply_line14_Block_split1_proc174 is 
...
attribute shreg_extract : string;
    ...
    signal scalar_val_0_read_reg_196 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal scalar_val_1_read_reg_201 : STD_LOGIC_VECTOR (31 downto 0);
    signal scalar_val_2_read_reg_206 : STD_LOGIC_VECTOR (31 downto 0);
    signal scalar_val_3_read_reg_211 : STD_LOGIC_VECTOR (31 downto 0);
    signal scalar_val_4_read_reg_216 : STD_LOGIC_VECTOR (31 downto 0);
    signal scalar_val_5_read_reg_221 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    fmul_32ns_32ns_32_3_max_dsp_1_U287 : component uz_VSD_6ph_asym_fmul_32ns_32ns_32_3_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    port map (
        clk => ap_clk,
        reset => ap_rst,
        din0 => scalar_val_0_read_reg_196,
        din1 => ap_const_lv32_3F5DB3D7,
        ce => ap_const_logic_1,
        dout => grp_fu_136_p2);

    fmul_32ns_32ns_32_3_max_dsp_1_U288 : component uz_VSD_6ph_asym_fmul_32ns_32ns_32_3_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    port map (
        clk => ap_clk,
        reset => ap_rst,
        din0 => scalar_val_1_read_reg_201,
        din1 => ap_const_lv32_3F000000,
        ce => ap_const_logic_1,
        dout => grp_fu_141_p2);

    fmul_32ns_32ns_32_3_max_dsp_1_U289 : component uz_VSD_6ph_asym_fmul_32ns_32ns_32_3_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    port map (
        clk => ap_clk,
        reset => ap_rst,
        din0 => scalar_val_2_read_reg_206,
        din1 => ap_const_lv32_BF5DB3D7,
        ce => ap_const_logic_1,
        dout => grp_fu_146_p2);

    fmul_32ns_32ns_32_3_max_dsp_1_U290 : component uz_VSD_6ph_asym_fmul_32ns_32ns_32_3_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    port map (
        clk => ap_clk,
        reset => ap_rst,
        din0 => scalar_val_3_read_reg_211,
        din1 => ap_const_lv32_3F000000,
        ce => ap_const_logic_1,
        dout => grp_fu_151_p2);

    fmul_32ns_32ns_32_3_max_dsp_1_U291 : component uz_VSD_6ph_asym_fmul_32ns_32ns_32_3_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    port map (
        clk => ap_clk,
        reset => ap_rst,
        din0 => scalar_val_4_read_reg_216,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((ap_start = ap_const_logic_0) or (val_5_out_full_n = ap_const_logic_0) or (scalar_val_5_empty_n = ap_const_logic_0) or (val_4_out_full_n = ap_const_logic_0) or (scalar_val_4_empty_n = ap_const_logic_0) or (val_3_out_full_n = ap_const_logic_0) or (scalar_val_3_empty_n = ap_const_logic_0) or (val_2_out_full_n = ap_const_logic_0) or (scalar_val_2_empty_n = ap_const_logic_0) or (val_1_out_full_n = ap_const_logic_0) or (scalar_val_1_empty_n = ap_const_logic_0) or (val_0_out_full_n = ap_const_logic_0) or (scalar_val_0_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                scalar_val_0_read_reg_196 <= scalar_val_0_dout;
                scalar_val_1_read_reg_201 <= scalar_val_1_dout;
                scalar_val_2_read_reg_206 <= scalar_val_2_dout;
                scalar_val_3_read_reg_211 <= scalar_val_3_dout;
                scalar_val_4_read_reg_216 <= scalar_val_4_dout;
                scalar_val_5_read_reg_221 <= scalar_val_5_dout;
            end if;
        end if;
    end process;
    ...
    ap_return_0 <= grp_fu_136_p2;
    ap_return_1 <= grp_fu_141_p2;
    ap_return_2 <= grp_fu_146_p2;
    ap_return_3 <= grp_fu_151_p2;
    ap_return_4 <= grp_fu_156_p2;
    ap_return_5 <= scalar_val_5_read_reg_221;
