...
ARCHITECTURE rtl OF parallel_8_sim_phase_voltages_src_Phase_voltages_per_switching_state1 IS
  ...
  SIGNAL Delay7_reg                       : std_logic_vector(0 TO 1);  -- ufix1 [2]
  SIGNAL Delay7_reg_next                  : std_logic_vector(0 TO 1);  -- ufix1 [2]
  ...
  SIGNAL Delay8_reg                       : vector_of_std_logic_vector32(0 TO 1);  -- ufix32 [2]
  SIGNAL Delay8_reg_next                  : vector_of_std_logic_vector32(0 TO 1);  -- ufix32 [2]
  ...
  SIGNAL Delay9_reg_next                  : vector_of_signed32(0 TO 1);  -- sfix32 [2]
  ...
  SIGNAL Delay3_reg                       : vector_of_signed24(0 TO 1);  -- sfix24 [2]
  SIGNAL Delay3_reg_next                  : vector_of_signed24(0 TO 1);  -- sfix24_En20 [2]
  ...
  SIGNAL Delay4_reg                       : vector_of_signed24(0 TO 1);  -- sfix24 [2]
  SIGNAL Delay4_reg_next                  : vector_of_signed24(0 TO 1);  -- sfix24_En20 [2]
...
BEGIN
  ...
  Delay6_reg_next(0) <= done_delay_compensation;
  ...
  Delay7_reg_next(0) <= done_min_cost_function_and_vopt;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay8_reg(0) <= X"00000000";
        Delay8_reg(1) <= X"00000000";
      ELSIF enb = '1' THEN
  ...
  Delay8_reg_next(0) <= u_dc_link_voltage_AXI;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay9_reg(0) <= to_signed(0, 32);
        Delay9_reg(1) <= to_signed(0, 32);
      ELSIF enb = '1' THEN
  ...
  Delay9_reg_next(0) <= Index_signed;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay3_reg(0) <= to_signed(16#000000#, 24);
        Delay3_reg(1) <= to_signed(16#000000#, 24);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay4_reg(0) <= to_signed(16#000000#, 24);
        Delay4_reg(1) <= to_signed(16#000000#, 24);
      ELSIF enb = '1' THEN
