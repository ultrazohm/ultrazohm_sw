-- -------------------------------------------------------------
-- 
-- File Name: /home/ts/Documents/integrate_nn_to_uz/ultrazohm_sw/ip_cores/nnAXI_v1_0/hdl_prj/hdlsrc/uz_mlp_three_layer/uz_mlp_three_layer_src_MAC2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_mlp_three_layer_src_MAC2
-- Source Path: uz_mlp_three_layer/uz_mlp_three_layer/reluLayer_4Parallel/MAC2
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_mlp_three_layer_src_MAC2 IS
...
END uz_mlp_three_layer_src_MAC2;


ARCHITECTURE rtl OF uz_mlp_three_layer_src_MAC2 IS

  -- Component Declarations
  COMPONENT uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block9
  ...
  COMPONENT uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block11
    GENERIC( AddrWidth                    : integer;
             DataWidth                    : integer
             );
    PORT( clk                             :   IN    std_logic;
  ...
  COMPONENT uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block10
    GENERIC( AddrWidth                    : integer;
             DataWidth                    : integer
             );
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block9
    USE ENTITY work.uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block9(rtl);

  FOR ALL : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block11
    USE ENTITY work.uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block11(rtl);

  FOR ALL : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block10
    USE ENTITY work.uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block10(rtl);
...
BEGIN
  u_Dual_Port_RAM_System1 : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block9
    GENERIC MAP( AddrWidth => 10,
                 DataWidth => 32
                 )
    PORT MAP( clk => clk,
              enb => enb,
              wr_din => axi_signals_axi_biasData,
              wr_addr => axi_signals_axi_biasAddr,
              wr_en => AND1_out1,
              rd_addr => fromStateMachine_n_perceptron,
              rd_dout => c
              );

  u_Dual_Port_RAM_System3 : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block11
    GENERIC MAP( AddrWidth => 10,
                 DataWidth => 32
                 )
    PORT MAP( clk => clk,
  ...
  u_Dual_Port_RAM_System2 : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block10
    GENERIC MAP( AddrWidth => 10,
                 DataWidth => 32
                 )
    PORT MAP( clk => clk,
  ...
  Compare_To_Constant1_out1 <= '1' WHEN axi_biasWriteEnable = to_unsigned(16#02#, 8) ELSE
      '0';
  ...
  Compare_To_Constant_out1 <= '1' WHEN axi_weightsWriteEnable = to_unsigned(16#02#, 8) ELSE
      '0';
  ...
  biasData <= std_logic_vector(axi_biasData);

  axi_biasAddr <= unsigned(axi_signals_axi_biasAddr);

  biasWriteAddr <= std_logic_vector(axi_biasAddr);

  rd_dout <= Dual_Port_RAM_System2_out1;

  biasWriteEnable <= AND1_out1;
