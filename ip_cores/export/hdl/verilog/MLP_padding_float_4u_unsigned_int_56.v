...
module MLP_padding_float_4u_unsigned_int_56 (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
reg    p_n_out_blk_n;
reg   [60:0] indvar_flatten_reg_113;
reg   [28:0] i_reg_124;
wire   [28:0] p_n_cast2_i_i_fu_148_p1;
reg   [28:0] p_n_cast2_i_i_reg_225;
reg    ap_block_state1;
wire   [28:0] l_totalNum_fu_168_p3;
reg   [28:0] l_totalNum_reg_230;
wire   [60:0] mul_ln52_fu_184_p2;
reg   [60:0] mul_ln52_reg_235;
wire   [0:0] icmp_ln58_fu_190_p2;
wire    ap_block_state2_pp0_stage0_iter0;
reg    ap_predicate_op38_read_state3;
reg    ap_block_state3_pp0_stage0_iter1;
reg    ap_block_pp0_stage0_11001;
wire   [60:0] add_ln58_fu_195_p2;
reg    ap_enable_reg_pp0_iter0;
wire   [0:0] icmp_ln61_fu_214_p2;
wire   [28:0] i_4_fu_219_p2;
...
wire   [28:0] add_ln56_fu_152_p2;
wire   [26:0] tmp_4_fu_158_p4;
wire   [31:0] mul_ln52_fu_184_p0;
wire   [28:0] mul_ln52_fu_184_p1;
wire   [0:0] icmp_ln59_fu_201_p2;
wire   [28:0] select_ln58_fu_206_p3;
wire    ap_CS_fsm_state4;
reg   [2:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
wire   [60:0] mul_ln52_fu_184_p00;
wire   [60:0] mul_ln52_fu_184_p10;
...
MLP_mul_32ns_29ns_61_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 29 ),
    .dout_WIDTH( 61 ))
mul_32ns_29ns_61_1_1_U282(
...
always @ (posedge ap_clk) begin
    if ((~((real_start == 1'b0) | (p_n_out_full_n == 1'b0) | (l_numElem_cast_loc_out_full_n == 1'b0) | (p_n_empty_n == 1'b0) | (l_numElem_cast_loc_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        l_totalNum_reg_230[28 : 2] <= l_totalNum_fu_168_p3[28 : 2];
        mul_ln52_reg_235 <= mul_ln52_fu_184_p2;
        p_n_cast2_i_i_reg_225[27 : 0] <= p_n_cast2_i_i_fu_148_p1[27 : 0];
    end
end
...
assign add_ln56_fu_152_p2 = (p_n_cast2_i_i_fu_148_p1 + 29'd3);

assign add_ln58_fu_195_p2 = (indvar_flatten_reg_113 + 61'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((icmp_ln58_reg_240 == 1'd0) & (l_pad_full_n == 1'b0)) | ((l_data_empty_n == 1'b0) & (ap_predicate_op38_read_state3 == 1'b1))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((icmp_ln58_reg_240 == 1'd0) & (l_pad_full_n == 1'b0)) | ((l_data_empty_n == 1'b0) & (ap_predicate_op38_read_state3 == 1'b1))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((icmp_ln58_reg_240 == 1'd0) & (l_pad_full_n == 1'b0)) | ((l_data_empty_n == 1'b0) & (ap_predicate_op38_read_state3 == 1'b1))));
end
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter1 = (((icmp_ln58_reg_240 == 1'd0) & (l_pad_full_n == 1'b0)) | ((l_data_empty_n == 1'b0) & (ap_predicate_op38_read_state3 == 1'b1)));
end
...
assign i_4_fu_219_p2 = (select_ln58_fu_206_p3 + 29'd1);
...
assign l_pad_din = ap_phi_mux_empty_phi_fu_139_p4;

assign l_totalNum_fu_168_p3 = {{tmp_4_fu_158_p4}, {2'd0}};

assign mul_ln52_fu_184_p0 = mul_ln52_fu_184_p00;

assign mul_ln52_fu_184_p00 = p_n_dout;
...
assign select_ln58_fu_206_p3 = ((icmp_ln59_fu_201_p2[0:0] === 1'b1) ? 29'd0 : i_reg_124);

assign start_out = real_start;

assign tmp_4_fu_158_p4 = {{add_ln56_fu_152_p2[28:2]}};

always @ (posedge ap_clk) begin
    p_n_cast2_i_i_reg_225[28] <= 1'b0;
    l_totalNum_reg_230[1:0] <= 2'b00;
end

endmodule //MLP_padding_float_4u_unsigned_int_56
