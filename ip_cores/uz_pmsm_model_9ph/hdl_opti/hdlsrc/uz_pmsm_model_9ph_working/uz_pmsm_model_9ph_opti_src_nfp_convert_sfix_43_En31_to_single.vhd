-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\valen\Documents\repos\UZ\ultrazohm_sw\ip_cores\new_ninephase\hdl_opti\hdlsrc\uz_pmsm_model_9ph_working\uz_pmsm_model_9ph_opti_src_nfp_convert_sfix_43_En31_to_single.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_9ph_opti_src_nfp_convert_sfix_43_En31_to_single
-- Source Path: uz_pmsm_model_9ph_working/uz_pmsm_model_9ph/Transformation/nfp_convert_sfix_43_En31_to_single
-- Hierarchy Level: 2
-- 
...
ENTITY uz_pmsm_model_9ph_opti_src_nfp_convert_sfix_43_En31_to_single IS
...
END uz_pmsm_model_9ph_opti_src_nfp_convert_sfix_43_En31_to_single;


ARCHITECTURE rtl OF uz_pmsm_model_9ph_opti_src_nfp_convert_sfix_43_En31_to_single IS

  -- Signals
  SIGNAL nfp_in_signed                    : signed(42 DOWNTO 0);  -- sfix43_En31
  SIGNAL Delay_out1                       : signed(42 DOWNTO 0);  -- sfix43_En31
  ...
  SIGNAL Delay_out1_dtc                   : unsigned(42 DOWNTO 0);  -- ufix43_En31
  SIGNAL Unary_Minus_cast                 : signed(43 DOWNTO 0);  -- sfix44_En31
  SIGNAL Unary_Minus_cast_1               : signed(43 DOWNTO 0);  -- sfix44_En31
  SIGNAL Unary_Minus_out1                 : signed(42 DOWNTO 0);  -- sfix43_En31
  SIGNAL Unary_Minus_out1_dtc             : unsigned(42 DOWNTO 0);  -- ufix43_En31
  SIGNAL Switch_out1                      : unsigned(42 DOWNTO 0);  -- ufix43_En31
  SIGNAL Data_Type_Conversion_out1        : unsigned(127 DOWNTO 0);  -- ufix128_En31
  ...
  SIGNAL Delay2_reg_next                  : vector_of_unsigned128(0 TO 2);  -- ufix128_En31 [3]
  SIGNAL Delay2_out1_3                    : unsigned(127 DOWNTO 0);  -- ufix128_En31
  ...
  SIGNAL Shift_Arithmetic_out1            : unsigned(127 DOWNTO 0);  -- ufix128_En31
...
BEGIN
  ...
  CompareToZero1_out1 <= '1' WHEN Delay_out1 = to_signed(0, 43) ELSE
      '0';
  ...
  Compare_To_Zero_out1 <= '1' WHEN Delay_out1 < to_signed(0, 43) ELSE
      '0';
  ...
  Unary_Minus_cast <= resize(Delay_out1, 44);
  Unary_Minus_cast_1 <=  - (Unary_Minus_cast);
  Unary_Minus_out1 <= Unary_Minus_cast_1(42 DOWNTO 0);
  ...
  Constant_out1 <= to_signed(16#5F#, 8);
