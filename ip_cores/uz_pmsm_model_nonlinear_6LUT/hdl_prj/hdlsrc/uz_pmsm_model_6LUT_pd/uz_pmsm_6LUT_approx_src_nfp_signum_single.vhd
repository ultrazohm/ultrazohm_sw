-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\Philipp\ultrazohm\ultrazohm_sw\ip_cores\uz_pmsm_model_nonlinear_6LUT\hdl_prj\hdlsrc\uz_pmsm_model_6LUT_pd\uz_pmsm_6LUT_approx_src_nfp_signum_single.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_6LUT_approx_src_nfp_signum_single
-- Source Path: uz_pmsm_model_6LUT_pd/uz_pmsm_model_6LUT/nfp_signum_single
-- Hierarchy Level: 1
-- Model version: 7.22
-- 
-- -------------------------------------------------------------
...
ENTITY uz_pmsm_6LUT_approx_src_nfp_signum_single IS
  PORT( nfp_in                            :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_out                           :   OUT   std_logic_vector(31 DOWNTO 0)  -- ufix32
        );
END uz_pmsm_6LUT_approx_src_nfp_signum_single;


ARCHITECTURE rtl OF uz_pmsm_6LUT_approx_src_nfp_signum_single IS
