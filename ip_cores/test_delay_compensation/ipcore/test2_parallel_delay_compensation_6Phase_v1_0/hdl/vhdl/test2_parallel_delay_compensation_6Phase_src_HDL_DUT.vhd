...
ARCHITECTURE rtl OF test2_parallel_delay_compensation_6Phase_src_HDL_DUT IS
  ...
  SIGNAL Delay39_out1_1                   : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL delayMatch44_reg                 : std_logic_vector(0 TO 46);  -- ufix1 [47]
  SIGNAL delayMatch44_reg_next            : std_logic_vector(0 TO 46);  -- ufix1 [47]
...
BEGIN
  ...
  End_Cycle_5 <= delayMatch4_reg(11);
  ...
  Delay39_out1_1 <= delayMatch2_reg(5);
  delayMatch2_reg_next(0) <= Delay39_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        ...
        delayMatch44_reg(6) <= '0';
        delayMatch44_reg(7) <= '0';
        delayMatch44_reg(8) <= '0';
        delayMatch44_reg(9) <= '0';
        delayMatch44_reg(10) <= '0';
        delayMatch44_reg(11) <= '0';
        delayMatch44_reg(12) <= '0';
        delayMatch44_reg(13) <= '0';
        delayMatch44_reg(14) <= '0';
        delayMatch44_reg(15) <= '0';
        delayMatch44_reg(16) <= '0';
        delayMatch44_reg(17) <= '0';
        delayMatch44_reg(18) <= '0';
        delayMatch44_reg(19) <= '0';
        delayMatch44_reg(20) <= '0';
        delayMatch44_reg(21) <= '0';
        delayMatch44_reg(22) <= '0';
        delayMatch44_reg(23) <= '0';
        delayMatch44_reg(24) <= '0';
        delayMatch44_reg(25) <= '0';
        delayMatch44_reg(26) <= '0';
        delayMatch44_reg(27) <= '0';
        delayMatch44_reg(28) <= '0';
        delayMatch44_reg(29) <= '0';
        delayMatch44_reg(30) <= '0';
        delayMatch44_reg(31) <= '0';
        delayMatch44_reg(32) <= '0';
        delayMatch44_reg(33) <= '0';
        delayMatch44_reg(34) <= '0';
        delayMatch44_reg(35) <= '0';
        delayMatch44_reg(36) <= '0';
        delayMatch44_reg(37) <= '0';
        delayMatch44_reg(38) <= '0';
        delayMatch44_reg(39) <= '0';
        delayMatch44_reg(40) <= '0';
        delayMatch44_reg(41) <= '0';
        delayMatch44_reg(42) <= '0';
        delayMatch44_reg(43) <= '0';
        delayMatch44_reg(44) <= '0';
        delayMatch44_reg(45) <= '0';
        delayMatch44_reg(46) <= '0';
      ELSIF enb = '1' THEN
        ...
        delayMatch44_reg(12) <= delayMatch44_reg_next(12);
        delayMatch44_reg(13) <= delayMatch44_reg_next(13);
        delayMatch44_reg(14) <= delayMatch44_reg_next(14);
        delayMatch44_reg(15) <= delayMatch44_reg_next(15);
        delayMatch44_reg(16) <= delayMatch44_reg_next(16);
        delayMatch44_reg(17) <= delayMatch44_reg_next(17);
        delayMatch44_reg(18) <= delayMatch44_reg_next(18);
        delayMatch44_reg(19) <= delayMatch44_reg_next(19);
        delayMatch44_reg(20) <= delayMatch44_reg_next(20);
        delayMatch44_reg(21) <= delayMatch44_reg_next(21);
        delayMatch44_reg(22) <= delayMatch44_reg_next(22);
        delayMatch44_reg(23) <= delayMatch44_reg_next(23);
        delayMatch44_reg(24) <= delayMatch44_reg_next(24);
        delayMatch44_reg(25) <= delayMatch44_reg_next(25);
        delayMatch44_reg(26) <= delayMatch44_reg_next(26);
        delayMatch44_reg(27) <= delayMatch44_reg_next(27);
        delayMatch44_reg(28) <= delayMatch44_reg_next(28);
        delayMatch44_reg(29) <= delayMatch44_reg_next(29);
        delayMatch44_reg(30) <= delayMatch44_reg_next(30);
        delayMatch44_reg(31) <= delayMatch44_reg_next(31);
        delayMatch44_reg(32) <= delayMatch44_reg_next(32);
        delayMatch44_reg(33) <= delayMatch44_reg_next(33);
        delayMatch44_reg(34) <= delayMatch44_reg_next(34);
        delayMatch44_reg(35) <= delayMatch44_reg_next(35);
        delayMatch44_reg(36) <= delayMatch44_reg_next(36);
        delayMatch44_reg(37) <= delayMatch44_reg_next(37);
        delayMatch44_reg(38) <= delayMatch44_reg_next(38);
        delayMatch44_reg(39) <= delayMatch44_reg_next(39);
        delayMatch44_reg(40) <= delayMatch44_reg_next(40);
        delayMatch44_reg(41) <= delayMatch44_reg_next(41);
        delayMatch44_reg(42) <= delayMatch44_reg_next(42);
        delayMatch44_reg(43) <= delayMatch44_reg_next(43);
        delayMatch44_reg(44) <= delayMatch44_reg_next(44);
        delayMatch44_reg(45) <= delayMatch44_reg_next(45);
        delayMatch44_reg(46) <= delayMatch44_reg_next(46);
      END IF;
    END IF;
  END PROCESS delayMatch44_process;

  Delay22_out1 <= delayMatch44_reg(46);
  delayMatch44_reg_next(0) <= End_Cycle_1;
  ...
  delayMatch44_reg_next(12) <= delayMatch44_reg(11);
  delayMatch44_reg_next(13) <= delayMatch44_reg(12);
  delayMatch44_reg_next(14) <= delayMatch44_reg(13);
  delayMatch44_reg_next(15) <= delayMatch44_reg(14);
  delayMatch44_reg_next(16) <= delayMatch44_reg(15);
  delayMatch44_reg_next(17) <= delayMatch44_reg(16);
  delayMatch44_reg_next(18) <= delayMatch44_reg(17);
  delayMatch44_reg_next(19) <= delayMatch44_reg(18);
  delayMatch44_reg_next(20) <= delayMatch44_reg(19);
  delayMatch44_reg_next(21) <= delayMatch44_reg(20);
  delayMatch44_reg_next(22) <= delayMatch44_reg(21);
  delayMatch44_reg_next(23) <= delayMatch44_reg(22);
  delayMatch44_reg_next(24) <= delayMatch44_reg(23);
  delayMatch44_reg_next(25) <= delayMatch44_reg(24);
  delayMatch44_reg_next(26) <= delayMatch44_reg(25);
  delayMatch44_reg_next(27) <= delayMatch44_reg(26);
  delayMatch44_reg_next(28) <= delayMatch44_reg(27);
  delayMatch44_reg_next(29) <= delayMatch44_reg(28);
  delayMatch44_reg_next(30) <= delayMatch44_reg(29);
  delayMatch44_reg_next(31) <= delayMatch44_reg(30);
  delayMatch44_reg_next(32) <= delayMatch44_reg(31);
  delayMatch44_reg_next(33) <= delayMatch44_reg(32);
  delayMatch44_reg_next(34) <= delayMatch44_reg(33);
  delayMatch44_reg_next(35) <= delayMatch44_reg(34);
  delayMatch44_reg_next(36) <= delayMatch44_reg(35);
  delayMatch44_reg_next(37) <= delayMatch44_reg(36);
  delayMatch44_reg_next(38) <= delayMatch44_reg(37);
  delayMatch44_reg_next(39) <= delayMatch44_reg(38);
  delayMatch44_reg_next(40) <= delayMatch44_reg(39);
  delayMatch44_reg_next(41) <= delayMatch44_reg(40);
  delayMatch44_reg_next(42) <= delayMatch44_reg(41);
  delayMatch44_reg_next(43) <= delayMatch44_reg(42);
  delayMatch44_reg_next(44) <= delayMatch44_reg(43);
  delayMatch44_reg_next(45) <= delayMatch44_reg(44);
  delayMatch44_reg_next(46) <= delayMatch44_reg(45);
