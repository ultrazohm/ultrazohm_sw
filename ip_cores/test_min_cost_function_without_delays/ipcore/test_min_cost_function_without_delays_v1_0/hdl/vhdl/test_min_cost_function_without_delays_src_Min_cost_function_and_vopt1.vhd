-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\test_min_cost_function_without_delays\hdlsrc\test_min_cost_function_without_delays\test_min_cost_function_without_delays_src_Min_cost_function_and_vopt1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: test_min_cost_function_without_delays_src_Min_cost_function_and_vopt1
-- Source Path: test_min_cost_function_without_delays/Min_cost_function_and_vopt1
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
USE work.test_min_cost_function_without_delays_src_Min_cost_function_and_vopt1_pkg.ALL;

ENTITY test_min_cost_function_without_delays_src_Min_cost_function_and_vopt1 IS
...
END test_min_cost_function_without_delays_src_Min_cost_function_and_vopt1;


ARCHITECTURE rtl OF test_min_cost_function_without_delays_src_Min_cost_function_and_vopt1 IS

  -- Component Declarations
  COMPONENT test_min_cost_function_without_delays_src_Detect_Rise_Positive
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  COMPONENT test_min_cost_function_without_delays_src_Compare_To_Constant
    PORT( u                               :   IN    std_logic_vector(31 DOWNTO 0);  -- int32
          y                               :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT test_min_cost_function_without_delays_src_Compare_To_Constant1
    PORT( u                               :   IN    std_logic_vector(32 DOWNTO 0);  -- sfix33
          y                               :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT test_min_cost_function_without_delays_src_Compare_To_Constant2
    PORT( u                               :   IN    std_logic_vector(32 DOWNTO 0);  -- sfix33
          y                               :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT test_min_cost_function_without_delays_src_Compare_To_Constant3
    PORT( u                               :   IN    std_logic_vector(32 DOWNTO 0);  -- sfix33
          y                               :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT test_min_cost_function_without_delays_src_Compare_To_Constant4
    PORT( u                               :   IN    std_logic_vector(32 DOWNTO 0);  -- sfix33
          y                               :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT test_min_cost_function_without_delays_src_Compare_To_Constant5
    PORT( u                               :   IN    std_logic_vector(32 DOWNTO 0);  -- sfix33
          y                               :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT test_min_cost_function_without_delays_src_Compare_To_Constant6
    PORT( u                               :   IN    std_logic_vector(32 DOWNTO 0);  -- sfix33
          y                               :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT test_min_cost_function_without_delays_src_Compare_To_Constant7
    PORT( u                               :   IN    std_logic_vector(32 DOWNTO 0);  -- sfix33
          y                               :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT test_min_cost_function_without_delays_src_Compare_To_Constant8
    PORT( u                               :   IN    std_logic_vector(32 DOWNTO 0);  -- sfix33
          y                               :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT test_min_cost_function_without_delays_src_Compare_To_Constant9
    PORT( u                               :   IN    std_logic_vector(32 DOWNTO 0);  -- sfix33
          y                               :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT test_min_cost_function_without_delays_src_Compare_To_Constant10
    PORT( u                               :   IN    std_logic_vector(32 DOWNTO 0);  -- sfix33
          y                               :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT test_min_cost_function_without_delays_src_Compare_To_Constant11
    PORT( u                               :   IN    std_logic_vector(32 DOWNTO 0);  -- sfix33
          y                               :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT test_min_cost_function_without_delays_src_Compare_To_Constant12
    PORT( u                               :   IN    std_logic_vector(32 DOWNTO 0);  -- sfix33
          y                               :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT test_min_cost_function_without_delays_src_Compare_To_Constant13
    PORT( u                               :   IN    std_logic_vector(32 DOWNTO 0);  -- sfix33
          y                               :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT test_min_cost_function_without_delays_src_Compare_To_Constant14
    PORT( u                               :   IN    std_logic_vector(32 DOWNTO 0);  -- sfix33
          y                               :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT test_min_cost_function_without_delays_src_Compare_To_Constant15
    PORT( u                               :   IN    std_logic_vector(32 DOWNTO 0);  -- sfix33
          y                               :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT test_min_cost_function_without_delays_src_Detect_Rise_Positive1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  COMPONENT test_min_cost_function_without_delays_src_MATLAB_Function
  ...
  FOR ALL : test_min_cost_function_without_delays_src_Detect_Rise_Positive
    USE ENTITY work.test_min_cost_function_without_delays_src_Detect_Rise_Positive(rtl);

  FOR ALL : test_min_cost_function_without_delays_src_Compare_To_Constant
    USE ENTITY work.test_min_cost_function_without_delays_src_Compare_To_Constant(rtl);

  FOR ALL : test_min_cost_function_without_delays_src_Compare_To_Constant1
    USE ENTITY work.test_min_cost_function_without_delays_src_Compare_To_Constant1(rtl);

  FOR ALL : test_min_cost_function_without_delays_src_Compare_To_Constant2
    USE ENTITY work.test_min_cost_function_without_delays_src_Compare_To_Constant2(rtl);

  FOR ALL : test_min_cost_function_without_delays_src_Compare_To_Constant3
    USE ENTITY work.test_min_cost_function_without_delays_src_Compare_To_Constant3(rtl);

  FOR ALL : test_min_cost_function_without_delays_src_Compare_To_Constant4
    USE ENTITY work.test_min_cost_function_without_delays_src_Compare_To_Constant4(rtl);

  FOR ALL : test_min_cost_function_without_delays_src_Compare_To_Constant5
    USE ENTITY work.test_min_cost_function_without_delays_src_Compare_To_Constant5(rtl);

  FOR ALL : test_min_cost_function_without_delays_src_Compare_To_Constant6
    USE ENTITY work.test_min_cost_function_without_delays_src_Compare_To_Constant6(rtl);

  FOR ALL : test_min_cost_function_without_delays_src_Compare_To_Constant7
    USE ENTITY work.test_min_cost_function_without_delays_src_Compare_To_Constant7(rtl);

  FOR ALL : test_min_cost_function_without_delays_src_Compare_To_Constant8
    USE ENTITY work.test_min_cost_function_without_delays_src_Compare_To_Constant8(rtl);

  FOR ALL : test_min_cost_function_without_delays_src_Compare_To_Constant9
    USE ENTITY work.test_min_cost_function_without_delays_src_Compare_To_Constant9(rtl);

  FOR ALL : test_min_cost_function_without_delays_src_Compare_To_Constant10
    USE ENTITY work.test_min_cost_function_without_delays_src_Compare_To_Constant10(rtl);

  FOR ALL : test_min_cost_function_without_delays_src_Compare_To_Constant11
    USE ENTITY work.test_min_cost_function_without_delays_src_Compare_To_Constant11(rtl);

  FOR ALL : test_min_cost_function_without_delays_src_Compare_To_Constant12
    USE ENTITY work.test_min_cost_function_without_delays_src_Compare_To_Constant12(rtl);

  FOR ALL : test_min_cost_function_without_delays_src_Compare_To_Constant13
    USE ENTITY work.test_min_cost_function_without_delays_src_Compare_To_Constant13(rtl);

  FOR ALL : test_min_cost_function_without_delays_src_Compare_To_Constant14
    USE ENTITY work.test_min_cost_function_without_delays_src_Compare_To_Constant14(rtl);

  FOR ALL : test_min_cost_function_without_delays_src_Compare_To_Constant15
    USE ENTITY work.test_min_cost_function_without_delays_src_Compare_To_Constant15(rtl);

  FOR ALL : test_min_cost_function_without_delays_src_Detect_Rise_Positive1
    USE ENTITY work.test_min_cost_function_without_delays_src_Detect_Rise_Positive1(rtl);

  FOR ALL : test_min_cost_function_without_delays_src_MATLAB_Function
    USE ENTITY work.test_min_cost_function_without_delays_src_MATLAB_Function(rtl);
  ...
  SIGNAL End_Cycle_42                     : signed(19 DOWNTO 0);  -- sfix20_En11
  ...
  SIGNAL End_Cycle_47                     : signed(19 DOWNTO 0);  -- sfix20_En11
  ...
  SIGNAL End_Cycle_52                     : signed(19 DOWNTO 0);  -- sfix20_En11
  ...
  SIGNAL End_Cycle_57                     : signed(19 DOWNTO 0);  -- sfix20_En11
  ...
  SIGNAL End_Cycle_62                     : signed(19 DOWNTO 0);  -- sfix20_En11
  ...
  SIGNAL End_Cycle_67                     : signed(19 DOWNTO 0);  -- sfix20_En11
  ...
  SIGNAL End_Cycle_72                     : signed(19 DOWNTO 0);  -- sfix20_En11
  ...
  SIGNAL End_Cycle_77                     : signed(19 DOWNTO 0);  -- sfix20_En11
...
BEGIN
  u_Detect_Rise_Positive : test_min_cost_function_without_delays_src_Detect_Rise_Positive
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              U => valid_in,
  ...
  u_Compare_To_Constant : test_min_cost_function_without_delays_src_Compare_To_Constant
    PORT MAP( u => std_logic_vector(Switch_on1_out1),  -- int32
              y => Compare_To_Constant_out1
              );

  u_Compare_To_Constant1 : test_min_cost_function_without_delays_src_Compare_To_Constant1
    PORT MAP( u => std_logic_vector(Switch_on7_out1),  -- sfix33
              y => Compare_To_Constant1_out1
              );

  u_Compare_To_Constant2 : test_min_cost_function_without_delays_src_Compare_To_Constant2
    PORT MAP( u => std_logic_vector(Switch_on17_out1),  -- sfix33
              y => Compare_To_Constant2_out1
              );

  u_Compare_To_Constant3 : test_min_cost_function_without_delays_src_Compare_To_Constant3
    PORT MAP( u => std_logic_vector(Switch_on23_out1),  -- sfix33
              y => Compare_To_Constant3_out1
              );

  u_Compare_To_Constant4 : test_min_cost_function_without_delays_src_Compare_To_Constant4
    PORT MAP( u => std_logic_vector(Switch_on29_out1),  -- sfix33
              y => Compare_To_Constant4_out1
              );

  u_Compare_To_Constant5 : test_min_cost_function_without_delays_src_Compare_To_Constant5
    PORT MAP( u => std_logic_vector(Switch_on35_out1),  -- sfix33
              y => Compare_To_Constant5_out1
              );

  u_Compare_To_Constant6 : test_min_cost_function_without_delays_src_Compare_To_Constant6
    PORT MAP( u => std_logic_vector(Switch_on41_out1),  -- sfix33
              y => Compare_To_Constant6_out1
              );

  u_Compare_To_Constant7 : test_min_cost_function_without_delays_src_Compare_To_Constant7
    PORT MAP( u => std_logic_vector(Switch_on47_out1),  -- sfix33
              y => Compare_To_Constant7_out1
              );

  u_Compare_To_Constant8 : test_min_cost_function_without_delays_src_Compare_To_Constant8
    PORT MAP( u => std_logic_vector(Switch_on53_out1),  -- sfix33
              y => Compare_To_Constant8_out1
              );

  u_Compare_To_Constant9 : test_min_cost_function_without_delays_src_Compare_To_Constant9
    PORT MAP( u => std_logic_vector(Switch_on59_out1),  -- sfix33
              y => Compare_To_Constant9_out1
              );

  u_Compare_To_Constant10 : test_min_cost_function_without_delays_src_Compare_To_Constant10
    PORT MAP( u => std_logic_vector(Switch_on65_out1),  -- sfix33
              y => Compare_To_Constant10_out1
              );

  u_Compare_To_Constant11 : test_min_cost_function_without_delays_src_Compare_To_Constant11
    PORT MAP( u => std_logic_vector(Switch_on71_out1),  -- sfix33
              y => Compare_To_Constant11_out1
              );

  u_Compare_To_Constant12 : test_min_cost_function_without_delays_src_Compare_To_Constant12
    PORT MAP( u => std_logic_vector(Switch_on77_out1),  -- sfix33
              y => Compare_To_Constant12_out1
              );

  u_Compare_To_Constant13 : test_min_cost_function_without_delays_src_Compare_To_Constant13
    PORT MAP( u => std_logic_vector(Switch_on83_out1),  -- sfix33
              y => Compare_To_Constant13_out1
              );

  u_Compare_To_Constant14 : test_min_cost_function_without_delays_src_Compare_To_Constant14
    PORT MAP( u => std_logic_vector(Switch_on89_out1),  -- sfix33
              y => Compare_To_Constant14_out1
              );

  u_Compare_To_Constant15 : test_min_cost_function_without_delays_src_Compare_To_Constant15
    PORT MAP( u => std_logic_vector(Switch_on95_out1),  -- sfix33
              y => Compare_To_Constant15_out1
              );

  u_Detect_Rise_Positive1 : test_min_cost_function_without_delays_src_Detect_Rise_Positive1
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_MATLAB_Function : test_min_cost_function_without_delays_src_MATLAB_Function
  ...
  switch_compare_1_105 <= '1' WHEN End_Cycle = '1' ELSE
      '0';

  End_Cycle_42 <= signed(J_in_8);
  ...
  switch_compare_1_106 <= '1' WHEN End_Cycle = '1' ELSE
      '0';
  ...
  switch_compare_1_111 <= '1' WHEN End_Cycle = '1' ELSE
      '0';

  End_Cycle_43 <= signed(phase_voltages_per_switching_state_in_32);
  ...
  switch_compare_1_113 <= '1' WHEN End_Cycle = '1' ELSE
      '0';

  End_Cycle_44 <= signed(phase_voltages_per_switching_state_in_33);
  ...
  switch_compare_1_115 <= '1' WHEN End_Cycle = '1' ELSE
      '0';

  End_Cycle_45 <= signed(phase_voltages_per_switching_state_in_34);
  ...
  switch_compare_1_117 <= '1' WHEN End_Cycle = '1' ELSE
      '0';

  End_Cycle_46 <= signed(phase_voltages_per_switching_state_in_35);
  ...
  switch_compare_1_118 <= '1' WHEN End_Cycle = '1' ELSE
      '0';

  End_Cycle_47 <= signed(J_in_9);
  ...
  switch_compare_1_119 <= '1' WHEN End_Cycle = '1' ELSE
      '0';
  ...
  switch_compare_1_124 <= '1' WHEN End_Cycle = '1' ELSE
      '0';

  End_Cycle_48 <= signed(phase_voltages_per_switching_state_in_36);
  ...
  switch_compare_1_126 <= '1' WHEN End_Cycle = '1' ELSE
      '0';

  End_Cycle_49 <= signed(phase_voltages_per_switching_state_in_37);
  ...
  switch_compare_1_128 <= '1' WHEN End_Cycle = '1' ELSE
      '0';

  End_Cycle_50 <= signed(phase_voltages_per_switching_state_in_38);
  ...
  switch_compare_1_130 <= '1' WHEN End_Cycle = '1' ELSE
      '0';

  End_Cycle_51 <= signed(phase_voltages_per_switching_state_in_39);
  ...
  switch_compare_1_131 <= '1' WHEN End_Cycle = '1' ELSE
      '0';

  End_Cycle_52 <= signed(J_in_10);
  ...
  switch_compare_1_132 <= '1' WHEN End_Cycle = '1' ELSE
      '0';
  ...
  switch_compare_1_137 <= '1' WHEN End_Cycle = '1' ELSE
      '0';

  End_Cycle_53 <= signed(phase_voltages_per_switching_state_in_40);
  ...
  switch_compare_1_139 <= '1' WHEN End_Cycle = '1' ELSE
      '0';

  End_Cycle_54 <= signed(phase_voltages_per_switching_state_in_41);
  ...
  switch_compare_1_141 <= '1' WHEN End_Cycle = '1' ELSE
      '0';

  End_Cycle_55 <= signed(phase_voltages_per_switching_state_in_42);
  ...
  switch_compare_1_143 <= '1' WHEN End_Cycle = '1' ELSE
      '0';

  End_Cycle_56 <= signed(phase_voltages_per_switching_state_in_43);
  ...
  switch_compare_1_144 <= '1' WHEN End_Cycle = '1' ELSE
      '0';

  End_Cycle_57 <= signed(J_in_11);
  ...
  switch_compare_1_145 <= '1' WHEN End_Cycle = '1' ELSE
      '0';
  ...
  switch_compare_1_150 <= '1' WHEN End_Cycle = '1' ELSE
      '0';

  End_Cycle_58 <= signed(phase_voltages_per_switching_state_in_44);
  ...
  switch_compare_1_152 <= '1' WHEN End_Cycle = '1' ELSE
      '0';

  End_Cycle_59 <= signed(phase_voltages_per_switching_state_in_45);
  ...
  switch_compare_1_154 <= '1' WHEN End_Cycle = '1' ELSE
      '0';

  End_Cycle_60 <= signed(phase_voltages_per_switching_state_in_46);
  ...
  switch_compare_1_156 <= '1' WHEN End_Cycle = '1' ELSE
      '0';

  End_Cycle_61 <= signed(phase_voltages_per_switching_state_in_47);
  ...
  switch_compare_1_157 <= '1' WHEN End_Cycle = '1' ELSE
      '0';

  End_Cycle_62 <= signed(J_in_12);
  ...
  switch_compare_1_158 <= '1' WHEN End_Cycle = '1' ELSE
      '0';
  ...
  switch_compare_1_163 <= '1' WHEN End_Cycle = '1' ELSE
      '0';

  End_Cycle_63 <= signed(phase_voltages_per_switching_state_in_48);
  ...
  switch_compare_1_165 <= '1' WHEN End_Cycle = '1' ELSE
      '0';

  End_Cycle_64 <= signed(phase_voltages_per_switching_state_in_49);
  ...
  switch_compare_1_167 <= '1' WHEN End_Cycle = '1' ELSE
      '0';

  End_Cycle_65 <= signed(phase_voltages_per_switching_state_in_50);
  ...
  switch_compare_1_169 <= '1' WHEN End_Cycle = '1' ELSE
      '0';

  End_Cycle_66 <= signed(phase_voltages_per_switching_state_in_51);
  ...
  switch_compare_1_170 <= '1' WHEN End_Cycle = '1' ELSE
      '0';

  End_Cycle_67 <= signed(J_in_13);
  ...
  switch_compare_1_171 <= '1' WHEN End_Cycle = '1' ELSE
      '0';
  ...
  switch_compare_1_176 <= '1' WHEN End_Cycle = '1' ELSE
      '0';

  End_Cycle_68 <= signed(phase_voltages_per_switching_state_in_52);
  ...
  switch_compare_1_178 <= '1' WHEN End_Cycle = '1' ELSE
      '0';

  End_Cycle_69 <= signed(phase_voltages_per_switching_state_in_53);
  ...
  switch_compare_1_180 <= '1' WHEN End_Cycle = '1' ELSE
      '0';

  End_Cycle_70 <= signed(phase_voltages_per_switching_state_in_54);
  ...
  switch_compare_1_182 <= '1' WHEN End_Cycle = '1' ELSE
      '0';

  End_Cycle_71 <= signed(phase_voltages_per_switching_state_in_55);
  ...
  switch_compare_1_183 <= '1' WHEN End_Cycle = '1' ELSE
      '0';

  End_Cycle_72 <= signed(J_in_14);
  ...
  switch_compare_1_184 <= '1' WHEN End_Cycle = '1' ELSE
      '0';
  ...
  switch_compare_1_189 <= '1' WHEN End_Cycle = '1' ELSE
      '0';

  End_Cycle_73 <= signed(phase_voltages_per_switching_state_in_56);
  ...
  switch_compare_1_191 <= '1' WHEN End_Cycle = '1' ELSE
      '0';

  End_Cycle_74 <= signed(phase_voltages_per_switching_state_in_57);
  ...
  switch_compare_1_193 <= '1' WHEN End_Cycle = '1' ELSE
      '0';

  End_Cycle_75 <= signed(phase_voltages_per_switching_state_in_58);
  ...
  switch_compare_1_195 <= '1' WHEN End_Cycle = '1' ELSE
      '0';

  End_Cycle_76 <= signed(phase_voltages_per_switching_state_in_59);
  ...
  switch_compare_1_196 <= '1' WHEN End_Cycle = '1' ELSE
      '0';

  End_Cycle_77 <= signed(J_in_15);
  ...
  switch_compare_1_197 <= '1' WHEN End_Cycle = '1' ELSE
      '0';
  ...
  switch_compare_1_202 <= '1' WHEN End_Cycle = '1' ELSE
      '0';

  End_Cycle_78 <= signed(phase_voltages_per_switching_state_in_60);
  ...
  switch_compare_1_204 <= '1' WHEN End_Cycle = '1' ELSE
      '0';

  End_Cycle_79 <= signed(phase_voltages_per_switching_state_in_61);
  ...
  switch_compare_1_206 <= '1' WHEN End_Cycle = '1' ELSE
      '0';

  End_Cycle_80 <= signed(phase_voltages_per_switching_state_in_62);
  ...
  switch_compare_1_208 <= '1' WHEN End_Cycle = '1' ELSE
      '0';

  End_Cycle_81 <= signed(phase_voltages_per_switching_state_in_63);
  ...
  switch_compare_1_209 <= '1' WHEN End_Cycle_82 = '1' ELSE
      '0';
  ...
  switch_compare_1_210 <= '1' WHEN End_Cycle_82 = '1' ELSE
      '0';
  ...
  switch_compare_1_211 <= '1' WHEN End_Cycle_82 = '1' ELSE
      '0';
  ...
  switch_compare_1_212 <= '1' WHEN End_Cycle_82 = '1' ELSE
      '0';
  ...
  switch_compare_1_213 <= '1' WHEN End_Cycle_82 = '1' ELSE
      '0';
  ...
  switch_compare_1_214 <= '1' WHEN End_Cycle_82 = '1' ELSE
      '0';
  ...
  switch_compare_1_215 <= '1' WHEN End_Cycle_82 = '1' ELSE
      '0';
  ...
  switch_compare_1_216 <= '1' WHEN End_Cycle_82 = '1' ELSE
      '0';
  ...
  switch_compare_1_217 <= '1' WHEN End_Cycle_82 = '1' ELSE
      '0';
  ...
  switch_compare_1_218 <= '1' WHEN End_Cycle_82 = '1' ELSE
      '0';
  ...
  switch_compare_1_219 <= '1' WHEN End_Cycle_82 = '1' ELSE
      '0';
  ...
  switch_compare_1_220 <= '1' WHEN End_Cycle_82 = '1' ELSE
      '0';
  ...
  switch_compare_1_221 <= '1' WHEN End_Cycle_82 = '1' ELSE
      '0';
  ...
  switch_compare_1_222 <= '1' WHEN End_Cycle_82 = '1' ELSE
      '0';
  ...
  switch_compare_1_223 <= '1' WHEN End_Cycle_82 = '1' ELSE
      '0';
  ...
  switch_compare_1_224 <= '1' WHEN End_Cycle_82 = '1' ELSE
      '0';
