...
{
    char training_absolute_path[] = "test/uz/uz_dqn/mt_init_mt_training";
    char eval_absolute_path[] = "test/uz/uz_dqn/mt_init_mt_eval";
...
{
    char training_absolute_path[] = "test/uz/uz_dqn/mt_init_squares_training";
    char eval_absolute_path[] = "test/uz/uz_dqn/mt_init_squares_eval";
...
{
    char training_absolute_path[] = "test/uz/uz_dqn/mt_init_pcg_training";
    char eval_absolute_path[] = "test/uz/uz_dqn/mt_init_pcg_eval";
...
{
    char training_absolute_path[] = "test/uz/uz_dqn/mt_init_halton_training";
    char eval_absolute_path[] = "test/uz/uz_dqn/mt_init_halton_eval";
...
{
    char training_absolute_path[] = "test/uz/uz_dqn/mt_init_xoshiro_training";
    char eval_absolute_path[] = "test/uz/uz_dqn/mt_init_xoshiro_eval";
