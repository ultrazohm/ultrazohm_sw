...
grid on
axis([0 x 0 y]);
title('FFT of phase a current without fundamental, IMPLMODMPC 4kHz')
xlabel('Frequency / kHz')
ylabel('THD_i / %');

% freq_22 = freq;
% FFT_sig_without_Fundamental_22 = FFT_sig_withoutFundamental(:,1);
% FundamentalCurrent_22 = FundamentalCurrent(1);
end
