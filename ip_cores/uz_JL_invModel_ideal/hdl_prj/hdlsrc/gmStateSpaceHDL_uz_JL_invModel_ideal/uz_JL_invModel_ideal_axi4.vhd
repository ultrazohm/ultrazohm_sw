-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\jonat\Documents\MA_JL_CIL\ip_cores\uz_JL_invModel_ideal\hdl_prj\hdlsrc\gmStateSpaceHDL_uz_JL_invModel_ideal\uz_JL_invModel_ideal_axi4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_JL_invModel_ideal_axi4
-- Source Path: uz_JL_invModel_ideal/uz_JL_invModel_ideal_axi4
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_JL_invModel_ideal_axi4 IS
...
END uz_JL_invModel_ideal_axi4;


ARCHITECTURE rtl OF uz_JL_invModel_ideal_axi4 IS
  ...
  COMPONENT uz_JL_invModel_ideal_axi4_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_ARESETN                    :   IN    std_logic;  -- ufix1
          AXI4_AWID                       :   IN    std_logic_vector(11 DOWNTO 0);  -- ufix12
          AXI4_AWADDR                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  FOR ALL : uz_JL_invModel_ideal_axi4_module
    USE ENTITY work.uz_JL_invModel_ideal_axi4_module(rtl);
  ...
  SIGNAL write_Udc_tmp                    : std_logic_vector(31 DOWNTO 0);  -- ufix32
...
BEGIN
  u_uz_JL_invModel_ideal_addr_decoder_inst : uz_JL_invModel_ideal_addr_decoder
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
              ...
              write_Udc => write_Udc_tmp  -- ufix32
              );

  u_uz_JL_invModel_ideal_axi4_module_inst : uz_JL_invModel_ideal_axi4_module
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
