-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/inc_enc_v26/Incremental_Encoder_v26_src_IncEnc_V26.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Incremental_Encoder_v26_src_IncEnc_V26
...
ENTITY Incremental_Encoder_v26_src_IncEnc_V26 IS
...
END Incremental_Encoder_v26_src_IncEnc_V26;


ARCHITECTURE rtl OF Incremental_Encoder_v26_src_IncEnc_V26 IS
  ...
  COMPONENT Incremental_Encoder_v26_src_speed1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          A                               :   IN    std_logic;
  ...
  COMPONENT Incremental_Encoder_v26_src_Check_d_Axis_Hit_WithCompare
  ...
  FOR ALL : Incremental_Encoder_v26_src_speed1
    USE ENTITY work.Incremental_Encoder_v26_src_speed1(rtl);
  ...
  FOR ALL : Incremental_Encoder_v26_src_Check_d_Axis_Hit_WithCompare
    USE ENTITY work.Incremental_Encoder_v26_src_Check_d_Axis_Hit_WithCompare(rtl);
  ...
  SIGNAL Check_d_Axis_Hit_WithCompare_out1_1 : std_logic;
...
BEGIN
  ...
  u_speed1 : Incremental_Encoder_v26_src_speed1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => clk_enable,
              A => AB_Line_Switch_out1,
  ...
  u_Check_d_Axis_Hit : Incremental_Encoder_v26_src_Check_d_Axis_Hit
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => clk_enable,
              Count_in => std_logic_vector(count_el_1),  -- uint16
              IncPerTurn_elek_AXI4 => std_logic_vector(IncPerTurn_elek_AXI4_1),  -- uint16
              d_axis_hit => Check_d_Axis_Hit_out1
              );

  u_Check_d_Axis_Hit_WithCompare : Incremental_Encoder_v26_src_Check_d_Axis_Hit_WithCompare
  ...
  position_tmp <= unsigned(count_mech);
  ...
  count_mech_unsigned <= unsigned(count_mech_1);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        position_w_offset <= count_mech_unsigned;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Check_d_Axis_Hit_WithCompare_out1_1 <= '0';
      ELSIF enb = '1' THEN
        Check_d_Axis_Hit_WithCompare_out1_1 <= Check_d_Axis_Hit_WithCompare_out1;
      END IF;
    END IF;
  END PROCESS rd_28_process;


  AND1_out1 <= Index_Latch_out1 AND Check_d_Axis_Hit_WithCompare_out1_1;

  ce_out <= clk_enable;

  position_AXI4 <= count_mech;
  ...
  Index_found_AXI4 <= Index_Latch_out1;

  d_Axis_Hit <= AND_out1;

  d_Axis_Hit_WithCompare <= AND1_out1;
