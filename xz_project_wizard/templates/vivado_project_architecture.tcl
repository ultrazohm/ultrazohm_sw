# -----------------------------------------------------------------------------
# xz Project Wizard architecture setup
# -----------------------------------------------------------------------------
# Platform: {{ platform_name }}
# Platform ID: {{ platform_id }}
# Platform revision: {{ platform_revision }}

set xz_project_wizard_origin [pwd]
set xz_project_wizard_platform {{ platform_id }}
set xz_project_wizard_platform_name "{{ platform_name }}"
set xz_project_wizard_platform_revision "{{ platform_revision }}"

puts "xz Project Wizard: applying adapter card configuration"
...
# TODO: Remove or reuse previously generated xz Project Wizard hierarchies.
