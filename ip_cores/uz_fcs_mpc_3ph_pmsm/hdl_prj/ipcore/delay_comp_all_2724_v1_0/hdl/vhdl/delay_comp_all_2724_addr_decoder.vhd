-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_mpc_3ph\delay_comp_all_2724_addr_decoder.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: delay_comp_all_2724_addr_decoder
-- Source Path: delay_comp_all_2724/delay_comp_all_2724_axi_lite/delay_comp_all_2724_addr_decoder
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY delay_comp_all_2724_addr_decoder IS
...
END delay_comp_all_2724_addr_decoder;


ARCHITECTURE rtl OF delay_comp_all_2724_addr_decoder IS
  ...
  SIGNAL data_in_Rs_over_ZB_AXI           : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL data_reg_Rs_over_ZB_AXI_1_1      : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL decode_sel_Ts_times_ZB_over_Ld_AXI_1_1 : std_logic;  -- ufix1
  SIGNAL reg_enb_Ts_times_ZB_over_Ld_AXI_1_1 : std_logic;  -- ufix1
  SIGNAL data_in_Ts_times_ZB_over_Ld_AXI  : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL data_reg_Ts_times_ZB_over_Ld_AXI_1_1 : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL decode_sel_Ts_times_ZB_over_Lq_AXI_1_1 : std_logic;  -- ufix1
  SIGNAL reg_enb_Ts_times_ZB_over_Lq_AXI_1_1 : std_logic;  -- ufix1
  SIGNAL data_in_Ts_times_ZB_over_Lq_AXI  : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL data_reg_Ts_times_ZB_over_Lq_AXI_1_1 : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL decode_sel_Ld_over_LB_AXI_1_1    : std_logic;  -- ufix1
  SIGNAL reg_enb_Ld_over_LB_AXI_1_1       : std_logic;  -- ufix1
  SIGNAL data_in_Ld_over_LB_AXI           : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL data_reg_Ld_over_LB_AXI_1_1      : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL decode_sel_Lq_over_LB_AXI_1_1    : std_logic;  -- ufix1
  SIGNAL reg_enb_Lq_over_LB_AXI_1_1       : std_logic;  -- ufix1
  SIGNAL data_in_Lq_over_LB_AXI           : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL data_reg_Lq_over_LB_AXI_1_1      : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL decode_sel_psi_pm_over_psiB_AXI_1_1 : std_logic;  -- ufix1
  SIGNAL reg_enb_psi_pm_over_psiB_AXI_1_1 : std_logic;  -- ufix1
  SIGNAL data_in_psi_pm_over_psiB_AXI     : signed(26 DOWNTO 0);  -- sfix27_En24
  SIGNAL data_reg_psi_pm_over_psiB_AXI_1_1 : signed(26 DOWNTO 0);  -- sfix27_En24
...
BEGIN
  ...
  data_read <= std_logic_vector(decode_rd_iq_delay_pu_AXI_1_1);
  ...
  data_in_Rs_over_ZB_AXI <= signed(data_write_unsigned(26 DOWNTO 0));

  reg_Rs_over_ZB_AXI_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_Rs_over_ZB_AXI_1_1 <= to_signed(16#0000000#, 27);
  ...
  data_in_Ts_times_ZB_over_Ld_AXI <= signed(data_write_unsigned(26 DOWNTO 0));

  reg_Ts_times_ZB_over_Ld_AXI_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_Ts_times_ZB_over_Ld_AXI_1_1 <= to_signed(16#0000000#, 27);
  ...
  data_in_Ts_times_ZB_over_Lq_AXI <= signed(data_write_unsigned(26 DOWNTO 0));

  reg_Ts_times_ZB_over_Lq_AXI_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_Ts_times_ZB_over_Lq_AXI_1_1 <= to_signed(16#0000000#, 27);
  ...
  data_in_Ld_over_LB_AXI <= signed(data_write_unsigned(26 DOWNTO 0));

  reg_Ld_over_LB_AXI_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_Ld_over_LB_AXI_1_1 <= to_signed(16#0000000#, 27);
  ...
  data_in_Lq_over_LB_AXI <= signed(data_write_unsigned(26 DOWNTO 0));

  reg_Lq_over_LB_AXI_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_Lq_over_LB_AXI_1_1 <= to_signed(16#0000000#, 27);
  ...
  data_in_psi_pm_over_psiB_AXI <= signed(data_write_unsigned(26 DOWNTO 0));

  reg_psi_pm_over_psiB_AXI_1_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_psi_pm_over_psiB_AXI_1_1 <= to_signed(16#0000000#, 27);
