...
int JavaScope_initialize(DS_Data* data)
{
	...
	js_ch_observable[JSO_D_PWM_A1] 				= &data->av.PWM_6ph_DutyCycle_output.system1.DutyCycle_A;
	js_ch_observable[JSO_D_PWM_B1] 				= &data->av.PWM_6ph_DutyCycle_output.system1.DutyCycle_B;
	js_ch_observable[JSO_D_PWM_C1] 				= &data->av.PWM_6ph_DutyCycle_output.system1.DutyCycle_C;
	js_ch_observable[JSO_D_PWM_A2] 				= &data->av.PWM_6ph_DutyCycle_output.system2.DutyCycle_A;
	js_ch_observable[JSO_D_PWM_B2] 				= &data->av.PWM_6ph_DutyCycle_output.system2.DutyCycle_B;
	js_ch_observable[JSO_D_PWM_C2] 				= &data->av.PWM_6ph_DutyCycle_output.system2.DutyCycle_C;
	js_ch_observable[JSO_D_PWM_alpha]			= &data->av.PWM_6ph_DutyCycle_VSD_output.alpha;
	js_ch_observable[JSO_D_PWM_beta] 			= &data->av.PWM_6ph_DutyCycle_VSD_output.beta;
	js_ch_observable[JSO_D_PWM_x] 				= &data->av.PWM_6ph_DutyCycle_VSD_output.x;
	js_ch_observable[JSO_D_PWM_y] 				= &data->av.PWM_6ph_DutyCycle_VSD_output.y;
	js_ch_observable[JSO_D_PWM_z1] 				= &data->av.PWM_6ph_DutyCycle_VSD_output.z1;
	js_ch_observable[JSO_D_PWM_z2] 				= &data->av.PWM_6ph_DutyCycle_VSD_output.z2;
