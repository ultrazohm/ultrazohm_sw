-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\valen\Documents\repos\UZ\ultrazohm_sw_pr\ip_cores\uz_pmsm_model_6ph_dq\hdl_prj\hdlsrc\uz_pmsm_model_6ph_dq\uz_pmsm_model_6ph_dq_src_nfp_convert_double_to_fixed_27_En18.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_6ph_dq_src_nfp_convert_double_to_fixed_27_En18
-- Source Path: uz_pmsm_model_6ph_dq/uz_pmsm_model_6ph_dq/nfp_convert_double_to_fixed_27_En18
-- Hierarchy Level: 1
-- 
...
ENTITY uz_pmsm_model_6ph_dq_src_nfp_convert_double_to_fixed_27_En18 IS
...
END uz_pmsm_model_6ph_dq_src_nfp_convert_double_to_fixed_27_En18;


ARCHITECTURE rtl OF uz_pmsm_model_6ph_dq_src_nfp_convert_double_to_fixed_27_En18 IS
  ...
  SIGNAL Data_Type_Conversion1_out1_1     : unsigned(61 DOWNTO 0);  -- ufix62_En53
  SIGNAL Data_Type_Conversion1_out1_2     : unsigned(61 DOWNTO 0);  -- ufix62_En53
  ...
  SIGNAL Shift_Arithmetic1_out1           : unsigned(61 DOWNTO 0);  -- ufix62_En53
  ...
  SIGNAL Shift_Arithmetic2_out1           : unsigned(61 DOWNTO 0);  -- ufix62_En53
  SIGNAL Switch1_out1                     : unsigned(61 DOWNTO 0);  -- ufix62_En53
  SIGNAL Delay2_out1                      : unsigned(61 DOWNTO 0);  -- ufix62_En53
  SIGNAL Data_Type_Conversion3_out1       : signed(62 DOWNTO 0);  -- sfix63_En53
  SIGNAL Unary_Minus_cast                 : signed(63 DOWNTO 0);  -- sfix64_En53
  SIGNAL Unary_Minus_cast_1               : signed(63 DOWNTO 0);  -- sfix64_En53
  SIGNAL Unary_Minus_out1                 : signed(62 DOWNTO 0);  -- sfix63_En53
  SIGNAL Switch1_out1_1                   : signed(62 DOWNTO 0);  -- sfix63_En53
  SIGNAL Data_Type_Conversion2_out1       : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL Delay8_out1_1                    : signed(26 DOWNTO 0);  -- sfix27_En18
...
BEGIN
  ...
  Data_Type_Conversion1_out1_1 <= resize(Data_Type_Conversion1_out1 & '0', 62);

  reduced_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Data_Type_Conversion1_out1_2 <= to_unsigned(0, 62);
      ELSIF enb = '1' THEN
  ...
  Data_Type_Conversion3_out1 <= signed(resize(Delay2_out1, 63));

  Unary_Minus_cast <= resize(Data_Type_Conversion3_out1, 64);
  Unary_Minus_cast_1 <=  - (Unary_Minus_cast);
  Unary_Minus_out1 <= Unary_Minus_cast_1(62 DOWNTO 0);

  
  Switch1_out1_1 <= Data_Type_Conversion3_out1 WHEN Delay8_out1 = '0' ELSE
      Unary_Minus_out1;

  Data_Type_Conversion2_out1 <= Switch1_out1_1(61 DOWNTO 35) + ('0' & Switch1_out1_1(34));
