-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_mpc_6ph_parallel\conv_theta_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: conv_theta_axi_lite
-- Source Path: conv_theta/conv_theta_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END conv_theta_axi_lite;


ARCHITECTURE rtl OF conv_theta_axi_lite IS

  -- Component Declarations
  COMPONENT conv_theta_addr_decoder
  ...
  COMPONENT conv_theta_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : conv_theta_addr_decoder
    USE ENTITY work.conv_theta_addr_decoder(rtl);

  FOR ALL : conv_theta_axi_lite_module
    USE ENTITY work.conv_theta_axi_lite_module(rtl);
...
BEGIN
  u_conv_theta_addr_decoder_inst : conv_theta_addr_decoder
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
              ...
              read_theta_el_out_AXI => read_theta_el_out_AXI,  -- sfix27_En20
              data_read => top_data_read,  -- ufix32
              write_axi_enable => write_axi_enable  -- ufix1
              );

  u_conv_theta_axi_lite_module_inst : conv_theta_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
