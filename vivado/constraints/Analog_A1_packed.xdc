...
#Analog_01
set_property PACKAGE_PIN AG8 [get_ports 	 A1_OUT_0]
#ANL_01_P_Ch1 = B64_L12_P
set_property PACKAGE_PIN AH8 [get_ports 	 A1_OUT_1]
...
## input standards
set_property IOSTANDARD LVDS [get_ports A1_OUT_0]
set_property IOSTANDARD LVDS [get_ports A1_OUT_1]
