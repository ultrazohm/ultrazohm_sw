...
ENTITY uz_pmsm_model_addr_decoder IS
  PORT( clk                               :   IN    std_logic;
        ...
        read_approx_flux_testing          :   IN    vector_of_std_logic_vector32(0 TO 5);  -- ufix32 [6]
...
ARCHITECTURE rtl OF uz_pmsm_model_addr_decoder IS
  ...
  SIGNAL decode_sel_approx_flux_testing_1_1 : std_logic;  -- ufix1
  SIGNAL data_slice_outputs_1_3           : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_outputs_1_4            : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_sel_approx_flux_testing   : std_logic;  -- ufix1
  SIGNAL strobe_sel_approx_flux_testing   : std_logic;  -- ufix1
  SIGNAL const_zero_1                     : std_logic;  -- ufix1
  SIGNAL strobe_in_approx_flux_testing    : std_logic;  -- ufix1
  SIGNAL strobe_sw_approx_flux_testing    : std_logic;  -- ufix1
  SIGNAL strobe_reg_approx_flux_testing   : std_logic;  -- ufix1
  SIGNAL read_approx_flux_testing_unsigned : vector_of_unsigned32(0 TO 5);  -- ufix32 [6]
  SIGNAL sync_reg_approx_flux_testing     : vector_of_unsigned32(0 TO 5);  -- ufix32 [6]
  SIGNAL decode_sel_approx_flux_testing_1_2 : std_logic;  -- ufix1
  SIGNAL data_slice_approx_flux_testing_1_0 : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_approx_flux_testing_1_1 : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_sel_approx_flux_testing_1_3 : std_logic;  -- ufix1
  SIGNAL data_slice_approx_flux_testing_1_1 : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_approx_flux_testing_1_2 : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_sel_approx_flux_testing_1_4 : std_logic;  -- ufix1
  SIGNAL data_slice_approx_flux_testing_1_2 : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_approx_flux_testing_1_3 : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_sel_approx_flux_testing_1_5 : std_logic;  -- ufix1
  SIGNAL data_slice_approx_flux_testing_1_3 : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_approx_flux_testing_1_4 : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_sel_approx_flux_testing_1_6 : std_logic;  -- ufix1
  SIGNAL data_slice_approx_flux_testing_1_4 : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_approx_flux_testing_1_5 : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL data_slice_approx_flux_testing_1_5 : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_approx_flux_testing_1_6 : unsigned(31 DOWNTO 0);  -- ufix32
...
BEGIN
  ...
  decode_sel_approx_flux_testing_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0088#, 14) ELSE
      '0';
  ...
  decode_sel_approx_flux_testing <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0090#, 14) ELSE
      '0';

  strobe_sel_approx_flux_testing <= decode_sel_approx_flux_testing AND wr_enb;

  const_zero_1 <= '0';

  strobe_in_approx_flux_testing <= data_write_unsigned(0);

  
  strobe_sw_approx_flux_testing <= const_zero_1 WHEN strobe_sel_approx_flux_testing = '0' ELSE
      strobe_in_approx_flux_testing;

  reg_1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        strobe_reg_approx_flux_testing <= '0';
      ELSIF enb = '1' THEN
        strobe_reg_approx_flux_testing <= strobe_sw_approx_flux_testing;
      END IF;
    END IF;
  ...
  outputgen2: FOR k IN 0 TO 5 GENERATE
    read_approx_flux_testing_unsigned(k) <= unsigned(read_approx_flux_testing(k));
  END GENERATE;

  reg_approx_flux_testing_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        sync_reg_approx_flux_testing <= (OTHERS => to_unsigned(0, 32));
      ELSIF enb = '1' AND strobe_reg_approx_flux_testing = '1' THEN
        sync_reg_approx_flux_testing <= read_approx_flux_testing_unsigned;
      END IF;
    END IF;
  END PROCESS reg_approx_flux_testing_process;


  
  decode_sel_approx_flux_testing_1_2 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0089#, 14) ELSE
      '0';

  data_slice_approx_flux_testing_1_0 <= sync_reg_approx_flux_testing(0);

  
  decode_rd_approx_flux_testing_1_1 <= decode_rd_outputs_1_4 WHEN decode_sel_approx_flux_testing_1_1 = '0' ELSE
      data_slice_approx_flux_testing_1_0;

  
  decode_sel_approx_flux_testing_1_3 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#008A#, 14) ELSE
      '0';

  data_slice_approx_flux_testing_1_1 <= sync_reg_approx_flux_testing(1);

  
  decode_rd_approx_flux_testing_1_2 <= decode_rd_approx_flux_testing_1_1 WHEN decode_sel_approx_flux_testing_1_2 = '0' ELSE
      data_slice_approx_flux_testing_1_1;

  
  decode_sel_approx_flux_testing_1_4 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#008B#, 14) ELSE
      '0';

  data_slice_approx_flux_testing_1_2 <= sync_reg_approx_flux_testing(2);

  
  decode_rd_approx_flux_testing_1_3 <= decode_rd_approx_flux_testing_1_2 WHEN decode_sel_approx_flux_testing_1_3 = '0' ELSE
      data_slice_approx_flux_testing_1_2;

  
  decode_sel_approx_flux_testing_1_5 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#008C#, 14) ELSE
      '0';

  data_slice_approx_flux_testing_1_3 <= sync_reg_approx_flux_testing(3);

  
  decode_rd_approx_flux_testing_1_4 <= decode_rd_approx_flux_testing_1_3 WHEN decode_sel_approx_flux_testing_1_4 = '0' ELSE
      data_slice_approx_flux_testing_1_3;

  
  decode_sel_approx_flux_testing_1_6 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#008D#, 14) ELSE
      '0';

  data_slice_approx_flux_testing_1_4 <= sync_reg_approx_flux_testing(4);

  
  decode_rd_approx_flux_testing_1_5 <= decode_rd_approx_flux_testing_1_4 WHEN decode_sel_approx_flux_testing_1_5 = '0' ELSE
      data_slice_approx_flux_testing_1_4;

  data_slice_approx_flux_testing_1_5 <= sync_reg_approx_flux_testing(5);

  
  decode_rd_approx_flux_testing_1_6 <= decode_rd_approx_flux_testing_1_5 WHEN decode_sel_approx_flux_testing_1_6 = '0' ELSE
      data_slice_approx_flux_testing_1_5;

  data_read <= std_logic_vector(decode_rd_approx_flux_testing_1_6);
  ...
  strobe_sw_fitting_parameter <= const_zero_3 WHEN strobe_sel_fitting_parameter = '0' ELSE
