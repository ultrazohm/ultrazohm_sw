-- -------------------------------------------------------------
-- 
-- File Name: abc_to_dq_fixed_100mhz/hdlsrc/Copy_of_uz_pmsm_model_9ph_21b_all_double/uz_pmsm9ph_trans_100mhz_axi4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm9ph_trans_100mhz_axi4
-- Source Path: uz_pmsm9ph_trans_100mhz/uz_pmsm9ph_trans_100mhz_axi4
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_pmsm9ph_trans_100mhz_axi4 IS
...
END uz_pmsm9ph_trans_100mhz_axi4;


ARCHITECTURE rtl OF uz_pmsm9ph_trans_100mhz_axi4 IS

  -- Component Declarations
  COMPONENT uz_pmsm9ph_trans_100mhz_addr_decoder
  ...
  COMPONENT uz_pmsm9ph_trans_100mhz_axi4_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_ARESETN                    :   IN    std_logic;  -- ufix1
          AXI4_AWID                       :   IN    std_logic_vector(11 DOWNTO 0);  -- ufix12
          AXI4_AWADDR                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  FOR ALL : uz_pmsm9ph_trans_100mhz_addr_decoder
    USE ENTITY work.uz_pmsm9ph_trans_100mhz_addr_decoder(rtl);

  FOR ALL : uz_pmsm9ph_trans_100mhz_axi4_module
    USE ENTITY work.uz_pmsm9ph_trans_100mhz_axi4_module(rtl);
...
BEGIN
  u_uz_pmsm9ph_trans_100mhz_addr_decoder_inst : uz_pmsm9ph_trans_100mhz_addr_decoder
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
              ...
              read_i_abc_out_axi => read_i_abc_out_axi,  -- sfix25_En12 [9]
              data_read => top_data_read,  -- ufix32
              write_axi_enable => write_axi_enable  -- ufix1
              );

  u_uz_pmsm9ph_trans_100mhz_axi4_module_inst : uz_pmsm9ph_trans_100mhz_axi4_module
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
