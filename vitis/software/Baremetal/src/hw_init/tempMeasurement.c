...
struct uz_PWM_duty_freq_detection_config_t config3 = {
...
struct uz_PWM_duty_freq_detection_outputs_t outputs3 = {
    .PWMdutyCycNormalized = 0.0f,
    .TempDegreesCelsius = 0.0f,
    .PWMFreq = 0,
    .PWMhightime = 0,
...
uz_PWM_duty_freq_detection_t* init_tempMeasurement3(void) {
	return(uz_PWM_duty_freq_detection_init(config3, outputs2));
}
