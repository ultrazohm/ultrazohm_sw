-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_d_inverter_adapter\uz_d_inverter_adapter_src_NewtonPolynomialIVStage.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_d_inverter_adapter_src_NewtonPolynomialIVStage
-- Source Path: uz_d_inverter_adapter/uz_d_inverter_adapter/PWMdutyFreqDetection/Reciprocal/Reciprocal_iv/NewtonPolynomialIVStage
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_d_inverter_adapter_src_NewtonPolynomialIVStage IS
...
END uz_d_inverter_adapter_src_NewtonPolynomialIVStage;


ARCHITECTURE rtl OF uz_d_inverter_adapter_src_NewtonPolynomialIVStage IS
