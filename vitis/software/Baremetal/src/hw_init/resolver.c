...
struct uz_resolverIP_config_t resolver_config_left={
        .base_address=XPAR_UZ_USER_UZ_RESOLVER_INTERFACE_RESOLVER_INTERFACE_V_0_BASEADDR,
        .ip_clk_frequency_Hz=100000000U,
        .resolution = 16,
        .freq_clockin = 8192000,
        .pole_pairs_machine = 4.0f,
        .pole_pairs_resolver = 1.0f,
        .zero_position_mechanical = 0.3959959f, //0.3964f <- was the rough estimate
        .mode_after_init = POSITION_VELOCITY_MODE,
     };

struct uz_resolverIP_config_t resolver_config_right={
        .base_address=XPAR_UZ_USER_UZ_RESOLVER_INTERFACE_RESOLVER_INTERFACE_V_1_BASEADDR,
        .ip_clk_frequency_Hz=100000000U,
        .resolution = 16,
        .freq_clockin = 8192000,
        .pole_pairs_machine = 4.0f,
...
struct uz_resolver_pl_interface_config_t resolver_pl_config_left = {
               .base_address = XPAR_UZ_USER_UZ_RESOLVER_INTERFACE_UZ_RESOLVER_PL_INTER_0_BASEADDR,
...
struct uz_resolver_pl_interface_config_t resolver_pl_config_right = {
               .base_address = XPAR_UZ_USER_UZ_RESOLVER_INTERFACE_UZ_RESOLVER_PL_INTER_1_BASEADDR,
               .bitToRPS_factor = BIT_TO_RPS_FACTOR_16BIT,
               .ip_clk_frequency_Hz = 100000000U,
               .machine_polepairs = 4,
               .position_intmax = 65535,
