/*
 * File Name:         hdl_prj\ipcore\uz_ssi_interface_v2_0\include\uz_ssi_interface_addr.h
 * Description:       C Header File
 * Created:           2025-04-26 13:41:21
*/
...
#define  IPCore_Timestamp_uz_ssi_interface                     0x8  //contains unique IP timestamp (yymmddHHMM): 2504261241: 2504261341
...
#define  machine_polepairs_AXI_Data_uz_ssi_interface           0x124  //data register for Inport machine_polepairs_AXI
#define  position_mech_offset_si_AXI_Data_uz_ssi_interface     0x128  //data register for Inport position_mech_offset_si_AXI
#define  position_raw_AXI_Data_uz_ssi_interface                0x12C  //data register for Outport position_raw_AXI
#define  position_mech_SI_AXI_Data_uz_ssi_interface            0x130  //data register for Outport position_mech_SI_AXI
#define  speed_mech_SI_AXI_Data_uz_ssi_interface               0x134  //data register for Outport speed_mech_SI_AXI
#define  speed_mech_rpm_AXI_Data_uz_ssi_interface              0x138  //data register for Outport speed_mech_rpm_AXI
#define  position_el_SI_AXI_Data_uz_ssi_interface              0x13C  //data register for Outport position_el_SI_AXI
