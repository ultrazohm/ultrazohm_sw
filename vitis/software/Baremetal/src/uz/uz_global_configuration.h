...
#define UZ_WAVEGEN_2_MAX_INSTANCES                  	5U
...
#define UZ_RESOLVERIP_MAX_INSTANCES                     4U
...
#define UZ_SVPWM6phIP_MAX_INSTANCES                     1U
#endif

// Configuration defines for the number of used instances for testing with ceedling
#ifdef TEST
    #define UZ_WAVEGEN_CHIRP_MAX_INSTANCES                  13U
	#define UZ_WAVEGEN_2_MAX_INSTANCES                  	13U
    ...
    #define UZ_PMSMMODEL_6PH_DQXY_MAX_INSTANCES             3U
    #define UZ_SVPWM6phIP_MAX_INSTANCES                      5U
#endif
