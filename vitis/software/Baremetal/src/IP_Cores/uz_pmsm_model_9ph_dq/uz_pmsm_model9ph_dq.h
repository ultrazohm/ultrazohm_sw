 ...
 * @param omega_mech value for fixed omega if simulate_mechanical_system if false
 * @param load_torque value for load torque if simulate_mechanical_system if true
 */
