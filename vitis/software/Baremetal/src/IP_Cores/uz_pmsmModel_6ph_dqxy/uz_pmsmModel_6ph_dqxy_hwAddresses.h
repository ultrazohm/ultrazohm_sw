...
#define  v_d_Data_uz_pmsm_model_6ph_dqxy                   0x140+0x0//offset due to vector port
#define  v_q_Data_uz_pmsm_model_6ph_dqxy                   0x140+0x4//offset due to vector port
#define  v_x_Data_uz_pmsm_model_6ph_dqxy                   0x140+0x8//offset due to vector port
#define  v_y_Data_uz_pmsm_model_6ph_dqxy                   0x140+0xC//offset due to vector port
#define  in_omega_mech_Data_uz_pmsm_model_6ph_dqxy         0x140+0x10//offset due to vector port
#define  load_torque_Data_uz_pmsm_model_6ph_dqxy           0x140+0x14//offset due to vector port
...
#define  i_d_Data_uz_pmsm_model_6ph_dqxy                   0x180+0x0//offset due to vector port
#define  i_q_Data_uz_pmsm_model_6ph_dqxy                   0x180+0x4//offset due to vector port
#define  i_x_Data_uz_pmsm_model_6ph_dqxy                   0x180+0x8//offset due to vector port
#define  i_y_Data_uz_pmsm_model_6ph_dqxy                   0x180+0xC//offset due to vector port
#define  torque_Data_uz_pmsm_model_6ph_dqxy                0x180+0x10//offset due to vector port
#define  out_omega_mech_Data_uz_pmsm_model_6ph_dqxy        0x180+0x14 //offset due to vector port
