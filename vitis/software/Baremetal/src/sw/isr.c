...
void ISR_Control(void *data)
{
    ...
    //Global_Data.av.mechanicalRotorSpeed = uz_EnDat_calc_revs_from_pos_delta_and_time(uz_EnDat_read_pos(Global_Data.objects.EnDat_master_pointer, uz_EnDat_pos_t0), uz_EnDat_read_pos(Global_Data.objects.EnDat_master_pointer, uz_EnDat_pos_t1), uz_EnDat_time_elapsed_ns_to_s_converter(uz_EnDat_read_time_elapsed(Global_Data.objects.EnDat_master_pointer, uz_EnDat_elapsed_t0_t1)), 0x1U, uz_EnDat_fetch_sensor_precision_from_EnDat_object(Global_Data.objects.EnDat_master_pointer), 0U); //ISR TIME : uses about 1,5 us ISR Time
    /*NEW DIFF MODE*/ //Global_Data.av.mechanicalRotorSpeed = uz_EnDat_calc_revs_from_fpga_pos_dif_and_time(uz_EnDat_read_pos_dif(Global_Data.objects.EnDat_master_pointer, uz_EnDat_dif_t0_t1), uz_EnDat_time_elapsed_ns_to_s_converter(uz_EnDat_read_time_elapsed(Global_Data.objects.EnDat_master_pointer, uz_EnDat_elapsed_t0_t1)), 0x0U, uz_EnDat_fetch_sensor_precision_from_EnDat_object(Global_Data.objects.EnDat_master_pointer), 0U);
    /*NEW DIFF MODE - EZ MODE*/ Global_Data.av.mechanicalRotorSpeed = uz_EnDat_easy_speedreadout_revolutions_per_minute(Global_Data.objects.EnDat_master_pointer);
