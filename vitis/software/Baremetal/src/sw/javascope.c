...
int JavaScope_initalize(DS_Data* data)
{
	...
	js_ptr_arr[JSO_iu_ref] 		= &codegenInstance.output.Iu_ref;
	js_ptr_arr[JSO_iv_ref] 		= &codegenInstance.output.Iv_ref;
	js_ptr_arr[JSO_iw_ref] 		= &codegenInstance.output.Iw_ref;
	js_ptr_arr[JSO_au] 			= &codegenInstance.output.a_U;
    js_ptr_arr[JSO_av] 			= &codegenInstance.output.a_V;
	js_ptr_arr[JSO_aw] 			= &codegenInstance.output.a_W;
	js_ptr_arr[JSO_id_ref] 		= &codegenInstance.output.I_re_Ref;
	js_ptr_arr[JSO_iq_ref] 		= &codegenInstance.output.I_im_Ref;
	js_ptr_arr[JSO_Speed_rpm]	= &codegenInstance.input.Act_n;
	js_ptr_arr[JSO_Speed_ref_rpm] = &codegenInstance.input.Ref_n;
	js_ptr_arr[JSO_Theta_el] 	= &codegenInstance.input.Act_theta_u_el;
