-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\valen\Documents\repos\UZ\ultrazohm_sw_working\ip_cores\uz_pmsm_model\hdl_prj\hdlsrc\uz_pmsm_model\uz_pmsm_model_src_uz_pmsm_model.vhd
...
ARCHITECTURE rtl OF uz_pmsm_model_src_uz_pmsm_model IS
  ...
  COMPONENT uz_pmsm_model_src_nfp_convert_sfix_27_En16_to_double
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT uz_pmsm_model_src_nfp_relop_double_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          nfp_in1                         :   IN    std_logic_vector(63 DOWNTO 0);  -- double
  ...
  COMPONENT uz_pmsm_model_src_nfp_relop_double
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          nfp_in1                         :   IN    std_logic_vector(63 DOWNTO 0);  -- double
  ...
  COMPONENT uz_pmsm_model_src_nfp_convert_double_to_fixed_27_En18
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          nfp_in                          :   IN    std_logic_vector(63 DOWNTO 0);  -- double
  ...
  COMPONENT uz_pmsm_model_src_nfp_convert_double_to_fixed_18_En14
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          nfp_in                          :   IN    std_logic_vector(63 DOWNTO 0);  -- double
  ...
  FOR ALL : uz_pmsm_model_src_nfp_convert_sfix_27_En16_to_double
    USE ENTITY work.uz_pmsm_model_src_nfp_convert_sfix_27_En16_to_double(rtl);
  ...
  FOR ALL : uz_pmsm_model_src_nfp_relop_double_block
    USE ENTITY work.uz_pmsm_model_src_nfp_relop_double_block(rtl);

  FOR ALL : uz_pmsm_model_src_nfp_relop_double
    USE ENTITY work.uz_pmsm_model_src_nfp_relop_double(rtl);

  FOR ALL : uz_pmsm_model_src_nfp_convert_double_to_fixed_27_En18
    USE ENTITY work.uz_pmsm_model_src_nfp_convert_double_to_fixed_27_En18(rtl);

  FOR ALL : uz_pmsm_model_src_nfp_convert_double_to_fixed_18_En14
    USE ENTITY work.uz_pmsm_model_src_nfp_convert_double_to_fixed_18_En14(rtl);
  ...
  SIGNAL t2_bypass_reg                    : vector_of_std_logic_vector32(0 TO 4);  -- ufix32 [5]
  SIGNAL t2_bypass_reg_next               : vector_of_std_logic_vector32(0 TO 4);  -- ufix32 [5]
  ...
  SIGNAL t3_bypass_reg                    : vector_of_signed27(0 TO 1);  -- sfix27 [2]
  SIGNAL t3_bypass_reg_next               : vector_of_signed27(0 TO 1);  -- sfix27_En18 [2]
...
BEGIN
  ...
  u_uz_pmsm_model_uz_pmsm_model_nfp_convert_sfix_27_En16_to_double : uz_pmsm_model_src_nfp_convert_sfix_27_En16_to_double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_uz_pmsm_model_uz_pmsm_model_nfp_convert_sfix_27_En16_to_double_1 : uz_pmsm_model_src_nfp_convert_sfix_27_En16_to_double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_relop_comp : uz_pmsm_model_src_nfp_relop_double_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Sum_out1_3,  -- double
  ...
  u_nfp_relop_comp_1 : uz_pmsm_model_src_nfp_relop_double
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_uz_pmsm_model_uz_pmsm_model_nfp_convert_double2single_4 : uz_pmsm_model_src_nfp_convert_double2single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_uz_pmsm_model_uz_pmsm_model_nfp_convert_double2single_5 : uz_pmsm_model_src_nfp_convert_double2single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_uz_pmsm_model_uz_pmsm_model_nfp_convert_double2single_6 : uz_pmsm_model_src_nfp_convert_double2single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_uz_pmsm_model_uz_pmsm_model_nfp_convert_double_to_fixed_27_En18 : uz_pmsm_model_src_nfp_convert_double_to_fixed_27_En18
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in => I_d_4,  -- double
  ...
  u_uz_pmsm_model_uz_pmsm_model_nfp_convert_double_to_fixed_27_En18_1 : uz_pmsm_model_src_nfp_convert_double_to_fixed_27_En18
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in => i_q_2,  -- double
  ...
  u_uz_pmsm_model_uz_pmsm_model_nfp_convert_double_to_fixed_18_En14 : uz_pmsm_model_src_nfp_convert_double_to_fixed_18_En14
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  Mux_out1_1(0) <= Mux_out1(0) WHEN enb_1_100_1 = '1' ELSE
      t2_bypass_reg(0);
  
  Mux_out1_1(1) <= Mux_out1(1) WHEN enb_1_100_1 = '1' ELSE
      t2_bypass_reg(1);
  
  Mux_out1_1(2) <= Mux_out1(2) WHEN enb_1_100_1 = '1' ELSE
      t2_bypass_reg(2);
  
  Mux_out1_1(3) <= Mux_out1(3) WHEN enb_1_100_1 = '1' ELSE
      t2_bypass_reg(3);
  
  Mux_out1_1(4) <= Mux_out1(4) WHEN enb_1_100_1 = '1' ELSE
      t2_bypass_reg(4);
  t2_bypass_reg_next(0) <= Mux_out1(0);
  t2_bypass_reg_next(1) <= Mux_out1(1);
  t2_bypass_reg_next(2) <= Mux_out1(2);
  t2_bypass_reg_next(3) <= Mux_out1(3);
  t2_bypass_reg_next(4) <= Mux_out1(4);
  ...
  Data_Type_Conversion3_out1_2(1) <= Data_Type_Conversion3_out1_1(1) WHEN enb_1_100_1 = '1' ELSE
      t3_bypass_reg(1);
  t3_bypass_reg_next(0) <= Data_Type_Conversion3_out1_1(0);
  t3_bypass_reg_next(1) <= Data_Type_Conversion3_out1_1(1);
