...
BEGIN
  ...
  X0_out1(0) <= X"c2c83330";
  X0_out1(1) <= X"c2c81997";
  X0_out1(2) <= X"c2c7b330";
  X0_out1(3) <= X"3586302c";
  X0_out1(4) <= X"c11ff6fb";
  X0_out1(5) <= X"bb02f943";
  X0_out1(6) <= X"39518ed2";
  X0_out1(7) <= X"3506289d";
  X0_out1(8) <= X"c09fedf8";
  X0_out1(9) <= X"3951d1ee";
  X0_out1(10) <= X"41700900";
  X0_out1(11) <= X"3951c482";
  ...
  State_Delay_Initial_Val_out(0) <= X"c2c83330";
  State_Delay_Initial_Val_out(1) <= X"c2c81997";
  State_Delay_Initial_Val_out(2) <= X"c2c7b330";
  State_Delay_Initial_Val_out(3) <= X"3586302c";
  State_Delay_Initial_Val_out(4) <= X"c11ff6fb";
  State_Delay_Initial_Val_out(5) <= X"bb02f943";
  State_Delay_Initial_Val_out(6) <= X"39518ed2";
  State_Delay_Initial_Val_out(7) <= X"3506289d";
  State_Delay_Initial_Val_out(8) <= X"c09fedf8";
  State_Delay_Initial_Val_out(9) <= X"3951d1ee";
  State_Delay_Initial_Val_out(10) <= X"41700900";
  State_Delay_Initial_Val_out(11) <= X"3951c482";
