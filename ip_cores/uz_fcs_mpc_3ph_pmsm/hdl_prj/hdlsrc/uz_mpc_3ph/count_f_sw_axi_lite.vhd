-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_mpc_3ph\count_f_sw_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: count_f_sw_axi_lite
-- Source Path: count_f_sw/count_f_sw_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END count_f_sw_axi_lite;


ARCHITECTURE rtl OF count_f_sw_axi_lite IS

  -- Component Declarations
  COMPONENT count_f_sw_addr_decoder
  ...
  COMPONENT count_f_sw_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : count_f_sw_addr_decoder
    USE ENTITY work.count_f_sw_addr_decoder(rtl);

  FOR ALL : count_f_sw_axi_lite_module
    USE ENTITY work.count_f_sw_axi_lite_module(rtl);
  ...
  SIGNAL write_bResetAXI_tmp              : std_logic_vector(31 DOWNTO 0);  -- ufix32
...
BEGIN
  u_count_f_sw_addr_decoder_inst : count_f_sw_addr_decoder
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
              ...
              write_bResetAXI => write_bResetAXI_tmp  -- ufix32
              );

  u_count_f_sw_axi_lite_module_inst : count_f_sw_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
  ...
  write_bResetAXI <= write_bResetAXI_tmp;
