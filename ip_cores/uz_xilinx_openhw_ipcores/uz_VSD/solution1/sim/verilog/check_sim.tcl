...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.uz_VSD_6ph_asym.autotvin_in_a1.dat"
         "c.uz_VSD_6ph_asym.autotvin_in_b1.dat"
         "c.uz_VSD_6ph_asym.autotvin_in_c1.dat"
         "c.uz_VSD_6ph_asym.autotvin_in_a2.dat"
         "c.uz_VSD_6ph_asym.autotvin_in_b2.dat"
         "c.uz_VSD_6ph_asym.autotvin_in_c2.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.uz_VSD_6ph_asym.autotvout_out_alpha.dat"
         "rtl.uz_VSD_6ph_asym.autotvout_out_beta.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
