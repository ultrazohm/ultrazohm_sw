-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_resolver_mech_revolution_float\uz_resolver_mech_rev_calc_src_revolution_counter.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_resolver_mech_rev_calc_src_revolution_counter
-- Source Path: uz_resolver_mech_revolution_float/uz_resolver_mech_rev_calc/revolution_counter
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_resolver_mech_rev_calc_src_revolution_counter IS
...
END uz_resolver_mech_rev_calc_src_revolution_counter;


ARCHITECTURE rtl OF uz_resolver_mech_rev_calc_src_revolution_counter IS
...
BEGIN
  ...
  BEGIN
    ...
    cnt_temp := cnt;
    --MATLAB Function 'uz_resolver_mech_rev_calc/revolution_counter'
