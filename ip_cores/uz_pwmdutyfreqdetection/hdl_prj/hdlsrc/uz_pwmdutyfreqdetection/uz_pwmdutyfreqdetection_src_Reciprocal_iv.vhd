-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_pwmdutyfreqdetection\uz_pwmdutyfreqdetection_src_Reciprocal_iv.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pwmdutyfreqdetection_src_Reciprocal_iv
-- Source Path: uz_pwmdutyfreqdetection/uz_pwmdutyfreqdetection/Reciprocal/Reciprocal_iv
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_pwmdutyfreqdetection_src_Reciprocal_iv IS
...
END uz_pwmdutyfreqdetection_src_Reciprocal_iv;


ARCHITECTURE rtl OF uz_pwmdutyfreqdetection_src_Reciprocal_iv IS

  -- Component Declarations
  COMPONENT uz_pwmdutyfreqdetection_src_NewtonPolynomialIVStage
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_23_0                      :   IN    std_logic;
          ain                             :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32_En32
  ...
  FOR ALL : uz_pwmdutyfreqdetection_src_NewtonPolynomialIVStage
    USE ENTITY work.uz_pwmdutyfreqdetection_src_NewtonPolynomialIVStage(rtl);
...
BEGIN
  ...
  u_NewtonPolynomialIVStage1 : uz_pwmdutyfreqdetection_src_NewtonPolynomialIVStage
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_NewtonPolynomialIVStage2 : uz_pwmdutyfreqdetection_src_NewtonPolynomialIVStage
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_23_0 => enb_1_23_0,
