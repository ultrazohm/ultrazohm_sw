...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "uz_FOC.autotvin.dat"
	set constFileTvOut       "uz_FOC.autotvout.dat"
	set constFileHdlTvIn     "uz_FOC.autohdltvin.dat"
	set constFileHdlTvOut    "uz_FOC.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
