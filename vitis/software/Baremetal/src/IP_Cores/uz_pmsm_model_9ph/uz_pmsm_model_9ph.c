...
void uz_pmsm_model_9ph_reset(uz_pmsm_model_9ph_t *self)
{
    ...
    struct uz_pmsm_model_9ph_inputs_dq_t inputs_dq = {
        .u_dq.d=0.0f,
        .u_dq.q=0.0f,
        .u_subspaces.z1=0.0f,
        .u_subspaces.z2=0.0f,
    ...
    uz_pmsm_model_9ph_set_inputs_dq(self, inputs_dq);
    uz_pmsm_model_9ph_set_inputs_abc(self, inputs_abc);
    uz_pmsm_model_9ph_trigger_input_general_strobe(self);
    uz_pmsm_model_9ph_trigger_input_voltages_dq_strobe(self);
    uz_pmsm_model_9ph_trigger_input_voltages_abc_strobe(self);
...
void uz_pmsm_model_9ph_set_inputs_dq(uz_pmsm_model_9ph_t *self, struct uz_pmsm_model_9ph_inputs_dq_t inputs)
{
    uz_assert_not_NULL(self);
    uz_assert(self->is_ready);
    uz_pmsm_model_9ph_hw_write_u_d(self->config.base_address, inputs.u_dq.d);
    uz_pmsm_model_9ph_hw_write_u_q(self->config.base_address, inputs.u_dq.q);
    uz_pmsm_model_9ph_hw_write_u_o1(self->config.base_address, inputs.u_subspaces.z1);
    uz_pmsm_model_9ph_hw_write_u_o2(self->config.base_address, inputs.u_subspaces.z2);
    uz_pmsm_model_9ph_hw_write_u_x1(self->config.base_address, inputs.u_subspaces.x1);
    uz_pmsm_model_9ph_hw_write_u_y1(self->config.base_address, inputs.u_subspaces.y1);
    uz_pmsm_model_9ph_hw_write_u_x2(self->config.base_address, inputs.u_subspaces.x2);
    uz_pmsm_model_9ph_hw_write_u_y2(self->config.base_address, inputs.u_subspaces.y2);
    uz_pmsm_model_9ph_hw_write_u_zero(self->config.base_address, inputs.u_subspaces.z3);
}
...
void uz_pmsm_model_9ph_set_inputs_abc(uz_pmsm_model_9ph_t *self, uz_9ph_abc_t inputs)
{
    uz_assert_not_NULL(self);
    uz_assert(self->is_ready);
    uz_pmsm_model_9ph_hw_write_u_a1(self->config.base_address, inputs.a1);
    uz_pmsm_model_9ph_hw_write_u_b1(self->config.base_address, inputs.b1);
    uz_pmsm_model_9ph_hw_write_u_c1(self->config.base_address, inputs.c1);
    uz_pmsm_model_9ph_hw_write_u_a2(self->config.base_address, inputs.a2);
    uz_pmsm_model_9ph_hw_write_u_b2(self->config.base_address, inputs.b2);
    uz_pmsm_model_9ph_hw_write_u_c2(self->config.base_address, inputs.c2);
    uz_pmsm_model_9ph_hw_write_u_a3(self->config.base_address, inputs.a3);
    uz_pmsm_model_9ph_hw_write_u_b3(self->config.base_address, inputs.b3);
    uz_pmsm_model_9ph_hw_write_u_c3(self->config.base_address, inputs.c3);
}
...
struct uz_pmsm_model_9ph_outputs_dq_t uz_pmsm_model_9ph_get_outputs_dq(uz_pmsm_model_9ph_t *self)
{
    ...
    struct uz_pmsm_model_9ph_outputs_dq_t outputs = {
        ...
        .i_subspaces.y2 = 0.0f,
        .i_subspaces.z3 = 0.0f};
    outputs.i_dq.d = uz_pmsm_model_9ph_hw_read_i_d_outdq(self->config.base_address);
    outputs.i_dq.q = uz_pmsm_model_9ph_hw_read_i_q_outdq(self->config.base_address);
    outputs.i_subspaces.z1 = uz_pmsm_model_9ph_hw_read_i_o1(self->config.base_address);
    outputs.i_subspaces.z2 = uz_pmsm_model_9ph_hw_read_i_o2(self->config.base_address);
    ...
    outputs.i_subspaces.z3 = uz_pmsm_model_9ph_hw_read_i_zero(self->config.base_address);
    return outputs;
}
...
void uz_pmsm_model_9ph_trigger_input_voltages_dq_strobe(uz_pmsm_model_9ph_t *self){
    uz_assert_not_NULL(self);
    uz_assert(self->is_ready);
    uz_pmsm_model_9ph_hw_trigger_input_voltages_dq_strobe(self->config.base_address);
}

void uz_pmsm_model_9ph_trigger_input_voltages_abc_strobe(uz_pmsm_model_9ph_t *self){
    uz_assert_not_NULL(self);
    uz_assert(self->is_ready);
    uz_pmsm_model_9ph_hw_trigger_input_voltages_abc_strobe(self->config.base_address);
}
...
void uz_pmsm_model_9ph_trigger_output_currents_abc_strobe(uz_pmsm_model_9ph_t *self){
        uz_assert_not_NULL(self);
    uz_assert(self->is_ready);
    uz_pmsm_model_9ph_hw_trigger_output_currents_abc_strobe(self->config.base_address);
}
...
static void write_config_to_pl(uz_pmsm_model_9ph_t *self)
{
    ...
    uz_pmsm_model_9ph_hw_write_L_o1(self->config.base_address, self->config.L_o1);
    uz_pmsm_model_9ph_hw_write_L_o2(self->config.base_address, self->config.L_o2);
    ...
    uz_pmsm_model_9ph_hw_write_L_zero(self->config.base_address, self->config.L_zero);
