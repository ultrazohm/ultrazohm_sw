-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_mpc_cost_and_optim_state_machine\uz_6ph_mp_ip_src_uz_6ph_mpc_prediction.vhd
...
-- last_prediciton_done          ce_out        1e-08
-- index                         ce_out        1e-08
-- -------------------------------------------------------------
-- 
-- -------------------------------------------------------------
...
-- -------------------------------------------------------------
-- 
-- Module: uz_6ph_mp_ip_src_uz_6ph_mpc_prediction
...
USE work.uz_6ph_mp_ip_src_uz_6ph_mpc_prediction_pkg.ALL;

ENTITY uz_6ph_mp_ip_src_uz_6ph_mpc_prediction IS
...
END uz_6ph_mp_ip_src_uz_6ph_mpc_prediction;


ARCHITECTURE rtl OF uz_6ph_mp_ip_src_uz_6ph_mpc_prediction IS

  -- Component Declarations
  COMPONENT uz_6ph_mp_ip_src_Detect_Rise_Positive
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  COMPONENT uz_6ph_mp_ip_src_Detect_Rise_Positive1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  COMPONENT uz_6ph_mp_ip_src_Detect_Rise_Positive2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  COMPONENT uz_6ph_mp_ip_src_Detect_Rise_Positive3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  COMPONENT uz_6ph_mp_ip_src_Subsystem
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          Set                             :   IN    std_logic;
  ...
  FOR ALL : uz_6ph_mp_ip_src_Detect_Rise_Positive
    USE ENTITY work.uz_6ph_mp_ip_src_Detect_Rise_Positive(rtl);

  FOR ALL : uz_6ph_mp_ip_src_Detect_Rise_Positive1
    USE ENTITY work.uz_6ph_mp_ip_src_Detect_Rise_Positive1(rtl);

  FOR ALL : uz_6ph_mp_ip_src_Detect_Rise_Positive2
    USE ENTITY work.uz_6ph_mp_ip_src_Detect_Rise_Positive2(rtl);

  FOR ALL : uz_6ph_mp_ip_src_Detect_Rise_Positive3
    USE ENTITY work.uz_6ph_mp_ip_src_Detect_Rise_Positive3(rtl);

  FOR ALL : uz_6ph_mp_ip_src_Subsystem
    USE ENTITY work.uz_6ph_mp_ip_src_Subsystem(rtl);
  ...
  SIGNAL Delay51_ctrl_const_out           : std_logic;
  SIGNAL Delay51_ctrl_delay_out           : std_logic;
  SIGNAL Delay51_Initial_Val_out          : unsigned(31 DOWNTO 0);  -- uint32
  SIGNAL Constant1_out1                   : unsigned(31 DOWNTO 0);  -- uint32
  SIGNAL Delay49_ctrl_const_out           : std_logic;
  SIGNAL Delay49_ctrl_delay_out           : std_logic;
  SIGNAL Delay49_Initial_Val_out          : unsigned(31 DOWNTO 0);  -- uint32
  SIGNAL Delay52_ctrl_const_out           : std_logic;
  SIGNAL Delay52_ctrl_delay_out           : std_logic;
  SIGNAL Delay52_Initial_Val_out          : unsigned(31 DOWNTO 0);  -- uint32
  ...
  SIGNAL Add8_out1                        : unsigned(31 DOWNTO 0);  -- uint32
  SIGNAL predict_done                     : unsigned(31 DOWNTO 0);  -- uint32
  SIGNAL Delay52_out1                     : unsigned(31 DOWNTO 0);  -- uint32
  SIGNAL Add9_out1                        : unsigned(31 DOWNTO 0);  -- uint32
  SIGNAL predict_done_1                   : unsigned(31 DOWNTO 0);  -- uint32
  ...
  SIGNAL predict_done_3                   : unsigned(31 DOWNTO 0);  -- uint32
...
BEGIN
  ...
  u_Detect_Rise_Positive : uz_6ph_mp_ip_src_Detect_Rise_Positive
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              U => Delay_out1,
  ...
  u_Detect_Rise_Positive1 : uz_6ph_mp_ip_src_Detect_Rise_Positive1
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              U => Delay50_out1,
  ...
  u_Detect_Rise_Positive2 : uz_6ph_mp_ip_src_Detect_Rise_Positive2
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              U => Delay53_out1,
  ...
  u_Detect_Rise_Positive3 : uz_6ph_mp_ip_src_Detect_Rise_Positive3
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_Subsystem : uz_6ph_mp_ip_src_Subsystem
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              Set => Delay55_out1,
  ...
  Delay51_ctrl_const_out <= '1';

  Delay51_ctrl_delay_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay51_ctrl_delay_out <= '0';
      ELSIF enb = '1' THEN
        Delay51_ctrl_delay_out <= Delay51_ctrl_const_out;
      END IF;
    END IF;
  END PROCESS Delay51_ctrl_delay_process;


  Delay51_Initial_Val_out <= to_unsigned(1, 32);

  Constant1_out1 <= to_unsigned(63, 32);

  Delay49_ctrl_const_out <= '1';

  Delay49_ctrl_delay_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay49_ctrl_delay_out <= '0';
      ELSIF enb = '1' THEN
        Delay49_ctrl_delay_out <= Delay49_ctrl_const_out;
      END IF;
    END IF;
  END PROCESS Delay49_ctrl_delay_process;


  Delay49_Initial_Val_out <= to_unsigned(1, 32);

  Delay52_ctrl_const_out <= '1';

  Delay52_ctrl_delay_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay52_ctrl_delay_out <= '0';
      ELSIF enb = '1' THEN
        Delay52_ctrl_delay_out <= Delay52_ctrl_const_out;
      END IF;
    END IF;
  END PROCESS Delay52_ctrl_delay_process;


  Delay52_Initial_Val_out <= to_unsigned(1, 32);

  Constant_out1 <= to_unsigned(1, 32);

  TmpGroundAtSwitch7Inport3_out1 <= '0';

  Add8_out1 <= Delay49_out1 + Constant_out1;

  
  Delay52_out1 <= Delay52_Initial_Val_out WHEN Delay52_ctrl_delay_out = '0' ELSE
      predict_done;

  Add9_out1 <= Delay52_out1 - Constant1_out1;

  
  Delay49_out1 <= Delay49_Initial_Val_out WHEN Delay49_ctrl_delay_out = '0' ELSE
      predict_done;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        predict_done <= to_unsigned(0, 32);
      ELSIF enb = '1' THEN
        predict_done <= predict_done_1;
      END IF;
    END IF;
  ...
  Delay51_out1 <= Delay51_Initial_Val_out WHEN Delay51_ctrl_delay_out = '0' ELSE
      predict_done;

  
  Relational_Operator_relop1 <= '1' WHEN Delay51_out1 >= Constant1_out1 ELSE
      '0';

  Logical_Operator_out1 <= Relational_Operator_relop1 AND Detect_Rise_Positive_out1;

  
  switch_compare_1_18 <= '1' WHEN Logical_Operator_out1 > '0' ELSE
      '0';

  
  Switch6_out1 <= Delay49_out1 WHEN switch_compare_1_18 = '0' ELSE
      Add9_out1;

  
  switch_compare_1_19 <= '1' WHEN trigger_predict > '0' ELSE
      '0';

  
  predict_done_1 <= Switch6_out1 WHEN switch_compare_1_19 = '0' ELSE
      Add8_out1;

  
  Relational_Operator1_relop1 <= '1' WHEN predict_done_1 > Constant1_out1 ELSE
      '0';

  Logical_Operator1_out1 <= Delay11_out1 AND Relational_Operator1_relop1;
  ...
  switch_compare_1_20 <= '1' WHEN Q > '0' ELSE
      '0';

  
  trigger_predict <= TmpGroundAtSwitch7Inport3_out1 WHEN switch_compare_1_20 = '0' ELSE
  ...
  index <= std_logic_vector(predict_done_1);
