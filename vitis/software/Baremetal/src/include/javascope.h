...
enum JS_SlowData {
	...
	JSSD_FLOAT_u_ind_d,
	JSSD_FLOAT_u_ind_q,
	JSSD_FLOAT_u_ind_q_1,
	JSSD_FLOAT_u_ind_d_1,
	...
	JSSD_FLOAT_rc_d,
	JSSD_FLOAT_rc_q,
	JSSD_FLOAT_rc_para_d,
	JSSD_FLOAT_rc_para_q,
	JSSD_FLOAT_u_ind_ref_Volts_d,
	JSSD_FLOAT_u_ind_ref_Volts_q,
	JSSD_FLOAT_u_ind_d_Kp,
	JSSD_FLOAT_u_ind_d_Ki,
	JSSD_FLOAT_u_ind_q_Kp,
	JSSD_FLOAT_u_ind_q_Ki,
	JSSD_FLOAT_rc_repeat,
	JSSD_ENDMARKER
};
...
// Do not change the first (zero) and last (end) entries.
	...
	MyButton1,
	control_uind,
	rc_measurement_Hoerner,
	rs_measurement_hoerner,
	rs_meas_Brose,
	rc_meas_Brose,
	FOC,
	reset,
