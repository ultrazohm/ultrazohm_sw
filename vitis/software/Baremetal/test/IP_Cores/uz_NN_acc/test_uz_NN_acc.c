...
float w_6[NUMBER_OF_NEURONS_IN_FIFTH_LAYER * NUMBER_OF_OUTPUTS] = {
#include "../uz_mlp_three_layer/layer4_weights.csv"
};
float b_6[NUMBER_OF_OUTPUTS] = {
#include "../uz_mlp_three_layer/layer4_bias.csv"
};
float y_6[NUMBER_OF_OUTPUTS] = {0};
struct uz_nn_layer_config software_nn_config_5N[6] = {
    ...
    [5] = {.activation_function = activation_tanh, .number_of_neurons = NUMBER_OF_OUTPUTS, .number_of_inputs = NUMBER_OF_NEURONS_IN_THIRD_LAYER, .length_of_weights = UZ_MATRIX_SIZE(w_6), .length_of_bias = UZ_MATRIX_SIZE(b_6), .length_of_output = UZ_MATRIX_SIZE(y_6), .weights = w_6, .bias = b_6, .output = y_6}};
struct uz_nn_layer_config software_nn_config_4N[5] = {
    ...
    [2] = {.activation_function = activation_ReLU, .number_of_neurons = NUMBER_OF_NEURONS_IN_THIRD_LAYER, .number_of_inputs = NUMBER_OF_NEURONS_IN_THIRD_LAYER, .length_of_weights = UZ_MATRIX_SIZE(w_3), .length_of_bias = UZ_MATRIX_SIZE(b_3), .length_of_output = UZ_MATRIX_SIZE(y_3), .weights = w_3, .bias = b_3, .output = y_3},
    [3] = {.activation_function = activation_ReLU, .number_of_neurons = NUMBER_OF_NEURONS_IN_FOURTH_LAYER, .number_of_inputs = NUMBER_OF_NEURONS_IN_FOURTH_LAYER, .length_of_weights = UZ_MATRIX_SIZE(w_4), .length_of_bias = UZ_MATRIX_SIZE(b_4), .length_of_output = UZ_MATRIX_SIZE(y_4), .weights = w_4, .bias = b_4, .output = y_4},
    [4] = {.activation_function = activation_tanh, .number_of_neurons = NUMBER_OF_OUTPUTS, .number_of_inputs = NUMBER_OF_NEURONS_IN_THIRD_LAYER, .length_of_weights = UZ_MATRIX_SIZE(w_6), .length_of_bias = UZ_MATRIX_SIZE(b_6), .length_of_output = UZ_MATRIX_SIZE(y_6), .weights = w_6, .bias = b_6, .output = y_6}};
...
struct uz_nn_layer_config software_nn_config_2N[3] = {
    [0] = {
        ...
        .output = y_1},
    [1] = {.activation_function = activation_ReLU, .number_of_neurons = NUMBER_OF_NEURONS_IN_SECOND_LAYER, .number_of_inputs = NUMBER_OF_NEURONS_IN_SECOND_LAYER, .length_of_weights = UZ_MATRIX_SIZE(w_2), .length_of_bias = UZ_MATRIX_SIZE(b_2), .length_of_output = UZ_MATRIX_SIZE(y_2), .weights = w_2, .bias = b_2, .output = y_2},
    [2] = {.activation_function = activation_tanh, .number_of_neurons = NUMBER_OF_OUTPUTS, .number_of_inputs = NUMBER_OF_NEURONS_IN_THIRD_LAYER, .length_of_weights = UZ_MATRIX_SIZE(w_6), .length_of_bias = UZ_MATRIX_SIZE(b_6), .length_of_output = UZ_MATRIX_SIZE(y_6), .weights = w_6, .bias = b_6, .output = y_6}};
struct uz_nn_layer_config software_nn_config_1N[2] = {
    [0] = {
        ...
        .bias = b_1,
        .output = y_1},
    [1] = {.activation_function = activation_tanh, .number_of_neurons = NUMBER_OF_OUTPUTS, .number_of_inputs = NUMBER_OF_NEURONS_IN_THIRD_LAYER, .length_of_weights = UZ_MATRIX_SIZE(w_6), .length_of_bias = UZ_MATRIX_SIZE(b_6), .length_of_output = UZ_MATRIX_SIZE(y_6), .weights = w_6, .bias = b_6, .output = y_6}};
...
uz_NN_acc_t *successful_init_5_layer(void) {
    ...
    uz_NN_acc_hw_set_L_Output_Weights_Data_Expect(BASE_ADDRESS,&w_6[0]);
    uz_NN_acc_hw_set_L_Output_Bias_Data_Expect(BASE_ADDRESS,&b_6[0]);
    ...
    uz_NN_acc_hw_set_Actions_Data_Expect(BASE_ADDRESS,&y_6[0]);
    Xil_DCacheFlushRange_CMockExpect(172,((INTPTR)((INTPTR*)output)),24U*4U);
