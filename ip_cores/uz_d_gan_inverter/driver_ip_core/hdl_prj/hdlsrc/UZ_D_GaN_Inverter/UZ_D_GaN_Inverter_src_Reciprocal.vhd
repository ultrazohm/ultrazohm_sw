-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\UZ_D_GaN_Inverter\UZ_D_GaN_Inverter_src_Reciprocal.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: UZ_D_GaN_Inverter_src_Reciprocal
-- Source Path: UZ_D_GaN_Inverter/UZ_D_GaN_Inverter/PWMdutyFreqDetection/Reciprocal
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY UZ_D_GaN_Inverter_src_Reciprocal IS
...
END UZ_D_GaN_Inverter_src_Reciprocal;


ARCHITECTURE rtl OF UZ_D_GaN_Inverter_src_Reciprocal IS

  -- Component Declarations
  COMPONENT UZ_D_GaN_Inverter_src_Reciprocal_iv
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT UZ_D_GaN_Inverter_src_Reciprocal_core
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : UZ_D_GaN_Inverter_src_Reciprocal_iv
    USE ENTITY work.UZ_D_GaN_Inverter_src_Reciprocal_iv(rtl);

  FOR ALL : UZ_D_GaN_Inverter_src_Reciprocal_core
    USE ENTITY work.UZ_D_GaN_Inverter_src_Reciprocal_core(rtl);
...
BEGIN
  ...
  u_iv_stage_inst : UZ_D_GaN_Inverter_src_Reciprocal_iv
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_core_stage1_inst : UZ_D_GaN_Inverter_src_Reciprocal_core
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_core_stage2_inst : UZ_D_GaN_Inverter_src_Reciprocal_core
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_core_stage3_inst : UZ_D_GaN_Inverter_src_Reciprocal_core
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
