-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_pmsm_model_nonlinear\uz_pmsm_model_nonlinear_src_nfp_cosh_single.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_nonlinear_src_nfp_cosh_single
-- Source Path: uz_pmsm_model_nonlinear/uz_pmsm_mode_nonlinear/nfp_cosh_single
-- Hierarchy Level: 1
-- Model version: 9.10
-- 
...
ENTITY uz_pmsm_model_nonlinear_src_nfp_cosh_single IS
...
END uz_pmsm_model_nonlinear_src_nfp_cosh_single;


ARCHITECTURE rtl OF uz_pmsm_model_nonlinear_src_nfp_cosh_single IS
...
BEGIN
  ...
  exp_tmp_upperBound_out1 <= '1' WHEN upperBound_out1 > reinterpretcast_bitconcat_fi_0_out1 ELSE
      '0';
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay2_out1_2 <= '0';
      ELSIF enb = '1' THEN
        Delay2_out1_2 <= exp_tmp_upperBound_out1;
      END IF;
    END IF;
