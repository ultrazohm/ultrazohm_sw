-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\parallel_8_phase_voltages\hdlsrc\parallel_8_phase_voltages\parallel_8_sim_phase_voltages_src_nfp_convert_sfix_16_En14_to_single.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: parallel_8_sim_phase_voltages_src_nfp_convert_sfix_16_En14_to_single
-- Source Path: parallel_8_phase_voltages/Phase_voltages_per_switching_state1/nfp_convert_sfix_16_En14_to_single
-- Hierarchy Level: 1
-- 
...
ENTITY parallel_8_sim_phase_voltages_src_nfp_convert_sfix_16_En14_to_single IS
...
END parallel_8_sim_phase_voltages_src_nfp_convert_sfix_16_En14_to_single;


ARCHITECTURE rtl OF parallel_8_sim_phase_voltages_src_nfp_convert_sfix_16_En14_to_single IS

  -- Signals
  SIGNAL nfp_in_signed                    : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL Delay_out1_dtc                   : unsigned(15 DOWNTO 0);  -- ufix16_En14
  ...
  SIGNAL Unary_Minus_out1_dtc             : unsigned(15 DOWNTO 0);  -- ufix16_En14
  SIGNAL Switch_out1                      : unsigned(15 DOWNTO 0);  -- ufix16_En14
  SIGNAL Data_Type_Conversion_out1        : unsigned(127 DOWNTO 0);  -- ufix128_En14
  ...
  SIGNAL Delay2_reg_next                  : vector_of_unsigned128(0 TO 2);  -- ufix128_En14 [3]
  SIGNAL Delay2_out1_3                    : unsigned(127 DOWNTO 0);  -- ufix128_En14
  ...
  SIGNAL Shift_Arithmetic_out1            : unsigned(127 DOWNTO 0);  -- ufix128_En14
...
BEGIN
  ...
  Constant_out1 <= to_signed(16#70#, 8);
