...
reg    p_m_blk_n;
wire    call_ln59_p_prop_scalar_p_m_proc124_fu_62_p_m_out_blk_n;
reg    p_m_out_blk_n;
reg    p_n_blk_n;
...
reg    call_ln59_p_prop_scalar_p_m_proc124_fu_62_ap_start;
wire    call_ln59_p_prop_scalar_p_m_proc124_fu_62_ap_done;
wire    call_ln59_p_prop_scalar_p_m_proc124_fu_62_ap_idle;
wire    call_ln59_p_prop_scalar_p_m_proc124_fu_62_ap_ready;
wire   [31:0] call_ln59_p_prop_scalar_p_m_proc124_fu_62_p_m_out_din;
wire    call_ln59_p_prop_scalar_p_m_proc124_fu_62_p_m_out_write;
...
MLP_p_prop_scalar_p_m_proc124 call_ln59_p_prop_scalar_p_m_proc124_fu_62(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((~((ap_start == 1'b0) | (call_ln59_p_prop_scalar_p_m_proc124_fu_62_p_m_out_blk_n == 1'b0) | (p_n_empty_n == 1'b0) | (p_m_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1)) | ((1'b1 == ap_CS_fsm_state2) & (ap_sync_grp_dot_fu_48_ap_ready == 1'b0)))) begin
...
always @ (posedge ap_clk) begin
    if ((~((ap_start == 1'b0) | (call_ln59_p_prop_scalar_p_m_proc124_fu_62_p_m_out_blk_n == 1'b0) | (p_n_empty_n == 1'b0) | (p_m_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (p_n_empty_n == 1'b0) | (p_m_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        call_ln59_p_prop_scalar_p_m_proc124_fu_62_ap_start = 1'b1;
    end else begin
        call_ln59_p_prop_scalar_p_m_proc124_fu_62_ap_start = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_state1 = ((ap_start == 1'b0) | (call_ln59_p_prop_scalar_p_m_proc124_fu_62_p_m_out_blk_n == 1'b0) | (p_n_empty_n == 1'b0) | (p_m_empty_n == 1'b0) | (ap_done_reg == 1'b1));
end
...
always @ (*) begin
    ap_block_state1_ignore_call13 = ((ap_start == 1'b0) | (call_ln59_p_prop_scalar_p_m_proc124_fu_62_p_m_out_blk_n == 1'b0) | (p_n_empty_n == 1'b0) | (p_m_empty_n == 1'b0) | (ap_done_reg == 1'b1));
end
...
assign p_m_out_din = call_ln59_p_prop_scalar_p_m_proc124_fu_62_p_m_out_din;

assign p_y_din = grp_dot_fu_48_p_res_din;

endmodule //MLP_dot144
