...
#define  IPCore_Timestamp_PWM_and_SS_control_V4_ip                  0x8  //contains unique IP timestamp (yymmddHHMM): 2310111417
...
#define  PWM_min_pulse_width_rd_AXI_Data_PWM_and_SS_control_V4_ip   0x148  //data register for Outport PWM_min_pulse_width_rd_AXI
#define  Mode_rd_AXI_Data_PWM_and_SS_control_V4_ip                  0x14C  //data register for Outport Mode_rd_AXI
