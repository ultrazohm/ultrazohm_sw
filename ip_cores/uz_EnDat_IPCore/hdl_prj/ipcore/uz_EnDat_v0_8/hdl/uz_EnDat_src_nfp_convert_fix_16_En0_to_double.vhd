...
-- Source Path: UZ_EnDat/UZ_ENDAT/nfp_convert_fix_16_En0_to_double
-- Hierarchy Level: 1
-- 
...
BEGIN
  ...
  CompareToZero1_out1 <= '1' WHEN nfp_in_unsigned = to_unsigned(16#0000#, 16) ELSE
      '0';
  ...
  Unary_Minus_cast <= signed(resize(nfp_in_unsigned, 17));
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay1_PS_4_out1 <= Switch_out1_1;
      END IF;
    END IF;
  ...
  Switch1_out1_1 <= Data_Type_Conversion_out1 WHEN Delay5_PS_2_5_out1 = '0' ELSE
      Constant_out1_2;
  ...
  Subtract_sub_cast_1 <= signed(resize(Switch_out1_1, 9));
  ...
  Bit_Slice1_out1_2 <= Shift_Arithmetic_out1(14 DOWNTO 0);
