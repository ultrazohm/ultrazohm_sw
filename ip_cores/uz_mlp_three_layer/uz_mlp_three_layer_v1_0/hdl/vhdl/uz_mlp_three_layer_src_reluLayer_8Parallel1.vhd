-- -------------------------------------------------------------
-- 
-- File Name: /home/ts/Documents/integrate_nn_to_uz/ultrazohm_sw/ip_cores/nnAXI_v1_0/hdl_prj/hdlsrc/uz_mlp_three_layer/uz_mlp_three_layer_src_reluLayer_8Parallel1.vhd
...
ARCHITECTURE rtl OF uz_mlp_three_layer_src_reluLayer_8Parallel1 IS
  ...
  COMPONENT uz_mlp_three_layer_src_MAC2_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          rd_addr                         :   IN    std_logic_vector(9 DOWNTO 0);  -- ufix10
  ...
  FOR ALL : uz_mlp_three_layer_src_MAC2_block1
    USE ENTITY work.uz_mlp_three_layer_src_MAC2_block1(rtl);
...
BEGIN
  ...
  u_MAC2 : uz_mlp_three_layer_src_MAC2_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              rd_addr => ram_rd_addr,  -- ufix10
  ...
  layer1_output <= MAC3_out1_signed WHEN MATLAB_Function1_out1_unsigned = to_unsigned(16#00#, 8) ELSE
      MAC2_out1_signed WHEN MATLAB_Function1_out1_unsigned = to_unsigned(16#01#, 8) ELSE
