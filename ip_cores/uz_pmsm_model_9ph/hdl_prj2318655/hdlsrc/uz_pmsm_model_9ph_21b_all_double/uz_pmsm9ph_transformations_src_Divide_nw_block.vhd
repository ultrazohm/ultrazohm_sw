-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj2318655/hdlsrc/uz_pmsm_model_9ph_21b_all_double/uz_pmsm9ph_transformations_src_Divide_nw_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm9ph_transformations_src_Divide_nw_block
-- Source Path: 
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
...
ENTITY uz_pmsm9ph_transformations_src_Divide_nw_block IS
...
END uz_pmsm9ph_transformations_src_Divide_nw_block;


ARCHITECTURE rtl OF uz_pmsm9ph_transformations_src_Divide_nw_block IS
  ...
  SIGNAL Divide_out1_bypass               : signed(24 DOWNTO 0);  -- sfix25_En12
  SIGNAL Divide_out1_last_value           : signed(24 DOWNTO 0);  -- sfix25_En12
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        cos_theta_hdl <= to_signed(16#00000#, 17);
      ELSIF enb_gated = '1' THEN
        cos_theta_hdl <= in0_signed;
      END IF;
    END IF;
  ...
  Divide_mul_temp <= cos_theta_hdl * u_alpha;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Divide_out1_last_value <= to_signed(16#0000000#, 25);
      ELSIF enb_gated = '1' THEN
