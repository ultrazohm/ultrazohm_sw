...
#define  IPCore_Timestamp_parallel_8_sim_phase_voltages               0x8  //contains unique IP timestamp (yymmddHHMM): 2211191333
...
#define  done_delay_compensation_Data_parallel_8_sim_phase_voltages   0x10C  //data register for Inport done_delay_compensation
