-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_inverter_3phgm\uz_invert_3ph_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_invert_3ph_dut
-- Source Path: uz_invert_3ph/uz_invert_3ph_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END uz_invert_3ph_dut;


ARCHITECTURE rtl OF uz_invert_3ph_dut IS

  -- Component Declarations
  COMPONENT uz_invert_3ph_src_uz_inverter_3ph
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : uz_invert_3ph_src_uz_inverter_3ph
    USE ENTITY work.uz_invert_3ph_src_uz_inverter_3ph(rtl);
...
BEGIN
  u_uz_invert_3ph_src_uz_inverter_3ph : uz_invert_3ph_src_uz_inverter_3ph
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
