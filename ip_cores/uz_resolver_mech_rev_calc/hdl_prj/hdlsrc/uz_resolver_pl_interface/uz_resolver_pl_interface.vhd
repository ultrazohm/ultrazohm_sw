-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_resolver_pl_interface\uz_resolver_pl_interface.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_resolver_pl_interface
-- Source Path: uz_resolver_pl_interface
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_resolver_pl_interface IS
  PORT( IPCORE_CLK                        :   IN    std_logic;  -- ufix1
        ...
        omega_mech_rad_s                  :   OUT   std_logic_vector(23 DOWNTO 0);  -- ufix24
        n_mech_rpm                        :   OUT   std_logic_vector(23 DOWNTO 0);  -- ufix24
...
END uz_resolver_pl_interface;


ARCHITECTURE rtl OF uz_resolver_pl_interface IS

  -- Component Declarations
  COMPONENT uz_resolver_pl_interface_reset_sync
  ...
  COMPONENT uz_resolver_pl_interface_axi_lite
  ...
  COMPONENT uz_resolver_pl_interface_dut
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
  ...
  FOR ALL : uz_resolver_pl_interface_reset_sync
    USE ENTITY work.uz_resolver_pl_interface_reset_sync(rtl);

  FOR ALL : uz_resolver_pl_interface_axi_lite
    USE ENTITY work.uz_resolver_pl_interface_axi_lite(rtl);

  FOR ALL : uz_resolver_pl_interface_dut
    USE ENTITY work.uz_resolver_pl_interface_dut(rtl);
  ...
  SIGNAL write_theta_m_offset_rad_AXI     : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL omega_mech_rad_s_sig_signed      : signed(23 DOWNTO 0);  -- sfix24_En11
  SIGNAL omega_mech_rad_s_tmp             : unsigned(23 DOWNTO 0);  -- ufix24
  SIGNAL n_mech_rpm_sig_signed            : signed(23 DOWNTO 0);  -- sfix24_En11
  SIGNAL n_mech_rpm_tmp                   : unsigned(23 DOWNTO 0);  -- ufix24

BEGIN
  u_uz_resolver_pl_interface_reset_sync_inst : uz_resolver_pl_interface_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_uz_resolver_pl_interface_axi_lite_inst : uz_resolver_pl_interface_axi_lite
    PORT MAP( reset => reset,
              ...
              read_position_mech_2pi_AXI => position_mech_2pi_AXI_sig,  -- ufix32
              read_position_el_2pi_AXI => position_el_2pi_AXI_sig,  -- ufix32
              read_omega_mech_rad_s_AXI => omega_mech_rad_s_AXI_sig,  -- ufix32
              read_cnt_AXI => cnt_AXI_sig,  -- sfix32
              read_n_mech_rpm_AXI => n_mech_rpm_AXI_sig,  -- ufix32
              ...
              write_theta_m_offset_rad_AXI => write_theta_m_offset_rad_AXI,  -- ufix32
              reset_internal => reset_internal  -- ufix1
              );

  u_uz_resolver_pl_interface_dut_inst : uz_resolver_pl_interface_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              ...
              theta_m_offset_rad_AXI => write_theta_m_offset_rad_AXI,  -- ufix32
  ...
  ip_timestamp <= unsigned'(X"89572E07");
  ...
  omega_mech_rad_s_sig_signed <= signed(omega_mech_rad_s_sig);

  omega_mech_rad_s_tmp <= unsigned(omega_mech_rad_s_sig_signed);

  omega_mech_rad_s <= std_logic_vector(omega_mech_rad_s_tmp);

  n_mech_rpm_sig_signed <= signed(n_mech_rpm_sig);

  n_mech_rpm_tmp <= unsigned(n_mech_rpm_sig_signed);

  n_mech_rpm <= std_logic_vector(n_mech_rpm_tmp);
