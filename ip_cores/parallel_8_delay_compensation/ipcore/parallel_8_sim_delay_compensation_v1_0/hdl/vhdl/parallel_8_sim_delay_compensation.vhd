-- -------------------------------------------------------------
-- 
-- File Name: C:\ultrazohm_sw\ip_cores\parallel_8_delay_compensation\hdlsrc\parallel_8_delay_compensation\parallel_8_sim_delay_compensation.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: parallel_8_sim_delay_compensation
-- Source Path: parallel_8_sim_delay_compensation
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY parallel_8_sim_delay_compensation IS
  PORT( IPCORE_CLK                        :   IN    std_logic;  -- ufix1
        IPCORE_RESETN                     :   IN    std_logic;  -- ufix1
        dq_measured_currents              :   IN    std_logic_vector(161 DOWNTO 0);  -- ufix162
...
END parallel_8_sim_delay_compensation;


ARCHITECTURE rtl OF parallel_8_sim_delay_compensation IS

  -- Component Declarations
  COMPONENT parallel_8_sim_delay_compensation_reset_sync
  ...
  COMPONENT parallel_8_sim_delay_compensation_axi_lite
  ...
  COMPONENT parallel_8_sim_delay_compensation_dut
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
  ...
  FOR ALL : parallel_8_sim_delay_compensation_reset_sync
    USE ENTITY work.parallel_8_sim_delay_compensation_reset_sync(rtl);

  FOR ALL : parallel_8_sim_delay_compensation_axi_lite
    USE ENTITY work.parallel_8_sim_delay_compensation_axi_lite(rtl);

  FOR ALL : parallel_8_sim_delay_compensation_dut
    USE ENTITY work.parallel_8_sim_delay_compensation_dut(rtl);

  -- Signals
  SIGNAL reset                            : std_logic;
  SIGNAL ip_timestamp                     : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL reset_cm                         : std_logic;  -- ufix1
  SIGNAL dq_measured_currents_unsigned    : unsigned(161 DOWNTO 0);  -- ufix162
  SIGNAL dq_measured_currents_slice       : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL dq_measured_currents_0_sig       : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL dq_measured_currents_unsigned_1  : unsigned(161 DOWNTO 0);  -- ufix162
  SIGNAL dq_measured_currents_slice_1     : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL dq_measured_currents_1_sig       : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL dq_measured_currents_unsigned_2  : unsigned(161 DOWNTO 0);  -- ufix162
  SIGNAL dq_measured_currents_slice_2     : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL dq_measured_currents_2_sig       : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL dq_measured_currents_unsigned_3  : unsigned(161 DOWNTO 0);  -- ufix162
  SIGNAL dq_measured_currents_slice_3     : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL dq_measured_currents_3_sig       : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL dq_measured_currents_unsigned_4  : unsigned(161 DOWNTO 0);  -- ufix162
  SIGNAL dq_measured_currents_slice_4     : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL dq_measured_currents_4_sig       : signed(26 DOWNTO 0);  -- sfix27_En18
  SIGNAL dq_measured_currents_unsigned_5  : unsigned(161 DOWNTO 0);  -- ufix162
  SIGNAL dq_measured_currents_slice_5     : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL dq_measured_currents_5_sig       : signed(26 DOWNTO 0);  -- sfix27_En18
  ...
  SIGNAL write_omega_m_measured_AXI       : std_logic_vector(31 DOWNTO 0);  -- ufix32
...
BEGIN
  u_parallel_8_sim_delay_compensation_reset_sync_inst : parallel_8_sim_delay_compensation_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_parallel_8_sim_delay_compensation_axi_lite_inst : parallel_8_sim_delay_compensation_axi_lite
    PORT MAP( reset => reset,
              ...
              write_omega_m_measured_AXI => write_omega_m_measured_AXI,  -- ufix32
              reset_internal => reset_internal  -- ufix1
              );

  u_parallel_8_sim_delay_compensation_dut_inst : parallel_8_sim_delay_compensation_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              dut_enable => write_axi_enable,  -- ufix1
              dq_measured_currents_0 => std_logic_vector(dq_measured_currents_0_sig),  -- sfix27_En18
              dq_measured_currents_1 => std_logic_vector(dq_measured_currents_1_sig),  -- sfix27_En18
              dq_measured_currents_2 => std_logic_vector(dq_measured_currents_2_sig),  -- sfix27_En18
              dq_measured_currents_3 => std_logic_vector(dq_measured_currents_3_sig),  -- sfix27_En18
              dq_measured_currents_4 => std_logic_vector(dq_measured_currents_4_sig),  -- sfix27_En18
              dq_measured_currents_5 => std_logic_vector(dq_measured_currents_5_sig),  -- sfix27_En18
              ...
              omega_m_measured_AXI => write_omega_m_measured_AXI,  -- ufix32
  ...
  ip_timestamp <= unsigned'(X"83DBF851");

  reset_cm <=  NOT IPCORE_RESETN;

  dq_measured_currents_unsigned <= unsigned(dq_measured_currents);

  dq_measured_currents_slice <= dq_measured_currents_unsigned(26 DOWNTO 0);

  dq_measured_currents_0_sig <= signed(dq_measured_currents_slice);

  dq_measured_currents_unsigned_1 <= unsigned(dq_measured_currents);

  dq_measured_currents_slice_1 <= dq_measured_currents_unsigned_1(53 DOWNTO 27);

  dq_measured_currents_1_sig <= signed(dq_measured_currents_slice_1);

  dq_measured_currents_unsigned_2 <= unsigned(dq_measured_currents);

  dq_measured_currents_slice_2 <= dq_measured_currents_unsigned_2(80 DOWNTO 54);

  dq_measured_currents_2_sig <= signed(dq_measured_currents_slice_2);

  dq_measured_currents_unsigned_3 <= unsigned(dq_measured_currents);

  dq_measured_currents_slice_3 <= dq_measured_currents_unsigned_3(107 DOWNTO 81);

  dq_measured_currents_3_sig <= signed(dq_measured_currents_slice_3);

  dq_measured_currents_unsigned_4 <= unsigned(dq_measured_currents);

  dq_measured_currents_slice_4 <= dq_measured_currents_unsigned_4(134 DOWNTO 108);

  dq_measured_currents_4_sig <= signed(dq_measured_currents_slice_4);

  dq_measured_currents_unsigned_5 <= unsigned(dq_measured_currents);

  dq_measured_currents_slice_5 <= dq_measured_currents_unsigned_5(161 DOWNTO 135);

  dq_measured_currents_5_sig <= signed(dq_measured_currents_slice_5);
