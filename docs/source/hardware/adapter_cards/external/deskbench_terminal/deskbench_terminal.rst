...
.. toctree::
   ...
   rev01/deskbench_terminal_rev01
   rev02/deskbench_terminal_rev02

General description
*******************
This PCB is designed to connect a 3-phase PMSM with a resolver or an absolute encoder to the Deskbench.
