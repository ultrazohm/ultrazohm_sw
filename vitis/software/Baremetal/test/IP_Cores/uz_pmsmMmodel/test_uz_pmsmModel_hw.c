...
//FittingParameter output tests

void test_uz_pmsmModel_hw_read_out_ad1(void)
{
    float out_ad1_val=4.2f;
    uz_axi_read_float_ExpectAndReturn(BASE_ADDRESS+out_ad1_Data_uz_pmsm_model,out_ad1_val);
    float readback=uz_pmsmModel_hw_read_out_ad1(BASE_ADDRESS);
    TEST_ASSERT_EQUAL_FLOAT(out_ad1_val,readback);
}

void test_uz_pmsmModel_hw_read_out_ad2(void)
{
    float out_ad2_val=4.2f;
    uz_axi_read_float_ExpectAndReturn(BASE_ADDRESS+out_ad2_Data_uz_pmsm_model,out_ad2_val);
    float readback=uz_pmsmModel_hw_read_out_ad2(BASE_ADDRESS);
    TEST_ASSERT_EQUAL_FLOAT(out_ad2_val,readback);
}

void test_uz_pmsmModel_hw_read_out_ad3(void)
{
    float out_ad3_val=4.2f;
    uz_axi_read_float_ExpectAndReturn(BASE_ADDRESS+out_ad3_Data_uz_pmsm_model,out_ad3_val);
    float readback=uz_pmsmModel_hw_read_out_ad3(BASE_ADDRESS);
    TEST_ASSERT_EQUAL_FLOAT(out_ad3_val,readback);
}

void test_uz_pmsmModel_hw_read_out_ad4(void)
{
    float out_ad4_val=4.2f;
    uz_axi_read_float_ExpectAndReturn(BASE_ADDRESS+out_ad4_Data_uz_pmsm_model,out_ad4_val);
    float readback=uz_pmsmModel_hw_read_out_ad4(BASE_ADDRESS);
    TEST_ASSERT_EQUAL_FLOAT(out_ad4_val,readback);
}

void test_uz_pmsmModel_hw_read_out_ad5(void)
{
    float out_ad5_val=4.2f;
    uz_axi_read_float_ExpectAndReturn(BASE_ADDRESS+out_ad5_Data_uz_pmsm_model,out_ad5_val);
    float readback=uz_pmsmModel_hw_read_out_ad5(BASE_ADDRESS);
    TEST_ASSERT_EQUAL_FLOAT(out_ad5_val,readback);
}

void test_uz_pmsmModel_hw_read_out_ad6(void)
{
    float out_ad6_val=4.2f;
    uz_axi_read_float_ExpectAndReturn(BASE_ADDRESS+out_ad6_Data_uz_pmsm_model,out_ad6_val);
    float readback=uz_pmsmModel_hw_read_out_ad6(BASE_ADDRESS);
    TEST_ASSERT_EQUAL_FLOAT(out_ad6_val,readback);
}

void test_uz_pmsmModel_hw_read_out_aq1(void)
{
    float out_aq1_val=4.2f;
    uz_axi_read_float_ExpectAndReturn(BASE_ADDRESS+out_aq1_Data_uz_pmsm_model,out_aq1_val);
    float readback=uz_pmsmModel_hw_read_out_aq1(BASE_ADDRESS);
    TEST_ASSERT_EQUAL_FLOAT(out_aq1_val,readback);
}

void test_uz_pmsmModel_hw_read_out_aq2(void)
{
    float out_aq2_val=4.2f;
    uz_axi_read_float_ExpectAndReturn(BASE_ADDRESS+out_aq2_Data_uz_pmsm_model,out_aq2_val);
    float readback=uz_pmsmModel_hw_read_out_aq2(BASE_ADDRESS);
    TEST_ASSERT_EQUAL_FLOAT(out_aq2_val,readback);
}

void test_uz_pmsmModel_hw_read_out_aq3(void)
{
    float out_aq3_val=4.2f;
    uz_axi_read_float_ExpectAndReturn(BASE_ADDRESS+out_aq3_Data_uz_pmsm_model,out_aq3_val);
    float readback=uz_pmsmModel_hw_read_out_aq3(BASE_ADDRESS);
    TEST_ASSERT_EQUAL_FLOAT(out_aq3_val,readback);
}

void test_uz_pmsmModel_hw_read_out_aq4(void)
{
    float out_aq4_val=4.2f;
    uz_axi_read_float_ExpectAndReturn(BASE_ADDRESS+out_aq4_Data_uz_pmsm_model,out_aq4_val);
    float readback=uz_pmsmModel_hw_read_out_aq4(BASE_ADDRESS);
    TEST_ASSERT_EQUAL_FLOAT(out_aq4_val,readback);
}

void test_uz_pmsmModel_hw_read_out_aq5(void)
{
    float out_aq5_val=4.2f;
    uz_axi_read_float_ExpectAndReturn(BASE_ADDRESS+out_aq5_Data_uz_pmsm_model,out_aq5_val);
    float readback=uz_pmsmModel_hw_read_out_aq5(BASE_ADDRESS);
    TEST_ASSERT_EQUAL_FLOAT(out_aq5_val,readback);
}

void test_uz_pmsmModel_hw_read_out_aq6(void)
{
    float out_aq6_val=4.2f;
    uz_axi_read_float_ExpectAndReturn(BASE_ADDRESS+out_aq6_Data_uz_pmsm_model,out_aq6_val);
    float readback=uz_pmsmModel_hw_read_out_aq6(BASE_ADDRESS);
    TEST_ASSERT_EQUAL_FLOAT(out_aq6_val,readback);
}

void test_uz_pmsmModel_hw_read_out_reciprocal_F1G1(void)
{
    float out_reciprocal_F1G1_val=4.2f;
    uz_axi_read_float_ExpectAndReturn(BASE_ADDRESS+out_reciprocal_F1G1_Data_uz_pmsm_model,out_reciprocal_F1G1_val);
    float readback=uz_pmsmModel_hw_read_out_reciprocal_F1G1(BASE_ADDRESS);
    TEST_ASSERT_EQUAL_FLOAT(out_reciprocal_F1G1_val,readback);
}

void test_uz_pmsmModel_hw_read_out_reciprocal_F2G2(void)
{
    float out_reciprocal_F2G2_val=4.2f;
    uz_axi_read_float_ExpectAndReturn(BASE_ADDRESS+out_reciprocal_F2G2_Data_uz_pmsm_model,out_reciprocal_F2G2_val);
    float readback=uz_pmsmModel_hw_read_out_reciprocal_F2G2(BASE_ADDRESS);
    TEST_ASSERT_EQUAL_FLOAT(out_reciprocal_F2G2_val,readback);
}

void test_uz_pmsmModel_hw_read_out_ad4_mul_ad5(void)
{
    float out_ad4_mul_ad5_val=4.2f;
    uz_axi_read_float_ExpectAndReturn(BASE_ADDRESS+out_ad4_mul_ad5_Data_uz_pmsm_model,out_ad4_mul_ad5_val);
    float readback=uz_pmsmModel_hw_read_out_ad4_mul_ad5(BASE_ADDRESS);
    TEST_ASSERT_EQUAL_FLOAT(out_ad4_mul_ad5_val,readback);
}

void test_uz_pmsmModel_hw_read_out_ad1_mul_ad2(void)
{
    float out_ad1_mul_ad2_val=4.2f;
    uz_axi_read_float_ExpectAndReturn(BASE_ADDRESS+out_ad1_mul_ad2_Data_uz_pmsm_model,out_ad1_mul_ad2_val);
    float readback=uz_pmsmModel_hw_read_out_ad1_mul_ad2(BASE_ADDRESS);
    TEST_ASSERT_EQUAL_FLOAT(out_ad1_mul_ad2_val,readback);
}

void test_uz_pmsmModel_hw_read_out_aq4_mul_aq5(void)
{
    float out_aq4_mul_aq5_val=4.2f;
    uz_axi_read_float_ExpectAndReturn(BASE_ADDRESS+out_aq4_mul_aq5_Data_uz_pmsm_model,out_aq4_mul_aq5_val);
    float readback=uz_pmsmModel_hw_read_out_aq4_mul_aq5(BASE_ADDRESS);
    TEST_ASSERT_EQUAL_FLOAT(out_aq4_mul_aq5_val,readback);
}

void test_uz_pmsmModel_hw_read_out_aq1_mul_aq2(void)
{
    float out_aq1_mul_aq2_val=4.2f;
    uz_axi_read_float_ExpectAndReturn(BASE_ADDRESS+out_aq1_mul_aq2_Data_uz_pmsm_model,out_aq1_mul_aq2_val);
    float readback=uz_pmsmModel_hw_read_out_aq1_mul_aq2(BASE_ADDRESS);
    TEST_ASSERT_EQUAL_FLOAT(out_aq1_mul_aq2_val,readback);
}

void test_uz_pmsmModel_hw_read_out_aq4_div_aq5(void)
{
    float out_aq4_div_aq5_val=4.2f;
    uz_axi_read_float_ExpectAndReturn(BASE_ADDRESS+out_aq4_div_aq5_Data_uz_pmsm_model,out_aq4_div_aq5_val);
    float readback=uz_pmsmModel_hw_read_out_aq4_div_aq5(BASE_ADDRESS);
    TEST_ASSERT_EQUAL_FLOAT(out_aq4_div_aq5_val,readback);
}

void test_uz_pmsmModel_hw_read_out_aq1_div_aq2(void)
{
    float out_aq1_div_aq2_val=4.2f;
    uz_axi_read_float_ExpectAndReturn(BASE_ADDRESS+out_aq1_div_aq2_Data_uz_pmsm_model,out_aq1_div_aq2_val);
    float readback=uz_pmsmModel_hw_read_out_aq1_div_aq2(BASE_ADDRESS);
    TEST_ASSERT_EQUAL_FLOAT(out_aq1_div_aq2_val,readback);
}

void test_uz_pmsmModel_hw_read_out_ad4_div_ad5(void)
{
    float out_ad4_div_ad5_val=4.2f;
    uz_axi_read_float_ExpectAndReturn(BASE_ADDRESS+out_ad4_div_ad5_Data_uz_pmsm_model,out_ad4_div_ad5_val);
    float readback=uz_pmsmModel_hw_read_out_ad4_div_ad5(BASE_ADDRESS);
    TEST_ASSERT_EQUAL_FLOAT(out_ad4_div_ad5_val,readback);
}

void test_uz_pmsmModel_hw_read_out_ad1_div_ad2(void)
{
    float out_ad1_div_ad2_val=4.2f;
    uz_axi_read_float_ExpectAndReturn(BASE_ADDRESS+out_ad1_div_ad2_Data_uz_pmsm_model,out_ad1_div_ad2_val);
    float readback=uz_pmsmModel_hw_read_out_ad1_div_ad2(BASE_ADDRESS);
    TEST_ASSERT_EQUAL_FLOAT(out_ad1_div_ad2_val,readback);
}

void test_uz_pmsmModel_hw_read_out_aq3_min_aq6(void)
{
    float out_aq3_min_aq6_val=4.2f;
    uz_axi_read_float_ExpectAndReturn(BASE_ADDRESS+out_aq3_min_aq6_Data_uz_pmsm_model,out_aq3_min_aq6_val);
    float readback=uz_pmsmModel_hw_read_out_aq3_min_aq6(BASE_ADDRESS);
    TEST_ASSERT_EQUAL_FLOAT(out_aq3_min_aq6_val,readback);
}
