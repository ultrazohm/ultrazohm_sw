-- -------------------------------------------------------------
-- 
-- File Name: /home/ts/Documents/integrate_nn_to_uz/ultrazohm_sw/ip_cores/nnAXI_v1_0/hdl_prj/hdlsrc/uz_mlp_three_layer/uz_mlp_three_layer_axi4_module.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_mlp_three_layer_axi4_module
-- Source Path: uz_mlp_three_layer/uz_mlp_three_layer_axi4/uz_mlp_three_layer_axi4_module
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_mlp_three_layer_axi4_module IS
...
END uz_mlp_three_layer_axi4_module;


ARCHITECTURE rtl OF uz_mlp_three_layer_axi4_module IS

  -- Component Declarations
  COMPONENT uz_mlp_three_layer_rdfifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT uz_mlp_three_layer_rdfifo_rid
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT uz_mlp_three_layer_rdfifo_last
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : uz_mlp_three_layer_rdfifo_data
    USE ENTITY work.uz_mlp_three_layer_rdfifo_data(rtl);

  FOR ALL : uz_mlp_three_layer_rdfifo_rid
    USE ENTITY work.uz_mlp_three_layer_rdfifo_rid(rtl);

  FOR ALL : uz_mlp_three_layer_rdfifo_last
    USE ENTITY work.uz_mlp_three_layer_rdfifo_last(rtl);
...
BEGIN
  u_uz_mlp_three_layer_rdfifo_data_inst : uz_mlp_three_layer_rdfifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
  ...
  u_uz_mlp_three_layer_rdfifo_rid_inst : uz_mlp_three_layer_rdfifo_rid
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
  ...
  u_uz_mlp_three_layer_rdfifo_last_inst : uz_mlp_three_layer_rdfifo_last
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
