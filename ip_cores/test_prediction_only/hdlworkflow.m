%--------------------------------------------------------------------------
% HDL Workflow Script
% Generated with MATLAB 9.12 (R2022a) at 10:09:54 on 12/10/2022
% This script was generated using the following parameter values:
%     Filename  : 'C:\ultrazohm_sw\ip_cores\test_prediction_only\hdlworkflow.m'
%     Overwrite : true
%     Comments  : true
%     Headers   : true
...
hdlset_param('parallel_prediction_and_cost_function_6phase', 'TargetDirectory', 'C:\ultrazohm_sw\ip_cores\test_prediction_only\hdlsrc');
...
hdlset_param('parallel_prediction_and_cost_function_6phase/Prediction_and_cost_function', 'IPCoreName', 'test_parallel_prediction_only');
...
% Set Outport HDL parameters
hdlset_param('parallel_prediction_and_cost_function_6phase/Prediction_and_cost_function/Prediction', 'IOInterface', 'External Port');
hdlset_param('parallel_prediction_and_cost_function_6phase/Prediction_and_cost_function/Prediction', 'IOInterfaceMapping', '');
...
hWC.ProjectFolder = 'C:\ultrazohm_sw\ip_cores\test_prediction_only';
