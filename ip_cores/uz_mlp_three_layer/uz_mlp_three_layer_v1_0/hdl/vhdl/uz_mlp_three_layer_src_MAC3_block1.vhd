-- -------------------------------------------------------------
-- 
-- File Name: /home/ts/Documents/integrate_nn_to_uz/ultrazohm_sw/ip_cores/nnAXI_v1_0/hdl_prj/hdlsrc/uz_mlp_three_layer/uz_mlp_three_layer_src_MAC3_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_mlp_three_layer_src_MAC3_block1
-- Source Path: uz_mlp_three_layer/uz_mlp_three_layer/reluLayer_8Parallel1/MAC3
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY uz_mlp_three_layer_src_MAC3_block1 IS
...
END uz_mlp_three_layer_src_MAC3_block1;


ARCHITECTURE rtl OF uz_mlp_three_layer_src_MAC3_block1 IS

  -- Component Declarations
  COMPONENT uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block48
  ...
  COMPONENT uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block50
    GENERIC( AddrWidth                    : integer;
             DataWidth                    : integer
             );
    PORT( clk                             :   IN    std_logic;
  ...
  COMPONENT uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block49
    GENERIC( AddrWidth                    : integer;
             DataWidth                    : integer
             );
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block48
    USE ENTITY work.uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block48(rtl);

  FOR ALL : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block50
    USE ENTITY work.uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block50(rtl);

  FOR ALL : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block49
    USE ENTITY work.uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block49(rtl);
...
BEGIN
  u_Dual_Port_RAM_System1 : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block48
  ...
  u_Dual_Port_RAM_System3 : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block50
    GENERIC MAP( AddrWidth => 10,
                 DataWidth => 32
                 )
    PORT MAP( clk => clk,
  ...
  u_Dual_Port_RAM_System2 : uz_mlp_three_layer_src_SimpleDualPortRAM_generic_block49
    GENERIC MAP( AddrWidth => 10,
                 DataWidth => 32
                 )
    PORT MAP( clk => clk,
  ...
  Compare_To_Constant2_out1 <= '1' WHEN axi_layerNr = to_unsigned(16#03#, 8) ELSE
      '0';
