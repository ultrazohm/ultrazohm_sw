-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\uz_pmsm_model_nonlinear\uz_pmsm_model_nonlinear_addr_decoder.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: uz_pmsm_model_nonlinear_addr_decoder
-- Source Path: uz_pmsm_model_nonlinear/uz_pmsm_model_nonlinear_axi4/uz_pmsm_model_nonlinear_addr_decoder
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
USE work.uz_pmsm_model_nonlinear_pkg.ALL;

ENTITY uz_pmsm_model_nonlinear_addr_decoder IS
...
END uz_pmsm_model_nonlinear_addr_decoder;


ARCHITECTURE rtl OF uz_pmsm_model_nonlinear_addr_decoder IS
...
BEGIN
  ...
  decode_sel_outputs <= '1' WHEN addr_write_unsigned = to_unsigned(16#0058#, 14) ELSE
      '0';
  ...
  mux0_level1_output : PROCESS (address_select_level1, const_0, data_slice_outputs_1_0, data_slice_outputs_1_1,
       data_slice_outputs_1_2, data_slice_outputs_1_3, read_reg_ip_timestamp)
  BEGIN
  ...
  decode_sel_inputs <= '1' WHEN addr_write_unsigned = to_unsigned(16#0050#, 14) ELSE
      '0';
  ...
  decode_sel_inputs_1_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#004C#, 14) ELSE
      '0';
  ...
  decode_sel_inputs_2_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#004D#, 14) ELSE
      '0';
  ...
  decode_sel_inputs_3_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#004E#, 14) ELSE
      '0';
  ...
  decode_sel_inputs_4_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#004F#, 14) ELSE
      '0';
  ...
  decode_sel_fitting_parameter <= '1' WHEN addr_write_unsigned = to_unsigned(16#0080#, 14) ELSE
      '0';
  ...
  decode_sel_fitting_parameter_1_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#0060#, 14) ELSE
      '0';
  ...
  decode_sel_fitting_parameter_2_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#0061#, 14) ELSE
      '0';
  ...
  decode_sel_fitting_parameter_3_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#0062#, 14) ELSE
      '0';
  ...
  decode_sel_fitting_parameter_4_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#0063#, 14) ELSE
      '0';
  ...
  decode_sel_fitting_parameter_5_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#0064#, 14) ELSE
      '0';
  ...
  decode_sel_fitting_parameter_6_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#0065#, 14) ELSE
      '0';
  ...
  decode_sel_fitting_parameter_7_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#0066#, 14) ELSE
      '0';
  ...
  decode_sel_fitting_parameter_8_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#0067#, 14) ELSE
      '0';
  ...
  decode_sel_fitting_parameter_9_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#0068#, 14) ELSE
      '0';
  ...
  decode_sel_fitting_parameter_10_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#0069#, 14) ELSE
      '0';
  ...
  decode_sel_fitting_parameter_11_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#006A#, 14) ELSE
      '0';
  ...
  decode_sel_fitting_parameter_12_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#006B#, 14) ELSE
      '0';
  ...
  decode_sel_fitting_parameter_13_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#006C#, 14) ELSE
      '0';
  ...
  decode_sel_fitting_parameter_14_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#006D#, 14) ELSE
      '0';
  ...
  decode_sel_fitting_parameter_15_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#006E#, 14) ELSE
      '0';
  ...
  decode_sel_fitting_parameter_16_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#006F#, 14) ELSE
      '0';
  ...
  decode_sel_fitting_parameter_17_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#0070#, 14) ELSE
      '0';
  ...
  decode_sel_fitting_parameter_18_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#0071#, 14) ELSE
      '0';
  ...
  decode_sel_fitting_parameter_19_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#0072#, 14) ELSE
      '0';
  ...
  decode_sel_fitting_parameter_20_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#0073#, 14) ELSE
      '0';
  ...
  decode_sel_fitting_parameter_21_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#0074#, 14) ELSE
      '0';
  ...
  decode_sel_fitting_parameter_22_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#0075#, 14) ELSE
      '0';
  ...
  decode_sel_fitting_parameter_23_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#0076#, 14) ELSE
      '0';
