...
ENTITY uz_pmsm_6LUT_approx_src_uz_pmsm_model_6LUT IS
  PORT( clk                               :   IN    std_logic;
        ...
        fitting_parameters_0              :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_1              :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_2              :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_3              :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_4              :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_5              :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_6              :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_7              :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_8              :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_9              :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_10             :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_11             :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_12             :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        fitting_parameters_13             :   IN    std_logic_vector(31 DOWNTO 0);  -- single
...
ARCHITECTURE rtl OF uz_pmsm_6LUT_approx_src_uz_pmsm_model_6LUT IS
  ...
  COMPONENT uz_pmsm_6LUT_approx_src_nfp_div_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT uz_pmsm_6LUT_approx_src_nfp_sub_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          nfp_in1                         :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT uz_pmsm_6LUT_approx_src_nfp_recip_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          nfp_in                          :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT uz_pmsm_6LUT_approx_src_nfp_add_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          nfp_in1                         :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT uz_pmsm_6LUT_approx_src_nfp_signum_single
    PORT( nfp_in                          :   IN    std_logic_vector(31 DOWNTO 0);  -- single
          nfp_out                         :   OUT   std_logic_vector(31 DOWNTO 0)  -- single
          );
  END COMPONENT;

  COMPONENT uz_pmsm_6LUT_approx_src_nfp_abs_single
    PORT( nfp_in                          :   IN    std_logic_vector(31 DOWNTO 0);  -- single
          nfp_out                         :   OUT   std_logic_vector(31 DOWNTO 0)  -- single
          );
  END COMPONENT;
  ...
  COMPONENT uz_pmsm_6LUT_approx_src_nfp_uminus_single
    PORT( nfp_in                          :   IN    std_logic_vector(31 DOWNTO 0);  -- single
          nfp_out                         :   OUT   std_logic_vector(31 DOWNTO 0)  -- single
          );
  END COMPONENT;
  ...
  FOR ALL : uz_pmsm_6LUT_approx_src_nfp_div_single
    USE ENTITY work.uz_pmsm_6LUT_approx_src_nfp_div_single(rtl);

  FOR ALL : uz_pmsm_6LUT_approx_src_nfp_sub_single
    USE ENTITY work.uz_pmsm_6LUT_approx_src_nfp_sub_single(rtl);
  ...
  FOR ALL : uz_pmsm_6LUT_approx_src_nfp_recip_single
    USE ENTITY work.uz_pmsm_6LUT_approx_src_nfp_recip_single(rtl);

  FOR ALL : uz_pmsm_6LUT_approx_src_nfp_tanh_single
    USE ENTITY work.uz_pmsm_6LUT_approx_src_nfp_tanh_single(rtl);

  FOR ALL : uz_pmsm_6LUT_approx_src_nfp_add_single
    USE ENTITY work.uz_pmsm_6LUT_approx_src_nfp_add_single(rtl);

  FOR ALL : uz_pmsm_6LUT_approx_src_nfp_signum_single
    USE ENTITY work.uz_pmsm_6LUT_approx_src_nfp_signum_single(rtl);

  FOR ALL : uz_pmsm_6LUT_approx_src_nfp_abs_single
    USE ENTITY work.uz_pmsm_6LUT_approx_src_nfp_abs_single(rtl);

  FOR ALL : uz_pmsm_6LUT_approx_src_nfp_log_single
    USE ENTITY work.uz_pmsm_6LUT_approx_src_nfp_log_single(rtl);

  FOR ALL : uz_pmsm_6LUT_approx_src_nfp_uminus_single
    USE ENTITY work.uz_pmsm_6LUT_approx_src_nfp_uminus_single(rtl);
  ...
  SIGNAL fitting_parameters               : vector_of_std_logic_vector32(0 TO 13);  -- ufix32 [14]
  SIGNAL fitting_parameters_14            : vector_of_std_logic_vector32(0 TO 13);  -- ufix32 [14]
  SIGNAL ad3                              : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL fitting_parameters_1_1           : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL ad2                              : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL fitting_parameters_0_1           : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL ad1                              : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL ad6                              : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL fitting_parameters_4_1           : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL ad5                              : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL fitting_parameters_3_1           : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL psi_pm_3                         : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL fitting_parameters_12_1          : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL ad1_1                            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Product21_out1                   : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL fitting_parameters_1_2           : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL ad2_1                            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL ad3_1                            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL ad4_1                            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Product8_out1                    : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL fitting_parameters_4_2           : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL ad5_1                            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL ad6_1                            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL fitting_parameters_13_1          : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL psi_pm_4                         : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL delayMatch53_reg                 : std_logic_vector(96 DOWNTO 0);  -- ufix1 [97]
  SIGNAL Switch1_out1_timer_1             : std_logic;
  SIGNAL Switch1_out1_default             : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Lq_2                             : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Constant1_out1                   : std_logic_vector(63 DOWNTO 0);  -- ufix64
  SIGNAL i_q_2                            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Product14_out1_timer             : std_logic;
  SIGNAL delayMatch42_reg                 : std_logic_vector(28 DOWNTO 0);  -- ufix1 [29]
  SIGNAL Product14_out1_timer_1           : std_logic;
  SIGNAL Product14_out1_default           : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL From1_out1_6                     : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL aq1_1                            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL From1_out1_7                     : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL Product15_out1_timer             : std_logic;
  SIGNAL delayMatch46_reg                 : std_logic_vector(28 DOWNTO 0);  -- ufix1 [29]
  SIGNAL Product15_out1_timer_1           : std_logic;
  SIGNAL Product15_out1_default           : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL From1_out1_9                     : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL aq4_1                            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL From1_out1_10                    : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL psi_pm_5                         : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Delay1_iv_1                      : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL aq3_2                            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL aq2_2                            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL fitting_parameters_6_1           : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL aq1_2                            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL aq5_2                            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL fitting_parameters_9_1           : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL aq4_2                            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL aq6_2                            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL From2_out1_12                    : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL psi_pm_6                         : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Ld_2                             : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Constant1_out1_1                 : std_logic_vector(63 DOWNTO 0);  -- ufix64
  SIGNAL i_q_3                            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Product14_out1_timer_2           : std_logic;
  SIGNAL delayMatch25_reg                 : std_logic_vector(34 DOWNTO 0);  -- ufix1 [35]
  SIGNAL Product14_out1_timer_3           : std_logic;
  SIGNAL Product14_out1_default_1         : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL ad3_2                            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL From1_out1_1                     : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL From1_out1_1_1                   : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL ad2_2                            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL From1_out1_0                     : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL ad1_2                            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Product15_out1_timer_2           : std_logic;
  SIGNAL delayMatch29_reg                 : std_logic_vector(34 DOWNTO 0);  -- ufix1 [35]
  SIGNAL Product15_out1_timer_3           : std_logic;
  SIGNAL Product15_out1_default_1         : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL ad6_2                            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL From1_out1_4                     : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL From1_out1_4_1                   : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL ad5_2                            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL From1_out1_3                     : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL ad4_2                            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL From1_out1_12                    : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL Product15_out1_zp                : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL Product14_out1_zp                : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Product13_out1                   : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Product1_out_1                   : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL Product13_out1_1                 : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL Product15_out1_zp_1              : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Product16_out1_1                 : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Product3_out_1_1                 : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL Product14_out1_zp_1              : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Product13_out1_2                 : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Product1_out_1_1                 : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL psidself_abgeleitet_2            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Lqq                              : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Lqq_1                            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Switch1_out1                     : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Switch1_out1_zp                  : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL Product9_out1_2                  : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL psi_q_approx                     : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL Product8_out1_1                  : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Product7_out_1                   : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL psi_d_approx_1                   : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL psid_cross_s1_6                  : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Product20_out_1_2                : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL psiq_cross_2                     : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Lqd_approx                       : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL Product11_out1_2                 : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL psiq_cross_3                     : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Ldq_approx                       : std_logic_vector(31 DOWNTO 0);  -- ufix32
...
BEGIN
  ...
  u_nfp_div_comp : uz_pmsm_6LUT_approx_src_nfp_div_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => aq1,  -- single
              nfp_in2 => fitting_parameters_14(7),  -- single
              nfp_out => Product9_out1  -- single
              );

  u_nfp_sub_comp : uz_pmsm_6LUT_approx_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => aq3,  -- single
  ...
  u_uz_pmsm_model_6LUT_pd_uz_pmsm_model_6LUT_nfp_convert_double2single : uz_pmsm_6LUT_approx_src_nfp_convert_double2single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in => Constant_out1,  -- double
              nfp_out => i_q_1  -- single
              );

  u_nfp_div_comp_1 : uz_pmsm_6LUT_approx_src_nfp_div_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => aq4,  -- single
              nfp_in2 => fitting_parameters_14(10),  -- single
              nfp_out => Product11_out1  -- single
              );

  u_nfp_div_comp_2 : uz_pmsm_6LUT_approx_src_nfp_div_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => ad1_1,  -- single
              nfp_in2 => fitting_parameters_14(1),  -- single
              nfp_out => Product21_out1  -- single
              );

  u_nfp_div_comp_3 : uz_pmsm_6LUT_approx_src_nfp_div_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => ad4_1,  -- single
              nfp_in2 => fitting_parameters_14(4),  -- single
  ...
  u_uz_pmsm_model_6LUT_pd_uz_pmsm_model_6LUT_nfp_convert_double2single_2 : uz_pmsm_6LUT_approx_src_nfp_convert_double2single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in => Constant1_out1_1,  -- double
              nfp_out => i_q_3  -- single
              );

  u_nfp_sub_comp_1 : uz_pmsm_6LUT_approx_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_div_comp_4 : uz_pmsm_6LUT_approx_src_nfp_div_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => i_q_3,  -- single
              nfp_in2 => Product15_out1_zp,  -- single
              nfp_out => Product16_out1  -- single
              );

  -- mul #1
  u_nfp_mul_comp_2 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Product16_out1,  -- single
              nfp_in2 => ad4_2,  -- single
              nfp_out => Product3_out_1  -- single
              );

  -- mul #2
  u_nfp_mul_comp_3 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Product3_out_1,  -- single
              nfp_in2 => From1_out1_4_1,  -- single
              nfp_out => psid_s1  -- single
              );

  u_nfp_sub_comp_2 : uz_pmsm_6LUT_approx_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  -- mul #1
  u_nfp_mul_comp_4 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  -- mul #2
  u_nfp_mul_comp_5 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_3 : uz_pmsm_6LUT_approx_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1,  -- single
  ...
  u_nfp_mul_comp_6 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_div_comp_5 : uz_pmsm_6LUT_approx_src_nfp_div_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => i_q_3,  -- single
              nfp_in2 => Product14_out1_zp,  -- single
              nfp_out => Product13_out1  -- single
              );

  -- mul #1
  u_nfp_mul_comp_8 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Product13_out1,  -- single
              nfp_in2 => ad1_2,  -- single
              nfp_out => Product1_out_1  -- single
              );

  -- mul #2
  u_nfp_mul_comp_9 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Product1_out_1,  -- single
              nfp_in2 => From1_out1_1_1,  -- single
              nfp_out => psidself_abgeleitet  -- single
              );

  u_nfp_sub_comp_4 : uz_pmsm_6LUT_approx_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_recip_comp : uz_pmsm_6LUT_approx_src_nfp_recip_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in => Switch2_out1,  -- single
              nfp_out => Divide_recip_out  -- single
              );

  u_nfp_mul_comp_10 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Product13_out1_1,  -- single
              nfp_in2 => Switch6_out1,  -- single
              nfp_out => psi_q_omega_ell  -- single
              );

  u_nfp_mul_comp_11 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1_2,  -- single
              nfp_in2 => aq6_2,  -- single
              nfp_out => Product6_out1  -- single
              );

  u_nfp_mul_comp_12 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1_2,  -- single
  ...
  u_nfp_mul_comp_13 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              ...
              nfp_in2 => aq4_2,  -- single
              nfp_out => psiq_s1  -- single
              );

  u_nfp_add_comp : uz_pmsm_6LUT_approx_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_14 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1_2,  -- single
  ...
  u_nfp_mul_comp_15 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Tanh_out1,  -- single
              nfp_in2 => aq1_2,  -- single
              nfp_out => Product1_out1  -- single
              );

  u_nfp_mul_comp_16 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1_2,  -- single
  ...
  u_nfp_div_comp_6 : uz_pmsm_6LUT_approx_src_nfp_div_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => i_q_2,  -- single
              nfp_in2 => Product15_out1_zp_1,  -- single
              nfp_out => Product16_out1_1  -- single
              );

  -- mul #1
  u_nfp_mul_comp_18 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Product16_out1_1,  -- single
              nfp_in2 => aq4_1,  -- single
              nfp_out => Product3_out_1_1  -- single
              );

  -- mul #2
  u_nfp_mul_comp_19 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Product3_out_1_1,  -- single
              nfp_in2 => aq5_1,  -- single
              nfp_out => psid_s1_1  -- single
              );

  u_nfp_add_comp_1 : uz_pmsm_6LUT_approx_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_5 : uz_pmsm_6LUT_approx_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  -- mul #1
  u_nfp_mul_comp_20 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  -- mul #2
  u_nfp_mul_comp_21 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Product20_out_1,  -- single
              nfp_in2 => psi_pm_5,  -- single
              nfp_out => psiq_cross  -- single
              );

  u_nfp_mul_comp_22 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1_2,  -- single
  ...
  u_nfp_div_comp_7 : uz_pmsm_6LUT_approx_src_nfp_div_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => i_q_2,  -- single
              nfp_in2 => Product14_out1_zp_1,  -- single
              nfp_out => Product13_out1_2  -- single
              );

  -- mul #1
  u_nfp_mul_comp_24 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Product13_out1_2,  -- single
              nfp_in2 => aq1_1,  -- single
              nfp_out => Product1_out_1_1  -- single
              );

  -- mul #2
  u_nfp_mul_comp_25 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Product1_out_1_1,  -- single
              nfp_in2 => aq2_1,  -- single
              nfp_out => psidself_abgeleitet_2  -- single
              );

  u_nfp_add_comp_2 : uz_pmsm_6LUT_approx_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_6 : uz_pmsm_6LUT_approx_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Sum1_out1_2,  -- single
  ...
  u_nfp_mul_comp_26 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1_2,  -- single
  ...
  u_nfp_signum_comp : uz_pmsm_6LUT_approx_src_nfp_signum_single
    PORT MAP( nfp_in => Delay1_out1_4,  -- single
              nfp_out => Sign1_out1  -- single
              );

  u_nfp_abs_comp : uz_pmsm_6LUT_approx_src_nfp_abs_single
    PORT MAP( nfp_in => Delay1_out1_4,  -- single
  ...
  u_nfp_add_comp_3 : uz_pmsm_6LUT_approx_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_28 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_7 : uz_pmsm_6LUT_approx_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1,  -- single
  ...
  u_nfp_mul_comp_29 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_30 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Product8_out1,  -- single
              nfp_in2 => Log1_out1,  -- single
              nfp_out => Product9_out1_2  -- single
              );

  u_nfp_sub_comp_8 : uz_pmsm_6LUT_approx_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1,  -- single
  ...
  u_nfp_mul_comp_31 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => ad2_1,  -- single
              nfp_in2 => psid_cross_s1_3,  -- single
  ...
  u_nfp_mul_comp_32 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Product21_out1,  -- single
              nfp_in2 => Log2_out1,  -- single
              nfp_out => Product4_out1_1  -- single
              );

  u_nfp_sub_comp_9 : uz_pmsm_6LUT_approx_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Product4_out1_1,  -- single
              nfp_in2 => Product9_out1_2,  -- single
  ...
  -- mul #2
  u_nfp_mul_comp_34 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Product20_out_1_1,  -- single
              nfp_in2 => psi_pm_4,  -- single
              nfp_out => psiq_cross_1  -- single
              );

  u_nfp_sub_comp_10 : uz_pmsm_6LUT_approx_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_35 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1_2,  -- single
  ...
  u_nfp_mul_comp_36 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => i_d,  -- single
  ...
  u_nfp_mul_comp_37 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Switch5_out1,  -- single
              nfp_in2 => i_q_5,  -- single
              nfp_out => Product3_out1  -- single
              );

  u_nfp_sub_comp_11 : uz_pmsm_6LUT_approx_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_38 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_39 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => M_Mi,  -- single
  ...
  u_nfp_sub_comp_12 : uz_pmsm_6LUT_approx_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_13 : uz_pmsm_6LUT_approx_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_40 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_41 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp_4 : uz_pmsm_6LUT_approx_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_42 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Switch_out1,  -- single
              nfp_in2 => polepairs_1,  -- single
              nfp_out => Product13_out1_1  -- single
              );

  u_nfp_mul_comp_43 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1_2,  -- single
  ...
  u_nfp_mul_comp_44 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_45 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1_2,  -- single
              nfp_in2 => Delay1_out1_2,  -- single
              nfp_out => Product8_out1_1  -- single
              );

  -- mul #1
  u_nfp_mul_comp_46 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Product8_out1_1,  -- single
              nfp_in2 => psid_cross_s1,  -- single
              nfp_out => Product7_out_1  -- single
              );

  -- mul #2
  u_nfp_mul_comp_47 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Product7_out_1,  -- single
              nfp_in2 => i_q_1,  -- single
              nfp_out => Product7_out1  -- single
              );

  u_nfp_mul_comp_48 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1_2,  -- single
  ...
  u_nfp_mul_comp_49 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp_5 : uz_pmsm_6LUT_approx_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_14 : uz_pmsm_6LUT_approx_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  -- mul #1
  u_nfp_mul_comp_50 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  -- mul #2
  u_nfp_mul_comp_51 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_15 : uz_pmsm_6LUT_approx_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_52 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1,  -- single
  ...
  u_nfp_add_comp_6 : uz_pmsm_6LUT_approx_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Product5_out1_1,  -- single
              nfp_in2 => psi_pm_3,  -- single
              nfp_out => Sum_out1_3  -- single
              );

  u_nfp_mul_comp_53 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Switch5_out1,  -- single
              nfp_in2 => Product13_out1_1,  -- single
              nfp_out => psi_d_omega_ell  -- single
              );

  -- mul #1
  u_nfp_mul_comp_54 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => psid_cross_s1_6,  -- single
              nfp_in2 => psiq_cross_s1_2,  -- single
              nfp_out => Product20_out_1_2  -- single
              );

  -- mul #2
  u_nfp_mul_comp_55 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Product20_out_1_2,  -- single
              nfp_in2 => psi_pm_1,  -- single
              nfp_out => psiq_cross_2  -- single
              );

  u_nfp_uminus_comp : uz_pmsm_6LUT_approx_src_nfp_uminus_single
    PORT MAP( nfp_in => psiq_cross_2,  -- single
              nfp_out => Lqd_approx  -- single
              );

  u_nfp_mul_comp_56 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Unit_Delay_out1_2,  -- single
              nfp_in2 => Lqd_approx,  -- single
              nfp_out => Product11_out1_2  -- single
              );

  u_nfp_sub_comp_16 : uz_pmsm_6LUT_approx_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => u_q,  -- single
  ...
  u_nfp_sub_comp_17 : uz_pmsm_6LUT_approx_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_18 : uz_pmsm_6LUT_approx_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_div_comp_8 : uz_pmsm_6LUT_approx_src_nfp_div_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Sum4_out1_1,  -- single
              nfp_in2 => Switch1_out1_zp,  -- single
              nfp_out => diq_dt  -- single
              );

  u_nfp_mul_comp_57 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp_7 : uz_pmsm_6LUT_approx_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_58 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1_2,  -- single
              nfp_in2 => aq3_2,  -- single
              nfp_out => Product5_out1_2  -- single
              );

  u_nfp_add_comp_8 : uz_pmsm_6LUT_approx_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_19 : uz_pmsm_6LUT_approx_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_20 : uz_pmsm_6LUT_approx_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1,  -- single
  ...
  u_nfp_mul_comp_59 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_60 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_21 : uz_pmsm_6LUT_approx_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Delay1_out1,  -- single
  ...
  u_nfp_mul_comp_61 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_62 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_sub_comp_22 : uz_pmsm_6LUT_approx_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => psidself,  -- single
              nfp_in2 => psid_s1_4,  -- single
              nfp_out => psid_cross_s1_4  -- single
              );

  -- mul #1
  u_nfp_mul_comp_63 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  -- mul #2
  u_nfp_mul_comp_64 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Product20_out_1_3,  -- single
              nfp_in2 => psi_pm_6,  -- single
              nfp_out => psiq_cross_3  -- single
              );

  u_nfp_uminus_comp_1 : uz_pmsm_6LUT_approx_src_nfp_uminus_single
    PORT MAP( nfp_in => psiq_cross_3,  -- single
              nfp_out => Ldq_approx  -- single
              );

  u_nfp_mul_comp_65 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => Ldq_approx,  -- single
              nfp_in2 => Unit_Delay1_out1_2,  -- single
              nfp_out => Product12_out1_2  -- single
              );

  u_nfp_mul_comp_66 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => R1_1,  -- single
  ...
  u_nfp_sub_comp_23 : uz_pmsm_6LUT_approx_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              nfp_in1 => u_d,  -- single
  ...
  u_nfp_sub_comp_24 : uz_pmsm_6LUT_approx_src_nfp_sub_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp_9 : uz_pmsm_6LUT_approx_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_67 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_mul_comp_68 : uz_pmsm_6LUT_approx_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_nfp_add_comp_10 : uz_pmsm_6LUT_approx_src_nfp_add_single
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  Constant_out1 <= X"3fe0000000000000";
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        psi_pm_4 <= X"00000000";
      ELSIF enb = '1' THEN
        psi_pm_4 <= fitting_parameters_13_1;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        delayMatch53_reg(0) <= Switch1_out1_timer;
        delayMatch53_reg(96 DOWNTO 1) <= delayMatch53_reg(95 DOWNTO 0);
      END IF;
    END IF;
  END PROCESS delayMatch53_process;

  Switch1_out1_timer_1 <= delayMatch53_reg(96);

  Switch1_out1_default <= X"3f800000";
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        delayMatch42_reg(0) <= Product14_out1_timer;
        delayMatch42_reg(28 DOWNTO 1) <= delayMatch42_reg(27 DOWNTO 0);
      END IF;
    END IF;
  END PROCESS delayMatch42_process;

  Product14_out1_timer_1 <= delayMatch42_reg(28);

  Product14_out1_default <= X"3f800000";
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        delayMatch46_reg(0) <= Product15_out1_timer;
        delayMatch46_reg(28 DOWNTO 1) <= delayMatch46_reg(27 DOWNTO 0);
      END IF;
    END IF;
  END PROCESS delayMatch46_process;

  Product15_out1_timer_1 <= delayMatch46_reg(28);

  Product15_out1_default <= X"3f800000";
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        delayMatch25_reg(0) <= Product14_out1_timer_2;
        delayMatch25_reg(34 DOWNTO 1) <= delayMatch25_reg(33 DOWNTO 0);
      END IF;
    END IF;
  END PROCESS delayMatch25_process;

  Product14_out1_timer_3 <= delayMatch25_reg(34);

  Product14_out1_default_1 <= X"3f800000";
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        delayMatch29_reg(0) <= Product15_out1_timer_2;
        delayMatch29_reg(34 DOWNTO 1) <= delayMatch29_reg(33 DOWNTO 0);
      END IF;
    END IF;
  END PROCESS delayMatch29_process;

  Product15_out1_timer_3 <= delayMatch29_reg(34);

  Product15_out1_default_1 <= X"3f800000";
  ...
  Product15_out1_zp <= Product15_out1_default_1 WHEN Product15_out1_timer_3 = '0' ELSE
      Product15_out1;

  
  Product14_out1_zp <= Product14_out1_default_1 WHEN Product14_out1_timer_3 = '0' ELSE
      Product14_out1;
  ...
  Switch2_out1 <= Ld_2 WHEN simulate_nonlinear_2 = '0' ELSE
      Ldd;
  ...
  Product15_out1_zp_1 <= Product15_out1_default WHEN Product15_out1_timer_1 = '0' ELSE
      Product15_out1_1;

  
  Product14_out1_zp_1 <= Product14_out1_default WHEN Product14_out1_timer_1 = '0' ELSE
      Product14_out1_1;

  Lqq_1 <= Lqq;

  
  Switch1_out1 <= Lq_2 WHEN simulate_nonlinear_2 = '0' ELSE
      Lqq_1;
  ...
  Switch6_out1 <= Product1_out1_1 WHEN simulate_nonlinear_3 = '0' ELSE
      psi_q_approx;
  ...
  Switch5_out1 <= Sum_out1_3 WHEN simulate_nonlinear_4 = '0' ELSE
      psi_d_approx_1;
  ...
  Switch4_out1 <= i_q WHEN simulate_nonlinear_2 = '0' ELSE
      Product11_out1_2;
  ...
  Switch3_out1 <= i_q WHEN simulate_nonlinear_2 = '0' ELSE
      Product12_out1_2;
  ...
  Switch1_out1_1 <= omega_mech WHEN simulate_mechanical_1 = '0' ELSE
      Delay1_out1_4;
