...
#define  IPCore_Timestamp_parallel_8_sim_delay_compensation             0x8  //contains unique IP timestamp (yymmddHHMM): 2212221548
...
#define  id_k_1_AXI_Data_parallel_8_sim_delay_compensation              0x124  //data register for Outport id_k_1_AXI
#define  iq_k_1_AXI_Data_parallel_8_sim_delay_compensation              0x128  //data register for Outport iq_k_1_AXI
#define  ix_k_1_AXI_Data_parallel_8_sim_delay_compensation              0x12C  //data register for Outport ix_k_1_AXI
#define  iy_k_1_AXI_Data_parallel_8_sim_delay_compensation              0x130  //data register for Outport iy_k_1_AXI
#define  omega_m_measured_AXI_Data_parallel_8_sim_delay_compensation    0x134  //data register for Inport omega_m_measured_AXI
