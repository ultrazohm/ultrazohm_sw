...
/*##################################################################### */
    ...
    * sed
    *  PSU_IOU_SLCR_MIO_PIN_22_L3_SEL                              1

    * Configures MIO Pin 22 peripheral interface mapping
    * (OFFSET, MASK, VALUE)      (0XFF180058, 0x000000FEU ,0x00000020U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_22_OFFSET, 0x000000FEU, 0x00000020U);
/*##################################################################### */
    ...
    * TTC Waveform Clock) 6= ua0, Output, ua0_txd- (UART transmitter serial ou
    * tput) 7= Not Used
    *  PSU_IOU_SLCR_MIO_PIN_23_L3_SEL                              1

    * Configures MIO Pin 23 peripheral interface mapping
    * (OFFSET, MASK, VALUE)      (0XFF18005C, 0x000000FEU ,0x00000020U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_23_OFFSET, 0x000000FEU, 0x00000020U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180204, 0xFFFFFFFFU ,0x2E640000U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI0_OFFSET,
		0xFFFFFFFFU, 0x2E640000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180140, 0x03FFFFFFU ,0x0267EF1EU)
    */
	PSU_Mask_Write(IOU_SLCR_BANK0_CTRL3_OFFSET,
		0x03FFFFFFU, 0x0267EF1EU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF18014C, 0x03FFFFFFU ,0x019BFFFFU)
    */
	PSU_Mask_Write(IOU_SLCR_BANK0_CTRL6_OFFSET,
		0x03FFFFFFU, 0x019BFFFFU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF18015C, 0x03FFFFFFU ,0x0003FFFBU)
    */
	PSU_Mask_Write(IOU_SLCR_BANK1_CTRL3_OFFSET,
		0x03FFFFFFU, 0x0003FFFBU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180168, 0x03FFFFFFU ,0x03FFFFF4U)
    */
