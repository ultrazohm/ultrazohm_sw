...
#define  IPCore_Timestamp_uz_JL_pmsmModel           0x8  //contains unique IP timestamp (yymmddHHMM): 2605190956
...
#define  pmsm_Iu_Data_uz_JL_pmsmModel         0x160  //data register for Outport pmsm_Iu
#define  pmsm_Iv_Data_uz_JL_pmsmModel         0x164 //+ 0x4  //data register for Outport pmsm_Iv
#define  pmsm_Iw_Data_uz_JL_pmsmModel         0x168 //+ 0x8  //data register for Outport pmsm_Iw
#define  omega_mech_Data_uz_JL_pmsmModel      0x16C //+ 0xC //data register for Outport omega_mech
#define  phi_mech_Data_uz_JL_pmsmModel        0x170 //+ 0x10 //data register for Outport phi_mech
#define  pmsm_M_Mot_Data_uz_JL_pmsmModel      0x174 //+ 0x14 //data register for Outport pmsm_M_Mot
